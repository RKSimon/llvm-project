...
; CHECK-LE-P8-NEXT:    vsplth v2, v2, 3
...
; CHECK-BE-P8-NEXT:    lhzx r4, 0, r3
; CHECK-BE-P8-NEXT:    lfdx f0, 0, r3
; CHECK-BE-P8-NEXT:    mtvsrwz v2, r4
; CHECK-BE-P8-NEXT:    vsplth v2, v2, 3
; CHECK-BE-P8-NEXT:    xxmrghw vs0, vs0, v2
...
; CHECK-AIX-64-P8-NEXT:    lhzx r4, 0, r3
; CHECK-AIX-64-P8-NEXT:    lfdx f0, 0, r3
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v2, r4
; CHECK-AIX-64-P8-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-64-P8-NEXT:    xxmrghw vs0, vs0, v2
...
; CHECK-AIX-32-P9-NEXT:    vsplth v2, v2, 3
...
; CHECK-LE-P8-NEXT:    vsplth v2, v2, 3
; CHECK-LE-P8-NEXT:    xxmrglw vs0, vs0, v2
; CHECK-LE-P8-NEXT:    xxswapd vs0, vs0
...
; CHECK-BE-P8-NEXT:    mtvsrwz v2, r4
; CHECK-BE-P8-NEXT:    vsplth v2, v2, 3
; CHECK-BE-P8-NEXT:    xxmrghw vs0, v2, vs0
...
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v2, r4
; CHECK-AIX-64-P8-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-64-P8-NEXT:    xxmrghw vs0, v2, vs0
...
; CHECK-AIX-32-P8-NEXT:    mtvsrwz v2, r4
; CHECK-AIX-32-P8-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-32-P8-NEXT:    xxmrghw vs0, v2, vs0
...
; CHECK-AIX-32-P9-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-32-P9-NEXT:    xxmrghw vs0, v2, vs0
...
; CHECK-LE-P8-NEXT:    xxspltw v3, v2, 3
...
; CHECK-LE-P9-NEXT:    xxspltw v3, v2, 3
...
; CHECK-BE-P8-NEXT:    xxspltw v3, v2, 0
...
; CHECK-BE-P9-NEXT:    xxspltw v3, v2, 0
...
; CHECK-AIX-64-P8-NEXT:    xxspltw v3, v2, 0
...
; CHECK-AIX-64-P9-NEXT:    xxspltw v3, v2, 0
...
; CHECK-AIX-32-P8-NEXT:    xxspltw v3, v2, 0
...
; CHECK-AIX-32-P9-NEXT:    xxspltw v3, v2, 0
...
; CHECK-LE-P9-NEXT:    xxspltw vs0, v2, 3
...
; CHECK-BE-P9-NEXT:    xxspltw vs0, v2, 0
...
; CHECK-AIX-64-P9-NEXT:    xxspltw vs0, v2, 0
...
; CHECK-AIX-32-P9-NEXT:    xxspltw vs0, v2, 0
...
; CHECK-LE-P8:       # %bb.0: # %entry
; CHECK-LE-P8-NEXT:    xxsldwi vs0, v2, v2, 1
; CHECK-LE-P8-NEXT:    lfdx f1, 0, r3
; CHECK-LE-P8-NEXT:    mffprwz r3, f0
; CHECK-LE-P8-NEXT:    rldimi r3, r4, 32, 0
; CHECK-LE-P8-NEXT:    mtfprd f0, r3
; CHECK-LE-P8-NEXT:    mffprwz r3, f1
; CHECK-LE-P8-NEXT:    rldimi r4, r3, 32, 0
; CHECK-LE-P8-NEXT:    mtfprd f1, r4
; CHECK-LE-P8-NEXT:    xxmrghd vs0, vs1, vs0
; CHECK-LE-P8-NEXT:    xxswapd vs0, vs0
; CHECK-LE-P8-NEXT:    stxvd2x vs0, 0, r3
;
...
; CHECK-LE-P9:       # %bb.0: # %entry
; CHECK-LE-P9-NEXT:    lfd f0, 0(r3)
; CHECK-LE-P9-NEXT:    li r3, 4
; CHECK-LE-P9-NEXT:    vextuwrx r3, r3, v2
; CHECK-LE-P9-NEXT:    mffprwz r5, f0
; CHECK-LE-P9-NEXT:    rldimi r3, r4, 32, 0
; CHECK-LE-P9-NEXT:    rldimi r4, r5, 32, 0
; CHECK-LE-P9-NEXT:    mtvsrdd vs0, r4, r3
; CHECK-LE-P9-NEXT:    stxv vs0, 0(r3)
;
; CHECK-BE-P8-LABEL: test_none_v2i64:
; CHECK-BE-P8:       # %bb.0: # %entry
; CHECK-BE-P8-NEXT:    lwz r3, 0(r3)
; CHECK-BE-P8-NEXT:    rldimi r3, r4, 32, 0
; CHECK-BE-P8-NEXT:    mtfprd f0, r3
; CHECK-BE-P8-NEXT:    mfvsrwz r3, v2
; CHECK-BE-P8-NEXT:    rldimi r4, r3, 32, 0
; CHECK-BE-P8-NEXT:    mtfprd f1, r4
; CHECK-BE-P8-NEXT:    xxmrghd vs0, vs1, vs0
; CHECK-BE-P8-NEXT:    stxvw4x vs0, 0, r3
;
; CHECK-BE-P9-LABEL: test_none_v2i64:
; CHECK-BE-P9:       # %bb.0: # %entry
; CHECK-BE-P9-NEXT:    lwz r3, 0(r3)
; CHECK-BE-P9-NEXT:    mfvsrwz r5, v2
; CHECK-BE-P9-NEXT:    rldimi r3, r4, 32, 0
; CHECK-BE-P9-NEXT:    rldimi r4, r5, 32, 0
; CHECK-BE-P9-NEXT:    mtvsrdd vs0, r4, r3
; CHECK-BE-P9-NEXT:    stxv vs0, 0(r3)
;
; CHECK-AIX-64-P8-LABEL: test_none_v2i64:
; CHECK-AIX-64-P8:       # %bb.0: # %entry
; CHECK-AIX-64-P8-NEXT:    lwz r3, 0(r3)
; CHECK-AIX-64-P8-NEXT:    rldimi r3, r4, 32, 0
; CHECK-AIX-64-P8-NEXT:    mtfprd f0, r3
; CHECK-AIX-64-P8-NEXT:    mfvsrwz r3, v2
; CHECK-AIX-64-P8-NEXT:    rldimi r4, r3, 32, 0
; CHECK-AIX-64-P8-NEXT:    mtfprd f1, r4
; CHECK-AIX-64-P8-NEXT:    xxmrghd vs0, vs1, vs0
; CHECK-AIX-64-P8-NEXT:    stxvw4x vs0, 0, r3
;
; CHECK-AIX-64-P9-LABEL: test_none_v2i64:
; CHECK-AIX-64-P9:       # %bb.0: # %entry
; CHECK-AIX-64-P9-NEXT:    lwz r3, 0(r3)
; CHECK-AIX-64-P9-NEXT:    mfvsrwz r5, v2
; CHECK-AIX-64-P9-NEXT:    rldimi r3, r4, 32, 0
; CHECK-AIX-64-P9-NEXT:    rldimi r4, r5, 32, 0
; CHECK-AIX-64-P9-NEXT:    mtvsrdd vs0, r4, r3
; CHECK-AIX-64-P9-NEXT:    stxv vs0, 0(r3)
;
...
; CHECK-AIX-32-P8-NEXT:    addi r3, r1, -12
...
; CHECK-AIX-32-P8-NEXT:    xxmrghw vs0, vs2, vs0
; CHECK-AIX-32-P8-NEXT:    xxmrghw vs1, vs1, vs2
; CHECK-AIX-32-P8-NEXT:    xxmrghd vs0, vs1, vs0
; CHECK-AIX-32-P8-NEXT:    stxvw4x vs0, 0, r3
;
...
; CHECK-LE-P8:       # %bb.0: # %entry
; CHECK-LE-P8-NEXT:    lhzx r4, 0, r3
; CHECK-LE-P8-NEXT:    lhzx r3, 0, r3
; CHECK-LE-P8-NEXT:    mtvsrwz v2, r4
; CHECK-LE-P8-NEXT:    mtvsrwz v3, r3
; CHECK-LE-P8-NEXT:    vsplth v2, v2, 3
; CHECK-LE-P8-NEXT:    vsplth v3, v3, 3
; CHECK-LE-P8-NEXT:    xxmrglw vs0, v3, v2
; CHECK-LE-P8-NEXT:    xxswapd vs0, vs0
; CHECK-LE-P8-NEXT:    stxvd2x vs0, 0, r3
; CHECK-LE-P8-NEXT:    blr
;
...
; CHECK-LE-P9-NEXT:    vsplth v2, v2, 3
; CHECK-LE-P9-NEXT:    vsplth v3, v3, 3
; CHECK-LE-P9-NEXT:    xxmrglw vs0, v3, v2
; CHECK-LE-P9-NEXT:    stxv vs0, 0(r3)
; CHECK-LE-P9-NEXT:    blr
;
...
; CHECK-BE-P8:       # %bb.0: # %entry
; CHECK-BE-P8-NEXT:    lhzx r4, 0, r3
; CHECK-BE-P8-NEXT:    lhzx r3, 0, r3
; CHECK-BE-P8-NEXT:    mtvsrwz v2, r4
; CHECK-BE-P8-NEXT:    mtvsrwz v3, r3
; CHECK-BE-P8-NEXT:    vsplth v2, v2, 3
; CHECK-BE-P8-NEXT:    vsplth v3, v3, 3
; CHECK-BE-P8-NEXT:    xxmrghw vs0, v2, v3
; CHECK-BE-P8-NEXT:    stxvw4x vs0, 0, r3
; CHECK-BE-P8-NEXT:    blr
;
...
; CHECK-BE-P9-NEXT:    vsplth v2, v2, 3
; CHECK-BE-P9-NEXT:    vsplth v3, v3, 3
; CHECK-BE-P9-NEXT:    xxmrghw vs0, v2, v3
; CHECK-BE-P9-NEXT:    stxv vs0, 0(r3)
; CHECK-BE-P9-NEXT:    blr
;
...
; CHECK-AIX-64-P8:       # %bb.0: # %entry
; CHECK-AIX-64-P8-NEXT:    lhzx r4, 0, r3
; CHECK-AIX-64-P8-NEXT:    lhzx r3, 0, r3
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v2, r4
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v3, r3
; CHECK-AIX-64-P8-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-64-P8-NEXT:    vsplth v3, v3, 3
; CHECK-AIX-64-P8-NEXT:    xxmrghw vs0, v2, v3
; CHECK-AIX-64-P8-NEXT:    stxvw4x vs0, 0, r3
; CHECK-AIX-64-P8-NEXT:    blr
;
...
; CHECK-AIX-64-P9-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-64-P9-NEXT:    vsplth v3, v3, 3
; CHECK-AIX-64-P9-NEXT:    xxmrghw vs0, v2, v3
; CHECK-AIX-64-P9-NEXT:    stxv vs0, 0(r3)
; CHECK-AIX-64-P9-NEXT:    blr
;
...
; CHECK-AIX-32-P8:       # %bb.0: # %entry
; CHECK-AIX-32-P8-NEXT:    lhzx r4, 0, r3
; CHECK-AIX-32-P8-NEXT:    lhzx r3, 0, r3
; CHECK-AIX-32-P8-NEXT:    mtvsrwz v2, r4
; CHECK-AIX-32-P8-NEXT:    mtvsrwz v3, r3
; CHECK-AIX-32-P8-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-32-P8-NEXT:    vsplth v3, v3, 3
; CHECK-AIX-32-P8-NEXT:    xxmrghw vs0, v2, v3
; CHECK-AIX-32-P8-NEXT:    stxvw4x vs0, 0, r3
; CHECK-AIX-32-P8-NEXT:    blr
;
...
; CHECK-AIX-32-P9-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-32-P9-NEXT:    vsplth v3, v3, 3
; CHECK-AIX-32-P9-NEXT:    xxmrghw vs0, v2, v3
; CHECK-AIX-32-P9-NEXT:    stxv vs0, 0(r3)
; CHECK-AIX-32-P9-NEXT:    blr
entry:
  %0 = load <2 x i8>, ptr undef, align 1
...
; CHECK-LE-P8-NEXT:    mtvsrwz v2, r4
; CHECK-LE-P8-NEXT:    xxspltw vs0, vs0, 1
; CHECK-LE-P8-NEXT:    vsplth v2, v2, 3
; CHECK-LE-P8-NEXT:    xxmrglw vs0, vs0, v2
; CHECK-LE-P8-NEXT:    xxswapd vs0, vs0
; CHECK-LE-P8-NEXT:    stxvd2x vs0, 0, r3
...
; CHECK-LE-P9:       # %bb.0: # %entry
; CHECK-LE-P9-NEXT:    lxsihzx v2, 0, r3
; CHECK-LE-P9-NEXT:    lxvwsx vs0, 0, r3
; CHECK-LE-P9-NEXT:    vsplth v2, v2, 3
; CHECK-LE-P9-NEXT:    xxmrglw vs0, vs0, v2
; CHECK-LE-P9-NEXT:    stxv vs0, 0(r3)
; CHECK-LE-P9-NEXT:    blr
...
; CHECK-BE-P8-NEXT:    mtvsrwz v2, r4
; CHECK-BE-P8-NEXT:    xxspltw vs0, vs0, 1
; CHECK-BE-P8-NEXT:    vsplth v2, v2, 3
; CHECK-BE-P8-NEXT:    xxmrghw vs0, v2, vs0
; CHECK-BE-P8-NEXT:    stxvw4x vs0, 0, r3
; CHECK-BE-P8-NEXT:    blr
...
; CHECK-BE-P9:       # %bb.0: # %entry
; CHECK-BE-P9-NEXT:    lxsihzx v2, 0, r3
; CHECK-BE-P9-NEXT:    lxvwsx vs0, 0, r3
; CHECK-BE-P9-NEXT:    vsplth v2, v2, 3
; CHECK-BE-P9-NEXT:    xxmrghw vs0, v2, vs0
; CHECK-BE-P9-NEXT:    stxv vs0, 0(r3)
; CHECK-BE-P9-NEXT:    blr
...
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v2, r4
; CHECK-AIX-64-P8-NEXT:    xxspltw vs0, vs0, 1
; CHECK-AIX-64-P8-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-64-P8-NEXT:    xxmrghw vs0, v2, vs0
; CHECK-AIX-64-P8-NEXT:    stxvw4x vs0, 0, r3
; CHECK-AIX-64-P8-NEXT:    blr
...
; CHECK-AIX-64-P9:       # %bb.0: # %entry
; CHECK-AIX-64-P9-NEXT:    lxsihzx v2, 0, r3
; CHECK-AIX-64-P9-NEXT:    lxvwsx vs0, 0, r3
; CHECK-AIX-64-P9-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-64-P9-NEXT:    xxmrghw vs0, v2, vs0
; CHECK-AIX-64-P9-NEXT:    stxv vs0, 0(r3)
; CHECK-AIX-64-P9-NEXT:    blr
...
; CHECK-AIX-32-P8-NEXT:    xxmrghd v2, vs0, vs0
; CHECK-AIX-32-P8-NEXT:    blr
;
; CHECK-AIX-32-P9-LABEL: test_v4i32_v4i32:
; CHECK-AIX-32-P9:       # %bb.0: # %entry
; CHECK-AIX-32-P9-NEXT:    lxvwsx vs0, 0, r4
; CHECK-AIX-32-P9-NEXT:    lxvwsx vs1, 0, r3
; CHECK-AIX-32-P9-NEXT:    xxmrghw vs0, vs1, vs0
; CHECK-AIX-32-P9-NEXT:    xxmrghd v2, vs0, vs0
; CHECK-AIX-32-P9-NEXT:    blr
entry:
...
; CHECK-LE-P8-NEXT:    xxspltw vs0, vs0, 1
; CHECK-LE-P8-NEXT:    vsplth v2, v2, 3
; CHECK-LE-P8-NEXT:    xxmrglw vs0, v2, vs0
; CHECK-LE-P8-NEXT:    xxswapd vs0, vs0
; CHECK-LE-P8-NEXT:    stxvd2x vs0, 0, r3
; CHECK-LE-P8-NEXT:    blr
;
...
; CHECK-AIX-32-P8-NEXT:    xxspltw vs0, vs0, 1
; CHECK-AIX-32-P8-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-32-P8-NEXT:    xxmrghw vs0, vs0, v2
; CHECK-AIX-32-P8-NEXT:    stxvw4x vs0, 0, r3
; CHECK-AIX-32-P8-NEXT:    blr
;
...
; CHECK-AIX-32-P9-NEXT:    lxvwsx vs0, 0, r3
; CHECK-AIX-32-P9-NEXT:    vsplth v2, v2, 3
; CHECK-AIX-32-P9-NEXT:    xxmrghw vs0, vs0, v2
; CHECK-AIX-32-P9-NEXT:    stxv vs0, 0(r3)
; CHECK-AIX-32-P9-NEXT:    blr
entry:
  %0 = load <2 x i8>, ptr undef, align 1
...
; CHECK-AIX-32-P9-NEXT:    xxmrghw vs0, vs1, vs0
; CHECK-AIX-32-P9-NEXT:    xxmrghw vs1, vs1, vs2
; CHECK-AIX-32-P9-NEXT:    xxmrghd vs0, vs1, vs0
; CHECK-AIX-32-P9-NEXT:    stxv vs0, 0(r3)
; CHECK-AIX-32-P9-NEXT:    blr
entry:
