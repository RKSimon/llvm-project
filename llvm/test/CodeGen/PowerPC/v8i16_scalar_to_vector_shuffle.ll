...
; CHECK-BE-P9-NEXT:    xxperm v3, v2, vs0
; CHECK-BE-P9-NEXT:    stxv v3, 0(r3)
...
; CHECK-AIX-64-P9-NEXT:    xxperm v3, v2, vs0
; CHECK-AIX-64-P9-NEXT:    stxv v3, 0(r3)
...
; CHECK-AIX-32-P9-NEXT:    xxperm v3, v2, vs0
; CHECK-AIX-32-P9-NEXT:    stxv v3, 0(r3)
...
; CHECK-LE-P8-NEXT:    mtvsrwz v5, r3
; CHECK-LE-P8-NEXT:    addis r3, r2, .LCPI1_1@toc@ha
; CHECK-LE-P8-NEXT:    lxvd2x vs0, 0, r4
; CHECK-LE-P8-NEXT:    addi r3, r3, .LCPI1_1@toc@l
; CHECK-LE-P8-NEXT:    vsplth v5, v5, 3
; CHECK-LE-P8-NEXT:    xxswapd v3, vs0
; CHECK-LE-P8-NEXT:    lxvd2x vs0, 0, r3
; CHECK-LE-P8-NEXT:    vperm v2, v2, v4, v3
; CHECK-LE-P8-NEXT:    xxswapd v3, vs0
; CHECK-LE-P8-NEXT:    vperm v2, v2, v5, v3
; CHECK-LE-P8-NEXT:    xxswapd vs0, v2
; CHECK-LE-P8-NEXT:    stxvd2x vs0, 0, r3
; CHECK-LE-P8-NEXT:    blr
;
...
; CHECK-LE-P9-NEXT:    lxv vs0, 0(r3)
; CHECK-LE-P9-NEXT:    vsplth v3, v3, 3
; CHECK-LE-P9-NEXT:    xxperm v3, v2, vs0
; CHECK-LE-P9-NEXT:    stxv v3, 0(r3)
; CHECK-LE-P9-NEXT:    blr
;
; CHECK-BE-P8-LABEL: test_v8i16_none:
; CHECK-BE-P8:       # %bb.0: # %entry
; CHECK-BE-P8-NEXT:    lhzx r3, 0, r3
; CHECK-BE-P8-NEXT:    mtvsrwz v5, r9
; CHECK-BE-P8-NEXT:    mtvsrwz v3, r3
...
; CHECK-BE-P8-NEXT:    vsplth v3, v3, 3
; CHECK-BE-P8-NEXT:    vperm v2, v5, v2, v4
; CHECK-BE-P8-NEXT:    lxvw4x v4, 0, r3
...
; CHECK-BE-P9-NEXT:    lxv vs0, 0(r3)
; CHECK-BE-P9-NEXT:    vsplth v3, v3, 3
; CHECK-BE-P9-NEXT:    xxperm v2, v3, vs0
...
; CHECK-AIX-64-P9-NEXT:    lxv vs0, 0(r3)
; CHECK-AIX-64-P9-NEXT:    vsplth v3, v3, 3
; CHECK-AIX-64-P9-NEXT:    xxperm v2, v3, vs0
...
; CHECK-AIX-32-P8:       # %bb.0: # %entry
; CHECK-AIX-32-P8-NEXT:    lhzx r3, 0, r3
; CHECK-AIX-32-P8-NEXT:    mtvsrwz v5, r5
; CHECK-AIX-32-P8-NEXT:    mtvsrwz v3, r3
...
; CHECK-BE-P9:       # %bb.0: # %entry
; CHECK-BE-P9-NEXT:    addis r5, r2, .LCPI7_0@toc@ha
; CHECK-BE-P9-NEXT:    lxsihzx v2, 0, r4
; CHECK-BE-P9-NEXT:    lxsihzx f1, 0, r3
; CHECK-BE-P9-NEXT:    addi r5, r5, .LCPI7_0@toc@l
...
; CHECK-AIX-64-P9:       # %bb.0: # %entry
; CHECK-AIX-64-P9-NEXT:    ld r5, L..C7(r2) # %const.0
; CHECK-AIX-64-P9-NEXT:    lxsihzx v2, 0, r4
...
; CHECK-AIX-32-P9-NEXT:    lhz r4, 0(r4)
...
; CHECK-BE-P9:       # %bb.0: # %entry
; CHECK-BE-P9-NEXT:    addis r5, r2, .LCPI8_0@toc@ha
; CHECK-BE-P9-NEXT:    lxsihzx v2, 0, r4
; CHECK-BE-P9-NEXT:    lxsihzx f1, 0, r3
; CHECK-BE-P9-NEXT:    addi r5, r5, .LCPI8_0@toc@l
; CHECK-BE-P9-NEXT:    lxv vs0, 0(r5)
; CHECK-BE-P9-NEXT:    xxperm v2, vs1, vs0
; CHECK-BE-P9-NEXT:    blr
;
...
; CHECK-LE-P9:       # %bb.0: # %entry
; CHECK-LE-P9-NEXT:    lxsihzx v2, 0, r4
; CHECK-LE-P9-NEXT:    lxsihzx v3, 0, r3
; CHECK-LE-P9-NEXT:    vmrghh v2, v3, v2
; CHECK-LE-P9-NEXT:    blr
;
...
; CHECK-BE-P8-NEXT:    lhz r3, 0(r3)
; CHECK-BE-P8-NEXT:    lhz r4, 0(r4)
; CHECK-BE-P8-NEXT:    addi r5, r5, .LCPI10_0@toc@l
; CHECK-BE-P8-NEXT:    mtvsrwz v3, r3
...
; CHECK-BE-P9:       # %bb.0: # %entry
; CHECK-BE-P9-NEXT:    addis r5, r2, .LCPI10_0@toc@ha
; CHECK-BE-P9-NEXT:    lxsihzx v2, 0, r3
; CHECK-BE-P9-NEXT:    lxsihzx f1, 0, r4
; CHECK-BE-P9-NEXT:    addi r5, r5, .LCPI10_0@toc@l
; CHECK-BE-P9-NEXT:    lxv vs0, 0(r5)
; CHECK-BE-P9-NEXT:    xxperm v2, vs1, vs0
; CHECK-BE-P9-NEXT:    blr
;
...
; CHECK-AIX-64-P9:       # %bb.0: # %entry
; CHECK-AIX-64-P9-NEXT:    ld r5, L..C10(r2) # %const.0
; CHECK-AIX-64-P9-NEXT:    lxsihzx v2, 0, r3
; CHECK-AIX-64-P9-NEXT:    lxsihzx f1, 0, r4
; CHECK-AIX-64-P9-NEXT:    lxv vs0, 0(r5)
; CHECK-AIX-64-P9-NEXT:    xxperm v2, vs1, vs0
; CHECK-AIX-64-P9-NEXT:    blr
;
...
; CHECK-BE-P8:       # %bb.0: # %entry
; CHECK-BE-P8-NEXT:    addis r5, r2, .LCPI11_0@toc@ha
; CHECK-BE-P8-NEXT:    lhz r3, 0(r3)
; CHECK-BE-P8-NEXT:    lhz r4, 0(r4)
; CHECK-BE-P8-NEXT:    addi r5, r5, .LCPI11_0@toc@l
; CHECK-BE-P8-NEXT:    mtvsrwz v3, r4
; CHECK-BE-P8-NEXT:    mtvsrwz v4, r3
; CHECK-BE-P8-NEXT:    lxvw4x v2, 0, r5
; CHECK-BE-P8-NEXT:    vperm v2, v4, v3, v2
...
; CHECK-BE-P9:       # %bb.0: # %entry
; CHECK-BE-P9-NEXT:    addis r5, r2, .LCPI11_0@toc@ha
; CHECK-BE-P9-NEXT:    lxsihzx v2, 0, r4
; CHECK-BE-P9-NEXT:    lxsihzx f1, 0, r3
; CHECK-BE-P9-NEXT:    addi r5, r5, .LCPI11_0@toc@l
; CHECK-BE-P9-NEXT:    lxv vs0, 0(r5)
; CHECK-BE-P9-NEXT:    xxperm v2, vs1, vs0
; CHECK-BE-P9-NEXT:    blr
;
...
; CHECK-AIX-64-P9:       # %bb.0: # %entry
; CHECK-AIX-64-P9-NEXT:    ld r5, L..C11(r2) # %const.0
; CHECK-AIX-64-P9-NEXT:    lxsihzx v2, 0, r4
; CHECK-AIX-64-P9-NEXT:    lxsihzx f1, 0, r3
; CHECK-AIX-64-P9-NEXT:    lxv vs0, 0(r5)
; CHECK-AIX-64-P9-NEXT:    xxperm v2, vs1, vs0
...
; CHECK-AIX-64-P9:       # %bb.0: # %entry
; CHECK-AIX-64-P9-NEXT:    lxsd v2, 0(r3)
; CHECK-AIX-64-P9-NEXT:    ld r3, L..C12(r2) # %const.0
...
; CHECK-BE-P8:       # %bb.0: # %entry
; CHECK-BE-P8-NEXT:    addis r5, r2, .LCPI13_0@toc@ha
; CHECK-BE-P8-NEXT:    lhz r3, 0(r3)
; CHECK-BE-P8-NEXT:    lhz r4, 0(r4)
; CHECK-BE-P8-NEXT:    addi r5, r5, .LCPI13_0@toc@l
; CHECK-BE-P8-NEXT:    mtvsrwz v3, r3
; CHECK-BE-P8-NEXT:    mtvsrwz v4, r4
; CHECK-BE-P8-NEXT:    lxvw4x v2, 0, r5
; CHECK-BE-P8-NEXT:    vperm v2, v4, v3, v2
...
; CHECK-BE-P9:       # %bb.0: # %entry
; CHECK-BE-P9-NEXT:    addis r5, r2, .LCPI13_0@toc@ha
; CHECK-BE-P9-NEXT:    lxsihzx v2, 0, r3
; CHECK-BE-P9-NEXT:    lxsihzx f1, 0, r4
; CHECK-BE-P9-NEXT:    addi r5, r5, .LCPI13_0@toc@l
; CHECK-BE-P9-NEXT:    lxv vs0, 0(r5)
; CHECK-BE-P9-NEXT:    xxperm v2, vs1, vs0
; CHECK-BE-P9-NEXT:    blr
;
...
; CHECK-AIX-64-P9:       # %bb.0: # %entry
; CHECK-AIX-64-P9-NEXT:    ld r5, L..C13(r2) # %const.0
; CHECK-AIX-64-P9-NEXT:    lxsihzx v2, 0, r3
; CHECK-AIX-64-P9-NEXT:    lxsihzx f1, 0, r4
; CHECK-AIX-64-P9-NEXT:    lxv vs0, 0(r5)
; CHECK-AIX-64-P9-NEXT:    xxperm v2, vs1, vs0
...
; CHECK-BE-P8:       # %bb.0: # %entry
; CHECK-BE-P8-NEXT:    addis r5, r2, .LCPI14_0@toc@ha
; CHECK-BE-P8-NEXT:    lhz r3, 0(r3)
; CHECK-BE-P8-NEXT:    lhz r4, 0(r4)
; CHECK-BE-P8-NEXT:    addi r5, r5, .LCPI14_0@toc@l
; CHECK-BE-P8-NEXT:    mtvsrwz v3, r3
; CHECK-BE-P8-NEXT:    mtvsrwz v4, r4
; CHECK-BE-P8-NEXT:    lxvw4x v2, 0, r5
; CHECK-BE-P8-NEXT:    vperm v2, v4, v3, v2
...
; CHECK-BE-P9:       # %bb.0: # %entry
; CHECK-BE-P9-NEXT:    addis r5, r2, .LCPI14_0@toc@ha
; CHECK-BE-P9-NEXT:    lxsihzx v2, 0, r3
; CHECK-BE-P9-NEXT:    lxsihzx f1, 0, r4
; CHECK-BE-P9-NEXT:    addi r5, r5, .LCPI14_0@toc@l
; CHECK-BE-P9-NEXT:    lxv vs0, 0(r5)
; CHECK-BE-P9-NEXT:    xxperm v2, vs1, vs0
; CHECK-BE-P9-NEXT:    blr
;
...
; CHECK-AIX-64-P9:       # %bb.0: # %entry
; CHECK-AIX-64-P9-NEXT:    ld r5, L..C14(r2) # %const.0
; CHECK-AIX-64-P9-NEXT:    lxsihzx v2, 0, r3
; CHECK-AIX-64-P9-NEXT:    lxsihzx f1, 0, r4
; CHECK-AIX-64-P9-NEXT:    lxv vs0, 0(r5)
; CHECK-AIX-64-P9-NEXT:    xxperm v2, vs1, vs0
