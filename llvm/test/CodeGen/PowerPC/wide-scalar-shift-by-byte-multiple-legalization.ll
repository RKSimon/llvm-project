...
; LE-32BIT-NEXT:    rlwinm 7, 4, 3, 27, 28
; LE-32BIT-NEXT:    lwz 6, 8(3)
; LE-32BIT-NEXT:    slwi 4, 4, 3
; LE-32BIT-NEXT:    lwz 8, 4(3)
; LE-32BIT-NEXT:    subfic 9, 7, 32
; LE-32BIT-NEXT:    lwz 10, 0(3)
; LE-32BIT-NEXT:    not 4, 4
; LE-32BIT-NEXT:    lwz 3, 12(3)
; LE-32BIT-NEXT:    srw 11, 6, 7
; LE-32BIT-NEXT:    slw 6, 6, 9
; LE-32BIT-NEXT:    clrlwi 4, 4, 27
; LE-32BIT-NEXT:    srw 3, 3, 7
; LE-32BIT-NEXT:    slw 9, 10, 9
; LE-32BIT-NEXT:    srw 10, 10, 7
; LE-32BIT-NEXT:    srw 7, 8, 7
; LE-32BIT-NEXT:    slwi 8, 8, 1
; LE-32BIT-NEXT:    or 3, 6, 3
; LE-32BIT-NEXT:    slw 4, 8, 4
; LE-32BIT-NEXT:    stw 3, 12(5)
; LE-32BIT-NEXT:    or 3, 9, 7
; LE-32BIT-NEXT:    stw 3, 4(5)
; LE-32BIT-NEXT:    or 3, 11, 4
; LE-32BIT-NEXT:    stw 10, 0(5)
...
; LE-32BIT-NEXT:    clrlwi 4, 4, 27
; LE-32BIT-NEXT:    lwz 10, 8(6)
; LE-32BIT-NEXT:    slw 3, 3, 7
; LE-32BIT-NEXT:    lwz 6, 12(6)
; LE-32BIT-NEXT:    slw 11, 8, 7
; LE-32BIT-NEXT:    srw 8, 8, 9
; LE-32BIT-NEXT:    or 3, 3, 8
; LE-32BIT-NEXT:    srw 9, 6, 9
; LE-32BIT-NEXT:    slw 6, 6, 7
; LE-32BIT-NEXT:    slw 7, 10, 7
; LE-32BIT-NEXT:    srwi 10, 10, 1
; LE-32BIT-NEXT:    srw 4, 10, 4
; LE-32BIT-NEXT:    stw 6, 12(5)
; LE-32BIT-NEXT:    or 6, 7, 9
; LE-32BIT-NEXT:    stw 3, 0(5)
; LE-32BIT-NEXT:    or 3, 11, 4
; LE-32BIT-NEXT:    stw 6, 8(5)
; LE-32BIT-NEXT:    stw 3, 4(5)
; LE-32BIT-NEXT:    addi 1, 1, 48
; LE-32BIT-NEXT:    blr
  %src = load i128, ptr %src.ptr, align 1
...
; LE-32BIT-NEXT:    stw 9, 40(1)
; LE-32BIT-NEXT:    stw 8, 36(1)
; LE-32BIT-NEXT:    rlwinm 8, 4, 3, 27, 28
; LE-32BIT-NEXT:    stw 3, 28(1)
; LE-32BIT-NEXT:    slwi 4, 4, 3
; LE-32BIT-NEXT:    stw 3, 24(1)
; LE-32BIT-NEXT:    subfic 9, 8, 32
...
; LE-32BIT-NEXT:    lwz 10, 0(3)
; LE-32BIT-NEXT:    srw 11, 6, 8
; LE-32BIT-NEXT:    lwz 3, 12(3)
; LE-32BIT-NEXT:    slw 6, 6, 9
; LE-32BIT-NEXT:    slw 9, 10, 9
; LE-32BIT-NEXT:    sraw 10, 10, 8
; LE-32BIT-NEXT:    srw 3, 3, 8
; LE-32BIT-NEXT:    srw 8, 7, 8
; LE-32BIT-NEXT:    slwi 7, 7, 1
; LE-32BIT-NEXT:    or 3, 6, 3
; LE-32BIT-NEXT:    slw 4, 7, 4
; LE-32BIT-NEXT:    stw 3, 12(5)
...
; LE-32BIT-NEXT:    rlwinm 9, 4, 3, 27, 28
; LE-32BIT-NEXT:    stw 8, 52(1)
; LE-32BIT-NEXT:    subfic 0, 9, 32
...
; LE-32BIT-NEXT:    srw 29, 6, 9
; LE-32BIT-NEXT:    lwz 10, 12(3)
; LE-32BIT-NEXT:    slwi 28, 7, 1
; LE-32BIT-NEXT:    lwz 11, 24(3)
; LE-32BIT-NEXT:    srw 27, 8, 9
; LE-32BIT-NEXT:    lwz 12, 20(3)
; LE-32BIT-NEXT:    slwi 26, 10, 1
; LE-32BIT-NEXT:    lwz 30, 0(3)
; LE-32BIT-NEXT:    srw 25, 11, 9
; LE-32BIT-NEXT:    lwz 3, 28(3)
; LE-32BIT-NEXT:    slw 11, 11, 0
; LE-32BIT-NEXT:    srw 7, 7, 9
; LE-32BIT-NEXT:    slw 6, 6, 0
; LE-32BIT-NEXT:    srw 3, 3, 9
; LE-32BIT-NEXT:    slw 8, 8, 0
; LE-32BIT-NEXT:    slw 0, 30, 0
; LE-32BIT-NEXT:    srw 10, 10, 9
; LE-32BIT-NEXT:    srw 30, 30, 9
; LE-32BIT-NEXT:    srw 9, 12, 9
; LE-32BIT-NEXT:    or 3, 11, 3
; LE-32BIT-NEXT:    stw 3, 28(5)
; LE-32BIT-NEXT:    or 3, 8, 9
; LE-32BIT-NEXT:    slwi 12, 12, 1
; LE-32BIT-NEXT:    stw 3, 20(5)
; LE-32BIT-NEXT:    or 3, 6, 10
; LE-32BIT-NEXT:    slw 28, 28, 4
; LE-32BIT-NEXT:    slw 26, 26, 4
; LE-32BIT-NEXT:    slw 4, 12, 4
; LE-32BIT-NEXT:    stw 3, 12(5)
; LE-32BIT-NEXT:    or 3, 0, 7
; LE-32BIT-NEXT:    stw 3, 4(5)
; LE-32BIT-NEXT:    or 3, 25, 4
; LE-32BIT-NEXT:    stw 3, 24(5)
; LE-32BIT-NEXT:    or 3, 27, 26
; LE-32BIT-NEXT:    stw 3, 16(5)
; LE-32BIT-NEXT:    or 3, 29, 28
; LE-32BIT-NEXT:    stw 30, 0(5)
; LE-32BIT-NEXT:    stw 3, 8(5)
...
; LE-32BIT-NEXT:    lwz 11, 28(3)
; LE-32BIT-NEXT:    lwz 3, 24(3)
; LE-32BIT-NEXT:    stw 11, 28(5)
; LE-32BIT-NEXT:    stw 3, 24(5)
; LE-32BIT-NEXT:    stw 10, 20(5)
; LE-32BIT-NEXT:    stw 9, 16(5)
; LE-32BIT-NEXT:    stw 8, 12(5)
; LE-32BIT-NEXT:    stw 7, 8(5)
; LE-32BIT-NEXT:    stw 6, 4(5)
; LE-32BIT-NEXT:    stw 4, 0(5)
...
; LE-64BIT-NEXT:    slwi 6, 4, 3
; LE-64BIT-NEXT:    rlwinm 4, 4, 3, 26, 28
; LE-64BIT-NEXT:    extsw 3, 3
; LE-64BIT-NEXT:    stxvd2x 0, 7, 8
; LE-64BIT-NEXT:    not 6, 6
; LE-64BIT-NEXT:    subfic 8, 4, 64
; LE-64BIT-NEXT:    ldux 3, 9, 3
; LE-64BIT-NEXT:    clrlwi 6, 6, 26
; LE-64BIT-NEXT:    ld 7, 8(9)
; LE-64BIT-NEXT:    ld 10, 16(9)
; LE-64BIT-NEXT:    ld 9, 24(9)
; LE-64BIT-NEXT:    rldicl 11, 7, 63, 1
; LE-64BIT-NEXT:    sld 7, 7, 4
; LE-64BIT-NEXT:    sld 9, 9, 4
; LE-64BIT-NEXT:    srd 6, 11, 6
; LE-64BIT-NEXT:    sld 11, 10, 4
; LE-64BIT-NEXT:    or 6, 11, 6
; LE-64BIT-NEXT:    srd 11, 3, 8
; LE-64BIT-NEXT:    srd 8, 10, 8
; LE-64BIT-NEXT:    sld 3, 3, 4
; LE-64BIT-NEXT:    or 8, 9, 8
; LE-64BIT-NEXT:    std 3, 0(5)
...
; BE-NEXT:    rlwinm 3, 4, 0, 27, 28
; BE-NEXT:    ldux 6, 3, 10
; BE-NEXT:    rlwinm 7, 4, 3, 26, 28
; BE-NEXT:    slwi 4, 4, 3
; BE-NEXT:    not 4, 4
; BE-NEXT:    subfic 10, 7, 64
; BE-NEXT:    ld 8, 16(3)
; BE-NEXT:    ld 9, 8(3)
; BE-NEXT:    ld 3, 24(3)
; BE-NEXT:    clrlwi 4, 4, 26
...
; LE-32BIT-NEXT:    lwzux 3, 6, 3
; LE-32BIT-NEXT:    not 4, 4
; LE-32BIT-NEXT:    subfic 12, 8, 32
; LE-32BIT-NEXT:    clrlwi 4, 4, 27
; LE-32BIT-NEXT:    lwz 7, 4(6)
; LE-32BIT-NEXT:    slw 3, 3, 8
; LE-32BIT-NEXT:    lwz 9, 8(6)
; LE-32BIT-NEXT:    lwz 10, 12(6)
; LE-32BIT-NEXT:    slw 29, 7, 8
; LE-32BIT-NEXT:    lwz 11, 16(6)
; LE-32BIT-NEXT:    srwi 28, 9, 1
; LE-32BIT-NEXT:    lwz 0, 20(6)
; LE-32BIT-NEXT:    slw 27, 10, 8
; LE-32BIT-NEXT:    lwz 30, 24(6)
; LE-32BIT-NEXT:    srwi 26, 11, 1
; LE-32BIT-NEXT:    lwz 6, 28(6)
; LE-32BIT-NEXT:    slw 25, 0, 8
; LE-32BIT-NEXT:    srw 7, 7, 12
; LE-32BIT-NEXT:    srw 10, 10, 12
; LE-32BIT-NEXT:    slw 9, 9, 8
; LE-32BIT-NEXT:    srw 0, 0, 12
; LE-32BIT-NEXT:    slw 11, 11, 8
; LE-32BIT-NEXT:    srw 12, 6, 12
; LE-32BIT-NEXT:    slw 6, 6, 8
; LE-32BIT-NEXT:    slw 8, 30, 8
; LE-32BIT-NEXT:    srwi 30, 30, 1
; LE-32BIT-NEXT:    srw 28, 28, 4
; LE-32BIT-NEXT:    srw 26, 26, 4
; LE-32BIT-NEXT:    srw 4, 30, 4
; LE-32BIT-NEXT:    or 3, 3, 7
; LE-32BIT-NEXT:    stw 6, 28(5)
; LE-32BIT-NEXT:    or 6, 8, 12
; LE-32BIT-NEXT:    stw 3, 0(5)
; LE-32BIT-NEXT:    or 3, 25, 4
; LE-32BIT-NEXT:    stw 6, 24(5)
; LE-32BIT-NEXT:    or 6, 11, 0
; LE-32BIT-NEXT:    stw 3, 20(5)
; LE-32BIT-NEXT:    or 3, 27, 26
; LE-32BIT-NEXT:    stw 6, 16(5)
; LE-32BIT-NEXT:    or 6, 9, 10
; LE-32BIT-NEXT:    stw 3, 12(5)
; LE-32BIT-NEXT:    or 3, 29, 28
; LE-32BIT-NEXT:    stw 6, 8(5)
; LE-32BIT-NEXT:    stw 3, 4(5)
...
; LE-32BIT-NEXT:    lwz 6, 4(4)
; LE-32BIT-NEXT:    lwz 7, 8(4)
; LE-32BIT-NEXT:    lwz 8, 12(4)
; LE-32BIT-NEXT:    lwz 9, 16(4)
; LE-32BIT-NEXT:    lwz 10, 20(4)
