...
; CHECK-NEXT:    std 30, 168(1) # 8-byte Folded Spill
; CHECK-NEXT:    std 27, 176(1) # 8-byte Folded Spill
...
; CHECK-NEXT:    xvmaddadp 5, 45, 35
; CHECK-NEXT:    lxvp 46, 0(30)
; CHECK-NEXT:    xvmaddadp 4, 47, 35
...
; CHECK-NEXT:    xvmaddadp 3, 49, 35
; CHECK-NEXT:    xvmaddadp 2, 51, 35
; CHECK-NEXT:    xvmaddadp 1, 63, 35
; CHECK-NEXT:    xvmaddadp 0, 61, 35
; CHECK-NEXT:    xvmaddadp 39, 44, 34
; CHECK-NEXT:    xvmaddadp 38, 46, 34
; CHECK-NEXT:    xvmaddadp 33, 48, 34
; CHECK-NEXT:    xvmaddadp 32, 50, 34
; CHECK-NEXT:    xvmaddadp 37, 62, 34
; CHECK-NEXT:    xvmaddadp 36, 60, 34
; CHECK-NEXT:    xvmaddadp 13, 57, 59
; CHECK-NEXT:    xvmaddadp 12, 55, 59
; CHECK-NEXT:    xvmaddadp 11, 53, 59
; CHECK-NEXT:    xvmaddadp 10, 31, 59
; CHECK-NEXT:    xvmaddadp 9, 29, 59
; CHECK-NEXT:    xvmaddadp 8, 27, 59
; CHECK-NEXT:    xvmaddadp 7, 56, 58
; CHECK-NEXT:    xvmaddadp 6, 54, 58
