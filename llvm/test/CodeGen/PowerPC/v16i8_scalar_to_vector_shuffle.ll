...
; CHECK-LE-P8-NEXT:    lbzx r3, 0, r4
; CHECK-LE-P8-NEXT:    mtvsrwz v3, r3
; CHECK-LE-P8-NEXT:    xxspltw v2, vs0, 1
; CHECK-LE-P8-NEXT:    vspltb v3, v3, 7
...
; CHECK-LE-P9:       # %bb.0: # %entry
; CHECK-LE-P9-NEXT:    lxsibzx v3, 0, r4
; CHECK-LE-P9-NEXT:    lxvwsx v2, 0, r3
...
; CHECK-BE-P8-NEXT:    lbzx r3, 0, r4
; CHECK-BE-P8-NEXT:    mtvsrwz v3, r3
; CHECK-BE-P8-NEXT:    xxspltw v2, vs0, 1
; CHECK-BE-P8-NEXT:    vspltb v3, v3, 7
...
; CHECK-BE-P9-NEXT:    lxvwsx v2, 0, r3
...
; CHECK-AIX-64-P8-NEXT:    lbzx r3, 0, r4
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v3, r3
; CHECK-AIX-64-P8-NEXT:    xxspltw v2, vs0, 1
; CHECK-AIX-64-P8-NEXT:    vspltb v3, v3, 7
...
; CHECK-AIX-64-P9-NEXT:    lxvwsx v2, 0, r3
...
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v2, r3
; CHECK-AIX-64-P8-NEXT:    lhzx r3, 0, r4
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v3, r3
...
; CHECK-AIX-32-P8-NEXT:    lhzx r3, 0, r4
; CHECK-AIX-32-P8-NEXT:    mtvsrwz v3, r3
...
; CHECK-LE-P8-NEXT:    lxvdsx v3, 0, r3
...
; CHECK-LE-P9:       # %bb.0: # %entry
; CHECK-LE-P9-NEXT:    lxvdsx v2, 0, r3
; CHECK-LE-P9-NEXT:    lxsibzx v3, 0, r4
; CHECK-LE-P9-NEXT:    vspltb v3, v3, 7
; CHECK-LE-P9-NEXT:    vmrglh v2, v3, v2
; CHECK-LE-P9-NEXT:    blr
...
; CHECK-BE-P8-NEXT:    lxvdsx v3, 0, r3
; CHECK-BE-P8-NEXT:    mtvsrwz v2, r4
; CHECK-BE-P8-NEXT:    vspltb v2, v2, 7
; CHECK-BE-P8-NEXT:    vmrghh v2, v3, v2
; CHECK-BE-P8-NEXT:    blr
...
; CHECK-BE-P9:       # %bb.0: # %entry
; CHECK-BE-P9-NEXT:    lxvdsx v2, 0, r3
; CHECK-BE-P9-NEXT:    lxsibzx v3, 0, r4
; CHECK-BE-P9-NEXT:    vspltb v3, v3, 7
; CHECK-BE-P9-NEXT:    vmrghh v2, v2, v3
; CHECK-BE-P9-NEXT:    blr
...
; CHECK-AIX-64-P8-NEXT:    lxvdsx v3, 0, r3
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v2, r4
; CHECK-AIX-64-P8-NEXT:    vspltb v2, v2, 7
; CHECK-AIX-64-P8-NEXT:    vmrghh v2, v3, v2
; CHECK-AIX-64-P8-NEXT:    blr
...
; CHECK-AIX-64-P9:       # %bb.0: # %entry
; CHECK-AIX-64-P9-NEXT:    lxvdsx v2, 0, r3
; CHECK-AIX-64-P9-NEXT:    lxsibzx v3, 0, r4
; CHECK-AIX-64-P9-NEXT:    vspltb v3, v3, 7
; CHECK-AIX-64-P9-NEXT:    vmrghh v2, v2, v3
; CHECK-AIX-64-P9-NEXT:    blr
...
; CHECK-AIX-64-P8:       # %bb.0: # %entry
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v2, r3
; CHECK-AIX-64-P8-NEXT:    ld r3, L..C12(r2) # %const.0
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v3, r4
; CHECK-AIX-64-P8-NEXT:    lxvw4x v4, 0, r3
; CHECK-AIX-64-P8-NEXT:    vperm v2, v2, v3, v4
; CHECK-AIX-64-P8-NEXT:    blr
...
; CHECK-AIX-64-P8:       # %bb.0: # %entry
; CHECK-AIX-64-P8-NEXT:    lhzx r4, 0, r4
; CHECK-AIX-64-P8-NEXT:    lxvdsx v3, 0, r3
; CHECK-AIX-64-P8-NEXT:    mtvsrwz v2, r4
...
; CHECK-LE-P8-NEXT:    lxvdsx v4, 0, r4
...
; CHECK-LE-P9-NEXT:    lxvdsx v3, 0, r4
...
; CHECK-BE-P8-NEXT:    lxvdsx v3, 0, r4
...
; CHECK-AIX-64-P8-NEXT:    lxvdsx v3, 0, r4
; CHECK-AIX-64-P8-NEXT:    lxvw4x v4, 0, r3
; CHECK-AIX-64-P8-NEXT:    xxspltw v2, vs0, 1
; CHECK-AIX-64-P8-NEXT:    vperm v2, v2, v3, v4
; CHECK-AIX-64-P8-NEXT:    blr
...
; CHECK-AIX-32-P8-NEXT:    xxspltw v2, vs2, 1
