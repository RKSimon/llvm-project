...
; CHECK-ASM-NEXT:    lis 3, 16256
; CHECK-ASM-NEXT:    stfd 27, -40(1) # 8-byte Folded Spill
; CHECK-ASM-NEXT:    li 4, 123
; CHECK-ASM-NEXT:    stfd 28, -32(1) # 8-byte Folded Spill
; CHECK-ASM-NEXT:    stfd 29, -24(1) # 8-byte Folded Spill
; CHECK-ASM-NEXT:    stfd 30, -16(1) # 8-byte Folded Spill
; CHECK-ASM-NEXT:    stfd 31, -8(1) # 8-byte Folded Spill
; CHECK-ASM-NEXT:    stw 3, -60(1)
; CHECK-ASM-NEXT:    #APP
; CHECK-ASM-NEXT:    fneg 3, 3
; CHECK-ASM-EMPTY:
; CHECK-ASM-NEXT:    #NO_APP
; CHECK-ASM-NEXT:    stw 28, -56(1) # 4-byte Folded Spill
; CHECK-ASM-NEXT:    stw 29, -52(1) # 4-byte Folded Spill
; CHECK-ASM-NEXT:    stw 30, -48(1) # 4-byte Folded Spill
; CHECK-ASM-NEXT:    stw 31, -44(1) # 4-byte Folded Spill
; CHECK-ASM-NEXT:    stw 4, -68(1)
; CHECK-ASM-NEXT:    stw 3, -60(1)
; CHECK-ASM-NEXT:    #APP
; CHECK-ASM-NEXT:    cntlzw 3, 4
; CHECK-ASM-EMPTY:
; CHECK-ASM-NEXT:    #NO_APP
; CHECK-ASM-NEXT:    lis 4, 17200
; CHECK-ASM-NEXT:    stw 4, -80(1)
; CHECK-ASM-NEXT:    lwz 4, L..C0(2) # %const.0
; CHECK-ASM-NEXT:    stw 3, -64(1)
; CHECK-ASM-NEXT:    xoris 3, 3, 32768
; CHECK-ASM-NEXT:    stw 3, -76(1)
; CHECK-ASM-NEXT:    lfs 0, 0(4)
; CHECK-ASM-NEXT:    lfd 1, -80(1)
; CHECK-ASM-NEXT:    fsub 0, 1, 0
; CHECK-ASM-NEXT:    lfs 1, -60(1)
; CHECK-ASM-NEXT:    frsp 0, 0
; CHECK-ASM-NEXT:    lfd 31, -8(1) # 8-byte Folded Reload
; CHECK-ASM-NEXT:    fadds 1, 0, 1
; CHECK-ASM-NEXT:    lfd 30, -16(1) # 8-byte Folded Reload
; CHECK-ASM-NEXT:    lfd 29, -24(1) # 8-byte Folded Reload
; CHECK-ASM-NEXT:    lfd 28, -32(1) # 8-byte Folded Reload
; CHECK-ASM-NEXT:    lfd 27, -40(1) # 8-byte Folded Reload
; CHECK-ASM-NEXT:    lwz 31, -44(1) # 4-byte Folded Reload
; CHECK-ASM-NEXT:    lwz 30, -48(1) # 4-byte Folded Reload
; CHECK-ASM-NEXT:    lwz 29, -52(1) # 4-byte Folded Reload
; CHECK-ASM-NEXT:    lwz 28, -56(1) # 4-byte Folded Reload
; CHECK-ASM-NEXT:    blr
entry:
...
; CHECK-ASM-LABEL: foov:
; CHECK-ASM:       # %bb.0: # %entry
; CHECK-ASM-NEXT:    li 3, -64
; CHECK-ASM-NEXT:    stvx 28, 1, 3 # 16-byte Folded Spill
; CHECK-ASM-NEXT:    li 3, -48
; CHECK-ASM-NEXT:    stvx 29, 1, 3 # 16-byte Folded Spill
; CHECK-ASM-NEXT:    li 3, -32
; CHECK-ASM-NEXT:    stvx 30, 1, 3 # 16-byte Folded Spill
; CHECK-ASM-NEXT:    li 3, -16
; CHECK-ASM-NEXT:    stvx 31, 1, 3 # 16-byte Folded Spill
; CHECK-ASM-NEXT:    lwz 3, L..C1(2) # %const.0
; CHECK-ASM-NEXT:    lvx 2, 0, 3
; CHECK-ASM-NEXT:    addi 3, 1, -96
; CHECK-ASM-NEXT:    stvx 2, 0, 3
; CHECK-ASM-NEXT:    addi 3, 1, -80
; CHECK-ASM-NEXT:    #APP
; CHECK-ASM-NEXT:    #NO_APP
; CHECK-ASM-NEXT:    lvx 2, 0, 3
; CHECK-ASM-NEXT:    li 3, -16
; CHECK-ASM-NEXT:    lvx 31, 1, 3 # 16-byte Folded Reload
; CHECK-ASM-NEXT:    li 3, -32
; CHECK-ASM-NEXT:    lvx 30, 1, 3 # 16-byte Folded Reload
; CHECK-ASM-NEXT:    li 3, -48
; CHECK-ASM-NEXT:    lvx 29, 1, 3 # 16-byte Folded Reload
; CHECK-ASM-NEXT:    li 3, -64
; CHECK-ASM-NEXT:    lvx 28, 1, 3 # 16-byte Folded Reload
; CHECK-ASM-NEXT:    blr
entry:
