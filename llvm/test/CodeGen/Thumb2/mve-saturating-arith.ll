...
; CHECK-NEXT:    subs r7, r3, r1
; CHECK-NEXT:    sbc.w r1, r2, lr
; CHECK-NEXT:    subs r3, r7, r3
; CHECK-NEXT:    vmov r3, r4, d3
; CHECK-NEXT:    sbcs.w r2, r1, r2
; CHECK-NEXT:    cset r2, lt
; CHECK-NEXT:    eor.w r2, r2, r12
; CHECK-NEXT:    rsbs r2, r2, #0
; CHECK-NEXT:    rsbs r5, r3, #0
; CHECK-NEXT:    sbcs.w r5, r0, r4
