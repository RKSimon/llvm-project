...
; CHECK-NEXT:    adc.w r1, r2, lr
; CHECK-NEXT:    adds r2, r0, r3
; CHECK-NEXT:    asr.w r6, r0, #31
; CHECK-NEXT:    vmov r0, s10
; CHECK-NEXT:    adc.w r3, r6, r4
; CHECK-NEXT:    asrs r6, r0, #31
; CHECK-NEXT:    adds r0, r0, r5
; CHECK-NEXT:    adc.w r5, r6, r7
; CHECK-NEXT:    vmov r7, s12
; CHECK-NEXT:    asrl r0, r5, r7
