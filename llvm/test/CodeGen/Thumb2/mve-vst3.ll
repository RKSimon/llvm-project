...
; CHECK-NEXT:    vmovx.f16 s11, s21
; CHECK-NEXT:    vins.f16 s1, s11
; CHECK-NEXT:    vmov.f32 s28, s20
; CHECK-NEXT:    vins.f16 s25, s24
...
; CHECK-NEXT:    vmovx.f16 s1, s12
; CHECK-NEXT:    vins.f16 s11, s5
...
; CHECK-NEXT:    vmov.f64 d1, d10
; CHECK-NEXT:    vstrw.32 q2, [r1, #16]
; CHECK-NEXT:    vmov.f64 d2, d11
; CHECK-NEXT:    vstrw.32 q0, [r1]
; CHECK-NEXT:    vmov.f64 d11, d7
; CHECK-NEXT:    vstrw.32 q1, [r1, #32]
; CHECK-NEXT:    vmov.f64 d10, d13
; CHECK-NEXT:    vmov.f64 d7, d9
...
; CHECK-NEXT:    vldr s0, [r0]
; CHECK-NEXT:    vldr s2, [r0, #16]
; CHECK-NEXT:    vldr s6, [r0, #8]
; CHECK-NEXT:    vmovx.f16 s4, s0
; CHECK-NEXT:    vmov.f32 s1, s2
; CHECK-NEXT:    vldr s3, [r0, #4]
; CHECK-NEXT:    vldr s8, [r0, #12]
; CHECK-NEXT:    vins.f16 s1, s4
; CHECK-NEXT:    vldr s10, [r0, #20]
...
; CHECK-NEXT:    vstr s4, [sp, #52] @ 4-byte Spill
...
; CHECK-NEXT:    vmov.f32 s4, s24
; CHECK-NEXT:    vstr s0, [sp, #48] @ 4-byte Spill
...
; CHECK-NEXT:    vmov.f32 s13, s26
; CHECK-NEXT:    vldrw.u32 q6, [sp, #32] @ 16-byte Reload
; CHECK-NEXT:    vmov.f32 s2, s4
; CHECK-NEXT:    vldrw.u32 q1, [sp, #16] @ 16-byte Reload
; CHECK-NEXT:    vins.f16 s13, s22
; CHECK-NEXT:    vmov.16 q5[2], r0
; CHECK-NEXT:    vldr s27, [sp, #52] @ 4-byte Reload
; CHECK-NEXT:    vins.f16 s21, s3
; CHECK-NEXT:    vldr s7, [sp, #48] @ 4-byte Reload
; CHECK-NEXT:    vmov.f32 s3, s14
