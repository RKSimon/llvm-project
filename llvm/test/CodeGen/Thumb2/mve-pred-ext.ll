...
; CHECK-MVE-NEXT:    rsb.w r2, lr, #0
; CHECK-MVE-NEXT:    cset r5, ne
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-MVE-NEXT:    vcmp.f16 s2, s6
; CHECK-MVE-NEXT:    vmovx.f16 s2, s7
; CHECK-MVE-NEXT:    vmovx.f16 s6, s3
; CHECK-MVE-NEXT:    rsb.w r5, r5, #0
; CHECK-MVE-NEXT:    cset r3, ne
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-MVE-NEXT:    vcmp.f16 s3, s7
; CHECK-MVE-NEXT:    rsb.w r3, r3, #0
; CHECK-MVE-NEXT:    cset r0, ne
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
...
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-MVE-NEXT:    rsb.w r7, r4, #0
; CHECK-MVE-NEXT:    rsb.w r4, r12, #0
; CHECK-MVE-NEXT:    vmov.16 q0[0], r4
; CHECK-MVE-NEXT:    cset r6, ne
; CHECK-MVE-NEXT:    rsbs r6, r6, #0
; CHECK-MVE-NEXT:    vmov.16 q0[1], r6
; CHECK-MVE-NEXT:    vmov.16 q0[2], r2
; CHECK-MVE-NEXT:    vmov.16 q0[3], r5
; CHECK-MVE-NEXT:    vmov.16 q0[4], r3
; CHECK-MVE-NEXT:    vmov.16 q0[5], r0
; CHECK-MVE-NEXT:    vmov.16 q0[6], r1
; CHECK-MVE-NEXT:    vmov.16 q0[7], r7
...
; CHECK-MVEFP-NEXT:    rsbs r0, r0, #0
; CHECK-MVEFP-NEXT:    rsbs r1, r1, #0
...
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-MVE-NEXT:    vcmp.f16 s0, s4
; CHECK-MVE-NEXT:    rsb.w r7, r1, #0
; CHECK-MVE-NEXT:    rsb.w r1, r12, #0
; CHECK-MVE-NEXT:    vmov.i16 q0, #0x1
; CHECK-MVE-NEXT:    cset r4, ne
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-MVE-NEXT:    rsb.w r4, r4, #0
; CHECK-MVE-NEXT:    cset r6, ne
; CHECK-MVE-NEXT:    rsbs r6, r6, #0
; CHECK-MVE-NEXT:    vmov.16 q1[0], r6
; CHECK-MVE-NEXT:    vmov.16 q1[1], r5
; CHECK-MVE-NEXT:    vmov.16 q1[2], r1
; CHECK-MVE-NEXT:    vmov.16 q1[3], r0
; CHECK-MVE-NEXT:    vmov.16 q1[4], r2
; CHECK-MVE-NEXT:    vmov.16 q1[5], r4
; CHECK-MVE-NEXT:    vmov.16 q1[6], r3
; CHECK-MVE-NEXT:    vmov.16 q1[7], r7
