...
; CHECK-NEXT:    vand q7, q2, q0
; CHECK-NEXT:    sub.w r12, r3, r12
; CHECK-NEXT:    vmov r3, r4, d10
; CHECK-NEXT:    subs r3, r5, r3
; CHECK-NEXT:    vmov q3[2], q3[0], r12, r3
; CHECK-NEXT:    sbcs.w r3, r6, r4
; CHECK-NEXT:    vmov r6, r5, d15
; CHECK-NEXT:    csetm r12, lt
; CHECK-NEXT:    vmov r4, r3, d3
; CHECK-NEXT:    subs r4, r4, r6
...
; CHECK-NEXT:    bfi r3, r9, #0, #4
; CHECK-NEXT:    sbcs.w r7, r4, r7
; CHECK-NEXT:    bfi r3, r8, #4, #4
