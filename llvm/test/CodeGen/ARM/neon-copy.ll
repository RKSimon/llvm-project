...
; CHECK-NEXT:    @ kill: def $q1 killed $q1 def $d1_d2_d3
...
; CHECK-NEXT:    vmov.8 d1[0], r0
; CHECK-NEXT:    vmov.u8 r0, d0[7]
; CHECK-NEXT:    vmov.8 d1[1], r1
; CHECK-NEXT:    vmov.8 d1[2], r2
; CHECK-NEXT:    vmov.8 d1[3], r3
; CHECK-NEXT:    vmov.8 d1[4], r12
; CHECK-NEXT:    vmov.8 d1[5], lr
...
; CHECK-NEXT:    vmov.8 d0[5], r1
; CHECK-NEXT:    vmov.u8 r1, d16[4]
...
; CHECK-NEXT:    vmov.u16 r1, d1[0]
; CHECK-NEXT:    vmov.u16 r4, d1[1]
; CHECK-NEXT:    vmov.u16 lr, d1[2]
; CHECK-NEXT:    vmov.u16 r12, d1[3]
; CHECK-NEXT:    vmov.16 d16[1], r2
; CHECK-NEXT:    vmov.16 d16[2], r3
; CHECK-NEXT:    vmov.16 d16[3], r0
; CHECK-NEXT:    vmov.16 d17[0], r1
; CHECK-NEXT:    vmov.16 d17[1], r4
; CHECK-NEXT:    vmov.16 d17[2], lr
; CHECK-NEXT:    vmov.16 d17[3], r12
