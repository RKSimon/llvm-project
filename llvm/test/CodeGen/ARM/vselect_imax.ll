...
; CHECK-NEXT:    subs r2, r6, r2
; CHECK-NEXT:    add r6, r0, #96
; CHECK-NEXT:    vld1.64 {d2, d3}, [r6:128]!
; CHECK-NEXT:    sbcs r2, r7, r5
...
; CHECK-NEXT:    vdup.32 d1, r5
; CHECK-NEXT:    vbif q14, q15, q0
; CHECK-NEXT:    vld1.64 {d30, d31}, [r8:128]!
...
; CHECK-NEXT:    vmov r2, r7, d22
; CHECK-NEXT:    mov r0, #0
; CHECK-NEXT:    movlt r0, #1
; CHECK-NEXT:    cmp r0, #0
; CHECK-NEXT:    mvnne r0, #0
; CHECK-NEXT:    vdup.32 d9, r0
; CHECK-NEXT:    vmov r0, r1, d26
; CHECK-NEXT:    subs r0, r2, r0
; CHECK-NEXT:    sbcs r0, r7, r1
; CHECK-NEXT:    vmov r2, r7, d23
; CHECK-NEXT:    mov r0, #0
; CHECK-NEXT:    movlt r0, #1
; CHECK-NEXT:    cmp r0, #0
; CHECK-NEXT:    mvnne r0, #0
; CHECK-NEXT:    vdup.32 d6, r0
; CHECK-NEXT:    vmov r0, r1, d27
; CHECK-NEXT:    subs r0, r2, r0
; CHECK-NEXT:    vmov r2, r6, d20
; CHECK-NEXT:    sbcs r0, r7, r1
; CHECK-NEXT:    mov r0, #0
; CHECK-NEXT:    movlt r0, #1
; CHECK-NEXT:    cmp r0, #0
...
; CHECK-NEXT:    vorr q13, q4, q4
; CHECK-NEXT:    vbsl q13, q1, q2
...
; CHECK-NEXT:    vdup.32 d11, r4
; CHECK-NEXT:    vmov r2, r4, d6
; CHECK-NEXT:    vbit q9, q10, q5
; CHECK-NEXT:    vld1.64 {d20, d21}, [r9:128]
; CHECK-NEXT:    subs r0, r2, r0
; CHECK-NEXT:    sbcs r1, r4, r1
; CHECK-NEXT:    vmov r0, r2, d31
...
; CHECK-NEXT:    vmov r4, r1, d5
; CHECK-NEXT:    vbit q10, q12, q1
...
; CHECK-NEXT:    mvnne r1, #0
; CHECK-NEXT:    subs r0, r2, r0
; CHECK-NEXT:    sbcs r0, r7, r8
; CHECK-NEXT:    add r0, r3, #112
; CHECK-NEXT:    movlt r12, #1
; CHECK-NEXT:    cmp r12, #0
; CHECK-NEXT:    mvnne r12, #0
; CHECK-NEXT:    vst1.64 {d20, d21}, [r0:128]
