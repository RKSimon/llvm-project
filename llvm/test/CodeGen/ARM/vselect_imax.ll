...
; CHECK-NEXT:    rsb r12, r1, #0
; CHECK-NEXT:    vmov r2, r1, d22
; CHECK-NEXT:    subs r2, r2, r4
; CHECK-NEXT:    sbcs r1, r1, r5
; CHECK-NEXT:    vmov r2, r4, d19
; CHECK-NEXT:    mov r1, #0
; CHECK-NEXT:    movlt r1, #1
; CHECK-NEXT:    rsb lr, r1, #0
; CHECK-NEXT:    vmov r5, r1, d21
; CHECK-NEXT:    subs r2, r5, r2
; CHECK-NEXT:    sbcs r1, r1, r4
; CHECK-NEXT:    vmov r2, r5, d17
; CHECK-NEXT:    vmov r1, r4, d23
...
; CHECK-NEXT:    vdup.32 d24, lr
; CHECK-NEXT:    vdup.32 d27, r0
; CHECK-NEXT:    vbit q8, q11, q12
; CHECK-NEXT:    vdup.32 d26, r12
...
; CHECK-NEXT:    mov r2, #0
; CHECK-NEXT:    movlt r2, #1
; CHECK-NEXT:    rsb lr, r2, #0
; CHECK-NEXT:    vmov r2, r4, d28
; CHECK-NEXT:    subs r2, r5, r2
; CHECK-NEXT:    sbcs r2, r6, r4
...
; CHECK-NEXT:    mov r5, #0
; CHECK-NEXT:    vdup.32 d9, r9
; CHECK-NEXT:    vdup.32 d8, r8
...
; CHECK-NEXT:    rsb r1, r12, #0
; CHECK-NEXT:    vst1.64 {d26, d27}, [r0:128]!
; CHECK-NEXT:    vbif q11, q14, q4
; CHECK-NEXT:    vbit q12, q15, q3
