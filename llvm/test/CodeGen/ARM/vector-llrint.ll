...
; LE-NEXT:    vpush {d8, d9, d10, d11, d12, d13, d14, d15}
; LE-NEXT:    .pad #128
; LE-NEXT:    sub sp, sp, #128
; LE-NEXT:    mov r11, r0
; LE-NEXT:    vmov r0, s11
; LE-NEXT:    vstr s15, [sp, #40] @ 4-byte Spill
; LE-NEXT:    vmov.f32 s20, s12
; LE-NEXT:    vstr s14, [sp, #100] @ 4-byte Spill
; LE-NEXT:    vmov.f32 s17, s10
; LE-NEXT:    vstr s13, [sp, #104] @ 4-byte Spill
; LE-NEXT:    vmov.f32 s19, s9
; LE-NEXT:    vmov.f32 s23, s8
; LE-NEXT:    vstr s5, [sp, #92] @ 4-byte Spill
; LE-NEXT:    vmov.f32 s25, s7
; LE-NEXT:    vmov.f32 s27, s6
; LE-NEXT:    vmov.f32 s29, s4
; LE-NEXT:    vmov.f32 s16, s3
; LE-NEXT:    vmov.f32 s21, s2
; LE-NEXT:    vmov.f32 s22, s1
; LE-NEXT:    vmov.f32 s18, s0
; LE-NEXT:    bl __aeabi_h2f
; LE-NEXT:    vmov s0, r0
; LE-NEXT:    bl llrintf
...
; LE-NEXT:    vmov s0, r7
; LE-NEXT:    str r1, [sp, #88] @ 4-byte Spill
...
; LE-NEXT:    mov r6, r1
; LE-NEXT:    bl __aeabi_h2f
; LE-NEXT:    vldr s0, [sp, #92] @ 4-byte Reload
; LE-NEXT:    mov r4, r0
...
; LE-NEXT:    bl llrintf
; LE-NEXT:    vmov.32 d12[0], r0
; LE-NEXT:    ldr r0, [sp, #88] @ 4-byte Reload
; LE-NEXT:    add lr, sp, #72
; LE-NEXT:    vmov.32 d15[1], r5
...
; LE-NEXT:    add r0, r11, #96
; LE-NEXT:    vmov.32 d12[1], r1
; LE-NEXT:    vldmia lr, {d22, d23} @ 16-byte Reload
; LE-NEXT:    add lr, sp, #40
...
; LE-NEXT:    add lr, sp, #56
; LE-NEXT:    vmov.32 d23[1], r8
; LE-NEXT:    vst1.64 {d20, d21}, [r0:128]!
; LE-NEXT:    vldmia lr, {d20, d21} @ 16-byte Reload
; LE-NEXT:    add lr, sp, #8
; LE-NEXT:    vmov.32 d22[1], r9
; LE-NEXT:    vst1.64 {d20, d21}, [r0:128]
; LE-NEXT:    add r0, r11, #32
; LE-NEXT:    vst1.64 {d14, d15}, [r0:128]!
; LE-NEXT:    vst1.64 {d16, d17}, [r0:128]
; LE-NEXT:    vldmia lr, {d16, d17} @ 16-byte Reload
; LE-NEXT:    vst1.64 {d16, d17}, [r11:128]!
; LE-NEXT:    vst1.64 {d22, d23}, [r11:128]
; LE-NEXT:    add sp, sp, #128
; LE-NEXT:    vpop {d8, d9, d10, d11, d12, d13, d14, d15}
; LE-NEXT:    add sp, sp, #4
; LE-NEXT:    pop {r4, r5, r6, r7, r8, r9, r10, r11, pc}
;
...
; BE-NEXT:    mov r11, r0
; BE-NEXT:    vmov r0, s2
; BE-NEXT:    vmov.f32 s30, s15
; BE-NEXT:    vstr s14, [sp, #76] @ 4-byte Spill
; BE-NEXT:    vmov.f32 s17, s13
; BE-NEXT:    vstr s7, [sp, #60] @ 4-byte Spill
; BE-NEXT:    vmov.f32 s18, s12
; BE-NEXT:    vstr s1, [sp, #92] @ 4-byte Spill
; BE-NEXT:    vmov.f32 s21, s11
; BE-NEXT:    vmov.f32 s23, s10
; BE-NEXT:    vmov.f32 s24, s9
; BE-NEXT:    vmov.f32 s31, s8
; BE-NEXT:    vmov.f32 s25, s6
; BE-NEXT:    vmov.f32 s27, s5
; BE-NEXT:    vmov.f32 s19, s4
; BE-NEXT:    vmov.f32 s29, s3
; BE-NEXT:    vmov.f32 s16, s0
; BE-NEXT:    bl __aeabi_h2f
; BE-NEXT:    mov r10, r0
; BE-NEXT:    vmov r0, s23
...
; BE-NEXT:    vmov.f32 s0, s17
; BE-NEXT:    vmov.32 d16[0], r0
; BE-NEXT:    str r1, [sp, #36] @ 4-byte Spill
; BE-NEXT:    vmov.32 d11[1], r6
; BE-NEXT:    vstr d16, [sp, #24] @ 8-byte Spill
; BE-NEXT:    vstr d11, [sp, #48] @ 8-byte Spill
; BE-NEXT:    bl llrintf
; BE-NEXT:    vmov.32 d16[0], r0
; BE-NEXT:    mov r0, r9
; BE-NEXT:    mov r10, r1
...
; BE-NEXT:    mov r6, r0
; BE-NEXT:    vmov r0, s24
; BE-NEXT:    vmov.32 d13[1], r8
; BE-NEXT:    vmov r5, s18
; BE-NEXT:    vstr d13, [sp, #16] @ 8-byte Spill
; BE-NEXT:    bl __aeabi_h2f
; BE-NEXT:    vmov s24, r0
...
; BE-NEXT:    mov r6, r1
; BE-NEXT:    bl __aeabi_h2f
; BE-NEXT:    vldr s0, [sp, #60] @ 4-byte Reload
; BE-NEXT:    mov r4, r0
; BE-NEXT:    vmov.32 d14[1], r7
; BE-NEXT:    vmov r0, s0
; BE-NEXT:    bl __aeabi_h2f
...
; BE-NEXT:    vmov.32 d11[1], r6
; BE-NEXT:    vmov r7, s0
; BE-NEXT:    vldr s0, [sp, #92] @ 4-byte Reload
; BE-NEXT:    vmov r0, s0
; BE-NEXT:    bl __aeabi_h2f
...
; LE-NEXT:    vmov.32 d17[0], r0
; LE-NEXT:    str r1, [sp, #148] @ 4-byte Spill
; LE-NEXT:    vstmia lr, {d16, d17} @ 16-byte Spill
; LE-NEXT:    bl llrintf
; LE-NEXT:    vmov.f32 s0, s27
; LE-NEXT:    str r1, [sp, #108] @ 4-byte Spill
...
; LE-NEXT:    add lr, sp, #24
; LE-NEXT:    vmov.32 d17[0], r0
; LE-NEXT:    str r1, [sp, #60] @ 4-byte Spill
; LE-NEXT:    vstmia lr, {d16, d17} @ 16-byte Spill
...
; LE-NEXT:    add lr, sp, #128
; LE-NEXT:    vmov.32 d10[0], r0
; LE-NEXT:    ldr r0, [sp, #148] @ 4-byte Reload
; LE-NEXT:    mov r5, r1
; LE-NEXT:    vldmia lr, {d8, d9} @ 16-byte Reload
; LE-NEXT:    add lr, sp, #152
; LE-NEXT:    vldmia lr, {d12, d13} @ 16-byte Reload
...
; LE-NEXT:    vldmia lr, {d14, d15} @ 16-byte Reload
; LE-NEXT:    vmov.32 d14[0], r0
; LE-NEXT:    ldr r0, [sp, #60] @ 4-byte Reload
; LE-NEXT:    vmov.32 d15[1], r0
; LE-NEXT:    bl llrintf
; LE-NEXT:    vorr q8, q4, q4
; LE-NEXT:    add lr, sp, #8
; LE-NEXT:    vmov.32 d14[1], r6
; LE-NEXT:    vmov.32 d16[0], r0
; LE-NEXT:    add r0, r4, #96
; LE-NEXT:    vldmia lr, {d18, d19} @ 16-byte Reload
; LE-NEXT:    add lr, sp, #40
; LE-NEXT:    vldmia lr, {d20, d21} @ 16-byte Reload
; LE-NEXT:    add lr, sp, #168
; LE-NEXT:    vmov.32 d19[1], r9
; LE-NEXT:    vmov.32 d16[1], r1
; LE-NEXT:    vmov.32 d21[1], r8
; LE-NEXT:    vst1.64 {d14, d15}, [r0:128]!
; LE-NEXT:    vmov.32 d18[1], r10
; LE-NEXT:    vmov.32 d20[1], r11
; LE-NEXT:    vst1.64 {d16, d17}, [r0:128]
; LE-NEXT:    add r0, r4, #48
...
; BE-NEXT:    vmov.32 d12[0], r0
; BE-NEXT:    bl llrintf
; BE-NEXT:    vldr d0, [sp, #72] @ 8-byte Reload
; BE-NEXT:    mov r7, r1
; BE-NEXT:    @ kill: def $s0 killed $s0 killed $d0
; BE-NEXT:    vmov.32 d13[0], r0
; BE-NEXT:    bl llrintf
...
; LE-NEXT:    bl llrint
; LE-NEXT:    vorr d0, d15, d15
; LE-NEXT:    str r1, [sp, #124] @ 4-byte Spill
; LE-NEXT:    vmov.32 d8[0], r0
; LE-NEXT:    bl llrint
; LE-NEXT:    vorr d0, d12, d12
...
; LE-NEXT:    vmov.32 d10[0], r0
; LE-NEXT:    add lr, sp, #24
; LE-NEXT:    str r1, [sp, #48] @ 4-byte Spill
; LE-NEXT:    vmov.32 d13[1], r7
; LE-NEXT:    vstmia lr, {d10, d11} @ 16-byte Spill
; LE-NEXT:    add lr, sp, #64
; LE-NEXT:    vldmia lr, {d8, d9} @ 16-byte Reload
...
; LE-NEXT:    bl llrint
; LE-NEXT:    vmov.32 d15[0], r0
; LE-NEXT:    ldr r0, [sp, #124] @ 4-byte Reload
; LE-NEXT:    vorr d0, d12, d12
; LE-NEXT:    add lr, sp, #160
; LE-NEXT:    mov r6, r1
; LE-NEXT:    vmov.32 d8[1], r0
...
; LE-NEXT:    bl llrint
; LE-NEXT:    vmov.32 d13[0], r0
; LE-NEXT:    ldr r0, [sp, #48] @ 4-byte Reload
; LE-NEXT:    vorr d0, d10, d10
; LE-NEXT:    mov r4, r1
; LE-NEXT:    vmov.32 d8[1], r0
; LE-NEXT:    bl llrint
...
; LE-NEXT:    vpush {d8, d9, d10, d11}
; LE-NEXT:    bl llrintl
; LE-NEXT:    ldr r5, [sp, #88]
; LE-NEXT:    add r3, sp, #92
; LE-NEXT:    mov r7, r1
; LE-NEXT:    vmov.32 d8[0], r0
; LE-NEXT:    ldm r3, {r1, r2, r3}
; LE-NEXT:    mov r0, r5
; LE-NEXT:    bl llrintl
; LE-NEXT:    ldr r4, [sp, #56]
; LE-NEXT:    add r3, sp, #60
; LE-NEXT:    mov r5, r1
; LE-NEXT:    vmov.32 d11[0], r0
; LE-NEXT:    ldm r3, {r1, r2, r3}
; LE-NEXT:    mov r0, r4
; LE-NEXT:    bl llrintl
; LE-NEXT:    ldr r6, [sp, #72]
; LE-NEXT:    add r3, sp, #76
; LE-NEXT:    mov r4, r1
; LE-NEXT:    vmov.32 d9[0], r0
; LE-NEXT:    ldm r3, {r1, r2, r3}
; LE-NEXT:    mov r0, r6
...
; BE-NEXT:    vpush {d8, d9, d10}
; BE-NEXT:    bl llrintl
; BE-NEXT:    ldr r5, [sp, #80]
; BE-NEXT:    add r3, sp, #84
; BE-NEXT:    mov r7, r1
; BE-NEXT:    vmov.32 d8[0], r0
; BE-NEXT:    ldm r3, {r1, r2, r3}
; BE-NEXT:    mov r0, r5
; BE-NEXT:    bl llrintl
; BE-NEXT:    ldr r4, [sp, #48]
; BE-NEXT:    add r3, sp, #52
; BE-NEXT:    mov r5, r1
; BE-NEXT:    vmov.32 d9[0], r0
; BE-NEXT:    ldm r3, {r1, r2, r3}
; BE-NEXT:    mov r0, r4
; BE-NEXT:    bl llrintl
; BE-NEXT:    ldr r6, [sp, #64]
; BE-NEXT:    add r3, sp, #68
; BE-NEXT:    mov r4, r1
; BE-NEXT:    vmov.32 d10[0], r0
; BE-NEXT:    ldm r3, {r1, r2, r3}
; BE-NEXT:    mov r0, r6
...
; LE-NEXT:    vpush {d8, d9, d10, d11, d12, d13, d14, d15}
; LE-NEXT:    bl llrintl
; LE-NEXT:    ldr r7, [sp, #200]
; LE-NEXT:    add r3, sp, #204
; LE-NEXT:    mov r8, r1
; LE-NEXT:    vmov.32 d8[0], r0
; LE-NEXT:    ldm r3, {r1, r2, r3}
; LE-NEXT:    mov r0, r7
; LE-NEXT:    bl llrintl
; LE-NEXT:    ldr r7, [sp, #152]
...
; LE-NEXT:    mov r0, r5
; LE-NEXT:    bl llrintl
; LE-NEXT:    ldr r6, [sp, #104]
; LE-NEXT:    add r3, sp, #108
; LE-NEXT:    mov r5, r1
; LE-NEXT:    vmov.32 d15[0], r0
; LE-NEXT:    ldm r3, {r1, r2, r3}
; LE-NEXT:    mov r0, r6
; LE-NEXT:    bl llrintl
; LE-NEXT:    ldr r7, [sp, #184]
...
; BE-NEXT:    mov r0, r5
; BE-NEXT:    bl llrintl
; BE-NEXT:    ldr r6, [sp, #96]
; BE-NEXT:    add r3, sp, #100
; BE-NEXT:    mov r5, r1
; BE-NEXT:    vmov.32 d13[0], r0
; BE-NEXT:    ldm r3, {r1, r2, r3}
; BE-NEXT:    mov r0, r6
