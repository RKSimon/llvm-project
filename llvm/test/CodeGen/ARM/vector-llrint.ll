...
; LE-NEXT:    mov r11, r0
; LE-NEXT:    vmov r0, s10
; LE-NEXT:    vstr s15, [sp, #104] @ 4-byte Spill
; LE-NEXT:    vmov.f32 s20, s14
; LE-NEXT:    vstr s13, [sp, #100] @ 4-byte Spill
; LE-NEXT:    vmov.f32 s17, s11
; LE-NEXT:    vstr s12, [sp, #112] @ 4-byte Spill
; LE-NEXT:    vmov.f32 s23, s9
; LE-NEXT:    vmov.f32 s21, s8
; LE-NEXT:    vstr s4, [sp, #92] @ 4-byte Spill
; LE-NEXT:    vmov.f32 s25, s7
; LE-NEXT:    vmov.f32 s27, s6
; LE-NEXT:    vmov.f32 s29, s5
; LE-NEXT:    vmov.f32 s19, s3
...
; BE-NEXT:    vstr s13, [sp, #76] @ 4-byte Spill
; BE-NEXT:    vmov.f32 s30, s14
; BE-NEXT:    vstr s6, [sp, #60] @ 4-byte Spill
; BE-NEXT:    vmov.f32 s24, s12
; BE-NEXT:    vstr s0, [sp, #92] @ 4-byte Spill
; BE-NEXT:    vmov.f32 s21, s11
; BE-NEXT:    vmov.f32 s23, s10
; BE-NEXT:    vmov.f32 s31, s9
; BE-NEXT:    vmov.f32 s16, s8
; BE-NEXT:    vmov.f32 s25, s7
; BE-NEXT:    vmov.f32 s19, s5
; BE-NEXT:    vmov.f32 s27, s4
; BE-NEXT:    vmov.f32 s29, s2
; BE-NEXT:    vmov.f32 s18, s1
; BE-NEXT:    bl __aeabi_h2f
; BE-NEXT:    mov r10, r0
; BE-NEXT:    vmov r0, s21
; BE-NEXT:    bl __aeabi_h2f
...
; BE-NEXT:    bl llrint
; BE-NEXT:    vorr d0, d14, d14
; BE-NEXT:    str r1, [sp, #116] @ 4-byte Spill
; BE-NEXT:    vmov.32 d9[0], r0
; BE-NEXT:    bl llrint
; BE-NEXT:    vorr d0, d13, d13
...
; BE-NEXT:    bl llrint
; BE-NEXT:    vmov.32 d14[0], r0
; BE-NEXT:    ldr r0, [sp, #116] @ 4-byte Reload
; BE-NEXT:    vorr d0, d13, d13
; BE-NEXT:    add lr, sp, #152
; BE-NEXT:    mov r6, r1
...
; BE-NEXT:    vmov.32 d16[1], r0
; BE-NEXT:    add r0, r10, #32
; BE-NEXT:    vmov.32 d17[1], r5
; BE-NEXT:    vorr q12, q8, q8
; BE-NEXT:    vldmia lr, {d16, d17} @ 16-byte Reload
; BE-NEXT:    add lr, sp, #152
; BE-NEXT:    vmov.32 d13[1], r1
