...
; CHECK-NEXT:    vldmia r11, {s0, s1, s2, s3, s4}
; CHECK-NEXT:    add r11, sp, #48
; CHECK-NEXT:    ldr lr, [r12], #4
; CHECK-NEXT:    vldmia r11, {s8, s9, s10, s11, s12}
; CHECK-NEXT:    vcgt.u32 q10, q3, q1
; CHECK-NEXT:    vmov.32 d17[0], lr
; CHECK-NEXT:    vcgt.u32 q9, q2, q0
; CHECK-NEXT:    vmov.u8 lr, d17[3]
; CHECK-NEXT:    vmovn.i32 d18, q9
; CHECK-NEXT:    vmovn.i32 d19, q10
; CHECK-NEXT:    vldr d20, .LCPI23_0
; CHECK-NEXT:    vmovn.i16 d16, q9
; CHECK-NEXT:    vmov.8 d19[0], lr
; CHECK-NEXT:    vtbl.8 d18, {d16, d17}, d20
; CHECK-NEXT:    vld1.8 {d19[1]}, [r12]
; CHECK-NEXT:    add r12, sp, #8
; CHECK-NEXT:    vshl.i8 q8, q9, #7
...
; CHECK-NEXT:    vmov.u16 lr, d20[0]
; CHECK-NEXT:    vld1.16 {d22, d23}, [r0]!
; CHECK-NEXT:    vmov.u16 r3, d22[0]
; CHECK-NEXT:    vld1.16 {d24}, [r0]!
; CHECK-NEXT:    vmov.u16 r4, d24[0]
; CHECK-NEXT:    vmov.u16 r6, d21[0]
; CHECK-NEXT:    vmov.u16 r5, d23[0]
; CHECK-NEXT:    vmov.16 d19[0], r12
; CHECK-NEXT:    vmov.u16 r12, d16[2]
; CHECK-NEXT:    vmov.16 d18[0], lr
; CHECK-NEXT:    vmov.u16 lr, d20[2]
; CHECK-NEXT:    vmov.16 d16[0], r3
; CHECK-NEXT:    vmov.u16 r3, d22[2]
; CHECK-NEXT:    vmov.16 d17[0], r4
; CHECK-NEXT:    vmov.u16 r4, d24[2]
; CHECK-NEXT:    vmov.16 d19[1], r12
; CHECK-NEXT:    vmov.u16 r12, d23[2]
; CHECK-NEXT:    vmov.16 d18[1], lr
; CHECK-NEXT:    vmov.u16 lr, d21[2]
; CHECK-NEXT:    vmov.16 d16[1], r3
; CHECK-NEXT:    ldr r3, [r2]
; CHECK-NEXT:    add r2, r2, #4
; CHECK-NEXT:    vmov.16 d19[2], r3
; CHECK-NEXT:    ldr r3, [r0]
; CHECK-NEXT:    add r0, r0, #4
; CHECK-NEXT:    vmov.16 d17[1], r4
; CHECK-NEXT:    vmov.16 d18[2], r6
; CHECK-NEXT:    vld1.16 {d19[3]}, [r2:16]
; CHECK-NEXT:    vmov.16 d16[2], r5
; CHECK-NEXT:    vmov.16 d17[2], r3
; CHECK-NEXT:    vmov.16 d16[3], r12
; CHECK-NEXT:    vld1.16 {d17[3]}, [r0:16]
; CHECK-NEXT:    vmov.16 d18[3], lr
