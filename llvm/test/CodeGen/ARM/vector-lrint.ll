...
; LE-I64-NEXT:    vpush {d8, d9, d10, d11, d12, d13, d14, d15}
; LE-I64-NEXT:    .pad #128
; LE-I64-NEXT:    sub sp, sp, #128
; LE-I64-NEXT:    mov r11, r0
; LE-I64-NEXT:    vmov r0, s11
; LE-I64-NEXT:    vstr s15, [sp, #40] @ 4-byte Spill
; LE-I64-NEXT:    vmov.f32 s20, s12
; LE-I64-NEXT:    vstr s14, [sp, #100] @ 4-byte Spill
; LE-I64-NEXT:    vmov.f32 s17, s10
; LE-I64-NEXT:    vstr s13, [sp, #104] @ 4-byte Spill
; LE-I64-NEXT:    vmov.f32 s19, s9
; LE-I64-NEXT:    vmov.f32 s23, s8
; LE-I64-NEXT:    vstr s5, [sp, #92] @ 4-byte Spill
; LE-I64-NEXT:    vmov.f32 s25, s7
; LE-I64-NEXT:    vmov.f32 s27, s6
; LE-I64-NEXT:    vmov.f32 s29, s4
; LE-I64-NEXT:    vmov.f32 s16, s3
; LE-I64-NEXT:    vmov.f32 s21, s2
; LE-I64-NEXT:    vmov.f32 s22, s1
; LE-I64-NEXT:    vmov.f32 s18, s0
; LE-I64-NEXT:    bl __aeabi_h2f
; LE-I64-NEXT:    vmov s0, r0
; LE-I64-NEXT:    bl lrintf
; LE-I64-NEXT:    mov r8, r0
...
; LE-I64-NEXT:    vmov s0, r7
; LE-I64-NEXT:    str r1, [sp, #88] @ 4-byte Spill
...
; LE-I64-NEXT:    vmov r6, s17
; LE-I64-NEXT:    vmov r9, s21
...
; LE-I64-NEXT:    mov r8, r1
; LE-I64-NEXT:    vmov.32 d14[1], r10
; LE-I64-NEXT:    vmov r5, s20
; LE-I64-NEXT:    vmov s24, r4
; LE-I64-NEXT:    vstmia lr, {d16, d17} @ 16-byte Spill
...
; LE-I64-NEXT:    mov r6, r1
; LE-I64-NEXT:    bl __aeabi_h2f
; LE-I64-NEXT:    vldr s0, [sp, #92] @ 4-byte Reload
; LE-I64-NEXT:    mov r4, r0
...
; LE-I64-NEXT:    bl lrintf
; LE-I64-NEXT:    vmov.32 d12[0], r0
; LE-I64-NEXT:    ldr r0, [sp, #88] @ 4-byte Reload
; LE-I64-NEXT:    add lr, sp, #72
; LE-I64-NEXT:    vmov.32 d15[1], r5
...
; LE-I64-NEXT:    add r0, r11, #96
; LE-I64-NEXT:    vmov.32 d12[1], r1
; LE-I64-NEXT:    vldmia lr, {d22, d23} @ 16-byte Reload
; LE-I64-NEXT:    add lr, sp, #40
...
; LE-I64-NEXT:    add lr, sp, #56
; LE-I64-NEXT:    vmov.32 d23[1], r8
; LE-I64-NEXT:    vst1.64 {d20, d21}, [r0:128]!
; LE-I64-NEXT:    vldmia lr, {d20, d21} @ 16-byte Reload
; LE-I64-NEXT:    add lr, sp, #8
; LE-I64-NEXT:    vmov.32 d22[1], r9
; LE-I64-NEXT:    vst1.64 {d20, d21}, [r0:128]
; LE-I64-NEXT:    add r0, r11, #32
; LE-I64-NEXT:    vst1.64 {d14, d15}, [r0:128]!
; LE-I64-NEXT:    vst1.64 {d16, d17}, [r0:128]
; LE-I64-NEXT:    vldmia lr, {d16, d17} @ 16-byte Reload
; LE-I64-NEXT:    vst1.64 {d16, d17}, [r11:128]!
; LE-I64-NEXT:    vst1.64 {d22, d23}, [r11:128]
; LE-I64-NEXT:    add sp, sp, #128
; LE-I64-NEXT:    vpop {d8, d9, d10, d11, d12, d13, d14, d15}
; LE-I64-NEXT:    add sp, sp, #4
; LE-I64-NEXT:    pop {r4, r5, r6, r7, r8, r9, r10, r11, pc}
;
...
; BE-I64-NEXT:    vmov r0, s2
; BE-I64-NEXT:    vmov.f32 s30, s15
; BE-I64-NEXT:    vstr s14, [sp, #76] @ 4-byte Spill
; BE-I64-NEXT:    vmov.f32 s17, s13
; BE-I64-NEXT:    vstr s7, [sp, #60] @ 4-byte Spill
; BE-I64-NEXT:    vmov.f32 s18, s12
; BE-I64-NEXT:    vstr s1, [sp, #92] @ 4-byte Spill
; BE-I64-NEXT:    vmov.f32 s21, s11
; BE-I64-NEXT:    vmov.f32 s23, s10
; BE-I64-NEXT:    vmov.f32 s24, s9
; BE-I64-NEXT:    vmov.f32 s31, s8
; BE-I64-NEXT:    vmov.f32 s25, s6
; BE-I64-NEXT:    vmov.f32 s27, s5
; BE-I64-NEXT:    vmov.f32 s19, s4
; BE-I64-NEXT:    vmov.f32 s29, s3
; BE-I64-NEXT:    vmov.f32 s16, s0
; BE-I64-NEXT:    bl __aeabi_h2f
; BE-I64-NEXT:    mov r10, r0
...
; BE-I64-NEXT:    vmov r4, s30
; BE-I64-NEXT:    mov r7, r1
; BE-I64-NEXT:    vmov r9, s17
; BE-I64-NEXT:    vmov.32 d13[0], r6
; BE-I64-NEXT:    vmov s30, r5
; BE-I64-NEXT:    bl __aeabi_h2f
; BE-I64-NEXT:    vmov.f32 s0, s30
; BE-I64-NEXT:    vmov s17, r0
; BE-I64-NEXT:    bl lrintf
; BE-I64-NEXT:    vmov.f32 s0, s17
; BE-I64-NEXT:    mov r5, r1
; BE-I64-NEXT:    vmov.32 d10[0], r0
; BE-I64-NEXT:    vmov s30, r10
; BE-I64-NEXT:    bl lrintf
; BE-I64-NEXT:    vmov.32 d11[0], r0
...
; BE-I64-NEXT:    vmov.f32 s0, s17
; BE-I64-NEXT:    vmov.32 d16[0], r0
; BE-I64-NEXT:    str r1, [sp, #36] @ 4-byte Spill
; BE-I64-NEXT:    vmov.32 d11[1], r6
; BE-I64-NEXT:    vstr d16, [sp, #24] @ 8-byte Spill
; BE-I64-NEXT:    vstr d11, [sp, #48] @ 8-byte Spill
; BE-I64-NEXT:    bl lrintf
; BE-I64-NEXT:    vmov.32 d16[0], r0
...
; BE-I64-NEXT:    mov r6, r0
; BE-I64-NEXT:    vmov r0, s24
; BE-I64-NEXT:    vmov.32 d13[1], r8
; BE-I64-NEXT:    vmov r5, s18
; BE-I64-NEXT:    vstr d13, [sp, #16] @ 8-byte Spill
; BE-I64-NEXT:    bl __aeabi_h2f
; BE-I64-NEXT:    vmov s24, r0
; BE-I64-NEXT:    vmov.32 d14[1], r7
; BE-I64-NEXT:    vmov r0, s31
; BE-I64-NEXT:    vmov r4, s16
...
; BE-I64-NEXT:    mov r6, r1
; BE-I64-NEXT:    bl __aeabi_h2f
; BE-I64-NEXT:    vldr s0, [sp, #60] @ 4-byte Reload
; BE-I64-NEXT:    mov r4, r0
; BE-I64-NEXT:    vmov.32 d14[1], r7
; BE-I64-NEXT:    vmov r0, s0
; BE-I64-NEXT:    bl __aeabi_h2f
...
; BE-I64-NEXT:    vldr s0, [sp, #92] @ 4-byte Reload
; BE-I64-NEXT:    vmov r0, s0
; BE-I64-NEXT:    bl __aeabi_h2f
...
; BE-I64-NEXT:    vldr d19, [sp, #64] @ 8-byte Reload
; BE-I64-NEXT:    vldr d30, [sp, #8] @ 8-byte Reload
; BE-I64-NEXT:    vmov.32 d19[1], r0
; BE-I64-NEXT:    ldr r0, [sp, #88] @ 4-byte Reload
; BE-I64-NEXT:    vldr d18, [sp, #80] @ 8-byte Reload
; BE-I64-NEXT:    vmov.32 d12[1], r8
; BE-I64-NEXT:    vldr d20, [sp] @ 8-byte Reload
; BE-I64-NEXT:    vmov.32 d9[1], r6
; BE-I64-NEXT:    vmov.32 d30[1], r10
; BE-I64-NEXT:    vmov.32 d18[1], r0
; BE-I64-NEXT:    ldr r0, [sp, #36] @ 4-byte Reload
; BE-I64-NEXT:    vrev64.32 d29, d20
; BE-I64-NEXT:    vldr d20, [sp, #16] @ 8-byte Reload
; BE-I64-NEXT:    vldr d25, [sp, #24] @ 8-byte Reload
; BE-I64-NEXT:    vrev64.32 d1, d12
; BE-I64-NEXT:    vmov.32 d24[1], r1
; BE-I64-NEXT:    vrev64.32 d28, d20
; BE-I64-NEXT:    vldr d20, [sp, #40] @ 8-byte Reload
; BE-I64-NEXT:    vrev64.32 d0, d9
; BE-I64-NEXT:    vrev64.32 d31, d30
; BE-I64-NEXT:    vmov.32 d25[1], r0
; BE-I64-NEXT:    add r0, r11, #96
; BE-I64-NEXT:    vrev64.32 d27, d14
; BE-I64-NEXT:    vrev64.32 d23, d20
; BE-I64-NEXT:    vldr d20, [sp, #48] @ 8-byte Reload
; BE-I64-NEXT:    vrev64.32 d30, d24
; BE-I64-NEXT:    vst1.64 {d0, d1}, [r0:128]!
; BE-I64-NEXT:    vrev64.32 d26, d15
; BE-I64-NEXT:    vst1.64 {d30, d31}, [r0:128]
; BE-I64-NEXT:    add r0, r11, #64
; BE-I64-NEXT:    vmov.32 d10[1], r5
; BE-I64-NEXT:    vst1.64 {d26, d27}, [r0:128]!
; BE-I64-NEXT:    vrev64.32 d22, d20
; BE-I64-NEXT:    vrev64.32 d17, d13
; BE-I64-NEXT:    vrev64.32 d21, d10
; BE-I64-NEXT:    vst1.64 {d28, d29}, [r0:128]
; BE-I64-NEXT:    add r0, r11, #32
; BE-I64-NEXT:    vrev64.32 d20, d19
...
; LE-I64-NEXT:    vmov.32 d17[0], r0
; LE-I64-NEXT:    str r1, [sp, #148] @ 4-byte Spill
; LE-I64-NEXT:    vstmia lr, {d16, d17} @ 16-byte Spill
; LE-I64-NEXT:    bl lrintf
; LE-I64-NEXT:    vmov.f32 s0, s27
; LE-I64-NEXT:    str r1, [sp, #108] @ 4-byte Spill
...
; LE-I64-NEXT:    add lr, sp, #128
; LE-I64-NEXT:    vmov.32 d10[0], r0
; LE-I64-NEXT:    ldr r0, [sp, #148] @ 4-byte Reload
; LE-I64-NEXT:    mov r5, r1
; LE-I64-NEXT:    vldmia lr, {d8, d9} @ 16-byte Reload
; LE-I64-NEXT:    add lr, sp, #152
; LE-I64-NEXT:    vldmia lr, {d12, d13} @ 16-byte Reload
...
; LE-I64-NEXT:    bl lrintf
; LE-I64-NEXT:    vorr q8, q4, q4
; LE-I64-NEXT:    add lr, sp, #8
; LE-I64-NEXT:    vmov.32 d14[1], r6
; LE-I64-NEXT:    vmov.32 d16[0], r0
; LE-I64-NEXT:    add r0, r4, #96
; LE-I64-NEXT:    vldmia lr, {d18, d19} @ 16-byte Reload
; LE-I64-NEXT:    add lr, sp, #40
; LE-I64-NEXT:    vldmia lr, {d20, d21} @ 16-byte Reload
; LE-I64-NEXT:    add lr, sp, #168
; LE-I64-NEXT:    vmov.32 d19[1], r9
; LE-I64-NEXT:    vmov.32 d16[1], r1
; LE-I64-NEXT:    vmov.32 d21[1], r8
; LE-I64-NEXT:    vst1.64 {d14, d15}, [r0:128]!
; LE-I64-NEXT:    vmov.32 d18[1], r10
; LE-I64-NEXT:    vmov.32 d20[1], r11
; LE-I64-NEXT:    vst1.64 {d16, d17}, [r0:128]
; LE-I64-NEXT:    add r0, r4, #48
...
; BE-I64-NEXT:    vmov.32 d12[0], r0
; BE-I64-NEXT:    bl lrintf
; BE-I64-NEXT:    vldr d0, [sp, #72] @ 8-byte Reload
; BE-I64-NEXT:    mov r7, r1
; BE-I64-NEXT:    @ kill: def $s0 killed $s0 killed $d0
; BE-I64-NEXT:    vmov.32 d13[0], r0
; BE-I64-NEXT:    bl lrintf
...
; LE-I64-NEXT:    bl lrint
; LE-I64-NEXT:    vorr d0, d15, d15
; LE-I64-NEXT:    str r1, [sp, #124] @ 4-byte Spill
; LE-I64-NEXT:    vmov.32 d8[0], r0
; LE-I64-NEXT:    bl lrint
; LE-I64-NEXT:    vorr d0, d12, d12
...
; LE-I64-NEXT:    vmov.32 d10[0], r0
; LE-I64-NEXT:    add lr, sp, #24
; LE-I64-NEXT:    str r1, [sp, #48] @ 4-byte Spill
; LE-I64-NEXT:    vmov.32 d13[1], r7
; LE-I64-NEXT:    vstmia lr, {d10, d11} @ 16-byte Spill
; LE-I64-NEXT:    add lr, sp, #64
; LE-I64-NEXT:    vldmia lr, {d8, d9} @ 16-byte Reload
...
; LE-I64-NEXT:    bl lrint
; LE-I64-NEXT:    vmov.32 d15[0], r0
; LE-I64-NEXT:    ldr r0, [sp, #124] @ 4-byte Reload
; LE-I64-NEXT:    vorr d0, d12, d12
; LE-I64-NEXT:    add lr, sp, #160
; LE-I64-NEXT:    mov r6, r1
; LE-I64-NEXT:    vmov.32 d8[1], r0
...
; LE-I64-NEXT:    bl lrint
; LE-I64-NEXT:    vmov.32 d13[0], r0
; LE-I64-NEXT:    ldr r0, [sp, #48] @ 4-byte Reload
; LE-I64-NEXT:    vorr d0, d10, d10
; LE-I64-NEXT:    mov r4, r1
; LE-I64-NEXT:    vmov.32 d8[1], r0
; LE-I64-NEXT:    bl lrint
...
; LE-I64-NEXT:    vpush {d8, d9, d10, d11}
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    ldr r5, [sp, #88]
; LE-I64-NEXT:    add r3, sp, #92
; LE-I64-NEXT:    mov r7, r1
; LE-I64-NEXT:    vmov.32 d8[0], r0
; LE-I64-NEXT:    ldm r3, {r1, r2, r3}
; LE-I64-NEXT:    mov r0, r5
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    ldr r4, [sp, #56]
; LE-I64-NEXT:    add r3, sp, #60
; LE-I64-NEXT:    mov r5, r1
; LE-I64-NEXT:    vmov.32 d11[0], r0
; LE-I64-NEXT:    ldm r3, {r1, r2, r3}
; LE-I64-NEXT:    mov r0, r4
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    ldr r6, [sp, #72]
; LE-I64-NEXT:    add r3, sp, #76
; LE-I64-NEXT:    mov r4, r1
; LE-I64-NEXT:    vmov.32 d9[0], r0
; LE-I64-NEXT:    ldm r3, {r1, r2, r3}
; LE-I64-NEXT:    mov r0, r6
...
; BE-I64-NEXT:    vpush {d8, d9, d10}
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r5, [sp, #80]
; BE-I64-NEXT:    add r3, sp, #84
; BE-I64-NEXT:    mov r7, r1
; BE-I64-NEXT:    vmov.32 d8[0], r0
; BE-I64-NEXT:    ldm r3, {r1, r2, r3}
; BE-I64-NEXT:    mov r0, r5
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r4, [sp, #48]
; BE-I64-NEXT:    add r3, sp, #52
; BE-I64-NEXT:    mov r5, r1
; BE-I64-NEXT:    vmov.32 d9[0], r0
; BE-I64-NEXT:    ldm r3, {r1, r2, r3}
; BE-I64-NEXT:    mov r0, r4
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r6, [sp, #64]
; BE-I64-NEXT:    add r3, sp, #68
; BE-I64-NEXT:    mov r4, r1
; BE-I64-NEXT:    vmov.32 d10[0], r0
; BE-I64-NEXT:    ldm r3, {r1, r2, r3}
...
; LE-I32-NEXT:    vpush {d8, d9, d10, d11}
; LE-I32-NEXT:    bl lrintl
; LE-I32-NEXT:    add r3, sp, #92
; LE-I32-NEXT:    ldr r12, [sp, #88]
; LE-I32-NEXT:    vmov.32 d8[0], r0
; LE-I32-NEXT:    ldm r3, {r1, r2, r3}
; LE-I32-NEXT:    mov r0, r12
; LE-I32-NEXT:    bl lrintl
; LE-I32-NEXT:    add r3, sp, #124
; LE-I32-NEXT:    ldr r12, [sp, #120]
; LE-I32-NEXT:    vmov.32 d10[0], r0
; LE-I32-NEXT:    ldm r3, {r1, r2, r3}
; LE-I32-NEXT:    mov r0, r12
; LE-I32-NEXT:    bl lrintl
...
; LE-I32-NEXT:    ldr r12, [sp, #72]
; LE-I32-NEXT:    vmov.32 d8[1], r0
; LE-I32-NEXT:    ldm r3, {r1, r2, r3}
; LE-I32-NEXT:    mov r0, r12
; LE-I32-NEXT:    bl lrintl
; LE-I32-NEXT:    add r3, sp, #140
; LE-I32-NEXT:    ldr r12, [sp, #136]
; LE-I32-NEXT:    vmov.32 d9[1], r0
; LE-I32-NEXT:    ldm r3, {r1, r2, r3}
; LE-I32-NEXT:    mov r0, r12
; LE-I32-NEXT:    bl lrintl
; LE-I32-NEXT:    add r3, sp, #108
; LE-I32-NEXT:    ldr r12, [sp, #104]
; LE-I32-NEXT:    vmov.32 d11[1], r0
; LE-I32-NEXT:    ldm r3, {r1, r2, r3}
; LE-I32-NEXT:    mov r0, r12
; LE-I32-NEXT:    bl lrintl
...
; LE-I64-NEXT:    vpush {d8, d9, d10, d11, d12, d13, d14, d15}
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    ldr r7, [sp, #200]
; LE-I64-NEXT:    add r3, sp, #204
; LE-I64-NEXT:    mov r8, r1
; LE-I64-NEXT:    vmov.32 d8[0], r0
; LE-I64-NEXT:    ldm r3, {r1, r2, r3}
; LE-I64-NEXT:    mov r0, r7
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    ldr r7, [sp, #152]
...
; LE-I64-NEXT:    mov r0, r5
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    ldr r6, [sp, #104]
; LE-I64-NEXT:    add r3, sp, #108
; LE-I64-NEXT:    mov r5, r1
; LE-I64-NEXT:    vmov.32 d15[0], r0
; LE-I64-NEXT:    ldm r3, {r1, r2, r3}
; LE-I64-NEXT:    mov r0, r6
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    ldr r7, [sp, #184]
...
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
; BE-I32-NEXT:    add r3, sp, #124
; BE-I32-NEXT:    ldr r12, [sp, #120]
; BE-I32-NEXT:    vmov.32 d9[0], r0
; BE-I32-NEXT:    ldm r3, {r1, r2, r3}
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
...
; BE-I32-NEXT:    ldr r12, [sp, #72]
; BE-I32-NEXT:    vmov.32 d11[1], r0
; BE-I32-NEXT:    ldm r3, {r1, r2, r3}
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
; BE-I32-NEXT:    add r3, sp, #108
; BE-I32-NEXT:    ldr r12, [sp, #104]
; BE-I32-NEXT:    vmov.32 d9[1], r0
; BE-I32-NEXT:    ldm r3, {r1, r2, r3}
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
...
; BE-I64-NEXT:    mov r0, r5
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r6, [sp, #96]
; BE-I64-NEXT:    add r3, sp, #100
; BE-I64-NEXT:    mov r5, r1
; BE-I64-NEXT:    vmov.32 d13[0], r0
; BE-I64-NEXT:    ldm r3, {r1, r2, r3}
; BE-I64-NEXT:    mov r0, r6
...
; LE-I32-NEXT:    vpush {d8, d9, d10, d11, d12, d13, d14, d15}
; LE-I32-NEXT:    bl lrintl
; LE-I32-NEXT:    add r3, sp, #252
; LE-I32-NEXT:    ldr r12, [sp, #248]
; LE-I32-NEXT:    vmov.32 d8[0], r0
; LE-I32-NEXT:    ldm r3, {r1, r2, r3}
; LE-I32-NEXT:    mov r0, r12
; LE-I32-NEXT:    bl lrintl
; LE-I32-NEXT:    add r3, sp, #284
; LE-I32-NEXT:    ldr r12, [sp, #280]
; LE-I32-NEXT:    vmov.32 d10[0], r0
; LE-I32-NEXT:    ldm r3, {r1, r2, r3}
; LE-I32-NEXT:    mov r0, r12
; LE-I32-NEXT:    bl lrintl
...
; LE-I32-NEXT:    mov r0, r12
; LE-I32-NEXT:    bl lrintl
; LE-I32-NEXT:    add r3, sp, #172
; LE-I32-NEXT:    ldr r12, [sp, #168]
; LE-I32-NEXT:    vmov.32 d9[1], r0
; LE-I32-NEXT:    ldm r3, {r1, r2, r3}
; LE-I32-NEXT:    mov r0, r12
; LE-I32-NEXT:    bl lrintl
...
; LE-I32-NEXT:    mov r0, r12
; LE-I32-NEXT:    bl lrintl
; LE-I32-NEXT:    add r3, sp, #236
; LE-I32-NEXT:    ldr r12, [sp, #232]
; LE-I32-NEXT:    vmov.32 d14[1], r0
; LE-I32-NEXT:    ldm r3, {r1, r2, r3}
; LE-I32-NEXT:    mov r0, r12
; LE-I32-NEXT:    bl lrintl
; LE-I32-NEXT:    add r3, sp, #204
...
; LE-I64-NEXT:    mov r0, r7
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    ldr r7, [sp, #288]
; LE-I64-NEXT:    add r3, sp, #292
; LE-I64-NEXT:    str r1, [sp, #60] @ 4-byte Spill
; LE-I64-NEXT:    add lr, sp, #40
; LE-I64-NEXT:    ldm r3, {r1, r2, r3}
; LE-I64-NEXT:    vmov.32 d9[0], r0
...
; LE-I64-NEXT:    vstmia lr, {d8, d9} @ 16-byte Spill
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    ldr r7, [sp, #432]
; LE-I64-NEXT:    add r3, sp, #436
; LE-I64-NEXT:    vmov.32 d16[0], r0
; LE-I64-NEXT:    str r1, [sp, #36] @ 4-byte Spill
; LE-I64-NEXT:    add lr, sp, #16
; LE-I64-NEXT:    ldm r3, {r1, r2, r3}
; LE-I64-NEXT:    mov r0, r7
; LE-I64-NEXT:    vstmia lr, {d16, d17} @ 16-byte Spill
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    ldr r7, [sp, #384]
...
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    add lr, sp, #96
; LE-I64-NEXT:    add r3, sp, #304
; LE-I64-NEXT:    vmov.32 d11[1], r9
; LE-I64-NEXT:    mov r11, r1
; LE-I64-NEXT:    vldmia lr, {d18, d19} @ 16-byte Reload
; LE-I64-NEXT:    add lr, sp, #112
; LE-I64-NEXT:    vmov.32 d15[1], r7
; LE-I64-NEXT:    ldr r7, [sp, #12] @ 4-byte Reload
...
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    add lr, sp, #16
; LE-I64-NEXT:    ldr r7, [sp, #448]
; LE-I64-NEXT:    add r3, sp, #452
; LE-I64-NEXT:    mov r4, r1
; LE-I64-NEXT:    vldmia lr, {d8, d9} @ 16-byte Reload
; LE-I64-NEXT:    ldm r3, {r1, r2, r3}
; LE-I64-NEXT:    vmov.32 d9[0], r0
; LE-I64-NEXT:    mov r0, r7
; LE-I64-NEXT:    bl lrintl
; LE-I64-NEXT:    vorr q10, q4, q4
; LE-I64-NEXT:    vmov.32 d14[0], r0
; LE-I64-NEXT:    ldr r0, [sp, #36] @ 4-byte Reload
; LE-I64-NEXT:    add lr, sp, #40
; LE-I64-NEXT:    vmov.32 d21[1], r4
; LE-I64-NEXT:    vmov.32 d20[1], r0
; LE-I64-NEXT:    ldr r0, [sp, #60] @ 4-byte Reload
; LE-I64-NEXT:    vldmia lr, {d18, d19} @ 16-byte Reload
; LE-I64-NEXT:    add lr, sp, #72
...
; LE-I64-NEXT:    vmov.32 d22[1], r11
; LE-I64-NEXT:    vmov.32 d16[1], r0
; LE-I64-NEXT:    add r0, r8, #96
; LE-I64-NEXT:    vmov.32 d14[1], r1
; LE-I64-NEXT:    vst1.64 {d22, d23}, [r0:128]!
; LE-I64-NEXT:    vst1.64 {d14, d15}, [r0:128]
; LE-I64-NEXT:    add r0, r8, #64
; LE-I64-NEXT:    vst1.64 {d12, d13}, [r0:128]!
; LE-I64-NEXT:    vst1.64 {d10, d11}, [r0:128]
; LE-I64-NEXT:    add r0, r8, #32
; LE-I64-NEXT:    vst1.64 {d20, d21}, [r0:128]!
; LE-I64-NEXT:    vst1.64 {d18, d19}, [r0:128]
; LE-I64-NEXT:    vldmia lr, {d18, d19} @ 16-byte Reload
; LE-I64-NEXT:    vst1.64 {d18, d19}, [r8:128]!
...
; BE-I32-NEXT:    ldr r12, [sp, #152]
; BE-I32-NEXT:    vmov.32 d12[0], r0
; BE-I32-NEXT:    ldm r3, {r1, r2, r3}
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
; BE-I32-NEXT:    add r3, sp, #188
; BE-I32-NEXT:    ldr r12, [sp, #184]
; BE-I32-NEXT:    vmov.32 d13[0], r0
; BE-I32-NEXT:    ldm r3, {r1, r2, r3}
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
; BE-I32-NEXT:    add r3, sp, #220
; BE-I32-NEXT:    ldr r12, [sp, #216]
; BE-I32-NEXT:    vmov.32 d14[0], r0
; BE-I32-NEXT:    ldm r3, {r1, r2, r3}
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
; BE-I32-NEXT:    add r3, sp, #284
; BE-I32-NEXT:    ldr r12, [sp, #280]
; BE-I32-NEXT:    vmov.32 d15[0], r0
; BE-I32-NEXT:    ldm r3, {r1, r2, r3}
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
...
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
; BE-I32-NEXT:    add r3, sp, #236
; BE-I32-NEXT:    ldr r12, [sp, #232]
; BE-I32-NEXT:    vmov.32 d11[1], r0
; BE-I32-NEXT:    ldm r3, {r1, r2, r3}
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
; BE-I32-NEXT:    add r3, sp, #204
; BE-I32-NEXT:    ldr r12, [sp, #200]
; BE-I32-NEXT:    vmov.32 d15[1], r0
; BE-I32-NEXT:    ldm r3, {r1, r2, r3}
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
; BE-I32-NEXT:    add r3, sp, #172
...
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
; BE-I32-NEXT:    add r3, sp, #268
; BE-I32-NEXT:    ldr r12, [sp, #264]
; BE-I32-NEXT:    vmov.32 d9[1], r0
; BE-I32-NEXT:    ldm r3, {r1, r2, r3}
; BE-I32-NEXT:    mov r0, r12
; BE-I32-NEXT:    bl lrintl
...
; BE-I64-NEXT:    vpush {d8, d9, d10, d11, d12, d13, d14, d15}
; BE-I64-NEXT:    .pad #120
; BE-I64-NEXT:    sub sp, sp, #120
; BE-I64-NEXT:    mov r1, r3
; BE-I64-NEXT:    mov r7, r2
; BE-I64-NEXT:    ldr r2, [sp, #224]
; BE-I64-NEXT:    mov r8, r0
; BE-I64-NEXT:    ldr r3, [sp, #228]
; BE-I64-NEXT:    mov r0, r7
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r7, [sp, #424]
; BE-I64-NEXT:    add r3, sp, #428
; BE-I64-NEXT:    str r1, [sp, #64] @ 4-byte Spill
; BE-I64-NEXT:    vmov.32 d14[0], r0
; BE-I64-NEXT:    ldm r3, {r1, r2, r3}
; BE-I64-NEXT:    mov r0, r7
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r7, [sp, #456]
; BE-I64-NEXT:    add r3, sp, #460
; BE-I64-NEXT:    vmov.32 d16[0], r0
; BE-I64-NEXT:    str r1, [sp, #116] @ 4-byte Spill
; BE-I64-NEXT:    ldm r3, {r1, r2, r3}
; BE-I64-NEXT:    mov r0, r7
; BE-I64-NEXT:    vstr d16, [sp, #104] @ 8-byte Spill
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r7, [sp, #248]
; BE-I64-NEXT:    add r3, sp, #252
; BE-I64-NEXT:    vmov.32 d16[0], r0
; BE-I64-NEXT:    str r1, [sp, #100] @ 4-byte Spill
; BE-I64-NEXT:    ldm r3, {r1, r2, r3}
; BE-I64-NEXT:    mov r0, r7
; BE-I64-NEXT:    vstr d16, [sp, #88] @ 8-byte Spill
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r7, [sp, #264]
; BE-I64-NEXT:    add r3, sp, #268
; BE-I64-NEXT:    vmov.32 d16[0], r0
; BE-I64-NEXT:    str r1, [sp, #84] @ 4-byte Spill
; BE-I64-NEXT:    ldm r3, {r1, r2, r3}
; BE-I64-NEXT:    mov r0, r7
; BE-I64-NEXT:    vstr d16, [sp, #72] @ 8-byte Spill
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r7, [sp, #312]
...
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r7, [sp, #280]
; BE-I64-NEXT:    add r3, sp, #284
; BE-I64-NEXT:    vmov.32 d16[0], r0
; BE-I64-NEXT:    str r1, [sp, #28] @ 4-byte Spill
; BE-I64-NEXT:    ldm r3, {r1, r2, r3}
; BE-I64-NEXT:    mov r0, r7
; BE-I64-NEXT:    vstr d16, [sp, #16] @ 8-byte Spill
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r7, [sp, #296]
...
; BE-I64-NEXT:    mov r0, r5
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r4, [sp, #408]
; BE-I64-NEXT:    add r3, sp, #412
; BE-I64-NEXT:    mov r5, r1
; BE-I64-NEXT:    vmov.32 d13[0], r0
; BE-I64-NEXT:    ldm r3, {r1, r2, r3}
; BE-I64-NEXT:    mov r0, r4
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    vmov.32 d12[0], r0
; BE-I64-NEXT:    ldr r0, [sp, #64] @ 4-byte Reload
; BE-I64-NEXT:    add r3, sp, #328
; BE-I64-NEXT:    mov r11, r1
; BE-I64-NEXT:    vmov.32 d8[1], r9
; BE-I64-NEXT:    vmov.32 d14[1], r0
; BE-I64-NEXT:    ldr r0, [sp, #12] @ 4-byte Reload
; BE-I64-NEXT:    vmov.32 d11[1], r7
; BE-I64-NEXT:    ldr r7, [sp, #28] @ 4-byte Reload
; BE-I64-NEXT:    vmov.32 d15[1], r0
; BE-I64-NEXT:    ldm r3, {r0, r1, r2, r3}
; BE-I64-NEXT:    vstr d8, [sp] @ 8-byte Spill
; BE-I64-NEXT:    vorr d8, d15, d15
; BE-I64-NEXT:    vldr d15, [sp, #16] @ 8-byte Reload
; BE-I64-NEXT:    vstr d14, [sp, #64] @ 8-byte Spill
; BE-I64-NEXT:    vmov.32 d13[1], r5
; BE-I64-NEXT:    vmov.32 d10[1], r6
; BE-I64-NEXT:    vmov.32 d9[1], r10
; BE-I64-NEXT:    vmov.32 d15[1], r7
; BE-I64-NEXT:    bl lrintl
; BE-I64-NEXT:    ldr r7, [sp, #440]
...
; BE-I64-NEXT:    vmov.32 d24[0], r0
; BE-I64-NEXT:    ldr r0, [sp, #44] @ 4-byte Reload
; BE-I64-NEXT:    vldr d19, [sp, #32] @ 8-byte Reload
; BE-I64-NEXT:    vldr d18, [sp, #48] @ 8-byte Reload
; BE-I64-NEXT:    vmov.32 d19[1], r0
; BE-I64-NEXT:    ldr r0, [sp, #60] @ 4-byte Reload
; BE-I64-NEXT:    vldr d31, [sp, #72] @ 8-byte Reload
; BE-I64-NEXT:    vmov.32 d18[1], r0
; BE-I64-NEXT:    ldr r0, [sp, #84] @ 4-byte Reload
; BE-I64-NEXT:    vldr d30, [sp, #88] @ 8-byte Reload
; BE-I64-NEXT:    vmov.32 d31[1], r0
; BE-I64-NEXT:    ldr r0, [sp, #100] @ 4-byte Reload
; BE-I64-NEXT:    vldr d25, [sp, #104] @ 8-byte Reload
; BE-I64-NEXT:    vmov.32 d30[1], r0
; BE-I64-NEXT:    ldr r0, [sp, #116] @ 4-byte Reload
; BE-I64-NEXT:    vmov.32 d14[1], r4
; BE-I64-NEXT:    vmov.32 d25[1], r0
; BE-I64-NEXT:    add r0, r8, #96
; BE-I64-NEXT:    vldr d20, [sp] @ 8-byte Reload
; BE-I64-NEXT:    vmov.32 d12[1], r11
; BE-I64-NEXT:    vrev64.32 d23, d20
; BE-I64-NEXT:    vrev64.32 d21, d14
; BE-I64-NEXT:    vrev64.32 d1, d25
; BE-I64-NEXT:    vmov.32 d24[1], r1
; BE-I64-NEXT:    vrev64.32 d20, d19
; BE-I64-NEXT:    vrev64.32 d19, d18
; BE-I64-NEXT:    vrev64.32 d0, d12
; BE-I64-NEXT:    vrev64.32 d18, d31
; BE-I64-NEXT:    vrev64.32 d31, d30
; BE-I64-NEXT:    vldr d16, [sp, #64] @ 8-byte Reload
; BE-I64-NEXT:    vrev64.32 d27, d13
; BE-I64-NEXT:    vrev64.32 d30, d24
; BE-I64-NEXT:    vst1.64 {d0, d1}, [r0:128]!
; BE-I64-NEXT:    vrev64.32 d26, d11
; BE-I64-NEXT:    vrev64.32 d29, d10
; BE-I64-NEXT:    vst1.64 {d30, d31}, [r0:128]
; BE-I64-NEXT:    add r0, r8, #64
; BE-I64-NEXT:    vrev64.32 d28, d9
; BE-I64-NEXT:    vst1.64 {d26, d27}, [r0:128]!
; BE-I64-NEXT:    vrev64.32 d22, d8
; BE-I64-NEXT:    vrev64.32 d16, d16
; BE-I64-NEXT:    vst1.64 {d28, d29}, [r0:128]
; BE-I64-NEXT:    add r0, r8, #32
; BE-I64-NEXT:    vst1.64 {d22, d23}, [r0:128]!
; BE-I64-NEXT:    vrev64.32 d17, d15
; BE-I64-NEXT:    vst1.64 {d20, d21}, [r0:128]
; BE-I64-NEXT:    vst1.64 {d16, d17}, [r8:128]!
; BE-I64-NEXT:    vst1.64 {d18, d19}, [r8:128]
; BE-I64-NEXT:    add sp, sp, #120
; BE-I64-NEXT:    vpop {d8, d9, d10, d11, d12, d13, d14, d15}
; BE-I64-NEXT:    add sp, sp, #4
; BE-I64-NEXT:    pop {r4, r5, r6, r7, r8, r9, r10, r11, pc}
