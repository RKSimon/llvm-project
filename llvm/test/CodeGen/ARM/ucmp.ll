...
; CHECK-NEXT:    mov r6, #0
; CHECK-NEXT:    ldr lr, [sp, #28]
; CHECK-NEXT:    subs r7, r0, r12
; CHECK-NEXT:    ldr r4, [sp, #32]
; CHECK-NEXT:    sbcs r7, r1, lr
; CHECK-NEXT:    ldr r5, [sp, #36]
; CHECK-NEXT:    sbcs r7, r2, r4
; CHECK-NEXT:    sbcs r7, r3, r5
; CHECK-NEXT:    mov r7, #0
; CHECK-NEXT:    movwlo r7, #1
; CHECK-NEXT:    subs r0, r12, r0
; CHECK-NEXT:    sbcs r0, lr, r1
; CHECK-NEXT:    sbcs r0, r4, r2
; CHECK-NEXT:    sbcs r0, r5, r3
