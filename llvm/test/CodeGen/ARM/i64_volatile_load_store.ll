...
; CHECK-ARMV5TE-NEXT:    ldrb r2, [r0, #4]
; CHECK-ARMV5TE-NEXT:    ldrb r4, [r0, #5]
; CHECK-ARMV5TE-NEXT:    ldrb r5, [r0, #6]
; CHECK-ARMV5TE-NEXT:    ldrb r0, [r0, #7]
; CHECK-ARMV5TE-NEXT:    strb r0, [r6, #7]
; CHECK-ARMV5TE-NEXT:    strb r5, [r6, #6]
; CHECK-ARMV5TE-NEXT:    strb r4, [r6, #5]
; CHECK-ARMV5TE-NEXT:    strb r2, [r6, #4]
...
; CHECK-ARMV4T-NEXT:    ldrb r2, [r0, #4]
; CHECK-ARMV4T-NEXT:    ldrb r4, [r0, #5]
; CHECK-ARMV4T-NEXT:    ldrb r5, [r0, #6]
; CHECK-ARMV4T-NEXT:    ldrb r0, [r0, #7]
; CHECK-ARMV4T-NEXT:    strb r0, [r6, #7]
; CHECK-ARMV4T-NEXT:    strb r5, [r6, #6]
; CHECK-ARMV4T-NEXT:    strb r4, [r6, #5]
; CHECK-ARMV4T-NEXT:    strb r2, [r6, #4]
...
; CHECK-ARMV7-STRICT-NEXT:    ldrb r2, [r0, #4]
; CHECK-ARMV7-STRICT-NEXT:    ldrb r4, [r0, #5]
; CHECK-ARMV7-STRICT-NEXT:    ldrb r5, [r0, #6]
; CHECK-ARMV7-STRICT-NEXT:    ldrb r0, [r0, #7]
; CHECK-ARMV7-STRICT-NEXT:    strb r0, [r6, #7]
; CHECK-ARMV7-STRICT-NEXT:    strb r5, [r6, #6]
; CHECK-ARMV7-STRICT-NEXT:    strb r4, [r6, #5]
; CHECK-ARMV7-STRICT-NEXT:    strb r2, [r6, #4]
...
; CHECK-ARMV6-STRICT-NEXT:    ldrb r2, [r0, #4]
; CHECK-ARMV6-STRICT-NEXT:    ldrb r4, [r0, #5]
; CHECK-ARMV6-STRICT-NEXT:    ldrb r5, [r0, #6]
; CHECK-ARMV6-STRICT-NEXT:    ldrb r0, [r0, #7]
; CHECK-ARMV6-STRICT-NEXT:    strb r0, [r6, #7]
; CHECK-ARMV6-STRICT-NEXT:    strb r5, [r6, #6]
; CHECK-ARMV6-STRICT-NEXT:    strb r4, [r6, #5]
; CHECK-ARMV6-STRICT-NEXT:    strb r2, [r6, #4]
