...
; CHECK-THUMBv6-NEXT:    ldrh r2, [r0]
; CHECK-THUMBv6-NEXT:    rev16 r2, r2
...
; CHECK-THUMBv7-NEXT:    ldrh r2, [r0]
; CHECK-THUMBv7-NEXT:    rev16 r2, r2
; CHECK-THUMBv7-NEXT:    adds r1, r2, r1
...
; CHECK-ARMv6:       @ %bb.0:
; CHECK-ARMv6-NEXT:    ldrb r1, [r0, #3]
; CHECK-ARMv6-NEXT:    ldrb r2, [r0, #4]
; CHECK-ARMv6-NEXT:    ldrh r0, [r0, #1]
; CHECK-ARMv6-NEXT:    rev16 r0, r0
; CHECK-ARMv6-NEXT:    orr r0, r0, r1, lsl #16
; CHECK-ARMv6-NEXT:    orr r0, r0, r2, lsl #24
; CHECK-ARMv6-NEXT:    bx lr
...
; CHECK-THUMBv7-NEXT:    ldrh r1, [r0, r1]
; CHECK-THUMBv7-NEXT:    rev16 r1, r1
; CHECK-THUMBv7-NEXT:    ldrb r2, [r0, #3]
; CHECK-THUMBv7-NEXT:    lsls r2, r2, #16
; CHECK-THUMBv7-NEXT:    adds r1, r1, r2
; CHECK-THUMBv7-NEXT:    ldrb r0, [r0, #4]
; CHECK-THUMBv7-NEXT:    lsls r0, r0, #24
; CHECK-THUMBv7-NEXT:    adds r0, r1, r0
; CHECK-THUMBv7-NEXT:    bx lr
...
; CHECK-THUMBv6:       @ %bb.0:
; CHECK-THUMBv6-NEXT:    subs r1, r0, #2
; CHECK-THUMBv6-NEXT:    ldrb r1, [r1]
; CHECK-THUMBv6-NEXT:    lsls r1, r1, #16
; CHECK-THUMBv6-NEXT:    subs r2, r0, #4
; CHECK-THUMBv6-NEXT:    ldrh r2, [r2]
; CHECK-THUMBv6-NEXT:    rev16 r2, r2
; CHECK-THUMBv6-NEXT:    adds r1, r2, r1
; CHECK-THUMBv6-NEXT:    subs r0, r0, #1
...
; CHECK-THUMBv7:       @ %bb.0:
; CHECK-THUMBv7-NEXT:    subs r1, r0, #2
; CHECK-THUMBv7-NEXT:    ldrb r1, [r1]
; CHECK-THUMBv7-NEXT:    lsls r1, r1, #16
; CHECK-THUMBv7-NEXT:    subs r2, r0, #4
; CHECK-THUMBv7-NEXT:    ldrh r2, [r2]
; CHECK-THUMBv7-NEXT:    rev16 r2, r2
; CHECK-THUMBv7-NEXT:    adds r1, r2, r1
; CHECK-THUMBv7-NEXT:    subs r0, r0, #1
...
; CHECK-ARMv6-NEXT:    ldrb r1, [r0, #14]
; CHECK-ARMv6-NEXT:    ldrb r2, [r0, #15]
; CHECK-ARMv6-NEXT:    ldrh r0, [r0, #12]
; CHECK-ARMv6-NEXT:    rev16 r0, r0
; CHECK-ARMv6-NEXT:    orr r0, r0, r1, lsl #16
; CHECK-ARMv6-NEXT:    orr r0, r0, r2, lsl #24
; CHECK-ARMv6-NEXT:    bx lr
...
; CHECK-THUMBv6-NEXT:    ldrb r1, [r0, #14]
; CHECK-THUMBv6-NEXT:    lsls r1, r1, #16
; CHECK-THUMBv6-NEXT:    ldrh r2, [r0, #12]
; CHECK-THUMBv6-NEXT:    rev16 r2, r2
; CHECK-THUMBv6-NEXT:    adds r1, r2, r1
; CHECK-THUMBv6-NEXT:    ldrb r0, [r0, #15]
; CHECK-THUMBv6-NEXT:    lsls r0, r0, #24
; CHECK-THUMBv6-NEXT:    adds r0, r1, r0
; CHECK-THUMBv6-NEXT:    bx lr
;
...
; CHECK-THUMBv7-NEXT:    ldrb r1, [r0, #14]
; CHECK-THUMBv7-NEXT:    lsls r1, r1, #16
; CHECK-THUMBv7-NEXT:    ldrh r2, [r0, #12]
; CHECK-THUMBv7-NEXT:    rev16 r2, r2
; CHECK-THUMBv7-NEXT:    adds r1, r2, r1
; CHECK-THUMBv7-NEXT:    ldrb r0, [r0, #15]
; CHECK-THUMBv7-NEXT:    lsls r0, r0, #24
; CHECK-THUMBv7-NEXT:    adds r0, r1, r0
; CHECK-THUMBv7-NEXT:    bx lr
...
; CHECK-ARMv6:       @ %bb.0:
; CHECK-ARMv6-NEXT:    add r0, r0, r1
; CHECK-ARMv6-NEXT:    ldrb r1, [r0, #15]
; CHECK-ARMv6-NEXT:    ldrb r2, [r0, #16]
; CHECK-ARMv6-NEXT:    ldrh r0, [r0, #13]
; CHECK-ARMv6-NEXT:    rev16 r0, r0
; CHECK-ARMv6-NEXT:    orr r0, r0, r1, lsl #16
; CHECK-ARMv6-NEXT:    orr r0, r0, r2, lsl #24
; CHECK-ARMv6-NEXT:    bx lr
...
; CHECK-THUMBv6:       @ %bb.0:
; CHECK-THUMBv6-NEXT:    adds r0, r0, r1
; CHECK-THUMBv6-NEXT:    ldrb r1, [r0, #15]
; CHECK-THUMBv6-NEXT:    lsls r1, r1, #16
; CHECK-THUMBv6-NEXT:    movs r2, #13
; CHECK-THUMBv6-NEXT:    ldrh r2, [r0, r2]
; CHECK-THUMBv6-NEXT:    rev16 r2, r2
; CHECK-THUMBv6-NEXT:    adds r1, r2, r1
; CHECK-THUMBv6-NEXT:    ldrb r0, [r0, #16]
; CHECK-THUMBv6-NEXT:    lsls r0, r0, #24
; CHECK-THUMBv6-NEXT:    adds r0, r1, r0
; CHECK-THUMBv6-NEXT:    bx lr
;
...
; CHECK-THUMBv7:       @ %bb.0:
; CHECK-THUMBv7-NEXT:    adds r0, r0, r1
; CHECK-THUMBv7-NEXT:    ldrb r1, [r0, #15]
; CHECK-THUMBv7-NEXT:    lsls r1, r1, #16
; CHECK-THUMBv7-NEXT:    movs r2, #13
; CHECK-THUMBv7-NEXT:    ldrh r2, [r0, r2]
; CHECK-THUMBv7-NEXT:    rev16 r2, r2
; CHECK-THUMBv7-NEXT:    adds r1, r2, r1
; CHECK-THUMBv7-NEXT:    ldrb r0, [r0, #16]
; CHECK-THUMBv7-NEXT:    lsls r0, r0, #24
; CHECK-THUMBv7-NEXT:    adds r0, r1, r0
; CHECK-THUMBv7-NEXT:    bx lr
