...
; THUMBV6-NEXT:    mov r1, r5
; THUMBV6-NEXT:    str r7, [sp, #12] @ 4-byte Spill
...
; THUMBV6-NEXT:    add r0, sp, #88
; THUMBV6-NEXT:    ldr r0, [r0, #4]
; THUMBV6-NEXT:    str r0, [sp, #28] @ 4-byte Spill
; THUMBV6-NEXT:    mov r1, r5
; THUMBV6-NEXT:    ldr r4, [sp, #8] @ 4-byte Reload
...
; THUMBV6-NEXT:    str r2, [sp] @ 4-byte Spill
...
; THUMBV6-NEXT:    ldr r6, [sp, #20] @ 4-byte Reload
...
; THUMBV6-NEXT:    ldr r3, [sp, #28] @ 4-byte Reload
