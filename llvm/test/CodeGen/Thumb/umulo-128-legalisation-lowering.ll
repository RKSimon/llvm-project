...
; THUMBV6-NEXT:    str r2, [sp, #16] @ 4-byte Spill
...
; THUMBV6-NEXT:    ldr r0, [r6, #4]
; THUMBV6-NEXT:    str r0, [sp, #56] @ 4-byte Spill
; THUMBV6-NEXT:    ldr r7, [sp, #96]
; THUMBV6-NEXT:    mov r1, r5
; THUMBV6-NEXT:    mov r2, r7
; THUMBV6-NEXT:    mov r3, r5
; THUMBV6-NEXT:    bl __aeabi_lmul
...
; THUMBV6-NEXT:    str r2, [sp, #12] @ 4-byte Spill
...
; THUMBV6-NEXT:    subs r0, r6, #1
; THUMBV6-NEXT:    sbcs r6, r0
; THUMBV6-NEXT:    ldr r4, [sp, #40] @ 4-byte Reload
; THUMBV6-NEXT:    subs r0, r4, #1
; THUMBV6-NEXT:    sbcs r4, r0
; THUMBV6-NEXT:    ldr r3, [sp, #64] @ 4-byte Reload
; THUMBV6-NEXT:    subs r0, r3, #1
; THUMBV6-NEXT:    sbcs r3, r0
; THUMBV6-NEXT:    ldr r0, [sp, #60] @ 4-byte Reload
; THUMBV6-NEXT:    subs r1, r0, #1
; THUMBV6-NEXT:    sbcs r0, r1
; THUMBV6-NEXT:    ands r0, r3
...
; THUMBV6-NEXT:    subs r1, r2, #1
; THUMBV6-NEXT:    sbcs r2, r1
; THUMBV6-NEXT:    str r2, [sp, #68] @ 4-byte Spill
; THUMBV6-NEXT:    ldr r6, [sp, #28] @ 4-byte Reload
; THUMBV6-NEXT:    subs r1, r6, #1
; THUMBV6-NEXT:    sbcs r6, r1
; THUMBV6-NEXT:    ldr r2, [sp, #56] @ 4-byte Reload
; THUMBV6-NEXT:    subs r1, r2, #1
; THUMBV6-NEXT:    sbcs r2, r1
; THUMBV6-NEXT:    mov r4, r2
; THUMBV6-NEXT:    ldr r3, [sp, #36] @ 4-byte Reload
; THUMBV6-NEXT:    subs r2, r3, #1
; THUMBV6-NEXT:    mov r1, r3
; THUMBV6-NEXT:    sbcs r1, r2
; THUMBV6-NEXT:    ands r1, r4
