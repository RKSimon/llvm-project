...
; CHECK-SM100-NEXT:    mov.b64 %rd3, 0;
; CHECK-SM100-NEXT:    st.b32 [%rd3], %rd2;
; CHECK-SM100-NEXT:    cvt.u64.u16 %rd4, %rs2;
; CHECK-SM100-NEXT:    mov.b64 %rd5, 12;
; CHECK-SM100-NEXT:    st.b32 [%rd5], %rd4;
; CHECK-SM100-NEXT:    mov.b64 %rd6, 8;
; CHECK-SM100-NEXT:    st.b32 [%rd6], %rd1;
; CHECK-SM100-NEXT:    mov.b64 %rd7, 4;
; CHECK-SM100-NEXT:    st.b32 [%rd7], 0;
; CHECK-SM100-NEXT:    ret;
...
; CHECK-SM100-NEXT:    mov.b64 %rd3, 0;
; CHECK-SM100-NEXT:    st.b32 [%rd3], %rd2;
; CHECK-SM100-NEXT:    mov.b64 %rd4, 12;
; CHECK-SM100-NEXT:    st.b32 [%rd4], %r3;
; CHECK-SM100-NEXT:    mov.b64 %rd5, 8;
; CHECK-SM100-NEXT:    st.b32 [%rd5], %rd1;
; CHECK-SM100-NEXT:    mov.b64 %rd6, 4;
; CHECK-SM100-NEXT:    st.b32 [%rd6], 0;
; CHECK-SM100-NEXT:    ret;
