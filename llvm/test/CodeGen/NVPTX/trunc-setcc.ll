...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [trunc_nsw_singed_const_param_0];
; CHECK-NEXT:    add.s16 %rs2, %rs1, 1;
; CHECK-NEXT:    cvt.s16.s8 %rs3, %rs2;
; CHECK-NEXT:    setp.gt.s16 %p1, %rs3, -1;
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [trunc_nuw_unsinged_const_param_0];
; CHECK-NEXT:    add.s16 %rs2, %rs1, 1;
; CHECK-NEXT:    and.b16 %rs3, %rs2, 255;
; CHECK-NEXT:    setp.gt.u16 %p1, %rs3, 100;
; CHECK-NEXT:    selp.b32 %r1, -1, 0, %p1;
; CHECK-NEXT:    st.param.b32 [func_retval0], %r1;
; CHECK-NEXT:    ret;
  %a2 = add i32 %a, 1
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [trunc_nsw_eq_const_param_0];
; CHECK-NEXT:    setp.eq.b16 %p1, %rs1, 99;
; CHECK-NEXT:    selp.b32 %r1, -1, 0, %p1;
; CHECK-NEXT:    st.param.b32 [func_retval0], %r1;
; CHECK-NEXT:    ret;
  %a2 = add i32 %a, 1
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [trunc_nuw_eq_const_param_0];
; CHECK-NEXT:    setp.eq.b16 %p1, %rs1, 99;
; CHECK-NEXT:    selp.b32 %r1, -1, 0, %p1;
; CHECK-NEXT:    st.param.b32 [func_retval0], %r1;
; CHECK-NEXT:    ret;
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [trunc_nsw_singed_param_0];
; CHECK-NEXT:    ld.param.b8 %rs2, [trunc_nsw_singed_param_1];
; CHECK-NEXT:    add.s16 %rs3, %rs1, 1;
; CHECK-NEXT:    cvt.s16.s8 %rs4, %rs3;
; CHECK-NEXT:    add.s16 %rs5, %rs2, 7;
; CHECK-NEXT:    cvt.s16.s8 %rs6, %rs5;
; CHECK-NEXT:    setp.gt.s16 %p1, %rs4, %rs6;
; CHECK-NEXT:    selp.b32 %r1, -1, 0, %p1;
; CHECK-NEXT:    st.param.b32 [func_retval0], %r1;
; CHECK-NEXT:    ret;
  %b1 = add i32 %a1, 1
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [trunc_nuw_unsinged_param_0];
; CHECK-NEXT:    ld.param.b8 %rs2, [trunc_nuw_unsinged_param_1];
; CHECK-NEXT:    add.s16 %rs3, %rs1, 1;
; CHECK-NEXT:    and.b16 %rs4, %rs3, 255;
; CHECK-NEXT:    add.s16 %rs5, %rs2, 5;
; CHECK-NEXT:    and.b16 %rs6, %rs5, 255;
; CHECK-NEXT:    setp.gt.u16 %p1, %rs4, %rs6;
; CHECK-NEXT:    selp.b32 %r1, -1, 0, %p1;
; CHECK-NEXT:    st.param.b32 [func_retval0], %r1;
; CHECK-NEXT:    ret;
  %b1 = add i32 %a1, 1
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [trunc_nsw_eq_param_0];
; CHECK-NEXT:    ld.param.b8 %rs2, [trunc_nsw_eq_param_1];
; CHECK-NEXT:    add.s16 %rs3, %rs1, 1;
; CHECK-NEXT:    and.b16 %rs4, %rs3, 255;
; CHECK-NEXT:    add.s16 %rs5, %rs2, 3;
; CHECK-NEXT:    and.b16 %rs6, %rs5, 255;
; CHECK-NEXT:    setp.eq.b16 %p1, %rs4, %rs6;
; CHECK-NEXT:    selp.b32 %r1, -1, 0, %p1;
; CHECK-NEXT:    st.param.b32 [func_retval0], %r1;
; CHECK-NEXT:    ret;
  %b1 = add i32 %a1, 1
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [trunc_nuw_eq_param_0];
; CHECK-NEXT:    ld.param.b8 %rs2, [trunc_nuw_eq_param_1];
; CHECK-NEXT:    add.s16 %rs3, %rs1, 2;
; CHECK-NEXT:    and.b16 %rs4, %rs3, 255;
; CHECK-NEXT:    add.s16 %rs5, %rs2, 1;
; CHECK-NEXT:    and.b16 %rs6, %rs5, 255;
; CHECK-NEXT:    setp.eq.b16 %p1, %rs4, %rs6;
; CHECK-NEXT:    selp.b32 %r1, -1, 0, %p1;
; CHECK-NEXT:    st.param.b32 [func_retval0], %r1;
