...
; CHECK-NEXT:    ld.b8 %r1, [%rd1+2];
; CHECK-NEXT:    shl.b32 %r2, %r1, 16;
; CHECK-NEXT:    ld.b8 %r3, [%rd1+3];
; CHECK-NEXT:    shl.b32 %r4, %r3, 24;
; CHECK-NEXT:    or.b32 %r5, %r4, %r2;
; CHECK-NEXT:    ld.b8 %r6, [%rd1];
; CHECK-NEXT:    ld.b8 %r7, [%rd1+1];
; CHECK-NEXT:    st.b8 [%rd2+1], %r7;
; CHECK-NEXT:    st.b8 [%rd2], %r6;
; CHECK-NEXT:    st.b8 [%rd2+3], %r3;
; CHECK-NEXT:    shr.u32 %r8, %r5, 16;
; CHECK-NEXT:    st.b8 [%rd2+2], %r8;
; CHECK-NEXT:    ret;
