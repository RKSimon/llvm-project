...
; CHECK-NEXT:    shr.u32 %r16, %r11, 8;
; CHECK-NEXT:    st.param.b8 [func_retval0+6], %r16;
; CHECK-NEXT:    shr.u32 %r17, %r15, 24;
; CHECK-NEXT:    st.param.b8 [func_retval0+8], %r17;
; CHECK-NEXT:    shr.u32 %r18, %r15, 16;
...
; CHECK-NEXT:    shl.b64 %rd20, %rd18, 8;
; CHECK-NEXT:    or.b64 %rd21, %rd20, %rd19;
; CHECK-NEXT:    shl.b64 %rd22, %rd17, 16;
; CHECK-NEXT:    shl.b64 %rd23, %rd16, 24;
; CHECK-NEXT:    or.b64 %rd24, %rd23, %rd22;
; CHECK-NEXT:    or.b64 %rd25, %rd24, %rd21;
; CHECK-NEXT:    shl.b64 %rd26, %rd14, 8;
; CHECK-NEXT:    or.b64 %rd27, %rd26, %rd15;
; CHECK-NEXT:    shl.b64 %rd28, %rd13, 16;
; CHECK-NEXT:    shl.b64 %rd29, %rd12, 24;
; CHECK-NEXT:    or.b64 %rd30, %rd29, %rd28;
; CHECK-NEXT:    or.b64 %rd31, %rd30, %rd27;
; CHECK-NEXT:    shl.b64 %rd32, %rd31, 32;
; CHECK-NEXT:    or.b64 %rd33, %rd32, %rd25;
...
; CHECK-NEXT:    shr.u64 %rd34, %rd21, 8;
; CHECK-NEXT:    st.param.b8 [func_retval0+10], %rd34;
; CHECK-NEXT:    shr.u64 %rd35, %rd25, 24;
; CHECK-NEXT:    st.param.b8 [func_retval0+12], %rd35;
; CHECK-NEXT:    shr.u64 %rd36, %rd25, 16;
; CHECK-NEXT:    st.param.b8 [func_retval0+11], %rd36;
; CHECK-NEXT:    shr.u64 %rd37, %rd33, 56;
; CHECK-NEXT:    st.param.b8 [func_retval0+16], %rd37;
; CHECK-NEXT:    shr.u64 %rd38, %rd33, 48;
; CHECK-NEXT:    st.param.b8 [func_retval0+15], %rd38;
; CHECK-NEXT:    shr.u64 %rd39, %rd33, 40;
; CHECK-NEXT:    st.param.b8 [func_retval0+14], %rd39;
; CHECK-NEXT:    shr.u64 %rd40, %rd33, 32;
; CHECK-NEXT:    st.param.b8 [func_retval0+13], %rd40;
; CHECK-NEXT:    ret;
