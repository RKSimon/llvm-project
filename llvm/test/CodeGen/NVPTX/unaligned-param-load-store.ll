...
; CHECK-NEXT:    shr.u32 %r21, %r13, 8;
; CHECK-NEXT:    st.param.b8 [func_retval0+6], %r21;
; CHECK-NEXT:    shr.u32 %r22, %r19, 24;
; CHECK-NEXT:    st.param.b8 [func_retval0+8], %r22;
; CHECK-NEXT:    shr.u32 %r23, %r19, 16;
; CHECK-NEXT:    st.param.b8 [func_retval0+7], %r23;
; CHECK-NEXT:    ret;
...
; CHECK-NEXT:    ld.param.b16 %rs1, [test_s_i8i64p_param_0+8];
; CHECK-NEXT:    ld.param.b64 %rd2, [test_s_i8i64p_param_0+24];
; CHECK-NEXT:    ld.param.b8 %rd3, [test_s_i8i64p_param_0+10];
; CHECK-NEXT:    ld.param.b8 %rd4, [test_s_i8i64p_param_0+11];
; CHECK-NEXT:    ld.param.b8 %rd5, [test_s_i8i64p_param_0+12];
; CHECK-NEXT:    ld.param.b8 %rd6, [test_s_i8i64p_param_0+13];
; CHECK-NEXT:    ld.param.b8 %rd7, [test_s_i8i64p_param_0+14];
; CHECK-NEXT:    ld.param.b8 %rd8, [test_s_i8i64p_param_0+15];
; CHECK-NEXT:    ld.param.b8 %rd9, [test_s_i8i64p_param_0+16];
; CHECK-NEXT:    { // callseq 2, 0
; CHECK-NEXT:    .param .align 8 .b8 param0[32];
; CHECK-NEXT:    .param .align 8 .b8 retval0[32];
; CHECK-NEXT:    st.param.b8 [param0+16], %rd9;
; CHECK-NEXT:    st.param.b8 [param0+15], %rd8;
; CHECK-NEXT:    st.param.b8 [param0+14], %rd7;
; CHECK-NEXT:    st.param.b8 [param0+13], %rd6;
; CHECK-NEXT:    st.param.b8 [param0+12], %rd5;
; CHECK-NEXT:    st.param.b8 [param0+11], %rd4;
; CHECK-NEXT:    st.param.b8 [param0+10], %rd3;
; CHECK-NEXT:    st.param.b64 [param0+24], %rd2;
; CHECK-NEXT:    st.param.b16 [param0+8], %rs1;
; CHECK-NEXT:    st.param.b64 [param0], %rd1;
; CHECK-NEXT:    call.uni (retval0), test_s_i8i64p, (param0);
; CHECK-NEXT:    ld.param.b8 %rs2, [retval0+8];
; CHECK-NEXT:    ld.param.b64 %rd10, [retval0];
; CHECK-NEXT:    ld.param.b64 %rd11, [retval0+24];
; CHECK-NEXT:    ld.param.b8 %rd12, [retval0+16];
; CHECK-NEXT:    ld.param.b8 %rd13, [retval0+15];
; CHECK-NEXT:    ld.param.b8 %rd14, [retval0+14];
; CHECK-NEXT:    ld.param.b8 %rd15, [retval0+13];
; CHECK-NEXT:    ld.param.b8 %rd16, [retval0+12];
; CHECK-NEXT:    ld.param.b8 %rd17, [retval0+11];
; CHECK-NEXT:    ld.param.b8 %rd18, [retval0+10];
; CHECK-NEXT:    ld.param.b8 %rd19, [retval0+9];
; CHECK-NEXT:    } // callseq 2
; CHECK-NEXT:    shl.b64 %rd22, %rd18, 8;
; CHECK-NEXT:    or.b64 %rd23, %rd22, %rd19;
; CHECK-NEXT:    shl.b64 %rd25, %rd17, 16;
; CHECK-NEXT:    shl.b64 %rd27, %rd16, 24;
; CHECK-NEXT:    or.b64 %rd28, %rd27, %rd25;
; CHECK-NEXT:    or.b64 %rd29, %rd28, %rd23;
; CHECK-NEXT:    shl.b64 %rd32, %rd14, 8;
; CHECK-NEXT:    or.b64 %rd33, %rd32, %rd15;
; CHECK-NEXT:    shl.b64 %rd35, %rd13, 16;
; CHECK-NEXT:    shl.b64 %rd37, %rd12, 24;
; CHECK-NEXT:    or.b64 %rd38, %rd37, %rd35;
; CHECK-NEXT:    or.b64 %rd39, %rd38, %rd33;
; CHECK-NEXT:    shl.b64 %rd40, %rd39, 32;
; CHECK-NEXT:    or.b64 %rd41, %rd40, %rd29;
; CHECK-NEXT:    st.param.b8 [func_retval0+9], %rd19;
; CHECK-NEXT:    st.param.b8 [func_retval0+8], %rs2;
; CHECK-NEXT:    st.param.b64 [func_retval0], %rd10;
; CHECK-NEXT:    st.param.b64 [func_retval0+24], %rd11;
; CHECK-NEXT:    shr.u64 %rd44, %rd23, 8;
; CHECK-NEXT:    st.param.b8 [func_retval0+10], %rd44;
; CHECK-NEXT:    shr.u64 %rd45, %rd29, 24;
; CHECK-NEXT:    st.param.b8 [func_retval0+12], %rd45;
; CHECK-NEXT:    shr.u64 %rd46, %rd29, 16;
; CHECK-NEXT:    st.param.b8 [func_retval0+11], %rd46;
; CHECK-NEXT:    shr.u64 %rd47, %rd41, 56;
; CHECK-NEXT:    st.param.b8 [func_retval0+16], %rd47;
; CHECK-NEXT:    shr.u64 %rd48, %rd41, 48;
; CHECK-NEXT:    st.param.b8 [func_retval0+15], %rd48;
; CHECK-NEXT:    shr.u64 %rd49, %rd41, 40;
; CHECK-NEXT:    st.param.b8 [func_retval0+14], %rd49;
; CHECK-NEXT:    shr.u64 %rd50, %rd41, 32;
; CHECK-NEXT:    st.param.b8 [func_retval0+13], %rd50;
; CHECK-NEXT:    ret;
...
; CHECK-NEXT:    ld.param.b16 %rs1, [test_s_i8f64p_param_0+8];
; CHECK-NEXT:    ld.param.b64 %rd2, [test_s_i8f64p_param_0+24];
; CHECK-NEXT:    ld.param.b8 %rd3, [test_s_i8f64p_param_0+10];
; CHECK-NEXT:    ld.param.b8 %rd4, [test_s_i8f64p_param_0+11];
; CHECK-NEXT:    ld.param.b8 %rd5, [test_s_i8f64p_param_0+12];
; CHECK-NEXT:    ld.param.b8 %rd6, [test_s_i8f64p_param_0+13];
; CHECK-NEXT:    ld.param.b8 %rd7, [test_s_i8f64p_param_0+14];
; CHECK-NEXT:    ld.param.b8 %rd8, [test_s_i8f64p_param_0+15];
; CHECK-NEXT:    ld.param.b8 %rd9, [test_s_i8f64p_param_0+16];
