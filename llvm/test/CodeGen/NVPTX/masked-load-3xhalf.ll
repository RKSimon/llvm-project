...
; CHECK-NEXT:    mov.b32 {_, %rs1}, %r1;
; CHECK-NEXT:    ld.b16 %rs2, [%rd1+4];
; CHECK-NEXT:    mov.b32 %r2, {%rs2, %rs1};
; CHECK-NEXT:    ld.b32 %rd2, [%rd1];
; CHECK-NEXT:    cvt.u32.u64 %r3, %rd2;
...
; CHECK-NEXT:    mov.b32 %r6, {%rs4, %rs1};
; CHECK-NEXT:    ld.b32 %rd3, [%rd1+6];
; CHECK-NEXT:    cvt.u32.u64 %r7, %rd3;
