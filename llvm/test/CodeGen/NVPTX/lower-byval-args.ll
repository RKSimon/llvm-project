...
; PTX-NEXT:    ld.volatile.b8 %rd4, [%rd1+8];
; PTX-NEXT:    ld.volatile.b8 %rd5, [%rd1+9];
; PTX-NEXT:    shl.b64 %rd6, %rd5, 8;
; PTX-NEXT:    or.b64 %rd7, %rd6, %rd4;
; PTX-NEXT:    ld.volatile.b8 %rd8, [%rd1+10];
; PTX-NEXT:    shl.b64 %rd9, %rd8, 16;
; PTX-NEXT:    ld.volatile.b8 %rd10, [%rd1+11];
; PTX-NEXT:    shl.b64 %rd11, %rd10, 24;
; PTX-NEXT:    or.b64 %rd12, %rd11, %rd9;
; PTX-NEXT:    or.b64 %rd13, %rd12, %rd7;
; PTX-NEXT:    ld.volatile.b8 %rd14, [%rd1+12];
; PTX-NEXT:    ld.volatile.b8 %rd15, [%rd1+13];
; PTX-NEXT:    shl.b64 %rd16, %rd15, 8;
; PTX-NEXT:    or.b64 %rd17, %rd16, %rd14;
; PTX-NEXT:    ld.volatile.b8 %rd18, [%rd1+14];
; PTX-NEXT:    shl.b64 %rd19, %rd18, 16;
; PTX-NEXT:    ld.volatile.b8 %rd20, [%rd1+15];
...
; PTX-NEXT:    st.volatile.b64 [%SP+8], %rd25;
; PTX-NEXT:    ld.volatile.b8 %rd26, [%rd1];
; PTX-NEXT:    ld.volatile.b8 %rd27, [%rd1+1];
; PTX-NEXT:    shl.b64 %rd28, %rd27, 8;
; PTX-NEXT:    or.b64 %rd29, %rd28, %rd26;
; PTX-NEXT:    ld.volatile.b8 %rd30, [%rd1+2];
; PTX-NEXT:    shl.b64 %rd31, %rd30, 16;
; PTX-NEXT:    ld.volatile.b8 %rd32, [%rd1+3];
; PTX-NEXT:    shl.b64 %rd33, %rd32, 24;
; PTX-NEXT:    or.b64 %rd34, %rd33, %rd31;
; PTX-NEXT:    or.b64 %rd35, %rd34, %rd29;
; PTX-NEXT:    ld.volatile.b8 %rd36, [%rd1+4];
; PTX-NEXT:    ld.volatile.b8 %rd37, [%rd1+5];
; PTX-NEXT:    shl.b64 %rd38, %rd37, 8;
; PTX-NEXT:    or.b64 %rd39, %rd38, %rd36;
; PTX-NEXT:    ld.volatile.b8 %rd40, [%rd1+6];
; PTX-NEXT:    shl.b64 %rd41, %rd40, 16;
; PTX-NEXT:    ld.volatile.b8 %rd42, [%rd1+7];
...
; PTX-NEXT:    st.volatile.b64 [%SP], %rd47;
; PTX-NEXT:    ret;
entry:
