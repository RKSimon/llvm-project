...
; PTX-NEXT:    st.local.b32 [%rd2], %r2;
; PTX-NEXT:    ld.volatile.b8 %rd3, [%rd1+8];
; PTX-NEXT:    ld.volatile.b8 %rd4, [%rd1+9];
; PTX-NEXT:    shl.b64 %rd5, %rd4, 8;
; PTX-NEXT:    or.b64 %rd6, %rd5, %rd3;
; PTX-NEXT:    ld.volatile.b8 %rd7, [%rd1+10];
; PTX-NEXT:    shl.b64 %rd8, %rd7, 16;
; PTX-NEXT:    ld.volatile.b8 %rd9, [%rd1+11];
; PTX-NEXT:    shl.b64 %rd10, %rd9, 24;
; PTX-NEXT:    or.b64 %rd11, %rd10, %rd8;
; PTX-NEXT:    or.b64 %rd12, %rd11, %rd6;
; PTX-NEXT:    ld.volatile.b8 %rd13, [%rd1+12];
; PTX-NEXT:    ld.volatile.b8 %rd14, [%rd1+13];
; PTX-NEXT:    shl.b64 %rd15, %rd14, 8;
; PTX-NEXT:    or.b64 %rd16, %rd15, %rd13;
; PTX-NEXT:    ld.volatile.b8 %rd17, [%rd1+14];
; PTX-NEXT:    shl.b64 %rd18, %rd17, 16;
; PTX-NEXT:    ld.volatile.b8 %rd19, [%rd1+15];
...
; PTX-NEXT:    st.volatile.b64 [%SP+8], %rd24;
; PTX-NEXT:    ld.volatile.b8 %rd25, [%rd1];
; PTX-NEXT:    ld.volatile.b8 %rd26, [%rd1+1];
; PTX-NEXT:    shl.b64 %rd27, %rd26, 8;
; PTX-NEXT:    or.b64 %rd28, %rd27, %rd25;
; PTX-NEXT:    ld.volatile.b8 %rd29, [%rd1+2];
; PTX-NEXT:    shl.b64 %rd30, %rd29, 16;
; PTX-NEXT:    ld.volatile.b8 %rd31, [%rd1+3];
; PTX-NEXT:    shl.b64 %rd32, %rd31, 24;
; PTX-NEXT:    or.b64 %rd33, %rd32, %rd30;
; PTX-NEXT:    or.b64 %rd34, %rd33, %rd28;
; PTX-NEXT:    ld.volatile.b8 %rd35, [%rd1+4];
; PTX-NEXT:    ld.volatile.b8 %rd36, [%rd1+5];
; PTX-NEXT:    shl.b64 %rd37, %rd36, 8;
; PTX-NEXT:    or.b64 %rd38, %rd37, %rd35;
; PTX-NEXT:    ld.volatile.b8 %rd39, [%rd1+6];
; PTX-NEXT:    shl.b64 %rd40, %rd39, 16;
; PTX-NEXT:    ld.volatile.b8 %rd41, [%rd1+7];
...
; PTX-NEXT:    st.volatile.b64 [%SP], %rd46;
; PTX-NEXT:    ret;
entry:
