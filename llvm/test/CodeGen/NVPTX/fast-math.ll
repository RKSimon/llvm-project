...
; CHECK-NEXT:    and.b16 %rs2, %rs1, 1;
; CHECK-NEXT:    setp.ne.b16 %p1, %rs2, 0;
; CHECK-NEXT:    ld.param.b32 %r1, [repeated_div_recip_allowed_sel_param_3];
; CHECK-NEXT:    rcp.rn.f32 %r2, %r1;
...
; CHECK-NEXT:    mul.rn.f32 %r4, %r3, %r2;
; CHECK-NEXT:    st.param.b32 [func_retval0], %r4;
; CHECK-NEXT:    ret;
  %x = fdiv arcp float %a, %divisor
  %y = fdiv arcp float %b, %divisor
...
; CHECK-NEXT:    and.b16 %rs2, %rs1, 1;
; CHECK-NEXT:    setp.ne.b16 %p1, %rs2, 0;
; CHECK-NEXT:    ld.param.b32 %r1, [repeated_div_recip_allowed_ftz_sel_param_3];
; CHECK-NEXT:    rcp.rn.ftz.f32 %r2, %r1;
...
; CHECK-NEXT:    selp.b64 %rd3, %rd2, %rd1, %p1;
; CHECK-NEXT:    ld.param.b32 %r3, [%rd3];
; CHECK-NEXT:    mul.rn.ftz.f32 %r4, %r3, %r2;
; CHECK-NEXT:    st.param.b32 [func_retval0], %r4;
; CHECK-NEXT:    ret;
  %x = fdiv arcp float %a, %divisor
  %y = fdiv arcp float %b, %divisor
