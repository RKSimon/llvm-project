...
; CHECK:       {
; CHECK-NEXT:    .local .align 4 .b8 __local_depot5[32];
; CHECK-NEXT:    .reg .b64 %SP;
; CHECK-NEXT:    .reg .b64 %SPL;
; CHECK-NEXT:    .reg .b32 %r<9>;
; CHECK-NEXT:    .reg .b64 %rd<19>;
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
...
; CHECK-NEXT:    add.u64 %rd13, %SP, 16;
; CHECK-NEXT:    add.s64 %rd14, %rd13, %rd12;
; CHECK-NEXT:    ld.b32 %r1, [%SP];
; CHECK-NEXT:    ld.b32 %r2, [%SP+4];
; CHECK-NEXT:    ld.b32 %r3, [%SP+8];
; CHECK-NEXT:    ld.b32 %r4, [%SP+12];
; CHECK-NEXT:    ld.param.b32 %rd15, [all_dynamic_param_3];
; CHECK-NEXT:    and.b64 %rd16, %rd15, 3;
; CHECK-NEXT:    shl.b64 %rd17, %rd16, 2;
; CHECK-NEXT:    add.s64 %rd18, %rd13, %rd17;
; CHECK-NEXT:    st.b32 [%SP+28], %r4;
; CHECK-NEXT:    st.b32 [%SP+24], %r3;
; CHECK-NEXT:    st.b32 [%SP+20], %r2;
; CHECK-NEXT:    st.b32 [%SP+16], %r1;
; CHECK-NEXT:    st.b32 [%rd14], 30;
; CHECK-NEXT:    st.b32 [%rd18], 40;
...
; CHECK-NEXT:    ld.b32 %r5, [%SP+20];
; CHECK-NEXT:    ld.b32 %r6, [%SP+16];
...
; CHECK-NEXT:    add.u64 %rd4, %SP, 0;
; CHECK-NEXT:    add.s64 %rd5, %rd4, %rd3;
; CHECK-NEXT:    add.u64 %rd6, %SP, 16;
; CHECK-NEXT:    add.s64 %rd7, %rd6, %rd3;
; CHECK-NEXT:    st.b32 [%rd7], 10;
; CHECK-NEXT:    ld.param.b32 %rd8, [overlapping_chains_param_1];
; CHECK-NEXT:    and.b64 %rd9, %rd8, 3;
; CHECK-NEXT:    shl.b64 %rd10, %rd9, 2;
; CHECK-NEXT:    add.s64 %rd11, %rd4, %rd10;
; CHECK-NEXT:    ld.b32 %r1, [%SP+28];
; CHECK-NEXT:    ld.b32 %r2, [%SP+16];
; CHECK-NEXT:    ld.param.b64 %rd12, [overlapping_chains_param_2];
; CHECK-NEXT:    st.b32 [%rd5], 10;
; CHECK-NEXT:    st.b32 [%SP+4], 20;
; CHECK-NEXT:    st.b32 [%rd11], 30;
...
; CHECK-NEXT:    st.v4.b32 [%rd12], {%r2, 20, 40, %r1};
...
; CHECK-NEXT:    st.param.b8 [func_retval0], %r7;
; CHECK-NEXT:    st.param.b8 [func_retval0+4], %r3;
; CHECK-NEXT:    st.param.b8 [func_retval0+3], %r8;
; CHECK-NEXT:    st.param.b8 [func_retval0+5], %r6;
; CHECK-NEXT:    st.param.b8 [func_retval0+6], %r5;
; CHECK-NEXT:    st.param.b8 [func_retval0+7], %r4;
...
; CHECK-NEXT:    shr.s16 %rs20, %rs18, 10;
; CHECK-NEXT:    st.param.b16 [func_retval0+10], %rs20;
; CHECK-NEXT:    shr.s16 %rs21, %rs18, 12;
; CHECK-NEXT:    st.param.b16 [func_retval0+12], %rs21;
; CHECK-NEXT:    shr.s16 %rs22, %rs18, 14;
; CHECK-NEXT:    st.param.b16 [func_retval0+14], %rs22;
...
; CHECK-NEXT:    cvt.u16.u32 %rs14, %r9;
; CHECK-NEXT:    and.b16 %rs15, %rs14, 15;
; CHECK-NEXT:    prmt.b32 %r10, %r9, 0, 0x7771U;
; CHECK-NEXT:    cvt.u16.u32 %rs16, %r10;
; CHECK-NEXT:    and.b16 %rs17, %rs16, 15;
; CHECK-NEXT:    shl.b16 %rs18, %rs17, 4;
; CHECK-NEXT:    or.b16 %rs19, %rs15, %rs18;
; CHECK-NEXT:    prmt.b32 %r11, %r9, 0, 0x7772U;
; CHECK-NEXT:    cvt.u16.u32 %rs20, %r11;
; CHECK-NEXT:    and.b16 %rs21, %rs20, 15;
; CHECK-NEXT:    shl.b16 %rs22, %rs21, 8;
; CHECK-NEXT:    or.b16 %rs23, %rs19, %rs22;
; CHECK-NEXT:    prmt.b32 %r12, %r9, 0, 0x7773U;
; CHECK-NEXT:    cvt.u16.u32 %rs24, %r12;
; CHECK-NEXT:    shl.b16 %rs25, %rs24, 12;
; CHECK-NEXT:    or.b16 %rs26, %rs23, %rs25;
; CHECK-NEXT:    cvt.u32.u16 %r13, %rs26;
; CHECK-NEXT:    shl.b32 %r14, %r13, 16;
; CHECK-NEXT:    or.b32 %r15, %r8, %r14;
; CHECK-NEXT:    mov.b16 %rs27, 2;
; CHECK-NEXT:    mov.b32 %r16, {%rs1, %rs27};
; CHECK-NEXT:    st.param.b32 [func_retval0], %r16;
; CHECK-NEXT:    bfe.s32 %r17, %r13, 12, 4;
; CHECK-NEXT:    bfe.s32 %r18, %r13, 8, 8;
; CHECK-NEXT:    prmt.b32 %r19, %r18, %r17, 0x5410U;
; CHECK-NEXT:    st.param.b32 [func_retval0+12], %r19;
; CHECK-NEXT:    bfe.s32 %r20, %r13, 4, 12;
; CHECK-NEXT:    cvt.u16.u32 %rs28, %r20;
; CHECK-NEXT:    mov.b32 %r21, {%rs26, %rs28};
; CHECK-NEXT:    st.param.b32 [func_retval0+8], %r21;
; CHECK-NEXT:    shr.u32 %r22, %r15, 12;
; CHECK-NEXT:    cvt.u16.u32 %rs29, %r22;
; CHECK-NEXT:    mov.b16 %rs30, 3;
; CHECK-NEXT:    mov.b32 %r23, {%rs30, %rs29};
; CHECK-NEXT:    st.param.b32 [func_retval0+4], %r23;
; CHECK-NEXT:    ret;
