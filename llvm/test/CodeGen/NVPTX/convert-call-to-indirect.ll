...
; CHECK-NEXT:    shr.u64 %rd25, %rd12, 8;
; CHECK-NEXT:    st.param.b8 [func_retval0+1], %rd25;
; CHECK-NEXT:    shr.u64 %rd26, %rd16, 24;
; CHECK-NEXT:    st.param.b8 [func_retval0+3], %rd26;
; CHECK-NEXT:    shr.u64 %rd27, %rd16, 16;
; CHECK-NEXT:    st.param.b8 [func_retval0+2], %rd27;
; CHECK-NEXT:    shr.u64 %rd28, %rd24, 56;
; CHECK-NEXT:    st.param.b8 [func_retval0+7], %rd28;
; CHECK-NEXT:    shr.u64 %rd29, %rd24, 48;
; CHECK-NEXT:    st.param.b8 [func_retval0+6], %rd29;
; CHECK-NEXT:    shr.u64 %rd30, %rd24, 40;
; CHECK-NEXT:    st.param.b8 [func_retval0+5], %rd30;
; CHECK-NEXT:    shr.u64 %rd31, %rd24, 32;
; CHECK-NEXT:    st.param.b8 [func_retval0+4], %rd31;
; CHECK-NEXT:    ret;
...
; CHECK-NEXT:    shr.u64 %rd26, %rd13, 8;
; CHECK-NEXT:    st.param.b8 [func_retval0+1], %rd26;
; CHECK-NEXT:    shr.u64 %rd27, %rd17, 24;
; CHECK-NEXT:    st.param.b8 [func_retval0+3], %rd27;
; CHECK-NEXT:    shr.u64 %rd28, %rd17, 16;
; CHECK-NEXT:    st.param.b8 [func_retval0+2], %rd28;
; CHECK-NEXT:    shr.u64 %rd29, %rd25, 56;
; CHECK-NEXT:    st.param.b8 [func_retval0+7], %rd29;
; CHECK-NEXT:    shr.u64 %rd30, %rd25, 48;
; CHECK-NEXT:    st.param.b8 [func_retval0+6], %rd30;
; CHECK-NEXT:    shr.u64 %rd31, %rd25, 40;
; CHECK-NEXT:    st.param.b8 [func_retval0+5], %rd31;
; CHECK-NEXT:    shr.u64 %rd32, %rd25, 32;
; CHECK-NEXT:    st.param.b8 [func_retval0+4], %rd32;
; CHECK-NEXT:    ret;
