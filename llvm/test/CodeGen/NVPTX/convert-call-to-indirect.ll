...
; CHECK-NEXT:    shr.u64 %rd33, %rd14, 8;
; CHECK-NEXT:    st.param.b8 [func_retval0+1], %rd33;
; CHECK-NEXT:    shr.u64 %rd34, %rd20, 24;
; CHECK-NEXT:    st.param.b8 [func_retval0+3], %rd34;
; CHECK-NEXT:    shr.u64 %rd35, %rd20, 16;
; CHECK-NEXT:    st.param.b8 [func_retval0+2], %rd35;
; CHECK-NEXT:    shr.u64 %rd36, %rd32, 56;
; CHECK-NEXT:    st.param.b8 [func_retval0+7], %rd36;
; CHECK-NEXT:    shr.u64 %rd37, %rd32, 48;
; CHECK-NEXT:    st.param.b8 [func_retval0+6], %rd37;
; CHECK-NEXT:    shr.u64 %rd38, %rd32, 40;
; CHECK-NEXT:    st.param.b8 [func_retval0+5], %rd38;
; CHECK-NEXT:    shr.u64 %rd39, %rd32, 32;
; CHECK-NEXT:    st.param.b8 [func_retval0+4], %rd39;
; CHECK-NEXT:    ret;
