...
; EG-NEXT:    TEX 1 @6
; EG-NEXT:    ALU 94, @14, KC0[CB0:0-32], KC1[]
...
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BCNT_INT * T1.W, PV.W,
; EG-NEXT:     LSHR T0.Z, T21.W, literal.x,
; EG-NEXT:     AND_INT T2.W, T0.X, literal.y,
; EG-NEXT:     LSHL * T1.W, PV.W, literal.x,
; EG-NEXT:    16(2.242078e-44), 65535(9.183409e-41)
; EG-NEXT:     OR_INT T1.Y, PV.W, PS,
; EG-NEXT:     AND_INT T1.Z, T21.Z, literal.x,
; EG-NEXT:     BCNT_INT T1.W, PV.Z,
; EG-NEXT:     AND_INT * T2.W, T21.W, literal.x,
; EG-NEXT:    65535(9.183409e-41), 0(0.000000e+00)
; EG-NEXT:     LSHR T21.X, KC0[2].Y, literal.x,
; EG-NEXT:     LSHL T2.Y, PV.W, literal.y,
; EG-NEXT:     BCNT_INT T0.Z, PS,
; EG-NEXT:     BCNT_INT T1.W, PV.Z,
; EG-NEXT:     AND_INT * T2.W, PV.Y, literal.z,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:    2031616(2.846900e-39), 0(0.000000e+00)
