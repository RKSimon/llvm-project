...
; GFX9-NEXT:    v_lshrrev_b32_e32 v3, 31, v1
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v3
; GFX9-NEXT:    v_addc_co_u32_e64 v2, s[4:5], 0, 0, vcc
; GFX9-NEXT:    v_add_lshl_u32 v2, v3, v2, 30
; GFX9-NEXT:    v_and_b32_e32 v2, 0x80000000, v2
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v0, v2
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX9-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:    v_lshrrev_b32_e32 v4, 31, v1
; GFX942-NEXT:    v_mov_b32_e32 v5, v3
; GFX942-NEXT:    v_lshl_add_u64 v[6:7], v[2:3], 0, v[4:5]
; GFX942-NEXT:    v_add_lshl_u32 v2, v4, v7, 30
; GFX942-NEXT:    v_and_b32_e32 v2, 0x80000000, v2
; GFX942-NEXT:    v_lshl_add_u64 v[0:1], v[0:1], 0, v[2:3]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1030:       ; %bb.0: ; %entry
; GFX1030-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1030-NEXT:    v_alignbit_b32 v2, v1, v0, 31
; GFX1030-NEXT:    v_lshrrev_b32_e32 v3, 31, v1
; GFX1030-NEXT:    v_add_co_u32 v2, s4, v2, v3
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v2, null, 0, 0, s4
; GFX1030-NEXT:    v_add_lshl_u32 v2, v3, v2, 30
; GFX1030-NEXT:    v_and_b32_e32 v2, 0x80000000, v2
; GFX1030-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v2
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v1, vcc_lo
; GFX1030-NEXT:    s_setpc_b64 s[30:31]
...
; GFX9-NEXT:    v_addc_co_u32_e64 v0, s[4:5], 0, 0, vcc
...
; GFX942-NEXT:    v_lshl_add_u64 v[2:3], v[2:3], 0, v[0:1]
; GFX942-NEXT:    v_add_u32_e32 v0, v0, v3
; GFX942-NEXT:    v_lshrrev_b32_e32 v0, 1, v0
; GFX942-NEXT:    v_mov_b32_e32 v1, 0
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v0, null, 0, 0, s4
; GFX1030-NEXT:    v_add_nc_u32_e32 v0, v1, v0
; GFX1030-NEXT:    v_mov_b32_e32 v1, 0
; GFX1030-NEXT:    v_lshrrev_b32_e32 v0, 1, v0
; GFX1030-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; GFX9-NEXT:    v_mov_b32_e32 v2, v4
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v0, s6, v[2:3]
; GFX9-NEXT:    v_lshl_add_u32 v4, v6, 31, v6
...
; GFX9-NEXT:    v_sub_co_u32_e32 v5, vcc, v6, v0
...
; GFX942:       ; %bb.0: ; %entry
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_mul_hi_u32 v2, v0, 3
; GFX942-NEXT:    v_mov_b32_e32 v3, 0
; GFX942-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], v1, 3, v[2:3]
; GFX942-NEXT:    v_mov_b32_e32 v2, v5
; GFX942-NEXT:    v_mov_b32_e32 v5, v3
...
; GFX942-NEXT:    v_lshl_add_u64 v[4:5], v[2:3], 0, v[4:5]
; GFX942-NEXT:    v_ashrrev_i32_e32 v2, 31, v1
; GFX942-NEXT:    v_lshl_add_u32 v8, v2, 31, v2
; GFX942-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], v2, 3, 0
; GFX942-NEXT:    v_add3_u32 v2, v7, v8, v6
; GFX942-NEXT:    v_sub_co_u32_e32 v6, vcc, v6, v0
; GFX942-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], v1, s2, v[4:5]
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_subb_co_u32_e32 v7, vcc, v2, v1, vcc
; GFX942-NEXT:    v_lshl_add_u64 v[4:5], v[4:5], 0, v[6:7]
; GFX942-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], v0, 1, v[4:5]
; GFX942-NEXT:    v_add_u32_e32 v5, v1, v5
; GFX942-NEXT:    v_ashrrev_i64 v[6:7], 30, v[4:5]
; GFX942-NEXT:    v_lshrrev_b32_e32 v2, 31, v5
...
; GFX1030-NEXT:    v_mad_u64_u32 v[6:7], null, v4, 3, 0
; GFX1030-NEXT:    v_lshl_add_u32 v8, v4, 31, v4
; GFX1030-NEXT:    v_add_co_u32 v2, s4, v5, v3
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, 0, s4
; GFX1030-NEXT:    v_add3_u32 v4, v7, v8, v6
; GFX1030-NEXT:    v_sub_co_u32 v5, vcc_lo, v6, v0
; GFX1030-NEXT:    v_mad_u64_u32 v[2:3], null, 0x80000001, v1, v[2:3]
; GFX1030-NEXT:    v_sub_co_ci_u32_e64 v4, null, v4, v1, vcc_lo
; GFX1030-NEXT:    v_add_co_u32 v2, vcc_lo, v2, v5
...
; GFX942-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], v0, 1, v[4:5]
; GFX942-NEXT:    v_add_u32_e32 v5, v1, v5
; GFX942-NEXT:    v_ashrrev_i64 v[0:1], 30, v[4:5]
; GFX942-NEXT:    v_lshrrev_b32_e32 v2, 31, v5
; GFX942-NEXT:    v_lshl_add_u64 v[0:1], v[0:1], 0, v[2:3]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_mul_hi_u32 v4, v3, 5
; GFX9-NEXT:    v_mov_b32_e32 v5, 0
; GFX9-NEXT:    v_mov_b32_e32 v2, v5
; GFX9-NEXT:    s_brev_b32 s6, -2
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v1, 5, v[4:5]
; GFX9-NEXT:    v_mov_b32_e32 v4, v5
; GFX9-NEXT:    v_lshlrev_b64 v[8:9], 1, v[3:4]
; GFX9-NEXT:    v_lshlrev_b64 v[4:5], 1, v[1:2]
...
; GFX9-NEXT:    v_sub_co_u32_e32 v4, vcc, v3, v0
...
; GFX9-NEXT:    v_alignbit_b32 v0, v2, v0, 30
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v0, s6, 0
; GFX9-NEXT:    v_lshrrev_b32_e32 v0, 30, v2
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v0, s6, v[5:6]
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v3, v4
...
; GFX942-NEXT:    v_mul_hi_u32 v4, v0, 5
; GFX942-NEXT:    v_mov_b32_e32 v5, 0
; GFX942-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], v2, 5, v[4:5]
; GFX942-NEXT:    v_mov_b32_e32 v4, v7
; GFX942-NEXT:    v_mov_b32_e32 v7, v5
; GFX942-NEXT:    v_mov_b32_e32 v1, v5
; GFX942-NEXT:    v_lshl_add_u64 v[6:7], v[0:1], 1, v[6:7]
; GFX942-NEXT:    v_mov_b32_e32 v6, v7
; GFX942-NEXT:    v_mov_b32_e32 v7, v5
; GFX942-NEXT:    v_lshl_add_u64 v[6:7], v[4:5], 0, v[6:7]
; GFX942-NEXT:    v_mov_b32_e32 v3, v5
; GFX942-NEXT:    v_lshl_add_u64 v[4:5], v[2:3], 1, v[6:7]
; GFX942-NEXT:    v_sub_co_u32_e32 v6, vcc, v0, v4
; GFX942-NEXT:    s_brev_b32 s2, -2
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_subb_co_u32_e32 v7, vcc, v2, v5, vcc
; GFX942-NEXT:    v_lshrrev_b64 v[6:7], 1, v[6:7]
; GFX942-NEXT:    v_lshl_add_u64 v[4:5], v[6:7], 0, v[4:5]
; GFX942-NEXT:    v_alignbit_b32 v1, v5, v4, 30
; GFX942-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], v1, s2, 0
; GFX942-NEXT:    v_mov_b32_e32 v4, v7
; GFX942-NEXT:    v_lshrrev_b32_e32 v1, 30, v5
; GFX942-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], v1, s2, v[4:5]
; GFX942-NEXT:    v_sub_co_u32_e32 v0, vcc, v0, v6
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_subb_co_u32_e32 v1, vcc, v2, v4, vcc
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1030-LABEL: urem64_i32max:
; GFX1030:       ; %bb.0: ; %entry
; GFX1030-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1030-NEXT:    v_mov_b32_e32 v3, v0
; GFX1030-NEXT:    v_mov_b32_e32 v6, 0
; GFX1030-NEXT:    v_mul_hi_u32 v5, v3, 5
; GFX1030-NEXT:    v_mov_b32_e32 v4, v6
; GFX1030-NEXT:    v_mov_b32_e32 v2, v6
; GFX1030-NEXT:    v_mad_u64_u32 v[7:8], null, v1, 5, v[5:6]
; GFX1030-NEXT:    v_lshlrev_b64 v[4:5], 1, v[3:4]
; GFX1030-NEXT:    v_add_co_u32 v0, vcc_lo, v4, v7
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v0, null, 0, v5, vcc_lo
; GFX1030-NEXT:    v_lshlrev_b64 v[4:5], 1, v[1:2]
; GFX1030-NEXT:    v_add_co_u32 v0, s4, v8, v0
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v2, null, 0, 0, s4
; GFX1030-NEXT:    v_add_co_u32 v0, vcc_lo, v4, v0
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v2, null, v5, v2, vcc_lo
; GFX1030-NEXT:    v_sub_co_u32 v4, vcc_lo, v3, v0
; GFX1030-NEXT:    v_sub_co_ci_u32_e64 v5, null, v1, v2, vcc_lo
; GFX1030-NEXT:    v_lshrrev_b64 v[4:5], 1, v[4:5]
; GFX1030-NEXT:    v_add_co_u32 v0, vcc_lo, v4, v0
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v2, null, v5, v2, vcc_lo
; GFX1030-NEXT:    v_alignbit_b32 v0, v2, v0, 30
; GFX1030-NEXT:    v_mad_u64_u32 v[4:5], null, 0x7fffffff, v0, 0
; GFX1030-NEXT:    v_lshrrev_b32_e32 v0, 30, v2
; GFX1030-NEXT:    v_mad_u64_u32 v[5:6], null, 0x7fffffff, v0, v[5:6]
; GFX1030-NEXT:    v_sub_co_u32 v0, vcc_lo, v3, v4
; GFX1030-NEXT:    v_sub_co_ci_u32_e64 v1, null, v1, v5, vcc_lo
; GFX1030-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, v7, v0
; GFX9-NEXT:    v_addc_co_u32_e64 v6, s[4:5], 0, 0, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v4, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v4, vcc, v5, v6, vcc
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v3, v2
...
; GFX1030-NEXT:    v_add_co_u32 v0, s4, v8, v0
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v2, null, 0, 0, s4
; GFX1030-NEXT:    v_add_co_u32 v4, vcc_lo, v4, v0
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v2, null, v5, v2, vcc_lo
; GFX1030-NEXT:    v_sub_co_u32 v0, vcc_lo, v3, v4
...
; GFX1030-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v2, vcc_lo
