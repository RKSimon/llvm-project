...
; CHECK-NEXT:    v_trunc_f32_e64 v14, -v0
...
; CHECK-NEXT:    v_fmac_f32_e32 v12, v16, v12
; CHECK-NEXT:    v_div_scale_f32 v17, null, 0x40400000, 0x40400000, v1
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; CHECK-NEXT:    v_dual_fmac_f32 v6, -2.0, v10 :: v_dual_fmac_f32 v11, v15, v11
...
; CHECK-NEXT:    v_add_f32_e32 v0, v14, v0
; CHECK-NEXT:    v_fma_f32 v14, -v8, v19, v13
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; CHECK-NEXT:    v_dual_fmac_f32 v20, v23, v12 :: v_dual_fmac_f32 v15, v24, v15
; CHECK-NEXT:    v_fmac_f32_e32 v19, v14, v11
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_4)
...
; CHECK-NEXT:    v_trunc_f32_e64 v9, -v7
...
; CHECK-NEXT:    v_trunc_f32_e64 v12, -v4
...
; CHECK-NEXT:    v_dual_sub_f32 v3, v3, v11 :: v_dual_add_f32 v4, v12, v4
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; CHECK-NEXT:    v_trunc_f32_e32 v9, v9
; CHECK-NEXT:    v_trunc_f32_e32 v10, v10
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_1)
