...
; GFX11-NEXT:    s_lshl_b32 s2, s19, 24
; GFX11-NEXT:    s_lshl_b32 s3, s3, 16
; GFX11-NEXT:    s_and_b32 s4, s20, 0xff
...
; GFX11-NEXT:    s_add_i32 s0, s0, 0x3000000
; GFX11-NEXT:    s_add_i32 s1, s1, 0x3000000
; GFX11-NEXT:    s_add_i32 s2, s2, 0x3000000
; GFX11-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX11-NEXT:    v_mov_b32_e32 v2, s2
...
; SI-NEXT:    v_mul_f32_e32 v7, 1.0, v5
...
; SI-NEXT:    v_mul_f32_e64 v7, 1.0, s8
...
; GFX11-FAKE16-NEXT:    s_and_b32 s2, s0, 0xffff0000
...
; SI-NEXT:    v_mul_f32_e32 v3, 1.0, v14
; SI-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; SI-NEXT:    v_and_b32_e32 v3, 0xffff0000, v3
; SI-NEXT:    v_or_b32_e32 v2, v2, v3
; SI-NEXT:    s_setpc_b64 s[30:31]
...
; SI-NEXT:    v_mul_f32_e32 v14, 1.0, v2
...
; SI-NEXT:    s_lshl_b32 s9, s16, 16
; SI-NEXT:    s_cmp_lg_u32 s19, 0
; SI-NEXT:    v_mul_f32_e64 v18, 1.0, s9
; SI-NEXT:    v_mul_f32_e64 v17, 1.0, s8
; SI-NEXT:    v_mul_f32_e64 v16, 1.0, s7
; SI-NEXT:    v_mul_f32_e64 v15, 1.0, s6
; SI-NEXT:    v_mul_f32_e64 v14, 1.0, s5
...
; GFX11-FAKE16-NEXT:    s_and_b32 s3, s1, 0xffff0000
; GFX11-FAKE16-NEXT:    s_lshl_b32 s1, s1, 16
; GFX11-FAKE16-NEXT:    s_and_b32 s4, s2, 0xffff0000
...
; GFX11-TRUE16-NEXT:    v_add3_u32 v6, v10, v4, 0x7fff
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v0, v7, v9, vcc_lo
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v3.h
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v4, v6, v7 :: v_dual_add_f32 v1, 0x40c00000, v1
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v5, v5
...
; SI-NEXT:    s_add_i32 s4, s4, 0x30000
; SI-NEXT:    s_add_i32 s5, s5, 0x30000
; SI-NEXT:    s_add_i32 s7, s6, 0x30000
