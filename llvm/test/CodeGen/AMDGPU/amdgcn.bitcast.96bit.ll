...
; GFX9-NEXT:    s_lshl_b32 s6, s19, 24
...
; GFX9-NEXT:    s_lshl_b32 s7, s23, 24
...
; GFX9-NEXT:    s_lshl_b32 s8, s27, 24
...
; GFX9-NEXT:    s_lshl_b32 s5, s19, 24
; GFX9-NEXT:    s_lshl_b32 s6, s6, 16
; GFX9-NEXT:    s_and_b32 s4, s4, 0xffff
; GFX9-NEXT:    s_or_b32 s5, s5, s6
...
; GFX9-NEXT:    s_lshl_b32 s6, s23, 24
; GFX9-NEXT:    s_lshl_b32 s7, s7, 16
; GFX9-NEXT:    s_and_b32 s5, s5, 0xffff
; GFX9-NEXT:    s_or_b32 s6, s6, s7
...
; GFX9-NEXT:    s_lshl_b32 s7, s27, 24
; GFX9-NEXT:    s_lshl_b32 s8, s8, 16
; GFX9-NEXT:    s_and_b32 s6, s6, 0xffff
; GFX9-NEXT:    s_or_b32 s7, s7, s8
; GFX9-NEXT:    s_or_b32 s6, s7, s6
; GFX9-NEXT:    s_add_i32 s4, s4, 0x3000000
; GFX9-NEXT:    s_add_i32 s5, s5, 0x3000000
; GFX9-NEXT:    s_add_i32 s6, s6, 0x3000000
...
; GFX11-NEXT:    s_lshl_b32 s6, s3, 24
...
; GFX11-NEXT:    s_lshl_b32 s8, s19, 24
...
; GFX11-NEXT:    s_lshl_b32 s10, s23, 24
...
; GFX11-NEXT:    s_lshl_b32 s4, s17, 8
...
; GFX9-NEXT:    v_perm_b32 v2, v2, v3, s7
...
; GFX9-NEXT:    v_perm_b32 v0, v0, v3, s7
...
; GFX11-FAKE16-NEXT:    v_dual_add_f32 v4, 0x40c00000, v4 :: v_dual_add_f32 v3, 0x40c00000, v3
...
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v3, v6, v8 :: v_dual_and_b32 v2, 0xffff0000, v2
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v2, v2, v3, 0x7060302
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v4, v6, v7 :: v_dual_add_f32 v1, 0x40c00000, v1
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v1, v1, v4, 0x7060302
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v5, v9, v10 :: v_dual_add_f32 v0, 0x40c00000, v0
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v0, v0, v5, 0x7060302
...
; GFX11-NEXT:    s_and_b32 s2, s0, 0xffff0000
; GFX11-NEXT:    s_lshl_b32 s0, s0, 16
; GFX11-NEXT:    s_and_b32 s3, s1, 0xffff0000
...
; GFX11-NEXT:    s_lshl_b32 s7, s19, 24
; GFX11-NEXT:    s_lshl_b32 s9, s21, 8
...
; GFX9-NEXT:    v_perm_b32 v1, v3, v2, s7
; GFX9-NEXT:    v_perm_b32 v0, v5, v4, s7
; GFX9-NEXT:    v_perm_b32 v11, v7, v6, s7
...
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v11, 8, v0
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v12.h, v0.h
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v4.h, v1.l
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v6.h, v1.h
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v8.h, v2.l
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v10.h, v2.h
...
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v16, 0x7fc07fc0 :: v_dual_lshlrev_b32 v3, 16, v1
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v4, v4, v8 :: v_dual_add_f32 v1, 0x40c00000, v1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
; GFX11-TRUE16-NEXT:    v_add3_u32 v0, v12, v5, 0x7fff
...
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 24, v1
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v12, v10, v9, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v5, v5
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v8.h
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v10, v0, v11, vcc_lo
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_bfi_b32 v0, 0xffff, v2, v12
; GFX11-TRUE16-NEXT:    v_bfi_b32 v15, 0xffff, v5, v10
...
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[15:16], 24, v[15:16]
...
; GFX11-FAKE16-NEXT:  ; %bb.3: ; %cmp.true
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v1, 0xffff0000, v14
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v0, 16, v14
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v5, 0xffff0000, v8
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v3, 0xffff0000, v13
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v2, 16, v13
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_dual_add_f32 v1, 0x40c00000, v1 :: v_dual_add_f32 v0, 0x40c00000, v0
; GFX11-FAKE16-NEXT:    v_dual_add_f32 v5, 0x40c00000, v5 :: v_dual_lshlrev_b32 v4, 16, v8
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
...
; GFX11-FAKE16-NEXT:    v_add_f32_e32 v2, 0x40c00000, v2
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v12, 0x7fc07fc0 :: v_dual_cndmask_b32 v13, v6, v8
; GFX11-FAKE16-NEXT:    v_bfe_u32 v10, v2, 16, 1
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v14, 16, v13
; GFX11-FAKE16-NEXT:    v_add3_u32 v1, v10, v2, 0x7fff
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v6, v7, v9, vcc_lo
...
; GFX11-FAKE16-NEXT:    v_add3_u32 v2, v7, v3, 0x7fff
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v7, 0x400000, v3
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_bfe_u32 v8, v0, 16, 1
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v4, v1, v4, vcc_lo
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v0, v2, v4, 0x7060302
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v5, v1, v10, vcc_lo
; GFX11-FAKE16-NEXT:    v_perm_b32 v1, v6, v13, 0x7060302
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v13, 16, v4
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v6, 16, v6
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_perm_b32 v11, v5, v3, 0x7060302
...
; GFX11-TRUE16-NEXT:    s_and_b32 s3, s1, 0xffff0000
...
; GFX11-TRUE16-NEXT:    s_and_b32 s3, s0, 0xffff0000
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v9, v0, v12 :: v_dual_mov_b32 v12, 0x7fc07fc0
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v2, v2, v10 :: v_dual_add_nc_u32 v3, v3, v8
...
; GFX11-TRUE16-NEXT:    v_lshl_or_b32 v15, v2, 16, v5
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v10, 16, v1
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v1, 0xffff, v8
; GFX11-TRUE16-NEXT:    v_lshl_or_b32 v16, v6, 16, v3
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_lshl_or_b32 v11, v10, 16, v1
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[13:14], 24, v[15:16]
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.l, s0
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v2.l, s14
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v4.l, s1
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v6.l, s11
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v9.l, s9
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v1.l, s12
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v7.l, s8
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v5.l, s10
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v11.l, s6
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v13.l, s4
...
; GFX11-FAKE16-NEXT:    s_and_b32 s3, s1, 0xffff0000
...
; GFX11-FAKE16-NEXT:    s_and_b32 s3, s0, 0xffff0000
...
; GFX9-NEXT:    v_perm_b32 v2, v2, v5, s6
; GFX9-NEXT:    v_perm_b32 v1, v1, v4, s6
...
; GFX11-FAKE16-NEXT:    v_dual_add_f32 v2, 0x40c00000, v2 :: v_dual_lshlrev_b32 v3, 16, v0
; GFX11-FAKE16-NEXT:    v_dual_add_f32 v3, 0x40c00000, v3 :: v_dual_lshlrev_b32 v4, 16, v1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v3, v6, v9 :: v_dual_add_f32 v0, 0x40c00000, v0
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v4, v8, v6 :: v_dual_add_f32 v1, 0x40c00000, v1
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v2, v2, v5, 0x7060302
...
; GFX11-NEXT:    s_and_b32 s3, s0, 0xffff0000
; GFX11-NEXT:    s_lshl_b32 s0, s0, 16
; GFX11-NEXT:    v_add_f32_e64 v0, 0x40c00000, s3
; GFX11-NEXT:    v_add_f32_e64 v2, 0x40c00000, s0
; GFX11-NEXT:    s_and_b32 s3, s1, 0xffff0000
; GFX11-NEXT:    s_lshl_b32 s1, s1, 16
; GFX11-NEXT:    s_and_b32 s4, s2, 0xffff0000
