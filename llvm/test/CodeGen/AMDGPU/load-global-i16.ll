...
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T22, T43.X
...
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T21, T39.X
...
; CM-NEXT:     VTX_READ_128 T29.XYZW, T19.X, 48, #1
; CM-NEXT:    ALU clause starting at 30:
; CM-NEXT:     MOV * T19.X, KC0[2].Z,
; CM-NEXT:    ALU clause starting at 31:
; CM-NEXT:     LSHR * T23.Z, T20.X, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T23.X, T20.X, literal.x,
; CM-NEXT:     MOV T23.Y, 0.0,
; CM-NEXT:     LSHR * T24.Z, T20.Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T24.X, T20.Y, literal.x,
; CM-NEXT:     MOV T24.Y, 0.0,
; CM-NEXT:     LSHR * T25.Z, T20.Z, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T25.X, T20.Z, literal.x,
; CM-NEXT:     MOV T25.Y, 0.0,
; CM-NEXT:     LSHR * T20.Z, T20.W, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T20.X, T20.W, literal.x,
; CM-NEXT:     MOV T20.Y, 0.0,
; CM-NEXT:     LSHR * T26.Z, T22.X, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T26.X, T22.X, literal.x,
; CM-NEXT:     MOV T26.Y, 0.0,
; CM-NEXT:     LSHR * T27.Z, T22.Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T27.X, T22.Y, literal.x,
; CM-NEXT:     MOV T27.Y, 0.0,
; CM-NEXT:     LSHR * T28.Z, T22.Z, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T28.X, T22.Z, literal.x,
...
; CM-NEXT:     LSHR * T19.Z, T21.X, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:    ALU clause starting at 65:
; CM-NEXT:     AND_INT T19.X, T21.X, literal.x,
; CM-NEXT:     MOV T19.Y, 0.0,
; CM-NEXT:     LSHR * T30.Z, T21.Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T30.X, T21.Y, literal.x,
; CM-NEXT:     MOV T30.Y, 0.0,
; CM-NEXT:     LSHR * T31.Z, T21.Z, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T31.X, T21.Z, literal.x,
