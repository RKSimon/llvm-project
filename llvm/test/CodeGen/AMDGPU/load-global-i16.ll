...
; EG-NEXT:     MOV * T4.X, KC0[2].Z,
; EG-NEXT:    ALU clause starting at 9:
; EG-NEXT:     ASHR * T4.Y, T4.X, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; CM-NEXT:     MOV * T4.X, KC0[2].Z,
; CM-NEXT:    ALU clause starting at 9:
; CM-NEXT:     ASHR * T4.Y, T4.X, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; EG-NEXT:     MOV * T5.X, KC0[2].Z,
; EG-NEXT:    ALU clause starting at 9:
; EG-NEXT:     ASHR * T5.W, T5.Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT * T5.Z, T5.Y, 0.0, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     ASHR * T5.Y, T5.X, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; CM-NEXT:     MOV * T5.X, KC0[2].Z,
; CM-NEXT:    ALU clause starting at 9:
; CM-NEXT:     ASHR * T5.W, T5.Y, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT * T5.Z, T5.Y, 0.0, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     ASHR * T5.Y, T5.X, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     ASHR T8.Y, T7.X, literal.x,
...
; CM-NEXT:     MOV * T7.X, KC0[2].Z,
; CM-NEXT:    ALU clause starting at 9:
; CM-NEXT:     ASHR * T8.W, T7.W, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT * T8.Z, T7.W, 0.0, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     ASHR T8.Y, T7.Z, literal.x,
; CM-NEXT:     ASHR * T7.W, T7.Y, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT T8.X, T7.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T7.Z, T7.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T9.X, PV.W, literal.x,
; CM-NEXT:     ASHR * T7.Y, T7.X, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
...
; EG-NEXT:    ALU 0, @12, KC0[CB0:0-32], KC1[]
; EG-NEXT:    TEX 1 @8
; EG-NEXT:    ALU 33, @13, KC0[CB0:0-32], KC1[]
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T17.XYZW, T18.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T15.XYZW, T11.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T14.XYZW, T16.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T13.XYZW, T12.X, 1
...
; EG-NEXT:     MOV * T11.X, KC0[2].Z,
; EG-NEXT:    ALU clause starting at 13:
; EG-NEXT:     ASHR * T13.W, T12.Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT * T13.Z, T12.Y, 0.0, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     ASHR T13.Y, T12.X, literal.x,
; EG-NEXT:     ASHR * T14.W, T12.W, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T13.X, T12.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T14.Z, T12.W, 0.0, literal.x,
; EG-NEXT:     LSHR * T12.X, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 2(2.802597e-45)
; EG-NEXT:     ASHR T14.Y, T12.Z, literal.x,
; EG-NEXT:     ASHR * T15.W, T11.Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T14.X, T12.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T15.Z, T11.Y, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     LSHR T16.X, PV.W, literal.x,
; EG-NEXT:     ASHR T15.Y, T11.X, literal.y,
; EG-NEXT:     ASHR * T17.W, T11.W, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T15.X, T11.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T17.Z, T11.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 32(4.484155e-44)
; EG-NEXT:     LSHR T11.X, PV.W, literal.x,
; EG-NEXT:     ASHR * T17.Y, T11.Z, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T17.X, T11.Z, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
...
; CM-NEXT:     MOV * T11.X, KC0[2].Z,
; CM-NEXT:    ALU clause starting at 13:
; CM-NEXT:     ASHR * T13.W, T12.W, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT * T13.Z, T12.W, 0.0, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     ASHR T13.Y, T12.Z, literal.x,
; CM-NEXT:     ASHR * T12.W, T12.Y, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT T13.X, T12.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T12.Z, T12.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 48(6.726233e-44)
; CM-NEXT:     LSHR T14.X, PV.W, literal.x,
; CM-NEXT:     ASHR T12.Y, T12.X, literal.y,
; CM-NEXT:     ASHR * T15.W, T11.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T12.X, T12.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T15.Z, T11.W, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 32(4.484155e-44)
; CM-NEXT:     LSHR T16.X, PV.W, literal.x,
; CM-NEXT:     ASHR T15.Y, T11.Z, literal.y,
; CM-NEXT:     ASHR * T11.W, T11.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T15.X, T11.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T11.Z, T11.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T17.X, PV.W, literal.x,
; CM-NEXT:     ASHR * T11.Y, T11.X, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
...
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v19, 16, v1
...
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v18, 0xffff, v1
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v16, 0xffff, v0
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v22, 0xffff, v3
...
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v31, 16, v11
...
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v30, 0xffff, v11
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v28, 0xffff, v10
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v11, 16, v13
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v9, 16, v12
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v35, 16, v15
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v33, 16, v14
...
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v17, 16, v5
...
; GCN-HSA-NEXT:    s_waitcnt vmcnt(4)
; GCN-HSA-NEXT:    v_and_b32_e32 v2, 0xffff, v8
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v5, 16, v9
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v3, 16, v8
; GCN-HSA-NEXT:    v_and_b32_e32 v4, 0xffff, v9
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v9, 16, v1
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v7, 16, v0
; GCN-HSA-NEXT:    v_and_b32_e32 v8, 0xffff, v1
; GCN-HSA-NEXT:    v_and_b32_e32 v6, 0xffff, v0
; GCN-HSA-NEXT:    v_mov_b32_e32 v26, s2
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v21, 16, v11
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v19, 16, v10
; GCN-HSA-NEXT:    v_and_b32_e32 v20, 0xffff, v11
; GCN-HSA-NEXT:    v_and_b32_e32 v18, 0xffff, v10
; GCN-HSA-NEXT:    flat_store_dwordx4 v[22:23], v[6:9]
; GCN-HSA-NEXT:    flat_store_dwordx4 v[24:25], v[18:21]
; GCN-HSA-NEXT:    flat_store_dwordx4 v[26:27], v[2:5]
; GCN-HSA-NEXT:    flat_store_dwordx4 v[28:29], v[14:17]
; GCN-HSA-NEXT:    s_endpgm
;
...
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(3)
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v19, 16, v1
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v18, 0xffff, v1
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v17, 16, v0
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v35, 16, v15
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v34, 0xffff, v15
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v33, 16, v14
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v32, 0xffff, v14
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v16, 0xffff, v0
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v23, 16, v3
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v22, 0xffff, v3
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v21, 16, v2
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v20, 0xffff, v2
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v3, 16, v5
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v2, 0xffff, v5
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v1, 16, v4
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v0, 0xffff, v4
...
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v31, 16, v11
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v30, 0xffff, v11
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v29, 16, v10
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v28, 0xffff, v10
...
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T19, T29.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T25, T27.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T20, T26.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T23, T24.X
; CM-NEXT:    CF_END
...
; CM-NEXT:     LSHR * T23.W, T20.W, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT * T23.Z, T20.W, literal.x,
; CM-NEXT:    65535(9.183409e-41), 0(0.000000e+00)
; CM-NEXT:     LSHR T23.Y, T20.Z, literal.x,
; CM-NEXT:     LSHR * T20.W, T20.Y, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T23.X, T20.Z, literal.x,
; CM-NEXT:     AND_INT T20.Z, T20.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 112(1.569454e-43)
; CM-NEXT:     LSHR T24.X, PV.W, literal.x,
; CM-NEXT:     LSHR T20.Y, T20.X, literal.y,
; CM-NEXT:     LSHR * T25.W, T19.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T20.X, T20.X, literal.x,
; CM-NEXT:     AND_INT T25.Z, T19.W, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 96(1.345247e-43)
; CM-NEXT:     LSHR T26.X, PV.W, literal.x,
; CM-NEXT:     LSHR T25.Y, T19.Z, literal.y,
; CM-NEXT:     LSHR * T19.W, T19.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T25.X, T19.Z, literal.x,
; CM-NEXT:     AND_INT T19.Z, T19.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 80(1.121039e-43)
; CM-NEXT:     LSHR T27.X, PV.W, literal.x,
; CM-NEXT:     LSHR T19.Y, T19.X, literal.y,
; CM-NEXT:     LSHR * T28.W, T22.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T19.X, T19.X, literal.x,
; CM-NEXT:     AND_INT T28.Z, T22.W, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 64(8.968310e-44)
; CM-NEXT:     LSHR T29.X, PV.W, literal.x,
; CM-NEXT:     LSHR T28.Y, T22.Z, literal.y,
; CM-NEXT:     LSHR * T22.W, T22.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T28.X, T22.Z, literal.x,
; CM-NEXT:     AND_INT T22.Z, T22.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 48(6.726233e-44)
; CM-NEXT:     LSHR T30.X, PV.W, literal.x,
; CM-NEXT:     LSHR T22.Y, T22.X, literal.y,
; CM-NEXT:     LSHR * T31.W, T21.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T22.X, T22.X, literal.x,
; CM-NEXT:     AND_INT T31.Z, T21.W, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 32(4.484155e-44)
; CM-NEXT:     LSHR T32.X, PV.W, literal.x,
; CM-NEXT:     LSHR T31.Y, T21.Z, literal.y,
; CM-NEXT:     LSHR * T21.W, T21.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T31.X, T21.Z, literal.x,
; CM-NEXT:     AND_INT T21.Z, T21.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     LSHR T33.X, PV.W, literal.x,
; CM-NEXT:     LSHR * T21.Y, T21.X, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT * T21.X, T21.X, literal.x,
; CM-NEXT:    65535(9.183409e-41), 0(0.000000e+00)
; CM-NEXT:     LSHR * T34.X, KC0[2].Y, literal.x,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
...
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[12:15], off, s[8:11], 0 offset:48
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(3)
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v19, 16, v1
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v17, 16, v0
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v18, v1, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v16, v0, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v23, 16, v3
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v21, 16, v2
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v22, v3, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v20, v2, 0, 16
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(2)
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v3, 16, v5
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v1, 16, v4
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v2, v5, 0, 16
...
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v31, 16, v11
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v29, 16, v10
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v30, v11, 0, 16
...
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 48
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v16, 16, v13
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v14, 16, v12
...
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v19, 16, v11
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v17, 16, v10
; GCN-HSA-NEXT:    v_bfe_i32 v18, v11, 0, 16
...
; GCN-HSA-NEXT:    flat_store_dwordx4 v[27:28], v[8:11]
...
; GCN-HSA-NEXT:    v_bfe_i32 v6, v1, 0, 16
; GCN-HSA-NEXT:    v_bfe_i32 v4, v0, 0, 16
; GCN-HSA-NEXT:    flat_store_dwordx4 v[29:30], v[8:11]
; GCN-HSA-NEXT:    flat_store_dwordx4 v[31:32], v[4:7]
; GCN-HSA-NEXT:    s_endpgm
;
...
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(3)
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v19, 16, v1
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v17, 16, v0
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v18, v1, 0, 16
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v35, 16, v15
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v33, 16, v14
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v34, v15, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v32, v14, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v16, v0, 0, 16
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v23, 16, v3
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v21, 16, v2
...
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v31, 16, v11
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v29, 16, v10
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v30, v11, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v28, v10, 0, 16
...
; EG-NEXT:     MOV * T19.X, KC0[2].Z,
; EG-NEXT:    ALU clause starting at 21:
; EG-NEXT:     ASHR * T23.W, T20.Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT * T23.Z, T20.Y, 0.0, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     ASHR T23.Y, T20.X, literal.x,
; EG-NEXT:     ASHR * T24.W, T20.W, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T23.X, T20.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T24.Z, T20.W, 0.0, literal.x,
; EG-NEXT:     LSHR * T20.X, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 2(2.802597e-45)
; EG-NEXT:     ASHR T24.Y, T20.Z, literal.x,
; EG-NEXT:     ASHR * T25.W, T19.Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T24.X, T20.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T25.Z, T19.Y, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     LSHR T26.X, PV.W, literal.x,
; EG-NEXT:     ASHR T25.Y, T19.X, literal.y,
; EG-NEXT:     ASHR * T27.W, T19.W, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T25.X, T19.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T27.Z, T19.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 32(4.484155e-44)
; EG-NEXT:     LSHR T19.X, PV.W, literal.x,
; EG-NEXT:     ASHR T27.Y, T19.Z, literal.y,
; EG-NEXT:     ASHR * T28.W, T22.Y, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T27.X, T19.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T28.Z, T22.Y, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 48(6.726233e-44)
; EG-NEXT:     LSHR T29.X, PV.W, literal.x,
; EG-NEXT:     ASHR T28.Y, T22.X, literal.y,
; EG-NEXT:     ASHR * T30.W, T22.W, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T28.X, T22.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T30.Z, T22.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 64(8.968310e-44)
; EG-NEXT:     LSHR T22.X, PV.W, literal.x,
; EG-NEXT:     ASHR T30.Y, T22.Z, literal.y,
; EG-NEXT:     ASHR * T31.W, T21.Y, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T30.X, T22.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T31.Z, T21.Y, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 80(1.121039e-43)
; EG-NEXT:     LSHR T32.X, PV.W, literal.x,
; EG-NEXT:     ASHR T31.Y, T21.X, literal.y,
; EG-NEXT:     ASHR * T33.W, T21.W, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T31.X, T21.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T33.Z, T21.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 96(1.345247e-43)
; EG-NEXT:     LSHR T21.X, PV.W, literal.x,
; EG-NEXT:     ASHR * T33.Y, T21.Z, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
...
; CM-NEXT:     MOV * T19.X, KC0[2].Z,
; CM-NEXT:    ALU clause starting at 21:
; CM-NEXT:     ASHR * T23.W, T20.W, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT * T23.Z, T20.W, 0.0, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     ASHR T23.Y, T20.Z, literal.x,
; CM-NEXT:     ASHR * T20.W, T20.Y, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT T23.X, T20.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T20.Z, T20.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 112(1.569454e-43)
; CM-NEXT:     LSHR T24.X, PV.W, literal.x,
; CM-NEXT:     ASHR T20.Y, T20.X, literal.y,
; CM-NEXT:     ASHR * T25.W, T19.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T20.X, T20.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T25.Z, T19.W, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 96(1.345247e-43)
; CM-NEXT:     LSHR T26.X, PV.W, literal.x,
; CM-NEXT:     ASHR T25.Y, T19.Z, literal.y,
; CM-NEXT:     ASHR * T19.W, T19.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T25.X, T19.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T19.Z, T19.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 80(1.121039e-43)
; CM-NEXT:     LSHR T27.X, PV.W, literal.x,
; CM-NEXT:     ASHR T19.Y, T19.X, literal.y,
; CM-NEXT:     ASHR * T28.W, T22.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T19.X, T19.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T28.Z, T22.W, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 64(8.968310e-44)
; CM-NEXT:     LSHR T29.X, PV.W, literal.x,
; CM-NEXT:     ASHR T28.Y, T22.Z, literal.y,
; CM-NEXT:     ASHR * T22.W, T22.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T28.X, T22.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T22.Z, T22.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 48(6.726233e-44)
; CM-NEXT:     LSHR T30.X, PV.W, literal.x,
; CM-NEXT:     ASHR T22.Y, T22.X, literal.y,
; CM-NEXT:     ASHR * T31.W, T21.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
...
; CM-NEXT:    16(2.242078e-44), 32(4.484155e-44)
; CM-NEXT:     LSHR T32.X, PV.W, literal.x,
; CM-NEXT:     ASHR T31.Y, T21.Z, literal.y,
; CM-NEXT:     ASHR * T21.W, T21.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T31.X, T21.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T21.Z, T21.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T33.X, PV.W, literal.x,
; CM-NEXT:     ASHR * T21.Y, T21.X, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
...
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[28:31], off, s[8:11], 0 offset:64
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[32:35], off, s[8:11], 0 offset:80
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[36:39], off, s[8:11], 0 offset:96
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[40:43], off, s[8:11], 0 offset:112
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(7)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v19, 16, v13
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v17, 16, v12
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v23, 16, v15
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v21, 16, v14
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(6)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v27, 16, v9
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v25, 16, v8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v18, 0xffff, v13
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v16, 0xffff, v12
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v16, off, s[12:15], 0 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v17, off, s[12:15], 0 offset:4 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v18, off, s[12:15], 0 offset:8 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v19, off, s[12:15], 0 offset:12 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v22, 0xffff, v15
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v20, 0xffff, v14
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v19, 16, v11
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v17, 16, v10
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v26, 0xffff, v9
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v24, 0xffff, v8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v18, 0xffff, v11
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v16, 0xffff, v10
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(9)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v47, 16, v5
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v45, 16, v4
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v15, 16, v7
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v13, 16, v6
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v46, 0xffff, v5
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v44, 0xffff, v4
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v14, 0xffff, v7
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v12, 0xffff, v6
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(8)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v51, 16, v1
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v49, 16, v0
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v11, 16, v3
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v9, 16, v2
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v50, 0xffff, v1
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v48, 0xffff, v0
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v10, 0xffff, v3
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v8, 0xffff, v2
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(7)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v55, 16, v29
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v53, 16, v28
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v59, 16, v31
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v57, 16, v30
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v54, 0xffff, v29
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v52, 0xffff, v28
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v58, 0xffff, v31
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v56, 0xffff, v30
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(6)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v31, 16, v33
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v29, 16, v32
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v63, 16, v35
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v61, 16, v34
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v30, 0xffff, v33
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v28, 0xffff, v32
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v62, 0xffff, v35
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v60, 0xffff, v34
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(5)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v35, 16, v37
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v33, 16, v36
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v7, 16, v39
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v5, 16, v38
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v34, 0xffff, v37
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v32, 0xffff, v36
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v6, 0xffff, v39
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v4, 0xffff, v38
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(4)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v39, 16, v41
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v37, 16, v40
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v3, 16, v43
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v1, 16, v42
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v38, 0xffff, v41
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v36, 0xffff, v40
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v2, 0xffff, v43
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v0, 0xffff, v42
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:240
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[36:39], off, s[0:3], 0 offset:224
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[60:63], off, s[0:3], 0 offset:176
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[28:31], off, s[0:3], 0 offset:160
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[56:59], off, s[0:3], 0 offset:144
...
; GCN-HSA-NEXT:    flat_load_dwordx4 v[22:25], v[18:19]
...
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    s_waitcnt vmcnt(5)
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v33, 16, v15
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v31, 16, v14
; GCN-HSA-NEXT:    v_and_b32_e32 v32, 0xffff, v15
; GCN-HSA-NEXT:    v_and_b32_e32 v30, 0xffff, v14
; GCN-HSA-NEXT:    flat_load_dwordx4 v[18:21], v[16:17]
; GCN-HSA-NEXT:    flat_load_dwordx4 v[14:17], v[34:35]
...
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v33, 16, v13
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v31, 16, v12
; GCN-HSA-NEXT:    v_and_b32_e32 v32, 0xffff, v13
; GCN-HSA-NEXT:    v_and_b32_e32 v30, 0xffff, v12
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s1
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s0
; GCN-HSA-NEXT:    s_add_u32 s14, s0, 0x90
; GCN-HSA-NEXT:    flat_store_dwordx4 v[12:13], v[30:33]
; GCN-HSA-NEXT:    s_addc_u32 s15, s1, 0
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v33, 16, v3
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v31, 16, v2
; GCN-HSA-NEXT:    v_and_b32_e32 v32, 0xffff, v3
; GCN-HSA-NEXT:    v_and_b32_e32 v30, 0xffff, v2
...
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v33, 16, v11
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v31, 16, v10
; GCN-HSA-NEXT:    v_and_b32_e32 v32, 0xffff, v11
; GCN-HSA-NEXT:    v_and_b32_e32 v30, 0xffff, v10
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s11
; GCN-HSA-NEXT:    flat_store_dwordx4 v[2:3], v[30:33]
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s12
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v12, 16, v9
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v10, 16, v8
; GCN-HSA-NEXT:    v_and_b32_e32 v11, 0xffff, v9
; GCN-HSA-NEXT:    v_and_b32_e32 v9, 0xffff, v8
...
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v8, 16, v5
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v6, 16, v4
; GCN-HSA-NEXT:    v_and_b32_e32 v7, 0xffff, v5
...
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v3, 16, v28
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v5, 16, v29
; GCN-HSA-NEXT:    v_and_b32_e32 v4, 0xffff, v29
; GCN-HSA-NEXT:    v_and_b32_e32 v2, 0xffff, v28
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v9, 16, v27
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v7, 16, v26
; GCN-HSA-NEXT:    v_and_b32_e32 v8, 0xffff, v27
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 0x80
; GCN-HSA-NEXT:    v_mov_b32_e32 v11, s4
; GCN-HSA-NEXT:    v_and_b32_e32 v6, 0xffff, v26
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v10, 16, v1
; GCN-HSA-NEXT:    flat_store_dwordx4 v[30:31], v[2:5]
...
; GCN-HSA-NEXT:    s_waitcnt vmcnt(12)
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v20, 16, v17
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v18, 16, v16
; GCN-HSA-NEXT:    v_and_b32_e32 v19, 0xffff, v17
; GCN-HSA-NEXT:    v_and_b32_e32 v17, 0xffff, v16
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[12:13], v[17:20]
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s2
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 48
...
; GCN-NOHSA-VI-NEXT:    buffer_load_dwordx4 v[28:31], off, s[8:11], 0 offset:64
; GCN-NOHSA-VI-NEXT:    buffer_load_dwordx4 v[32:35], off, s[8:11], 0 offset:80
; GCN-NOHSA-VI-NEXT:    buffer_load_dwordx4 v[36:39], off, s[8:11], 0 offset:96
; GCN-NOHSA-VI-NEXT:    buffer_load_dwordx4 v[40:43], off, s[8:11], 0 offset:112
; GCN-NOHSA-VI-NEXT:    s_addc_u32 s89, s89, 0
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(7)
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v19, 16, v13
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v17, 16, v12
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v18, 0xffff, v13
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v16, 0xffff, v12
; GCN-NOHSA-VI-NEXT:    buffer_store_dword v16, off, s[88:91], 0 ; 4-byte Folded Spill
; GCN-NOHSA-VI-NEXT:    buffer_store_dword v17, off, s[88:91], 0 offset:4 ; 4-byte Folded Spill
; GCN-NOHSA-VI-NEXT:    buffer_store_dword v18, off, s[88:91], 0 offset:8 ; 4-byte Folded Spill
; GCN-NOHSA-VI-NEXT:    buffer_store_dword v19, off, s[88:91], 0 offset:12 ; 4-byte Folded Spill
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(10)
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v27, 16, v9
...
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v24, 0xffff, v8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v18, 0xffff, v11
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v16, 0xffff, v10
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(8)
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v51, 16, v1
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v49, 16, v0
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v11, 16, v3
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v9, 16, v2
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v50, 0xffff, v1
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v48, 0xffff, v0
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v10, 0xffff, v3
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v8, 0xffff, v2
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(4)
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v3, 16, v43
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v1, 16, v42
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v2, 0xffff, v43
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v0, 0xffff, v42
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v23, 16, v15
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v21, 16, v14
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v22, 0xffff, v15
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v20, 0xffff, v14
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v47, 16, v5
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v45, 16, v4
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v15, 16, v7
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v13, 16, v6
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v46, 0xffff, v5
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v44, 0xffff, v4
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v14, 0xffff, v7
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v12, 0xffff, v6
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v55, 16, v29
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v53, 16, v28
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v59, 16, v31
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v57, 16, v30
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v54, 0xffff, v29
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v52, 0xffff, v28
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v58, 0xffff, v31
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v56, 0xffff, v30
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v31, 16, v33
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v29, 16, v32
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v63, 16, v35
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v61, 16, v34
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v30, 0xffff, v33
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v28, 0xffff, v32
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v62, 0xffff, v35
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v60, 0xffff, v34
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v35, 16, v37
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v33, 16, v36
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v7, 16, v39
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v5, 16, v38
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v34, 0xffff, v37
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v32, 0xffff, v36
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v6, 0xffff, v39
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v4, 0xffff, v38
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v39, 16, v41
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v37, 16, v40
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v38, 0xffff, v41
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v36, 0xffff, v40
...
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[60:63], off, s[0:3], 0 offset:176
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[28:31], off, s[0:3], 0 offset:160
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[56:59], off, s[0:3], 0 offset:144
...
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T48, T66.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T63, T65.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T49, T64.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T60, T62.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T50, T61.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T57, T59.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T51, T58.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T54, T56.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T37, T55.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T35, T53.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T38, T52.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T45, T47.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T39, T46.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T42, T44.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T36, T43.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T40, T41.X
; CM-NEXT:    CF_END
...
; CM-NEXT:     LSHR * T40.W, T36.W, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT * T40.Z, T36.W, literal.x,
; CM-NEXT:    65535(9.183409e-41), 0(0.000000e+00)
; CM-NEXT:     LSHR T40.Y, T36.Z, literal.x,
; CM-NEXT:     LSHR * T36.W, T36.Y, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T40.X, T36.Z, literal.x,
; CM-NEXT:     AND_INT T36.Z, T36.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 240(3.363116e-43)
; CM-NEXT:     LSHR T41.X, PV.W, literal.x,
; CM-NEXT:     LSHR T36.Y, T36.X, literal.y,
; CM-NEXT:     LSHR * T42.W, T39.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T36.X, T36.X, literal.x,
; CM-NEXT:     AND_INT T42.Z, T39.W, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 224(3.138909e-43)
; CM-NEXT:     LSHR T43.X, PV.W, literal.x,
; CM-NEXT:     LSHR T42.Y, T39.Z, literal.y,
; CM-NEXT:     LSHR * T39.W, T39.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T42.X, T39.Z, literal.x,
; CM-NEXT:     AND_INT T39.Z, T39.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 208(2.914701e-43)
; CM-NEXT:     LSHR T44.X, PV.W, literal.x,
; CM-NEXT:     LSHR T39.Y, T39.X, literal.y,
; CM-NEXT:     LSHR * T45.W, T38.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T39.X, T39.X, literal.x,
; CM-NEXT:     AND_INT T45.Z, T38.W, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 192(2.690493e-43)
; CM-NEXT:     LSHR T46.X, PV.W, literal.x,
; CM-NEXT:     LSHR T45.Y, T38.Z, literal.y,
; CM-NEXT:     LSHR * T38.W, T38.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T45.X, T38.Z, literal.x,
; CM-NEXT:     AND_INT T38.Z, T38.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 176(2.466285e-43)
; CM-NEXT:     LSHR T47.X, PV.W, literal.x,
; CM-NEXT:     LSHR T38.Y, T38.X, literal.y,
; CM-NEXT:     LSHR * T35.W, T37.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T38.X, T38.X, literal.x,
; CM-NEXT:     AND_INT T35.Z, T37.W, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 160(2.242078e-43)
; CM-NEXT:    ALU clause starting at 90:
; CM-NEXT:     LSHR T52.X, T0.W, literal.x,
; CM-NEXT:     LSHR T35.Y, T37.Z, literal.y,
; CM-NEXT:     LSHR * T37.W, T37.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T35.X, T37.Z, literal.x,
; CM-NEXT:     AND_INT T37.Z, T37.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 144(2.017870e-43)
; CM-NEXT:     LSHR T53.X, PV.W, literal.x,
; CM-NEXT:     LSHR T37.Y, T37.X, literal.y,
; CM-NEXT:     LSHR * T54.W, T51.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T37.X, T37.X, literal.x,
; CM-NEXT:     AND_INT T54.Z, T51.W, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 128(1.793662e-43)
; CM-NEXT:     LSHR T55.X, PV.W, literal.x,
; CM-NEXT:     LSHR T54.Y, T51.Z, literal.y,
; CM-NEXT:     LSHR * T51.W, T51.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T54.X, T51.Z, literal.x,
; CM-NEXT:     AND_INT T51.Z, T51.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 112(1.569454e-43)
; CM-NEXT:     LSHR T56.X, PV.W, literal.x,
; CM-NEXT:     LSHR T51.Y, T51.X, literal.y,
; CM-NEXT:     LSHR * T57.W, T50.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T51.X, T51.X, literal.x,
; CM-NEXT:     AND_INT T57.Z, T50.W, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 96(1.345247e-43)
; CM-NEXT:     LSHR T58.X, PV.W, literal.x,
; CM-NEXT:     LSHR T57.Y, T50.Z, literal.y,
; CM-NEXT:     LSHR * T50.W, T50.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T57.X, T50.Z, literal.x,
; CM-NEXT:     AND_INT T50.Z, T50.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 80(1.121039e-43)
; CM-NEXT:     LSHR T59.X, PV.W, literal.x,
; CM-NEXT:     LSHR T50.Y, T50.X, literal.y,
; CM-NEXT:     LSHR * T60.W, T49.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T50.X, T50.X, literal.x,
; CM-NEXT:     AND_INT T60.Z, T49.W, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 64(8.968310e-44)
; CM-NEXT:     LSHR T61.X, PV.W, literal.x,
; CM-NEXT:     LSHR T60.Y, T49.Z, literal.y,
; CM-NEXT:     LSHR * T49.W, T49.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T60.X, T49.Z, literal.x,
; CM-NEXT:     AND_INT T49.Z, T49.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 48(6.726233e-44)
; CM-NEXT:     LSHR T62.X, PV.W, literal.x,
; CM-NEXT:     LSHR T49.Y, T49.X, literal.y,
; CM-NEXT:     LSHR * T63.W, T48.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T49.X, T49.X, literal.x,
; CM-NEXT:     AND_INT T63.Z, T48.W, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 32(4.484155e-44)
; CM-NEXT:     LSHR T64.X, PV.W, literal.x,
; CM-NEXT:     LSHR T63.Y, T48.Z, literal.y,
; CM-NEXT:     LSHR * T48.W, T48.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT T63.X, T48.Z, literal.x,
; CM-NEXT:     AND_INT T48.Z, T48.Y, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     LSHR T65.X, PV.W, literal.x,
; CM-NEXT:     LSHR * T48.Y, T48.X, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     AND_INT * T48.X, T48.X, literal.x,
; CM-NEXT:    65535(9.183409e-41), 0(0.000000e+00)
; CM-NEXT:     LSHR * T66.X, KC0[2].Y, literal.x,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
...
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[6:9], off, s[4:7], 0
...
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v4, v8, 0, 16
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(6)
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v11, 16, v33
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v9, 16, v32
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v10, v33, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v8, v32, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v15, 16, v35
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v13, 16, v34
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v14, v35, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v12, v34, 0, 16
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(5)
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v35, 16, v37
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v33, 16, v36
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v34, v37, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v32, v36, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v47, 16, v39
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v45, 16, v38
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v46, v39, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v44, v38, 0, 16
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(4)
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v39, 16, v41
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v37, 16, v40
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v38, v41, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v36, v40, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v51, 16, v43
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v49, 16, v42
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v50, v43, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v48, v42, 0, 16
...
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v55, 16, v31
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v53, 16, v30
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v54, v31, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v52, v30, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v31, 16, v25
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v29, 16, v24
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v30, v25, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v28, v24, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v59, 16, v27
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v57, 16, v26
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v58, v27, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v56, v26, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v27, 16, v21
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v25, 16, v20
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v26, v21, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v24, v20, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v63, 16, v23
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v61, 16, v22
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v62, v23, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v60, v22, 0, 16
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v23, 16, v17
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v21, 16, v16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v22, v17, 0, 16
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v20, v16, 0, 16
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[56:59], off, s[0:3], 0 offset:176
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[28:31], off, s[0:3], 0 offset:160
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[52:55], off, s[0:3], 0 offset:144
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[40:43], off, s[0:3], 0 offset:128
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[48:51], off, s[0:3], 0 offset:112
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[36:39], off, s[0:3], 0 offset:96
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[44:47], off, s[0:3], 0 offset:80
...
; GCN-HSA-NEXT:    s_addc_u32 s5, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v36, s5
; GCN-HSA-NEXT:    v_mov_b32_e32 v35, s4
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 0xf0
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
...
; GCN-HSA-NEXT:    flat_store_dwordx4 v[35:36], v[31:34]
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v30, 16, v28
; GCN-HSA-NEXT:    v_mov_b32_e32 v34, s1
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v32, 16, v29
; GCN-HSA-NEXT:    v_bfe_i32 v31, v29, 0, 16
; GCN-HSA-NEXT:    v_bfe_i32 v29, v28, 0, 16
; GCN-HSA-NEXT:    v_mov_b32_e32 v33, s0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[33:34], v[29:32]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(8)
...
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[31:32], v[27:30]
...
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v25, 16, v6
; GCN-HSA-NEXT:    v_bfe_i32 v26, v7, 0, 16
; GCN-HSA-NEXT:    v_bfe_i32 v24, v6, 0, 16
; GCN-HSA-NEXT:    flat_store_dwordx4 v[31:32], v[24:27]
; GCN-HSA-NEXT:    v_mov_b32_e32 v31, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v30, s2
...
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v25, 16, v4
; GCN-HSA-NEXT:    v_bfe_i32 v26, v5, 0, 16
; GCN-HSA-NEXT:    v_bfe_i32 v24, v4, 0, 16
; GCN-HSA-NEXT:    s_waitcnt vmcnt(9)
...
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v5, 16, v18
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v3, 16, v17
; GCN-HSA-NEXT:    v_bfe_i32 v2, v17, 0, 16
; GCN-HSA-NEXT:    v_bfe_i32 v4, v18, 0, 16
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, s2
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 64
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v7, 16, v19
...
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v17, 16, v12
...
; GCN-NOHSA-VI-NEXT:    buffer_store_dword v19, off, s[88:91], 0 offset:12 ; 4-byte Folded Spill
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(10)
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v19, 16, v9
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v17, 16, v8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v18, v9, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v16, v8, 0, 16
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v43, 16, v11
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v41, 16, v10
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v42, v11, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v40, v10, 0, 16
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(8)
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v11, 16, v1
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v9, 16, v0
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v10, v1, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v8, v0, 0, 16
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v51, 16, v3
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v49, 16, v2
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v50, v3, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v48, v2, 0, 16
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(4)
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v3, 16, v39
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v1, 16, v38
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v2, v39, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v0, v38, 0, 16
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v23, 16, v15
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v21, 16, v14
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v22, v15, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v20, v14, 0, 16
...
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v47, 16, v7
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v45, 16, v6
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v46, v7, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v44, v6, 0, 16
...
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v55, 16, v27
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v53, 16, v26
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v54, v27, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v52, v26, 0, 16
...
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v59, 16, v31
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v57, 16, v30
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v58, v31, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v56, v30, 0, 16
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v31, 16, v33
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v29, 16, v32
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v30, v33, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v28, v32, 0, 16
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v63, 16, v35
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v61, 16, v34
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v62, v35, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v60, v34, 0, 16
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v35, 16, v37
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v33, 16, v36
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v34, v37, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v32, v36, 0, 16
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:240
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[32:35], off, s[0:3], 0 offset:224
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[60:63], off, s[0:3], 0 offset:208
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[28:31], off, s[0:3], 0 offset:192
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[56:59], off, s[0:3], 0 offset:176
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:160
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[52:55], off, s[0:3], 0 offset:144
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0 offset:128
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[48:51], off, s[0:3], 0 offset:112
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[8:11], off, s[0:3], 0 offset:96
...
; EG-NEXT:    ALU 0, @38, KC0[CB0:0-32], KC1[]
; EG-NEXT:    TEX 3 @22
; EG-NEXT:    ALU 51, @39, KC0[CB0:0-32], KC1[]
; EG-NEXT:    TEX 3 @30
; EG-NEXT:    ALU 78, @91, KC0[CB0:0-32], KC1[]
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T65.XYZW, T66.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T63.XYZW, T49.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T62.XYZW, T64.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T60.XYZW, T50.X, 0
...
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T54.XYZW, T52.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T53.XYZW, T55.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T37.XYZW, T38.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T47.XYZW, T48.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T45.XYZW, T39.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T44.XYZW, T46.X, 0
...
; EG-NEXT:    CF_END
; EG-NEXT:    Fetch clause starting at 22:
; EG-NEXT:     VTX_READ_128 T41.XYZW, T37.X, 0, #1
...
; EG-NEXT:     MOV * T37.X, KC0[2].Z,
; EG-NEXT:    ALU clause starting at 39:
; EG-NEXT:     ASHR * T35.W, T41.Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT * T35.Z, T41.Y, 0.0, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     ASHR T35.Y, T41.X, literal.x,
; EG-NEXT:     ASHR * T36.W, T41.W, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T35.X, T41.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T36.Z, T41.W, 0.0, literal.x,
; EG-NEXT:     LSHR * T41.X, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 2(2.802597e-45)
; EG-NEXT:     ASHR T36.Y, T41.Z, literal.x,
; EG-NEXT:     ASHR * T42.W, T40.Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T36.X, T41.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T42.Z, T40.Y, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     LSHR T43.X, PV.W, literal.x,
; EG-NEXT:     ASHR T42.Y, T40.X, literal.y,
; EG-NEXT:     ASHR * T44.W, T40.W, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T42.X, T40.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T44.Z, T40.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 32(4.484155e-44)
; EG-NEXT:     LSHR T40.X, PV.W, literal.x,
; EG-NEXT:     ASHR T44.Y, T40.Z, literal.y,
; EG-NEXT:     ASHR * T45.W, T39.Y, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T44.X, T40.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T45.Z, T39.Y, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 48(6.726233e-44)
; EG-NEXT:     LSHR T46.X, PV.W, literal.x,
; EG-NEXT:     ASHR T45.Y, T39.X, literal.y,
; EG-NEXT:     ASHR * T47.W, T39.W, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T45.X, T39.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T47.Z, T39.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 64(8.968310e-44)
; EG-NEXT:     LSHR T39.X, PV.W, literal.x,
; EG-NEXT:     ASHR * T47.Y, T39.Z, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T47.X, T39.Z, 0.0, literal.x,
; EG-NEXT:     ADD_INT T0.W, KC0[2].Y, literal.y,
; EG-NEXT:     ASHR * T37.W, T38.Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 80(1.121039e-43)
; EG-NEXT:     LSHR T48.X, PV.W, literal.x,
; EG-NEXT:     BFE_INT * T37.Z, T38.Y, 0.0, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:    ALU clause starting at 91:
; EG-NEXT:     ASHR T37.Y, T38.X, literal.x,
; EG-NEXT:     ASHR * T53.W, T38.W, literal.x,
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T37.X, T38.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T53.Z, T38.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 96(1.345247e-43)
; EG-NEXT:     LSHR T38.X, PV.W, literal.x,
; EG-NEXT:     ASHR T53.Y, T38.Z, literal.y,
; EG-NEXT:     ASHR * T54.W, T52.Y, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T53.X, T38.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T54.Z, T52.Y, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 112(1.569454e-43)
; EG-NEXT:     LSHR T55.X, PV.W, literal.x,
; EG-NEXT:     ASHR T54.Y, T52.X, literal.y,
; EG-NEXT:     ASHR * T56.W, T52.W, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T54.X, T52.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T56.Z, T52.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 128(1.793662e-43)
; EG-NEXT:     LSHR T52.X, PV.W, literal.x,
; EG-NEXT:     ASHR T56.Y, T52.Z, literal.y,
; EG-NEXT:     ASHR * T57.W, T51.Y, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T56.X, T52.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T57.Z, T51.Y, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 144(2.017870e-43)
; EG-NEXT:     LSHR T58.X, PV.W, literal.x,
; EG-NEXT:     ASHR T57.Y, T51.X, literal.y,
; EG-NEXT:     ASHR * T59.W, T51.W, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T57.X, T51.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T59.Z, T51.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 160(2.242078e-43)
; EG-NEXT:     LSHR T51.X, PV.W, literal.x,
; EG-NEXT:     ASHR T59.Y, T51.Z, literal.y,
; EG-NEXT:     ASHR * T60.W, T50.Y, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T59.X, T51.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T60.Z, T50.Y, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 176(2.466285e-43)
; EG-NEXT:     LSHR T61.X, PV.W, literal.x,
; EG-NEXT:     ASHR T60.Y, T50.X, literal.y,
; EG-NEXT:     ASHR * T62.W, T50.W, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T60.X, T50.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T62.Z, T50.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 192(2.690493e-43)
; EG-NEXT:     LSHR T50.X, PV.W, literal.x,
; EG-NEXT:     ASHR T62.Y, T50.Z, literal.y,
; EG-NEXT:     ASHR * T63.W, T49.Y, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T62.X, T50.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T63.Z, T49.Y, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 208(2.914701e-43)
; EG-NEXT:     LSHR T64.X, PV.W, literal.x,
; EG-NEXT:     ASHR T63.Y, T49.X, literal.y,
; EG-NEXT:     ASHR * T65.W, T49.W, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T63.X, T49.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T65.Z, T49.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; EG-NEXT:    16(2.242078e-44), 224(3.138909e-43)
; EG-NEXT:     LSHR T49.X, PV.W, literal.x,
; EG-NEXT:     ASHR * T65.Y, T49.Z, literal.y,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:     BFE_INT T65.X, T49.Z, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
...
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T51, T58.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T54, T56.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T36, T55.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T35, T53.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T37, T52.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T45, T47.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T39, T46.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T42, T44.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T38, T43.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T40, T41.X
; CM-NEXT:    CF_END
; CM-NEXT:    Fetch clause starting at 22:
; CM-NEXT:     VTX_READ_128 T38.XYZW, T35.X, 112, #1
...
; CM-NEXT:     MOV * T35.X, KC0[2].Z,
; CM-NEXT:    ALU clause starting at 39:
; CM-NEXT:     ASHR * T40.W, T38.W, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT * T40.Z, T38.W, 0.0, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     ASHR T40.Y, T38.Z, literal.x,
; CM-NEXT:     ASHR * T38.W, T38.Y, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT T40.X, T38.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T38.Z, T38.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 240(3.363116e-43)
; CM-NEXT:     LSHR T41.X, PV.W, literal.x,
; CM-NEXT:     ASHR T38.Y, T38.X, literal.y,
; CM-NEXT:     ASHR * T42.W, T39.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T38.X, T38.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T42.Z, T39.W, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 224(3.138909e-43)
; CM-NEXT:     LSHR T43.X, PV.W, literal.x,
; CM-NEXT:     ASHR T42.Y, T39.Z, literal.y,
; CM-NEXT:     ASHR * T39.W, T39.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T42.X, T39.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T39.Z, T39.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 208(2.914701e-43)
; CM-NEXT:     LSHR T44.X, PV.W, literal.x,
; CM-NEXT:     ASHR T39.Y, T39.X, literal.y,
; CM-NEXT:     ASHR * T45.W, T37.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T39.X, T39.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T45.Z, T37.W, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 192(2.690493e-43)
; CM-NEXT:     LSHR T46.X, PV.W, literal.x,
; CM-NEXT:     ASHR T45.Y, T37.Z, literal.y,
; CM-NEXT:     ASHR * T37.W, T37.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T45.X, T37.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T37.Z, T37.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 176(2.466285e-43)
; CM-NEXT:     LSHR T47.X, PV.W, literal.x,
; CM-NEXT:     ASHR T37.Y, T37.X, literal.y,
; CM-NEXT:     ASHR * T35.W, T36.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T37.X, T37.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T35.Z, T36.W, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 160(2.242078e-43)
; CM-NEXT:    ALU clause starting at 90:
; CM-NEXT:     LSHR T52.X, T0.W, literal.x,
; CM-NEXT:     ASHR T35.Y, T36.Z, literal.y,
; CM-NEXT:     ASHR * T36.W, T36.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T35.X, T36.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T36.Z, T36.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 144(2.017870e-43)
; CM-NEXT:     LSHR T53.X, PV.W, literal.x,
; CM-NEXT:     ASHR T36.Y, T36.X, literal.y,
; CM-NEXT:     ASHR * T54.W, T51.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T36.X, T36.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T54.Z, T51.W, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 128(1.793662e-43)
; CM-NEXT:     LSHR T55.X, PV.W, literal.x,
; CM-NEXT:     ASHR T54.Y, T51.Z, literal.y,
; CM-NEXT:     ASHR * T51.W, T51.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T54.X, T51.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T51.Z, T51.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 112(1.569454e-43)
; CM-NEXT:     LSHR T56.X, PV.W, literal.x,
; CM-NEXT:     ASHR T51.Y, T51.X, literal.y,
; CM-NEXT:     ASHR * T57.W, T50.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T51.X, T51.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T57.Z, T50.W, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 96(1.345247e-43)
; CM-NEXT:     LSHR T58.X, PV.W, literal.x,
; CM-NEXT:     ASHR T57.Y, T50.Z, literal.y,
; CM-NEXT:     ASHR * T50.W, T50.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T57.X, T50.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T50.Z, T50.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 80(1.121039e-43)
; CM-NEXT:     LSHR T59.X, PV.W, literal.x,
; CM-NEXT:     ASHR T50.Y, T50.X, literal.y,
; CM-NEXT:     ASHR * T60.W, T49.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T50.X, T50.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T60.Z, T49.W, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 64(8.968310e-44)
; CM-NEXT:     LSHR T61.X, PV.W, literal.x,
; CM-NEXT:     ASHR T60.Y, T49.Z, literal.y,
; CM-NEXT:     ASHR * T49.W, T49.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T60.X, T49.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T49.Z, T49.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 48(6.726233e-44)
; CM-NEXT:     LSHR T62.X, PV.W, literal.x,
; CM-NEXT:     ASHR T49.Y, T49.X, literal.y,
; CM-NEXT:     ASHR * T63.W, T48.W, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T49.X, T49.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T63.Z, T48.W, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 32(4.484155e-44)
; CM-NEXT:     LSHR T64.X, PV.W, literal.x,
; CM-NEXT:     ASHR T63.Y, T48.Z, literal.y,
; CM-NEXT:     ASHR * T48.W, T48.Y, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T63.X, T48.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T48.Z, T48.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T65.X, PV.W, literal.x,
; CM-NEXT:     ASHR * T48.Y, T48.X, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:     BFE_INT * T48.X, T48.X, 0.0, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR * T66.X, KC0[2].Y, literal.x,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
  %load = load <64 x i16>, ptr addrspace(1) %in
...
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s10, v3
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s17, s6, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s18, s10, 31
...
; GCN-HSA-NEXT:    v_readfirstlane_b32 s8, v3
...
; GCN-HSA-NEXT:    s_ashr_i32 s14, s4, 31
; GCN-HSA-NEXT:    s_ashr_i32 s15, s4, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s16, s8, 31
...
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v9, 16, v7
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v21, 16, v2
...
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v33, 16, v5
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v31, 0xffff, v5
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v7, 0xffff, v7
...
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s14, v5
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s16, v6
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s18, v7
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x100000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s28, s14, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s29, s14, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s30, s18, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s31, s18, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s33, s6, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s34, s6, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s35, s10, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s36, s10, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x100000
...
; GCN-HSA-NEXT:    v_readfirstlane_b32 s4, v5
; GCN-HSA-NEXT:    v_readfirstlane_b32 s8, v7
; GCN-HSA-NEXT:    v_readfirstlane_b32 s6, v6
; GCN-HSA-NEXT:    s_lshr_b32 s12, s2, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s15, s4, 31
; GCN-HSA-NEXT:    s_ashr_i32 s17, s4, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s21, s8, 16
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s14, v0
; GCN-HSA-NEXT:    v_readfirstlane_b32 s18, v2
; GCN-HSA-NEXT:    v_readfirstlane_b32 s20, v3
; GCN-HSA-NEXT:    s_lshr_b32 s10, s6, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s19, s8, 31
; GCN-HSA-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x100000
; GCN-HSA-NEXT:    v_readfirstlane_b32 s16, v1
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x100000
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s21
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s4
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s2
; GCN-HSA-NEXT:    s_lshr_b32 s2, s18, 16
; GCN-HSA-NEXT:    s_lshr_b32 s4, s14, 16
; GCN-HSA-NEXT:    s_ashr_i32 s21, s20, 31
; GCN-HSA-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x100000
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s8
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s9
...
; GCN-HSA-NEXT:    s_bfe_i64 s[8:9], s[18:19], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s18, s16, 31
; GCN-HSA-NEXT:    s_ashr_i32 s19, s16, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[14:15], s[16:17], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s22, s20, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[16:17], s[20:21], 0x100000
; GCN-HSA-NEXT:    v_mov_b32_e32 v14, s12
; GCN-HSA-NEXT:    v_mov_b32_e32 v15, s13
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x100000
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v23, s18
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v26, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v40, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v55, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v22, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v24, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v18, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v20, v53
...
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v44, 16, v30
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v42, 0xffff, v30
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v30, 16, v31
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v28, 0xffff, v31
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(2)
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v47, 16, v32
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v45, 0xffff, v32
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v50, 16, v33
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v48, 0xffff, v33
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v33, 16, v34
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v31, 0xffff, v34
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v32, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v34, v53
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v41, 16, v29
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v39, 0xffff, v29
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v31, v53
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(3)
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v6, 0xffff, v9
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(2)
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v19, 16, v13
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v17, 0xffff, v13
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v23, 16, v14
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v21, 0xffff, v14
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v27, 16, v15
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v25, 0xffff, v15
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v15, 16, v16
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v13, 0xffff, v16
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[45:48], off, s[0:3], 0 offset:192
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[28:31], off, s[0:3], 0 offset:176
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v45, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v14, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v16, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v28, v53
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v2, 16, v7
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v0, 0xffff, v7
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v5, 16, v8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v3, 0xffff, v8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v8, 16, v9
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v12, 16, v10
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v10, 0xffff, v10
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v54, 16, v35
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v52, 0xffff, v35
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[42:45], off, s[0:3], 0 offset:160
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[13:16], off, s[0:3], 0 offset:112
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v42, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v13, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v7, v53
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v9, v53
...
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T21, T47.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T26, T46.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T27, T45.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T28, T44.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T23, T43.X
...
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T22, T39.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T32, T38.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T33, T37.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T34, T36.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T29, T35.X
; CM-NEXT:    CF_END
; CM-NEXT:    Fetch clause starting at 22:
...
; CM-NEXT:     VTX_READ_128 T29.XYZW, T20.X, 48, #1
; CM-NEXT:    ALU clause starting at 30:
; CM-NEXT:     MOV * T20.X, KC0[2].Z,
; CM-NEXT:    ALU clause starting at 31:
; CM-NEXT:     LSHR * T19.Z, T21.X, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T19.X, T21.X, literal.x,
; CM-NEXT:     MOV T19.Y, 0.0,
; CM-NEXT:     LSHR * T24.Z, T21.Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T24.X, T21.Y, literal.x,
; CM-NEXT:     MOV T24.Y, 0.0,
; CM-NEXT:     LSHR * T25.Z, T21.Z, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T25.X, T21.Z, literal.x,
; CM-NEXT:     MOV T25.Y, 0.0,
; CM-NEXT:     LSHR * T21.Z, T21.W, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T21.X, T21.W, literal.x,
; CM-NEXT:     MOV T21.Y, 0.0,
; CM-NEXT:     LSHR * T26.Z, T23.X, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T26.X, T23.X, literal.x,
; CM-NEXT:     MOV T26.Y, 0.0,
; CM-NEXT:     LSHR * T27.Z, T23.Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T27.X, T23.Y, literal.x,
; CM-NEXT:     MOV T27.Y, 0.0,
; CM-NEXT:     LSHR * T28.Z, T23.Z, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T28.X, T23.Z, literal.x,
; CM-NEXT:     MOV T28.Y, 0.0,
; CM-NEXT:     LSHR * T23.Z, T23.W, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T23.X, T23.W, literal.x,
...
; CM-NEXT:     LSHR * T30.Z, T22.Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T30.X, T22.Y, literal.x,
; CM-NEXT:     MOV T30.Y, 0.0,
; CM-NEXT:     LSHR * T31.Z, T22.Z, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T31.X, T22.Z, literal.x,
; CM-NEXT:     MOV T31.Y, 0.0,
; CM-NEXT:     LSHR * T22.Z, T22.W, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T22.X, T22.W, literal.x,
; CM-NEXT:     MOV T22.Y, 0.0,
; CM-NEXT:     LSHR * T32.Z, T29.X, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T32.X, T29.X, literal.x,
; CM-NEXT:     MOV T32.Y, 0.0,
; CM-NEXT:     LSHR * T33.Z, T29.Y, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T33.X, T29.Y, literal.x,
; CM-NEXT:     MOV T33.Y, 0.0,
; CM-NEXT:     LSHR * T34.Z, T29.Z, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T34.X, T29.Z, literal.x,
; CM-NEXT:     MOV T34.Y, 0.0,
; CM-NEXT:     LSHR * T29.Z, T29.W, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     AND_INT T29.X, T29.W, literal.x,
...
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s22, v1
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s28, v2
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s20, v3
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(2)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s12, v4
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s16, v5
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s18, v6
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s14, v7
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s8, v12
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s42, v13
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s10, v14
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s44, v15
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s4, v8
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s38, v9
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s6, v10
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s40, v11
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s36, s28, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s30, s24, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s46, s18, 16
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x100000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x100000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[26:27], s[24:25], 0x100000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[34:35], s[28:29], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s33, s38, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s47, s38, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s49, s40, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s51, s40, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s53, s42, 31
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[24:25], s[20:21], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s55, s42, 16
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v0, s24
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v1, s25
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[24:25], s[22:23], 0x100000
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s57, s44, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s15, s22, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s17, s22, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s21, s20, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s20, s20, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s62, s44, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x100000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v2, s20
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s63, s16, 31
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v3, s21
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s64, s16, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[58:59], s[16:17], 0x100000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v6, s17
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s65, s14, 31
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v7, s15
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s66, s14, 16
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[22:23], s[50:51], 0x100000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[24:25], s[48:49], 0x100000
...
; GCN-HSA-NEXT:    v_readfirstlane_b32 s2, v4
; GCN-HSA-NEXT:    v_readfirstlane_b32 s8, v7
; GCN-HSA-NEXT:    v_readfirstlane_b32 s6, v5
...
; GCN-HSA-NEXT:    v_readfirstlane_b32 s24, v17
; GCN-HSA-NEXT:    s_lshr_b32 s10, s4, 16
; GCN-HSA-NEXT:    s_ashr_i32 s33, s6, 31
; GCN-HSA-NEXT:    s_ashr_i32 s41, s6, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s46, s8, 31
; GCN-HSA-NEXT:    s_ashr_i32 s47, s8, 16
; GCN-HSA-NEXT:    v_readfirstlane_b32 s18, v14
; GCN-HSA-NEXT:    s_bfe_i64 s[8:9], s[12:13], 0x100000
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s16
; GCN-HSA-NEXT:    s_lshr_b32 s16, s22, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[22:23], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s50, s24, 31
; GCN-HSA-NEXT:    s_ashr_i32 s51, s24, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[22:23], s[24:25], 0x100000
; GCN-HSA-NEXT:    s_waitcnt vmcnt(1)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s24, v10
; GCN-HSA-NEXT:    v_readfirstlane_b32 s30, v13
; GCN-HSA-NEXT:    v_readfirstlane_b32 s20, v15
; GCN-HSA-NEXT:    s_bfe_i64 s[14:15], s[10:11], 0x100000
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s17
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, s6
; GCN-HSA-NEXT:    v_mov_b32_e32 v9, s7
; GCN-HSA-NEXT:    s_lshr_b32 s10, s18, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[6:7], s[18:19], 0x100000
; GCN-HSA-NEXT:    v_readfirstlane_b32 s26, v11
; GCN-HSA-NEXT:    v_readfirstlane_b32 s28, v12
; GCN-HSA-NEXT:    s_bfe_i64 s[18:19], s[16:17], 0x100000
; GCN-HSA-NEXT:    s_lshr_b32 s34, s24, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[16:17], s[24:25], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[24:25], s[30:31], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s48, s20, 31
; GCN-HSA-NEXT:    s_ashr_i32 s49, s20, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x100000
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s22
; GCN-HSA-NEXT:    s_lshr_b32 s22, s28, 16
; GCN-HSA-NEXT:    s_ashr_i32 s52, s26, 31
; GCN-HSA-NEXT:    s_ashr_i32 s53, s26, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[36:37], s[26:27], 0x100000
; GCN-HSA-NEXT:    v_mov_b32_e32 v20, s24
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s24, v0
; GCN-HSA-NEXT:    v_readfirstlane_b32 s26, v2
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s23
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s20
; GCN-HSA-NEXT:    v_mov_b32_e32 v17, s21
; GCN-HSA-NEXT:    s_bfe_i64 s[20:21], s[28:29], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s54, s30, 31
; GCN-HSA-NEXT:    s_ashr_i32 s55, s30, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[28:29], s[34:35], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[34:35], s[22:23], 0x100000
; GCN-HSA-NEXT:    v_readfirstlane_b32 s30, v1
; GCN-HSA-NEXT:    s_lshr_b32 s38, s24, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[22:23], s[24:25], 0x100000
; GCN-HSA-NEXT:    s_lshr_b32 s40, s26, 16
; GCN-HSA-NEXT:    v_readfirstlane_b32 s24, v3
; GCN-HSA-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x100000
; GCN-HSA-NEXT:    v_mov_b32_e32 v21, s25
; GCN-HSA-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s56, s30, 31
; GCN-HSA-NEXT:    s_ashr_i32 s57, s30, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[42:43], s[30:31], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s58, s24, 31
; GCN-HSA-NEXT:    s_ashr_i32 s59, s24, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[44:45], s[24:25], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[24:25], s[38:39], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[30:31], s[40:41], 0x100000
; GCN-HSA-NEXT:    s_add_u32 s38, s0, 48
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, s41
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v14, s51
; GCN-HSA-NEXT:    v_mov_b32_e32 v15, s50
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s49
; GCN-HSA-NEXT:    v_mov_b32_e32 v19, s48
; GCN-HSA-NEXT:    v_mov_b32_e32 v22, s55
; GCN-HSA-NEXT:    v_mov_b32_e32 v23, s54
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s57
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s56
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s37
; GCN-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GCN-HSA-NEXT:    s_nop 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s4
...
; GCN-NOHSA-VI-NEXT:    buffer_load_dwordx4 v[10:13], off, s[8:11], 0 offset:32
; GCN-NOHSA-VI-NEXT:    buffer_load_dwordx4 v[2:5], off, s[8:11], 0 offset:16
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(3)
...
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v1, 16, v6
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(2)
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v6, v17
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v18, 16, v17
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v17, v6, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v19, v18, 0, 16
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v18, 31, v17
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v20, 31, v19
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v6, 16, v16
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[17:20], off, s[0:3], 0 offset:240
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(1)
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v27, v4, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v17, v16, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v19, v6, 0, 16
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v18, 31, v17
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v20, 31, v19
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v6, 16, v15
...
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v16, v15, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v6, v7, 0, 16
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v18, 16, v7
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v7, v13
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v19, 16, v13
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v15, 31, v14
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v17, 31, v16
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[14:17], off, s[0:3], 0 offset:192
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v13, v7, 0, 16
...
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v7, 16, v12
...
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v12, 16, v8
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v8, 31, v7
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v10, 31, v9
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[7:10], off, s[0:3], 0 offset:128
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v15, v2, 0, 16
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v7, 16, v2
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v9, v5
...
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v25, v1, 0, 16
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v1, 16, v4
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v17, 31, v16
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v19, 31, v18
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v29, v1, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v13, v12, 0, 16
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[16:19], off, s[0:3], 0 offset:112
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v21, v20, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v19, v14, 0, 16
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v17, v7, 0, 16
...
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[15:18], off, s[0:3], 0 offset:64
...
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[6:9], off, s[0:3], 0 offset:16
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; GCN-NOHSA-VI-NEXT:    s_endpgm
;
...
; CM-NEXT:    ALU 0, @30, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 0 @22
; CM-NEXT:    ALU 56, @31, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 2 @24
; CM-NEXT:    ALU 73, @88, KC0[CB0:0-32], KC1[]
...
; CM-NEXT:     ADD_INT T0.Z, KC0[2].Y, literal.y,
; CM-NEXT:     ASHR * T35.W, T20.Z, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T36.X, PV.Z, literal.x,
...
; CM-NEXT:     ASHR * T19.W, T20.Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:    ALU clause starting at 88:
; CM-NEXT:     ASHR T37.Y, T37.X, literal.x,
; CM-NEXT:     ASHR T19.Z, T20.Y, literal.y,
; CM-NEXT:     ASHR * T20.W, T20.X, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:    31(4.344025e-44), 16(2.242078e-44)
; CM-NEXT:     BFE_INT T19.X, T20.Y, 0.0, literal.x,
; CM-NEXT:     ASHR T35.Y, T35.X, literal.y,
; CM-NEXT:     ASHR T20.Z, T20.X, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:     ASHR * T41.W, T40.W, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T20.X, T20.X, 0.0, literal.x,
; CM-NEXT:     ASHR T19.Y, PV.X, literal.y,
; CM-NEXT:     ASHR T41.Z, T40.W, literal.x,
; CM-NEXT:     ASHR * T42.W, T40.Z, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T41.X, T40.W, 0.0, literal.x,
; CM-NEXT:     ASHR T20.Y, PV.X, literal.y,
; CM-NEXT:     ASHR T42.Z, T40.Z, literal.x,
; CM-NEXT:     ASHR * T43.W, T40.Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T42.X, T40.Z, 0.0, literal.x,
; CM-NEXT:     ASHR T41.Y, PV.X, literal.y,
; CM-NEXT:     ASHR T43.Z, T40.Y, literal.x,
; CM-NEXT:     ASHR * T40.W, T40.X, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T43.X, T40.Y, 0.0, literal.x,
; CM-NEXT:     ASHR T42.Y, PV.X, literal.y,
; CM-NEXT:     ASHR T40.Z, T40.X, literal.x,
; CM-NEXT:     ASHR * T44.W, T39.W, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T40.X, T40.X, 0.0, literal.x,
; CM-NEXT:     ASHR T43.Y, PV.X, literal.y,
; CM-NEXT:     ASHR T44.Z, T39.W, literal.x,
; CM-NEXT:     ASHR * T45.W, T39.Z, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T44.X, T39.W, 0.0, literal.x,
; CM-NEXT:     ASHR T40.Y, PV.X, literal.y,
; CM-NEXT:     ASHR T45.Z, T39.Z, literal.x,
; CM-NEXT:     ASHR * T46.W, T39.Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T45.X, T39.Z, 0.0, literal.x,
; CM-NEXT:     ASHR T44.Y, PV.X, literal.y,
; CM-NEXT:     ASHR T46.Z, T39.Y, literal.x,
; CM-NEXT:     ASHR * T39.W, T39.X, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T46.X, T39.Y, 0.0, literal.x,
; CM-NEXT:     ASHR T45.Y, PV.X, literal.y,
; CM-NEXT:     ASHR T39.Z, T39.X, literal.x,
; CM-NEXT:     ASHR * T47.W, T38.W, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T39.X, T39.X, 0.0, literal.x,
; CM-NEXT:     ASHR T46.Y, PV.X, literal.y,
; CM-NEXT:     ASHR T47.Z, T38.W, literal.x,
; CM-NEXT:     ASHR * T48.W, T38.Z, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T47.X, T38.W, 0.0, literal.x,
; CM-NEXT:     ASHR T39.Y, PV.X, literal.y,
; CM-NEXT:     ASHR T48.Z, T38.Z, literal.x,
; CM-NEXT:     ASHR * T49.W, T38.Y, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T48.X, T38.Z, 0.0, literal.x,
; CM-NEXT:     ASHR T47.Y, PV.X, literal.y,
; CM-NEXT:     ASHR T49.Z, T38.Y, literal.x,
; CM-NEXT:     ASHR * T38.W, T38.X, literal.y,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T49.X, T38.Y, 0.0, literal.x,
; CM-NEXT:     ASHR T48.Y, PV.X, literal.y,
; CM-NEXT:     ASHR * T38.Z, T38.X, literal.x,
; CM-NEXT:    16(2.242078e-44), 31(4.344025e-44)
; CM-NEXT:     BFE_INT T38.X, T38.X, 0.0, literal.x,
