...
; GFX9-NEXT:    s_mul_hi_u32 s14, s5, s0
; GFX9-NEXT:    s_mul_i32 s15, s5, s0
...
; GFX9-NEXT:    s_mul_i32 s1, s10, s5
; GFX9-NEXT:    s_mul_hi_u32 s15, s10, s14
; GFX9-NEXT:    s_mul_hi_u32 s0, s10, s5
; GFX9-NEXT:    s_add_u32 s1, s15, s1
; GFX9-NEXT:    s_addc_u32 s0, 0, s0
; GFX9-NEXT:    s_mul_hi_u32 s16, s11, s14
; GFX9-NEXT:    s_mul_i32 s14, s11, s14
; GFX9-NEXT:    s_add_u32 s1, s1, s14
; GFX9-NEXT:    s_mul_hi_u32 s15, s11, s5
; GFX9-NEXT:    s_addc_u32 s0, s0, s16
; GFX9-NEXT:    s_addc_u32 s1, s15, 0
; GFX9-NEXT:    s_mul_i32 s5, s11, s5
; GFX9-NEXT:    s_add_u32 s14, s0, s5
; GFX9-NEXT:    s_addc_u32 s5, 0, s1
; GFX9-NEXT:    s_mul_i32 s0, s6, s5
; GFX9-NEXT:    s_mul_hi_u32 s1, s6, s14
; GFX9-NEXT:    s_add_i32 s0, s1, s0
; GFX9-NEXT:    s_mul_i32 s1, s7, s14
; GFX9-NEXT:    s_add_i32 s16, s0, s1
; GFX9-NEXT:    s_mul_i32 s1, s6, s14
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    s_sub_i32 s0, s11, s16
...
; GFX9-NEXT:    s_or_b64 s[4:5], s[14:15], s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v3, v2, s[0:1]
; GFX9-NEXT:    s_add_u32 s0, s4, 1
; GFX9-NEXT:    s_addc_u32 s10, s5, 0
; GFX9-NEXT:    s_add_u32 s1, s4, 2
; GFX9-NEXT:    s_addc_u32 s14, s5, 0
...
; GFX9-NEXT:    s_subb_u32 s0, s11, s16
; GFX9-NEXT:    s_cmp_ge_u32 s0, s7
...
; GFX9-NEXT:    s_xor_b64 s[0:1], s[12:13], s[2:3]
...
; GFX9-NEXT:    s_mul_i32 s16, s0, s5
; GFX9-NEXT:    s_mul_hi_u32 s18, s0, s4
; GFX9-NEXT:    s_mul_i32 s17, s1, s4
; GFX9-NEXT:    s_add_i32 s16, s18, s16
; GFX9-NEXT:    s_mul_i32 s19, s0, s4
...
; GFX9-NEXT:    s_mul_hi_u32 s21, s5, s19
; GFX9-NEXT:    s_mul_i32 s19, s5, s19
; GFX9-NEXT:    s_add_u32 s18, s18, s19
; GFX9-NEXT:    s_mul_hi_u32 s20, s5, s16
...
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, s16, v0
; GFX9-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX9-NEXT:    s_addc_u32 s5, s5, s17
; GFX9-NEXT:    v_readfirstlane_b32 s17, v0
; GFX9-NEXT:    s_mul_i32 s16, s0, s5
; GFX9-NEXT:    s_mul_hi_u32 s18, s0, s17
; GFX9-NEXT:    s_add_i32 s16, s18, s16
; GFX9-NEXT:    s_mul_i32 s1, s1, s17
; GFX9-NEXT:    s_add_i32 s16, s16, s1
; GFX9-NEXT:    s_mul_i32 s0, s0, s17
; GFX9-NEXT:    s_mul_hi_u32 s18, s5, s0
; GFX9-NEXT:    s_mul_i32 s19, s5, s0
; GFX9-NEXT:    s_mul_i32 s21, s17, s16
; GFX9-NEXT:    s_mul_hi_u32 s0, s17, s0
; GFX9-NEXT:    s_mul_hi_u32 s20, s17, s16
; GFX9-NEXT:    s_add_u32 s0, s0, s21
; GFX9-NEXT:    s_addc_u32 s17, 0, s20
; GFX9-NEXT:    s_add_u32 s0, s0, s19
; GFX9-NEXT:    s_mul_hi_u32 s1, s5, s16
; GFX9-NEXT:    s_addc_u32 s0, s17, s18
; GFX9-NEXT:    s_addc_u32 s1, s1, 0
; GFX9-NEXT:    s_mul_i32 s16, s5, s16
...
; GFX9-NEXT:    v_readfirstlane_b32 s18, v0
; GFX9-NEXT:    s_mul_i32 s1, s8, s5
; GFX9-NEXT:    s_mul_hi_u32 s19, s8, s18
; GFX9-NEXT:    s_mul_hi_u32 s0, s8, s5
; GFX9-NEXT:    s_add_u32 s1, s19, s1
; GFX9-NEXT:    s_addc_u32 s0, 0, s0
; GFX9-NEXT:    s_mul_hi_u32 s20, s9, s18
; GFX9-NEXT:    s_mul_i32 s18, s9, s18
; GFX9-NEXT:    s_add_u32 s1, s1, s18
; GFX9-NEXT:    s_mul_hi_u32 s19, s9, s5
; GFX9-NEXT:    s_addc_u32 s0, s0, s20
; GFX9-NEXT:    s_addc_u32 s1, s19, 0
; GFX9-NEXT:    s_mul_i32 s5, s9, s5
; GFX9-NEXT:    s_add_u32 s18, s0, s5
; GFX9-NEXT:    s_addc_u32 s5, 0, s1
; GFX9-NEXT:    s_mul_i32 s0, s14, s5
; GFX9-NEXT:    s_mul_hi_u32 s1, s14, s18
; GFX9-NEXT:    s_add_i32 s0, s1, s0
; GFX9-NEXT:    s_mul_i32 s1, s15, s18
; GFX9-NEXT:    s_add_i32 s20, s0, s1
; GFX9-NEXT:    s_mul_i32 s1, s14, s18
; GFX9-NEXT:    v_mov_b32_e32 v0, s1
; GFX9-NEXT:    s_sub_i32 s0, s9, s20
...
; GFX9-NEXT:    s_add_u32 s0, s18, 1
; GFX9-NEXT:    s_addc_u32 s5, s19, 0
; GFX9-NEXT:    s_add_u32 s1, s18, 2
; GFX9-NEXT:    s_addc_u32 s8, s19, 0
...
; GFX9-NEXT:    s_subb_u32 s0, s9, s20
...
; GFX9-NEXT:    s_mul_hi_u32 s5, s5, s16
...
; GFX9-NEXT:    s_mul_hi_u32 s15, s14, s13
; GFX9-NEXT:    s_addc_u32 s5, s12, s17
; GFX9-NEXT:    s_addc_u32 s12, s15, 0
; GFX9-NEXT:    s_mul_i32 s13, s14, s13
; GFX9-NEXT:    s_add_u32 s5, s5, s13
; GFX9-NEXT:    s_addc_u32 s12, 0, s12
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, s5, v2
; GFX9-NEXT:    s_cmp_lg_u64 vcc, 0
