...
; GFX6-NEXT:    v_mad_f32 v0, -v0, v2, v5
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v0|, v2
; GFX6-NEXT:    s_or_b32 s4, s4, s5
; GFX6-NEXT:    v_addc_u32_e32 v0, vcc, 0, v1, vcc
...
; GFX6-NEXT:    v_readfirstlane_b32 s0, v0
; GFX6-NEXT:    s_mul_i32 s14, s1, s13
; GFX6-NEXT:    v_readfirstlane_b32 s17, v2
; GFX6-NEXT:    s_mul_i32 s15, s12, s0
; GFX6-NEXT:    s_mul_i32 s16, s1, s0
...
; GFX6-NEXT:    s_mul_i32 s17, s0, s14
...
; GFX6-NEXT:    s_add_u32 s14, s0, s14
; GFX6-NEXT:    v_mov_b32_e32 v0, s14
; GFX6-NEXT:    v_mul_hi_u32 v0, s1, v0
; GFX6-NEXT:    s_mov_b32 s0, s4
; GFX6-NEXT:    s_addc_u32 s4, s13, s15
; GFX6-NEXT:    s_mul_i32 s13, s1, s4
; GFX6-NEXT:    v_readfirstlane_b32 s15, v0
; GFX6-NEXT:    s_add_i32 s13, s15, s13
; GFX6-NEXT:    s_mul_i32 s12, s12, s14
; GFX6-NEXT:    s_mul_i32 s1, s1, s14
; GFX6-NEXT:    s_add_i32 s12, s13, s12
; GFX6-NEXT:    v_mov_b32_e32 v2, s1
...
; GFX6-NEXT:    v_readfirstlane_b32 s16, v1
; GFX6-NEXT:    s_add_u32 s5, s5, s14
; GFX6-NEXT:    s_addc_u32 s5, s15, s16
...
; GFX6-NEXT:    s_cselect_b32 s19, s19, s20
; GFX6-NEXT:    s_or_b64 s[4:5], s[4:5], s[14:15]
; GFX6-NEXT:    s_add_u32 s14, s4, 1
; GFX6-NEXT:    s_addc_u32 s15, s5, 0
; GFX6-NEXT:    s_add_u32 s20, s4, 2
; GFX6-NEXT:    s_addc_u32 s21, s5, 0
; GFX6-NEXT:    s_cmp_lg_u32 s19, 0
; GFX6-NEXT:    s_cselect_b32 s14, s20, s14
; GFX6-NEXT:    s_cselect_b32 s15, s21, s15
...
; GFX9-NEXT:    s_mul_i32 s4, s5, s11
; GFX9-NEXT:    s_mul_hi_u32 s14, s5, s12
; GFX9-NEXT:    s_mul_i32 s13, s10, s12
; GFX9-NEXT:    s_add_i32 s4, s14, s4
; GFX9-NEXT:    s_mul_i32 s15, s5, s12
; GFX9-NEXT:    s_add_i32 s13, s4, s13
; GFX9-NEXT:    s_mul_hi_u32 s14, s12, s15
; GFX9-NEXT:    s_mul_i32 s17, s12, s13
; GFX9-NEXT:    s_mul_hi_u32 s16, s12, s13
; GFX9-NEXT:    s_add_u32 s14, s14, s17
; GFX9-NEXT:    s_addc_u32 s16, 0, s16
; GFX9-NEXT:    s_mul_hi_u32 s18, s11, s15
; GFX9-NEXT:    s_mul_i32 s15, s11, s15
; GFX9-NEXT:    s_add_u32 s14, s14, s15
; GFX9-NEXT:    s_mul_hi_u32 s17, s11, s13
...
; GFX9-NEXT:    s_add_i32 s13, s13, s10
; GFX9-NEXT:    s_mul_i32 s5, s5, s12
; GFX9-NEXT:    s_mul_hi_u32 s14, s11, s5
; GFX9-NEXT:    s_mul_i32 s15, s11, s5
; GFX9-NEXT:    s_mul_i32 s17, s12, s13
; GFX9-NEXT:    s_mul_hi_u32 s5, s12, s5
; GFX9-NEXT:    s_mul_hi_u32 s16, s12, s13
; GFX9-NEXT:    s_add_u32 s5, s5, s17
; GFX9-NEXT:    s_addc_u32 s16, 0, s16
; GFX9-NEXT:    s_add_u32 s5, s5, s15
; GFX9-NEXT:    s_mul_hi_u32 s10, s11, s13
; GFX9-NEXT:    s_addc_u32 s5, s16, s14
; GFX9-NEXT:    s_addc_u32 s10, s10, 0
; GFX9-NEXT:    s_mul_i32 s13, s11, s13
; GFX9-NEXT:    s_add_u32 s5, s5, s13
; GFX9-NEXT:    s_addc_u32 s10, 0, s10
; GFX9-NEXT:    s_add_u32 s5, s12, s5
; GFX9-NEXT:    s_addc_u32 s12, s11, s10
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    s_sub_i32 s13, s3, s16
...
; GFX9-NEXT:    s_add_u32 s18, s4, 2
; GFX9-NEXT:    s_addc_u32 s19, s5, 0
; GFX9-NEXT:    s_cmp_lg_u32 s17, 0
; GFX9-NEXT:    s_cselect_b32 s12, s18, s12
...
; GFX6-NEXT:    s_sub_u32 s6, 0, s12
; GFX6-NEXT:    s_subb_u32 s7, 0, s13
...
; GFX6-NEXT:    v_readfirstlane_b32 s15, v0
; GFX6-NEXT:    s_mul_i32 s16, s6, s14
; GFX6-NEXT:    v_readfirstlane_b32 s19, v2
; GFX6-NEXT:    s_mul_i32 s17, s7, s15
; GFX6-NEXT:    s_mul_i32 s18, s6, s15
...
; GFX6-NEXT:    s_mul_i32 s16, s6, s14
; GFX6-NEXT:    s_mul_i32 s7, s7, s15
; GFX6-NEXT:    v_readfirstlane_b32 s17, v0
; GFX6-NEXT:    s_add_i32 s16, s17, s16
; GFX6-NEXT:    s_mul_i32 s6, s6, s15
; GFX6-NEXT:    s_add_i32 s7, s16, s7
; GFX6-NEXT:    v_mov_b32_e32 v2, s6
; GFX6-NEXT:    v_mov_b32_e32 v0, s7
...
; GFX6-NEXT:    s_mul_i32 s17, s15, s7
; GFX6-NEXT:    v_readfirstlane_b32 s19, v2
...
; GFX6-NEXT:    v_readfirstlane_b32 s16, v3
; GFX6-NEXT:    s_add_u32 s6, s17, s6
; GFX6-NEXT:    s_addc_u32 s6, s18, s16
; GFX6-NEXT:    v_readfirstlane_b32 s16, v1
; GFX6-NEXT:    s_addc_u32 s16, s16, 0
; GFX6-NEXT:    s_mul_i32 s7, s14, s7
; GFX6-NEXT:    s_add_u32 s6, s6, s7
; GFX6-NEXT:    s_addc_u32 s7, 0, s16
; GFX6-NEXT:    s_add_u32 s16, s15, s6
; GFX6-NEXT:    s_addc_u32 s17, s14, s7
...
; GFX6-NEXT:    v_readfirstlane_b32 s18, v1
; GFX6-NEXT:    s_add_u32 s6, s6, s16
; GFX6-NEXT:    s_addc_u32 s6, s7, s18
; GFX6-NEXT:    v_readfirstlane_b32 s7, v0
; GFX6-NEXT:    s_addc_u32 s7, s7, 0
; GFX6-NEXT:    s_mul_i32 s16, s9, s17
...
; GFX6-NEXT:    s_cselect_b32 s9, s21, s17
...
; GFX6-NEXT:    s_add_u32 s15, s17, s15
; GFX6-NEXT:    s_addc_u32 s16, 0, s16
; GFX6-NEXT:    s_mul_i32 s1, s7, s1
; GFX6-NEXT:    v_readfirstlane_b32 s17, v0
; GFX6-NEXT:    s_add_u32 s1, s15, s1
; GFX6-NEXT:    s_addc_u32 s1, s16, s17
; GFX6-NEXT:    v_readfirstlane_b32 s15, v1
; GFX6-NEXT:    s_addc_u32 s15, s15, 0
; GFX6-NEXT:    s_mul_i32 s14, s7, s14
; GFX6-NEXT:    s_add_u32 s1, s1, s14
; GFX6-NEXT:    s_addc_u32 s14, 0, s15
; GFX6-NEXT:    s_add_u32 s15, s0, s1
; GFX6-NEXT:    v_mov_b32_e32 v0, s15
; GFX6-NEXT:    v_mul_hi_u32 v0, s2, v0
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX6-NEXT:    s_addc_u32 s4, s7, s14
; GFX6-NEXT:    s_mul_i32 s5, s2, s4
; GFX6-NEXT:    v_readfirstlane_b32 s7, v0
; GFX6-NEXT:    s_add_i32 s5, s7, s5
; GFX6-NEXT:    s_mul_i32 s3, s3, s15
; GFX6-NEXT:    s_mul_i32 s2, s2, s15
...
; GFX6-NEXT:    v_mul_hi_u32 v1, s4, v0
; GFX6-NEXT:    v_mul_hi_u32 v0, s15, v0
; GFX6-NEXT:    s_mul_i32 s7, s15, s3
; GFX6-NEXT:    v_readfirstlane_b32 s16, v2
; GFX6-NEXT:    s_add_u32 s7, s16, s7
; GFX6-NEXT:    v_readfirstlane_b32 s14, v0
; GFX6-NEXT:    s_mul_i32 s2, s4, s2
; GFX6-NEXT:    s_addc_u32 s14, 0, s14
; GFX6-NEXT:    v_readfirstlane_b32 s5, v3
; GFX6-NEXT:    s_add_u32 s2, s7, s2
; GFX6-NEXT:    s_addc_u32 s2, s14, s5
...
; GFX6-NEXT:    s_add_u32 s7, s15, s2
; GFX6-NEXT:    s_addc_u32 s14, s4, s3
...
; GFX6-NEXT:    v_mul_hi_u32 v3, s10, v2
; GFX6-NEXT:    s_mul_i32 s2, s10, s14
; GFX6-NEXT:    v_readfirstlane_b32 s15, v1
...
; GFX6-NEXT:    s_sub_u32 s21, s10, s12
...
; GFX6-NEXT:    s_add_u32 s22, s6, 2
; GFX6-NEXT:    s_addc_u32 s23, s7, 0
; GFX6-NEXT:    s_cmp_lg_u32 s21, 0
; GFX6-NEXT:    s_cselect_b32 s14, s22, s14
; GFX6-NEXT:    s_cselect_b32 s15, s23, s15
; GFX6-NEXT:    s_or_b32 s16, s16, s17
...
; GFX9-NEXT:    s_subb_u32 s14, 0, s13
...
; GFX9-NEXT:    s_mul_hi_u32 s19, s1, s16
; GFX9-NEXT:    s_mul_i32 s18, s14, s16
; GFX9-NEXT:    s_add_i32 s17, s19, s17
; GFX9-NEXT:    s_mul_i32 s20, s1, s16
; GFX9-NEXT:    s_add_i32 s17, s17, s18
; GFX9-NEXT:    s_mul_hi_u32 s19, s16, s20
; GFX9-NEXT:    s_mul_i32 s21, s16, s17
; GFX9-NEXT:    s_mul_hi_u32 s18, s16, s17
; GFX9-NEXT:    s_add_u32 s19, s19, s21
; GFX9-NEXT:    s_addc_u32 s18, 0, s18
; GFX9-NEXT:    s_mul_hi_u32 s22, s15, s20
; GFX9-NEXT:    s_mul_i32 s20, s15, s20
; GFX9-NEXT:    s_add_u32 s19, s19, s20
; GFX9-NEXT:    s_mul_hi_u32 s21, s15, s17
...
; GFX9-NEXT:    s_mul_i32 s17, s1, s15
; GFX9-NEXT:    s_mul_hi_u32 s18, s1, s16
; GFX9-NEXT:    s_add_i32 s17, s18, s17
; GFX9-NEXT:    s_mul_i32 s14, s14, s16
; GFX9-NEXT:    s_add_i32 s17, s17, s14
; GFX9-NEXT:    s_mul_i32 s1, s1, s16
; GFX9-NEXT:    s_mul_hi_u32 s18, s15, s1
; GFX9-NEXT:    s_mul_i32 s19, s15, s1
; GFX9-NEXT:    s_mul_i32 s21, s16, s17
; GFX9-NEXT:    s_mul_hi_u32 s1, s16, s1
; GFX9-NEXT:    s_mul_hi_u32 s20, s16, s17
; GFX9-NEXT:    s_add_u32 s1, s1, s21
; GFX9-NEXT:    s_addc_u32 s20, 0, s20
; GFX9-NEXT:    s_add_u32 s1, s1, s19
; GFX9-NEXT:    s_mul_hi_u32 s14, s15, s17
; GFX9-NEXT:    s_addc_u32 s1, s20, s18
; GFX9-NEXT:    s_addc_u32 s14, s14, 0
; GFX9-NEXT:    s_mul_i32 s17, s15, s17
; GFX9-NEXT:    s_add_u32 s1, s1, s17
; GFX9-NEXT:    s_addc_u32 s14, 0, s14
; GFX9-NEXT:    s_add_u32 s1, s16, s1
; GFX9-NEXT:    s_addc_u32 s16, s15, s14
...
; GFX9-NEXT:    s_add_i32 s20, s17, s18
; GFX9-NEXT:    s_sub_i32 s17, s9, s20
...
; GFX9-NEXT:    s_mul_i32 s12, s4, s5
; GFX9-NEXT:    s_add_i32 s13, s13, s15
; GFX9-NEXT:    s_add_i32 s13, s13, s12
; GFX9-NEXT:    s_mul_i32 s18, s1, s5
; GFX9-NEXT:    s_mul_i32 s15, s5, s13
; GFX9-NEXT:    s_mul_hi_u32 s19, s5, s18
; GFX9-NEXT:    s_mul_hi_u32 s12, s5, s13
; GFX9-NEXT:    s_add_u32 s15, s19, s15
; GFX9-NEXT:    s_addc_u32 s12, 0, s12
; GFX9-NEXT:    s_mul_hi_u32 s20, s14, s18
; GFX9-NEXT:    s_mul_i32 s18, s14, s18
; GFX9-NEXT:    s_add_u32 s15, s15, s18
; GFX9-NEXT:    s_mul_hi_u32 s19, s14, s13
; GFX9-NEXT:    s_addc_u32 s12, s12, s20
; GFX9-NEXT:    s_addc_u32 s15, s19, 0
; GFX9-NEXT:    s_mul_i32 s13, s14, s13
; GFX9-NEXT:    s_add_u32 s12, s12, s13
; GFX9-NEXT:    s_addc_u32 s13, 0, s15
; GFX9-NEXT:    s_add_u32 s5, s5, s12
; GFX9-NEXT:    s_addc_u32 s12, s14, s13
; GFX9-NEXT:    s_mul_i32 s13, s1, s12
; GFX9-NEXT:    s_mul_hi_u32 s14, s1, s5
; GFX9-NEXT:    s_add_i32 s13, s14, s13
; GFX9-NEXT:    s_mul_i32 s4, s4, s5
; GFX9-NEXT:    s_add_i32 s13, s13, s4
; GFX9-NEXT:    s_mul_i32 s1, s1, s5
; GFX9-NEXT:    s_mul_hi_u32 s14, s12, s1
; GFX9-NEXT:    s_mul_i32 s15, s12, s1
; GFX9-NEXT:    s_mul_i32 s19, s5, s13
; GFX9-NEXT:    s_mul_hi_u32 s1, s5, s1
; GFX9-NEXT:    s_mul_hi_u32 s18, s5, s13
; GFX9-NEXT:    s_add_u32 s1, s1, s19
; GFX9-NEXT:    s_addc_u32 s18, 0, s18
; GFX9-NEXT:    s_add_u32 s1, s1, s15
; GFX9-NEXT:    s_mul_hi_u32 s4, s12, s13
; GFX9-NEXT:    s_addc_u32 s1, s18, s14
; GFX9-NEXT:    s_addc_u32 s4, s4, 0
; GFX9-NEXT:    s_mul_i32 s13, s12, s13
; GFX9-NEXT:    s_add_u32 s1, s1, s13
; GFX9-NEXT:    s_addc_u32 s4, 0, s4
; GFX9-NEXT:    s_add_u32 s1, s5, s1
; GFX9-NEXT:    s_addc_u32 s12, s12, s4
...
; GFX9-NEXT:    s_sub_i32 s13, s11, s18
; GFX9-NEXT:    s_mul_i32 s14, s8, s12
; GFX9-NEXT:    s_sub_u32 s10, s10, s14
; GFX9-NEXT:    s_cselect_b64 s[14:15], -1, 0
; GFX9-NEXT:    s_subb_u32 s13, s13, s9
; GFX9-NEXT:    s_sub_u32 s19, s10, s8
; GFX9-NEXT:    s_subb_u32 s13, s13, 0
; GFX9-NEXT:    s_cmp_ge_u32 s13, s9
