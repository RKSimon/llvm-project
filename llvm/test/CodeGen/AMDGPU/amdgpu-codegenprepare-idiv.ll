...
; GFX6-NEXT:    s_sext_i32_i16 s5, s4
...
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_i32 s6, s4, 0x30008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s6
; GFX6-NEXT:    s_bfe_i32 s6, s4, 0x30000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s6
; GFX6-NEXT:    s_lshl_b32 s5, s4, 29
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX6-NEXT:    s_lshl_b32 s4, s4, 21
; GFX6-NEXT:    s_xor_b32 s4, s5, s4
; GFX6-NEXT:    s_ashr_i32 s4, s4, 30
; GFX6-NEXT:    v_mul_f32_e32 v2, v1, v2
; GFX6-NEXT:    v_trunc_f32_e32 v2, v2
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_bfe_i32 s3, s4, 0x30008
; GFX9-NEXT:    v_cvt_f32_i32_e32 v1, s3
; GFX9-NEXT:    s_bfe_i32 s3, s4, 0x30000
; GFX9-NEXT:    v_cvt_f32_i32_e32 v2, s3
; GFX9-NEXT:    s_lshl_b32 s2, s4, 29
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v3, v1
; GFX9-NEXT:    s_lshl_b32 s4, s4, 21
; GFX9-NEXT:    s_xor_b32 s2, s2, s4
; GFX9-NEXT:    s_ashr_i32 s2, s2, 30
; GFX9-NEXT:    v_mul_f32_e32 v3, v2, v3
; GFX9-NEXT:    v_trunc_f32_e32 v3, v3
...
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_i32 s3, s4, 0x30008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s3
; GFX6-NEXT:    s_bfe_i32 s3, s4, 0x30000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s3
; GFX6-NEXT:    s_lshl_b32 s2, s4, 29
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX6-NEXT:    s_lshl_b32 s6, s4, 21
...
; GFX6-NEXT:    s_lshl_b32 s1, s10, 17
; GFX6-NEXT:    s_lshl_b32 s3, s0, 17
; GFX6-NEXT:    v_mul_f32_e32 v4, v3, v4
...
; GFX6-NEXT:    s_bfe_i32 s2, s0, 0xf000f
; GFX6-NEXT:    v_cvt_i32_f32_e32 v4, v4
; GFX6-NEXT:    v_cvt_f32_i32_e32 v3, s2
; GFX6-NEXT:    s_bfe_i32 s2, s10, 0xf000f
; GFX6-NEXT:    s_lshl_b32 s0, s0, 2
; GFX6-NEXT:    v_add_i32_e32 v2, vcc, s1, v4
; GFX6-NEXT:    v_cvt_f32_i32_e32 v4, s2
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v5, v3
; GFX6-NEXT:    s_lshl_b32 s1, s10, 2
...
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v4|, |v3|
; GFX6-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GFX6-NEXT:    s_cselect_b32 s0, s2, 0
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, s0, v5
; GFX6-NEXT:    v_bfe_i32 v5, v1, 0, 15
; GFX6-NEXT:    v_cvt_f32_i32_e32 v5, v5
; GFX6-NEXT:    v_alignbit_b32 v0, s11, v0, 30
; GFX6-NEXT:    v_bfe_i32 v4, v0, 0, 15
; GFX6-NEXT:    v_cvt_f32_i32_e32 v4, v4
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v6, v5
; GFX6-NEXT:    v_lshlrev_b32_e32 v0, 17, v0
; GFX6-NEXT:    v_lshlrev_b32_e32 v1, 17, v1
; GFX6-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX6-NEXT:    v_mul_f32_e32 v1, v4, v6
; GFX6-NEXT:    v_trunc_f32_e32 v1, v1
; GFX6-NEXT:    v_mad_f32 v4, -v1, v5, v4
...
; GFX9-NEXT:    s_lshl_b32 s1, s6, 17
; GFX9-NEXT:    s_lshl_b32 s3, s0, 17
; GFX9-NEXT:    v_mul_f32_e32 v5, v4, v5
...
; GFX9-NEXT:    s_bfe_i32 s2, s0, 0xf000f
; GFX9-NEXT:    v_cvt_i32_f32_e32 v5, v5
; GFX9-NEXT:    v_cvt_f32_i32_e32 v4, s2
; GFX9-NEXT:    s_bfe_i32 s2, s6, 0xf000f
; GFX9-NEXT:    s_lshl_b32 s0, s0, 2
; GFX9-NEXT:    v_add_u32_e32 v3, s1, v5
; GFX9-NEXT:    v_cvt_f32_i32_e32 v5, s2
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v6, v4
; GFX9-NEXT:    s_lshl_b32 s1, s6, 2
...
; GFX9-NEXT:    v_bfe_i32 v6, v1, 0, 15
; GFX9-NEXT:    v_cvt_f32_i32_e32 v6, v6
; GFX9-NEXT:    v_alignbit_b32 v0, s7, v0, 30
; GFX9-NEXT:    v_bfe_i32 v5, v0, 0, 15
; GFX9-NEXT:    v_cvt_f32_i32_e32 v5, v5
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v7, v6
; GFX9-NEXT:    v_lshlrev_b32_e32 v0, 17, v0
; GFX9-NEXT:    v_lshlrev_b32_e32 v1, 17, v1
; GFX9-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX9-NEXT:    v_mul_f32_e32 v1, v5, v7
; GFX9-NEXT:    v_trunc_f32_e32 v1, v1
; GFX9-NEXT:    v_cvt_i32_f32_e32 v7, v1
; GFX9-NEXT:    v_ashrrev_i32_e32 v0, 30, v0
; GFX9-NEXT:    v_mad_f32 v1, -v1, v6, v5
...
; GFX6-NEXT:    v_cvt_f32_i32_e32 v3, s3
; GFX6-NEXT:    s_bfe_i32 s3, s10, 0xf0000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v4, s3
; GFX6-NEXT:    v_alignbit_b32 v0, s11, v0, 30
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v5, v3
; GFX6-NEXT:    s_lshl_b32 s2, s10, 17
; GFX6-NEXT:    s_lshl_b32 s11, s0, 17
...
; GFX6-NEXT:    s_or_b32 s11, s2, 1
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[2:3], |v4|, |v3|
; GFX6-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX6-NEXT:    s_cselect_b32 s2, s11, 0
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, s2, v5
; GFX6-NEXT:    s_bfe_i32 s2, s0, 0xf000f
; GFX6-NEXT:    v_cvt_f32_i32_e32 v5, s2
; GFX6-NEXT:    s_bfe_i32 s2, s10, 0xf000f
; GFX6-NEXT:    v_cvt_f32_i32_e32 v6, s2
; GFX6-NEXT:    v_mov_b32_e32 v2, s0
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v7, v5
; GFX6-NEXT:    v_mul_lo_u32 v3, v3, s0
; GFX6-NEXT:    v_alignbit_b32 v2, s1, v2, 30
; GFX6-NEXT:    s_lshl_b32 s1, s10, 2
; GFX6-NEXT:    s_lshl_b32 s0, s0, 2
...
; GFX6-NEXT:    v_bfe_i32 v7, v2, 0, 15
; GFX6-NEXT:    v_cvt_f32_i32_e32 v7, v7
; GFX6-NEXT:    v_bfe_i32 v6, v0, 0, 15
; GFX6-NEXT:    v_cvt_f32_i32_e32 v6, v6
; GFX6-NEXT:    v_and_b32_e32 v1, 0x7fff, v0
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v8, v7
; GFX6-NEXT:    v_and_b32_e32 v4, 0x7fff, v2
; GFX6-NEXT:    v_lshlrev_b32_e32 v0, 17, v0
; GFX6-NEXT:    v_lshlrev_b32_e32 v2, 17, v2
; GFX6-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX6-NEXT:    v_mul_f32_e32 v2, v6, v8
; GFX6-NEXT:    v_trunc_f32_e32 v2, v2
; GFX6-NEXT:    v_mad_f32 v6, -v2, v7, v6
; GFX6-NEXT:    v_cvt_i32_f32_e32 v2, v2
; GFX6-NEXT:    v_sub_i32_e32 v3, vcc, s10, v3
; GFX6-NEXT:    v_ashrrev_i32_e32 v0, 30, v0
; GFX6-NEXT:    v_or_b32_e32 v0, 1, v0
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v6|, |v7|
; GFX6-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; GFX6-NEXT:    v_mul_lo_u32 v5, v5, s9
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, v0, v2
; GFX6-NEXT:    v_mul_lo_u32 v0, v0, v4
...
; GFX9-NEXT:    v_cvt_f32_i32_e32 v6, s2
