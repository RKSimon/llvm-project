...
; CI-NEXT:    v_cndmask_b32_e64 v2, v2, v6, s[2:3]
...
; CI-NEXT:    v_or_b32_e32 v3, v10, v3
; CI-NEXT:    v_or_b32_e32 v2, v9, v2
; CI-NEXT:    v_or_b32_e32 v1, v8, v1
; CI-NEXT:    v_or_b32_e32 v0, v6, v0
; CI-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; CI-NEXT:    s_endpgm
;
...
; CI-NEXT:    v_lshlrev_b32_e32 v9, 5, v0
; CI-NEXT:    s_add_i32 s12, s12, s17
; CI-NEXT:    s_mov_b32 flat_scratch_lo, s13
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    v_mov_b32_e32 v0, s7
; CI-NEXT:    v_add_i32_e32 v5, vcc, s6, v9
; CI-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; CI-NEXT:    v_addc_u32_e32 v6, vcc, 0, v0, vcc
; CI-NEXT:    flat_load_dwordx4 v[1:4], v[5:6]
; CI-NEXT:    v_add_i32_e32 v5, vcc, 16, v5
; CI-NEXT:    v_addc_u32_e32 v6, vcc, 0, v6, vcc
; CI-NEXT:    flat_load_dwordx4 v[5:8], v[5:6]
; CI-NEXT:    v_cvt_f32_f16_e32 v18, s8
...
; CI-NEXT:    v_lshrrev_b32_e32 v13, 16, v3
; CI-NEXT:    v_cvt_f32_f16_e32 v14, v4
; CI-NEXT:    v_lshrrev_b32_e32 v15, 16, v4
; CI-NEXT:    v_cvt_f32_f16_e32 v11, v2
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    v_cvt_f32_f16_e32 v3, v7
; CI-NEXT:    v_lshrrev_b32_e32 v4, 16, v7
; CI-NEXT:    v_cvt_f32_f16_e32 v7, v8
; CI-NEXT:    v_lshrrev_b32_e32 v8, 16, v8
; CI-NEXT:    v_cvt_f32_f16_e32 v8, v8
; CI-NEXT:    v_cvt_f32_f16_e32 v4, v4
; CI-NEXT:    v_cndmask_b32_e64 v7, v7, v18, s[0:1]
; CI-NEXT:    s_cselect_b64 s[0:1], -1, 0
; CI-NEXT:    v_cndmask_b32_e32 v8, v8, v18, vcc
; CI-NEXT:    v_cndmask_b32_e64 v4, v4, v18, s[2:3]
; CI-NEXT:    v_cvt_f16_f32_e32 v8, v8
; CI-NEXT:    v_cndmask_b32_e64 v3, v3, v18, s[0:1]
...
; CI-NEXT:    v_lshlrev_b32_e32 v10, 16, v4
; CI-NEXT:    v_or_b32_e32 v4, v7, v8
; CI-NEXT:    v_mov_b32_e32 v7, s5
; CI-NEXT:    v_add_i32_e32 v9, vcc, s4, v9
; CI-NEXT:    v_or_b32_e32 v3, v3, v10
; CI-NEXT:    v_addc_u32_e32 v10, vcc, 0, v7, vcc
...
; CI-NEXT:    v_cvt_f32_f16_e32 v2, v15
; CI-NEXT:    v_cndmask_b32_e32 v6, v6, v18, vcc
; CI-NEXT:    s_cselect_b64 vcc, -1, 0
; CI-NEXT:    s_cmp_eq_u32 s9, 9
; CI-NEXT:    v_cvt_f32_f16_e32 v0, v1
; CI-NEXT:    v_lshrrev_b32_e32 v1, 16, v1
; CI-NEXT:    v_cndmask_b32_e32 v7, v17, v18, vcc
; CI-NEXT:    s_cselect_b64 vcc, -1, 0
; CI-NEXT:    s_cmp_eq_u32 s9, 8
; CI-NEXT:    v_cvt_f32_f16_e32 v19, v1
; CI-NEXT:    v_cvt_f32_f16_e32 v1, v13
; CI-NEXT:    v_cvt_f16_f32_e32 v6, v6
; CI-NEXT:    v_cndmask_b32_e32 v5, v5, v18, vcc
; CI-NEXT:    s_cselect_b64 vcc, -1, 0
; CI-NEXT:    s_cmp_eq_u32 s9, 7
; CI-NEXT:    v_cvt_f16_f32_e32 v7, v7
; CI-NEXT:    v_cvt_f16_f32_e32 v5, v5
; CI-NEXT:    v_cndmask_b32_e32 v8, v16, v18, vcc
; CI-NEXT:    s_cselect_b64 vcc, -1, 0
; CI-NEXT:    s_cmp_eq_u32 s9, 6
; CI-NEXT:    v_cvt_f16_f32_e32 v8, v8
; CI-NEXT:    v_cndmask_b32_e32 v2, v2, v18, vcc
; CI-NEXT:    s_cselect_b64 vcc, -1, 0
; CI-NEXT:    s_cmp_eq_u32 s9, 5
; CI-NEXT:    v_cndmask_b32_e32 v14, v14, v18, vcc
; CI-NEXT:    s_cselect_b64 vcc, -1, 0
; CI-NEXT:    s_cmp_eq_u32 s9, 4
; CI-NEXT:    v_lshlrev_b32_e32 v6, 16, v6
; CI-NEXT:    v_cvt_f16_f32_e32 v13, v2
; CI-NEXT:    v_cndmask_b32_e32 v1, v1, v18, vcc
; CI-NEXT:    s_cselect_b64 vcc, -1, 0
; CI-NEXT:    v_or_b32_e32 v2, v7, v6
; CI-NEXT:    v_cvt_f16_f32_e32 v6, v14
; CI-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
; CI-NEXT:    v_cvt_f16_f32_e32 v7, v1
; CI-NEXT:    v_cndmask_b32_e32 v12, v12, v18, vcc
; CI-NEXT:    v_or_b32_e32 v1, v8, v5
; CI-NEXT:    v_cvt_f16_f32_e32 v5, v12
; CI-NEXT:    s_cmp_eq_u32 s9, 3
; CI-NEXT:    v_lshlrev_b32_e32 v8, 16, v13
; CI-NEXT:    v_or_b32_e32 v8, v6, v8
; CI-NEXT:    v_lshlrev_b32_e32 v6, 16, v7
; CI-NEXT:    s_cselect_b64 vcc, -1, 0
; CI-NEXT:    s_cmp_eq_u32 s9, 2
; CI-NEXT:    v_or_b32_e32 v7, v5, v6
; CI-NEXT:    v_cndmask_b32_e32 v5, v20, v18, vcc
; CI-NEXT:    s_cselect_b64 vcc, -1, 0
; CI-NEXT:    s_cmp_eq_u32 s9, 1
; CI-NEXT:    v_cndmask_b32_e32 v6, v11, v18, vcc
; CI-NEXT:    s_cselect_b64 vcc, -1, 0
; CI-NEXT:    s_cmp_eq_u32 s9, 0
; CI-NEXT:    v_cvt_f16_f32_e32 v5, v5
; CI-NEXT:    v_cndmask_b32_e32 v11, v19, v18, vcc
; CI-NEXT:    s_cselect_b64 vcc, -1, 0
; CI-NEXT:    v_cvt_f16_f32_e32 v6, v6
; CI-NEXT:    v_cvt_f16_f32_e32 v11, v11
; CI-NEXT:    v_cndmask_b32_e32 v0, v0, v18, vcc
; CI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; CI-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
; CI-NEXT:    v_or_b32_e32 v6, v6, v5
; CI-NEXT:    v_lshlrev_b32_e32 v5, 16, v11
; CI-NEXT:    v_or_b32_e32 v5, v0, v5
; CI-NEXT:    flat_store_dwordx4 v[9:10], v[5:8]
; CI-NEXT:    s_nop 0
; CI-NEXT:    v_add_i32_e32 v5, vcc, 16, v9
; CI-NEXT:    v_addc_u32_e32 v6, vcc, 0, v10, vcc
; CI-NEXT:    flat_store_dwordx4 v[5:6], v[1:4]
; CI-NEXT:    s_endpgm
;
