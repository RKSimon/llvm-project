...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_lshrrev_b64 v[4:5], 24, v[0:1]
...
; GFX942-NEXT:    v_mov_b32_e32 v4, 4
...
; GFX942-NEXT:    global_store_dwordx2 v6, v[2:3], s[12:13]
...
; GFX942-NEXT:    v_or_b32_sdwa v2, v13, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
