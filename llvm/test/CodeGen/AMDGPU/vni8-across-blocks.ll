...
; GFX942-NEXT:    v_lshrrev_b32_e32 v8, 16, v1
; GFX942-NEXT:    v_lshrrev_b32_e32 v9, 8, v1
...
; GFX942-NEXT:    v_mov_b32_e32 v8, 7
; GFX942-NEXT:    v_mov_b32_e32 v9, 6
...
; GFX942-NEXT:  ; %bb.3: ; %bb.2
; GFX942-NEXT:    v_lshlrev_b16_e32 v2, 8, v11
...
; GFX942-NEXT:    v_lshlrev_b16_e32 v3, 8, v9
; GFX942-NEXT:    v_or_b32_sdwa v3, v1, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX942-NEXT:    v_or_b32_sdwa v7, v8, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
