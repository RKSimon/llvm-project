...
; HAWAII-NEXT:    s_or_b32 s0, s8, 12
; HAWAII-NEXT:    s_add_u32 s0, s0, 2
...
; FIJI-NEXT:    s_or_b32 s0, s8, 12
; FIJI-NEXT:    s_add_u32 s0, s0, 2
; FIJI-NEXT:    s_addc_u32 s1, s9, 0
...
; GFX9-NEXT:    global_load_ubyte v0, v0, s[8:9] offset:14
...
; GFX10-NEXT:    global_load_ubyte v0, v0, s[8:9] offset:14
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v1, s2 :: v_dual_mov_b32 v2, s1
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v3, s0 :: v_dual_and_b32 v0, 0x7f, v0
; GFX11-TRUE16-NEXT:    ds_store_b8 v1, v0 offset:6
...
; GFX11-FAKE16-NEXT:    global_load_u8 v0, v0, s[4:5] offset:14
; GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v1, s2 :: v_dual_mov_b32 v2, s1
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v3, s0 :: v_dual_and_b32 v0, 0x7f, v0
; GFX11-FAKE16-NEXT:    ds_store_b8 v1, v0 offset:6
...
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    ds_write_b16 v0, v1
; GFX9-NEXT:    v_bfe_u32 v1, v1, 16, 1
; GFX9-NEXT:    ds_write_b8 v0, v1 offset:2
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    ds_write_b16 v0, v1
; GFX10-NEXT:    ds_write_b8 v0, v2 offset:2
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    ds_store_b8 v0, v2 offset:2
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_setpc_b64 s[30:31]
