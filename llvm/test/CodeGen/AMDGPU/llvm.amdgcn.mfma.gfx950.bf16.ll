...
; AGPR-NEXT:    v_mov_b32_e32 v18, s16
; AGPR-NEXT:    v_mov_b32_e32 v19, s17
; AGPR-NEXT:    v_mfma_f32_32x32x16_bf16 a[16:31], v[6:9], v[10:13], a[0:15]
; AGPR-NEXT:    v_mov_b32_e32 v20, s18
; AGPR-NEXT:    v_mov_b32_e32 v21, s19
...
; AGPR-NEXT:    s_waitcnt vmcnt(0)
; AGPR-NEXT:    global_store_dwordx4 v[0:1], v[18:21], off sc0 sc1
; AGPR-NEXT:    s_waitcnt vmcnt(0)
...
; VGPR-NEXT:    v_mov_b32_e32 v50, s16
; VGPR-NEXT:    v_mov_b32_e32 v51, s17
; VGPR-NEXT:    v_mfma_f32_32x32x16_bf16 v[16:31], v[38:41], v[42:45], v[0:15]
; VGPR-NEXT:    v_mov_b32_e32 v52, s18
; VGPR-NEXT:    v_mov_b32_e32 v53, s19
...
; VGPR-NEXT:    s_waitcnt vmcnt(0)
; VGPR-NEXT:    global_store_dwordx4 v[32:33], v[50:53], off sc0 sc1
; VGPR-NEXT:    s_waitcnt vmcnt(0)
