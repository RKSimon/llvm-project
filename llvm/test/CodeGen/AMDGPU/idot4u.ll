...
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_perm_b32 v5, v2, v2, s0
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v3, 24, v1
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v4, 24, v2
; GFX9-DL-NEXT:    v_perm_b32 v2, v2, v2, s1
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    v_dot4_u32_u8 v5, v6, v5, s2
; GFX9-DL-NEXT:    v_perm_b32 v1, v1, v1, s1
; GFX9-DL-NEXT:    v_dot4_u32_u8 v1, v1, v2, v5
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_bfe_u32 v3, v1, 16, 8
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_bfe_u32 v4, v2, 16, 8
; GFX9-DL-NEXT:    v_perm_b32 v2, v2, v2, s0
; GFX9-DL-NEXT:    v_perm_b32 v1, v1, v1, s0
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    v_dot4_u32_u8 v1, v1, v2, s1
; GFX9-DL-NEXT:    v_mad_u32_u24 v1, v3, v4, v1
; GFX9-DL-NEXT:    global_store_dword v0, v1, s[6:7]
; GFX9-DL-NEXT:    s_endpgm
;
...
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_perm_b32 v3, v2, v2, 0xc0c0100
; GFX10-DL-NEXT:    v_bfe_u32 v2, v2, 16, 8
; GFX10-DL-NEXT:    v_bfe_u32 v1, v1, 16, 8
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_dot4_u32_u8 v0, v3, v0, s0
; GFX10-DL-NEXT:    v_mov_b32_e32 v3, 0
; GFX10-DL-NEXT:    v_mad_u32_u24 v0, v2, v1, v0
...
; GFX9-DL-NEXT:    global_load_dword v2, v0, s[2:3]
; GFX9-DL-NEXT:    s_load_dword s1, s[6:7], 0x0
; GFX9-DL-NEXT:    s_mov_b32 s0, 0xc0c0003
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_bfe_u32 v3, v1, 16, 8
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_mul_u32_u24_sdwa v3, v1, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:BYTE_1
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v5, 24, v2
; GFX9-DL-NEXT:    v_perm_b32 v2, v2, v2, s0
; GFX9-DL-NEXT:    v_perm_b32 v1, v1, v1, s0
; GFX9-DL-NEXT:    v_dot4_u32_u8 v1, v1, v2, v3
; GFX9-DL-NEXT:    v_mad_u32_u24 v1, v4, v5, v1
; GFX9-DL-NEXT:    global_store_dword v0, v1, s[6:7]
; GFX9-DL-NEXT:    s_endpgm
;
...
; GFX10-DL-NEXT:    v_mov_b32_e32 v3, 0
; GFX10-DL-NEXT:    v_mad_u32_u24 v0, v1, v2, v0
; GFX10-DL-NEXT:    global_store_dword v3, v0, s[6:7]
; GFX10-DL-NEXT:    s_endpgm
;
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(2)
; GFX9-DL-NEXT:    v_bfe_u32 v4, v1, 16, 8
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_bfe_u32 v2, v2, 16, 8
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_perm_b32 v3, v3, v1, s0
; GFX9-DL-NEXT:    v_perm_b32 v1, v1, v1, s1
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    v_dot4_u32_u8 v1, v1, v3, s2
; GFX9-DL-NEXT:    v_mad_u32_u24 v1, v4, v2, v1
; GFX9-DL-NEXT:    global_store_dword v0, v1, s[14:15]
; GFX9-DL-NEXT:    s_endpgm
;
...
; GFX10-DL-NEXT:    v_bfe_u32 v1, v1, 16, 8
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_bfe_u32 v3, v3, 16, 8
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_dot4_u32_u8 v0, v2, v0, s0
; GFX10-DL-NEXT:    v_mov_b32_e32 v2, 0
; GFX10-DL-NEXT:    v_mad_u32_u24 v0, v1, v3, v0
; GFX10-DL-NEXT:    global_store_dword v2, v0, s[14:15]
; GFX10-DL-NEXT:    s_endpgm
;
...
; GFX9-DL-NEXT:    v_perm_b32 v2, v2, v2, s0
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    v_dot4_u32_u8 v1, v2, v1, s1
...
; GFX9-DL-NEXT:    s_mov_b32 s1, 0xc0c0101
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(2)
; GFX9-DL-NEXT:    v_bfe_u32 v1, v1, 16, 8
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_bfe_u32 v4, v2, 16, 8
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_perm_b32 v3, v3, v2, s0
; GFX9-DL-NEXT:    v_perm_b32 v2, v2, v2, s1
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    v_dot4_u32_u8 v2, v3, v2, s2
; GFX9-DL-NEXT:    v_mad_u32_u24 v1, v4, v1, v2
; GFX9-DL-NEXT:    global_store_dword v0, v1, s[14:15]
; GFX9-DL-NEXT:    s_endpgm
;
...
; GFX10-DL-NEXT:    v_mov_b32_e32 v1, 0
; GFX10-DL-NEXT:    v_mad_u32_u24 v0, v2, v3, v0
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_and_b32_e32 v5, 0xff, v1
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
...
; GFX8-NEXT:    v_mul_u32_u24_sdwa v6, v3, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_2 src1_sel:BYTE_0
; GFX8-NEXT:    v_lshrrev_b32_e32 v8, 24, v2
; GFX8-NEXT:    v_mad_u32_u24 v4, v4, v5, v6
; GFX8-NEXT:    v_lshrrev_b32_e32 v3, 24, v3
...
; GFX10-DL-NEXT:    v_perm_b32 v3, v2, v2, 0xc0c0302
; GFX10-DL-NEXT:    v_lshrrev_b32_e32 v1, 24, v1
; GFX10-DL-NEXT:    v_bfe_u32 v2, v2, 8, 8
; GFX10-DL-NEXT:    v_dot4_u32_u8 v0, v4, v3, v0
; GFX10-DL-NEXT:    v_mov_b32_e32 v3, 0
; GFX10-DL-NEXT:    v_mad_u32_u24 v0, v1, v2, v0
; GFX10-DL-NEXT:    global_store_dword v3, v0, s[6:7]
...
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v4, 24, v0
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v5, 24, v1
; GFX9-DL-NEXT:    v_perm_b32 v1, v1, v1, s0
; GFX9-DL-NEXT:    v_perm_b32 v0, v0, v0, s0
; GFX9-DL-NEXT:    v_dot4_u32_u8 v0, v0, v1, v3
; GFX9-DL-NEXT:    v_mad_u32_u24 v0, v4, v5, v0
...
; GFX10-DL-NEXT:    v_perm_b32 v4, v0, v0, 0xc0c0200
; GFX10-DL-NEXT:    v_lshrrev_b32_e32 v0, 24, v0
; GFX10-DL-NEXT:    v_lshrrev_b32_e32 v1, 24, v1
; GFX10-DL-NEXT:    v_dot4_u32_u8 v2, v4, v3, v2
; GFX10-DL-NEXT:    v_mov_b32_e32 v3, 0
...
; GFX10-DL-NEXT:    v_mov_b32_e32 v2, 0
; GFX10-DL-NEXT:    v_mad_u32_u24 v0, v3, v0, v1
; GFX10-DL-NEXT:    global_store_dword v2, v0, s[6:7]
; GFX10-DL-NEXT:    s_endpgm
;
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_bfe_u32 v4, v2, 8, 8
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
