...
; SI-NEXT:    s_mov_b32 s7, 0xf000
; SI-NEXT:    s_mov_b32 s6, -1
; SI-NEXT:    buffer_load_ubyte v2, off, s[4:7], 0 offset:58
; SI-NEXT:    buffer_load_ubyte v3, off, s[4:7], 0 offset:60
; SI-NEXT:    buffer_load_ubyte v4, off, s[4:7], 0 offset:54
; SI-NEXT:    buffer_load_ubyte v5, off, s[4:7], 0 offset:56
; SI-NEXT:    buffer_load_ubyte v6, off, s[4:7], 0 offset:50
; SI-NEXT:    buffer_load_ubyte v7, off, s[4:7], 0 offset:52
; SI-NEXT:    buffer_load_ubyte v8, off, s[4:7], 0 offset:57
; SI-NEXT:    buffer_load_ubyte v9, off, s[4:7], 0 offset:59
; SI-NEXT:    buffer_load_ubyte v10, off, s[4:7], 0 offset:53
; SI-NEXT:    buffer_load_ubyte v11, off, s[4:7], 0 offset:55
; SI-NEXT:    buffer_load_ubyte v12, off, s[4:7], 0 offset:49
; SI-NEXT:    buffer_load_ubyte v13, off, s[4:7], 0 offset:51
...
; SI-NEXT:    v_mov_b32_e32 v0, s0
; SI-NEXT:    v_mov_b32_e32 v1, s1
; SI-NEXT:    buffer_store_dword v14, off, s[4:7], 0
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
...
; SI-NEXT:    v_lshlrev_b32_e32 v4, 8, v6
...
; VI-NEXT:    flat_load_ubyte v14, v[4:5]
; VI-NEXT:    flat_load_ubyte v15, v[6:7]
...
; VI-NEXT:    flat_load_ubyte v16, v[0:1]
; VI-NEXT:    flat_load_ubyte v17, v[2:3]
...
; VI-NEXT:    v_lshlrev_b32_e32 v3, 8, v14
; VI-NEXT:    v_or_b32_sdwa v3, v3, v15 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; VI-NEXT:    v_or_b32_sdwa v6, v6, v11 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v2, v6, v2
; VI-NEXT:    v_lshlrev_b32_e32 v6, 8, v16
