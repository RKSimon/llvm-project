...
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v6, v1
; GFX7-SDAG-NEXT:    v_max_i32_e32 v0, v0, v7
; GFX7-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-SDAG-NEXT:    v_max_i16_sdwa v1, v1, sext(v7) dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX9-SDAG-NEXT:    v_bfe_i32 v2, v2, 0, 8
...
; GFX9-SDAG-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX9-SDAG-NEXT:    v_max3_i16 v0, v0, v6, v1
; GFX9-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-SDAG-NEXT:    v_max_i16 v1, v1, v7
; GFX10-SDAG-NEXT:    v_max3_i16 v0, v0, v3, v2
; GFX10-SDAG-NEXT:    v_lshlrev_b16 v1, 8, v1
; GFX10-SDAG-NEXT:    v_lshrrev_b32_e32 v1, 8, v1
; GFX10-SDAG-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX10-SDAG-NEXT:    v_max3_i16 v0, v0, v4, v1
; GFX10-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-SDAG-TRUE16-NEXT:    v_max3_i16 v1.l, v1.l, v3.l, v5.l
...
; GFX11-SDAG-FAKE16-NEXT:    v_max_i16 v1, v1, v7
...
; GFX11-SDAG-FAKE16-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v4, v1
; GFX11-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-SDAG-TRUE16-NEXT:    v_max3_i16 v1.l, v1.l, v3.l, v5.l
...
; GFX12-SDAG-FAKE16-NEXT:    v_max_i16 v1, v1, v7
...
; GFX12-SDAG-FAKE16-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX12-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v4, v1
; GFX12-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v8, v4
; GFX7-SDAG-NEXT:    v_max3_i32 v3, v3, v11, v7
; GFX7-SDAG-NEXT:    v_max3_i32 v1, v1, v9, v5
; GFX7-SDAG-NEXT:    v_bfe_i32 v14, v14, 0, 8
; GFX7-SDAG-NEXT:    v_max3_i32 v1, v1, v13, v3
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v12, v2
; GFX7-SDAG-NEXT:    v_bfe_i32 v15, v15, 0, 8
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v14, v1
; GFX7-SDAG-NEXT:    v_max_i32_e32 v0, v0, v15
; GFX7-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-SDAG-NEXT:    v_max3_i16 v1, v1, v9, v5
; GFX9-SDAG-NEXT:    v_max3_i16 v1, v1, v13, v3
; GFX9-SDAG-NEXT:    v_bfe_i32 v4, v4, 0, 8
...
; GFX9-SDAG-NEXT:    v_bfe_i32 v2, v2, 0, 8
; GFX9-SDAG-NEXT:    v_max_i16_sdwa v1, v1, sext(v15) dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX9-SDAG-NEXT:    v_bfe_i32 v12, v12, 0, 8
; GFX9-SDAG-NEXT:    v_max3_i16 v2, v2, v10, v6
; GFX9-SDAG-NEXT:    v_max3_i16 v0, v0, v8, v4
; GFX9-SDAG-NEXT:    v_lshrrev_b32_e32 v1, 8, v1
; GFX9-SDAG-NEXT:    v_bfe_i32 v14, v14, 0, 8
; GFX9-SDAG-NEXT:    v_max3_i16 v0, v0, v12, v2
; GFX9-SDAG-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX9-SDAG-NEXT:    v_max3_i16 v0, v0, v14, v1
; GFX9-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-SDAG-NEXT:    v_max3_i16 v1, v1, v9, v5
; GFX10-SDAG-NEXT:    v_bfe_i32 v5, v15, 0, 8
; GFX10-SDAG-NEXT:    v_bfe_i32 v7, v12, 0, 8
; GFX10-SDAG-NEXT:    v_max3_i16 v1, v1, v13, v3
; GFX10-SDAG-NEXT:    v_bfe_i32 v3, v4, 0, 8
...
; GFX10-SDAG-NEXT:    v_max3_i16 v0, v0, v4, v3
; GFX10-SDAG-NEXT:    v_bfe_i32 v3, v14, 0, 8
; GFX10-SDAG-NEXT:    v_lshlrev_b16 v1, 8, v1
; GFX10-SDAG-NEXT:    v_max3_i16 v2, v2, v6, v5
; GFX10-SDAG-NEXT:    v_lshrrev_b32_e32 v1, 8, v1
; GFX10-SDAG-NEXT:    v_max3_i16 v0, v0, v7, v2
; GFX10-SDAG-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX10-SDAG-NEXT:    v_max3_i16 v0, v0, v3, v1
; GFX10-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-SDAG-TRUE16-NEXT:    v_max3_i16 v1.l, v1.l, v3.l, v4.l
; GFX11-SDAG-TRUE16-NEXT:    v_max3_i16 v1.h, v5.l, v7.l, v8.l
...
; GFX11-SDAG-TRUE16-NEXT:    v_bfe_i32 v2, v2, 0, 8
; GFX11-SDAG-TRUE16-NEXT:    v_max3_i16 v0.l, v1.h, v3.l, v1.l
...
; GFX11-SDAG-TRUE16-NEXT:    v_max3_i16 v0.h, v1.l, v2.l, v3.l
; GFX11-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v7.l
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v6, 8, v6
; GFX11-SDAG-TRUE16-NEXT:    v_max3_i16 v0.l, v4.l, v0.l, v5.l
...
; GFX11-SDAG-FAKE16-NEXT:    v_max3_i16 v1, v1, v9, v5
...
; GFX11-SDAG-FAKE16-NEXT:    v_max3_i16 v1, v1, v13, v3
; GFX11-SDAG-FAKE16-NEXT:    v_bfe_i32 v3, v4, 0, 8
...
; GFX11-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v4, v3
; GFX11-SDAG-FAKE16-NEXT:    v_bfe_i32 v3, v14, 0, 8
; GFX11-SDAG-FAKE16-NEXT:    v_lshlrev_b16 v1, 8, v1
; GFX11-SDAG-FAKE16-NEXT:    v_max3_i16 v2, v2, v6, v5
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v1
; GFX11-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v7, v2
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-FAKE16-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX11-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v3, v1
; GFX11-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-SDAG-TRUE16-NEXT:    v_max3_i16 v1.l, v1.l, v3.l, v4.l
; GFX12-SDAG-TRUE16-NEXT:    v_max3_i16 v1.h, v5.l, v7.l, v8.l
...
; GFX12-SDAG-TRUE16-NEXT:    v_bfe_i32 v2, v2, 0, 8
; GFX12-SDAG-TRUE16-NEXT:    v_max3_i16 v0.l, v1.h, v3.l, v1.l
...
; GFX12-SDAG-TRUE16-NEXT:    v_max3_i16 v0.h, v1.l, v2.l, v3.l
; GFX12-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v7.l
; GFX12-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v6, 8, v6
; GFX12-SDAG-TRUE16-NEXT:    v_max3_i16 v0.l, v4.l, v0.l, v5.l
...
; GFX12-SDAG-FAKE16-NEXT:    v_max3_i16 v1, v1, v9, v5
...
; GFX12-SDAG-FAKE16-NEXT:    v_max3_i16 v1, v1, v13, v3
; GFX12-SDAG-FAKE16-NEXT:    v_bfe_i32 v3, v4, 0, 8
...
; GFX12-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v4, v3
; GFX12-SDAG-FAKE16-NEXT:    v_bfe_i32 v3, v14, 0, 8
; GFX12-SDAG-FAKE16-NEXT:    v_lshlrev_b16 v1, 8, v1
; GFX12-SDAG-FAKE16-NEXT:    v_max3_i16 v2, v2, v6, v5
; GFX12-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v1
; GFX12-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v7, v2
; GFX12-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-SDAG-FAKE16-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX12-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v3, v1
; GFX12-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v2, v0, s4
; GFX7-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-SDAG-NEXT:    v_max3_i32 v5, v7, v6, v5
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v2, v1
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v3, v5
...
; GFX7-SDAG-NEXT:    v_max3_i32 v13, v15, v14, v13
; GFX7-SDAG-NEXT:    v_max3_i32 v10, v12, v11, v10
; GFX7-SDAG-NEXT:    v_max3_i32 v1, v1, v5, v3
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v4, v2
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v8, 16, v7
; GFX7-SDAG-NEXT:    v_bfe_i32 v7, v7, 0, 16
; GFX7-SDAG-NEXT:    v_max3_i32 v2, v10, v9, v13
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v6, v1
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v7, v2
...
; GFX8-SDAG-NEXT:    v_max3_i32 v0, v0, v8, v4
...
; GFX9-SDAG-NEXT:    v_max3_i32 v0, v0, v8, v4
...
; GFX10-SDAG-NEXT:    v_max3_i32 v0, v0, v8, v4
...
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-SDAG-NEXT:    v_max3_i32 v0, v0, v8, v4
...
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX12-SDAG-NEXT:    v_max3_i32 v0, v0, v8, v4
