...
; GFX9-SDAG-NEXT:    v_max_i16_sdwa v1, v1, v3 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX10-SDAG-NEXT:    v_max_i16 v4, v4, v7
; GFX10-SDAG-NEXT:    v_lshlrev_b16 v1, 8, v1
; GFX10-SDAG-NEXT:    v_max_i16 v3, v6, v3
; GFX10-SDAG-NEXT:    v_max3_i16 v0, v0, v5, v4
; GFX10-SDAG-NEXT:    v_lshrrev_b32_e32 v1, 8, v1
; GFX10-SDAG-NEXT:    v_max3_i16 v2, v2, v8, v3
; GFX10-SDAG-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX10-SDAG-NEXT:    v_max3_i16 v0, v0, v2, v1
; GFX10-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-SDAG-TRUE16:       ; %bb.0: ; %entry
; GFX11-SDAG-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-TRUE16-NEXT:    v_bfe_i32 v16, v1, 0, 8
...
; GFX11-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v7.l, v15.l
...
; GFX11-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v7.l
; GFX11-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v7.l, v10.l
; GFX11-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v10.l, v2.l
; GFX11-SDAG-TRUE16-NEXT:    v_max_i16 v0.l, v0.l, v1.l
; GFX11-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v17.l
; GFX11-SDAG-TRUE16-NEXT:    v_max_i16 v0.h, v3.l, v5.l
...
; GFX11-SDAG-TRUE16-NEXT:    v_max3_i16 v0.l, v3.l, v5.l, v0.l
; GFX11-SDAG-TRUE16-NEXT:    v_bfe_i32 v2, v9, 0, 8
; GFX11-SDAG-TRUE16-NEXT:    v_bfe_i32 v3, v6, 0, 8
...
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 8, v5
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-SDAG-TRUE16-NEXT:    v_max3_i16 v0.h, v1.l, v2.l, v0.h
; GFX11-SDAG-TRUE16-NEXT:    v_max3_i16 v0.l, v3.l, v4.l, v0.l
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-TRUE16-NEXT:    v_bfe_i32 v5, v5, 0, 8
; GFX11-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v5.l
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-SDAG-FAKE16-NEXT:    v_max_i16 v4, v4, v7
...
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v5, v4
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v1
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-SDAG-FAKE16-NEXT:    v_max3_i16 v2, v2, v8, v3
; GFX11-SDAG-FAKE16-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v2, v1
; GFX11-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-SDAG-TRUE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    v_bfe_i32 v16, v1, 0, 8
...
; GFX12-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v7.l, v15.l
...
; GFX12-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v7.l
; GFX12-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v7.l, v10.l
; GFX12-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v10.l, v2.l
; GFX12-SDAG-TRUE16-NEXT:    v_max_i16 v0.l, v0.l, v1.l
; GFX12-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v17.l
; GFX12-SDAG-TRUE16-NEXT:    v_max_i16 v0.h, v3.l, v5.l
...
; GFX12-SDAG-TRUE16-NEXT:    v_max3_i16 v0.l, v3.l, v5.l, v0.l
; GFX12-SDAG-TRUE16-NEXT:    v_bfe_i32 v2, v9, 0, 8
; GFX12-SDAG-TRUE16-NEXT:    v_bfe_i32 v3, v6, 0, 8
...
; GFX12-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 8, v5
; GFX12-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX12-SDAG-TRUE16-NEXT:    v_max3_i16 v0.h, v1.l, v2.l, v0.h
; GFX12-SDAG-TRUE16-NEXT:    v_max3_i16 v0.l, v3.l, v4.l, v0.l
; GFX12-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-SDAG-TRUE16-NEXT:    v_bfe_i32 v5, v5, 0, 8
; GFX12-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v5.l
; GFX12-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX12-SDAG-FAKE16-NEXT:    v_max_i16 v4, v4, v7
...
; GFX12-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX12-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v5, v4
; GFX12-SDAG-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v1
; GFX12-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-SDAG-FAKE16-NEXT:    v_max3_i16 v2, v2, v8, v3
; GFX12-SDAG-FAKE16-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX12-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-FAKE16-NEXT:    v_max3_i16 v0, v0, v2, v1
; GFX12-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX7-SDAG-NEXT:    v_bfe_i32 v1, v1, 0, 16
; GFX7-SDAG-NEXT:    v_bfe_i32 v0, v0, 0, 16
; GFX7-SDAG-NEXT:    v_max_i32_e32 v2, v3, v2
...
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v7, 16, v1
; GFX7-SDAG-NEXT:    v_bfe_i32 v3, v3, 0, 16
; GFX7-SDAG-NEXT:    v_bfe_i32 v1, v1, 0, 16
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v4, 16, v2
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v5, 16, v0
; GFX7-SDAG-NEXT:    v_bfe_i32 v2, v2, 0, 16
; GFX7-SDAG-NEXT:    v_bfe_i32 v0, v0, 0, 16
; GFX7-SDAG-NEXT:    v_max_i32_e32 v6, v7, v6
; GFX7-SDAG-NEXT:    v_max_i32_e32 v1, v1, v3
; GFX7-SDAG-NEXT:    v_max3_i32 v3, v5, v4, v6
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v2, v1
...
; GFX7-SDAG:       ; %bb.0: ; %entry
; GFX7-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v12, 16, v7
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v13, 16, v3
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v14, 16, v6
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v15, 16, v2
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v8, 16, v4
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v9, 16, v0
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v10, 16, v5
; GFX7-SDAG-NEXT:    v_ashrrev_i32_e32 v11, 16, v1
; GFX7-SDAG-NEXT:    v_bfe_i32 v7, v7, 0, 16
; GFX7-SDAG-NEXT:    v_bfe_i32 v3, v3, 0, 16
; GFX7-SDAG-NEXT:    v_bfe_i32 v6, v6, 0, 16
; GFX7-SDAG-NEXT:    v_bfe_i32 v2, v2, 0, 16
; GFX7-SDAG-NEXT:    v_max_i32_e32 v14, v15, v14
; GFX7-SDAG-NEXT:    v_max_i32_e32 v12, v13, v12
...
; GFX7-SDAG-NEXT:    v_max_i32_e32 v2, v2, v6
; GFX7-SDAG-NEXT:    v_max_i32_e32 v3, v3, v7
; GFX7-SDAG-NEXT:    v_max3_i32 v6, v11, v10, v12
; GFX7-SDAG-NEXT:    v_max3_i32 v7, v9, v8, v14
; GFX7-SDAG-NEXT:    v_max3_i32 v1, v1, v5, v3
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v4, v2
; GFX7-SDAG-NEXT:    v_max_i32_e32 v2, v7, v6
; GFX7-SDAG-NEXT:    v_max3_i32 v0, v0, v1, v2
; GFX7-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
