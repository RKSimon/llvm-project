...
; EG-NEXT:    ALU clause starting at 9:
; EG-NEXT:     AND_INT T0.Y, T6.Y, literal.x,
; EG-NEXT:     BFE_INT T0.Z, T6.X, 0.0, literal.y,
; EG-NEXT:     LSHR T0.W, T6.Y, literal.y,
; EG-NEXT:     ASHR * T1.W, T6.X, literal.y,
...
; EG-NEXT:    TEX 0 @6
; EG-NEXT:    ALU 30, @10, KC0[CB0:0-32], KC1[]
...
; EG-NEXT:     LSHR * T1.W, T9.Z, literal.z,
; EG-NEXT:    65535(9.183409e-41), -65536(nan)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     ASHR T9.X, T9.X, literal.x,
; EG-NEXT:     AND_INT T0.Y, T9.W, literal.y,
; EG-NEXT:     BFE_INT T1.Z, T9.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T2.W, T9.W, literal.x,
; EG-NEXT:     ASHR * T3.W, T9.Y, literal.x,
; EG-NEXT:    16(2.242078e-44), 65535(9.183409e-41)
; EG-NEXT:     ASHR T1.Y, PS, PV.W,
; EG-NEXT:     ASHR T1.Z, PV.Z, PV.Y,
; EG-NEXT:     ASHR T1.W, PV.X, T1.W,
; EG-NEXT:     OR_INT * T0.W, T0.W, T0.Z,
...
; EG-NEXT:    TEX 3 @6
; EG-NEXT:    ALU 40, @15, KC0[CB0:0-32], KC1[]
...
; EG-NEXT:     ASHR T1.Z, T3.Y, literal.y,
...
; EG-NEXT:     CNDE_INT * T2.Y, T4.W, T5.Y, PV.Z,
; EG-NEXT:    2(2.802597e-45), 0(0.000000e+00)
