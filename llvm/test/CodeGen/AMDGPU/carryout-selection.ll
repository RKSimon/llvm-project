...
; VI-NEXT:    v_mad_u64_u32 v[1:2], s[8:9], v5, v3, 0
; VI-NEXT:    v_add_u32_e32 v6, vcc, v6, v1
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], v4, v0, 0
; VI-NEXT:    v_addc_u32_e32 v7, vcc, 0, v2, vcc
; VI-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v4, v3, 0
...
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], s7, v6, 0
; VI-NEXT:    v_mul_lo_u32 v4, s7, v7
; VI-NEXT:    v_mul_lo_u32 v5, s10, v6
; VI-NEXT:    v_mul_hi_u32 v8, v6, v0
; VI-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v7, v0, 0
; VI-NEXT:    v_add_u32_e32 v1, vcc, v4, v1
; VI-NEXT:    v_add_u32_e32 v1, vcc, v5, v1
; VI-NEXT:    v_mad_u64_u32 v[4:5], s[8:9], v6, v1, 0
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], v7, v1, 0
...
; VI-NEXT:    s_add_u32 s15, s6, 2
; VI-NEXT:    s_addc_u32 s18, s7, 0
; VI-NEXT:    s_cmp_lg_u32 s14, 0
; VI-NEXT:    s_cselect_b32 s10, s15, s10
; VI-NEXT:    s_cselect_b32 s11, s18, s11
; VI-NEXT:    s_cmp_lg_u64 s[12:13], 0
; VI-NEXT:    s_subb_u32 s3, s3, s16
...
; GFX9-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x34
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_or_b64 s[8:9], s[2:3], s[6:7]
...
; GFX9-NEXT:    s_mul_hi_u32 s15, s9, s10
; GFX9-NEXT:    s_mul_i32 s14, s12, s10
; GFX9-NEXT:    s_add_i32 s11, s15, s11
; GFX9-NEXT:    s_add_i32 s11, s11, s14
; GFX9-NEXT:    s_mul_i32 s16, s9, s10
; GFX9-NEXT:    s_mul_i32 s15, s10, s11
; GFX9-NEXT:    s_mul_hi_u32 s17, s10, s16
; GFX9-NEXT:    s_mul_hi_u32 s14, s10, s11
; GFX9-NEXT:    s_add_u32 s15, s17, s15
; GFX9-NEXT:    s_addc_u32 s14, 0, s14
; GFX9-NEXT:    s_mul_hi_u32 s18, s13, s16
; GFX9-NEXT:    s_mul_i32 s16, s13, s16
...
; GFX9-NEXT:    s_mul_i32 s10, s9, s13
...
; GFX9-NEXT:    s_mul_i32 s9, s9, s15
; GFX9-NEXT:    s_mul_hi_u32 s12, s13, s9
; GFX9-NEXT:    s_mul_i32 s14, s13, s9
; GFX9-NEXT:    s_mul_i32 s17, s15, s10
; GFX9-NEXT:    s_mul_hi_u32 s9, s15, s9
...
; GFX1030W64-NEXT:    s_sub_u32 s10, 0, s4
; GFX1030W64-NEXT:    s_subb_u32 s11, 0, s5
...
; GFX1030W64-NEXT:    s_mul_i32 s9, s10, s7
; GFX1030W64-NEXT:    s_mul_hi_u32 s13, s10, s8
; GFX1030W64-NEXT:    s_mul_i32 s12, s11, s8
; GFX1030W64-NEXT:    s_add_i32 s9, s13, s9
; GFX1030W64-NEXT:    s_mul_i32 s14, s10, s8
; GFX1030W64-NEXT:    s_add_i32 s9, s9, s12
; GFX1030W64-NEXT:    s_mul_hi_u32 s13, s8, s14
; GFX1030W64-NEXT:    s_mul_i32 s16, s8, s9
...
; GFX1030W64-NEXT:    s_mul_hi_u32 s17, s7, s9
...
; GFX1030W64-NEXT:    s_add_u32 s13, s8, s9
...
; GFX1030W64-NEXT:    s_mul_i32 s11, s11, s13
; GFX1030W64-NEXT:    s_mul_i32 s10, s10, s7
; GFX1030W64-NEXT:    s_mul_hi_u32 s9, s13, s8
; GFX1030W64-NEXT:    s_add_i32 s10, s14, s10
; GFX1030W64-NEXT:    s_mul_hi_u32 s12, s7, s8
; GFX1030W64-NEXT:    s_add_i32 s10, s10, s11
; GFX1030W64-NEXT:    s_mul_i32 s8, s7, s8
; GFX1030W64-NEXT:    s_mul_i32 s15, s13, s10
; GFX1030W64-NEXT:    s_mul_hi_u32 s14, s13, s10
; GFX1030W64-NEXT:    s_add_u32 s9, s9, s15
; GFX1030W64-NEXT:    s_addc_u32 s14, 0, s14
; GFX1030W64-NEXT:    s_mul_hi_u32 s11, s7, s10
; GFX1030W64-NEXT:    s_add_u32 s8, s9, s8
; GFX1030W64-NEXT:    s_mul_i32 s10, s7, s10
; GFX1030W64-NEXT:    s_addc_u32 s8, s14, s12
; GFX1030W64-NEXT:    s_addc_u32 s9, s11, 0
; GFX1030W64-NEXT:    s_add_u32 s8, s8, s10
; GFX1030W64-NEXT:    s_addc_u32 s10, 0, s9
; GFX1030W64-NEXT:    s_add_u32 s11, s13, s8
; GFX1030W64-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GFX1030W64-NEXT:    s_mul_hi_u32 s12, s2, s11
; GFX1030W64-NEXT:    s_cmp_lg_u64 s[8:9], 0
; GFX1030W64-NEXT:    s_mul_hi_u32 s8, s3, s11
; GFX1030W64-NEXT:    s_addc_u32 s7, s7, s10
; GFX1030W64-NEXT:    s_mul_i32 s9, s3, s11
; GFX1030W64-NEXT:    s_mul_i32 s11, s2, s7
; GFX1030W64-NEXT:    s_mul_hi_u32 s10, s2, s7
...
; GFX1030W64-NEXT:    s_addc_u32 s8, s10, s8
...
; GFX1030W64-NEXT:    s_add_i32 s14, s9, s11
; GFX1030W64-NEXT:    s_mul_i32 s9, s4, s8
; GFX1030W64-NEXT:    s_sub_i32 s12, s3, s14
; GFX1030W64-NEXT:    s_sub_u32 s15, s2, s9
; GFX1030W64-NEXT:    s_cselect_b64 s[10:11], -1, 0
; GFX1030W64-NEXT:    s_cmp_lg_u64 s[10:11], 0
; GFX1030W64-NEXT:    s_subb_u32 s9, s12, s5
; GFX1030W64-NEXT:    s_sub_u32 s16, s15, s4
; GFX1030W64-NEXT:    s_cselect_b64 s[12:13], -1, 0
; GFX1030W64-NEXT:    s_cmp_lg_u64 s[12:13], 0
; GFX1030W64-NEXT:    s_subb_u32 s9, s9, 0
; GFX1030W64-NEXT:    s_cmp_ge_u32 s9, s5
; GFX1030W64-NEXT:    s_cselect_b32 s12, -1, 0
; GFX1030W64-NEXT:    s_cmp_ge_u32 s16, s4
; GFX1030W64-NEXT:    s_cselect_b32 s13, -1, 0
; GFX1030W64-NEXT:    s_cmp_eq_u32 s9, s5
; GFX1030W64-NEXT:    s_mov_b32 s9, s6
; GFX1030W64-NEXT:    s_cselect_b32 s12, s13, s12
...
; GFX1030W64-NEXT:    s_cmp_lg_u32 s12, 0
; GFX1030W64-NEXT:    s_cselect_b32 s12, s13, s8
; GFX1030W64-NEXT:    s_cselect_b32 s13, s16, s9
; GFX1030W64-NEXT:    s_cmp_lg_u64 s[10:11], 0
; GFX1030W64-NEXT:    s_subb_u32 s3, s3, s14
...
; GFX1030W64-NEXT:    s_cselect_b32 s7, s13, s7
; GFX1030W64-NEXT:    s_cselect_b32 s6, s12, s6
