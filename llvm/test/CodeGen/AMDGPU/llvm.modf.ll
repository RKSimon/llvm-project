...
; GFX9-SDAG-NEXT:    v_cmp_class_f16_e64 s[4:5], v0, s4
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v2, v2, 0, s[4:5]
...
; GFX9-SDAG-NEXT:    v_cmp_class_f16_e64 s[4:5], v0, s4
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v1, v1, 0, s[4:5]
; GFX9-SDAG-NEXT:    s_movk_i32 s4, 0x7fff
...
; GFX9-SDAG-NEXT:    v_trunc_f16_e32 v1, v0
; GFX9-SDAG-NEXT:    v_sub_f16_e32 v2, v0, v1
; GFX9-SDAG-NEXT:    v_cmp_class_f16_e64 s[4:5], v0, s6
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v2, v2, 0, s[4:5]
; GFX9-SDAG-NEXT:    s_movk_i32 s7, 0x7fff
; GFX9-SDAG-NEXT:    v_bfi_b32 v2, s7, v2, v0
; GFX9-SDAG-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX9-SDAG-NEXT:    v_trunc_f16_e32 v3, v0
; GFX9-SDAG-NEXT:    v_sub_f16_e32 v4, v0, v3
; GFX9-SDAG-NEXT:    v_cmp_class_f16_e64 s[4:5], v0, s6
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v4, v4, 0, s[4:5]
; GFX9-SDAG-NEXT:    v_bfi_b32 v0, s7, v4, v0
...
; GFX9-SDAG-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, s4
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v2, v2, 0, s[4:5]
...
; GFX9-SDAG-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, s6
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v3, v3, 0, s[4:5]
; GFX9-SDAG-NEXT:    s_brev_b32 s7, -2
; GFX9-SDAG-NEXT:    v_bfi_b32 v0, s7, v3, v0
; GFX9-SDAG-NEXT:    v_trunc_f32_e32 v3, v1
; GFX9-SDAG-NEXT:    v_sub_f32_e32 v4, v1, v3
; GFX9-SDAG-NEXT:    v_cmp_class_f32_e64 s[4:5], v1, s6
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v4, v4, 0, s[4:5]
; GFX9-SDAG-NEXT:    v_bfi_b32 v1, s7, v4, v1
; GFX9-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-SDAG-NEXT:    v_cmp_class_f32_e64 s[4:5], v1, s6
; GFX9-SDAG-NEXT:    v_cndmask_b32_e64 v2, v2, 0, s[4:5]
; GFX9-SDAG-NEXT:    v_bfi_b32 v1, s7, v2, v1
; GFX9-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
