...
; CHECK:       ; %bb.0:
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_and_b32_e32 v4, 0x7ff, v0
; CHECK-NEXT:    s_mov_b32 s4, 0x2aaaaaab
; CHECK-NEXT:    v_mul_hi_u32 v4, v4, s4
; CHECK-NEXT:    v_and_b32_e32 v5, 0x7ff, v1
; CHECK-NEXT:    s_mov_b32 s4, 0x24924925
; CHECK-NEXT:    v_mul_hi_u32 v5, v5, s4
; CHECK-NEXT:    v_and_b32_e32 v3, 0x7ff, v2
; CHECK-NEXT:    v_mul_u32_u24_e32 v4, 6, v4
; CHECK-NEXT:    v_mul_hi_u32_u24_e32 v3, 0x20140d, v3
; CHECK-NEXT:    v_sub_i32_e32 v0, vcc, v0, v4
; CHECK-NEXT:    v_mul_u32_u24_e32 v4, 7, v5
