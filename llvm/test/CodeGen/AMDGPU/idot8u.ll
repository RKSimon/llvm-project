...
; GFX10-DL-NEXT:    v_lshrrev_b32_e32 v7, 20, v3
; GFX10-DL-NEXT:    v_mad_u16 v0, v4, v5, v0
...
; GFX8-NEXT:    s_waitcnt vmcnt(1)
; GFX8-NEXT:    v_bfe_u32 v3, v2, 12, 4
; GFX8-NEXT:    v_bfe_u32 v13, v2, 8, 4
; GFX8-NEXT:    v_lshrrev_b32_e32 v16, 28, v2
; GFX8-NEXT:    v_bfe_u32 v17, v2, 24, 4
; GFX8-NEXT:    v_bfe_u32 v18, v2, 20, 4
; GFX8-NEXT:    v_bfe_u32 v14, v2, 4, 4
; GFX8-NEXT:    v_and_b32_e32 v15, 15, v2
...
; GFX8-NEXT:    v_mul_lo_u16_sdwa v3, v5, v3 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX8-NEXT:    v_or_b32_e32 v5, v18, v9
; GFX8-NEXT:    v_or_b32_e32 v6, v6, v3
...
; GFX8-NEXT:    v_or_b32_sdwa v2, v7, v8 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX8-NEXT:    v_lshrrev_b32_e32 v8, 8, v3
; GFX8-NEXT:    v_lshrrev_b32_e32 v9, 8, v2
; GFX8-NEXT:    v_lshrrev_b64 v[2:3], 24, v[2:3]
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_u16_e32 v3, v7, v4
; GFX8-NEXT:    v_add_u16_e32 v3, v3, v9
; GFX8-NEXT:    v_add_u16_e32 v3, v3, v6
...
; GFX9-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-NEXT:    s_waitcnt vmcnt(2)
; GFX9-NEXT:    v_bfe_u32 v0, v1, 12, 4
; GFX9-NEXT:    v_bfe_u32 v5, v1, 8, 4
; GFX9-NEXT:    v_bfe_u32 v6, v1, 4, 4
; GFX9-NEXT:    v_and_b32_e32 v7, 15, v1
...
; GFX9-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NEXT:    v_bfe_u32 v1, v2, 12, 4
; GFX9-NEXT:    v_bfe_u32 v12, v2, 8, 4
; GFX9-NEXT:    v_lshrrev_b32_e32 v15, 28, v2
; GFX9-NEXT:    v_bfe_u32 v16, v2, 24, 4
; GFX9-NEXT:    v_bfe_u32 v17, v2, 20, 4
; GFX9-NEXT:    v_bfe_u32 v13, v2, 4, 4
; GFX9-NEXT:    v_and_b32_e32 v14, 15, v2
...
; GFX9-NEXT:    v_mul_lo_u16_sdwa v0, v0, v1 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX9-NEXT:    v_or_b32_e32 v5, v5, v0
...
; GFX9-NEXT:    v_or_b32_sdwa v0, v6, v7 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX9-NEXT:    v_lshrrev_b32_e32 v7, 8, v1
; GFX9-NEXT:    v_lshrrev_b32_e32 v10, 8, v0
; GFX9-NEXT:    v_lshrrev_b64 v[0:1], 24, v[0:1]
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_add_u16_e32 v1, v6, v4
; GFX9-NEXT:    v_add_u16_e32 v1, v1, v10
...
; GFX9-DL-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(2)
; GFX9-DL-NEXT:    v_bfe_u32 v0, v1, 12, 4
; GFX9-DL-NEXT:    v_bfe_u32 v5, v1, 8, 4
; GFX9-DL-NEXT:    v_bfe_u32 v6, v1, 4, 4
; GFX9-DL-NEXT:    v_and_b32_e32 v7, 15, v1
...
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_bfe_u32 v1, v2, 12, 4
; GFX9-DL-NEXT:    v_bfe_u32 v12, v2, 8, 4
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v15, 28, v2
; GFX9-DL-NEXT:    v_bfe_u32 v16, v2, 24, 4
; GFX9-DL-NEXT:    v_bfe_u32 v17, v2, 20, 4
; GFX9-DL-NEXT:    v_bfe_u32 v13, v2, 4, 4
; GFX9-DL-NEXT:    v_and_b32_e32 v14, 15, v2
...
; GFX9-DL-NEXT:    v_mul_lo_u16_sdwa v0, v0, v1 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX9-DL-NEXT:    v_or_b32_e32 v5, v5, v0
; GFX9-DL-NEXT:    v_or_b32_e32 v1, v18, v10
; GFX9-DL-NEXT:    v_or_b32_e32 v6, v7, v6
; GFX9-DL-NEXT:    v_lshlrev_b32_e32 v0, 16, v8
; GFX9-DL-NEXT:    v_lshlrev_b32_e32 v7, 16, v5
; GFX9-DL-NEXT:    v_or_b32_sdwa v1, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX9-DL-NEXT:    v_or_b32_sdwa v0, v6, v7 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v7, 8, v1
; GFX9-DL-NEXT:    v_lshrrev_b32_e32 v10, 8, v0
; GFX9-DL-NEXT:    v_lshrrev_b64 v[0:1], 24, v[0:1]
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_add_u16_e32 v1, v6, v4
; GFX9-DL-NEXT:    v_add_u16_e32 v1, v1, v10
...
; GFX10-DL-NEXT:    s_waitcnt vmcnt(2)
; GFX10-DL-NEXT:    v_bfe_u32 v0, v1, 12, 4
...
; GFX10-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX10-DL-NEXT:    v_bfe_u32 v1, v2, 12, 4
; GFX10-DL-NEXT:    v_bfe_u32 v12, v2, 8, 4
; GFX10-DL-NEXT:    v_bfe_u32 v13, v2, 4, 4
...
; GFX10-DL-NEXT:    v_bfe_u32 v1, v2, 20, 4
...
; GFX10-DL-NEXT:    v_or_b32_e32 v5, v5, v0
; GFX10-DL-NEXT:    v_mul_lo_u16 v0, v10, v1
; GFX10-DL-NEXT:    v_mul_lo_u16 v1, v9, v16
; GFX10-DL-NEXT:    v_lshlrev_b16 v2, 8, v2
; GFX10-DL-NEXT:    v_or_b32_e32 v6, v7, v6
; GFX10-DL-NEXT:    v_lshlrev_b32_e32 v7, 16, v5
; GFX10-DL-NEXT:    v_mul_lo_u16 v8, v11, v12
; GFX10-DL-NEXT:    v_lshlrev_b16 v10, 8, v0
; GFX10-DL-NEXT:    v_or_b32_e32 v13, v1, v2
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_add_nc_u16 v3, v6, v3
; GFX10-DL-NEXT:    v_or_b32_sdwa v0, v6, v7 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX10-DL-NEXT:    v_or_b32_e32 v1, v8, v10
; GFX10-DL-NEXT:    v_lshlrev_b32_e32 v2, 16, v13
; GFX10-DL-NEXT:    v_lshrrev_b32_e32 v7, 8, v0
; GFX10-DL-NEXT:    v_or_b32_sdwa v1, v1, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX10-DL-NEXT:    v_add_nc_u16 v6, v3, v7
; GFX10-DL-NEXT:    v_lshrrev_b64 v[2:3], 24, v[0:1]
; GFX10-DL-NEXT:    v_lshrrev_b32_e32 v1, 8, v1
; GFX10-DL-NEXT:    v_add_nc_u16 v0, v6, v5
