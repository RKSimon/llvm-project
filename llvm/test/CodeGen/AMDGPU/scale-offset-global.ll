...
; SDAG-NEXT:    global_load_b96 v[0:2], v[0:1], off
; SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GISEL-NEXT:    global_load_b96 v[0:2], v0, s[0:1] scale_offset
; GISEL-NEXT:    s_wait_loadcnt 0x0
...
; SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; SDAG-NEXT:    v_add_nc_u64_e32 v[0:1], s[0:1], v[0:1]
; SDAG-NEXT:    global_load_b96 v[0:2], v[0:1], off offset:192
; SDAG-NEXT:    s_wait_loadcnt 0x0
; SDAG-NEXT:    ; return to shader part epilog
;
...
; GISEL-NEXT:    global_load_b32 v0, v[0:1], off
; GISEL-NEXT:    s_wait_loadcnt 0x0
; GISEL-NEXT:    global_load_b96 v[0:2], v0, s[0:1] offset:192 scale_offset
; GISEL-NEXT:    s_wait_loadcnt 0x0
; GISEL-NEXT:    ; return to shader part epilog
entry:
  %idx = load i32, ptr addrspace(1) %pp, align 4, !range !0
