...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b64 s[12:13], s[8:9]
...
; VI-NEXT:    v_addc_u32_e32 v3, vcc, 0, v1, vcc
; VI-NEXT:    v_add_u32_e32 v0, vcc, 2, v4
...
; VI-NEXT:    s_waitcnt vmcnt(2)
; VI-NEXT:    v_lshlrev_b32_e32 v6, 8, v4
; VI-NEXT:    s_waitcnt vmcnt(1)
; VI-NEXT:    v_cvt_f32_ubyte0_e32 v2, v5
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_cvt_f32_ubyte0_e32 v1, v3
; VI-NEXT:    v_cvt_f32_ubyte0_e32 v0, v4
; VI-NEXT:    v_or_b32_e32 v4, v6, v3
...
; GFX10-NEXT:    s_waitcnt vmcnt(1)
; GFX10-NEXT:    v_lshl_or_b32 v5, v3, 8, v2
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    global_load_u8 v4, v0, s[6:7] offset:2
; GFX11-NEXT:    s_waitcnt vmcnt(2)
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v1, v2
; GFX11-NEXT:    s_waitcnt vmcnt(1)
; GFX11-NEXT:    v_lshl_or_b32 v5, v3, 8, v2
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v2, v4
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v0, v3
; GFX11-NEXT:    v_mov_b32_e32 v3, v1
; GFX11-NEXT:    v_perm_b32 v4, v5, v4, 0x4000405
...
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v2, 24, v5
...
; GFX11-TRUE16-NEXT:    v_and_b16 v0.l, 0xff, v0.l
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 8, v2.l
...
; GFX11-FAKE16-NEXT:    v_add_nc_u16 v1, v1, 9
...
; GFX10-NEXT:    global_load_ubyte v7, v0, s[2:3] offset:5
; GFX10-NEXT:    global_load_ubyte v8, v0, s[2:3] offset:4
; GFX10-NEXT:    global_load_ubyte v9, v0, s[2:3]
...
; GFX10-NEXT:    s_waitcnt vmcnt(2)
; GFX10-NEXT:    v_cvt_f32_ubyte0_e32 v5, v7
; GFX10-NEXT:    s_waitcnt vmcnt(1)
; GFX10-NEXT:    v_cvt_f32_ubyte0_e32 v4, v8
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_cvt_f32_ubyte0_e32 v0, v9
; GFX10-NEXT:    global_store_dwordx3 v10, v[4:6], s[0:1] offset:16
...
; GFX9-NEXT:    global_load_ubyte v4, v0, s[2:3] offset:1
; GFX9-NEXT:    global_load_ubyte v5, v0, s[2:3]
; GFX9-NEXT:    global_load_ubyte v6, v0, s[2:3] offset:6
; GFX9-NEXT:    global_load_ubyte v7, v0, s[2:3] offset:5
; GFX9-NEXT:    global_load_ubyte v8, v0, s[2:3] offset:4
...
; GFX9-NEXT:    v_cvt_f32_ubyte0_e32 v0, v5
; GFX9-NEXT:    s_waitcnt vmcnt(2)
; GFX9-NEXT:    v_cvt_f32_ubyte0_e32 v6, v6
; GFX9-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NEXT:    v_cvt_f32_ubyte0_e32 v5, v7
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-NEXT:    v_dual_mov_b32 v9, 0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-NEXT:    global_load_u8 v7, v0, s[2:3] offset:5
; GFX11-NEXT:    global_load_u8 v8, v0, s[2:3] offset:4
; GFX11-NEXT:    global_load_u8 v0, v0, s[2:3]
...
; GFX11-NEXT:    s_waitcnt vmcnt(2)
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v5, v7
; GFX11-NEXT:    s_waitcnt vmcnt(1)
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v4, v8
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v0, v0
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_store_b96 v9, v[4:6], s[0:1] offset:16
; GFX11-NEXT:    global_store_b128 v9, v[0:3], s[0:1]
; GFX11-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
