...
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v7, v4, v3
; GFX7-SDAG-NEXT:    v_add_i32_e32 v1, vcc, v6, v5
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v5, v0, v3
; GFX7-SDAG-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v4, v2, 0
; GFX7-SDAG-NEXT:    v_add_i32_e32 v8, vcc, v5, v1
; GFX7-SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v0, v2, 1
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v2, v8, v2
; GFX7-SDAG-NEXT:    v_add_i32_e32 v7, vcc, v4, v7
...
; GFX7-SDAG-NEXT:    v_add_i32_e32 v2, vcc, v7, v2
...
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v7, v4, v3
; GFX8-SDAG-NEXT:    v_add_u32_e32 v1, vcc, v6, v5
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v5, v0, v3
; GFX8-SDAG-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v4, v2, 0
; GFX8-SDAG-NEXT:    v_add_u32_e32 v8, vcc, v5, v1
; GFX8-SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v0, v2, 1
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v2, v8, v2
; GFX8-SDAG-NEXT:    v_add_u32_e32 v7, vcc, v4, v7
; GFX8-SDAG-NEXT:    v_add_u32_e32 v1, vcc, v6, v1
; GFX8-SDAG-NEXT:    v_add_u32_e32 v1, vcc, v5, v1
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v1, v3, v1
; GFX8-SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v3, v0, 0
; GFX8-SDAG-NEXT:    v_add_u32_e32 v2, vcc, v7, v2
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v0, v2, v0
; GFX8-SDAG-NEXT:    v_add_u32_e32 v1, vcc, v5, v1
...
; GFX7-SDAG-NEXT:    v_mul_lo_u32 v5, v1, v6
; GFX7-SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v0, v4, 1
; GFX7-SDAG-NEXT:    v_add_i32_e32 v8, vcc, v8, v11
; GFX7-SDAG-NEXT:    v_add_i32_e32 v8, vcc, v8, v5
...
; GFX8-SDAG-NEXT:    v_mul_lo_u32 v5, v1, v6
; GFX8-SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v0, v4, 1
; GFX8-SDAG-NEXT:    v_add_u32_e32 v8, vcc, v8, v11
; GFX8-SDAG-NEXT:    v_add_u32_e32 v8, vcc, v8, v5
...
; GFX10-SDAG-NEXT:    v_mul_lo_u32 v16, v8, v5
...
; GFX10-SDAG-NEXT:    v_add3_u32 v11, v15, v11, v14
; GFX10-SDAG-NEXT:    v_mul_lo_u32 v17, v1, v4
; GFX10-SDAG-NEXT:    v_mad_u64_u32 v[1:2], null, v2, v6, 1
; GFX10-SDAG-NEXT:    v_mad_u64_u32 v[3:4], null, v0, v4, 1
; GFX10-SDAG-NEXT:    v_mul_lo_u32 v0, v11, v6
; GFX10-SDAG-NEXT:    v_mad_u64_u32 v[5:6], null, v10, v6, 0
; GFX10-SDAG-NEXT:    v_add3_u32 v9, v9, v16, v17
; GFX10-SDAG-NEXT:    v_add3_u32 v2, v15, v2, v14
; GFX10-SDAG-NEXT:    v_add3_u32 v4, v13, v4, v12
; GFX10-SDAG-NEXT:    v_add3_u32 v0, v6, v7, v0
; GFX10-SDAG-NEXT:    v_mul_lo_u32 v11, v9, v3
; GFX10-SDAG-NEXT:    v_mul_lo_u32 v10, v5, v2
; GFX10-SDAG-NEXT:    v_mul_lo_u32 v4, v8, v4
; GFX10-SDAG-NEXT:    v_mad_u64_u32 v[2:3], null, v8, v3, 0
; GFX10-SDAG-NEXT:    v_mad_u64_u32 v[6:7], null, v5, v1, 0
; GFX10-SDAG-NEXT:    v_mul_lo_u32 v1, v0, v1
; GFX10-SDAG-NEXT:    v_add3_u32 v3, v3, v4, v11
; GFX10-SDAG-NEXT:    v_mul_lo_u32 v4, v2, v9
; GFX10-SDAG-NEXT:    v_add3_u32 v7, v7, v10, v1
; GFX10-SDAG-NEXT:    v_mul_lo_u32 v9, v6, v0
; GFX10-SDAG-NEXT:    v_mul_lo_u32 v10, v3, v8
; GFX10-SDAG-NEXT:    v_mad_u64_u32 v[0:1], null, v2, v8, v[2:3]
; GFX10-SDAG-NEXT:    v_mul_lo_u32 v8, v7, v5
; GFX10-SDAG-NEXT:    v_mad_u64_u32 v[2:3], null, v6, v5, v[6:7]
; GFX10-SDAG-NEXT:    v_add3_u32 v1, v10, v1, v4
; GFX10-SDAG-NEXT:    v_add3_u32 v3, v8, v3, v9
; GFX10-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-SDAG-NEXT:    v_mul_lo_u32 v17, v8, v5
; GFX11-SDAG-NEXT:    v_add3_u32 v1, v14, v9, v13
; GFX11-SDAG-NEXT:    v_mul_lo_u32 v7, v10, v7
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX11-SDAG-NEXT:    v_add3_u32 v16, v3, v11, v15
; GFX11-SDAG-NEXT:    v_mad_u64_u32 v[11:12], null, v8, v4, 0
; GFX11-SDAG-NEXT:    v_mul_lo_u32 v18, v1, v4
; GFX11-SDAG-NEXT:    v_mad_u64_u32 v[8:9], null, v2, v6, 1
; GFX11-SDAG-NEXT:    v_mad_u64_u32 v[1:2], null, v0, v4, 1
; GFX11-SDAG-NEXT:    v_mul_lo_u32 v0, v16, v6
; GFX11-SDAG-NEXT:    v_mad_u64_u32 v[4:5], null, v10, v6, 0
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX11-SDAG-NEXT:    v_add3_u32 v3, v3, v9, v15
; GFX11-SDAG-NEXT:    v_add3_u32 v9, v12, v17, v18
; GFX11-SDAG-NEXT:    v_add3_u32 v2, v14, v2, v13
; GFX11-SDAG-NEXT:    v_add3_u32 v0, v5, v7, v0
; GFX11-SDAG-NEXT:    v_mad_u64_u32 v[5:6], null, v4, v8, 0
; GFX11-SDAG-NEXT:    v_mul_lo_u32 v7, v4, v3
; GFX11-SDAG-NEXT:    v_mul_lo_u32 v10, v9, v1
; GFX11-SDAG-NEXT:    v_mul_lo_u32 v12, v11, v2
; GFX11-SDAG-NEXT:    v_mad_u64_u32 v[2:3], null, v11, v1, 0
; GFX11-SDAG-NEXT:    v_mul_lo_u32 v1, v0, v8
; GFX11-SDAG-NEXT:    v_mul_lo_u32 v8, v5, v0
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-SDAG-NEXT:    v_add3_u32 v3, v3, v12, v10
; GFX11-SDAG-NEXT:    v_add3_u32 v6, v6, v7, v1
; GFX11-SDAG-NEXT:    v_mul_lo_u32 v7, v2, v9
...
; GFX11-SDAG-NEXT:    v_mul_lo_u32 v10, v6, v4
; GFX11-SDAG-NEXT:    v_mad_u64_u32 v[2:3], null, v5, v4, v[5:6]
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-SDAG-NEXT:    v_add3_u32 v1, v9, v1, v7
; GFX11-SDAG-NEXT:    v_add3_u32 v3, v10, v3, v8
; GFX11-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1200-SDAG-NEXT:    v_mul_lo_u32 v16, v8, v5
...
; GFX1200-SDAG-NEXT:    v_add3_u32 v11, v15, v11, v14
; GFX1200-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX1200-SDAG-NEXT:    v_mul_lo_u32 v17, v1, v4
; GFX1200-SDAG-NEXT:    v_mad_co_u64_u32 v[1:2], null, v2, v6, 1
; GFX1200-SDAG-NEXT:    v_mad_co_u64_u32 v[3:4], null, v0, v4, 1
; GFX1200-SDAG-NEXT:    v_mul_lo_u32 v0, v11, v6
; GFX1200-SDAG-NEXT:    v_mad_co_u64_u32 v[5:6], null, v10, v6, 0
; GFX1200-SDAG-NEXT:    v_add3_u32 v9, v9, v16, v17
; GFX1200-SDAG-NEXT:    v_add3_u32 v2, v15, v2, v14
; GFX1200-SDAG-NEXT:    v_add3_u32 v4, v13, v4, v12
; GFX1200-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1200-SDAG-NEXT:    v_add3_u32 v0, v6, v7, v0
; GFX1200-SDAG-NEXT:    v_mul_lo_u32 v11, v9, v3
; GFX1200-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1200-SDAG-NEXT:    v_mul_lo_u32 v10, v5, v2
; GFX1200-SDAG-NEXT:    v_mul_lo_u32 v4, v8, v4
; GFX1200-SDAG-NEXT:    v_mad_co_u64_u32 v[2:3], null, v8, v3, 0
; GFX1200-SDAG-NEXT:    v_mad_co_u64_u32 v[6:7], null, v5, v1, 0
; GFX1200-SDAG-NEXT:    v_mul_lo_u32 v1, v0, v1
; GFX1200-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1200-SDAG-NEXT:    v_add3_u32 v3, v3, v4, v11
; GFX1200-SDAG-NEXT:    v_mul_lo_u32 v4, v2, v9
; GFX1200-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX1200-SDAG-NEXT:    v_add3_u32 v7, v7, v10, v1
; GFX1200-SDAG-NEXT:    v_mul_lo_u32 v9, v6, v0
; GFX1200-SDAG-NEXT:    v_mul_lo_u32 v10, v3, v8
; GFX1200-SDAG-NEXT:    v_mad_co_u64_u32 v[0:1], null, v2, v8, v[2:3]
; GFX1200-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1200-SDAG-NEXT:    v_mul_lo_u32 v8, v7, v5
; GFX1200-SDAG-NEXT:    v_mad_co_u64_u32 v[2:3], null, v6, v5, v[6:7]
; GFX1200-SDAG-NEXT:    v_add3_u32 v1, v10, v1, v4
; GFX1200-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1200-SDAG-NEXT:    v_add3_u32 v3, v8, v3, v9
; GFX1200-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
