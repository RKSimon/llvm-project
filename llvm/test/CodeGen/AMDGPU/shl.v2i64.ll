...
; GCN-NEXT:    global_load_b128 v[0:3], v32, s[2:3] offset:16
; GCN-NEXT:    global_load_b128 v[4:7], v32, s[2:3]
; GCN-NEXT:    global_load_b128 v[8:11], v32, s[2:3] offset:80
; GCN-NEXT:    global_load_b128 v[12:15], v32, s[2:3] offset:64
; GCN-NEXT:    global_load_b128 v[16:19], v32, s[2:3] offset:48
; GCN-NEXT:    global_load_b128 v[20:23], v32, s[2:3] offset:32
; GCN-NEXT:    global_load_b128 v[24:27], v32, s[2:3] offset:96
; GCN-NEXT:    global_load_b128 v[28:31], v32, s[2:3] offset:112
...
; GCN-NEXT:    s_clause 0x3
; GCN-NEXT:    global_store_b128 v32, v[16:19], s[0:1] offset:48
; GCN-NEXT:    global_store_b128 v32, v[20:23], s[0:1] offset:32
; GCN-NEXT:    global_store_b128 v32, v[0:3], s[0:1] offset:16
; GCN-NEXT:    global_store_b128 v32, v[4:7], s[0:1]
; GCN-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %tid.ext = sext i32 %tid to i64
...
; GFX1250-NEXT:    global_load_b128 v[0:3], v52, s[2:3] offset:128
; GFX1250-NEXT:    global_load_b128 v[4:7], v52, s[2:3]
; GFX1250-NEXT:    global_load_b128 v[8:11], v52, s[2:3] offset:16
; GFX1250-NEXT:    global_load_b128 v[12:15], v52, s[2:3] offset:144
; GFX1250-NEXT:    global_load_b128 v[16:19], v52, s[2:3] offset:80
; GFX1250-NEXT:    global_load_b128 v[20:23], v52, s[2:3] offset:208
; GFX1250-NEXT:    global_load_b128 v[24:27], v52, s[2:3] offset:112
; GFX1250-NEXT:    global_load_b128 v[28:31], v52, s[2:3] offset:96
; GFX1250-NEXT:    global_load_b128 v[32:35], v52, s[2:3] offset:64
; GFX1250-NEXT:    global_load_b128 v[36:39], v52, s[2:3] offset:48
; GFX1250-NEXT:    global_load_b128 v[40:43], v52, s[2:3] offset:32
; GFX1250-NEXT:    global_load_b128 v[44:47], v52, s[2:3] offset:240
; GFX1250-NEXT:    global_load_b128 v[48:51], v52, s[2:3] offset:224
...
; GFX1250-NEXT:    global_load_b128 v[4:7], v52, s[2:3] offset:192
...
; GFX1250-NEXT:    global_load_b128 v[12:15], v52, s[2:3] offset:160
...
; GFX1250-NEXT:    global_load_b128 v[20:23], v52, s[2:3] offset:176
...
; GFX1250-NEXT:    global_store_b128 v52, v[24:27], s[0:1] offset:112
; GFX1250-NEXT:    global_store_b128 v52, v[28:31], s[0:1] offset:96
; GFX1250-NEXT:    global_store_b128 v52, v[16:19], s[0:1] offset:80
; GFX1250-NEXT:    global_store_b128 v52, v[4:7], s[0:1] offset:64
; GFX1250-NEXT:    global_store_b128 v52, v[20:23], s[0:1] offset:48
; GFX1250-NEXT:    global_store_b128 v52, v[12:15], s[0:1] offset:32
; GFX1250-NEXT:    global_store_b128 v52, v[8:11], s[0:1] offset:16
; GFX1250-NEXT:    global_store_b128 v52, v[0:3], s[0:1]
; GFX1250-NEXT:    s_endpgm
;
...
; GFX1251-NEXT:    global_load_b128 v[0:3], v52, s[2:3] offset:128
; GFX1251-NEXT:    global_load_b128 v[4:7], v52, s[2:3]
; GFX1251-NEXT:    global_load_b128 v[8:11], v52, s[2:3] offset:16
; GFX1251-NEXT:    global_load_b128 v[12:15], v52, s[2:3] offset:144
; GFX1251-NEXT:    global_load_b128 v[16:19], v52, s[2:3] offset:160
; GFX1251-NEXT:    global_load_b128 v[20:23], v52, s[2:3] offset:32
; GFX1251-NEXT:    global_load_b128 v[24:27], v52, s[2:3] offset:48
; GFX1251-NEXT:    global_load_b128 v[28:31], v52, s[2:3] offset:176
; GFX1251-NEXT:    global_load_b128 v[32:35], v52, s[2:3] offset:112
; GFX1251-NEXT:    global_load_b128 v[36:39], v52, s[2:3] offset:96
; GFX1251-NEXT:    global_load_b128 v[40:43], v52, s[2:3] offset:80
; GFX1251-NEXT:    global_load_b128 v[44:47], v52, s[2:3] offset:64
...
; GFX1251-NEXT:    s_clause 0x1
; GFX1251-NEXT:    global_load_b128 v[4:7], v52, s[2:3] offset:240
; GFX1251-NEXT:    global_load_b128 v[48:51], v52, s[2:3] offset:224
; GFX1251-NEXT:    s_wait_loadcnt 0xa
...
; GFX1251-NEXT:    s_clause 0x1
; GFX1251-NEXT:    global_load_b128 v[16:19], v52, s[2:3] offset:192
...
; GFX1251-NEXT:    global_store_b128 v52, v[4:7], s[0:1] offset:112
; GFX1251-NEXT:    global_store_b128 v52, v[36:39], s[0:1] offset:96
; GFX1251-NEXT:    global_store_b128 v52, v[20:23], s[0:1] offset:80
; GFX1251-NEXT:    global_store_b128 v52, v[16:19], s[0:1] offset:64
; GFX1251-NEXT:    global_store_b128 v52, v[24:27], s[0:1] offset:48
; GFX1251-NEXT:    global_store_b128 v52, v[12:15], s[0:1] offset:32
; GFX1251-NEXT:    global_store_b128 v52, v[8:11], s[0:1] offset:16
; GFX1251-NEXT:    global_store_b128 v52, v[0:3], s[0:1]
; GFX1251-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %tid.ext = sext i32 %tid to i64
...
; GFX1250-NEXT:    global_load_b128 v[0:3], v24, s[2:3] offset:256
; GFX1250-NEXT:    global_load_b128 v[4:7], v24, s[2:3]
; GFX1250-NEXT:    global_load_b128 v[8:11], v24, s[2:3] offset:16
; GFX1250-NEXT:    global_load_b128 v[12:15], v24, s[2:3] offset:272
; GFX1250-NEXT:    global_load_b128 v[16:19], v24, s[2:3] offset:288
; GFX1250-NEXT:    global_load_b128 v[20:23], v24, s[2:3] offset:32
; GFX1250-NEXT:    global_load_b128 v[26:29], v24, s[2:3] offset:48
; GFX1250-NEXT:    global_load_b128 v[30:33], v24, s[2:3] offset:304
; GFX1250-NEXT:    global_load_b128 v[34:37], v24, s[2:3] offset:320
; GFX1250-NEXT:    global_load_b128 v[38:41], v24, s[2:3] offset:64
; GFX1250-NEXT:    global_load_b128 v[42:45], v24, s[2:3] offset:80
; GFX1250-NEXT:    global_load_b128 v[46:49], v24, s[2:3] offset:336
; GFX1250-NEXT:    global_load_b128 v[50:53], v24, s[2:3] offset:352
; GFX1250-NEXT:    global_load_b128 v[54:57], v24, s[2:3] offset:96
; GFX1250-NEXT:    global_load_b128 v[58:61], v24, s[2:3] offset:112
; GFX1250-NEXT:    global_load_b128 v[62:65], v24, s[2:3] offset:368
; GFX1250-NEXT:    global_load_b128 v[66:69], v24, s[2:3] offset:128
; GFX1250-NEXT:    global_load_b128 v[70:73], v24, s[2:3] offset:144
; GFX1250-NEXT:    global_load_b128 v[74:77], v24, s[2:3] offset:384
; GFX1250-NEXT:    global_load_b128 v[78:81], v24, s[2:3] offset:400
...
; GFX1250-NEXT:    global_load_b128 v[26:29], v24, s[2:3] offset:176
; GFX1250-NEXT:    s_wait_loadcnt 0xb
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[18:19], v36, v[40:41]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[16:17], v34, v[38:39]
; GFX1250-NEXT:    global_load_b128 v[30:33], v24, s[2:3] offset:432
; GFX1250-NEXT:    s_wait_loadcnt 0xa
...
; GFX1250-NEXT:    global_load_b128 v[42:45], v24, s[2:3] offset:208
; GFX1250-NEXT:    s_wait_loadcnt 0xa
...
; GFX1250-NEXT:    global_load_b128 v[50:53], v24, s[2:3] offset:192
...
; GFX1250-NEXT:    global_load_b128 v[58:61], v24, s[2:3] offset:160
; GFX1250-NEXT:    s_wait_loadcnt 0x6
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[64:65], v80, v[72:73]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[62:63], v78, v[70:71]
; GFX1250-NEXT:    global_load_b128 v[66:69], v24, s[2:3] offset:416
...
; GFX1250-NEXT:    global_load_b128 v[30:33], v24, s[2:3] offset:448
; GFX1250-NEXT:    s_wait_loadcnt 0x4
...
; GFX1250-NEXT:    global_load_b128 v[42:45], v24, s[2:3] offset:496
; GFX1250-NEXT:    global_load_b128 v[70:73], v24, s[2:3] offset:240
; GFX1250-NEXT:    global_load_b128 v[74:77], v24, s[2:3] offset:224
; GFX1250-NEXT:    global_load_b128 v[78:81], v24, s[2:3] offset:480
; GFX1250-NEXT:    s_wait_loadcnt 0x4
...
; GFX1250-NEXT:    global_store_b128 v24, v[42:45], s[0:1] offset:240
; GFX1250-NEXT:    global_store_b128 v24, v[70:73], s[0:1] offset:224
; GFX1250-NEXT:    global_store_b128 v24, v[34:37], s[0:1] offset:208
; GFX1250-NEXT:    global_store_b128 v24, v[30:33], s[0:1] offset:192
; GFX1250-NEXT:    global_store_b128 v24, v[26:29], s[0:1] offset:176
; GFX1250-NEXT:    global_store_b128 v24, v[50:53], s[0:1] offset:160
; GFX1250-NEXT:    global_store_b128 v24, v[62:65], s[0:1] offset:144
; GFX1250-NEXT:    global_store_b128 v24, v[54:57], s[0:1] offset:128
; GFX1250-NEXT:    global_store_b128 v24, v[46:49], s[0:1] offset:112
; GFX1250-NEXT:    global_store_b128 v24, v[38:41], s[0:1] offset:96
; GFX1250-NEXT:    global_store_b128 v24, v[20:23], s[0:1] offset:80
; GFX1250-NEXT:    global_store_b128 v24, v[16:19], s[0:1] offset:64
; GFX1250-NEXT:    global_store_b128 v24, v[12:15], s[0:1] offset:48
; GFX1250-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:32
; GFX1250-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:16
; GFX1250-NEXT:    global_store_b128 v24, v[0:3], s[0:1]
...
; GFX1251-NEXT:    global_load_b128 v[0:3], v24, s[2:3] offset:256
; GFX1251-NEXT:    global_load_b128 v[4:7], v24, s[2:3]
; GFX1251-NEXT:    global_load_b128 v[8:11], v24, s[2:3] offset:16
; GFX1251-NEXT:    global_load_b128 v[12:15], v24, s[2:3] offset:272
; GFX1251-NEXT:    global_load_b128 v[16:19], v24, s[2:3] offset:288
; GFX1251-NEXT:    global_load_b128 v[20:23], v24, s[2:3] offset:32
; GFX1251-NEXT:    global_load_b128 v[26:29], v24, s[2:3] offset:48
; GFX1251-NEXT:    global_load_b128 v[30:33], v24, s[2:3] offset:304
; GFX1251-NEXT:    global_load_b128 v[34:37], v24, s[2:3] offset:320
; GFX1251-NEXT:    global_load_b128 v[38:41], v24, s[2:3] offset:64
; GFX1251-NEXT:    global_load_b128 v[42:45], v24, s[2:3] offset:80
; GFX1251-NEXT:    global_load_b128 v[46:49], v24, s[2:3] offset:336
; GFX1251-NEXT:    global_load_b128 v[50:53], v24, s[2:3] offset:352
; GFX1251-NEXT:    global_load_b128 v[54:57], v24, s[2:3] offset:96
; GFX1251-NEXT:    global_load_b128 v[58:61], v24, s[2:3] offset:112
; GFX1251-NEXT:    global_load_b128 v[62:65], v24, s[2:3] offset:368
; GFX1251-NEXT:    global_load_b128 v[66:69], v24, s[2:3] offset:128
; GFX1251-NEXT:    global_load_b128 v[70:73], v24, s[2:3] offset:144
; GFX1251-NEXT:    global_load_b128 v[74:77], v24, s[2:3] offset:384
; GFX1251-NEXT:    global_load_b128 v[78:81], v24, s[2:3] offset:400
...
; GFX1251-NEXT:    s_clause 0x1
; GFX1251-NEXT:    global_load_b128 v[34:37], v24, s[2:3] offset:192
; GFX1251-NEXT:    global_load_b128 v[42:45], v24, s[2:3] offset:448
; GFX1251-NEXT:    s_wait_loadcnt 0xa
...
; GFX1251-NEXT:    global_load_b128 v[50:53], v24, s[2:3] offset:208
...
; GFX1251-NEXT:    global_load_b128 v[42:45], v24, s[2:3] offset:480
; GFX1251-NEXT:    global_load_b128 v[70:73], v24, s[2:3] offset:224
; GFX1251-NEXT:    global_load_b128 v[74:77], v24, s[2:3] offset:240
; GFX1251-NEXT:    global_load_b128 v[78:81], v24, s[2:3] offset:496
; GFX1251-NEXT:    s_wait_loadcnt 0x4
...
; GFX1251-NEXT:    global_store_b128 v24, v[70:73], s[0:1] offset:240
; GFX1251-NEXT:    global_store_b128 v24, v[42:45], s[0:1] offset:224
; GFX1251-NEXT:    global_store_b128 v24, v[30:33], s[0:1] offset:208
; GFX1251-NEXT:    global_store_b128 v24, v[34:37], s[0:1] offset:192
; GFX1251-NEXT:    global_store_b128 v24, v[50:53], s[0:1] offset:176
; GFX1251-NEXT:    global_store_b128 v24, v[26:29], s[0:1] offset:160
; GFX1251-NEXT:    global_store_b128 v24, v[62:65], s[0:1] offset:144
; GFX1251-NEXT:    global_store_b128 v24, v[54:57], s[0:1] offset:128
; GFX1251-NEXT:    global_store_b128 v24, v[46:49], s[0:1] offset:112
; GFX1251-NEXT:    global_store_b128 v24, v[38:41], s[0:1] offset:96
; GFX1251-NEXT:    global_store_b128 v24, v[20:23], s[0:1] offset:80
; GFX1251-NEXT:    global_store_b128 v24, v[16:19], s[0:1] offset:64
; GFX1251-NEXT:    global_store_b128 v24, v[12:15], s[0:1] offset:48
; GFX1251-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:32
; GFX1251-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:16
; GFX1251-NEXT:    global_store_b128 v24, v[0:3], s[0:1]
