...
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    v_and_b32_e32 v1, 0x80000000, v4
...
; VI:       ; %bb.0:
; VI-NEXT:    s_and_b32 s1, s4, 0x80000000
...
; SI-NEXT:    v_bfi_b32 v5, s4, v5, v11
; SI-NEXT:    v_bfi_b32 v3, s4, v3, v8
; SI-NEXT:    v_bfi_b32 v7, s4, v7, v9
; SI-NEXT:    s_setpc_b64 s[30:31]
;
...
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    v_and_b32_e32 v2, 0x80000000, v5
; VI-NEXT:    v_or_b32_sdwa v2, v3, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    s_mov_b32 s4, 0x7fff7fff
; VI-NEXT:    v_bfi_b32 v0, s4, v0, v2
; VI-NEXT:    v_and_b32_e32 v2, 0x80000000, v9
; VI-NEXT:    v_or_b32_sdwa v2, v7, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_bfi_b32 v1, s4, v1, v2
; VI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_copysign_f16_0_f32:
; GFX11:       ; %bb.0:
...
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    v_and_b32_e32 v0, 0x80000000, v3
