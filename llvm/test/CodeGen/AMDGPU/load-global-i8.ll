...
; EG-NEXT:     BFE_UINT T2.W, T5.X, literal.x, PS,
...
; CM-NEXT:    ALU 0, @8, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 0 @6
; CM-NEXT:    ALU 26, @9, KC0[CB0:0-32], KC1[]
...
; CM-NEXT:     BFE_UINT T1.Z, T5.X, literal.x, PV.W,
...
; EG-NEXT:    TEX 0 @6
; EG-NEXT:    ALU 8, @10, KC0[CB0:0-32], KC1[]
...
; CM-NEXT:    TEX 0 @6
; CM-NEXT:    ALU 8, @10, KC0[CB0:0-32], KC1[]
...
; CM-NEXT:     AND_INT * T4.X, PV.W, literal.x,
; CM-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T5.X, KC0[2].Y, literal.x,
; CM-NEXT:     LSHR * T4.Y, T0.Z, literal.y,
...
; EG-NEXT:    ALU 1, @8, KC0[CB0:0-32], KC1[]
; EG-NEXT:    TEX 0 @6
; EG-NEXT:    ALU 9, @10, KC0[CB0:0-32], KC1[]
...
; CM-NEXT:    ALU 1, @8, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 0 @6
; CM-NEXT:    ALU 9, @10, KC0[CB0:0-32], KC1[]
...
; CM-NEXT:     BFE_INT T5.Z, PV.W, 0.0, literal.x,
; CM-NEXT:     LSHR * T0.W, T4.X, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T4.X, KC0[2].Y, literal.x,
; CM-NEXT:     BFE_INT * T5.Y, PV.W, 0.0, literal.y,
...
; EG-NEXT:     MOV * T5.X, KC0[2].Z,
; EG-NEXT:    ALU clause starting at 9:
; EG-NEXT:     ASHR * T6.W, T5.X, literal.x,
; EG-NEXT:    24(3.363116e-44), 0(0.000000e+00)
...
; CM-NEXT:     MOV * T5.X, KC0[2].Z,
; CM-NEXT:    ALU clause starting at 9:
; CM-NEXT:     ASHR * T6.W, T5.Y, literal.x,
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT T6.X, T5.Y, 0.0, literal.x,
; CM-NEXT:     LSHR T0.Y, T5.X, literal.y,
; CM-NEXT:     LSHR T0.Z, T5.Y, literal.y,
; CM-NEXT:     ASHR * T7.W, T5.X, literal.z,
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT T7.X, T5.X, 0.0, literal.x,
; CM-NEXT:     LSHR T1.Y, T5.Y, literal.x,
...
; CM-NEXT:     BFE_INT T7.Z, T0.Y, 0.0, literal.y,
...
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T11.XYZW, T9.X, 0
...
; EG-NEXT:     LSHR T0.Z, T7.Z, literal.y,
; EG-NEXT:     LSHR T0.W, T7.X, literal.y,
; EG-NEXT:     ASHR * T11.W, T7.Y, literal.z,
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T11.X, T7.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T1.Y, T7.Y, literal.y,
; EG-NEXT:     BFE_INT T10.Z, PV.W, 0.0, literal.x,
; EG-NEXT:     LSHR T0.W, T7.X, literal.x,
; EG-NEXT:     ASHR * T12.W, T7.Z, literal.z,
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T12.X, T7.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T10.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T11.Z, PV.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T0.W, T7.Y, literal.x,
; EG-NEXT:     ASHR * T13.W, T7.W, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T13.X, T7.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T11.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T12.Z, T0.Z, 0.0, literal.x,
; EG-NEXT:     LSHR T0.W, T7.Z, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 32(4.484155e-44)
; EG-NEXT:     LSHR T7.X, PS, literal.x,
; EG-NEXT:     BFE_INT T12.Y, PV.W, 0.0, literal.y,
; EG-NEXT:     BFE_INT T13.Z, T0.Y, 0.0, literal.y,
...
; CM-NEXT:     LSHR T0.Z, T7.Y, literal.z,
...
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T15.XYZW, T18.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T23.XYZW, T17.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T22.XYZW, T16.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T21.XYZW, T13.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T20.XYZW, T12.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T19.XYZW, T11.X, 1
; EG-NEXT:    CF_END
; EG-NEXT:    Fetch clause starting at 12:
; EG-NEXT:     VTX_READ_128 T15.XYZW, T14.X, 0, #1
; EG-NEXT:     VTX_READ_128 T14.XYZW, T14.X, 16, #1
; EG-NEXT:    ALU clause starting at 16:
...
; EG-NEXT:     LSHR T0.W, T14.W, literal.y,
; EG-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:    80(1.121039e-43), 0(0.000000e+00)
; EG-NEXT:     LSHR T18.X, PS, literal.x,
; EG-NEXT:     LSHR T0.Y, T14.Z, literal.y,
; EG-NEXT:     LSHR T0.Z, T14.Y, literal.y,
; EG-NEXT:     LSHR T1.W, T14.X, literal.y,
; EG-NEXT:     ASHR * T19.W, T15.X, literal.z,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T19.X, T15.X, 0.0, literal.x,
; EG-NEXT:     LSHR T1.Y, T15.W, literal.y,
; EG-NEXT:     LSHR T1.Z, T15.Z, literal.y,
; EG-NEXT:     LSHR T2.W, T15.X, literal.y,
; EG-NEXT:     ASHR * T20.W, T15.Y, literal.z,
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T20.X, T15.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T2.Y, T15.Y, literal.y,
; EG-NEXT:     BFE_INT T19.Z, PV.W, 0.0, literal.x,
; EG-NEXT:     LSHR T2.W, T15.X, literal.x,
; EG-NEXT:     ASHR * T21.W, T15.Z, literal.z,
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T21.X, T15.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T19.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T20.Z, PV.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T2.W, T15.Y, literal.x,
; EG-NEXT:     ASHR * T22.W, T15.W, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T22.X, T15.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T20.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T21.Z, T1.Z, 0.0, literal.x,
; EG-NEXT:     LSHR T2.W, T15.Z, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     ASHR * T23.W, T14.X, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T23.X, T14.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T21.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T22.Z, T1.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T2.W, T15.W, literal.x,
; EG-NEXT:     ASHR * T15.W, T14.Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T15.X, T14.Y, 0.0, literal.x,
; EG-NEXT:     BFE_INT T22.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T23.Z, T1.W, 0.0, literal.x,
; EG-NEXT:     LSHR T1.W, T14.X, literal.x,
; EG-NEXT:     ASHR * T24.W, T14.Z, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T24.X, T14.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T23.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T15.Z, T0.Z, 0.0, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     LSHR T1.W, T14.Y, literal.x,
; EG-NEXT:     ASHR * T25.W, T14.W, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T25.X, T14.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T15.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T24.Z, T0.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T1.W, T14.Z, literal.x,
; EG-NEXT:     ADD_INT * T2.W, KC0[2].Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 96(1.345247e-43)
; EG-NEXT:     LSHR T14.X, PS, literal.x,
; EG-NEXT:     BFE_INT T24.Y, PV.W, 0.0, literal.y,
; EG-NEXT:     BFE_INT T25.Z, T0.W, 0.0, literal.y,
; EG-NEXT:     LSHR T0.W, T14.W, literal.y, BS:VEC_120/SCL_212
; EG-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; EG-NEXT:    2(2.802597e-45), 8(1.121039e-44)
; EG-NEXT:    112(1.569454e-43), 0(0.000000e+00)
; EG-NEXT:     LSHR T26.X, PS, literal.x,
; EG-NEXT:     BFE_INT * T25.Y, PV.W, 0.0, literal.y,
; EG-NEXT:    2(2.802597e-45), 8(1.121039e-44)
;
...
; CM-NEXT:    TEX 0 @14
; CM-NEXT:    ALU 7, @19, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 0 @16
; CM-NEXT:    ALU 78, @27, KC0[CB0:0-32], KC1[]
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T25, T12.X
...
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T20, T14.X
...
; CM-NEXT:     LSHR T0.Z, T12.Y, literal.z,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 96(1.345247e-43)
; CM-NEXT:    ALU clause starting at 27:
; CM-NEXT:     LSHR T14.X, T0.W, literal.x,
; CM-NEXT:     LSHR T1.Y, T12.Y, literal.y,
; CM-NEXT:     LSHR T1.Z, T12.Z, literal.z,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 80(1.121039e-43)
; CM-NEXT:     LSHR T15.X, PV.W, literal.x,
; CM-NEXT:     LSHR T2.Y, T12.Z, literal.y,
; CM-NEXT:     LSHR T2.Z, T12.W, literal.z,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 64(8.968310e-44)
; CM-NEXT:     LSHR T16.X, PV.W, literal.x,
; CM-NEXT:     LSHR T3.Y, T12.W, literal.y,
; CM-NEXT:     LSHR T3.Z, T11.X, literal.z,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 48(6.726233e-44)
; CM-NEXT:     LSHR T17.X, PV.W, literal.x,
; CM-NEXT:     LSHR T4.Y, T11.X, literal.y,
; CM-NEXT:     LSHR T4.Z, T11.Y, literal.z,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 32(4.484155e-44)
; CM-NEXT:     LSHR T18.X, PV.W, literal.x,
; CM-NEXT:     LSHR T5.Y, T11.Y, literal.y,
; CM-NEXT:     LSHR T5.Z, T11.Z, literal.z,
; CM-NEXT:     ASHR * T19.W, T11.W, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T19.X, T11.W, 0.0, literal.x,
; CM-NEXT:     LSHR T6.Y, T11.Z, literal.y,
; CM-NEXT:     LSHR T6.Z, T11.W, literal.y,
; CM-NEXT:     ASHR * T20.W, T11.Z, literal.z,
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT T20.X, T11.Z, 0.0, literal.x,
; CM-NEXT:     LSHR T7.Y, T11.W, literal.x,
; CM-NEXT:     BFE_INT T19.Z, PV.Z, 0.0, literal.x,
; CM-NEXT:     ASHR * T21.W, T11.Y, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T21.X, T11.Y, 0.0, literal.x,
; CM-NEXT:     BFE_INT T19.Y, PV.Y, 0.0, literal.x,
; CM-NEXT:     BFE_INT T20.Z, T6.Y, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:     ASHR * T11.W, T11.X, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T11.X, T11.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T20.Y, T5.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T21.Z, T5.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T22.W, T12.W, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T22.X, T12.W, 0.0, literal.x,
; CM-NEXT:     BFE_INT T21.Y, T4.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T11.Z, T4.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T23.W, T12.Z, literal.y, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T23.X, T12.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T11.Y, T3.Z, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:     BFE_INT T22.Z, T3.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T24.W, T12.Y, literal.y, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T24.X, T12.Y, 0.0, literal.x,
; CM-NEXT:     BFE_INT T22.Y, T2.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T23.Z, T2.Y, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:     ASHR * T25.W, T12.X, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T25.X, T12.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T23.Y, T1.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T24.Z, T1.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:     LSHR T26.X, PV.W, literal.x,
; CM-NEXT:     BFE_INT T24.Y, T0.Z, 0.0, literal.y,
; CM-NEXT:     BFE_INT T25.Z, T0.Y, 0.0, literal.y,
; CM-NEXT:     LSHR * T0.W, T12.X, literal.y,
; CM-NEXT:    2(2.802597e-45), 8(1.121039e-44)
; CM-NEXT:     LSHR T12.X, KC0[2].Y, literal.x,
; CM-NEXT:     BFE_INT * T25.Y, PV.W, 0.0, literal.y,
; CM-NEXT:    2(2.802597e-45), 8(1.121039e-44)
  %load = load <32 x i8>, ptr addrspace(1) %in
...
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v7, 24, v12
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v5, v12, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v11, 24, v13
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v9, v13, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v19, 24, v14
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v17, v14, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v23, 24, v15
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v21, v15, 8, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v4, 0xff, v12
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v6, v12, 16, 8
...
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v8, 0xff, v13
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v10, v13, 16, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v16, 0xff, v14
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v18, v14, 16, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v20, 0xff, v15
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v22, v15, 16, 8
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(6)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v15, 24, v0
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v13, v0, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v35, 24, v1
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v33, v1, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v39, 24, v2
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v37, v2, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v43, 24, v3
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v41, v3, 8, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v12, 0xff, v0
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v14, v0, 16, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v32, 0xff, v1
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v34, v1, 16, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v36, 0xff, v2
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v38, v2, 16, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v40, 0xff, v3
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v42, v3, 16, 8
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(5) expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v7, 24, v24
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v5, v24, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v47, 24, v25
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v45, v25, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v51, 24, v26
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v49, v26, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v55, 24, v27
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v53, v27, 8, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v4, 0xff, v24
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v6, v24, 16, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v44, 0xff, v25
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v46, v25, 16, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v48, 0xff, v26
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v50, v26, 16, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v52, 0xff, v27
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v54, v27, 16, 8
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(4)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v27, 24, v28
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v25, v28, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v59, 24, v29
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v57, v29, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v63, 24, v30
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v61, v30, 8, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v3, 24, v31
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v1, v31, 8, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v24, 0xff, v28
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v26, v28, 16, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v56, 0xff, v29
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v58, v29, 16, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v60, 0xff, v30
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v62, v30, 16, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v0, 0xff, v31
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v2, v31, 16, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[56:59], off, s[0:3], 0 offset:208
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:192
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[52:55], off, s[0:3], 0 offset:176
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[48:51], off, s[0:3], 0 offset:160
...
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v18, 24, v14
; GCN-HSA-NEXT:    v_bfe_u32 v16, v14, 8, 8
; GCN-HSA-NEXT:    v_and_b32_e32 v15, 0xff, v14
; GCN-HSA-NEXT:    v_bfe_u32 v17, v14, 16, 8
...
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v16, 24, v12
; GCN-HSA-NEXT:    v_bfe_u32 v14, v12, 8, 8
; GCN-HSA-NEXT:    v_and_b32_e32 v13, 0xff, v12
; GCN-HSA-NEXT:    v_bfe_u32 v15, v12, 16, 8
...
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v14, 24, v10
; GCN-HSA-NEXT:    v_bfe_u32 v12, v10, 8, 8
; GCN-HSA-NEXT:    v_and_b32_e32 v11, 0xff, v10
; GCN-HSA-NEXT:    v_bfe_u32 v13, v10, 16, 8
...
; GCN-HSA-NEXT:    v_bfe_u32 v10, v8, 8, 8
; GCN-HSA-NEXT:    v_and_b32_e32 v9, 0xff, v8
; GCN-HSA-NEXT:    v_bfe_u32 v11, v8, 16, 8
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s2
; GCN-HSA-NEXT:    flat_store_dwordx4 v[16:17], v[9:12]
; GCN-HSA-NEXT:    v_and_b32_e32 v8, 0xff, v2
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v11, 24, v2
; GCN-HSA-NEXT:    v_bfe_u32 v9, v2, 8, 8
...
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v3, 24, v5
; GCN-HSA-NEXT:    v_bfe_u32 v1, v5, 8, 8
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v11, 24, v0
; GCN-HSA-NEXT:    v_bfe_u32 v9, v0, 8, 8
; GCN-HSA-NEXT:    v_and_b32_e32 v8, 0xff, v0
; GCN-HSA-NEXT:    v_bfe_u32 v10, v0, 16, 8
...
; GCN-HSA-NEXT:    v_and_b32_e32 v0, 0xff, v5
; GCN-HSA-NEXT:    v_bfe_u32 v2, v5, 16, 8
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 0x60
; GCN-HSA-NEXT:    flat_store_dwordx4 v[16:17], v[8:11]
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v19, 24, v7
; GCN-HSA-NEXT:    v_bfe_u32 v17, v7, 8, 8
; GCN-HSA-NEXT:    v_and_b32_e32 v16, 0xff, v7
; GCN-HSA-NEXT:    v_bfe_u32 v18, v7, 16, 8
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[16:19]
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 0x50
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v11, 24, v6
; GCN-HSA-NEXT:    v_bfe_u32 v9, v6, 8, 8
; GCN-HSA-NEXT:    v_and_b32_e32 v8, 0xff, v6
...
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v3, 24, v16
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v1, v16, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v0, 0xff, v16
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v2, v16, 16, 8
...
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v3, 24, v39
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v1, v39, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v0, 0xff, v39
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v2, v39, 16, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v7, 24, v17
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v5, v17, 8, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v11, 24, v18
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v9, v18, 8, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v15, 24, v19
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v13, v19, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v4, 0xff, v17
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v6, v17, 16, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v8, 0xff, v18
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v10, v18, 16, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v12, 0xff, v19
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v14, v19, 16, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v19, 24, v28
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v17, v28, 8, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v23, 24, v29
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v21, v29, 8, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v27, 24, v30
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v25, v30, 8, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v43, 24, v31
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v41, v31, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v16, 0xff, v28
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v18, v28, 16, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v20, 0xff, v29
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v22, v29, 16, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v24, 0xff, v30
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v26, v30, 16, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v40, 0xff, v31
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v42, v31, 16, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v31, 24, v32
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v29, v32, 8, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v47, 24, v33
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v45, v33, 8, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v51, 24, v34
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v49, v34, 8, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v55, 24, v35
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v53, v35, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v28, 0xff, v32
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v30, v32, 16, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v44, 0xff, v33
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v46, v33, 16, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v48, 0xff, v34
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v50, v34, 16, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v52, 0xff, v35
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v54, v35, 16, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v35, 24, v36
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v33, v36, 8, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v59, 24, v37
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v57, v37, 8, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v63, 24, v38
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v61, v38, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v32, 0xff, v36
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v34, v36, 16, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v56, 0xff, v37
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v58, v37, 16, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v60, 0xff, v38
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v62, v38, 16, 8
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:240
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[60:63], off, s[0:3], 0 offset:224
...
; CM-NEXT:    TEX 1 @26
; CM-NEXT:    ALU 96, @95, KC0[CB0:0-32], KC1[]
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T32, T50.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T47, T49.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T45, T48.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T43, T46.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T33, T44.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T40, T42.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T38, T41.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T36, T39.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T20, T37.X
...
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T21, T29.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T25, T27.X
...
; CM-NEXT:     MOV * T0.W, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_UINT * T22.Z, T21.W, literal.x, PV.W,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_UINT T22.Y, T21.W, literal.x, T0.W,
; CM-NEXT:     BFE_UINT T23.Z, T21.Z, literal.y, T0.W,
; CM-NEXT:     LSHR * T22.W, T21.W, literal.z,
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T22.X, T21.W, literal.x,
; CM-NEXT:     BFE_UINT T23.Y, T21.Z, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    240(3.363116e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T24.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T25.Z, T21.Y, literal.y, T0.W,
; CM-NEXT:     LSHR * T23.W, T21.Z, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T23.X, T21.Z, literal.x,
; CM-NEXT:     BFE_UINT T25.Y, T21.Y, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    224(3.138909e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T26.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T21.Z, T21.X, literal.y, T0.W,
; CM-NEXT:     LSHR * T25.W, T21.Y, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T25.X, T21.Y, literal.x,
; CM-NEXT:     BFE_UINT T21.Y, T21.X, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    208(2.914701e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T27.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T28.Z, T20.W, literal.y, T0.W,
; CM-NEXT:     LSHR * T21.W, T21.X, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T21.X, T21.X, literal.x,
; CM-NEXT:     BFE_UINT T28.Y, T20.W, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    192(2.690493e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T29.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T30.Z, T20.Z, literal.y, T0.W,
; CM-NEXT:     LSHR * T28.W, T20.W, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T28.X, T20.W, literal.x,
; CM-NEXT:     BFE_UINT T30.Y, T20.Z, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    176(2.466285e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T31.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T19.Z, T20.Y, literal.y, T0.W,
; CM-NEXT:     LSHR * T30.W, T20.Z, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T30.X, T20.Z, literal.x,
; CM-NEXT:     BFE_UINT T19.Y, T20.Y, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    160(2.242078e-43), 0(0.000000e+00)
; CM-NEXT:    ALU clause starting at 95:
; CM-NEXT:     LSHR T34.X, T1.W, literal.x,
; CM-NEXT:     BFE_UINT T20.Z, T20.X, literal.y, T0.W,
; CM-NEXT:     LSHR * T19.W, T20.Y, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T19.X, T20.Y, literal.x,
; CM-NEXT:     BFE_UINT T20.Y, T20.X, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    144(2.017870e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T35.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T36.Z, T33.W, literal.y, T0.W,
; CM-NEXT:     LSHR * T20.W, T20.X, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T20.X, T20.X, literal.x,
; CM-NEXT:     BFE_UINT T36.Y, T33.W, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    128(1.793662e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T37.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T38.Z, T33.Z, literal.y, T0.W,
; CM-NEXT:     LSHR * T36.W, T33.W, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T36.X, T33.W, literal.x,
; CM-NEXT:     BFE_UINT T38.Y, T33.Z, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    112(1.569454e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T39.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T40.Z, T33.Y, literal.y, T0.W,
; CM-NEXT:     LSHR * T38.W, T33.Z, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T38.X, T33.Z, literal.x,
; CM-NEXT:     BFE_UINT T40.Y, T33.Y, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    96(1.345247e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T41.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T33.Z, T33.X, literal.y, T0.W,
; CM-NEXT:     LSHR * T40.W, T33.Y, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T40.X, T33.Y, literal.x,
; CM-NEXT:     BFE_UINT T33.Y, T33.X, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    80(1.121039e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T42.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T43.Z, T32.W, literal.y, T0.W,
; CM-NEXT:     LSHR * T33.W, T33.X, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T33.X, T33.X, literal.x,
; CM-NEXT:     BFE_UINT T43.Y, T32.W, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    64(8.968310e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T44.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T45.Z, T32.Z, literal.y, T0.W,
; CM-NEXT:     LSHR * T43.W, T32.W, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T43.X, T32.W, literal.x,
; CM-NEXT:     BFE_UINT T45.Y, T32.Z, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    48(6.726233e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T46.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T47.Z, T32.Y, literal.y, T0.W,
; CM-NEXT:     LSHR * T45.W, T32.Z, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T45.X, T32.Z, literal.x,
; CM-NEXT:     BFE_UINT T47.Y, T32.Y, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    32(4.484155e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T48.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T32.Z, T32.X, literal.y, T0.W,
; CM-NEXT:     LSHR * T47.W, T32.Y, literal.z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T47.X, T32.Y, literal.x,
; CM-NEXT:     BFE_UINT T32.Y, T32.X, literal.y, T0.W,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.z,
; CM-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T49.X, PV.W, literal.x,
; CM-NEXT:     LSHR * T32.W, T32.X, literal.y,
; CM-NEXT:    2(2.802597e-45), 24(3.363116e-44)
; CM-NEXT:     AND_INT * T32.X, T32.X, literal.x,
; CM-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR * T50.X, KC0[2].Y, literal.x,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
...
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[13:16], off, s[4:7], 0
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[17:20], off, s[4:7], 0 offset:16
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[21:24], off, s[4:7], 0 offset:32
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[25:28], off, s[4:7], 0 offset:48
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(3)
...
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(6)
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v32, 24, v17
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v31, v17, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v30, v17, 8, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v29, v17, 0, 8
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v36, 24, v18
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v35, v18, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v34, v18, 8, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v33, v18, 0, 8
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v40, 24, v19
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v39, v19, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v38, v19, 8, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v37, v19, 0, 8
...
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v44, 24, v21
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v43, v21, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v42, v21, 8, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v41, v21, 0, 8
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v48, 24, v22
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v47, v22, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v46, v22, 8, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v45, v22, 0, 8
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v52, 24, v23
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v51, v23, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v50, v23, 8, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v49, v23, 0, 8
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v23, 24, v24
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v22, v24, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v21, v24, 8, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v20, v24, 0, 8
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(4)
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v56, 24, v25
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v55, v25, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v54, v25, 8, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v53, v25, 0, 8
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v60, 24, v26
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v59, v26, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v58, v26, 8, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v57, v26, 0, 8
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v3, 24, v27
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v2, v27, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v1, v27, 8, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v0, v27, 0, 8
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v27, 24, v28
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v26, v28, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v25, v28, 8, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_i32 v24, v28, 0, 8
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[57:60], off, s[0:3], 0 offset:208
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[53:56], off, s[0:3], 0 offset:192
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[20:23], off, s[0:3], 0 offset:176
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[49:52], off, s[0:3], 0 offset:160
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[29:32], off, s[0:3], 0 offset:64
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s2
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 16
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v17, 24, v14
; GCN-HSA-NEXT:    v_bfe_i32 v16, v14, 16, 8
; GCN-HSA-NEXT:    v_bfe_i32 v15, v14, 8, 8
; GCN-HSA-NEXT:    v_bfe_i32 v14, v14, 0, 8
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[18:19], v[14:17]
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v17, s2
...
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v15, 24, v12
; GCN-HSA-NEXT:    v_bfe_i32 v14, v12, 16, 8
; GCN-HSA-NEXT:    v_bfe_i32 v13, v12, 8, 8
; GCN-HSA-NEXT:    v_bfe_i32 v12, v12, 0, 8
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s0
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[16:17], v[12:15]
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s3
...
; GCN-HSA-NEXT:    flat_store_dwordx4 v[18:19], v[11:14]
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v17, s2
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 0xc0
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v13, 24, v10
; GCN-HSA-NEXT:    v_bfe_i32 v12, v10, 16, 8
; GCN-HSA-NEXT:    v_bfe_i32 v11, v10, 8, 8
; GCN-HSA-NEXT:    v_bfe_i32 v10, v10, 0, 8
; GCN-HSA-NEXT:    flat_store_dwordx4 v[15:16], v[10:13]
; GCN-HSA-NEXT:    v_mov_b32_e32 v14, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s2
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s2
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 0xa0
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v11, 24, v8
; GCN-HSA-NEXT:    v_bfe_i32 v10, v8, 16, 8
; GCN-HSA-NEXT:    v_bfe_i32 v9, v8, 8, 8
; GCN-HSA-NEXT:    v_bfe_i32 v8, v8, 0, 8
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[13:14], v[8:11]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(9)
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v15, 24, v7
...
; GCN-HSA-NEXT:    v_bfe_i32 v14, v7, 16, 8
; GCN-HSA-NEXT:    v_bfe_i32 v13, v7, 8, 8
; GCN-HSA-NEXT:    v_bfe_i32 v12, v7, 0, 8
...
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v15, 24, v0
; GCN-HSA-NEXT:    v_bfe_i32 v14, v0, 16, 8
; GCN-HSA-NEXT:    v_bfe_i32 v13, v0, 8, 8
; GCN-HSA-NEXT:    v_bfe_i32 v12, v0, 0, 8
...
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s2
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v19, 24, v4
; GCN-HSA-NEXT:    v_bfe_i32 v18, v4, 16, 8
; GCN-HSA-NEXT:    v_bfe_i32 v17, v4, 8, 8
; GCN-HSA-NEXT:    v_bfe_i32 v16, v4, 0, 8
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 0x70
...
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s2
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v19, 24, v2
; GCN-HSA-NEXT:    v_bfe_i32 v18, v2, 16, 8
; GCN-HSA-NEXT:    v_bfe_i32 v17, v2, 8, 8
; GCN-HSA-NEXT:    v_bfe_i32 v16, v2, 0, 8
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 0x50
; GCN-HSA-NEXT:    flat_store_dwordx4 v[0:1], v[16:19]
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
...
; GCN-NOHSA-VI-NEXT:    buffer_store_dword v3, off, s[88:91], 0 offset:12 ; 4-byte Folded Spill
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(4)
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v3, 24, v37
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v2, v37, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v1, v37, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v0, v37, 0, 8
...
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v19, 24, v26
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v18, v26, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v17, v26, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v16, v26, 0, 8
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v23, 24, v27
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v22, v27, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v21, v27, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v20, v27, 0, 8
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v27, 24, v28
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v26, v28, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v25, v28, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v24, v28, 0, 8
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v41, 24, v29
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v40, v29, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v39, v29, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v38, v29, 0, 8
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v45, 24, v30
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v44, v30, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v43, v30, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v42, v30, 0, 8
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v49, 24, v31
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v48, v31, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v47, v31, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v46, v31, 0, 8
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v31, 24, v32
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v30, v32, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v29, v32, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v28, v32, 0, 8
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v53, 24, v33
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v52, v33, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v51, v33, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v50, v33, 0, 8
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v57, 24, v34
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v56, v34, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v55, v34, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v54, v34, 0, 8
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v61, 24, v35
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v60, v35, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v59, v35, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v58, v35, 0, 8
; GCN-NOHSA-VI-NEXT:    v_ashrrev_i32_e32 v35, 24, v36
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v34, v36, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v33, v36, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v32, v36, 0, 8
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:240
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[32:35], off, s[0:3], 0 offset:224
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[58:61], off, s[0:3], 0 offset:208
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[54:57], off, s[0:3], 0 offset:192
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[50:53], off, s[0:3], 0 offset:176
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[28:31], off, s[0:3], 0 offset:160
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[46:49], off, s[0:3], 0 offset:144
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[42:45], off, s[0:3], 0 offset:128
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[38:41], off, s[0:3], 0 offset:112
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:96
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[20:23], off, s[0:3], 0 offset:80
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[16:19], off, s[0:3], 0 offset:64
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[12:15], off, s[0:3], 0 offset:48
...
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T49.XYZW, T50.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T48.XYZW, T25.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T28.XYZW, T36.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T47.XYZW, T35.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T46.XYZW, T34.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T45.XYZW, T33.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T27.XYZW, T32.X, 0
...
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T26.XYZW, T24.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T41.XYZW, T23.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T40.XYZW, T22.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T39.XYZW, T21.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T38.XYZW, T20.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T37.XYZW, T19.X, 1
; EG-NEXT:    CF_END
; EG-NEXT:    PAD
; EG-NEXT:    Fetch clause starting at 22:
; EG-NEXT:     VTX_READ_128 T26.XYZW, T25.X, 0, #1
; EG-NEXT:     VTX_READ_128 T27.XYZW, T25.X, 16, #1
; EG-NEXT:     VTX_READ_128 T28.XYZW, T25.X, 32, #1
; EG-NEXT:     VTX_READ_128 T25.XYZW, T25.X, 48, #1
; EG-NEXT:    ALU clause starting at 30:
...
; EG-NEXT:     LSHR T33.X, PV.W, literal.x,
; EG-NEXT:     LSHR T0.Y, T25.W, literal.y,
; EG-NEXT:     LSHR T0.Z, T25.Z, literal.y,
; EG-NEXT:     LSHR T0.W, T25.Y, literal.y,
; EG-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:    176(2.466285e-43), 0(0.000000e+00)
; EG-NEXT:     LSHR T34.X, PS, literal.x,
; EG-NEXT:     LSHR T1.Y, T25.X, literal.y,
; EG-NEXT:     LSHR T1.Z, T28.W, literal.y,
; EG-NEXT:     LSHR T1.W, T28.Z, literal.y,
; EG-NEXT:     ADD_INT * T2.W, KC0[2].Y, literal.z,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:    192(2.690493e-43), 0(0.000000e+00)
; EG-NEXT:     LSHR T35.X, PS, literal.x,
; EG-NEXT:     LSHR T2.Y, T28.Y, literal.y,
; EG-NEXT:     LSHR T2.Z, T28.X, literal.y,
; EG-NEXT:     LSHR T2.W, T27.W, literal.y,
; EG-NEXT:     ADD_INT * T3.W, KC0[2].Y, literal.z,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:    208(2.914701e-43), 0(0.000000e+00)
; EG-NEXT:     LSHR T36.X, PS, literal.x,
; EG-NEXT:     LSHR T3.Y, T27.Z, literal.y,
; EG-NEXT:     LSHR T3.Z, T27.Y, literal.y,
; EG-NEXT:     LSHR T3.W, T27.X, literal.y,
; EG-NEXT:     ASHR * T37.W, T26.X, literal.z,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T37.X, T26.X, 0.0, literal.x,
; EG-NEXT:     LSHR T4.Y, T26.W, literal.y,
; EG-NEXT:     LSHR T4.Z, T26.Z, literal.y,
; EG-NEXT:     LSHR T4.W, T26.X, literal.y,
; EG-NEXT:     ASHR * T38.W, T26.Y, literal.z,
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T38.X, T26.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T5.Y, T26.Y, literal.y,
; EG-NEXT:     BFE_INT T37.Z, PV.W, 0.0, literal.x,
; EG-NEXT:     LSHR T4.W, T26.X, literal.x,
; EG-NEXT:     ASHR * T39.W, T26.Z, literal.z,
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T39.X, T26.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T37.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T38.Z, PV.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T4.W, T26.Y, literal.x,
; EG-NEXT:     ASHR * T40.W, T26.W, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T40.X, T26.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T38.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T39.Z, T4.Z, 0.0, literal.x,
; EG-NEXT:     LSHR T4.W, T26.Z, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     ASHR * T41.W, T27.X, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T41.X, T27.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T39.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T40.Z, T4.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T4.W, T26.W, literal.x,
; EG-NEXT:     ASHR * T26.W, T27.Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T26.X, T27.Y, 0.0, literal.x,
; EG-NEXT:     BFE_INT T40.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T41.Z, T3.W, 0.0, literal.x,
; EG-NEXT:     LSHR * T3.W, T27.X, literal.x,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:    ALU clause starting at 127:
; EG-NEXT:     ASHR * T42.W, T27.Z, literal.x,
; EG-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T42.X, T27.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T41.Y, T3.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T26.Z, T3.Z, 0.0, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     LSHR T3.W, T27.Y, literal.x,
; EG-NEXT:     ASHR * T43.W, T27.W, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T43.X, T27.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T26.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T42.Z, T3.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T3.W, T27.Z, literal.x,
; EG-NEXT:     ASHR * T44.W, T28.X, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T44.X, T28.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T42.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T43.Z, T2.W, 0.0, literal.x,
; EG-NEXT:     LSHR T2.W, T27.W, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     ASHR * T27.W, T28.Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T27.X, T28.Y, 0.0, literal.x,
; EG-NEXT:     BFE_INT T43.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T44.Z, T2.Z, 0.0, literal.x,
; EG-NEXT:     LSHR T2.W, T28.X, literal.x,
; EG-NEXT:     ASHR * T45.W, T28.Z, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T45.X, T28.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T44.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T27.Z, T2.Y, 0.0, literal.x,
; EG-NEXT:     LSHR T2.W, T28.Y, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     ASHR * T46.W, T28.W, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T46.X, T28.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T27.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T45.Z, T1.W, 0.0, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     LSHR T1.W, T28.Z, literal.x,
; EG-NEXT:     ASHR * T47.W, T25.X, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T47.X, T25.X, 0.0, literal.x,
; EG-NEXT:     BFE_INT T45.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T46.Z, T1.Z, 0.0, literal.x,
; EG-NEXT:     LSHR T1.W, T28.W, literal.x,
; EG-NEXT:     ASHR * T28.W, T25.Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T28.X, T25.Y, 0.0, literal.x,
; EG-NEXT:     BFE_INT T46.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T47.Z, T1.Y, 0.0, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     LSHR T1.W, T25.X, literal.x,
; EG-NEXT:     ASHR * T48.W, T25.Z, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T48.X, T25.Z, 0.0, literal.x,
; EG-NEXT:     BFE_INT T47.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T28.Z, T0.W, 0.0, literal.x,
; EG-NEXT:     LSHR T0.W, T25.Y, literal.x,
; EG-NEXT:     ASHR * T49.W, T25.W, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     BFE_INT T49.X, T25.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T28.Y, PV.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T48.Z, T0.Z, 0.0, literal.x,
; EG-NEXT:     LSHR T0.W, T25.Z, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 224(3.138909e-43)
; EG-NEXT:     LSHR T25.X, PS, literal.x,
; EG-NEXT:     BFE_INT T48.Y, PV.W, 0.0, literal.y,
; EG-NEXT:     BFE_INT T49.Z, T0.Y, 0.0, literal.y,
; EG-NEXT:     LSHR T0.W, T25.W, literal.y,
; EG-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; EG-NEXT:    2(2.802597e-45), 8(1.121039e-44)
; EG-NEXT:    240(3.363116e-43), 0(0.000000e+00)
; EG-NEXT:     LSHR T50.X, PS, literal.x,
; EG-NEXT:     BFE_INT * T49.Y, PV.W, 0.0, literal.y,
; EG-NEXT:    2(2.802597e-45), 8(1.121039e-44)
;
...
; CM-NEXT:    TEX 0 @24
; CM-NEXT:    ALU 16, @33, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 2 @26
; CM-NEXT:    ALU 84, @50, KC0[CB0:0-32], KC1[]
; CM-NEXT:    ALU 72, @135, KC0[CB0:0-32], KC1[]
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T49, T19.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T48, T50.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T47, T36.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T46, T35.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T20, T34.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T45, T33.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T44, T32.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T43, T31.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T25, T30.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T42, T29.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T41, T28.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T40, T27.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T24, T26.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T39, T23.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T38, T22.X
...
; CM-NEXT:     LSHR T22.X, PV.W, literal.x,
; CM-NEXT:     LSHR T0.Y, T19.X, literal.y,
; CM-NEXT:     LSHR T0.Z, T19.Y, literal.z,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 208(2.914701e-43)
; CM-NEXT:     LSHR T23.X, PV.W, literal.x,
; CM-NEXT:     LSHR T1.Y, T19.Y, literal.y,
; CM-NEXT:     LSHR T1.Z, T19.Z, literal.z,
; CM-NEXT:     LSHR * T0.W, T19.Z, literal.y,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:    ALU clause starting at 50:
; CM-NEXT:     LSHR T2.Z, T19.W, literal.x,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.y,
; CM-NEXT:    8(1.121039e-44), 192(2.690493e-43)
; CM-NEXT:     LSHR T26.X, PV.W, literal.x,
; CM-NEXT:     LSHR T2.Y, T19.W, literal.y,
; CM-NEXT:     LSHR T3.Z, T20.X, literal.z,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 176(2.466285e-43)
; CM-NEXT:     LSHR T27.X, PV.W, literal.x,
; CM-NEXT:     LSHR T3.Y, T20.X, literal.y,
; CM-NEXT:     LSHR T4.Z, T20.Y, literal.z,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 160(2.242078e-43)
; CM-NEXT:     LSHR T28.X, PV.W, literal.x,
; CM-NEXT:     LSHR T4.Y, T20.Y, literal.y,
; CM-NEXT:     LSHR T5.Z, T20.Z, literal.z,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 144(2.017870e-43)
; CM-NEXT:     LSHR T29.X, PV.W, literal.x,
; CM-NEXT:     LSHR T5.Y, T20.Z, literal.y,
...
; CM-NEXT:     LSHR T7.Z, T25.X, literal.z,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 112(1.569454e-43)
; CM-NEXT:     LSHR T31.X, PV.W, literal.x,
; CM-NEXT:     LSHR T7.Y, T25.X, literal.y,
...
; CM-NEXT:     LSHR T9.Z, T25.Z, literal.z,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 80(1.121039e-43)
; CM-NEXT:     LSHR T33.X, PV.W, literal.x,
; CM-NEXT:     LSHR T9.Y, T25.Z, literal.y,
; CM-NEXT:     LSHR T10.Z, T25.W, literal.z,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 64(8.968310e-44)
; CM-NEXT:     LSHR T34.X, PV.W, literal.x,
; CM-NEXT:     LSHR T10.Y, T25.W, literal.y,
; CM-NEXT:     LSHR T11.Z, T24.X, literal.z,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 48(6.726233e-44)
; CM-NEXT:     LSHR T35.X, PV.W, literal.x,
; CM-NEXT:     LSHR T11.Y, T24.X, literal.y,
; CM-NEXT:     LSHR T12.Z, T24.Y, literal.z,
; CM-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 32(4.484155e-44)
; CM-NEXT:     LSHR T36.X, PV.W, literal.x,
; CM-NEXT:     LSHR T12.Y, T24.Y, literal.y,
; CM-NEXT:     LSHR T13.Z, T24.Z, literal.z,
; CM-NEXT:     ASHR * T37.W, T24.W, literal.w,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T37.X, T24.W, 0.0, literal.x,
; CM-NEXT:     LSHR T13.Y, T24.Z, literal.y,
; CM-NEXT:     LSHR T14.Z, T24.W, literal.y,
; CM-NEXT:     ASHR * T38.W, T24.Z, literal.z,
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT T38.X, T24.Z, 0.0, literal.x,
; CM-NEXT:     LSHR T14.Y, T24.W, literal.x,
; CM-NEXT:     BFE_INT T37.Z, PV.Z, 0.0, literal.x,
; CM-NEXT:     ASHR * T39.W, T24.Y, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T39.X, T24.Y, 0.0, literal.x,
; CM-NEXT:     BFE_INT T37.Y, PV.Y, 0.0, literal.x,
; CM-NEXT:     BFE_INT T38.Z, T13.Y, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:     ASHR * T24.W, T24.X, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:    ALU clause starting at 135:
; CM-NEXT:     BFE_INT T24.X, T24.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T38.Y, T13.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T39.Z, T12.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T40.W, T25.W, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T40.X, T25.W, 0.0, literal.x,
; CM-NEXT:     BFE_INT T39.Y, T12.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T24.Z, T11.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T41.W, T25.Z, literal.y, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T41.X, T25.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T24.Y, T11.Z, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:     BFE_INT T40.Z, T10.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T42.W, T25.Y, literal.y, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T42.X, T25.Y, 0.0, literal.x,
; CM-NEXT:     BFE_INT T40.Y, T10.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T41.Z, T9.Y, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:     ASHR * T25.W, T25.X, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T25.X, T25.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T41.Y, T9.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T42.Z, T8.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T43.W, T20.W, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T43.X, T20.W, 0.0, literal.x,
; CM-NEXT:     BFE_INT T42.Y, T8.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T25.Z, T7.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T44.W, T20.Z, literal.y, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T44.X, T20.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T25.Y, T7.Z, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:     BFE_INT T43.Z, T6.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T45.W, T20.Y, literal.y, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T45.X, T20.Y, 0.0, literal.x,
; CM-NEXT:     BFE_INT T43.Y, T6.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T44.Z, T5.Y, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:     ASHR * T20.W, T20.X, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T20.X, T20.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T44.Y, T5.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T45.Z, T4.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T46.W, T19.W, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T46.X, T19.W, 0.0, literal.x,
; CM-NEXT:     BFE_INT T45.Y, T4.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T20.Z, T3.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T47.W, T19.Z, literal.y, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T47.X, T19.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T20.Y, T3.Z, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:     BFE_INT T46.Z, T2.Y, 0.0, literal.x,
; CM-NEXT:     ASHR * T48.W, T19.Y, literal.y, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T48.X, T19.Y, 0.0, literal.x,
; CM-NEXT:     BFE_INT T46.Y, T2.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T47.Z, T0.W, 0.0, literal.x,
; CM-NEXT:     ASHR * T49.W, T19.X, literal.y,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     BFE_INT T49.X, T19.X, 0.0, literal.x,
; CM-NEXT:     BFE_INT T47.Y, T1.Z, 0.0, literal.x,
; CM-NEXT:     BFE_INT T48.Z, T1.Y, 0.0, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:     LSHR T50.X, PV.W, literal.x,
; CM-NEXT:     BFE_INT T48.Y, T0.Z, 0.0, literal.y,
; CM-NEXT:     BFE_INT T49.Z, T0.Y, 0.0, literal.y,
; CM-NEXT:     LSHR * T0.W, T19.X, literal.y,
; CM-NEXT:    2(2.802597e-45), 8(1.121039e-44)
; CM-NEXT:     LSHR T19.X, KC0[2].Y, literal.x,
; CM-NEXT:     BFE_INT * T49.Y, PV.W, 0.0, literal.y,
; CM-NEXT:    2(2.802597e-45), 8(1.121039e-44)
  %load = load <64 x i8>, ptr addrspace(1) %in
...
; EG-NEXT:    ALU clause starting at 9:
; EG-NEXT:     AND_INT T5.X, T4.X, literal.x,
; EG-NEXT:     AND_INT * T0.W, T4.X, literal.y,
; EG-NEXT:    255(3.573311e-43), 65535(9.183409e-41)
...
; CM-NEXT:     AND_INT * T0.W, T4.X, literal.y,
; CM-NEXT:    255(3.573311e-43), 65535(9.183409e-41)
; CM-NEXT:     LSHR * T5.Z, PV.W, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     MOV T5.Y, 0.0,
...
; CM-NEXT:     BFE_INT * T5.X, T4.X, 0.0, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     ASHR T5.Y, PV.X, literal.x,
; CM-NEXT:     LSHR * T0.W, T4.X, literal.y,
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v2, 24, v16
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v6, 24, v17
...
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v4, v17, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v0, v16, 16, 8
...
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v2, 24, v15
; GCN-HSA-NEXT:    v_bfe_u32 v0, v15, 16, 8
...
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v5, 24, v16
; GCN-HSA-NEXT:    v_bfe_u32 v3, v16, 16, 8
...
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v10, v17, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v14, v16, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v12, 0xff, v16
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v8, 0xff, v17
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v4, v16, 16, 8
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s10, s4, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s12, s5, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s5, 24
...
; GCN-HSA-NEXT:    s_lshr_b32 s8, s2, 8
; GCN-HSA-NEXT:    s_lshr_b32 s10, s3, 16
; GCN-HSA-NEXT:    s_lshr_b32 s12, s3, 24
...
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v7, 0xff, v1
...
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v25, v3, 8, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v23, 0xff, v3
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v29, 24, v3
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v27, v3, 16, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v33, 24, v0
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v31, v0, 16, 8
...
; GCN-HSA-NEXT:    s_addc_u32 s5, s1, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[7:8], v[10:13]
...
; GCN-HSA-NEXT:    v_bfe_u32 v15, v3, 8, 8
; GCN-HSA-NEXT:    v_and_b32_e32 v13, 0xff, v3
; GCN-HSA-NEXT:    s_addc_u32 s5, s1, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[11:12], v[13:16]
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, v4
; GCN-HSA-NEXT:    v_mov_b32_e32 v15, s5
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, v4
; GCN-HSA-NEXT:    v_mov_b32_e32 v14, s4
; GCN-HSA-NEXT:    v_bfe_u32 v9, v2, 8, 8
; GCN-HSA-NEXT:    v_and_b32_e32 v7, 0xff, v2
; GCN-HSA-NEXT:    flat_store_dwordx4 v[14:15], v[7:10]
; GCN-HSA-NEXT:    v_mov_b32_e32 v15, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v14, s2
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v5, 24, v2
; GCN-HSA-NEXT:    v_bfe_u32 v3, v2, 16, 8
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 48
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, v4
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s2
; GCN-HSA-NEXT:    s_addc_u32 s1, s1, 0
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v12, 24, v1
; GCN-HSA-NEXT:    v_bfe_u32 v8, v1, 8, 8
; GCN-HSA-NEXT:    v_bfe_u32 v4, v0, 8, 8
; GCN-HSA-NEXT:    v_and_b32_e32 v2, 0xff, v0
...
; GCN-HSA-NEXT:    flat_store_dwordx4 v[14:15], v[2:5]
; GCN-HSA-NEXT:    s_endpgm
;
...
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v8, 0xff, v1
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v26, 24, v1
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v24, v1, 16, 8
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v1, 0
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v6, v2, 8, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v14, v0, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v12, 0xff, v0
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v4, 0xff, v2
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v18, v3, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v16, 0xff, v3
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v22, 24, v0
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v20, v0, 16, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v30, 24, v2
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v28, v2, 16, 8
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s4, v3
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s6, v2
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s8, v1
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s12, s8, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s30, s10, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s34, s10, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s36, s10, 8
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x80000
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[14:17], off, s[0:3], 0 offset:112
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s0
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s2, v3
...
; GCN-HSA-NEXT:    s_lshr_b32 s18, s4, 24
; GCN-HSA-NEXT:    s_lshr_b32 s20, s4, 8
; GCN-HSA-NEXT:    s_lshr_b32 s22, s6, 16
; GCN-HSA-NEXT:    s_lshr_b32 s24, s6, 24
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s2
...
; GCN-HSA-NEXT:    s_lshr_b32 s6, s8, 24
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, s10
; GCN-HSA-NEXT:    s_lshr_b32 s10, s8, 8
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s5
...
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s10, v3
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s8, v2
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s12, s10, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s14, s10, 8
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s4, v0
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s6, v1
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s16, s8, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s18, s8, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s20, s8, 8
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[38:39], s[10:11], 0x80000
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s31, s10, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s33, s10, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
...
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s27, s6, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s29, s6, 24
...
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[10:11], s[26:27], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x80000
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v8, s36
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v9, s37
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:112
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v4, s18
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v5, s19
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v10, s20
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v11, s21
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v14, s29
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v15, s27
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v16, s34
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v17, s35
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v0, s4
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v1, s5
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v12, s22
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v13, s23
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v18, s24
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v19, s25
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[2:5], off, s[0:3], 0 offset:80
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s8, s6
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s9, s7
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[11:14], off, s[8:11], 0
...
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v10, v11, 8, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v8, 0xff, v11
...
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v1, v12, 16, 8
...
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(2)
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v2, v13, 8, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v0, 0xff, v13
...
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v23, v14, 8, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v21, 0xff, v14
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v31, 24, v14
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v29, v14, 16, 8
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v35, 24, v11
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v33, v11, 16, 8
...
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v27, 24, v19
...
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v51, 24, v18
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v49, v18, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v55, v19, 8, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v53, 0xff, v19
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v59, v20, 8, 8
; GCN-NOHSA-SI-NEXT:    v_and_b32_e32 v57, 0xff, v20
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v6, 24, v20
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(4)
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v4, v20, 16, 8
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(1)
; GCN-NOHSA-SI-NEXT:    v_lshrrev_b32_e32 v2, 24, v17
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v0, v17, 16, 8
; GCN-NOHSA-SI-NEXT:    v_bfe_u32 v25, v19, 16, 8
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v28, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v1, v26
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v3, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v38, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v40, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v34, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v36, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v5, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v7, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v58, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v60, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v54, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v56, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v50, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v52, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v46, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v48, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v42, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v44, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v30, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v32, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v22, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v24, v26
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v11, off, s[12:15], 0 offset:16 ; 4-byte Folded Reload
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v12, off, s[12:15], 0 offset:20 ; 4-byte Folded Reload
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v13, off, s[12:15], 0 offset:24 ; 4-byte Folded Reload
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v14, off, s[12:15], 0 offset:28 ; 4-byte Folded Reload
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(2)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v12, v26
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v14, v26
...
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v11, off, s[12:15], 0 ; 4-byte Folded Reload
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(2)
...
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v14, v26
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v11, off, s[12:15], 0 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v12, off, s[12:15], 0 offset:4 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v13, off, s[12:15], 0 offset:8 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    buffer_store_dword v14, off, s[12:15], 0 offset:12 ; 4-byte Folded Spill
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(3)
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v11, off, s[12:15], 0 offset:32 ; 4-byte Folded Reload
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(2)
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v12, off, s[12:15], 0 offset:36 ; 4-byte Folded Reload
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(1)
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v13, off, s[12:15], 0 offset:40 ; 4-byte Folded Reload
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    buffer_load_dword v14, off, s[12:15], 0 offset:44 ; 4-byte Folded Reload
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v14, v11
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v16, v13
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v15, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v17, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v9, v26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v11, v26
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[25:28], off, s[0:3], 0 offset:208
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[33:36], off, s[0:3], 0 offset:16
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0 offset:240
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[57:60], off, s[0:3], 0 offset:224
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[53:56], off, s[0:3], 0 offset:192
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s4
; GCN-HSA-NEXT:    v_bfe_u32 v10, v8, 8, 8
; GCN-HSA-NEXT:    v_and_b32_e32 v8, 0xff, v8
; GCN-HSA-NEXT:    v_mov_b32_e32 v9, v1
; GCN-HSA-NEXT:    v_mov_b32_e32 v11, v1
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s5
; GCN-HSA-NEXT:    flat_store_dwordx4 v[2:3], v[8:11]
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v2, 24, v4
; GCN-HSA-NEXT:    v_bfe_u32 v0, v4, 16, 8
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, v1
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GCN-HSA-NEXT:    s_add_u32 s2, s0, 0xb0
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s3
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s1
; GCN-HSA-NEXT:    flat_store_dwordx4 v[2:3], v[6:9]
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v31, v54
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v26, v54
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v37, v54
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v39, v54
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v33, v54
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v35, v54
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v56, v54
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v20, v54
...
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(1)
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v13, v5, 8, 8
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v51, 24, v8
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v49, v8, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v2, v3, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v0, 0xff, v3
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v11, 0xff, v5
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v21, v6, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v19, 0xff, v6
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v24, 24, v3
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v22, v3, 16, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v30, 24, v5
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v28, v5, 16, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v5, 24, v6
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v3, v6, 16, 8
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v34, v7, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v32, 0xff, v7
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v38, v8, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v36, 0xff, v8
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v42, v9, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v40, 0xff, v9
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v48, 24, v7
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v46, v7, 16, 8
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v8, 24, v9
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v6, v9, 16, 8
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v7, v54
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v9, v54
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[49:52], off, s[0:3], 0 offset:176
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v17, v4, 8, 8
...
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v45, v10, 8, 8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v43, 0xff, v10
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[6:9], off, s[0:3], 0 offset:208
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[46:49], off, s[0:3], 0 offset:144
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v4, v54
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v6, v54
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[28:31], off, s[0:3], 0 offset:80
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v46, v54
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v28, v54
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[3:6], off, s[0:3], 0 offset:112
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[25:28], off, s[0:3], 0 offset:48
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[43:46], off, s[0:3], 0 offset:224
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v25, v54
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v43, v54
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v3, v54
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v55, 24, v10
; GCN-NOHSA-VI-NEXT:    v_bfe_u32 v53, v10, 16, 8
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[22:25], off, s[0:3], 0 offset:16
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v22, v54
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[40:43], off, s[0:3], 0 offset:192
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[36:39], off, s[0:3], 0 offset:160
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(1)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s34, v3
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s44, v2
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s40, v1
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s42, v0
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s28, v7
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s36, s34, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s38, s34, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s30, s34, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s24, s44, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s26, s44, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s22, s44, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s4, s40, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s6, s40, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s8, s40, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s12, s42, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s42, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s16, s42, 8
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s40, s28, 8
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v0, s42
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v1, s43
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s30, s10, 24
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x80000
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[6:9], off, s[0:3], 0 offset:224
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v6, s24
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v7, s25
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s22, s18, 8
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[46:47], s[18:19], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[48:49], s[10:11], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[10:11], s[22:23], 0x80000
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[2:5], off, s[0:3], 0 offset:160
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v2, s12
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v3, s13
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v4, s14
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v5, s15
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[2:5], off, s[0:3], 0 offset:144
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
...
; GCN-HSA-NEXT:    s_lshr_b32 s26, s6, 16
; GCN-HSA-NEXT:    s_lshr_b32 s28, s6, 24
; GCN-HSA-NEXT:    s_lshr_b32 s22, s6, 8
...
; GCN-HSA-NEXT:    s_lshr_b32 s34, s16, 24
; GCN-HSA-NEXT:    s_lshr_b32 s36, s16, 8
; GCN-HSA-NEXT:    s_add_u32 s2, s2, 16
; GCN-HSA-NEXT:    s_addc_u32 s3, s3, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s2
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCN-HSA-NEXT:    flat_load_dwordx4 v[12:15], v[0:1]
; GCN-HSA-NEXT:    s_bfe_i64 s[2:3], s[26:27], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[26:27], s[28:29], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[28:29], s[36:37], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x80000
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v32, s22
; GCN-HSA-NEXT:    v_mov_b32_e32 v22, s24
; GCN-HSA-NEXT:    v_mov_b32_e32 v24, s10
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s12
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v33, s23
; GCN-HSA-NEXT:    v_mov_b32_e32 v23, s25
; GCN-HSA-NEXT:    v_mov_b32_e32 v25, s11
...
; GCN-HSA-NEXT:    s_waitcnt vmcnt(1)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s2, v14
; GCN-HSA-NEXT:    v_readfirstlane_b32 s4, v13
; GCN-HSA-NEXT:    v_readfirstlane_b32 s6, v12
; GCN-HSA-NEXT:    v_readfirstlane_b32 s8, v15
; GCN-HSA-NEXT:    s_lshr_b32 s18, s2, 16
; GCN-HSA-NEXT:    s_lshr_b32 s16, s2, 24
; GCN-HSA-NEXT:    s_lshr_b32 s14, s2, 8
; GCN-HSA-NEXT:    s_lshr_b32 s12, s4, 16
; GCN-HSA-NEXT:    s_lshr_b32 s10, s4, 24
; GCN-HSA-NEXT:    s_lshr_b32 s22, s4, 8
...
; GCN-HSA-NEXT:    s_lshr_b32 s38, s8, 24
; GCN-HSA-NEXT:    s_lshr_b32 s40, s8, 8
; GCN-HSA-NEXT:    s_bfe_i64 s[20:21], s[6:7], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[28:29], s[4:5], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[34:35], s[2:3], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[42:43], s[8:9], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[2:3], s[30:31], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[26:27], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[6:7], s[24:25], 0x80000
...
; GCN-HSA-NEXT:    s_bfe_i64 s[24:25], s[38:39], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[26:27], s[36:37], 0x80000
; GCN-HSA-NEXT:    s_add_u32 s30, s0, 0x70
...
; GCN-HSA-NEXT:    flat_store_dwordx4 v[14:15], v[30:33]
; GCN-HSA-NEXT:    s_addc_u32 s31, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v14, s30
; GCN-HSA-NEXT:    v_mov_b32_e32 v15, s31
; GCN-HSA-NEXT:    flat_store_dwordx4 v[14:15], v[22:25]
; GCN-HSA-NEXT:    flat_store_dwordx4 v[12:13], v[26:29]
; GCN-HSA-NEXT:    v_mov_b32_e32 v24, s28
; GCN-HSA-NEXT:    s_add_u32 s28, s0, 64
...
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s10, v5
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s14, v1
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s16, v2
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s18, v6
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s20, v7
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s34, s8, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s58, s10, 16
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s35, s10, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s40, s8, 8
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s42, s16, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s44, s16, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s48, s14, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s36, s20, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s30, s20, 8
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s28, s18, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s26, s18, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s22, s18, 8
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s60, s10, 8
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[6:7], s[10:11], 0x80000
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s33, s10, 31
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[10:11], s[18:19], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[18:19], s[20:21], 0x80000
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s61, s20, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s63, s20, 24
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s72, s8, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s73, s8, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[20:21], s[58:59], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[58:59], s[34:35], 0x80000
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s12, v0
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s50, s14, 8
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s65, s14, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s67, s14, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[70:71], s[8:9], 0x80000
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v2, s73
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v3, s72
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v0, s58
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v1, s59
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s4, v4
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s52, s12, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s54, s12, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[38:39], s[14:15], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[50:51], s[50:51], 0x80000
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v4, s70
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v5, s71
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v6, s40
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v7, s41
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v9, s42
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v10, s43
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v11, s44
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v12, s45
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:240
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0 offset:224
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[9:12], off, s[0:3], 0 offset:208
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s56, s12, 8
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s46, s16, 8
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s64, s4, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[68:69], s[16:17], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[16:17], s[60:61], 0x80000
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:64
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s66, s4, 8
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v9, s69
...
; GCN-NOHSA-VI-NEXT:    v_or_b32_e32 v0, v0, v1
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v0, 0xff00ff, v0
; GCN-NOHSA-VI-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; GCN-NOHSA-VI-NEXT:    s_endpgm
;
...
; CM-NEXT:     MOV * T5.X, KC0[2].Z,
; CM-NEXT:    ALU clause starting at 9:
; CM-NEXT:     LSHR * T0.W, T5.X, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT T0.Z, T5.X, 0.0, literal.x,
...
; EG-NEXT:    ALU 1, @8, KC0[CB0:0-32], KC1[]
; EG-NEXT:    TEX 0 @6
; EG-NEXT:    ALU 20, @10, KC0[CB0:0-32], KC1[]
...
; EG-NEXT:     LSHL T2.W, T7.X, literal.x,
; EG-NEXT:     OR_INT * T0.W, PS, PV.W,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T1.Y, PS, literal.x,
; EG-NEXT:     AND_INT T1.Z, PV.W, literal.y,
; EG-NEXT:     BFE_UINT T0.W, T7.X, literal.z, PV.Z,
; EG-NEXT:     AND_INT * T1.W, PV.Y, literal.y,
; EG-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; CM-NEXT:    ALU 1, @8, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 0 @6
; CM-NEXT:    ALU 20, @10, KC0[CB0:0-32], KC1[]
...
; CM-NEXT:     MOV T8.X, literal.x,
; CM-NEXT:     LSHR T0.Y, T7.X, literal.x,
; CM-NEXT:     LSHL T1.Z, T7.X, literal.x,
; CM-NEXT:     OR_INT * T0.W, PV.W, PV.Z,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T9.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T1.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.y,
; CM-NEXT:     BFE_UINT * T0.W, T7.X, literal.z, PV.X,
; CM-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T7.X, KC0[2].Y, literal.x,
; CM-NEXT:     OR_INT T8.Y, PV.W, PV.Z,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; CM-NEXT:     MOV * T4.X, PV.W,
; CM-NEXT:     MOV * T5.X, T8.Y,
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v3, 16
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s4, s0
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s5, s1
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v4, 24, v0
...
; GCN-NOHSA-VI-NEXT:    v_and_b32_sdwa v2, v2, sext(v5) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_sdwa v3, v3, sext(v4) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GCN-NOHSA-VI-NEXT:    v_or_b32_e32 v0, v0, v1
; GCN-NOHSA-VI-NEXT:    v_or_b32_e32 v1, v2, v3
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GCN-NOHSA-VI-NEXT:    s_endpgm
;
...
; EG-NEXT:    ALU 1, @8, KC0[CB0:0-32], KC1[]
; EG-NEXT:    TEX 0 @6
; EG-NEXT:    ALU 24, @10, KC0[CB0:0-32], KC1[]
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T8.XY, T7.X, 1
; EG-NEXT:    CF_END
; EG-NEXT:    PAD
; EG-NEXT:    Fetch clause starting at 6:
...
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T1.Y, PV.W, literal.x,
; EG-NEXT:     AND_INT T0.Z, T0.Y, literal.y,
; EG-NEXT:     LSHR T0.W, T7.X, literal.z,
; EG-NEXT:     LSHR * T1.W, T7.X, literal.w,
; EG-NEXT:    65535(9.183409e-41), -65536(nan)
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:     ASHR T0.Y, T7.X, literal.x,
; EG-NEXT:     BFE_INT T1.Z, PS, 0.0, literal.y,
; EG-NEXT:     BFE_INT T0.W, PV.W, 0.0, literal.y,
; EG-NEXT:     OR_INT * T1.W, PV.Z, PV.Y,
; EG-NEXT:    24(3.363116e-44), 8(1.121039e-44)
; EG-NEXT:     AND_INT T1.Y, PS, literal.x,
; EG-NEXT:     LSHL T0.Z, PV.W, literal.y,
...
; CM-NEXT:    ALU 1, @8, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 0 @6
; CM-NEXT:    ALU 24, @10, KC0[CB0:0-32], KC1[]
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T8, T7.X
; CM-NEXT:    CF_END
; CM-NEXT:    PAD
; CM-NEXT:    Fetch clause starting at 6:
...
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T8.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T0.Y, T0.Y, literal.y,
; CM-NEXT:     LSHR T0.Z, T7.X, literal.z,
; CM-NEXT:     LSHR * T0.W, T7.X, literal.w,
; CM-NEXT:    65535(9.183409e-41), -65536(nan)
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:     ASHR T7.X, T7.X, literal.x,
; CM-NEXT:     BFE_INT T1.Y, PV.W, 0.0, literal.y,
; CM-NEXT:     BFE_INT T0.Z, PV.Z, 0.0, literal.y,
; CM-NEXT:     OR_INT * T0.W, PV.Y, PV.X,
; CM-NEXT:    24(3.363116e-44), 8(1.121039e-44)
; CM-NEXT:     AND_INT T8.X, PV.W, literal.x,
; CM-NEXT:     LSHL T0.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     LSHL * T0.W, PV.X, literal.y,
...
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx2 v[0:1], off, s[8:11], 0
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s0, v1
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s1, v0
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s6, s0, 16
; GCN-NOHSA-SI-NEXT:    s_and_b32 s7, s1, 0xff00
; GCN-NOHSA-SI-NEXT:    s_and_b32 s8, s0, 0xff00
; GCN-NOHSA-SI-NEXT:    s_and_b32 s0, s0, 0xff
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s9, s1, 8
; GCN-NOHSA-SI-NEXT:    s_bfe_u32 s10, s1, 0x80010
; GCN-NOHSA-SI-NEXT:    s_and_b32 s1, s1, 0xff
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s8, s8, 8
; GCN-NOHSA-SI-NEXT:    s_and_b32 s9, s9, 0xff0000
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s7, s7, 8
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s11, s6, 8
; GCN-NOHSA-SI-NEXT:    s_or_b32 s8, s0, s8
; GCN-NOHSA-SI-NEXT:    s_or_b32 s9, s10, s9
; GCN-NOHSA-SI-NEXT:    s_or_b32 s7, s1, s7
; GCN-NOHSA-SI-NEXT:    s_or_b32 s0, s6, s11
; GCN-NOHSA-SI-NEXT:    s_and_b32 s6, s0, 0xff00ff
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s1
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s0, v1
; GCN-HSA-NEXT:    v_readfirstlane_b32 s1, v0
; GCN-HSA-NEXT:    s_lshr_b32 s2, s0, 16
; GCN-HSA-NEXT:    s_and_b32 s3, s1, 0xff00
; GCN-HSA-NEXT:    s_and_b32 s4, s0, 0xff00
; GCN-HSA-NEXT:    s_lshr_b32 s5, s1, 8
; GCN-HSA-NEXT:    s_lshl_b32 s7, s2, 8
; GCN-HSA-NEXT:    s_and_b32 s0, s0, 0xff
; GCN-HSA-NEXT:    s_bfe_u32 s6, s1, 0x80010
; GCN-HSA-NEXT:    s_and_b32 s1, s1, 0xff
; GCN-HSA-NEXT:    s_lshl_b32 s4, s4, 8
; GCN-HSA-NEXT:    s_and_b32 s5, s5, 0xff0000
; GCN-HSA-NEXT:    s_lshl_b32 s3, s3, 8
; GCN-HSA-NEXT:    s_or_b32 s2, s2, s7
; GCN-HSA-NEXT:    s_or_b32 s0, s0, s4
; GCN-HSA-NEXT:    s_or_b32 s4, s6, s5
...
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v3, 8, v1
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v4, 24, v0
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v5, 8, v0
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v2, v2, v1, 16
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v6, 0xff0000, v3
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v4, v4, v0, 16
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v5, 0xff0000, v5
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v3, 0xff00ff, v2
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v2, v1, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v1, 0xff00ff, v4
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v0, v0, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
; GCN-NOHSA-VI-NEXT:    s_endpgm
;
...
; EG-NEXT:     MOV T0.Z, literal.x,
; EG-NEXT:     LSHL T2.W, T11.X, literal.x,
; EG-NEXT:     OR_INT * T0.W, PS, PV.W,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T1.Y, PS, literal.x,
; EG-NEXT:     AND_INT T1.Z, PV.W, literal.y,
; EG-NEXT:     BFE_UINT T0.W, T11.X, literal.z, PV.Z,
; EG-NEXT:     AND_INT * T1.W, PV.Y, literal.y,
; EG-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; CM-NEXT:     AND_INT * T0.W, T0.Y, literal.y,
; CM-NEXT:    255(3.573311e-43), -65536(nan)
; CM-NEXT:     MOV T12.X, literal.x,
; CM-NEXT:     LSHR T0.Y, T11.X, literal.x,
; CM-NEXT:     LSHL T1.Z, T11.X, literal.x,
; CM-NEXT:     OR_INT * T0.W, PV.W, PV.Z,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T13.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T1.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.y,
; CM-NEXT:     BFE_UINT * T0.W, T11.X, literal.z, PV.X,
; CM-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     OR_INT T12.Y, PV.W, PV.Z,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T8.X, PV.W,
; CM-NEXT:     MOV T9.X, T12.Y,
; CM-NEXT:     MOV * T0.Y, T4.X,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     AND_INT * T0.W, T11.Y, literal.y,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
; CM-NEXT:     LSHL T0.Y, T11.Y, literal.x,
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     LSHR * T0.W, T11.Y, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T11.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T1.Y, T11.Y, literal.y, T12.X,
; CM-NEXT:     AND_INT T0.Z, PV.Z, literal.z,
; CM-NEXT:     AND_INT * T0.W, PV.Y, literal.x,
; CM-NEXT:    16711680(2.341805e-38), 16(2.242078e-44)
; CM-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; CM-NEXT:     LSHR T13.X, KC0[2].Y, literal.x,
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     OR_INT * T12.W, PV.Y, PV.X,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; CM-NEXT:     MOV * T4.X, PV.Z,
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s6, s4, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s7, s4, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s8, s5, 16
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s9, s4
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s4, s4, 0x80000
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s10, s5
...
; GCN-NOHSA-VI-NEXT:    s_and_b32 s4, 0xffff, s4
...
; GCN-NOHSA-VI-NEXT:    s_or_b32 s4, s4, s9
...
; EG-NEXT:    65535(9.183409e-41), -65536(nan)
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:     ASHR T0.Y, T11.X, literal.x,
; EG-NEXT:     BFE_INT T1.Z, PS, 0.0, literal.y,
; EG-NEXT:     BFE_INT T0.W, PV.W, 0.0, literal.y,
; EG-NEXT:     OR_INT * T1.W, PV.Z, PV.Y,
; EG-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; EG-NEXT:     LSHR * T1.Y, T11.Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; EG-NEXT:     AND_INT T0.W, PV.W, literal.y,
; EG-NEXT:     LSHR * T1.W, T11.Y, literal.z,
; EG-NEXT:    -65536(nan), 65535(9.183409e-41)
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T0.Y, PS, 0.0, literal.x,
; EG-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; EG-NEXT:     BFE_INT T0.W, T1.Y, 0.0, literal.x,
; EG-NEXT:     ASHR * T1.W, T11.Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     AND_INT T1.Y, PV.W, literal.x,
; EG-NEXT:     LSHL T1.Z, PS, literal.y,
; EG-NEXT:     AND_INT T0.W, PV.Z, literal.x,
; EG-NEXT:     LSHL * T1.W, PV.Y, literal.y,
; EG-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; EG-NEXT:     LSHR T11.X, KC0[2].Y, literal.x,
...
; CM-NEXT:    ALU 1, @8, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 0 @6
; CM-NEXT:    ALU 48, @10, KC0[CB0:0-32], KC1[]
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T12, T13.X
; CM-NEXT:    CF_END
; CM-NEXT:    PAD
; CM-NEXT:    Fetch clause starting at 6:
...
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T12.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T0.Y, T0.Y, literal.y,
; CM-NEXT:     LSHR T0.Z, T11.X, literal.z,
; CM-NEXT:     LSHR * T0.W, T11.X, literal.w,
; CM-NEXT:    65535(9.183409e-41), -65536(nan)
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:     ASHR T11.X, T11.X, literal.x,
; CM-NEXT:     BFE_INT T1.Y, PV.W, 0.0, literal.y,
; CM-NEXT:     BFE_INT T0.Z, PV.Z, 0.0, literal.y,
; CM-NEXT:     OR_INT * T0.W, PV.Y, PV.X,
; CM-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; CM-NEXT:     MOV T9.X, T12.Y,
; CM-NEXT:     MOV T0.Y, T4.X,
; CM-NEXT:     BFE_INT * T0.W, T11.Y, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T11.X, T11.Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.Y, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.W, literal.z,
; CM-NEXT:     LSHR * T0.W, T11.Y, literal.w,
; CM-NEXT:    16(2.242078e-44), -65536(nan)
; CM-NEXT:    65535(9.183409e-41), 8(1.121039e-44)
; CM-NEXT:     BFE_INT T12.X, PV.W, 0.0, literal.x,
; CM-NEXT:     OR_INT T0.Y, PV.Y, PV.Z,
; CM-NEXT:     ASHR T0.Z, T11.Y, literal.y,
; CM-NEXT:     BFE_INT * T0.W, PV.X, 0.0, literal.x,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     AND_INT T11.X, PV.W, literal.x,
; CM-NEXT:     LSHL T1.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     LSHL * T0.W, PV.X, literal.y,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     LSHR T13.X, KC0[2].Y, literal.x,
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     OR_INT * T12.W, PV.X, PV.Y,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; CM-NEXT:     MOV * T4.X, PV.Z,
; CM-NEXT:     MOV * T5.X, T12.W,
; CM-NEXT:     MOV T12.X, T8.X,
...
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s18, s11, 8
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s10, s10, 8
; GCN-NOHSA-SI-NEXT:    s_and_b32 s16, s16, 0xff0000
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s9, s9, 8
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s19, s8, 8
; GCN-NOHSA-SI-NEXT:    s_or_b32 s6, s6, s13
; GCN-NOHSA-SI-NEXT:    s_or_b32 s13, s15, s14
; GCN-NOHSA-SI-NEXT:    s_or_b32 s7, s7, s12
; GCN-NOHSA-SI-NEXT:    s_or_b32 s11, s11, s18
; GCN-NOHSA-SI-NEXT:    s_or_b32 s4, s4, s10
; GCN-NOHSA-SI-NEXT:    s_or_b32 s10, s17, s16
; GCN-NOHSA-SI-NEXT:    s_or_b32 s5, s5, s9
; GCN-NOHSA-SI-NEXT:    s_or_b32 s8, s8, s19
; GCN-NOHSA-SI-NEXT:    s_and_b32 s8, s8, 0xff00ff
; GCN-NOHSA-SI-NEXT:    s_and_b32 s9, s11, 0xff00ff
...
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s2, v3
; GCN-HSA-NEXT:    v_readfirstlane_b32 s4, v1
; GCN-HSA-NEXT:    v_readfirstlane_b32 s3, v2
; GCN-HSA-NEXT:    v_readfirstlane_b32 s5, v0
; GCN-HSA-NEXT:    s_lshr_b32 s6, s2, 16
; GCN-HSA-NEXT:    s_lshr_b32 s9, s4, 16
; GCN-HSA-NEXT:    s_and_b32 s7, s3, 0xff00
; GCN-HSA-NEXT:    s_and_b32 s8, s2, 0xff00
; GCN-HSA-NEXT:    s_and_b32 s10, s5, 0xff00
; GCN-HSA-NEXT:    s_and_b32 s11, s4, 0xff00
; GCN-HSA-NEXT:    s_lshr_b32 s12, s5, 8
; GCN-HSA-NEXT:    s_lshr_b32 s14, s3, 8
; GCN-HSA-NEXT:    s_lshl_b32 s16, s9, 8
; GCN-HSA-NEXT:    s_lshl_b32 s17, s6, 8
; GCN-HSA-NEXT:    s_and_b32 s4, s4, 0xff
; GCN-HSA-NEXT:    s_bfe_u32 s13, s5, 0x80010
...
; GCN-HSA-NEXT:    s_or_b32 s9, s9, s16
; GCN-HSA-NEXT:    s_or_b32 s6, s6, s17
; GCN-HSA-NEXT:    s_or_b32 s4, s4, s11
; GCN-HSA-NEXT:    s_or_b32 s11, s13, s12
; GCN-HSA-NEXT:    s_or_b32 s5, s5, s10
; GCN-HSA-NEXT:    s_or_b32 s2, s2, s8
; GCN-HSA-NEXT:    s_or_b32 s8, s15, s14
; GCN-HSA-NEXT:    s_or_b32 s3, s3, s7
; GCN-HSA-NEXT:    s_and_b32 s7, s9, 0xff00ff
...
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v8, 24, v3
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v9, 8, v3
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v10, 24, v2
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v11, 8, v2
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v4, 24, v1
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v5, 8, v1
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v6, 24, v0
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v7, 8, v0
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v8, v8, v3, 16
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v9, 0xff0000, v9
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v14, v10, v2, 16
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v15, 0xff0000, v11
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v4, v4, v1, 16
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v5, 0xff0000, v5
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v12, v6, v0, 16
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v13, 0xff0000, v7
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v11, 0xff00ff, v8
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v10, v3, v9 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v9, 0xff00ff, v14
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v8, v2, v15 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v7, 0xff00ff, v4
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v6, v1, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v5, 0xff00ff, v12
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v4, v0, v13 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[8:11], off, s[0:3], 0 offset:16
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0
; GCN-NOHSA-VI-NEXT:    s_endpgm
;
...
; EG-NEXT:    ALU 1, @8, KC0[CB0:0-32], KC1[]
; EG-NEXT:    TEX 0 @6
; EG-NEXT:    ALU 79, @10, KC0[CB0:0-32], KC1[]
...
; EG-NEXT:     MOV T0.Z, literal.x,
; EG-NEXT:     LSHL T2.W, T19.X, literal.x,
; EG-NEXT:     OR_INT * T0.W, PS, PV.W,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T1.Y, PS, literal.x,
; EG-NEXT:     AND_INT T1.Z, PV.W, literal.y,
; EG-NEXT:     BFE_UINT T0.W, T19.X, literal.z, PV.Z,
; EG-NEXT:     AND_INT * T1.W, PV.Y, literal.y,
; EG-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; EG-NEXT:    -65536(nan), 255(3.573311e-43)
; EG-NEXT:     LSHL T1.Z, T19.Y, literal.x,
; EG-NEXT:     OR_INT T0.W, PV.W, PS,
; EG-NEXT:     LSHR * T1.W, T19.Y, literal.x,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T0.Y, PS, literal.x,
; EG-NEXT:     BFE_UINT T2.Z, T19.Y, literal.y, T0.Z,
; EG-NEXT:     AND_INT T0.W, PV.W, literal.z,
; EG-NEXT:     AND_INT * T1.W, PV.Z, literal.x,
; EG-NEXT:    16711680(2.341805e-38), 16(2.242078e-44)
; EG-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; EG-NEXT:     OR_INT T0.W, PV.W, PS,
; EG-NEXT:     OR_INT * T20.W, PV.Z, PV.Y,
; EG-NEXT:     MOV T12.X, PV.W,
; EG-NEXT:     MOV * T13.X, PS,
; EG-NEXT:     MOV * T0.Y, T8.X,
; EG-NEXT:     AND_INT T0.W, PV.Y, literal.x,
; EG-NEXT:     AND_INT * T1.W, T19.Z, literal.y,
; EG-NEXT:    -65536(nan), 255(3.573311e-43)
; EG-NEXT:     LSHR T1.Z, T19.Z, literal.x,
; EG-NEXT:     LSHL T2.W, T19.Z, literal.x,
; EG-NEXT:     OR_INT * T0.W, PV.W, PS,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T0.Y, PS, literal.x,
; EG-NEXT:     AND_INT T2.Z, PV.W, literal.y,
; EG-NEXT:     BFE_UINT T0.W, T19.Z, literal.z, T0.Z,
; EG-NEXT:     AND_INT * T1.W, PV.Z, literal.y,
; EG-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; EG-NEXT:     MOV * T0.Y, T4.X,
; EG-NEXT:     AND_INT T0.W, PV.Y, literal.x,
; EG-NEXT:     AND_INT * T1.W, T19.W, literal.y,
; EG-NEXT:    -65536(nan), 255(3.573311e-43)
; EG-NEXT:     LSHL T0.Y, T19.W, literal.x,
...
; EG-NEXT:     BFE_UINT T0.Z, T19.W, literal.z, T0.Z,
; EG-NEXT:     AND_INT T0.W, PV.Z, literal.w,
; EG-NEXT:     AND_INT * T1.W, PV.Y, literal.y,
; EG-NEXT:    2(2.802597e-45), 16711680(2.341805e-38)
; EG-NEXT:    16(2.242078e-44), 255(3.573311e-43)
; EG-NEXT:     LSHR T22.X, KC0[2].Y, literal.x,
; EG-NEXT:     OR_INT T0.W, PV.W, PS,
; EG-NEXT:     OR_INT * T19.W, PV.Z, PV.Y,
; EG-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; EG-NEXT:     MOV T4.X, PV.W,
; EG-NEXT:     MOV * T5.X, PS,
; EG-NEXT:     MOV T20.X, T16.X,
; EG-NEXT:     MOV T20.Z, T12.X, BS:VEC_120/SCL_212
; EG-NEXT:     MOV * T19.X, T8.X,
; EG-NEXT:     MOV * T19.Z, T4.X,
;
; CM-LABEL: global_zextload_v16i8_to_v16i16:
; CM:       ; %bb.0:
; CM-NEXT:    ALU 1, @8, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 0 @6
; CM-NEXT:    ALU 81, @10, KC0[CB0:0-32], KC1[]
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T19, T22.X
...
; CM-NEXT:     AND_INT * T0.W, T0.Y, literal.y,
; CM-NEXT:    255(3.573311e-43), -65536(nan)
; CM-NEXT:     MOV T20.X, literal.x,
; CM-NEXT:     LSHR T0.Y, T19.X, literal.x,
; CM-NEXT:     LSHL T1.Z, T19.X, literal.x,
; CM-NEXT:     OR_INT * T0.W, PV.W, PV.Z,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T21.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T1.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.y,
; CM-NEXT:     BFE_UINT * T0.W, T19.X, literal.z, PV.X,
; CM-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     OR_INT T20.Y, PV.W, PV.Z,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T16.X, PV.W,
; CM-NEXT:     MOV T17.X, T20.Y,
; CM-NEXT:     MOV * T0.Y, T12.X,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     AND_INT * T0.W, T19.Y, literal.y,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
; CM-NEXT:     LSHL T0.Y, T19.Y, literal.x,
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     LSHR * T0.W, T19.Y, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T19.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T1.Y, T19.Y, literal.y, T20.X,
; CM-NEXT:     AND_INT T0.Z, PV.Z, literal.z,
; CM-NEXT:     AND_INT * T0.W, PV.Y, literal.x,
; CM-NEXT:    16711680(2.341805e-38), 16(2.242078e-44)
; CM-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     OR_INT * T20.W, PV.Y, PV.X,
; CM-NEXT:     MOV * T12.X, PV.Z,
; CM-NEXT:     MOV T13.X, T20.W,
; CM-NEXT:     MOV * T0.Y, T8.X,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     AND_INT * T0.W, T19.Z, literal.y,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
; CM-NEXT:     LSHR T0.Y, T19.Z, literal.x,
; CM-NEXT:     LSHL T1.Z, T19.Z, literal.x,
; CM-NEXT:     OR_INT * T0.W, PV.Z, PV.W,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T19.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T1.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.y,
; CM-NEXT:     BFE_UINT * T0.W, T19.Z, literal.z, T20.X,
; CM-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     OR_INT T19.Y, PV.W, PV.Z,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T8.X, PV.W,
; CM-NEXT:     MOV T9.X, T19.Y,
; CM-NEXT:     MOV * T0.Y, T4.X,
; CM-NEXT:     AND_INT T0.Y, PV.Y, literal.x,
; CM-NEXT:     AND_INT T0.Z, T19.W, literal.y,
; CM-NEXT:     LSHR * T0.W, T19.W, literal.z,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T19.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T1.Y, T19.W, literal.y, T20.X,
; CM-NEXT:     LSHL T1.Z, T19.W, literal.z,
; CM-NEXT:     OR_INT * T0.W, PV.Y, PV.Z,
; CM-NEXT:    16711680(2.341805e-38), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T21.X, KC0[2].Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.W, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Z, literal.z,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.w,
...
; CM-NEXT:     OR_INT * T19.W, T1.Y, T19.X,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; CM-NEXT:     MOV * T4.X, PV.Z,
...
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s18, s5
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s19, s4
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s12, s6, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s13, s6, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s14, s7, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s15, s7, 16
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s16, s7
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s17, s6
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s5, s5, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s4, s4, 0x80000
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s18, s18, 8
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s19, s19, 8
...
; GCN-NOHSA-VI-NEXT:    s_and_b32 s19, s19, 0xffff0000
...
; GCN-NOHSA-VI-NEXT:    s_or_b32 s5, s5, s18
; GCN-NOHSA-VI-NEXT:    s_or_b32 s4, s4, s19
; GCN-NOHSA-VI-NEXT:    s_or_b32 s10, s11, s10
; GCN-NOHSA-VI-NEXT:    s_or_b32 s8, s9, s8
; GCN-NOHSA-VI-NEXT:    s_or_b32 s7, s7, s16
; GCN-NOHSA-VI-NEXT:    s_or_b32 s6, s6, s17
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v5, s12
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v6, s7
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v7, s14
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:16
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0
; GCN-NOHSA-VI-NEXT:    s_endpgm
;
...
; EG-NEXT:    TEX 0 @8
; EG-NEXT:    ALU 89, @12, KC0[CB0:0-32], KC1[]
; EG-NEXT:    ALU 11, @102, KC0[CB0:0-32], KC1[]
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T20.XYZW, T22.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T19.XYZW, T21.X, 1
; EG-NEXT:    CF_END
; EG-NEXT:    PAD
...
; EG-NEXT:     LSHR * T1.W, T19.X, literal.w,
; EG-NEXT:    65535(9.183409e-41), -65536(nan)
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:     ASHR T0.Y, T19.X, literal.x,
; EG-NEXT:     BFE_INT T1.Z, PS, 0.0, literal.y,
; EG-NEXT:     BFE_INT T0.W, PV.W, 0.0, literal.y,
; EG-NEXT:     OR_INT * T1.W, PV.Z, PV.Y,
; EG-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; EG-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; EG-NEXT:     BFE_INT T0.W, T1.Y, 0.0, literal.x,
; EG-NEXT:     ASHR * T1.W, T19.Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     AND_INT T1.Y, PV.W, literal.x,
; EG-NEXT:     LSHL T1.Z, PS, literal.y,
; EG-NEXT:     AND_INT T0.W, PV.Z, literal.x,
...
; EG-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; EG-NEXT:     OR_INT T0.W, PV.W, PS,
; EG-NEXT:     OR_INT * T20.W, PV.Y, PV.Z,
; EG-NEXT:     MOV T12.X, PV.W,
; EG-NEXT:     MOV * T13.X, PS,
; EG-NEXT:     MOV T0.Y, T8.X,
; EG-NEXT:     BFE_INT * T0.W, T19.Z, 0.0, literal.x,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T0.Y, PV.Y, literal.x,
; EG-NEXT:     AND_INT T0.Z, PV.W, literal.y,
; EG-NEXT:     LSHR T0.W, T19.Z, literal.z,
; EG-NEXT:     LSHR * T1.W, T19.Z, literal.w,
; EG-NEXT:    -65536(nan), 65535(9.183409e-41)
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:     ASHR T1.Y, T19.Z, literal.x,
; EG-NEXT:     BFE_INT T1.Z, PS, 0.0, literal.y,
; EG-NEXT:     BFE_INT T0.W, PV.W, 0.0, literal.y,
...
; EG-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; EG-NEXT:     AND_INT T0.W, PV.W, literal.y,
; EG-NEXT:     LSHR * T1.W, T19.W, literal.z,
; EG-NEXT:    -65536(nan), 65535(9.183409e-41)
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T19.X, PS, 0.0, literal.x,
; EG-NEXT:     OR_INT T0.Y, PV.Z, PV.W,
; EG-NEXT:     ASHR T0.Z, T19.W, literal.y,
; EG-NEXT:     BFE_INT T0.W, T1.Y, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.z,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; CM-NEXT:    TEX 0 @8
; CM-NEXT:    ALU 90, @12, KC0[CB0:0-32], KC1[]
; CM-NEXT:    ALU 11, @103, KC0[CB0:0-32], KC1[]
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T19, T22.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T20, T21.X
; CM-NEXT:    CF_END
; CM-NEXT:    PAD
...
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T20.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T0.Y, T0.Y, literal.y,
; CM-NEXT:     LSHR T0.Z, T19.X, literal.z,
; CM-NEXT:     LSHR * T0.W, T19.X, literal.w,
; CM-NEXT:    65535(9.183409e-41), -65536(nan)
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:     ASHR T19.X, T19.X, literal.x,
; CM-NEXT:     BFE_INT T1.Y, PV.W, 0.0, literal.y,
; CM-NEXT:     BFE_INT T0.Z, PV.Z, 0.0, literal.y,
; CM-NEXT:     OR_INT * T0.W, PV.Y, PV.X,
; CM-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; CM-NEXT:     MOV T17.X, T20.Y,
; CM-NEXT:     MOV T0.Y, T12.X,
; CM-NEXT:     BFE_INT * T0.W, T19.Y, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T19.X, T19.Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.Y, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.W, literal.z,
; CM-NEXT:     LSHR * T0.W, T19.Y, literal.w,
; CM-NEXT:    16(2.242078e-44), -65536(nan)
; CM-NEXT:    65535(9.183409e-41), 8(1.121039e-44)
; CM-NEXT:     BFE_INT T20.X, PV.W, 0.0, literal.x,
; CM-NEXT:     OR_INT T0.Y, PV.Y, PV.Z,
; CM-NEXT:     ASHR T0.Z, T19.Y, literal.y,
; CM-NEXT:     BFE_INT * T0.W, PV.X, 0.0, literal.x,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     AND_INT T19.X, PV.W, literal.x,
; CM-NEXT:     LSHL T1.Y, PV.Z, literal.y,
...
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     OR_INT * T20.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T12.X, PV.Z,
; CM-NEXT:     MOV T13.X, T20.W,
; CM-NEXT:     MOV T0.Y, T8.X,
; CM-NEXT:     BFE_INT * T0.W, T19.Z, 0.0, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T19.X, PV.Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.W, literal.y,
; CM-NEXT:     LSHR T0.Z, T19.Z, literal.z,
; CM-NEXT:     LSHR * T0.W, T19.Z, literal.w,
; CM-NEXT:    -65536(nan), 65535(9.183409e-41)
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:     ASHR T20.X, T19.Z, literal.x,
; CM-NEXT:     BFE_INT T1.Y, PV.W, 0.0, literal.y,
; CM-NEXT:     BFE_INT T0.Z, PV.Z, 0.0, literal.y,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; CM-NEXT:     MOV * T0.Y, T4.X,
; CM-NEXT:     AND_INT T0.Y, PV.Y, literal.x,
; CM-NEXT:     LSHR T0.Z, T19.W, literal.y,
; CM-NEXT:     BFE_INT * T0.W, T19.W, 0.0, literal.z,
; CM-NEXT:    -65536(nan), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T19.X, PV.W, literal.x,
; CM-NEXT:     LSHR T1.Y, T19.W, literal.y,
; CM-NEXT:     ASHR T1.Z, T19.W, literal.z,
; CM-NEXT:     BFE_INT * T0.W, PV.Z, 0.0, literal.y,
; CM-NEXT:    65535(9.183409e-41), 8(1.121039e-44)
; CM-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T20.X, PV.W, literal.x,
; CM-NEXT:     LSHL T2.Y, PV.Z, literal.y,
; CM-NEXT:     BFE_INT T0.Z, PV.Y, 0.0, literal.z,
; CM-NEXT:     OR_INT * T0.W, T0.Y, PV.X,
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T21.X, KC0[2].Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.W, literal.y,
; CM-NEXT:     LSHL * T0.Z, PV.Z, literal.z,
...
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T22.X, PV.W, literal.x,
; CM-NEXT:     OR_INT T0.Z, T0.Y, T0.Z,
; CM-NEXT:     OR_INT * T19.W, T20.X, T2.Y,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; CM-NEXT:     MOV * T4.X, PV.Z,
; CM-NEXT:     MOV * T5.X, T19.W,
; CM-NEXT:     MOV T20.X, T16.X,
...
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s7, v0
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s8, v7
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s9, v6
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s10, v5
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s11, v4
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s12, s4, 16
; GCN-NOHSA-SI-NEXT:    s_and_b32 s13, s5, 0xff00
; GCN-NOHSA-SI-NEXT:    s_and_b32 s14, s4, 0xff00
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s15, s6, 16
; GCN-NOHSA-SI-NEXT:    s_and_b32 s16, s7, 0xff00
; GCN-NOHSA-SI-NEXT:    s_and_b32 s17, s6, 0xff00
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s18, s8, 16
; GCN-NOHSA-SI-NEXT:    s_and_b32 s19, s9, 0xff00
; GCN-NOHSA-SI-NEXT:    s_and_b32 s20, s8, 0xff00
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s21, s10, 16
; GCN-NOHSA-SI-NEXT:    s_and_b32 s22, s11, 0xff00
; GCN-NOHSA-SI-NEXT:    s_and_b32 s23, s10, 0xff00
; GCN-NOHSA-SI-NEXT:    s_and_b32 s10, s10, 0xff
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s24, s11, 8
; GCN-NOHSA-SI-NEXT:    s_bfe_u32 s25, s11, 0x80010
; GCN-NOHSA-SI-NEXT:    s_and_b32 s11, s11, 0xff
; GCN-NOHSA-SI-NEXT:    s_and_b32 s8, s8, 0xff
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s26, s9, 8
; GCN-NOHSA-SI-NEXT:    s_bfe_u32 s27, s9, 0x80010
...
; GCN-NOHSA-SI-NEXT:    s_and_b32 s7, s7, 0xff
; GCN-NOHSA-SI-NEXT:    s_and_b32 s4, s4, 0xff
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s30, s5, 8
; GCN-NOHSA-SI-NEXT:    s_bfe_u32 s31, s5, 0x80010
; GCN-NOHSA-SI-NEXT:    s_and_b32 s5, s5, 0xff
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s23, s23, 8
; GCN-NOHSA-SI-NEXT:    s_and_b32 s24, s24, 0xff0000
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s22, s22, 8
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s33, s21, 8
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s20, s20, 8
; GCN-NOHSA-SI-NEXT:    s_and_b32 s26, s26, 0xff0000
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s19, s19, 8
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s34, s18, 8
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s17, s17, 8
; GCN-NOHSA-SI-NEXT:    s_and_b32 s28, s28, 0xff0000
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s16, s16, 8
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s35, s15, 8
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s14, s14, 8
; GCN-NOHSA-SI-NEXT:    s_and_b32 s30, s30, 0xff0000
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s13, s13, 8
; GCN-NOHSA-SI-NEXT:    s_lshl_b32 s36, s12, 8
; GCN-NOHSA-SI-NEXT:    s_or_b32 s10, s10, s23
; GCN-NOHSA-SI-NEXT:    s_or_b32 s23, s25, s24
; GCN-NOHSA-SI-NEXT:    s_or_b32 s11, s11, s22
; GCN-NOHSA-SI-NEXT:    s_or_b32 s21, s21, s33
; GCN-NOHSA-SI-NEXT:    s_or_b32 s8, s8, s20
; GCN-NOHSA-SI-NEXT:    s_or_b32 s20, s27, s26
; GCN-NOHSA-SI-NEXT:    s_or_b32 s9, s9, s19
; GCN-NOHSA-SI-NEXT:    s_or_b32 s18, s18, s34
; GCN-NOHSA-SI-NEXT:    s_or_b32 s6, s6, s17
; GCN-NOHSA-SI-NEXT:    s_or_b32 s17, s29, s28
; GCN-NOHSA-SI-NEXT:    s_or_b32 s7, s7, s16
; GCN-NOHSA-SI-NEXT:    s_or_b32 s15, s15, s35
; GCN-NOHSA-SI-NEXT:    s_or_b32 s4, s4, s14
; GCN-NOHSA-SI-NEXT:    s_or_b32 s14, s31, s30
; GCN-NOHSA-SI-NEXT:    s_or_b32 s5, s5, s13
; GCN-NOHSA-SI-NEXT:    s_or_b32 s12, s12, s36
; GCN-NOHSA-SI-NEXT:    s_and_b32 s13, s21, 0xff00ff
; GCN-NOHSA-SI-NEXT:    s_and_b32 s16, s18, 0xff00ff
; GCN-NOHSA-SI-NEXT:    s_and_b32 s12, s12, 0xff00ff
; GCN-NOHSA-SI-NEXT:    s_and_b32 s15, s15, 0xff00ff
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v0, s5
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v12, s11
...
; GCN-HSA-NEXT:    v_readfirstlane_b32 s5, v2
; GCN-HSA-NEXT:    v_readfirstlane_b32 s6, v1
; GCN-HSA-NEXT:    v_readfirstlane_b32 s7, v0
; GCN-HSA-NEXT:    s_lshr_b32 s8, s4, 16
; GCN-HSA-NEXT:    s_and_b32 s9, s5, 0xff00
; GCN-HSA-NEXT:    s_and_b32 s10, s4, 0xff00
; GCN-HSA-NEXT:    s_lshr_b32 s11, s6, 16
; GCN-HSA-NEXT:    s_and_b32 s12, s7, 0xff00
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCN-HSA-NEXT:    flat_load_dwordx4 v[0:3], v[0:1]
; GCN-HSA-NEXT:    s_and_b32 s2, s6, 0xff
; GCN-HSA-NEXT:    s_lshl_b32 s3, s13, 8
; GCN-HSA-NEXT:    s_lshr_b32 s6, s7, 8
; GCN-HSA-NEXT:    s_and_b32 s4, s4, 0xff
; GCN-HSA-NEXT:    s_lshl_b32 s10, s10, 8
; GCN-HSA-NEXT:    s_lshr_b32 s15, s5, 8
; GCN-HSA-NEXT:    s_bfe_u32 s13, s7, 0x80010
; GCN-HSA-NEXT:    s_and_b32 s7, s7, 0xff
; GCN-HSA-NEXT:    s_lshl_b32 s12, s12, 8
; GCN-HSA-NEXT:    s_lshl_b32 s14, s11, 8
; GCN-HSA-NEXT:    s_bfe_u32 s16, s5, 0x80010
; GCN-HSA-NEXT:    s_and_b32 s5, s5, 0xff
; GCN-HSA-NEXT:    s_lshl_b32 s9, s9, 8
; GCN-HSA-NEXT:    s_lshl_b32 s17, s8, 8
; GCN-HSA-NEXT:    s_or_b32 s2, s2, s3
; GCN-HSA-NEXT:    s_and_b32 s3, s6, 0xff0000
; GCN-HSA-NEXT:    s_or_b32 s4, s4, s10
; GCN-HSA-NEXT:    s_and_b32 s10, s15, 0xff0000
; GCN-HSA-NEXT:    s_or_b32 s6, s7, s12
; GCN-HSA-NEXT:    s_or_b32 s7, s11, s14
; GCN-HSA-NEXT:    s_or_b32 s5, s5, s9
; GCN-HSA-NEXT:    s_or_b32 s8, s8, s17
; GCN-HSA-NEXT:    s_or_b32 s3, s13, s3
; GCN-HSA-NEXT:    s_or_b32 s9, s16, s10
; GCN-HSA-NEXT:    v_mov_b32_e32 v6, s4
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, s2
; GCN-HSA-NEXT:    s_and_b32 s7, s7, 0xff00ff
...
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(1)
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v8, 8, v1
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v10, 8, v0
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v12, 8, v3
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v14, 8, v2
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v8, 0xff0000, v8
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v15, 0xff0000, v10
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v9, 24, v1
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v11, 24, v0
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v13, 24, v3
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v12, 0xff0000, v12
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v16, 0xff0000, v14
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v10, v1, v8 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v8, v0, v15 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v15, 24, v2
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v14, v3, v12 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v12, v2, v16 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v1, v9, v1, 16
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v9, v11, v0, 16
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v3, v13, v3, 16
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v13, v15, v2, 16
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v0, 8, v5
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v2, 8, v4
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v0, 0xff0000, v0
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v11, 0xff0000, v2
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v2, v5, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v0, v4, v11 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v11, 8, v7
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v11, 0xff0000, v11
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v18, v7, v11 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v11, 24, v5
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v5, v11, v5, 16
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v11, 24, v4
; GCN-NOHSA-VI-NEXT:    v_lshlrev_b32_e32 v15, 8, v6
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v4, v11, v4, 16
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v11, 24, v7
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v15, 0xff0000, v15
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v7, v11, v7, 16
; GCN-NOHSA-VI-NEXT:    v_lshrrev_b32_e32 v11, 24, v6
; GCN-NOHSA-VI-NEXT:    v_or_b32_sdwa v16, v6, v15 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GCN-NOHSA-VI-NEXT:    v_alignbit_b32 v6, v11, v6, 16
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v19, 0xff00ff, v7
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v17, 0xff00ff, v6
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v11, 0xff00ff, v1
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v9, 0xff00ff, v9
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v15, 0xff00ff, v3
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v13, 0xff00ff, v13
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v3, 0xff00ff, v5
; GCN-NOHSA-VI-NEXT:    v_and_b32_e32 v1, 0xff00ff, v4
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[16:19], off, s[0:3], 0 offset:48
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:32
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[12:15], off, s[0:3], 0 offset:16
...
; EG-NEXT:    TEX 1 @10
; EG-NEXT:    ALU 93, @16, KC0[], KC1[]
; EG-NEXT:    ALU 69, @110, KC0[CB0:0-32], KC1[]
...
; EG-NEXT:     AND_INT * T1.W, T0.Y, literal.y,
; EG-NEXT:    255(3.573311e-43), -65536(nan)
; EG-NEXT:     LSHR T0.Y, T37.X, literal.x,
; EG-NEXT:     MOV T0.Z, literal.x,
; EG-NEXT:     LSHL T2.W, T37.X, literal.x,
; EG-NEXT:     OR_INT * T0.W, PS, PV.W,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T1.Y, PS, literal.x,
; EG-NEXT:     AND_INT T1.Z, PV.W, literal.y,
; EG-NEXT:     BFE_UINT T0.W, T37.X, literal.z, PV.Z,
; EG-NEXT:     AND_INT * T1.W, PV.Y, literal.y,
; EG-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; EG-NEXT:     MOV * T0.Y, T12.X,
; EG-NEXT:     AND_INT T0.W, PV.Y, literal.x,
; EG-NEXT:     AND_INT * T1.W, T37.Y, literal.y,
; EG-NEXT:    -65536(nan), 255(3.573311e-43)
; EG-NEXT:     LSHL T1.Z, T37.Y, literal.x,
; EG-NEXT:     OR_INT T0.W, PV.W, PS,
; EG-NEXT:     LSHR * T1.W, T37.Y, literal.x,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T0.Y, PS, literal.x,
; EG-NEXT:     BFE_UINT T2.Z, T37.Y, literal.y, T0.Z,
; EG-NEXT:     AND_INT T0.W, PV.W, literal.z,
; EG-NEXT:     AND_INT * T1.W, PV.Z, literal.x,
; EG-NEXT:    16711680(2.341805e-38), 16(2.242078e-44)
; EG-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; EG-NEXT:     OR_INT T0.W, PV.W, PS,
; EG-NEXT:     OR_INT * T36.W, PV.Z, PV.Y,
; EG-NEXT:     MOV T12.X, PV.W,
; EG-NEXT:     MOV * T13.X, PS,
; EG-NEXT:     MOV * T0.Y, T8.X,
; EG-NEXT:     AND_INT T0.W, PV.Y, literal.x,
; EG-NEXT:     AND_INT * T1.W, T37.Z, literal.y,
; EG-NEXT:    -65536(nan), 255(3.573311e-43)
; EG-NEXT:     LSHR T1.Z, T37.Z, literal.x,
; EG-NEXT:     LSHL T2.W, T37.Z, literal.x,
; EG-NEXT:     OR_INT * T0.W, PV.W, PS,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T0.Y, PS, literal.x,
; EG-NEXT:     AND_INT T2.Z, PV.W, literal.y,
; EG-NEXT:     BFE_UINT T0.W, T37.Z, literal.z, T0.Z,
; EG-NEXT:     AND_INT * T1.W, PV.Z, literal.y,
; EG-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; EG-NEXT:     MOV * T0.Y, T4.X,
; EG-NEXT:     AND_INT T0.W, PV.Y, literal.x,
; EG-NEXT:     AND_INT * T1.W, T37.W, literal.y,
; EG-NEXT:    -65536(nan), 255(3.573311e-43)
; EG-NEXT:     LSHL T1.Z, T37.W, literal.x,
; EG-NEXT:     OR_INT T0.W, PV.W, PS,
; EG-NEXT:     LSHR * T1.W, T37.W, literal.x,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T0.Y, PS, literal.x,
; EG-NEXT:     BFE_UINT T2.Z, T37.W, literal.y, T0.Z,
; EG-NEXT:     AND_INT T0.W, PV.W, literal.z,
; EG-NEXT:     AND_INT * T1.W, PV.Z, literal.x,
; EG-NEXT:    16711680(2.341805e-38), 16(2.242078e-44)
; EG-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; EG-NEXT:     OR_INT T0.W, PV.W, PS,
; EG-NEXT:     OR_INT * T37.W, PV.Z, PV.Y,
; EG-NEXT:     MOV T4.X, PV.W,
; EG-NEXT:     MOV * T5.X, PS,
; EG-NEXT:     MOV * T0.Y, T32.X,
; EG-NEXT:     AND_INT T0.W, PV.Y, literal.x,
; EG-NEXT:     AND_INT * T1.W, T35.X, literal.y,
; EG-NEXT:    -65536(nan), 255(3.573311e-43)
; EG-NEXT:     LSHR T1.Z, T35.X, literal.x,
; EG-NEXT:     LSHL T2.W, T35.X, literal.x,
; EG-NEXT:     OR_INT * T0.W, PV.W, PS,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T0.Y, PS, literal.x,
; EG-NEXT:     AND_INT T2.Z, PV.W, literal.y,
; EG-NEXT:     BFE_UINT T0.W, T35.X, literal.z, T0.Z,
; EG-NEXT:     AND_INT * T1.W, PV.Z, literal.y,
; EG-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; EG-NEXT:     AND_INT T0.W, PV.Y, literal.x,
; EG-NEXT:     AND_INT * T1.W, T35.Y, literal.y,
; EG-NEXT:    -65536(nan), 255(3.573311e-43)
; EG-NEXT:    ALU clause starting at 110:
; EG-NEXT:     LSHL T1.Z, T35.Y, literal.x,
; EG-NEXT:     OR_INT T0.W, T0.W, T1.W,
; EG-NEXT:     LSHR * T1.W, T35.Y, literal.x,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T0.Y, PS, literal.x,
; EG-NEXT:     BFE_UINT T2.Z, T35.Y, literal.y, T0.Z,
; EG-NEXT:     AND_INT T0.W, PV.W, literal.z,
; EG-NEXT:     AND_INT * T1.W, PV.Z, literal.x,
; EG-NEXT:    16711680(2.341805e-38), 16(2.242078e-44)
; EG-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; EG-NEXT:     OR_INT T0.W, PV.W, PS,
; EG-NEXT:     OR_INT * T38.W, PV.Z, PV.Y,
; EG-NEXT:     MOV T28.X, PV.W,
; EG-NEXT:     MOV * T29.X, PS,
; EG-NEXT:     MOV * T0.Y, T24.X,
; EG-NEXT:     AND_INT T0.W, PV.Y, literal.x,
; EG-NEXT:     AND_INT * T1.W, T35.Z, literal.y,
; EG-NEXT:    -65536(nan), 255(3.573311e-43)
; EG-NEXT:     LSHR T1.Z, T35.Z, literal.x,
; EG-NEXT:     LSHL T2.W, T35.Z, literal.x,
; EG-NEXT:     OR_INT * T0.W, PV.W, PS,
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     AND_INT T0.Y, PS, literal.x,
; EG-NEXT:     AND_INT T2.Z, PV.W, literal.y,
; EG-NEXT:     BFE_UINT T0.W, T35.Z, literal.z, T0.Z,
; EG-NEXT:     AND_INT * T1.W, PV.Z, literal.y,
; EG-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; EG-NEXT:     AND_INT T0.W, T35.W, literal.z,
; EG-NEXT:     LSHR * T1.W, T35.W, literal.w,
; EG-NEXT:    2(2.802597e-45), -65536(nan)
; EG-NEXT:    255(3.573311e-43), 8(1.121039e-44)
; EG-NEXT:     LSHR T40.X, KC0[2].Y, literal.x,
; EG-NEXT:     AND_INT T0.Y, PS, literal.y,
; EG-NEXT:     LSHL T2.Z, T35.W, literal.z,
; EG-NEXT:     OR_INT T0.W, PV.Z, PV.W,
; EG-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.w,
; EG-NEXT:    2(2.802597e-45), 16711680(2.341805e-38)
; EG-NEXT:    8(1.121039e-44), 48(6.726233e-44)
; EG-NEXT:     LSHR T41.X, PS, literal.x,
; EG-NEXT:     BFE_UINT T1.Y, T35.W, literal.y, T0.Z,
; EG-NEXT:     AND_INT T0.Z, PV.W, literal.z,
; EG-NEXT:     AND_INT * T0.W, PV.Z, literal.w,
; EG-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; EG-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; EG-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.x,
...
; EG-NEXT:     OR_INT * T35.W, T1.Y, T0.Y,
; EG-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; EG-NEXT:     MOV T20.X, PV.W,
; EG-NEXT:     MOV * T21.X, PS,
; EG-NEXT:     MOV T36.X, T16.X,
; EG-NEXT:     MOV T36.Z, T12.X, BS:VEC_120/SCL_212
; EG-NEXT:     MOV * T37.X, T8.X,
; EG-NEXT:     MOV * T37.Z, T4.X,
; EG-NEXT:     MOV T38.X, T32.X,
; EG-NEXT:     MOV T38.Z, T28.X, BS:VEC_120/SCL_212
; EG-NEXT:     MOV * T35.X, T24.X,
; EG-NEXT:     MOV * T35.Z, T20.X,
;
; CM-LABEL: global_zextload_v32i8_to_v32i16:
; CM:       ; %bb.0:
; CM-NEXT:    ALU 1, @14, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 1 @10
; CM-NEXT:    ALU 93, @16, KC0[], KC1[]
; CM-NEXT:    ALU 69, @110, KC0[CB0:0-32], KC1[]
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T37, T42.X
; CM-NEXT:    MEM_RAT_CACHELESS STORE_DWORD T38, T41.X
...
; CM-NEXT:    ALU clause starting at 16:
; CM-NEXT:     AND_INT T0.Z, T36.X, literal.x,
; CM-NEXT:     AND_INT * T0.W, T0.Y, literal.y,
; CM-NEXT:    255(3.573311e-43), -65536(nan)
; CM-NEXT:     MOV T35.X, literal.x,
; CM-NEXT:     LSHR T0.Y, T36.X, literal.x,
; CM-NEXT:     LSHL T1.Z, T36.X, literal.x,
; CM-NEXT:     OR_INT * T0.W, PV.W, PV.Z,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T38.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T1.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.y,
; CM-NEXT:     BFE_UINT * T0.W, T36.X, literal.z, PV.X,
; CM-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     OR_INT T35.Y, PV.W, PV.Z,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T16.X, PV.W,
; CM-NEXT:     MOV T17.X, T35.Y,
; CM-NEXT:     MOV * T0.Y, T12.X,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     AND_INT * T0.W, T36.Y, literal.y,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
; CM-NEXT:     LSHL T0.Y, T36.Y, literal.x,
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     LSHR * T0.W, T36.Y, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T36.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T1.Y, T36.Y, literal.y, T35.X,
; CM-NEXT:     AND_INT T0.Z, PV.Z, literal.z,
; CM-NEXT:     AND_INT * T0.W, PV.Y, literal.x,
; CM-NEXT:    16711680(2.341805e-38), 16(2.242078e-44)
; CM-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     OR_INT * T35.W, PV.Y, PV.X,
; CM-NEXT:     MOV * T12.X, PV.Z,
; CM-NEXT:     MOV T13.X, T35.W,
; CM-NEXT:     MOV * T0.Y, T8.X,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     AND_INT * T0.W, T36.Z, literal.y,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
; CM-NEXT:     LSHR T0.Y, T36.Z, literal.x,
; CM-NEXT:     LSHL T1.Z, T36.Z, literal.x,
; CM-NEXT:     OR_INT * T0.W, PV.Z, PV.W,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T36.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T1.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.y,
; CM-NEXT:     BFE_UINT * T0.W, T36.Z, literal.z, T35.X,
; CM-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     OR_INT T36.Y, PV.W, PV.Z,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T8.X, PV.W,
; CM-NEXT:     MOV T9.X, T36.Y,
; CM-NEXT:     MOV * T0.Y, T4.X,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     AND_INT * T0.W, T36.W, literal.y,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
; CM-NEXT:     LSHL T0.Y, T36.W, literal.x,
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     LSHR * T0.W, T36.W, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T36.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T1.Y, T36.W, literal.y, T35.X,
; CM-NEXT:     AND_INT T0.Z, PV.Z, literal.z,
; CM-NEXT:     AND_INT * T0.W, PV.Y, literal.x,
; CM-NEXT:    16711680(2.341805e-38), 16(2.242078e-44)
; CM-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     OR_INT * T36.W, PV.Y, PV.X,
; CM-NEXT:     MOV * T4.X, PV.Z,
; CM-NEXT:     MOV T5.X, T36.W,
; CM-NEXT:     MOV * T0.Y, T32.X,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     AND_INT * T0.W, T37.X, literal.y,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
; CM-NEXT:     LSHR T0.Y, T37.X, literal.x,
; CM-NEXT:     LSHL T1.Z, T37.X, literal.x,
; CM-NEXT:     OR_INT * T0.W, PV.Z, PV.W,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T36.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T1.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.y,
; CM-NEXT:     BFE_UINT * T0.W, T37.X, literal.z, T35.X,
; CM-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     OR_INT T38.Y, PV.W, PV.Z,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T32.X, PV.W,
; CM-NEXT:     MOV T33.X, T38.Y,
; CM-NEXT:     MOV * T0.Y, T28.X,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     AND_INT * T0.W, T37.Y, literal.y,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
; CM-NEXT:    ALU clause starting at 110:
; CM-NEXT:     LSHL T0.Y, T37.Y, literal.x,
; CM-NEXT:     OR_INT T0.Z, T0.Z, T0.W,
; CM-NEXT:     LSHR * T0.W, T37.Y, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T36.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T1.Y, T37.Y, literal.y, T35.X,
; CM-NEXT:     AND_INT T0.Z, PV.Z, literal.z,
; CM-NEXT:     AND_INT * T0.W, PV.Y, literal.x,
; CM-NEXT:    16711680(2.341805e-38), 16(2.242078e-44)
; CM-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     OR_INT * T38.W, PV.Y, PV.X,
; CM-NEXT:     MOV * T28.X, PV.Z,
; CM-NEXT:     MOV T29.X, T38.W,
; CM-NEXT:     MOV * T0.Y, T24.X,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     AND_INT * T0.W, T37.Z, literal.y,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
; CM-NEXT:     LSHR T0.Y, T37.Z, literal.x,
; CM-NEXT:     LSHL T1.Z, T37.Z, literal.x,
; CM-NEXT:     OR_INT * T0.W, PV.Z, PV.W,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T36.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T1.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.y,
; CM-NEXT:     BFE_UINT * T0.W, T37.Z, literal.z, T35.X,
; CM-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     OR_INT T37.Y, PV.W, PV.Z,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T24.X, PV.W,
; CM-NEXT:     MOV T25.X, T37.Y,
; CM-NEXT:     MOV T0.Y, T20.X,
; CM-NEXT:     LSHR * T0.W, T37.W, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T0.Z, PV.W, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.y,
; CM-NEXT:    16711680(2.341805e-38), 32(4.484155e-44)
; CM-NEXT:     LSHR T39.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T0.Y, T0.Y, literal.y,
; CM-NEXT:     AND_INT T1.Z, T37.W, literal.z,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), -65536(nan)
; CM-NEXT:    255(3.573311e-43), 48(6.726233e-44)
; CM-NEXT:     LSHR T40.X, PV.W, literal.x,
; CM-NEXT:     BFE_UINT T1.Y, T37.W, literal.y, T35.X,
; CM-NEXT:     LSHL T2.Z, T37.W, literal.z,
; CM-NEXT:     OR_INT * T0.W, PV.Y, PV.Z,
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T41.X, KC0[2].Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.W, literal.y,
; CM-NEXT:     AND_INT T1.Z, PV.Z, literal.z,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 255(3.573311e-43)
; CM-NEXT:    16711680(2.341805e-38), 16(2.242078e-44)
; CM-NEXT:     LSHR T42.X, PV.W, literal.x,
; CM-NEXT:     OR_INT T1.Z, PV.Y, PV.Z,
; CM-NEXT:     OR_INT * T37.W, T1.Y, T0.Z,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; CM-NEXT:     MOV * T20.X, PV.Z,
; CM-NEXT:     MOV * T21.X, T37.W,
; CM-NEXT:     MOV T35.X, T16.X,
; CM-NEXT:     MOV * T35.Z, T12.X, BS:VEC_120/SCL_212
; CM-NEXT:     MOV T36.X, T8.X,
; CM-NEXT:     MOV * T36.Z, T4.X, BS:VEC_120/SCL_212
; CM-NEXT:     MOV T38.X, T32.X,
; CM-NEXT:     MOV * T38.Z, T28.X, BS:VEC_120/SCL_212
; CM-NEXT:     MOV T37.X, T24.X,
; CM-NEXT:     MOV * T37.Z, T20.X, BS:VEC_120/SCL_212
  %load = load <32 x i8>, ptr addrspace(1) %in
...
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(1)
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s6, v0
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s16, s6, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s17, s6, 16
...
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s17, s5
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s14, s5, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s15, s5, 16
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s17, s17, 8
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s5, s5, 0x80000
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s4, v2
; GCN-NOHSA-VI-NEXT:    s_and_b32 s17, s17, 0xffff0000
...
; GCN-NOHSA-VI-NEXT:    s_or_b32 s5, s5, s17
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s17, s4
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s8, v6
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s9, v7
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s18, s7, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s19, s7, 16
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s33, s7
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s34, s6
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s17, s17, 8
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s4, s4, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s15, s15, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s14, s14, 0x80000
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s21, s8, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s22, s9, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s23, s9, 16
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s30, s9
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s31, s8
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s7, s7, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s6, s6, 0x80000
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s33, s33, 8
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s34, s34, 8
...
; GCN-NOHSA-VI-NEXT:    s_and_b32 s13, 0xffff, s13
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s12, s12, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s24, s10, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s25, s10, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s26, s11, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s27, s11, 16
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s28, s11
; GCN-NOHSA-VI-NEXT:    s_sext_i32_i16 s29, s10
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s9, s9, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s8, s8, 0x80000
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s30, s30, 8
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s31, s31, 8
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s23, s23, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s22, s22, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s21, s21, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s20, s20, 0x80000
; GCN-NOHSA-VI-NEXT:    s_and_b32 s7, 0xffff, s7
; GCN-NOHSA-VI-NEXT:    s_and_b32 s6, 0xffff, s6
; GCN-NOHSA-VI-NEXT:    s_and_b32 s33, s33, 0xffff0000
; GCN-NOHSA-VI-NEXT:    s_and_b32 s34, s34, 0xffff0000
; GCN-NOHSA-VI-NEXT:    s_and_b32 s19, 0xffff, s19
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s18, s18, 16
; GCN-NOHSA-VI-NEXT:    s_or_b32 s4, s4, s17
; GCN-NOHSA-VI-NEXT:    s_or_b32 s14, s15, s14
; GCN-NOHSA-VI-NEXT:    s_or_b32 s12, s13, s12
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s11, s11, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s10, s10, 0x80000
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s28, s28, 8
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s29, s29, 8
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s27, s27, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s26, s26, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s25, s25, 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i32 s24, s24, 0x80000
; GCN-NOHSA-VI-NEXT:    s_and_b32 s9, 0xffff, s9
; GCN-NOHSA-VI-NEXT:    s_and_b32 s8, 0xffff, s8
; GCN-NOHSA-VI-NEXT:    s_and_b32 s30, s30, 0xffff0000
; GCN-NOHSA-VI-NEXT:    s_and_b32 s31, s31, 0xffff0000
; GCN-NOHSA-VI-NEXT:    s_and_b32 s23, 0xffff, s23
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s22, s22, 16
; GCN-NOHSA-VI-NEXT:    s_and_b32 s21, 0xffff, s21
; GCN-NOHSA-VI-NEXT:    s_lshl_b32 s20, s20, 16
; GCN-NOHSA-VI-NEXT:    s_or_b32 s7, s7, s33
; GCN-NOHSA-VI-NEXT:    s_or_b32 s6, s6, s34
; GCN-NOHSA-VI-NEXT:    s_or_b32 s18, s19, s18
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v0, s4
...
; GCN-NOHSA-VI-NEXT:    s_and_b32 s29, s29, 0xffff0000
...
; GCN-NOHSA-VI-NEXT:    s_or_b32 s9, s9, s30
; GCN-NOHSA-VI-NEXT:    s_or_b32 s8, s8, s31
; GCN-NOHSA-VI-NEXT:    s_or_b32 s22, s23, s22
; GCN-NOHSA-VI-NEXT:    s_or_b32 s20, s21, s20
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:48
; GCN-NOHSA-VI-NEXT:    s_or_b32 s11, s11, s28
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v0, s6
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v1, s16
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v2, s7
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v3, s18
; GCN-NOHSA-VI-NEXT:    s_or_b32 s10, s10, s29
; GCN-NOHSA-VI-NEXT:    s_or_b32 s26, s27, s26
; GCN-NOHSA-VI-NEXT:    s_or_b32 s24, s25, s24
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:32
...
; EG-NEXT:    ALU 1, @14, KC0[CB0:0-32], KC1[]
; EG-NEXT:    TEX 1 @10
; EG-NEXT:    ALU 87, @16, KC0[], KC1[]
; EG-NEXT:    ALU 88, @104, KC0[CB0:0-32], KC1[]
; EG-NEXT:    ALU 24, @193, KC0[CB0:0-32], KC1[]
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T36.XYZW, T42.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T37.XYZW, T41.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T38.XYZW, T40.X, 0
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T35.XYZW, T39.X, 1
...
; EG-NEXT:     AND_INT T1.Y, PV.W, literal.x,
; EG-NEXT:     AND_INT T0.Z, T0.Y, literal.y,
; EG-NEXT:     LSHR T0.W, T37.X, literal.z,
; EG-NEXT:     LSHR * T1.W, T37.X, literal.w,
; EG-NEXT:    65535(9.183409e-41), -65536(nan)
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:     ASHR T0.Y, T37.X, literal.x,
; EG-NEXT:     BFE_INT T1.Z, PS, 0.0, literal.y,
; EG-NEXT:     BFE_INT T0.W, PV.W, 0.0, literal.y,
; EG-NEXT:     OR_INT * T1.W, PV.Z, PV.Y,
; EG-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; EG-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; EG-NEXT:     AND_INT T0.W, PV.W, literal.y,
; EG-NEXT:     LSHR * T1.W, T37.Y, literal.z,
; EG-NEXT:    -65536(nan), 65535(9.183409e-41)
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T0.Y, PS, 0.0, literal.x,
; EG-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; EG-NEXT:     BFE_INT T0.W, T1.Y, 0.0, literal.x,
; EG-NEXT:     ASHR * T1.W, T37.Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     AND_INT T1.Y, PV.W, literal.x,
; EG-NEXT:     LSHL T1.Z, PS, literal.y,
; EG-NEXT:     AND_INT T0.W, PV.Z, literal.x,
...
; EG-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; EG-NEXT:     OR_INT T0.W, PV.W, PS,
; EG-NEXT:     OR_INT * T36.W, PV.Y, PV.Z,
; EG-NEXT:     MOV T12.X, PV.W,
; EG-NEXT:     MOV * T13.X, PS,
; EG-NEXT:     MOV T0.Y, T8.X,
...
; EG-NEXT:     AND_INT T0.Y, PV.Y, literal.x,
; EG-NEXT:     AND_INT T0.Z, PV.W, literal.y,
; EG-NEXT:     LSHR T0.W, T37.Z, literal.z,
; EG-NEXT:     LSHR * T1.W, T37.Z, literal.w,
; EG-NEXT:    -65536(nan), 65535(9.183409e-41)
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:     ASHR T1.Y, T37.Z, literal.x,
; EG-NEXT:     BFE_INT T1.Z, PS, 0.0, literal.y,
; EG-NEXT:     BFE_INT T0.W, PV.W, 0.0, literal.y,
; EG-NEXT:     OR_INT * T1.W, PV.Y, PV.Z,
; EG-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; EG-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; EG-NEXT:     AND_INT T0.W, PV.W, literal.y,
; EG-NEXT:     LSHR * T1.W, T37.W, literal.z,
; EG-NEXT:    -65536(nan), 65535(9.183409e-41)
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T0.Y, PS, 0.0, literal.x,
; EG-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; EG-NEXT:     BFE_INT T0.W, T1.Y, 0.0, literal.x,
; EG-NEXT:     ASHR * T1.W, T37.W, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     AND_INT T1.Y, PV.W, literal.x,
; EG-NEXT:     LSHL T1.Z, PS, literal.y,
; EG-NEXT:     AND_INT T0.W, PV.Z, literal.x,
...
; EG-NEXT:     OR_INT * T37.W, T1.Y, T1.Z,
...
; EG-NEXT:     AND_INT T0.Y, PV.Y, literal.x,
; EG-NEXT:     AND_INT T0.Z, PV.W, literal.y,
; EG-NEXT:     LSHR T0.W, T35.X, literal.z,
; EG-NEXT:     LSHR * T1.W, T35.X, literal.w,
; EG-NEXT:    -65536(nan), 65535(9.183409e-41)
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:     ASHR T1.Y, T35.X, literal.x,
; EG-NEXT:     BFE_INT T1.Z, PS, 0.0, literal.y,
; EG-NEXT:     BFE_INT T0.W, PV.W, 0.0, literal.y,
; EG-NEXT:     OR_INT * T1.W, PV.Y, PV.Z,
; EG-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; EG-NEXT:     LSHR * T1.Y, T35.Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; EG-NEXT:     AND_INT T0.W, PV.W, literal.y,
; EG-NEXT:     LSHR * T1.W, T35.Y, literal.z,
; EG-NEXT:    -65536(nan), 65535(9.183409e-41)
; EG-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T0.Y, PS, 0.0, literal.x,
; EG-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; EG-NEXT:     BFE_INT T0.W, T1.Y, 0.0, literal.x,
; EG-NEXT:     ASHR * T1.W, T35.Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; EG-NEXT:     AND_INT T1.Y, PV.W, literal.x,
; EG-NEXT:     LSHL T1.Z, PS, literal.y,
; EG-NEXT:     AND_INT T0.W, PV.Z, literal.x,
...
; EG-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; EG-NEXT:     OR_INT T0.W, PV.W, PS,
; EG-NEXT:     OR_INT * T38.W, PV.Y, PV.Z,
; EG-NEXT:     MOV T28.X, PV.W,
; EG-NEXT:     MOV * T29.X, PS,
; EG-NEXT:     MOV T0.Y, T24.X,
...
; EG-NEXT:     AND_INT T0.Y, PV.Y, literal.x,
; EG-NEXT:     AND_INT T0.Z, PV.W, literal.y,
; EG-NEXT:     LSHR T0.W, T35.Z, literal.z,
; EG-NEXT:     LSHR * T1.W, T35.Z, literal.w,
; EG-NEXT:    -65536(nan), 65535(9.183409e-41)
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:     ASHR T1.Y, T35.Z, literal.x,
; EG-NEXT:     BFE_INT T1.Z, PS, 0.0, literal.y,
; EG-NEXT:     BFE_INT T0.W, PV.W, 0.0, literal.y,
; EG-NEXT:     OR_INT * T1.W, PV.Y, PV.Z,
; EG-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; EG-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_INT T0.Z, T35.W, 0.0, literal.x,
; EG-NEXT:     BFE_INT T0.W, PV.W, 0.0, literal.x,
; EG-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.y,
; EG-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; EG-NEXT:     LSHR T39.X, PS, literal.x,
; EG-NEXT:     AND_INT T1.Y, PV.W, literal.y,
; EG-NEXT:     AND_INT T1.Z, T0.Y, literal.z,
; EG-NEXT:     AND_INT T0.W, PV.Z, literal.y,
; EG-NEXT:     LSHR * T1.W, T35.W, literal.w,
; EG-NEXT:    2(2.802597e-45), 65535(9.183409e-41)
; EG-NEXT:    -65536(nan), 8(1.121039e-44)
; EG-NEXT:     LSHR T40.X, KC0[2].Y, literal.x,
; EG-NEXT:     BFE_INT * T0.Y, PS, 0.0, literal.y,
; EG-NEXT:    2(2.802597e-45), 8(1.121039e-44)
; EG-NEXT:    ALU clause starting at 193:
; EG-NEXT:     OR_INT T0.Z, T1.Z, T0.W,
; EG-NEXT:     ASHR T0.W, T35.W, literal.x,
; EG-NEXT:     ADD_INT * T1.W, KC0[2].Y, literal.y,
; EG-NEXT:    24(3.363116e-44), 48(6.726233e-44)
; EG-NEXT:     LSHR T41.X, PS, literal.x,
; EG-NEXT:     LSHL T2.Y, PV.W, literal.y,
; EG-NEXT:     AND_INT T0.Z, PV.Z, literal.z,
...
; EG-NEXT:     OR_INT T0.W, PV.Z, PV.W,
; EG-NEXT:     OR_INT * T35.W, T1.Y, PV.Y,
; EG-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; EG-NEXT:     MOV T20.X, PV.W,
; EG-NEXT:     MOV * T21.X, PS,
; EG-NEXT:     MOV T36.X, T16.X,
...
; CM-NEXT:    ALU 1, @14, KC0[CB0:0-32], KC1[]
; CM-NEXT:    TEX 1 @10
; CM-NEXT:    ALU 87, @16, KC0[], KC1[]
; CM-NEXT:    ALU 89, @104, KC0[CB0:0-32], KC1[]
; CM-NEXT:    ALU 25, @194, KC0[CB0:0-32], KC1[]
...
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T35.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T0.Y, T0.Y, literal.y,
; CM-NEXT:     LSHR T0.Z, T37.X, literal.z,
; CM-NEXT:     LSHR * T0.W, T37.X, literal.w,
; CM-NEXT:    65535(9.183409e-41), -65536(nan)
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:     ASHR T37.X, T37.X, literal.x,
; CM-NEXT:     BFE_INT T1.Y, PV.W, 0.0, literal.y,
; CM-NEXT:     BFE_INT T0.Z, PV.Z, 0.0, literal.y,
; CM-NEXT:     OR_INT * T0.W, PV.Y, PV.X,
; CM-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; CM-NEXT:     MOV T17.X, T35.Y,
; CM-NEXT:     MOV T0.Y, T12.X,
; CM-NEXT:     BFE_INT * T0.W, T37.Y, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T35.X, T37.Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.Y, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.W, literal.z,
; CM-NEXT:     LSHR * T0.W, T37.Y, literal.w,
; CM-NEXT:    16(2.242078e-44), -65536(nan)
; CM-NEXT:    65535(9.183409e-41), 8(1.121039e-44)
; CM-NEXT:     BFE_INT T37.X, PV.W, 0.0, literal.x,
; CM-NEXT:     OR_INT T0.Y, PV.Y, PV.Z,
; CM-NEXT:     ASHR T0.Z, T37.Y, literal.y,
; CM-NEXT:     BFE_INT * T0.W, PV.X, 0.0, literal.x,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     AND_INT T35.X, PV.W, literal.x,
; CM-NEXT:     LSHL T1.Y, PV.Z, literal.y,
...
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     OR_INT * T35.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T12.X, PV.Z,
; CM-NEXT:     MOV T13.X, T35.W,
; CM-NEXT:     MOV T0.Y, T8.X,
; CM-NEXT:     BFE_INT * T0.W, T37.Z, 0.0, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T35.X, PV.Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.W, literal.y,
; CM-NEXT:     LSHR T0.Z, T37.Z, literal.z,
; CM-NEXT:     LSHR * T0.W, T37.Z, literal.w,
; CM-NEXT:    -65536(nan), 65535(9.183409e-41)
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:     ASHR T37.X, T37.Z, literal.x,
; CM-NEXT:     BFE_INT T1.Y, PV.W, 0.0, literal.y,
; CM-NEXT:     BFE_INT T0.Z, PV.Z, 0.0, literal.y,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T8.X, PV.W,
; CM-NEXT:     MOV T9.X, T37.Y,
; CM-NEXT:     MOV T0.Y, T4.X,
; CM-NEXT:     BFE_INT * T0.W, T37.W, 0.0, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T35.X, T37.W, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.Y, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.W, literal.z,
; CM-NEXT:     LSHR * T0.W, T37.W, literal.w,
; CM-NEXT:    16(2.242078e-44), -65536(nan)
; CM-NEXT:    65535(9.183409e-41), 8(1.121039e-44)
; CM-NEXT:     BFE_INT T37.X, PV.W, 0.0, literal.x,
; CM-NEXT:     OR_INT T0.Y, PV.Y, PV.Z,
; CM-NEXT:     ASHR T0.Z, T37.W, literal.y,
; CM-NEXT:     BFE_INT * T0.W, PV.X, 0.0, literal.x,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     AND_INT T35.X, PV.W, literal.x,
; CM-NEXT:     LSHL T1.Y, PV.Z, literal.y,
...
; CM-NEXT:     OR_INT * T37.W, T35.X, T1.Y,
; CM-NEXT:     MOV * T4.X, T0.Z,
; CM-NEXT:     MOV T5.X, T37.W,
; CM-NEXT:     MOV T0.Y, T32.X,
; CM-NEXT:     BFE_INT * T0.W, T36.X, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T35.X, PV.Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.W, literal.y,
; CM-NEXT:     LSHR T0.Z, T36.X, literal.z,
; CM-NEXT:     LSHR * T0.W, T36.X, literal.w,
; CM-NEXT:    -65536(nan), 65535(9.183409e-41)
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:     ASHR T36.X, T36.X, literal.x,
; CM-NEXT:     BFE_INT T1.Y, PV.W, 0.0, literal.y,
; CM-NEXT:     BFE_INT T0.Z, PV.Z, 0.0, literal.y,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; CM-NEXT:     MOV T33.X, T38.Y,
; CM-NEXT:     MOV T0.Y, T28.X,
; CM-NEXT:     BFE_INT * T0.W, T36.Y, 0.0, literal.x, BS:VEC_120/SCL_212
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T35.X, T36.Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.Y, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.W, literal.z,
; CM-NEXT:     LSHR * T0.W, T36.Y, literal.w,
; CM-NEXT:    16(2.242078e-44), -65536(nan)
; CM-NEXT:    65535(9.183409e-41), 8(1.121039e-44)
; CM-NEXT:     BFE_INT T36.X, PV.W, 0.0, literal.x,
; CM-NEXT:     OR_INT T0.Y, PV.Y, PV.Z,
; CM-NEXT:     ASHR T0.Z, T36.Y, literal.y,
; CM-NEXT:     BFE_INT * T0.W, PV.X, 0.0, literal.x,
; CM-NEXT:    8(1.121039e-44), 24(3.363116e-44)
; CM-NEXT:     AND_INT T35.X, PV.W, literal.x,
; CM-NEXT:     LSHL T1.Y, PV.Z, literal.y,
...
; CM-NEXT:    65535(9.183409e-41), 16(2.242078e-44)
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     OR_INT * T38.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T28.X, PV.Z,
; CM-NEXT:     MOV T29.X, T38.W,
; CM-NEXT:     MOV T0.Y, T24.X,
; CM-NEXT:     BFE_INT * T0.W, T36.Z, 0.0, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T35.X, PV.Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.W, literal.y,
; CM-NEXT:     LSHR T0.Z, T36.Z, literal.z,
; CM-NEXT:     LSHR * T0.W, T36.Z, literal.w,
; CM-NEXT:    -65536(nan), 65535(9.183409e-41)
; CM-NEXT:    8(1.121039e-44), 16(2.242078e-44)
; CM-NEXT:     ASHR T36.X, T36.Z, literal.x,
; CM-NEXT:     BFE_INT T1.Y, PV.W, 0.0, literal.y,
; CM-NEXT:     BFE_INT T0.Z, PV.Z, 0.0, literal.y,
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:    24(3.363116e-44), 8(1.121039e-44)
...
; CM-NEXT:     OR_INT * T0.W, PV.X, PV.Y,
; CM-NEXT:     MOV * T24.X, PV.W,
; CM-NEXT:     MOV T25.X, T36.Y,
; CM-NEXT:     MOV T0.Y, T20.X,
; CM-NEXT:     LSHR * T0.W, T36.W, literal.x,
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
; CM-NEXT:     BFE_INT T0.Z, T36.W, 0.0, literal.x,
; CM-NEXT:     BFE_INT * T0.W, PV.W, 0.0, literal.x,
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T35.X, PV.W, literal.x,
; CM-NEXT:     AND_INT T0.Y, T0.Y, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Z, literal.x,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.z,
; CM-NEXT:    65535(9.183409e-41), -65536(nan)
; CM-NEXT:    32(4.484155e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T39.X, PV.W, literal.x,
; CM-NEXT:     LSHR T1.Y, T36.W, literal.y,
; CM-NEXT:     ASHR T1.Z, T36.W, literal.z,
; CM-NEXT:     ADD_INT * T0.W, KC0[2].Y, literal.w,
; CM-NEXT:    2(2.802597e-45), 8(1.121039e-44)
; CM-NEXT:    24(3.363116e-44), 48(6.726233e-44)
; CM-NEXT:    ALU clause starting at 194:
; CM-NEXT:     LSHR T40.X, T0.W, literal.x,
; CM-NEXT:     LSHL T2.Y, T1.Z, literal.y,
; CM-NEXT:     BFE_INT T1.Z, T1.Y, 0.0, literal.z,
; CM-NEXT:     OR_INT * T0.W, T0.Y, T0.Z, BS:VEC_120/SCL_212
; CM-NEXT:    2(2.802597e-45), 16(2.242078e-44)
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     LSHR T41.X, KC0[2].Y, literal.x,
; CM-NEXT:     AND_INT T0.Y, PV.W, literal.y,
...
; CM-NEXT:     LSHR T42.X, PV.W, literal.x,
; CM-NEXT:     OR_INT T0.Z, PV.Y, PV.Z,
; CM-NEXT:     OR_INT * T36.W, T35.X, T2.Y,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; CM-NEXT:     MOV * T20.X, PV.Z,
