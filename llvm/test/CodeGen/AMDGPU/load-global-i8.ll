...
; GCN-HSA-NEXT:    v_readfirstlane_b32 s9, v0
; GCN-HSA-NEXT:    s_lshr_b32 s2, s6, 16
; GCN-HSA-NEXT:    s_lshr_b32 s8, s6, 24
; GCN-HSA-NEXT:    s_lshr_b32 s4, s6, 8
; GCN-HSA-NEXT:    s_lshr_b32 s10, s9, 16
; GCN-HSA-NEXT:    s_lshr_b32 s12, s9, 24
; GCN-HSA-NEXT:    s_lshr_b32 s14, s9, 8
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s17, s15
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s19, s15
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s13, s15
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[4:5], s[38:39], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[6:7], s[36:37], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[8:9], s[34:35], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
...
; GCN-HSA-NEXT:    s_lshr_b32 s14, s11, 24
; GCN-HSA-NEXT:    s_lshr_b32 s2, s11, 8
; GCN-HSA-NEXT:    s_mov_b32 s16, s11
; GCN-HSA-NEXT:    s_lshr_b32 s18, s10, 16
; GCN-HSA-NEXT:    s_lshr_b32 s20, s10, 24
; GCN-HSA-NEXT:    s_lshr_b32 s22, s10, 8
; GCN-HSA-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x80000
...
; GCN-HSA-NEXT:    s_lshr_b32 s24, s13, 24
...
; GCN-HSA-NEXT:    s_lshr_b32 s14, s12, 24
; GCN-HSA-NEXT:    s_lshr_b32 s12, s12, 8
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s21, s25
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s15, s25
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s17, s25
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(1)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s37, v3
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s36, v2
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s41, v1
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s40, v0
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s27, v7
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s26, v6
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s23, v5
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s22, v4
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s24, s37, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s37, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s20, s37, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s10, s37
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s30, s36, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s34, s36, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s28, s36, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s6, s41, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s4, s41, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s8, s41, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s12, s41
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s18, s40, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[38:39], s[10:11], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[42:43], s[36:37], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v10, s38
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v11, s39
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s36, s40, 24
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v4, s42
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v5, s43
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s38, s40, 8
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s42, s27, 24
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s16, s27
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[40:41], s[14:15], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v6, s24
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v7, s25
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s24, s26, 16
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v8, s40
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v9, s41
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s40, s26, 24
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[44:45], s[16:17], 0x80000
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s44, s26, 8
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x80000
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s23, 16
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v12, s20
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v13, s21
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s46, s23, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s16, s23, 8
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s30, s23
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v12, s20
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v13, s21
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s34, s22, 16
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v6, s26
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v7, s27
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s20, s22, 8
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[26:27], s[22:23], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x80000
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:80
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v14, s44
...
; GCN-HSA-NEXT:    s_lshr_b32 s4, s13, 16
; GCN-HSA-NEXT:    s_lshr_b32 s10, s13, 24
; GCN-HSA-NEXT:    s_lshr_b32 s8, s13, 8
; GCN-HSA-NEXT:    s_mov_b32 s16, s13
; GCN-HSA-NEXT:    s_lshr_b32 s2, s15, 16
; GCN-HSA-NEXT:    s_lshr_b32 s6, s15, 8
; GCN-HSA-NEXT:    s_mov_b32 s20, s15
; GCN-HSA-NEXT:    s_lshr_b32 s24, s14, 16
; GCN-HSA-NEXT:    s_lshr_b32 s26, s14, 24
; GCN-HSA-NEXT:    s_lshr_b32 s28, s14, 8
; GCN-HSA-NEXT:    s_bfe_i64 s[22:23], s[14:15], 0x80000
; GCN-HSA-NEXT:    s_lshr_b32 s14, s12, 16
; GCN-HSA-NEXT:    s_lshr_b32 s30, s12, 24
; GCN-HSA-NEXT:    s_lshr_b32 s34, s12, 8
; GCN-HSA-NEXT:    s_bfe_i64 s[50:51], s[12:13], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[10:11], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[40:41], s[16:17], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x80000
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s43, v3
; GCN-HSA-NEXT:    v_readfirstlane_b32 s42, v2
; GCN-HSA-NEXT:    v_readfirstlane_b32 s53, v1
; GCN-HSA-NEXT:    v_readfirstlane_b32 s52, v0
; GCN-HSA-NEXT:    s_lshr_b32 s18, s15, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[36:37], s[26:27], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[38:39], s[24:25], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[46:47], s[20:21], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[44:45], s[6:7], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[54:55], s[2:3], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[56:57], s[34:35], 0x80000
...
; GCN-HSA-NEXT:    s_lshr_b32 s16, s53, 16
; GCN-HSA-NEXT:    s_lshr_b32 s10, s53, 8
; GCN-HSA-NEXT:    s_lshr_b32 s14, s53, 24
...
; GCN-HSA-NEXT:    s_lshr_b32 s52, s43, 24
; GCN-HSA-NEXT:    s_mov_b32 s40, s43
; GCN-HSA-NEXT:    s_lshr_b32 s26, s42, 16
; GCN-HSA-NEXT:    s_lshr_b32 s24, s42, 24
; GCN-HSA-NEXT:    s_lshr_b32 s20, s42, 8
; GCN-HSA-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[48:49], s[18:19], 0x80000
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s5
; GCN-HSA-NEXT:    v_mov_b32_e32 v7, s13
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s41
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s9
; GCN-HSA-NEXT:    s_bfe_i64 s[18:19], s[42:43], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
...
; GCN-HSA-NEXT:    s_bfe_i64 s[42:43], s[52:53], 0x80000
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v9, s61
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s1
; GCN-HSA-NEXT:    s_add_u32 s22, s0, 0xd0
...
; GCN-HSA-NEXT:    s_add_u32 s18, s0, 0xc0
...
; CM-NEXT:     AND_INT T1.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.y,
; CM-NEXT:     BFE_UINT * T0.W, T37.X, literal.z, PV.X,
; CM-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; CM-NEXT:    8(1.121039e-44), 0(0.000000e+00)
; CM-NEXT:     AND_INT T37.X, PV.W, literal.x,
...
; CM-NEXT:     MOV * T0.Y, T4.X,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     AND_INT * T0.W, T37.W, literal.y,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
; CM-NEXT:     LSHL T0.Y, T37.W, literal.x,
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
...
; CM-NEXT:    255(3.573311e-43), 0(0.000000e+00)
; CM-NEXT:     OR_INT T0.Z, PV.Z, PV.W,
; CM-NEXT:     OR_INT * T37.W, PV.Y, PV.X,
; CM-NEXT:     MOV * T4.X, PV.Z,
; CM-NEXT:     MOV T5.X, T37.W,
; CM-NEXT:     MOV * T0.Y, T32.X,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.x,
; CM-NEXT:     AND_INT * T0.W, T36.X, literal.y,
; CM-NEXT:    -65536(nan), 255(3.573311e-43)
...
; CM-NEXT:     AND_INT T1.Y, PV.Z, literal.y,
; CM-NEXT:     AND_INT T0.Z, PV.Y, literal.y,
; CM-NEXT:     BFE_UINT * T0.W, T36.X, literal.z, T35.X,
; CM-NEXT:    255(3.573311e-43), 16711680(2.341805e-38)
; CM-NEXT:    16(2.242078e-44), 0(0.000000e+00)
...
; CM-NEXT:     OR_INT * T36.W, T1.Y, T0.Z,
; CM-NEXT:    2(2.802597e-45), 0(0.000000e+00)
