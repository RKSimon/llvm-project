...
; GFX9-NEXT:    v_min3_u16 v0, v1, v4, v0
; GFX9-NEXT:    v_lshrrev_b32_e32 v6, 16, v2
; GFX9-NEXT:    v_min3_u16 v0, v2, v5, v0
; GFX9-NEXT:    v_min3_u16 v0, v3, v6, v0
; GFX9-NEXT:    v_min_u16_sdwa v0, v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_min3_i16 v0, v1, v8, v0
; GFX9-NEXT:    v_lshrrev_b32_e32 v10, 16, v2
; GFX9-NEXT:    v_min3_i16 v0, v2, v9, v0
; GFX9-NEXT:    v_lshrrev_b32_e32 v11, 16, v3
; GFX9-NEXT:    v_min3_i16 v0, v3, v10, v0
; GFX9-NEXT:    v_lshrrev_b32_e32 v12, 16, v4
; GFX9-NEXT:    v_min3_i16 v0, v4, v11, v0
; GFX9-NEXT:    v_lshrrev_b32_e32 v13, 16, v5
; GFX9-NEXT:    v_min3_i16 v0, v5, v12, v0
; GFX9-NEXT:    v_lshrrev_b32_e32 v14, 16, v6
; GFX9-NEXT:    v_min3_i16 v0, v6, v13, v0
; GFX9-NEXT:    v_min3_i16 v0, v7, v14, v0
; GFX9-NEXT:    v_min_i16_sdwa v0, v7, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
