...
; SI-NEXT:    s_mov_b64 s[0:1], 0
; SI-NEXT:    s_branch .LBB10_12
; SI-NEXT:  .LBB10_11:
; SI-NEXT:    s_mov_b64 s[0:1], -1
; SI-NEXT:    ; implicit-def: $vgpr7
; SI-NEXT:  .LBB10_12: ; %Flow131
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cselect_b32 s0, 1, 0
; SI-NEXT:    s_cmp_lg_u32 s0, 1
; SI-NEXT:    s_cbranch_scc1 .LBB10_18
; SI-NEXT:  ; %bb.13: ; %frem.compute52
...
; SI-NEXT:  ; %bb.14: ; %frem.loop_body60.preheader
; SI-NEXT:    s_sub_i32 s1, s4, s5
; SI-NEXT:    s_add_i32 s1, s1, 11
; SI-NEXT:  .LBB10_15: ; %frem.loop_body60
; SI-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; SI-NEXT:  ; %bb.16: ; %Flow129
; SI-NEXT:    v_mov_b32_e32 v8, v10
; SI-NEXT:  .LBB10_17: ; %frem.loop_exit61
; SI-NEXT:    s_add_i32 s1, s1, -10
...
; SI-NEXT:  .LBB10_21: ; %Flow127
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cselect_b32 s0, 1, 0
; SI-NEXT:    s_cmp_lg_u32 s0, 1
; SI-NEXT:    s_cbranch_scc1 .LBB10_27
; SI-NEXT:  ; %bb.22: ; %frem.compute19
; SI-NEXT:    s_mov_b32 s5, 0x7f800000
; SI-NEXT:    v_cmp_lt_f32_e64 vcc, |v9|, s5
...
; SI-NEXT:  ; %bb.23: ; %frem.loop_body27.preheader
; SI-NEXT:    s_sub_i32 s1, s4, s5
; SI-NEXT:    s_add_i32 s1, s1, 11
; SI-NEXT:  .LBB10_24: ; %frem.loop_body27
; SI-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; SI-NEXT:  ; %bb.25: ; %Flow125
; SI-NEXT:    v_mov_b32_e32 v9, v11
; SI-NEXT:  .LBB10_26: ; %frem.loop_exit28
; SI-NEXT:    s_add_i32 s1, s1, -10
...
; SI-NEXT:    s_cbranch_vccz .LBB10_30
...
; SI-NEXT:    s_mov_b64 s[0:1], -1
; SI-NEXT:    ; implicit-def: $sgpr4
; SI-NEXT:  .LBB10_31: ; %Flow123
; SI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; SI-NEXT:    s_cselect_b32 s0, 1, 0
; SI-NEXT:    s_cmp_lg_u32 s0, 1
; SI-NEXT:    s_cbranch_scc1 .LBB10_37
; SI-NEXT:  ; %bb.32: ; %frem.compute
; SI-NEXT:    s_mov_b32 s5, 0x7f800000
...
; SI-NEXT:    s_branch .LBB10_38
; SI-NEXT:  .LBB10_37:
; SI-NEXT:    v_mov_b32_e32 v9, s4
; SI-NEXT:  .LBB10_38: ; %Flow124
; SI-NEXT:    v_cvt_f32_f16_e32 v0, v0
...
; CI-NEXT:    s_mov_b64 s[0:1], 0
; CI-NEXT:    s_branch .LBB10_12
; CI-NEXT:  .LBB10_11:
; CI-NEXT:    s_mov_b64 s[0:1], -1
; CI-NEXT:    ; implicit-def: $vgpr7
; CI-NEXT:  .LBB10_12: ; %Flow131
; CI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; CI-NEXT:    s_cselect_b32 s0, 1, 0
; CI-NEXT:    s_cmp_lg_u32 s0, 1
; CI-NEXT:    s_cbranch_scc1 .LBB10_18
; CI-NEXT:  ; %bb.13: ; %frem.compute52
...
; CI-NEXT:  ; %bb.14: ; %frem.loop_body60.preheader
; CI-NEXT:    v_sub_i32_e32 v9, vcc, v12, v13
; CI-NEXT:    v_add_i32_e32 v9, vcc, 11, v9
; CI-NEXT:  .LBB10_15: ; %frem.loop_body60
; CI-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; CI-NEXT:  ; %bb.16: ; %Flow129
; CI-NEXT:    v_mov_b32_e32 v10, v12
; CI-NEXT:  .LBB10_17: ; %frem.loop_exit61
...
; CI-NEXT:  .LBB10_21: ; %Flow127
; CI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; CI-NEXT:    s_cselect_b32 s0, 1, 0
; CI-NEXT:    s_cmp_lg_u32 s0, 1
; CI-NEXT:    s_cbranch_scc1 .LBB10_27
; CI-NEXT:  ; %bb.22: ; %frem.compute19
...
; CI-NEXT:  ; %bb.23: ; %frem.loop_body27.preheader
; CI-NEXT:    v_sub_i32_e32 v10, vcc, v13, v14
; CI-NEXT:    v_add_i32_e32 v10, vcc, 11, v10
; CI-NEXT:  .LBB10_24: ; %frem.loop_body27
; CI-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; CI-NEXT:  ; %bb.25: ; %Flow125
; CI-NEXT:    v_mov_b32_e32 v11, v13
; CI-NEXT:  .LBB10_26: ; %frem.loop_exit28
...
; CI-NEXT:    s_cbranch_vccz .LBB10_30
...
; CI-NEXT:    s_mov_b64 s[0:1], -1
; CI-NEXT:    ; implicit-def: $sgpr4
; CI-NEXT:  .LBB10_31: ; %Flow123
; CI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; CI-NEXT:    s_cselect_b32 s0, 1, 0
; CI-NEXT:    s_cmp_lg_u32 s0, 1
; CI-NEXT:    s_cbranch_scc1 .LBB10_37
; CI-NEXT:  ; %bb.32: ; %frem.compute
...
; CI-NEXT:    s_branch .LBB10_38
; CI-NEXT:  .LBB10_37:
; CI-NEXT:    v_mov_b32_e32 v9, s4
; CI-NEXT:  .LBB10_38: ; %Flow124
; CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
