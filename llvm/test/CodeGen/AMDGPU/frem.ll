...
; SI-NEXT:    v_cmp_ne_u32_e64 s[0:1], s0, v0
...
; CI-NEXT:    v_cmp_ne_u32_e64 s[0:1], s0, v0
...
; SI-NEXT:    v_cmp_ne_u32_e64 s[0:1], s2, v2
; SI-NEXT:    s_and_b64 vcc, s[0:1], vcc
...
; SI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; SI-NEXT:    v_and_b32_e32 v0, 0x7fff, v0
; SI-NEXT:    v_cmp_ne_u32_e64 s[0:1], s2, v0
; SI-NEXT:    s_and_b64 vcc, s[0:1], vcc
...
; CI-NEXT:    v_cmp_ne_u32_e64 s[0:1], s2, v2
...
; CI-NEXT:    v_cmp_ne_u32_e64 s[0:1], s2, v0
; CI-NEXT:    s_and_b64 vcc, s[0:1], vcc
; CI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
...
; SI-NEXT:    s_movk_i32 s2, 0x7c00
; SI-NEXT:    v_cmp_ne_u32_e64 s[0:1], s2, v6
; SI-NEXT:    s_and_b64 vcc, s[0:1], vcc
...
; SI-NEXT:    v_cmp_ne_u32_e64 s[0:1], s2, v4
; SI-NEXT:    s_and_b64 vcc, s[0:1], vcc
...
; CI-NEXT:    v_cmp_ne_u32_e64 s[0:1], s2, v6
...
; CI-NEXT:    v_cmp_ne_u32_e64 s[0:1], s2, v4
; CI-NEXT:    s_and_b64 vcc, s[0:1], vcc
; CI-NEXT:    v_cvt_f32_f16_e32 v5, v5
; CI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; CI-NEXT:    v_cvt_f32_f16_e32 v1, v1
