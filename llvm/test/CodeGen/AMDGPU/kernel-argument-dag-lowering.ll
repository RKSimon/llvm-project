...
; GCN-NEXT:    s_and_b32 s2, s0, 0xff0000
; GCN-NEXT:    s_and_b32 s4, s0, 0xff
; GCN-NEXT:    v_mov_b32_e32 v1, s0
; GCN-NEXT:    s_lshl_b32 s0, s3, 24
; GCN-NEXT:    s_or_b32 s0, s0, s2
; GCN-NEXT:    v_perm_b32 v0, s4, v1, v0
...
; GCN-NEXT:    s_lshl_b32 s0, s3, 24
; GCN-NEXT:    s_or_b32 s0, s0, s2
; GCN-NEXT:    v_perm_b32 v1, s4, v1, v0
...
; GCN-NEXT:    v_mov_b32_e32 v0, 0
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_and_b32 s4, s3, 0x7fff
