...
; GFX1251-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1251-SDAG-NEXT:    s_clause 0x1
; GFX1251-SDAG-NEXT:    global_load_b128 v[0:3], v16, s[0:1] offset:16
; GFX1251-SDAG-NEXT:    global_load_b128 v[4:7], v16, s[0:1]
...
; GFX1251-SDAG-NEXT:    global_store_b128 v16, v[4:7], s[0:1]
; GFX1251-SDAG-NEXT:    s_endpgm
;
...
; GFX1251-SDAG-NEXT:    s_load_b512 s[68:83], s[4:5], 0x124 nv
...
; GFX1251-SDAG-NEXT:    global_load_b128 v[40:43], v44, s[0:1]
; GFX1251-SDAG-NEXT:    global_load_b128 v[36:39], v44, s[0:1] offset:16
; GFX1251-SDAG-NEXT:    global_load_b128 v[32:35], v44, s[0:1] offset:32
; GFX1251-SDAG-NEXT:    global_load_b128 v[28:31], v44, s[0:1] offset:48
; GFX1251-SDAG-NEXT:    global_load_b128 v[24:27], v44, s[0:1] offset:64
; GFX1251-SDAG-NEXT:    global_load_b128 v[20:23], v44, s[0:1] offset:80
; GFX1251-SDAG-NEXT:    global_load_b128 v[16:19], v44, s[0:1] offset:96
; GFX1251-SDAG-NEXT:    global_load_b128 v[12:15], v44, s[0:1] offset:112
; GFX1251-SDAG-NEXT:    global_load_b128 v[8:11], v44, s[0:1] offset:128
; GFX1251-SDAG-NEXT:    global_load_b128 v[4:7], v44, s[0:1] offset:144
; GFX1251-SDAG-NEXT:    global_load_b128 v[0:3], v44, s[0:1] offset:192
; GFX1251-SDAG-NEXT:    global_load_b128 v[46:49], v44, s[0:1] offset:208
; GFX1251-SDAG-NEXT:    global_load_b128 v[50:53], v44, s[0:1] offset:224
; GFX1251-SDAG-NEXT:    global_load_b128 v[54:57], v44, s[0:1] offset:240
; GFX1251-SDAG-NEXT:    global_load_b128 v[58:61], v44, s[0:1] offset:176
; GFX1251-SDAG-NEXT:    global_load_b128 v[62:65], v44, s[0:1] offset:160
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v66, s68 :: v_dual_mov_b32 v67, s69
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v68, s70 :: v_dual_mov_b32 v69, s71
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s72 :: v_dual_mov_b32 v71, s73
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v72, s74 :: v_dual_mov_b32 v73, s75
...
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s80 :: v_dual_mov_b32 v71, s81
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v72, s82 :: v_dual_mov_b32 v73, s83
...
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v66, s60 :: v_dual_mov_b32 v67, s61
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v68, s62 :: v_dual_mov_b32 v69, s63
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xa
; GFX1251-SDAG-NEXT:    v_pk_add_f64 v[20:23], v[20:23], v[70:73]
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s64 :: v_dual_mov_b32 v71, s65
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v72, s66 :: v_dual_mov_b32 v73, s67
...
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v70, s40 :: v_dual_mov_b32 v71, s41
; GFX1251-SDAG-NEXT:    v_dual_mov_b32 v72, s42 :: v_dual_mov_b32 v73, s43
...
; GFX1251-SDAG-NEXT:    s_clause 0xf
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[54:57], s[0:1] offset:240
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[50:53], s[0:1] offset:224
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[46:49], s[0:1] offset:208
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[0:3], s[0:1] offset:192
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[58:61], s[0:1] offset:176
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[62:65], s[0:1] offset:160
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[4:7], s[0:1] offset:144
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[8:11], s[0:1] offset:128
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[12:15], s[0:1] offset:112
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[16:19], s[0:1] offset:96
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[20:23], s[0:1] offset:80
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[24:27], s[0:1] offset:64
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[28:31], s[0:1] offset:48
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[32:35], s[0:1] offset:32
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[36:39], s[0:1] offset:16
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[40:43], s[0:1]
...
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x1
; GFX1251-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[0:3], v[0:3], v[8:11], v[8:11]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[4:7], v[4:7], v[12:15], v[12:15]
; GFX1251-SDAG-NEXT:    s_clause 0x1
; GFX1251-SDAG-NEXT:    global_store_b128 v16, v[0:3], s[0:1] offset:16
; GFX1251-SDAG-NEXT:    global_store_b128 v16, v[4:7], s[0:1]
; GFX1251-SDAG-NEXT:    s_endpgm
...
; GFX1251-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1251-SDAG-NEXT:    s_clause 0x2
; GFX1251-SDAG-NEXT:    s_load_b512 s[16:31], s[4:5], 0x124 nv
; GFX1251-SDAG-NEXT:    s_load_b512 s[52:67], s[4:5], 0x164 nv
; GFX1251-SDAG-NEXT:    s_load_b512 s[36:51], s[4:5], 0x1e4 nv
; GFX1251-SDAG-NEXT:    v_lshlrev_b32_e32 v44, 8, v0
; GFX1251-SDAG-NEXT:    s_wait_kmcnt 0x0
...
; GFX1251-SDAG-NEXT:    global_load_b128 v[12:15], v44, s[0:1] offset:112
; GFX1251-SDAG-NEXT:    global_load_b128 v[8:11], v44, s[0:1] offset:128
; GFX1251-SDAG-NEXT:    global_load_b128 v[0:3], v44, s[0:1] offset:144
; GFX1251-SDAG-NEXT:    global_load_b128 v[4:7], v44, s[0:1] offset:192
; GFX1251-SDAG-NEXT:    global_load_b128 v[46:49], v44, s[0:1] offset:208
; GFX1251-SDAG-NEXT:    global_load_b128 v[50:53], v44, s[0:1] offset:224
; GFX1251-SDAG-NEXT:    global_load_b128 v[54:57], v44, s[0:1] offset:240
; GFX1251-SDAG-NEXT:    global_load_b128 v[58:61], v44, s[0:1] offset:176
...
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[68:69], s[62:63]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[66:67], s[60:61]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xa
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[20:23], v[20:23], v[70:73], v[70:73]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[72:73], s[66:67]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[70:71], s[64:65]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x9
...
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[68:69], s[38:39]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[66:67], s[36:37]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x6
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[0:3], v[0:3], v[70:73], v[70:73]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[72:73], s[42:43]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[70:71], s[40:41]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x5
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[4:7], v[4:7], v[66:69], v[66:69]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[68:69], s[46:47]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[66:67], s[44:45]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x4
; GFX1251-SDAG-NEXT:    v_pk_fma_f64 v[46:49], v[46:49], v[70:73], v[70:73]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[72:73], s[50:51]
; GFX1251-SDAG-NEXT:    v_mov_b64_e32 v[70:71], s[48:49]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x3
...
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[50:53], s[0:1] offset:224
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[46:49], s[0:1] offset:208
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[4:7], s[0:1] offset:192
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[58:61], s[0:1] offset:176
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[62:65], s[0:1] offset:160
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[0:3], s[0:1] offset:144
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[8:11], s[0:1] offset:128
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[12:15], s[0:1] offset:112
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[16:19], s[0:1] offset:96
; GFX1251-SDAG-NEXT:    global_store_b128 v44, v[20:23], s[0:1] offset:80
...
; GFX1251-SDAG-NEXT:    global_load_b128 v[0:3], v56, s[0:1] offset:240
; GFX1251-SDAG-NEXT:    global_load_b128 v[4:7], v56, s[0:1] offset:224
; GFX1251-SDAG-NEXT:    global_load_b128 v[8:11], v56, s[0:1] offset:112
; GFX1251-SDAG-NEXT:    global_load_b128 v[12:15], v56, s[0:1] offset:96
; GFX1251-SDAG-NEXT:    global_load_b128 v[16:19], v56, s[0:1] offset:16
; GFX1251-SDAG-NEXT:    global_load_b128 v[20:23], v56, s[0:1]
; GFX1251-SDAG-NEXT:    global_load_b128 v[24:27], v56, s[0:1] offset:48
; GFX1251-SDAG-NEXT:    global_load_b128 v[28:31], v56, s[0:1] offset:32
; GFX1251-SDAG-NEXT:    global_load_b128 v[32:35], v56, s[0:1] offset:80
; GFX1251-SDAG-NEXT:    global_load_b128 v[36:39], v56, s[0:1] offset:64
; GFX1251-SDAG-NEXT:    global_load_b128 v[40:43], v56, s[0:1] offset:208
; GFX1251-SDAG-NEXT:    global_load_b128 v[44:47], v56, s[0:1] offset:192
; GFX1251-SDAG-NEXT:    global_load_b128 v[48:51], v56, s[0:1] offset:176
; GFX1251-SDAG-NEXT:    global_load_b128 v[52:55], v56, s[0:1] offset:160
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xd
; GFX1251-SDAG-NEXT:    v_pk_add_f64 v[0:3], v[0:3], 0 neg_lo:[1,1] neg_hi:[1,1]
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0xc
...
; GFX1251-SDAG-NEXT:    s_clause 0x3
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[0:3], s[0:1] offset:240
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[4:7], s[0:1] offset:224
; GFX1251-SDAG-NEXT:    global_load_b128 v[0:3], v56, s[0:1] offset:144
; GFX1251-SDAG-NEXT:    global_load_b128 v[4:7], v56, s[0:1] offset:128
; GFX1251-SDAG-NEXT:    s_wait_loadcnt 0x5
...
; GFX1251-SDAG-NEXT:    v_pk_add_f64 v[4:7], v[4:7], 0 neg_lo:[1,1] neg_hi:[1,1]
; GFX1251-SDAG-NEXT:    s_clause 0xd
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[40:43], s[0:1] offset:208
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[44:47], s[0:1] offset:192
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[48:51], s[0:1] offset:176
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[52:55], s[0:1] offset:160
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[0:3], s[0:1] offset:144
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[4:7], s[0:1] offset:128
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[8:11], s[0:1] offset:112
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[12:15], s[0:1] offset:96
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[32:35], s[0:1] offset:80
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[36:39], s[0:1] offset:64
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[24:27], s[0:1] offset:48
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[28:31], s[0:1] offset:32
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[16:19], s[0:1] offset:16
; GFX1251-SDAG-NEXT:    global_store_b128 v56, v[20:23], s[0:1]
; GFX1251-SDAG-NEXT:    s_endpgm
;
