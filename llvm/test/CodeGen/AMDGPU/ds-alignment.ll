...
; ALIGNED-SDAG-NEXT:    ds_read_u8 v1, v0 offset:1
; ALIGNED-SDAG-NEXT:    ds_read_u8 v0, v0
; ALIGNED-SDAG-NEXT:    v_mov_b32_e32 v2, s1
; ALIGNED-SDAG-NEXT:    s_waitcnt lgkmcnt(1)
; ALIGNED-SDAG-NEXT:    ds_write_b8 v2, v1 offset:1
; ALIGNED-SDAG-NEXT:    s_waitcnt lgkmcnt(1)
; ALIGNED-SDAG-NEXT:    ds_write_b8 v2, v0
...
; ALIGNED-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; ALIGNED-SDAG-NEXT:    v_mov_b32_e32 v0, s0
; ALIGNED-SDAG-NEXT:    ds_read_u8 v1, v0 offset:3
; ALIGNED-SDAG-NEXT:    ds_read_u8 v2, v0 offset:2
; ALIGNED-SDAG-NEXT:    ds_read_u8 v3, v0 offset:1
; ALIGNED-SDAG-NEXT:    ds_read_u8 v0, v0
; ALIGNED-SDAG-NEXT:    v_mov_b32_e32 v4, s1
; ALIGNED-SDAG-NEXT:    s_waitcnt lgkmcnt(3)
; ALIGNED-SDAG-NEXT:    ds_write_b8 v4, v1 offset:3
; ALIGNED-SDAG-NEXT:    s_waitcnt lgkmcnt(3)
; ALIGNED-SDAG-NEXT:    ds_write_b8 v4, v2 offset:2
; ALIGNED-SDAG-NEXT:    s_waitcnt lgkmcnt(3)
; ALIGNED-SDAG-NEXT:    ds_write_b8 v4, v3 offset:1
; ALIGNED-SDAG-NEXT:    s_waitcnt lgkmcnt(3)
; ALIGNED-SDAG-NEXT:    ds_write_b8 v4, v0
; ALIGNED-SDAG-NEXT:    s_endpgm
;
...
; ALIGNED-SDAG-NEXT:    ds_read_u16 v0, v0
; ALIGNED-SDAG-NEXT:    v_mov_b32_e32 v2, s1
; ALIGNED-SDAG-NEXT:    s_waitcnt lgkmcnt(1)
; ALIGNED-SDAG-NEXT:    ds_write_b16 v2, v1 offset:2
; ALIGNED-SDAG-NEXT:    s_waitcnt lgkmcnt(1)
; ALIGNED-SDAG-NEXT:    ds_write_b16 v2, v0
; ALIGNED-SDAG-NEXT:    s_endpgm
;
...
; ALIGNED-SDAG-NEXT:    ds_read_b64 v[0:1], v0
...
; ALIGNED-SDAG-NEXT:    s_waitcnt lgkmcnt(12)
