...
; SDAG-NEXT:    v_mul_lo_u32 v15, v11, v6
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v11, v[2:3]
; SDAG-NEXT:    ; implicit-def: $vgpr11
; SDAG-NEXT:    v_add3_u32 v5, v5, v15, v14
; SDAG-NEXT:    v_mov_b32_e32 v2, v6
; SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v13, v8, v[2:3]
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v9, v13, v[4:5]
; SDAG-NEXT:    v_add_co_u32_e64 v2, s[4:5], v7, v2
; SDAG-NEXT:    v_addc_co_u32_e64 v3, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_mul_lo_u32 v6, v9, v12
...
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v13, v8, v[6:7]
...
; SDAG-NEXT:    v_mul_lo_u32 v10, v11, v13
; SDAG-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v12, v8, v[3:4]
; SDAG-NEXT:    ; implicit-def: $vgpr8
; SDAG-NEXT:    v_add3_u32 v5, v10, v2, v9
...
; SDAG-NEXT:    v_mov_b32_e32 v6, v4
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v13, v9, v[6:7]
; SDAG-NEXT:    v_add3_u32 v3, v3, v15, v14
...
; SDAG-NEXT:    v_mul_lo_u32 v10, v11, v13
; SDAG-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v12, v9, v[3:4]
