...
; SDAG-NEXT:    v_ashrrev_i32_e32 v9, 31, v5
; SDAG-NEXT:    v_and_b32_e32 v0, 0xfffff, v5
; SDAG-NEXT:    v_cmp_lt_u64_e32 vcc, s[4:5], v[6:7]
; SDAG-NEXT:    v_ashrrev_i32_e32 v8, 31, v9
; SDAG-NEXT:    v_or_b32_e32 v10, 1, v9
...
; SDAG-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v10, v5, 0
; SDAG-NEXT:    ; implicit-def: $vgpr10
; SDAG-NEXT:    v_mov_b32_e32 v1, v3
; SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v11, v8, v[1:2]
; SDAG-NEXT:    v_add3_u32 v6, v6, v7, v12
; SDAG-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v9, v11, v[5:6]
; SDAG-NEXT:    v_mul_lo_u32 v7, v9, v13
; SDAG-NEXT:    v_add_co_u32_e32 v2, vcc, v4, v2
; SDAG-NEXT:    v_addc_co_u32_e64 v3, s[4:5], 0, 0, vcc
; SDAG-NEXT:    v_mul_lo_u32 v9, v8, v11
...
; SDAG-NEXT:    v_mov_b32_e32 v2, 0
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], v4, v10, 0
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[8:9], v5, v10, v[1:2]
...
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v9, v4, v[2:3]
; SDAG-NEXT:    v_mad_u64_u32 v[3:4], s[8:9], v8, v4, v[3:4]
...
; SDAG-NEXT:    v_mul_lo_u32 v5, v5, v13
; SDAG-NEXT:    v_add_co_u32_e32 v2, vcc, v4, v2
; SDAG-NEXT:    v_addc_co_u32_e64 v3, s[4:5], 0, 0, vcc
; SDAG-NEXT:    v_mul_lo_u32 v9, v6, v10
...
; SDAG-NEXT:    v_mul_lo_u32 v7, v6, v10
; SDAG-NEXT:    v_add_co_u32_e32 v2, vcc, v4, v2
; SDAG-NEXT:    v_addc_co_u32_e64 v3, s[4:5], 0, 0, vcc
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v13, v6, v[2:3]
