...
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v11, v[4:5]
; SDAG-NEXT:    v_mul_lo_u32 v15, v11, v3
...
; SDAG-NEXT:    v_mul_lo_u32 v9, v10, v13
...
; SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, v2, s[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v14, 0, v0, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v13, 0, v1, s[4:5]
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v14, v11, 0
; SDAG-NEXT:    v_mul_lo_u32 v4, v9, v2
; SDAG-NEXT:    v_mul_lo_u32 v15, v11, v3
; SDAG-NEXT:    v_mov_b32_e32 v5, v1
; SDAG-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v13, v11, v[5:6]
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v11, v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v5, v7
; SDAG-NEXT:    v_mul_lo_u32 v7, v12, v14
; SDAG-NEXT:    v_add3_u32 v3, v3, v15, v4
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v14, v9, v[5:6]
; SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v10, v14, v[2:3]
; SDAG-NEXT:    v_add_co_u32_e64 v5, s[4:5], v8, v5
; SDAG-NEXT:    v_addc_co_u32_e64 v6, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_mul_lo_u32 v3, v10, v13
; SDAG-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v13, v9, v[5:6]
; SDAG-NEXT:    ; implicit-def: $vgpr11
; SDAG-NEXT:    ; implicit-def: $vgpr9
; SDAG-NEXT:    ; implicit-def: $vgpr10
...
; SDAG-NEXT:    v_mov_b32_e32 v5, v1
; SDAG-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v13, v9, v[5:6]
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v9, v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v5, v7
; SDAG-NEXT:    v_mul_lo_u32 v7, v12, v14
; SDAG-NEXT:    v_add3_u32 v3, v3, v15, v4
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v14, v10, v[5:6]
; SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v11, v14, v[2:3]
; SDAG-NEXT:    v_add_co_u32_e64 v5, s[4:5], v8, v5
; SDAG-NEXT:    v_addc_co_u32_e64 v6, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_mul_lo_u32 v3, v11, v13
; SDAG-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v13, v10, v[5:6]
; SDAG-NEXT:    ; implicit-def: $vgpr9
; SDAG-NEXT:    v_add3_u32 v3, v7, v2, v3
; SDAG-NEXT:    v_add_co_u32_e64 v2, s[4:5], v5, v1
; SDAG-NEXT:    v_addc_co_u32_e64 v3, s[4:5], v6, v3, s[4:5]
