...
; SDAG-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v14, v11, v[1:2]
...
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v14, v8, v[2:3]
...
; SDAG-NEXT:    v_addc_co_u32_e64 v12, s[4:5], 0, -1, s[4:5]
...
; SDAG-NEXT:    v_cndmask_b32_e64 v14, 0, v1, s[4:5]
; SDAG-NEXT:    v_mul_lo_u32 v8, v9, v2
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v14, v11, v[5:6]
; SDAG-NEXT:    v_mul_lo_u32 v13, v11, v3
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[6:7], v11, v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v5, v0
; SDAG-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v7, v9, v[5:6]
; SDAG-NEXT:    v_add3_u32 v3, v3, v13, v8
...
; SDAG-NEXT:    v_mul_lo_u32 v8, v10, v14
; SDAG-NEXT:    v_mul_lo_u32 v7, v12, v7
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v14, v9, v[0:1]
; SDAG-NEXT:    ; implicit-def: $vgpr11
; SDAG-NEXT:    ; implicit-def: $vgpr9
; SDAG-NEXT:    ; implicit-def: $vgpr10
...
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v14, v9, v[5:6]
; SDAG-NEXT:    v_mul_lo_u32 v13, v9, v3
...
; SDAG-NEXT:    v_add_co_u32_e64 v0, s[4:5], v1, v6
; SDAG-NEXT:    v_addc_co_u32_e64 v1, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_mul_lo_u32 v8, v11, v14
; SDAG-NEXT:    v_mul_lo_u32 v7, v12, v7
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v14, v10, v[0:1]
; SDAG-NEXT:    ; implicit-def: $vgpr9
; SDAG-NEXT:    v_add3_u32 v3, v7, v3, v8
; SDAG-NEXT:    v_add_co_u32_e64 v2, s[4:5], v0, v2
; SDAG-NEXT:    v_addc_co_u32_e64 v3, s[4:5], v1, v3, s[4:5]
