...
; GFX10-NEXT:    s_bfe_u32 s1, s4, 0x80010
; GFX10-NEXT:    s_and_b32 s2, s4, 0xff
; GFX10-NEXT:    s_and_b32 s4, s8, 0xff00
...
; GFX10-NEXT:    s_and_b32 s4, s5, 0xff0000
; GFX10-NEXT:    s_or_b32 s2, s2, s3
; GFX10-NEXT:    s_or_b32 s3, s9, s4
...
; GFX9-NEXT:    s_bfe_u32 s1, s4, 0x80010
; GFX9-NEXT:    s_and_b32 s2, s4, 0xff
; GFX9-NEXT:    s_and_b32 s4, s8, 0xff00
...
; GFX10-NEXT:    v_lshlrev_b16 v1, 8, v4
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_and_b32_sdwa v2, v9, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX10-NEXT:    v_lshrrev_b16 v0, 8, v9
; GFX10-NEXT:    v_and_b32_e32 v3, 0xff, v9
; GFX10-NEXT:    v_and_b32_e32 v4, 0xff, v4
; GFX10-NEXT:    v_or_b32_sdwa v10, v2, v1 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX10-NEXT:    v_perm_b32 v0, v0, v3, 0x5040100
; GFX10-NEXT:    v_perm_b32 v1, v4, v2, 0x5040100
; GFX10-NEXT:    v_and_or_b32 v2, 0xffff, v9, v10
; GFX10-NEXT:    global_store_dwordx2 v[7:8], v[0:1], off
; GFX10-NEXT:    global_store_dword v[5:6], v2, off
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_and_b32_e32 v3, 0xff, v4
; GFX9-NEXT:    v_and_b32_e32 v9, 0xff, v9
; GFX9-NEXT:    v_or_b32_sdwa v10, v2, v1 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-NEXT:    v_perm_b32 v0, v0, v3, s6
; GFX9-NEXT:    v_perm_b32 v1, v9, v2, s6
