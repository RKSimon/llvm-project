...
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-ISEL-NEXT:    v_min_u32_e32 v3, 0xff, v1
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v1, v4
; GFX7-ISEL-NEXT:    v_min_u32_e32 v2, 0xff, v2
; GFX7-ISEL-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GFX7-ISEL-NEXT:    v_lshlrev_b32_e32 v4, 24, v3
; GFX7-ISEL-NEXT:    v_min_u32_e32 v1, 0xff, v1
; GFX7-ISEL-NEXT:    v_min_u32_e32 v0, 0xff, v0
; GFX7-ISEL-NEXT:    v_lshlrev_b32_e32 v1, 8, v1
; GFX7-ISEL-NEXT:    v_or_b32_e32 v2, v4, v2
...
; GFX7-ISEL-NEXT:    v_lshlrev_b32_e32 v4, 24, v3
; GFX7-ISEL-NEXT:    v_or_b32_e32 v4, v4, v0
; GFX7-ISEL-NEXT:    v_min_u32_e32 v0, 0xff, v1
; GFX7-ISEL-NEXT:    v_min_u32_e32 v1, 0xff, v2
; GFX7-ISEL-NEXT:    v_lshlrev_b32_e32 v1, 8, v1
; GFX7-ISEL-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX7-ISEL-NEXT:    v_or_b32_e32 v0, v0, v4
; GFX7-ISEL-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
; GFX7-ISEL-NEXT:    v_lshrrev_b32_e32 v2, 16, v4
; GFX7-ISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-FAKE16-NEXT:    v_min_u32_e32 v0, 0xff, v0
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v3, v1, v3
...
; GFX11-TRUE16-NEXT:    v_min_u32_e32 v0, 0xff, v0
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v3, v1, v3
...
; GFX12-FAKE16-NEXT:    v_min_u32_e32 v0, 0xff, v0
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v3, v1, v3
...
; GFX12-TRUE16-NEXT:    v_min_u32_e32 v0, 0xff, v0
; GFX12-TRUE16-NEXT:    v_or_b32_e32 v3, v1, v3
...
; GFX11-FAKE16-NEXT:    v_cvt_u16_f16_e32 v4, v2
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; GFX11-FAKE16-NEXT:    v_cvt_u16_f16_e32 v5, v3
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v3, 16, v3
; GFX11-FAKE16-NEXT:    v_cvt_u16_f16_e32 v6, v0
...
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v2, 8, v2
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v3, 8, v3
; GFX11-FAKE16-NEXT:    v_min_u16 v9, 0xff, v6
...
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, v9, v0
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v2, v1, v7
...
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v7, 24, v3
...
; GFX12-FAKE16-NEXT:    v_cvt_u16_f16_e32 v4, v2
; GFX12-FAKE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; GFX12-FAKE16-NEXT:    v_cvt_u16_f16_e32 v5, v3
; GFX12-FAKE16-NEXT:    v_lshrrev_b32_e32 v3, 16, v3
; GFX12-FAKE16-NEXT:    v_cvt_u16_f16_e32 v6, v0
...
; GFX12-FAKE16-NEXT:    v_lshlrev_b16 v2, 8, v2
; GFX12-FAKE16-NEXT:    v_lshlrev_b16 v3, 8, v3
; GFX12-FAKE16-NEXT:    v_min_u16 v9, 0xff, v6
...
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v0, v9, v0
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v2, v1, v7
...
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v10, v1, v3
; GFX12-FAKE16-NEXT:    v_lshrrev_b32_e32 v7, 24, v3
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v9, v4, v5
; GFX12-FAKE16-NEXT:    v_lshrrev_b32_e32 v5, 8, v10
; GFX12-FAKE16-NEXT:    v_lshrrev_b64 v[3:4], 24, v[9:10]
...
; GFX9-NEXT:    v_cvt_u16_f16_e32 v1, s5
; GFX9-NEXT:    v_or_b32_e32 v10, v8, v0
; GFX9-NEXT:    v_cvt_u16_f16_e32 v0, s16
; GFX9-NEXT:    v_min_u32_sdwa v1, v1, s4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX9-NEXT:    s_lshr_b32 s5, s17, 16
; GFX9-NEXT:    v_min_u32_sdwa v0, v0, s4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
; GFX9-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX9-NEXT:    v_cvt_u16_f16_e32 v1, s17
; GFX9-NEXT:    v_min_u32_sdwa v2, v2, s4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX9-NEXT:    v_min_u32_sdwa v1, v1, s4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
; GFX11-FAKE16-NEXT:    v_cvt_u16_f16_e32 v1, s4
; GFX11-FAKE16-NEXT:    v_min_u32_e32 v5, 0xff, v2
; GFX11-FAKE16-NEXT:    v_cvt_u16_f16_e32 v2, s2
; GFX11-FAKE16-NEXT:    v_cvt_u16_f16_e32 v6, s1
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v4, 0xffff, v4
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v3, 0xffff, v3
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX11-FAKE16-NEXT:    v_cvt_u16_f16_e32 v7, s0
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v2, 0xffff, v2
...
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v9, 8, v2
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v2, v6, v4
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v6, v5, v3
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v8, v0, v1
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, v7, v9
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v1, 16, v2
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v3, 16, v6
; GFX11-FAKE16-NEXT:    v_bfe_u32 v7, v6, 8, 8
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v4, v0, v1
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v5, v8, v3
...
; GFX11-TRUE16-NEXT:    v_min_u32_e32 v6, 0xff, v6
...
; GFX11-TRUE16-NEXT:    v_min_u32_e32 v7, 0xff, v7
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v9, 8, v2
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v2, v6, v4
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v6, v5, v3
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v8, v0, v1
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v0, v7, v9
...
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v4, v0, v1
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v5, v8, v3
...
; GFX12-FAKE16-NEXT:    v_cvt_u16_f16_e32 v1, s4
; GFX12-FAKE16-NEXT:    v_min_u32_e32 v5, 0xff, v2
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    v_cvt_u16_f16_e32 v2, s2
...
; GFX12-FAKE16-NEXT:    v_and_b32_e32 v3, 0xffff, v3
; GFX12-FAKE16-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX12-FAKE16-NEXT:    v_cvt_u16_f16_e32 v7, s0
; GFX12-FAKE16-NEXT:    v_and_b32_e32 v2, 0xffff, v2
...
; GFX12-FAKE16-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX12-FAKE16-NEXT:    v_min_u32_e32 v1, 0xff, v1
; GFX12-FAKE16-NEXT:    v_and_b32_e32 v7, 0xffff, v7
...
; GFX12-FAKE16-NEXT:    v_lshlrev_b32_e32 v9, 8, v2
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v2, v6, v4
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v6, v5, v3
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v8, v0, v1
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v0, v7, v9
; GFX12-FAKE16-NEXT:    v_lshlrev_b32_e32 v1, 16, v2
; GFX12-FAKE16-NEXT:    v_lshlrev_b32_e32 v3, 16, v6
; GFX12-FAKE16-NEXT:    v_bfe_u32 v7, v6, 8, 8
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v4, v0, v1
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v5, v8, v3
...
; GFX12-TRUE16-NEXT:    s_lshr_b32 s2, s0, 16
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.l, s4
; GFX12-TRUE16-NEXT:    v_min_u32_e32 v5, 0xff, v2
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v3, 0xffff, v3
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v7.l, s0
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v2, 0xffff, v2
...
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX12-TRUE16-NEXT:    v_min_u32_e32 v1, 0xff, v1
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v7, 0xffff, v7
; GFX12-TRUE16-NEXT:    v_min_u32_e32 v2, 0xff, v2
; GFX12-TRUE16-NEXT:    v_min_u32_e32 v6, 0xff, v6
...
; GFX12-TRUE16-NEXT:    v_min_u32_e32 v7, 0xff, v7
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v9, 8, v2
; GFX12-TRUE16-NEXT:    v_or_b32_e32 v2, v6, v4
; GFX12-TRUE16-NEXT:    v_or_b32_e32 v6, v5, v3
; GFX12-TRUE16-NEXT:    v_or_b32_e32 v8, v0, v1
; GFX12-TRUE16-NEXT:    v_or_b32_e32 v0, v7, v9
...
; GFX12-TRUE16-NEXT:    v_or_b32_e32 v4, v0, v1
; GFX12-TRUE16-NEXT:    v_or_b32_e32 v5, v8, v3
...
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v2, s17
; GFX7-ISEL-NEXT:    v_min_u32_e32 v3, 0xff, v1
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v1, s16
; GFX7-ISEL-NEXT:    v_min_u32_e32 v0, 0xff, v0
; GFX7-ISEL-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GFX7-ISEL-NEXT:    v_lshlrev_b32_e32 v4, 24, v3
; GFX7-ISEL-NEXT:    v_or_b32_e32 v4, v4, v0
...
; GFX12-ISEL-NEXT:    s_bfe_u32 s3, s2, 0x80008
; GFX12-ISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
