...
; GFX6-NEXT:    v_max_i32_e32 v2, v1, v2
...
; GFX7-NEXT:    v_max_i32_e32 v2, v1, v2
...
; GFX6-NEXT:    v_sub_i32_e32 v4, vcc, 0, v5
; GFX6-NEXT:    v_max_i32_e32 v5, v4, v5
; GFX6-NEXT:    v_lshlrev_b32_e32 v4, 16, v5
; GFX6-NEXT:    v_or_b32_e32 v4, v1, v4
; GFX6-NEXT:    v_alignbit_b32 v1, v2, v0, 16
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    v_sub_i32_e32 v4, vcc, 0, v5
; GFX7-NEXT:    v_max_i32_e32 v5, v4, v5
...
; GFX6-NEXT:    v_sub_i32_e32 v5, vcc, 0, v0
; GFX6-NEXT:    v_max_i32_e32 v0, v5, v0
; GFX6-NEXT:    v_sub_i32_e32 v5, vcc, 0, v1
...
; GFX7-NEXT:    v_max_i32_e32 v2, v5, v2
; GFX7-NEXT:    v_sub_i32_e32 v5, vcc, 0, v3
; GFX7-NEXT:    v_max_i32_e32 v3, v5, v3
; GFX7-NEXT:    v_bfe_i32 v0, v0, 0, 16
; GFX7-NEXT:    v_lshlrev_b32_e32 v5, 16, v3
; GFX7-NEXT:    v_bfe_i32 v1, v1, 0, 16
; GFX7-NEXT:    v_or_b32_e32 v2, v2, v5
; GFX7-NEXT:    v_sub_i32_e32 v5, vcc, 0, v0
; GFX7-NEXT:    v_max_i32_e32 v0, v5, v0
; GFX7-NEXT:    v_sub_i32_e32 v5, vcc, 0, v1
; GFX7-NEXT:    v_max_i32_e32 v1, v5, v1
; GFX7-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GFX7-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX7-NEXT:    v_alignbit_b32 v1, v2, v0, 16
...
; GFX6-NEXT:    v_max_i32_e32 v10, v13, v10
; GFX6-NEXT:    v_sub_i32_e32 v13, vcc, 0, v11
; GFX6-NEXT:    v_max_i32_e32 v11, v13, v11
; GFX6-NEXT:    v_bfe_i32 v8, v8, 0, 16
; GFX6-NEXT:    v_lshlrev_b32_e32 v13, 16, v11
; GFX6-NEXT:    v_bfe_i32 v9, v9, 0, 16
; GFX6-NEXT:    v_or_b32_e32 v10, v10, v13
; GFX6-NEXT:    v_sub_i32_e32 v13, vcc, 0, v8
; GFX6-NEXT:    v_max_i32_e32 v8, v13, v8
; GFX6-NEXT:    v_sub_i32_e32 v13, vcc, 0, v9
; GFX6-NEXT:    v_max_i32_e32 v9, v13, v9
; GFX6-NEXT:    v_bfe_i32 v6, v6, 0, 16
...
; GFX6-NEXT:    v_bfe_i32 v4, v4, 0, 16
; GFX6-NEXT:    v_lshlrev_b32_e32 v9, 16, v7
; GFX6-NEXT:    v_bfe_i32 v5, v5, 0, 16
; GFX6-NEXT:    v_or_b32_e32 v6, v6, v9
; GFX6-NEXT:    v_sub_i32_e32 v9, vcc, 0, v4
; GFX6-NEXT:    v_max_i32_e32 v4, v9, v4
; GFX6-NEXT:    v_sub_i32_e32 v9, vcc, 0, v5
; GFX6-NEXT:    v_max_i32_e32 v5, v9, v5
; GFX6-NEXT:    v_bfe_i32 v2, v2, 0, 16
; GFX6-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
; GFX6-NEXT:    v_bfe_i32 v3, v3, 0, 16
; GFX6-NEXT:    v_or_b32_e32 v4, v4, v5
...
; GFX7-NEXT:    v_max_i32_e32 v10, v13, v10
; GFX7-NEXT:    v_sub_i32_e32 v13, vcc, 0, v11
; GFX7-NEXT:    v_max_i32_e32 v11, v13, v11
; GFX7-NEXT:    v_bfe_i32 v8, v8, 0, 16
; GFX7-NEXT:    v_lshlrev_b32_e32 v13, 16, v11
; GFX7-NEXT:    v_bfe_i32 v9, v9, 0, 16
; GFX7-NEXT:    v_or_b32_e32 v10, v10, v13
; GFX7-NEXT:    v_sub_i32_e32 v13, vcc, 0, v8
; GFX7-NEXT:    v_max_i32_e32 v8, v13, v8
; GFX7-NEXT:    v_sub_i32_e32 v13, vcc, 0, v9
; GFX7-NEXT:    v_max_i32_e32 v9, v13, v9
; GFX7-NEXT:    v_bfe_i32 v6, v6, 0, 16
; GFX7-NEXT:    v_lshlrev_b32_e32 v9, 16, v9
; GFX7-NEXT:    v_bfe_i32 v7, v7, 0, 16
; GFX7-NEXT:    v_or_b32_e32 v8, v8, v9
; GFX7-NEXT:    v_sub_i32_e32 v9, vcc, 0, v6
; GFX7-NEXT:    v_max_i32_e32 v6, v9, v6
; GFX7-NEXT:    v_sub_i32_e32 v9, vcc, 0, v7
; GFX7-NEXT:    v_max_i32_e32 v7, v9, v7
; GFX7-NEXT:    v_bfe_i32 v4, v4, 0, 16
; GFX7-NEXT:    v_lshlrev_b32_e32 v9, 16, v7
; GFX7-NEXT:    v_bfe_i32 v5, v5, 0, 16
; GFX7-NEXT:    v_or_b32_e32 v6, v6, v9
; GFX7-NEXT:    v_sub_i32_e32 v9, vcc, 0, v4
; GFX7-NEXT:    v_max_i32_e32 v4, v9, v4
; GFX7-NEXT:    v_sub_i32_e32 v9, vcc, 0, v5
; GFX7-NEXT:    v_max_i32_e32 v5, v9, v5
; GFX7-NEXT:    v_bfe_i32 v2, v2, 0, 16
; GFX7-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
; GFX7-NEXT:    v_bfe_i32 v3, v3, 0, 16
; GFX7-NEXT:    v_or_b32_e32 v4, v4, v5
...
; GFX6-NEXT:    v_max_i32_e32 v26, v31, v26
; GFX6-NEXT:    v_sub_i32_e32 v31, vcc, 0, v27
; GFX6-NEXT:    v_bfe_i32 v24, v24, 0, 16
; GFX6-NEXT:    v_max_i32_e32 v27, v31, v27
...
; GFX6-NEXT:    v_lshlrev_b32_e32 v29, 16, v27
; GFX6-NEXT:    v_or_b32_e32 v26, v26, v29
; GFX6-NEXT:    v_sub_i32_e32 v29, vcc, 0, v20
; GFX6-NEXT:    v_max_i32_e32 v20, v29, v20
...
; GFX6-NEXT:    v_bfe_i32 v25, v31, 0, 16
; GFX6-NEXT:    v_sub_i32_e32 v31, vcc, 0, v25
; GFX6-NEXT:    v_max_i32_e32 v31, v31, v25
; GFX6-NEXT:    v_lshlrev_b32_e32 v25, 16, v31
; GFX6-NEXT:    v_or_b32_e32 v30, v30, v25
; GFX6-NEXT:    v_sub_i32_e32 v25, vcc, 0, v21
; GFX6-NEXT:    v_max_i32_e32 v21, v25, v21
; GFX6-NEXT:    v_lshlrev_b32_e32 v21, 16, v21
; GFX6-NEXT:    v_or_b32_e32 v20, v20, v21
; GFX6-NEXT:    v_sub_i32_e32 v21, vcc, 0, v18
; GFX6-NEXT:    v_max_i32_e32 v18, v21, v18
; GFX6-NEXT:    v_sub_i32_e32 v21, vcc, 0, v19
; GFX6-NEXT:    v_max_i32_e32 v19, v21, v19
; GFX6-NEXT:    v_lshlrev_b32_e32 v21, 16, v19
; GFX6-NEXT:    v_or_b32_e32 v18, v18, v21
; GFX6-NEXT:    v_sub_i32_e32 v21, vcc, 0, v16
; GFX6-NEXT:    v_max_i32_e32 v16, v21, v16
; GFX6-NEXT:    v_sub_i32_e32 v21, vcc, 0, v17
; GFX6-NEXT:    v_max_i32_e32 v17, v21, v17
; GFX6-NEXT:    v_lshlrev_b32_e32 v17, 16, v17
; GFX6-NEXT:    v_or_b32_e32 v16, v16, v17
; GFX6-NEXT:    v_sub_i32_e32 v17, vcc, 0, v14
; GFX6-NEXT:    v_max_i32_e32 v14, v17, v14
; GFX6-NEXT:    v_sub_i32_e32 v17, vcc, 0, v15
; GFX6-NEXT:    v_max_i32_e32 v15, v17, v15
; GFX6-NEXT:    v_lshlrev_b32_e32 v17, 16, v15
; GFX6-NEXT:    v_or_b32_e32 v14, v14, v17
; GFX6-NEXT:    v_sub_i32_e32 v17, vcc, 0, v12
; GFX6-NEXT:    v_max_i32_e32 v12, v17, v12
; GFX6-NEXT:    v_sub_i32_e32 v17, vcc, 0, v13
; GFX6-NEXT:    v_max_i32_e32 v13, v17, v13
; GFX6-NEXT:    v_lshlrev_b32_e32 v13, 16, v13
; GFX6-NEXT:    v_or_b32_e32 v12, v12, v13
; GFX6-NEXT:    v_sub_i32_e32 v13, vcc, 0, v10
; GFX6-NEXT:    v_max_i32_e32 v10, v13, v10
...
; GFX7-NEXT:    v_max_i32_e32 v26, v31, v26
; GFX7-NEXT:    v_sub_i32_e32 v31, vcc, 0, v27
; GFX7-NEXT:    v_bfe_i32 v24, v24, 0, 16
; GFX7-NEXT:    v_max_i32_e32 v27, v31, v27
...
; GFX7-NEXT:    v_lshlrev_b32_e32 v29, 16, v27
; GFX7-NEXT:    v_or_b32_e32 v26, v26, v29
; GFX7-NEXT:    v_sub_i32_e32 v29, vcc, 0, v20
; GFX7-NEXT:    v_max_i32_e32 v20, v29, v20
...
; GFX7-NEXT:    v_bfe_i32 v25, v31, 0, 16
; GFX7-NEXT:    v_sub_i32_e32 v31, vcc, 0, v25
; GFX7-NEXT:    v_max_i32_e32 v31, v31, v25
; GFX7-NEXT:    v_lshlrev_b32_e32 v25, 16, v31
; GFX7-NEXT:    v_or_b32_e32 v30, v30, v25
; GFX7-NEXT:    v_sub_i32_e32 v25, vcc, 0, v21
; GFX7-NEXT:    v_max_i32_e32 v21, v25, v21
; GFX7-NEXT:    v_lshlrev_b32_e32 v21, 16, v21
; GFX7-NEXT:    v_or_b32_e32 v20, v20, v21
; GFX7-NEXT:    v_sub_i32_e32 v21, vcc, 0, v18
; GFX7-NEXT:    v_max_i32_e32 v18, v21, v18
; GFX7-NEXT:    v_sub_i32_e32 v21, vcc, 0, v19
; GFX7-NEXT:    v_max_i32_e32 v19, v21, v19
; GFX7-NEXT:    v_lshlrev_b32_e32 v21, 16, v19
; GFX7-NEXT:    v_or_b32_e32 v18, v18, v21
; GFX7-NEXT:    v_sub_i32_e32 v21, vcc, 0, v16
; GFX7-NEXT:    v_max_i32_e32 v16, v21, v16
; GFX7-NEXT:    v_sub_i32_e32 v21, vcc, 0, v17
; GFX7-NEXT:    v_max_i32_e32 v17, v21, v17
; GFX7-NEXT:    v_lshlrev_b32_e32 v17, 16, v17
; GFX7-NEXT:    v_or_b32_e32 v16, v16, v17
; GFX7-NEXT:    v_sub_i32_e32 v17, vcc, 0, v14
; GFX7-NEXT:    v_max_i32_e32 v14, v17, v14
; GFX7-NEXT:    v_sub_i32_e32 v17, vcc, 0, v15
; GFX7-NEXT:    v_max_i32_e32 v15, v17, v15
; GFX7-NEXT:    v_lshlrev_b32_e32 v17, 16, v15
; GFX7-NEXT:    v_or_b32_e32 v14, v14, v17
; GFX7-NEXT:    v_sub_i32_e32 v17, vcc, 0, v12
; GFX7-NEXT:    v_max_i32_e32 v12, v17, v12
; GFX7-NEXT:    v_sub_i32_e32 v17, vcc, 0, v13
; GFX7-NEXT:    v_max_i32_e32 v13, v17, v13
; GFX7-NEXT:    v_lshlrev_b32_e32 v13, 16, v13
; GFX7-NEXT:    v_or_b32_e32 v12, v12, v13
; GFX7-NEXT:    v_sub_i32_e32 v13, vcc, 0, v10
; GFX7-NEXT:    v_max_i32_e32 v10, v13, v10
