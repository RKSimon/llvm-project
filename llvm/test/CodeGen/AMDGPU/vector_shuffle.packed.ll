...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    global_load_dwordx4 v[6:9], v[2:3], off offset:16
; GFX9-NEXT:    global_load_dwordx4 v[10:13], v[2:3], off
; GFX9-NEXT:    global_load_dwordx4 v[14:17], v[0:1], off offset:16
; GFX9-NEXT:    global_load_dwordx4 v[18:21], v[0:1], off
; GFX9-NEXT:    s_waitcnt vmcnt(3)
; GFX9-NEXT:    global_store_dwordx4 v[4:5], v[6:9], off offset:48
; GFX9-NEXT:    s_waitcnt vmcnt(3)
; GFX9-NEXT:    global_store_dwordx4 v[4:5], v[10:13], off offset:32
; GFX9-NEXT:    s_waitcnt vmcnt(3)
; GFX9-NEXT:    global_store_dwordx4 v[4:5], v[14:17], off offset:16
; GFX9-NEXT:    s_waitcnt vmcnt(3)
; GFX9-NEXT:    global_store_dwordx4 v[4:5], v[18:21], off
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    global_load_dwordx4 v[6:9], v[2:3], off offset:16
; GFX10-NEXT:    global_load_dwordx4 v[10:13], v[2:3], off
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    global_load_dwordx4 v[14:17], v[0:1], off offset:16
; GFX10-NEXT:    global_load_dwordx4 v[18:21], v[0:1], off
; GFX10-NEXT:    s_waitcnt vmcnt(3)
; GFX10-NEXT:    global_store_dwordx4 v[4:5], v[6:9], off offset:48
; GFX10-NEXT:    s_waitcnt vmcnt(2)
; GFX10-NEXT:    global_store_dwordx4 v[4:5], v[10:13], off offset:32
; GFX10-NEXT:    s_waitcnt vmcnt(1)
; GFX10-NEXT:    global_store_dwordx4 v[4:5], v[14:17], off offset:16
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    global_store_dwordx4 v[4:5], v[18:21], off
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b128 v[6:9], v[2:3], off offset:16
; GFX11-NEXT:    global_load_b128 v[10:13], v[2:3], off
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b128 v[14:17], v[0:1], off offset:16
; GFX11-NEXT:    global_load_b128 v[0:3], v[0:1], off
; GFX11-NEXT:    s_waitcnt vmcnt(3)
; GFX11-NEXT:    global_store_b128 v[4:5], v[6:9], off offset:48
; GFX11-NEXT:    s_waitcnt vmcnt(2)
; GFX11-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:32
; GFX11-NEXT:    s_waitcnt vmcnt(1)
; GFX11-NEXT:    global_store_b128 v[4:5], v[14:17], off offset:16
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b128 v[4:5], v[0:3], off
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GX900-NEXT:    global_load_dwordx2 v[3:4], v0, s[6:7]
; GX900-NEXT:    global_load_dwordx2 v[5:6], v0, s[4:5]
; GX900-NEXT:    s_waitcnt vmcnt(2)
; GX900-NEXT:    v_and_b32_e32 v7, 0xffff0000, v1
; GX900-NEXT:    s_waitcnt vmcnt(1)
; GX900-NEXT:    v_and_b32_e32 v8, 0xffff0000, v3
; GX900-NEXT:    s_waitcnt vmcnt(0)
; GX900-NEXT:    v_lshlrev_b32_e32 v9, 16, v5
; GX900-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GX900-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; GX900-NEXT:    v_and_b32_e32 v11, 0xffff0000, v2
; GX900-NEXT:    v_lshlrev_b32_e32 v12, 16, v6
; GX900-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GX900-NEXT:    v_fma_f32 v7, v9, v8, v7
; GX900-NEXT:    v_fma_f32 v1, v9, v3, v1
; GX900-NEXT:    v_fma_f32 v2, v12, v3, v2
; GX900-NEXT:    v_bfe_u32 v3, v7, 16, 1
; GX900-NEXT:    v_fma_f32 v8, v12, v8, v11
; GX900-NEXT:    v_or_b32_e32 v9, 0x400000, v7
; GX900-NEXT:    v_bfe_u32 v11, v1, 16, 1
; GX900-NEXT:    v_add3_u32 v3, v3, v7, s2
...
; GX900-NEXT:    v_cndmask_b32_e32 v3, v3, v9, vcc
...
; GX900-NEXT:    v_lshlrev_b32_e32 v10, 16, v4
...
; GX900-NEXT:    v_fma_f32 v1, v5, v10, v1
...
; GX900-NEXT:    v_fma_f32 v3, v5, v4, v3
; GX900-NEXT:    v_bfe_u32 v5, v1, 16, 1
; GX900-NEXT:    v_fma_f32 v2, v6, v10, v2
; GX900-NEXT:    v_fma_f32 v4, v6, v4, v7
...
; GFX942-NEXT:    global_load_dwordx2 v[6:7], v2, s[0:1]
; GFX942-NEXT:    s_waitcnt vmcnt(2)
; GFX942-NEXT:    v_and_b32_e32 v3, 0xffff0000, v4
; GFX942-NEXT:    s_waitcnt vmcnt(1)
; GFX942-NEXT:    v_lshlrev_b32_e32 v8, 16, v0
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_and_b32_e32 v9, 0xffff0000, v6
; GFX942-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
; GFX942-NEXT:    v_lshlrev_b32_e32 v6, 16, v6
; GFX942-NEXT:    v_lshlrev_b32_e32 v11, 16, v1
; GFX942-NEXT:    v_and_b32_e32 v12, 0xffff0000, v7
; GFX942-NEXT:    v_fmac_f32_e32 v9, v8, v3
; GFX942-NEXT:    v_lshlrev_b32_e32 v7, 16, v7
; GFX942-NEXT:    v_fmac_f32_e32 v6, v8, v4
; GFX942-NEXT:    v_fmac_f32_e32 v12, v11, v3
; GFX942-NEXT:    v_bfe_u32 v3, v9, 16, 1
; GFX942-NEXT:    v_fmac_f32_e32 v7, v11, v4
; GFX942-NEXT:    v_or_b32_e32 v4, 0x400000, v9
; GFX942-NEXT:    v_bfe_u32 v8, v6, 16, 1
; GFX942-NEXT:    v_add3_u32 v3, v3, v9, s2
; GFX942-NEXT:    v_cmp_u_f32_e32 vcc, v9, v9
; GFX942-NEXT:    v_or_b32_e32 v11, 0x400000, v6
; GFX942-NEXT:    v_bfe_u32 v13, v12, 16, 1
; GFX942-NEXT:    v_add3_u32 v8, v8, v6, s2
; GFX942-NEXT:    v_cndmask_b32_e32 v3, v3, v4, vcc
; GFX942-NEXT:    v_cmp_u_f32_e32 vcc, v6, v6
; GFX942-NEXT:    v_or_b32_e32 v14, 0x400000, v12
; GFX942-NEXT:    v_bfe_u32 v15, v7, 16, 1
; GFX942-NEXT:    v_add3_u32 v13, v13, v12, s2
; GFX942-NEXT:    v_cndmask_b32_e32 v4, v8, v11, vcc
; GFX942-NEXT:    v_cmp_u_f32_e32 vcc, v12, v12
; GFX942-NEXT:    v_lshlrev_b32_e32 v10, 16, v5
; GFX942-NEXT:    v_and_b32_e32 v0, 0xffff0000, v0
; GFX942-NEXT:    v_or_b32_e32 v16, 0x400000, v7
; GFX942-NEXT:    v_add3_u32 v15, v15, v7, s2
; GFX942-NEXT:    v_cndmask_b32_e32 v6, v13, v14, vcc
...
; GFX942-NEXT:    v_cndmask_b32_e32 v7, v15, v16, vcc
; GFX942-NEXT:    v_and_b32_e32 v3, 0xffff0000, v3
; GFX942-NEXT:    v_fmac_f32_e32 v4, v0, v10
; GFX942-NEXT:    v_and_b32_e32 v1, 0xffff0000, v1
; GFX942-NEXT:    v_and_b32_e32 v7, 0xffff0000, v7
; GFX942-NEXT:    v_and_b32_e32 v6, 0xffff0000, v6
; GFX942-NEXT:    v_fmac_f32_e32 v3, v0, v5
; GFX942-NEXT:    v_bfe_u32 v0, v4, 16, 1
; GFX942-NEXT:    v_fmac_f32_e32 v7, v1, v10
; GFX942-NEXT:    v_fmac_f32_e32 v6, v1, v5
; GFX942-NEXT:    v_or_b32_e32 v1, 0x400000, v4
; GFX942-NEXT:    v_bfe_u32 v5, v3, 16, 1
; GFX942-NEXT:    v_add3_u32 v0, v0, v4, s2
; GFX942-NEXT:    v_cmp_u_f32_e32 vcc, v4, v4
; GFX942-NEXT:    v_or_b32_e32 v8, 0x400000, v3
; GFX942-NEXT:    v_bfe_u32 v9, v7, 16, 1
...
; GFX942-NEXT:    v_bfe_u32 v11, v6, 16, 1
; GFX942-NEXT:    v_add3_u32 v9, v9, v7, s2
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v5, v8, vcc
; GFX942-NEXT:    v_cmp_u_f32_e32 vcc, v7, v7
; GFX942-NEXT:    v_or_b32_e32 v12, 0x400000, v6
; GFX942-NEXT:    v_add3_u32 v11, v11, v6, s2
; GFX942-NEXT:    v_cndmask_b32_e32 v3, v9, v10, vcc
; GFX942-NEXT:    v_cmp_u_f32_e32 vcc, v6, v6
; GFX942-NEXT:    v_perm_b32 v0, v1, v0, s3
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v4, v11, v12, vcc
; GFX942-NEXT:    v_perm_b32 v1, v4, v3, s3
...
; GFX10-NEXT:    s_clause 0x2
; GFX10-NEXT:    global_load_dwordx2 v[0:1], v6, s[0:1]
; GFX10-NEXT:    global_load_dwordx2 v[2:3], v6, s[6:7]
; GFX10-NEXT:    global_load_dwordx2 v[4:5], v6, s[4:5]
; GFX10-NEXT:    s_waitcnt vmcnt(2)
...
; GFX10-NEXT:    v_fmac_f32_e32 v11, v12, v8
; GFX10-NEXT:    v_fmac_f32_e32 v1, v12, v2
...
; GFX10-NEXT:    v_fmac_f32_e32 v2, v4, v3
...
; GFX10-NEXT:    v_cmp_u_f32_e32 vcc_lo, v7, v7
; GFX10-NEXT:    v_cndmask_b32_e32 v3, v11, v12, vcc_lo
...
; GFX11-TRUE16-NEXT:    global_load_b64 v[2:3], v6, s[6:7]
...
; GFX11-TRUE16-NEXT:    v_fmac_f32_e32 v11, v12, v8
...
; GFX11-TRUE16-NEXT:    v_fmac_f32_e32 v1, v12, v2
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_fmac_f32_e32 v0, v9, v2
; GFX11-TRUE16-NEXT:    v_fmac_f32_e32 v7, v9, v8
...
; GFX11-TRUE16-NEXT:    v_add3_u32 v2, v2, v7, 0x7fff
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v7, v13, v14 :: v_dual_and_b32 v4, 0xffff0000, v4
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_dual_fmac_f32 v2, v4, v3 :: v_dual_and_b32 v5, 0xffff0000, v5
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v7, 0xffff0000, v7
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v0, 0xffff0000, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v8, 0x400000, v2
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
; GFX11-TRUE16-NEXT:    v_dual_fmac_f32 v7, v5, v3 :: v_dual_fmac_f32 v0, v4, v10
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v1, 0xffff0000, v1
; GFX11-TRUE16-NEXT:    v_fmac_f32_e32 v1, v5, v10
...
; GFX11-FAKE16-NEXT:    global_load_b64 v[2:3], v6, s[6:7]
...
; GFX11-FAKE16-NEXT:    v_fmac_f32_e32 v11, v12, v8
...
; GFX11-FAKE16-NEXT:    v_fmac_f32_e32 v1, v12, v2
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_fmac_f32_e32 v0, v9, v2
; GFX11-FAKE16-NEXT:    v_fmac_f32_e32 v7, v9, v8
...
; GFX11-FAKE16-NEXT:    v_bfe_u32 v2, v7, 16, 1
...
; GFX11-FAKE16-NEXT:    v_add3_u32 v2, v2, v7, 0x7fff
...
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v7, v13, v14 :: v_dual_and_b32 v4, 0xffff0000, v4
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_dual_fmac_f32 v2, v4, v3 :: v_dual_and_b32 v5, 0xffff0000, v5
...
; GFX11-FAKE16-NEXT:    v_dual_fmac_f32 v7, v5, v3 :: v_dual_fmac_f32 v0, v4, v10
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v0, v3, v4 :: v_dual_and_b32 v1, 0xffff0000, v1
; GFX11-FAKE16-NEXT:    v_fmac_f32_e32 v1, v5, v10
