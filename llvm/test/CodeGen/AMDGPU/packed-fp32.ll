...
; GFX1250-SDAG-NEXT:    global_load_b128 v[4:7], v56, s[34:35] offset:32
; GFX1250-SDAG-NEXT:    global_load_b128 v[8:11], v56, s[34:35] offset:48
; GFX1250-SDAG-NEXT:    global_load_b128 v[12:15], v56, s[34:35]
; GFX1250-SDAG-NEXT:    global_load_b128 v[16:19], v56, s[34:35] offset:64
; GFX1250-SDAG-NEXT:    global_load_b128 v[20:23], v56, s[34:35] offset:112
; GFX1250-SDAG-NEXT:    global_load_b128 v[24:27], v56, s[34:35] offset:80
; GFX1250-SDAG-NEXT:    global_load_b128 v[28:31], v56, s[34:35] offset:96
; GFX1250-SDAG-NEXT:    s_load_b512 s[16:31], s[4:5], 0xa4
; GFX1250-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX1250-SDAG-NEXT:    s_load_b512 s[0:15], s[4:5], 0xe4
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v33, s19 :: v_dual_mov_b32 v34, s20
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v35, s21 :: v_dual_mov_b32 v36, s22
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v37, s23 :: v_dual_mov_b32 v38, s24
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v39, s25 :: v_dual_mov_b32 v40, s26
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v41, s27 :: v_dual_mov_b32 v42, s28
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v55, s11 :: v_dual_mov_b32 v51, s7
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v52, s8 :: v_dual_mov_b32 v53, s9
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v54, s10 :: v_dual_mov_b32 v47, s3
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v48, s4 :: v_dual_mov_b32 v49, s5
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v50, s6 :: v_dual_mov_b32 v45, s31
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v46, s2 :: v_dual_mov_b32 v43, s29
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v44, s30 :: v_dual_mov_b32 v32, s18
...
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v34, s12 :: v_dual_mov_b32 v35, s13
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v36, s14 :: v_dual_mov_b32 v37, s15
...
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[22:23], v[22:23], v[36:37]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[28:29], v[28:29], v[52:53]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[30:31], v[30:31], v[54:55]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[24:25], v[24:25], v[48:49]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[26:27], v[26:27], v[50:51]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[18:19], v[18:19], v[46:47]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[16:17], v[16:17], v[40:41]
...
; GFX1250-SDAG-NEXT:    s_clause 0x7
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[20:23], s[34:35] offset:112
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[28:31], s[34:35] offset:96
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[24:27], s[34:35] offset:80
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[16:19], s[34:35] offset:64
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[8:11], s[34:35] offset:48
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[4:7], s[34:35] offset:32
...
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[22:23], v[22:23], v[36:37]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[28:29], v[28:29], v[52:53]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[30:31], v[30:31], v[54:55]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[24:25], v[24:25], v[48:49]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[26:27], v[26:27], v[50:51]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[18:19], v[18:19], v[46:47]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[16:17], v[16:17], v[40:41]
...
; GFX1250-SDAG-NEXT:    s_load_b512 s[0:15], s[4:5], 0xe4
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[34:35], s[20:21]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[36:37], s[22:23]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[40:41], s[26:27]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[38:39], s[24:25]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[52:53], s[8:9]
...
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[46:47], s[2:3]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[28:29]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[44:45], s[30:31]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[18:19]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x7
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[0:1], v[0:1], v[34:35], v[34:35]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[2:3], v[2:3], v[36:37], v[36:37]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[34:35], s[12:13]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[36:37], s[14:15]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x6
...
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[20:21], v[20:21], v[34:35], v[34:35]
...
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[24:25], v[24:25], v[48:49], v[48:49]
...
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[16:17], v[16:17], v[40:41], v[40:41]
