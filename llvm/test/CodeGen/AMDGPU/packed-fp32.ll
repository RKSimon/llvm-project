...
; GFX1250-SDAG-NEXT:    v_dual_lshlrev_b32 v56, 7, v0 :: v_dual_mov_b32 v32, s38
; GFX1250-SDAG-NEXT:    s_clause 0x7
; GFX1250-SDAG-NEXT:    global_load_b128 v[0:3], v56, s[0:1] offset:16
; GFX1250-SDAG-NEXT:    global_load_b128 v[4:7], v56, s[0:1] offset:32
; GFX1250-SDAG-NEXT:    global_load_b128 v[8:11], v56, s[0:1] offset:48
; GFX1250-SDAG-NEXT:    global_load_b128 v[12:15], v56, s[0:1]
; GFX1250-SDAG-NEXT:    global_load_b128 v[16:19], v56, s[0:1] offset:64
; GFX1250-SDAG-NEXT:    global_load_b128 v[20:23], v56, s[0:1] offset:112
; GFX1250-SDAG-NEXT:    global_load_b128 v[24:27], v56, s[0:1] offset:80
; GFX1250-SDAG-NEXT:    global_load_b128 v[28:31], v56, s[0:1] offset:96
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v33, s39 :: v_dual_mov_b32 v34, s40
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v35, s41 :: v_dual_mov_b32 v36, s42
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v37, s43 :: v_dual_mov_b32 v38, s44
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v39, s45 :: v_dual_mov_b32 v40, s46
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v41, s47 :: v_dual_mov_b32 v42, s48
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v55, s19 :: v_dual_mov_b32 v51, s15
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v52, s16 :: v_dual_mov_b32 v53, s17
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v54, s18 :: v_dual_mov_b32 v47, s11
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v48, s12 :: v_dual_mov_b32 v49, s13
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v50, s14 :: v_dual_mov_b32 v45, s51
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v46, s10 :: v_dual_mov_b32 v43, s49
; GFX1250-SDAG-NEXT:    v_mov_b32_e32 v44, s50
...
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v36, s22 :: v_dual_mov_b32 v37, s23
...
; GFX1250-SDAG-NEXT:    s_clause 0x7
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[20:23], s[0:1] offset:112
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[28:31], s[0:1] offset:96
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[24:27], s[0:1] offset:80
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[16:19], s[0:1] offset:64
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[8:11], s[0:1] offset:48
; GFX1250-SDAG-NEXT:    global_store_b128 v56, v[4:7], s[0:1] offset:32
...
; GFX1250-SDAG-NEXT:    global_load_b128 v[24:27], v56, s[0:1] offset:80
; GFX1250-SDAG-NEXT:    global_load_b128 v[28:31], v56, s[0:1] offset:96
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[34:35], s[40:41]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[36:37], s[42:43]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[40:41], s[46:47]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[38:39], s[44:45]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[52:53], s[16:17]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[54:55], s[18:19]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[48:49], s[12:13]
...
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[38:39]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x7
