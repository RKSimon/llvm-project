...
; EG-NEXT:    ALU 108, @382, KC0[], KC1[]
; EG-NEXT:    TEX 1 @30
; EG-NEXT:    ALU 113, @491, KC0[], KC1[]
; EG-NEXT:    ALU 112, @605, KC0[], KC1[]
; EG-NEXT:    ALU 115, @718, KC0[], KC1[]
; EG-NEXT:    ALU 115, @834, KC0[], KC1[]
; EG-NEXT:    ALU 114, @950, KC0[], KC1[]
; EG-NEXT:    ALU 115, @1065, KC0[], KC1[]
; EG-NEXT:    ALU 114, @1181, KC0[], KC1[]
; EG-NEXT:    ALU 115, @1296, KC0[], KC1[]
; EG-NEXT:    ALU 114, @1412, KC0[], KC1[]
; EG-NEXT:    ALU 115, @1527, KC0[], KC1[]
; EG-NEXT:    ALU 113, @1643, KC0[], KC1[]
; EG-NEXT:    ALU 115, @1757, KC0[], KC1[]
; EG-NEXT:    ALU 113, @1873, KC0[], KC1[]
; EG-NEXT:    ALU 115, @1987, KC0[], KC1[]
; EG-NEXT:    ALU 102, @2103, KC0[CB0:0-32], KC1[]
; EG-NEXT:    MEM_RAT_CACHELESS STORE_RAW T7.XYZW, T1.X, 0
...
; EG-NEXT:     VTX_READ_128 T9.XYZW, T0.X, 0, #1
; EG-NEXT:     VTX_READ_128 T10.XYZW, T0.X, 32, #1
...
; EG-NEXT:     SETGE_UINT T5.W, PV.W, T7.W,
; EG-NEXT:     SUB_INT * T6.W, PV.W, T7.W,
; EG-NEXT:     CNDE_INT T0.Z, PV.W, T4.W, PS, BS:VEC_021/SCL_122
; EG-NEXT:     ADD_INT T2.W, T2.W, T3.W,
; EG-NEXT:     ADDC_UINT * T4.W, T2.Z, T3.W,
; EG-NEXT:     ADD_INT T2.Z, PV.W, PS,
; EG-NEXT:     SETGE_UINT T2.W, PV.Z, T7.W,
; EG-NEXT:     SUB_INT * T4.W, PV.Z, T7.W,
; EG-NEXT:     ADD_INT T1.Z, T1.Z, T0.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT T2.W, PV.W, T0.Z, PS,
; EG-NEXT:     XOR_INT * T8.W, PV.Z, T3.W,
; EG-NEXT:     CNDE_INT T1.W, PS, PV.W, T1.W,
; EG-NEXT:     XOR_INT * T6.W, PV.Z, T0.W,
; EG-NEXT:     BIT_ALIGN_INT T2.W, PV.W, PS, literal.x,
; EG-NEXT:     LSHR * T1.W, PV.W, literal.x,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETE_INT T0.Z, PS, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T3.W, PS, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT * T4.W, PV.W, T7.W,
; EG-NEXT:     CNDE_INT T0.Y, PV.Z, PV.W, PS,
; EG-NEXT:     SUB_INT * T0.Z, T2.W, T7.W,
; EG-NEXT:     SUB_INT * T3.W, T1.W, T8.W,
; EG-NEXT:     SUBB_UINT * T4.W, T2.W, T7.W,
; EG-NEXT:     SUB_INT T3.W, T3.W, PV.W,
; EG-NEXT:     CNDE_INT * T2.W, T0.Y, T2.W, T0.Z,
; EG-NEXT:     LSHL T0.Z, PS, 1,
; EG-NEXT:     BFE_UINT T4.W, T6.W, literal.x, 1,
; EG-NEXT:     CNDE_INT * T1.W, T0.Y, T1.W, PV.W,
; EG-NEXT:    30(4.203895e-44), 0(0.000000e+00)
; EG-NEXT:     BIT_ALIGN_INT T1.W, PS, T2.W, literal.x,
; EG-NEXT:     OR_INT * T2.W, PV.Z, PV.W,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETGE_UINT T0.Z, PS, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETE_INT T3.W, PV.W, T8.W,
; EG-NEXT:     SETGE_UINT * T4.W, PV.W, T8.W,
; EG-NEXT:     CNDE_INT T0.Y, PV.W, PS, PV.Z,
; EG-NEXT:     SUB_INT T0.Z, T2.W, T7.W,
; EG-NEXT:     SUBB_UINT * T3.W, T2.W, T7.W,
; EG-NEXT:     SUB_INT * T4.W, T1.W, T8.W,
...
; EG-NEXT:     OR_INT * T2.W, PV.Z, PV.W,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETGE_UINT * T0.Z, PS, T7.W,
; EG-NEXT:    ALU clause starting at 150:
; EG-NEXT:     SETE_INT T3.W, T1.W, T8.W,
; EG-NEXT:     SETGE_UINT * T4.W, T1.W, T8.W,
...
; EG-NEXT:     SUB_INT T3.W, T2.W, T7.W,
; EG-NEXT:     SUBB_UINT * T4.W, T2.W, T7.W,
; EG-NEXT:    ALU clause starting at 491:
; EG-NEXT:     SUB_INT * T5.W, T1.W, T8.W,
; EG-NEXT:     SUB_INT T4.W, PV.W, T4.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T2.W, T0.Z, T2.W, T3.W,
; EG-NEXT:     LSHL T1.Z, PS, 1,
; EG-NEXT:     BFE_UINT T3.W, T6.W, literal.x, 1,
; EG-NEXT:     CNDE_INT * T1.W, T0.Z, T1.W, PV.W,
; EG-NEXT:    4(5.605194e-45), 0(0.000000e+00)
; EG-NEXT:     BIT_ALIGN_INT T1.W, PS, T2.W, literal.x,
; EG-NEXT:     OR_INT * T2.W, PV.Z, PV.W,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
...
; EG-NEXT:     CNDE_INT * T1.W, T0.Y, T1.W, PV.W,
; EG-NEXT:    3(4.203895e-45), 0(0.000000e+00)
; EG-NEXT:     BIT_ALIGN_INT T1.Z, PS, T2.W, literal.x,
; EG-NEXT:     OR_INT T1.W, PV.Z, PV.W,
; EG-NEXT:     ASHR * T11.W, T10.Y, literal.x,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     ADD_INT T0.Y, T10.X, PS,
; EG-NEXT:     SETGE_UINT T0.Z, PV.W, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETE_INT T2.W, PV.Z, T8.W,
; EG-NEXT:     SETGE_UINT * T3.W, PV.Z, T8.W,
; EG-NEXT:     CNDE_INT T0.X, PV.W, PS, PV.Z,
; EG-NEXT:     SUB_INT T3.Y, T1.W, T7.W,
; EG-NEXT:     SUBB_UINT T0.Z, T1.W, T7.W,
; EG-NEXT:     SUB_INT * T3.W, T1.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     XOR_INT * T2.W, T0.Y, T11.W,
; EG-NEXT:     ASHR T0.Y, T10.W, literal.x,
; EG-NEXT:     SUB_INT T2.Z, 0.0, PV.W,
; EG-NEXT:     SUB_INT T3.W, T3.W, T0.Z, BS:VEC_201
; EG-NEXT:     CNDE_INT * T4.W, T0.X, T1.W, T3.Y,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     LSHL T3.X, PS, 1,
; EG-NEXT:     BFE_UINT T3.Y, T6.W, literal.x, 1,
; EG-NEXT:     CNDE_INT T0.Z, T0.X, T1.Z, PV.W,
; EG-NEXT:     ASHR T1.W, T9.Y, literal.y,
; EG-NEXT:     RECIP_UINT * T0.X, T2.W,
; EG-NEXT:    2(2.802597e-45), 31(4.344025e-44)
; EG-NEXT:     ADD_INT T4.X, T9.Y, PV.W,
; EG-NEXT:     ADDC_UINT T4.Y, T9.X, PV.W,
; EG-NEXT:     BIT_ALIGN_INT T0.Z, PV.Z, T4.W, literal.x,
; EG-NEXT:     OR_INT T5.W, PV.X, PV.Y,
; EG-NEXT:     MULLO_INT * T1.Z, T2.Z, PS,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETGE_UINT T3.X, PV.W, T7.W,
; EG-NEXT:     SETE_INT T3.Y, PV.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T2.Z, PV.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     ADD_INT T3.W, PV.X, PV.Y,
; EG-NEXT:     MULHI * T1.Z, T0.X, PS,
; EG-NEXT:     ADD_INT T4.Y, T0.X, PS,
; EG-NEXT:     XOR_INT T4.Z, PV.W, T1.W,
; EG-NEXT:     CNDE_INT T12.W, PV.Y, PV.Z, PV.X,
; EG-NEXT:     ADD_INT * T3.W, T10.Z, T0.Y,
; EG-NEXT:     SUB_INT T0.X, T5.W, T7.W,
; EG-NEXT:     SUBB_UINT T3.Y, T5.W, T7.W,
; EG-NEXT:     SUB_INT T1.Z, T0.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     XOR_INT T4.W, PS, T0.Y,
; EG-NEXT:     ASHR * T3.W, T1.Y, literal.x,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     ADD_INT T3.X, T1.Y, PS,
; EG-NEXT:     SUB_INT T1.Y, 0.0, PV.W,
; EG-NEXT:     SUB_INT T1.Z, PV.Z, PV.Y,
; EG-NEXT:     CNDE_INT T13.W, T12.W, T5.W, PV.X,
; EG-NEXT:     RECIP_UINT * T0.X, PV.W,
; EG-NEXT:     LSHL T4.X, PV.W, 1,
; EG-NEXT:     BFE_UINT T3.Y, T6.W, 1, 1,
; EG-NEXT:     CNDE_INT T0.Z, T12.W, T0.Z, PV.Z, BS:VEC_120/SCL_212
; EG-NEXT:     ASHR T5.W, T9.W, literal.x, BS:VEC_201
; EG-NEXT:     MULLO_INT * T1.Y, PV.Y, PS,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     ADD_INT T5.X, T9.W, PV.W,
; EG-NEXT:     ADDC_UINT T5.Y, T9.Z, PV.W,
; EG-NEXT:     BIT_ALIGN_INT T0.Z, PV.Z, T13.W, literal.x,
; EG-NEXT:     OR_INT T9.W, PV.X, PV.Y,
; EG-NEXT:     MULHI * T1.Y, T0.X, PS,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     ADD_INT T0.X, T0.X, PS,
; EG-NEXT:     SETGE_UINT T1.Y, PV.W, T7.W,
; EG-NEXT:     SETE_INT T1.Z, PV.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T12.W, PV.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     ADD_INT * T13.W, PV.X, PV.Y,
; EG-NEXT:     XOR_INT T4.X, PS, T5.W,
; EG-NEXT:     CNDE_INT T1.Y, PV.Z, PV.W, PV.Y,
; EG-NEXT:     SUB_INT T1.Z, T9.W, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUBB_UINT * T12.W, T9.W, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT * T13.W, T0.Z, T8.W,
; EG-NEXT:     ADDC_UINT T5.X, T1.X, T3.W,
; EG-NEXT:     SUB_INT T3.Y, PV.W, T12.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT T1.Z, T1.Y, T9.W, T1.Z, BS:VEC_102/SCL_221
; EG-NEXT:     ASHR T9.W, T2.Y, literal.x,
; EG-NEXT:     MULHI * T0.X, T4.X, T0.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     ADD_INT T6.X, T2.X, PV.W,
; EG-NEXT:     LSHL T5.Y, PV.Z, 1,
; EG-NEXT:     AND_INT T2.Z, T6.W, 1,
; EG-NEXT:     CNDE_INT T6.W, T1.Y, T0.Z, PV.Y,
; EG-NEXT:     MULLO_INT * T0.X, PS, T4.W,
; EG-NEXT:     ADD_INT T7.X, T9.Z, T5.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT T1.Y, T4.X, PS,
; EG-NEXT:     BIT_ALIGN_INT T0.Z, PV.W, T1.Z, literal.x,
; EG-NEXT:     OR_INT T12.W, PV.Y, PV.Z,
; EG-NEXT:     XOR_INT * T6.W, PV.X, T9.W,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SUB_INT T0.X, 0.0, PS,
; EG-NEXT:     SETGE_UINT * T3.Y, PV.W, T7.W,
; EG-NEXT:    ALU clause starting at 605:
; EG-NEXT:     SETE_INT T1.Z, T0.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T13.W, T1.Y, T4.W,
; EG-NEXT:     SUB_INT * T14.W, T1.Y, T4.W,
; EG-NEXT:     SETGE_UINT T6.X, T0.Z, T8.W,
; EG-NEXT:     SUBB_UINT T5.Y, T12.W, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T2.Z, PV.W, T1.Y, PS,
; EG-NEXT:     ADD_INT T10.W, T10.W, T0.Y,
; EG-NEXT:     ADDC_UINT * T13.W, T10.Z, T0.Y,
; EG-NEXT:     SUB_INT T8.X, T0.Z, T8.W,
; EG-NEXT:     ADD_INT T1.Y, PV.W, PS,
; EG-NEXT:     SETGE_UINT T3.Z, T2.Z, T4.W, BS:VEC_102/SCL_221
; EG-NEXT:     SUB_INT T8.W, T2.Z, T4.W, BS:VEC_102/SCL_221
; EG-NEXT:     RECIP_UINT * T5.Z, T6.W,
; EG-NEXT:     CNDE_INT T11.X, PV.Z, T2.Z, PV.W,
; EG-NEXT:     XOR_INT T1.Y, PV.Y, T0.Y,
; EG-NEXT:     SUB_INT T2.Z, PV.X, T5.Y, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT T8.W, T1.Z, T6.X, T3.Y, BS:VEC_210
; EG-NEXT:     MULLO_INT * T0.X, T0.X, PS,
; EG-NEXT:     CNDE_INT T6.X, PV.W, T0.Z, PV.Z,
; EG-NEXT:     CNDE_INT T0.Y, PV.Y, PV.X, T4.X,
; EG-NEXT:     XOR_INT * T3.Z, T7.X, T5.W,
; EG-NEXT:     ADD_INT T10.W, T3.X, T5.X, BS:VEC_021/SCL_122
; EG-NEXT:     MULHI * T0.X, T5.Z, T0.X,
; EG-NEXT:     ADD_INT T0.X, T5.Z, PS,
; EG-NEXT:     XOR_INT T3.Y, PV.W, T3.W, BS:VEC_102/SCL_221
; EG-NEXT:     BIT_ALIGN_INT T2.Z, T0.Y, T3.Z, literal.x,
; EG-NEXT:     LSHR T10.W, T0.Y, literal.x,
; EG-NEXT:     SUB_INT * T7.W, T12.W, T7.W,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT T3.X, T8.W, T12.W, PS,
; EG-NEXT:     SETE_INT T0.Y, PV.W, T1.Y,
; EG-NEXT:     SETGE_UINT T0.Z, PV.W, T1.Y,
; EG-NEXT:     SETGE_UINT T7.W, PV.Z, T4.W, BS:VEC_021/SCL_122
; EG-NEXT:     MULHI * T0.X, PV.Y, PV.X,
; EG-NEXT:     CNDE_INT T4.X, PV.Y, PV.Z, PV.W,
; EG-NEXT:     SUB_INT T5.Y, T2.Z, T4.W,
; EG-NEXT:     XOR_INT T0.Z, PV.X, T0.W, BS:VEC_021/SCL_122
; EG-NEXT:     XOR_INT T7.W, T6.X, T0.W, BS:VEC_021/SCL_122
; EG-NEXT:     MULHI * T3.X, T4.Z, T4.Y,
; EG-NEXT:     SUB_INT T0.Y, PV.W, T0.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUBB_UINT T1.Z, PV.Z, T0.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT T12.W, PV.X, T2.Z, PV.Y,
; EG-NEXT:     MULLO_INT * T3.X, PS, T2.W,
; EG-NEXT:     LSHL T5.X, PV.W, 1,
; EG-NEXT:     BFE_UINT T4.Y, T3.Z, literal.x, 1,
; EG-NEXT:     SUB_INT T5.Z, T10.W, T1.Y,
; EG-NEXT:     SUB_INT T7.W, T4.Z, PS, BS:VEC_120/SCL_212
; EG-NEXT:     MULLO_INT * T0.X, T0.X, T6.W,
; EG-NEXT:    30(4.203895e-44), 0(0.000000e+00)
; EG-NEXT:     SETGE_UINT T3.X, PV.W, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT T5.Y, PV.W, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT T6.Z, T3.Y, PS,
; EG-NEXT:     ADD_INT T8.W, T10.Y, T11.W, BS:VEC_102/SCL_221
; EG-NEXT:     ADDC_UINT * T13.W, T10.X, T11.W,
; EG-NEXT:     SUBB_UINT T6.X, T2.Z, T4.W, BS:VEC_021/SCL_122
; EG-NEXT:     ADD_INT T6.Y, PV.W, PS,
; EG-NEXT:     SETGE_UINT T2.Z, PV.Z, T6.W, BS:VEC_102/SCL_221
; EG-NEXT:     SUB_INT T8.W, PV.Z, T6.W, BS:VEC_102/SCL_221
; EG-NEXT:     CNDE_INT * T7.W, PV.X, T7.W, PV.Y,
; EG-NEXT:     SETGE_UINT T0.X, PS, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT T5.Y, PS, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT T2.Z, PV.Z, T6.Z, PV.W,
; EG-NEXT:     ADD_INT T8.W, T2.Y, T9.W,
; EG-NEXT:     ADDC_UINT * T13.W, T2.X, T9.W,
; EG-NEXT:     ADD_INT T2.X, PV.W, PS,
; EG-NEXT:     SETGE_UINT T2.Y, PV.Z, T6.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT T6.Z, PV.Z, T6.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT T7.W, PV.X, T7.W, PV.Y, BS:VEC_102/SCL_221
; EG-NEXT:     XOR_INT * T8.W, T6.Y, T11.W,
; EG-NEXT:     CNDE_INT T3.X, PS, PV.W, T4.Z,
; EG-NEXT:     ADD_INT T5.Y, T1.X, T3.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT T2.Z, PV.Y, T2.Z, PV.Z,
; EG-NEXT:     XOR_INT T7.W, PV.X, T9.W, BS:VEC_102/SCL_221
; EG-NEXT:     ADD_INT * T9.W, T9.X, T1.W,
; EG-NEXT:     XOR_INT T0.X, PS, T1.W,
; EG-NEXT:     CNDE_INT T2.Y, PV.W, PV.Z, T3.Y,
; EG-NEXT:     XOR_INT T2.Z, PV.Y, T3.W, BS:VEC_021/SCL_122
; EG-NEXT:     LSHR T9.W, PV.X, literal.x,
; EG-NEXT:     SUB_INT * T11.W, T5.Z, T6.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT T1.X, T4.X, T10.W, PS,
; EG-NEXT:     SETE_INT T3.Y, PV.W, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     BIT_ALIGN_INT T4.Z, PV.Y, PV.Z, literal.x,
; EG-NEXT:     BIT_ALIGN_INT T10.W, T3.X, PV.X, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:     LSHR * T11.W, PV.Y, literal.x,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETGE_UINT T2.X, T9.W, T8.W,
; EG-NEXT:     SETGE_UINT * T2.Y, PV.W, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETE_INT T5.Z, T11.W, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T13.W, T11.W, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT * T14.W, T4.Z, T6.W,
; EG-NEXT:     CNDE_INT T3.X, PV.Z, PV.W, PS,
; EG-NEXT:     CNDE_INT T2.Y, T3.Y, T2.X, T2.Y,
; EG-NEXT:     SUB_INT T5.Z, T10.W, T2.W,
; EG-NEXT:     BIT_ALIGN_INT T12.W, T1.X, T12.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T13.W, T5.X, T4.Y,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SUB_INT * T1.X, T9.W, T8.W,
; EG-NEXT:     SUBB_UINT * T3.Y, T10.W, T2.W,
; EG-NEXT:     SETGE_UINT T6.Z, T13.W, T4.W,
; EG-NEXT:     SETE_INT T14.W, T12.W, T1.Y, BS:VEC_201
; EG-NEXT:     SETGE_UINT * T15.W, T12.W, T1.Y,
; EG-NEXT:     SUBB_UINT T2.X, T13.W, T4.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT T4.Y, PV.W, PS, PV.Z,
; EG-NEXT:     SUB_INT T6.Z, T13.W, T4.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT T14.W, T1.X, T3.Y,
; EG-NEXT:     CNDE_INT * T10.W, T2.Y, T10.W, T5.Z,
; EG-NEXT:     SUB_INT T1.X, T12.W, T1.Y,
; EG-NEXT:     LSHL T3.Y, PS, 1,
; EG-NEXT:     BFE_UINT T5.Z, T0.X, literal.x, 1,
; EG-NEXT:     CNDE_INT T9.W, T2.Y, T9.W, PV.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T13.W, PV.Y, T13.W, PV.Z,
; EG-NEXT:    30(4.203895e-44), 0(0.000000e+00)
; EG-NEXT:    ALU clause starting at 718:
; EG-NEXT:     SUB_INT T4.X, T4.Z, T6.W,
; EG-NEXT:     LSHL * T2.Y, T13.W, 1,
; EG-NEXT:     BIT_ALIGN_INT T6.Z, T9.W, T10.W, literal.x,
; EG-NEXT:     OR_INT T9.W, T3.Y, T5.Z,
; EG-NEXT:     SUB_INT * T10.W, T1.X, T2.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_UINT T1.X, T3.Z, literal.x, 1,
; EG-NEXT:     CNDE_INT T3.Y, T4.Y, T12.W, PS, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T5.Z, PV.W, T2.W, BS:VEC_102/SCL_221
; EG-NEXT:     SETE_INT T10.W, PV.Z, T8.W,
; EG-NEXT:     SETGE_UINT * T12.W, PV.Z, T8.W,
; EG-NEXT:    29(4.063766e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT T2.X, PV.W, PS, PV.Z,
; EG-NEXT:     SUB_INT T4.Y, T9.W, T2.W,
; EG-NEXT:     BIT_ALIGN_INT T5.Z, PV.Y, T13.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT T10.W, T2.Y, PV.X,
; EG-NEXT:     CNDE_INT * T12.W, T3.X, T4.Z, T4.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     LSHL T1.X, PS, 1,
; EG-NEXT:     SETGE_UINT T2.Y, PV.W, T4.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETE_INT T7.Z, PV.Z, T1.Y,
; EG-NEXT:     SETGE_UINT T13.W, PV.Z, T1.Y,
; EG-NEXT:     CNDE_INT * T14.W, PV.X, T9.W, PV.Y,
; EG-NEXT:     BFE_UINT T4.X, T2.Z, literal.x, 1,
; EG-NEXT:     LSHL T3.Y, PS, 1,
; EG-NEXT:     SUB_INT T8.Z, T11.W, T7.W,
; EG-NEXT:     CNDE_INT * T13.W, PV.Z, PV.W, PV.Y,
; EG-NEXT:    30(4.203895e-44), 0(0.000000e+00)
; EG-NEXT:     SUB_INT * T15.W, T10.W, T4.W,
; EG-NEXT:     SUBB_UINT T5.X, T10.W, T4.W,
; EG-NEXT:     SUB_INT * T2.Y, T5.Z, T1.Y,
; EG-NEXT:     SUBB_UINT T7.Z, T9.W, T2.W,
; EG-NEXT:     SUB_INT * T9.W, T6.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T10.W, T13.W, T10.W, T15.W,
; EG-NEXT:     SUBB_UINT T6.X, T4.Z, T6.W,
; EG-NEXT:     LSHL T4.Y, PV.W, 1,
; EG-NEXT:     BFE_UINT T4.Z, T3.Z, literal.x, 1, BS:VEC_120/SCL_212
; EG-NEXT:     SUB_INT T9.W, T9.W, T7.Z, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT * T15.W, T2.Y, T5.X,
; EG-NEXT:    28(3.923636e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_UINT T5.X, T0.X, literal.x, 1,
; EG-NEXT:     CNDE_INT T2.Y, T13.W, T5.Z, PS,
; EG-NEXT:     CNDE_INT T5.Z, T2.X, T6.Z, PV.W, BS:VEC_102/SCL_221
; EG-NEXT:     OR_INT T9.W, PV.Y, PV.Z,
; EG-NEXT:     SUB_INT * T13.W, T8.Z, PV.X,
; EG-NEXT:    29(4.063766e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT T2.X, T3.X, T11.W, PS,
; EG-NEXT:     SETGE_UINT T4.Y, PV.W, T4.W, BS:VEC_021/SCL_122
; EG-NEXT:     BIT_ALIGN_INT * T4.Z, PV.Z, T14.W, literal.x, BS:VEC_102/SCL_221
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     BIT_ALIGN_INT T10.W, T2.Y, T10.W, literal.x,
; EG-NEXT:     OR_INT * T11.W, T3.Y, T5.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETE_INT T3.X, PV.W, T1.Y,
; EG-NEXT:     SETGE_UINT T2.Y, PV.W, T1.Y,
; EG-NEXT:     SETGE_UINT T5.Z, PS, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETE_INT T13.W, T4.Z, T8.W,
; EG-NEXT:     SETGE_UINT * T14.W, T4.Z, T8.W,
; EG-NEXT:     CNDE_INT T5.X, PV.W, PS, PV.Z,
; EG-NEXT:     CNDE_INT T2.Y, PV.X, PV.Y, T4.Y,
; EG-NEXT:     SUB_INT T5.Z, T9.W, T4.W,
; EG-NEXT:     BIT_ALIGN_INT T12.W, T2.X, T12.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T13.W, T1.X, T4.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SUBB_UINT T1.X, T9.W, T4.W,
; EG-NEXT:     SUB_INT * T3.Y, T10.W, T1.Y, BS:VEC_201
; EG-NEXT:     SETGE_UINT * T6.Z, T13.W, T6.W,
; EG-NEXT:     SETE_INT T14.W, T12.W, T7.W,
; EG-NEXT:     SETGE_UINT * T15.W, T12.W, T7.W,
; EG-NEXT:     SUBB_UINT T2.X, T13.W, T6.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT T4.Y, PV.W, PS, T6.Z,
; EG-NEXT:     SUB_INT T6.Z, T13.W, T6.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT T14.W, T3.Y, T1.X,
; EG-NEXT:     CNDE_INT * T9.W, T2.Y, T9.W, T5.Z,
; EG-NEXT:     SUB_INT T1.X, T12.W, T7.W,
; EG-NEXT:     LSHL T3.Y, PS, 1,
; EG-NEXT:     BFE_UINT T5.Z, T3.Z, literal.x, 1,
; EG-NEXT:     CNDE_INT * T10.W, T2.Y, T10.W, PV.W, BS:VEC_021/SCL_122
; EG-NEXT:    27(3.783506e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT * T13.W, T4.Y, T13.W, T6.Z,
; EG-NEXT:     SUB_INT T3.X, T11.W, T2.W,
; EG-NEXT:     LSHL * T2.Y, PV.W, 1,
; EG-NEXT:     BIT_ALIGN_INT T6.Z, T10.W, T9.W, literal.x,
; EG-NEXT:     OR_INT T9.W, T3.Y, T5.Z,
; EG-NEXT:     SUB_INT * T10.W, T1.X, T2.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_UINT T1.X, T2.Z, literal.x, 1,
; EG-NEXT:     CNDE_INT T3.Y, T4.Y, T12.W, PS,
; EG-NEXT:     SETGE_UINT T5.Z, PV.W, T4.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETE_INT T10.W, PV.Z, T1.Y,
; EG-NEXT:     SETGE_UINT * T12.W, PV.Z, T1.Y,
; EG-NEXT:    29(4.063766e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT T2.X, PV.W, PS, PV.Z,
; EG-NEXT:     SUB_INT T4.Y, T9.W, T4.W,
; EG-NEXT:     BIT_ALIGN_INT T5.Z, PV.Y, T13.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T10.W, T2.Y, PV.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT * T12.W, T5.X, T11.W, T3.X,
; EG-NEXT:     LSHL T1.X, PV.W, 1,
; EG-NEXT:     SETGE_UINT T2.Y, T10.W, T6.W,
; EG-NEXT:     SETE_INT T7.Z, T5.Z, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT * T13.W, T5.Z, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T14.W, T2.X, T9.W, T4.Y,
; EG-NEXT:     BFE_UINT T3.X, T0.X, literal.x, 1,
; EG-NEXT:     LSHL T3.Y, PV.W, 1,
; EG-NEXT:     SUBB_UINT T8.Z, T11.W, T2.W,
; EG-NEXT:     CNDE_INT * T11.W, T7.Z, T13.W, T2.Y, BS:VEC_021/SCL_122
; EG-NEXT:    28(3.923636e-44), 0(0.000000e+00)
; EG-NEXT:     SUB_INT * T13.W, T10.W, T6.W,
; EG-NEXT:     SUBB_UINT T4.X, T10.W, T6.W,
; EG-NEXT:     SUB_INT * T2.Y, T5.Z, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUBB_UINT T7.Z, T9.W, T4.W,
; EG-NEXT:     SUB_INT * T9.W, T6.Z, T1.Y,
; EG-NEXT:     CNDE_INT * T10.W, T11.W, T10.W, T13.W,
; EG-NEXT:     SUB_INT T6.X, T4.Z, T8.W,
; EG-NEXT:     LSHL * T4.Y, PV.W, 1,
; EG-NEXT:    ALU clause starting at 834:
; EG-NEXT:     BFE_UINT T9.Z, T2.Z, literal.x, 1,
; EG-NEXT:     SUB_INT T9.W, T9.W, T7.Z,
; EG-NEXT:     SUB_INT * T13.W, T2.Y, T4.X,
; EG-NEXT:    28(3.923636e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_UINT T4.X, T3.Z, literal.x, 1,
; EG-NEXT:     CNDE_INT T2.Y, T11.W, T5.Z, PS,
; EG-NEXT:     CNDE_INT T5.Z, T2.X, T6.Z, PV.W, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T9.W, T4.Y, PV.Z,
; EG-NEXT:    26(3.643376e-44), 0(0.000000e+00)
; EG-NEXT:     SUB_INT * T11.W, T6.X, T8.Z,
; EG-NEXT:     CNDE_INT T2.X, T5.X, T4.Z, PV.W,
; EG-NEXT:     SETGE_UINT T4.Y, T9.W, T6.W,
; EG-NEXT:     BIT_ALIGN_INT * T4.Z, T5.Z, T14.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     BIT_ALIGN_INT T10.W, T2.Y, T10.W, literal.x,
; EG-NEXT:     OR_INT * T11.W, T3.Y, T4.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETE_INT T4.X, PV.W, T7.W,
; EG-NEXT:     SETGE_UINT T2.Y, PV.W, T7.W,
; EG-NEXT:     SETGE_UINT T5.Z, PS, T4.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETE_INT T13.W, T4.Z, T1.Y,
; EG-NEXT:     SETGE_UINT * T14.W, T4.Z, T1.Y,
; EG-NEXT:     CNDE_INT T5.X, PV.W, PS, PV.Z,
; EG-NEXT:     CNDE_INT T2.Y, PV.X, PV.Y, T4.Y,
; EG-NEXT:     SUB_INT T5.Z, T9.W, T6.W,
; EG-NEXT:     BIT_ALIGN_INT T12.W, T2.X, T12.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T13.W, T1.X, T3.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SUBB_UINT * T1.X, T9.W, T6.W,
; EG-NEXT:     SUB_INT * T3.Y, T10.W, T7.W,
; EG-NEXT:     SETGE_UINT * T6.Z, T13.W, T2.W,
; EG-NEXT:     SETE_INT T14.W, T12.W, T8.W,
; EG-NEXT:     SETGE_UINT * T15.W, T12.W, T8.W,
; EG-NEXT:     SUBB_UINT T2.X, T13.W, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT T4.Y, PV.W, PS, T6.Z,
; EG-NEXT:     SUB_INT T6.Z, T13.W, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT T14.W, T3.Y, T1.X,
; EG-NEXT:     CNDE_INT * T9.W, T2.Y, T9.W, T5.Z,
; EG-NEXT:     SUB_INT T1.X, T12.W, T8.W,
; EG-NEXT:     LSHL T3.Y, PS, 1,
; EG-NEXT:     BFE_UINT T5.Z, T2.Z, literal.x, 1,
; EG-NEXT:     CNDE_INT * T10.W, T2.Y, T10.W, PV.W, BS:VEC_021/SCL_122
; EG-NEXT:    27(3.783506e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT * T13.W, T4.Y, T13.W, T6.Z,
; EG-NEXT:     SUB_INT T3.X, T11.W, T4.W,
; EG-NEXT:     LSHL * T2.Y, PV.W, 1,
; EG-NEXT:     BIT_ALIGN_INT T6.Z, T10.W, T9.W, literal.x,
; EG-NEXT:     OR_INT T9.W, T3.Y, T5.Z,
; EG-NEXT:     SUB_INT * T10.W, T1.X, T2.X,
...
; EG-NEXT:     CNDE_INT T3.Y, T4.Y, T12.W, PS, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T5.Z, PV.W, T6.W, BS:VEC_102/SCL_221
; EG-NEXT:     SETE_INT T10.W, PV.Z, T7.W,
; EG-NEXT:     SETGE_UINT * T12.W, PV.Z, T7.W,
; EG-NEXT:    27(3.783506e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT T2.X, PV.W, PS, PV.Z,
; EG-NEXT:     SUB_INT T4.Y, T9.W, T6.W,
; EG-NEXT:     BIT_ALIGN_INT T5.Z, PV.Y, T13.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T10.W, T2.Y, PV.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT * T12.W, T5.X, T11.W, T3.X,
; EG-NEXT:     LSHL T1.X, PV.W, 1,
; EG-NEXT:     SETGE_UINT T2.Y, T10.W, T2.W,
; EG-NEXT:     SETE_INT T7.Z, T5.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT * T13.W, T5.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T14.W, T2.X, T9.W, T4.Y,
; EG-NEXT:     BFE_UINT T3.X, T3.Z, literal.x, 1,
; EG-NEXT:     LSHL T3.Y, PV.W, 1,
; EG-NEXT:     SUBB_UINT T8.Z, T11.W, T4.W,
; EG-NEXT:     CNDE_INT * T11.W, T7.Z, T13.W, T2.Y, BS:VEC_120/SCL_212
; EG-NEXT:    25(3.503246e-44), 0(0.000000e+00)
; EG-NEXT:     SUB_INT * T13.W, T10.W, T2.W,
; EG-NEXT:     SUBB_UINT T4.X, T10.W, T2.W,
; EG-NEXT:     SUB_INT * T2.Y, T5.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUBB_UINT T7.Z, T9.W, T6.W,
; EG-NEXT:     SUB_INT * T9.W, T6.Z, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T10.W, T11.W, T10.W, T13.W,
; EG-NEXT:     SUB_INT T6.X, T4.Z, T1.Y,
; EG-NEXT:     LSHL T4.Y, PV.W, 1,
; EG-NEXT:     BFE_UINT T9.Z, T0.X, literal.x, 1,
; EG-NEXT:     SUB_INT T9.W, T9.W, T7.Z,
; EG-NEXT:     SUB_INT * T13.W, T2.Y, T4.X,
; EG-NEXT:    26(3.643376e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_UINT T4.X, T2.Z, literal.x, 1,
...
; EG-NEXT:     SUB_INT * T11.W, T6.X, T8.Z,
; EG-NEXT:     CNDE_INT T2.X, T5.X, T4.Z, PV.W,
; EG-NEXT:     SETGE_UINT T4.Y, T9.W, T2.W,
; EG-NEXT:     BIT_ALIGN_INT * T4.Z, T5.Z, T14.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     BIT_ALIGN_INT T10.W, T2.Y, T10.W, literal.x,
; EG-NEXT:     OR_INT * T11.W, T3.Y, T4.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETE_INT T4.X, PV.W, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T2.Y, PV.W, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T5.Z, PS, T6.W, BS:VEC_102/SCL_221
; EG-NEXT:     SETE_INT T13.W, T4.Z, T7.W,
; EG-NEXT:     SETGE_UINT * T14.W, T4.Z, T7.W,
; EG-NEXT:     CNDE_INT T5.X, PV.W, PS, PV.Z,
; EG-NEXT:     CNDE_INT T2.Y, PV.X, PV.Y, T4.Y,
; EG-NEXT:     SUB_INT T5.Z, T9.W, T2.W,
; EG-NEXT:     BIT_ALIGN_INT T12.W, T2.X, T12.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T13.W, T1.X, T3.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SUBB_UINT * T1.X, T9.W, T2.W,
; EG-NEXT:     SUB_INT * T3.Y, T10.W, T8.W,
; EG-NEXT:     SETGE_UINT T6.Z, T13.W, T4.W,
; EG-NEXT:     SETE_INT T14.W, T12.W, T1.Y, BS:VEC_201
; EG-NEXT:     SETGE_UINT * T15.W, T12.W, T1.Y,
; EG-NEXT:     SUBB_UINT T2.X, T13.W, T4.W,
; EG-NEXT:     CNDE_INT T4.Y, PV.W, PS, PV.Z,
; EG-NEXT:     SUB_INT * T6.Z, T13.W, T4.W,
; EG-NEXT:    ALU clause starting at 950:
; EG-NEXT:     SUB_INT T14.W, T3.Y, T1.X,
; EG-NEXT:     CNDE_INT * T9.W, T2.Y, T9.W, T5.Z,
; EG-NEXT:     SUB_INT T1.X, T12.W, T1.Y,
; EG-NEXT:     LSHL T3.Y, PS, 1,
...
; EG-NEXT:     CNDE_INT * T12.W, T5.X, T11.W, T3.X,
; EG-NEXT:     LSHL T1.X, PV.W, 1,
; EG-NEXT:     SETGE_UINT T2.Y, T10.W, T4.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETE_INT T7.Z, T5.Z, T1.Y,
; EG-NEXT:     SETGE_UINT T13.W, T5.Z, T1.Y,
; EG-NEXT:     CNDE_INT * T14.W, T2.X, T9.W, T4.Y,
; EG-NEXT:     BFE_UINT T3.X, T2.Z, literal.x, 1,
; EG-NEXT:     LSHL T3.Y, PS, 1,
; EG-NEXT:     SUBB_UINT T8.Z, T11.W, T6.W,
; EG-NEXT:     CNDE_INT * T11.W, PV.Z, PV.W, PV.Y,
; EG-NEXT:    25(3.503246e-44), 0(0.000000e+00)
; EG-NEXT:     SUB_INT * T13.W, T10.W, T4.W,
; EG-NEXT:     SUBB_UINT T4.X, T10.W, T4.W,
; EG-NEXT:     SUB_INT * T2.Y, T5.Z, T1.Y,
; EG-NEXT:     SUBB_UINT T7.Z, T9.W, T2.W,
; EG-NEXT:     SUB_INT * T9.W, T6.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T10.W, T11.W, T10.W, T13.W,
; EG-NEXT:     SUB_INT T6.X, T4.Z, T7.W,
; EG-NEXT:     LSHL T4.Y, PV.W, 1,
; EG-NEXT:     BFE_UINT T9.Z, T3.Z, literal.x, 1, BS:VEC_120/SCL_212
; EG-NEXT:     SUB_INT T9.W, T9.W, T7.Z, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT * T13.W, T2.Y, T4.X,
; EG-NEXT:    23(3.222986e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_UINT T4.X, T0.X, literal.x, 1,
; EG-NEXT:     CNDE_INT T2.Y, T11.W, T5.Z, PS, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT T5.Z, T2.X, T6.Z, PV.W, BS:VEC_102/SCL_221
; EG-NEXT:     OR_INT T9.W, PV.Y, PV.Z,
; EG-NEXT:     SUB_INT * T11.W, PV.X, T8.Z,
; EG-NEXT:    24(3.363116e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT T2.X, T5.X, T4.Z, PS,
; EG-NEXT:     SETGE_UINT T4.Y, PV.W, T4.W,
; EG-NEXT:     BIT_ALIGN_INT T4.Z, PV.Z, T14.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     BIT_ALIGN_INT T10.W, PV.Y, T10.W, literal.x, BS:VEC_102/SCL_221
; EG-NEXT:     OR_INT * T11.W, T3.Y, PV.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETE_INT T4.X, PV.W, T1.Y,
; EG-NEXT:     SETGE_UINT T2.Y, PV.W, T1.Y,
; EG-NEXT:     SETGE_UINT T5.Z, PS, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETE_INT T13.W, PV.Z, T8.W,
; EG-NEXT:     SETGE_UINT * T14.W, PV.Z, T8.W,
; EG-NEXT:     CNDE_INT T5.X, PV.W, PS, PV.Z,
; EG-NEXT:     CNDE_INT T2.Y, PV.X, PV.Y, T4.Y,
; EG-NEXT:     SUB_INT T5.Z, T9.W, T4.W,
; EG-NEXT:     BIT_ALIGN_INT T12.W, T2.X, T12.W, literal.x, BS:VEC_021/SCL_122
...
; EG-NEXT:     CNDE_INT * T11.W, T7.Z, T13.W, T2.Y, BS:VEC_021/SCL_122
; EG-NEXT:    23(3.222986e-44), 0(0.000000e+00)
; EG-NEXT:    ALU clause starting at 1065:
; EG-NEXT:     SUB_INT * T13.W, T10.W, T6.W,
; EG-NEXT:     SUBB_UINT T4.X, T10.W, T6.W,
; EG-NEXT:     SUB_INT * T2.Y, T5.Z, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUBB_UINT T7.Z, T9.W, T4.W,
...
; EG-NEXT:     SUB_INT T6.X, T4.Z, T8.W,
; EG-NEXT:     LSHL T4.Y, PV.W, 1,
; EG-NEXT:     BFE_UINT T9.Z, T2.Z, literal.x, 1, BS:VEC_120/SCL_212
; EG-NEXT:     SUB_INT T9.W, T9.W, T7.Z, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT * T13.W, T2.Y, T4.X,
; EG-NEXT:    23(3.222986e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_UINT T4.X, T3.Z, literal.x, 1,
...
; EG-NEXT:     LSHL T3.Y, PS, 1,
; EG-NEXT:     SUBB_UINT T8.Z, T11.W, T2.W,
; EG-NEXT:     CNDE_INT * T11.W, PV.Z, PV.W, T2.Y,
; EG-NEXT:    18(2.522337e-44), 0(0.000000e+00)
; EG-NEXT:     SUB_INT * T13.W, T10.W, T6.W,
; EG-NEXT:     SUBB_UINT T4.X, T10.W, T6.W,
; EG-NEXT:     SUB_INT * T2.Y, T5.Z, T7.W, BS:VEC_021/SCL_122
...
; EG-NEXT:     OR_INT * T11.W, T3.Y, T4.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETE_INT T4.X, PV.W, T8.W,
; EG-NEXT:     SETGE_UINT T2.Y, PV.W, T8.W,
; EG-NEXT:     SETGE_UINT * T5.Z, PS, T6.W, BS:VEC_021/SCL_122
; EG-NEXT:    ALU clause starting at 1412:
; EG-NEXT:     SETE_INT T13.W, T4.Z, T7.W,
; EG-NEXT:     SETGE_UINT * T14.W, T4.Z, T7.W,
; EG-NEXT:     CNDE_INT T5.X, PV.W, PS, T5.Z,
; EG-NEXT:     CNDE_INT T2.Y, T4.X, T2.Y, T4.Y,
; EG-NEXT:     SUB_INT T5.Z, T9.W, T2.W,
; EG-NEXT:     BIT_ALIGN_INT * T12.W, T2.X, T12.W, literal.x, BS:VEC_120/SCL_212
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     OR_INT * T13.W, T1.X, T3.X,
; EG-NEXT:     SUBB_UINT * T1.X, T9.W, T2.W,
; EG-NEXT:     SUB_INT * T3.Y, T10.W, T8.W,
...
; EG-NEXT:     SETGE_UINT * T12.W, PV.Z, T1.Y,
; EG-NEXT:    14(1.961818e-44), 0(0.000000e+00)
; EG-NEXT:    ALU clause starting at 1527:
; EG-NEXT:     CNDE_INT * T2.X, T10.W, T12.W, T5.Z,
; EG-NEXT:     SUB_INT T4.Y, T9.W, T4.W,
; EG-NEXT:     BIT_ALIGN_INT T5.Z, T3.Y, T13.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T10.W, T2.Y, T1.X, BS:VEC_120/SCL_212
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT * T12.W, T5.X, T11.W, T3.X,
; EG-NEXT:     LSHL T1.X, PV.W, 1,
; EG-NEXT:     SETGE_UINT T2.Y, T10.W, T6.W,
...
; EG-NEXT:     CNDE_INT T2.X, T5.X, T4.Z, PV.W,
; EG-NEXT:     SETGE_UINT * T4.Y, T9.W, T2.W,
; EG-NEXT:    ALU clause starting at 1643:
; EG-NEXT:     BIT_ALIGN_INT T4.Z, T5.Z, T14.W, literal.x,
; EG-NEXT:     BIT_ALIGN_INT T10.W, T2.Y, T10.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T11.W, T3.Y, T4.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETE_INT T4.X, PV.W, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T2.Y, PV.W, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T5.Z, PS, T6.W, BS:VEC_102/SCL_221
; EG-NEXT:     SETE_INT T13.W, PV.Z, T7.W,
; EG-NEXT:     SETGE_UINT * T14.W, PV.Z, T7.W,
; EG-NEXT:     CNDE_INT T5.X, PV.W, PS, PV.Z,
; EG-NEXT:     CNDE_INT T2.Y, PV.X, PV.Y, T4.Y,
; EG-NEXT:     SUB_INT T5.Z, T9.W, T2.W,
; EG-NEXT:     BIT_ALIGN_INT T12.W, T2.X, T12.W, literal.x, BS:VEC_021/SCL_122
...
; EG-NEXT:     BIT_ALIGN_INT * T6.Z, T10.W, T9.W, literal.x,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:    ALU clause starting at 1757:
; EG-NEXT:     OR_INT T9.W, T3.Y, T5.Z,
; EG-NEXT:     SUB_INT * T10.W, T1.X, T2.X,
; EG-NEXT:     BFE_UINT T1.X, T2.Z, literal.x, 1,
; EG-NEXT:     CNDE_INT T3.Y, T4.Y, T12.W, PS,
; EG-NEXT:     SETGE_UINT T5.Z, PV.W, T4.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETE_INT T10.W, T6.Z, T1.Y, BS:VEC_120/SCL_212
; EG-NEXT:     SETGE_UINT * T12.W, T6.Z, T1.Y,
; EG-NEXT:    9(1.261169e-44), 0(0.000000e+00)
; EG-NEXT:     CNDE_INT T2.X, PV.W, PS, PV.Z,
; EG-NEXT:     SUB_INT T4.Y, T9.W, T4.W,
; EG-NEXT:     BIT_ALIGN_INT T5.Z, PV.Y, T13.W, literal.x, BS:VEC_021/SCL_122
...
; EG-NEXT:     SUB_INT * T13.W, T2.Y, T4.X,
; EG-NEXT:    6(8.407791e-45), 0(0.000000e+00)
; EG-NEXT:    ALU clause starting at 1873:
; EG-NEXT:     BFE_UINT T4.X, T2.Z, literal.x, 1,
; EG-NEXT:     CNDE_INT T2.Y, T11.W, T5.Z, T13.W,
; EG-NEXT:     CNDE_INT * T5.Z, T2.X, T6.Z, T9.W, BS:VEC_021/SCL_122
; EG-NEXT:    6(8.407791e-45), 0(0.000000e+00)
; EG-NEXT:     OR_INT T9.W, T4.Y, T9.Z, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT * T11.W, T6.X, T8.Z,
; EG-NEXT:     CNDE_INT T2.X, T5.X, T4.Z, PS,
; EG-NEXT:     SETGE_UINT T4.Y, PV.W, T2.W,
; EG-NEXT:     BIT_ALIGN_INT T4.Z, T5.Z, T14.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     BIT_ALIGN_INT T10.W, T2.Y, T10.W, literal.x, BS:VEC_102/SCL_221
; EG-NEXT:     OR_INT * T11.W, T3.Y, T4.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETE_INT T4.X, PV.W, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T2.Y, PV.W, T8.W, BS:VEC_021/SCL_122
...
; EG-NEXT:     SUB_INT T1.X, T12.W, T7.W,
; EG-NEXT:     LSHL * T3.Y, PS, 1,
; EG-NEXT:    ALU clause starting at 1987:
; EG-NEXT:     BFE_UINT T5.Z, T3.Z, literal.x, 1, BS:VEC_120/SCL_212
; EG-NEXT:     CNDE_INT T10.W, T2.Y, T10.W, T14.W, BS:VEC_120/SCL_212
; EG-NEXT:     CNDE_INT * T13.W, T4.Y, T13.W, T6.Z,
; EG-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; EG-NEXT:     SUB_INT T3.X, T11.W, T2.W,
; EG-NEXT:     LSHL T2.Y, PS, 1,
; EG-NEXT:     BIT_ALIGN_INT T6.Z, PV.W, T9.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT T9.W, T3.Y, PV.Z,
; EG-NEXT:     SUB_INT * T10.W, T1.X, T2.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     BFE_UINT T1.X, T2.Z, literal.x, 1,
; EG-NEXT:     CNDE_INT T3.Y, T4.Y, T12.W, PS,
...
; EG-NEXT:     SUB_INT * T13.W, T2.Y, T4.X,
; EG-NEXT:    3(4.203895e-45), 0(0.000000e+00)
; EG-NEXT:     BFE_UINT T4.X, T3.Z, 1, 1,
; EG-NEXT:     CNDE_INT T2.Y, T11.W, T5.Z, PS,
; EG-NEXT:     CNDE_INT T5.Z, T2.X, T6.Z, PV.W, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T9.W, PV.Y, PV.Z,
; EG-NEXT:     SUB_INT * T11.W, T6.X, T8.Z,
...
; EG-NEXT:     SETGE_UINT * T13.W, T5.Z, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T14.W, T2.X, T9.W, T4.Y,
; EG-NEXT:     AND_INT T3.X, T3.Z, 1,
; EG-NEXT:     LSHL T3.Y, PV.W, 1,
; EG-NEXT:     SUBB_UINT T3.Z, T11.W, T4.W,
; EG-NEXT:     CNDE_INT * T11.W, T7.Z, T13.W, T2.Y, BS:VEC_120/SCL_212
; EG-NEXT:     SUB_INT * T13.W, T10.W, T2.W,
; EG-NEXT:     SUBB_UINT T4.X, T10.W, T2.W,
; EG-NEXT:     SUB_INT * T2.Y, T5.Z, T8.W, BS:VEC_021/SCL_122
...
; EG-NEXT:     SUB_INT * T9.W, T6.Z, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T10.W, T11.W, T10.W, T13.W,
; EG-NEXT:    ALU clause starting at 2103:
; EG-NEXT:     SUB_INT T6.X, T4.Z, T1.Y,
; EG-NEXT:     LSHL T4.Y, T10.W, 1,
; EG-NEXT:     BFE_UINT T8.Z, T0.X, 1, 1,
; EG-NEXT:     SUB_INT T9.W, T9.W, T7.Z, BS:VEC_120/SCL_212
; EG-NEXT:     SUB_INT * T13.W, T2.Y, T4.X,
; EG-NEXT:     BFE_UINT T4.X, T2.Z, 1, 1,
; EG-NEXT:     CNDE_INT T2.Y, T11.W, T5.Z, PS,
; EG-NEXT:     CNDE_INT T5.Z, T2.X, T6.Z, PV.W, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T9.W, PV.Y, PV.Z,
; EG-NEXT:     SUB_INT * T11.W, T6.X, T3.Z,
; EG-NEXT:     CNDE_INT T2.X, T5.X, T4.Z, PV.W,
; EG-NEXT:     SETGE_UINT T4.Y, T9.W, T2.W,
; EG-NEXT:     BIT_ALIGN_INT * T3.Z, T5.Z, T14.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     BIT_ALIGN_INT T10.W, T2.Y, T10.W, literal.x,
; EG-NEXT:     OR_INT * T11.W, T3.Y, T4.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETE_INT T4.X, PV.W, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T2.Y, PV.W, T8.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT T4.Z, PS, T6.W, BS:VEC_102/SCL_221
; EG-NEXT:     SETE_INT T13.W, T3.Z, T7.W,
; EG-NEXT:     SETGE_UINT * T14.W, T3.Z, T7.W,
; EG-NEXT:     CNDE_INT T5.X, PV.W, PS, PV.Z,
; EG-NEXT:     SUB_INT T3.Y, T11.W, T6.W,
; EG-NEXT:     CNDE_INT T4.Z, PV.X, PV.Y, T4.Y,
; EG-NEXT:     BIT_ALIGN_INT T12.W, T2.X, T12.W, literal.x, BS:VEC_021/SCL_122
; EG-NEXT:     OR_INT * T13.W, T1.X, T3.X,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETGE_UINT T1.X, PS, T4.W,
; EG-NEXT:     SETE_INT T2.Y, PV.W, T1.Y,
; EG-NEXT:     SETGE_UINT T5.Z, PV.W, T1.Y,
; EG-NEXT:     SUBB_UINT T14.W, PS, T4.W,
; EG-NEXT:     SUB_INT * T15.W, PV.W, T1.Y,
; EG-NEXT:     SUB_INT T2.X, T9.W, T2.W,
; EG-NEXT:     SUBB_UINT * T1.Y, T9.W, T2.W,
; EG-NEXT:     SUB_INT * T6.Z, T10.W, T8.W,
; EG-NEXT:     SUB_INT T14.W, T15.W, T14.W,
; EG-NEXT:     CNDE_INT * T15.W, T2.Y, T5.Z, T1.X,
; EG-NEXT:     SUBB_UINT T1.X, T11.W, T6.W,
; EG-NEXT:     CNDE_INT T2.Y, PS, T12.W, PV.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT * T5.Z, T6.Z, T1.Y,
; EG-NEXT:     CNDE_INT T9.W, T4.Z, T9.W, T2.X, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T11.W, T5.X, T11.W, T3.Y,
; EG-NEXT:     LSHL T2.X, PS, 1,
; EG-NEXT:     AND_INT T1.Y, T2.Z, 1, BS:VEC_120/SCL_212
; EG-NEXT:     LSHL T2.Z, PV.W, 1,
; EG-NEXT:     AND_INT T12.W, T0.X, 1,
; EG-NEXT:     CNDE_INT * T10.W, T4.Z, T10.W, T5.Z,
; EG-NEXT:     SUB_INT T0.X, T3.Z, T7.W, BS:VEC_021/SCL_122
; EG-NEXT:     BIT_ALIGN_INT T3.Y, PS, T9.W, literal.x, BS:VEC_102/SCL_221
; EG-NEXT:     OR_INT T2.Z, PV.Z, PV.W,
; EG-NEXT:     OR_INT T9.W, PV.X, PV.Y,
; EG-NEXT:     XOR_INT * T10.W, T2.Y, T5.W,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SUB_INT T2.X, PS, T5.W,
; EG-NEXT:     SUB_INT T1.Y, PV.W, T6.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETGE_UINT * T4.Z, PV.Z, T2.W, BS:VEC_102/SCL_221
; EG-NEXT:     SETE_INT T10.W, T3.Y, T8.W,
; EG-NEXT:     SUB_INT * T12.W, T0.X, T1.X,
; EG-NEXT:     SETGE_UINT T0.X, T3.Y, T8.W,
; EG-NEXT:     CNDE_INT T2.Y, T5.X, T3.Z, PS,
; EG-NEXT:     SUBB_UINT T3.Z, T2.Z, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT * T8.W, T3.Y, T8.W,
; EG-NEXT:     SUB_INT * T4.W, T13.W, T4.W,
; EG-NEXT:     CNDE_INT T1.X, T15.W, T13.W, PV.W,
; EG-NEXT:     SUB_INT * T4.Y, T2.Z, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT T3.Z, T8.W, T3.Z,
; EG-NEXT:     BIT_ALIGN_INT T2.W, T2.Y, T11.W, literal.x,
; EG-NEXT:     CNDE_INT * T4.W, T10.W, T0.X, T4.Z,
; EG-NEXT:    31(4.344025e-44), 0(0.000000e+00)
; EG-NEXT:     SETGE_UINT T0.X, T9.W, T6.W, BS:VEC_021/SCL_122
; EG-NEXT:     SETE_INT T2.Y, PV.W, T7.W,
; EG-NEXT:     SETGE_UINT T4.Z, PV.W, T7.W,
; EG-NEXT:     SUBB_UINT T6.W, T9.W, T6.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT * T7.W, PV.W, T7.W,
; EG-NEXT:     SUB_INT T3.X, PS, PV.W,
; EG-NEXT:     CNDE_INT T2.Y, PV.Y, PV.Z, PV.X,
; EG-NEXT:     CNDE_INT T3.Z, T4.W, T3.Y, T3.Z,
; EG-NEXT:     CNDE_INT T4.W, T4.W, T2.Z, T4.Y,
; EG-NEXT:     XOR_INT * T6.W, T1.X, T5.W,
; EG-NEXT:     SUBB_UINT T0.X, PS, T5.W,
; EG-NEXT:     XOR_INT T3.Y, PV.W, T1.W, BS:VEC_021/SCL_122
; EG-NEXT:     XOR_INT T2.Z, PV.Z, T1.W, BS:VEC_021/SCL_122
; EG-NEXT:     CNDE_INT * T2.W, PV.Y, T2.W, PV.X, BS:VEC_102/SCL_221
; EG-NEXT:     CNDE_INT * T4.W, T2.Y, T9.W, T1.Y,
; EG-NEXT:     XOR_INT T1.X, PV.W, T3.W,
; EG-NEXT:     XOR_INT T1.Y, T2.W, T3.W,
; EG-NEXT:     SUB_INT T2.Z, T2.Z, T1.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUBB_UINT T2.W, T3.Y, T1.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT * T4.W, T2.X, T0.X,
; EG-NEXT:     SUB_INT T4.Y, PV.Z, PV.W,
; EG-NEXT:     SUB_INT T2.Z, PV.Y, T3.W,
; EG-NEXT:     SUBB_UINT T2.W, PV.X, T3.W,
; EG-NEXT:     SUB_INT * T7.W, T0.Y, T1.Z,
; EG-NEXT:     SUB_INT T7.Y, PV.Z, PV.W,
; EG-NEXT:     SUB_INT * T4.Z, T6.W, T5.W,
; EG-NEXT:     SUB_INT T4.X, T3.Y, T1.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT T7.Z, T0.Z, T0.W, BS:VEC_102/SCL_221
; EG-NEXT:     SUB_INT * T7.X, T1.X, T3.W,
; EG-NEXT:     LSHR * T0.X, KC0[2].Y, literal.x,
; EG-NEXT:    2(2.802597e-45), 0(0.000000e+00)
...
; EG-NEXT:    31(4.344025e-44), 30(4.203895e-44)
; EG-NEXT:    -4(nan), 0(0.000000e+00)
; EG-NEXT:     SUBB_UINT T2.X, T1.Z, PS,
; EG-NEXT:     ADD_INT T0.Y, T0.Z, PV.W, BS:VEC_120/SCL_212
; EG-NEXT:     LSHR T2.Z, PV.Z, literal.x,
; EG-NEXT:     ASHR T3.W, T1.Y, literal.y,
; EG-NEXT:     ADDC_UINT * T1.W, T1.Z, T1.W,
; EG-NEXT:    30(4.203895e-44), 31(4.344025e-44)
; EG-NEXT:     BFE_INT T3.X, PS, 0.0, 1,
; EG-NEXT:     LSHR T1.Y, PV.W, literal.x,
; EG-NEXT:     ADD_INT T3.Z, T0.X, PV.Z,
; EG-NEXT:     ADDC_UINT T0.W, T0.Z, T0.W,
; EG-NEXT:     AND_INT * T1.W, PV.Y, literal.y,
; EG-NEXT:    30(4.203895e-44), -4(nan)
; EG-NEXT:     SUBB_UINT T4.X, T0.Z, PS,
; EG-NEXT:     BFE_INT T0.Y, PV.W, 0.0, 1,
; EG-NEXT:     ADDC_UINT T2.Z, T0.X, T2.Z,
; EG-NEXT:     AND_INT T0.W, PV.Z, literal.x,
; EG-NEXT:     ADD_INT * T3.W, T1.X, PV.Y,
; EG-NEXT:    -4(nan), 0(0.000000e+00)
; EG-NEXT:     ADDC_UINT T5.X, T1.X, T1.Y,
; EG-NEXT:     AND_INT T1.Y, PS, literal.x,
; EG-NEXT:     SUBB_UINT T3.Z, T0.X, PV.W, BS:VEC_120/SCL_212
; EG-NEXT:     BFE_INT T3.W, PV.Z, 0.0, 1,
; EG-NEXT:     SUB_INT * T4.W, PV.Y, PV.X,
; EG-NEXT:    -4(nan), 0(0.000000e+00)
; EG-NEXT:     SUB_INT T4.Y, PV.W, PV.Z,
; EG-NEXT:     SUBB_UINT T2.Z, T1.X, PV.Y,
; EG-NEXT:     BFE_INT T3.W, PV.X, 0.0, 1,
; EG-NEXT:     SUB_INT * T5.W, T3.X, T2.X,
; EG-NEXT:     SUB_INT T5.Y, PV.W, PV.Z,
; EG-NEXT:     SUB_INT * T4.Z, T0.Z, T1.W,
; EG-NEXT:     SUB_INT T4.X, T0.X, T0.W,
; EG-NEXT:     SUB_INT T5.Z, T1.Z, T2.W, BS:VEC_021/SCL_122
; EG-NEXT:     SUB_INT * T5.X, T1.X, T1.Y,
; EG-NEXT:     LSHR * T0.X, KC0[2].Y, literal.x,
; EG-NEXT:    2(2.802597e-45), 0(0.000000e+00)
; EG-NEXT:     ADD_INT * T1.X, PV.X, literal.x,
; EG-NEXT:    4(5.605194e-45), 0(0.000000e+00)
