...
; GCN-NEXT:    s_mul_i32 s13, s1, s14
; GCN-NEXT:    v_readfirstlane_b32 s17, v2
; GCN-NEXT:    s_mul_i32 s15, s4, s12
; GCN-NEXT:    s_mul_i32 s16, s1, s12
...
; GCN-NEXT:    s_mul_i32 s13, s14, s13
; GCN-NEXT:    s_add_u32 s13, s15, s13
; GCN-NEXT:    s_addc_u32 s15, 0, s16
; GCN-NEXT:    s_add_u32 s16, s12, s13
...
; GCN-NEXT:    s_mul_i32 s12, s1, s14
; GCN-NEXT:    v_readfirstlane_b32 s13, v0
; GCN-NEXT:    s_add_i32 s12, s13, s12
; GCN-NEXT:    s_mul_i32 s4, s4, s16
; GCN-NEXT:    s_mul_i32 s1, s1, s16
; GCN-NEXT:    s_add_i32 s4, s12, s4
...
; GCN-NEXT:    s_mul_i32 s4, s14, s4
; GCN-NEXT:    s_add_u32 s1, s1, s4
; GCN-NEXT:    s_addc_u32 s4, 0, s12
; GCN-NEXT:    s_add_u32 s15, s16, s1
; GCN-NEXT:    s_cselect_b64 s[12:13], -1, 0
; GCN-NEXT:    s_or_b32 s1, s12, s13
; GCN-NEXT:    s_cmp_lg_u32 s1, 0
; GCN-NEXT:    s_addc_u32 s4, s14, s4
...
; GCN-NEXT:    s_add_u32 s5, s5, s15
; GCN-NEXT:    s_addc_u32 s5, s14, s16
...
; GCN-NEXT:    s_add_u32 s17, s4, 2
; GCN-NEXT:    s_addc_u32 s20, s5, 0
; GCN-NEXT:    s_cmp_lg_u32 s16, 0
; GCN-NEXT:    s_cselect_b32 s14, s17, s14
; GCN-NEXT:    s_cselect_b32 s15, s20, s15
; GCN-NEXT:    s_cmp_lg_u32 s19, 0
...
; GCN-IR-NEXT:    s_and_b64 s[12:13], s[16:17], s[18:19]
