...
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[8:9], v[16:19], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v[8:9], v[16:19], off sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
...
; VGPRRC-NEXT:    v_mov_b32_e32 v48, s20
; VGPRRC-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[32:35], v[36:39], v[0:15]
; VGPRRC-NEXT:    v_mov_b32_e32 v49, s21
; VGPRRC-NEXT:    v_mov_b32_e32 v50, s22
; VGPRRC-NEXT:    v_mov_b32_e32 v51, s23
; VGPRRC-NEXT:    s_nop 7
; VGPRRC-NEXT:    s_nop 0
...
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[40:41], v[48:51], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
