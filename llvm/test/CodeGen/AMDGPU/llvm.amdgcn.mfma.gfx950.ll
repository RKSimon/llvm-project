...
; SDAG-NEXT:    v_mov_b64_e32 v[0:1], 32
; SDAG-NEXT:    v_mov_b64_e32 v[2:3], 16
; SDAG-NEXT:    v_mov_b64_e32 v[4:5], 0
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mov_b64_e32 v[6:7], s[24:25]
; SDAG-NEXT:    v_mov_b64_e32 v[8:9], s[26:27]
; SDAG-NEXT:    v_mov_b64_e32 v[10:11], s[28:29]
; SDAG-NEXT:    v_accvgpr_write_b32 a0, s8
; SDAG-NEXT:    v_mov_b64_e32 v[12:13], s[30:31]
...
; SDAG-NEXT:    v_mfma_f32_32x32x16_f16 a[16:31], v[6:9], v[10:13], a[0:15]
...
; SDAG-NEXT:    s_nop 5
; SDAG-NEXT:    global_store_dwordx4 v[0:1], a[28:31], off offset:16 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[0:1], a[24:27], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[2:3], a[20:23], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[4:5], a[16:19], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[0:1], v[14:17], off offset:16 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[0:1], v[6:9], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; SDAG-NEXT:    global_store_dwordx4 v[2:3], v[6:9], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; SDAG-NEXT:    v_mov_b32_e32 v14, s20
; SDAG-NEXT:    v_mov_b32_e32 v15, s21
; SDAG-NEXT:    v_mfma_f32_32x32x16_f16 a[16:31], v[6:9], v[10:13], a[0:15] cbsz:2 abid:3 blgp:1
; SDAG-NEXT:    v_mov_b32_e32 v16, s22
; SDAG-NEXT:    v_mov_b32_e32 v17, s23
; SDAG-NEXT:    v_mov_b32_e32 v6, s16
; SDAG-NEXT:    v_mov_b32_e32 v7, s17
...
; SDAG-NEXT:    v_accvgpr_write_b32 a15, s23
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_i32_32x32x32_i8 a[16:31], v[4:7], v[8:11], a[0:15]
; SDAG-NEXT:    v_mov_b64_e32 v[4:5], 0
...
; SDAG-NEXT:    global_store_dwordx4 v[4:5], a[16:19], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[0:1], v[6:9], off offset:16 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    s_nop 0
; SDAG-NEXT:    v_mov_b32_e32 v6, s16
; SDAG-NEXT:    v_mov_b32_e32 v7, s17
...
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[2:5], off offset:16 sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    s_nop 0
...
; SDAG-NEXT:    v_accvgpr_write_b32 a15, s23
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_i32_32x32x32_i8 a[16:31], v[4:7], v[8:11], a[0:15] cbsz:2 abid:3 blgp:1
; SDAG-NEXT:    v_mov_b64_e32 v[4:5], 0
; SDAG-NEXT:    v_mov_b32_e32 v6, s20
; SDAG-NEXT:    v_mov_b32_e32 v7, s21
; SDAG-NEXT:    v_mov_b32_e32 v8, s22
