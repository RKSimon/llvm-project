...
; SDAG-NEXT:    v_mov_b64_e32 v[32:33], 32
; SDAG-NEXT:    v_mov_b64_e32 v[34:35], 16
; SDAG-NEXT:    v_mov_b64_e32 v[36:37], 0
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; SDAG-NEXT:    v_mov_b32_e32 v50, s16
; SDAG-NEXT:    v_mov_b32_e32 v51, s17
; SDAG-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[38:41], v[42:45], v[0:15]
; SDAG-NEXT:    v_mov_b32_e32 v52, s18
; SDAG-NEXT:    v_mov_b32_e32 v53, s19
; SDAG-NEXT:    v_mov_b32_e32 v46, s20
; SDAG-NEXT:    v_mov_b32_e32 v47, s21
; SDAG-NEXT:    v_mov_b32_e32 v48, s22
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mov_b32_e32 v0, s12
; SDAG-NEXT:    v_mov_b32_e32 v1, s13
; SDAG-NEXT:    v_mov_b32_e32 v2, s14
; SDAG-NEXT:    v_mov_b32_e32 v3, s15
; SDAG-NEXT:    v_mov_b32_e32 v49, s23
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[28:31], off offset:16 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[24:27], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[34:35], v[20:23], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[36:37], v[16:19], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[46:49], off offset:16 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[50:53], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; HEURRC-NEXT:    v_mov_b64_e32 v[0:1], 32
; HEURRC-NEXT:    v_mov_b64_e32 v[2:3], 16
; HEURRC-NEXT:    v_mov_b64_e32 v[4:5], 0
; HEURRC-NEXT:    s_waitcnt lgkmcnt(0)
...
; HEURRC-NEXT:    v_mov_b32_e32 v18, s16
; HEURRC-NEXT:    v_mov_b32_e32 v19, s17
; HEURRC-NEXT:    v_mfma_f32_32x32x16_f16 a[16:31], v[6:9], v[10:13], a[0:15]
; HEURRC-NEXT:    v_mov_b32_e32 v20, s18
; HEURRC-NEXT:    v_mov_b32_e32 v21, s19
...
; HEURRC-NEXT:    v_mov_b32_e32 v14, s20
; HEURRC-NEXT:    v_mov_b32_e32 v15, s21
; HEURRC-NEXT:    v_mov_b32_e32 v16, s22
; HEURRC-NEXT:    v_mov_b32_e32 v17, s23
; HEURRC-NEXT:    s_nop 1
; HEURRC-NEXT:    global_store_dwordx4 v[0:1], a[28:31], off offset:16 sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v[0:1], a[24:27], off sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v[2:3], a[20:23], off sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v[4:5], a[16:19], off sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v[0:1], v[14:17], off offset:16 sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v[0:1], v[18:21], off sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v[2:3], v[6:9], off sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[32:33], 32
; VGPRRC-NEXT:    v_mov_b64_e32 v[34:35], 16
; VGPRRC-NEXT:    v_mov_b64_e32 v[36:37], 0
; VGPRRC-NEXT:    s_waitcnt lgkmcnt(0)
...
; VGPRRC-NEXT:    v_mov_b32_e32 v50, s16
; VGPRRC-NEXT:    v_mov_b32_e32 v51, s17
; VGPRRC-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[38:41], v[42:45], v[0:15]
; VGPRRC-NEXT:    v_mov_b32_e32 v52, s18
; VGPRRC-NEXT:    v_mov_b32_e32 v53, s19
; VGPRRC-NEXT:    v_mov_b32_e32 v46, s20
; VGPRRC-NEXT:    v_mov_b32_e32 v47, s21
; VGPRRC-NEXT:    v_mov_b32_e32 v48, s22
; VGPRRC-NEXT:    s_nop 1
...
; VGPRRC-NEXT:    v_mov_b32_e32 v49, s23
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[28:31], off offset:16 sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[24:27], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[34:35], v[20:23], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[36:37], v[16:19], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[46:49], off offset:16 sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[50:53], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
...
; SDAG-NEXT:    v_mov_b64_e32 v[0:1], s[8:9]
; SDAG-NEXT:    v_mov_b32_e32 v42, s28
; SDAG-NEXT:    v_mov_b32_e32 v43, s29
; SDAG-NEXT:    v_mov_b32_e32 v44, s30
; SDAG-NEXT:    v_mov_b32_e32 v45, s31
; SDAG-NEXT:    v_mov_b64_e32 v[2:3], s[10:11]
; SDAG-NEXT:    v_mov_b64_e32 v[4:5], s[12:13]
; SDAG-NEXT:    v_mov_b64_e32 v[6:7], s[14:15]
; SDAG-NEXT:    v_mov_b64_e32 v[8:9], s[16:17]
...
; SDAG-NEXT:    v_mov_b64_e32 v[14:15], s[22:23]
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_i32_32x32x32_i8 v[16:31], v[38:41], v[42:45], v[0:15]
; SDAG-NEXT:    s_nop 11
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[28:31], off offset:16 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[24:27], off sc0 sc1
...
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[0:3], off offset:16 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    s_nop 0
...
; HEURRC-NEXT:    v_accvgpr_write_b32 a0, s8
; HEURRC-NEXT:    v_mov_b32_e32 v10, s28
; HEURRC-NEXT:    v_mov_b32_e32 v11, s29
; HEURRC-NEXT:    v_mov_b32_e32 v12, s30
; HEURRC-NEXT:    v_mov_b32_e32 v13, s31
; HEURRC-NEXT:    v_accvgpr_write_b32 a1, s9
; HEURRC-NEXT:    v_accvgpr_write_b32 a2, s10
; HEURRC-NEXT:    v_accvgpr_write_b32 a3, s11
; HEURRC-NEXT:    v_accvgpr_write_b32 a4, s12
...
; HEURRC-NEXT:    v_accvgpr_write_b32 a15, s23
; HEURRC-NEXT:    s_nop 1
; HEURRC-NEXT:    v_mfma_i32_32x32x32_i8 a[16:31], v[6:9], v[10:13], a[0:15]
; HEURRC-NEXT:    v_mov_b32_e32 v6, s20
; HEURRC-NEXT:    v_mov_b32_e32 v7, s21
; HEURRC-NEXT:    v_mov_b32_e32 v8, s22
; HEURRC-NEXT:    v_mov_b32_e32 v9, s23
; HEURRC-NEXT:    s_nop 7
; HEURRC-NEXT:    global_store_dwordx4 v[0:1], a[28:31], off offset:16 sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v[0:1], a[24:27], off sc0 sc1
...
; HEURRC-NEXT:    global_store_dwordx4 v[4:5], a[16:19], off sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v[0:1], v[6:9], off offset:16 sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    s_nop 0
; HEURRC-NEXT:    v_mov_b32_e32 v6, s16
; HEURRC-NEXT:    v_mov_b32_e32 v7, s17
; HEURRC-NEXT:    v_mov_b32_e32 v8, s18
; HEURRC-NEXT:    v_mov_b32_e32 v9, s19
; HEURRC-NEXT:    global_store_dwordx4 v[0:1], v[6:9], off sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    v_mov_b32_e32 v0, s8
; HEURRC-NEXT:    v_mov_b32_e32 v1, s9
; HEURRC-NEXT:    v_mov_b32_e32 v6, s12
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[0:1], s[8:9]
; VGPRRC-NEXT:    v_mov_b32_e32 v42, s28
; VGPRRC-NEXT:    v_mov_b32_e32 v43, s29
; VGPRRC-NEXT:    v_mov_b32_e32 v44, s30
; VGPRRC-NEXT:    v_mov_b32_e32 v45, s31
; VGPRRC-NEXT:    v_mov_b64_e32 v[2:3], s[10:11]
; VGPRRC-NEXT:    v_mov_b64_e32 v[4:5], s[12:13]
; VGPRRC-NEXT:    v_mov_b64_e32 v[6:7], s[14:15]
; VGPRRC-NEXT:    v_mov_b64_e32 v[8:9], s[16:17]
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[14:15], s[22:23]
; VGPRRC-NEXT:    s_nop 1
; VGPRRC-NEXT:    v_mfma_i32_32x32x32_i8 v[16:31], v[38:41], v[42:45], v[0:15]
; VGPRRC-NEXT:    s_nop 11
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[28:31], off offset:16 sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[24:27], off sc0 sc1
...
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[0:3], off offset:16 sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    s_nop 0
...
; SDAG-NEXT:    v_mov_b64_e32 v[14:15], s[22:23]
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_i32_32x32x32_i8 v[16:31], v[38:41], v[42:45], v[0:15] cbsz:2 abid:3 blgp:1
; SDAG-NEXT:    s_nop 11
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[28:31], off offset:16 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[24:27], off sc0 sc1
...
; HEURRC-NEXT:    v_accvgpr_write_b32 a15, s23
; HEURRC-NEXT:    s_nop 1
; HEURRC-NEXT:    v_mfma_i32_32x32x32_i8 a[16:31], v[6:9], v[10:13], a[0:15] cbsz:2 abid:3 blgp:1
; HEURRC-NEXT:    v_mov_b32_e32 v6, s20
; HEURRC-NEXT:    v_mov_b32_e32 v7, s21
; HEURRC-NEXT:    v_mov_b32_e32 v8, s22
; HEURRC-NEXT:    v_mov_b32_e32 v9, s23
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[14:15], s[22:23]
; VGPRRC-NEXT:    s_nop 1
; VGPRRC-NEXT:    v_mfma_i32_32x32x32_i8 v[16:31], v[38:41], v[42:45], v[0:15] cbsz:2 abid:3 blgp:1
; VGPRRC-NEXT:    s_nop 11
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[28:31], off offset:16 sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[24:27], off sc0 sc1
