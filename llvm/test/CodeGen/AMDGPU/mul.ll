...
; GFX1250-NEXT:    s_mov_b32 s23, s4
; GFX1250-NEXT:    s_add_nc_u64 s[2:3], s[6:7], s[2:3]
; GFX1250-NEXT:    s_or_b64 s[4:5], s[14:15], s[22:23]
...
; GFX13-NEXT:    s_mov_b32 s21, s3
; GFX13-NEXT:    s_mov_b32 s22, s3
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_mov_b32 s2, s8
; GFX13-NEXT:    s_mov_b32 s16, s12
; GFX13-NEXT:    s_mov_b32 s6, s13
; GFX13-NEXT:    s_mul_u64 s[24:25], s[16:17], s[2:3]
; GFX13-NEXT:    s_mov_b32 s18, s9
; GFX13-NEXT:    s_mul_u64 s[8:9], s[8:9], s[14:15]
; GFX13-NEXT:    s_mul_u64 s[14:15], s[6:7], s[2:3]
; GFX13-NEXT:    s_mov_b32 s2, s25
; GFX13-NEXT:    s_mul_u64 s[10:11], s[10:11], s[12:13]
; GFX13-NEXT:    s_add_nc_u64 s[14:15], s[14:15], s[2:3]
; GFX13-NEXT:    s_mul_u64 s[12:13], s[16:17], s[18:19]
; GFX13-NEXT:    s_and_b64 s[4:5], s[14:15], s[4:5]
; GFX13-NEXT:    s_mov_b32 s2, s15
; GFX13-NEXT:    s_add_nc_u64 s[4:5], s[12:13], s[4:5]
; GFX13-NEXT:    s_mul_u64 s[6:7], s[6:7], s[18:19]
; GFX13-NEXT:    s_mov_b32 s20, s5
; GFX13-NEXT:    s_mov_b32 s25, s3
; GFX13-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[20:21]
; GFX13-NEXT:    s_add_nc_u64 s[8:9], s[10:11], s[8:9]
; GFX13-NEXT:    s_mov_b32 s23, s4
; GFX13-NEXT:    s_add_nc_u64 s[2:3], s[6:7], s[2:3]
; GFX13-NEXT:    s_or_b64 s[4:5], s[24:25], s[22:23]
