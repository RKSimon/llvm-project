...
; SSE2-NEXT:    pshufd {{.*#+}} xmm9 = xmm11[0,0,2,2]
...
; SSSE3-NEXT:    pcmpeqd %xmm7, %xmm10
; SSSE3-NEXT:    movdqa %xmm6, %xmm11
; SSSE3-NEXT:    pcmpgtd %xmm9, %xmm11
; SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm11[0,0,2,2]
...
; SSSE3-NEXT:    psubq %xmm10, %xmm1
; SSSE3-NEXT:    pxor %xmm8, %xmm2
; SSSE3-NEXT:    psubq %xmm8, %xmm2
...
; SSE41-NEXT:    pmovzxdq {{.*#+}} xmm6 = [2147483649,2147483649]
...
; SSE41-NEXT:    psubq %xmm10, %xmm1
; SSE41-NEXT:    pxor %xmm8, %xmm2
; SSE41-NEXT:    psubq %xmm8, %xmm2
