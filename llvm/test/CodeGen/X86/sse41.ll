...
; X86-SSE-LABEL: i32_shuf_W00W:
; X86-SSE:       ## %bb.0:
; X86-SSE-NEXT:    pshufb {{.*#+}} xmm0 = xmm0[12,13,14,15],zero,zero,zero,zero,zero,zero,zero,zero,xmm0[12,13,14,15]
; X86-SSE-NEXT:    ## encoding: [0x66,0x0f,0x38,0x00,0x05,A,A,A,A]
; X86-SSE-NEXT:    ## fixup A - offset: 5, value: {{\.?LCPI[0-9]+_[0-9]+}}, kind: FK_Data_4
; X86-SSE-NEXT:    retl ## encoding: [0xc3]
;
; X86-AVX1-LABEL: i32_shuf_W00W:
; X86-AVX1:       ## %bb.0:
; X86-AVX1-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[12,13,14,15],zero,zero,zero,zero,zero,zero,zero,zero,xmm0[12,13,14,15]
...
; X86-AVX1-NEXT:    retl ## encoding: [0xc3]
;
; X86-AVX512-LABEL: i32_shuf_W00W:
; X86-AVX512:       ## %bb.0:
; X86-AVX512-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[12,13,14,15],zero,zero,zero,zero,zero,zero,zero,zero,xmm0[12,13,14,15]
...
; X86-AVX512-NEXT:    retl ## encoding: [0xc3]
;
; X64-SSE-LABEL: i32_shuf_W00W:
; X64-SSE:       ## %bb.0:
; X64-SSE-NEXT:    pshufb {{.*#+}} xmm0 = xmm0[12,13,14,15],zero,zero,zero,zero,zero,zero,zero,zero,xmm0[12,13,14,15]
; X64-SSE-NEXT:    ## encoding: [0x66,0x0f,0x38,0x00,0x05,A,A,A,A]
; X64-SSE-NEXT:    ## fixup A - offset: 5, value: {{\.?LCPI[0-9]+_[0-9]+}}, kind: reloc_riprel_4byte
; X64-SSE-NEXT:    retq ## encoding: [0xc3]
;
; X64-AVX1-LABEL: i32_shuf_W00W:
; X64-AVX1:       ## %bb.0:
; X64-AVX1-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[12,13,14,15],zero,zero,zero,zero,zero,zero,zero,zero,xmm0[12,13,14,15]
; X64-AVX1-NEXT:    ## encoding: [0xc4,0xe2,0x79,0x00,0x05,A,A,A,A]
; X64-AVX1-NEXT:    ## fixup A - offset: 5, value: {{\.?LCPI[0-9]+_[0-9]+}}, kind: reloc_riprel_4byte
; X64-AVX1-NEXT:    retq ## encoding: [0xc3]
;
; X64-AVX512-LABEL: i32_shuf_W00W:
; X64-AVX512:       ## %bb.0:
; X64-AVX512-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[12,13,14,15],zero,zero,zero,zero,zero,zero,zero,zero,xmm0[12,13,14,15]
