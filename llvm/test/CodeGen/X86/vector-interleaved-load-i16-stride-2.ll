...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm2 = [0,1,4,5,8,9,12,13,0,1,4,5,8,9,12,13,16,17,20,21,24,25,28,29,16,17,20,21,24,25,28,29]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm2 = [0,1,4,5,8,9,12,13,0,1,4,5,8,9,12,13,16,17,20,21,24,25,28,29,16,17,20,21,24,25,28,29]
...
; AVX512-VL-NEXT:    vpsrld $16, %zmm1, %zmm2
; AVX512-VL-NEXT:    vpmovdw %zmm2, %ymm2
; AVX512-VL-NEXT:    vpsrld $16, %zmm0, %zmm3
; AVX512-VL-NEXT:    vpmovdw %zmm0, (%rsi)
; AVX512-VL-NEXT:    vpmovdw %zmm1, 32(%rsi)
; AVX512-VL-NEXT:    vpmovdw %zmm3, (%rdx)
; AVX512-VL-NEXT:    vmovdqa %ymm2, 32(%rdx)
...
; AVX512-VL-NEXT:    vpsrld $16, %zmm1, %zmm4
...
; AVX512-VL-NEXT:    vpmovdw %zmm4, 32(%rdx)
; AVX512-VL-NEXT:    vzeroupper
; AVX512-VL-NEXT:    retq
;
