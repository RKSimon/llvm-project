...
; AVX2-NEXT:    vpshufb {{.*#+}} ymm2 = ymm1[u,u,u,u,u,u,u,u,0,1,4,5,8,9,12,13,u,u,u,u,u,u,u,u,16,17,20,21,24,25,28,29]
; AVX2-NEXT:    vpshufb {{.*#+}} ymm3 = ymm0[0,1,4,5,8,9,12,13,u,u,u,u,u,u,u,u,16,17,20,21,24,25,28,29,u,u,u,u,u,u,u,u]
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm2 = ymm1[u,u,u,u,u,u,u,u,0,1,4,5,8,9,12,13,u,u,u,u,u,u,u,u,16,17,20,21,24,25,28,29]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm3 = ymm0[0,1,4,5,8,9,12,13,u,u,u,u,u,u,u,u,16,17,20,21,24,25,28,29,u,u,u,u,u,u,u,u]
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm2 = ymm1[u,u,u,u,u,u,u,u,0,1,4,5,8,9,12,13,u,u,u,u,u,u,u,u,16,17,20,21,24,25,28,29]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm3 = ymm0[0,1,4,5,8,9,12,13,u,u,u,u,u,u,u,u,16,17,20,21,24,25,28,29,u,u,u,u,u,u,u,u]
...
; AVX2-NEXT:    vpshufb %ymm6, %ymm2, %ymm6
; AVX2-NEXT:    vpblendd {{.*#+}} ymm4 = ymm6[0,1],ymm4[2,3],ymm6[4,5],ymm4[6,7]
; AVX2-NEXT:    vpermq {{.*#+}} ymm4 = ymm4[0,2,1,3]
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm6 = [6,7,2,3,4,5,6,7,2,3,6,7,10,11,14,15,22,23,18,19,20,21,22,23,18,19,22,23,26,27,30,31]
; AVX2-NEXT:    vpshufb %ymm6, %ymm1, %ymm1
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm7 = [2,3,6,7,10,11,14,15,14,15,10,11,12,13,14,15,18,19,22,23,26,27,30,31,30,31,26,27,28,29,30,31]
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm4 = [0,1,4,5,4,5,6,7,0,1,4,5,8,9,12,13,16,17,20,21,20,21,22,23,16,17,20,21,24,25,28,29]
; AVX2-FP-NEXT:    vpshufb %ymm4, %ymm1, %ymm5
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm6 = [0,1,4,5,8,9,12,13,8,9,12,13,12,13,14,15,16,17,20,21,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-FP-NEXT:    vpshufb %ymm6, %ymm0, %ymm7
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm6 = [6,7,2,3,4,5,6,7,2,3,6,7,10,11,14,15,22,23,18,19,20,21,22,23,18,19,22,23,26,27,30,31]
; AVX2-FP-NEXT:    vpshufb %ymm6, %ymm1, %ymm1
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm7 = [2,3,6,7,10,11,14,15,14,15,10,11,12,13,14,15,18,19,22,23,26,27,30,31,30,31,26,27,28,29,30,31]
...
; AVX2-FP-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[0,2,1,3]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm4 = [0,1,4,5,4,5,6,7,0,1,4,5,8,9,12,13,16,17,20,21,20,21,22,23,16,17,20,21,24,25,28,29]
...
; AVX2-FCP-NEXT:    vpshufb %ymm4, %ymm3, %ymm4
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm7 = [2,3,6,7,10,11,14,15,14,15,10,11,12,13,14,15,18,19,22,23,26,27,30,31,30,31,26,27,28,29,30,31]
...
; AVX2-FCP-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[0,2,1,3]
...
; AVX512-FCP-NEXT:    vpsrld $16, %zmm1, %zmm2
; AVX512-FCP-NEXT:    vpmovdw %zmm2, %ymm2
; AVX512-FCP-NEXT:    vpsrld $16, %zmm0, %zmm3
; AVX512-FCP-NEXT:    vpmovdw %zmm0, (%rsi)
; AVX512-FCP-NEXT:    vpmovdw %zmm1, 32(%rsi)
; AVX512-FCP-NEXT:    vpmovdw %zmm3, (%rdx)
; AVX512-FCP-NEXT:    vmovdqa %ymm2, 32(%rdx)
; AVX512-FCP-NEXT:    vzeroupper
; AVX512-FCP-NEXT:    retq
;
...
; AVX512DQ-NEXT:    vpsrld $16, %zmm0, %zmm3
; AVX512DQ-NEXT:    vpmovdw %zmm0, (%rsi)
; AVX512DQ-NEXT:    vpmovdw %zmm1, 32(%rsi)
; AVX512DQ-NEXT:    vpmovdw %zmm3, (%rdx)
; AVX512DQ-NEXT:    vmovdqa %ymm2, 32(%rdx)
; AVX512DQ-NEXT:    vzeroupper
; AVX512DQ-NEXT:    retq
;
...
; AVX512DQ-FCP-NEXT:    vpsrld $16, %zmm1, %zmm2
; AVX512DQ-FCP-NEXT:    vpmovdw %zmm2, %ymm2
; AVX512DQ-FCP-NEXT:    vpsrld $16, %zmm0, %zmm3
; AVX512DQ-FCP-NEXT:    vpmovdw %zmm0, (%rsi)
; AVX512DQ-FCP-NEXT:    vpmovdw %zmm1, 32(%rsi)
; AVX512DQ-FCP-NEXT:    vpmovdw %zmm3, (%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa %ymm2, 32(%rdx)
; AVX512DQ-FCP-NEXT:    vzeroupper
; AVX512DQ-FCP-NEXT:    retq
;
...
; SSE-NEXT:    psrad $16, %xmm8
; SSE-NEXT:    psrad $16, %xmm4
; SSE-NEXT:    packssdw %xmm8, %xmm4
; SSE-NEXT:    psrad $16, %xmm7
; SSE-NEXT:    psrad $16, %xmm2
; SSE-NEXT:    packssdw %xmm7, %xmm2
; SSE-NEXT:    movdqa %xmm1, 112(%rsi)
; SSE-NEXT:    movdqa %xmm3, 96(%rsi)
; SSE-NEXT:    movdqa %xmm15, 80(%rsi)
; SSE-NEXT:    movdqa %xmm14, 64(%rsi)
; SSE-NEXT:    movdqa %xmm11, 48(%rsi)
; SSE-NEXT:    movdqa %xmm9, 32(%rsi)
; SSE-NEXT:    movdqa %xmm10, 16(%rsi)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, (%rsi)
; SSE-NEXT:    movdqa %xmm2, 112(%rdx)
...
; AVX-NEXT:    vpblendw {{.*#+}} xmm0 = xmm13[0],xmm10[1],xmm13[2],xmm10[3],xmm13[4],xmm10[5],xmm13[6],xmm10[7]
; AVX-NEXT:    vpblendw {{.*#+}} xmm1 = xmm11[0],xmm10[1],xmm11[2],xmm10[3],xmm11[4],xmm10[5],xmm11[6],xmm10[7]
...
; AVX-NEXT:    vpblendw {{.*#+}} xmm1 = xmm0[0],xmm10[1],xmm0[2],xmm10[3],xmm0[4],xmm10[5],xmm0[6],xmm10[7]
; AVX-NEXT:    vmovdqa 160(%rdi), %xmm0
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vpblendw {{.*#+}} xmm2 = xmm0[0],xmm10[1],xmm0[2],xmm10[3],xmm0[4],xmm10[5],xmm0[6],xmm10[7]
; AVX-NEXT:    vpackusdw %xmm1, %xmm2, %xmm0
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vpblendw {{.*#+}} xmm2 = xmm3[0],xmm10[1],xmm3[2],xmm10[3],xmm3[4],xmm10[5],xmm3[6],xmm10[7]
; AVX-NEXT:    vpblendw {{.*#+}} xmm3 = xmm4[0],xmm10[1],xmm4[2],xmm10[3],xmm4[4],xmm10[5],xmm4[6],xmm10[7]
; AVX-NEXT:    vpackusdw %xmm2, %xmm3, %xmm0
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovdqa 144(%rdi), %xmm9
; AVX-NEXT:    vpblendw {{.*#+}} xmm3 = xmm9[0],xmm10[1],xmm9[2],xmm10[3],xmm9[4],xmm10[5],xmm9[6],xmm10[7]
; AVX-NEXT:    vmovdqa 128(%rdi), %xmm12
; AVX-NEXT:    vpblendw {{.*#+}} xmm7 = xmm12[0],xmm10[1],xmm12[2],xmm10[3],xmm12[4],xmm10[5],xmm12[6],xmm10[7]
; AVX-NEXT:    vpackusdw %xmm3, %xmm7, %xmm0
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovdqa 112(%rdi), %xmm6
; AVX-NEXT:    vpblendw {{.*#+}} xmm7 = xmm6[0],xmm10[1],xmm6[2],xmm10[3],xmm6[4],xmm10[5],xmm6[6],xmm10[7]
; AVX-NEXT:    vmovdqa 96(%rdi), %xmm2
; AVX-NEXT:    vpblendw {{.*#+}} xmm14 = xmm2[0],xmm10[1],xmm2[2],xmm10[3],xmm2[4],xmm10[5],xmm2[6],xmm10[7]
; AVX-NEXT:    vpackusdw %xmm7, %xmm14, %xmm0
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovdqa 240(%rdi), %xmm15
; AVX-NEXT:    vpblendw {{.*#+}} xmm14 = xmm15[0],xmm10[1],xmm15[2],xmm10[3],xmm15[4],xmm10[5],xmm15[6],xmm10[7]
; AVX-NEXT:    vmovdqa 224(%rdi), %xmm8
; AVX-NEXT:    vpblendw {{.*#+}} xmm3 = xmm8[0],xmm10[1],xmm8[2],xmm10[3],xmm8[4],xmm10[5],xmm8[6],xmm10[7]
; AVX-NEXT:    vpackusdw %xmm14, %xmm3, %xmm14
; AVX-NEXT:    vmovdqa 80(%rdi), %xmm3
; AVX-NEXT:    vpblendw {{.*#+}} xmm0 = xmm3[0],xmm10[1],xmm3[2],xmm10[3],xmm3[4],xmm10[5],xmm3[6],xmm10[7]
; AVX-NEXT:    vmovdqa 64(%rdi), %xmm1
; AVX-NEXT:    vpblendw {{.*#+}} xmm7 = xmm1[0],xmm10[1],xmm1[2],xmm10[3],xmm1[4],xmm10[5],xmm1[6],xmm10[7]
; AVX-NEXT:    vpackusdw %xmm0, %xmm7, %xmm7
; AVX-NEXT:    vmovdqa 208(%rdi), %xmm5
; AVX-NEXT:    vpblendw {{.*#+}} xmm0 = xmm5[0],xmm10[1],xmm5[2],xmm10[3],xmm5[4],xmm10[5],xmm5[6],xmm10[7]
; AVX-NEXT:    vmovdqa 192(%rdi), %xmm4
; AVX-NEXT:    vpblendw {{.*#+}} xmm10 = xmm4[0],xmm10[1],xmm4[2],xmm10[3],xmm4[4],xmm10[5],xmm4[6],xmm10[7]
; AVX-NEXT:    vpackusdw %xmm0, %xmm10, %xmm10
; AVX-NEXT:    vpsrld $16, %xmm13, %xmm0
; AVX-NEXT:    vpsrld $16, %xmm11, %xmm11
; AVX-NEXT:    vpackusdw %xmm0, %xmm11, %xmm11
; AVX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX-NEXT:    vpsrld $16, %xmm0, %xmm0
; AVX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX-NEXT:    vpsrld $16, %xmm13, %xmm13
; AVX-NEXT:    vpackusdw %xmm0, %xmm13, %xmm0
; AVX-NEXT:    vpsrld $16, %xmm6, %xmm6
; AVX-NEXT:    vpsrld $16, %xmm2, %xmm2
; AVX-NEXT:    vpackusdw %xmm6, %xmm2, %xmm2
; AVX-NEXT:    vpsrld $16, %xmm3, %xmm3
; AVX-NEXT:    vpsrld $16, %xmm1, %xmm1
; AVX-NEXT:    vpackusdw %xmm3, %xmm1, %xmm1
; AVX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; AVX-NEXT:    vpsrld $16, %xmm3, %xmm3
; AVX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm6 # 16-byte Reload
; AVX-NEXT:    vpsrld $16, %xmm6, %xmm6
; AVX-NEXT:    vpackusdw %xmm3, %xmm6, %xmm3
; AVX-NEXT:    vpsrld $16, %xmm9, %xmm6
; AVX-NEXT:    vpsrld $16, %xmm12, %xmm9
; AVX-NEXT:    vpackusdw %xmm6, %xmm9, %xmm6
; AVX-NEXT:    vpsrld $16, %xmm15, %xmm9
; AVX-NEXT:    vpsrld $16, %xmm8, %xmm8
; AVX-NEXT:    vpackusdw %xmm9, %xmm8, %xmm8
; AVX-NEXT:    vpsrld $16, %xmm5, %xmm5
; AVX-NEXT:    vpsrld $16, %xmm4, %xmm4
; AVX-NEXT:    vpackusdw %xmm5, %xmm4, %xmm4
; AVX-NEXT:    vmovdqa %xmm10, 96(%rsi)
; AVX-NEXT:    vmovdqa %xmm7, 32(%rsi)
...
; AVX-NEXT:    vmovdqa %xmm4, 96(%rdx)
; AVX-NEXT:    vmovdqa %xmm8, 112(%rdx)
; AVX-NEXT:    vmovdqa %xmm6, 64(%rdx)
; AVX-NEXT:    vmovdqa %xmm3, 80(%rdx)
...
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm9 = [0,1,4,5,4,5,6,7,0,1,4,5,8,9,12,13,16,17,20,21,20,21,22,23,16,17,20,21,24,25,28,29]
; AVX2-NEXT:    vpshufb %ymm9, %ymm6, %ymm3
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm10 = [0,1,4,5,8,9,12,13,8,9,12,13,12,13,14,15,16,17,20,21,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-NEXT:    vpshufb %ymm10, %ymm5, %ymm11
; AVX2-NEXT:    vpblendd {{.*#+}} ymm3 = ymm11[0,1],ymm3[2,3],ymm11[4,5],ymm3[6,7]
; AVX2-NEXT:    vpermq {{.*#+}} ymm3 = ymm3[0,2,1,3]
; AVX2-NEXT:    vpshufb %ymm9, %ymm4, %ymm11
; AVX2-NEXT:    vpshufb %ymm10, %ymm2, %ymm12
; AVX2-NEXT:    vpblendd {{.*#+}} ymm11 = ymm12[0,1],ymm11[2,3],ymm12[4,5],ymm11[6,7]
; AVX2-NEXT:    vpermq {{.*#+}} ymm11 = ymm11[0,2,1,3]
; AVX2-NEXT:    vpshufb %ymm9, %ymm8, %ymm12
; AVX2-NEXT:    vpshufb %ymm10, %ymm7, %ymm13
; AVX2-NEXT:    vpblendd {{.*#+}} ymm12 = ymm13[0,1],ymm12[2,3],ymm13[4,5],ymm12[6,7]
; AVX2-NEXT:    vpermq {{.*#+}} ymm12 = ymm12[0,2,1,3]
...
; AVX2-NEXT:    vpermq {{.*#+}} ymm9 = ymm9[0,2,1,3]
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm10 = [6,7,2,3,4,5,6,7,2,3,6,7,10,11,14,15,22,23,18,19,20,21,22,23,18,19,22,23,26,27,30,31]
...
; AVX2-NEXT:    vpshufb %ymm13, %ymm5, %ymm5
; AVX2-NEXT:    vpblendd {{.*#+}} ymm5 = ymm5[0,1],ymm6[2,3],ymm5[4,5],ymm6[6,7]
; AVX2-NEXT:    vpermq {{.*#+}} ymm5 = ymm5[0,2,1,3]
; AVX2-NEXT:    vpshufb %ymm10, %ymm8, %ymm6
; AVX2-NEXT:    vpshufb %ymm13, %ymm7, %ymm7
; AVX2-NEXT:    vpblendd {{.*#+}} ymm6 = ymm7[0,1],ymm6[2,3],ymm7[4,5],ymm6[6,7]
; AVX2-NEXT:    vpermq {{.*#+}} ymm6 = ymm6[0,2,1,3]
; AVX2-NEXT:    vpshufb %ymm10, %ymm4, %ymm4
; AVX2-NEXT:    vpshufb %ymm13, %ymm2, %ymm2
; AVX2-NEXT:    vpblendd {{.*#+}} ymm2 = ymm2[0,1],ymm4[2,3],ymm2[4,5],ymm4[6,7]
; AVX2-NEXT:    vpermq {{.*#+}} ymm2 = ymm2[0,2,1,3]
; AVX2-NEXT:    vpshufb %ymm10, %ymm1, %ymm1
; AVX2-NEXT:    vpshufb %ymm13, %ymm0, %ymm0
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX2-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,2,1,3]
; AVX2-NEXT:    vmovdqa %ymm9, 96(%rsi)
; AVX2-NEXT:    vmovdqa %ymm12, 32(%rsi)
; AVX2-NEXT:    vmovdqa %ymm11, 64(%rsi)
; AVX2-NEXT:    vmovdqa %ymm3, (%rsi)
; AVX2-NEXT:    vmovdqa %ymm0, 96(%rdx)
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm9 = [0,1,4,5,4,5,6,7,0,1,4,5,8,9,12,13,16,17,20,21,20,21,22,23,16,17,20,21,24,25,28,29]
; AVX2-FP-NEXT:    vpshufb %ymm9, %ymm6, %ymm3
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm10 = [0,1,4,5,8,9,12,13,8,9,12,13,12,13,14,15,16,17,20,21,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm5, %ymm11
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm3 = ymm11[0,1],ymm3[2,3],ymm11[4,5],ymm3[6,7]
; AVX2-FP-NEXT:    vpermq {{.*#+}} ymm3 = ymm3[0,2,1,3]
; AVX2-FP-NEXT:    vpshufb %ymm9, %ymm4, %ymm11
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm2, %ymm12
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm11 = ymm12[0,1],ymm11[2,3],ymm12[4,5],ymm11[6,7]
; AVX2-FP-NEXT:    vpermq {{.*#+}} ymm11 = ymm11[0,2,1,3]
; AVX2-FP-NEXT:    vpshufb %ymm9, %ymm8, %ymm12
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm7, %ymm13
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm12 = ymm13[0,1],ymm12[2,3],ymm13[4,5],ymm12[6,7]
; AVX2-FP-NEXT:    vpermq {{.*#+}} ymm12 = ymm12[0,2,1,3]
...
; AVX2-FP-NEXT:    vpermq {{.*#+}} ymm9 = ymm9[0,2,1,3]
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm10 = [6,7,2,3,4,5,6,7,2,3,6,7,10,11,14,15,22,23,18,19,20,21,22,23,18,19,22,23,26,27,30,31]
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm6, %ymm6
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm13 = [2,3,6,7,10,11,14,15,14,15,10,11,12,13,14,15,18,19,22,23,26,27,30,31,30,31,26,27,28,29,30,31]
; AVX2-FP-NEXT:    vpshufb %ymm13, %ymm5, %ymm5
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm5[0,1],ymm6[2,3],ymm5[4,5],ymm6[6,7]
; AVX2-FP-NEXT:    vpermq {{.*#+}} ymm5 = ymm5[0,2,1,3]
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm8, %ymm6
; AVX2-FP-NEXT:    vpshufb %ymm13, %ymm7, %ymm7
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm6 = ymm7[0,1],ymm6[2,3],ymm7[4,5],ymm6[6,7]
; AVX2-FP-NEXT:    vpermq {{.*#+}} ymm6 = ymm6[0,2,1,3]
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm4, %ymm4
; AVX2-FP-NEXT:    vpshufb %ymm13, %ymm2, %ymm2
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm2 = ymm2[0,1],ymm4[2,3],ymm2[4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vpermq {{.*#+}} ymm2 = ymm2[0,2,1,3]
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm1, %ymm1
; AVX2-FP-NEXT:    vpshufb %ymm13, %ymm0, %ymm0
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,2,1,3]
; AVX2-FP-NEXT:    vmovdqa %ymm9, 96(%rsi)
; AVX2-FP-NEXT:    vmovdqa %ymm12, 32(%rsi)
; AVX2-FP-NEXT:    vmovdqa %ymm11, 64(%rsi)
; AVX2-FP-NEXT:    vmovdqa %ymm3, (%rsi)
; AVX2-FP-NEXT:    vmovdqa %ymm0, 96(%rdx)
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm10 = [0,1,4,5,8,9,12,13,8,9,12,13,12,13,14,15,16,17,20,21,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm5, %ymm11
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm3 = ymm11[0,1],ymm3[2,3],ymm11[4,5],ymm3[6,7]
; AVX2-FCP-NEXT:    vpermq {{.*#+}} ymm3 = ymm3[0,2,1,3]
; AVX2-FCP-NEXT:    vpshufb %ymm9, %ymm4, %ymm11
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm2, %ymm12
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm11 = ymm12[0,1],ymm11[2,3],ymm12[4,5],ymm11[6,7]
; AVX2-FCP-NEXT:    vpermq {{.*#+}} ymm11 = ymm11[0,2,1,3]
; AVX2-FCP-NEXT:    vpshufb %ymm9, %ymm8, %ymm12
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm7, %ymm13
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm12 = ymm13[0,1],ymm12[2,3],ymm13[4,5],ymm12[6,7]
; AVX2-FCP-NEXT:    vpermq {{.*#+}} ymm12 = ymm12[0,2,1,3]
; AVX2-FCP-NEXT:    vpshufb %ymm9, %ymm1, %ymm9
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm0, %ymm10
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm9 = ymm10[0,1],ymm9[2,3],ymm10[4,5],ymm9[6,7]
; AVX2-FCP-NEXT:    vpermq {{.*#+}} ymm9 = ymm9[0,2,1,3]
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm5[0,1],ymm6[2,3],ymm5[4,5],ymm6[6,7]
; AVX2-FCP-NEXT:    vpermq {{.*#+}} ymm5 = ymm5[0,2,1,3]
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm8, %ymm6
; AVX2-FCP-NEXT:    vpshufb %ymm13, %ymm7, %ymm7
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm6 = ymm7[0,1],ymm6[2,3],ymm7[4,5],ymm6[6,7]
; AVX2-FCP-NEXT:    vpermq {{.*#+}} ymm6 = ymm6[0,2,1,3]
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm4, %ymm4
; AVX2-FCP-NEXT:    vpshufb %ymm13, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm2 = ymm2[0,1],ymm4[2,3],ymm2[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vpermq {{.*#+}} ymm2 = ymm2[0,2,1,3]
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm1, %ymm1
; AVX2-FCP-NEXT:    vpshufb %ymm13, %ymm0, %ymm0
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,2,1,3]
; AVX2-FCP-NEXT:    vmovdqa %ymm9, 96(%rsi)
; AVX2-FCP-NEXT:    vmovdqa %ymm12, 32(%rsi)
; AVX2-FCP-NEXT:    vmovdqa %ymm11, 64(%rsi)
; AVX2-FCP-NEXT:    vmovdqa %ymm3, (%rsi)
; AVX2-FCP-NEXT:    vmovdqa %ymm0, 96(%rdx)
...
; AVX512-NEXT:    vpsrld $16, %zmm1, %zmm4
...
; AVX512-NEXT:    vpmovdw %zmm4, 32(%rdx)
; AVX512-NEXT:    vzeroupper
; AVX512-NEXT:    retq
;
...
; AVX512-FCP-NEXT:    vpsrld $16, %zmm1, %zmm4
...
; AVX512-FCP-NEXT:    vpmovdw %zmm4, 32(%rdx)
; AVX512-FCP-NEXT:    vzeroupper
; AVX512-FCP-NEXT:    retq
;
...
; AVX512DQ-NEXT:    vpsrld $16, %zmm1, %zmm4
...
; AVX512DQ-NEXT:    vpmovdw %zmm4, 32(%rdx)
; AVX512DQ-NEXT:    vzeroupper
; AVX512DQ-NEXT:    retq
;
...
; AVX512DQ-FCP-NEXT:    vpsrld $16, %zmm1, %zmm4
...
; AVX512DQ-FCP-NEXT:    vpmovdw %zmm4, 32(%rdx)
; AVX512DQ-FCP-NEXT:    vzeroupper
; AVX512DQ-FCP-NEXT:    retq
;
