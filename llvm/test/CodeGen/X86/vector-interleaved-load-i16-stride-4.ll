...
; AVX2-FP-NEXT:    vmovdqa 112(%rdi), %xmm14
; AVX2-FP-NEXT:    vinserti128 $1, %xmm14, %ymm2, %ymm3
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm8 = [0,1,4,5,4,5,6,7,0,1,4,5,8,9,12,13,16,17,20,21,20,21,22,23,16,17,20,21,24,25,28,29]
; AVX2-FCP-NEXT:    vpshufb %ymm8, %ymm7, %ymm1
; AVX2-FCP-NEXT:    vpermd %ymm4, %ymm3, %ymm2
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm9 = [0,1,4,5,8,9,12,13,8,9,12,13,12,13,14,15,16,17,20,21,24,25,28,29,24,25,28,29,28,29,30,31]
