...
; AVX2-NEXT:    vpackusdw %xmm1, %xmm2, %xmm4
; AVX2-NEXT:    vmovdqa 96(%rdi), %xmm1
; AVX2-NEXT:    vmovdqa 112(%rdi), %xmm2
; AVX2-NEXT:    vinserti128 $1, %xmm2, %ymm1, %ymm3
...
; AVX2-NEXT:    vinserti128 $1, %xmm6, %ymm3, %ymm7
; AVX2-NEXT:    vpblendw {{.*#+}} ymm0 = ymm7[0],ymm0[1,2,3],ymm7[4],ymm0[5,6,7],ymm7[8],ymm0[9,10,11],ymm7[12],ymm0[13,14,15]
; AVX2-NEXT:    vextracti128 $1, %ymm0, %xmm7
; AVX2-NEXT:    vpackusdw %xmm7, %xmm0, %xmm0
; AVX2-NEXT:    vpackusdw %xmm0, %xmm0, %xmm0
...
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm7 = xmm10[0],xmm7[0],xmm10[1],xmm7[1]
; AVX2-NEXT:    vinserti128 $1, %xmm7, %ymm0, %ymm7
; AVX2-NEXT:    vpshufd {{.*#+}} xmm10 = xmm6[0,2,2,3]
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm7 = ymm10[0,1,2,3,4,5],ymm7[6,7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm10 = xmm9[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm10[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm11 = xmm8[0,2,2,3]
...
; AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[3,1,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm1[0,1,2,0,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm10 = xmm11[0],xmm10[0],xmm11[1],xmm10[1]
; AVX2-NEXT:    vinserti128 $1, %xmm10, %ymm0, %ymm10
; AVX2-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[3,1,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm6[2,0,2,3,4,5,6,7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[3,1,2,3]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm9[0,1,2,0,4,5,6,7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[3,1,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm8[0,1,2,0,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm11 = xmm12[0],xmm11[0],xmm12[1],xmm11[1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm5 = xmm5[3,1,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm5[2,0,2,3,4,5,6,7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[3,1,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm4[2,0,2,3,4,5,6,7]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm1[0,1,3,1,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm1[0],xmm2[0],xmm1[1],xmm2[1]
; AVX2-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm6[3,1,2,3,4,5,6,7]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm8[0,1,3,1,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm2 = xmm3[0],xmm2[0],xmm3[1],xmm2[1]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm5[3,1,2,3,4,5,6,7]
...
; AVX2-FP-NEXT:    vpackusdw %xmm1, %xmm2, %xmm2
; AVX2-FP-NEXT:    vmovdqa 96(%rdi), %xmm1
; AVX2-FP-NEXT:    vmovdqa 112(%rdi), %xmm3
; AVX2-FP-NEXT:    vinserti128 $1, %xmm3, %ymm1, %ymm4
...
; AVX2-FP-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm5
; AVX2-FP-NEXT:    vmovdqa 64(%rdi), %xmm4
; AVX2-FP-NEXT:    vmovdqa 80(%rdi), %xmm7
; AVX2-FP-NEXT:    vinserti128 $1, %xmm7, %ymm4, %ymm6
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm6[0],ymm0[1,2,3],ymm6[4],ymm0[5,6,7],ymm6[8],ymm0[9,10,11],ymm6[12],ymm0[13,14,15]
; AVX2-FP-NEXT:    vextracti128 $1, %ymm0, %xmm6
; AVX2-FP-NEXT:    vpackusdw %xmm6, %xmm0, %xmm0
; AVX2-FP-NEXT:    vpackusdw %xmm0, %xmm0, %xmm0
...
; AVX2-FP-NEXT:    vmovdqa 16(%rdi), %xmm6
...
; AVX2-FP-NEXT:    vpshufb %xmm2, %xmm3, %xmm10
; AVX2-FP-NEXT:    vpshufb %xmm2, %xmm1, %xmm11
...
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm7, %xmm12
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm4, %xmm13
...
; AVX2-FP-NEXT:    vpshufb %xmm2, %xmm9, %xmm12
; AVX2-FP-NEXT:    vpshufb %xmm2, %xmm8, %xmm2
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm2 = xmm2[0],xmm12[0],xmm2[1],xmm12[1]
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm6, %xmm12
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm5, %xmm11
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm11 = xmm11[0],xmm12[0],xmm11[1],xmm12[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm2 = xmm11[0,1],xmm2[2,3]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm10[4,5,6,7]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[3,1,2,3]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm3[0,1,2,0,4,5,6,7]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[3,1,2,3]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm1[0,1,2,0,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm10 = xmm11[0],xmm10[0],xmm11[1],xmm10[1]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm10, %ymm0, %ymm10
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm7 = xmm7[3,1,2,3]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm7[2,0,2,3,4,5,6,7]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[3,1,2,3]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm4[2,0,2,3,4,5,6,7]
...
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm8[0,1,2,0,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm11 = xmm12[0],xmm11[0],xmm12[1],xmm11[1]
...
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm3 = xmm4[0],xmm3[0],xmm4[1],xmm3[1]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm6[3,1,2,3,4,5,6,7]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm5 = [0,1,4,5,4,5,6,7,0,1,4,5,8,9,12,13,16,17,20,21,20,21,22,23,16,17,20,21,24,25,28,29]
; AVX2-FCP-NEXT:    vpshufb %ymm5, %ymm4, %ymm6
; AVX2-FCP-NEXT:    vpermd %ymm1, %ymm3, %ymm7
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm8 = [0,1,4,5,8,9,12,13,8,9,12,13,12,13,14,15,16,17,20,21,24,25,28,29,24,25,28,29,28,29,30,31]
...
; AVX2-NEXT:    vmovdqa 96(%rdi), %xmm8
; AVX2-NEXT:    vmovdqa 112(%rdi), %xmm6
; AVX2-NEXT:    vinserti128 $1, %xmm6, %ymm8, %ymm2
...
; AVX2-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX2-NEXT:    vmovdqa 64(%rdi), %xmm12
; AVX2-NEXT:    vmovdqa 80(%rdi), %xmm9
; AVX2-NEXT:    vinserti128 $1, %xmm9, %ymm12, %ymm3
; AVX2-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm0[1,2,3],ymm3[4],ymm0[5,6,7],ymm3[8],ymm0[9,10,11],ymm3[12],ymm0[13,14,15]
...
; AVX2-NEXT:    vinserti128 $1, %xmm5, %ymm15, %ymm2
...
; AVX2-NEXT:    vmovdqa 208(%rdi), %xmm10
; AVX2-NEXT:    vinserti128 $1, %xmm10, %ymm4, %ymm3
; AVX2-NEXT:    vmovdqa %ymm4, %ymm11
; AVX2-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpblendw {{.*#+}} ymm0 = ymm3[0],ymm0[1,2,3],ymm3[4],ymm0[5,6,7],ymm3[8],ymm0[9,10,11],ymm3[12],ymm0[13,14,15]
...
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm2 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm3[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm1[1,3,2,3,4,5,6,7]
...
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpshufd {{.*#+}} xmm0 = xmm5[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm15[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm2[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm2[0],xmm0[0],xmm2[1],xmm0[1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm10[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm2[1,3,2,3,4,5,6,7]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm14[0,1,2,0,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm13[0,1,2,0,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm12[0],xmm2[0],xmm12[1],xmm2[1]
; AVX2-NEXT:    vpshufd $231, (%rsp), %xmm12 # 16-byte Folded Reload
; AVX2-NEXT:    # xmm12 = mem[3,1,2,3]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm9 = xmm7[3,1,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm12[2,0,2,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm9[2,0,2,3,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm7 = xmm8[0],xmm7[0],xmm8[1],xmm7[1]
; AVX2-NEXT:    vpblendd {{.*#+}} xmm0 = xmm7[0,1],xmm0[2,3]
...
; AVX2-NEXT:    vpshufd {{.*#+}} xmm6 = xmm15[3,1,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm8[0,1,2,0,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm6[0,1,2,0,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm7[0],xmm0[0],xmm7[1],xmm0[1]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm7[2,0,2,3,4,5,6,7]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm15[0,1,2,0,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm5[0,1,2,0,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm4[0],xmm0[0],xmm4[1],xmm0[1]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm3[2,0,2,3,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm11[0],xmm0[0],xmm11[1],xmm0[1]
; AVX2-NEXT:    vpblendd {{.*#+}} xmm0 = xmm0[0,1],xmm1[2,3]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm11 = ymm0[0,1,2,3],ymm2[4,5,6,7]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm13[0,1,3,1,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm12[3,1,2,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm9[3,1,2,3,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm2 = xmm9[0],xmm2[0],xmm9[1],xmm2[1]
...
; AVX2-NEXT:    vmovdqa %ymm11, 32(%rcx)
...
; AVX2-FP-NEXT:    vmovdqa 112(%rdi), %xmm13
; AVX2-FP-NEXT:    vinserti128 $1, %xmm13, %ymm2, %ymm4
...
; AVX2-FP-NEXT:    vinserti128 $1, %xmm9, %ymm2, %ymm6
; AVX2-FP-NEXT:    vmovdqa %ymm2, %ymm5
; AVX2-FP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm6 = ymm6[0],ymm0[1,2,3],ymm6[4],ymm0[5,6,7],ymm6[8],ymm0[9,10,11],ymm6[12],ymm0[13,14,15]
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm4 = ymm6[0,1,2,3,4,5],ymm4[6,7]
...
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm4 = mem[0],ymm0[1,2,3],mem[4],ymm0[5,6,7],mem[8],ymm0[9,10,11],mem[12],ymm0[13,14,15]
...
; AVX2-FP-NEXT:    vmovdqa 240(%rdi), %xmm8
; AVX2-FP-NEXT:    vinserti128 $1, %xmm8, %ymm3, %ymm4
...
; AVX2-FP-NEXT:    vmovdqa 208(%rdi), %xmm10
; AVX2-FP-NEXT:    vinserti128 $1, %xmm10, %ymm2, %ymm6
; AVX2-FP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm6[0],ymm0[1,2,3],ymm6[4],ymm0[5,6,7],ymm6[8],ymm0[9,10,11],ymm6[12],ymm0[13,14,15]
; AVX2-FP-NEXT:    vextracti128 $1, %ymm0, %xmm6
; AVX2-FP-NEXT:    vpackusdw %xmm6, %xmm0, %xmm0
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} xmm7 = [2,3,10,11,8,9,10,11,8,9,10,11,12,13,14,15]
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm9, %xmm1
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm5, %xmm6
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm6 = xmm6[0],xmm1[0],xmm6[1],xmm1[1]
; AVX2-FP-NEXT:    vmovdqa 48(%rdi), %xmm5
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX2-FP-NEXT:    vinserti128 $1, %xmm6, %ymm0, %ymm6
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm6 = ymm6[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vpshufb %xmm4, %xmm5, %xmm0
; AVX2-FP-NEXT:    vpshufb %xmm4, %xmm12, %xmm11
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm13 = xmm11[0],xmm0[0],xmm11[1],xmm0[1]
; AVX2-FP-NEXT:    vmovdqa (%rdi), %xmm11
; AVX2-FP-NEXT:    vmovdqa 16(%rdi), %xmm1
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm1, %xmm14
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm11, %xmm15
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm14 = xmm15[0],xmm14[0],xmm15[1],xmm14[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm13 = xmm14[0,1],xmm13[2,3]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm13[0,1,2,3],ymm6[4,5,6,7]
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpshufb %xmm4, %xmm8, %xmm6
; AVX2-FP-NEXT:    vpshufb %xmm4, %xmm3, %xmm13
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm6 = xmm13[0],xmm6[0],xmm13[1],xmm6[1]
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm10, %xmm13
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm2, %xmm14
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm13 = xmm14[0],xmm13[0],xmm14[1],xmm13[1]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm6, %ymm0, %ymm6
; AVX2-FP-NEXT:    vinserti128 $1, %xmm13, %ymm0, %ymm13
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm13 = ymm13[0,1,2,3,4,5],ymm6[6,7]
; AVX2-FP-NEXT:    vmovdqa 160(%rdi), %xmm14
; AVX2-FP-NEXT:    vmovdqa 176(%rdi), %xmm6
; AVX2-FP-NEXT:    vpshufb %xmm4, %xmm6, %xmm15
...
; AVX2-FP-NEXT:    vmovdqa 144(%rdi), %xmm15
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm15, %xmm0
; AVX2-FP-NEXT:    vpshufb %xmm7, %xmm2, %xmm7
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm7[0],xmm0[0],xmm7[1],xmm0[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm0 = xmm0[0,1],xmm4[2,3]
...
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,1,2,0,4,5,6,7]
...
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[2,0,2,3,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm4[2,0,2,3,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm3 = xmm4[0],xmm3[0],xmm4[1],xmm3[1]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX2-FP-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm3[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm9 = xmm5[3,1,2,3]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm12 = xmm12[3,1,2,3]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm9[0,1,2,0,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm12[0,1,2,0,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm2 = xmm3[0],xmm2[0],xmm3[1],xmm2[1]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm7 = xmm1[3,1,2,3]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm5 = xmm11[3,1,2,3]
...
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[3,1,2,3]
; AVX2-FP-NEXT:    vpshufd $231, (%rsp), %xmm4 # 16-byte Folded Reload
; AVX2-FP-NEXT:    # xmm4 = mem[3,1,2,3]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm8[0,1,2,0,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm4[0,1,2,0,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm10 = xmm10[3,1,2,3]
; AVX2-FP-NEXT:    vpshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Folded Reload
; AVX2-FP-NEXT:    # xmm3 = mem[3,1,2,3]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm10[2,0,2,3,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm3[2,0,2,3,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm11[0],xmm1[0],xmm11[1],xmm1[1]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX2-FP-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm11 = ymm1[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[3,1,2,3]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm14 = xmm14[3,1,2,3]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm6[0,1,2,0,4,5,6,7]
...
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm2[2,0,2,3,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm15[2,0,2,3,4,5,6,7]
...
; AVX2-FP-NEXT:    vpshuflw $116, {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Folded Reload
; AVX2-FP-NEXT:    # xmm11 = mem[0,1,3,1,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm11[0],xmm1[0],xmm11[1],xmm1[1]
...
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm9[0,1,3,1,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm12[0,1,3,1,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm9 = xmm11[0],xmm9[0],xmm11[1],xmm9[1]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm7[3,1,2,3,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm5[3,1,2,3,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm5 = xmm5[0],xmm7[0],xmm5[1],xmm7[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm5 = xmm5[0,1],xmm9[2,3]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm5[0,1,2,3],ymm1[4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm8[0,1,3,1,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm4[0,1,3,1,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm4 = xmm4[0],xmm5[0],xmm4[1],xmm5[1]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm10[3,1,2,3,4,5,6,7]
...
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm6[0,1,3,1,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm14[0,1,3,1,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm2[3,1,2,3,4,5,6,7]
...
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm11, %ymm4
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm9 = [6,7,2,3,4,5,6,7,2,3,6,7,10,11,14,15,22,23,18,19,20,21,22,23,18,19,22,23,26,27,30,31]
; AVX2-FCP-NEXT:    vpshufb %ymm9, %ymm10, %ymm13
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm10 = [2,3,6,7,10,11,14,15,14,15,10,11,12,13,14,15,18,19,22,23,26,27,30,31,30,31,26,27,28,29,30,31]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm10 = [0,1,4,5,4,5,6,7,0,1,4,5,8,9,12,13,16,17,20,21,20,21,22,23,16,17,20,21,24,25,28,29]
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm4, %ymm0
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm1 = ymm8[0,1,4,5,8,9,12,13,8,9,12,13,12,13,14,15,16,17,20,21,24,25,28,29,24,25,28,29,28,29,30,31]
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm9 = ymm2[0,1,4,5,8,9,12,13,8,9,12,13,12,13,14,15,16,17,20,21,24,25,28,29,24,25,28,29,28,29,30,31]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm10 = [6,7,2,3,4,5,6,7,2,3,6,7,10,11,14,15,22,23,18,19,20,21,22,23,18,19,22,23,26,27,30,31]
...
; AVX2-NEXT:    vmovdqa 112(%rdi), %xmm12
; AVX2-NEXT:    vinserti128 $1, %xmm12, %ymm3, %ymm2
...
; AVX2-NEXT:    vmovdqa 80(%rdi), %xmm15
; AVX2-NEXT:    vinserti128 $1, %xmm15, %ymm6, %ymm3
...
; AVX2-NEXT:    vpackusdw %xmm3, %xmm2, %xmm2
; AVX2-NEXT:    vpackusdw %xmm1, %xmm2, %xmm1
; AVX2-NEXT:    vmovdqa 352(%rdi), %xmm13
; AVX2-NEXT:    vmovdqa 368(%rdi), %xmm10
; AVX2-NEXT:    vinserti128 $1, %xmm10, %ymm13, %ymm2
...
; AVX2-NEXT:    vmovdqu %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovdqa 336(%rdi), %xmm5
...
; AVX2-NEXT:    vmovdqa 240(%rdi), %xmm3
...
; AVX2-NEXT:    vextracti128 $1, %ymm2, %xmm3
; AVX2-NEXT:    vpackusdw %xmm3, %xmm2, %xmm2
; AVX2-NEXT:    vmovdqa 448(%rdi), %xmm9
; AVX2-NEXT:    vmovdqa 464(%rdi), %xmm8
; AVX2-NEXT:    vinserti128 $1, %xmm8, %ymm9, %ymm3
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpshufd {{.*#+}} xmm0 = xmm12[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm14[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm1[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm1[1,3,2,3,4,5,6,7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm6[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm2[1,3,2,3,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
; AVX2-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX2-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm0[1,3,2,3,4,5,6,7]
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm1 = ymm2[0,1,2,3],ymm1[4,5,6,7]
; AVX2-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm10[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm1[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm13[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm2[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
...
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm7[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm2[1,3,2,3,4,5,6,7]
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm1 = ymm2[0,1,2,3],ymm1[4,5,6,7]
; AVX2-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm11[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm1[0,1,1,3,4,5,6,7]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm3[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm2 = xmm3[0],xmm2[0],xmm3[1],xmm2[1]
; AVX2-NEXT:    vmovdqa 400(%rdi), %xmm0
; AVX2-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vpshufd {{.*#+}} xmm3 = xmm0[0,2,2,3]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm3[1,3,2,3,4,5,6,7]
...
; AVX2-NEXT:    # xmm0 = mem[3,1,2,3]
; AVX2-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vpshufd {{.*#+}} xmm3 = xmm15[3,1,2,3]
; AVX2-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm0[0,1,2,0,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm3[0,1,2,0,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm2 = xmm3[0],xmm2[0],xmm3[1],xmm2[1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm0 = xmm14[3,1,2,3]
; AVX2-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX2-NEXT:    # xmm1 = mem[3,1,2,3]
; AVX2-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm10[3,1,2,3]
; AVX2-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm12[3,1,2,3]
; AVX2-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm1[2,0,2,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm2[2,0,2,3,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
...
; AVX2-NEXT:    # xmm1 = mem[0,1,3,1,4,5,6,7]
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; AVX2-NEXT:    vpshuflw $231, (%rsp), %xmm1 # 16-byte Folded Reload
; AVX2-NEXT:    # xmm1 = mem[3,1,2,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Folded Reload
; AVX2-NEXT:    # xmm15 = mem[3,1,2,3,4,5,6,7]
...
; AVX2-FP:       # %bb.0:
; AVX2-FP-NEXT:    subq $856, %rsp # imm = 0x358
; AVX2-FP-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm1 = mem[0],ymm0[1,2,3],mem[4],ymm0[5,6,7],mem[8],ymm0[9,10,11],mem[12],ymm0[13,14,15]
; AVX2-FP-NEXT:    vextracti128 $1, %ymm1, %xmm2
; AVX2-FP-NEXT:    vpackusdw %xmm2, %xmm1, %xmm1
...
; AVX2-FP-NEXT:    vmovdqa 112(%rdi), %xmm8
; AVX2-FP-NEXT:    vinserti128 $1, %xmm8, %ymm3, %ymm2
; AVX2-FP-NEXT:    vmovdqa %xmm8, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vmovdqa %ymm3, %ymm7
...
; AVX2-FP-NEXT:    vinserti128 $1, %xmm14, %ymm5, %ymm4
...
; AVX2-FP-NEXT:    vinserti128 $1, %xmm12, %ymm4, %ymm2
...
; AVX2-FP-NEXT:    vinserti128 $1, %xmm15, %ymm3, %ymm4
...
; AVX2-FP-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vinserti128 $1, %xmm4, %ymm3, %ymm4
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm4 = ymm4[0],ymm0[1,2,3],ymm4[4],ymm0[5,6,7],ymm4[8],ymm0[9,10,11],ymm4[12],ymm0[13,14,15]
; AVX2-FP-NEXT:    vextracti128 $1, %ymm4, %xmm6
; AVX2-FP-NEXT:    vpackusdw %xmm6, %xmm4, %xmm4
; AVX2-FP-NEXT:    vpackusdw %xmm2, %xmm2, %xmm2
...
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm8, %xmm0
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm7, %xmm1
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} xmm11 = [2,3,10,11,8,9,10,11,8,9,10,11,12,13,14,15]
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm14, %xmm1
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm9, %xmm2
...
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm7, %xmm2
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
; AVX2-FP-NEXT:    vmovdqa (%rdi), %xmm6
; AVX2-FP-NEXT:    vmovdqa 16(%rdi), %xmm8
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm8, %xmm2
...
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm15, %xmm1
...
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm1, %xmm0
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm2, %xmm4
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm13 = xmm4[0],xmm0[0],xmm4[1],xmm0[1]
; AVX2-FP-NEXT:    vmovdqa 256(%rdi), %xmm0
; AVX2-FP-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vmovdqa 272(%rdi), %xmm4
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm4, %xmm14
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm0, %xmm15
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm14 = xmm15[0],xmm14[0],xmm15[1],xmm14[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm13 = xmm14[0,1],xmm13[2,3]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm13[0,1,2,3],ymm12[4,5,6,7]
; AVX2-FP-NEXT:    vmovdqu %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm5, %xmm13
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm12 = xmm13[0],xmm12[0],xmm13[1],xmm12[1]
; AVX2-FP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm5, %xmm13
; AVX2-FP-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm5 # 32-byte Reload
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm5, %xmm14
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm13 = xmm14[0],xmm13[0],xmm14[1],xmm13[1]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm12, %ymm0, %ymm12
; AVX2-FP-NEXT:    vinserti128 $1, %xmm13, %ymm0, %ymm13
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm13 = ymm13[0,1,2,3,4,5],ymm12[6,7]
; AVX2-FP-NEXT:    vmovdqa 160(%rdi), %xmm0
; AVX2-FP-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vmovdqa 176(%rdi), %xmm12
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm12, %xmm14
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm0, %xmm15
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm14 = xmm15[0],xmm14[0],xmm15[1],xmm14[1]
; AVX2-FP-NEXT:    vmovdqa 128(%rdi), %xmm0
; AVX2-FP-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vmovdqa 144(%rdi), %xmm5
; AVX2-FP-NEXT:    vmovdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm5, %xmm15
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm0, %xmm5
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm5 = xmm5[0],xmm15[0],xmm5[1],xmm15[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm5 = xmm5[0,1],xmm14[2,3]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm5[0,1,2,3],ymm13[4,5,6,7]
; AVX2-FP-NEXT:    vmovdqu %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm15, %xmm13
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm5 = xmm13[0],xmm5[0],xmm13[1],xmm5[1]
; AVX2-FP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm13, %xmm13
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm3, %xmm14
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm13 = xmm14[0],xmm13[0],xmm14[1],xmm13[1]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
; AVX2-FP-NEXT:    vinserti128 $1, %xmm13, %ymm0, %ymm13
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm13[0,1,2,3,4,5],ymm5[6,7]
; AVX2-FP-NEXT:    vmovdqa 416(%rdi), %xmm3
; AVX2-FP-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vmovdqa 432(%rdi), %xmm13
; AVX2-FP-NEXT:    vmovdqa %xmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm13, %xmm13
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm3, %xmm10
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm10 = xmm10[0],xmm13[0],xmm10[1],xmm13[1]
; AVX2-FP-NEXT:    vmovdqa 384(%rdi), %xmm3
; AVX2-FP-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vmovdqa 400(%rdi), %xmm13
; AVX2-FP-NEXT:    vmovdqa %xmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm13, %xmm13
; AVX2-FP-NEXT:    vpshufb %xmm11, %xmm3, %xmm11
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm11 = xmm11[0],xmm13[0],xmm11[1],xmm13[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm10 = xmm11[0,1],xmm10[2,3]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm3 = ymm10[0,1,2,3],ymm5[4,5,6,7]
; AVX2-FP-NEXT:    vmovdqu %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Folded Reload
; AVX2-FP-NEXT:    # xmm3 = mem[3,1,2,3]
; AVX2-FP-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm3[0,1,2,0,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm10[0,1,2,0,4,5,6,7]
...
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm10[2,0,2,3,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm3 = xmm10[0],xmm3[0],xmm10[1],xmm3[1]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
; AVX2-FP-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0,1,2,3,4,5],ymm5[6,7]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm5 = xmm9[3,1,2,3]
; AVX2-FP-NEXT:    vmovdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm0 = xmm7[3,1,2,3]
; AVX2-FP-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm5[0,1,2,0,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm0[0,1,2,0,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm5 = xmm7[0],xmm5[0],xmm7[1],xmm5[1]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm0 = xmm8[3,1,2,3]
; AVX2-FP-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm7 = xmm6[3,1,2,3]
; AVX2-FP-NEXT:    vmovdqa %xmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm0[2,0,2,3,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm7[2,0,2,3,4,5,6,7]
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm5 = xmm6[0,1],xmm5[2,3]
...
; AVX2-FP-NEXT:    vmovdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm0[0,1,2,0,4,5,6,7]
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm5[0,1,2,0,4,5,6,7]
...
; AVX2-FP-NEXT:    # xmm2 = mem[3,1,2,3]
; AVX2-FP-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[2,0,2,3,4,5,6,7]
...
; AVX2-FP-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm14 = xmm12[3,1,2,3]
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpshufd $231, (%rsp), %xmm11 # 16-byte Folded Reload
; AVX2-FP-NEXT:    # xmm11 = mem[3,1,2,3]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm9 = xmm15[3,1,2,3]
...
; AVX2-FP-NEXT:    addq $856, %rsp # imm = 0x358
; AVX2-FP-NEXT:    vzeroupper
; AVX2-FP-NEXT:    retq
;
...
; AVX2-FCP-NEXT:    vextracti128 $1, %ymm2, %xmm3
; AVX2-FCP-NEXT:    vpackusdw %xmm3, %xmm2, %xmm2
; AVX2-FCP-NEXT:    vpackusdw %xmm1, %xmm2, %xmm2
; AVX2-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm1 = [0,2,2,3,0,2,4,6]
; AVX2-FCP-NEXT:    vpermd %ymm4, %ymm1, %ymm3
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm10 = [0,1,4,5,4,5,6,7,0,1,4,5,8,9,12,13,16,17,20,21,20,21,22,23,16,17,20,21,24,25,28,29]
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm3, %ymm5
; AVX2-FCP-NEXT:    vpermd %ymm6, %ymm1, %ymm4
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm7 = [0,1,4,5,8,9,12,13,8,9,12,13,12,13,14,15,16,17,20,21,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-FCP-NEXT:    vpshufb %ymm7, %ymm4, %ymm6
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm5 = mem[0],ymm0[1,2,3],mem[4],ymm0[5,6,7],mem[8],ymm0[9,10,11],mem[12],ymm0[13,14,15]
; AVX2-FCP-NEXT:    vextracti128 $1, %ymm5, %xmm6
; AVX2-FCP-NEXT:    vpackusdw %xmm6, %xmm5, %xmm5
; AVX2-FCP-NEXT:    vpackusdw %xmm2, %xmm5, %xmm2
; AVX2-FCP-NEXT:    vpermd %ymm9, %ymm1, %ymm5
; AVX2-FCP-NEXT:    vmovdqu %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm5, %ymm5
; AVX2-FCP-NEXT:    vpermd %ymm8, %ymm1, %ymm13
; AVX2-FCP-NEXT:    vpshufb %ymm7, %ymm13, %ymm6
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm6[0,1,2,3,4,5],ymm5[6,7]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm5[4,5,6,7]
; AVX2-FCP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm2 = mem[0],ymm0[1,2,3],mem[4],ymm0[5,6,7],mem[8],ymm0[9,10,11],mem[12],ymm0[13,14,15]
...
; AVX2-FCP-NEXT:    vpermd %ymm5, %ymm1, %ymm5
; AVX2-FCP-NEXT:    vmovdqu %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermd %ymm2, %ymm1, %ymm10
; AVX2-FCP-NEXT:    vpshufb %ymm8, %ymm5, %ymm1
; AVX2-FCP-NEXT:    vpshufb %ymm7, %ymm10, %ymm2
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm2[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 160(%rdi), %xmm2
; AVX2-FCP-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 176(%rdi), %xmm7
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} xmm1 = [0,1,2,3,2,3,10,11,8,9,10,11,12,13,14,15]
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm7, %xmm0
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm2, %xmm5
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm6 = xmm5[0],xmm0[0],xmm5[1],xmm0[1]
; AVX2-FCP-NEXT:    vmovdqa 128(%rdi), %xmm11
; AVX2-FCP-NEXT:    vmovdqa 144(%rdi), %xmm5
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} xmm0 = [2,3,10,11,8,9,10,11,8,9,10,11,12,13,14,15]
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm5, %xmm9
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm11, %xmm12
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm9 = xmm12[0],xmm9[0],xmm12[1],xmm9[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm6 = xmm9[0,1],xmm6[2,3]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm3 = ymm3[6,7,2,3,4,5,6,7,2,3,6,7,10,11,14,15,22,23,18,19,20,21,22,23,18,19,22,23,26,27,30,31]
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm8 = [2,3,6,7,10,11,14,15,14,15,10,11,12,13,14,15,18,19,22,23,26,27,30,31,30,31,26,27,28,29,30,31]
...
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm6, %xmm4
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm2, %xmm9
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm12 = xmm9[0],xmm4[0],xmm9[1],xmm4[1]
; AVX2-FCP-NEXT:    vmovdqa 384(%rdi), %xmm9
; AVX2-FCP-NEXT:    vmovdqa 400(%rdi), %xmm4
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm4, %xmm15
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm9, %xmm14
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm14 = xmm14[0],xmm15[0],xmm14[1],xmm15[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm12 = xmm14[0,1],xmm12[2,3]
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm2 = [6,7,2,3,4,5,6,7,2,3,6,7,10,11,14,15,22,23,18,19,20,21,22,23,18,19,22,23,26,27,30,31]
; AVX2-FCP-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Reload
; AVX2-FCP-NEXT:    vpshufb %ymm2, %ymm3, %ymm14
; AVX2-FCP-NEXT:    vpshufb %ymm8, %ymm13, %ymm13
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm13 = ymm13[0,1,2,3,4,5],ymm14[6,7]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm8 = ymm12[0,1,2,3],ymm13[4,5,6,7]
; AVX2-FCP-NEXT:    vmovdqu %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 32(%rdi), %xmm3
; AVX2-FCP-NEXT:    vmovdqa %xmm3, (%rsp) # 16-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 48(%rdi), %xmm13
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm13, %xmm12
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm3, %xmm14
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm12 = xmm14[0],xmm12[0],xmm14[1],xmm12[1]
; AVX2-FCP-NEXT:    vmovdqa (%rdi), %xmm3
; AVX2-FCP-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 16(%rdi), %xmm15
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm15, %xmm14
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm3, %xmm8
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm8 = xmm8[0],xmm14[0],xmm8[1],xmm14[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm8 = xmm8[0,1],xmm12[2,3]
; AVX2-FCP-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Reload
; AVX2-FCP-NEXT:    vpshufb %ymm2, %ymm3, %ymm12
; AVX2-FCP-NEXT:    vmovdqa %ymm2, %ymm3
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm2 = [2,3,6,7,10,11,14,15,14,15,10,11,12,13,14,15,18,19,22,23,26,27,30,31,30,31,26,27,28,29,30,31]
; AVX2-FCP-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Reload
; AVX2-FCP-NEXT:    vpshufb %ymm2, %ymm14, %ymm14
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm12 = ymm14[0,1,2,3,4,5],ymm12[6,7]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm8 = ymm8[0,1,2,3],ymm12[4,5,6,7]
; AVX2-FCP-NEXT:    vmovdqu %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 288(%rdi), %xmm12
...
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm1[0],xmm8[0],xmm1[1],xmm8[1]
...
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm0[0],xmm8[0],xmm0[1],xmm8[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm0 = xmm0[0,1],xmm1[2,3]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm14 = [0,1,4,5,8,9,12,13,8,9,12,13,12,13,14,15,16,17,20,21,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm2, %ymm8
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm8[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm2 = xmm7[3,1,2,3]
; AVX2-FCP-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX2-FCP-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm3[0,1,2,0,4,5,6,7]
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm2 = xmm7[0],xmm2[0],xmm7[1],xmm2[1]
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm3 = xmm5[3,1,2,3]
; AVX2-FCP-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm7 = xmm11[3,1,2,3]
; AVX2-FCP-NEXT:    vmovdqa %xmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm3[2,0,2,3,4,5,6,7]
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm2[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm2 = xmm6[3,1,2,3]
; AVX2-FCP-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vpshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm3 = mem[3,1,2,3]
; AVX2-FCP-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm3 = xmm4[3,1,2,3]
; AVX2-FCP-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm4 = xmm9[3,1,2,3]
...
; AVX2-FCP-NEXT:    vpermd {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermd {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm12 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm1, %ymm1
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm12, %ymm2
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm4 = ymm2[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm11 = xmm13[3,1,2,3]
; AVX2-FCP-NEXT:    vpshufd $231, (%rsp), %xmm8 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm8 = mem[3,1,2,3]
; AVX2-FCP-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm11[0,1,2,0,4,5,6,7]
; AVX2-FCP-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm8[0,1,2,0,4,5,6,7]
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm6 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm7 = xmm15[3,1,2,3]
; AVX2-FCP-NEXT:    vpshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm10 = mem[3,1,2,3]
; AVX2-FCP-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm7[2,0,2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm10[2,0,2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm9 = xmm13[0],xmm9[0],xmm13[1],xmm9[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm6 = xmm9[0,1],xmm6[2,3]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm6[0,1,2,3],ymm4[4,5,6,7]
; AVX2-FCP-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermd {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermd {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm13 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    vpshufb %ymm5, %ymm1, %ymm0
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm13, %ymm4
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm2 = ymm4[0,1,2,3,4,5],ymm0[6,7]
...
; AVX2-FCP-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm15[0,1,2,0,4,5,6,7]
...
; AVX2-FCP-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm9[2,0,2,3,4,5,6,7]
...
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm2 = xmm14[0],xmm2[0],xmm14[1],xmm2[1]
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm2[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm11[0,1,3,1,4,5,6,7]
...
; AVX2-FCP-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm10[3,1,2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm3 = xmm3[0],xmm7[0],xmm3[1],xmm7[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm2 = xmm3[0,1],xmm2[2,3]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm2[0,1,2,3],ymm1[4,5,6,7]
...
; AVX2-FCP-NEXT:    vpshuflw $116, {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm7 = mem[0,1,3,1,4,5,6,7]
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm3 = xmm7[0],xmm3[0],xmm7[1],xmm3[1]
; AVX2-FCP-NEXT:    vpshuflw $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm7 = mem[3,1,2,3,4,5,6,7]
...
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm13, %ymm7
