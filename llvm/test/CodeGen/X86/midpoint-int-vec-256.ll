...
; XOP-NEXT:    vmovdqa (%rdi), %xmm2
; XOP-NEXT:    vmovdqa 16(%rdi), %xmm3
; XOP-NEXT:    vpminsd %xmm3, %xmm1, %xmm4
; XOP-NEXT:    vpmaxsd %xmm3, %xmm1, %xmm3
; XOP-NEXT:    vpsubd %xmm4, %xmm3, %xmm3
; XOP-NEXT:    vpminsd %xmm2, %xmm0, %xmm4
; XOP-NEXT:    vpmaxsd %xmm2, %xmm0, %xmm2
; XOP-NEXT:    vpsubd %xmm4, %xmm2, %xmm2
; XOP-NEXT:    vpsrld $1, %xmm2, %xmm2
; XOP-NEXT:    vpsrld $1, %xmm3, %xmm3
; XOP-NEXT:    vpmacsdd %xmm1, %xmm3, %xmm3, %xmm1
; XOP-NEXT:    vpmacsdd %xmm0, %xmm2, %xmm2, %xmm0
; XOP-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; XOP-NEXT:    retq
;
...
; AVX512VL-ONLY:       # %bb.0:
; AVX512VL-ONLY-NEXT:    vpcmpgtw %ymm1, %ymm0, %ymm2
; AVX512VL-ONLY-NEXT:    vpord {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %ymm2, %ymm2
; AVX512VL-ONLY-NEXT:    vpminsw %ymm1, %ymm0, %ymm3
; AVX512VL-ONLY-NEXT:    vpmaxsw %ymm1, %ymm0, %ymm1
; AVX512VL-ONLY-NEXT:    vpsubw %ymm3, %ymm1, %ymm1
...
; AVX512VL-ONLY-NEXT:    vpcmpeqw %ymm2, %ymm0, %ymm3
; AVX512VL-ONLY-NEXT:    vpcmpeqd %ymm4, %ymm4, %ymm4
; AVX512VL-ONLY-NEXT:    vpternlogd {{.*#+}} ymm4 = m32bcst | (ymm4 ^ ymm3)
; AVX512VL-ONLY-NEXT:    vpmaxuw %ymm1, %ymm0, %ymm1
; AVX512VL-ONLY-NEXT:    vpsubw %ymm2, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpsrlw $1, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpmullw %ymm4, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpaddw %ymm0, %ymm1, %ymm0
; AVX512VL-ONLY-NEXT:    retq
;
...
; AVX512VL-ONLY-NEXT:    vpcmpgtw %ymm0, %ymm1, %ymm2
; AVX512VL-ONLY-NEXT:    vpord {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %ymm2, %ymm2
; AVX512VL-ONLY-NEXT:    vpminsw %ymm0, %ymm1, %ymm3
; AVX512VL-ONLY-NEXT:    vpmaxsw %ymm0, %ymm1, %ymm0
; AVX512VL-ONLY-NEXT:    vpsubw %ymm3, %ymm0, %ymm0
; AVX512VL-ONLY-NEXT:    vpsrlw $1, %ymm0, %ymm0
...
; AVX512VL-ONLY:       # %bb.0:
; AVX512VL-ONLY-NEXT:    vpcmpgtb %ymm1, %ymm0, %ymm2
; AVX512VL-ONLY-NEXT:    vpord {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %ymm2, %ymm2
; AVX512VL-ONLY-NEXT:    vpminsb %ymm1, %ymm0, %ymm3
; AVX512VL-ONLY-NEXT:    vpmaxsb %ymm1, %ymm0, %ymm1
; AVX512VL-ONLY-NEXT:    vpsubb %ymm3, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpsrlw $1, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpandd {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpmullw %ymm2, %ymm1, %ymm3
; AVX512VL-ONLY-NEXT:    vpbroadcastd {{.*#+}} ymm4 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; AVX512VL-ONLY-NEXT:    vpandn %ymm2, %ymm4, %ymm2
; AVX512VL-ONLY-NEXT:    vpmaddubsw %ymm2, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpsllw $8, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpternlogq {{.*#+}} ymm1 = ymm1 | (ymm3 & ymm4)
...
; AVX512VL-ONLY-NEXT:    vpcmpeqb %ymm2, %ymm0, %ymm3
; AVX512VL-ONLY-NEXT:    vpcmpeqd %ymm4, %ymm4, %ymm4
; AVX512VL-ONLY-NEXT:    vpternlogd {{.*#+}} ymm4 = m32bcst | (ymm4 ^ ymm3)
...
; AVX512VL-ONLY-NEXT:    vpsrlw $1, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpandd {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpmullw %ymm4, %ymm1, %ymm2
; AVX512VL-ONLY-NEXT:    vpbroadcastd {{.*#+}} ymm3 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; AVX512VL-ONLY-NEXT:    vpandn %ymm4, %ymm3, %ymm4
; AVX512VL-ONLY-NEXT:    vpmaddubsw %ymm4, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpsllw $8, %ymm1, %ymm1
; AVX512VL-ONLY-NEXT:    vpternlogq {{.*#+}} ymm1 = ymm1 | (ymm2 & ymm3)
; AVX512VL-ONLY-NEXT:    vpaddb %ymm0, %ymm1, %ymm0
; AVX512VL-ONLY-NEXT:    retq
;
...
; AVX512VL-ONLY:       # %bb.0:
; AVX512VL-ONLY-NEXT:    vmovdqa (%rdi), %ymm1
; AVX512VL-ONLY-NEXT:    vpcmpgtb %ymm0, %ymm1, %ymm2
; AVX512VL-ONLY-NEXT:    vpord {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %ymm2, %ymm2
; AVX512VL-ONLY-NEXT:    vpminsb %ymm0, %ymm1, %ymm3
; AVX512VL-ONLY-NEXT:    vpmaxsb %ymm0, %ymm1, %ymm0
; AVX512VL-ONLY-NEXT:    vpsubb %ymm3, %ymm0, %ymm0
; AVX512VL-ONLY-NEXT:    vpsrlw $1, %ymm0, %ymm0
; AVX512VL-ONLY-NEXT:    vpandd {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %ymm0, %ymm0
; AVX512VL-ONLY-NEXT:    vpmullw %ymm2, %ymm0, %ymm3
; AVX512VL-ONLY-NEXT:    vpbroadcastd {{.*#+}} ymm4 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; AVX512VL-ONLY-NEXT:    vpandn %ymm2, %ymm4, %ymm2
; AVX512VL-ONLY-NEXT:    vpmaddubsw %ymm2, %ymm0, %ymm0
; AVX512VL-ONLY-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX512VL-ONLY-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm0 | (ymm3 & ymm4)
