...
; AVX512VL-FALLBACK-NEXT:    vpmullw %ymm2, %ymm0, %ymm3
; AVX512VL-FALLBACK-NEXT:    vpbroadcastd {{.*#+}} ymm4 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; AVX512VL-FALLBACK-NEXT:    vpandn %ymm2, %ymm4, %ymm2
; AVX512VL-FALLBACK-NEXT:    vpmaddubsw %ymm2, %ymm0, %ymm0
; AVX512VL-FALLBACK-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX512VL-FALLBACK-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm0 | (ymm3 & ymm4)
