...
; AVX512VL-FALLBACK-NEXT:    vpand %ymm2, %ymm3, %ymm4
...
; AVX512VL-FALLBACK-NEXT:    vpternlogq $248, %ymm3, %ymm4, %ymm1
...
; AVX512VL-FALLBACK-NEXT:    vpand %ymm4, %ymm2, %ymm3
...
; AVX512VL-FALLBACK-NEXT:    vpsllw $8, %ymm1, %ymm1
; AVX512VL-FALLBACK-NEXT:    vpternlogq $248, %ymm2, %ymm3, %ymm1
; AVX512VL-FALLBACK-NEXT:    vpaddb %ymm0, %ymm1, %ymm0
; AVX512VL-FALLBACK-NEXT:    retq
;
...
; AVX512VL-FALLBACK-NEXT:    vpternlogq $248, %ymm3, %ymm4, %ymm0
