...
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm5 = ymm1[0],ymm4[0],ymm1[2],ymm4[2]
...
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm2[0],ymm6[0],ymm2[2],ymm6[2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm1[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 96(%rdi), %ymm1, %ymm1
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm1[0],ymm8[0],ymm1[2],ymm8[2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm3[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 224(%rdi), %ymm3, %ymm3
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm3[0],ymm10[0],ymm3[2],ymm10[2]
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm0[1],ymm4[1],ymm0[3],ymm4[3]
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm1[1],ymm8[1],ymm1[3],ymm8[3]
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm2[1],ymm6[1],ymm2[3],ymm6[3]
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm3[1],ymm10[1],ymm3[3],ymm10[3]
...
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
...
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,2,1,3]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm2[0],ymm3[0],ymm2[2],ymm3[2]
...
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,2,1,3]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm2[0],ymm3[0],ymm2[2],ymm3[2]
...
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm13[0],ymm12[0],ymm13[2],ymm12[2]
...
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm8 = ymm9[1],ymm8[1],ymm9[3],ymm8[3]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm6[0],ymm5[0],ymm6[2],ymm5[2]
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm6[1],ymm5[1],ymm6[3],ymm5[3]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm7[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 224(%rdi), %ymm7, %ymm7
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm10 = ymm11[1],ymm10[1],ymm11[3],ymm10[3]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm7[0],ymm6[0],ymm7[2],ymm6[2]
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm7[1],ymm6[1],ymm7[3],ymm6[3]
...
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm3[0],ymm7[0],ymm3[2],ymm7[2]
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm3[1],ymm7[1],ymm3[3],ymm7[3]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm15[0],ymm14[0],ymm15[2],ymm14[2]
...
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm0[0],ymm15[0],ymm0[2],ymm15[2]
...
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm15[0],ymm3[0],ymm15[2],ymm3[2]
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm15[1],ymm3[1],ymm15[3],ymm3[3]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm8[0],ymm5[0],ymm8[2],ymm5[2]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm8[1],ymm5[1],ymm8[3],ymm5[3]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm14[0],ymm13[0],ymm14[2],ymm13[2]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm8 = ymm14[1],ymm13[1],ymm14[3],ymm13[3]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm10[0],ymm9[0],ymm10[2],ymm9[2]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm10[1],ymm9[1],ymm10[3],ymm9[3]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm12[0],ymm11[0],ymm12[2],ymm11[2]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm12[1],ymm11[1],ymm12[3],ymm11[3]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm12 = ymm7[0],ymm6[0],ymm7[2],ymm6[2]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm7[1],ymm6[1],ymm7[3],ymm6[3]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm2[0],ymm4[0],ymm2[2],ymm4[2]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm2[1],ymm4[1],ymm2[3],ymm4[3]
; AVX2-NEXT:    vmovaps 96(%rdi), %ymm4
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm0[0],ymm4[0],ymm0[2],ymm4[2]
...
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm15[0],ymm3[0],ymm15[2],ymm3[2]
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm15[1],ymm3[1],ymm15[3],ymm3[3]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm8[0],ymm5[0],ymm8[2],ymm5[2]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm8[1],ymm5[1],ymm8[3],ymm5[3]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm14[0],ymm13[0],ymm14[2],ymm13[2]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm8 = ymm14[1],ymm13[1],ymm14[3],ymm13[3]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm10[0],ymm9[0],ymm10[2],ymm9[2]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm10[1],ymm9[1],ymm10[3],ymm9[3]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm12[0],ymm11[0],ymm12[2],ymm11[2]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm12[1],ymm11[1],ymm12[3],ymm11[3]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm12 = ymm7[0],ymm6[0],ymm7[2],ymm6[2]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm7[1],ymm6[1],ymm7[3],ymm6[3]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm2[0],ymm4[0],ymm2[2],ymm4[2]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm2[1],ymm4[1],ymm2[3],ymm4[3]
; AVX2-FP-NEXT:    vmovaps 96(%rdi), %ymm4
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm0[0],ymm4[0],ymm0[2],ymm4[2]
...
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm15[0],ymm3[0],ymm15[2],ymm3[2]
; AVX2-FCP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm15[1],ymm3[1],ymm15[3],ymm3[3]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm8[0],ymm5[0],ymm8[2],ymm5[2]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm8[1],ymm5[1],ymm8[3],ymm5[3]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm14[0],ymm13[0],ymm14[2],ymm13[2]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm8 = ymm14[1],ymm13[1],ymm14[3],ymm13[3]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm10[0],ymm9[0],ymm10[2],ymm9[2]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm10[1],ymm9[1],ymm10[3],ymm9[3]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm12[0],ymm11[0],ymm12[2],ymm11[2]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm12[1],ymm11[1],ymm12[3],ymm11[3]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm12 = ymm7[0],ymm6[0],ymm7[2],ymm6[2]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm7[1],ymm6[1],ymm7[3],ymm6[3]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm2[0],ymm4[0],ymm2[2],ymm4[2]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm2[1],ymm4[1],ymm2[3],ymm4[3]
; AVX2-FCP-NEXT:    vmovaps 96(%rdi), %ymm4
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm0[0],ymm4[0],ymm0[2],ymm4[2]
...
; AVX512-NEXT:    vpermt2q %zmm1, %zmm8, %zmm11
...
; AVX512-FCP-NEXT:    vpermt2q %zmm1, %zmm8, %zmm11
...
; AVX512DQ-NEXT:    vpermt2q %zmm1, %zmm8, %zmm11
...
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm1, %zmm8, %zmm11
...
; AVX512BW-NEXT:    vpermt2q %zmm1, %zmm8, %zmm11
...
; AVX512BW-FCP-NEXT:    vpermt2q %zmm1, %zmm8, %zmm11
...
; AVX512DQ-BW-NEXT:    vpermt2q %zmm1, %zmm8, %zmm11
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm1, %zmm8, %zmm11
...
; AVX-NEXT:    vinsertf128 $1, 224(%rdi), %ymm5, %ymm2
...
; AVX-NEXT:    vinsertf128 $1, 352(%rdi), %ymm8, %ymm2
...
; AVX-NEXT:    vinsertf128 $1, 480(%rdi), %ymm7, %ymm1
...
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm0[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 608(%rdi), %ymm0, %ymm2
...
; AVX-NEXT:    vmovaps %ymm6, 352(%rsi)
; AVX-NEXT:    vmovaps %ymm10, 288(%rsi)
...
; AVX-NEXT:    vmovaps %ymm4, 448(%rsi)
; AVX-NEXT:    vmovaps %ymm7, 384(%rsi)
; AVX-NEXT:    vmovaps %ymm11, 320(%rsi)
; AVX-NEXT:    vmovaps %ymm15, 256(%rsi)
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
...
; AVX-NEXT:    vmovaps %ymm5, 448(%rdx)
; AVX-NEXT:    vmovaps %ymm8, 416(%rdx)
; AVX-NEXT:    vmovaps %ymm9, 384(%rdx)
; AVX-NEXT:    vmovaps %ymm12, 352(%rdx)
; AVX-NEXT:    vmovaps %ymm14, 320(%rdx)
...
; AVX2-NEXT:    vmovaps 384(%rdi), %ymm13
...
; AVX2-FCP-NEXT:    vmovaps 384(%rdi), %ymm13
...
; AVX512-NEXT:    vmovdqa64 576(%rdi), %zmm10
...
; AVX512-NEXT:    vpermt2q %zmm1, %zmm16, %zmm23
; AVX512-NEXT:    vpermi2q %zmm3, %zmm2, %zmm16
...
; AVX512-FCP-NEXT:    vpermt2q %zmm1, %zmm16, %zmm23
; AVX512-FCP-NEXT:    vpermi2q %zmm3, %zmm2, %zmm16
...
; AVX512DQ-NEXT:    vmovdqa64 576(%rdi), %zmm10
...
; AVX512DQ-NEXT:    vpermt2q %zmm1, %zmm16, %zmm23
; AVX512DQ-NEXT:    vpermi2q %zmm3, %zmm2, %zmm16
...
; AVX512DQ-NEXT:    vmovdqa64 %zmm19, 256(%rsi)
; AVX512DQ-NEXT:    vmovdqa64 %zmm18, 192(%rsi)
; AVX512DQ-NEXT:    vmovdqa64 %zmm17, 128(%rsi)
...
; AVX512DQ-NEXT:    vmovdqa64 %zmm15, 128(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, 64(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, (%rdx)
; AVX512DQ-NEXT:    vzeroupper
; AVX512DQ-NEXT:    retq
...
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm1, %zmm16, %zmm23
; AVX512DQ-FCP-NEXT:    vpermi2q %zmm3, %zmm2, %zmm16
...
; AVX512BW-NEXT:    vpermt2q %zmm1, %zmm16, %zmm23
; AVX512BW-NEXT:    vpermi2q %zmm3, %zmm2, %zmm16
...
; AVX512BW-NEXT:    vmovdqa64 %zmm16, 64(%rsi)
...
; AVX512BW-NEXT:    vmovdqa64 %zmm15, 128(%rdx)
; AVX512BW-NEXT:    vmovdqa64 %zmm2, 64(%rdx)
; AVX512BW-NEXT:    vmovdqa64 %zmm0, (%rdx)
; AVX512BW-NEXT:    vzeroupper
; AVX512BW-NEXT:    retq
...
; AVX512BW-FCP-NEXT:    vmovdqa64 576(%rdi), %zmm10
...
; AVX512BW-FCP-NEXT:    vpermt2q %zmm1, %zmm16, %zmm23
; AVX512BW-FCP-NEXT:    vpermi2q %zmm3, %zmm2, %zmm16
...
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm19, 256(%rsi)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm18, 192(%rsi)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm17, 128(%rsi)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm16, 64(%rsi)
...
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm11, 256(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm13, 192(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm15, 128(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm2, 64(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, (%rdx)
; AVX512BW-FCP-NEXT:    vzeroupper
; AVX512BW-FCP-NEXT:    retq
...
; AVX512DQ-BW-NEXT:    vmovdqa64 576(%rdi), %zmm10
...
; AVX512DQ-BW-NEXT:    vpermt2q %zmm1, %zmm16, %zmm23
; AVX512DQ-BW-NEXT:    vpermi2q %zmm3, %zmm2, %zmm16
...
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm19, 256(%rsi)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm18, 192(%rsi)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm17, 128(%rsi)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm16, 64(%rsi)
...
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm11, 256(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm13, 192(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm15, 128(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, 64(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, (%rdx)
; AVX512DQ-BW-NEXT:    vzeroupper
; AVX512DQ-BW-NEXT:    retq
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 576(%rdi), %zmm10
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm1, %zmm16, %zmm23
; AVX512DQ-BW-FCP-NEXT:    vpermi2q %zmm3, %zmm2, %zmm16
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm19, 256(%rsi)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm18, 192(%rsi)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm17, 128(%rsi)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm16, 64(%rsi)
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm11, 256(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm13, 192(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm15, 128(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm2, 64(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, (%rdx)
; AVX512DQ-BW-FCP-NEXT:    vzeroupper
; AVX512DQ-BW-FCP-NEXT:    retq
