...
; X86-NO-BMI2-NO-SHLD-NEXT:    andb $96, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrb $3, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    movzbl %cl, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl (%esp,%eax), %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 4(%esp,%eax), %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %dh, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %dh, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 8(%esp,%eax), %edi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %dh, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, 12(%edi)
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, 8(%edi)
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    andb $96, %dl
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    andb $96, %dl
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrb $3, %dl
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movzbl %dl, %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, (%esp,%esi), %edi
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, %ebx, %edi
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ecx, 12(%esi)
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    andb $96, %dl
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrb $3, %dl
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movzbl %dl, %ebx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 8(%esp,%ebx), %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl (%esp,%ebx), %edx
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, 12(%eax)
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, 4(%eax)
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edi, 12(%eax)
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movsbl %dl, %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 16(%esp,%ebx), %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 20(%esp,%ebx), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 24(%esp,%ebx), %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebp, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 28(%esp,%ebx), %ebx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movsbl %dl, %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 32(%esp,%edx), %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 36(%esp,%edx), %ebx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 40(%esp,%edx), %ebp
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ecx, 44(%esp,%edx), %ecx
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 16(%esp,%edi), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 20(%esp,%edi), %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 24(%esp,%edi), %ebx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebx, %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %esi, %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 28(%esp,%edi), %edi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    andb $96, %al
; X86-NO-BMI2-NO-SHLD-NEXT:    shrb $3, %al
; X86-NO-BMI2-NO-SHLD-NEXT:    movzbl %al, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl (%esp,%edi), %eax
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebp, 4(%eax)
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    andb $-64, %cl
; X64-NO-BMI2-NO-SHLD-NEXT:    shrb $3, %cl
; X64-NO-BMI2-NO-SHLD-NEXT:    movzbl %cl, %r8d
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -72(%rsp,%r8), %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -64(%rsp,%r8), %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -56(%rsp,%r8), %r9
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -48(%rsp,%r8), %r8
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    andb $-64, %al
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shrb $3, %al
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movzbl %al, %eax
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -56(%rsp,%rax), %rsi
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -72(%rsp,%rax), %rdi
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -64(%rsp,%rax), %r8
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %r8, %r9
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %rsi, %r9
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -48(%rsp,%rax), %rax
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    andb $-64, %sil
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrb $3, %sil
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movzbl %sil, %esi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, -72(%rsp,%rsi), %rdi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    andb $63, %al
; X64-HAVE-BMI2-NO-SHLD-NEXT:    xorb $63, %al
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -64(%rsp,%rsi), %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -56(%rsp,%rsi), %r9
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, %r8, %rdi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    leaq (%r9,%r9), %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %rax, %r8, %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %rdi, %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, %r9, %rdi
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    andb $-64, %al
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -72(%rsp,%rax), %rdi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -64(%rsp,%rax), %r8
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[0-9]+}}(%esp)
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %al
; X86-NO-BMI2-NO-SHLD-NEXT:    andb $-32, %al
; X86-NO-BMI2-NO-SHLD-NEXT:    shrb $3, %al
; X86-NO-BMI2-NO-SHLD-NEXT:    movzbl %al, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 16(%esp,%edi), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 20(%esp,%edi), %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %dl
; X86-NO-BMI2-NO-SHLD-NEXT:    andb $31, %dl
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 24(%esp,%edi), %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (%ebx,%ebx), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %dl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %eax
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 28(%esp,%edi), %ebp
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 36(%esp,%edi), %eax
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 44(%esp,%edi), %eax
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    andb $-32, %al
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrb $3, %al
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movzbl %al, %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 24(%esp,%ebp), %eax
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 20(%esp,%ebp), %edx
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, (%esp) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 32(%esp,%ebp), %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %ebx, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 36(%esp,%ebp), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edx, %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 40(%esp,%ebp), %eax
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %eax, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 16(%esp,%ebp), %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 44(%esp,%ebp), %ebp
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebp, 28(%ecx)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, 24(%ecx)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, 20(%ecx)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebx, 16(%ecx)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %eax, %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    andb $-32, %dl
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrb $3, %dl
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movzbl %dl, %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, 16(%esp,%esi), %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    andb $31, %al
; X86-HAVE-BMI2-NO-SHLD-NEXT:    xorb $31, %al
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 20(%esp,%esi), %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 24(%esp,%esi), %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%edi,%edi), %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %eax, %ebp, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %edx, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, %edi, %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%ebx,%ebx), %edi
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 28(%esp,%esi), %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%ebp,%ebp), %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %eax, %ebx, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %edx, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, %ebp, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 32(%esp,%esi), %edx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, %edx, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 36(%esp,%esi), %edx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 40(%esp,%esi), %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%edx,%edx), %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %eax, %ebx, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ebp, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 44(%esp,%esi), %esi
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ecx, %esi, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ecx, 28(%edx)
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %eax, 24(%edx)
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebx, 20(%edx)
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, 16(%edx)
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, {{[0-9]+}}(%esp)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, %eax
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    andb $-32, %al
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 32(%esp,%edx), %eax
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 36(%esp,%edx), %eax
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 44(%esp,%edx), %eax
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 48(%esp,%edx), %eax
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 52(%esp,%edx), %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 56(%esp,%edx), %esi
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, 20(%ebx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, 16(%ebx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, 12(%ebx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -32(%rsp,%rax), %rdi
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -24(%rsp,%rax), %r8
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %r8, %r9
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %rdi, %r9
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %rcx, %rdi, %r9
; X64-HAVE-BMI2-NO-SHLD-NEXT:    andb $63, %al
; X64-HAVE-BMI2-NO-SHLD-NEXT:    xorb $63, %al
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -24(%rsp,%rax), %r8
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r8, %r9
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movb (%ebx), %ch
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 64(%esp,%ebx), %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 68(%esp,%ebx), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %eax
...
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %eax, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 84(%esp,%ebx), %eax
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 92(%esp,%esi), %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %bl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebp, 16(%ecx)
; X86-NO-BMI2-NO-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, 12(%ecx)
; X86-NO-BMI2-NO-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, 8(%ecx)
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 52(%esp,%edi), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 56(%esp,%edi), %eax
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebx, 20(%edi)
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %esi, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, 4(%edi)
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %eax, %edx, %ebx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 76(%esp,%esi), %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ecx, %edx, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %edi, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %eax, %edx, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 80(%esp,%esi), %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ecx, %edx, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %edi, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %eax, %edx, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 84(%esp,%esi), %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ecx, %edx, %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ebp, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %eax, %edx, %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 88(%esp,%esi), %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ecx, %ebp, %ebx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ebx, %edx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ecx, {{[-0-9]+}}(%e{{[sb]}}p), %ebx # 4-byte Folded Reload
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ecx, 92(%esp,%esi), %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %eax, %ebp, %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ecx, %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %ecx
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, 20(%ecx)
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 60(%esp,%edi), %ebp
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 68(%esp,%edi), %ebp
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 48(%esp,%edi), %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 76(%esp,%edi), %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, 28(%edi)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, 24(%edi)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, 20(%edi)
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %esi, %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, 4(%edi)
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 40(%esp,%edi), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (%eax,%eax), %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %dl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %ebp
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, 16(%eax)
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -128(%rsp,%rdi), %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -120(%rsp,%rdi), %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %esi
; X64-NO-BMI2-NO-SHLD-NEXT:    xorb $63, %sil
; X64-NO-BMI2-NO-SHLD-NEXT:    leaq (%r10,%r10), %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r9, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -112(%rsp,%rdi), %r11
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r11
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -104(%rsp,%rdi), %rbx
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -80(%rsp,%rdi), %r14
; X64-NO-BMI2-NO-SHLD-NEXT:    leaq (%r14,%r14), %r12
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %ecx
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -96(%rsp,%rax), %r11
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %r11, %r10
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -88(%rsp,%rax), %rbx
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %rbx, %r11
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -80(%rsp,%rax), %r14
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %r14, %rbx
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -72(%rsp,%rax), %rax
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %rax, %r14
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %rbx, 40(%rdx)
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, -128(%rsp,%rax), %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    xorb $63, %sil
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -120(%rsp,%rax), %r9
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %r9, %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, %r10, %r10
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -104(%rsp,%rax), %r11
; X64-HAVE-BMI2-NO-SHLD-NEXT:    leaq (%r11,%r11), %r9
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %rsi, %r9, %r9
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %r10, %r9
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, %r11, %r10
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -96(%rsp,%rax), %r11
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    leaq (%r11,%r11), %r14
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    leaq (%r11,%r11), %r15
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %rsi, %r15, %r15
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %r10, %r15
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, %r11, %r10
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -72(%rsp,%rax), %rax
; X64-HAVE-BMI2-NO-SHLD-NEXT:    leaq (%rax,%rax), %r11
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %rsi, %r11, %rsi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %r10, %rsi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rcx, %rax, %rax
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -96(%rsp,%rax), %r11
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %r11, %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -88(%rsp,%rax), %rbx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %rbx, %r11
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -80(%rsp,%rax), %r14
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %r14, %rbx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -72(%rsp,%rax), %rax
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %rax, %r14
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 72(%esp,%esi), %ebx
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 88(%esp,%esi), %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (%ebx,%ebx), %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %edi, %ebp
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 104(%esp,%esi), %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (%ebx,%ebx), %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %edi, %ebp
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 112(%esp,%esi), %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (%ebx,%ebx), %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %edi, %ebp
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 116(%esp,%esi), %ebp
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 120(%esp,%esi), %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (%edi,%edi), %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %ebx
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 124(%esp,%esi), %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (%esi,%esi), %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %edi, %ebp
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 60(%esp,%eax), %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 64(%esp,%eax), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edx, %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 80(%esp,%eax), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edx, %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 84(%esp,%eax), %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 96(%esp,%eax), %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %ebp, %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 100(%esp,%eax), %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %ebx, %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 104(%esp,%eax), %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edi, %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 48(%esp,%eax), %esi
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %edx, 48(%esp,%eax), %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    xorb $31, %bl
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 52(%esp,%eax), %esi
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %edx, %edi, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 60(%esp,%eax), %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%esi,%esi), %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ebx, %edi, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ecx, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %edx, %esi, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 64(%esp,%eax), %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%esi,%esi), %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ebx, %edi, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ecx, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %edx, %esi, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 68(%esp,%eax), %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%esi,%esi), %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ebx, %edi, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ecx, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %edx, %esi, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 76(%esp,%eax), %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal (%esi,%esi), %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %ebx, %edi, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %ecx, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 104(%esp,%eax), %ebp
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 108(%esp,%eax), %eax
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 52(%esp,%eax), %edi
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 64(%esp,%eax), %edx
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 80(%esp,%eax), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edx, %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 84(%esp,%eax), %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 88(%esp,%eax), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edx, %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, (%esp) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 92(%esp,%eax), %ebx
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edx, %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 48(%esp,%eax), %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, 4(%eax)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrxl %ecx, %ebp, %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    # kill: def $cl killed $cl killed $ecx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edi # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edi
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movslq %esi, %r11
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -64(%rsp,%r11), %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -56(%rsp,%r11), %rdi
...
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r10, %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -48(%rsp,%r11), %r10
...
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %rbx, %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -40(%rsp,%r11), %rbx
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r14, %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -32(%rsp,%r11), %r14
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -24(%rsp,%r11), %r15
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -16(%rsp,%r11), %r12
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -8(%rsp,%r11), %r11
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %r11
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %r12
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r12
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r11, %r12
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %r8, (%rdx)
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %rbx, 32(%rdx)
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %r10, 24(%rdx)
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %rdi, 16(%rdx)
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %r9, 8(%rdx)
; X64-NO-BMI2-NO-SHLD-NEXT:    popq %rbx
; X64-NO-BMI2-NO-SHLD-NEXT:    popq %r12
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -64(%rsp,%r9), %rdi
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -56(%rsp,%r9), %rax
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -48(%rsp,%r9), %r10
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r10, %r8
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -32(%rsp,%r9), %r10
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %r10, %rbx
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r11, %rbx
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -24(%rsp,%r9), %r11
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %r11, %r14
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r10, %r14
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -16(%rsp,%r9), %r10
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %r10, %r15
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r11, %r15
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %r15, 48(%rdx)
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -32(%rsp,%rsi), %rbx
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -24(%rsp,%rsi), %r14
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %rcx, %r14, %r15
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrq %rbx
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rax, %rbx, %rbx
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %r15, %rbx
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq -16(%rsp,%rsi), %r15
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %rcx, %r15, %r12
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrq %r14
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rax, %r14, %r14
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %r12, %r14
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %rcx, -8(%rsp,%rsi), %rcx
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrq %r15
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rax, %r15, %rax
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %rcx, %rax
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq %r10, (%rdx)
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq %rax, 56(%rdx)
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq %r14, 48(%rdx)
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -64(%rsp,%r9), %rdi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -56(%rsp,%r9), %rax
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -48(%rsp,%r9), %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r10, %rsi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %rax, %rsi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -40(%rsp,%r9), %r11
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r11, %r8
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r10, %r8
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -32(%rsp,%r9), %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r10, %rbx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r11, %rbx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -24(%rsp,%r9), %r11
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r11, %r14
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r10, %r14
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -16(%rsp,%r9), %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r10, %r15
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r11, %r15
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -8(%rsp,%r9), %r9
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r10, %r9
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shlxq %rcx, %rdi, %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    # kill: def $cl killed $cl killed $rcx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %rdi, %rax
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r9, 56(%rdx)
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r15, 48(%rdx)
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r10, (%rdx)
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    popq %rbx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    popq %r14
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 8(%ecx), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 12(%ecx), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 16(%ecx), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 20(%ecx), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 24(%ecx), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 28(%ecx), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 32(%ecx), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 36(%ecx), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 40(%ecx), %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 44(%ecx), %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 48(%ecx), %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 52(%ecx), %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 56(%ecx), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 60(%ecx), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl (%ecx), %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    xorps %xmm0, %xmm0
; X86-NO-BMI2-NO-SHLD-NEXT:    movaps %xmm0, {{[0-9]+}}(%esp)
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[0-9]+}}(%esp)
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, {{[0-9]+}}(%esp)
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 132(%esp,%ecx), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %eax
...
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %eax, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 12(%edi), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %bl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %esi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %eax, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 16(%edi), %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %bl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %edx
...
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %eax, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 28(%edi), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %bl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %esi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %eax, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 32(%edi), %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %bl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %edx
...
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %eax, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 36(%edi), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %bl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %esi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %eax, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 40(%edi), %esi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %eax, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 48(%ebx), %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edi, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %dl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %eax
...
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %eax, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 52(%ebx), %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %dl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %eax
...
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %eax, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 56(%ebx), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %edx
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 60(%edx), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %bl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    leal {{[0-9]+}}(%esp), %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    subl %esi, %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 8(%ebp), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 16(%ebp), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %eax, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 20(%ebp), %eax
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 24(%ebp), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %eax, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 32(%ebp), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %eax, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 36(%ebp), %eax
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 40(%ebp), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %eax, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 44(%ebp), %eax
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, (%esp) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 48(%ebp), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %eax, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 52(%ebp), %eax
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 56(%ebp), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %eax, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl (%ebp), %eax
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 60(%ebp), %eax
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %eax
; X86-NO-BMI2-HAVE-SHLD-NEXT:    negl %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 116(%esp,%esi), %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, 60(%esi)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, 56(%esi)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebx, 52(%esi)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shll %cl, %eax
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, 12(%esi)
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, 8(%esi)
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-NO-SHLD-NEXT:    leal {{[0-9]+}}(%esp), %eax
; X86-HAVE-BMI2-NO-SHLD-NEXT:    subl %ecx, %eax
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrxl %ebx, %ecx, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 8(%eax), %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %edx, %ecx, %esi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %esi, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 52(%eax), %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %edx, %ebp, %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    orl %edi, %ecx
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl 56(%eax), %edi
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shrl %ebp
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %edx, {{[-0-9]+}}(%e{{[sb]}}p), %ebx # 4-byte Folded Reload
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ebp # 4-byte Reload
; X86-HAVE-BMI2-NO-SHLD-NEXT:    negl %ebp
; X86-HAVE-BMI2-NO-SHLD-NEXT:    shlxl %edx, 188(%esp,%ebp), %ebp
...
; X86-HAVE-BMI2-NO-SHLD-NEXT:    movl %ecx, 52(%edx)
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 8(%ebp), %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 12(%ebp), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %esi, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 16(%ebp), %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 20(%ebp), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %esi, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 24(%ebp), %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 28(%ebp), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %esi, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 32(%ebp), %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 36(%ebp), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %esi, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 40(%ebp), %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 44(%ebp), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %esi, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, (%esp) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 48(%ebp), %edi
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 56(%ebp), %edi
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 116(%esp,%eax), %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, 60(%eax)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, 56(%eax)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebx, 52(%eax)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, 48(%eax)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl (%esp), %edx # 4-byte Reload
...
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl $3, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    andl $60, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 64(%esp,%ecx), %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 68(%esp,%ecx), %edi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 124(%esp,%esi), %ebp
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, 4(%eax)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    sarxl %ecx, %ebp, %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    # kill: def $cl killed $cl killed $ecx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edi # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edi
