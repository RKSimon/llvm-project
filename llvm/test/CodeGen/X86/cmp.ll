...
; NDD:       # %bb.0:
; NDD-NEXT:    movzwl %di, %eax # encoding: [0x0f,0xb7,0xc7]
; NDD-NEXT:    shrl $15, %eax # EVEX TO LEGACY Compression encoding: [0xc1,0xe8,0x0f]
; NDD-NEXT:    xorb $1, %al # EVEX TO LEGACY Compression encoding: [0x34,0x01]
; NDD-NEXT:    retq # encoding: [0xc3]
  %lshr = lshr i16 %L, 15
