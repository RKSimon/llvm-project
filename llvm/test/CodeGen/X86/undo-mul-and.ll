...
; CHECK-SSE-NEXT:    paddb %xmm0, %xmm1
; CHECK-SSE-NEXT:    paddb %xmm1, %xmm1
; CHECK-SSE-NEXT:    psllw $3, %xmm0
; CHECK-SSE-NEXT:    pand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0
; CHECK-SSE-NEXT:    paddb %xmm1, %xmm0
; CHECK-SSE-NEXT:    pand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX1-LABEL: mul_and_to_neg_shl_and_vec_with_undef_mul_and:
; CHECK-AVX1:       # %bb.0:
; CHECK-AVX1-NEXT:    vpaddb %xmm0, %xmm0, %xmm1
; CHECK-AVX1-NEXT:    vpaddb %xmm1, %xmm1, %xmm1
; CHECK-AVX1-NEXT:    vpsllw $3, %xmm0, %xmm0
; CHECK-AVX1-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX1-NEXT:    vpaddb %xmm1, %xmm0, %xmm0
; CHECK-AVX1-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX1-NEXT:    retq
;
; CHECK-AVX512-LABEL: mul_and_to_neg_shl_and_vec_with_undef_mul_and:
; CHECK-AVX512:       # %bb.0:
; CHECK-AVX512-NEXT:    vpaddb %xmm0, %xmm0, %xmm1
; CHECK-AVX512-NEXT:    vpaddb %xmm1, %xmm1, %xmm1
; CHECK-AVX512-NEXT:    vpsllw $3, %xmm0, %xmm0
; CHECK-AVX512-NEXT:    vpandd {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to4}, %xmm0, %xmm0
; CHECK-AVX512-NEXT:    vpaddb %xmm1, %xmm0, %xmm0
; CHECK-AVX512-NEXT:    vpandd {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to4}, %xmm0, %xmm0
; CHECK-AVX512-NEXT:    retq
