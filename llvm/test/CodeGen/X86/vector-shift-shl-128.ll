...
; SSE41-NEXT:    pmullw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0 # [1,u,4,u,16,u,64,u,128,u,32,u,8,u,2,u]
...
; AVX1-NEXT:    vpmullw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0 # [1,u,4,u,16,u,64,u,128,u,32,u,8,u,2,u]
