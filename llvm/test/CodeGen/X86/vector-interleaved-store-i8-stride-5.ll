...
; AVX512-NEXT:    vpternlogq {{.*#+}} xmm3 = xmm3 ^ (mem & (xmm3 ^ xmm2))
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} xmm3 = xmm3 ^ (mem & (xmm3 ^ xmm2))
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} xmm3 = xmm3 ^ (mem & (xmm3 ^ xmm2))
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} xmm3 = xmm3 ^ (mem & (xmm3 ^ xmm2))
...
; AVX512-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm6 ^ (zmm7 & (zmm5 ^ zmm6))
...
; AVX512-NEXT:    vpternlogd {{.*#+}} zmm8 = zmm8 ^ (mem & (zmm8 ^ zmm5))
...
; AVX512-FCP-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm6 ^ (zmm7 & (zmm5 ^ zmm6))
...
; AVX512-FCP-NEXT:    vpternlogd {{.*#+}} zmm8 = zmm8 ^ (mem & (zmm8 ^ zmm5))
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm5 = zmm5 | (zmm8 & mem)
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} ymm7 = ymm3 ^ (ymm7 & (ymm1 ^ ymm3))
...
; AVX512DQ-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm6 ^ (zmm7 & (zmm5 ^ zmm6))
...
; AVX512DQ-NEXT:    vpternlogd {{.*#+}} zmm8 = zmm8 ^ (mem & (zmm8 ^ zmm5))
...
; AVX512DQ-FCP-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm6 ^ (zmm7 & (zmm5 ^ zmm6))
...
; AVX512DQ-FCP-NEXT:    vpternlogd {{.*#+}} zmm8 = zmm8 ^ (mem & (zmm8 ^ zmm5))
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm5 = zmm5 | (zmm8 & mem)
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} ymm7 = ymm3 ^ (ymm7 & (ymm1 ^ ymm3))
...
; AVX-NEXT:    vmovddup {{.*#+}} xmm9 = [3,0,0,1,4,5,0,2,3,0,0,1,4,5,0,2]
; AVX-NEXT:    # xmm9 = mem[0,0]
; AVX-NEXT:    vpshufb %xmm9, %xmm0, %xmm0
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm0, %ymm0
; AVX-NEXT:    vmovaps {{.*#+}} ymm8 = [255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255]
; AVX-NEXT:    vandnps %ymm0, %ymm8, %ymm3
; AVX-NEXT:    vmovdqa (%rdi), %xmm0
; AVX-NEXT:    vmovdqa (%rsi), %xmm4
...
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm4, %ymm4
; AVX-NEXT:    vmovaps {{.*#+}} ymm11 = [255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255]
...
; AVX2-NEXT:    vpshufb %ymm7, %ymm14, %ymm1
...
; AVX2-FP-NEXT:    vpshufb %ymm2, %ymm12, %ymm3
...
; AVX2-FCP-NEXT:    vmovdqa (%rsi), %ymm12
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm8 = zmm7 ^ (zmm10 & (zmm8 ^ zmm7))
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm0 | (zmm8 & zmm29)
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm10 = zmm7 ^ (zmm13 & (zmm10 ^ zmm7))
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm5 = zmm4 ^ (zmm13 & (zmm5 ^ zmm4))
; AVX512-NEXT:    vpternlogd {{.*#+}} zmm3 = zmm3 ^ (mem & (zmm3 ^ zmm10))
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm12 = zmm12 | (zmm8 & mem)
...
; AVX512-NEXT:    vpternlogd {{.*#+}} zmm2 = zmm2 ^ (mem & (zmm2 ^ zmm1))
; AVX512-NEXT:    vpternlogd {{.*#+}} zmm6 = zmm6 ^ (mem & (zmm6 ^ zmm5))
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm1 = zmm1 | (zmm6 & zmm29)
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm7 = zmm5 ^ (zmm11 & (zmm7 ^ zmm5))
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm9 ^ (zmm11 & (zmm0 ^ zmm9))
; AVX512-FCP-NEXT:    vpternlogd {{.*#+}} zmm3 = zmm3 ^ (mem & (zmm3 ^ zmm7))
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm10 = zmm10 | (zmm6 & mem)
...
; AVX512-FCP-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm5 ^ (mem & (zmm5 ^ zmm2))
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm8 = zmm7 ^ (zmm10 & (zmm8 ^ zmm7))
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm0 | (zmm8 & zmm29)
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm10 = zmm7 ^ (zmm13 & (zmm10 ^ zmm7))
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm5 = zmm4 ^ (zmm13 & (zmm5 ^ zmm4))
; AVX512DQ-NEXT:    vpternlogd {{.*#+}} zmm3 = zmm3 ^ (mem & (zmm3 ^ zmm10))
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm12 = zmm12 | (zmm8 & mem)
...
; AVX512DQ-NEXT:    vpternlogd {{.*#+}} zmm2 = zmm2 ^ (mem & (zmm2 ^ zmm1))
; AVX512DQ-NEXT:    vpternlogd {{.*#+}} zmm6 = zmm6 ^ (mem & (zmm6 ^ zmm5))
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm1 = zmm1 | (zmm6 & zmm29)
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm7 = zmm5 ^ (zmm11 & (zmm7 ^ zmm5))
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm9 ^ (zmm11 & (zmm0 ^ zmm9))
; AVX512DQ-FCP-NEXT:    vpternlogd {{.*#+}} zmm3 = zmm3 ^ (mem & (zmm3 ^ zmm7))
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm10 = zmm10 | (zmm6 & mem)
...
; AVX512DQ-FCP-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm5 ^ (mem & (zmm5 ^ zmm2))
