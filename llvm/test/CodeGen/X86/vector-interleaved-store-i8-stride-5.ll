...
; AVX512-NEXT:    vporq %xmm1, %xmm2, %xmm21
...
; AVX512-NEXT:    vinserti64x4 $1, %ymm2, %zmm3, %zmm22
...
; AVX512-NEXT:    vinserti64x4 $1, %ymm10, %zmm9, %zmm23
...
; AVX512-NEXT:    vinserti64x4 $1, %ymm10, %zmm5, %zmm24
...
; AVX512-NEXT:    vpshufb %ymm15, %ymm12, %ymm15
; AVX512-NEXT:    vporq %ymm11, %ymm15, %ymm26
; AVX512-NEXT:    vpshufb %ymm1, %ymm0, %ymm1
; AVX512-NEXT:    vpshufb %ymm5, %ymm12, %ymm5
; AVX512-NEXT:    vporq %ymm1, %ymm5, %ymm27
...
; AVX512-NEXT:    vporq %ymm1, %ymm5, %ymm16
...
; AVX512-NEXT:    vpshufb {{.*#+}} xmm4 = zero,xmm8[6],zero,xmm8[8,u],zero,xmm8[7],zero,xmm8[9],zero,xmm8[11,u],zero,xmm8[10],zero,xmm8[12]
; AVX512-NEXT:    vmovdqa (%rdx), %xmm1
; AVX512-NEXT:    vmovdqa64 %xmm31, %xmm3
; AVX512-NEXT:    vpshufb %xmm3, %xmm1, %xmm3
; AVX512-NEXT:    vpor %xmm4, %xmm3, %xmm4
; AVX512-NEXT:    vpshufb %ymm9, %ymm12, %ymm3
; AVX512-NEXT:    vpshufb %ymm10, %ymm0, %ymm0
...
; AVX512-NEXT:    vpshufb %ymm12, %ymm10, %ymm0
...
; AVX512-NEXT:    vpshufb %ymm12, %ymm10, %ymm12
...
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm5[0],xmm2[0],xmm5[1],xmm2[1],xmm5[2],xmm2[2],xmm5[3],xmm2[3],xmm5[4],xmm2[4],xmm5[5],xmm2[5],xmm5[6],xmm2[6],xmm5[7],xmm2[7]
; AVX512-NEXT:    vmovdqa {{.*#+}} xmm5 = [0,1,4,5,u,2,3,6,7,10,11,u,8,9,12,13]
...
; AVX512-NEXT:    vinserti64x4 $1, %ymm17, %zmm7, %zmm7
; AVX512-NEXT:    vpermq {{.*#+}} ymm8 = ymm21[0,0,1,1]
...
; AVX512-NEXT:    vpermq {{.*#+}} ymm7 = ymm27[2,2,3,3]
; AVX512-NEXT:    vinserti64x4 $1, %ymm7, %zmm26, %zmm7
; AVX512-NEXT:    vpermq {{.*#+}} ymm8 = ymm20[2,2,3,3]
; AVX512-NEXT:    vinserti64x4 $1, %ymm8, %zmm16, %zmm8
; AVX512-NEXT:    vpternlogq $226, %zmm7, %zmm10, %zmm8
; AVX512-NEXT:    vporq %zmm22, %zmm23, %zmm7
; AVX512-NEXT:    vpermq {{.*#+}} zmm7 = zmm7[2,2,3,3,6,6,7,7]
; AVX512-NEXT:    vporq %zmm24, %zmm25, %zmm10
; AVX512-NEXT:    vpermq {{.*#+}} zmm10 = zmm10[2,2,3,3,6,6,7,7]
; AVX512-NEXT:    vmovdqa64 {{.*#+}} zmm13 = [0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255]
; AVX512-NEXT:    vpternlogq $226, %zmm7, %zmm13, %zmm10
...
; AVX512-NEXT:    vpternlogq $226, %zmm4, %zmm13, %zmm5
; AVX512-NEXT:    vpternlogd $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm10, %zmm3
; AVX512-NEXT:    vpternlogq $248, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm8, %zmm12
...
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} xmm9 = [8,128,u,7,128,9,128,u,128,u,10,128,12,128,u,11]
...
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [128,11,128,128,10,128,12,128,14,128,128,13,128,15,128,128,128,27,128,128,26,128,28,128,30,128,128,29,128,31,128,128]
...
; AVX512-FCP-NEXT:    vporq %ymm1, %ymm2, %ymm17
...
; AVX512-FCP-NEXT:    vpshufb %xmm9, %xmm8, %xmm1
...
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} xmm1 = zero,xmm2[6],zero,xmm2[8,u],zero,xmm2[7],zero,xmm2[9],zero,xmm2[11,u],zero,xmm2[10],zero,xmm2[12]
; AVX512-FCP-NEXT:    vmovdqa (%rdx), %xmm5
; AVX512-FCP-NEXT:    vmovdqa64 %xmm28, %xmm4
; AVX512-FCP-NEXT:    vpshufb %xmm4, %xmm5, %xmm9
; AVX512-FCP-NEXT:    vporq %xmm1, %xmm9, %xmm28
...
; AVX512-FCP-NEXT:    vpermd %ymm11, %ymm13, %ymm13
...
; AVX512-FCP-NEXT:    vpandnq %ymm13, %ymm29, %ymm13
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm1, %zmm13, %zmm1
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [4,6,5,5,5,5,4,6,14,14,14,14,15,15,15,15]
; AVX512-FCP-NEXT:    vpermd %zmm3, %zmm13, %zmm3
; AVX512-FCP-NEXT:    vmovdqa (%r8), %ymm4
; AVX512-FCP-NEXT:    vpshufb %ymm10, %ymm4, %ymm10
...
; AVX512-FCP-NEXT:    vinserti32x4 $2, %xmm30, %zmm8, %zmm8
...
; AVX512-FCP-NEXT:    vinserti32x4 $2, %xmm28, %zmm2, %zmm2
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm14[0],xmm12[0],xmm14[1],xmm12[1],xmm14[2],xmm12[2],xmm14[3],xmm12[3],xmm14[4],xmm12[4],xmm14[5],xmm12[5],xmm14[6],xmm12[6],xmm14[7],xmm12[7]
; AVX512-FCP-NEXT:    vpshufb %xmm13, %xmm5, %xmm5
; AVX512-FCP-NEXT:    vpermt2q %zmm5, %zmm6, %zmm0
; AVX512-FCP-NEXT:    vinserti32x4 $2, %xmm11, %zmm4, %zmm4
; AVX512-FCP-NEXT:    vpermq {{.*#+}} ymm5 = ymm18[0,0,1,1]
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm31, %zmm5, %zmm5
; AVX512-FCP-NEXT:    vpermq {{.*#+}} ymm6 = ymm20[0,0,1,1]
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm19, %zmm6, %zmm6
...
; AVX512-FCP-NEXT:    vpternlogq $248, %zmm29, %zmm6, %zmm1
...
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm6, %zmm17, %zmm6
; AVX512-FCP-NEXT:    vpternlogq $226, %zmm5, %zmm7, %zmm6
; AVX512-FCP-NEXT:    vporq %zmm21, %zmm22, %zmm5
; AVX512-FCP-NEXT:    vpermq {{.*#+}} zmm5 = zmm5[2,2,3,3,6,6,7,7]
; AVX512-FCP-NEXT:    vporq %zmm23, %zmm24, %zmm7
; AVX512-FCP-NEXT:    vpermq {{.*#+}} zmm7 = zmm7[2,2,3,3,6,6,7,7]
...
; AVX512-FCP-NEXT:    vpermd %zmm4, %zmm2, %zmm2
...
; AVX512DQ-NEXT:    vporq %xmm1, %xmm2, %xmm21
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm2, %zmm3, %zmm22
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm10, %zmm9, %zmm23
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm10, %zmm5, %zmm24
...
; AVX512DQ-NEXT:    vpshufb %ymm15, %ymm12, %ymm15
; AVX512DQ-NEXT:    vporq %ymm11, %ymm15, %ymm26
; AVX512DQ-NEXT:    vpshufb %ymm1, %ymm0, %ymm1
; AVX512DQ-NEXT:    vpshufb %ymm5, %ymm12, %ymm5
; AVX512DQ-NEXT:    vporq %ymm1, %ymm5, %ymm27
...
; AVX512DQ-NEXT:    vpshufb {{.*#+}} xmm4 = zero,xmm8[6],zero,xmm8[8,u],zero,xmm8[7],zero,xmm8[9],zero,xmm8[11,u],zero,xmm8[10],zero,xmm8[12]
; AVX512DQ-NEXT:    vmovdqa (%rdx), %xmm1
; AVX512DQ-NEXT:    vmovdqa64 %xmm31, %xmm3
; AVX512DQ-NEXT:    vpshufb %xmm3, %xmm1, %xmm3
; AVX512DQ-NEXT:    vpor %xmm4, %xmm3, %xmm4
; AVX512DQ-NEXT:    vpshufb %ymm9, %ymm12, %ymm3
; AVX512DQ-NEXT:    vpshufb %ymm10, %ymm0, %ymm0
...
; AVX512DQ-NEXT:    vpshufb %ymm12, %ymm10, %ymm0
...
; AVX512DQ-NEXT:    vpshufb %ymm12, %ymm10, %ymm12
...
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm5[0],xmm2[0],xmm5[1],xmm2[1],xmm5[2],xmm2[2],xmm5[3],xmm2[3],xmm5[4],xmm2[4],xmm5[5],xmm2[5],xmm5[6],xmm2[6],xmm5[7],xmm2[7]
; AVX512DQ-NEXT:    vmovdqa {{.*#+}} xmm5 = [0,1,4,5,u,2,3,6,7,10,11,u,8,9,12,13]
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm17, %zmm7, %zmm7
; AVX512DQ-NEXT:    vpermq {{.*#+}} ymm8 = ymm21[0,0,1,1]
...
; AVX512DQ-NEXT:    vpermq {{.*#+}} ymm7 = ymm27[2,2,3,3]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm7, %zmm26, %zmm7
; AVX512DQ-NEXT:    vpermq {{.*#+}} ymm8 = ymm20[2,2,3,3]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm8, %zmm16, %zmm8
; AVX512DQ-NEXT:    vpternlogq $226, %zmm7, %zmm10, %zmm8
; AVX512DQ-NEXT:    vporq %zmm22, %zmm23, %zmm7
; AVX512DQ-NEXT:    vpermq {{.*#+}} zmm7 = zmm7[2,2,3,3,6,6,7,7]
; AVX512DQ-NEXT:    vporq %zmm24, %zmm25, %zmm10
; AVX512DQ-NEXT:    vpermq {{.*#+}} zmm10 = zmm10[2,2,3,3,6,6,7,7]
; AVX512DQ-NEXT:    vmovdqa64 {{.*#+}} zmm13 = [0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255,0,0,255,255,255]
; AVX512DQ-NEXT:    vpternlogq $226, %zmm7, %zmm13, %zmm10
...
; AVX512DQ-NEXT:    vpternlogq $226, %zmm4, %zmm13, %zmm5
; AVX512DQ-NEXT:    vpternlogd $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm10, %zmm3
; AVX512DQ-NEXT:    vpternlogq $248, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm8, %zmm12
...
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} xmm9 = [8,128,u,7,128,9,128,u,128,u,10,128,12,128,u,11]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm9, %xmm14, %xmm2
...
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [128,11,128,128,10,128,12,128,14,128,128,13,128,15,128,128,128,27,128,128,26,128,28,128,30,128,128,29,128,31,128,128]
...
; AVX512DQ-FCP-NEXT:    vporq %ymm1, %ymm2, %ymm17
...
; AVX512DQ-FCP-NEXT:    vpshufb %xmm9, %xmm8, %xmm1
; AVX512DQ-FCP-NEXT:    vmovdqa (%rsi), %xmm15
; AVX512DQ-FCP-NEXT:    vmovdqa64 %xmm30, %xmm2
; AVX512DQ-FCP-NEXT:    vpshufb %xmm2, %xmm15, %xmm2
; AVX512DQ-FCP-NEXT:    vporq %xmm1, %xmm2, %xmm30
; AVX512DQ-FCP-NEXT:    vmovdqa (%rcx), %xmm2
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} xmm1 = zero,xmm2[6],zero,xmm2[8,u],zero,xmm2[7],zero,xmm2[9],zero,xmm2[11,u],zero,xmm2[10],zero,xmm2[12]
; AVX512DQ-FCP-NEXT:    vmovdqa (%rdx), %xmm5
; AVX512DQ-FCP-NEXT:    vmovdqa64 %xmm28, %xmm4
; AVX512DQ-FCP-NEXT:    vpshufb %xmm4, %xmm5, %xmm9
; AVX512DQ-FCP-NEXT:    vporq %xmm1, %xmm9, %xmm28
...
; AVX512DQ-FCP-NEXT:    vpermd %ymm11, %ymm13, %ymm13
...
; AVX512DQ-FCP-NEXT:    vpandnq %ymm13, %ymm29, %ymm13
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm1, %zmm13, %zmm1
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [4,6,5,5,5,5,4,6,14,14,14,14,15,15,15,15]
; AVX512DQ-FCP-NEXT:    vpermd %zmm3, %zmm13, %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqa (%r8), %ymm4
; AVX512DQ-FCP-NEXT:    vpshufb %ymm10, %ymm4, %ymm10
...
; AVX512DQ-FCP-NEXT:    vinserti32x4 $2, %xmm30, %zmm8, %zmm8
...
; AVX512DQ-FCP-NEXT:    vinserti32x4 $2, %xmm28, %zmm2, %zmm2
...
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm14[0],xmm12[0],xmm14[1],xmm12[1],xmm14[2],xmm12[2],xmm14[3],xmm12[3],xmm14[4],xmm12[4],xmm14[5],xmm12[5],xmm14[6],xmm12[6],xmm14[7],xmm12[7]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm13, %xmm5, %xmm5
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm5, %zmm6, %zmm0
; AVX512DQ-FCP-NEXT:    vinserti32x4 $2, %xmm11, %zmm4, %zmm4
; AVX512DQ-FCP-NEXT:    vpermq {{.*#+}} ymm5 = ymm18[0,0,1,1]
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm31, %zmm5, %zmm5
; AVX512DQ-FCP-NEXT:    vpermq {{.*#+}} ymm6 = ymm20[0,0,1,1]
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm19, %zmm6, %zmm6
...
; AVX512DQ-FCP-NEXT:    vpternlogq $248, %zmm29, %zmm6, %zmm1
...
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm6, %zmm17, %zmm6
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %zmm5, %zmm7, %zmm6
; AVX512DQ-FCP-NEXT:    vporq %zmm21, %zmm22, %zmm5
; AVX512DQ-FCP-NEXT:    vpermq {{.*#+}} zmm5 = zmm5[2,2,3,3,6,6,7,7]
; AVX512DQ-FCP-NEXT:    vporq %zmm23, %zmm24, %zmm7
; AVX512DQ-FCP-NEXT:    vpermq {{.*#+}} zmm7 = zmm7[2,2,3,3,6,6,7,7]
...
; AVX512DQ-FCP-NEXT:    vpermd %zmm4, %zmm2, %zmm2
