...
; SSE2-NEXT:    movdqu (%rdx), %xmm4
; SSE2-NEXT:    movdqu 16(%rdx), %xmm5
; SSE2-NEXT:    movdqu 32(%rdx), %xmm6
; SSE2-NEXT:    movdqu 48(%rdx), %xmm7
; SSE2-NEXT:    movdqa %xmm0, %xmm8
; SSE2-NEXT:    pminub %xmm4, %xmm8
; SSE2-NEXT:    pmaxub %xmm4, %xmm0
; SSE2-NEXT:    psubb %xmm8, %xmm0
; SSE2-NEXT:    movdqa %xmm2, %xmm4
; SSE2-NEXT:    pminub %xmm6, %xmm4
; SSE2-NEXT:    pmaxub %xmm6, %xmm2
; SSE2-NEXT:    psubb %xmm4, %xmm2
; SSE2-NEXT:    movdqa %xmm1, %xmm4
; SSE2-NEXT:    pminub %xmm5, %xmm4
; SSE2-NEXT:    pmaxub %xmm5, %xmm1
; SSE2-NEXT:    psubb %xmm4, %xmm1
; SSE2-NEXT:    movdqa %xmm3, %xmm4
; SSE2-NEXT:    pminub %xmm7, %xmm4
; SSE2-NEXT:    pmaxub %xmm7, %xmm3
; SSE2-NEXT:    psubb %xmm4, %xmm3
; SSE2-NEXT:    pxor %xmm4, %xmm4
; SSE2-NEXT:    psadbw %xmm4, %xmm3
; SSE2-NEXT:    psadbw %xmm4, %xmm1
; SSE2-NEXT:    paddq %xmm3, %xmm1
; SSE2-NEXT:    psadbw %xmm4, %xmm2
...
; AVX2-NEXT:    vpaddd %xmm1, %xmm0, %xmm0
; AVX2-NEXT:    vpaddd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm1
...
; AVX512-NEXT:    vpaddd %xmm1, %xmm0, %xmm0
; AVX512-NEXT:    vpaddd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm1
