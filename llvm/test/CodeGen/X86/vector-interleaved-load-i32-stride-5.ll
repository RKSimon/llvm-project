...
; AVX2-NEXT:    vbroadcastss 16(%rdi), %ymm2
; AVX2-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0],mem[1],xmm2[2,3]
...
; AVX2-FP-NEXT:    vbroadcastss 16(%rdi), %ymm2
; AVX2-FP-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0],mem[1],xmm2[2,3]
...
; AVX2-FCP-NEXT:    vbroadcastss 16(%rdi), %ymm2
; AVX2-FCP-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0],mem[1],xmm2[2,3]
...
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm4 = [1,6,1,1]
; AVX512DQ-FCP-NEXT:    vpermps (%rdi), %ymm4, %ymm4
; AVX512DQ-FCP-NEXT:    vpbroadcastd 8(%rdi), %xmm5
; AVX512DQ-FCP-NEXT:    vpextrd $3, %xmm1, %eax
; AVX512DQ-FCP-NEXT:    vpinsrd $1, %eax, %xmm5, %xmm1
...
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} xmm2 = xmm5[0],xmm2[1],xmm5[2,3]
; AVX512DQ-FCP-NEXT:    vmovq %xmm3, (%rsi)
; AVX512DQ-FCP-NEXT:    vmovlps %xmm4, (%rdx)
...
; AVX512BW-NEXT:    vpinsrd $1, %eax, %xmm0, %xmm0
...
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm4 = [1,6,1,1]
; AVX512BW-FCP-NEXT:    vpermps (%rdi), %ymm4, %ymm4
; AVX512BW-FCP-NEXT:    vpbroadcastd 8(%rdi), %xmm5
; AVX512BW-FCP-NEXT:    vpextrd $3, %xmm1, %eax
; AVX512BW-FCP-NEXT:    vpinsrd $1, %eax, %xmm5, %xmm1
...
; AVX512BW-FCP-NEXT:    vpblendd {{.*#+}} xmm2 = xmm5[0],xmm2[1],xmm5[2,3]
; AVX512BW-FCP-NEXT:    vmovq %xmm3, (%rsi)
; AVX512BW-FCP-NEXT:    vmovlps %xmm4, (%rdx)
...
; AVX512DQ-BW-NEXT:    vmovd %xmm2, %eax
; AVX512DQ-BW-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[3,3,3,3]
; AVX512DQ-BW-NEXT:    vpinsrd $1, %eax, %xmm0, %xmm0
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm4 = [1,6,1,1]
; AVX512DQ-BW-FCP-NEXT:    vpermps (%rdi), %ymm4, %ymm4
; AVX512DQ-BW-FCP-NEXT:    vpbroadcastd 8(%rdi), %xmm5
; AVX512DQ-BW-FCP-NEXT:    vpextrd $3, %xmm1, %eax
; AVX512DQ-BW-FCP-NEXT:    vpinsrd $1, %eax, %xmm5, %xmm1
...
; AVX512DQ-BW-FCP-NEXT:    vpblendd {{.*#+}} xmm2 = xmm5[0],xmm2[1],xmm5[2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovq %xmm3, (%rsi)
; AVX512DQ-BW-FCP-NEXT:    vmovlps %xmm4, (%rdx)
...
; AVX-NEXT:    vblendps {{.*#+}} xmm4 = xmm13[0,1],xmm14[2,3]
...
; AVX-NEXT:    vblendps {{.*#+}} xmm4 = xmm15[0,1],xmm8[2,3]
; AVX-NEXT:    vblendps {{.*#+}} xmm4 = xmm4[0,1],mem[2],xmm4[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm4 = xmm4[1,2,3,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0,1,2],ymm3[3,4,5,6,7]
...
; AVX-NEXT:    vmovups %ymm11, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} xmm11 = xmm14[0,1],xmm13[2,3]
...
; AVX-NEXT:    vblendps {{.*#+}} xmm8 = xmm8[0,1],xmm15[2,3]
