...
; AVX-NEXT:    vpand %xmm1, %xmm5, %xmm0
; AVX-NEXT:    vpand %xmm1, %xmm4, %xmm6
; AVX-NEXT:    vpackuswb %xmm0, %xmm6, %xmm0
; AVX-NEXT:    vpand %xmm1, %xmm3, %xmm6
; AVX-NEXT:    vpand %xmm1, %xmm2, %xmm7
; AVX-NEXT:    vpackuswb %xmm6, %xmm7, %xmm6
; AVX-NEXT:    vmovdqa 112(%rdi), %xmm7
; AVX-NEXT:    vpand %xmm1, %xmm7, %xmm8
; AVX-NEXT:    vmovdqa 96(%rdi), %xmm9
; AVX-NEXT:    vpand %xmm1, %xmm9, %xmm10
...
; AVX-NEXT:    vpand %xmm1, %xmm12, %xmm1
; AVX-NEXT:    vpackuswb %xmm11, %xmm1, %xmm1
...
; AVX-NEXT:    vpshufb %xmm11, %xmm12, %xmm5
