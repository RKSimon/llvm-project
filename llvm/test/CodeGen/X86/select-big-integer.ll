...
; X64-SSE2-NEXT:    movdqa (%rsi), %xmm0
; X64-SSE2-NEXT:    movdqa 16(%rsi), %xmm1
; X64-SSE2-NEXT:    movdqa 32(%rsi), %xmm2
; X64-SSE2-NEXT:    movdqa 48(%rsi), %xmm3
; X64-SSE2-NEXT:    negl %edx
; X64-SSE2-NEXT:    movd %edx, %xmm4
; X64-SSE2-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,0,0]
; X64-SSE2-NEXT:    movdqa (%rdi), %xmm5
...
; X64-SSE2-NEXT:    pand 48(%rdi), %xmm4
; X64-SSE2-NEXT:    pandn %xmm6, %xmm3
; X64-SSE2-NEXT:    por %xmm4, %xmm3
; X64-SSE2-NEXT:    movdqa %xmm3, 48(%rcx)
; X64-SSE2-NEXT:    movdqa %xmm2, 32(%rcx)
; X64-SSE2-NEXT:    movdqa %xmm1, 16(%rcx)
; X64-SSE2-NEXT:    movdqa %xmm0, (%rcx)
; X64-SSE2-NEXT:    retq
;
...
; X64-SSE4:       # %bb.0:
; X64-SSE4-NEXT:    pcmpeqd %xmm1, %xmm1
; X64-SSE4-NEXT:    movdqa 48(%rsi), %xmm2
; X64-SSE4-NEXT:    pxor %xmm1, %xmm2
; X64-SSE4-NEXT:    movdqa 32(%rsi), %xmm3
; X64-SSE4-NEXT:    pxor %xmm1, %xmm3
; X64-SSE4-NEXT:    movdqa 16(%rsi), %xmm4
...
; X64-SSE4-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,0,0,0]
; X64-SSE4-NEXT:    blendvps %xmm0, (%rdi), %xmm1
; X64-SSE4-NEXT:    blendvps %xmm0, 16(%rdi), %xmm4
; X64-SSE4-NEXT:    blendvps %xmm0, 32(%rdi), %xmm3
; X64-SSE4-NEXT:    blendvps %xmm0, 48(%rdi), %xmm2
; X64-SSE4-NEXT:    movaps %xmm2, 48(%rcx)
; X64-SSE4-NEXT:    movaps %xmm3, 32(%rcx)
; X64-SSE4-NEXT:    movaps %xmm4, 16(%rcx)
; X64-SSE4-NEXT:    movaps %xmm1, (%rcx)
; X64-SSE4-NEXT:    retq
;
...
; X64-AVX1-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[0,0,0,0]
; X64-AVX1-NEXT:    vblendvps %xmm3, (%rdi), %xmm0, %xmm4
; X64-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm0
; X64-AVX1-NEXT:    vblendvps %xmm3, 16(%rdi), %xmm0, %xmm0
; X64-AVX1-NEXT:    vxorps %ymm2, %ymm1, %ymm1
; X64-AVX1-NEXT:    vblendvps %xmm3, 32(%rdi), %xmm1, %xmm2
; X64-AVX1-NEXT:    vextractf128 $1, %ymm1, %xmm1
; X64-AVX1-NEXT:    vblendvps %xmm3, 48(%rdi), %xmm1, %xmm1
; X64-AVX1-NEXT:    vmovaps %xmm1, 48(%rcx)
; X64-AVX1-NEXT:    vmovaps %xmm2, 32(%rcx)
; X64-AVX1-NEXT:    vmovaps %xmm0, 16(%rcx)
; X64-AVX1-NEXT:    vmovaps %xmm4, (%rcx)
; X64-AVX1-NEXT:    vzeroupper
; X64-AVX1-NEXT:    retq
;
