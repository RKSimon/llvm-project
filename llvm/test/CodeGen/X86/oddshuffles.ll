...
; AVX2-FAST-ALL-NEXT:    vpmovsxbd {{.*#+}} ymm3 = [0,0,0,0,1,1,0,2]
...
; AVX1:       # %bb.0:
; AVX1-NEXT:    vmovups (%rsi), %xmm0
; AVX1-NEXT:    vmovups 16(%rsi), %xmm1
; AVX1-NEXT:    vmovups (%rdx), %xmm2
; AVX1-NEXT:    vmovups 16(%rdx), %xmm3
; AVX1-NEXT:    vshufps {{.*#+}} xmm4 = xmm2[1,1,2,2]
; AVX1-NEXT:    vblendps {{.*#+}} xmm4 = xmm4[0,1],xmm0[2],xmm4[3]
; AVX1-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm0[0],xmm2[0],xmm0[1],xmm2[1]
...
; AVX1-NEXT:    vshufps {{.*#+}} xmm2 = xmm1[3,3],xmm3[3,3]
; AVX1-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[1,1,2,2]
; AVX1-NEXT:    vblendps {{.*#+}} xmm1 = xmm3[0,1],xmm1[2],xmm3[3]
; AVX1-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX1-NEXT:    vbroadcastf128 {{.*#+}} ymm2 = mem[0,1,0,1]
; AVX1-NEXT:    vshufpd {{.*#+}} ymm2 = ymm2[0,0,3,3]
; AVX1-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2,3],ymm2[4],ymm1[5,6],ymm2[7]
...
; XOP-NEXT:    vmovups (%rsi), %xmm1
; XOP-NEXT:    vmovups 16(%rsi), %xmm2
; XOP-NEXT:    vmovups (%rdx), %xmm3
; XOP-NEXT:    vmovups 16(%rdx), %xmm4
; XOP-NEXT:    vshufps {{.*#+}} xmm5 = xmm3[1,1,2,2]
; XOP-NEXT:    vblendps {{.*#+}} xmm5 = xmm5[0,1],xmm1[2],xmm5[3]
; XOP-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[1],xmm3[1]
; XOP-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,2]
; XOP-NEXT:    vinsertf128 $1, %xmm5, %ymm1, %ymm1
; XOP-NEXT:    vbroadcastsd (%rcx), %ymm3
; XOP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm3[2],ymm1[3,4],ymm3[5],ymm1[6,7]
; XOP-NEXT:    vshufps {{.*#+}} xmm3 = xmm2[3,3],xmm4[3,3]
; XOP-NEXT:    vshufps {{.*#+}} xmm4 = xmm4[1,1,2,2]
; XOP-NEXT:    vblendps {{.*#+}} xmm2 = xmm4[0,1],xmm2[2],xmm4[3]
; XOP-NEXT:    vinsertf128 $1, %xmm3, %ymm2, %ymm2
; XOP-NEXT:    vbroadcastf128 {{.*#+}} ymm3 = mem[0,1,0,1]
; XOP-NEXT:    vshufpd {{.*#+}} ymm3 = ymm3[0,0,3,3]
; XOP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm3[1],ymm2[2,3],ymm3[4],ymm2[5,6],ymm3[7]
...
; AVX1-NEXT:    vmovups 192(%rdi), %ymm1
...
; AVX1-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[0,1],ymm1[0,2],ymm0[4,5],ymm1[4,6]
...
; AVX1-NEXT:    vshufps {{.*#+}} xmm1 = xmm2[0,1],xmm1[0,2]
...
; AVX1-NEXT:    vmovshdup {{.*#+}} ymm3 = ymm0[1,1,3,3,5,5,7,7]
; AVX1-NEXT:    vshufpd {{.*#+}} ymm4 = ymm0[0,0,3,2]
; AVX1-NEXT:    vshufps {{.*#+}} ymm5 = ymm0[3,3,3,3,7,7,7,7]
...
; XOP-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[0,1],ymm1[0,2],ymm0[4,5],ymm1[4,6]
; XOP-NEXT:    vmovaps 80(%rdi), %xmm1
; XOP-NEXT:    vunpcklpd {{.*#+}} xmm1 = xmm1[0],mem[0]
; XOP-NEXT:    vmovaps 16(%rdi), %xmm2
; XOP-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm2[0],mem[0],xmm2[1],mem[1]
; XOP-NEXT:    vshufps {{.*#+}} xmm1 = xmm2[0,1],xmm1[0,2]
...
; XOP-NEXT:    vinsertf128 $1, %xmm3, %ymm2, %ymm2
; XOP-NEXT:    vmovshdup {{.*#+}} ymm3 = ymm0[1,1,3,3,5,5,7,7]
; XOP-NEXT:    vshufpd {{.*#+}} ymm4 = ymm0[0,0,3,2]
; XOP-NEXT:    vshufps {{.*#+}} ymm5 = ymm0[3,3,3,3,7,7,7,7]
; XOP-NEXT:    vpshufd {{.*#+}} xmm6 = xmm1[1,1,1,1]
