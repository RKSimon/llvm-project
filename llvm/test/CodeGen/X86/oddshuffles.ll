...
; AVX1-NEXT:    vmovups 192(%rdi), %ymm2
...
; AVX1-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,1],ymm2[0,2],ymm1[4,5],ymm2[4,6]
...
; AVX1-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[0,1,0,2,4,5,4,6]
...
; XOP-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,1],ymm2[0,2],ymm1[4,5],ymm2[4,6]
...
; XOP-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[0,1,0,2,4,5,4,6]
