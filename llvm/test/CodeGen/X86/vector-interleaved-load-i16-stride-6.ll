...
; AVX512-FCP-NEXT:    vpternlogq $248, %ymm11, %ymm3, %ymm4
...
; AVX512DQ-FCP-NEXT:    vpternlogq $248, %ymm11, %ymm3, %ymm4
...
; AVX512-NEXT:    vpblendd {{.*#+}} ymm4 = ymm1[0],ymm14[1],ymm1[2,3],ymm14[4],ymm1[5,6],ymm14[7]
...
; AVX512-NEXT:    vpternlogq $226, %zmm17, %zmm11, %zmm0
...
; AVX512-NEXT:    vpternlogq $184, %zmm0, %zmm17, %zmm16
...
; AVX512-NEXT:    vpternlogq $226, %zmm0, %zmm11, %zmm4
; AVX512-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm0
; AVX512-NEXT:    vpternlogq $184, %zmm4, %zmm17, %zmm0
...
; AVX512-NEXT:    vpternlogq $236, %ymm15, %ymm11, %ymm8
...
; AVX512-NEXT:    vpternlogq $236, %ymm15, %ymm5, %ymm3
...
; AVX512-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512-NEXT:    vpternlogq $184, %zmm4, %zmm17, %zmm11
; AVX512-NEXT:    vpternlogq $184, %zmm1, %zmm17, %zmm2
...
; AVX512-FCP-NEXT:    vpternlogq $226, %zmm17, %zmm10, %zmm12
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm12, %zmm17, %zmm16
...
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm0[0,1,2],ymm1[3,4,5,6,7],ymm0[8,9,10],ymm1[11,12,13,14,15]
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX512-FCP-NEXT:    vpternlogq $226, %zmm7, %zmm10, %zmm3
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm0, %zmm20
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm3, %zmm17, %zmm20
...
; AVX512-FCP-NEXT:    vpternlogq $236, %ymm23, %ymm12, %ymm7
...
; AVX512-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm3, %zmm17, %zmm6
...
; AVX512DQ-NEXT:    vpternlogq $226, %zmm1, %zmm17, %zmm12
...
; AVX512DQ-NEXT:    vpternlogq $226, %zmm16, %zmm9, %zmm8
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm8, %zmm17, %zmm18
...
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm1 = ymm0[0,1,2],ymm1[3,4,5,6,7],ymm0[8,9,10],ymm1[11,12,13,14,15]
; AVX512DQ-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX512DQ-NEXT:    vpternlogq $226, %zmm6, %zmm9, %zmm2
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm0, %zmm0, %zmm16
; AVX512DQ-NEXT:    vpternlogq $184, %zmm2, %zmm17, %zmm16
...
; AVX512DQ-NEXT:    vpternlogq $236, %ymm14, %ymm9, %ymm6
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %zmm16, %zmm17, %zmm2
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %zmm7, %zmm17, %zmm5
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %zmm16, %zmm8, %zmm10
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm10, %zmm17, %zmm18
...
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm0[0,1,2],ymm1[3,4,5,6,7],ymm0[8,9,10],ymm1[11,12,13,14,15]
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %zmm4, %zmm8, %zmm2
...
; AVX512DQ-FCP-NEXT:    vpternlogq $236, %ymm19, %ymm11, %ymm4
...
; AVX512DQ-FCP-NEXT:    vpternlogq $248, %ymm19, %ymm7, %ymm3
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} xmm1 = [4,5,4,5,4,5,4,5,8,9,8,9,8,9,8,9]
; AVX2-FP-NEXT:    vpshufb %xmm1, %xmm11, %xmm0
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} xmm3 = [0,1,0,1,0,1,0,1,8,9,12,13,12,13,14,15]
; AVX2-FP-NEXT:    vpshufb %xmm3, %xmm14, %xmm2
; AVX2-FP-NEXT:    vmovdqa %xmm3, %xmm5
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} xmm1 = [4,5,4,5,4,5,4,5,8,9,8,9,8,9,8,9]
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm11, %xmm0
; AVX2-FCP-NEXT:    vmovdqa %xmm1, %xmm6
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} xmm3 = [0,1,0,1,0,1,0,1,8,9,12,13,12,13,14,15]
; AVX2-FCP-NEXT:    vpshufb %xmm3, %xmm14, %xmm2
; AVX2-FCP-NEXT:    vmovdqa %xmm3, %xmm5
...
; AVX512-NEXT:    vpternlogq $226, %zmm0, %zmm29, %zmm1
; AVX512-NEXT:    vpmovsxdq {{.*#+}} zmm0 = [18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,65535,0,0]
; AVX512-NEXT:    vpternlogq $184, %zmm1, %zmm0, %zmm2
...
; AVX512-NEXT:    vpternlogq $226, %zmm23, %zmm29, %zmm0
; AVX512-NEXT:    vpternlogq $184, %zmm0, %zmm22, %zmm13
...
; AVX512-NEXT:    vpternlogq $184, %zmm0, %zmm22, %zmm27
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm10[3,1,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm9[0,1,3,3,4,5,6,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm9[0,1,2,3,7,7,7,7]
; AVX512-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0],xmm9[1,2],xmm0[3],xmm9[4,5,6,7]
...
; AVX512-NEXT:    vpternlogq $226, %zmm0, %zmm29, %zmm4
; AVX512-NEXT:    vpternlogq $184, %zmm4, %zmm22, %zmm28
; AVX512-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX512-NEXT:    vpternlogq $236, %ymm30, %ymm4, %ymm3
; AVX512-NEXT:    movw $31, %ax
; AVX512-NEXT:    kmovw %eax, %k1
...
; AVX512-NEXT:    vpternlogq $236, %ymm30, %ymm0, %ymm3
; AVX512-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX512-NEXT:    vpternlogq $236, %ymm30, %ymm12, %ymm0
...
; AVX512-NEXT:    vpternlogq $236, %ymm30, %ymm1, %ymm9
...
; AVX512-NEXT:    vpternlogq $184, %zmm29, %zmm6, %zmm3
; AVX512-NEXT:    vpternlogq $184, %zmm31, %zmm6, %zmm4
; AVX512-NEXT:    vpternlogq $184, %zmm2, %zmm6, %zmm0
; AVX512-NEXT:    vpternlogq $184, %zmm1, %zmm6, %zmm5
...
; AVX512-FCP-NEXT:    vpternlogq $226, %zmm0, %zmm29, %zmm1
; AVX512-FCP-NEXT:    vpmovsxdq {{.*#+}} zmm0 = [18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,65535,0,0]
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm1, %zmm0, %zmm2
...
; AVX512-FCP-NEXT:    vpternlogq $226, %zmm23, %zmm29, %zmm0
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm0, %zmm24, %zmm1
...
; AVX512-FCP-NEXT:    vpternlogq $226, %zmm28, %zmm29, %zmm0
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm0, %zmm24, %zmm25
...
; AVX512-FCP-NEXT:    vpternlogq $226, %zmm0, %zmm29, %zmm1
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm1, %zmm24, %zmm28
; AVX512-FCP-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm30, %zmm4, %zmm5
...
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm1 = xmm2[0,2,0,3]
...
; AVX512DQ-NEXT:    vextracti128 $1, %ymm10, %xmm5
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm3 = xmm5[0,2,0,3]
...
; AVX512DQ-NEXT:    vextracti128 $1, %ymm8, %xmm1
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm0 = xmm1[0,2,0,3]
...
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm2 = ymm1[0,1,2],ymm2[3,4,5,6,7],ymm1[8,9,10],ymm2[11,12,13,14,15]
; AVX512DQ-NEXT:    vpblendd {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4,5,6,7]
; AVX512DQ-NEXT:    vpternlogq $226, %zmm17, %zmm16, %zmm0
...
; AVX512DQ-NEXT:    vpternlogq $226, %zmm0, %zmm16, %zmm15
...
; AVX512DQ-NEXT:    vmovdqa {{.*#+}} ymm4 = [4,5,0,1,12,13,14,15,8,9,0,1,12,13,8,9,20,21,16,17,28,29,30,31,24,25,16,17,28,29,24,25]
...
; AVX512DQ-NEXT:    vpshufb %ymm4, %ymm10, %ymm3
...
; AVX512DQ-NEXT:    vpternlogq $226, %zmm0, %zmm21, %zmm1
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm1, %zmm31, %zmm2
...
; AVX512DQ-NEXT:    vpternlogq $226, %zmm19, %zmm21, %zmm0
; AVX512DQ-NEXT:    vpternlogq $184, %zmm0, %zmm31, %zmm30
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm0, %zmm31, %zmm29
...
; AVX512DQ-NEXT:    vpternlogq $226, %zmm0, %zmm21, %zmm4
; AVX512DQ-NEXT:    vpternlogq $184, %zmm4, %zmm31, %zmm20
; AVX512DQ-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX512DQ-NEXT:    vpternlogq $236, %ymm26, %ymm4, %ymm2
; AVX512DQ-NEXT:    movw $31, %ax
; AVX512DQ-NEXT:    kmovw %eax, %k1
...
; AVX512DQ-NEXT:    vpternlogq $236, %ymm26, %ymm0, %ymm2
; AVX512DQ-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX512DQ-NEXT:    vpblendd $36, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm0 = ymm0[0,1],mem[2],ymm0[3,4],mem[5],ymm0[6,7]
...
; AVX512DQ-NEXT:    vpternlogq $236, %ymm26, %ymm13, %ymm8
...
; AVX512DQ-NEXT:    vpternlogq $236, %ymm26, %ymm12, %ymm11
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm21, %zmm31, %zmm23
; AVX512DQ-NEXT:    vpternlogq $184, %zmm24, %zmm31, %zmm25
; AVX512DQ-NEXT:    vpternlogq $184, %zmm10, %zmm31, %zmm8
; AVX512DQ-NEXT:    vpternlogq $184, %zmm0, %zmm31, %zmm1
...
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} xmm4 = [4,5,4,5,4,5,4,5,8,9,8,9,8,9,8,9]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm4, %xmm2, %xmm1
; AVX512DQ-FCP-NEXT:    vmovdqa %xmm4, %xmm7
; AVX512DQ-FCP-NEXT:    vextracti128 $1, %ymm2, %xmm4
; AVX512DQ-FCP-NEXT:    vmovdqa64 %ymm2, %ymm18
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} xmm5 = [0,1,4,5,4,5,6,7,0,1,12,13,12,13,4,5]
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %zmm17, %zmm16, %zmm0
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %zmm0, %zmm16, %zmm14
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %zmm0, %zmm16, %zmm5
...
; AVX512DQ-FCP-NEXT:    vpmovsxdq {{.*#+}} zmm0 = [18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,65535,0,0]
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm1, %zmm0, %zmm2
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %zmm19, %zmm21, %zmm0
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm0, %zmm26, %zmm31
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %zmm20, %zmm21, %zmm0
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm0, %zmm26, %zmm29
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %zmm0, %zmm21, %zmm1
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm1, %zmm26, %zmm20
; AVX512DQ-FCP-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX512DQ-FCP-NEXT:    vpternlogq $236, %ymm28, %ymm3, %ymm2
; AVX512DQ-FCP-NEXT:    movw $31, %ax
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k1
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 %ymm4, %ymm16
; AVX512DQ-FCP-NEXT:    vpternlogq $236, %ymm28, %ymm1, %ymm2
; AVX512DQ-FCP-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX512DQ-FCP-NEXT:    vpblendd $36, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm1 # 32-byte Folded Reload
; AVX512DQ-FCP-NEXT:    # ymm1 = ymm1[0,1],mem[2],ymm1[3,4],mem[5],ymm1[6,7]
...
; AVX512DQ-FCP-NEXT:    vpternlogq $236, %ymm28, %ymm10, %ymm9
...
; AVX512DQ-FCP-NEXT:    vpternlogq $236, %ymm28, %ymm15, %ymm0
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm21, %zmm2, %zmm23
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm24, %zmm2, %zmm25
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm26, %zmm2, %zmm9
