...
; AVXVNNI-AVX512-NEXT:    vpmulld {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm0 # [0,1,2,64,0,1,2,64,0,1,2,64,0,1,2,64]
...
; AVX512-NEXT:    vpmulld {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm0 # [0,1,2,64,0,1,2,64,0,1,2,64,0,1,2,64]
