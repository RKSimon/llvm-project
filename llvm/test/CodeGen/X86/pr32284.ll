...
; X64-SETZUCC-NEXT:    cmpq %rax, %rcx
; X64-SETZUCC-NEXT:    setzug %al
; X64-SETZUCC-NEXT:    movq %rax, var_57(%rip)
; X64-SETZUCC-NEXT:    cmpl $-1, var_5(%rip)
; X64-SETZUCC-NEXT:    setzue %al
; X64-SETZUCC-NEXT:    movq %rax, _ZN8struct_210member_2_0E(%rip)
; X64-SETZUCC-NEXT:    retq
;
...
; X64-NO-SETZUCC-NEXT:    cmpq %rax, %rcx
; X64-NO-SETZUCC-NEXT:    setg %dl
; X64-NO-SETZUCC-NEXT:    movq %rdx, var_57(%rip)
; X64-NO-SETZUCC-NEXT:    xorl %eax, %eax
; X64-NO-SETZUCC-NEXT:    cmpl $-1, var_5(%rip)
; X64-NO-SETZUCC-NEXT:    sete %al
; X64-NO-SETZUCC-NEXT:    movq %rax, _ZN8struct_210member_2_0E(%rip)
