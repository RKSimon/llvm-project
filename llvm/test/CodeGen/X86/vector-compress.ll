...
; AVX512F-NEXT:    vpmovdb %zmm3, 96(%rsp,%rcx)
...
; AVX512F-NEXT:    vmovdqa %ymm4, (%rsp,%rcx)
...
; AVX512F-NEXT:    vpblendvb %xmm2, (%rsp), %xmm1, %xmm1
; AVX512F-NEXT:    vinserti128 $1, %xmm0, %ymm1, %ymm0
...
; AVX512F-NEXT:    vmovaps %zmm2, 320(%rsp,%rcx,4)
