...
; AVX512F-NEXT:    vpternlogd {{.*#+}} zmm5 {%k3} {z} = -1
; AVX512F-NEXT:    vpsrld $31, %zmm5, %zmm0
...
; AVX512F-NEXT:    vmovd {{.*#+}} xmm7 = mem[0],zero,zero,zero
; AVX512F-NEXT:    vpinsrb $1, 232(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $2, 240(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $3, 248(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $4, 256(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $5, 264(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $6, 272(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $7, 280(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $8, 288(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $9, 296(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $10, 304(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $11, 312(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $12, 320(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $13, 328(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vpinsrb $14, 336(%rbp), %xmm7, %xmm7
; AVX512F-NEXT:    vmovd %xmm6, %eax
; AVX512F-NEXT:    vpinsrb $15, 344(%rbp), %xmm7, %xmm6
...
; AVX512F-NEXT:    andl $31, %eax
; AVX512F-NEXT:    vpcompressd %zmm3, %zmm0 {%k1} {z}
; AVX512F-NEXT:    vmovdqa64 %zmm0, 128(%rsp,%rax,4)
; AVX512F-NEXT:    vmovdqa64 (%rsp), %zmm0
; AVX512F-NEXT:    vmovaps {{[0-9]+}}(%rsp), %zmm1
; AVX512F-NEXT:    vmovdqa64 %zmm0, {{[0-9]+}}(%rsp)
; AVX512F-NEXT:    vpternlogd {{.*#+}} zmm0 {%k2} {z} = -1
; AVX512F-NEXT:    vpsrld $31, %zmm0, %zmm0
; AVX512F-NEXT:    vpsubd %zmm5, %zmm0, %zmm0
...
; AVX512F-NEXT:    vmovaps %zmm2, 320(%rsp,%rax,4)
; AVX512F-NEXT:    vmovaps {{[0-9]+}}(%rsp), %zmm0
; AVX512F-NEXT:    vmovaps {{[0-9]+}}(%rsp), %zmm1
; AVX512F-NEXT:    vmovaps {{[0-9]+}}(%rsp), %zmm2
