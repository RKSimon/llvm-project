...
; AVX2-NEXT:    vpbroadcastd (%rdx), %xmm2
...
; AVX2-FP-NEXT:    vpbroadcastd (%rdx), %xmm2
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} xmm1 = xmm1[8,9,12,13,10,11,14,15,u,u,u,u,u,u,u,u]
...
; AVX2-FCP-NEXT:    vpbroadcastd (%rdx), %xmm2
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} xmm1 = xmm1[8,9,12,13,10,11,14,15,u,u,u,u,u,u,u,u]
...
; AVX512-NEXT:    vpbroadcastd (%rcx), %xmm1
...
; AVX512-FCP-NEXT:    vpbroadcastd (%rdx), %xmm1
; AVX512-FCP-NEXT:    vpunpckldq (%rcx){1to4}, %xmm1, %xmm1
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3]
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} xmm1 = xmm1[8,9,12,13,10,11,14,15,u,u,u,u,u,u,u,u]
...
; AVX512DQ-NEXT:    vpbroadcastd (%rcx), %xmm1
...
; AVX512DQ-FCP-NEXT:    vpbroadcastd (%rdx), %xmm1
; AVX512DQ-FCP-NEXT:    vpunpckldq (%rcx){1to4}, %xmm1, %xmm1
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3]
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} xmm1 = xmm1[8,9,12,13,10,11,14,15,u,u,u,u,u,u,u,u]
...
; AVX512BW-NEXT:    vpbroadcastd (%rcx), %xmm1
...
; AVX512BW-FCP-NEXT:    vpbroadcastd (%rcx), %xmm1
; AVX512BW-FCP-NEXT:    vpbroadcastd (%rdx), %xmm2
; AVX512BW-FCP-NEXT:    vpbroadcastq {{.*#+}} xmm3 = [4,14,5,15,4,14,5,15]
; AVX512BW-FCP-NEXT:    vpermi2w %xmm1, %xmm2, %xmm3
; AVX512BW-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3]
; AVX512BW-FCP-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm0[0],xmm3[0],xmm0[1],xmm3[1]
...
; AVX512DQ-BW-NEXT:    vpbroadcastd (%rcx), %xmm1
...
; AVX512DQ-BW-FCP-NEXT:    vpbroadcastd (%rcx), %xmm1
; AVX512DQ-BW-FCP-NEXT:    vpbroadcastd (%rdx), %xmm2
; AVX512DQ-BW-FCP-NEXT:    vpbroadcastq {{.*#+}} xmm3 = [4,14,5,15,4,14,5,15]
; AVX512DQ-BW-FCP-NEXT:    vpermi2w %xmm1, %xmm2, %xmm3
; AVX512DQ-BW-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3]
; AVX512DQ-BW-FCP-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm0[0],xmm3[0],xmm0[1],xmm3[1]
...
; AVX-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm7, %ymm6
; AVX-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
...
; AVX2-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm6, %ymm7, %ymm6
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
...
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm6, %ymm7, %ymm6
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
...
; AVX2-FP-NEXT:    vmovdqa %ymm6, 64(%r8)
...
; AVX2-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3]
...
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm1 = xmm8[4],xmm6[4],xmm8[5],xmm6[5],xmm8[6],xmm6[6],xmm8[7],xmm6[7]
...
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm5[4],xmm2[4],xmm5[5],xmm2[5],xmm5[6],xmm2[6],xmm5[7],xmm2[7]
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm5[0],xmm2[0],xmm5[1],xmm2[1],xmm5[2],xmm2[2],xmm5[3],xmm2[3]
; AVX512-NEXT:    vinserti32x4 $2, %xmm7, %zmm2, %zmm2
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm5 = [0,16,1,17,2,18,3,19,8,24,9,25,10,26,11,27]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm5, %zmm2
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
...
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm6[0],xmm4[0],xmm6[1],xmm4[1],xmm6[2],xmm4[2],xmm6[3],xmm4[3]
; AVX512-NEXT:    vinserti32x4 $2, %xmm1, %zmm3, %zmm1
; AVX512-NEXT:    vpermt2d %zmm0, %zmm5, %zmm1
...
; AVX512-FCP-NEXT:    vinserti32x4 $2, %xmm4, %zmm0, %zmm0
...
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm5[4],xmm2[4],xmm5[5],xmm2[5],xmm5[6],xmm2[6],xmm5[7],xmm2[7]
...
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm5 = [0,16,1,17,2,18,3,19,8,24,9,25,10,26,11,27]
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm5, %zmm2
...
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm6[0],xmm4[0],xmm6[1],xmm4[1],xmm6[2],xmm4[2],xmm6[3],xmm4[3]
; AVX512-FCP-NEXT:    vinserti32x4 $2, %xmm1, %zmm3, %zmm1
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm5, %zmm1
...
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm5[4],xmm2[4],xmm5[5],xmm2[5],xmm5[6],xmm2[6],xmm5[7],xmm2[7]
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm5[0],xmm2[0],xmm5[1],xmm2[1],xmm5[2],xmm2[2],xmm5[3],xmm2[3]
; AVX512DQ-NEXT:    vinserti32x4 $2, %xmm7, %zmm2, %zmm2
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm5 = [0,16,1,17,2,18,3,19,8,24,9,25,10,26,11,27]
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm5, %zmm2
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
...
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm6[0],xmm4[0],xmm6[1],xmm4[1],xmm6[2],xmm4[2],xmm6[3],xmm4[3]
; AVX512DQ-NEXT:    vinserti32x4 $2, %xmm1, %zmm3, %zmm1
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm5, %zmm1
...
; AVX512DQ-FCP-NEXT:    vinserti32x4 $2, %xmm4, %zmm0, %zmm0
...
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm5[4],xmm2[4],xmm5[5],xmm2[5],xmm5[6],xmm2[6],xmm5[7],xmm2[7]
...
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm5 = [0,16,1,17,2,18,3,19,8,24,9,25,10,26,11,27]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm5, %zmm2
...
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm6[0],xmm4[0],xmm6[1],xmm4[1],xmm6[2],xmm4[2],xmm6[3],xmm4[3]
; AVX512DQ-FCP-NEXT:    vinserti32x4 $2, %xmm1, %zmm3, %zmm1
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm5, %zmm1
...
; AVX-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm6[0],xmm3[0],xmm6[1],xmm3[1],xmm6[2],xmm3[2],xmm6[3],xmm3[3]
...
; AVX-NEXT:    vpunpckhwd {{.*#+}} xmm3 = xmm6[4],xmm3[4],xmm6[5],xmm3[5],xmm6[6],xmm3[6],xmm6[7],xmm3[7]
; AVX-NEXT:    vpshufd {{.*#+}} xmm6 = xmm3[0,0,1,1]
; AVX-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm6, %ymm3
; AVX-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm10[4],xmm9[4],xmm10[5],xmm9[5],xmm10[6],xmm9[6],xmm10[7],xmm9[7]
...
; AVX2-NEXT:    vmovdqa 48(%rcx), %xmm0
; AVX2-NEXT:    vmovdqa (%rdx), %xmm6
; AVX2-NEXT:    vmovdqa 16(%rdx), %xmm8
; AVX2-NEXT:    vmovdqa 32(%rdx), %xmm5
; AVX2-NEXT:    vmovdqa 48(%rdx), %xmm1
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm6[0],xmm3[0],xmm6[1],xmm3[1],xmm6[2],xmm3[2],xmm6[3],xmm3[3]
...
; AVX2-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm10[4],xmm9[4],xmm10[5],xmm9[5],xmm10[6],xmm9[6],xmm10[7],xmm9[7]
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4],ymm0[5],ymm1[6],ymm0[7]
; AVX2-NEXT:    vmovdqa %ymm0, 224(%r8)
; AVX2-NEXT:    vmovdqa %ymm5, 192(%r8)
...
; AVX2-FP-NEXT:    vmovdqa 16(%rcx), %xmm7
; AVX2-FP-NEXT:    vmovdqa 32(%rcx), %xmm4
; AVX2-FP-NEXT:    vmovdqa 48(%rcx), %xmm0
; AVX2-FP-NEXT:    vmovdqa (%rdx), %xmm6
; AVX2-FP-NEXT:    vmovdqa 16(%rdx), %xmm8
; AVX2-FP-NEXT:    vmovdqa 32(%rdx), %xmm5
; AVX2-FP-NEXT:    vmovdqa 48(%rdx), %xmm1
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm6[0],xmm3[0],xmm6[1],xmm3[1],xmm6[2],xmm3[2],xmm6[3],xmm3[3]
...
; AVX2-FP-NEXT:    vpunpckhwd {{.*#+}} xmm3 = xmm6[4],xmm3[4],xmm6[5],xmm3[5],xmm6[6],xmm3[6],xmm6[7],xmm3[7]
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4],ymm0[5],ymm1[6],ymm0[7]
; AVX2-FP-NEXT:    vmovdqa %ymm0, 224(%r8)
; AVX2-FP-NEXT:    vmovdqa %ymm5, 192(%r8)
...
; AVX2-FCP-NEXT:    vmovdqa 16(%rsi), %xmm8
; AVX2-FCP-NEXT:    vmovdqa 32(%rsi), %xmm4
; AVX2-FCP-NEXT:    vmovdqa 48(%rsi), %xmm0
; AVX2-FCP-NEXT:    vmovdqa (%rdi), %xmm7
; AVX2-FCP-NEXT:    vmovdqa 16(%rdi), %xmm9
...
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm11[4],xmm10[4],xmm11[5],xmm10[5],xmm11[6],xmm10[6],xmm11[7],xmm10[7]
...
; AVX2-FCP-NEXT:    vmovdqa 48(%rdx), %xmm6
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2],ymm1[3],ymm0[4],ymm1[5],ymm0[6],ymm1[7]
; AVX2-FCP-NEXT:    vmovdqa %ymm0, 224(%r8)
; AVX2-FCP-NEXT:    vmovdqa %ymm10, 192(%r8)
...
; AVX512-NEXT:    vmovdqa 16(%rcx), %xmm12
; AVX512-NEXT:    vmovdqa 32(%rcx), %xmm8
; AVX512-NEXT:    vmovdqa 48(%rcx), %xmm3
; AVX512-NEXT:    vmovdqa (%rdx), %xmm13
; AVX512-NEXT:    vmovdqa 16(%rdx), %xmm14
...
; AVX512-NEXT:    vmovdqa32 %zmm13, %zmm0 {%k1}
...
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm2[4],xmm1[4],xmm2[5],xmm1[5],xmm2[6],xmm1[6],xmm2[7],xmm1[7]
...
; AVX512-NEXT:    vmovdqa64 %zmm10, 64(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm0, (%r8)
; AVX512-NEXT:    vzeroupper
; AVX512-NEXT:    retq
;
...
; AVX512-FCP-NEXT:    vmovdqa 48(%rsi), %xmm0
...
; AVX512-FCP-NEXT:    vmovdqa 16(%rcx), %xmm12
; AVX512-FCP-NEXT:    vmovdqa 32(%rcx), %xmm7
; AVX512-FCP-NEXT:    vmovdqa 48(%rcx), %xmm3
; AVX512-FCP-NEXT:    vmovdqa (%rdx), %xmm13
; AVX512-FCP-NEXT:    vmovdqa 16(%rdx), %xmm14
...
; AVX512-FCP-NEXT:    vmovdqa64 %zmm9, 64(%r8)
...
; AVX512DQ-NEXT:    vmovdqa 48(%rcx), %xmm3
...
; AVX512DQ-NEXT:    vmovdqa32 %zmm13, %zmm0 {%k1}
...
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm2[4],xmm1[4],xmm2[5],xmm1[5],xmm2[6],xmm1[6],xmm2[7],xmm1[7]
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm7, %zmm1, %zmm1
...
; AVX512DQ-NEXT:    vmovdqa32 %zmm3, %zmm1 {%k1}
; AVX512DQ-NEXT:    vmovdqa64 %zmm1, 192(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm6, 128(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm10, 64(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, (%r8)
; AVX512DQ-NEXT:    vzeroupper
; AVX512DQ-NEXT:    retq
;
...
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%rsi), %xmm0
...
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rcx), %xmm12
; AVX512DQ-FCP-NEXT:    vmovdqa 32(%rcx), %xmm7
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%rcx), %xmm3
; AVX512DQ-FCP-NEXT:    vmovdqa (%rdx), %xmm13
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rdx), %xmm14
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm9, 64(%r8)
...
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm15 = xmm11[0],zero,xmm11[1],zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm11 = xmm11[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm15, %ymm11
; AVX-NEXT:    vmovdqa 16(%rdi), %xmm15
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0],ymm0[1],ymm11[2],ymm0[3],ymm11[4],ymm0[5],ymm11[6],ymm0[7]
...
; AVX-NEXT:    vpunpckhwd {{.*#+}} xmm2 = xmm14[4],xmm12[4],xmm14[5],xmm12[5],xmm14[6],xmm12[6],xmm14[7],xmm12[7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm12 = xmm2[0],zero,xmm2[1],zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[2,2,3,3]
...
; AVX-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm12, %ymm2
; AVX-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm15[0],xmm13[0],xmm15[1],xmm13[1],xmm15[2],xmm13[2],xmm15[3],xmm13[3]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm14 = xmm12[0],zero,xmm12[1],zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm12 = xmm12[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm14, %ymm14
; AVX-NEXT:    vmovdqa 48(%rdi), %xmm12
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0],ymm2[1],ymm14[2],ymm2[3],ymm14[4],ymm2[5],ymm14[6],ymm2[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vpunpckhwd {{.*#+}} xmm4 = xmm15[4],xmm13[4],xmm15[5],xmm13[5],xmm15[6],xmm13[6],xmm15[7],xmm13[7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm13 = xmm4[0],zero,xmm4[1],zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[2,2,3,3]
...
; AVX-NEXT:    vpshufd {{.*#+}} xmm13 = xmm4[0,0,1,1]
; AVX-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm13, %ymm4
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm13[0],ymm4[1],ymm13[2],ymm4[3],ymm13[4],ymm4[5],ymm13[6],ymm4[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm6[4],xmm5[4],xmm6[5],xmm5[5],xmm6[6],xmm5[6],xmm6[7],xmm5[7]
; AVX-NEXT:    vpshufd {{.*#+}} xmm6 = xmm5[0,0,1,1]
; AVX-NEXT:    vpshufd {{.*#+}} xmm5 = xmm5[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm6, %ymm5
; AVX-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm11[4],xmm10[4],xmm11[5],xmm10[5],xmm11[6],xmm10[6],xmm11[7],xmm10[7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm10 = xmm6[0],zero,xmm6[1],zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[2,2,3,3]
...
; AVX-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm10, %ymm6
; AVX-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm12[0],xmm9[0],xmm12[1],xmm9[1],xmm12[2],xmm9[2],xmm12[3],xmm9[3]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm10[0],ymm6[1],ymm10[2],ymm6[3],ymm10[4],ymm6[5],ymm10[6],ymm6[7]
; AVX-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm8[4],xmm7[4],xmm8[5],xmm7[5],xmm8[6],xmm7[6],xmm8[7],xmm7[7]
; AVX-NEXT:    vpshufd {{.*#+}} xmm8 = xmm7[0,0,1,1]
; AVX-NEXT:    vpshufd {{.*#+}} xmm7 = xmm7[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm7, %ymm8, %ymm7
; AVX-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm12[4],xmm9[4],xmm12[5],xmm9[5],xmm12[6],xmm9[6],xmm12[7],xmm9[7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm9 = xmm8[0],zero,xmm8[1],zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm9, %ymm8
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm8[0],ymm7[1],ymm8[2],ymm7[3],ymm8[4],ymm7[5],ymm8[6],ymm7[7]
; AVX-NEXT:    vmovdqa 64(%rcx), %xmm9
; AVX-NEXT:    vmovdqa 64(%rdx), %xmm10
; AVX-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX-NEXT:    vpshufd {{.*#+}} xmm11 = xmm8[0,0,1,1]
; AVX-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm11, %ymm8
; AVX-NEXT:    vmovdqa 64(%rsi), %xmm11
; AVX-NEXT:    vmovdqa 64(%rdi), %xmm12
; AVX-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm12[0],xmm11[0],xmm12[1],xmm11[1],xmm12[2],xmm11[2],xmm12[3],xmm11[3]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm14 = xmm13[0],zero,xmm13[1],zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm13 = xmm13[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm13, %ymm14, %ymm13
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm13[0],ymm8[1],ymm13[2],ymm8[3],ymm13[4],ymm8[5],ymm13[6],ymm8[7]
; AVX-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm10[4],xmm9[4],xmm10[5],xmm9[5],xmm10[6],xmm9[6],xmm10[7],xmm9[7]
; AVX-NEXT:    vpshufd {{.*#+}} xmm10 = xmm9[0,0,1,1]
; AVX-NEXT:    vpshufd {{.*#+}} xmm9 = xmm9[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm9, %ymm10, %ymm9
; AVX-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm12[4],xmm11[4],xmm12[5],xmm11[5],xmm12[6],xmm11[6],xmm12[7],xmm11[7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm11 = xmm10[0],zero,xmm10[1],zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm10 = xmm10[2,2,3,3]
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm11, %ymm10
; AVX-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0],ymm9[1],ymm10[2],ymm9[3],ymm10[4],ymm9[5],ymm10[6],ymm9[7]
; AVX-NEXT:    vmovdqa 80(%rcx), %xmm11
; AVX-NEXT:    vmovdqa 80(%rdx), %xmm12
; AVX-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm12[0],xmm11[0],xmm12[1],xmm11[1],xmm12[2],xmm11[2],xmm12[3],xmm11[3]
; AVX-NEXT:    vpshufd {{.*#+}} xmm13 = xmm10[0,0,1,1]
; AVX-NEXT:    vpshufd {{.*#+}} xmm10 = xmm10[2,2,3,3]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm10 = ymm0[0],ymm10[1],ymm0[2],ymm10[3],ymm0[4],ymm10[5],ymm0[6],ymm10[7]
...
; AVX-NEXT:    vmovdqa 96(%rcx), %xmm1
; AVX-NEXT:    vmovdqa 96(%rdx), %xmm13
...
; AVX-NEXT:    vmovaps %ymm12, 384(%r8)
; AVX-NEXT:    vmovaps %ymm11, 352(%r8)
; AVX-NEXT:    vmovaps %ymm10, 320(%r8)
; AVX-NEXT:    vmovaps %ymm9, 288(%r8)
; AVX-NEXT:    vmovaps %ymm8, 256(%r8)
...
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm9 = xmm0[0,0,1,1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm0, %ymm9, %ymm0
; AVX2-NEXT:    vmovdqa (%rsi), %xmm12
; AVX2-NEXT:    vmovdqa 16(%rsi), %xmm13
; AVX2-NEXT:    vmovdqa 32(%rsi), %xmm10
; AVX2-NEXT:    vmovdqa 48(%rsi), %xmm9
; AVX2-NEXT:    vmovdqa (%rdi), %xmm14
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm11 = xmm14[0],xmm12[0],xmm14[1],xmm12[1],xmm14[2],xmm12[2],xmm14[3],xmm12[3]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm15 = xmm11[0],zero,xmm11[1],zero
; AVX2-NEXT:    vpshufd {{.*#+}} xmm11 = xmm11[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm11, %ymm15, %ymm11
; AVX2-NEXT:    vmovdqa 16(%rdi), %xmm15
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm11[0],ymm0[1],ymm11[2],ymm0[3],ymm11[4],ymm0[5],ymm11[6],ymm0[7]
...
; AVX2-NEXT:    vpunpckhwd {{.*#+}} xmm2 = xmm14[4],xmm12[4],xmm14[5],xmm12[5],xmm14[6],xmm12[6],xmm14[7],xmm12[7]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm12 = xmm2[0],zero,xmm2[1],zero
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[2,2,3,3]
...
; AVX2-NEXT:    vpshufd {{.*#+}} xmm12 = xmm2[0,0,1,1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm2, %ymm12, %ymm2
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm15[0],xmm13[0],xmm15[1],xmm13[1],xmm15[2],xmm13[2],xmm15[3],xmm13[3]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm14 = xmm12[0],zero,xmm12[1],zero
; AVX2-NEXT:    vpshufd {{.*#+}} xmm12 = xmm12[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm12, %ymm14, %ymm14
; AVX2-NEXT:    vmovdqa 48(%rdi), %xmm12
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm14[0],ymm2[1],ymm14[2],ymm2[3],ymm14[4],ymm2[5],ymm14[6],ymm2[7]
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vpunpckhwd {{.*#+}} xmm4 = xmm15[4],xmm13[4],xmm15[5],xmm13[5],xmm15[6],xmm13[6],xmm15[7],xmm13[7]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm13 = xmm4[0],zero,xmm4[1],zero
; AVX2-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm4, %ymm13, %ymm4
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm4[0],ymm3[1],ymm4[2],ymm3[3],ymm4[4],ymm3[5],ymm4[6],ymm3[7]
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm13 = xmm4[0,0,1,1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm4, %ymm13, %ymm4
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm13[0],ymm4[1],ymm13[2],ymm4[3],ymm13[4],ymm4[5],ymm13[6],ymm4[7]
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm6[4],xmm5[4],xmm6[5],xmm5[5],xmm6[6],xmm5[6],xmm6[7],xmm5[7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm6 = xmm5[0,0,1,1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm5 = xmm5[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm5, %ymm6, %ymm5
; AVX2-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm11[4],xmm10[4],xmm11[5],xmm10[5],xmm11[6],xmm10[6],xmm11[7],xmm10[7]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm10 = xmm6[0],zero,xmm6[1],zero
; AVX2-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm6, %ymm10, %ymm6
; AVX2-NEXT:    vpblendd {{.*#+}} ymm5 = ymm6[0],ymm5[1],ymm6[2],ymm5[3],ymm6[4],ymm5[5],ymm6[6],ymm5[7]
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm8[0],xmm7[0],xmm8[1],xmm7[1],xmm8[2],xmm7[2],xmm8[3],xmm7[3]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm10 = xmm6[0,0,1,1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm6, %ymm10, %ymm6
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm12[0],xmm9[0],xmm12[1],xmm9[1],xmm12[2],xmm9[2],xmm12[3],xmm9[3]
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm6 = ymm10[0],ymm6[1],ymm10[2],ymm6[3],ymm10[4],ymm6[5],ymm10[6],ymm6[7]
; AVX2-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm8[4],xmm7[4],xmm8[5],xmm7[5],xmm8[6],xmm7[6],xmm8[7],xmm7[7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm8 = xmm7[0,0,1,1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm7 = xmm7[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm7, %ymm8, %ymm7
; AVX2-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm12[4],xmm9[4],xmm12[5],xmm9[5],xmm12[6],xmm9[6],xmm12[7],xmm9[7]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm9 = xmm8[0],zero,xmm8[1],zero
; AVX2-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm8, %ymm9, %ymm8
; AVX2-NEXT:    vpblendd {{.*#+}} ymm7 = ymm8[0],ymm7[1],ymm8[2],ymm7[3],ymm8[4],ymm7[5],ymm8[6],ymm7[7]
; AVX2-NEXT:    vmovdqa 64(%rcx), %xmm9
; AVX2-NEXT:    vmovdqa 64(%rdx), %xmm10
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm11 = xmm8[0,0,1,1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm8, %ymm11, %ymm8
; AVX2-NEXT:    vmovdqa 64(%rsi), %xmm11
; AVX2-NEXT:    vmovdqa 64(%rdi), %xmm12
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm12[0],xmm11[0],xmm12[1],xmm11[1],xmm12[2],xmm11[2],xmm12[3],xmm11[3]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm14 = xmm13[0],zero,xmm13[1],zero
; AVX2-NEXT:    vpshufd {{.*#+}} xmm13 = xmm13[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm13, %ymm14, %ymm13
; AVX2-NEXT:    vpblendd {{.*#+}} ymm8 = ymm13[0],ymm8[1],ymm13[2],ymm8[3],ymm13[4],ymm8[5],ymm13[6],ymm8[7]
...
; AVX2-NEXT:    vpshufd {{.*#+}} xmm9 = xmm9[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm9, %ymm10, %ymm9
; AVX2-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm12[4],xmm11[4],xmm12[5],xmm11[5],xmm12[6],xmm11[6],xmm12[7],xmm11[7]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} xmm11 = xmm10[0],zero,xmm10[1],zero
; AVX2-NEXT:    vpshufd {{.*#+}} xmm10 = xmm10[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm10, %ymm11, %ymm10
; AVX2-NEXT:    vpblendd {{.*#+}} ymm9 = ymm10[0],ymm9[1],ymm10[2],ymm9[3],ymm10[4],ymm9[5],ymm10[6],ymm9[7]
; AVX2-NEXT:    vmovdqa 80(%rcx), %xmm11
; AVX2-NEXT:    vmovdqa 80(%rdx), %xmm12
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm12[0],xmm11[0],xmm12[1],xmm11[1],xmm12[2],xmm11[2],xmm12[3],xmm11[3]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm13 = xmm10[0,0,1,1]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm10 = xmm10[2,2,3,3]
; AVX2-NEXT:    vinserti128 $1, %xmm10, %ymm13, %ymm10
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm10 = ymm0[0],ymm10[1],ymm0[2],ymm10[3],ymm0[4],ymm10[5],ymm0[6],ymm10[7]
...
; AVX2-NEXT:    vmovdqa 112(%rdx), %xmm2
; AVX2-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
...
; AVX2-NEXT:    vmovdqa %ymm1, 480(%r8)
; AVX2-NEXT:    vmovdqa %ymm0, 448(%r8)
; AVX2-NEXT:    vmovdqa %ymm4, 416(%r8)
; AVX2-NEXT:    vmovdqa %ymm12, 384(%r8)
; AVX2-NEXT:    vmovdqa %ymm11, 352(%r8)
; AVX2-NEXT:    vmovdqa %ymm10, 320(%r8)
; AVX2-NEXT:    vmovdqa %ymm9, 288(%r8)
; AVX2-NEXT:    vmovdqa %ymm8, 256(%r8)
; AVX2-NEXT:    vmovdqa %ymm7, 224(%r8)
; AVX2-NEXT:    vmovdqa %ymm6, 192(%r8)
; AVX2-NEXT:    vmovdqa %ymm5, 160(%r8)
...
; AVX2-FP-NEXT:    vmovdqa 16(%rcx), %xmm3
; AVX2-FP-NEXT:    vmovdqa 32(%rcx), %xmm5
; AVX2-FP-NEXT:    vmovdqa 48(%rcx), %xmm7
; AVX2-FP-NEXT:    vmovdqa (%rdx), %xmm2
; AVX2-FP-NEXT:    vmovdqa 16(%rdx), %xmm4
; AVX2-FP-NEXT:    vmovdqa 32(%rdx), %xmm6
; AVX2-FP-NEXT:    vmovdqa 48(%rdx), %xmm8
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm9 = xmm0[0,0,1,1]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm9, %ymm0
; AVX2-FP-NEXT:    vmovdqa (%rsi), %xmm12
; AVX2-FP-NEXT:    vmovdqa 16(%rsi), %xmm13
; AVX2-FP-NEXT:    vmovdqa 32(%rsi), %xmm10
...
; AVX2-FP-NEXT:    vpmovzxdq {{.*#+}} xmm15 = xmm11[0],zero,xmm11[1],zero
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm11 = xmm11[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm11, %ymm15, %ymm11
; AVX2-FP-NEXT:    vmovdqa 16(%rdi), %xmm15
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm11[0],ymm0[1],ymm11[2],ymm0[3],ymm11[4],ymm0[5],ymm11[6],ymm0[7]
...
; AVX2-FP-NEXT:    vpunpckhwd {{.*#+}} xmm2 = xmm14[4],xmm12[4],xmm14[5],xmm12[5],xmm14[6],xmm12[6],xmm14[7],xmm12[7]
; AVX2-FP-NEXT:    vpmovzxdq {{.*#+}} xmm12 = xmm2[0],zero,xmm2[1],zero
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm12, %ymm2
...
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm12 = xmm2[0,0,1,1]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm12, %ymm2
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm15[0],xmm13[0],xmm15[1],xmm13[1],xmm15[2],xmm13[2],xmm15[3],xmm13[3]
; AVX2-FP-NEXT:    vpmovzxdq {{.*#+}} xmm14 = xmm12[0],zero,xmm12[1],zero
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm12 = xmm12[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm12, %ymm14, %ymm14
; AVX2-FP-NEXT:    vmovdqa 48(%rdi), %xmm12
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm14[0],ymm2[1],ymm14[2],ymm2[3],ymm14[4],ymm2[5],ymm14[6],ymm2[7]
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vpunpckhwd {{.*#+}} xmm4 = xmm15[4],xmm13[4],xmm15[5],xmm13[5],xmm15[6],xmm13[6],xmm15[7],xmm13[7]
; AVX2-FP-NEXT:    vpmovzxdq {{.*#+}} xmm13 = xmm4[0],zero,xmm4[1],zero
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm4, %ymm13, %ymm4
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm4[0],ymm3[1],ymm4[2],ymm3[3],ymm4[4],ymm3[5],ymm4[6],ymm3[7]
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm13 = xmm4[0,0,1,1]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm4, %ymm13, %ymm4
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm13[0],ymm4[1],ymm13[2],ymm4[3],ymm13[4],ymm4[5],ymm13[6],ymm4[7]
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm6[4],xmm5[4],xmm6[5],xmm5[5],xmm6[6],xmm5[6],xmm6[7],xmm5[7]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm6 = xmm5[0,0,1,1]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm5 = xmm5[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm5, %ymm6, %ymm5
; AVX2-FP-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm11[4],xmm10[4],xmm11[5],xmm10[5],xmm11[6],xmm10[6],xmm11[7],xmm10[7]
; AVX2-FP-NEXT:    vpmovzxdq {{.*#+}} xmm10 = xmm6[0],zero,xmm6[1],zero
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm6, %ymm10, %ymm6
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm6[0],ymm5[1],ymm6[2],ymm5[3],ymm6[4],ymm5[5],ymm6[6],ymm5[7]
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm8[0],xmm7[0],xmm8[1],xmm7[1],xmm8[2],xmm7[2],xmm8[3],xmm7[3]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm10 = xmm6[0,0,1,1]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm6, %ymm10, %ymm6
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm12[0],xmm9[0],xmm12[1],xmm9[1],xmm12[2],xmm9[2],xmm12[3],xmm9[3]
...
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm7 = xmm7[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm7, %ymm8, %ymm7
; AVX2-FP-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm12[4],xmm9[4],xmm12[5],xmm9[5],xmm12[6],xmm9[6],xmm12[7],xmm9[7]
; AVX2-FP-NEXT:    vpmovzxdq {{.*#+}} xmm9 = xmm8[0],zero,xmm8[1],zero
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm8, %ymm9, %ymm8
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm7 = ymm8[0],ymm7[1],ymm8[2],ymm7[3],ymm8[4],ymm7[5],ymm8[6],ymm7[7]
; AVX2-FP-NEXT:    vmovdqa 64(%rcx), %xmm9
; AVX2-FP-NEXT:    vmovdqa 64(%rdx), %xmm10
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm11 = xmm8[0,0,1,1]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm8, %ymm11, %ymm8
...
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm13 = xmm13[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm13, %ymm14, %ymm13
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm8 = ymm13[0],ymm8[1],ymm13[2],ymm8[3],ymm13[4],ymm8[5],ymm13[6],ymm8[7]
...
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm9 = xmm9[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm9, %ymm10, %ymm9
; AVX2-FP-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm12[4],xmm11[4],xmm12[5],xmm11[5],xmm12[6],xmm11[6],xmm12[7],xmm11[7]
; AVX2-FP-NEXT:    vpmovzxdq {{.*#+}} xmm11 = xmm10[0],zero,xmm10[1],zero
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm10 = xmm10[2,2,3,3]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm10, %ymm11, %ymm10
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm9 = ymm10[0],ymm9[1],ymm10[2],ymm9[3],ymm10[4],ymm9[5],ymm10[6],ymm9[7]
; AVX2-FP-NEXT:    vmovdqa 80(%rcx), %xmm11
; AVX2-FP-NEXT:    vmovdqa 80(%rdx), %xmm12
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm12[0],xmm11[0],xmm12[1],xmm11[1],xmm12[2],xmm11[2],xmm12[3],xmm11[3]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm13 = xmm10[0,0,1,1]
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm10 = xmm10[2,2,3,3]
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm10 = ymm0[0],ymm10[1],ymm0[2],ymm10[3],ymm0[4],ymm10[5],ymm0[6],ymm10[7]
...
; AVX2-FP-NEXT:    vmovdqa 96(%rdx), %xmm13
...
; AVX2-FP-NEXT:    vmovdqa 112(%rdx), %xmm2
; AVX2-FP-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
...
; AVX2-FP-NEXT:    vmovdqa %ymm1, 480(%r8)
; AVX2-FP-NEXT:    vmovdqa %ymm0, 448(%r8)
; AVX2-FP-NEXT:    vmovdqa %ymm4, 416(%r8)
; AVX2-FP-NEXT:    vmovdqa %ymm12, 384(%r8)
; AVX2-FP-NEXT:    vmovdqa %ymm11, 352(%r8)
; AVX2-FP-NEXT:    vmovdqa %ymm10, 320(%r8)
; AVX2-FP-NEXT:    vmovdqa %ymm9, 288(%r8)
; AVX2-FP-NEXT:    vmovdqa %ymm8, 256(%r8)
; AVX2-FP-NEXT:    vmovdqa %ymm7, 224(%r8)
; AVX2-FP-NEXT:    vmovdqa %ymm6, 192(%r8)
; AVX2-FP-NEXT:    vmovdqa %ymm5, 160(%r8)
...
; AVX2-FCP-NEXT:    vmovdqa 16(%rsi), %xmm4
...
; AVX2-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3]
...
; AVX2-FCP-NEXT:    vmovdqa 48(%rcx), %xmm10
; AVX2-FCP-NEXT:    vmovdqa (%rdx), %xmm15
; AVX2-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm14 = xmm15[0],xmm12[0],xmm15[1],xmm12[1],xmm15[2],xmm12[2],xmm15[3],xmm12[3]
; AVX2-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,0,1,1,2,2,3,3]
; AVX2-FCP-NEXT:    vpermd %ymm14, %ymm2, %ymm14
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm14[1],ymm0[2],ymm14[3],ymm0[4],ymm14[5],ymm0[6],ymm14[7]
...
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm3 = xmm15[4],xmm12[4],xmm15[5],xmm12[5],xmm15[6],xmm12[6],xmm15[7],xmm12[7]
; AVX2-FCP-NEXT:    vpermd %ymm3, %ymm2, %ymm3
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm1[0],ymm3[1],ymm1[2],ymm3[3],ymm1[4],ymm3[5],ymm1[6],ymm3[7]
...
; AVX2-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm12 = xmm3[0],zero,xmm3[1],zero
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[2,2,3,3]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm12, %ymm3
; AVX2-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm0[0],xmm13[0],xmm0[1],xmm13[1],xmm0[2],xmm13[2],xmm0[3],xmm13[3]
; AVX2-FCP-NEXT:    vpermd %ymm12, %ymm2, %ymm12
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0],ymm12[1],ymm3[2],ymm12[3],ymm3[4],ymm12[5],ymm3[6],ymm12[7]
; AVX2-FCP-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 48(%rdx), %xmm12
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm4 = xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX2-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm5 = xmm4[0],zero,xmm4[1],zero
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[2,2,3,3]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm4, %ymm5, %ymm4
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm0[4],xmm13[4],xmm0[5],xmm13[5],xmm0[6],xmm13[6],xmm0[7],xmm13[7]
...
; AVX2-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX2-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm5 = xmm0[0],zero,xmm0[1],zero
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[2,2,3,3]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm5, %ymm0
; AVX2-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm14[0],xmm11[0],xmm14[1],xmm11[1],xmm14[2],xmm11[2],xmm14[3],xmm11[3]
; AVX2-FCP-NEXT:    vpermd %ymm5, %ymm2, %ymm5
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm5[1],ymm0[2],ymm5[3],ymm0[4],ymm5[5],ymm0[6],ymm5[7]
; AVX2-FCP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm7[4],xmm6[4],xmm7[5],xmm6[5],xmm7[6],xmm6[6],xmm7[7],xmm6[7]
; AVX2-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm6 = xmm0[0],zero,xmm0[1],zero
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[2,2,3,3]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm6, %ymm0
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm14[4],xmm11[4],xmm14[5],xmm11[5],xmm14[6],xmm11[6],xmm14[7],xmm11[7]
; AVX2-FCP-NEXT:    vpermd %ymm6, %ymm2, %ymm6
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm6 = ymm0[0],ymm6[1],ymm0[2],ymm6[3],ymm0[4],ymm6[5],ymm0[6],ymm6[7]
; AVX2-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX2-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm7 = xmm0[0],zero,xmm0[1],zero
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[2,2,3,3]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm7, %ymm0
; AVX2-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm12[0],xmm10[0],xmm12[1],xmm10[1],xmm12[2],xmm10[2],xmm12[3],xmm10[3]
; AVX2-FCP-NEXT:    vpermd %ymm7, %ymm2, %ymm7
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm7 = ymm0[0],ymm7[1],ymm0[2],ymm7[3],ymm0[4],ymm7[5],ymm0[6],ymm7[7]
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm9[4],xmm8[4],xmm9[5],xmm8[5],xmm9[6],xmm8[6],xmm9[7],xmm8[7]
; AVX2-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm8 = xmm0[0],zero,xmm0[1],zero
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[2,2,3,3]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm8, %ymm0
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm12[4],xmm10[4],xmm12[5],xmm10[5],xmm12[6],xmm10[6],xmm12[7],xmm10[7]
; AVX2-FCP-NEXT:    vpermd %ymm8, %ymm2, %ymm8
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm8 = ymm0[0],ymm8[1],ymm0[2],ymm8[3],ymm0[4],ymm8[5],ymm0[6],ymm8[7]
; AVX2-FCP-NEXT:    vmovdqa 64(%rsi), %xmm0
; AVX2-FCP-NEXT:    vmovdqa 64(%rdi), %xmm10
; AVX2-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm10[0],xmm0[0],xmm10[1],xmm0[1],xmm10[2],xmm0[2],xmm10[3],xmm0[3]
; AVX2-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm11 = xmm9[0],zero,xmm9[1],zero
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm9 = xmm9[2,2,3,3]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm9, %ymm11, %ymm9
; AVX2-FCP-NEXT:    vmovdqa 64(%rcx), %xmm11
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm9 = ymm9[0],ymm13[1],ymm9[2],ymm13[3],ymm9[4],ymm13[5],ymm9[6],ymm13[7]
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm10[4],xmm0[4],xmm10[5],xmm0[5],xmm10[6],xmm0[6],xmm10[7],xmm0[7]
; AVX2-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm10 = xmm0[0],zero,xmm0[1],zero
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[2,2,3,3]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm10, %ymm0
; AVX2-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm12[4],xmm11[4],xmm12[5],xmm11[5],xmm12[6],xmm11[6],xmm12[7],xmm11[7]
; AVX2-FCP-NEXT:    vpermd %ymm10, %ymm2, %ymm10
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm10 = ymm0[0],ymm10[1],ymm0[2],ymm10[3],ymm0[4],ymm10[5],ymm0[6],ymm10[7]
; AVX2-FCP-NEXT:    vmovdqa 80(%rsi), %xmm0
; AVX2-FCP-NEXT:    vmovdqa 80(%rdi), %xmm12
; AVX2-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm11 = xmm12[0],xmm0[0],xmm12[1],xmm0[1],xmm12[2],xmm0[2],xmm12[3],xmm0[3]
; AVX2-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm13 = xmm11[0],zero,xmm11[1],zero
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm11 = xmm11[2,2,3,3]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm11, %ymm13, %ymm11
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm11 = ymm11[0],ymm15[1],ymm11[2],ymm15[3],ymm11[4],ymm15[5],ymm11[6],ymm15[7]
...
; AVX2-FCP-NEXT:    vmovdqa 112(%rdi), %xmm3
...
; AVX2-FCP-NEXT:    vmovdqa %ymm0, 480(%r8)
; AVX2-FCP-NEXT:    vmovdqa %ymm5, 448(%r8)
; AVX2-FCP-NEXT:    vmovdqa %ymm4, 416(%r8)
; AVX2-FCP-NEXT:    vmovdqa %ymm13, 384(%r8)
; AVX2-FCP-NEXT:    vmovdqa %ymm12, 352(%r8)
; AVX2-FCP-NEXT:    vmovdqa %ymm11, 320(%r8)
; AVX2-FCP-NEXT:    vmovdqa %ymm10, 288(%r8)
; AVX2-FCP-NEXT:    vmovdqa %ymm9, 256(%r8)
; AVX2-FCP-NEXT:    vmovdqa %ymm8, 224(%r8)
; AVX2-FCP-NEXT:    vmovdqa %ymm7, 192(%r8)
; AVX2-FCP-NEXT:    vmovdqa %ymm6, 160(%r8)
...
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm7 = xmm6[0],zero,xmm6[1],zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[2,2,3,3]
; AVX512-NEXT:    vinserti128 $1, %xmm6, %ymm7, %ymm6
...
; AVX512-NEXT:    vmovdqa 48(%rcx), %xmm6
; AVX512-NEXT:    vmovdqa (%rdx), %xmm13
; AVX512-NEXT:    vmovdqa 16(%rdx), %xmm14
; AVX512-NEXT:    vmovdqa 32(%rdx), %xmm10
; AVX512-NEXT:    vmovdqa 48(%rdx), %xmm7
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm15 = xmm13[4],xmm1[4],xmm13[5],xmm1[5],xmm13[6],xmm1[6],xmm13[7],xmm1[7]
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm13[0],xmm1[0],xmm13[1],xmm1[1],xmm13[2],xmm1[2],xmm13[3],xmm1[3]
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [0,0,1,1,2,2,3,3,16,16,17,17,18,18,19,19]
; AVX512-NEXT:    vpermt2d %zmm15, %zmm1, %zmm13
; AVX512-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vmovdqa32 %zmm13, %zmm0 {%k1}
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm13 = xmm11[4],xmm2[4],xmm11[5],xmm2[5],xmm11[6],xmm2[6],xmm11[7],xmm2[7]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm15 = xmm13[0],zero,xmm13[1],zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm13 = xmm13[2,2,3,3]
; AVX512-NEXT:    vinserti128 $1, %xmm13, %ymm15, %ymm13
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm11[0],xmm2[0],xmm11[1],xmm2[1],xmm11[2],xmm2[2],xmm11[3],xmm2[3]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm11 = xmm2[0],zero,xmm2[1],zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[2,2,3,3]
; AVX512-NEXT:    vinserti128 $1, %xmm2, %ymm11, %ymm2
; AVX512-NEXT:    vinserti64x4 $1, %ymm13, %zmm2, %zmm2
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm14[4],xmm12[4],xmm14[5],xmm12[5],xmm14[6],xmm12[6],xmm14[7],xmm12[7]
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm14[0],xmm12[0],xmm14[1],xmm12[1],xmm14[2],xmm12[2],xmm14[3],xmm12[3]
; AVX512-NEXT:    vpermt2d %zmm11, %zmm1, %zmm12
; AVX512-NEXT:    vmovdqa32 %zmm12, %zmm2 {%k1}
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm8[4],xmm3[4],xmm8[5],xmm3[5],xmm8[6],xmm3[6],xmm8[7],xmm3[7]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm12 = xmm11[0],zero,xmm11[1],zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm11 = xmm11[2,2,3,3]
; AVX512-NEXT:    vinserti128 $1, %xmm11, %ymm12, %ymm11
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm8[0],xmm3[0],xmm8[1],xmm3[1],xmm8[2],xmm3[2],xmm8[3],xmm3[3]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm8 = xmm3[0],zero,xmm3[1],zero
; AVX512-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[2,2,3,3]
; AVX512-NEXT:    vinserti128 $1, %xmm3, %ymm8, %ymm3
; AVX512-NEXT:    vinserti64x4 $1, %ymm11, %zmm3, %zmm3
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm10[4],xmm9[4],xmm10[5],xmm9[5],xmm10[6],xmm9[6],xmm10[7],xmm9[7]
...
; AVX512-NEXT:    vmovdqa32 %zmm9, %zmm3 {%k1}
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512-NEXT:    vpmovzxdq {{.*#+}} xmm9 = xmm8[0],zero,xmm8[1],zero
...
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm7[4],xmm6[4],xmm7[5],xmm6[5],xmm7[6],xmm6[6],xmm7[7],xmm6[7]
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX512-NEXT:    vpermt2d %zmm5, %zmm1, %zmm6
...
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX512-NEXT:    vpermt2d %zmm8, %zmm1, %zmm6
; AVX512-NEXT:    vmovdqa32 %zmm6, %zmm5 {%k1}
; AVX512-NEXT:    vmovdqa 80(%rsi), %xmm6
...
; AVX512-NEXT:    vmovdqa 80(%rcx), %xmm7
; AVX512-NEXT:    vmovdqa 80(%rdx), %xmm8
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm8[4],xmm7[4],xmm8[5],xmm7[5],xmm8[6],xmm7[6],xmm8[7],xmm7[7]
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm8[0],xmm7[0],xmm8[1],xmm7[1],xmm8[2],xmm7[2],xmm8[3],xmm7[3]
; AVX512-NEXT:    vpermt2d %zmm9, %zmm1, %zmm7
; AVX512-NEXT:    vmovdqa32 %zmm7, %zmm6 {%k1}
; AVX512-NEXT:    vmovdqa 96(%rsi), %xmm7
...
; AVX512-NEXT:    vmovdqa 112(%rcx), %xmm9
; AVX512-NEXT:    vmovdqa 112(%rdx), %xmm10
; AVX512-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm10[4],xmm9[4],xmm10[5],xmm9[5],xmm10[6],xmm9[6],xmm10[7],xmm9[7]
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX512-NEXT:    vpermt2d %zmm11, %zmm1, %zmm9
; AVX512-NEXT:    vmovdqa32 %zmm9, %zmm8 {%k1}
; AVX512-NEXT:    vmovdqa64 %zmm8, 448(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm7, 384(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm6, 320(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm5, 256(%r8)
...
; AVX512-FCP-NEXT:    vmovdqa 48(%rcx), %xmm6
; AVX512-FCP-NEXT:    vmovdqa (%rdx), %xmm13
; AVX512-FCP-NEXT:    vmovdqa 16(%rdx), %xmm14
; AVX512-FCP-NEXT:    vmovdqa 32(%rdx), %xmm10
; AVX512-FCP-NEXT:    vmovdqa 48(%rdx), %xmm7
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm15 = xmm13[4],xmm1[4],xmm13[5],xmm1[5],xmm13[6],xmm1[6],xmm13[7],xmm1[7]
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm13[0],xmm1[0],xmm13[1],xmm1[1],xmm13[2],xmm1[2],xmm13[3],xmm1[3]
; AVX512-FCP-NEXT:    vinserti32x4 $2, %xmm15, %zmm1, %zmm13
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [0,0,1,1,2,2,3,3,8,8,9,9,10,10,11,11]
; AVX512-FCP-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512-FCP-NEXT:    kmovw %eax, %k1
; AVX512-FCP-NEXT:    vpermd %zmm13, %zmm1, %zmm0 {%k1}
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm13 = xmm11[4],xmm2[4],xmm11[5],xmm2[5],xmm11[6],xmm2[6],xmm11[7],xmm2[7]
...
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm11[0],xmm2[0],xmm11[1],xmm2[1],xmm11[2],xmm2[2],xmm11[3],xmm2[3]
; AVX512-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm11 = xmm2[0],zero,xmm2[1],zero
; AVX512-FCP-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[2,2,3,3]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm11, %ymm2
...
; AVX512-FCP-NEXT:    vpermd %zmm11, %zmm1, %zmm2 {%k1}
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm8[4],xmm3[4],xmm8[5],xmm3[5],xmm8[6],xmm3[6],xmm8[7],xmm3[7]
...
; AVX512-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm8 = xmm3[0],zero,xmm3[1],zero
; AVX512-FCP-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[2,2,3,3]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm8, %ymm3
...
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX512-FCP-NEXT:    vinserti32x4 $2, %xmm8, %zmm9, %zmm8
; AVX512-FCP-NEXT:    vpermd %zmm8, %zmm1, %zmm3 {%k1}
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm9 = xmm8[0],zero,xmm8[1],zero
...
; AVX512-FCP-NEXT:    vpermd %zmm5, %zmm1, %zmm4 {%k1}
...
; AVX512-FCP-NEXT:    vpermd %zmm6, %zmm1, %zmm5 {%k1}
; AVX512-FCP-NEXT:    vmovdqa 80(%rsi), %xmm6
; AVX512-FCP-NEXT:    vmovdqa 80(%rdi), %xmm7
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm7[4],xmm6[4],xmm7[5],xmm6[5],xmm7[6],xmm6[6],xmm7[7],xmm6[7]
; AVX512-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm9 = xmm8[0],zero,xmm8[1],zero
; AVX512-FCP-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[2,2,3,3]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm8, %ymm9, %ymm8
...
; AVX512-FCP-NEXT:    vmovdqa 80(%rcx), %xmm7
; AVX512-FCP-NEXT:    vmovdqa 80(%rdx), %xmm8
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm8[4],xmm7[4],xmm8[5],xmm7[5],xmm8[6],xmm7[6],xmm8[7],xmm7[7]
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm8[0],xmm7[0],xmm8[1],xmm7[1],xmm8[2],xmm7[2],xmm8[3],xmm7[3]
; AVX512-FCP-NEXT:    vinserti32x4 $2, %xmm9, %zmm7, %zmm7
; AVX512-FCP-NEXT:    vpermd %zmm7, %zmm1, %zmm6 {%k1}
...
; AVX512-FCP-NEXT:    vmovdqa 96(%rdx), %xmm9
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm9[4],xmm8[4],xmm9[5],xmm8[5],xmm9[6],xmm8[6],xmm9[7],xmm8[7]
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX512-FCP-NEXT:    vinserti32x4 $2, %xmm10, %zmm8, %zmm8
; AVX512-FCP-NEXT:    vpermd %zmm8, %zmm1, %zmm7 {%k1}
; AVX512-FCP-NEXT:    vmovdqa 112(%rsi), %xmm8
...
; AVX512-FCP-NEXT:    vmovdqa 112(%rcx), %xmm9
; AVX512-FCP-NEXT:    vmovdqa 112(%rdx), %xmm10
; AVX512-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm10[4],xmm9[4],xmm10[5],xmm9[5],xmm10[6],xmm9[6],xmm10[7],xmm9[7]
; AVX512-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX512-FCP-NEXT:    vinserti32x4 $2, %xmm11, %zmm9, %zmm9
; AVX512-FCP-NEXT:    vpermd %zmm9, %zmm1, %zmm8 {%k1}
; AVX512-FCP-NEXT:    vmovdqa64 %zmm8, 448(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm7, 384(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm6, 320(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm5, 256(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm4, 192(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm3, 128(%r8)
...
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} xmm7 = xmm6[0],zero,xmm6[1],zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[2,2,3,3]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm6, %ymm7, %ymm6
...
; AVX512DQ-NEXT:    vmovdqa 48(%rcx), %xmm6
; AVX512DQ-NEXT:    vmovdqa (%rdx), %xmm13
; AVX512DQ-NEXT:    vmovdqa 16(%rdx), %xmm14
; AVX512DQ-NEXT:    vmovdqa 32(%rdx), %xmm10
; AVX512DQ-NEXT:    vmovdqa 48(%rdx), %xmm7
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm15 = xmm13[4],xmm1[4],xmm13[5],xmm1[5],xmm13[6],xmm1[6],xmm13[7],xmm1[7]
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm13[0],xmm1[0],xmm13[1],xmm1[1],xmm13[2],xmm1[2],xmm13[3],xmm1[3]
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [0,0,1,1,2,2,3,3,16,16,17,17,18,18,19,19]
; AVX512DQ-NEXT:    vpermt2d %zmm15, %zmm1, %zmm13
; AVX512DQ-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-NEXT:    kmovw %eax, %k1
; AVX512DQ-NEXT:    vmovdqa32 %zmm13, %zmm0 {%k1}
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm13 = xmm11[4],xmm2[4],xmm11[5],xmm2[5],xmm11[6],xmm2[6],xmm11[7],xmm2[7]
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} xmm15 = xmm13[0],zero,xmm13[1],zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm13 = xmm13[2,2,3,3]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm13, %ymm15, %ymm13
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm11[0],xmm2[0],xmm11[1],xmm2[1],xmm11[2],xmm2[2],xmm11[3],xmm2[3]
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} xmm11 = xmm2[0],zero,xmm2[1],zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[2,2,3,3]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm2, %ymm11, %ymm2
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm13, %zmm2, %zmm2
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm14[4],xmm12[4],xmm14[5],xmm12[5],xmm14[6],xmm12[6],xmm14[7],xmm12[7]
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm14[0],xmm12[0],xmm14[1],xmm12[1],xmm14[2],xmm12[2],xmm14[3],xmm12[3]
; AVX512DQ-NEXT:    vpermt2d %zmm11, %zmm1, %zmm12
; AVX512DQ-NEXT:    vmovdqa32 %zmm12, %zmm2 {%k1}
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm8[4],xmm3[4],xmm8[5],xmm3[5],xmm8[6],xmm3[6],xmm8[7],xmm3[7]
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} xmm12 = xmm11[0],zero,xmm11[1],zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm11 = xmm11[2,2,3,3]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm11, %ymm12, %ymm11
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm8[0],xmm3[0],xmm8[1],xmm3[1],xmm8[2],xmm3[2],xmm8[3],xmm3[3]
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} xmm8 = xmm3[0],zero,xmm3[1],zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[2,2,3,3]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm3, %ymm8, %ymm3
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm11, %zmm3, %zmm3
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm10[4],xmm9[4],xmm10[5],xmm9[5],xmm10[6],xmm9[6],xmm10[7],xmm9[7]
...
; AVX512DQ-NEXT:    vmovdqa32 %zmm9, %zmm3 {%k1}
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} xmm9 = xmm8[0],zero,xmm8[1],zero
...
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm7[4],xmm6[4],xmm7[5],xmm6[5],xmm7[6],xmm6[6],xmm7[7],xmm6[7]
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX512DQ-NEXT:    vpermt2d %zmm5, %zmm1, %zmm6
; AVX512DQ-NEXT:    vmovdqa32 %zmm6, %zmm4 {%k1}
...
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX512DQ-NEXT:    vpermt2d %zmm8, %zmm1, %zmm6
; AVX512DQ-NEXT:    vmovdqa32 %zmm6, %zmm5 {%k1}
; AVX512DQ-NEXT:    vmovdqa 80(%rsi), %xmm6
...
; AVX512DQ-NEXT:    vmovdqa 80(%rcx), %xmm7
; AVX512DQ-NEXT:    vmovdqa 80(%rdx), %xmm8
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm8[4],xmm7[4],xmm8[5],xmm7[5],xmm8[6],xmm7[6],xmm8[7],xmm7[7]
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm8[0],xmm7[0],xmm8[1],xmm7[1],xmm8[2],xmm7[2],xmm8[3],xmm7[3]
; AVX512DQ-NEXT:    vpermt2d %zmm9, %zmm1, %zmm7
; AVX512DQ-NEXT:    vmovdqa32 %zmm7, %zmm6 {%k1}
; AVX512DQ-NEXT:    vmovdqa 96(%rsi), %xmm7
; AVX512DQ-NEXT:    vmovdqa 96(%rdi), %xmm8
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm8[4],xmm7[4],xmm8[5],xmm7[5],xmm8[6],xmm7[6],xmm8[7],xmm7[7]
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} xmm10 = xmm9[0],zero,xmm9[1],zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm9 = xmm9[2,2,3,3]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm9, %ymm10, %ymm9
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm8[0],xmm7[0],xmm8[1],xmm7[1],xmm8[2],xmm7[2],xmm8[3],xmm7[3]
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} xmm8 = xmm7[0],zero,xmm7[1],zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm7 = xmm7[2,2,3,3]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm7, %ymm8, %ymm7
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm9, %zmm7, %zmm7
; AVX512DQ-NEXT:    vmovdqa 96(%rcx), %xmm8
; AVX512DQ-NEXT:    vmovdqa 96(%rdx), %xmm9
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm9[4],xmm8[4],xmm9[5],xmm8[5],xmm9[6],xmm8[6],xmm9[7],xmm8[7]
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX512DQ-NEXT:    vpermt2d %zmm10, %zmm1, %zmm8
; AVX512DQ-NEXT:    vmovdqa32 %zmm8, %zmm7 {%k1}
; AVX512DQ-NEXT:    vmovdqa 112(%rsi), %xmm8
...
; AVX512DQ-NEXT:    vmovdqa 112(%rcx), %xmm9
; AVX512DQ-NEXT:    vmovdqa 112(%rdx), %xmm10
; AVX512DQ-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm10[4],xmm9[4],xmm10[5],xmm9[5],xmm10[6],xmm9[6],xmm10[7],xmm9[7]
; AVX512DQ-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX512DQ-NEXT:    vpermt2d %zmm11, %zmm1, %zmm9
; AVX512DQ-NEXT:    vmovdqa32 %zmm9, %zmm8 {%k1}
; AVX512DQ-NEXT:    vmovdqa64 %zmm8, 448(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm7, 384(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm6, 320(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm5, 256(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm4, 192(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm3, 128(%r8)
...
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%rcx), %xmm6
; AVX512DQ-FCP-NEXT:    vmovdqa (%rdx), %xmm13
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rdx), %xmm14
; AVX512DQ-FCP-NEXT:    vmovdqa 32(%rdx), %xmm10
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%rdx), %xmm7
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm15 = xmm13[4],xmm1[4],xmm13[5],xmm1[5],xmm13[6],xmm1[6],xmm13[7],xmm1[7]
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm13[0],xmm1[0],xmm13[1],xmm1[1],xmm13[2],xmm1[2],xmm13[3],xmm1[3]
; AVX512DQ-FCP-NEXT:    vinserti32x4 $2, %xmm15, %zmm1, %zmm13
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [0,0,1,1,2,2,3,3,8,8,9,9,10,10,11,11]
; AVX512DQ-FCP-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k1
; AVX512DQ-FCP-NEXT:    vpermd %zmm13, %zmm1, %zmm0 {%k1}
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm13 = xmm11[4],xmm2[4],xmm11[5],xmm2[5],xmm11[6],xmm2[6],xmm11[7],xmm2[7]
...
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm11[0],xmm2[0],xmm11[1],xmm2[1],xmm11[2],xmm2[2],xmm11[3],xmm2[3]
; AVX512DQ-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm11 = xmm2[0],zero,xmm2[1],zero
...
; AVX512DQ-FCP-NEXT:    vpermd %zmm11, %zmm1, %zmm2 {%k1}
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm8[4],xmm3[4],xmm8[5],xmm3[5],xmm8[6],xmm3[6],xmm8[7],xmm3[7]
...
; AVX512DQ-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm8 = xmm3[0],zero,xmm3[1],zero
; AVX512DQ-FCP-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[2,2,3,3]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm8, %ymm3
...
; AVX512DQ-FCP-NEXT:    vpermd %zmm8, %zmm1, %zmm3 {%k1}
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512DQ-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm9 = xmm8[0],zero,xmm8[1],zero
...
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm7[4],xmm6[4],xmm7[5],xmm6[5],xmm7[6],xmm6[6],xmm7[7],xmm6[7]
...
; AVX512DQ-FCP-NEXT:    vpermd %zmm5, %zmm1, %zmm4 {%k1}
...
; AVX512DQ-FCP-NEXT:    vpermd %zmm6, %zmm1, %zmm5 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa 80(%rsi), %xmm6
; AVX512DQ-FCP-NEXT:    vmovdqa 80(%rdi), %xmm7
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm7[4],xmm6[4],xmm7[5],xmm6[5],xmm7[6],xmm6[6],xmm7[7],xmm6[7]
; AVX512DQ-FCP-NEXT:    vpmovzxdq {{.*#+}} xmm9 = xmm8[0],zero,xmm8[1],zero
; AVX512DQ-FCP-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[2,2,3,3]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm8, %ymm9, %ymm8
...
; AVX512DQ-FCP-NEXT:    vmovdqa 80(%rcx), %xmm7
; AVX512DQ-FCP-NEXT:    vmovdqa 80(%rdx), %xmm8
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm8[4],xmm7[4],xmm8[5],xmm7[5],xmm8[6],xmm7[6],xmm8[7],xmm7[7]
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm8[0],xmm7[0],xmm8[1],xmm7[1],xmm8[2],xmm7[2],xmm8[3],xmm7[3]
; AVX512DQ-FCP-NEXT:    vinserti32x4 $2, %xmm9, %zmm7, %zmm7
; AVX512DQ-FCP-NEXT:    vpermd %zmm7, %zmm1, %zmm6 {%k1}
...
; AVX512DQ-FCP-NEXT:    vmovdqa 96(%rdx), %xmm9
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm9[4],xmm8[4],xmm9[5],xmm8[5],xmm9[6],xmm8[6],xmm9[7],xmm8[7]
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX512DQ-FCP-NEXT:    vinserti32x4 $2, %xmm10, %zmm8, %zmm8
; AVX512DQ-FCP-NEXT:    vpermd %zmm8, %zmm1, %zmm7 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa 112(%rsi), %xmm8
...
; AVX512DQ-FCP-NEXT:    vmovdqa 112(%rcx), %xmm9
; AVX512DQ-FCP-NEXT:    vmovdqa 112(%rdx), %xmm10
; AVX512DQ-FCP-NEXT:    vpunpckhwd {{.*#+}} xmm11 = xmm10[4],xmm9[4],xmm10[5],xmm9[5],xmm10[6],xmm9[6],xmm10[7],xmm9[7]
; AVX512DQ-FCP-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX512DQ-FCP-NEXT:    vinserti32x4 $2, %xmm11, %zmm9, %zmm9
; AVX512DQ-FCP-NEXT:    vpermd %zmm9, %zmm1, %zmm8 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm8, 448(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm7, 384(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm6, 320(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm5, 256(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm4, 192(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm3, 128(%r8)
...
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm8 = [0,0,0,32,0,0,1,33,0,0,2,34,0,0,3,35,0,0,4,36,0,0,5,37,0,0,6,38,0,0,7,39]
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm9
; AVX512BW-NEXT:    vpermt2w %zmm6, %zmm8, %zmm9
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm10 = [0,32,0,0,1,33,0,0,2,34,0,0,3,35,0,0,4,36,0,0,5,37,0,0,6,38,0,0,7,39,0,0]
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm11
; AVX512BW-NEXT:    vpermt2w %zmm2, %zmm10, %zmm11
; AVX512BW-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512BW-NEXT:    kmovd %eax, %k1
; AVX512BW-NEXT:    vmovdqa32 %zmm9, %zmm11 {%k1}
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm9 = [0,0,8,40,0,0,9,41,0,0,10,42,0,0,11,43,0,0,12,44,0,0,13,45,0,0,14,46,0,0,15,47]
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm12
; AVX512BW-NEXT:    vpermt2w %zmm6, %zmm9, %zmm12
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm13 = [8,40,0,0,9,41,0,0,10,42,0,0,11,43,0,0,12,44,0,0,13,45,0,0,14,46,0,0,15,47,0,0]
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm14
; AVX512BW-NEXT:    vpermt2w %zmm2, %zmm13, %zmm14
; AVX512BW-NEXT:    vmovdqa32 %zmm12, %zmm14 {%k1}
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm12 = [0,0,16,48,0,0,17,49,0,0,18,50,0,0,19,51,0,0,20,52,0,0,21,53,0,0,22,54,0,0,23,55]
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm15
; AVX512BW-NEXT:    vpermt2w %zmm6, %zmm12, %zmm15
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm16 = [16,48,0,0,17,49,0,0,18,50,0,0,19,51,0,0,20,52,0,0,21,53,0,0,22,54,0,0,23,55,0,0]
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm17
; AVX512BW-NEXT:    vpermt2w %zmm2, %zmm16, %zmm17
; AVX512BW-NEXT:    vmovdqa32 %zmm15, %zmm17 {%k1}
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm15 = [0,0,24,56,0,0,25,57,0,0,26,58,0,0,27,59,0,0,28,60,0,0,29,61,0,0,30,62,0,0,31,63]
; AVX512BW-NEXT:    vpermt2w %zmm6, %zmm15, %zmm4
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm6 = [24,56,0,0,25,57,0,0,26,58,0,0,27,59,0,0,28,60,0,0,29,61,0,0,30,62,0,0,31,63,0,0]
...
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm8 = [0,0,0,32,0,0,1,33,0,0,2,34,0,0,3,35,0,0,4,36,0,0,5,37,0,0,6,38,0,0,7,39]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm9
; AVX512BW-FCP-NEXT:    vpermt2w %zmm6, %zmm8, %zmm9
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm10 = [0,32,0,0,1,33,0,0,2,34,0,0,3,35,0,0,4,36,0,0,5,37,0,0,6,38,0,0,7,39,0,0]
...
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm9 = [0,0,8,40,0,0,9,41,0,0,10,42,0,0,11,43,0,0,12,44,0,0,13,45,0,0,14,46,0,0,15,47]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm12
; AVX512BW-FCP-NEXT:    vpermt2w %zmm6, %zmm9, %zmm12
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm13 = [8,40,0,0,9,41,0,0,10,42,0,0,11,43,0,0,12,44,0,0,13,45,0,0,14,46,0,0,15,47,0,0]
...
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm12 = [0,0,16,48,0,0,17,49,0,0,18,50,0,0,19,51,0,0,20,52,0,0,21,53,0,0,22,54,0,0,23,55]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm15
; AVX512BW-FCP-NEXT:    vpermt2w %zmm6, %zmm12, %zmm15
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm16 = [16,48,0,0,17,49,0,0,18,50,0,0,19,51,0,0,20,52,0,0,21,53,0,0,22,54,0,0,23,55,0,0]
...
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm15 = [0,0,24,56,0,0,25,57,0,0,26,58,0,0,27,59,0,0,28,60,0,0,29,61,0,0,30,62,0,0,31,63]
; AVX512BW-FCP-NEXT:    vpermt2w %zmm6, %zmm15, %zmm4
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm6 = [24,56,0,0,25,57,0,0,26,58,0,0,27,59,0,0,28,60,0,0,29,61,0,0,30,62,0,0,31,63,0,0]
...
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm1, 448(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm16, 384(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm13, 320(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm10, 256(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, 192(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm17, 128(%r8)
...
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} zmm8 = [0,0,0,32,0,0,1,33,0,0,2,34,0,0,3,35,0,0,4,36,0,0,5,37,0,0,6,38,0,0,7,39]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm4, %zmm9
; AVX512DQ-BW-NEXT:    vpermt2w %zmm6, %zmm8, %zmm9
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} zmm10 = [0,32,0,0,1,33,0,0,2,34,0,0,3,35,0,0,4,36,0,0,5,37,0,0,6,38,0,0,7,39,0,0]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, %zmm11
; AVX512DQ-BW-NEXT:    vpermt2w %zmm2, %zmm10, %zmm11
; AVX512DQ-BW-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-BW-NEXT:    kmovd %eax, %k1
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm9, %zmm11 {%k1}
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} zmm9 = [0,0,8,40,0,0,9,41,0,0,10,42,0,0,11,43,0,0,12,44,0,0,13,45,0,0,14,46,0,0,15,47]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm4, %zmm12
; AVX512DQ-BW-NEXT:    vpermt2w %zmm6, %zmm9, %zmm12
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} zmm13 = [8,40,0,0,9,41,0,0,10,42,0,0,11,43,0,0,12,44,0,0,13,45,0,0,14,46,0,0,15,47,0,0]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, %zmm14
; AVX512DQ-BW-NEXT:    vpermt2w %zmm2, %zmm13, %zmm14
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm12, %zmm14 {%k1}
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} zmm12 = [0,0,16,48,0,0,17,49,0,0,18,50,0,0,19,51,0,0,20,52,0,0,21,53,0,0,22,54,0,0,23,55]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm4, %zmm15
; AVX512DQ-BW-NEXT:    vpermt2w %zmm6, %zmm12, %zmm15
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} zmm16 = [16,48,0,0,17,49,0,0,18,50,0,0,19,51,0,0,20,52,0,0,21,53,0,0,22,54,0,0,23,55,0,0]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, %zmm17
; AVX512DQ-BW-NEXT:    vpermt2w %zmm2, %zmm16, %zmm17
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm15, %zmm17 {%k1}
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} zmm15 = [0,0,24,56,0,0,25,57,0,0,26,58,0,0,27,59,0,0,28,60,0,0,29,61,0,0,30,62,0,0,31,63]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm6, %zmm15, %zmm4
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} zmm6 = [24,56,0,0,25,57,0,0,26,58,0,0,27,59,0,0,28,60,0,0,29,61,0,0,30,62,0,0,31,63,0,0]
...
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm1, 448(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm16, 384(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm13, 320(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm10, 256(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, 192(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm17, 128(%r8)
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm8 = [0,0,0,32,0,0,1,33,0,0,2,34,0,0,3,35,0,0,4,36,0,0,5,37,0,0,6,38,0,0,7,39]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm6, %zmm8, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm10 = [0,32,0,0,1,33,0,0,2,34,0,0,3,35,0,0,4,36,0,0,5,37,0,0,6,38,0,0,7,39,0,0]
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm9 = [0,0,8,40,0,0,9,41,0,0,10,42,0,0,11,43,0,0,12,44,0,0,13,45,0,0,14,46,0,0,15,47]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm6, %zmm9, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm13 = [8,40,0,0,9,41,0,0,10,42,0,0,11,43,0,0,12,44,0,0,13,45,0,0,14,46,0,0,15,47,0,0]
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm12 = [0,0,16,48,0,0,17,49,0,0,18,50,0,0,19,51,0,0,20,52,0,0,21,53,0,0,22,54,0,0,23,55]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm15
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm6, %zmm12, %zmm15
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm16 = [16,48,0,0,17,49,0,0,18,50,0,0,19,51,0,0,20,52,0,0,21,53,0,0,22,54,0,0,23,55,0,0]
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm15 = [0,0,24,56,0,0,25,57,0,0,26,58,0,0,27,59,0,0,28,60,0,0,29,61,0,0,30,62,0,0,31,63]
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm6, %zmm15, %zmm4
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm6 = [24,56,0,0,25,57,0,0,26,58,0,0,27,59,0,0,28,60,0,0,29,61,0,0,30,62,0,0,31,63,0,0]
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm1, 448(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm16, 384(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm13, 320(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm10, 256(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, 192(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm17, 128(%r8)
