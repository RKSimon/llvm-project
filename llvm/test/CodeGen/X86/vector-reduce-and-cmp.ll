...
; X86-SSE2-NEXT:    andl %eax, %ecx
; X86-SSE2-NEXT:    cmpl $-1, %ecx
...
; X86-SSE4-NEXT:    andl %eax, %ecx
; X86-SSE4-NEXT:    cmpl $-1, %ecx
...
; X86-AVX1-NEXT:    andl %eax, %ecx
; X86-AVX1-NEXT:    cmpl $-1, %ecx
...
; X86-AVX2-NEXT:    andl %eax, %ecx
; X86-AVX2-NEXT:    cmpl $-1, %ecx
