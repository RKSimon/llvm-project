...
; AVX1-NEXT:    vmovsd {{.*#+}} xmm2 = xmm2[0],xmm4[1]
...
; AVX512-NEXT:    vpermi2ps 0, %ymm3, %ymm0
; AVX512-NEXT:    vmovaps %ymm0, %ymm2 {%k1}
; AVX512-NEXT:    vmovups %ymm2, (%rax)
; AVX512-NEXT:    vzeroupper
; AVX512-NEXT:    retq
entry:
