...
; AVX512DQ-NEXT:    vpand %ymm1, %ymm2, %ymm3
; AVX512DQ-NEXT:    vpmaddubsw %ymm3, %ymm0, %ymm3
; AVX512DQ-NEXT:    vpandn %ymm2, %ymm1, %ymm1
...
; AVX512DQVL-NEXT:    vpand %ymm2, %ymm1, %ymm3
...
; AVX512BWVL-NEXT:    vpandq %zmm2, %zmm1, %zmm3
...
; AVX512BWVL-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm0 | (zmm3 & zmm2)
; AVX512BWVL-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX512BWVL-NEXT:    vpandq %zmm2, %zmm1, %zmm3
; AVX512BWVL-NEXT:    vpmaddubsw %zmm3, %zmm0, %zmm3
; AVX512BWVL-NEXT:    vpandnq %zmm1, %zmm2, %zmm1
...
; SSE41-NEXT:    pmaddubsw %xmm5, %xmm10
...
; AVX1-NEXT:    vpand %xmm4, %xmm2, %xmm6
...
; AVX1-NEXT:    vpsllw $8, %xmm1, %xmm1
; AVX1-NEXT:    vpand %xmm4, %xmm6, %xmm2
...
; AVX512DQVL-NEXT:    vpternlogq {{.*#+}} ymm4 = ymm4 | (ymm3 & ymm2)
...
; AVX512DQVL-NEXT:    vpternlogq {{.*#+}} ymm1 = ymm1 | (ymm0 & ymm2)
; AVX512DQVL-NEXT:    vextracti128 $1, %ymm1, %xmm0
; AVX512DQVL-NEXT:    vpand %ymm2, %ymm0, %ymm3
