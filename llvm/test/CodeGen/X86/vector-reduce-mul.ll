...
; AVX1-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
; AVX1-NEXT:    vpandn %xmm1, %xmm3, %xmm4
; AVX1-NEXT:    vpmaddubsw %xmm4, %xmm0, %xmm0
; AVX1-NEXT:    vpsllw $8, %xmm0, %xmm0
; AVX1-NEXT:    vpmullw %xmm1, %xmm2, %xmm1
; AVX1-NEXT:    vpand %xmm3, %xmm1, %xmm2
; AVX1-NEXT:    vpor %xmm0, %xmm2, %xmm0
; AVX1-NEXT:    vpshufd {{.*#+}} xmm2 = xmm0[1,1,1,1]
; AVX1-NEXT:    vpandn %xmm2, %xmm3, %xmm4
; AVX1-NEXT:    vpmaddubsw %xmm4, %xmm0, %xmm0
; AVX1-NEXT:    vpsllw $8, %xmm0, %xmm0
...
; AVX1-NEXT:    vpandn %xmm2, %xmm3, %xmm3
...
; AVX2-NEXT:    vpmaddubsw %ymm3, %ymm0, %ymm0
...
; AVX512DQVL:       # %bb.0:
; AVX512DQVL-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX512DQVL-NEXT:    vpmullw %ymm1, %ymm0, %ymm2
; AVX512DQVL-NEXT:    vpbroadcastd {{.*#+}} ymm3 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; AVX512DQVL-NEXT:    vpandn %ymm1, %ymm3, %ymm1
; AVX512DQVL-NEXT:    vpmaddubsw %ymm1, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm0 | (ymm2 & ymm3)
; AVX512DQVL-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
; AVX512DQVL-NEXT:    vpandn %ymm1, %ymm3, %ymm4
; AVX512DQVL-NEXT:    vpmaddubsw %ymm4, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpmullw %ymm1, %ymm2, %ymm1
; AVX512DQVL-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm0 | (ymm1 & ymm3)
; AVX512DQVL-NEXT:    vpshufd {{.*#+}} xmm2 = xmm0[1,1,1,1]
; AVX512DQVL-NEXT:    vpandn %ymm2, %ymm3, %ymm4
; AVX512DQVL-NEXT:    vpmaddubsw %ymm4, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpsllw $8, %ymm0, %ymm0
...
; AVX512DQVL-NEXT:    vpsrlw $8, %xmm0, %xmm0
...
; AVX1-NEXT:    vbroadcastss {{.*#+}} xmm3 = [255,255,255,255,255,255,255,255]
; AVX1-NEXT:    vpand %xmm3, %xmm2, %xmm4
; AVX1-NEXT:    vpandn %xmm1, %xmm3, %xmm5
...
; AVX1-NEXT:    vpmaddubsw %xmm5, %xmm0, %xmm5
; AVX1-NEXT:    vpsllw $8, %xmm5, %xmm5
; AVX1-NEXT:    vpmaddubsw %xmm5, %xmm4, %xmm4
; AVX1-NEXT:    vpmullw %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vpmullw %xmm0, %xmm2, %xmm0
; AVX1-NEXT:    vpand %xmm3, %xmm0, %xmm1
; AVX1-NEXT:    vpsllw $8, %xmm4, %xmm2
...
; AVX512BW-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX512BW-NEXT:    vpandnq %zmm1, %zmm3, %zmm4
; AVX512BW-NEXT:    vpmaddubsw %zmm4, %zmm0, %zmm0
; AVX512BW-NEXT:    vpsllw $8, %zmm0, %zmm0
; AVX512BW-NEXT:    vpmullw %zmm1, %zmm2, %zmm1
; AVX512BW-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm0 | (zmm1 & zmm3)
; AVX512BW-NEXT:    vpshufd {{.*#+}} xmm2 = xmm0[2,3,2,3]
; AVX512BW-NEXT:    vpandnq %zmm2, %zmm3, %zmm4
; AVX512BW-NEXT:    vpmaddubsw %zmm4, %zmm0, %zmm0
; AVX512BW-NEXT:    vpsllw $8, %zmm0, %zmm0
...
; AVX512BW-NEXT:    vpmaddubsw %zmm3, %zmm0, %zmm0
...
; AVX512BWVL-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX512BWVL-NEXT:    vpandnq %zmm1, %zmm3, %zmm4
; AVX512BWVL-NEXT:    vpmaddubsw %zmm4, %zmm0, %zmm0
; AVX512BWVL-NEXT:    vpsllw $8, %zmm0, %zmm0
; AVX512BWVL-NEXT:    vpmullw %zmm1, %zmm2, %zmm1
; AVX512BWVL-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm0 | (zmm1 & zmm3)
; AVX512BWVL-NEXT:    vpshufd {{.*#+}} xmm2 = xmm0[2,3,2,3]
; AVX512BWVL-NEXT:    vpandnq %zmm2, %zmm3, %zmm4
; AVX512BWVL-NEXT:    vpmaddubsw %zmm4, %zmm0, %zmm0
; AVX512BWVL-NEXT:    vpsllw $8, %zmm0, %zmm0
; AVX512BWVL-NEXT:    vpmullw %zmm2, %zmm1, %zmm1
; AVX512BWVL-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm0 | (zmm1 & zmm3)
; AVX512BWVL-NEXT:    vpshufd {{.*#+}} xmm2 = xmm0[1,1,1,1]
; AVX512BWVL-NEXT:    vpandnq %zmm2, %zmm3, %zmm4
; AVX512BWVL-NEXT:    vpmaddubsw %zmm4, %zmm0, %zmm0
; AVX512BWVL-NEXT:    vpsllw $8, %zmm0, %zmm0
; AVX512BWVL-NEXT:    vpmullw %zmm2, %zmm1, %zmm1
...
; AVX512BWVL-NEXT:    vpshufb {{.*#+}} xmm3 = zero,xmm0[3],zero,zero,zero,xmm0[7],zero,zero,zero,xmm0[11],zero,zero,zero,xmm0[15],zero,zero
; AVX512BWVL-NEXT:    vpmaddubsw %zmm3, %zmm0, %zmm0
...
; SSE41-NEXT:    movdqa %xmm8, %xmm11
; SSE41-NEXT:    pandn %xmm4, %xmm11
; SSE41-NEXT:    pmaddubsw %xmm11, %xmm0
; SSE41-NEXT:    psllw $8, %xmm0
; SSE41-NEXT:    por %xmm5, %xmm0
; SSE41-NEXT:    movdqa %xmm8, %xmm4
; SSE41-NEXT:    pandn %xmm7, %xmm4
; SSE41-NEXT:    pmaddubsw %xmm4, %xmm3
; SSE41-NEXT:    psllw $8, %xmm3
; SSE41-NEXT:    pmaddubsw %xmm3, %xmm1
; SSE41-NEXT:    movdqa %xmm8, %xmm3
; SSE41-NEXT:    pandn %xmm6, %xmm3
; SSE41-NEXT:    pmaddubsw %xmm3, %xmm10
; SSE41-NEXT:    psllw $8, %xmm10
...
; SSE41-NEXT:    pmullw %xmm2, %xmm9
; SSE41-NEXT:    movdqa %xmm9, %xmm1
; SSE41-NEXT:    punpckhwd {{.*#+}} xmm1 = xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; SSE41-NEXT:    punpcklwd {{.*#+}} xmm9 = xmm9[0],xmm0[0],xmm9[1],xmm0[1],xmm9[2],xmm0[2],xmm9[3],xmm0[3]
; SSE41-NEXT:    pmullw %xmm1, %xmm9
...
; AVX1-NEXT:    vpmullw %xmm6, %xmm7, %xmm5
; AVX1-NEXT:    vbroadcastss {{.*#+}} xmm4 = [255,255,255,255,255,255,255,255]
; AVX1-NEXT:    vpand %xmm4, %xmm5, %xmm8
; AVX1-NEXT:    vpandn %xmm6, %xmm4, %xmm6
; AVX1-NEXT:    vpmaddubsw %xmm6, %xmm7, %xmm6
; AVX1-NEXT:    vpsllw $8, %xmm6, %xmm6
; AVX1-NEXT:    vpor %xmm6, %xmm8, %xmm6
; AVX1-NEXT:    vpmullw %xmm2, %xmm0, %xmm7
; AVX1-NEXT:    vpand %xmm4, %xmm7, %xmm8
...
; AVX1-NEXT:    vpandn %xmm2, %xmm4, %xmm2
; AVX1-NEXT:    vpmaddubsw %xmm2, %xmm8, %xmm2
; AVX1-NEXT:    vpsllw $8, %xmm2, %xmm2
; AVX1-NEXT:    vpmaddubsw %xmm2, %xmm6, %xmm2
; AVX1-NEXT:    vpandn %xmm3, %xmm4, %xmm6
; AVX1-NEXT:    vpmaddubsw %xmm6, %xmm1, %xmm6
; AVX1-NEXT:    vpsllw $8, %xmm6, %xmm6
; AVX1-NEXT:    vpmaddubsw %xmm6, %xmm0, %xmm0
; AVX1-NEXT:    vpmullw %xmm3, %xmm1, %xmm1
...
; AVX512DQ-NEXT:    vpand %ymm2, %ymm3, %ymm4
; AVX512DQ-NEXT:    vpandn %ymm1, %ymm2, %ymm5
; AVX512DQ-NEXT:    vpmaddubsw %ymm5, %ymm0, %ymm5
; AVX512DQ-NEXT:    vpsllw $8, %ymm5, %ymm5
...
; AVX512DQ-NEXT:    vpmaddubsw %ymm5, %ymm0, %ymm5
; AVX512DQ-NEXT:    vpsllw $8, %ymm5, %ymm5
; AVX512DQ-NEXT:    vpmaddubsw %ymm5, %ymm4, %ymm4
; AVX512DQ-NEXT:    vpmullw %ymm1, %ymm0, %ymm0
; AVX512DQ-NEXT:    vpmullw %ymm0, %ymm3, %ymm0
; AVX512DQ-NEXT:    vpand %ymm2, %ymm0, %ymm1
; AVX512DQ-NEXT:    vpsllw $8, %ymm4, %ymm3
; AVX512DQ-NEXT:    vpor %ymm3, %ymm1, %ymm1
; AVX512DQ-NEXT:    vextracti128 $1, %ymm1, %xmm3
; AVX512DQ-NEXT:    vpandn %ymm3, %ymm2, %ymm4
; AVX512DQ-NEXT:    vpmaddubsw %ymm4, %ymm1, %ymm1
...
; AVX512DQ-NEXT:    vpand %ymm2, %ymm0, %ymm3
; AVX512DQ-NEXT:    vpor %ymm1, %ymm3, %ymm1
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm3 = xmm1[1,1,1,1]
; AVX512DQ-NEXT:    vpandn %ymm3, %ymm2, %ymm4
; AVX512DQ-NEXT:    vpmaddubsw %ymm4, %ymm1, %ymm1
; AVX512DQ-NEXT:    vpsllw $8, %ymm1, %ymm1
; AVX512DQ-NEXT:    vpmullw %ymm3, %ymm0, %ymm0
...
; AVX512DQ-NEXT:    vpshufb {{.*#+}} xmm3 = zero,xmm1[3],zero,zero,zero,xmm1[7],zero,zero,zero,xmm1[11],zero,zero,zero,xmm1[15],zero,zero
; AVX512DQ-NEXT:    vpmaddubsw %ymm3, %ymm1, %ymm1
; AVX512DQ-NEXT:    vpsllw $8, %xmm1, %xmm1
...
; AVX512DQVL-NEXT:    vpbroadcastd {{.*#+}} ymm3 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; AVX512DQVL-NEXT:    vpandn %ymm1, %ymm3, %ymm4
; AVX512DQVL-NEXT:    vpmaddubsw %ymm4, %ymm0, %ymm4
; AVX512DQVL-NEXT:    vpsllw $8, %ymm4, %ymm4
; AVX512DQVL-NEXT:    vpternlogq {{.*#+}} ymm4 = ymm4 | (ymm2 & ymm3)
; AVX512DQVL-NEXT:    vextracti64x4 $1, %zmm1, %ymm1
; AVX512DQVL-NEXT:    vpandn %ymm1, %ymm3, %ymm5
; AVX512DQVL-NEXT:    vextracti64x4 $1, %zmm0, %ymm0
; AVX512DQVL-NEXT:    vpmaddubsw %ymm5, %ymm0, %ymm5
; AVX512DQVL-NEXT:    vpsllw $8, %ymm5, %ymm5
; AVX512DQVL-NEXT:    vpmaddubsw %ymm5, %ymm4, %ymm4
; AVX512DQVL-NEXT:    vpmullw %ymm1, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpmullw %ymm0, %ymm2, %ymm0
; AVX512DQVL-NEXT:    vpsllw $8, %ymm4, %ymm1
; AVX512DQVL-NEXT:    vpternlogq {{.*#+}} ymm1 = ymm1 | (ymm0 & ymm3)
; AVX512DQVL-NEXT:    vextracti128 $1, %ymm1, %xmm2
; AVX512DQVL-NEXT:    vpandn %ymm2, %ymm3, %ymm4
; AVX512DQVL-NEXT:    vpmaddubsw %ymm4, %ymm1, %ymm1
; AVX512DQVL-NEXT:    vpsllw $8, %ymm1, %ymm1
; AVX512DQVL-NEXT:    vpmullw %ymm2, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpternlogq {{.*#+}} ymm1 = ymm1 | (ymm0 & ymm3)
; AVX512DQVL-NEXT:    vpshufd {{.*#+}} xmm2 = xmm1[2,3,2,3]
; AVX512DQVL-NEXT:    vpandn %ymm2, %ymm3, %ymm4
; AVX512DQVL-NEXT:    vpmaddubsw %ymm4, %ymm1, %ymm1
; AVX512DQVL-NEXT:    vpsllw $8, %ymm1, %ymm1
; AVX512DQVL-NEXT:    vpmullw %ymm2, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpternlogq {{.*#+}} ymm1 = ymm1 | (ymm0 & ymm3)
; AVX512DQVL-NEXT:    vpshufd {{.*#+}} xmm2 = xmm1[1,1,1,1]
; AVX512DQVL-NEXT:    vpandn %ymm2, %ymm3, %ymm4
; AVX512DQVL-NEXT:    vpmaddubsw %ymm4, %ymm1, %ymm1
; AVX512DQVL-NEXT:    vpsllw $8, %ymm1, %ymm1
; AVX512DQVL-NEXT:    vpmullw %ymm2, %ymm0, %ymm0
...
; AVX512DQVL-NEXT:    vpshufb {{.*#+}} xmm3 = zero,xmm1[3],zero,zero,zero,xmm1[7],zero,zero,zero,xmm1[11],zero,zero,zero,xmm1[15],zero,zero
; AVX512DQVL-NEXT:    vpmaddubsw %ymm3, %ymm1, %ymm1
; AVX512DQVL-NEXT:    vpsllw $8, %xmm1, %xmm1
