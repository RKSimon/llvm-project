...
; SSE41-NEXT:    pandn %xmm3, %xmm6
; SSE41-NEXT:    pmaddubsw %xmm6, %xmm1
...
; SSE41-NEXT:    punpckhwd {{.*#+}} xmm1 = xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; SSE41-NEXT:    punpcklwd {{.*#+}} xmm4 = xmm4[0],xmm0[0],xmm4[1],xmm0[1],xmm4[2],xmm0[2],xmm4[3],xmm0[3]
...
; SSE41-NEXT:    pandn %xmm6, %xmm10
; SSE41-NEXT:    pmaddubsw %xmm10, %xmm2
; SSE41-NEXT:    psllw $8, %xmm2
; SSE41-NEXT:    por %xmm2, %xmm8
...
; SSE41-NEXT:    pandn %xmm7, %xmm6
; SSE41-NEXT:    pmaddubsw %xmm6, %xmm3
...
; AVX1-NEXT:    vpor %xmm1, %xmm8, %xmm3
; AVX1-NEXT:    vextractf128 $1, %ymm2, %xmm2
; AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm0
; AVX1-NEXT:    vpmullw %xmm2, %xmm0, %xmm8
; AVX1-NEXT:    vpand %xmm4, %xmm8, %xmm8
; AVX1-NEXT:    vpandn %xmm2, %xmm4, %xmm2
; AVX1-NEXT:    vpmaddubsw %xmm2, %xmm0, %xmm0
; AVX1-NEXT:    vpsllw $8, %xmm0, %xmm0
; AVX1-NEXT:    vpor %xmm0, %xmm8, %xmm0
; AVX1-NEXT:    vpmullw %xmm3, %xmm0, %xmm2
; AVX1-NEXT:    vpand %xmm4, %xmm2, %xmm2
; AVX1-NEXT:    vpmaddubsw %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vpsllw $8, %xmm0, %xmm0
; AVX1-NEXT:    vpor %xmm0, %xmm2, %xmm1
; AVX1-NEXT:    vpmullw %xmm6, %xmm7, %xmm2
; AVX1-NEXT:    vpand %xmm4, %xmm2, %xmm2
; AVX1-NEXT:    vpmaddubsw %xmm5, %xmm7, %xmm3
; AVX1-NEXT:    vpsllw $8, %xmm3, %xmm3
; AVX1-NEXT:    vpor %xmm3, %xmm2, %xmm2
; AVX1-NEXT:    vpmullw %xmm1, %xmm2, %xmm1
; AVX1-NEXT:    vpand %xmm4, %xmm1, %xmm1
; AVX1-NEXT:    vpmaddubsw %xmm0, %xmm2, %xmm0
; AVX1-NEXT:    vpsllw $8, %xmm0, %xmm0
; AVX1-NEXT:    vpor %xmm0, %xmm1, %xmm0
; AVX1-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
; AVX1-NEXT:    vpmullw %xmm1, %xmm0, %xmm2
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vpmullw %ymm3, %ymm1, %ymm5
...
; AVX2-NEXT:    vpor %ymm1, %ymm5, %ymm3
; AVX2-NEXT:    vpmullw %ymm2, %ymm0, %ymm5
; AVX2-NEXT:    vpand %ymm4, %ymm5, %ymm5
; AVX2-NEXT:    vpandn %ymm2, %ymm4, %ymm2
; AVX2-NEXT:    vpmaddubsw %ymm2, %ymm0, %ymm0
; AVX2-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX2-NEXT:    vpor %ymm0, %ymm5, %ymm0
; AVX2-NEXT:    vpmullw %ymm3, %ymm0, %ymm2
...
; AVX2-NEXT:    vpor %ymm0, %ymm2, %ymm0
; AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[1,1,1,1]
; AVX2-NEXT:    vpshufb {{.*#+}} xmm2 = zero,xmm0[5],zero,xmm0[7],zero,xmm0[5],zero,xmm0[7],zero,xmm0[5],zero,xmm0[7],zero,xmm0[5],zero,xmm0[7]
; AVX2-NEXT:    vpmaddubsw %xmm2, %xmm0, %xmm2
; AVX2-NEXT:    vpsllw $8, %xmm2, %xmm2
; AVX2-NEXT:    vpmullw %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vpand %ymm4, %ymm0, %ymm0
; AVX2-NEXT:    vpor %ymm2, %ymm0, %ymm0
; AVX2-NEXT:    vpsrld $16, %xmm0, %xmm1
; AVX2-NEXT:    vpshufb {{.*#+}} xmm2 = zero,xmm0[3],zero,zero,zero,xmm0[7],zero,zero,zero,xmm0[11],zero,zero,zero,xmm0[15],zero,zero
; AVX2-NEXT:    vpmaddubsw %xmm2, %xmm0, %xmm2
; AVX2-NEXT:    vpsllw $8, %xmm2, %xmm2
; AVX2-NEXT:    vpsrlw $8, %xmm2, %xmm3
; AVX2-NEXT:    vpmullw %xmm1, %xmm0, %xmm0
