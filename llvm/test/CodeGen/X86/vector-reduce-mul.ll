...
; SSE41-NEXT:    punpcklwd {{.*#+}} xmm0 = xmm0[0],xmm4[0],xmm0[1],xmm4[1],xmm0[2],xmm4[2],xmm0[3],xmm4[3]
; SSE41-NEXT:    pmullw %xmm1, %xmm0
; SSE41-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
; SSE41-NEXT:    pmullw %xmm0, %xmm1
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm1[1,1,1,1]
...
; AVX1-NEXT:    vpandn %xmm2, %xmm1, %xmm2
...
; AVX2-NEXT:    vpmaddubsw %ymm2, %ymm0, %ymm0
; AVX2-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX2-NEXT:    vpor %ymm0, %ymm3, %ymm2
; AVX2-NEXT:    vpsrlw $8, %xmm0, %xmm0
; AVX2-NEXT:    vpand %ymm0, %ymm1, %ymm0
; AVX2-NEXT:    vpmaddubsw %ymm0, %ymm2, %ymm0
; AVX2-NEXT:    vmovd %xmm0, %eax
...
; AVX512DQ-NEXT:    vpmaddubsw %ymm3, %ymm0, %ymm3
...
; AVX512DQ-NEXT:    vpmaddubsw %ymm2, %ymm0, %ymm0
; AVX512DQ-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX512DQ-NEXT:    vpor %ymm0, %ymm3, %ymm2
; AVX512DQ-NEXT:    vpsrlw $8, %xmm0, %xmm0
; AVX512DQ-NEXT:    vpand %ymm0, %ymm1, %ymm0
; AVX512DQ-NEXT:    vpmaddubsw %ymm0, %ymm2, %ymm0
; AVX512DQ-NEXT:    vmovd %xmm0, %eax
...
; AVX512DQVL-NEXT:    vpand %ymm1, %ymm2, %ymm3
; AVX512DQVL-NEXT:    vpmaddubsw %ymm3, %ymm0, %ymm3
; AVX512DQVL-NEXT:    vpandn %ymm1, %ymm2, %ymm1
; AVX512DQVL-NEXT:    vpmaddubsw %ymm1, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpternlogq $248, %ymm2, %ymm3, %ymm0
; AVX512DQVL-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
; AVX512DQVL-NEXT:    vpand %ymm1, %ymm2, %ymm3
; AVX512DQVL-NEXT:    vpmaddubsw %ymm3, %ymm0, %ymm3
; AVX512DQVL-NEXT:    vpandn %ymm1, %ymm2, %ymm1
...
; AVX512DQVL-NEXT:    vpmaddubsw %ymm1, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpor %ymm0, %ymm3, %ymm1
; AVX512DQVL-NEXT:    vpsrlw $8, %xmm0, %xmm0
; AVX512DQVL-NEXT:    vpand %ymm0, %ymm2, %ymm0
; AVX512DQVL-NEXT:    vpmaddubsw %ymm0, %ymm1, %ymm0
; AVX512DQVL-NEXT:    vmovd %xmm0, %eax
...
; SSE41-NEXT:    pmaddubsw %xmm5, %xmm7
; SSE41-NEXT:    movdqa %xmm4, %xmm5
...
; SSE41-NEXT:    pmaddubsw %xmm1, %xmm2
...
; AVX1-NEXT:    vpandn %xmm1, %xmm2, %xmm4
...
; AVX1-NEXT:    vpmaddubsw %xmm0, %xmm3, %xmm0
; AVX1-NEXT:    vpand %xmm2, %xmm0, %xmm0
; AVX1-NEXT:    vpmaddubsw %xmm4, %xmm3, %xmm1
...
; AVX2-NEXT:    vpmaddubsw %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX2-NEXT:    vpor %ymm0, %ymm3, %ymm1
; AVX2-NEXT:    vpsrlw $8, %xmm0, %xmm0
; AVX2-NEXT:    vpand %ymm0, %ymm2, %ymm0
; AVX2-NEXT:    vpmaddubsw %ymm0, %ymm1, %ymm0
; AVX2-NEXT:    vmovd %xmm0, %eax
; AVX2-NEXT:    # kill: def $al killed $al killed $eax
; AVX2-NEXT:    vzeroupper
; AVX2-NEXT:    retq
...
; AVX512BW-NEXT:    vpmaddubsw %zmm1, %zmm0, %zmm0
; AVX512BW-NEXT:    vpsllw $8, %zmm0, %zmm0
; AVX512BW-NEXT:    vporq %zmm0, %zmm3, %zmm1
; AVX512BW-NEXT:    vpsrlw $8, %xmm0, %xmm0
; AVX512BW-NEXT:    vpandq %zmm0, %zmm2, %zmm0
; AVX512BW-NEXT:    vpmaddubsw %zmm0, %zmm1, %zmm0
; AVX512BW-NEXT:    vmovd %xmm0, %eax
; AVX512BW-NEXT:    # kill: def $al killed $al killed $eax
; AVX512BW-NEXT:    vzeroupper
; AVX512BW-NEXT:    retq
...
; AVX512BWVL:       # %bb.0:
; AVX512BWVL-NEXT:    vextracti64x4 $1, %zmm0, %ymm1
; AVX512BWVL-NEXT:    vpbroadcastw {{.*#+}} zmm2 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; AVX512BWVL-NEXT:    vpandq %zmm1, %zmm2, %zmm3
; AVX512BWVL-NEXT:    vpmaddubsw %zmm3, %zmm0, %zmm3
; AVX512BWVL-NEXT:    vpandnq %zmm1, %zmm2, %zmm1
; AVX512BWVL-NEXT:    vpmaddubsw %zmm1, %zmm0, %zmm0
; AVX512BWVL-NEXT:    vpsllw $8, %zmm0, %zmm0
; AVX512BWVL-NEXT:    vpternlogq $248, %zmm2, %zmm3, %zmm0
; AVX512BWVL-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX512BWVL-NEXT:    vpandq %zmm1, %zmm2, %zmm3
; AVX512BWVL-NEXT:    vpmaddubsw %zmm3, %zmm0, %zmm3
; AVX512BWVL-NEXT:    vpandnq %zmm1, %zmm2, %zmm1
...
; AVX512BWVL-NEXT:    vpmaddubsw %zmm1, %zmm0, %zmm0
; AVX512BWVL-NEXT:    vpsllw $8, %zmm0, %zmm0
; AVX512BWVL-NEXT:    vporq %zmm0, %zmm3, %zmm1
; AVX512BWVL-NEXT:    vpsrlw $8, %xmm0, %xmm0
; AVX512BWVL-NEXT:    vpandq %zmm0, %zmm2, %zmm0
; AVX512BWVL-NEXT:    vpmaddubsw %zmm0, %zmm1, %zmm0
; AVX512BWVL-NEXT:    vmovd %xmm0, %eax
; AVX512BWVL-NEXT:    # kill: def $al killed $al killed $eax
; AVX512BWVL-NEXT:    vzeroupper
; AVX512BWVL-NEXT:    retq
...
; SSE41-NEXT:    movdqa %xmm8, %xmm5
; SSE41-NEXT:    pandn %xmm7, %xmm5
; SSE41-NEXT:    movdqa %xmm3, %xmm4
; SSE41-NEXT:    pmaddubsw %xmm5, %xmm4
...
; SSE41-NEXT:    pmaddubsw %xmm5, %xmm7
; SSE41-NEXT:    psllw $8, %xmm7
; SSE41-NEXT:    pand %xmm8, %xmm6
; SSE41-NEXT:    pmaddubsw %xmm6, %xmm2
...
; SSE41-NEXT:    pmaddubsw %xmm3, %xmm2
; SSE41-NEXT:    pmaddubsw %xmm4, %xmm1
; SSE41-NEXT:    psllw $8, %xmm1
; SSE41-NEXT:    movdqa %xmm0, %xmm3
; SSE41-NEXT:    pmaddubsw %xmm1, %xmm3
; SSE41-NEXT:    pand %xmm8, %xmm2
; SSE41-NEXT:    pmaddubsw %xmm2, %xmm0
; SSE41-NEXT:    movdqa %xmm0, %xmm1
...
; AVX1-NEXT:    vpmaddubsw %xmm5, %xmm7, %xmm5
...
; AVX1-NEXT:    vpandn %xmm3, %xmm4, %xmm7
; AVX1-NEXT:    vpmaddubsw %xmm7, %xmm1, %xmm7
...
; AVX1-NEXT:    vpmaddubsw %xmm7, %xmm0, %xmm0
; AVX1-NEXT:    vpsllw $8, %xmm0, %xmm0
; AVX1-NEXT:    vpor %xmm0, %xmm1, %xmm0
; AVX1-NEXT:    vpmaddubsw %xmm2, %xmm5, %xmm1
; AVX1-NEXT:    vpsllw $8, %xmm1, %xmm1
; AVX1-NEXT:    vpand %xmm6, %xmm4, %xmm2
; AVX1-NEXT:    vpmaddubsw %xmm2, %xmm5, %xmm2
...
; AVX1-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
; AVX1-NEXT:    vpand %xmm1, %xmm4, %xmm2
; AVX1-NEXT:    vpmaddubsw %xmm2, %xmm0, %xmm2
; AVX1-NEXT:    vpand %xmm4, %xmm2, %xmm2
...
; AVX2-NEXT:    vpmaddubsw %ymm1, %ymm0, %ymm1
...
; AVX2-NEXT:    vpmaddubsw %ymm2, %ymm0, %ymm2
...
; AVX512DQ-NEXT:    vpand %ymm1, %ymm2, %ymm3
; AVX512DQ-NEXT:    vpmaddubsw %ymm3, %ymm0, %ymm3
; AVX512DQ-NEXT:    vpand %ymm2, %ymm3, %ymm3
; AVX512DQ-NEXT:    vpandn %ymm1, %ymm2, %ymm4
; AVX512DQ-NEXT:    vpmaddubsw %ymm4, %ymm0, %ymm4
; AVX512DQ-NEXT:    vpsllw $8, %ymm4, %ymm4
; AVX512DQ-NEXT:    vpor %ymm4, %ymm3, %ymm3
...
; AVX512DQ-NEXT:    vpmaddubsw %ymm0, %ymm3, %ymm0
; AVX512DQ-NEXT:    vpand %ymm2, %ymm0, %ymm0
; AVX512DQ-NEXT:    vpmaddubsw %ymm4, %ymm3, %ymm1
...
; AVX512DQ-NEXT:    vpmaddubsw %ymm1, %ymm0, %ymm0
; AVX512DQ-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX512DQ-NEXT:    vpor %ymm0, %ymm3, %ymm1
; AVX512DQ-NEXT:    vpsrlw $8, %xmm0, %xmm0
; AVX512DQ-NEXT:    vpand %ymm0, %ymm2, %ymm0
; AVX512DQ-NEXT:    vpmaddubsw %ymm0, %ymm1, %ymm0
; AVX512DQ-NEXT:    vmovd %xmm0, %eax
; AVX512DQ-NEXT:    # kill: def $al killed $al killed $eax
; AVX512DQ-NEXT:    vzeroupper
; AVX512DQ-NEXT:    retq
...
; AVX512DQVL-NEXT:    vpand %ymm1, %ymm2, %ymm3
; AVX512DQVL-NEXT:    vpmaddubsw %ymm3, %ymm0, %ymm3
; AVX512DQVL-NEXT:    vpandn %ymm1, %ymm2, %ymm4
; AVX512DQVL-NEXT:    vpmaddubsw %ymm4, %ymm0, %ymm4
; AVX512DQVL-NEXT:    vpsllw $8, %ymm4, %ymm4
; AVX512DQVL-NEXT:    vpternlogq $248, %ymm2, %ymm3, %ymm4
; AVX512DQVL-NEXT:    vextracti64x4 $1, %zmm1, %ymm1
; AVX512DQVL-NEXT:    vpandn %ymm1, %ymm2, %ymm3
; AVX512DQVL-NEXT:    vextracti64x4 $1, %zmm0, %ymm0
; AVX512DQVL-NEXT:    vpmaddubsw %ymm3, %ymm0, %ymm3
; AVX512DQVL-NEXT:    vpsllw $8, %ymm3, %ymm3
; AVX512DQVL-NEXT:    vpand %ymm1, %ymm2, %ymm1
; AVX512DQVL-NEXT:    vpmaddubsw %ymm1, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpand %ymm2, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpmaddubsw %ymm0, %ymm4, %ymm0
; AVX512DQVL-NEXT:    vpmaddubsw %ymm3, %ymm4, %ymm1
; AVX512DQVL-NEXT:    vpsllw $8, %ymm1, %ymm1
; AVX512DQVL-NEXT:    vpternlogq $248, %ymm2, %ymm0, %ymm1
; AVX512DQVL-NEXT:    vextracti128 $1, %ymm1, %xmm0
; AVX512DQVL-NEXT:    vpand %ymm0, %ymm2, %ymm3
; AVX512DQVL-NEXT:    vpmaddubsw %ymm3, %ymm1, %ymm3
; AVX512DQVL-NEXT:    vpandn %ymm0, %ymm2, %ymm0
; AVX512DQVL-NEXT:    vpmaddubsw %ymm0, %ymm1, %ymm0
; AVX512DQVL-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX512DQVL-NEXT:    vpternlogq $248, %ymm2, %ymm3, %ymm0
; AVX512DQVL-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
