...
; AVX512-NEXT:    vpmovsxbd {{.*#+}} xmm3 = [3,7,0,0]
...
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm3 = [3,7,0,0]
...
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} xmm3 = [3,7,0,0]
...
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm7 = [1,5,0,0]
...
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm7 = [0,0,2,6]
...
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm3 = [3,7,0,0]
...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [0,0,0,4]
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} xmm3 = [3,7,0,0]
...
; AVX512BW-FCP:       # %bb.0:
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [0,0,0,4]
...
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm7 = [1,5,0,0]
...
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm7 = [0,0,2,6]
...
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm3 = [3,7,0,0]
...
; AVX512DQ-BW:       # %bb.0:
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [0,0,0,4]
...
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} xmm3 = [3,7,0,0]
...
; AVX512DQ-BW-FCP:       # %bb.0:
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [0,0,0,4]
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm7 = [1,5,0,0]
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm7 = [0,0,2,6]
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm3 = [3,7,0,0]
...
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm7[0],ymm11[0],ymm7[2],ymm11[2]
; AVX-NEXT:    vmovups %ymm7, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm8[2,3,0,1]
; AVX-NEXT:    vunpcklps {{.*#+}} ymm1 = ymm9[0],ymm8[0],ymm9[1],ymm8[1],ymm9[4],ymm8[4],ymm9[5],ymm8[5]
...
; AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm10[0],xmm14[0]
...
; AVX-NEXT:    vmovaps 144(%rdi), %xmm12
; AVX-NEXT:    vmovaps 128(%rdi), %xmm6
; AVX-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm6[0],xmm12[0],xmm6[1],xmm12[1]
; AVX-NEXT:    vmovaps %xmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX-NEXT:    vmovaps 256(%rdi), %xmm13
; AVX-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm13[0],xmm5[0],xmm13[1],xmm5[1]
; AVX-NEXT:    vmovaps %xmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX2-NEXT:    vblendps {{.*#+}} xmm1 = xmm1[0,1],xmm3[2,3]
; AVX2-NEXT:    vmovaps 864(%rdi), %ymm7
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermps %ymm7, %ymm2, %ymm0
; AVX2-NEXT:    vpermps %ymm5, %ymm2, %ymm1
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} xmm1 = xmm1[0,1],xmm3[2,3]
; AVX2-FP-NEXT:    vmovaps 864(%rdi), %ymm7
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermps %ymm7, %ymm2, %ymm0
; AVX2-FP-NEXT:    vpermps %ymm5, %ymm2, %ymm1
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} xmm1 = xmm1[0,1],xmm3[2,3]
; AVX2-FCP-NEXT:    vmovaps 864(%rdi), %ymm7
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermps %ymm7, %ymm2, %ymm0
; AVX2-FCP-NEXT:    vpermps %ymm5, %ymm2, %ymm1
