...
; AVX512F-NEXT:    vpternlogq $228, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm0, %ymm3
...
; AVX512F-NEXT:    vpternlogq $248, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm1, %ymm2
...
; AVX2-NEXT:    vmovdqa 128(%rdi), %ymm1
; AVX2-NEXT:    vmovdqa 32(%rdi), %ymm0
; AVX2-NEXT:    vbroadcasti128 {{.*#+}} ymm2 = [1,5,7,11,13,128,128,128,128,128,128,3,5,9,11,15,1,5,7,11,13,128,128,128,128,128,128,3,5,9,11,15]
...
; AVX2-NEXT:    vpshufb %xmm2, %xmm3, %xmm3
; AVX2-NEXT:    vmovdqa 64(%rdi), %xmm6
; AVX2-NEXT:    vmovdqa {{.*#+}} xmm7 = [u,u,u,u,u,1,3,7,9,13,15,128,128,128,128,128]
; AVX2-NEXT:    vpshufb %xmm7, %xmm6, %xmm6
...
; AVX2-NEXT:    vpshufb %xmm2, %xmm3, %xmm3
; AVX2-NEXT:    vmovdqa 112(%rdi), %xmm8
...
; AVX512F-NEXT:    vpternlogq $216, %ymm4, %ymm3, %ymm2
...
; AVX512F-NEXT:    vpternlogq $226, %ymm1, %ymm4, %ymm0
...
; AVX2-NEXT:    vmovdqa 128(%rdi), %ymm1
; AVX2-NEXT:    vmovdqa 32(%rdi), %ymm0
; AVX2-NEXT:    vbroadcasti128 {{.*#+}} ymm2 = [0,4,6,10,12,128,128,128,128,128,128,2,4,8,10,14,0,4,6,10,12,128,128,128,128,128,128,2,4,8,10,14]
; AVX2-NEXT:    # ymm2 = mem[0,1,0,1]
; AVX2-NEXT:    vmovdqa (%rdi), %xmm3
; AVX2-NEXT:    vmovdqa 16(%rdi), %xmm4
; AVX2-NEXT:    vpshufb %xmm2, %xmm3, %xmm3
...
; AVX2-NEXT:    vpshufb %xmm2, %xmm3, %xmm3
; AVX2-NEXT:    vmovdqa 64(%rdi), %xmm6
; AVX2-NEXT:    vmovdqa {{.*#+}} xmm7 = [u,u,u,u,u,0,2,6,8,12,14,128,128,128,128,128]
; AVX2-NEXT:    vpshufb %xmm7, %xmm6, %xmm6
; AVX2-NEXT:    vpor %xmm3, %xmm6, %xmm3
; AVX2-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX2-NEXT:    vpmovsxwd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm6
