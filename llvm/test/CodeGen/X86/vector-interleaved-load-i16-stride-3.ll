...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} xmm0 = [0,9,6,3,6,3,6,7]
; AVX512BW-NEXT:    vmovdqa (%rdi), %ymm1
; AVX512BW-NEXT:    vpermw %ymm1, %ymm0, %ymm0
; AVX512BW-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,3,2,1,4,5,6,7]
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} xmm2 = [10,1,4,7,4,7,6,7]
; AVX512BW-NEXT:    vpermw %ymm1, %ymm2, %ymm1
; AVX512BW-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm1[1,2,3,0,4,5,6,7]
...
; AVX512BW-FCP:       # %bb.0:
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} xmm0 = [0,9,4,5,6,3,6,7]
; AVX512BW-FCP-NEXT:    vmovdqa (%rdi), %ymm1
; AVX512BW-FCP-NEXT:    vpermw %ymm1, %ymm0, %ymm0
; AVX512BW-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[0,1,10,11,8,9,2,3,u,u,u,u,u,u,u,u]
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} xmm2 = [10,1,10,11,4,7,6,7]
; AVX512BW-FCP-NEXT:    vpermw %ymm1, %ymm2, %ymm2
; AVX512BW-FCP-NEXT:    vpshufb {{.*#+}} xmm2 = xmm2[2,3,8,9,10,11,0,1,u,u,u,u,u,u,u,u]
...
; AVX512DQ-BW:       # %bb.0:
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} xmm0 = [0,9,6,3,6,3,6,7]
; AVX512DQ-BW-NEXT:    vmovdqa (%rdi), %ymm1
; AVX512DQ-BW-NEXT:    vpermw %ymm1, %ymm0, %ymm0
; AVX512DQ-BW-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,3,2,1,4,5,6,7]
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} xmm2 = [10,1,4,7,4,7,6,7]
; AVX512DQ-BW-NEXT:    vpermw %ymm1, %ymm2, %ymm1
; AVX512DQ-BW-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm1[1,2,3,0,4,5,6,7]
...
; AVX512DQ-BW-FCP:       # %bb.0:
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} xmm0 = [0,9,4,5,6,3,6,7]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa (%rdi), %ymm1
; AVX512DQ-BW-FCP-NEXT:    vpermw %ymm1, %ymm0, %ymm0
; AVX512DQ-BW-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[0,1,10,11,8,9,2,3,u,u,u,u,u,u,u,u]
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} xmm2 = [10,1,10,11,4,7,6,7]
; AVX512DQ-BW-FCP-NEXT:    vpermw %ymm1, %ymm2, %ymm2
; AVX512DQ-BW-FCP-NEXT:    vpshufb {{.*#+}} xmm2 = xmm2[2,3,8,9,10,11,0,1,u,u,u,u,u,u,u,u]
