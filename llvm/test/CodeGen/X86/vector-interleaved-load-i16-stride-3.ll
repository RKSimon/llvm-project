...
; AVX512-NEXT:    vpternlogq $202, %ymm10, %ymm9, %ymm3
; AVX512-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
; AVX512-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm4[1],ymm3[2,3],ymm4[4],ymm3[5,6],ymm4[7],ymm3[8],ymm4[9],ymm3[10,11],ymm4[12],ymm3[13,14],ymm4[15]
...
; AVX512-NEXT:    vpternlogq $202, %ymm6, %ymm5, %ymm8
...
; AVX512-NEXT:    vpternlogq $202, %ymm9, %ymm10, %ymm13
...
; AVX512-NEXT:    vpternlogq $202, %ymm9, %ymm10, %ymm0
...
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm10, %ymm9, %ymm3
; AVX512-FCP-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm4[1],ymm3[2,3],ymm4[4],ymm3[5,6],ymm4[7],ymm3[8],ymm4[9],ymm3[10,11],ymm4[12],ymm3[13,14],ymm4[15]
...
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm6, %ymm5, %ymm8
...
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm9, %ymm10, %ymm13
...
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm9, %ymm10, %ymm0
...
; AVX512DQ-NEXT:    vpternlogq $202, %ymm10, %ymm9, %ymm3
; AVX512DQ-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm4[1],ymm3[2,3],ymm4[4],ymm3[5,6],ymm4[7],ymm3[8],ymm4[9],ymm3[10,11],ymm4[12],ymm3[13,14],ymm4[15]
...
; AVX512DQ-NEXT:    vpternlogq $202, %ymm6, %ymm5, %ymm8
...
; AVX512DQ-NEXT:    vpternlogq $202, %ymm9, %ymm10, %ymm13
...
; AVX512DQ-NEXT:    vpternlogq $202, %ymm9, %ymm10, %ymm0
...
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm10, %ymm9, %ymm3
; AVX512DQ-FCP-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm4[1],ymm3[2,3],ymm4[4],ymm3[5,6],ymm4[7],ymm3[8],ymm4[9],ymm3[10,11],ymm4[12],ymm3[13,14],ymm4[15]
...
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm6, %ymm5, %ymm8
...
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm9, %ymm10, %ymm13
...
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm9, %ymm10, %ymm0
...
; AVX-NEXT:    vpblendw {{.*#+}} xmm0 = xmm13[0,1],xmm1[2],xmm13[3,4],xmm1[5],xmm13[6,7]
...
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm9 = [0,1,6,7,12,13,2,3,8,9,14,15,4,5,10,11,16,17,22,23,28,29,18,19,24,25,30,31,20,21,26,27]
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm9 = [0,1,6,7,12,13,2,3,8,9,14,15,4,5,10,11,16,17,22,23,28,29,18,19,24,25,30,31,20,21,26,27]
; AVX2-FP-NEXT:    vpshufb %ymm9, %ymm1, %ymm2
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm9 = [0,1,6,7,12,13,2,3,8,9,14,15,4,5,10,11,16,17,22,23,28,29,18,19,24,25,30,31,20,21,26,27]
; AVX2-FCP-NEXT:    vpshufb %ymm9, %ymm1, %ymm2
...
; AVX512-NEXT:    vmovdqa 160(%rdi), %ymm6
; AVX512-NEXT:    vmovdqa %ymm0, %ymm1
; AVX512-NEXT:    vpternlogq $202, %ymm22, %ymm6, %ymm1
; AVX512-NEXT:    vpermq {{.*#+}} ymm2 = ymm1[2,3,0,1]
...
; AVX512-NEXT:    vpternlogq $202, %ymm8, %ymm23, %ymm4
...
; AVX512-NEXT:    vmovdqa %ymm0, %ymm3
; AVX512-NEXT:    vpternlogq $202, %ymm19, %ymm21, %ymm3
; AVX512-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
; AVX512-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm4[1],ymm3[2,3],ymm4[4],ymm3[5,6],ymm4[7],ymm3[8],ymm4[9],ymm3[10,11],ymm4[12],ymm3[13,14],ymm4[15]
; AVX512-NEXT:    vpshufb %ymm1, %ymm3, %ymm3
; AVX512-NEXT:    vmovdqa 272(%rdi), %xmm2
; AVX512-NEXT:    vmovdqa 256(%rdi), %xmm4
; AVX512-NEXT:    vpblendw {{.*#+}} xmm15 = xmm4[0,1],xmm2[2],xmm4[3,4],xmm2[5],xmm4[6,7]
; AVX512-NEXT:    vmovdqa %xmm4, %xmm5
; AVX512-NEXT:    vmovdqa %xmm2, %xmm10
...
; AVX512-NEXT:    vpternlogq $202, %ymm15, %ymm16, %ymm14
...
; AVX512-NEXT:    vmovdqa %ymm2, %ymm3
; AVX512-NEXT:    vpternlogq $202, %ymm21, %ymm19, %ymm3
; AVX512-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
...
; AVX512-NEXT:    vpternlogq $202, %ymm16, %ymm15, %ymm7
...
; AVX512-NEXT:    vmovdqa %ymm0, %ymm4
; AVX512-NEXT:    vpternlogq $202, %ymm6, %ymm22, %ymm4
; AVX512-NEXT:    vpermq {{.*#+}} ymm5 = ymm4[2,3,0,1]
...
; AVX512-NEXT:    vpternlogq $202, %ymm23, %ymm8, %ymm5
...
; AVX512-NEXT:    vpternlogq $226, %ymm22, %ymm2, %ymm6
...
; AVX512-NEXT:    vpternlogq $226, %ymm23, %ymm0, %ymm8
...
; AVX512-NEXT:    vpternlogq $202, %ymm15, %ymm16, %ymm2
...
; AVX512-NEXT:    vpternlogq $202, %ymm21, %ymm19, %ymm0
; AVX512-NEXT:    vpermq {{.*#+}} ymm2 = ymm0[2,3,0,1]
; AVX512-NEXT:    vpblendw {{.*#+}} ymm0 = ymm2[0],ymm0[1,2],ymm2[3],ymm0[4,5],ymm2[6],ymm0[7],ymm2[8],ymm0[9,10],ymm2[11],ymm0[12,13],ymm2[14],ymm0[15]
...
; AVX512-FCP-NEXT:    vmovdqa 160(%rdi), %ymm6
; AVX512-FCP-NEXT:    vmovdqa %ymm0, %ymm1
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm22, %ymm6, %ymm1
; AVX512-FCP-NEXT:    vpermq {{.*#+}} ymm2 = ymm1[2,3,0,1]
...
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm8, %ymm23, %ymm4
...
; AVX512-FCP-NEXT:    vmovdqa %ymm0, %ymm3
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm19, %ymm21, %ymm3
; AVX512-FCP-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm4[1],ymm3[2,3],ymm4[4],ymm3[5,6],ymm4[7],ymm3[8],ymm4[9],ymm3[10,11],ymm4[12],ymm3[13,14],ymm4[15]
; AVX512-FCP-NEXT:    vpshufb %ymm1, %ymm3, %ymm3
; AVX512-FCP-NEXT:    vmovdqa 272(%rdi), %xmm2
; AVX512-FCP-NEXT:    vmovdqa 256(%rdi), %xmm4
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} xmm15 = xmm4[0,1],xmm2[2],xmm4[3,4],xmm2[5],xmm4[6,7]
; AVX512-FCP-NEXT:    vmovdqa %xmm4, %xmm5
...
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm15, %ymm16, %ymm14
...
; AVX512-FCP-NEXT:    vmovdqa %ymm2, %ymm3
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm21, %ymm19, %ymm3
; AVX512-FCP-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
...
; AVX512-FCP-NEXT:    vmovdqa %ymm0, %ymm4
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm6, %ymm22, %ymm4
; AVX512-FCP-NEXT:    vpermq {{.*#+}} ymm5 = ymm4[2,3,0,1]
...
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm23, %ymm8, %ymm5
...
; AVX512-FCP-NEXT:    vpternlogq $226, %ymm22, %ymm2, %ymm6
...
; AVX512-FCP-NEXT:    vpternlogq $226, %ymm23, %ymm0, %ymm8
...
; AVX512-FCP-NEXT:    vpternlogq $202, %ymm21, %ymm19, %ymm0
; AVX512-FCP-NEXT:    vpermq {{.*#+}} ymm2 = ymm0[2,3,0,1]
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm2[0],ymm0[1,2],ymm2[3],ymm0[4,5],ymm2[6],ymm0[7],ymm2[8],ymm0[9,10],ymm2[11],ymm0[12,13],ymm2[14],ymm0[15]
...
; AVX512DQ-NEXT:    vmovdqa 160(%rdi), %ymm6
; AVX512DQ-NEXT:    vmovdqa %ymm0, %ymm1
; AVX512DQ-NEXT:    vpternlogq $202, %ymm22, %ymm6, %ymm1
; AVX512DQ-NEXT:    vpermq {{.*#+}} ymm2 = ymm1[2,3,0,1]
...
; AVX512DQ-NEXT:    vpternlogq $202, %ymm8, %ymm23, %ymm4
...
; AVX512DQ-NEXT:    vmovdqa %ymm0, %ymm3
; AVX512DQ-NEXT:    vpternlogq $202, %ymm19, %ymm21, %ymm3
; AVX512DQ-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm4[1],ymm3[2,3],ymm4[4],ymm3[5,6],ymm4[7],ymm3[8],ymm4[9],ymm3[10,11],ymm4[12],ymm3[13,14],ymm4[15]
; AVX512DQ-NEXT:    vpshufb %ymm1, %ymm3, %ymm3
; AVX512DQ-NEXT:    vmovdqa 272(%rdi), %xmm2
; AVX512DQ-NEXT:    vmovdqa 256(%rdi), %xmm4
; AVX512DQ-NEXT:    vpblendw {{.*#+}} xmm15 = xmm4[0,1],xmm2[2],xmm4[3,4],xmm2[5],xmm4[6,7]
; AVX512DQ-NEXT:    vmovdqa %xmm4, %xmm5
; AVX512DQ-NEXT:    vmovdqa %xmm2, %xmm10
...
; AVX512DQ-NEXT:    vpternlogq $202, %ymm15, %ymm16, %ymm14
...
; AVX512DQ-NEXT:    vmovdqa %ymm2, %ymm3
; AVX512DQ-NEXT:    vpternlogq $202, %ymm21, %ymm19, %ymm3
; AVX512DQ-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
...
; AVX512DQ-NEXT:    vpternlogq $202, %ymm16, %ymm15, %ymm7
...
; AVX512DQ-NEXT:    vmovdqa %ymm0, %ymm4
; AVX512DQ-NEXT:    vpternlogq $202, %ymm6, %ymm22, %ymm4
; AVX512DQ-NEXT:    vpermq {{.*#+}} ymm5 = ymm4[2,3,0,1]
...
; AVX512DQ-NEXT:    vpternlogq $202, %ymm23, %ymm8, %ymm5
...
; AVX512DQ-NEXT:    vpternlogq $226, %ymm22, %ymm2, %ymm6
...
; AVX512DQ-NEXT:    vpternlogq $226, %ymm23, %ymm0, %ymm8
...
; AVX512DQ-NEXT:    vpternlogq $202, %ymm15, %ymm16, %ymm2
...
; AVX512DQ-NEXT:    vpternlogq $202, %ymm21, %ymm19, %ymm0
; AVX512DQ-NEXT:    vpermq {{.*#+}} ymm2 = ymm0[2,3,0,1]
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm0 = ymm2[0],ymm0[1,2],ymm2[3],ymm0[4,5],ymm2[6],ymm0[7],ymm2[8],ymm0[9,10],ymm2[11],ymm0[12,13],ymm2[14],ymm0[15]
...
; AVX512DQ-FCP-NEXT:    vmovdqa 160(%rdi), %ymm6
; AVX512DQ-FCP-NEXT:    vmovdqa %ymm0, %ymm1
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm22, %ymm6, %ymm1
; AVX512DQ-FCP-NEXT:    vpermq {{.*#+}} ymm2 = ymm1[2,3,0,1]
...
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm8, %ymm23, %ymm4
...
; AVX512DQ-FCP-NEXT:    vmovdqa %ymm0, %ymm3
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm19, %ymm21, %ymm3
; AVX512DQ-FCP-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm4[1],ymm3[2,3],ymm4[4],ymm3[5,6],ymm4[7],ymm3[8],ymm4[9],ymm3[10,11],ymm4[12],ymm3[13,14],ymm4[15]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm1, %ymm3, %ymm3
; AVX512DQ-FCP-NEXT:    vmovdqa 272(%rdi), %xmm2
; AVX512DQ-FCP-NEXT:    vmovdqa 256(%rdi), %xmm4
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} xmm15 = xmm4[0,1],xmm2[2],xmm4[3,4],xmm2[5],xmm4[6,7]
...
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm15, %ymm16, %ymm14
...
; AVX512DQ-FCP-NEXT:    vmovdqa %ymm2, %ymm3
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm21, %ymm19, %ymm3
; AVX512DQ-FCP-NEXT:    vpermq {{.*#+}} ymm4 = ymm3[2,3,0,1]
...
; AVX512DQ-FCP-NEXT:    vmovdqa %ymm0, %ymm4
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm6, %ymm22, %ymm4
; AVX512DQ-FCP-NEXT:    vpermq {{.*#+}} ymm5 = ymm4[2,3,0,1]
...
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm23, %ymm8, %ymm5
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %ymm22, %ymm2, %ymm6
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, %ymm23, %ymm0, %ymm8
...
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm21, %ymm19, %ymm0
; AVX512DQ-FCP-NEXT:    vpermq {{.*#+}} ymm2 = ymm0[2,3,0,1]
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm2[0],ymm0[1,2],ymm2[3],ymm0[4,5],ymm2[6],ymm0[7],ymm2[8],ymm0[9,10],ymm2[11],ymm0[12,13],ymm2[14],ymm0[15]
