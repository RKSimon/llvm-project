...
; AVX512-FCP-NEXT:    vpextrd $2, %xmm1, %r10d
; AVX512-FCP-NEXT:    vpinsrd $1, %r10d, %xmm0, %xmm3
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm4 = [1,7,0,0]
; AVX512-FCP-NEXT:    vpermi2d %xmm1, %xmm0, %xmm4
; AVX512-FCP-NEXT:    vpbroadcastd 8(%rdi), %xmm1
; AVX512-FCP-NEXT:    vmovd %xmm2, %r10d
; AVX512-FCP-NEXT:    vpinsrd $1, %r10d, %xmm1, %xmm1
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm5 = [3,5,0,0]
; AVX512-FCP-NEXT:    vpermi2d %xmm2, %xmm0, %xmm5
; AVX512-FCP-NEXT:    vmovsd {{.*#+}} xmm0 = [4,2,0,0]
...
; AVX512DQ-FCP-NEXT:    vpextrd $2, %xmm1, %r10d
; AVX512DQ-FCP-NEXT:    vpinsrd $1, %r10d, %xmm0, %xmm3
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm4 = [1,7,0,0]
; AVX512DQ-FCP-NEXT:    vpermi2d %xmm1, %xmm0, %xmm4
; AVX512DQ-FCP-NEXT:    vpbroadcastd 8(%rdi), %xmm1
; AVX512DQ-FCP-NEXT:    vmovd %xmm2, %r10d
; AVX512DQ-FCP-NEXT:    vpinsrd $1, %r10d, %xmm1, %xmm1
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm5 = [3,5,0,0]
; AVX512DQ-FCP-NEXT:    vpermi2d %xmm2, %xmm0, %xmm5
; AVX512DQ-FCP-NEXT:    vmovsd {{.*#+}} xmm0 = [4,2,0,0]
...
; AVX512BW-FCP-NEXT:    vpextrd $2, %xmm1, %r10d
; AVX512BW-FCP-NEXT:    vpinsrd $1, %r10d, %xmm0, %xmm3
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm4 = [1,7,0,0]
; AVX512BW-FCP-NEXT:    vpermi2d %xmm1, %xmm0, %xmm4
; AVX512BW-FCP-NEXT:    vpbroadcastd 8(%rdi), %xmm1
; AVX512BW-FCP-NEXT:    vmovd %xmm2, %r10d
; AVX512BW-FCP-NEXT:    vpinsrd $1, %r10d, %xmm1, %xmm1
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm5 = [3,5,0,0]
; AVX512BW-FCP-NEXT:    vpermi2d %xmm2, %xmm0, %xmm5
; AVX512BW-FCP-NEXT:    vmovsd {{.*#+}} xmm0 = [4,2,0,0]
...
; AVX512DQ-BW-FCP-NEXT:    vpextrd $2, %xmm1, %r10d
; AVX512DQ-BW-FCP-NEXT:    vpinsrd $1, %r10d, %xmm0, %xmm3
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm4 = [1,7,0,0]
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %xmm1, %xmm0, %xmm4
; AVX512DQ-BW-FCP-NEXT:    vpbroadcastd 8(%rdi), %xmm1
; AVX512DQ-BW-FCP-NEXT:    vmovd %xmm2, %r10d
; AVX512DQ-BW-FCP-NEXT:    vpinsrd $1, %r10d, %xmm1, %xmm1
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm5 = [3,5,0,0]
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %xmm2, %xmm0, %xmm5
; AVX512DQ-BW-FCP-NEXT:    vmovsd {{.*#+}} xmm0 = [4,2,0,0]
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm1 = ymm11[0],ymm5[0],ymm11[3],ymm5[2]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,1,2,0,4,5,6,4]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm1[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm1 = ymm1[1],ymm5[0],ymm1[2],ymm5[2]
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm1 = ymm4[1],ymm6[0],ymm4[2],ymm6[2]
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm14 = ymm8[1],ymm14[0],ymm8[2],ymm14[2]
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm6 # 32-byte Reload
...
; AVX2-NEXT:    vpermps %ymm9, %ymm1, %ymm3
; AVX2-NEXT:    vmovaps %ymm1, %ymm7
...
; AVX2-FP-NEXT:    vpermps %ymm9, %ymm1, %ymm3
; AVX2-FP-NEXT:    vmovaps %ymm1, %ymm7
...
; AVX2-FP-NEXT:    vmovaps %ymm7, %ymm8
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm15 = ymm0[0],ymm15[0],ymm0[3],ymm15[2]
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm1 = ymm1[1],ymm15[0],ymm1[2],ymm15[2]
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Reload
...
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm1 = ymm1[1],ymm13[0],ymm1[2],ymm13[2]
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm2[0,1],ymm1[2,0],ymm2[4,5],ymm1[6,4]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3,4,5,6,7]
...
; AVX2-FP-NEXT:    vmovaps %ymm1, %ymm5
