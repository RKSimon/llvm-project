...
; AVX512-FCP-NEXT:    vpinsrd $1, %r10d, %xmm4, %xmm4
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm5 = [3,5,0,0]
; AVX512-FCP-NEXT:    vpermi2d %xmm2, %xmm0, %xmm5
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [4,2,0,0]
; AVX512-FCP-NEXT:    vmovaps 32(%rdi), %ymm2
; AVX512-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],mem[4,5,6,7]
; AVX512-FCP-NEXT:    vpermps %ymm2, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm6 = [5,3,0,0]
; AVX512-FCP-NEXT:    vpermps %ymm2, %ymm6, %ymm2
...
; AVX512-FCP-NEXT:    vmovlps %xmm2, (%rax)
...
; AVX512DQ-FCP-NEXT:    vpinsrd $1, %r10d, %xmm4, %xmm4
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm5 = [3,5,0,0]
; AVX512DQ-FCP-NEXT:    vpermi2d %xmm2, %xmm0, %xmm5
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [4,2,0,0]
; AVX512DQ-FCP-NEXT:    vmovaps 32(%rdi), %ymm2
; AVX512DQ-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],mem[4,5,6,7]
; AVX512DQ-FCP-NEXT:    vpermps %ymm2, %ymm0, %ymm0
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm6 = [5,3,0,0]
; AVX512DQ-FCP-NEXT:    vpermps %ymm2, %ymm6, %ymm2
...
; AVX512DQ-FCP-NEXT:    vmovlps %xmm2, (%rax)
...
; AVX512BW-FCP-NEXT:    vmovd %xmm2, %r10d
; AVX512BW-FCP-NEXT:    vpinsrd $1, %r10d, %xmm4, %xmm4
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm5 = [3,5,0,0]
; AVX512BW-FCP-NEXT:    vpermi2d %xmm2, %xmm0, %xmm5
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [4,2,0,0]
; AVX512BW-FCP-NEXT:    vmovaps 32(%rdi), %ymm2
; AVX512BW-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],mem[4,5,6,7]
; AVX512BW-FCP-NEXT:    vpermps %ymm2, %ymm0, %ymm0
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm6 = [5,3,0,0]
; AVX512BW-FCP-NEXT:    vpermps %ymm2, %ymm6, %ymm2
...
; AVX512BW-FCP-NEXT:    vmovlps %xmm2, (%rax)
...
; AVX512DQ-BW-FCP-NEXT:    vmovd %xmm2, %r10d
; AVX512DQ-BW-FCP-NEXT:    vpinsrd $1, %r10d, %xmm4, %xmm4
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm5 = [3,5,0,0]
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %xmm2, %xmm0, %xmm5
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [4,2,0,0]
; AVX512DQ-BW-FCP-NEXT:    vmovaps 32(%rdi), %ymm2
; AVX512DQ-BW-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],mem[4,5,6,7]
; AVX512DQ-BW-FCP-NEXT:    vpermps %ymm2, %ymm0, %ymm0
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm6 = [5,3,0,0]
; AVX512DQ-BW-FCP-NEXT:    vpermps %ymm2, %ymm6, %ymm2
...
; AVX512DQ-BW-FCP-NEXT:    vmovlps %xmm2, (%rax)
...
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm11 = ymm5[2,3],ymm4[0,1]
; AVX-NEXT:    vshufpd {{.*#+}} ymm1 = ymm11[0],ymm5[1],ymm11[3],ymm5[2]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,1,2,0,4,5,6,4]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm1[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vinsertf128 $1, 480(%rdi), %ymm3, %ymm6
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm2[2,0],ymm6[0,0],ymm2[6,4],ymm6[4,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[2,0],ymm6[2,2],ymm0[6,4],ymm6[6,6]
; AVX-NEXT:    vmovaps 384(%rdi), %ymm1
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm9[4,5],ymm1[6,7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm13 = ymm2[0,1,2,3],ymm1[4,5],ymm2[6,7]
; AVX-NEXT:    vextractf128 $1, %ymm13, %xmm2
; AVX-NEXT:    vblendps {{.*#+}} xmm1 = xmm13[0,1],xmm2[2,3]
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm10 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm14 = ymm10[3,0],ymm8[1,0],ymm10[7,4],ymm8[5,4]
...
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm14[3,0],ymm3[1,0],ymm14[7,4],ymm3[5,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm5[2,0],ymm3[2,3],ymm5[6,4],ymm3[6,7]
; AVX-NEXT:    vshufps {{.*#+}} xmm5 = xmm13[1,0],xmm2[3,0]
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm0[3,1],ymm13[1,3],ymm0[7,5],ymm13[5,7]
...
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm15[3,0],ymm9[1,0],ymm15[7,4],ymm9[5,4]
...
; AVX-NEXT:    vshufps $38, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10, %ymm1 # 32-byte Folded Reload
; AVX-NEXT:    # ymm1 = ymm10[2,1],mem[2,0],ymm10[6,5],mem[6,4]
...
; AVX-NEXT:    vshufps $38, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11, %ymm5 # 32-byte Folded Reload
; AVX-NEXT:    # ymm5 = ymm11[2,1],mem[2,0],ymm11[6,5],mem[6,4]
...
; AVX-NEXT:    vshufps $38, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14, %ymm9 # 32-byte Folded Reload
; AVX-NEXT:    # ymm9 = ymm14[2,1],mem[2,0],ymm14[6,5],mem[6,4]
...
; AVX-NEXT:    vblendps $48, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm11 # 32-byte Folded Reload
; AVX-NEXT:    # ymm11 = ymm13[0,1,2,3],mem[4,5],ymm13[6,7]
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm9 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm13 = ymm15[2,1],ymm9[2,0],ymm15[6,5],ymm9[6,4]
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm12 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm12[3,1],ymm6[2,1],ymm12[7,5],ymm6[6,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm3[2,3,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2],ymm3[3,4,5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1,2,3,4],ymm1[5,6,7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm11[2,0],ymm7[0,0],ymm11[6,4],ymm7[4,4]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm9[2,2,3,3]
; AVX-NEXT:    vmovaps 208(%rdi), %xmm3
; AVX-NEXT:    vblendps {{.*#+}} xmm0 = xmm3[0],xmm0[1],xmm3[2,3]
; AVX-NEXT:    vmovapd 272(%rdi), %xmm4
; AVX-NEXT:    vshufpd {{.*#+}} ymm1 = ymm4[1],ymm6[0],ymm4[2],ymm6[3]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm12[0,1],ymm1[2,0],ymm12[4,5],ymm1[6,4]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm0[0,1],ymm1[2,3,4,5,6,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm2[2,3,0,1]
; AVX-NEXT:    vshufps {{.*#+}} ymm6 = ymm2[2,0],ymm0[0,0],ymm2[6,4],ymm0[4,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm6 = ymm0[0,2],ymm6[2,0],ymm0[4,6],ymm6[6,4]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3,4],ymm6[5,6,7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm12 # 32-byte Folded Reload
; AVX-NEXT:    # ymm12 = mem[0,1],ymm1[2,3],mem[4,5,6,7]
; AVX-NEXT:    vmovaps 608(%rdi), %xmm13
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm13[2,2,3,3]
; AVX-NEXT:    vmovaps 592(%rdi), %xmm10
; AVX-NEXT:    vblendps {{.*#+}} xmm1 = xmm10[0],xmm1[1],xmm10[2,3]
; AVX-NEXT:    vmovapd 656(%rdi), %xmm8
; AVX-NEXT:    vshufpd {{.*#+}} ymm14 = ymm8[1],ymm14[0],ymm8[2],ymm14[3]
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm6 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm14 = ymm6[0,1],ymm14[2,0],ymm6[4,5],ymm14[6,4]
; AVX-NEXT:    vblendps {{.*#+}} ymm14 = ymm1[0,1],ymm14[2,3,4,5,6,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm12[2,3,0,1]
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm12[2,0],ymm1[0,0],ymm12[6,4],ymm1[4,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm1[0,2],ymm15[2,0],ymm1[4,6],ymm15[6,4]
; AVX-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4],ymm15[5,6,7]
; AVX-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} ymm11 = ymm11[3,0],ymm7[1,0],ymm11[7,4],ymm7[5,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[0,3],ymm11[2,0],ymm7[4,7],ymm11[6,4]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm11[0,1,2,3,4],ymm7[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[3,0],ymm0[1,0],ymm2[7,4],ymm0[5,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[0,3],ymm2[2,0],ymm0[4,7],ymm2[6,4]
; AVX-NEXT:    vblendps {{.*#+}} xmm2 = xmm3[0,1],xmm9[2,3]
; AVX-NEXT:    vshufps $215, {{[-0-9]+}}(%r{{[sb]}}p), %ymm4, %ymm3 # 32-byte Folded Reload
; AVX-NEXT:    # ymm3 = ymm4[3,1],mem[1,3],ymm4[7,5],mem[5,7]
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm4 # 32-byte Reload
...
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm12[3,0],ymm1[1,0],ymm12[7,4],ymm1[5,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,3],ymm3[2,0],ymm1[4,7],ymm3[6,4]
; AVX-NEXT:    vblendps {{.*#+}} xmm3 = xmm10[0,1],xmm13[2,3]
; AVX-NEXT:    vshufps $215, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm4 # 32-byte Folded Reload
; AVX-NEXT:    # ymm4 = ymm8[3,1],mem[1,3],ymm8[7,5],mem[5,7]
...
; AVX:       # %bb.0:
; AVX-NEXT:    subq $2600, %rsp # imm = 0xA28
...
; AVX-NEXT:    vmovaps 64(%rdi), %ymm0
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vinsertf128 $1, 96(%rdi), %ymm0, %ymm9
; AVX-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm1[2,0],ymm9[0,0],ymm1[6,4],ymm9[4,4]
...
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vinsertf128 $1, 864(%rdi), %ymm0, %ymm2
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vinsertf128 $1, 1248(%rdi), %ymm0, %ymm11
...
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 1152(%rdi), %ymm2
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1,2,3],ymm1[4,5],ymm2[6,7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vmovaps 256(%rdi), %ymm0
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vinsertf128 $1, 288(%rdi), %ymm0, %ymm8
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm1[2,0],ymm8[0,0],ymm1[6,4],ymm8[4,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[2,0],ymm8[2,2],ymm0[6,4],ymm8[6,6]
; AVX-NEXT:    vmovaps 224(%rdi), %ymm1
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vmovaps 640(%rdi), %ymm0
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vinsertf128 $1, 672(%rdi), %ymm0, %ymm6
...
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vinsertf128 $1, 1056(%rdi), %ymm0, %ymm3
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm1[2,0],ymm3[0,0],ymm1[6,4],ymm3[4,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[2,0],ymm3[2,2],ymm0[6,4],ymm3[6,6]
...
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vinsertf128 $1, 1440(%rdi), %ymm0, %ymm9
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm1[2,0],ymm9[0,0],ymm1[6,4],ymm9[4,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm0[2,0],ymm9[2,2],ymm0[6,4],ymm9[6,6]
; AVX-NEXT:    vmovaps 1376(%rdi), %ymm0
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 1344(%rdi), %ymm5
; AVX-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm12 = ymm5[0,1,2,3],ymm0[4,5],ymm5[6,7]
; AVX-NEXT:    vextractf128 $1, %ymm12, %xmm5
; AVX-NEXT:    vblendps {{.*#+}} xmm14 = xmm12[0,1],xmm5[2,3]
...
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 1472(%rdi), %ymm15
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm15[2,3],ymm0[0,1]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovupd %ymm15, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm15 = ymm0[0],ymm15[1],ymm0[3],ymm15[2]
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm15[0,1,2,0,4,5,6,4]
; AVX-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4,5],ymm15[6,7]
; AVX-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm14 = ymm0[3,0],ymm15[1,0],ymm0[7,4],ymm15[5,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm14 = ymm14[2,0],ymm15[2,3],ymm14[6,4],ymm15[6,7]
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm10 # 32-byte Reload
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm8 = ymm0[3,1],ymm10[1,3],ymm0[7,5],ymm10[5,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm8 = ymm8[0,1,2,0,4,5,6,4]
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3,4,5],ymm8[6,7]
; AVX-NEXT:    vmovups %ymm7, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Reload
...
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm0[3,0],ymm9[1,0],ymm0[7,4],ymm9[5,4]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm2[2,0],ymm9[2,3],ymm2[6,4],ymm9[6,7]
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm12[1,0],xmm5[3,0]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2],ymm0[3,4,5,6,7]
; AVX-NEXT:    vblendps $48, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10, %ymm5 # 32-byte Folded Reload
; AVX-NEXT:    # ymm5 = ymm10[0,1,2,3],mem[4,5],ymm10[6,7]
...
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm8[2,1],ymm13[2,0],ymm8[6,5],ymm13[6,4]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3,0,1]
; AVX-NEXT:    vextractf128 $1, %ymm2, %xmm1
; AVX-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm2[2,0],xmm1[2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2],ymm0[3,4,5,6,7]
; AVX-NEXT:    vblendps $48, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm3 # 32-byte Folded Reload
; AVX-NEXT:    # ymm3 = ymm7[0,1,2,3],mem[4,5],ymm7[6,7]
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm6[2,1],ymm11[2,0],ymm6[6,5],ymm11[6,4]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3,0,1]
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm6 # 32-byte Reload
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[2,1],ymm6[2,0],ymm0[6,5],ymm6[6,4]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3,0,1]
; AVX-NEXT:    vextractf128 $1, %ymm10, %xmm1
; AVX-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm10[2,0],xmm1[2,3]
...
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm1[0,0],ymm4[2,0],ymm1[4,4],ymm4[6,4]
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm7 # 32-byte Reload
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm14 = ymm8[3,1],ymm7[2,1],ymm8[7,5],ymm7[6,5]
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Reload
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm14[3,1],ymm8[2,1],ymm14[7,5],ymm8[6,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm9[2,3,0,1]
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm9 # 32-byte Reload
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm9[3,1],ymm15[2,1],ymm9[7,5],ymm15[6,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm9[2,3,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2],ymm9[3,4,5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm5[0,1,2,3,4],ymm1[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm9 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm9[3,1],ymm13[2,1],ymm9[7,5],ymm13[6,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm5[2,3,0,1]
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Reload
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm5 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm5[3,1],ymm13[2,1],ymm5[7,5],ymm13[6,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm5[2,3,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2],ymm5[3,4,5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0,1,2,3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vshufps $247, {{[-0-9]+}}(%r{{[sb]}}p), %xmm12, %xmm2 # 16-byte Folded Reload
; AVX-NEXT:    # xmm2 = xmm12[3,1],mem[3,3]
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm12 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm12[3,1],ymm11[2,1],ymm12[7,5],ymm11[6,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm3[2,3,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2],ymm3[3,4,5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0,1,2,3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[0,1],ymm4[3,1],ymm0[4,5],ymm4[7,5]
; AVX-NEXT:    vshufps $247, {{[-0-9]+}}(%r{{[sb]}}p), %xmm10, %xmm1 # 16-byte Folded Reload
; AVX-NEXT:    # xmm1 = xmm10[3,1],mem[3,3]
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[3,1],ymm6[2,1],ymm2[7,5],ymm6[6,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm2[2,3,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2],ymm2[3,4,5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3,4,5,6,7]
; AVX-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm3[2,3,0,1]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm3[2,0],ymm10[0,0],ymm3[6,4],ymm10[4,4]
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm12 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm12[0,1],ymm15[2,0],ymm12[4,5],ymm15[6,4]
...
; AVX-NEXT:    addq $2600, %rsp # imm = 0xA28
; AVX-NEXT:    vzeroupper
; AVX-NEXT:    retq
;
