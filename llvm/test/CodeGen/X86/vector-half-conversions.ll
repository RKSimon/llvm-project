...
; F16C-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[1,1,1,1,4,5,6,7]
; F16C-NEXT:    vcvtph2ps %xmm0, %xmm0
...
; AVX512F-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[1,1,1,1,4,5,6,7]
...
; AVX512-FASTLANE-NEXT:    vcvtph2ps %xmm0, %xmm1
; AVX512-FASTLANE-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[1,1,1,1,4,5,6,7]
; AVX512-FASTLANE-NEXT:    vcvtph2ps %xmm0, %xmm0
; AVX512-FASTLANE-NEXT:    vinsertps {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[2,3]
