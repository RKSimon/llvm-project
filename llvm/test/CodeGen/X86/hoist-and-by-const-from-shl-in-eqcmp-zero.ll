...
; RUN: llc -mtriple=i686-unknown-linux-gnu -mattr=+sse,sse2,+bmi,+bmi2       < %s | FileCheck %s --check-prefixes=X86,X86-SSE2,X86-BMI2,X86-SSE2-BMI2
; RUN: llc -mtriple=i686-unknown-linux-gnu -mattr=+sse,sse2,+bmi,+bmi2,+avx2 < %s | FileCheck %s --check-prefixes=X86,X86-BMI2,X86-AVX2-BMI2
...
; RUN: llc -mtriple=x86_64-unknown-linux-gnu -mattr=+sse,sse2,+bmi,+bmi2       < %s | FileCheck %s --check-prefixes=X64,X64-SSE2,X64-BMI2,X64-SSE2-BMI2
; RUN: llc -mtriple=x86_64-unknown-linux-gnu -mattr=+sse,sse2,+bmi,+bmi2,+avx2 < %s | FileCheck %s --check-prefixes=X64,X64-BMI2,X64-AVX2-BMI2
...
; X86-SSE2-NEXT:    retl
;
; X86-AVX2-BMI2-LABEL: vec_4xi32_splat_eq:
; X86-AVX2-BMI2:       # %bb.0:
; X86-AVX2-BMI2-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; X86-AVX2-BMI2-NEXT:    vpsrlvd %xmm1, %xmm0, %xmm0
; X86-AVX2-BMI2-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}, %xmm0, %xmm0
; X86-AVX2-BMI2-NEXT:    vpcmpeqd %xmm2, %xmm0, %xmm0
; X86-AVX2-BMI2-NEXT:    retl
;
...
; X64-SSE2-NEXT:    retq
;
; X64-AVX2-BMI2-LABEL: vec_4xi32_splat_eq:
; X64-AVX2-BMI2:       # %bb.0:
; X64-AVX2-BMI2-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; X64-AVX2-BMI2-NEXT:    vpsrlvd %xmm1, %xmm0, %xmm0
; X64-AVX2-BMI2-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; X64-AVX2-BMI2-NEXT:    vpcmpeqd %xmm2, %xmm0, %xmm0
; X64-AVX2-BMI2-NEXT:    retq
...
; X86-SSE2-NEXT:    retl
;
; X86-AVX2-BMI2-LABEL: vec_4xi32_nonsplat_eq:
; X86-AVX2-BMI2:       # %bb.0:
; X86-AVX2-BMI2-NEXT:    vmovdqa {{.*#+}} xmm2 = [0,1,16776960,2147483648]
; X86-AVX2-BMI2-NEXT:    vpsllvd %xmm1, %xmm2, %xmm1
; X86-AVX2-BMI2-NEXT:    vpand %xmm0, %xmm1, %xmm0
; X86-AVX2-BMI2-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; X86-AVX2-BMI2-NEXT:    vpcmpeqd %xmm1, %xmm0, %xmm0
; X86-AVX2-BMI2-NEXT:    retl
;
...
; X64-SSE2-NEXT:    retq
;
; X64-AVX2-BMI2-LABEL: vec_4xi32_nonsplat_eq:
; X64-AVX2-BMI2:       # %bb.0:
; X64-AVX2-BMI2-NEXT:    vmovdqa {{.*#+}} xmm2 = [0,1,16776960,2147483648]
; X64-AVX2-BMI2-NEXT:    vpsllvd %xmm1, %xmm2, %xmm1
; X64-AVX2-BMI2-NEXT:    vpand %xmm0, %xmm1, %xmm0
; X64-AVX2-BMI2-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; X64-AVX2-BMI2-NEXT:    vpcmpeqd %xmm1, %xmm0, %xmm0
; X64-AVX2-BMI2-NEXT:    retq
...
; X86-SSE2-NEXT:    retl
;
; X86-AVX2-BMI2-LABEL: vec_4xi32_nonsplat_undef0_eq:
; X86-AVX2-BMI2:       # %bb.0:
; X86-AVX2-BMI2-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; X86-AVX2-BMI2-NEXT:    vpsrlvd %xmm1, %xmm0, %xmm0
; X86-AVX2-BMI2-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}, %xmm0, %xmm0
...
; X64-SSE2-NEXT:    retq
;
; X64-AVX2-BMI2-LABEL: vec_4xi32_nonsplat_undef0_eq:
; X64-AVX2-BMI2:       # %bb.0:
; X64-AVX2-BMI2-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; X64-AVX2-BMI2-NEXT:    vpsrlvd %xmm1, %xmm0, %xmm0
; X64-AVX2-BMI2-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
...
; X86-SSE2-NEXT:    retl
;
; X86-AVX2-BMI2-LABEL: vec_4xi32_nonsplat_undef1_eq:
; X86-AVX2-BMI2:       # %bb.0:
; X86-AVX2-BMI2-NEXT:    vpbroadcastd {{.*#+}} xmm2 = [1,1,1,1]
; X86-AVX2-BMI2-NEXT:    vpsllvd %xmm1, %xmm2, %xmm1
; X86-AVX2-BMI2-NEXT:    vpand %xmm0, %xmm1, %xmm0
; X86-AVX2-BMI2-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; X86-AVX2-BMI2-NEXT:    vpcmpeqd %xmm1, %xmm0, %xmm0
...
; X64-SSE2-NEXT:    retq
;
; X64-AVX2-BMI2-LABEL: vec_4xi32_nonsplat_undef1_eq:
; X64-AVX2-BMI2:       # %bb.0:
; X64-AVX2-BMI2-NEXT:    vpbroadcastd {{.*#+}} xmm2 = [1,1,1,1]
; X64-AVX2-BMI2-NEXT:    vpsllvd %xmm1, %xmm2, %xmm1
; X64-AVX2-BMI2-NEXT:    vpand %xmm0, %xmm1, %xmm0
; X64-AVX2-BMI2-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; X64-AVX2-BMI2-NEXT:    vpcmpeqd %xmm1, %xmm0, %xmm0
...
; X86-SSE2-NEXT:    retl
;
; X86-AVX2-BMI2-LABEL: vec_4xi32_nonsplat_undef2_eq:
; X86-AVX2-BMI2:       # %bb.0:
; X86-AVX2-BMI2-NEXT:    vpbroadcastd {{.*#+}} xmm2 = [1,1,1,1]
; X86-AVX2-BMI2-NEXT:    vpsllvd %xmm1, %xmm2, %xmm1
; X86-AVX2-BMI2-NEXT:    vpand %xmm0, %xmm1, %xmm0
...
; X64-SSE2-NEXT:    retq
;
; X64-AVX2-BMI2-LABEL: vec_4xi32_nonsplat_undef2_eq:
; X64-AVX2-BMI2:       # %bb.0:
; X64-AVX2-BMI2-NEXT:    vpbroadcastd {{.*#+}} xmm2 = [1,1,1,1]
; X64-AVX2-BMI2-NEXT:    vpsllvd %xmm1, %xmm2, %xmm1
; X64-AVX2-BMI2-NEXT:    vpand %xmm0, %xmm1, %xmm0
