...
; AVX512-NEXT:    vshufps {{.*#+}} xmm2 = xmm0[0,2],xmm1[0,2]
...
; AVX512-FCP-NEXT:    vshufps {{.*#+}} xmm2 = xmm0[0,2],xmm1[0,2]
; AVX512-FCP-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,3],xmm1[1,3]
...
; AVX512DQ-NEXT:    vshufps {{.*#+}} xmm2 = xmm0[0,2],xmm1[0,2]
; AVX512DQ-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,3],xmm1[1,3]
...
; AVX512DQ-FCP-NEXT:    vshufps {{.*#+}} xmm2 = xmm0[0,2],xmm1[0,2]
; AVX512DQ-FCP-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,3],xmm1[1,3]
...
; AVX512BW-NEXT:    vshufps {{.*#+}} xmm2 = xmm0[0,2],xmm1[0,2]
...
; AVX512BW-FCP-NEXT:    vshufps {{.*#+}} xmm2 = xmm0[0,2],xmm1[0,2]
; AVX512BW-FCP-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,3],xmm1[1,3]
...
; AVX512DQ-BW-NEXT:    vshufps {{.*#+}} xmm2 = xmm0[0,2],xmm1[0,2]
; AVX512DQ-BW-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,3],xmm1[1,3]
...
; AVX512DQ-BW-FCP-NEXT:    vshufps {{.*#+}} xmm2 = xmm0[0,2],xmm1[0,2]
; AVX512DQ-BW-FCP-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,3],xmm1[1,3]
...
; AVX512-FCP:       # %bb.0:
; AVX512-FCP-NEXT:    vmovaps {{.*#+}} ymm0 = [0,2,4,6,8,10,12,14]
; AVX512-FCP-NEXT:    vmovaps (%rdi), %ymm1
; AVX512-FCP-NEXT:    vmovaps 32(%rdi), %ymm2
; AVX512-FCP-NEXT:    vpermi2ps %ymm2, %ymm1, %ymm0
; AVX512-FCP-NEXT:    vmovaps {{.*#+}} ymm3 = [1,3,5,7,9,11,13,15]
; AVX512-FCP-NEXT:    vpermi2ps %ymm2, %ymm1, %ymm3
; AVX512-FCP-NEXT:    vmovaps %ymm0, (%rsi)
; AVX512-FCP-NEXT:    vmovaps %ymm3, (%rdx)
...
; AVX512DQ-NEXT:    vshufps {{.*#+}} ymm2 = ymm0[0,2],ymm1[0,2],ymm0[4,6],ymm1[4,6]
; AVX512DQ-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,2,1,3]
; AVX512DQ-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm1[1,3],ymm0[5,7],ymm1[5,7]
...
; AVX512DQ-FCP:       # %bb.0:
; AVX512DQ-FCP-NEXT:    vmovaps {{.*#+}} ymm0 = [0,2,4,6,8,10,12,14]
; AVX512DQ-FCP-NEXT:    vmovaps (%rdi), %ymm1
; AVX512DQ-FCP-NEXT:    vmovaps 32(%rdi), %ymm2
; AVX512DQ-FCP-NEXT:    vpermi2ps %ymm2, %ymm1, %ymm0
; AVX512DQ-FCP-NEXT:    vmovaps {{.*#+}} ymm3 = [1,3,5,7,9,11,13,15]
; AVX512DQ-FCP-NEXT:    vpermi2ps %ymm2, %ymm1, %ymm3
; AVX512DQ-FCP-NEXT:    vmovaps %ymm0, (%rsi)
; AVX512DQ-FCP-NEXT:    vmovaps %ymm3, (%rdx)
...
; AVX512BW-NEXT:    vshufps {{.*#+}} ymm2 = ymm0[0,2],ymm1[0,2],ymm0[4,6],ymm1[4,6]
...
; AVX512BW-FCP:       # %bb.0:
; AVX512BW-FCP-NEXT:    vmovaps {{.*#+}} ymm0 = [0,2,4,6,8,10,12,14]
; AVX512BW-FCP-NEXT:    vmovaps (%rdi), %ymm1
; AVX512BW-FCP-NEXT:    vmovaps 32(%rdi), %ymm2
; AVX512BW-FCP-NEXT:    vpermi2ps %ymm2, %ymm1, %ymm0
; AVX512BW-FCP-NEXT:    vmovaps {{.*#+}} ymm3 = [1,3,5,7,9,11,13,15]
; AVX512BW-FCP-NEXT:    vpermi2ps %ymm2, %ymm1, %ymm3
; AVX512BW-FCP-NEXT:    vmovaps %ymm0, (%rsi)
; AVX512BW-FCP-NEXT:    vmovaps %ymm3, (%rdx)
...
; AVX512DQ-BW-NEXT:    vshufps {{.*#+}} ymm2 = ymm0[0,2],ymm1[0,2],ymm0[4,6],ymm1[4,6]
; AVX512DQ-BW-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,2,1,3]
; AVX512DQ-BW-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm1[1,3],ymm0[5,7],ymm1[5,7]
...
; AVX512DQ-BW-FCP:       # %bb.0:
; AVX512DQ-BW-FCP-NEXT:    vmovaps {{.*#+}} ymm0 = [0,2,4,6,8,10,12,14]
; AVX512DQ-BW-FCP-NEXT:    vmovaps (%rdi), %ymm1
; AVX512DQ-BW-FCP-NEXT:    vmovaps 32(%rdi), %ymm2
; AVX512DQ-BW-FCP-NEXT:    vpermi2ps %ymm2, %ymm1, %ymm0
; AVX512DQ-BW-FCP-NEXT:    vmovaps {{.*#+}} ymm3 = [1,3,5,7,9,11,13,15]
; AVX512DQ-BW-FCP-NEXT:    vpermi2ps %ymm2, %ymm1, %ymm3
; AVX512DQ-BW-FCP-NEXT:    vmovaps %ymm0, (%rsi)
; AVX512DQ-BW-FCP-NEXT:    vmovaps %ymm3, (%rdx)
...
; AVX-NEXT:    vinsertf128 $1, 32(%rdi), %ymm0, %ymm0
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm0[0,2],ymm2[0,2],ymm0[4,6],ymm2[4,6]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm1[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 96(%rdi), %ymm1, %ymm1
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm1[0,2],ymm4[0,2],ymm1[4,6],ymm4[4,6]
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm2[1,3],ymm0[5,7],ymm2[5,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[1,3],ymm4[1,3],ymm1[5,7],ymm4[5,7]
...
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm4 = ymm0[0,2],ymm1[0,2],ymm0[4,6],ymm1[4,6]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm4[0,2,1,3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm5 = ymm2[0,2],ymm3[0,2],ymm2[4,6],ymm3[4,6]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,2,1,3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm1[1,3],ymm0[5,7],ymm1[5,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,2,1,3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm1 = ymm2[1,3],ymm3[1,3],ymm2[5,7],ymm3[5,7]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm4 = ymm0[0,2],ymm1[0,2],ymm0[4,6],ymm1[4,6]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm4[0,2,1,3]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm5 = ymm2[0,2],ymm3[0,2],ymm2[4,6],ymm3[4,6]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,2,1,3]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm1[1,3],ymm0[5,7],ymm1[5,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,2,1,3]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm1 = ymm2[1,3],ymm3[1,3],ymm2[5,7],ymm3[5,7]
...
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm2[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 160(%rdi), %ymm2, %ymm2
; AVX-NEXT:    vshufps {{.*#+}} ymm7 = ymm2[0,2],ymm6[0,2],ymm2[4,6],ymm6[4,6]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm1[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 96(%rdi), %ymm1, %ymm1
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm1[0,2],ymm8[0,2],ymm1[4,6],ymm8[4,6]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm3[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 224(%rdi), %ymm3, %ymm3
; AVX-NEXT:    vshufps {{.*#+}} ymm11 = ymm3[0,2],ymm10[0,2],ymm3[4,6],ymm10[4,6]
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm4[1,3],ymm0[5,7],ymm4[5,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[1,3],ymm8[1,3],ymm1[5,7],ymm8[5,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[1,3],ymm6[1,3],ymm2[5,7],ymm6[5,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[1,3],ymm10[1,3],ymm3[5,7],ymm10[5,7]
...
; AVX2-NEXT:    vshufps {{.*#+}} ymm10 = ymm0[0,2],ymm1[0,2],ymm0[4,6],ymm1[4,6]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,2,1,3]
; AVX2-NEXT:    vshufps {{.*#+}} ymm11 = ymm2[0,2],ymm3[0,2],ymm2[4,6],ymm3[4,6]
...
; AVX2-NEXT:    vmovaps %ymm11, 32(%rsi)
...
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm10 = ymm0[0,2],ymm1[0,2],ymm0[4,6],ymm1[4,6]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,2,1,3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm11 = ymm2[0,2],ymm3[0,2],ymm2[4,6],ymm3[4,6]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm10 = ymm0[0,2],ymm1[0,2],ymm0[4,6],ymm1[4,6]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,2,1,3]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm11 = ymm2[0,2],ymm3[0,2],ymm2[4,6],ymm3[4,6]
...
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm1[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 32(%rdi), %ymm1, %ymm9
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm9[0,2],ymm8[0,2],ymm9[4,6],ymm8[4,6]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm2[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 160(%rdi), %ymm2, %ymm11
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm11[0,2],ymm10[0,2],ymm11[4,6],ymm10[4,6]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm12 = ymm4[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 288(%rdi), %ymm4, %ymm13
; AVX-NEXT:    vshufps {{.*#+}} ymm4 = ymm13[0,2],ymm12[0,2],ymm13[4,6],ymm12[4,6]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm14 = ymm5[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 416(%rdi), %ymm5, %ymm15
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm6[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 96(%rdi), %ymm6, %ymm6
; AVX-NEXT:    vshufps {{.*#+}} ymm8 = ymm9[1,3],ymm8[1,3],ymm9[5,7],ymm8[5,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm6[0,2],ymm5[0,2],ymm6[4,6],ymm5[4,6]
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm6[1,3],ymm5[1,3],ymm6[5,7],ymm5[5,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm7[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 224(%rdi), %ymm7, %ymm7
; AVX-NEXT:    vshufps {{.*#+}} ymm10 = ymm11[1,3],ymm10[1,3],ymm11[5,7],ymm10[5,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm11 = ymm7[0,2],ymm6[0,2],ymm7[4,6],ymm6[4,6]
; AVX-NEXT:    vshufps {{.*#+}} ymm6 = ymm7[1,3],ymm6[1,3],ymm7[5,7],ymm6[5,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm3[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 352(%rdi), %ymm3, %ymm3
; AVX-NEXT:    vshufps {{.*#+}} ymm12 = ymm13[1,3],ymm12[1,3],ymm13[5,7],ymm12[5,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm13 = ymm3[0,2],ymm7[0,2],ymm3[4,6],ymm7[4,6]
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[1,3],ymm7[1,3],ymm3[5,7],ymm7[5,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm7 = ymm15[0,2],ymm14[0,2],ymm15[4,6],ymm14[4,6]
; AVX-NEXT:    vshufps {{.*#+}} ymm14 = ymm15[1,3],ymm14[1,3],ymm15[5,7],ymm14[5,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm0[2,3],mem[2,3]
; AVX-NEXT:    vinsertf128 $1, 480(%rdi), %ymm0, %ymm0
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm0[0,2],ymm15[0,2],ymm0[4,6],ymm15[4,6]
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm15[1,3],ymm0[5,7],ymm15[5,7]
; AVX-NEXT:    vmovaps %ymm1, 224(%rsi)
; AVX-NEXT:    vmovaps %ymm13, 160(%rsi)
; AVX-NEXT:    vmovaps %ymm11, 96(%rsi)
; AVX-NEXT:    vmovaps %ymm9, 32(%rsi)
...
; AVX-NEXT:    vmovaps %ymm14, 192(%rdx)
...
; AVX2-NEXT:    vshufps {{.*#+}} ymm1 = ymm15[0,2],ymm3[0,2],ymm15[4,6],ymm3[4,6]
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vshufps {{.*#+}} ymm3 = ymm15[1,3],ymm3[1,3],ymm15[5,7],ymm3[5,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm15 = ymm8[0,2],ymm5[0,2],ymm8[4,6],ymm5[4,6]
; AVX2-NEXT:    vshufps {{.*#+}} ymm5 = ymm8[1,3],ymm5[1,3],ymm8[5,7],ymm5[5,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm1 = ymm14[0,2],ymm13[0,2],ymm14[4,6],ymm13[4,6]
; AVX2-NEXT:    vshufps {{.*#+}} ymm8 = ymm14[1,3],ymm13[1,3],ymm14[5,7],ymm13[5,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm13 = ymm10[0,2],ymm9[0,2],ymm10[4,6],ymm9[4,6]
; AVX2-NEXT:    vshufps {{.*#+}} ymm9 = ymm10[1,3],ymm9[1,3],ymm10[5,7],ymm9[5,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm10 = ymm12[0,2],ymm11[0,2],ymm12[4,6],ymm11[4,6]
; AVX2-NEXT:    vshufps {{.*#+}} ymm11 = ymm12[1,3],ymm11[1,3],ymm12[5,7],ymm11[5,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm12 = ymm7[0,2],ymm6[0,2],ymm7[4,6],ymm6[4,6]
; AVX2-NEXT:    vshufps {{.*#+}} ymm6 = ymm7[1,3],ymm6[1,3],ymm7[5,7],ymm6[5,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm7 = ymm2[0,2],ymm4[0,2],ymm2[4,6],ymm4[4,6]
; AVX2-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[1,3],ymm4[1,3],ymm2[5,7],ymm4[5,7]
; AVX2-NEXT:    vmovaps 96(%rdi), %ymm4
; AVX2-NEXT:    vshufps {{.*#+}} ymm14 = ymm0[0,2],ymm4[0,2],ymm0[4,6],ymm4[4,6]
; AVX2-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm4[1,3],ymm0[5,7],ymm4[5,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm12[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm4, 224(%rsi)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm4, 160(%rsi)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm15[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm4, 96(%rsi)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm14[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm4, 32(%rsi)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm10[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm4, 192(%rsi)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm1, 128(%rsi)
; AVX2-NEXT:    vpermpd $216, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm1 = mem[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm1, 64(%rsi)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm7[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm1, (%rsi)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm6[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm1, 224(%rdx)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm11[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm1, 192(%rdx)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm9[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm1, 160(%rdx)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm8[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm1, 128(%rdx)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm5[0,2,1,3]
; AVX2-NEXT:    vmovaps %ymm1, 96(%rdx)
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm3[0,2,1,3]
...
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm1 = ymm15[0,2],ymm3[0,2],ymm15[4,6],ymm3[4,6]
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm3 = ymm15[1,3],ymm3[1,3],ymm15[5,7],ymm3[5,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm15 = ymm8[0,2],ymm5[0,2],ymm8[4,6],ymm5[4,6]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm5 = ymm8[1,3],ymm5[1,3],ymm8[5,7],ymm5[5,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm1 = ymm14[0,2],ymm13[0,2],ymm14[4,6],ymm13[4,6]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm8 = ymm14[1,3],ymm13[1,3],ymm14[5,7],ymm13[5,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm13 = ymm10[0,2],ymm9[0,2],ymm10[4,6],ymm9[4,6]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm9 = ymm10[1,3],ymm9[1,3],ymm10[5,7],ymm9[5,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm10 = ymm12[0,2],ymm11[0,2],ymm12[4,6],ymm11[4,6]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm11 = ymm12[1,3],ymm11[1,3],ymm12[5,7],ymm11[5,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm12 = ymm7[0,2],ymm6[0,2],ymm7[4,6],ymm6[4,6]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm6 = ymm7[1,3],ymm6[1,3],ymm7[5,7],ymm6[5,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm7 = ymm2[0,2],ymm4[0,2],ymm2[4,6],ymm4[4,6]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[1,3],ymm4[1,3],ymm2[5,7],ymm4[5,7]
; AVX2-FP-NEXT:    vmovaps 96(%rdi), %ymm4
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm14 = ymm0[0,2],ymm4[0,2],ymm0[4,6],ymm4[4,6]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm4[1,3],ymm0[5,7],ymm4[5,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm12[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm4, 224(%rsi)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm4, 160(%rsi)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm15[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm4, 96(%rsi)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm14[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm4, 32(%rsi)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm10[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm4, 192(%rsi)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm1, 128(%rsi)
; AVX2-FP-NEXT:    vpermpd $216, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm1 = mem[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm1, 64(%rsi)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm7[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm1, (%rsi)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm6[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm1, 224(%rdx)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm11[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm1, 192(%rdx)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm9[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm1, 160(%rdx)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm8[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm1, 128(%rdx)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm5[0,2,1,3]
; AVX2-FP-NEXT:    vmovaps %ymm1, 96(%rdx)
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm3[0,2,1,3]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm1 = ymm15[0,2],ymm3[0,2],ymm15[4,6],ymm3[4,6]
; AVX2-FCP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm3 = ymm15[1,3],ymm3[1,3],ymm15[5,7],ymm3[5,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm15 = ymm8[0,2],ymm5[0,2],ymm8[4,6],ymm5[4,6]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm5 = ymm8[1,3],ymm5[1,3],ymm8[5,7],ymm5[5,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm1 = ymm14[0,2],ymm13[0,2],ymm14[4,6],ymm13[4,6]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm8 = ymm14[1,3],ymm13[1,3],ymm14[5,7],ymm13[5,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm13 = ymm10[0,2],ymm9[0,2],ymm10[4,6],ymm9[4,6]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm9 = ymm10[1,3],ymm9[1,3],ymm10[5,7],ymm9[5,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm10 = ymm12[0,2],ymm11[0,2],ymm12[4,6],ymm11[4,6]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm11 = ymm12[1,3],ymm11[1,3],ymm12[5,7],ymm11[5,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm12 = ymm7[0,2],ymm6[0,2],ymm7[4,6],ymm6[4,6]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm6 = ymm7[1,3],ymm6[1,3],ymm7[5,7],ymm6[5,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm7 = ymm2[0,2],ymm4[0,2],ymm2[4,6],ymm4[4,6]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[1,3],ymm4[1,3],ymm2[5,7],ymm4[5,7]
; AVX2-FCP-NEXT:    vmovaps 96(%rdi), %ymm4
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm14 = ymm0[0,2],ymm4[0,2],ymm0[4,6],ymm4[4,6]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm4[1,3],ymm0[5,7],ymm4[5,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm12[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm4, 224(%rsi)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm4, 160(%rsi)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm15[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm4, 96(%rsi)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm14[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm4, 32(%rsi)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm10[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm4, 192(%rsi)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm1, 128(%rsi)
; AVX2-FCP-NEXT:    vpermpd $216, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm1 = mem[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm1, 64(%rsi)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm7[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm1, (%rsi)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm6[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm1, 224(%rdx)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm11[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm1, 192(%rdx)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm9[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm1, 160(%rdx)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm8[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm1, 128(%rdx)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm5[0,2,1,3]
; AVX2-FCP-NEXT:    vmovaps %ymm1, 96(%rdx)
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm3[0,2,1,3]
...
; AVX512-FCP-NEXT:    vpermt2d %zmm1, %zmm8, %zmm11
...
; AVX512DQ-NEXT:    vpermt2d %zmm1, %zmm8, %zmm11
...
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm1, %zmm8, %zmm11
...
; AVX512BW-FCP-NEXT:    vpermt2d %zmm1, %zmm8, %zmm11
...
; AVX512DQ-BW-NEXT:    vpermt2d %zmm1, %zmm8, %zmm11
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm1, %zmm8, %zmm11
