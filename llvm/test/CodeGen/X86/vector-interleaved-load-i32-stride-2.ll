...
; AVX512DQ-FCP:       # %bb.0:
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm0 = [0,2,4,6,8,10,12,14]
...
; AVX512DQ-FCP-NEXT:    vpermps %zmm1, %zmm2, %zmm1
...
; AVX512BW-FCP:       # %bb.0:
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm0 = [0,2,4,6,8,10,12,14]
...
; AVX512BW-FCP-NEXT:    vpermps %zmm1, %zmm2, %zmm1
...
; AVX512DQ-BW-FCP:       # %bb.0:
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm0 = [0,2,4,6,8,10,12,14]
...
; AVX512DQ-BW-FCP-NEXT:    vpermps %zmm1, %zmm2, %zmm1
