...
; AVX512F-NEXT:    vpmovsxbq {{.*#+}} zmm1 = [1,0,0,1,0,1,2,3]
...
; AVX512BW-NEXT:    vpmovsxbq {{.*#+}} zmm1 = [1,0,0,1,0,1,2,3]
...
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    vbroadcasti128 {{.*#+}} ymm0 = mem[0,1,0,1]
; AVX512F-NEXT:    vpmovsxbq {{.*#+}} zmm1 = [0,1,2,3,0,1,1,0]
; AVX512F-NEXT:    vpermq %zmm0, %zmm1, %zmm0
; AVX512F-NEXT:    vmovdqa64 %zmm0, (%rsi)
; AVX512F-NEXT:    vzeroupper
; AVX512F-NEXT:    retq
...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vbroadcasti128 {{.*#+}} ymm0 = mem[0,1,0,1]
; AVX512BW-NEXT:    vpmovsxbq {{.*#+}} zmm1 = [0,1,2,3,0,1,1,0]
; AVX512BW-NEXT:    vpermq %zmm0, %zmm1, %zmm0
; AVX512BW-NEXT:    vmovdqa64 %zmm0, (%rsi)
; AVX512BW-NEXT:    vzeroupper
; AVX512BW-NEXT:    retq
