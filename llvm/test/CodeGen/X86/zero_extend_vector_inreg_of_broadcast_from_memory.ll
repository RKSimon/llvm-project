...
; AVX-NEXT:    vpblendw {{.*#+}} xmm3 = xmm0[0],mem[1,2],xmm0[3],mem[4,5],xmm0[6],mem[7]
; AVX-NEXT:    vpaddb (%rsi), %xmm3, %xmm3
; AVX-NEXT:    vpblendw {{.*#+}} xmm0 = xmm1[0],xmm0[1],xmm1[2,3],xmm0[4],xmm1[5,6],xmm0[7]
; AVX-NEXT:    vpaddb 16(%rsi), %xmm0, %xmm0
; AVX-NEXT:    vpaddb 32(%rsi), %xmm2, %xmm1
; AVX-NEXT:    vmovdqa %xmm1, 32(%rdx)
; AVX-NEXT:    vmovdqa %xmm0, 16(%rdx)
; AVX-NEXT:    vmovdqa %xmm3, (%rdx)
; AVX-NEXT:    retq
;
...
; AVX-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0],mem[1,2,3],xmm0[4],mem[5,6,7]
; AVX-NEXT:    vpaddb (%rsi), %xmm0, %xmm0
; AVX-NEXT:    vpaddb 16(%rsi), %xmm1, %xmm2
...
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm0[0,2,1,3,4,6,5,7]
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0],zero,xmm1[0],zero
; AVX-NEXT:    vpaddb (%rsi), %xmm2, %xmm2
; AVX-NEXT:    vextractf128 $1, %ymm0, %xmm0
...
; AVX-NEXT:    vmovss {{.*#+}} xmm2 = xmm0[0],xmm1[1,2,3]
; AVX-NEXT:    vmovaps 48(%rdi), %xmm3
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm0[0],ymm3[1,2,3],ymm0[4,5,6,7]
; AVX-NEXT:    vpaddb (%rsi), %xmm3, %xmm3
