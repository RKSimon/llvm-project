...
; AVX512-FAST-NEXT:    vhaddpd %xmm1, %xmm0, %xmm0
; AVX512-FAST-NEXT:    vextractf128 $1, %ymm1, %xmm1
; AVX512-FAST-NEXT:    vhaddpd %xmm1, %xmm1, %xmm1
; AVX512-FAST-NEXT:    vpmovsxbq {{.*#+}} ymm2 = [0,0,1,8]
; AVX512-FAST-NEXT:    vpermt2pd %zmm1, %zmm2, %zmm0
; AVX512-FAST-NEXT:    # kill: def $ymm0 killed $ymm0 killed $zmm0
...
; AVX512-FAST-NEXT:    vextractf128 $1, %ymm1, %xmm1
; AVX512-FAST-NEXT:    vhaddpd %xmm1, %xmm1, %xmm1
; AVX512-FAST-NEXT:    vpmovsxbq {{.*#+}} ymm2 = [0,1,1,8]
; AVX512-FAST-NEXT:    vpermt2pd %zmm1, %zmm2, %zmm0
; AVX512-FAST-NEXT:    # kill: def $ymm0 killed $ymm0 killed $zmm0
; AVX512-FAST-NEXT:    retq
