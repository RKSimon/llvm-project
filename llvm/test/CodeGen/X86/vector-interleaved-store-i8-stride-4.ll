...
; AVX512BW-NEXT:    vextracti64x4 $1, %zmm0, %ymm8
...
; AVX512BW-FCP-NEXT:    vinserti128 $1, %xmm7, %ymm6, %ymm6
; AVX512BW-FCP-NEXT:    vextracti64x4 $1, %zmm4, %ymm7
; AVX512BW-FCP-NEXT:    vextracti64x4 $1, %zmm0, %ymm8
; AVX512BW-FCP-NEXT:    vinserti128 $1, %xmm8, %ymm7, %ymm7
...
; AVX512DQ-BW-NEXT:    vextracti64x4 $1, %zmm4, %ymm7
; AVX512DQ-BW-NEXT:    vextracti64x4 $1, %zmm0, %ymm8
...
; AVX512DQ-BW-FCP-NEXT:    vinserti128 $1, %xmm7, %ymm6, %ymm6
; AVX512DQ-BW-FCP-NEXT:    vextracti64x4 $1, %zmm4, %ymm7
; AVX512DQ-BW-FCP-NEXT:    vextracti64x4 $1, %zmm0, %ymm8
; AVX512DQ-BW-FCP-NEXT:    vinserti128 $1, %xmm8, %ymm7, %ymm7
