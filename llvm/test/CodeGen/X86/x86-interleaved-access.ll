...
; AVX512-NEXT:    vpsrlw $8, %ymm1, %ymm2
; AVX512-NEXT:    vpmovwb %zmm2, %ymm2
; AVX512-NEXT:    vinserti128 $1, %xmm0, %ymm1, %ymm3
; AVX512-NEXT:    vpmovdw %zmm3, %ymm4
; AVX512-NEXT:    vpaddb %xmm2, %xmm4, %xmm2
; AVX512-NEXT:    vpmovsxbw {{.*#+}} xmm4 = [3,7,11,15,7,15,6,7]
; AVX512-NEXT:    vpshufb %xmm4, %xmm0, %xmm0
; AVX512-NEXT:    vpshufb %xmm4, %xmm1, %xmm1
; AVX512-NEXT:    vpunpcklqdq {{.*#+}} xmm0 = xmm1[0],xmm0[0]
; AVX512-NEXT:    vpsrld $16, %ymm3, %ymm1
