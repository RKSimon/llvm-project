...
; AVX1-NEXT:    vpaddb 48(%rsi), %xmm2, %xmm2
; AVX1-NEXT:    vpaddb (%rsi), %xmm0, %xmm0
; AVX1-NEXT:    vinsertf128 $1, %xmm0, %ymm0, %ymm3
; AVX1-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0],ymm2[1,2,3],ymm3[4,5,6,7]
; AVX1-NEXT:    vpaddb (%rdx), %xmm2, %xmm2
; AVX1-NEXT:    vpaddb 16(%rdx), %xmm0, %xmm3
; AVX1-NEXT:    vpaddb 32(%rdx), %xmm0, %xmm0
; AVX1-NEXT:    vpaddb 48(%rdx), %xmm1, %xmm1
...
; AVX1-NEXT:    vpaddb (%rsi), %xmm0, %xmm0
; AVX1-NEXT:    vinsertf128 $1, %xmm0, %ymm0, %ymm3
; AVX1-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0,1],ymm2[2,3],ymm3[4,5,6,7]
; AVX1-NEXT:    vpaddb (%rdx), %xmm2, %xmm2
; AVX1-NEXT:    vpaddb 16(%rdx), %xmm0, %xmm3
; AVX1-NEXT:    vpaddb 32(%rdx), %xmm0, %xmm0
; AVX1-NEXT:    vpaddb 48(%rdx), %xmm1, %xmm1
...
; AVX1-NEXT:    vpaddb 16(%rdx), %xmm1, %xmm3
; AVX1-NEXT:    vpaddb 32(%rdx), %xmm0, %xmm0
; AVX1-NEXT:    vpaddb 48(%rdx), %xmm1, %xmm1
; AVX1-NEXT:    vmovdqa %xmm1, 48(%rcx)
; AVX1-NEXT:    vmovdqa %xmm0, 32(%rcx)
