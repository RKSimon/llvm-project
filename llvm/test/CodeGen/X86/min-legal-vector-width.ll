...
; CHECK-SKX-NOVBMI-NEXT:    vpand %ymm4, %ymm2, %ymm5
; CHECK-SKX-NOVBMI-NEXT:    vpmaddubsw %ymm5, %ymm0, %ymm5
...
; CHECK-SKX-NOVBMI-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm0 | (ymm5 & ymm4)
; CHECK-SKX-NOVBMI-NEXT:    vpand %ymm4, %ymm3, %ymm2
; CHECK-SKX-NOVBMI-NEXT:    vpmaddubsw %ymm2, %ymm1, %ymm2
...
; CHECK-SKX-NOVBMI-NEXT:    vpternlogq {{.*#+}} ymm1 = ymm1 | (ymm2 & ymm4)
...
; CHECK-SKX-VBMI-NEXT:    vpermt2b %ymm5, %ymm2, %ymm0
...
; CHECK-SKX-VBMI-NEXT:    vpermt2b %ymm5, %ymm2, %ymm1
...
; CHECK-AVX512-NEXT:    vpand %ymm4, %ymm2, %ymm5
; CHECK-AVX512-NEXT:    vpmaddubsw %ymm5, %ymm0, %ymm5
; CHECK-AVX512-NEXT:    vpandn %ymm2, %ymm4, %ymm2
; CHECK-AVX512-NEXT:    vpmaddubsw %ymm2, %ymm0, %ymm0
; CHECK-AVX512-NEXT:    vpsllw $8, %ymm0, %ymm0
; CHECK-AVX512-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm0 | (ymm5 & ymm4)
; CHECK-AVX512-NEXT:    vpand %ymm4, %ymm3, %ymm2
; CHECK-AVX512-NEXT:    vpmaddubsw %ymm2, %ymm1, %ymm2
; CHECK-AVX512-NEXT:    vpandn %ymm3, %ymm4, %ymm3
; CHECK-AVX512-NEXT:    vpmaddubsw %ymm3, %ymm1, %ymm1
; CHECK-AVX512-NEXT:    vpsllw $8, %ymm1, %ymm1
; CHECK-AVX512-NEXT:    vpternlogq {{.*#+}} ymm1 = ymm1 | (ymm2 & ymm4)
...
; CHECK-VBMI-NEXT:    vpermt2b %ymm5, %ymm2, %ymm0
...
; CHECK-VBMI-NEXT:    vpermt2b %ymm5, %ymm2, %ymm1
