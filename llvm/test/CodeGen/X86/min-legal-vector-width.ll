...
; CHECK-AVX512-NEXT:    vpand %ymm2, %ymm4, %ymm5
...
; CHECK-AVX512-NEXT:    vpternlogq $248, %ymm4, %ymm5, %ymm0
; CHECK-AVX512-NEXT:    vpand %ymm3, %ymm4, %ymm2
...
; CHECK-AVX512-NEXT:    vpternlogq $248, %ymm4, %ymm2, %ymm1
