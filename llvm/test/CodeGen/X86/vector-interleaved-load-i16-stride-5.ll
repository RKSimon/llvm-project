...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm0 = ymm12[0],ymm3[1,2],ymm12[3],ymm3[4],ymm12[5],ymm3[6,7],ymm12[8],ymm3[9,10],ymm12[11],ymm3[12],ymm12[13],ymm3[14,15]
...
; AVX2-NEXT:    vextracti128 $1, %ymm11, %xmm13
; AVX2-NEXT:    vpblendw {{.*#+}} xmm11 = xmm11[0,1],xmm13[2,3],xmm11[4,5,6],xmm13[7]
; AVX2-NEXT:    vmovdqa 304(%rdi), %xmm1
; AVX2-NEXT:    vpshufb %xmm14, %xmm11, %xmm11
; AVX2-NEXT:    vmovdqa 288(%rdi), %xmm14
; AVX2-NEXT:    vpblendvb %ymm9, %ymm11, %ymm10, %ymm9
; AVX2-NEXT:    vpblendd {{.*#+}} xmm10 = xmm14[0],xmm1[1],xmm14[2,3]
...
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm8 = ymm10[0],ymm12[1,2],ymm10[3],ymm12[4],ymm10[5],ymm12[6,7],ymm10[8],ymm12[9,10],ymm10[11],ymm12[12],ymm10[13],ymm12[14,15]
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm14 = xmm3[0],xmm2[1],xmm3[2,3]
; AVX2-FP-NEXT:    vmovdqa %xmm3, %xmm4
; AVX2-FP-NEXT:    vmovdqa %xmm2, %xmm3
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm9 = ymm2[0],ymm4[1],ymm2[2,3],ymm4[4],ymm2[5],ymm4[6],ymm2[7,8],ymm4[9],ymm2[10,11],ymm4[12],ymm2[13],ymm4[14],ymm2[15]
...
; AVX512-NEXT:    vpternlogq $184, %zmm15, %zmm18, %zmm6
...
; AVX512-NEXT:    vpshufb %xmm14, %xmm13, %xmm13
; AVX512-NEXT:    vpternlogq $228, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm6
...
; AVX512-NEXT:    vpternlogq $184, %zmm6, %zmm18, %zmm11
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm12, %zmm16, %zmm13
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm4, %zmm16, %zmm13
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm4, %zmm16, %zmm11
...
; AVX512-FCP-NEXT:    vpternlogq $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm4, %zmm11
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm15, %zmm18, %zmm6
...
; AVX512DQ-NEXT:    vpshufb %xmm14, %xmm13, %xmm13
; AVX512DQ-NEXT:    vpternlogq $228, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm6
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm6, %zmm18, %zmm11
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm12, %zmm16, %zmm13
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm4, %zmm16, %zmm13
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm4, %zmm16, %zmm11
...
; AVX512DQ-FCP-NEXT:    vpternlogq $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm4, %zmm11
...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm3 = ymm6[0],ymm9[1],ymm6[2,3],ymm9[4],ymm6[5],ymm9[6],ymm6[7,8],ymm9[9],ymm6[10,11],ymm9[12],ymm6[13],ymm9[14],ymm6[15]
...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm2 = ymm7[0],ymm4[1,2],ymm7[3],ymm4[4],ymm7[5],ymm4[6,7],ymm7[8],ymm4[9,10],ymm7[11],ymm4[12],ymm7[13],ymm4[14,15]
...
; AVX2-NEXT:    vpblendd {{.*#+}} xmm8 = xmm2[0],xmm4[1],xmm2[2,3]
...
; AVX2-NEXT:    vpblendd {{.*#+}} xmm10 = xmm9[0],xmm5[1],xmm9[2,3]
...
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm4[0],ymm9[1,2],ymm4[3],ymm9[4],ymm4[5],ymm9[6,7],ymm4[8],ymm9[9,10],ymm4[11],ymm9[12],ymm4[13],ymm9[14,15]
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm7 = xmm0[0],xmm3[1],xmm0[2,3]
; AVX2-FP-NEXT:    vmovdqa %xmm3, %xmm12
; AVX2-FP-NEXT:    vmovdqa %xmm0, %xmm10
...
; AVX2-FP-NEXT:    vmovdqu %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovdqa 624(%rdi), %xmm3
; AVX2-FP-NEXT:    vmovdqa 608(%rdi), %xmm5
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm7 = xmm5[0],xmm3[1],xmm5[2,3]
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm7[4,5,6,7]
; AVX2-FP-NEXT:    vmovdqu %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovdqa 464(%rdi), %xmm3
...
; AVX512-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; AVX512-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vpblendd {{.*#+}} xmm0 = xmm3[0],xmm10[1],xmm3[2,3]
...
; AVX512-NEXT:    vpternlogq $184, %zmm22, %zmm25, %zmm8
...
; AVX512-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX512-NEXT:    vpternlogq $184, %zmm21, %zmm25, %zmm2
; AVX512-NEXT:    vinserti64x4 $1, %ymm0, %zmm2, %zmm0
; AVX512-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512-NEXT:    vpternlogq $184, %zmm2, %zmm25, %zmm12
...
; AVX512-NEXT:    vinserti128 $1, %xmm8, %ymm0, %ymm8
; AVX512-NEXT:    vpternlogq $184, %zmm2, %zmm25, %zmm8
...
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm10 = [8,9,2,3,12,13,u,u,8,9,14,15,0,1,6,7,16,17,22,23,20,21,22,23,24,25,30,31,16,17,22,23]
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm5, %zmm30, %zmm8
...
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm5[0],ymm7[1,2],ymm5[3],ymm7[4],ymm5[5],ymm7[6,7],ymm5[8],ymm7[9,10],ymm5[11],ymm7[12],ymm5[13],ymm7[14,15]
...
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm7[0],ymm4[1],ymm7[2,3],ymm4[4],ymm7[5],ymm4[6],ymm7[7,8],ymm4[9],ymm7[10,11],ymm4[12],ymm7[13],ymm4[14],ymm7[15]
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm18, %zmm30, %zmm5
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm2, %zmm30, %zmm1
...
; AVX512DQ-NEXT:    vmovdqa %xmm2, %xmm7
...
; AVX512DQ-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; AVX512DQ-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vpblendd {{.*#+}} xmm0 = xmm3[0],xmm10[1],xmm3[2,3]
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm22, %zmm25, %zmm8
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX512DQ-NEXT:    vpternlogq $184, %zmm21, %zmm25, %zmm2
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm0, %zmm2, %zmm0
; AVX512DQ-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm2, %zmm25, %zmm12
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm8, %ymm0, %ymm8
; AVX512DQ-NEXT:    vpternlogq $184, %zmm2, %zmm25, %zmm8
...
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm10 = [8,9,2,3,12,13,u,u,8,9,14,15,0,1,6,7,16,17,22,23,20,21,22,23,24,25,30,31,16,17,22,23]
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm5, %zmm30, %zmm8
...
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm5[0],ymm7[1,2],ymm5[3],ymm7[4],ymm5[5],ymm7[6,7],ymm5[8],ymm7[9,10],ymm5[11],ymm7[12],ymm5[13],ymm7[14,15]
...
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm7[0],ymm4[1],ymm7[2,3],ymm4[4],ymm7[5],ymm4[6],ymm7[7,8],ymm4[9],ymm7[10,11],ymm4[12],ymm7[13],ymm4[14],ymm7[15]
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm18, %zmm30, %zmm5
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm2, %zmm30, %zmm1
