...
; AVX512BW-FCP-NEXT:    vpinsrw $1, %eax, %xmm0, %xmm2
; AVX512BW-FCP-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0,1],xmm1[2],xmm2[3,4,5,6,7]
; AVX512BW-FCP-NEXT:    vpextrw $7, %xmm1, %eax
; AVX512BW-FCP-NEXT:    vpinsrw $3, %eax, %xmm2, %xmm2
; AVX512BW-FCP-NEXT:    vpbroadcastq {{.*#+}} xmm3 = [1,6,11,0,1,6,11,0]
; AVX512BW-FCP-NEXT:    vpermi2w %xmm1, %xmm0, %xmm3
; AVX512BW-FCP-NEXT:    vpinsrw $3, 32(%rdi), %xmm3, %xmm0
...
; AVX512DQ-BW-FCP-NEXT:    vpinsrw $1, %eax, %xmm0, %xmm2
; AVX512DQ-BW-FCP-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0,1],xmm1[2],xmm2[3,4,5,6,7]
; AVX512DQ-BW-FCP-NEXT:    vpextrw $7, %xmm1, %eax
; AVX512DQ-BW-FCP-NEXT:    vpinsrw $3, %eax, %xmm2, %xmm2
; AVX512DQ-BW-FCP-NEXT:    vpbroadcastq {{.*#+}} xmm3 = [1,6,11,0,1,6,11,0]
; AVX512DQ-BW-FCP-NEXT:    vpermi2w %xmm1, %xmm0, %xmm3
; AVX512DQ-BW-FCP-NEXT:    vpinsrw $3, 32(%rdi), %xmm3, %xmm0
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm8 = ymm0[0],ymm6[1,2],ymm0[3],ymm6[4],ymm0[5],ymm6[6,7],ymm0[8],ymm6[9,10],ymm0[11],ymm6[12],ymm0[13],ymm6[14,15]
...
; AVX512-NEXT:    vpternlogq $184, %zmm11, %zmm18, %zmm14
...
; AVX512-NEXT:    vinserti128 $1, %xmm11, %ymm0, %ymm11
; AVX512-NEXT:    vpternlogq $184, %zmm0, %zmm18, %zmm11
...
; AVX512-NEXT:    vpternlogq $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm7
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm13, %zmm16, %zmm15
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm2, %zmm16, %zmm13
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm7, %zmm16, %zmm13
...
; AVX512-FCP-NEXT:    vpternlogq $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm2, %zmm7
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm11, %zmm18, %zmm14
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm11, %ymm0, %ymm11
; AVX512DQ-NEXT:    vpternlogq $184, %zmm0, %zmm18, %zmm11
...
; AVX512DQ-NEXT:    vpternlogq $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm7
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm13, %zmm16, %zmm15
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm2, %zmm16, %zmm13
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm7, %zmm16, %zmm13
...
; AVX512DQ-FCP-NEXT:    vpternlogq $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm2, %zmm7
...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm2[1,2],ymm0[3],ymm2[4],ymm0[5],ymm2[6,7],ymm0[8],ymm2[9,10],ymm0[11],ymm2[12],ymm0[13],ymm2[14,15]
...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm2 = ymm3[0],ymm6[1,2],ymm3[3],ymm6[4],ymm3[5],ymm6[6,7],ymm3[8],ymm6[9,10],ymm3[11],ymm6[12],ymm3[13],ymm6[14,15]
; AVX2-NEXT:    vmovdqu %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vpblendd {{.*#+}} xmm12 = xmm3[0],xmm5[1],xmm3[2,3]
; AVX2-NEXT:    vmovdqa %xmm5, %xmm15
; AVX2-NEXT:    vmovdqa %xmm3, %xmm10
...
; AVX2-NEXT:    vpblendd {{.*#+}} xmm14 = xmm3[0],xmm5[1],xmm3[2,3]
...
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpblendd {{.*#+}} xmm0 = xmm3[0,1],xmm5[2],xmm3[3]
; AVX2-NEXT:    vmovdqa %xmm3, %xmm12
...
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm10[0],ymm8[1],ymm10[2,3],ymm8[4],ymm10[5],ymm8[6],ymm10[7,8],ymm8[9],ymm10[10,11],ymm8[12],ymm10[13],ymm8[14],ymm10[15]
...
; AVX2-FP-NEXT:    vmovdqa 448(%rdi), %xmm3
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm4 = xmm3[0],xmm5[1],xmm3[2,3]
; AVX2-FP-NEXT:    vmovdqa %xmm3, %xmm10
...
; AVX2-FCP-NEXT:    vpshufb %ymm2, %ymm0, %ymm3
; AVX2-FCP-NEXT:    vmovdqa %ymm2, %ymm15
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm4[0],ymm5[1],ymm4[2,3],ymm5[4],ymm4[5],ymm5[6],ymm4[7,8],ymm5[9],ymm4[10,11],ymm5[12],ymm4[13],ymm5[14],ymm4[15]
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm10[0],ymm11[1],ymm10[2,3],ymm11[4],ymm10[5],ymm11[6],ymm10[7,8],ymm11[9],ymm10[10,11],ymm11[12],ymm10[13],ymm11[14],ymm10[15]
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm4 = ymm6[0],ymm7[1,2],ymm6[3],ymm7[4],ymm6[5],ymm7[6,7],ymm6[8],ymm7[9,10],ymm6[11],ymm7[12],ymm6[13],ymm7[14,15]
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm4[0],ymm14[1],ymm4[2,3],ymm14[4],ymm4[5],ymm14[6],ymm4[7,8],ymm14[9],ymm4[10,11],ymm14[12],ymm4[13],ymm14[14],ymm4[15]
...
; AVX2-FCP-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 256(%rdi), %ymm7
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm4 = ymm4[0],ymm7[1,2],ymm4[3],ymm7[4],ymm4[5],ymm7[6,7],ymm4[8],ymm7[9,10],ymm4[11],ymm7[12],ymm4[13],ymm7[14,15]
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm6[0],ymm7[1],ymm6[2,3],ymm7[4],ymm6[5],ymm7[6],ymm6[7,8],ymm7[9],ymm6[10,11],ymm7[12],ymm6[13],ymm7[14],ymm6[15]
...
; AVX2-FCP-NEXT:    vpermd %ymm3, %ymm11, %ymm9
...
; AVX512-NEXT:    vpblendw {{.*#+}} ymm2 = ymm3[0],ymm4[1,2],ymm3[3],ymm4[4],ymm3[5],ymm4[6,7],ymm3[8],ymm4[9,10],ymm3[11],ymm4[12],ymm3[13],ymm4[14,15]
; AVX512-NEXT:    vmovdqu %ymm4, (%rsp) # 32-byte Spill
; AVX512-NEXT:    vmovdqa %ymm3, %ymm6
...
; AVX512-NEXT:    vmovdqa 544(%rdi), %ymm3
; AVX512-NEXT:    vpblendw {{.*#+}} ymm1 = ymm3[0],ymm8[1],ymm3[2,3],ymm8[4],ymm3[5],ymm8[6],ymm3[7,8],ymm8[9],ymm3[10,11],ymm8[12],ymm3[13],ymm8[14],ymm3[15]
; AVX512-NEXT:    vmovdqa %ymm3, %ymm12
; AVX512-NEXT:    vextracti128 $1, %ymm1, %xmm2
...
; AVX512-NEXT:    vpternlogq $184, %zmm10, %zmm23, %zmm14
...
; AVX512-NEXT:    vmovdqa 288(%rdi), %ymm2
...
; AVX512-NEXT:    vpshufd {{.*#+}} xmm1 = xmm2[3,1,2,3]
...
; AVX512-NEXT:    vinserti128 $1, %xmm9, %ymm0, %ymm9
; AVX512-NEXT:    vpternlogq $184, %zmm17, %zmm23, %zmm9
...
; AVX512-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512-NEXT:    vpternlogq $184, %zmm25, %zmm23, %zmm1
...
; AVX512-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512-NEXT:    vpternlogq $184, %zmm0, %zmm23, %zmm1
...
; AVX512-NEXT:    vpternlogq $184, %zmm1, %zmm23, %zmm2
...
; AVX512-NEXT:    vpternlogq $184, %zmm1, %zmm26, %zmm0
...
; AVX512-NEXT:    vpternlogq $184, %zmm0, %zmm26, %zmm2
...
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm14[0],ymm6[1,2],ymm14[3],ymm6[4],ymm14[5],ymm6[6,7],ymm14[8],ymm6[9,10],ymm14[11],ymm6[12],ymm14[13],ymm6[14,15]
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm8, %zmm23, %zmm9
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm3, %zmm23, %zmm1
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm19, %zmm23, %zmm2
...
; AVX512-FCP-NEXT:    vpshufb %ymm3, %ymm2, %ymm2
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm0, %zmm23, %zmm2
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm0, %zmm23, %zmm15
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm1, %zmm21, %zmm2
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm2, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm0, %zmm6, %zmm25
...
; AVX512-FCP-NEXT:    vpshufb %ymm2, %ymm1, %ymm1
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0,1,2],ymm1[3,4,5,6,7]
; AVX512-FCP-NEXT:    vpternlogq $184, %zmm1, %zmm6, %zmm24
...
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm2 = ymm3[0],ymm4[1,2],ymm3[3],ymm4[4],ymm3[5],ymm4[6,7],ymm3[8],ymm4[9,10],ymm3[11],ymm4[12],ymm3[13],ymm4[14,15]
...
; AVX512DQ-NEXT:    vmovdqa 544(%rdi), %ymm3
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm1 = ymm3[0],ymm8[1],ymm3[2,3],ymm8[4],ymm3[5],ymm8[6],ymm3[7,8],ymm8[9],ymm3[10,11],ymm8[12],ymm3[13],ymm8[14],ymm3[15]
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm10, %zmm23, %zmm14
...
; AVX512DQ-NEXT:    vmovdqa 288(%rdi), %ymm2
...
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm1 = xmm2[3,1,2,3]
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm9, %ymm0, %ymm9
; AVX512DQ-NEXT:    vpternlogq $184, %zmm17, %zmm23, %zmm9
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512DQ-NEXT:    vpternlogq $184, %zmm25, %zmm23, %zmm1
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512DQ-NEXT:    vpternlogq $184, %zmm0, %zmm23, %zmm1
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm1, %zmm23, %zmm2
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm1, %zmm26, %zmm0
...
; AVX512DQ-NEXT:    vpternlogq $184, %zmm0, %zmm26, %zmm2
...
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm14[0],ymm6[1,2],ymm14[3],ymm6[4],ymm14[5],ymm6[6,7],ymm14[8],ymm6[9,10],ymm14[11],ymm6[12],ymm14[13],ymm6[14,15]
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm8, %zmm23, %zmm9
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm3, %zmm23, %zmm1
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm19, %zmm23, %zmm2
...
; AVX512DQ-FCP-NEXT:    vpshufb %ymm3, %ymm2, %ymm2
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm0, %zmm23, %zmm2
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm0, %zmm23, %zmm15
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm1, %zmm21, %zmm2
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm2, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm0, %zmm6, %zmm25
...
; AVX512DQ-FCP-NEXT:    vpshufb %ymm2, %ymm1, %ymm1
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0,1,2],ymm1[3,4,5,6,7]
; AVX512DQ-FCP-NEXT:    vpternlogq $184, %zmm1, %zmm6, %zmm24
