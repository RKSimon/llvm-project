...
; AVX:       # %bb.0:
; AVX-NEXT:    vmovapd (%rdi), %ymm4
; AVX-NEXT:    vmovapd 32(%rdi), %ymm2
; AVX-NEXT:    vmovapd (%rsi), %ymm7
; AVX-NEXT:    vmovapd (%r8), %ymm5
; AVX-NEXT:    vmovapd 32(%r8), %ymm3
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = mem[2,3],ymm2[2,3]
...
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm6 = ymm2[0],mem[0],ymm2[2],mem[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1],ymm6[2,3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0],ymm3[1],ymm1[2,3]
; AVX-NEXT:    vmovapd 16(%rdx), %xmm9
; AVX-NEXT:    vpermilpd {{.*#+}} ymm6 = mem[0,0,3,2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm7[2,3],ymm6[2,3]
; AVX-NEXT:    vshufpd {{.*#+}} ymm6 = ymm6[1],ymm9[1],ymm6[2],ymm9[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm6 = ymm6[0,1,2],ymm5[3]
; AVX-NEXT:    vmovddup {{.*#+}} xmm10 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm4[0],ymm7[0],ymm4[2],ymm7[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm7 = ymm10[0,1],ymm7[2,3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm7 = ymm7[0],ymm5[1],ymm7[2,3]
; AVX-NEXT:    vmovlpd {{.*#+}} xmm8 = mem[0],xmm8[1]
; AVX-NEXT:    vbroadcastsd 56(%rcx), %ymm10
; AVX-NEXT:    vblendpd {{.*#+}} ymm8 = ymm8[0,1],ymm10[2,3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm8 = ymm8[0,1,2],ymm3[3]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm9 = xmm9[0],mem[0]
; AVX-NEXT:    vblendpd {{.*#+}} ymm9 = ymm9[0,1],ymm4[2,3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm9 = ymm9[0,1],ymm5[2],ymm9[3]
; AVX-NEXT:    vmovaps (%rdx), %xmm10
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm4, %ymm4
; AVX-NEXT:    vbroadcastsd 8(%rsi), %ymm11
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm4[0,1],ymm11[2],ymm4[3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm5[0],ymm4[1,2,3]
; AVX-NEXT:    vmovaps 32(%rdx), %xmm5
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm2, %ymm2
; AVX-NEXT:    vbroadcastsd 40(%rsi), %ymm11
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],ymm11[2],ymm2[3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm3[0],ymm2[1,2,3]
...
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm5 = xmm5[0],mem[0]
; AVX-NEXT:    vmovaps %xmm5, (%r9)
; AVX-NEXT:    vmovaps %xmm10, 16(%r9)
; AVX-NEXT:    vmovaps %xmm11, 160(%r9)
; AVX-NEXT:    vmovaps %xmm3, 176(%r9)
; AVX-NEXT:    vmovapd %ymm7, 64(%r9)
; AVX-NEXT:    vmovapd %ymm6, 128(%r9)
; AVX-NEXT:    vmovapd %ymm1, 224(%r9)
; AVX-NEXT:    vmovapd %ymm2, 192(%r9)
; AVX-NEXT:    vmovapd %ymm0, 256(%r9)
; AVX-NEXT:    vmovapd %ymm4, 32(%r9)
; AVX-NEXT:    vmovapd %ymm9, 96(%r9)
; AVX-NEXT:    vmovapd %ymm8, 288(%r9)
; AVX-NEXT:    vzeroupper
; AVX-NEXT:    retq
;
...
; AVX2-NEXT:    vbroadcastsd 8(%rsi), %ymm10
; AVX2-NEXT:    vblendps {{.*#+}} ymm10 = ymm0[0,1,2,3],ymm10[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm10[0,1,2,3,4,5],ymm1[6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0,1],ymm1[2,3,4,5,6,7]
; AVX2-NEXT:    vmovaps (%rsi), %xmm10
; AVX2-NEXT:    vmovaps 32(%rsi), %xmm12
; AVX2-NEXT:    vinsertf128 $1, (%rcx), %ymm10, %ymm10
; AVX2-NEXT:    vmovaps (%rdi), %xmm13
; AVX2-NEXT:    vmovaps 32(%rdi), %xmm14
; AVX2-NEXT:    vinsertf128 $1, %xmm9, %ymm13, %ymm9
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm9[0],ymm10[0],ymm9[2],ymm10[2]
; AVX2-NEXT:    vinsertf128 $1, %xmm11, %ymm0, %ymm10
; AVX2-NEXT:    vbroadcastsd 40(%rsi), %ymm13
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm7[0,1,2,3],ymm13[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm10 = ymm13[0,1,2,3,4,5],ymm10[6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm10 = ymm8[0,1],ymm10[2,3,4,5,6,7]
; AVX2-NEXT:    vmovddup {{.*#+}} xmm13 = mem[0,0]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm7[0],ymm5[0],ymm7[2],ymm5[2]
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1,2,3],ymm15[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1],ymm8[2,3],ymm13[4,5,6,7]
; AVX2-NEXT:    vinsertf128 $1, 32(%rcx), %ymm12, %ymm12
; AVX2-NEXT:    vinsertf128 $1, %xmm11, %ymm14, %ymm11
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm11[0],ymm12[0],ymm11[2],ymm12[2]
; AVX2-NEXT:    vmovddup {{.*#+}} xmm12 = mem[0,0]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm0[0],mem[0],ymm0[2],mem[2]
; AVX2-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2,3],ymm14[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1],ymm3[2,3],ymm12[4,5,6,7]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm14 = ymm2[1],ymm4[1],ymm2[3],ymm4[3]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4,5],ymm3[6,7]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm6[2,3],ymm7[2,3]
; AVX2-NEXT:    vbroadcastsd 48(%rcx), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm15[2,3],ymm7[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3],ymm8[4,5],ymm7[6,7]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm5[1],ymm6[1],ymm5[3],ymm6[3]
; AVX2-NEXT:    vbroadcastsd 56(%rcx), %ymm6
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm5[2,3],ymm6[2,3]
...
; AVX2-NEXT:    vmovaps %ymm0, 96(%r9)
; AVX2-NEXT:    vmovaps %ymm13, 224(%r9)
; AVX2-NEXT:    vmovaps %ymm10, 192(%r9)
; AVX2-NEXT:    vmovaps %ymm5, 288(%r9)
...
; AVX2-FP-NEXT:    vbroadcastsd 8(%rsi), %ymm10
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm10 = ymm0[0,1,2,3],ymm10[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm10[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0,1],ymm1[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovaps (%rsi), %xmm10
; AVX2-FP-NEXT:    vmovaps 32(%rsi), %xmm12
; AVX2-FP-NEXT:    vinsertf128 $1, (%rcx), %ymm10, %ymm10
; AVX2-FP-NEXT:    vmovaps (%rdi), %xmm13
; AVX2-FP-NEXT:    vmovaps 32(%rdi), %xmm14
; AVX2-FP-NEXT:    vinsertf128 $1, %xmm9, %ymm13, %ymm9
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm9[0],ymm10[0],ymm9[2],ymm10[2]
; AVX2-FP-NEXT:    vinsertf128 $1, %xmm11, %ymm0, %ymm10
; AVX2-FP-NEXT:    vbroadcastsd 40(%rsi), %ymm13
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm7[0,1,2,3],ymm13[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm10 = ymm13[0,1,2,3,4,5],ymm10[6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm10 = ymm8[0,1],ymm10[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovddup {{.*#+}} xmm13 = mem[0,0]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm7[0],ymm5[0],ymm7[2],ymm5[2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1,2,3],ymm15[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1],ymm8[2,3],ymm13[4,5,6,7]
; AVX2-FP-NEXT:    vinsertf128 $1, 32(%rcx), %ymm12, %ymm12
; AVX2-FP-NEXT:    vinsertf128 $1, %xmm11, %ymm14, %ymm11
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm11[0],ymm12[0],ymm11[2],ymm12[2]
; AVX2-FP-NEXT:    vmovddup {{.*#+}} xmm12 = mem[0,0]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm0[0],mem[0],ymm0[2],mem[2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2,3],ymm14[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1],ymm3[2,3],ymm12[4,5,6,7]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm14 = ymm2[1],ymm4[1],ymm2[3],ymm4[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,2,3,3]
; AVX2-FP-NEXT:    vbroadcastsd 24(%rsi), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0,1],ymm14[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4,5],ymm3[6,7]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm6[2,3],ymm7[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 48(%rcx), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm15[2,3],ymm7[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3],ymm8[4,5],ymm7[6,7]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm5[1],ymm6[1],ymm5[3],ymm6[3]
; AVX2-FP-NEXT:    vbroadcastsd 56(%rcx), %ymm6
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm5[2,3],ymm6[2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2,3,4,5],ymm8[6,7]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm2[0],ymm4[0],ymm2[2],ymm4[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm2[2,3],ymm0[2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm3[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vmovaps %ymm12, 64(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm11, 160(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm0, 96(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm13, 224(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm10, 192(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm5, 288(%r9)
...
; AVX2-FCP-NEXT:    vbroadcastsd 8(%rsi), %ymm10
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm0[0,1,2,3],ymm10[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm10[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0,1],ymm1[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovaps (%rsi), %xmm10
; AVX2-FCP-NEXT:    vmovaps 32(%rsi), %xmm12
; AVX2-FCP-NEXT:    vinsertf128 $1, (%rcx), %ymm10, %ymm10
; AVX2-FCP-NEXT:    vmovaps (%rdi), %xmm13
; AVX2-FCP-NEXT:    vmovaps 32(%rdi), %xmm14
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm9, %ymm13, %ymm9
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm9[0],ymm10[0],ymm9[2],ymm10[2]
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm11, %ymm0, %ymm10
; AVX2-FCP-NEXT:    vbroadcastsd 40(%rsi), %ymm13
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm13 = ymm7[0,1,2,3],ymm13[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm13[0,1,2,3,4,5],ymm10[6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm8[0,1],ymm10[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovddup {{.*#+}} xmm13 = mem[0,0]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm7[0],ymm5[0],ymm7[2],ymm5[2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1,2,3],ymm15[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1],ymm8[2,3],ymm13[4,5,6,7]
; AVX2-FCP-NEXT:    vinsertf128 $1, 32(%rcx), %ymm12, %ymm12
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm11, %ymm14, %ymm11
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm11[0],ymm12[0],ymm11[2],ymm12[2]
; AVX2-FCP-NEXT:    vmovddup {{.*#+}} xmm12 = mem[0,0]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm0[0],mem[0],ymm0[2],mem[2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2,3],ymm14[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1],ymm3[2,3],ymm12[4,5,6,7]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm14 = ymm2[1],ymm4[1],ymm2[3],ymm4[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,2,3,3]
; AVX2-FCP-NEXT:    vbroadcastsd 24(%rsi), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0,1],ymm14[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4,5],ymm3[6,7]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm6[2,3],ymm7[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 48(%rcx), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm15[2,3],ymm7[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3],ymm8[4,5],ymm7[6,7]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm5[1],ymm6[1],ymm5[3],ymm6[3]
; AVX2-FCP-NEXT:    vbroadcastsd 56(%rcx), %ymm6
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm5[2,3],ymm6[2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2,3,4,5],ymm8[6,7]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm2[0],ymm4[0],ymm2[2],ymm4[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm2[2,3],ymm0[2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm3[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovaps %ymm12, 64(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm11, 160(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm0, 96(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm13, 224(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm10, 192(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm5, 288(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm7, 256(%r9)
...
; AVX-NEXT:    vmovapd 64(%rdi), %ymm11
; AVX-NEXT:    vmovapd 32(%rdi), %ymm2
; AVX-NEXT:    vmovapd (%rdi), %ymm3
; AVX-NEXT:    vmovapd 64(%rsi), %ymm8
; AVX-NEXT:    vmovapd (%rsi), %ymm5
; AVX-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm6 = ymm3[0],ymm5[0],ymm3[2],ymm5[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm0[0,1],ymm6[2,3]
; AVX-NEXT:    vmovapd 16(%rdx), %xmm6
; AVX-NEXT:    vpermilpd {{.*#+}} ymm7 = mem[0,0,3,2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm5[2,3],ymm7[2,3]
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm5[1],ymm6[1],ymm5[2],ymm6[2]
; AVX-NEXT:    vmovddup {{.*#+}} xmm7 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm2[0],mem[0],ymm2[2],mem[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm9 = ymm7[0,1],ymm9[2,3]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm7 = mem[2,3],ymm2[2,3]
; AVX-NEXT:    vmovapd 48(%rdx), %xmm12
; AVX-NEXT:    vshufpd {{.*#+}} ymm5 = ymm12[0],ymm7[0],ymm12[2],ymm7[3]
; AVX-NEXT:    vmovddup {{.*#+}} xmm7 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm11[0],ymm8[0],ymm11[2],ymm8[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm7 = ymm7[0,1],ymm10[2,3]
; AVX-NEXT:    vpermilpd {{.*#+}} ymm10 = mem[0,0,3,2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm14 = ymm8[2,3],ymm10[2,3]
; AVX-NEXT:    vmovddup {{.*#+}} xmm8 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm1[0],mem[0],ymm1[2],mem[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm8 = ymm8[0,1],ymm10[2,3]
; AVX-NEXT:    vmovupd %ymm8, (%rsp) # 32-byte Spill
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm10 = mem[2,3],ymm1[2,3]
; AVX-NEXT:    vmovapd %ymm1, %ymm8
; AVX-NEXT:    vmovapd 112(%rdx), %xmm13
; AVX-NEXT:    vshufpd {{.*#+}} ymm10 = ymm13[0],ymm10[0],ymm13[2],ymm10[3]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm6 = xmm6[0],mem[0]
; AVX-NEXT:    vblendpd {{.*#+}} ymm6 = ymm6[0,1],ymm3[2,3]
; AVX-NEXT:    vmovlpd {{.*#+}} xmm12 = mem[0],xmm12[1]
; AVX-NEXT:    vbroadcastsd 56(%rcx), %ymm15
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm12[0,1],ymm15[2,3]
; AVX-NEXT:    vmovlpd {{.*#+}} xmm12 = mem[0],xmm13[1]
; AVX-NEXT:    vbroadcastsd 120(%rcx), %ymm13
; AVX-NEXT:    vblendpd {{.*#+}} ymm15 = ymm12[0,1],ymm13[2,3]
; AVX-NEXT:    vmovaps (%rdx), %xmm12
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm3, %ymm3
; AVX-NEXT:    vbroadcastsd 8(%rsi), %ymm13
; AVX-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1],ymm13[2],ymm3[3]
; AVX-NEXT:    vmovapd (%r8), %ymm13
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm4[0],ymm13[1],ymm4[2,3]
...
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm6[0,1],ymm13[2],ymm6[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm13[0],ymm3[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 32(%rdx), %xmm4
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm2, %ymm2
; AVX-NEXT:    vbroadcastsd 40(%rsi), %ymm3
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],ymm3[2],ymm2[3]
; AVX-NEXT:    vmovapd 32(%r8), %ymm13
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm9[0],ymm13[1],ymm9[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm5[0,1],ymm13[2],ymm5[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm1[0,1,2],ymm13[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm13[0],ymm2[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 80(%rdx), %xmm1
; AVX-NEXT:    vshufpd {{.*#+}} ymm3 = ymm14[1],ymm1[1],ymm14[2],ymm1[2]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm1 = xmm1[0],mem[0]
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm1[0,1],ymm11[2,3]
; AVX-NEXT:    vmovaps 64(%rdx), %xmm1
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm11, %ymm11
; AVX-NEXT:    vbroadcastsd 72(%rsi), %ymm14
; AVX-NEXT:    vblendpd {{.*#+}} ymm11 = ymm11[0,1],ymm14[2],ymm11[3]
; AVX-NEXT:    vmovapd 64(%r8), %ymm0
; AVX-NEXT:    vblendpd {{.*#+}} ymm7 = ymm7[0],ymm0[1],ymm7[2,3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm14 = ymm3[0,1,2],ymm0[3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm6 = ymm2[0,1],ymm0[2],ymm2[3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm5 = ymm0[0],ymm11[1,2,3]
; AVX-NEXT:    vmovaps 96(%rdx), %xmm3
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm8, %ymm11
; AVX-NEXT:    vbroadcastsd 104(%rsi), %ymm8
; AVX-NEXT:    vblendpd {{.*#+}} ymm11 = ymm11[0,1],ymm8[2],ymm11[3]
; AVX-NEXT:    vmovapd 96(%r8), %ymm0
; AVX-NEXT:    vblendpd $13, (%rsp), %ymm0, %ymm2 # 32-byte Folded Reload
; AVX-NEXT:    # ymm2 = mem[0],ymm0[1],mem[2,3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm8 = ymm10[0,1],ymm0[2],ymm10[3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm15 = ymm15[0,1,2],ymm0[3]
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0],ymm11[1,2,3]
...
; AVX-NEXT:    vmovaps %xmm12, 16(%r9)
; AVX-NEXT:    vmovaps %xmm13, (%r9)
; AVX-NEXT:    vmovaps %xmm3, 496(%r9)
; AVX-NEXT:    vmovaps %xmm9, 480(%r9)
; AVX-NEXT:    vmovaps %xmm4, 176(%r9)
; AVX-NEXT:    vmovaps %xmm10, 160(%r9)
; AVX-NEXT:    vmovaps %xmm1, 336(%r9)
; AVX-NEXT:    vmovaps %xmm11, 320(%r9)
; AVX-NEXT:    vmovapd %ymm8, 576(%r9)
; AVX-NEXT:    vmovapd %ymm2, 544(%r9)
; AVX-NEXT:    vmovapd %ymm0, 512(%r9)
; AVX-NEXT:    vmovapd %ymm14, 448(%r9)
; AVX-NEXT:    vmovapd %ymm7, 384(%r9)
; AVX-NEXT:    vmovapd %ymm5, 352(%r9)
...
; AVX2-NEXT:    vinsertf128 $1, %xmm10, %ymm9, %ymm9
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm9[0],ymm7[0],ymm9[2],ymm7[2]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vinsertf128 $1, %xmm10, %ymm0, %ymm7
; AVX2-NEXT:    vbroadcastsd 8(%rsi), %ymm9
; AVX2-NEXT:    vblendps {{.*#+}} ymm9 = ymm6[0,1,2,3],ymm9[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3,4,5],ymm7[6,7]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovddup {{.*#+}} xmm9 = mem[0,0]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm6[0],mem[0],ymm6[2],mem[2]
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3],ymm10[4,5,6,7]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vinsertf128 $1, 32(%rcx), %ymm8, %ymm8
; AVX2-NEXT:    vinsertf128 $1, %xmm12, %ymm11, %ymm9
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm9[0],ymm8[0],ymm9[2],ymm8[2]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vinsertf128 $1, %xmm12, %ymm0, %ymm8
; AVX2-NEXT:    vbroadcastsd 40(%rsi), %ymm9
; AVX2-NEXT:    vblendps {{.*#+}} ymm9 = ymm13[0,1,2,3],ymm9[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3,4,5],ymm8[6,7]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovddup {{.*#+}} xmm9 = mem[0,0]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm13[0],ymm4[0],ymm13[2],ymm4[2]
; AVX2-NEXT:    vmovaps %ymm4, %ymm12
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3],ymm11[4,5,6,7]
...
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm15[0],ymm4[0],ymm15[2],ymm4[2]
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm1[0,1,2,3],ymm3[4,5,6,7]
...
; AVX2-NEXT:    vbroadcastsd 24(%rsi), %ymm9
; AVX2-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm7[2,3,4,5,6,7]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm5 = ymm10[0,1],ymm7[2,3,4,5,6,7]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm1[0],ymm0[0],ymm1[2],ymm0[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm6[2,3]
; AVX2-NEXT:    vmovaps (%r8), %ymm1
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm11 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm11 = ymm1[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm10 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm10 = mem[0,1],ymm1[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm9[0,1,2,3,4,5],ymm1[6,7]
...
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm0[2,3],ymm13[2,3]
; AVX2-NEXT:    vbroadcastsd 48(%rcx), %ymm9
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm6[0,1],ymm9[2,3],ymm6[4,5,6,7]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm12[1],ymm0[1],ymm12[3],ymm0[3]
; AVX2-NEXT:    vbroadcastsd 56(%rcx), %ymm6
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm0[2,3],ymm6[2,3]
; AVX2-NEXT:    vmovaps 32(%r8), %ymm0
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm9 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm9 = ymm0[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vblendps $243, (%rsp), %ymm0, %ymm6 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm6 = mem[0,1],ymm0[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1,2,3],ymm0[4,5],ymm13[6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3,4,5],ymm0[6,7]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm3[0],ymm2[0],ymm3[2],ymm2[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm0[2,3],ymm14[2,3]
; AVX2-NEXT:    vmovaps 64(%r8), %ymm3
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm14 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm14 = ymm3[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = mem[0,1],ymm3[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2,3,4,5],ymm3[6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm3[4,5],ymm2[6,7]
; AVX2-NEXT:    vmovaps 96(%rdx), %ymm3
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm3[2,3],ymm15[2,3]
; AVX2-NEXT:    vbroadcastsd 112(%rcx), %ymm12
; AVX2-NEXT:    vblendps {{.*#+}} ymm12 = ymm15[0,1],ymm12[2,3],ymm15[4,5,6,7]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm4[1],ymm3[1],ymm4[3],ymm3[3]
; AVX2-NEXT:    vbroadcastsd 120(%rcx), %ymm4
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm3[2,3],ymm4[2,3]
; AVX2-NEXT:    vmovaps 96(%r8), %ymm4
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm4, %ymm15 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm15 = ymm4[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm4[2,3],ymm8[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2,3],ymm4[4,5],ymm12[6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3,4,5],ymm4[6,7]
; AVX2-NEXT:    vmovaps %ymm3, 608(%r9)
; AVX2-NEXT:    vmovaps %ymm12, 576(%r9)
; AVX2-NEXT:    vmovaps %ymm8, 544(%r9)
; AVX2-NEXT:    vmovaps %ymm15, 512(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm3, 480(%r9)
; AVX2-NEXT:    vmovaps %ymm2, 416(%r9)
; AVX2-NEXT:    vmovaps %ymm0, 384(%r9)
; AVX2-NEXT:    vmovaps %ymm14, 352(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 320(%r9)
; AVX2-NEXT:    vmovaps %ymm1, 288(%r9)
; AVX2-NEXT:    vmovaps %ymm13, 256(%r9)
; AVX2-NEXT:    vmovaps %ymm6, 224(%r9)
; AVX2-NEXT:    vmovaps %ymm9, 192(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 160(%r9)
; AVX2-NEXT:    vmovaps %ymm7, 96(%r9)
; AVX2-NEXT:    vmovaps %ymm10, 64(%r9)
; AVX2-NEXT:    vmovaps %ymm11, 32(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, (%r9)
; AVX2-NEXT:    vmovaps %ymm5, 448(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FP-NEXT:    vinsertf128 $1, %xmm10, %ymm9, %ymm9
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm9[0],ymm7[0],ymm9[2],ymm7[2]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vinsertf128 $1, %xmm10, %ymm0, %ymm7
; AVX2-FP-NEXT:    vbroadcastsd 8(%rsi), %ymm9
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm6[0,1,2,3],ymm9[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3,4,5],ymm7[6,7]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovddup {{.*#+}} xmm9 = mem[0,0]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm6[0],mem[0],ymm6[2],mem[2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3],ymm10[4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vinsertf128 $1, 32(%rcx), %ymm8, %ymm8
; AVX2-FP-NEXT:    vinsertf128 $1, %xmm12, %ymm11, %ymm9
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm9[0],ymm8[0],ymm9[2],ymm8[2]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vinsertf128 $1, %xmm12, %ymm0, %ymm8
; AVX2-FP-NEXT:    vbroadcastsd 40(%rsi), %ymm9
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm13[0,1,2,3],ymm9[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3,4,5],ymm8[6,7]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovddup {{.*#+}} xmm9 = mem[0,0]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm13[0],ymm4[0],ymm13[2],ymm4[2]
; AVX2-FP-NEXT:    vmovaps %ymm4, %ymm12
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3],ymm11[4,5,6,7]
...
; AVX2-FP-NEXT:    vmovaps 96(%rdx), %xmm3
; AVX2-FP-NEXT:    vinsertf128 $1, %xmm3, %ymm1, %ymm1
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm1[0],ymm0[0],ymm1[2],ymm0[2]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm15[0],ymm4[0],ymm15[2],ymm4[2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm1[0,1,2,3],ymm3[4,5,6,7]
...
; AVX2-FP-NEXT:    vbroadcastsd 24(%rsi), %ymm9
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm7[2,3,4,5,6,7]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm5 = ymm10[0,1],ymm7[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm1[0],ymm0[0],ymm1[2],ymm0[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm6[2,3]
; AVX2-FP-NEXT:    vmovaps (%r8), %ymm1
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm11 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm11 = ymm1[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm10 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm10 = mem[0,1],ymm1[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm9[0,1,2,3,4,5],ymm1[6,7]
...
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm0[2,3],ymm13[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 48(%rcx), %ymm9
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm6[0,1],ymm9[2,3],ymm6[4,5,6,7]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm12[1],ymm0[1],ymm12[3],ymm0[3]
; AVX2-FP-NEXT:    vbroadcastsd 56(%rcx), %ymm6
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm0[2,3],ymm6[2,3]
; AVX2-FP-NEXT:    vmovaps 32(%r8), %ymm0
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm9 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm9 = ymm0[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vblendps $243, (%rsp), %ymm0, %ymm6 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm6 = mem[0,1],ymm0[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1,2,3],ymm0[4,5],ymm13[6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm3[0],ymm2[0],ymm3[2],ymm2[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm0[2,3],ymm14[2,3]
; AVX2-FP-NEXT:    vmovaps 64(%r8), %ymm3
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm14 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm14 = ymm3[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = mem[0,1],ymm3[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2,3,4,5],ymm3[6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm3[4,5],ymm2[6,7]
; AVX2-FP-NEXT:    vmovaps 96(%rdx), %ymm3
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm3[2,3],ymm15[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 112(%rcx), %ymm12
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm15[0,1],ymm12[2,3],ymm15[4,5,6,7]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm4[1],ymm3[1],ymm4[3],ymm3[3]
; AVX2-FP-NEXT:    vbroadcastsd 120(%rcx), %ymm4
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm3[2,3],ymm4[2,3]
; AVX2-FP-NEXT:    vmovaps 96(%r8), %ymm4
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm4, %ymm15 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm15 = ymm4[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm4[2,3],ymm8[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2,3],ymm4[4,5],ymm12[6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3,4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vmovaps %ymm3, 608(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm12, 576(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm8, 544(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm15, 512(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm3, 480(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm2, 416(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm0, 384(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm14, 352(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, 320(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm1, 288(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm13, 256(%r9)
...
; AVX2-FP-NEXT:    vmovaps %ymm10, 64(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm11, 32(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, (%r9)
; AVX2-FP-NEXT:    vmovaps %ymm5, 448(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm10, %ymm9, %ymm9
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm9[0],ymm7[0],ymm9[2],ymm7[2]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm10, %ymm0, %ymm7
; AVX2-FCP-NEXT:    vbroadcastsd 8(%rsi), %ymm9
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm6[0,1,2,3],ymm9[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3,4,5],ymm7[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovddup {{.*#+}} xmm9 = mem[0,0]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm6[0],mem[0],ymm6[2],mem[2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3],ymm10[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vinsertf128 $1, 32(%rcx), %ymm8, %ymm8
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm12, %ymm11, %ymm9
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm9[0],ymm8[0],ymm9[2],ymm8[2]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm12, %ymm0, %ymm8
; AVX2-FCP-NEXT:    vbroadcastsd 40(%rsi), %ymm9
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm13[0,1,2,3],ymm9[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3,4,5],ymm8[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovddup {{.*#+}} xmm9 = mem[0,0]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm13[0],ymm4[0],ymm13[2],ymm4[2]
; AVX2-FCP-NEXT:    vmovaps %ymm4, %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1,2,3],ymm11[4,5,6,7]
...
; AVX2-FCP-NEXT:    vmovaps 96(%rdx), %xmm3
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm3, %ymm1, %ymm1
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm1[0],ymm0[0],ymm1[2],ymm0[2]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm15[0],ymm4[0],ymm15[2],ymm4[2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm1[0,1,2,3],ymm3[4,5,6,7]
...
; AVX2-FCP-NEXT:    vbroadcastsd 24(%rsi), %ymm9
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm7[2,3,4,5,6,7]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm10[0,1],ymm7[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm1[0],ymm0[0],ymm1[2],ymm0[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm6[2,3]
; AVX2-FCP-NEXT:    vmovaps (%r8), %ymm1
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm11 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm11 = ymm1[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm10 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm10 = mem[0,1],ymm1[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm6 = ymm9[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm0[0,1,2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovaps 32(%rdx), %ymm0
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm0[2,3],ymm13[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 48(%rcx), %ymm9
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm13 = ymm6[0,1],ymm9[2,3],ymm6[4,5,6,7]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm12[1],ymm0[1],ymm12[3],ymm0[3]
; AVX2-FCP-NEXT:    vbroadcastsd 56(%rcx), %ymm6
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm0[2,3],ymm6[2,3]
; AVX2-FCP-NEXT:    vmovaps 32(%r8), %ymm0
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm9 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm9 = ymm0[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vblendps $243, (%rsp), %ymm0, %ymm6 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm6 = mem[0,1],ymm0[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1,2,3],ymm0[4,5],ymm13[6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm3[0],ymm2[0],ymm3[2],ymm2[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm0[2,3],ymm14[2,3]
; AVX2-FCP-NEXT:    vmovaps 64(%r8), %ymm3
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm14 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm14 = ymm3[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm0 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm0 = mem[0,1],ymm3[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2,3,4,5],ymm3[6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm3[4,5],ymm2[6,7]
; AVX2-FCP-NEXT:    vmovaps 96(%rdx), %ymm3
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm3[2,3],ymm15[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 112(%rcx), %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm15[0,1],ymm12[2,3],ymm15[4,5,6,7]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm4[1],ymm3[1],ymm4[3],ymm3[3]
; AVX2-FCP-NEXT:    vbroadcastsd 120(%rcx), %ymm4
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm3[2,3],ymm4[2,3]
; AVX2-FCP-NEXT:    vmovaps 96(%r8), %ymm4
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm4, %ymm15 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm15 = ymm4[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm4[2,3],ymm8[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2,3],ymm4[4,5],ymm12[6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3,4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vmovaps %ymm3, 608(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm12, 576(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm8, 544(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm15, 512(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm3, 480(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm2, 416(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm0, 384(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm14, 352(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, 320(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm1, 288(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm13, 256(%r9)
...
; AVX2-FCP-NEXT:    vmovaps %ymm10, 64(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm11, 32(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, (%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm5, 448(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX-NEXT:    vmovapd 96(%rdi), %ymm13
; AVX-NEXT:    vmovapd 64(%rdi), %ymm8
; AVX-NEXT:    vmovapd 32(%rdi), %ymm3
; AVX-NEXT:    vmovapd (%rdi), %ymm6
; AVX-NEXT:    vmovapd 128(%rsi), %ymm2
; AVX-NEXT:    vmovapd 64(%rsi), %ymm0
; AVX-NEXT:    vmovapd (%rsi), %ymm4
; AVX-NEXT:    vmovddup {{.*#+}} xmm5 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm6[0],ymm4[0],ymm6[2],ymm4[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm5 = ymm5[0,1],ymm7[2,3]
; AVX-NEXT:    vmovupd %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpermilpd {{.*#+}} ymm5 = mem[0,0,3,2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm4[2,3],ymm5[2,3]
; AVX-NEXT:    vmovddup {{.*#+}} xmm4 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm5 = ymm3[0],mem[0],ymm3[2],mem[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm4[0,1],ymm5[2,3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovddup {{.*#+}} xmm4 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm5 = ymm8[0],ymm0[0],ymm8[2],ymm0[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm4[0,1],ymm5[2,3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpermilpd {{.*#+}} ymm4 = mem[0,0,3,2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm4[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm13[0],mem[0],ymm13[2],mem[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm4[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm10[0],ymm2[0],ymm10[2],ymm2[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm4[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpermilpd {{.*#+}} ymm0 = mem[0,0,3,2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm2[2,3],ymm0[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm1[0],mem[0],ymm1[2],mem[2]
; AVX-NEXT:    vmovapd %ymm1, %ymm12
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm2[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 192(%rdi), %ymm5
; AVX-NEXT:    vmovapd 192(%rsi), %ymm0
; AVX-NEXT:    vmovddup {{.*#+}} xmm2 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm5[0],ymm0[0],ymm5[2],ymm0[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm2[0,1],ymm4[2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpermilpd {{.*#+}} ymm2 = mem[0,0,3,2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm2[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 224(%rdi), %ymm11
; AVX-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm11[0],mem[0],ymm11[2],mem[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm2[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = mem[2,3],ymm3[2,3]
; AVX-NEXT:    vmovapd 48(%rdx), %xmm2
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm2[0],ymm0[0],ymm2[2],ymm0[3]
; AVX-NEXT:    vmovlpd {{.*#+}} xmm0 = mem[0],xmm2[1]
; AVX-NEXT:    vbroadcastsd 56(%rcx), %ymm2
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm0[0,1],ymm2[2,3]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm2 = mem[2,3],ymm13[2,3]
; AVX-NEXT:    vmovapd 112(%rdx), %xmm10
; AVX-NEXT:    vshufpd {{.*#+}} ymm7 = ymm10[0],ymm2[0],ymm10[2],ymm2[3]
; AVX-NEXT:    vmovlpd {{.*#+}} xmm2 = mem[0],xmm10[1]
; AVX-NEXT:    vbroadcastsd 120(%rcx), %ymm10
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],ymm10[2,3]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm10 = mem[2,3],ymm12[2,3]
; AVX-NEXT:    vmovapd 176(%rdx), %xmm14
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm14[0],ymm10[0],ymm14[2],ymm10[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovlpd {{.*#+}} xmm10 = mem[0],xmm14[1]
; AVX-NEXT:    vbroadcastsd 184(%rcx), %ymm14
; AVX-NEXT:    vblendpd {{.*#+}} ymm12 = ymm10[0,1],ymm14[2,3]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm14 = mem[2,3],ymm11[2,3]
; AVX-NEXT:    vmovapd 240(%rdx), %xmm15
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm15[0],ymm14[0],ymm15[2],ymm14[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovlpd {{.*#+}} xmm14 = mem[0],xmm15[1]
; AVX-NEXT:    vbroadcastsd 248(%rcx), %ymm15
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm14[0,1],ymm15[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 16(%rdx), %xmm14
; AVX-NEXT:    vshufpd {{.*#+}} ymm9 = ymm9[1],ymm14[1],ymm9[2],ymm14[2]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm14 = xmm14[0],mem[0]
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm14[0,1],ymm6[2,3]
; AVX-NEXT:    vmovaps (%rdx), %xmm10
; AVX-NEXT:    vmovaps %xmm10, (%rsp) # 16-byte Spill
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm6, %ymm6
; AVX-NEXT:    vbroadcastsd 8(%rsi), %ymm15
; AVX-NEXT:    vblendpd {{.*#+}} ymm6 = ymm6[0,1],ymm15[2],ymm6[3]
; AVX-NEXT:    vmovapd (%r8), %ymm15
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15, %ymm10 # 32-byte Folded Reload
; AVX-NEXT:    # ymm10 = mem[0],ymm15[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm9 = ymm9[0,1,2],ymm15[3]
; AVX-NEXT:    vmovupd %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm15[2],ymm0[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm15[0],ymm6[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 32(%rdx), %xmm10
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm3, %ymm0
; AVX-NEXT:    vbroadcastsd 40(%rsi), %ymm3
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm3[2],ymm0[3]
; AVX-NEXT:    vmovapd 32(%r8), %ymm3
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm6 # 32-byte Folded Reload
; AVX-NEXT:    # ymm6 = mem[0],ymm3[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm4[0,1],ymm3[2],ymm4[3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1,2],ymm3[3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm3[0],ymm0[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 80(%rdx), %xmm0
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX-NEXT:    vshufpd {{.*#+}} ymm1 = ymm1[1],ymm0[1],ymm1[2],ymm0[2]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm0 = xmm0[0],mem[0]
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm8[2,3]
; AVX-NEXT:    vmovaps 64(%rdx), %xmm9
; AVX-NEXT:    vinsertf128 $1, %xmm9, %ymm8, %ymm3
; AVX-NEXT:    vbroadcastsd 72(%rsi), %ymm6
; AVX-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1],ymm6[2],ymm3[3]
; AVX-NEXT:    vmovapd 64(%r8), %ymm6
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm4 # 32-byte Folded Reload
; AVX-NEXT:    # ymm4 = mem[0],ymm6[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1,2],ymm6[3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm6[2],ymm0[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm6[0],ymm3[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 96(%rdx), %xmm4
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm13, %ymm0
; AVX-NEXT:    vbroadcastsd 104(%rsi), %ymm1
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm1[2],ymm0[3]
; AVX-NEXT:    vmovapd 96(%r8), %ymm1
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm3 # 32-byte Folded Reload
; AVX-NEXT:    # ymm3 = mem[0],ymm1[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm3 = ymm7[0,1],ymm1[2],ymm7[3]
; AVX-NEXT:    vmovupd %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1,2],ymm1[3]
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm1[0],ymm0[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 144(%rdx), %xmm0
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX-NEXT:    vshufpd {{.*#+}} ymm2 = ymm1[1],ymm0[1],ymm1[2],ymm0[2]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm0 = xmm0[0],mem[0]
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3]
; AVX-NEXT:    vmovaps 128(%rdx), %xmm3
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm1, %ymm6
; AVX-NEXT:    vbroadcastsd 136(%rsi), %ymm7
; AVX-NEXT:    vblendpd {{.*#+}} ymm6 = ymm6[0,1],ymm7[2],ymm6[3]
; AVX-NEXT:    vmovapd 128(%r8), %ymm7
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm1 # 32-byte Folded Reload
; AVX-NEXT:    # ymm1 = mem[0],ymm7[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm2[0,1,2],ymm7[3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm7[2],ymm0[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm7[0],ymm6[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 160(%rdx), %xmm2
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm0
; AVX-NEXT:    vbroadcastsd 168(%rsi), %ymm6
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm6[2],ymm0[3]
; AVX-NEXT:    vmovapd 160(%r8), %ymm6
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm1 # 32-byte Folded Reload
; AVX-NEXT:    # ymm1 = mem[0],ymm6[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd $11, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm1 # 32-byte Folded Reload
; AVX-NEXT:    # ymm1 = mem[0,1],ymm6[2],mem[3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm12[0,1,2],ymm6[3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm6[0],ymm0[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 208(%rdx), %xmm0
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX-NEXT:    vshufpd {{.*#+}} ymm6 = ymm1[1],ymm0[1],ymm1[2],ymm0[2]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm0 = xmm0[0],mem[0]
; AVX-NEXT:    vblendpd {{.*#+}} ymm7 = ymm0[0,1],ymm5[2,3]
; AVX-NEXT:    vmovaps 192(%rdx), %xmm1
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm5, %ymm5
; AVX-NEXT:    vbroadcastsd 200(%rsi), %ymm8
; AVX-NEXT:    vblendpd {{.*#+}} ymm5 = ymm5[0,1],ymm8[2],ymm5[3]
; AVX-NEXT:    vmovapd 192(%r8), %ymm8
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm0 # 32-byte Folded Reload
; AVX-NEXT:    # ymm0 = mem[0],ymm8[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm6[0,1,2],ymm8[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm7[0,1],ymm8[2],ymm7[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm8[0],ymm5[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 224(%rdx), %xmm0
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm11, %ymm5
; AVX-NEXT:    vbroadcastsd 232(%rsi), %ymm6
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2,3],ymm6[4,5],ymm5[6,7]
; AVX-NEXT:    vmovaps 224(%r8), %ymm6
...
; AVX-NEXT:    vblendps $207, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm7 # 32-byte Folded Reload
; AVX-NEXT:    # ymm7 = mem[0,1,2,3],ymm6[4,5],mem[6,7]
; AVX-NEXT:    vmovups %ymm7, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm6 = xmm5[0],mem[0]
...
; AVX-NEXT:    vmovaps %xmm13, 1120(%r9)
; AVX-NEXT:    vmovaps %xmm2, 816(%r9)
; AVX-NEXT:    vmovaps %xmm12, 800(%r9)
; AVX-NEXT:    vmovaps %xmm4, 496(%r9)
; AVX-NEXT:    vmovaps %xmm14, 480(%r9)
; AVX-NEXT:    vmovaps %xmm10, 176(%r9)
; AVX-NEXT:    vmovaps %xmm15, 160(%r9)
; AVX-NEXT:    vmovaps %xmm9, 336(%r9)
; AVX-NEXT:    vmovaps %xmm3, 320(%r9)
; AVX-NEXT:    vmovaps %xmm5, 656(%r9)
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    subq $1064, %rsp # imm = 0x428
...
; AVX2-NEXT:    vmovaps 64(%rsi), %xmm0
; AVX2-NEXT:    vinsertf128 $1, (%rcx), %ymm1, %ymm4
...
; AVX2-NEXT:    vinsertf128 $1, %xmm7, %ymm0, %ymm4
...
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vinsertf128 $1, 32(%rcx), %ymm3, %ymm3
; AVX2-NEXT:    vinsertf128 $1, %xmm8, %ymm6, %ymm4
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm4[0],ymm3[0],ymm4[2],ymm3[2]
; AVX2-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vinsertf128 $1, %xmm8, %ymm0, %ymm3
; AVX2-NEXT:    vbroadcastsd 40(%rsi), %ymm4
; AVX2-NEXT:    vmovups %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm10[0,1,2,3],ymm4[4,5,6,7]
...
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm10[0],ymm1[0],ymm10[2],ymm1[2]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vmovaps (%rcx), %ymm0
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm15[1],ymm0[1],ymm15[3],ymm0[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,2,3,3]
; AVX2-NEXT:    vbroadcastsd 24(%rsi), %ymm2
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm2[0,1],ymm1[2,3,4,5,6,7]
; AVX2-NEXT:    vmovaps 64(%rdx), %ymm12
; AVX2-NEXT:    vmovaps 64(%rcx), %ymm1
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm12[1],ymm1[1],ymm12[3],ymm1[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,2,3,3]
; AVX2-NEXT:    vbroadcastsd 88(%rsi), %ymm4
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm4[0,1],ymm2[2,3,4,5,6,7]
; AVX2-NEXT:    vmovaps 128(%rdx), %ymm4
; AVX2-NEXT:    vmovaps 128(%rcx), %ymm2
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm4[1],ymm2[1],ymm4[3],ymm2[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,2,3,3]
; AVX2-NEXT:    vbroadcastsd 152(%rsi), %ymm6
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm6[0,1],ymm5[2,3,4,5,6,7]
; AVX2-NEXT:    vmovaps 192(%rdx), %ymm6
; AVX2-NEXT:    vmovaps 192(%rcx), %ymm5
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm14 = ymm6[1],ymm5[1],ymm6[3],ymm5[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,2,3,3]
; AVX2-NEXT:    vbroadcastsd 216(%rsi), %ymm13
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1],ymm14[2,3,4,5,6,7]
...
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm14 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm14 = ymm13[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm14 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm14 = mem[0,1],ymm13[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 32(%rdx), %ymm0
; AVX2-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm3 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm3 = ymm0[2,3],mem[2,3]
; AVX2-NEXT:    vbroadcastsd 48(%rcx), %ymm13
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm13[2,3],ymm3[4,5,6,7]
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Reload
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm13[1],ymm0[1],ymm13[3],ymm0[3]
; AVX2-NEXT:    vbroadcastsd 56(%rcx), %ymm13
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm13[2,3]
...
; AVX2-NEXT:    # ymm14 = mem[0,1],ymm13[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm13[4,5],ymm3[6,7]
; AVX2-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm3 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm3 = ymm1[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm3 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm3 = mem[0,1],ymm1[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm8[0,1,2,3,4,5],ymm1[6,7]
; AVX2-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vblendps $252, (%rsp), %ymm3, %ymm8 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm8 = ymm3[0,1],mem[2,3,4,5,6,7]
...
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm4[0],ymm2[0],ymm4[2],ymm2[2]
; AVX2-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = ymm0[2,3],mem[2,3]
; AVX2-NEXT:    vmovaps 128(%r8), %ymm2
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm14 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm14 = ymm2[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm12 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm12 = mem[0,1],ymm2[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm11[0,1,2,3,4,5],ymm2[6,7]
; AVX2-NEXT:    vmovups %ymm1, (%rsp) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm0[0,1,2,3],ymm2[4,5],ymm0[6,7]
; AVX2-NEXT:    vmovaps 160(%rdx), %ymm0
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm0[2,3],ymm10[2,3]
; AVX2-NEXT:    vbroadcastsd 176(%rcx), %ymm8
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm8[2,3],ymm2[4,5,6,7]
...
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm0[2,3],ymm8[2,3]
; AVX2-NEXT:    vmovaps 160(%r8), %ymm0
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm2[0,1,2,3],ymm0[4,5],ymm2[6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1,2,3,4,5],ymm0[6,7]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm6[0],ymm5[0],ymm6[2],ymm5[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm0[2,3],ymm9[2,3]
; AVX2-NEXT:    vmovaps 192(%r8), %ymm6
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm9 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm9 = ymm6[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm2 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm2 = mem[0,1],ymm6[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vblendps $63, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm13 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm13 = mem[0,1,2,3,4,5],ymm6[6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2,3],ymm6[4,5],ymm5[6,7]
; AVX2-NEXT:    vmovaps 224(%rdx), %ymm6
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm6[2,3],ymm7[2,3]
; AVX2-NEXT:    vbroadcastsd 240(%rcx), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm15[2,3],ymm7[4,5,6,7]
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm0[1],ymm6[1],ymm0[3],ymm6[3]
; AVX2-NEXT:    vbroadcastsd 248(%rcx), %ymm15
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm6[2,3],ymm15[2,3]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3],ymm15[4,5],ymm7[6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1,2,3,4,5],ymm15[6,7]
; AVX2-NEXT:    vmovaps %ymm6, 1248(%r9)
; AVX2-NEXT:    vmovaps %ymm7, 1216(%r9)
; AVX2-NEXT:    vmovaps %ymm0, 1184(%r9)
; AVX2-NEXT:    vmovaps %ymm1, 1152(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 1120(%r9)
; AVX2-NEXT:    vmovaps %ymm5, 1056(%r9)
; AVX2-NEXT:    vmovaps %ymm2, 1024(%r9)
; AVX2-NEXT:    vmovaps %ymm9, 992(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 960(%r9)
; AVX2-NEXT:    vmovaps %ymm10, 928(%r9)
; AVX2-NEXT:    vmovaps %ymm3, 896(%r9)
; AVX2-NEXT:    vmovaps %ymm4, 864(%r9)
; AVX2-NEXT:    vmovaps %ymm8, 832(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 800(%r9)
; AVX2-NEXT:    vmovaps %ymm11, 736(%r9)
...
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, (%r9)
; AVX2-NEXT:    vmovaps %ymm13, 1088(%r9)
...
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 128(%r9)
; AVX2-NEXT:    addq $1064, %rsp # imm = 0x428
; AVX2-NEXT:    vzeroupper
; AVX2-NEXT:    retq
;
; AVX2-FP-LABEL: store_i64_stride5_vf32:
; AVX2-FP:       # %bb.0:
; AVX2-FP-NEXT:    subq $1064, %rsp # imm = 0x428
...
; AVX2-FP-NEXT:    vmovaps 64(%rsi), %xmm0
; AVX2-FP-NEXT:    vinsertf128 $1, (%rcx), %ymm1, %ymm4
...
; AVX2-FP-NEXT:    vinsertf128 $1, %xmm7, %ymm0, %ymm4
...
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vinsertf128 $1, 32(%rcx), %ymm3, %ymm3
; AVX2-FP-NEXT:    vinsertf128 $1, %xmm8, %ymm6, %ymm4
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm4[0],ymm3[0],ymm4[2],ymm3[2]
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vinsertf128 $1, %xmm8, %ymm0, %ymm3
; AVX2-FP-NEXT:    vbroadcastsd 40(%rsi), %ymm4
; AVX2-FP-NEXT:    vmovups %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm10[0,1,2,3],ymm4[4,5,6,7]
...
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm10[0],ymm1[0],ymm10[2],ymm1[2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vmovaps (%rcx), %ymm0
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm15[1],ymm0[1],ymm15[3],ymm0[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,2,3,3]
; AVX2-FP-NEXT:    vbroadcastsd 24(%rsi), %ymm2
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm2[0,1],ymm1[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovaps 64(%rdx), %ymm12
; AVX2-FP-NEXT:    vmovaps 64(%rcx), %ymm1
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm12[1],ymm1[1],ymm12[3],ymm1[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,2,3,3]
; AVX2-FP-NEXT:    vbroadcastsd 88(%rsi), %ymm4
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm4[0,1],ymm2[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovaps 128(%rdx), %ymm4
; AVX2-FP-NEXT:    vmovaps 128(%rcx), %ymm2
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm4[1],ymm2[1],ymm4[3],ymm2[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,2,3,3]
; AVX2-FP-NEXT:    vbroadcastsd 152(%rsi), %ymm6
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm6[0,1],ymm5[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovaps 192(%rdx), %ymm6
; AVX2-FP-NEXT:    vmovaps 192(%rcx), %ymm5
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm14 = ymm6[1],ymm5[1],ymm6[3],ymm5[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,2,3,3]
; AVX2-FP-NEXT:    vbroadcastsd 216(%rsi), %ymm13
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1],ymm14[2,3,4,5,6,7]
...
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm14 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm14 = ymm13[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm14 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm14 = mem[0,1],ymm13[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 32(%rdx), %ymm0
; AVX2-FP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm3 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm3 = ymm0[2,3],mem[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 48(%rcx), %ymm13
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm13[2,3],ymm3[4,5,6,7]
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Reload
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm13[1],ymm0[1],ymm13[3],ymm0[3]
; AVX2-FP-NEXT:    vbroadcastsd 56(%rcx), %ymm13
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm13[2,3]
; AVX2-FP-NEXT:    vmovaps 32(%r8), %ymm13
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm14 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm14 = ymm13[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm14 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm14 = mem[0,1],ymm13[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm13[4,5],ymm3[6,7]
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm3 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm3 = ymm1[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm3 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm3 = mem[0,1],ymm1[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm8[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vblendps $252, (%rsp), %ymm3, %ymm8 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm8 = ymm3[0,1],mem[2,3,4,5,6,7]
...
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm4[0],ymm2[0],ymm4[2],ymm2[2]
; AVX2-FP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = ymm0[2,3],mem[2,3]
; AVX2-FP-NEXT:    vmovaps 128(%r8), %ymm2
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm14 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm14 = ymm2[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm12 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm12 = mem[0,1],ymm2[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm11[0,1,2,3,4,5],ymm2[6,7]
; AVX2-FP-NEXT:    vmovups %ymm1, (%rsp) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm0[0,1,2,3],ymm2[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vmovaps 160(%rdx), %ymm0
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm0[2,3],ymm10[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 176(%rcx), %ymm8
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm8[2,3],ymm2[4,5,6,7]
...
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm0[2,3],ymm8[2,3]
; AVX2-FP-NEXT:    vmovaps 160(%r8), %ymm0
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm2[0,1,2,3],ymm0[4,5],ymm2[6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm6[0],ymm5[0],ymm6[2],ymm5[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm0[2,3],ymm9[2,3]
; AVX2-FP-NEXT:    vmovaps 192(%r8), %ymm6
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm9 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm9 = ymm6[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm2 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm2 = mem[0,1],ymm6[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vblendps $63, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm13 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm13 = mem[0,1,2,3,4,5],ymm6[6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2,3],ymm6[4,5],ymm5[6,7]
; AVX2-FP-NEXT:    vmovaps 224(%rdx), %ymm6
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm6[2,3],ymm7[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 240(%rcx), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm15[2,3],ymm7[4,5,6,7]
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm0[1],ymm6[1],ymm0[3],ymm6[3]
; AVX2-FP-NEXT:    vbroadcastsd 248(%rcx), %ymm15
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm6[2,3],ymm15[2,3]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3],ymm15[4,5],ymm7[6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1,2,3,4,5],ymm15[6,7]
; AVX2-FP-NEXT:    vmovaps %ymm6, 1248(%r9)
...
; AVX2-FP-NEXT:    vmovaps %ymm5, 1056(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm2, 1024(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm9, 992(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, 960(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm10, 928(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm3, 896(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm4, 864(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm8, 832(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, 800(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm11, 736(%r9)
...
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, (%r9)
; AVX2-FP-NEXT:    vmovaps %ymm13, 1088(%r9)
...
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, 128(%r9)
; AVX2-FP-NEXT:    addq $1064, %rsp # imm = 0x428
; AVX2-FP-NEXT:    vzeroupper
; AVX2-FP-NEXT:    retq
;
; AVX2-FCP-LABEL: store_i64_stride5_vf32:
; AVX2-FCP:       # %bb.0:
; AVX2-FCP-NEXT:    subq $1064, %rsp # imm = 0x428
; AVX2-FCP-NEXT:    vmovaps 64(%rdi), %ymm9
; AVX2-FCP-NEXT:    vmovaps 32(%rdi), %ymm10
; AVX2-FCP-NEXT:    vmovaps (%rdi), %ymm12
; AVX2-FCP-NEXT:    vmovaps 32(%rsi), %ymm11
; AVX2-FCP-NEXT:    vmovups %ymm11, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps (%rsi), %xmm1
; AVX2-FCP-NEXT:    vmovaps 32(%rsi), %xmm3
; AVX2-FCP-NEXT:    vmovaps 64(%rsi), %xmm0
; AVX2-FCP-NEXT:    vinsertf128 $1, (%rcx), %ymm1, %ymm4
...
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm7, %ymm0, %ymm4
...
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vinsertf128 $1, 32(%rcx), %ymm3, %ymm3
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm8, %ymm6, %ymm4
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm4[0],ymm3[0],ymm4[2],ymm3[2]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm8, %ymm0, %ymm3
; AVX2-FCP-NEXT:    vbroadcastsd 40(%rsi), %ymm4
; AVX2-FCP-NEXT:    vmovups %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm10[0,1,2,3],ymm4[4,5,6,7]
...
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm0
; AVX2-FCP-NEXT:    vmovaps 160(%rdi), %ymm10
...
; AVX2-FCP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm10[0],ymm1[0],ymm10[2],ymm1[2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps (%rdx), %ymm15
; AVX2-FCP-NEXT:    vmovaps (%rcx), %ymm0
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm15[1],ymm0[1],ymm15[3],ymm0[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,2,3,3]
; AVX2-FCP-NEXT:    vbroadcastsd 24(%rsi), %ymm2
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm2[0,1],ymm1[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovaps 64(%rdx), %ymm12
; AVX2-FCP-NEXT:    vmovaps 64(%rcx), %ymm1
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm12[1],ymm1[1],ymm12[3],ymm1[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,2,3,3]
; AVX2-FCP-NEXT:    vbroadcastsd 88(%rsi), %ymm4
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm4[0,1],ymm2[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovaps 128(%rdx), %ymm4
; AVX2-FCP-NEXT:    vmovaps 128(%rcx), %ymm2
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm4[1],ymm2[1],ymm4[3],ymm2[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,2,3,3]
; AVX2-FCP-NEXT:    vbroadcastsd 152(%rsi), %ymm6
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm6[0,1],ymm5[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovaps 192(%rdx), %ymm6
; AVX2-FCP-NEXT:    vmovaps 192(%rcx), %ymm5
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm14 = ymm6[1],ymm5[1],ymm6[3],ymm5[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,2,3,3]
; AVX2-FCP-NEXT:    vbroadcastsd 216(%rsi), %ymm13
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1],ymm14[2,3,4,5,6,7]
...
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm14 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm14 = ymm13[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm14 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm14 = mem[0,1],ymm13[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3,4,5],ymm13[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm13[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 32(%rdx), %ymm0
; AVX2-FCP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm3 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm3 = ymm0[2,3],mem[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 48(%rcx), %ymm13
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm13[2,3],ymm3[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Reload
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm13[1],ymm0[1],ymm13[3],ymm0[3]
; AVX2-FCP-NEXT:    vbroadcastsd 56(%rcx), %ymm13
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm13[2,3]
; AVX2-FCP-NEXT:    vmovaps 32(%r8), %ymm13
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm14 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm14 = ymm13[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm14 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm14 = mem[0,1],ymm13[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm13[4,5],ymm3[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm3 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm3 = ymm1[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm3 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm3 = mem[0,1],ymm1[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm8[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vmovaps 96(%r8), %ymm3
; AVX2-FCP-NEXT:    vblendps $252, (%rsp), %ymm3, %ymm8 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm8 = ymm3[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm8 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm8 = mem[0,1],ymm3[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm3[4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm3[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm4[0],ymm2[0],ymm4[2],ymm2[2]
; AVX2-FCP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm0 = ymm0[2,3],mem[2,3]
; AVX2-FCP-NEXT:    vmovaps 128(%r8), %ymm2
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm14 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm14 = ymm2[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm12 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm12 = mem[0,1],ymm2[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm11[0,1,2,3,4,5],ymm2[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm1, (%rsp) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm0[0,1,2,3],ymm2[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovaps 160(%rdx), %ymm0
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm0[2,3],ymm10[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 176(%rcx), %ymm8
...
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm0[2,3],ymm8[2,3]
; AVX2-FCP-NEXT:    vmovaps 160(%r8), %ymm0
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm6[0],ymm5[0],ymm6[2],ymm5[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm0[2,3],ymm9[2,3]
; AVX2-FCP-NEXT:    vmovaps 192(%r8), %ymm6
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm9 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm9 = ymm6[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm2 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm2 = mem[0,1],ymm6[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps $63, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm13 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm13 = mem[0,1,2,3,4,5],ymm6[6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2,3],ymm6[4,5],ymm5[6,7]
; AVX2-FCP-NEXT:    vmovaps 224(%rdx), %ymm6
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm6[2,3],ymm7[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 240(%rcx), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm15[2,3],ymm7[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm0[1],ymm6[1],ymm0[3],ymm6[3]
; AVX2-FCP-NEXT:    vbroadcastsd 248(%rcx), %ymm15
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm6[2,3],ymm15[2,3]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3],ymm15[4,5],ymm7[6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1,2,3,4,5],ymm15[6,7]
; AVX2-FCP-NEXT:    vmovaps %ymm6, 1248(%r9)
...
; AVX2-FCP-NEXT:    vmovaps %ymm5, 1056(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm2, 1024(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm9, 992(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, 960(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm10, 928(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm3, 896(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm4, 864(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm8, 832(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, 800(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm11, 736(%r9)
...
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, (%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm13, 1088(%r9)
...
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, 128(%r9)
; AVX2-FCP-NEXT:    addq $1064, %rsp # imm = 0x428
; AVX2-FCP-NEXT:    vzeroupper
; AVX2-FCP-NEXT:    retq
;
...
; AVX:       # %bb.0:
; AVX-NEXT:    subq $2216, %rsp # imm = 0x8A8
; AVX-NEXT:    vmovapd 160(%rdi), %ymm10
; AVX-NEXT:    vmovapd 128(%rdi), %ymm7
; AVX-NEXT:    vmovupd %ymm7, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 96(%rdi), %ymm8
; AVX-NEXT:    vmovapd 64(%rdi), %ymm9
; AVX-NEXT:    vmovupd %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 32(%rdi), %ymm5
; AVX-NEXT:    vmovapd (%rdi), %ymm6
; AVX-NEXT:    vmovapd 128(%rsi), %ymm0
; AVX-NEXT:    vmovapd 64(%rsi), %ymm1
; AVX-NEXT:    vmovapd (%rsi), %ymm2
; AVX-NEXT:    vmovddup {{.*#+}} xmm3 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm6[0],ymm2[0],ymm6[2],ymm2[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm15 = ymm3[0,1],ymm4[2,3]
; AVX-NEXT:    vpermilpd {{.*#+}} ymm3 = mem[0,0,3,2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm2[2,3],ymm3[2,3]
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovddup {{.*#+}} xmm2 = mem[0,0]
...
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovddup {{.*#+}} xmm2 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm9[0],ymm1[0],ymm9[2],ymm1[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],ymm3[2,3]
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpermilpd {{.*#+}} ymm2 = mem[0,0,3,2]
...
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovddup {{.*#+}} xmm1 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm7[0],ymm0[0],ymm7[2],ymm0[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpermilpd {{.*#+}} ymm1 = mem[0,0,3,2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm1[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm10[0],mem[0],ymm10[2],mem[2]
; AVX-NEXT:    vmovapd %ymm10, %ymm12
; AVX-NEXT:    vmovupd %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vmovapd 192(%rsi), %ymm0
; AVX-NEXT:    vmovddup {{.*#+}} xmm1 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm2[0],ymm0[0],ymm2[2],ymm0[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpermilpd {{.*#+}} ymm1 = mem[0,0,3,2]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm1[2,3]
...
; AVX-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm2[0],mem[0],ymm2[2],mem[2]
; AVX-NEXT:    vmovapd %ymm2, %ymm11
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 384(%rdi), %ymm2
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 384(%rsi), %ymm0
; AVX-NEXT:    vmovddup {{.*#+}} xmm1 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm2[0],ymm0[0],ymm2[2],ymm0[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm2[0],mem[0],ymm2[2],mem[2]
; AVX-NEXT:    vmovapd %ymm2, %ymm10
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 448(%rdi), %ymm2
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 448(%rsi), %ymm0
; AVX-NEXT:    vmovddup {{.*#+}} xmm1 = mem[0,0]
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm2[0],ymm0[0],ymm2[2],ymm0[2]
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm7 = ymm1[0],ymm0[0],ymm1[2],ymm0[3]
; AVX-NEXT:    vmovlpd {{.*#+}} xmm0 = mem[0],xmm1[1]
; AVX-NEXT:    vbroadcastsd 56(%rcx), %ymm1
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm0[0,1],ymm1[2,3]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = mem[2,3],ymm8[2,3]
; AVX-NEXT:    vmovapd 112(%rdx), %xmm3
; AVX-NEXT:    vshufpd {{.*#+}} ymm9 = ymm3[0],ymm0[0],ymm3[2],ymm0[3]
; AVX-NEXT:    vmovlpd {{.*#+}} xmm0 = mem[0],xmm3[1]
; AVX-NEXT:    vbroadcastsd 120(%rcx), %ymm3
; AVX-NEXT:    vblendpd {{.*#+}} ymm3 = ymm0[0,1],ymm3[2,3]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = mem[2,3],ymm12[2,3]
; AVX-NEXT:    vmovapd 176(%rdx), %xmm12
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm12[0],ymm0[0],ymm12[2],ymm0[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovlpd {{.*#+}} xmm0 = mem[0],xmm12[1]
; AVX-NEXT:    vbroadcastsd 184(%rcx), %ymm12
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm12[2,3]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm12 = mem[2,3],ymm14[2,3]
; AVX-NEXT:    vmovapd 240(%rdx), %xmm13
; AVX-NEXT:    vshufpd {{.*#+}} ymm12 = ymm13[0],ymm12[0],ymm13[2],ymm12[3]
; AVX-NEXT:    vmovupd %ymm12, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovlpd {{.*#+}} xmm12 = mem[0],xmm13[1]
; AVX-NEXT:    vbroadcastsd 248(%rcx), %ymm13
; AVX-NEXT:    vblendpd {{.*#+}} ymm12 = ymm12[0,1],ymm13[2,3]
; AVX-NEXT:    vmovupd %ymm12, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm12 = mem[2,3],ymm4[2,3]
; AVX-NEXT:    vmovapd 304(%rdx), %xmm13
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm13[0],ymm12[0],ymm13[2],ymm12[3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovlpd {{.*#+}} xmm12 = mem[0],xmm13[1]
; AVX-NEXT:    vbroadcastsd 312(%rcx), %ymm13
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm12[0,1],ymm13[2,3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm12 = mem[2,3],ymm11[2,3]
; AVX-NEXT:    vmovapd 368(%rdx), %xmm13
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm13[0],ymm12[0],ymm13[2],ymm12[3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovlpd {{.*#+}} xmm12 = mem[0],xmm13[1]
; AVX-NEXT:    vbroadcastsd 376(%rcx), %ymm13
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm12[0,1],ymm13[2,3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm12 = mem[2,3],ymm10[2,3]
; AVX-NEXT:    vmovapd 432(%rdx), %xmm13
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm13[0],ymm12[0],ymm13[2],ymm12[3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovlpd {{.*#+}} xmm12 = mem[0],xmm13[1]
...
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm12[0,1],ymm13[2,3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm12 = mem[2,3],ymm2[2,3]
; AVX-NEXT:    vmovapd 496(%rdx), %xmm13
; AVX-NEXT:    vshufpd {{.*#+}} ymm2 = ymm13[0],ymm12[0],ymm13[2],ymm12[3]
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovlpd {{.*#+}} xmm12 = mem[0],xmm13[1]
; AVX-NEXT:    vbroadcastsd 504(%rcx), %ymm13
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm12[0,1],ymm13[2,3]
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 16(%rdx), %xmm12
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX-NEXT:    vshufpd {{.*#+}} ymm13 = ymm2[1],ymm12[1],ymm2[2],ymm12[2]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm12 = xmm12[0],mem[0]
; AVX-NEXT:    vblendpd {{.*#+}} ymm12 = ymm12[0,1],ymm6[2,3]
; AVX-NEXT:    vmovaps (%rdx), %xmm2
; AVX-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm6, %ymm6
; AVX-NEXT:    vbroadcastsd 8(%rsi), %ymm14
; AVX-NEXT:    vblendpd {{.*#+}} ymm6 = ymm6[0,1],ymm14[2],ymm6[3]
; AVX-NEXT:    vmovapd (%r8), %ymm14
; AVX-NEXT:    vblendpd {{.*#+}} ymm15 = ymm15[0],ymm14[1],ymm15[2,3]
; AVX-NEXT:    vmovupd %ymm15, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm13 = ymm13[0,1,2],ymm14[3]
; AVX-NEXT:    vmovupd %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm12 = ymm12[0,1],ymm14[2],ymm12[3]
; AVX-NEXT:    vmovupd %ymm12, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm6 = ymm14[0],ymm6[1,2,3]
; AVX-NEXT:    vmovupd %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 32(%rdx), %xmm2
; AVX-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm5, %ymm5
; AVX-NEXT:    vbroadcastsd 40(%rsi), %ymm6
; AVX-NEXT:    vblendpd {{.*#+}} ymm5 = ymm5[0,1],ymm6[2],ymm5[3]
; AVX-NEXT:    vmovapd 32(%r8), %ymm6
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm12 # 32-byte Folded Reload
; AVX-NEXT:    # ymm12 = mem[0],ymm6[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm12, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm7[0,1],ymm6[2],ymm7[3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm1[0,1,2],ymm6[3]
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm6[0],ymm5[1,2,3]
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 80(%rdx), %xmm2
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm4 # 32-byte Reload
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm4[1],ymm2[1],ymm4[2],ymm2[2]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm2 = xmm2[0],mem[0]
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm5 # 32-byte Reload
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],ymm5[2,3]
; AVX-NEXT:    vmovaps 64(%rdx), %xmm12
...
; AVX-NEXT:    # ymm1 = mem[0],ymm6[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm4[0,1,2],ymm6[3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],ymm6[2],ymm2[3]
; AVX-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm6[0],ymm5[1,2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 96(%rdx), %xmm1
; AVX-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm8, %ymm2
; AVX-NEXT:    vbroadcastsd 104(%rsi), %ymm4
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],ymm4[2],ymm2[3]
; AVX-NEXT:    vmovapd 96(%r8), %ymm4
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm4, %ymm1 # 32-byte Folded Reload
; AVX-NEXT:    # ymm1 = mem[0],ymm4[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm9[0,1],ymm4[2],ymm9[3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm3[0,1,2],ymm4[3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm4[0],ymm2[1,2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 144(%rdx), %xmm1
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX-NEXT:    vshufpd {{.*#+}} ymm3 = ymm2[1],ymm1[1],ymm2[2],ymm1[2]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm1 = xmm1[0],mem[0]
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm4 # 32-byte Reload
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1],ymm4[2,3]
; AVX-NEXT:    vmovaps 128(%rdx), %xmm2
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm4, %ymm4
; AVX-NEXT:    vbroadcastsd 136(%rsi), %ymm5
; AVX-NEXT:    vblendpd {{.*#+}} ymm4 = ymm4[0,1],ymm5[2],ymm4[3]
; AVX-NEXT:    vmovapd 128(%r8), %ymm5
...
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm5[0],ymm4[1,2,3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 160(%rdx), %xmm9
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX-NEXT:    vinsertf128 $1, %xmm9, %ymm1, %ymm1
; AVX-NEXT:    vbroadcastsd 168(%rsi), %ymm3
...
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd $11, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm4 # 32-byte Folded Reload
; AVX-NEXT:    # ymm4 = mem[0,1],ymm3[2],mem[3]
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm3[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm3[0],ymm1[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 208(%rdx), %xmm0
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX-NEXT:    vshufpd {{.*#+}} ymm1 = ymm1[1],ymm0[1],ymm1[2],ymm0[2]
...
; AVX-NEXT:    vmovaps 192(%rdx), %xmm11
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm3, %ymm3
; AVX-NEXT:    vbroadcastsd 200(%rsi), %ymm4
; AVX-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3]
...
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm4[2],ymm0[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm4[0],ymm3[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm3 # 32-byte Folded Reload
; AVX-NEXT:    # ymm3 = mem[0,1],ymm1[2,3],mem[4,5,6,7]
...
; AVX-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps $63, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm3 # 32-byte Folded Reload
; AVX-NEXT:    # ymm3 = mem[0,1,2,3,4,5],ymm1[6,7]
; AVX-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Reload
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm3[2,3]
; AVX-NEXT:    vmovaps 256(%rdx), %xmm4
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
; AVX-NEXT:    vbroadcastsd 264(%rsi), %ymm5
; AVX-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1],ymm5[2],ymm3[3]
; AVX-NEXT:    vmovapd 256(%r8), %ymm5
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm5, %ymm6 # 32-byte Folded Reload
; AVX-NEXT:    # ymm6 = mem[0],ymm5[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1,2],ymm5[3]
; AVX-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm5[2],ymm0[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm5[0],ymm3[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3,4,5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 336(%rdx), %xmm0
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX-NEXT:    vshufpd {{.*#+}} ymm1 = ymm1[1],ymm0[1],ymm1[2],ymm0[2]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm0 = xmm0[0],mem[0]
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Reload
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm3[2,3]
; AVX-NEXT:    vmovaps 320(%rdx), %xmm13
; AVX-NEXT:    vinsertf128 $1, %xmm13, %ymm3, %ymm3
; AVX-NEXT:    vbroadcastsd 328(%rsi), %ymm5
; AVX-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1],ymm5[2],ymm3[3]
; AVX-NEXT:    vmovapd 320(%r8), %ymm5
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm5, %ymm6 # 32-byte Folded Reload
; AVX-NEXT:    # ymm6 = mem[0],ymm5[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1,2],ymm5[3]
...
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Reload
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1],ymm3[2,3]
; AVX-NEXT:    vmovaps 384(%rdx), %xmm5
; AVX-NEXT:    vmovaps %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm3, %ymm3
; AVX-NEXT:    vbroadcastsd 392(%rsi), %ymm5
; AVX-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1],ymm5[2],ymm3[3]
; AVX-NEXT:    vmovapd 384(%r8), %ymm5
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm5, %ymm6 # 32-byte Folded Reload
; AVX-NEXT:    # ymm6 = mem[0],ymm5[1],mem[2,3]
; AVX-NEXT:    vmovupd %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1,2],ymm5[3]
...
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm5[0],ymm3[1,2,3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 416(%rdx), %xmm3
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm0, %ymm0
; AVX-NEXT:    vbroadcastsd 424(%rsi), %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5],ymm0[6,7]
; AVX-NEXT:    vmovaps 416(%r8), %ymm1
; AVX-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm5 # 32-byte Folded Reload
; AVX-NEXT:    # ymm5 = mem[0,1],ymm1[2,3],mem[4,5,6,7]
; AVX-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps $207, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm5 # 32-byte Folded Reload
; AVX-NEXT:    # ymm5 = mem[0,1,2,3],ymm1[4,5],mem[6,7]
; AVX-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps $63, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm5 # 32-byte Folded Reload
; AVX-NEXT:    # ymm5 = mem[0,1,2,3,4,5],ymm1[6,7]
; AVX-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3,4,5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 464(%rdx), %xmm0
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX-NEXT:    vshufpd {{.*#+}} ymm5 = ymm1[1],ymm0[1],ymm1[2],ymm0[2]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm0 = xmm0[0],mem[0]
...
; AVX-NEXT:    vblendpd {{.*#+}} ymm6 = ymm6[0,1],ymm7[2],ymm6[3]
; AVX-NEXT:    vmovapd 448(%r8), %ymm7
; AVX-NEXT:    vblendpd $13, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm14 # 32-byte Folded Reload
; AVX-NEXT:    # ymm14 = mem[0],ymm7[1],mem[2,3]
...
; AVX-NEXT:    vbroadcastsd 488(%rsi), %ymm6
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2,3],ymm6[4,5],ymm5[6,7]
; AVX-NEXT:    vmovaps 480(%r8), %ymm6
; AVX-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm7 # 32-byte Folded Reload
; AVX-NEXT:    # ymm7 = mem[0,1],ymm6[2,3],mem[4,5,6,7]
; AVX-NEXT:    vmovups %ymm7, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps $207, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm7 # 32-byte Folded Reload
...
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm2 = xmm2[0],mem[0]
; AVX-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm2 = xmm9[0],mem[0]
; AVX-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovaps 224(%rdi), %xmm2
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm2 = xmm2[0],mem[0]
; AVX-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm2 = xmm10[0],mem[0]
; AVX-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm5 = xmm2[0],mem[0]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm15 = xmm15[0],mem[0]
...
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm12 = xmm12[0],mem[0]
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm3 = xmm3[0],mem[0]
; AVX-NEXT:    vmovaps 480(%rdi), %xmm11
; AVX-NEXT:    vunpcklpd {{.*#+}} xmm11 = xmm11[0],mem[0]
...
; AVX-NEXT:    vmovaps %xmm7, (%r9)
; AVX-NEXT:    vmovaps %xmm0, 1936(%r9)
; AVX-NEXT:    vmovaps %xmm9, 1920(%r9)
; AVX-NEXT:    vmovaps %xmm1, 2256(%r9)
; AVX-NEXT:    vmovaps %xmm10, 2240(%r9)
; AVX-NEXT:    vmovaps %xmm2, 2416(%r9)
; AVX-NEXT:    vmovaps %xmm11, 2400(%r9)
; AVX-NEXT:    vmovaps %xmm3, 2096(%r9)
; AVX-NEXT:    vmovaps %xmm12, 2080(%r9)
; AVX-NEXT:    vmovaps %xmm13, 1616(%r9)
; AVX-NEXT:    vmovaps %xmm14, 1600(%r9)
; AVX-NEXT:    vmovaps %xmm8, 1776(%r9)
; AVX-NEXT:    vmovaps %xmm4, 1760(%r9)
; AVX-NEXT:    vmovaps %xmm15, 1456(%r9)
; AVX-NEXT:    vmovaps %xmm5, 1440(%r9)
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vmovaps %ymm0, 96(%r9)
; AVX-NEXT:    addq $2216, %rsp # imm = 0x8A8
; AVX-NEXT:    vzeroupper
; AVX-NEXT:    retq
;
; AVX2-LABEL: store_i64_stride5_vf64:
; AVX2:       # %bb.0:
; AVX2-NEXT:    subq $2632, %rsp # imm = 0xA48
; AVX2-NEXT:    vmovaps 64(%rdi), %ymm9
; AVX2-NEXT:    vmovaps 32(%rdi), %ymm10
; AVX2-NEXT:    vmovaps (%rdi), %ymm12
; AVX2-NEXT:    vmovaps 32(%rsi), %ymm11
...
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm6[1],ymm1[1],ymm6[3],ymm1[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,2,3,3]
; AVX2-NEXT:    vbroadcastsd 24(%rsi), %ymm3
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm3[0,1],ymm2[2,3,4,5,6,7]
; AVX2-NEXT:    vmovaps 64(%rdx), %ymm3
; AVX2-NEXT:    vmovaps 64(%rcx), %ymm2
...
; AVX2-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX2-NEXT:    vmovaps 128(%rdx), %ymm8
; AVX2-NEXT:    vmovaps 128(%rcx), %ymm4
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm8[1],ymm4[1],ymm8[3],ymm4[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,2,3,3]
; AVX2-NEXT:    vbroadcastsd 152(%rsi), %ymm9
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0,1],ymm5[2,3,4,5,6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 192(%rdx), %ymm15
; AVX2-NEXT:    vmovaps 192(%rcx), %ymm5
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm15[1],ymm5[1],ymm15[3],ymm5[3]
...
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 256(%rdx), %ymm10
; AVX2-NEXT:    vmovaps 256(%rcx), %ymm9
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm10[1],ymm9[1],ymm10[3],ymm9[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[0,2,3,3]
; AVX2-NEXT:    vbroadcastsd 280(%rsi), %ymm12
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0,1],ymm11[2,3,4,5,6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 320(%rdx), %ymm12
; AVX2-NEXT:    vmovaps 320(%rcx), %ymm11
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm13 = ymm12[1],ymm11[1],ymm12[3],ymm11[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[0,2,3,3]
; AVX2-NEXT:    vbroadcastsd 344(%rsi), %ymm14
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm13[2,3,4,5,6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 384(%rdx), %ymm0
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 384(%rcx), %ymm13
; AVX2-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm14 = ymm0[1],ymm13[1],ymm0[3],ymm13[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,2,3,3]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm13[2,3,4,5,6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm6[0],ymm1[0],ymm6[2],ymm1[2]
; AVX2-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = ymm0[2,3],mem[2,3]
; AVX2-NEXT:    vmovaps (%r8), %ymm1
...
; AVX2-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3,4,5],ymm1[6,7]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm7[2,3],ymm1[4,5,6,7]
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm7 # 32-byte Reload
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm7[1],ymm0[1],ymm7[3],ymm0[3]
; AVX2-NEXT:    vbroadcastsd 56(%rcx), %ymm7
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm7[2,3]
; AVX2-NEXT:    vmovaps 32(%r8), %ymm7
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm13 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm13 = ymm7[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm13 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm13 = mem[0,1],ymm7[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm7[4,5],ymm1[6,7]
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-NEXT:    vbroadcastsd 112(%rcx), %ymm2
...
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm3 = ymm2[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm3 = mem[0,1],ymm2[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4,5],ymm1[6,7]
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm2[6,7]
; AVX2-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm8[0],ymm4[0],ymm8[2],ymm4[2]
; AVX2-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = ymm0[2,3],mem[2,3]
...
; AVX2-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-NEXT:    vbroadcastsd 176(%rcx), %ymm2
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
...
; AVX2-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-NEXT:    vbroadcastsd 240(%rcx), %ymm2
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
; AVX2-NEXT:    vbroadcastsd 248(%rcx), %ymm2
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm2[2,3]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5],ymm0[6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 288(%rdx), %ymm0
; AVX2-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-NEXT:    vbroadcastsd 304(%rcx), %ymm2
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5],ymm0[6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 352(%rdx), %ymm0
; AVX2-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-NEXT:    vbroadcastsd 368(%rcx), %ymm2
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
; AVX2-NEXT:    vbroadcastsd 376(%rcx), %ymm2
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm2[2,3]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4,5],ymm1[6,7]
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm12 = ymm0[0,1,2,3,4,5],ymm2[6,7]
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm13 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm13 = ymm1[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm14 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm14 = mem[0,1],ymm1[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vblendps $63, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm2 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm2 = mem[0,1,2,3,4,5],ymm1[6,7]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm10 = ymm0[0,1,2,3],ymm1[4,5],ymm0[6,7]
; AVX2-NEXT:    vmovaps 416(%rdx), %ymm0
; AVX2-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-NEXT:    vbroadcastsd 432(%rcx), %ymm11
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm1[0,1],ymm11[2,3],ymm1[4,5,6,7]
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm1[1],ymm0[1],ymm1[3],ymm0[3]
; AVX2-NEXT:    vbroadcastsd 440(%rcx), %ymm1
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm0[2,3],ymm1[2,3]
; AVX2-NEXT:    vmovaps 416(%r8), %ymm0
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm9 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm9 = ymm0[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm8 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm8 = mem[0,1],ymm0[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1,2,3],ymm0[4,5],ymm11[6,7]
...
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm6 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm6 = ymm0[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm5 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm5 = mem[0,1],ymm0[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vblendps $63, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm2 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm2 = mem[0,1,2,3,4,5],ymm0[6,7]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm1[0,1,2,3],ymm0[4,5],ymm1[6,7]
; AVX2-NEXT:    vmovaps 480(%rdx), %ymm1
; AVX2-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = ymm1[2,3],mem[2,3]
; AVX2-NEXT:    vbroadcastsd 496(%rcx), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm0[0,1],ymm15[2,3],ymm0[4,5,6,7]
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm0[1],ymm1[1],ymm0[3],ymm1[3]
; AVX2-NEXT:    vbroadcastsd 504(%rcx), %ymm15
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm1[2,3],ymm15[2,3]
; AVX2-NEXT:    vmovaps 480(%r8), %ymm15
; AVX2-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15, %ymm2 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm2 = ymm15[0,1],mem[2,3,4,5,6,7]
; AVX2-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15, %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = mem[0,1],ymm15[2,3],mem[4,5,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm15[4,5],ymm3[6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3,4,5],ymm15[6,7]
; AVX2-NEXT:    vmovaps %ymm1, 2528(%r9)
; AVX2-NEXT:    vmovaps %ymm3, 2496(%r9)
; AVX2-NEXT:    vmovaps %ymm0, 2464(%r9)
; AVX2-NEXT:    vmovaps %ymm2, 2432(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 2400(%r9)
; AVX2-NEXT:    vmovaps %ymm4, 2336(%r9)
; AVX2-NEXT:    vmovaps %ymm5, 2304(%r9)
; AVX2-NEXT:    vmovaps %ymm6, 2272(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 2240(%r9)
; AVX2-NEXT:    vmovaps %ymm7, 2208(%r9)
; AVX2-NEXT:    vmovaps %ymm11, 2176(%r9)
; AVX2-NEXT:    vmovaps %ymm8, 2144(%r9)
; AVX2-NEXT:    vmovaps %ymm9, 2112(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 2080(%r9)
; AVX2-NEXT:    vmovaps %ymm10, 2016(%r9)
; AVX2-NEXT:    vmovaps %ymm14, 1984(%r9)
; AVX2-NEXT:    vmovaps %ymm13, 1952(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 1920(%r9)
; AVX2-NEXT:    vmovaps %ymm12, 1888(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 1856(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, 128(%r9)
; AVX2-NEXT:    addq $2632, %rsp # imm = 0xA48
; AVX2-NEXT:    vzeroupper
; AVX2-NEXT:    retq
;
; AVX2-FP-LABEL: store_i64_stride5_vf64:
; AVX2-FP:       # %bb.0:
; AVX2-FP-NEXT:    subq $2632, %rsp # imm = 0xA48
; AVX2-FP-NEXT:    vmovaps 64(%rdi), %ymm9
; AVX2-FP-NEXT:    vmovaps 32(%rdi), %ymm10
; AVX2-FP-NEXT:    vmovaps (%rdi), %ymm12
; AVX2-FP-NEXT:    vmovaps 32(%rsi), %ymm11
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 480(%rsi), %ymm1
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm2[0],ymm1[0],ymm2[2],ymm1[2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
...
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm6[1],ymm1[1],ymm6[3],ymm1[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,2,3,3]
; AVX2-FP-NEXT:    vbroadcastsd 24(%rsi), %ymm3
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm3[0,1],ymm2[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovaps 64(%rdx), %ymm3
; AVX2-FP-NEXT:    vmovaps 64(%rcx), %ymm2
...
; AVX2-FP-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 128(%rdx), %ymm8
; AVX2-FP-NEXT:    vmovaps 128(%rcx), %ymm4
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm8[1],ymm4[1],ymm8[3],ymm4[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,2,3,3]
; AVX2-FP-NEXT:    vbroadcastsd 152(%rsi), %ymm9
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0,1],ymm5[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 192(%rdx), %ymm15
; AVX2-FP-NEXT:    vmovaps 192(%rcx), %ymm5
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm15[1],ymm5[1],ymm15[3],ymm5[3]
...
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 256(%rdx), %ymm10
; AVX2-FP-NEXT:    vmovaps 256(%rcx), %ymm9
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm10[1],ymm9[1],ymm10[3],ymm9[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[0,2,3,3]
; AVX2-FP-NEXT:    vbroadcastsd 280(%rsi), %ymm12
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0,1],ymm11[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 320(%rdx), %ymm12
; AVX2-FP-NEXT:    vmovaps 320(%rcx), %ymm11
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm13 = ymm12[1],ymm11[1],ymm12[3],ymm11[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[0,2,3,3]
; AVX2-FP-NEXT:    vbroadcastsd 344(%rsi), %ymm14
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm13[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 384(%rdx), %ymm0
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 384(%rcx), %ymm13
; AVX2-FP-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm14 = ymm0[1],ymm13[1],ymm0[3],ymm13[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,2,3,3]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm13[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm6[0],ymm1[0],ymm6[2],ymm1[2]
; AVX2-FP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = ymm0[2,3],mem[2,3]
; AVX2-FP-NEXT:    vmovaps (%r8), %ymm1
...
; AVX2-FP-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3,4,5],ymm1[6,7]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm7[2,3],ymm1[4,5,6,7]
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm7 # 32-byte Reload
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm7[1],ymm0[1],ymm7[3],ymm0[3]
; AVX2-FP-NEXT:    vbroadcastsd 56(%rcx), %ymm7
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm7[2,3]
; AVX2-FP-NEXT:    vmovaps 32(%r8), %ymm7
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm13 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm13 = ymm7[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm13 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm13 = mem[0,1],ymm7[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm7[4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 112(%rcx), %ymm2
...
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm3 = ymm2[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm3 = mem[0,1],ymm2[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm2[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm8[0],ymm4[0],ymm8[2],ymm4[2]
; AVX2-FP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = ymm0[2,3],mem[2,3]
...
; AVX2-FP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 176(%rcx), %ymm2
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
...
; AVX2-FP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 240(%rcx), %ymm2
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
; AVX2-FP-NEXT:    vbroadcastsd 248(%rcx), %ymm2
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm2[2,3]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 288(%rdx), %ymm0
; AVX2-FP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 304(%rcx), %ymm2
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
; AVX2-FP-NEXT:    vbroadcastsd 312(%rcx), %ymm2
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm2[2,3]
; AVX2-FP-NEXT:    vmovaps 288(%r8), %ymm2
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm3 = ymm2[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 352(%rdx), %ymm0
; AVX2-FP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 368(%rcx), %ymm2
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
; AVX2-FP-NEXT:    vbroadcastsd 376(%rcx), %ymm2
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm2[2,3]
; AVX2-FP-NEXT:    vmovaps 352(%r8), %ymm2
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm3 = ymm2[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm0[0,1,2,3,4,5],ymm2[6,7]
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm13 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm13 = ymm1[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm14 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm14 = mem[0,1],ymm1[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vblendps $63, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm2 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm2 = mem[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm10 = ymm0[0,1,2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vmovaps 416(%rdx), %ymm0
; AVX2-FP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 432(%rcx), %ymm11
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm1[0,1],ymm11[2,3],ymm1[4,5,6,7]
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm1[1],ymm0[1],ymm1[3],ymm0[3]
; AVX2-FP-NEXT:    vbroadcastsd 440(%rcx), %ymm1
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm0[2,3],ymm1[2,3]
; AVX2-FP-NEXT:    vmovaps 416(%r8), %ymm0
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm9 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm9 = ymm0[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm8 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm8 = mem[0,1],ymm0[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1,2,3],ymm0[4,5],ymm11[6,7]
...
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm6 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm6 = ymm0[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm5 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm5 = mem[0,1],ymm0[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vblendps $63, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm2 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm2 = mem[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm1[0,1,2,3],ymm0[4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vmovaps 480(%rdx), %ymm1
; AVX2-FP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = ymm1[2,3],mem[2,3]
; AVX2-FP-NEXT:    vbroadcastsd 496(%rcx), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm0[0,1],ymm15[2,3],ymm0[4,5,6,7]
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm0[1],ymm1[1],ymm0[3],ymm1[3]
; AVX2-FP-NEXT:    vbroadcastsd 504(%rcx), %ymm15
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm1[2,3],ymm15[2,3]
; AVX2-FP-NEXT:    vmovaps 480(%r8), %ymm15
; AVX2-FP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15, %ymm2 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm2 = ymm15[0,1],mem[2,3,4,5,6,7]
; AVX2-FP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15, %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = mem[0,1],ymm15[2,3],mem[4,5,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm15[4,5],ymm3[6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3,4,5],ymm15[6,7]
; AVX2-FP-NEXT:    vmovaps %ymm1, 2528(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm3, 2496(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm0, 2464(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm2, 2432(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, 2400(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm4, 2336(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm5, 2304(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm6, 2272(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, 2240(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm7, 2208(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm11, 2176(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm8, 2144(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm9, 2112(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, 2080(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm10, 2016(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm14, 1984(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm13, 1952(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, 1920(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm12, 1888(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, 1856(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, 128(%r9)
; AVX2-FP-NEXT:    addq $2632, %rsp # imm = 0xA48
; AVX2-FP-NEXT:    vzeroupper
; AVX2-FP-NEXT:    retq
;
; AVX2-FCP-LABEL: store_i64_stride5_vf64:
; AVX2-FCP:       # %bb.0:
; AVX2-FCP-NEXT:    subq $2632, %rsp # imm = 0xA48
; AVX2-FCP-NEXT:    vmovaps 64(%rdi), %ymm9
; AVX2-FCP-NEXT:    vmovaps 32(%rdi), %ymm10
; AVX2-FCP-NEXT:    vmovaps (%rdi), %ymm12
; AVX2-FCP-NEXT:    vmovaps 32(%rsi), %ymm11
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 480(%rsi), %ymm1
; AVX2-FCP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovddup {{.*#+}} xmm0 = mem[0,0]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm2[0],ymm1[0],ymm2[2],ymm1[2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
...
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm6[1],ymm1[1],ymm6[3],ymm1[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,2,3,3]
; AVX2-FCP-NEXT:    vbroadcastsd 24(%rsi), %ymm3
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm3[0,1],ymm2[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovaps 64(%rdx), %ymm3
; AVX2-FCP-NEXT:    vmovaps 64(%rcx), %ymm2
...
; AVX2-FCP-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 128(%rdx), %ymm8
; AVX2-FCP-NEXT:    vmovaps 128(%rcx), %ymm4
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm8[1],ymm4[1],ymm8[3],ymm4[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,2,3,3]
; AVX2-FCP-NEXT:    vbroadcastsd 152(%rsi), %ymm9
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0,1],ymm5[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 192(%rdx), %ymm15
; AVX2-FCP-NEXT:    vmovaps 192(%rcx), %ymm5
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm15[1],ymm5[1],ymm15[3],ymm5[3]
...
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 256(%rdx), %ymm10
; AVX2-FCP-NEXT:    vmovaps 256(%rcx), %ymm9
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm10[1],ymm9[1],ymm10[3],ymm9[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[0,2,3,3]
; AVX2-FCP-NEXT:    vbroadcastsd 280(%rsi), %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0,1],ymm11[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 320(%rdx), %ymm12
; AVX2-FCP-NEXT:    vmovaps 320(%rcx), %ymm11
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm13 = ymm12[1],ymm11[1],ymm12[3],ymm11[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[0,2,3,3]
; AVX2-FCP-NEXT:    vbroadcastsd 344(%rsi), %ymm14
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm13[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 384(%rdx), %ymm0
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 384(%rcx), %ymm13
; AVX2-FCP-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm14 = ymm0[1],ymm13[1],ymm0[3],ymm13[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,2,3,3]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm13[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm6[0],ymm1[0],ymm6[2],ymm1[2]
; AVX2-FCP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm0 = ymm0[2,3],mem[2,3]
; AVX2-FCP-NEXT:    vmovaps (%r8), %ymm1
...
; AVX2-FCP-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3,4,5],ymm1[6,7]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm7[2,3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm7 # 32-byte Reload
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm7[1],ymm0[1],ymm7[3],ymm0[3]
; AVX2-FCP-NEXT:    vbroadcastsd 56(%rcx), %ymm7
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm7[2,3]
; AVX2-FCP-NEXT:    vmovaps 32(%r8), %ymm7
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm13 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm13 = ymm7[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm13 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm13 = mem[0,1],ymm7[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm7[4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 112(%rcx), %ymm2
...
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm3 = ymm2[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm3 = mem[0,1],ymm2[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm2[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm8[0],ymm4[0],ymm8[2],ymm4[2]
; AVX2-FCP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm0 = ymm0[2,3],mem[2,3]
...
; AVX2-FCP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 176(%rcx), %ymm2
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
...
; AVX2-FCP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 240(%rcx), %ymm2
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
; AVX2-FCP-NEXT:    vbroadcastsd 248(%rcx), %ymm2
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm2[2,3]
; AVX2-FCP-NEXT:    vmovaps 224(%r8), %ymm2
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm3 = ymm2[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 288(%rdx), %ymm0
; AVX2-FCP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 304(%rcx), %ymm2
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
; AVX2-FCP-NEXT:    vbroadcastsd 312(%rcx), %ymm2
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm2[2,3]
; AVX2-FCP-NEXT:    vmovaps 288(%r8), %ymm2
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm3 = ymm2[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 352(%rdx), %ymm0
; AVX2-FCP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 368(%rcx), %ymm2
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2,3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
; AVX2-FCP-NEXT:    vbroadcastsd 376(%rcx), %ymm2
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm2[2,3]
; AVX2-FCP-NEXT:    vmovaps 352(%r8), %ymm2
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm3 = ymm2[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm3 # 32-byte Folded Reload
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm0[0,1,2,3,4,5],ymm2[6,7]
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FCP-NEXT:    vmovaps 416(%rdx), %ymm0
; AVX2-FCP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm1 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm1 = ymm0[2,3],mem[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 432(%rcx), %ymm11
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm1[0,1],ymm11[2,3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm1[1],ymm0[1],ymm1[3],ymm0[3]
; AVX2-FCP-NEXT:    vbroadcastsd 440(%rcx), %ymm1
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm0[2,3],ymm1[2,3]
; AVX2-FCP-NEXT:    vmovaps 416(%r8), %ymm0
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm9 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm9 = ymm0[0,1],mem[2,3,4,5,6,7]
...
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm6 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm6 = ymm0[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm5 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm5 = mem[0,1],ymm0[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps $63, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm2 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm2 = mem[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm1[0,1,2,3],ymm0[4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovaps 480(%rdx), %ymm1
; AVX2-FCP-NEXT:    vperm2f128 $49, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm0 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm0 = ymm1[2,3],mem[2,3]
; AVX2-FCP-NEXT:    vbroadcastsd 496(%rcx), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm0[0,1],ymm15[2,3],ymm0[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm0[1],ymm1[1],ymm0[3],ymm1[3]
; AVX2-FCP-NEXT:    vbroadcastsd 504(%rcx), %ymm15
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm1[2,3],ymm15[2,3]
; AVX2-FCP-NEXT:    vmovaps 480(%r8), %ymm15
; AVX2-FCP-NEXT:    vblendps $252, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15, %ymm2 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm2 = ymm15[0,1],mem[2,3,4,5,6,7]
; AVX2-FCP-NEXT:    vblendps $243, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15, %ymm0 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm0 = mem[0,1],ymm15[2,3],mem[4,5,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm15[4,5],ymm3[6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3,4,5],ymm15[6,7]
; AVX2-FCP-NEXT:    vmovaps %ymm1, 2528(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm3, 2496(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm0, 2464(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm2, 2432(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, 2400(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm4, 2336(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm5, 2304(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm6, 2272(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, 2240(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm7, 2208(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm11, 2176(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm8, 2144(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm9, 2112(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, 2080(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm10, 2016(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm14, 1984(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm13, 1952(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, 1920(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm12, 1888(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, 1856(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, 128(%r9)
; AVX2-FCP-NEXT:    addq $2632, %rsp # imm = 0xA48
; AVX2-FCP-NEXT:    vzeroupper
; AVX2-FCP-NEXT:    retq
;
