...
; AVX512F-NEXT:    vpand %ymm5, %ymm7, %ymm8
...
; AVX512VL-FALLBACK-NEXT:    vpand %ymm5, %ymm7, %ymm8
...
; AVX512VL-FALLBACK-NEXT:    vpternlogq $248, %ymm7, %ymm8, %ymm1
; AVX512VL-FALLBACK-NEXT:    vpor %ymm6, %ymm4, %ymm4
...
; AVX512VL-FALLBACK-NEXT:    vpternlogq $248, %ymm7, %ymm5, %ymm3
...
; AVX512F-NEXT:    vpand %ymm5, %ymm4, %ymm6
...
; AVX512VL-FALLBACK-NEXT:    vpsllw $8, %ymm1, %ymm1
; AVX512VL-FALLBACK-NEXT:    vpternlogq $248, %ymm4, %ymm5, %ymm1
; AVX512VL-FALLBACK-NEXT:    vextracti64x4 $1, %zmm7, %ymm5
; AVX512VL-FALLBACK-NEXT:    vpand %ymm5, %ymm4, %ymm6
...
; AVX512VL-FALLBACK-NEXT:    vpsllw $8, %ymm3, %ymm3
; AVX512VL-FALLBACK-NEXT:    vpternlogq $248, %ymm4, %ymm6, %ymm3
; AVX512VL-FALLBACK-NEXT:    vpaddb %ymm2, %ymm3, %ymm2
; AVX512VL-FALLBACK-NEXT:    vpaddb %ymm0, %ymm1, %ymm0
; AVX512VL-FALLBACK-NEXT:    vinserti64x4 $1, %ymm2, %zmm0, %zmm0
; AVX512VL-FALLBACK-NEXT:    retq
...
; AVX512VL-FALLBACK-NEXT:    vpternlogq $248, %ymm7, %ymm8, %ymm0
; AVX512VL-FALLBACK-NEXT:    vpor %ymm6, %ymm4, %ymm4
; AVX512VL-FALLBACK-NEXT:    vpand %ymm4, %ymm7, %ymm5
; AVX512VL-FALLBACK-NEXT:    vpmaddubsw %ymm5, %ymm3, %ymm5
; AVX512VL-FALLBACK-NEXT:    vpandn %ymm4, %ymm7, %ymm4
...
; AVX512VL-FALLBACK-NEXT:    vpternlogq $248, %ymm7, %ymm8, %ymm2
; AVX512VL-FALLBACK-NEXT:    vpor %ymm6, %ymm4, %ymm4
; AVX512VL-FALLBACK-NEXT:    vpand %ymm4, %ymm7, %ymm5
; AVX512VL-FALLBACK-NEXT:    vpmaddubsw %ymm5, %ymm3, %ymm5
; AVX512VL-FALLBACK-NEXT:    vpandn %ymm4, %ymm7, %ymm4
...
; AVX512VL-FALLBACK-NEXT:    vpsllw $8, %ymm2, %ymm2
; AVX512VL-FALLBACK-NEXT:    vpternlogq $248, %ymm7, %ymm5, %ymm2
