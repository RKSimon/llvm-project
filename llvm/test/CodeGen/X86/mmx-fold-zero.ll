...
; X86-NEXT:    movl %ecx, {{[0-9]+}}(%esp)
; X86-NEXT:    movl %eax, {{[0-9]+}}(%esp)
; X86-NEXT:    movq {{[0-9]+}}(%esp), %mm6
; X86-NEXT:    movq %mm0, %mm3
; X86-NEXT:    paddd %mm6, %mm3
; X86-NEXT:    movq %mm6, {{[-0-9]+}}(%e{{[sb]}}p) # 8-byte Spill
; X86-NEXT:    pxor %mm1, %mm1
; X86-NEXT:    movq %mm3, %mm5
; X86-NEXT:    pmuludq %mm1, %mm5
; X86-NEXT:    movl 24(%ebp), %eax
; X86-NEXT:    movl 28(%ebp), %ecx
; X86-NEXT:    movl %ecx, {{[0-9]+}}(%esp)
; X86-NEXT:    movl %eax, {{[0-9]+}}(%esp)
; X86-NEXT:    movq {{[0-9]+}}(%esp), %mm4
; X86-NEXT:    movq %mm5, %mm2
; X86-NEXT:    paddd %mm4, %mm2
; X86-NEXT:    paddw %mm2, %mm0
; X86-NEXT:    movq %mm6, %mm1
; X86-NEXT:    paddw %mm0, %mm1
; X86-NEXT:    movl 32(%ebp), %eax
; X86-NEXT:    movl 36(%ebp), %ecx
; X86-NEXT:    movl %ecx, {{[0-9]+}}(%esp)
; X86-NEXT:    movl %eax, (%esp)
; X86-NEXT:    movq (%esp), %mm7
; X86-NEXT:    movq %mm1, %mm6
; X86-NEXT:    pmuludq %mm7, %mm6
; X86-NEXT:    paddw %mm4, %mm6
; X86-NEXT:    paddw %mm6, %mm7
; X86-NEXT:    paddw %mm7, %mm2
; X86-NEXT:    paddw %mm2, %mm0
