...
; AVX512BW-SLOW:       # %bb.0:
; AVX512BW-SLOW-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512BW-SLOW-NEXT:    vpmovsxbd {{.*#+}} xmm1 = [0,5,0,7]
; AVX512BW-SLOW-NEXT:    vpaddb (%rsi), %zmm0, %zmm0
...
; AVX-NEXT:    vpaddb (%rsi), %xmm0, %xmm0
; AVX-NEXT:    vpaddb 48(%rsi), %xmm2, %xmm2
; AVX-NEXT:    vmovq {{.*#+}} xmm3 = [2,3,6,7,10,11,14,15,0,0,0,0,0,0,0,0]
; AVX-NEXT:    vpshufb %xmm3, %xmm2, %xmm2
; AVX-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,0,0,0,4,5,6,7]
...
; AVX512BW-FAST:       # %bb.0:
; AVX512BW-FAST-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512BW-FAST-NEXT:    vpmovsxbq {{.*#+}} ymm1 = [0,13,0,15]
; AVX512BW-FAST-NEXT:    vpaddb (%rsi), %zmm0, %zmm0
...
; AVX512BW-SLOW-NEXT:    vpaddb (%rsi), %zmm0, %zmm0
; AVX512BW-SLOW-NEXT:    vextracti64x4 $1, %zmm0, %ymm1
; AVX512BW-SLOW-NEXT:    vpmovsxbw {{.*#+}} ymm2 = [16,9,10,11,12,13,16,15,0,0,0,0,16,0,0,0]
; AVX512BW-SLOW-NEXT:    vpermi2w %ymm0, %ymm1, %ymm2
; AVX512BW-SLOW-NEXT:    vpxor %xmm1, %xmm1, %xmm1
...
; AVX512BW-SLOW-NEXT:    vpaddb (%rsi), %zmm0, %zmm0
; AVX512BW-SLOW-NEXT:    vextracti64x4 $1, %zmm0, %ymm1
; AVX512BW-SLOW-NEXT:    vpmovsxbw {{.*#+}} ymm2 = [16,9,10,11,12,13,14,15,0,0,0,0,16,0,0,0]
; AVX512BW-SLOW-NEXT:    vpermi2w %ymm0, %ymm1, %ymm2
...
; AVX512BW-NEXT:    vinserti64x4 $1, %ymm0, %zmm0, %zmm0
; AVX512BW-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm2 = [0,33,0,35,0,37,0,39,0,41,0,43,0,45,0,47,16,49,16,51,16,53,16,55,16,57,16,59,16,61,16,63]
...
; AVX512BW-NEXT:    vinserti64x4 $1, %ymm0, %zmm0, %zmm0
; AVX512BW-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm2 = [0,33,34,35,0,37,38,39,0,41,42,43,0,45,46,47,16,49,50,51,16,53,54,55,16,57,58,59,16,61,62,63]
; AVX512BW-NEXT:    vpermi2w %zmm1, %zmm0, %zmm2
; AVX512BW-NEXT:    vpaddb (%rdx), %zmm2, %zmm0
; AVX512BW-NEXT:    vmovdqa64 %zmm0, (%rcx)
; AVX512BW-NEXT:    vzeroupper
...
; AVX512BW-NEXT:    vinserti64x4 $1, %ymm0, %zmm0, %zmm0
; AVX512BW-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm2 = [0,33,34,35,36,37,38,39,0,41,42,43,44,45,46,47,16,49,50,51,52,53,54,55,16,57,58,59,60,61,62,63]
; AVX512BW-NEXT:    vpermi2w %zmm1, %zmm0, %zmm2
; AVX512BW-NEXT:    vpaddb (%rdx), %zmm2, %zmm0
; AVX512BW-NEXT:    vmovdqa64 %zmm0, (%rcx)
; AVX512BW-NEXT:    vzeroupper
