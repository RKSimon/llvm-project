...
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm2[2,0],xmm0[2,1]
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[1,1,3,3]
...
; AVX2-NEXT:    vmovaps {{.*#+}} ymm1 = [0,4,u,1,5,u,u,u]
...
; AVX2-FP-NEXT:    vmovaps {{.*#+}} ymm1 = [0,4,u,1,5,u,u,u]
...
; AVX2-FCP-NEXT:    vmovaps {{.*#+}} ymm1 = [0,4,u,1,5,u,u,u]
...
; AVX512-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,4,10,1,5,13,0,0]
...
; AVX512-FCP-NEXT:    vpbroadcastq (%rdx), %ymm1
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,4,10,1,5,13,0,0]
...
; AVX512DQ-NEXT:    vpbroadcastq (%rdx), %ymm1
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,4,10,1,5,13,0,0]
...
; AVX512DQ-FCP-NEXT:    vpbroadcastq (%rdx), %ymm1
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,4,10,1,5,13,0,0]
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,4,10,1,5,13,0,0]
; AVX512BW-NEXT:    vpermi2d %ymm1, %ymm0, %ymm2
...
; AVX512BW-FCP-NEXT:    vpbroadcastq (%rdx), %ymm1
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,4,10,1,5,13,0,0]
...
; AVX512DQ-BW-NEXT:    vpbroadcastq (%rdx), %ymm1
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,4,10,1,5,13,0,0]
; AVX512DQ-BW-NEXT:    vpermi2d %ymm1, %ymm0, %ymm2
...
; AVX512DQ-BW-FCP-NEXT:    vpbroadcastq (%rdx), %ymm1
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,4,10,1,5,13,0,0]
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm2[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0],ymm5[1],ymm4[2,3],ymm5[4],ymm4[5,6],ymm5[7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2],ymm0[3,4],ymm1[5],ymm0[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm2[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2],ymm1[3],ymm0[4,5],ymm1[6],ymm0[7]
...
; AVX2-NEXT:    vbroadcastsd 24(%rdi), %ymm7
; AVX2-NEXT:    vshufps {{.*#+}} ymm8 = ymm5[1,2,3,3,5,6,7,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm8[0,1],ymm7[2],ymm8[3,4],ymm7[5],ymm8[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm8 = ymm6[2,1,3,3]
...
; AVX2-NEXT:    vbroadcastsd 56(%rdi), %ymm9
; AVX2-NEXT:    vshufps {{.*#+}} ymm10 = ymm3[1,2,3,3,5,6,7,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0,1],ymm9[2],ymm10[3,4],ymm9[5],ymm10[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm10 = ymm1[2,1,3,3]
...
; AVX2-NEXT:    vmovaps %ymm9, 160(%rcx)
...
; AVX2-FP-NEXT:    vbroadcastsd 24(%rdi), %ymm7
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm8 = ymm5[1,2,3,3,5,6,7,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm8[0,1],ymm7[2],ymm8[3,4],ymm7[5],ymm8[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm6[2,1,3,3]
...
; AVX2-FP-NEXT:    vbroadcastsd 56(%rdi), %ymm9
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm10 = ymm3[1,2,3,3,5,6,7,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0,1],ymm9[2],ymm10[3,4],ymm9[5],ymm10[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm1[2,1,3,3]
...
; AVX2-FP-NEXT:    vmovaps %ymm9, 160(%rcx)
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0],ymm2[1],ymm9[2,3],ymm2[4],ymm9[5,6],ymm2[7]
; AVX2-FCP-NEXT:    vbroadcastsd (%rdx), %ymm9
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm9[2],ymm2[3,4],ymm9[5],ymm2[6,7]
; AVX2-FCP-NEXT:    vpermps %ymm7, %ymm8, %ymm7
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm4[0,0,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm8[0],ymm7[1],ymm8[2,3],ymm7[4],ymm8[5,6],ymm7[7]
; AVX2-FCP-NEXT:    vbroadcastsd 32(%rdx), %ymm8
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm6[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm8[0],ymm3[1,2],ymm8[3],ymm3[4,5],ymm8[6],ymm3[7]
; AVX2-FCP-NEXT:    vmovaps {{.*#+}} ymm8 = [5,6,5,6,5,6,7,7]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm6 = ymm0[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm4[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm6[2],ymm4[3,4],ymm6[5],ymm4[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm1[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm6[0],ymm4[1,2],ymm6[3],ymm4[4,5],ymm6[6],ymm4[7]
; AVX2-FCP-NEXT:    vpermps %ymm0, %ymm8, %ymm0
; AVX2-FCP-NEXT:    vbroadcastsd 56(%rdi), %ymm6
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm6[2],ymm0[3,4],ymm6[5],ymm0[6,7]
...
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm11 = xmm8[1],xmm1[1]
; AVX-NEXT:    vshufps {{.*#+}} xmm11 = xmm1[1,1],xmm11[0,2]
; AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm1[0],xmm8[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[2,0],xmm8[2,1]
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm1, %ymm1
; AVX-NEXT:    vbroadcastsd (%rdx), %ymm8
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm8[2],ymm1[3,4],ymm8[5],ymm1[6,7]
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm9[3,3],xmm4[3,3]
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm9 = xmm9[1],xmm4[1]
; AVX-NEXT:    vshufps {{.*#+}} xmm4 = xmm4[1,1],xmm9[0,2]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm4, %ymm4
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm5[2,3,2,3]
; AVX-NEXT:    vshufpd {{.*#+}} ymm8 = ymm8[0,0,3,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0],ymm8[1],ymm4[2,3],ymm8[4],ymm4[5,6],ymm8[7]
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm8 = xmm10[1],xmm6[1]
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm6[1,1],xmm8[0,2]
; AVX-NEXT:    vmovlhps {{.*#+}} xmm6 = xmm6[0],xmm10[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm6 = xmm6[2,0],xmm10[2,1]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm6, %ymm6
; AVX-NEXT:    vbroadcastsd 32(%rdx), %ymm8
...
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm3[2,3,2,3]
; AVX-NEXT:    vshufpd {{.*#+}} ymm8 = ymm8[0,0,3,3]
...
; AVX-NEXT:    vbroadcastsd 64(%rdx), %ymm9
...
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm10 = xmm10[1],xmm9[1]
; AVX-NEXT:    vshufps {{.*#+}} xmm9 = xmm9[1,1],xmm10[0,2]
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm9, %ymm9
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm2[2,3,2,3]
...
; AVX-NEXT:    vbroadcastsd 96(%rdx), %ymm11
...
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0],ymm12[1,2],ymm5[3],ymm12[4,5],ymm5[6],ymm12[7]
; AVX-NEXT:    vpermilps {{.*#+}} ymm12 = mem[0,0,3,3,4,4,7,7]
; AVX-NEXT:    vpermilpd {{.*#+}} ymm13 = mem[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm12 = ymm13[0,1],ymm12[2],ymm13[3,4],ymm12[5],ymm13[6,7]
; AVX-NEXT:    vshufpd {{.*#+}} ymm3 = ymm3[1,1,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm12[1,2],ymm3[3],ymm12[4,5],ymm3[6],ymm12[7]
; AVX-NEXT:    vpermilps {{.*#+}} ymm12 = mem[0,0,3,3,4,4,7,7]
; AVX-NEXT:    vpermilpd {{.*#+}} ymm13 = mem[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm12 = ymm13[0,1],ymm12[2],ymm13[3,4],ymm12[5],ymm13[6,7]
...
; AVX-NEXT:    vmovaps %ymm10, 288(%rcx)
; AVX-NEXT:    vmovaps %ymm9, 256(%rcx)
; AVX-NEXT:    vmovaps %ymm8, 192(%rcx)
; AVX-NEXT:    vmovaps %ymm7, 160(%rcx)
...
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm6[0,0,2,1]
...
; AVX2-NEXT:    vbroadcastsd 24(%rdi), %ymm2
; AVX2-NEXT:    vshufps {{.*#+}} ymm9 = ymm10[1,2,3,3,5,6,7,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1],ymm2[2],ymm9[3,4],ymm2[5],ymm9[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm9 = ymm11[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0],ymm9[1],ymm2[2,3],ymm9[4],ymm2[5,6],ymm9[7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermilps {{.*#+}} xmm9 = mem[1,0,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[0,1,0,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm12 = ymm3[0,0,2,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm9 = ymm12[0],ymm9[1],ymm12[2,3],ymm9[4],ymm12[5,6],ymm9[7]
; AVX2-NEXT:    vbroadcastsd 32(%rdx), %ymm12
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0,1],ymm12[2],ymm9[3,4],ymm12[5],ymm9[6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vbroadcastsd 56(%rdi), %ymm12
; AVX2-NEXT:    vshufps {{.*#+}} ymm13 = ymm7[1,2,3,3,5,6,7,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm12 = ymm13[0,1],ymm12[2],ymm13[3,4],ymm12[5],ymm13[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm8[2,1,3,3]
...
; AVX2-NEXT:    vbroadcastsd 64(%rdx), %ymm14
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm13[0,1],ymm14[2],ymm13[3,4],ymm14[5],ymm13[6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vbroadcastsd 88(%rdi), %ymm14
; AVX2-NEXT:    vshufps {{.*#+}} ymm15 = ymm4[1,2,3,3,5,6,7,7]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm15[1],ymm2[2,3],ymm15[4],ymm2[5,6],ymm15[7]
; AVX2-NEXT:    vbroadcastsd 96(%rdx), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm15 = ymm2[0,1],ymm15[2],ymm2[3,4],ymm15[5],ymm2[6,7]
; AVX2-NEXT:    vmovaps 96(%rsi), %ymm2
; AVX2-NEXT:    vshufps {{.*#+}} ymm9 = ymm2[1,2,3,3,5,6,7,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[2,2,2,3]
; AVX2-NEXT:    vbroadcastsd 120(%rdi), %ymm12
; AVX2-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm12[2],ymm9[3,4],ymm12[5],ymm9[6,7]
; AVX2-NEXT:    vmovaps 96(%rdx), %ymm12
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm12[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0],ymm13[1],ymm9[2,3],ymm13[4],ymm9[5,6],ymm13[7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm10 = ymm10[0,0,3,3,4,4,7,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1],ymm10[2],ymm6[3,4],ymm10[5],ymm6[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm10 = ymm11[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm10[0],ymm6[1,2],ymm10[3],ymm6[4,5],ymm10[6],ymm6[7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[0,0,3,3,4,4,7,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm3 = ymm3[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm7[2],ymm3[3,4],ymm7[5],ymm3[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm8[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm7[0],ymm3[1,2],ymm7[3],ymm3[4,5],ymm7[6],ymm3[7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm4 = ymm4[0,0,3,3,4,4,7,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm4[2],ymm1[3,4],ymm4[5],ymm1[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm5[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm4[0],ymm1[1,2],ymm4[3],ymm1[4,5],ymm4[6],ymm1[7]
...
; AVX2-NEXT:    vmovaps %ymm14, 256(%rcx)
...
; AVX2-FP-NEXT:    vmovaps 32(%rdx), %ymm8
; AVX2-FP-NEXT:    vmovaps 64(%rdx), %ymm5
; AVX2-FP-NEXT:    vpermilps {{.*#+}} xmm0 = mem[1,0,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,1,0,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm6[0,0,2,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0],ymm0[1],ymm2[2,3],ymm0[4],ymm2[5,6],ymm0[7]
; AVX2-FP-NEXT:    vbroadcastsd (%rdx), %ymm2
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm2[2],ymm0[3,4],ymm2[5],ymm0[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX2-FP-NEXT:    vbroadcastsd 24(%rdi), %ymm2
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm9 = ymm10[1,2,3,3,5,6,7,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm9[0,1],ymm2[2],ymm9[3,4],ymm2[5],ymm9[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm11[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0],ymm9[1],ymm2[2,3],ymm9[4],ymm2[5,6],ymm9[7]
...
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm3[0,0,2,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm12[0],ymm9[1],ymm12[2,3],ymm9[4],ymm12[5,6],ymm9[7]
; AVX2-FP-NEXT:    vbroadcastsd 32(%rdx), %ymm12
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0,1],ymm12[2],ymm9[3,4],ymm12[5],ymm9[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vbroadcastsd 56(%rdi), %ymm12
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm13 = ymm7[1,2,3,3,5,6,7,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm13[0,1],ymm12[2],ymm13[3,4],ymm12[5],ymm13[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm8[2,1,3,3]
...
; AVX2-FP-NEXT:    vbroadcastsd 64(%rdx), %ymm14
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm13[0,1],ymm14[2],ymm13[3,4],ymm14[5],ymm13[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vbroadcastsd 88(%rdi), %ymm14
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm15 = ymm4[1,2,3,3,5,6,7,7]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm15[1],ymm2[2,3],ymm15[4],ymm2[5,6],ymm15[7]
; AVX2-FP-NEXT:    vbroadcastsd 96(%rdx), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm15 = ymm2[0,1],ymm15[2],ymm2[3,4],ymm15[5],ymm2[6,7]
; AVX2-FP-NEXT:    vmovaps 96(%rsi), %ymm2
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm9 = ymm2[1,2,3,3,5,6,7,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[2,2,2,3]
; AVX2-FP-NEXT:    vbroadcastsd 120(%rdi), %ymm12
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm12[2],ymm9[3,4],ymm12[5],ymm9[6,7]
; AVX2-FP-NEXT:    vmovaps 96(%rdx), %ymm12
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm12[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0],ymm13[1],ymm9[2,3],ymm13[4],ymm9[5,6],ymm13[7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm10 = ymm10[0,0,3,3,4,4,7,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1],ymm10[2],ymm6[3,4],ymm10[5],ymm6[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm11[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm10[0],ymm6[1,2],ymm10[3],ymm6[4,5],ymm10[6],ymm6[7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[0,0,3,3,4,4,7,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm3[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm7[2],ymm3[3,4],ymm7[5],ymm3[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm8[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm7[0],ymm3[1,2],ymm7[3],ymm3[4,5],ymm7[6],ymm3[7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm4 = ymm4[0,0,3,3,4,4,7,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm4[2],ymm1[3,4],ymm4[5],ymm1[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm5[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm4[0],ymm1[1,2],ymm4[3],ymm1[4,5],ymm4[6],ymm1[7]
...
; AVX2-FP-NEXT:    vmovaps %ymm14, 256(%rcx)
...
; AVX2-FCP-NEXT:    vmovaps (%rsi), %ymm12
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm10[0,0,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm13[0],ymm1[1],ymm13[2,3],ymm1[4],ymm13[5,6],ymm1[7]
; AVX2-FCP-NEXT:    vbroadcastsd (%rdx), %ymm13
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm13[2],ymm1[3,4],ymm13[5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpermps %ymm3, %ymm8, %ymm3
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm7[0,0,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm13[0],ymm3[1],ymm13[2,3],ymm3[4],ymm13[5,6],ymm3[7]
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm5[0,0,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm6 = ymm13[0],ymm6[1],ymm13[2,3],ymm6[4],ymm13[5,6],ymm6[7]
; AVX2-FCP-NEXT:    vbroadcastsd 64(%rdx), %ymm13
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1],ymm13[2],ymm6[3,4],ymm13[5],ymm6[6,7]
; AVX2-FCP-NEXT:    vmovaps 96(%rsi), %xmm13
; AVX2-FCP-NEXT:    vpermps %ymm13, %ymm8, %ymm8
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm2[0,0,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm13[0],ymm8[1],ymm13[2,3],ymm8[4],ymm13[5,6],ymm8[7]
; AVX2-FCP-NEXT:    vbroadcastsd 96(%rdx), %ymm13
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm13[2],ymm8[3,4],ymm13[5],ymm8[6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm13 = ymm12[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1],ymm13[2],ymm10[3,4],ymm13[5],ymm10[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm11[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm13[0],ymm10[1,2],ymm13[3],ymm10[4,5],ymm13[6],ymm10[7]
; AVX2-FCP-NEXT:    vmovaps {{.*#+}} ymm13 = [5,6,5,6,5,6,7,7]
; AVX2-FCP-NEXT:    vpermps %ymm12, %ymm13, %ymm12
; AVX2-FCP-NEXT:    vbroadcastsd 24(%rdi), %ymm14
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1],ymm14[2],ymm12[3,4],ymm14[5],ymm12[6,7]
; AVX2-FCP-NEXT:    vmovaps 32(%rdx), %ymm14
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm12[0],ymm11[1],ymm12[2,3],ymm11[4],ymm12[5,6],ymm11[7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm12 = ymm9[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm12[2],ymm7[3,4],ymm12[5],ymm7[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm14[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm12[0],ymm7[1,2],ymm12[3],ymm7[4,5],ymm12[6],ymm7[7]
; AVX2-FCP-NEXT:    vpermps %ymm9, %ymm13, %ymm9
; AVX2-FCP-NEXT:    vbroadcastsd 56(%rdi), %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm12[2],ymm9[3,4],ymm12[5],ymm9[6,7]
; AVX2-FCP-NEXT:    vmovaps 64(%rdx), %ymm12
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0],ymm14[1],ymm9[2,3],ymm14[4],ymm9[5,6],ymm14[7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm14 = ymm4[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1],ymm14[2],ymm5[3,4],ymm14[5],ymm5[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm12[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm14[0],ymm5[1,2],ymm14[3],ymm5[4,5],ymm14[6],ymm5[7]
; AVX2-FCP-NEXT:    vpermps %ymm4, %ymm13, %ymm4
; AVX2-FCP-NEXT:    vbroadcastsd 88(%rdi), %ymm14
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm14[2],ymm4[3,4],ymm14[5],ymm4[6,7]
; AVX2-FCP-NEXT:    vmovaps 96(%rdx), %ymm14
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0],ymm12[1],ymm4[2,3],ymm12[4],ymm4[5,6],ymm12[7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm12 = ymm0[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm12[2],ymm2[3,4],ymm12[5],ymm2[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm14[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm12[0],ymm2[1,2],ymm12[3],ymm2[4,5],ymm12[6],ymm2[7]
; AVX2-FCP-NEXT:    vpermps %ymm0, %ymm13, %ymm0
; AVX2-FCP-NEXT:    vbroadcastsd 120(%rdi), %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm12[2],ymm0[3,4],ymm12[5],ymm0[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm14[2,1,3,3]
...
; AVX2-FCP-NEXT:    vmovaps %ymm8, 288(%rcx)
...
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm9 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512-NEXT:    vmovdqa64 %zmm2, %zmm10
; AVX512-NEXT:    vpermt2d %zmm0, %zmm9, %zmm10
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm11 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512-NEXT:    vpermt2d %zmm4, %zmm11, %zmm10
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm12 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512-NEXT:    vpermt2d %zmm2, %zmm12, %zmm0
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
...
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm9 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm2, %zmm10
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm9, %zmm10
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm11 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm4, %zmm11, %zmm10
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm12 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512-FCP-NEXT:    vpermt2d %zmm2, %zmm12, %zmm0
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512-FCP-NEXT:    vpermt2d %zmm4, %zmm2, %zmm0
; AVX512-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm6
; AVX512-FCP-NEXT:    vpermt2d %zmm5, %zmm8, %zmm6
; AVX512-FCP-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512-FCP-NEXT:    vpermt2d %zmm5, %zmm11, %zmm9
; AVX512-FCP-NEXT:    vpermt2d %zmm3, %zmm12, %zmm1
; AVX512-FCP-NEXT:    vpermt2d %zmm5, %zmm2, %zmm1
; AVX512-FCP-NEXT:    vmovdqa64 %zmm1, 320(%rcx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm9, 256(%rcx)
...
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm9 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, %zmm10
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm9, %zmm10
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm11 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512DQ-NEXT:    vpermt2d %zmm4, %zmm11, %zmm10
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm12 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512DQ-NEXT:    vpermt2d %zmm2, %zmm12, %zmm0
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512DQ-NEXT:    vpermt2d %zmm4, %zmm2, %zmm0
; AVX512DQ-NEXT:    vpermi2d %zmm3, %zmm1, %zmm6
; AVX512DQ-NEXT:    vpermt2d %zmm5, %zmm8, %zmm6
; AVX512DQ-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512DQ-NEXT:    vpermt2d %zmm5, %zmm11, %zmm9
; AVX512DQ-NEXT:    vpermt2d %zmm3, %zmm12, %zmm1
; AVX512DQ-NEXT:    vpermt2d %zmm5, %zmm2, %zmm1
; AVX512DQ-NEXT:    vmovdqa64 %zmm1, 320(%rcx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm9, 256(%rcx)
...
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm9 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm2, %zmm10
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm9, %zmm10
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm11 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm4, %zmm11, %zmm10
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm12 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm2, %zmm12, %zmm0
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm4, %zmm2, %zmm0
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm6
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm5, %zmm8, %zmm6
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm5, %zmm11, %zmm9
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm3, %zmm12, %zmm1
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm5, %zmm2, %zmm1
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm1, 320(%rcx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm9, 256(%rcx)
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm9 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm10
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm9, %zmm10
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm11 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512BW-NEXT:    vpermt2d %zmm4, %zmm11, %zmm10
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm12 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm12, %zmm0
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512BW-NEXT:    vpermt2d %zmm4, %zmm2, %zmm0
; AVX512BW-NEXT:    vpermi2d %zmm3, %zmm1, %zmm6
; AVX512BW-NEXT:    vpermt2d %zmm5, %zmm8, %zmm6
; AVX512BW-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512BW-NEXT:    vpermt2d %zmm5, %zmm11, %zmm9
; AVX512BW-NEXT:    vpermt2d %zmm3, %zmm12, %zmm1
; AVX512BW-NEXT:    vpermt2d %zmm5, %zmm2, %zmm1
...
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm9 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm2, %zmm10
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm9, %zmm10
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm11 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm4, %zmm11, %zmm10
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm12 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm2, %zmm12, %zmm0
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm4, %zmm2, %zmm0
; AVX512BW-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm6
; AVX512BW-FCP-NEXT:    vpermt2d %zmm5, %zmm8, %zmm6
; AVX512BW-FCP-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512BW-FCP-NEXT:    vpermt2d %zmm5, %zmm11, %zmm9
; AVX512BW-FCP-NEXT:    vpermt2d %zmm3, %zmm12, %zmm1
; AVX512BW-FCP-NEXT:    vpermt2d %zmm5, %zmm2, %zmm1
...
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm9 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, %zmm10
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm9, %zmm10
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm11 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm4, %zmm11, %zmm10
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm12 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm2, %zmm12, %zmm0
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm4, %zmm2, %zmm0
; AVX512DQ-BW-NEXT:    vpermi2d %zmm3, %zmm1, %zmm6
; AVX512DQ-BW-NEXT:    vpermt2d %zmm5, %zmm8, %zmm6
; AVX512DQ-BW-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512DQ-BW-NEXT:    vpermt2d %zmm5, %zmm11, %zmm9
; AVX512DQ-BW-NEXT:    vpermt2d %zmm3, %zmm12, %zmm1
; AVX512DQ-BW-NEXT:    vpermt2d %zmm5, %zmm2, %zmm1
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm9 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm2, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm9, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm11 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm4, %zmm11, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm12 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm2, %zmm12, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm4, %zmm2, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm6
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm5, %zmm8, %zmm6
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm5, %zmm11, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm3, %zmm12, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm5, %zmm2, %zmm1
...
; AVX2-FCP-NEXT:    vmovaps 64(%rsi), %xmm6
; AVX2-FCP-NEXT:    vbroadcastf128 {{.*#+}} ymm2 = [1,0,2,2,1,0,2,2]
; AVX2-FCP-NEXT:    # ymm2 = mem[0,1,0,1]
; AVX2-FCP-NEXT:    vpermps %ymm3, %ymm2, %ymm3
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm0[0,0,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm9[0],ymm3[1],ymm9[2,3],ymm3[4],ymm9[5,6],ymm3[7]
; AVX2-FCP-NEXT:    vbroadcastsd (%rdx), %ymm9
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm9[2],ymm3[3,4],ymm9[5],ymm3[6,7]
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm14[0,0,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0],ymm3[1],ymm4[2,3],ymm3[4],ymm4[5,6],ymm3[7]
...
; AVX2-FCP-NEXT:    vpermps %ymm3, %ymm2, %ymm3
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm11[0,0,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0],ymm3[1],ymm4[2,3],ymm3[4],ymm4[5,6],ymm3[7]
; AVX2-FCP-NEXT:    vbroadcastsd 96(%rdx), %ymm4
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4],ymm4[5],ymm3[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 128(%rsi), %xmm3
; AVX2-FCP-NEXT:    vpermps %ymm3, %ymm2, %ymm3
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm8[0,0,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0],ymm3[1],ymm4[2,3],ymm3[4],ymm4[5,6],ymm3[7]
; AVX2-FCP-NEXT:    vbroadcastsd 128(%rdx), %ymm4
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4],ymm4[5],ymm3[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 160(%rsi), %xmm3
; AVX2-FCP-NEXT:    vpermps %ymm3, %ymm2, %ymm3
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm7[0,0,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0],ymm3[1],ymm4[2,3],ymm3[4],ymm4[5,6],ymm3[7]
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm15[0,0,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0],ymm2[1],ymm3[2,3],ymm2[4],ymm3[5,6],ymm2[7]
; AVX2-FCP-NEXT:    vbroadcastsd 224(%rdx), %ymm3
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm3[1,1,2,2]
...
; AVX2-FCP-NEXT:    vmovaps {{.*#+}} ymm5 = [5,6,5,6,5,6,7,7]
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm3[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0],ymm3[1],ymm2[2,3],ymm3[4],ymm2[5,6],ymm3[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm3[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm4[0],ymm1[1,2],ymm4[3],ymm1[4,5],ymm4[6],ymm1[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermps %ymm2, %ymm5, %ymm1
; AVX2-FCP-NEXT:    vbroadcastsd 56(%rdi), %ymm2
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2],ymm1[3,4],ymm2[5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm3[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm1[0],ymm2[1],ymm1[2,3],ymm2[4],ymm1[5,6],ymm2[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm14[1,1,2,2]
; AVX2-FCP-NEXT:    vmovaps 64(%rsi), %ymm2
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm3 = ymm2[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm3[2],ymm1[3,4],ymm3[5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovaps 64(%rdx), %ymm3
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm3[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0],ymm1[1,2],ymm14[3],ymm1[4,5],ymm14[6],ymm1[7]
; AVX2-FCP-NEXT:    vpermps %ymm2, %ymm5, %ymm1
; AVX2-FCP-NEXT:    vbroadcastsd 88(%rdi), %ymm2
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2],ymm1[3,4],ymm2[5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm3[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm1[0],ymm2[1],ymm1[2,3],ymm2[4],ymm1[5,6],ymm2[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm11[1,1,2,2]
; AVX2-FCP-NEXT:    vmovaps 96(%rsi), %ymm2
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm11 = ymm2[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm11[2],ymm1[3,4],ymm11[5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovaps 96(%rdx), %ymm0
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm0[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm1[1,2],ymm11[3],ymm1[4,5],ymm11[6],ymm1[7]
; AVX2-FCP-NEXT:    vpermps %ymm2, %ymm5, %ymm1
; AVX2-FCP-NEXT:    vbroadcastsd 120(%rdi), %ymm2
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm2[2],ymm1[3,4],ymm2[5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm1[0],ymm0[1],ymm1[2,3],ymm0[4],ymm1[5,6],ymm0[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm8[1,1,2,2]
; AVX2-FCP-NEXT:    vmovaps 128(%rsi), %ymm1
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm8 = ymm1[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm0[0,1],ymm8[2],ymm0[3,4],ymm8[5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovaps 128(%rdx), %ymm0
...
; AVX2-FCP-NEXT:    vbroadcastsd 152(%rdi), %ymm9
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm9[2],ymm1[3,4],ymm9[5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm0[1],ymm1[2,3],ymm0[4],ymm1[5,6],ymm0[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm7[1,1,2,2]
; AVX2-FCP-NEXT:    vmovaps 160(%rsi), %ymm7
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm9 = ymm7[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm9[2],ymm0[3,4],ymm9[5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovaps 160(%rdx), %ymm9
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm9[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0],ymm0[1,2],ymm12[3],ymm0[4,5],ymm12[6],ymm0[7]
; AVX2-FCP-NEXT:    vpermps %ymm7, %ymm5, %ymm7
; AVX2-FCP-NEXT:    vbroadcastsd 184(%rdi), %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm12[2],ymm7[3,4],ymm12[5],ymm7[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm9[1],ymm7[2,3],ymm9[4],ymm7[5,6],ymm9[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm10[1,1,2,2]
; AVX2-FCP-NEXT:    vmovaps 192(%rsi), %ymm10
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm12 = ymm10[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm12[2],ymm9[3,4],ymm12[5],ymm9[6,7]
; AVX2-FCP-NEXT:    vmovaps 192(%rdx), %ymm12
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm12[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm13[0],ymm9[1,2],ymm13[3],ymm9[4,5],ymm13[6],ymm9[7]
; AVX2-FCP-NEXT:    vpermps %ymm10, %ymm5, %ymm10
; AVX2-FCP-NEXT:    vbroadcastsd 216(%rdi), %ymm13
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1],ymm13[2],ymm10[3,4],ymm13[5],ymm10[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0],ymm12[1],ymm10[2,3],ymm12[4],ymm10[5,6],ymm12[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm15[1,1,2,2]
; AVX2-FCP-NEXT:    vmovaps 224(%rsi), %ymm13
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm15 = ymm13[0,0,3,3,4,4,7,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1],ymm15[2],ymm12[3,4],ymm15[5],ymm12[6,7]
; AVX2-FCP-NEXT:    vmovaps 224(%rdx), %ymm15
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm15[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm12[1,2],ymm6[3],ymm12[4,5],ymm6[6],ymm12[7]
; AVX2-FCP-NEXT:    vpermps %ymm13, %ymm5, %ymm5
; AVX2-FCP-NEXT:    vbroadcastsd 248(%rdi), %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1],ymm12[2],ymm5[3,4],ymm12[5],ymm5[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm15[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0],ymm12[1],ymm5[2,3],ymm12[4],ymm5[5,6],ymm12[7]
; AVX2-FCP-NEXT:    vmovaps %ymm5, 736(%rcx)
; AVX2-FCP-NEXT:    vmovaps %ymm6, 704(%rcx)
; AVX2-FCP-NEXT:    vmovaps %ymm10, 640(%rcx)
; AVX2-FCP-NEXT:    vmovaps %ymm9, 608(%rcx)
; AVX2-FCP-NEXT:    vmovaps %ymm7, 544(%rcx)
; AVX2-FCP-NEXT:    vmovaps %ymm0, 512(%rcx)
; AVX2-FCP-NEXT:    vmovaps %ymm1, 448(%rcx)
; AVX2-FCP-NEXT:    vmovaps %ymm8, 416(%rcx)
...
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512-NEXT:    vmovdqa64 %zmm4, %zmm16
; AVX512-NEXT:    vpermt2d %zmm0, %zmm15, %zmm16
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512-NEXT:    vpermt2d %zmm8, %zmm17, %zmm16
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm18 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512-NEXT:    vpermt2d %zmm4, %zmm18, %zmm0
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm4 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
...
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm4, %zmm16
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm16
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm8, %zmm17, %zmm16
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm18 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512-FCP-NEXT:    vpermt2d %zmm4, %zmm18, %zmm0
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm4 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512-FCP-NEXT:    vpermt2d %zmm8, %zmm4, %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 %zmm1, %zmm8
; AVX512-FCP-NEXT:    vpermt2d %zmm5, %zmm12, %zmm8
; AVX512-FCP-NEXT:    vpermt2d %zmm9, %zmm14, %zmm8
; AVX512-FCP-NEXT:    vmovdqa64 %zmm5, %zmm19
; AVX512-FCP-NEXT:    vpermt2d %zmm1, %zmm15, %zmm19
; AVX512-FCP-NEXT:    vpermt2d %zmm9, %zmm17, %zmm19
; AVX512-FCP-NEXT:    vpermt2d %zmm5, %zmm18, %zmm1
; AVX512-FCP-NEXT:    vpermt2d %zmm9, %zmm4, %zmm1
; AVX512-FCP-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512-FCP-NEXT:    vpermt2d %zmm6, %zmm12, %zmm5
; AVX512-FCP-NEXT:    vpermt2d %zmm10, %zmm14, %zmm5
; AVX512-FCP-NEXT:    vmovdqa64 %zmm6, %zmm9
; AVX512-FCP-NEXT:    vpermt2d %zmm2, %zmm15, %zmm9
; AVX512-FCP-NEXT:    vpermt2d %zmm10, %zmm17, %zmm9
; AVX512-FCP-NEXT:    vpermt2d %zmm6, %zmm18, %zmm2
; AVX512-FCP-NEXT:    vpermt2d %zmm10, %zmm4, %zmm2
; AVX512-FCP-NEXT:    vpermi2d %zmm7, %zmm3, %zmm12
; AVX512-FCP-NEXT:    vpermt2d %zmm11, %zmm14, %zmm12
; AVX512-FCP-NEXT:    vpermi2d %zmm3, %zmm7, %zmm15
; AVX512-FCP-NEXT:    vpermt2d %zmm11, %zmm17, %zmm15
; AVX512-FCP-NEXT:    vpermt2d %zmm7, %zmm18, %zmm3
; AVX512-FCP-NEXT:    vpermt2d %zmm11, %zmm4, %zmm3
; AVX512-FCP-NEXT:    vmovdqa64 %zmm3, 704(%rcx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm15, 640(%rcx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm12, 576(%rcx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm2, 512(%rcx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm9, 448(%rcx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm5, 384(%rcx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm1, 320(%rcx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm19, 256(%rcx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm8, 192(%rcx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm0, 128(%rcx)
...
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512DQ-NEXT:    vmovdqa64 %zmm4, %zmm16
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm15, %zmm16
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512DQ-NEXT:    vpermt2d %zmm8, %zmm17, %zmm16
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm18 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512DQ-NEXT:    vpermt2d %zmm4, %zmm18, %zmm0
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm4 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512DQ-NEXT:    vpermt2d %zmm8, %zmm4, %zmm0
; AVX512DQ-NEXT:    vmovdqa64 %zmm1, %zmm8
; AVX512DQ-NEXT:    vpermt2d %zmm5, %zmm12, %zmm8
; AVX512DQ-NEXT:    vpermt2d %zmm9, %zmm14, %zmm8
; AVX512DQ-NEXT:    vmovdqa64 %zmm5, %zmm19
; AVX512DQ-NEXT:    vpermt2d %zmm1, %zmm15, %zmm19
; AVX512DQ-NEXT:    vpermt2d %zmm9, %zmm17, %zmm19
; AVX512DQ-NEXT:    vpermt2d %zmm5, %zmm18, %zmm1
; AVX512DQ-NEXT:    vpermt2d %zmm9, %zmm4, %zmm1
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512DQ-NEXT:    vpermt2d %zmm6, %zmm12, %zmm5
; AVX512DQ-NEXT:    vpermt2d %zmm10, %zmm14, %zmm5
; AVX512DQ-NEXT:    vmovdqa64 %zmm6, %zmm9
; AVX512DQ-NEXT:    vpermt2d %zmm2, %zmm15, %zmm9
; AVX512DQ-NEXT:    vpermt2d %zmm10, %zmm17, %zmm9
; AVX512DQ-NEXT:    vpermt2d %zmm6, %zmm18, %zmm2
; AVX512DQ-NEXT:    vpermt2d %zmm10, %zmm4, %zmm2
; AVX512DQ-NEXT:    vpermi2d %zmm7, %zmm3, %zmm12
; AVX512DQ-NEXT:    vpermt2d %zmm11, %zmm14, %zmm12
; AVX512DQ-NEXT:    vpermi2d %zmm3, %zmm7, %zmm15
; AVX512DQ-NEXT:    vpermt2d %zmm11, %zmm17, %zmm15
; AVX512DQ-NEXT:    vpermt2d %zmm7, %zmm18, %zmm3
; AVX512DQ-NEXT:    vpermt2d %zmm11, %zmm4, %zmm3
; AVX512DQ-NEXT:    vmovdqa64 %zmm3, 704(%rcx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm15, 640(%rcx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm12, 576(%rcx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, 512(%rcx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm9, 448(%rcx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm5, 384(%rcx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm1, 320(%rcx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm19, 256(%rcx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm8, 192(%rcx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, 128(%rcx)
...
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm4, %zmm16
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm16
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm8, %zmm17, %zmm16
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm18 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm4, %zmm18, %zmm0
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm4 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm8, %zmm4, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm1, %zmm8
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm5, %zmm12, %zmm8
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm9, %zmm14, %zmm8
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm5, %zmm19
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm1, %zmm15, %zmm19
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm9, %zmm17, %zmm19
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm5, %zmm18, %zmm1
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm9, %zmm4, %zmm1
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm6, %zmm12, %zmm5
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm10, %zmm14, %zmm5
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm6, %zmm9
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm2, %zmm15, %zmm9
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm10, %zmm17, %zmm9
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm6, %zmm18, %zmm2
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm10, %zmm4, %zmm2
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm7, %zmm3, %zmm12
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm11, %zmm14, %zmm12
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm3, %zmm7, %zmm15
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm11, %zmm17, %zmm15
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm7, %zmm18, %zmm3
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm11, %zmm4, %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm3, 704(%rcx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm15, 640(%rcx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm12, 576(%rcx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm2, 512(%rcx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm9, 448(%rcx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm5, 384(%rcx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm1, 320(%rcx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm19, 256(%rcx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm8, 192(%rcx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm0, 128(%rcx)
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm16
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm15, %zmm16
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512BW-NEXT:    vpermt2d %zmm8, %zmm17, %zmm16
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm18 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512BW-NEXT:    vpermt2d %zmm4, %zmm18, %zmm0
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm4 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512BW-NEXT:    vpermt2d %zmm8, %zmm4, %zmm0
; AVX512BW-NEXT:    vmovdqa64 %zmm1, %zmm8
; AVX512BW-NEXT:    vpermt2d %zmm5, %zmm12, %zmm8
; AVX512BW-NEXT:    vpermt2d %zmm9, %zmm14, %zmm8
; AVX512BW-NEXT:    vmovdqa64 %zmm5, %zmm19
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm15, %zmm19
; AVX512BW-NEXT:    vpermt2d %zmm9, %zmm17, %zmm19
; AVX512BW-NEXT:    vpermt2d %zmm5, %zmm18, %zmm1
; AVX512BW-NEXT:    vpermt2d %zmm9, %zmm4, %zmm1
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512BW-NEXT:    vpermt2d %zmm6, %zmm12, %zmm5
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm14, %zmm5
; AVX512BW-NEXT:    vmovdqa64 %zmm6, %zmm9
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm15, %zmm9
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm17, %zmm9
; AVX512BW-NEXT:    vpermt2d %zmm6, %zmm18, %zmm2
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm4, %zmm2
; AVX512BW-NEXT:    vpermi2d %zmm7, %zmm3, %zmm12
; AVX512BW-NEXT:    vpermt2d %zmm11, %zmm14, %zmm12
; AVX512BW-NEXT:    vpermi2d %zmm3, %zmm7, %zmm15
; AVX512BW-NEXT:    vpermt2d %zmm11, %zmm17, %zmm15
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm18, %zmm3
; AVX512BW-NEXT:    vpermt2d %zmm11, %zmm4, %zmm3
; AVX512BW-NEXT:    vmovdqa64 %zmm3, 704(%rcx)
; AVX512BW-NEXT:    vmovdqa64 %zmm15, 640(%rcx)
; AVX512BW-NEXT:    vmovdqa64 %zmm12, 576(%rcx)
; AVX512BW-NEXT:    vmovdqa64 %zmm2, 512(%rcx)
; AVX512BW-NEXT:    vmovdqa64 %zmm9, 448(%rcx)
; AVX512BW-NEXT:    vmovdqa64 %zmm5, 384(%rcx)
; AVX512BW-NEXT:    vmovdqa64 %zmm1, 320(%rcx)
; AVX512BW-NEXT:    vmovdqa64 %zmm19, 256(%rcx)
; AVX512BW-NEXT:    vmovdqa64 %zmm8, 192(%rcx)
; AVX512BW-NEXT:    vmovdqa64 %zmm0, 128(%rcx)
...
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm16
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm16
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm8, %zmm17, %zmm16
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm18 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm4, %zmm18, %zmm0
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm4 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm8, %zmm4, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm1, %zmm8
; AVX512BW-FCP-NEXT:    vpermt2d %zmm5, %zmm12, %zmm8
; AVX512BW-FCP-NEXT:    vpermt2d %zmm9, %zmm14, %zmm8
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm5, %zmm19
; AVX512BW-FCP-NEXT:    vpermt2d %zmm1, %zmm15, %zmm19
; AVX512BW-FCP-NEXT:    vpermt2d %zmm9, %zmm17, %zmm19
; AVX512BW-FCP-NEXT:    vpermt2d %zmm5, %zmm18, %zmm1
; AVX512BW-FCP-NEXT:    vpermt2d %zmm9, %zmm4, %zmm1
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2d %zmm6, %zmm12, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2d %zmm10, %zmm14, %zmm5
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm6, %zmm9
; AVX512BW-FCP-NEXT:    vpermt2d %zmm2, %zmm15, %zmm9
; AVX512BW-FCP-NEXT:    vpermt2d %zmm10, %zmm17, %zmm9
; AVX512BW-FCP-NEXT:    vpermt2d %zmm6, %zmm18, %zmm2
; AVX512BW-FCP-NEXT:    vpermt2d %zmm10, %zmm4, %zmm2
; AVX512BW-FCP-NEXT:    vpermi2d %zmm7, %zmm3, %zmm12
; AVX512BW-FCP-NEXT:    vpermt2d %zmm11, %zmm14, %zmm12
; AVX512BW-FCP-NEXT:    vpermi2d %zmm3, %zmm7, %zmm15
; AVX512BW-FCP-NEXT:    vpermt2d %zmm11, %zmm17, %zmm15
; AVX512BW-FCP-NEXT:    vpermt2d %zmm7, %zmm18, %zmm3
; AVX512BW-FCP-NEXT:    vpermt2d %zmm11, %zmm4, %zmm3
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm3, 704(%rcx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm15, 640(%rcx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm12, 576(%rcx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm2, 512(%rcx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm9, 448(%rcx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm5, 384(%rcx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm1, 320(%rcx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm19, 256(%rcx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm8, 192(%rcx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, 128(%rcx)
...
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm4, %zmm16
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm15, %zmm16
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm8, %zmm17, %zmm16
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm18 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm4, %zmm18, %zmm0
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm4 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm8, %zmm4, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm1, %zmm8
; AVX512DQ-BW-NEXT:    vpermt2d %zmm5, %zmm12, %zmm8
; AVX512DQ-BW-NEXT:    vpermt2d %zmm9, %zmm14, %zmm8
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm5, %zmm19
; AVX512DQ-BW-NEXT:    vpermt2d %zmm1, %zmm15, %zmm19
; AVX512DQ-BW-NEXT:    vpermt2d %zmm9, %zmm17, %zmm19
; AVX512DQ-BW-NEXT:    vpermt2d %zmm5, %zmm18, %zmm1
; AVX512DQ-BW-NEXT:    vpermt2d %zmm9, %zmm4, %zmm1
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2d %zmm6, %zmm12, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2d %zmm10, %zmm14, %zmm5
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm6, %zmm9
; AVX512DQ-BW-NEXT:    vpermt2d %zmm2, %zmm15, %zmm9
; AVX512DQ-BW-NEXT:    vpermt2d %zmm10, %zmm17, %zmm9
; AVX512DQ-BW-NEXT:    vpermt2d %zmm6, %zmm18, %zmm2
; AVX512DQ-BW-NEXT:    vpermt2d %zmm10, %zmm4, %zmm2
; AVX512DQ-BW-NEXT:    vpermi2d %zmm7, %zmm3, %zmm12
; AVX512DQ-BW-NEXT:    vpermt2d %zmm11, %zmm14, %zmm12
; AVX512DQ-BW-NEXT:    vpermi2d %zmm3, %zmm7, %zmm15
; AVX512DQ-BW-NEXT:    vpermt2d %zmm11, %zmm17, %zmm15
; AVX512DQ-BW-NEXT:    vpermt2d %zmm7, %zmm18, %zmm3
; AVX512DQ-BW-NEXT:    vpermt2d %zmm11, %zmm4, %zmm3
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm3, 704(%rcx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm15, 640(%rcx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm12, 576(%rcx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, 512(%rcx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm9, 448(%rcx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm5, 384(%rcx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm1, 320(%rcx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm19, 256(%rcx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm8, 192(%rcx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, 128(%rcx)
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [5,0,22,6,0,23,7,0,24,8,0,25,9,0,26,10]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm16
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm16
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,21,2,3,22,5,6,23,8,9,24,11,12,25,14,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm8, %zmm17, %zmm16
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm18 = [0,11,27,0,12,28,0,13,29,0,14,30,0,15,31,0]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm4, %zmm18, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm4 = [26,1,2,27,4,5,28,7,8,29,10,11,30,13,14,31]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm8, %zmm4, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm1, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm5, %zmm12, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm9, %zmm14, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm5, %zmm19
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm1, %zmm15, %zmm19
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm9, %zmm17, %zmm19
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm5, %zmm18, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm9, %zmm4, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm6, %zmm12, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm10, %zmm14, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm6, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm2, %zmm15, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm10, %zmm17, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm6, %zmm18, %zmm2
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm10, %zmm4, %zmm2
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm7, %zmm3, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm11, %zmm14, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm3, %zmm7, %zmm15
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm11, %zmm17, %zmm15
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm7, %zmm18, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm11, %zmm4, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm3, 704(%rcx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm15, 640(%rcx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm12, 576(%rcx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm2, 512(%rcx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm9, 448(%rcx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm5, 384(%rcx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm1, 320(%rcx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm19, 256(%rcx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm8, 192(%rcx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, 128(%rcx)
