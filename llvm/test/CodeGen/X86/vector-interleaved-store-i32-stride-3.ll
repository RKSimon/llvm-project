...
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm3[2,0],xmm0[2,1]
; AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1],xmm2[0],xmm0[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[1],xmm2[1],zero,zero
...
; AVX512-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,8,0,1,9,0,0,0]
; AVX512-NEXT:    vpermi2d %ymm1, %ymm0, %ymm2
; AVX512-NEXT:    vpbroadcastq (%rdx), %ymm0
...
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,8,0,1,9,0,0,0]
; AVX512-FCP-NEXT:    vpermi2d %ymm1, %ymm0, %ymm2
; AVX512-FCP-NEXT:    vpbroadcastq (%rdx), %ymm0
...
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,8,0,1,9,0,0,0]
; AVX512DQ-NEXT:    vpermi2d %ymm1, %ymm0, %ymm2
; AVX512DQ-NEXT:    vpbroadcastq (%rdx), %ymm0
...
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,8,0,1,9,0,0,0]
; AVX512DQ-FCP-NEXT:    vpermi2d %ymm1, %ymm0, %ymm2
; AVX512DQ-FCP-NEXT:    vpbroadcastq (%rdx), %ymm0
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,8,0,1,9,0,0,0]
; AVX512BW-NEXT:    vpermi2d %ymm1, %ymm0, %ymm2
; AVX512BW-NEXT:    vpbroadcastq (%rdx), %ymm0
; AVX512BW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm2[0,1],ymm0[2],ymm2[3,4],ymm0[5],ymm2[6,7]
...
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,8,0,1,9,0,0,0]
; AVX512BW-FCP-NEXT:    vpermi2d %ymm1, %ymm0, %ymm2
; AVX512BW-FCP-NEXT:    vpbroadcastq (%rdx), %ymm0
; AVX512BW-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm2[0,1],ymm0[2],ymm2[3,4],ymm0[5],ymm2[6,7]
...
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,8,0,1,9,0,0,0]
; AVX512DQ-BW-NEXT:    vpermi2d %ymm1, %ymm0, %ymm2
; AVX512DQ-BW-NEXT:    vpbroadcastq (%rdx), %ymm0
; AVX512DQ-BW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm2[0,1],ymm0[2],ymm2[3,4],ymm0[5],ymm2[6,7]
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,8,0,1,9,0,0,0]
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %ymm1, %ymm0, %ymm2
; AVX512DQ-BW-FCP-NEXT:    vpbroadcastq (%rdx), %ymm0
; AVX512DQ-BW-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm2[0,1],ymm0[2],ymm2[3,4],ymm0[5],ymm2[6,7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm3[1],ymm1[2,3],ymm3[4],ymm1[5,6],ymm3[7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0,1],ymm8[2],ymm9[3,4],ymm8[5],ymm9[6,7]
; AVX-NEXT:    vpermilpd {{.*#+}} ymm9 = mem[1,1,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0],ymm8[1,2],ymm9[3],ymm8[4,5],ymm9[6],ymm8[7]
