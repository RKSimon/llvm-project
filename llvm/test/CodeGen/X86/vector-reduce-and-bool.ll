...
; X64-SSE4-NEXT:    pmovmskb %xmm2, %eax
; X64-SSE4-NEXT:    cmpl $65535, %eax # imm = 0xFFFF
; X64-SSE4-NEXT:    sete %al
; X64-SSE4-NEXT:    retq
;
...
; SSE4-NEXT:    ret{{[l|q]}}
;
; X86-AVX1-LABEL: icmp1_v4i64_v4i1:
; X86-AVX1:       # %bb.0:
; X86-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm1
...
; X86-AVX1-NEXT:    retl
;
; X64-AVX1-LABEL: icmp1_v4i64_v4i1:
; X64-AVX1:       # %bb.0:
; X64-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm1
...
; SSE-NEXT:    ret{{[l|q]}}
;
; X86-AVX1-LABEL: icmp1_v8i32_v8i1:
; X86-AVX1:       # %bb.0:
; X86-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm1
; X86-AVX1-NEXT:    vpcmpeqd %xmm2, %xmm2, %xmm2
; X86-AVX1-NEXT:    vpand %xmm1, %xmm0, %xmm0
...
; X86-AVX1-NEXT:    retl
;
; X64-AVX1-LABEL: icmp1_v8i32_v8i1:
; X64-AVX1:       # %bb.0:
; X64-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm1
; X64-AVX1-NEXT:    vpand %xmm1, %xmm0, %xmm0
; X64-AVX1-NEXT:    vpcmpeqd %xmm1, %xmm1, %xmm1
...
; X64-SSE4-NEXT:    pcmpeqd %xmm0, %xmm0
; X64-SSE4-NEXT:    ptest %xmm0, %xmm1
; X64-SSE4-NEXT:    setb %al
; X64-SSE4-NEXT:    retq
;
...
; X64-AVX1:       # %bb.0:
; X64-AVX1-NEXT:    vpcmpeqw %xmm2, %xmm0, %xmm4
; X64-AVX1-NEXT:    vpcmpeqw %xmm3, %xmm1, %xmm5
; X64-AVX1-NEXT:    vpand %xmm4, %xmm5, %xmm4
; X64-AVX1-NEXT:    vextractf128 $1, %ymm2, %xmm2
; X64-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm0
...
; X86-AVX1-NEXT:    vextractf128 $1, %ymm2, %xmm3
; X86-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm4
; X86-AVX1-NEXT:    vpcmpeqb %xmm3, %xmm4, %xmm3
; X86-AVX1-NEXT:    vpcmpeqb %xmm2, %xmm0, %xmm0
; X86-AVX1-NEXT:    vextractf128 $1, %ymm1, %xmm2
; X86-AVX1-NEXT:    vpcmpeqb 24(%ebp), %xmm2, %xmm2
; X86-AVX1-NEXT:    vpand %xmm3, %xmm2, %xmm2
; X86-AVX1-NEXT:    vpcmpeqb 8(%ebp), %xmm1, %xmm1
; X86-AVX1-NEXT:    vpand %xmm0, %xmm1, %xmm0
