...
; SSE2:       # %bb.0:
; SSE2-NEXT:    movl $134217728, %eax # imm = 0x8000000
...
; AVX1:       # %bb.0:
; AVX1-NEXT:    movl $134217728, %eax # imm = 0x8000000
; AVX1-NEXT:    vmovd %eax, %xmm1
; AVX1-NEXT:    vpshufd {{.*#+}} xmm2 = xmm0[1,1,3,3]
; AVX1-NEXT:    vpmuludq %xmm1, %xmm2, %xmm1
; AVX1-NEXT:    movl $268435456, %eax # imm = 0x10000000
