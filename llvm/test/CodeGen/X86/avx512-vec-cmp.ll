...
; KNL-NEXT:    vcmpneqss %xmm2, %xmm1, %k0 ## encoding: [0x62,0xf1,0x76,0x08,0xc2,0xc2,0x04]
; KNL-NEXT:    kmovw %k0, %eax ## encoding: [0xc5,0xf8,0x93,0xc0]
; KNL-NEXT:    negl %eax ## encoding: [0xf7,0xd8]
; KNL-NEXT:    vcvtph2ps %xmm0, %xmm0 ## encoding: [0xc4,0xe2,0x79,0x13,0xc0]
; KNL-NEXT:    vcmpneqss %xmm2, %xmm0, %k0 ## encoding: [0x62,0xf1,0x7e,0x08,0xc2,0xc2,0x04]
; KNL-NEXT:    kmovw %k0, %ecx ## encoding: [0xc5,0xf8,0x93,0xc8]
; KNL-NEXT:    negl %ecx ## encoding: [0xf7,0xd9]
; KNL-NEXT:    vmovd %ecx, %xmm0 ## EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6e,0xc1]
; KNL-NEXT:    vpinsrw $1, %eax, %xmm0, %xmm0 ## encoding: [0xc5,0xf9,0xc4,0xc0,0x01]
...
; AVX512BW-NEXT:    vcmpneqss %xmm2, %xmm1, %k0 ## encoding: [0x62,0xf1,0x76,0x08,0xc2,0xc2,0x04]
; AVX512BW-NEXT:    kmovd %k0, %eax ## encoding: [0xc5,0xfb,0x93,0xc0]
; AVX512BW-NEXT:    negl %eax ## encoding: [0xf7,0xd8]
; AVX512BW-NEXT:    vcvtph2ps %xmm0, %xmm0 ## encoding: [0xc4,0xe2,0x79,0x13,0xc0]
; AVX512BW-NEXT:    vcmpneqss %xmm2, %xmm0, %k0 ## encoding: [0x62,0xf1,0x7e,0x08,0xc2,0xc2,0x04]
; AVX512BW-NEXT:    kmovd %k0, %ecx ## encoding: [0xc5,0xfb,0x93,0xc8]
; AVX512BW-NEXT:    negl %ecx ## encoding: [0xf7,0xd9]
; AVX512BW-NEXT:    vmovd %ecx, %xmm0 ## EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6e,0xc1]
; AVX512BW-NEXT:    vpinsrw $1, %eax, %xmm0, %xmm0 ## EVEX TO VEX Compression encoding: [0xc5,0xf9,0xc4,0xc0,0x01]
...
; SKX-NEXT:    orb %al, %dl ## encoding: [0x08,0xc2]
; SKX-NEXT:    andl $1, %edx ## encoding: [0x83,0xe2,0x01]
; SKX-NEXT:    kmovw %edx, %k0 ## encoding: [0xc5,0xf8,0x92,0xc2]
