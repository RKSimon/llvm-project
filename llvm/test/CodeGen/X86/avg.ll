...
; SSE2-NEXT:    addl %ebp, %r11d
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %ebp
; SSE2-NEXT:    addl %ebp, %r9d
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %ebp
; SSE2-NEXT:    leaq -1(%rcx,%rbp), %rcx
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %ebp
; SSE2-NEXT:    leaq -1(%rax,%rbp), %rax
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %ebp
; SSE2-NEXT:    leaq -1(%rdx,%rbp), %rdx
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %ebp
; SSE2-NEXT:    leaq -1(%r13,%rbp), %rbp
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %r13d
; SSE2-NEXT:    leaq -1(%r12,%r13), %r13
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %r12d
; SSE2-NEXT:    leaq -1(%r14,%r12), %r12
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %r14d
; SSE2-NEXT:    leaq -1(%rbx,%r14), %r14
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %ebx
; SSE2-NEXT:    leaq -1(%r10,%rbx), %rbx
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %r10d
; SSE2-NEXT:    leaq -1(%r8,%r10), %r8
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %r10d
; SSE2-NEXT:    leaq -1(%rdi,%r10), %rdi
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %r10d
; SSE2-NEXT:    leaq -1(%rsi,%r10), %rsi
; SSE2-NEXT:    movzbl -{{[0-9]+}}(%rsp), %r10d
; SSE2-NEXT:    leaq -1(%r15,%r10), %r10
...
; SSE2-NEXT:    shrq %rbp
; SSE2-NEXT:    movq %rbp, %xmm3
; SSE2-NEXT:    shrq %r13
; SSE2-NEXT:    movq %r13, %xmm5
; SSE2-NEXT:    shrq %r12
; SSE2-NEXT:    movq %r12, %xmm4
; SSE2-NEXT:    shrq %r14
; SSE2-NEXT:    movq %r14, %xmm6
; SSE2-NEXT:    shrq %rbx
; SSE2-NEXT:    movq %rbx, %xmm7
; SSE2-NEXT:    movq %r15, %xmm9
; SSE2-NEXT:    movq %r10, %xmm8
; SSE2-NEXT:    shrq %r8
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm0 = [65535,65535,65535,65535,65535,0,65535,65535]
; SSE2-NEXT:    pshufd {{.*#+}} xmm2 = xmm7[0,1,0,1]
...
; SSE2-NEXT:    punpcklbw {{.*#+}} xmm11 = xmm11[0],xmm13[0],xmm11[1],xmm13[1],xmm11[2],xmm13[2],xmm11[3],xmm13[3],xmm11[4],xmm13[4],xmm11[5],xmm13[5],xmm11[6],xmm13[6],xmm11[7],xmm13[7]
; SSE2-NEXT:    psllq $48, %xmm11
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm3 = xmm15[0,0,1,1]
...
; AVX1-NEXT:    vpextrw $0, %xmm3, %r8d
; AVX1-NEXT:    vpextrw $1, %xmm3, %r9d
...
; AVX1-NEXT:    leaq -1(%r10,%r11), %r14
; AVX1-NEXT:    vpextrw $1, %xmm2, %r10d
; AVX1-NEXT:    leaq -1(%r9,%r10), %r11
; AVX1-NEXT:    vpextrw $0, %xmm2, %r9d
; AVX1-NEXT:    leaq -1(%r8,%r9), %r10
; AVX1-NEXT:    vpextrw $7, %xmm1, %r8d
; AVX1-NEXT:    leaq -1(%rsi,%r8), %r9
; AVX1-NEXT:    vpextrw $6, %xmm1, %esi
; AVX1-NEXT:    leaq -1(%rdi,%rsi), %r8
...
; AVX2-NEXT:    vmovq %xmm8, %rdx
; AVX2-NEXT:    vpextrq $1, %xmm8, %rdi
; AVX2-NEXT:    vpextrq $1, %xmm2, %r8
; AVX2-NEXT:    vpextrq $1, %xmm7, %rbp
...
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm9 = xmm3[0],zero,xmm3[1],zero,xmm3[2],zero,xmm3[3],zero
...
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm5 = xmm7[0],zero,xmm7[1],zero,xmm7[2],zero,xmm7[3],zero
...
; AVX2-NEXT:    shldq $63, %rcx, %rbx
; AVX2-NEXT:    shldq $63, %r11, %r15
; AVX2-NEXT:    shldq $63, %rdx, %r14
; AVX2-NEXT:    shldq $63, %r13, %r10
; AVX2-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; AVX2-NEXT:    shldq $63, %rax, %r9
; AVX2-NEXT:    shldq $63, %rbp, %r8
; AVX2-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; AVX2-NEXT:    shldq $63, %rax, %rdi
; AVX2-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
...
; AVX2-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; AVX2-NEXT:    shrq %rax
; AVX2-NEXT:    vmovq %rax, %xmm11
; AVX2-NEXT:    vmovq %r15, %xmm12
; AVX2-NEXT:    vmovq %rbx, %xmm13
; AVX2-NEXT:    vmovq %r12, %xmm14
; AVX2-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; AVX2-NEXT:    shrq %rax
...
; AVX512-NEXT:    vpextrq $1, %xmm4, %r10
; AVX512-NEXT:    vpextrq $1, %xmm3, %r8
; AVX512-NEXT:    vpextrq $1, %xmm1, %rdi
; AVX512-NEXT:    vpextrq $1, %xmm0, %rsi
; AVX512-NEXT:    vpmovzxwd {{.*#+}} ymm4 = xmm6[0],zero,xmm6[1],zero,xmm6[2],zero,xmm6[3],zero,xmm6[4],zero,xmm6[5],zero,xmm6[6],zero,xmm6[7],zero
...
; AVX512-NEXT:    vpmovzxwd {{.*#+}} ymm8 = xmm6[0],zero,xmm6[1],zero,xmm6[2],zero,xmm6[3],zero,xmm6[4],zero,xmm6[5],zero,xmm6[6],zero,xmm6[7],zero
; AVX512-NEXT:    vextracti128 $1, %ymm8, %xmm6
; AVX512-NEXT:    vpmovzxdq {{.*#+}} ymm6 = xmm6[0],zero,xmm6[1],zero,xmm6[2],zero,xmm6[3],zero
; AVX512-NEXT:    vextracti128 $1, %ymm6, %xmm7
; AVX512-NEXT:    vpmovzxdq {{.*#+}} ymm8 = xmm8[0],zero,xmm8[1],zero,xmm8[2],zero,xmm8[3],zero
; AVX512-NEXT:    vextracti128 $1, %ymm8, %xmm9
; AVX512-NEXT:    vpextrq $1, %xmm2, %r12
; AVX512-NEXT:    addl %r12d, %esi
; AVX512-NEXT:    vpextrq $1, %xmm3, %r12
; AVX512-NEXT:    addl %r12d, %edi
; AVX512-NEXT:    vpextrq $1, %xmm6, %r12
; AVX512-NEXT:    addl %r12d, %r8d
; AVX512-NEXT:    vpextrq $1, %xmm7, %r12
; AVX512-NEXT:    addl %r12d, %r10d
; AVX512-NEXT:    vpextrq $1, %xmm9, %r12
; AVX512-NEXT:    leaq -1(%r11,%r12), %r11
; AVX512-NEXT:    vmovq %xmm9, %r12
; AVX512-NEXT:    leaq -1(%rbx,%r12), %rbx
; AVX512-NEXT:    vpextrq $1, %xmm8, %r12
; AVX512-NEXT:    leaq -1(%r15,%r12), %rbp
; AVX512-NEXT:    vmovq %xmm8, %r15
; AVX512-NEXT:    leaq -1(%r14,%r15), %r13
; AVX512-NEXT:    vmovq %xmm7, %r14
; AVX512-NEXT:    leaq -1(%rdx,%r14), %r12
; AVX512-NEXT:    vmovq %xmm6, %rdx
; AVX512-NEXT:    leaq -1(%rcx,%rdx), %r15
; AVX512-NEXT:    vpextrq $1, %xmm5, %rcx
; AVX512-NEXT:    leaq -1(%rax,%rcx), %r14
; AVX512-NEXT:    vmovq %xmm5, %rax
; AVX512-NEXT:    leaq -1(%r9,%rax), %rax
; AVX512-NEXT:    movq %rax, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; AVX512-NEXT:    vpextrq $1, %xmm4, %rax
; AVX512-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rcx # 8-byte Reload
; AVX512-NEXT:    leaq -1(%rcx,%rax), %rax
; AVX512-NEXT:    movq %rax, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
...
; AVX512-NEXT:    shldq $63, %rsi, %r9
; AVX512-NEXT:    shldq $63, %rdi, %rdx
; AVX512-NEXT:    shldq $63, %r8, %rcx
; AVX512-NEXT:    shldq $63, %r10, %rax
...
; AVX512-NEXT:    vmovq %rdx, %xmm12
; AVX512-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; AVX512-NEXT:    shrq %rax
; AVX512-NEXT:    vmovq %rax, %xmm13
; AVX512-NEXT:    vmovq %r9, %xmm14
; AVX512-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; AVX512-NEXT:    shrq %rax
