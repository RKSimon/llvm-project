...
; AVX512-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm0 | (ymm1 & ~mem)
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm0 | (ymm1 & ~mem)
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm0 | (ymm1 & ~mem)
...
; AVX512-NEXT:    vpternlogq {{.*#+}} ymm1 = ymm1 ^ (mem & (ymm1 ^ ymm2))
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} ymm1 = ymm1 ^ (mem & (ymm1 ^ ymm2))
...
; AVX512-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm5 ^ (zmm6 & (zmm5 ^ zmm4))
...
; AVX512-FCP-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm5 ^ (zmm6 & (zmm5 ^ zmm4))
...
; AVX512DQ-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm5 ^ (zmm6 & (zmm5 ^ zmm4))
...
; AVX512DQ-FCP-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm5 ^ (zmm6 & (zmm5 ^ zmm4))
...
; AVX2-FP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [5,5,0,6,6,0,7,7]
; AVX2-FP-NEXT:    vpermd %ymm1, %ymm2, %ymm5
...
; AVX2-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [5,5,0,6,6,0,7,7]
; AVX2-FCP-NEXT:    vpermd %ymm1, %ymm2, %ymm5
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 | (zmm12 & zmm15)
...
; AVX512-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm5 ^ (zmm9 & (zmm5 ^ zmm12))
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm10 = zmm10 | (zmm0 & zmm15)
...
; AVX512-NEXT:    vpternlogd {{.*#+}} zmm1 = zmm1 ^ (zmm9 & (zmm1 ^ zmm0))
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm6 = zmm6 | (zmm0 & zmm11)
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm3 = zmm3 | (zmm0 & zmm11)
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 | (zmm12 & zmm15)
...
; AVX512-FCP-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm5 ^ (zmm9 & (zmm5 ^ zmm12))
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm10 = zmm10 | (zmm0 & zmm15)
...
; AVX512-FCP-NEXT:    vpternlogd {{.*#+}} zmm1 = zmm1 ^ (zmm9 & (zmm1 ^ zmm0))
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm6 = zmm6 | (zmm0 & zmm11)
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm3 = zmm3 | (zmm0 & zmm11)
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 | (zmm12 & zmm15)
...
; AVX512DQ-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm5 ^ (zmm9 & (zmm5 ^ zmm12))
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm10 = zmm10 | (zmm0 & zmm15)
...
; AVX512DQ-NEXT:    vpternlogd {{.*#+}} zmm1 = zmm1 ^ (zmm9 & (zmm1 ^ zmm0))
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm6 = zmm6 | (zmm0 & zmm11)
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm3 = zmm3 | (zmm0 & zmm11)
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 | (zmm12 & zmm15)
...
; AVX512DQ-FCP-NEXT:    vpternlogd {{.*#+}} zmm5 = zmm5 ^ (zmm9 & (zmm5 ^ zmm12))
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm10 = zmm10 | (zmm0 & zmm15)
...
; AVX512DQ-FCP-NEXT:    vpternlogd {{.*#+}} zmm1 = zmm1 ^ (zmm9 & (zmm1 ^ zmm0))
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm6 = zmm6 | (zmm0 & zmm11)
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm3 = zmm3 | (zmm0 & zmm11)
