...
; SSE41-NEXT:    retq
;
; AVX12-LABEL: trunc_v4i64_cmp:
; AVX12:       # %bb.0:
; AVX12-NEXT:    vptest {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm0
; AVX12-NEXT:    setne %al
