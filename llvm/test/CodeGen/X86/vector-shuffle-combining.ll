...
; AVX1-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,0,0,0]
; AVX1-NEXT:    vblendps {{.*#+}} xmm1 = xmm1[0,1,2],xmm0[3]
; AVX1-NEXT:    vmovaps {{.*#+}} xmm2 = [0.0E+0,0.0E+0,-2.0E+0,-2.0E+0]
; AVX1-NEXT:    vmulps %xmm2, %xmm0, %xmm3
; AVX1-NEXT:    vmovss {{.*#+}} xmm4 = [NaN,0.0E+0,0.0E+0,0.0E+0]
; AVX1-NEXT:    vinsertps {{.*#+}} xmm3 = xmm3[0,1,2],xmm4[0]
; AVX1-NEXT:    vinsertps {{.*#+}} xmm0 = zero,xmm4[0],zero,xmm0[3]
; AVX1-NEXT:    vaddps %xmm0, %xmm3, %xmm0
