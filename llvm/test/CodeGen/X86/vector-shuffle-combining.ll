...
; AVX2-SLOW-NEXT:    vpaddd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm0, %ymm0 # [30064771080,21474836486,30064771080,21474836486]
; AVX2-SLOW-NEXT:    retq
;
...
; AVX2-FAST-ALL-NEXT:    vpaddd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm0, %ymm0 # [30064771080,21474836486,30064771080,21474836486]
...
; AVX2-FAST-PERLANE-NEXT:    vpaddd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm0, %ymm0 # [30064771080,21474836486,30064771080,21474836486]
...
; SSE41-NEXT:    pshufb {{.*#+}} xmm0 = xmm0[8,9,2,3,0,1,14,15,u,u,u,u,u,u,u,u]
...
; AVX-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[8,9,2,3,0,1,14,15,u,u,u,u,u,u,u,u]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm2[1,3,0,1]
; SSE2-NEXT:    retq
;
...
; SSSE3-NEXT:    pshufd {{.*#+}} xmm0 = xmm2[1,3,0,1]
; SSSE3-NEXT:    retq
;
; SSE41-LABEL: PR179112:
; SSE41:       # %bb.0:
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[1,0,2,3]
; SSE41-NEXT:    pcmpeqd %xmm1, %xmm1
; SSE41-NEXT:    movdqa %xmm0, %xmm2
; SSE41-NEXT:    psubd %xmm1, %xmm2
; SSE41-NEXT:    pmaxud %xmm2, %xmm0
; SSE41-NEXT:    pcmpeqd %xmm2, %xmm0
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[1,1,0,3]
...
; AVX-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[1,1,0,3]
...
; SSE2-NEXT:    movaps {{.*#+}} xmm3 = [0.0E+0,0.0E+0,-2.0E+0,u]
; SSE2-NEXT:    mulps %xmm3, %xmm0
; SSE2-NEXT:    movss {{.*#+}} xmm4 = [NaN,0.0E+0,0.0E+0,0.0E+0]
; SSE2-NEXT:    movaps %xmm0, %xmm5
; SSE2-NEXT:    movsd {{.*#+}} xmm5 = xmm4[0],xmm5[1]
; SSE2-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,1],xmm5[2,0]
; SSE2-NEXT:    movq {{.*#+}} xmm4 = xmm4[0],zero
; SSE2-NEXT:    shufps {{.*#+}} xmm4 = xmm4[2,0],xmm1[2,0]
; SSE2-NEXT:    addps %xmm0, %xmm4
; SSE2-NEXT:    movaps %xmm4, (%rax)
...
; SSSE3-NEXT:    movaps {{.*#+}} xmm3 = [0.0E+0,0.0E+0,-2.0E+0,u]
; SSSE3-NEXT:    mulps %xmm3, %xmm0
; SSSE3-NEXT:    movss {{.*#+}} xmm4 = [NaN,0.0E+0,0.0E+0,0.0E+0]
; SSSE3-NEXT:    movaps %xmm0, %xmm5
; SSSE3-NEXT:    movsd {{.*#+}} xmm5 = xmm4[0],xmm5[1]
; SSSE3-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,1],xmm5[2,0]
; SSSE3-NEXT:    movq {{.*#+}} xmm4 = xmm4[0],zero
; SSSE3-NEXT:    shufps {{.*#+}} xmm4 = xmm4[2,0],xmm1[2,0]
; SSSE3-NEXT:    addps %xmm0, %xmm4
; SSSE3-NEXT:    movaps %xmm4, (%rax)
...
; AVX1-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,zero,xmm0[0]
; AVX1-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,0,0,2]
; AVX1-NEXT:    vmovaps {{.*#+}} xmm2 = [0.0E+0,0.0E+0,-2.0E+0,-2.0E+0]
; AVX1-NEXT:    vmulps %xmm2, %xmm0, %xmm0
; AVX1-NEXT:    vmovss {{.*#+}} xmm3 = [NaN,0.0E+0,0.0E+0,0.0E+0]
; AVX1-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1,2],xmm3[0]
; AVX1-NEXT:    vinsertps {{.*#+}} xmm3 = xmm1[0],xmm3[0],xmm1[2,3]
; AVX1-NEXT:    vaddps %xmm3, %xmm0, %xmm0
; AVX1-NEXT:    vmovaps %xmm0, (%rax)
; AVX1-NEXT:    vbroadcastss (%rax), %xmm0
; AVX1-NEXT:    vmulps %xmm2, %xmm0, %xmm0
...
; AVX2-NEXT:    vbroadcastss %xmm0, %xmm0
; AVX2-NEXT:    vblendps {{.*#+}} xmm1 = xmm1[0,1,2],xmm0[3]
; AVX2-NEXT:    vmovaps {{.*#+}} xmm2 = [0.0E+0,0.0E+0,-2.0E+0,-2.0E+0]
; AVX2-NEXT:    vmulps %xmm2, %xmm0, %xmm3
; AVX2-NEXT:    vmovss {{.*#+}} xmm4 = [NaN,0.0E+0,0.0E+0,0.0E+0]
; AVX2-NEXT:    vinsertps {{.*#+}} xmm3 = xmm3[0,1,2],xmm4[0]
; AVX2-NEXT:    vinsertps {{.*#+}} xmm0 = zero,xmm4[0],zero,xmm0[3]
; AVX2-NEXT:    vaddps %xmm0, %xmm3, %xmm0
; AVX2-NEXT:    vmovaps %xmm0, (%rax)
; AVX2-NEXT:    vbroadcastss (%rax), %xmm0
; AVX2-NEXT:    vmulps %xmm2, %xmm0, %xmm0
