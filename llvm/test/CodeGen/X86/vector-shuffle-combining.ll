...
; SSE2-NEXT:    movaps {{.*#+}} xmm2 = [0.0E+0,0.0E+0,-2.0E+0,u]
; SSE2-NEXT:    movaps %xmm1, %xmm3
; SSE2-NEXT:    mulps %xmm2, %xmm3
...
; SSE2-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,0],xmm0[0,0]
; SSE2-NEXT:    addps %xmm3, %xmm4
...
; AVX-NEXT:    vmovss {{.*#+}} xmm3 = [NaN,0.0E+0,0.0E+0,0.0E+0]
