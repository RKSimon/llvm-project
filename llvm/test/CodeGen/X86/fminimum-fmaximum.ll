...
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm1[3,3,3,3,4,5,6,7]
; AVX512-NEXT:    vcvtph2ps %xmm3, %xmm3
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm0[3,3,3,3,4,5,6,7]
; AVX512-NEXT:    vcvtph2ps %xmm4, %xmm4
; AVX512-NEXT:    xorl %esi, %esi
...
; AVX512-NEXT:    vpinsrw $4, %r8d, %xmm2, %xmm2
; AVX512-NEXT:    vpsrldq {{.*#+}} xmm3 = xmm1[10,11,12,13,14,15],zero,zero,zero,zero,zero,zero,zero,zero,zero,zero
; AVX512-NEXT:    vcvtph2ps %xmm3, %xmm3
...
; AVX512-NEXT:    seta %r10b
; AVX512-NEXT:    negl %r10d
; AVX512-NEXT:    vpinsrw $6, %r10d, %xmm2, %xmm2
...
; AVX512-NEXT:    seta %r11b
; AVX512-NEXT:    negl %r11d
; AVX512-NEXT:    vpinsrw $7, %r11d, %xmm2, %xmm2
...
; AVX512-NEXT:    negl %esi
; AVX512-NEXT:    vpinsrw $3, %esi, %xmm3, %xmm3
; AVX512-NEXT:    negl %edi
; AVX512-NEXT:    vpinsrw $4, %edi, %xmm3, %xmm3
; AVX512-NEXT:    negl %r8d
; AVX512-NEXT:    vpinsrw $5, %r8d, %xmm3, %xmm3
; AVX512-NEXT:    negl %r9d
; AVX512-NEXT:    vpinsrw $6, %r9d, %xmm3, %xmm3
; AVX512-NEXT:    negl %r10d
; AVX512-NEXT:    vpinsrw $7, %r10d, %xmm3, %xmm3
...
; AVX512-NEXT:    vcmpeqss %xmm4, %xmm3, %k0
...
; AVX512-NEXT:    vcmpeqss %xmm4, %xmm5, %k0
; AVX512-NEXT:    kmovw %k0, %eax
; AVX512-NEXT:    negl %eax
