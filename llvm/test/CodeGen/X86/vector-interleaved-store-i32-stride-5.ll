...
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[2,3],xmm8[0,2]
; SSE-NEXT:    movaps %xmm0, %xmm12
; SSE-NEXT:    shufps {{.*#+}} xmm12 = xmm12[3,1],xmm11[2,3]
; SSE-NEXT:    movaps %xmm2, %xmm8
; SSE-NEXT:    unpckhpd {{.*#+}} xmm8 = xmm8[1],xmm10[1]
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[2,0],xmm12[2,0]
; SSE-NEXT:    movaps %xmm0, %xmm12
; SSE-NEXT:    unpckhps {{.*#+}} xmm12 = xmm12[2],xmm7[2],xmm12[3],xmm7[3]
; SSE-NEXT:    movaps %xmm10, %xmm13
; SSE-NEXT:    unpcklps {{.*#+}} xmm13 = xmm13[0],xmm2[0],xmm13[1],xmm2[1]
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[1,1],xmm11[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[0,2],xmm12[0,1]
; SSE-NEXT:    movaps %xmm0, %xmm12
; SSE-NEXT:    unpcklps {{.*#+}} xmm12 = xmm12[0],xmm7[0],xmm12[1],xmm7[1]
; SSE-NEXT:    movlhps {{.*#+}} xmm12 = xmm12[0],xmm13[0]
; SSE-NEXT:    movaps %xmm4, %xmm14
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[3,3],xmm5[3,3]
; SSE-NEXT:    movaps %xmm6, %xmm13
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[3,3],xmm3[3,3]
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[0,2],xmm14[0,2]
; SSE-NEXT:    movaps %xmm1, %xmm14
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[3,0],xmm5[2,0]
...
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[1,1],xmm7[1,1]
...
; SSE-NEXT:    movaps %xmm13, 64(%r9)
; SSE-NEXT:    movaps %xmm12, 80(%r9)
; SSE-NEXT:    movaps %xmm2, 112(%r9)
; SSE-NEXT:    movaps %xmm8, 128(%r9)
; SSE-NEXT:    movaps %xmm9, 144(%r9)
...
; SSE-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,2],xmm2[0,1]
; SSE-NEXT:    movaps %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps %xmm5, %xmm2
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[3,0],xmm11[2,0]
; SSE-NEXT:    movaps %xmm14, %xmm4
; SSE-NEXT:    unpckhps {{.*#+}} xmm4 = xmm4[2],xmm1[2],xmm4[3],xmm1[3]
; SSE-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,1],xmm2[2,0]
; SSE-NEXT:    movaps %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[3,3],xmm11[3,3]
; SSE-NEXT:    movaps %xmm8, %xmm2
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[3,3],xmm14[3,3]
...
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[0,2],xmm1[0,1]
; SSE-NEXT:    movaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps %xmm3, %xmm1
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[3,1],xmm10[2,3]
; SSE-NEXT:    movaps %xmm0, %xmm2
; SSE-NEXT:    unpckhpd {{.*#+}} xmm2 = xmm2[1],xmm7[1]
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[2,0],xmm1[2,0]
; SSE-NEXT:    movaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[3,3],xmm10[3,3]
; SSE-NEXT:    movaps %xmm6, %xmm1
; SSE-NEXT:    unpckhps {{.*#+}} xmm1 = xmm1[2],xmm7[2],xmm1[3],xmm7[3]
; SSE-NEXT:    movaps %xmm7, %xmm13
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[2,3],xmm0[0,2]
...
; SSE-NEXT:    shufps {{.*#+}} xmm11 = xmm11[0,2],xmm1[0,1]
; SSE-NEXT:    movaps %xmm15, %xmm1
...
; SSE-NEXT:    movss {{.*#+}} xmm5 = xmm7[0],xmm5[1,2,3]
; SSE-NEXT:    movaps %xmm0, 304(%r9)
; SSE-NEXT:    movaps %xmm1, 288(%r9)
; SSE-NEXT:    movaps %xmm4, 272(%r9)
; SSE-NEXT:    movaps %xmm6, 240(%r9)
; SSE-NEXT:    movaps %xmm12, 224(%r9)
...
; SSE-NEXT:    movaps %xmm5, 256(%r9)
; SSE-NEXT:    movaps %xmm15, 176(%r9)
; SSE-NEXT:    movaps %xmm14, 96(%r9)
...
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,2],xmm1[0,1]
; SSE-NEXT:    movaps %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps %xmm2, %xmm1
...
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[3,3],xmm7[3,3]
...
; SSE-NEXT:    movaps 112(%r8), %xmm8
; SSE-NEXT:    movaps %xmm2, %xmm4
; SSE-NEXT:    shufps {{.*#+}} xmm4 = xmm4[1,1],xmm8[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,2],xmm0[0,1]
; SSE-NEXT:    movaps %xmm3, %xmm6
; SSE-NEXT:    shufps {{.*#+}} xmm6 = xmm6[3,1],xmm8[2,3]
; SSE-NEXT:    movaps %xmm2, %xmm0
; SSE-NEXT:    unpckhpd {{.*#+}} xmm0 = xmm0[1],xmm1[1]
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[2,0],xmm6[2,0]
...
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm2 = xmm14[0],xmm2[1,2,3]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Folded Reload
; SSE-NEXT:    # xmm14 = xmm14[1,1],mem[1,1]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
...
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Folded Reload
; SSE-NEXT:    # xmm13 = xmm13[1,1],mem[1,1]
; SSE-NEXT:    movaps (%rsp), %xmm14 # 16-byte Reload
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[0,1],xmm13[2,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm14 = xmm13[0],xmm14[1,2,3]
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Folded Reload
; SSE-NEXT:    # xmm7 = xmm7[1,1],mem[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[0,1],xmm7[2,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm10 = xmm7[0],xmm10[1,2,3]
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[1,1],xmm11[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,1],xmm1[2,0]
; SSE-NEXT:    movss {{.*#+}} xmm3 = xmm8[0],xmm3[1,2,3]
; SSE-NEXT:    movaps %xmm6, 624(%r9)
; SSE-NEXT:    movaps %xmm0, 608(%r9)
; SSE-NEXT:    movaps %xmm4, 592(%r9)
; SSE-NEXT:    movaps %xmm5, 560(%r9)
; SSE-NEXT:    movaps %xmm9, 544(%r9)
; SSE-NEXT:    movaps %xmm12, 528(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; SSE-NEXT:    movaps %xmm10, 496(%r9)
; SSE-NEXT:    movaps %xmm14, 416(%r9)
; SSE-NEXT:    movaps %xmm15, 336(%r9)
...
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[0,2],xmm0[0,2]
; SSE-NEXT:    movaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps 176(%rdx), %xmm4
; SSE-NEXT:    movaps 176(%rcx), %xmm0
; SSE-NEXT:    movaps %xmm4, %xmm1
; SSE-NEXT:    unpcklps {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; SSE-NEXT:    movaps 176(%rdi), %xmm2
; SSE-NEXT:    movaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps 176(%rsi), %xmm5
; SSE-NEXT:    movaps %xmm2, %xmm3
; SSE-NEXT:    unpcklps {{.*#+}} xmm3 = xmm3[0],xmm5[0],xmm3[1],xmm5[1]
; SSE-NEXT:    movlhps {{.*#+}} xmm3 = xmm3[0],xmm1[0]
; SSE-NEXT:    movaps %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[3,3],xmm3[3,3]
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[3,3],xmm4[3,3]
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[0,2],xmm0[0,2]
...
; SSE-NEXT:    movaps %xmm5, %xmm1
; SSE-NEXT:    unpckhps {{.*#+}} xmm1 = xmm1[2],xmm14[2],xmm1[3],xmm14[3]
; SSE-NEXT:    movaps 240(%r8), %xmm12
; SSE-NEXT:    movaps %xmm2, %xmm3
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[1,1],xmm12[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,2],xmm1[0,1]
; SSE-NEXT:    movaps %xmm5, %xmm10
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[3,1],xmm12[2,3]
; SSE-NEXT:    movaps %xmm2, %xmm1
; SSE-NEXT:    unpckhpd {{.*#+}} xmm1 = xmm1[1],xmm0[1]
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[2,0],xmm10[2,0]
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[3,3],xmm12[3,3]
; SSE-NEXT:    movaps %xmm14, %xmm10
; SSE-NEXT:    unpckhps {{.*#+}} xmm10 = xmm10[2],xmm0[2],xmm10[3],xmm0[3]
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[2,3],xmm2[0,2]
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Folded Reload
; SSE-NEXT:    # xmm15 = xmm15[1,1],mem[1,1]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[0,1],xmm15[2,0]
...
; SSE-NEXT:    movaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; SSE-NEXT:    shufps {{.*#+}} xmm15 = xmm15[1,1],xmm8[1,1]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[0,1],xmm15[2,0]
...
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; SSE-NEXT:    shufps {{.*#+}} xmm15 = xmm15[0,1],xmm8[2,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm15 = xmm8[0],xmm15[1,2,3]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Folded Reload
; SSE-NEXT:    # xmm8 = xmm8[1,1],mem[1,1]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
...
; SSE-NEXT:    movss {{.*#+}} xmm8 = xmm11[0],xmm8[1,2,3]
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm4 # 16-byte Folded Reload
; SSE-NEXT:    # xmm4 = xmm4[1,1],mem[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[0,1],xmm4[2,0]
...
; SSE-NEXT:    movss {{.*#+}} xmm5 = xmm12[0],xmm5[1,2,3]
; SSE-NEXT:    movaps %xmm10, 1264(%r9)
; SSE-NEXT:    movaps %xmm1, 1248(%r9)
; SSE-NEXT:    movaps %xmm3, 1232(%r9)
; SSE-NEXT:    movaps %xmm6, 1200(%r9)
; SSE-NEXT:    movaps %xmm9, 1184(%r9)
...
; SSE-NEXT:    movaps %xmm13, 1136(%r9)
; SSE-NEXT:    movaps %xmm8, 1056(%r9)
; SSE-NEXT:    movaps %xmm2, 976(%r9)
; SSE-NEXT:    movaps %xmm15, 896(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
