...
; AVX-NEXT:    vmovsd {{.*#+}} xmm1 = mem[0],zero
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm0[0,2,2,1,4,6,6,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm0[2,3,0,1]
; AVX-NEXT:    vpermilps {{.*#+}} ymm3 = ymm3[u,u,0,2,u,5,7,u]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm3[2,3,4,5,6],ymm2[7]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm3
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm3[4],ymm2[5,6,7]
; AVX-NEXT:    vextractf128 $1, %ymm0, %xmm0
; AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[3],xmm1[1],zero,zero
; AVX-NEXT:    vmovlps %xmm0, 32(%r9)
...
; AVX2-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,4,2,6,0,1,5,3]
...
; AVX2-FP-NEXT:    vmovq %rax, %xmm1
; AVX2-FP-NEXT:    vextracti128 $1, %ymm0, %xmm2
; AVX2-FP-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[3,3,3,3]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm1 = xmm2[0],xmm1[1],xmm2[2,3]
; AVX2-FP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,4,2,6,0,1,5,3]
; AVX2-FP-NEXT:    vpermd %ymm0, %ymm2, %ymm0
; AVX2-FP-NEXT:    vmovd %eax, %xmm2
; AVX2-FP-NEXT:    vpbroadcastd %xmm2, %ymm2
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm2[4],ymm0[5,6,7]
...
; AVX2-FCP-NEXT:    vmovq %rax, %xmm1
; AVX2-FCP-NEXT:    vextracti128 $1, %ymm0, %xmm2
; AVX2-FCP-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[3,3,3,3]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm1 = xmm2[0],xmm1[1],xmm2[2,3]
; AVX2-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,4,2,6,0,1,5,3]
; AVX2-FCP-NEXT:    vpermd %ymm0, %ymm2, %ymm0
; AVX2-FCP-NEXT:    vmovd %eax, %xmm2
; AVX2-FCP-NEXT:    vpbroadcastd %xmm2, %ymm2
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm2[4],ymm0[5,6,7]
...
; AVX512-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,2,4,6,16,1,3,5,7,17,0,0,0,0,0,0]
...
; AVX512-FCP-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,2,4,6,16,1,3,5,7,17,0,0,0,0,0,0]
; AVX512-FCP-NEXT:    vpermi2d %zmm1, %zmm0, %zmm2
; AVX512-FCP-NEXT:    vextracti32x4 $2, %zmm2, %xmm0
...
; AVX512DQ-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,2,4,6,16,1,3,5,7,17,0,0,0,0,0,0]
; AVX512DQ-NEXT:    vpermi2d %zmm1, %zmm0, %zmm2
; AVX512DQ-NEXT:    vextracti32x4 $2, %zmm2, %xmm0
...
; AVX512DQ-FCP-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,2,4,6,16,1,3,5,7,17,0,0,0,0,0,0]
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm1, %zmm0, %zmm2
; AVX512DQ-FCP-NEXT:    vextracti32x4 $2, %zmm2, %xmm0
...
; AVX512BW-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,2,4,6,16,1,3,5,7,17,0,0,0,0,0,0]
...
; AVX512BW-FCP-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,2,4,6,16,1,3,5,7,17,0,0,0,0,0,0]
...
; AVX512DQ-BW-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,2,4,6,16,1,3,5,7,17,0,0,0,0,0,0]
...
; AVX512DQ-BW-FCP-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,2,4,6,16,1,3,5,7,17,0,0,0,0,0,0]
...
; AVX2-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[3],xmm2[1,2,3]
...
; AVX2-FP-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[3],xmm2[1,2,3]
...
; AVX-NEXT:    vbroadcastss 4(%rdx), %xmm9
; AVX-NEXT:    vinsertf128 $1, %xmm9, %ymm8, %ymm8
; AVX-NEXT:    vmovaps 16(%rdx), %xmm9
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm8[2,3],ymm2[4,5,6],ymm8[7]
; AVX-NEXT:    vmovaps 16(%rcx), %xmm8
; AVX-NEXT:    vinsertf128 $1, (%r8), %ymm5, %ymm5
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm5[0],ymm2[1,2,3],ymm5[4],ymm2[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} xmm10 = xmm9[3,3],xmm8[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm8 = xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX-NEXT:    vmovaps (%rdx), %ymm5
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm8, %ymm8
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm1[3,3],ymm0[3,3],ymm1[7,7],ymm0[7,7]
...
; AVX-NEXT:    vbroadcastss 4(%rcx), %xmm7
...
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm6[1],ymm3[2,3,4,5],ymm6[6],ymm3[7]
; AVX-NEXT:    vinsertps {{.*#+}} xmm6 = zero,zero,xmm4[2],xmm7[2]
; AVX-NEXT:    vshufps {{.*#+}} xmm4 = xmm4[1,1],xmm7[1,1]
; AVX-NEXT:    vmovaps (%r8), %ymm7
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm4, %ymm4
; AVX-NEXT:    vshufps {{.*#+}} ymm6 = ymm9[1,1],ymm5[1,1],ymm9[5,5],ymm5[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm6[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1,2],ymm6[3,4],ymm4[5,6,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm7[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm6[2],ymm8[3,4,5,6],ymm6[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm6[0],ymm4[1,2,3,4],ymm6[5],ymm4[6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4],ymm1[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm9[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vshufpd {{.*#+}} ymm5 = ymm5[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm5[0,1],ymm1[2],ymm5[3,4,5,6],ymm1[7]
...
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm7 = ymm3[2],ymm1[2],ymm3[3],ymm1[3],ymm3[6],ymm1[6],ymm3[7],ymm1[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[3,3,3,3]
; AVX2-NEXT:    vshufps {{.*#+}} ymm8 = ymm4[0,2,3,3,4,6,7,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm9 = ymm2[2,3,2,3,6,7,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0],ymm8[1,2],ymm9[3,4],ymm8[5,6],ymm9[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm8[0,1,2],ymm7[3,4],ymm8[5,6,7]
; AVX2-NEXT:    vbroadcastsd 24(%r8), %ymm8
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm8[2],ymm7[3,4,5,6],ymm8[7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm8 = ymm4[1,1,1,1,5,5,5,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0],ymm2[1],ymm8[2,3,4],ymm2[5],ymm8[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,2,2,2]
; AVX2-NEXT:    vshufps {{.*#+}} ymm9 = ymm3[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0],ymm1[1,2],ymm9[3,4],ymm1[5,6],ymm9[7]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0],ymm8[1,2,3,4],ymm9[5],ymm8[6,7]
...
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm7 = ymm3[2],ymm1[2],ymm3[3],ymm1[3],ymm3[6],ymm1[6],ymm3[7],ymm1[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[3,3,3,3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm8 = ymm4[0,2,3,3,4,6,7,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm9 = ymm2[2,3,2,3,6,7,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0],ymm8[1,2],ymm9[3,4],ymm8[5,6],ymm9[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm8[0,1,2],ymm7[3,4],ymm8[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 24(%r8), %ymm8
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm8[2],ymm7[3,4,5,6],ymm8[7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm8 = ymm4[1,1,1,1,5,5,5,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0],ymm2[1],ymm8[2,3,4],ymm2[5],ymm8[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,2,2,2]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm9 = ymm3[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0],ymm1[1,2],ymm9[3,4],ymm1[5,6],ymm9[7]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0],ymm8[1,2,3,4],ymm9[5],ymm8[6,7]
...
; AVX2-FCP-NEXT:    vmovaps {{.*#+}} ymm7 = [u,1,u,u,u,2,3,u]
...
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm7 = ymm3[2],ymm1[2],ymm3[3],ymm1[3],ymm3[6],ymm1[6],ymm3[7],ymm1[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[3,3,3,3]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm8 = ymm4[0,2,3,3,4,6,7,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm9 = ymm2[2,3,2,3,6,7,6,7]
...
; AVX2-FCP-NEXT:    vbroadcastsd 24(%r8), %ymm8
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm8[2],ymm7[3,4,5,6],ymm8[7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm8 = ymm4[1,1,1,1,5,5,5,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0],ymm2[1],ymm8[2,3,4],ymm2[5],ymm8[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,2,2,2]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm9 = ymm3[1,1,2,2,5,5,6,6]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0],ymm8[1,2,3,4],ymm9[5],ymm8[6,7]
...
; AVX2-FCP-NEXT:    vmovaps %ymm7, 128(%r9)
...
; AVX512-NEXT:    vpermi2d %zmm1, %zmm0, %zmm4
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm0 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
...
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4,5,6],ymm4[7]
...
; AVX512DQ-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4,5,6],ymm4[7]
...
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4,5,6],ymm4[7]
...
; AVX512BW-NEXT:    vpbroadcastq 24(%r8), %ymm4
; AVX512BW-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4,5,6],ymm4[7]
...
; AVX512BW-FCP-NEXT:    vpbroadcastq 24(%r8), %ymm4
; AVX512BW-FCP-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4,5,6],ymm4[7]
...
; AVX512DQ-BW-NEXT:    vpbroadcastq 24(%r8), %ymm4
; AVX512DQ-BW-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4,5,6],ymm4[7]
...
; AVX512DQ-BW-FCP-NEXT:    vpbroadcastq 24(%r8), %ymm4
; AVX512DQ-BW-FCP-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4,5,6],ymm4[7]
...
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm1, %zmm0, %zmm4
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm0 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa %ymm3, 128(%r9)
; AVX512DQ-BW-FCP-NEXT:    vzeroupper
; AVX512DQ-BW-FCP-NEXT:    retq
...
; AVX-NEXT:    vshufps {{.*#+}} xmm4 = xmm12[1,1],xmm6[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm5 = xmm12[0],xmm6[0],xmm12[1],xmm6[1]
...
; AVX-NEXT:    vbroadcastss 4(%rdx), %xmm15
...
; AVX-NEXT:    vshufps {{.*#+}} xmm5 = xmm9[1,1],xmm8[1,1]
; AVX-NEXT:    vmovlhps {{.*#+}} xmm7 = xmm11[0],xmm10[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,2,0]
; AVX-NEXT:    vbroadcastss 36(%rdx), %xmm15
; AVX-NEXT:    vinsertf128 $1, %xmm15, %ymm7, %ymm7
; AVX-NEXT:    vunpcklps {{.*#+}} xmm15 = xmm9[0],xmm8[0],xmm9[1],xmm8[1]
...
; AVX-NEXT:    vinsertps {{.*#+}} xmm6 = zero,zero,xmm12[2],xmm6[2]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm6, %ymm6
; AVX-NEXT:    vmovaps 16(%rdx), %xmm12
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm13[0,1],ymm6[2,3],ymm13[4,5],ymm6[6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm13 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm6[0],ymm13[1],ymm6[2,3,4,5],ymm13[6],ymm6[7]
; AVX-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vinsertps {{.*#+}} xmm13 = zero,zero,xmm14[2],xmm15[2]
; AVX-NEXT:    vshufps {{.*#+}} xmm14 = xmm14[1,1],xmm15[1,1]
; AVX-NEXT:    vmovaps 16(%rcx), %xmm15
; AVX-NEXT:    vinsertf128 $1, %xmm13, %ymm14, %ymm13
; AVX-NEXT:    vshufps {{.*#+}} ymm14 = ymm7[1,1],ymm0[1,1],ymm7[5,5],ymm0[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm14 = ymm14[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1,2],ymm14[3,4],ymm13[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm12[3,3],xmm15[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm12 = xmm12[2],xmm15[2],xmm12[3],xmm15[3]
; AVX-NEXT:    vmovaps (%r8), %ymm14
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm12, %ymm0
; AVX-NEXT:    vshufps {{.*#+}} ymm12 = ymm3[3,3],ymm2[3,3],ymm3[7,7],ymm2[7,7]
; AVX-NEXT:    vmovaps %ymm2, %ymm6
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm12 = ymm12[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm12[3,4],ymm0[5,6,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm14[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm12 = ymm15[0],ymm13[1,2,3,4],ymm15[5],ymm13[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm13 = ymm0[0,1],ymm15[2],ymm0[3,4,5,6],ymm15[7]
; AVX-NEXT:    vmovaps 32(%rcx), %ymm15
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm10[2],xmm11[2],xmm10[3],xmm11[3]
; AVX-NEXT:    vbroadcastss 36(%rcx), %xmm10
...
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm0[0],ymm8[1],ymm0[2,3,4,5],ymm8[6],ymm0[7]
; AVX-NEXT:    vmovaps 48(%rsi), %xmm0
; AVX-NEXT:    vmovaps 48(%rdi), %xmm9
; AVX-NEXT:    vinsertps {{.*#+}} xmm10 = zero,zero,xmm9[2],xmm0[2]
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm9[1,1],xmm0[1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm0, %ymm0
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm15[1,1],ymm1[1,1],ymm15[5,5],ymm1[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm9[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm0[0,1,2],ymm9[3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovaps 48(%rcx), %xmm9
; AVX-NEXT:    vmovaps 48(%rdx), %xmm10
...
; AVX-NEXT:    vshufps {{.*#+}} ymm4 = ymm11[3,3],ymm10[3,3],ymm11[7,7],ymm10[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm4[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm9[0,1,2],ymm4[3,4],ymm9[5,6,7]
; AVX-NEXT:    vmovaps 32(%r8), %ymm9
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm9[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm0[0],ymm2[1,2,3,4],ymm0[5],ymm2[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm4[0,1],ymm0[2],ymm4[3,4,5,6],ymm0[7]
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm6[4],ymm3[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm4 = ymm7[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vpermilpd $1, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Folded Reload
; AVX-NEXT:    # ymm2 = mem[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm4[2],ymm2[3,4,5,6],ymm4[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0],ymm2[1,2,3],ymm3[4,5],ymm2[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2],ymm14[3],ymm2[4,5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm11[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm10[4],ymm3[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm4 = ymm15[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vshufpd {{.*#+}} ymm7 = ymm1[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm7[0,1],ymm4[2],ymm7[3,4,5,6],ymm4[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm4[1,2,3],ymm3[4,5],ymm4[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2],ymm9[3],ymm3[4,5,6,7]
; AVX-NEXT:    vmovaps %ymm3, 224(%r9)
; AVX-NEXT:    vmovaps %ymm2, 64(%r9)
; AVX-NEXT:    vmovaps %ymm0, 288(%r9)
; AVX-NEXT:    vmovaps %ymm5, 256(%r9)
; AVX-NEXT:    vmovaps %ymm8, 192(%r9)
; AVX-NEXT:    vmovaps %ymm13, 128(%r9)
; AVX-NEXT:    vmovaps %ymm12, 96(%r9)
...
; AVX2-NEXT:    vmovaps (%rcx), %xmm8
; AVX2-NEXT:    vmovaps 32(%rcx), %xmm11
; AVX2-NEXT:    vmovaps (%rdx), %xmm9
; AVX2-NEXT:    vmovaps 32(%rdx), %xmm13
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm7 = xmm9[0],xmm8[0],xmm9[1],xmm8[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[0,0,2,1]
; AVX2-NEXT:    vmovaps (%rsi), %xmm10
; AVX2-NEXT:    vmovaps (%rdi), %xmm12
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm14 = xmm12[0],xmm10[0],xmm12[1],xmm10[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm14 = xmm14[0,1,3,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm15 = ymm14[0,1,1,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm15[0,1],ymm7[2,3],ymm15[4,5,6],ymm7[7]
; AVX2-NEXT:    vmovaps 32(%rsi), %xmm15
; AVX2-NEXT:    vinsertf128 $1, (%r8), %ymm14, %ymm14
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm14[0],ymm7[1,2,3],ymm14[4],ymm7[5,6,7]
...
; AVX2-NEXT:    vshufps {{.*#+}} xmm8 = xmm8[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} xmm8 = xmm8[0,1],xmm9[2],xmm8[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm10[2,3],ymm8[4,5],ymm10[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm9 = ymm0[0,1,2,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm8[0],ymm9[1],ymm8[2,3,4,5],ymm9[6],ymm8[7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm9 = xmm13[0],xmm11[0],xmm13[1],xmm11[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm9 = xmm9[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[0,0,2,1]
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm10 = xmm14[0],xmm15[0],xmm14[1],xmm15[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm10 = xmm10[0,1,3,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm12 = ymm10[0,1,1,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm9 = ymm12[0,1],ymm9[2,3],ymm12[4,5,6],ymm9[7]
; AVX2-NEXT:    vmovaps (%rcx), %ymm12
; AVX2-NEXT:    vinsertf128 $1, 32(%r8), %ymm10, %ymm10
; AVX2-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0],ymm9[1,2,3],ymm10[4],ymm9[5,6,7]
; AVX2-NEXT:    vmovaps 32(%r8), %ymm10
; AVX2-NEXT:    vunpckhps {{.*#+}} xmm14 = xmm14[2],xmm15[2],xmm14[3],xmm15[3]
; AVX2-NEXT:    vshufps {{.*#+}} xmm14 = xmm14[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,0,2,1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm11 = xmm11[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} xmm11 = xmm11[0,1],xmm13[2],xmm11[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1],ymm14[2,3],ymm11[4,5],ymm14[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm10[0,1,2,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm13[1],ymm11[2,3,4,5],ymm13[6],ymm11[7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm13 = ymm12[1,1,1,1,5,5,5,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0],ymm4[1],ymm13[2,3,4],ymm4[5],ymm13[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,2,2,2]
; AVX2-NEXT:    vshufps {{.*#+}} ymm14 = ymm6[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0],ymm3[1,2],ymm14[3,4],ymm3[5,6],ymm14[7]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm14[0],ymm13[1,2,3,4],ymm14[5],ymm13[6,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm14 = ymm12[0,2,3,3,4,6,7,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm15 = ymm4[2,3,2,3,6,7,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0],ymm14[1,2],ymm15[3,4],ymm14[5,6],ymm15[7]
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm6[2],ymm3[2],ymm6[3],ymm3[3],ymm6[6],ymm3[6],ymm6[7],ymm3[7]
...
; AVX2-NEXT:    vshufps {{.*#+}} ymm15 = ymm2[1,1,1,1,5,5,5,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm1[1],ymm15[2,3,4],ymm1[5],ymm15[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[2,2,2,2]
; AVX2-NEXT:    vmovaps 32(%rsi), %ymm0
; AVX2-NEXT:    vshufps {{.*#+}} ymm7 = ymm0[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm5[1,2],ymm7[3,4],ymm5[5,6],ymm7[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2],ymm15[3,4],ymm7[5,6,7]
; AVX2-NEXT:    vbroadcastsd 48(%r8), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm15[0],ymm7[1,2,3,4],ymm15[5],ymm7[6,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm15 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm8 = ymm1[2,3,2,3,6,7,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0],ymm15[1,2],ymm8[3,4],ymm15[5,6],ymm8[7]
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm0[2],ymm5[2],ymm0[3],ymm5[3],ymm0[6],ymm5[6],ymm0[7],ymm5[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[3,3,3,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1,2],ymm15[3,4],ymm8[5,6,7]
; AVX2-NEXT:    vbroadcastsd 56(%r8), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm15[2],ymm8[3,4,5,6],ymm15[7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm6 = ymm6[3,0,2,3,7,4,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm6[0,1,2,3],ymm3[4],ymm6[5,6,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm6 = ymm12[0,1,3,0,4,5,7,4]
; AVX2-NEXT:    vshufps {{.*#+}} ymm4 = ymm4[2,3,0,1,6,7,4,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm6[2],ymm4[3,4,5,6],ymm6[7]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm5[4],ymm0[5,6,7]
...
; AVX2-NEXT:    vmovaps %ymm8, 288(%r9)
; AVX2-NEXT:    vmovaps %ymm7, 256(%r9)
; AVX2-NEXT:    vmovaps %ymm14, 128(%r9)
; AVX2-NEXT:    vmovaps %ymm13, 96(%r9)
...
; AVX2-FP-NEXT:    vmovaps (%rcx), %xmm8
; AVX2-FP-NEXT:    vmovaps 32(%rcx), %xmm11
; AVX2-FP-NEXT:    vmovaps (%rdx), %xmm9
; AVX2-FP-NEXT:    vmovaps 32(%rdx), %xmm13
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm7 = xmm9[0],xmm8[0],xmm9[1],xmm8[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[0,0,2,1]
; AVX2-FP-NEXT:    vmovaps (%rsi), %xmm10
; AVX2-FP-NEXT:    vmovaps (%rdi), %xmm12
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm14 = xmm12[0],xmm10[0],xmm12[1],xmm10[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm14 = xmm14[0,1,3,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm14[0,1,1,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm15[0,1],ymm7[2,3],ymm15[4,5,6],ymm7[7]
; AVX2-FP-NEXT:    vmovaps 32(%rsi), %xmm15
; AVX2-FP-NEXT:    vinsertf128 $1, (%r8), %ymm14, %ymm14
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm14[0],ymm7[1,2,3],ymm14[4],ymm7[5,6,7]
...
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm8 = xmm8[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} xmm8 = xmm8[0,1],xmm9[2],xmm8[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm10[2,3],ymm8[4,5],ymm10[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm0[0,1,2,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm8[0],ymm9[1],ymm8[2,3,4,5],ymm9[6],ymm8[7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm9 = xmm13[0],xmm11[0],xmm13[1],xmm11[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm9 = xmm9[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[0,0,2,1]
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm10 = xmm14[0],xmm15[0],xmm14[1],xmm15[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm10 = xmm10[0,1,3,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm10[0,1,1,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm12[0,1],ymm9[2,3],ymm12[4,5,6],ymm9[7]
; AVX2-FP-NEXT:    vmovaps (%rcx), %ymm12
; AVX2-FP-NEXT:    vinsertf128 $1, 32(%r8), %ymm10, %ymm10
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0],ymm9[1,2,3],ymm10[4],ymm9[5,6,7]
; AVX2-FP-NEXT:    vmovaps 32(%r8), %ymm10
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} xmm14 = xmm14[2],xmm15[2],xmm14[3],xmm15[3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm14 = xmm14[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,0,2,1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm11 = xmm11[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} xmm11 = xmm11[0,1],xmm13[2],xmm11[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1],ymm14[2,3],ymm11[4,5],ymm14[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm10[0,1,2,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm13[1],ymm11[2,3,4,5],ymm13[6],ymm11[7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm13 = ymm12[1,1,1,1,5,5,5,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0],ymm4[1],ymm13[2,3,4],ymm4[5],ymm13[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,2,2,2]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm14 = ymm6[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0],ymm3[1,2],ymm14[3,4],ymm3[5,6],ymm14[7]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm14[0],ymm13[1,2,3,4],ymm14[5],ymm13[6,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm14 = ymm12[0,2,3,3,4,6,7,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm15 = ymm4[2,3,2,3,6,7,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0],ymm14[1,2],ymm15[3,4],ymm14[5,6],ymm15[7]
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm6[2],ymm3[2],ymm6[3],ymm3[3],ymm6[6],ymm3[6],ymm6[7],ymm3[7]
...
; AVX2-FP-NEXT:    vbroadcastsd 24(%r8), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1],ymm15[2],ymm14[3,4,5,6],ymm15[7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm15 = ymm2[1,1,1,1,5,5,5,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm1[1],ymm15[2,3,4],ymm1[5],ymm15[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[2,2,2,2]
; AVX2-FP-NEXT:    vmovaps 32(%rsi), %ymm0
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm7 = ymm0[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm5[1,2],ymm7[3,4],ymm5[5,6],ymm7[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2],ymm15[3,4],ymm7[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 48(%r8), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm15[0],ymm7[1,2,3,4],ymm15[5],ymm7[6,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm15 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm8 = ymm1[2,3,2,3,6,7,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0],ymm15[1,2],ymm8[3,4],ymm15[5,6],ymm8[7]
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm0[2],ymm5[2],ymm0[3],ymm5[3],ymm0[6],ymm5[6],ymm0[7],ymm5[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[3,3,3,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1,2],ymm15[3,4],ymm8[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 56(%r8), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm15[2],ymm8[3,4,5,6],ymm15[7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm6 = ymm6[3,0,2,3,7,4,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm6[0,1,2,3],ymm3[4],ymm6[5,6,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm6 = ymm12[0,1,3,0,4,5,7,4]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm4 = ymm4[2,3,0,1,6,7,4,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm6[2],ymm4[3,4,5,6],ymm6[7]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm5[4],ymm0[5,6,7]
...
; AVX2-FP-NEXT:    vmovaps %ymm8, 288(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm7, 256(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm14, 128(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm13, 96(%r9)
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,2,2,2]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm13 = ymm3[1,1,2,2,5,5,6,6]
...
; AVX2-FCP-NEXT:    vbroadcastsd 16(%r8), %ymm13
...
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm13 = ymm3[2],ymm1[2],ymm3[3],ymm1[3],ymm3[6],ymm1[6],ymm3[7],ymm1[7]
...
; AVX2-FCP-NEXT:    vbroadcastsd 24(%r8), %ymm13
...
; AVX2-FCP-NEXT:    vmovaps 32(%rcx), %ymm14
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm12[1,2],ymm15[3,4],ymm12[5,6],ymm15[7]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm15 = ymm14[0,2,3,3,4,6,7,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm6 = ymm10[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm15[1,2],ymm6[3,4],ymm15[5,6],ymm6[7]
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm5[2],ymm12[2],ymm5[3],ymm12[3],ymm5[6],ymm12[6],ymm5[7],ymm12[7]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[3,0,2,3,7,4,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0,1,2,3],ymm1[4],ymm3[5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm3 = ymm11[0,1,3,0,4,5,7,4]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[2,3,0,1,6,7,4,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm7[0,1],ymm3[2],ymm7[3,4,5,6],ymm3[7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm3[1,2,3],ymm1[4,5],ymm3[6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2],ymm2[3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm2 = ymm5[3,0,2,3,7,4,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm12[4],ymm2[5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm3 = ymm14[0,1,3,0,4,5,7,4]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm5 = ymm10[2,3,0,1,6,7,4,5]
...
; AVX2-FCP-NEXT:    vmovaps %ymm6, 288(%r9)
...
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm6[1,1],xmm5[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm6[0],xmm5[0],xmm6[1],xmm5[1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vmovaps (%rdx), %xmm10
; AVX-NEXT:    vmovaps 32(%rdx), %xmm11
; AVX-NEXT:    vmovaps (%rcx), %xmm14
; AVX-NEXT:    vmovaps 32(%rcx), %xmm4
; AVX-NEXT:    vmovlhps {{.*#+}} xmm8 = xmm14[0],xmm10[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm8[0,1,2,0]
; AVX-NEXT:    vbroadcastss 4(%rdx), %xmm9
; AVX-NEXT:    vinsertf128 $1, %xmm9, %ymm8, %ymm8
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm8[2,3],ymm0[4,5,6],ymm8[7]
; AVX-NEXT:    vinsertf128 $1, (%r8), %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2,3],ymm1[4],ymm0[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm7[1,1],xmm3[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm7[0],xmm3[0],xmm7[1],xmm3[1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vmovlhps {{.*#+}} xmm8 = xmm4[0],xmm11[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm8[0,1,2,0]
; AVX-NEXT:    vbroadcastss 36(%rdx), %xmm9
; AVX-NEXT:    vinsertf128 $1, %xmm9, %ymm8, %ymm8
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm8[2,3],ymm0[4,5,6],ymm8[7]
...
; AVX-NEXT:    vmovlhps {{.*#+}} xmm8 = xmm9[0],xmm0[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm8[0,1,2,0]
; AVX-NEXT:    vbroadcastss 68(%rdx), %xmm12
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm8, %ymm8
; AVX-NEXT:    vshufps {{.*#+}} xmm12 = xmm1[1,1],xmm2[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm13 = xmm1[0],xmm2[0],xmm1[1],xmm2[1]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm13, %ymm12
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm12[0,1],ymm8[2,3],ymm12[4,5,6],ymm8[7]
; AVX-NEXT:    vinsertf128 $1, 64(%r8), %ymm13, %ymm12
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0],ymm8[1,2,3],ymm12[4],ymm8[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vshufps {{.*#+}} xmm15 = xmm12[1,1],xmm13[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm12[0],xmm13[0],xmm12[1],xmm13[1]
; AVX-NEXT:    vinsertf128 $1, %xmm15, %ymm0, %ymm15
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm15[0,1],ymm8[2,3],ymm15[4,5,6],ymm8[7]
; AVX-NEXT:    vinsertf128 $1, 96(%r8), %ymm0, %ymm0
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm8[1,2,3],ymm0[4],ymm8[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm10[2],xmm14[2],xmm10[3],xmm14[3]
...
; AVX-NEXT:    vinsertps {{.*#+}} xmm6 = zero,zero,xmm5[2],xmm0[2]
...
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm5[1,1],ymm15[1,1],ymm5[5,5],ymm15[5,5]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm5[3,3],xmm6[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm5 = xmm5[2],xmm6[2],xmm5[3],xmm6[3]
...
; AVX-NEXT:    vshufps {{.*#+}} ymm6 = ymm8[3,3],ymm6[3,3],ymm8[7,7],ymm6[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm6[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2],ymm6[3,4],ymm5[5,6,7]
; AVX-NEXT:    vmovaps (%r8), %ymm6
; AVX-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm6[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm6[0],ymm0[1,2,3,4],ymm6[5],ymm0[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm5[0,1],ymm6[2],ymm5[3,4,5,6],ymm6[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm11[2],xmm4[2],xmm11[3],xmm4[3]
; AVX-NEXT:    vbroadcastss 36(%rcx), %xmm4
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm4, %ymm0
; AVX-NEXT:    vinsertps {{.*#+}} xmm3 = zero,zero,xmm7[2],xmm3[2]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm3[3,4],ymm0[5,6,7]
...
; AVX-NEXT:    vinsertps {{.*#+}} xmm2 = zero,zero,xmm1[2],xmm2[2]
...
; AVX512-NEXT:    vmovdqa64 (%rsi), %zmm13
; AVX512-NEXT:    vmovdqa64 64(%rsi), %zmm3
; AVX512-NEXT:    vmovdqa64 (%rdx), %zmm14
; AVX512-NEXT:    vmovdqa64 64(%rdx), %zmm4
; AVX512-NEXT:    vmovdqa64 (%rcx), %zmm16
; AVX512-NEXT:    vmovdqa64 64(%rcx), %zmm7
; AVX512-NEXT:    vmovdqa64 (%r8), %zmm15
; AVX512-NEXT:    vmovdqa64 64(%r8), %zmm6
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm14, %zmm8
; AVX512-NEXT:    vpermt2d %zmm16, %zmm12, %zmm8
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm5 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512-NEXT:    # zmm5 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm0, %zmm2
; AVX512-NEXT:    vpermt2d %zmm13, %zmm5, %zmm2
; AVX512-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vmovdqa32 %zmm8, %zmm2 {%k1}
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512-NEXT:    vpermt2d %zmm15, %zmm17, %zmm2
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512-NEXT:    vpermt2d %zmm16, %zmm18, %zmm10
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm9 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512-NEXT:    # zmm9 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm13, %zmm8
; AVX512-NEXT:    vpermt2d %zmm0, %zmm9, %zmm8
; AVX512-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512-NEXT:    kmovw %eax, %k3
; AVX512-NEXT:    vmovdqa32 %zmm10, %zmm8 {%k3}
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm19 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512-NEXT:    vpermt2d %zmm15, %zmm19, %zmm8
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512-NEXT:    # zmm20 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm0, %zmm21
; AVX512-NEXT:    vpermt2d %zmm13, %zmm20, %zmm21
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512-NEXT:    vpermt2d %zmm16, %zmm11, %zmm10
; AVX512-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512-NEXT:    kmovw %eax, %k2
; AVX512-NEXT:    vmovdqa32 %zmm21, %zmm10 {%k2}
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm21 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512-NEXT:    vpermt2d %zmm15, %zmm21, %zmm10
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm22 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512-NEXT:    # zmm22 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512-NEXT:    vpermt2d %zmm13, %zmm22, %zmm23
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm24 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512-NEXT:    # zmm24 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm16, %zmm25
; AVX512-NEXT:    vpermt2d %zmm14, %zmm24, %zmm25
; AVX512-NEXT:    vmovdqa32 %zmm23, %zmm25 {%k1}
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm23 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512-NEXT:    vpermt2d %zmm15, %zmm23, %zmm25
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm26 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512-NEXT:    # zmm26 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vpermt2d %zmm16, %zmm26, %zmm14
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vpermt2d %zmm13, %zmm16, %zmm0
; AVX512-NEXT:    vmovdqa32 %zmm14, %zmm0 {%k2}
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512-NEXT:    vpermt2d %zmm15, %zmm13, %zmm0
; AVX512-NEXT:    vpermi2d %zmm7, %zmm4, %zmm12
; AVX512-NEXT:    vpermi2d %zmm3, %zmm1, %zmm5
; AVX512-NEXT:    vmovdqa32 %zmm12, %zmm5 {%k1}
; AVX512-NEXT:    vpermt2d %zmm6, %zmm17, %zmm5
; AVX512-NEXT:    vpermi2d %zmm7, %zmm4, %zmm18
; AVX512-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512-NEXT:    vmovdqa32 %zmm18, %zmm9 {%k3}
; AVX512-NEXT:    vpermt2d %zmm6, %zmm19, %zmm9
; AVX512-NEXT:    vpermi2d %zmm3, %zmm1, %zmm20
; AVX512-NEXT:    vpermi2d %zmm7, %zmm4, %zmm11
; AVX512-NEXT:    vmovdqa32 %zmm20, %zmm11 {%k2}
; AVX512-NEXT:    vpermt2d %zmm6, %zmm21, %zmm11
; AVX512-NEXT:    vpermi2d %zmm3, %zmm1, %zmm22
; AVX512-NEXT:    vpermi2d %zmm4, %zmm7, %zmm24
; AVX512-NEXT:    vmovdqa32 %zmm22, %zmm24 {%k1}
; AVX512-NEXT:    vpermt2d %zmm6, %zmm23, %zmm24
; AVX512-NEXT:    vpermt2d %zmm7, %zmm26, %zmm4
; AVX512-NEXT:    vpermt2d %zmm3, %zmm16, %zmm1
; AVX512-NEXT:    vmovdqa32 %zmm4, %zmm1 {%k2}
; AVX512-NEXT:    vpermt2d %zmm6, %zmm13, %zmm1
...
; AVX512-NEXT:    vmovdqa64 %zmm0, 256(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm25, 192(%r9)
...
; AVX512-FCP-NEXT:    vmovdqa64 (%rsi), %zmm13
; AVX512-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm3
; AVX512-FCP-NEXT:    vmovdqa64 (%rdx), %zmm14
; AVX512-FCP-NEXT:    vmovdqa64 64(%rdx), %zmm4
; AVX512-FCP-NEXT:    vmovdqa64 (%rcx), %zmm16
; AVX512-FCP-NEXT:    vmovdqa64 64(%rcx), %zmm7
; AVX512-FCP-NEXT:    vmovdqa64 (%r8), %zmm15
; AVX512-FCP-NEXT:    vmovdqa64 64(%r8), %zmm6
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512-FCP-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm14, %zmm8
; AVX512-FCP-NEXT:    vpermt2d %zmm16, %zmm12, %zmm8
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm5 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512-FCP-NEXT:    # zmm5 = mem[0,1,2,3,0,1,2,3]
...
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm15, %zmm17, %zmm2
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512-FCP-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512-FCP-NEXT:    vpermt2d %zmm16, %zmm18, %zmm10
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm9 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512-FCP-NEXT:    # zmm9 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm13, %zmm8
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm9, %zmm8
; AVX512-FCP-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512-FCP-NEXT:    kmovw %eax, %k3
; AVX512-FCP-NEXT:    vmovdqa32 %zmm10, %zmm8 {%k3}
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm19 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm15, %zmm19, %zmm8
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512-FCP-NEXT:    # zmm20 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm0, %zmm21
; AVX512-FCP-NEXT:    vpermt2d %zmm13, %zmm20, %zmm21
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512-FCP-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512-FCP-NEXT:    vpermt2d %zmm16, %zmm11, %zmm10
; AVX512-FCP-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512-FCP-NEXT:    kmovw %eax, %k2
; AVX512-FCP-NEXT:    vmovdqa32 %zmm21, %zmm10 {%k2}
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm21 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm15, %zmm21, %zmm10
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm22 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512-FCP-NEXT:    # zmm22 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512-FCP-NEXT:    vpermt2d %zmm13, %zmm22, %zmm23
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm24 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512-FCP-NEXT:    # zmm24 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm16, %zmm25
; AVX512-FCP-NEXT:    vpermt2d %zmm14, %zmm24, %zmm25
; AVX512-FCP-NEXT:    vmovdqa32 %zmm23, %zmm25 {%k1}
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm23 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm15, %zmm23, %zmm25
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm26 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512-FCP-NEXT:    # zmm26 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vpermt2d %zmm16, %zmm26, %zmm14
...
; AVX512-FCP-NEXT:    vpermt2d %zmm13, %zmm16, %zmm0
; AVX512-FCP-NEXT:    vmovdqa32 %zmm14, %zmm0 {%k2}
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512-FCP-NEXT:    vpermt2d %zmm15, %zmm13, %zmm0
; AVX512-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm12
; AVX512-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm5
; AVX512-FCP-NEXT:    vmovdqa32 %zmm12, %zmm5 {%k1}
; AVX512-FCP-NEXT:    vpermt2d %zmm6, %zmm17, %zmm5
; AVX512-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm18
; AVX512-FCP-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512-FCP-NEXT:    vmovdqa32 %zmm18, %zmm9 {%k3}
; AVX512-FCP-NEXT:    vpermt2d %zmm6, %zmm19, %zmm9
; AVX512-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm20
; AVX512-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm11
; AVX512-FCP-NEXT:    vmovdqa32 %zmm20, %zmm11 {%k2}
; AVX512-FCP-NEXT:    vpermt2d %zmm6, %zmm21, %zmm11
; AVX512-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm22
; AVX512-FCP-NEXT:    vpermi2d %zmm4, %zmm7, %zmm24
; AVX512-FCP-NEXT:    vmovdqa32 %zmm22, %zmm24 {%k1}
; AVX512-FCP-NEXT:    vpermt2d %zmm6, %zmm23, %zmm24
; AVX512-FCP-NEXT:    vpermt2d %zmm7, %zmm26, %zmm4
; AVX512-FCP-NEXT:    vpermt2d %zmm3, %zmm16, %zmm1
; AVX512-FCP-NEXT:    vmovdqa32 %zmm4, %zmm1 {%k2}
; AVX512-FCP-NEXT:    vpermt2d %zmm6, %zmm13, %zmm1
; AVX512-FCP-NEXT:    vmovdqa64 %zmm1, 576(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm24, 512(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm11, 448(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm9, 384(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm5, 320(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm0, 256(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm25, 192(%r9)
...
; AVX512DQ-NEXT:    vmovdqa64 (%rsi), %zmm13
; AVX512DQ-NEXT:    vmovdqa64 64(%rsi), %zmm3
; AVX512DQ-NEXT:    vmovdqa64 (%rdx), %zmm14
; AVX512DQ-NEXT:    vmovdqa64 64(%rdx), %zmm4
; AVX512DQ-NEXT:    vmovdqa64 (%rcx), %zmm16
; AVX512DQ-NEXT:    vmovdqa64 64(%rcx), %zmm7
; AVX512DQ-NEXT:    vmovdqa64 (%r8), %zmm15
; AVX512DQ-NEXT:    vmovdqa64 64(%r8), %zmm6
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512DQ-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm14, %zmm8
; AVX512DQ-NEXT:    vpermt2d %zmm16, %zmm12, %zmm8
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm5 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512DQ-NEXT:    # zmm5 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, %zmm2
; AVX512DQ-NEXT:    vpermt2d %zmm13, %zmm5, %zmm2
; AVX512DQ-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512DQ-NEXT:    kmovw %eax, %k1
; AVX512DQ-NEXT:    vmovdqa32 %zmm8, %zmm2 {%k1}
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-NEXT:    vpermt2d %zmm15, %zmm17, %zmm2
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512DQ-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512DQ-NEXT:    vpermt2d %zmm16, %zmm18, %zmm10
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm9 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-NEXT:    # zmm9 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm13, %zmm8
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm9, %zmm8
; AVX512DQ-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512DQ-NEXT:    kmovw %eax, %k3
; AVX512DQ-NEXT:    vmovdqa32 %zmm10, %zmm8 {%k3}
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm19 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512DQ-NEXT:    vpermt2d %zmm15, %zmm19, %zmm8
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512DQ-NEXT:    # zmm20 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, %zmm21
; AVX512DQ-NEXT:    vpermt2d %zmm13, %zmm20, %zmm21
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512DQ-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512DQ-NEXT:    vpermt2d %zmm16, %zmm11, %zmm10
; AVX512DQ-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512DQ-NEXT:    kmovw %eax, %k2
; AVX512DQ-NEXT:    vmovdqa32 %zmm21, %zmm10 {%k2}
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm21 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-NEXT:    vpermt2d %zmm15, %zmm21, %zmm10
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm22 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-NEXT:    # zmm22 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512DQ-NEXT:    vpermt2d %zmm13, %zmm22, %zmm23
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm24 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512DQ-NEXT:    # zmm24 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm16, %zmm25
; AVX512DQ-NEXT:    vpermt2d %zmm14, %zmm24, %zmm25
; AVX512DQ-NEXT:    vmovdqa32 %zmm23, %zmm25 {%k1}
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm23 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-NEXT:    vpermt2d %zmm15, %zmm23, %zmm25
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm26 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-NEXT:    # zmm26 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vpermt2d %zmm16, %zmm26, %zmm14
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512DQ-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vpermt2d %zmm13, %zmm16, %zmm0
; AVX512DQ-NEXT:    vmovdqa32 %zmm14, %zmm0 {%k2}
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-NEXT:    vpermt2d %zmm15, %zmm13, %zmm0
; AVX512DQ-NEXT:    vpermi2d %zmm7, %zmm4, %zmm12
; AVX512DQ-NEXT:    vpermi2d %zmm3, %zmm1, %zmm5
; AVX512DQ-NEXT:    vmovdqa32 %zmm12, %zmm5 {%k1}
; AVX512DQ-NEXT:    vpermt2d %zmm6, %zmm17, %zmm5
; AVX512DQ-NEXT:    vpermi2d %zmm7, %zmm4, %zmm18
; AVX512DQ-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512DQ-NEXT:    vmovdqa32 %zmm18, %zmm9 {%k3}
; AVX512DQ-NEXT:    vpermt2d %zmm6, %zmm19, %zmm9
; AVX512DQ-NEXT:    vpermi2d %zmm3, %zmm1, %zmm20
; AVX512DQ-NEXT:    vpermi2d %zmm7, %zmm4, %zmm11
; AVX512DQ-NEXT:    vmovdqa32 %zmm20, %zmm11 {%k2}
; AVX512DQ-NEXT:    vpermt2d %zmm6, %zmm21, %zmm11
; AVX512DQ-NEXT:    vpermi2d %zmm3, %zmm1, %zmm22
; AVX512DQ-NEXT:    vpermi2d %zmm4, %zmm7, %zmm24
; AVX512DQ-NEXT:    vmovdqa32 %zmm22, %zmm24 {%k1}
; AVX512DQ-NEXT:    vpermt2d %zmm6, %zmm23, %zmm24
; AVX512DQ-NEXT:    vpermt2d %zmm7, %zmm26, %zmm4
; AVX512DQ-NEXT:    vpermt2d %zmm3, %zmm16, %zmm1
; AVX512DQ-NEXT:    vmovdqa32 %zmm4, %zmm1 {%k2}
; AVX512DQ-NEXT:    vpermt2d %zmm6, %zmm13, %zmm1
...
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, 256(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm25, 192(%r9)
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rsi), %zmm13
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rdx), %zmm14
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rdx), %zmm4
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rcx), %zmm16
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rcx), %zmm7
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%r8), %zmm15
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%r8), %zmm6
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512DQ-FCP-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm14, %zmm8
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm16, %zmm12, %zmm8
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm5 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512DQ-FCP-NEXT:    # zmm5 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm0, %zmm2
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm13, %zmm5, %zmm2
; AVX512DQ-FCP-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k1
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm8, %zmm2 {%k1}
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm15, %zmm17, %zmm2
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512DQ-FCP-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm16, %zmm18, %zmm10
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm9 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-FCP-NEXT:    # zmm9 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm13, %zmm8
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm9, %zmm8
; AVX512DQ-FCP-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k3
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm10, %zmm8 {%k3}
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm19 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm15, %zmm19, %zmm8
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
...
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512DQ-FCP-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm16, %zmm11, %zmm10
; AVX512DQ-FCP-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k2
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm21, %zmm10 {%k2}
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm21 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm15, %zmm21, %zmm10
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm22 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-FCP-NEXT:    # zmm22 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm13, %zmm22, %zmm23
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm24 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512DQ-FCP-NEXT:    # zmm24 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm16, %zmm25
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm14, %zmm24, %zmm25
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm23, %zmm25 {%k1}
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm23 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm15, %zmm23, %zmm25
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm26 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-FCP-NEXT:    # zmm26 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm16, %zmm26, %zmm14
...
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm14, %zmm0 {%k2}
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm15, %zmm13, %zmm0
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm12
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm5
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm12, %zmm5 {%k1}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm6, %zmm17, %zmm5
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm18
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm18, %zmm9 {%k3}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm6, %zmm19, %zmm9
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm20
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm11
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm20, %zmm11 {%k2}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm6, %zmm21, %zmm11
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm22
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm4, %zmm7, %zmm24
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm22, %zmm24 {%k1}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm6, %zmm23, %zmm24
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm7, %zmm26, %zmm4
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm3, %zmm16, %zmm1
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm4, %zmm1 {%k2}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm6, %zmm13, %zmm1
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm1, 576(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm24, 512(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm11, 448(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm9, 384(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm5, 320(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm0, 256(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm25, 192(%r9)
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm19 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm21 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm23 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
...
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm15, %zmm17, %zmm2
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512BW-FCP-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512BW-FCP-NEXT:    vpermt2d %zmm16, %zmm18, %zmm10
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm9 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512BW-FCP-NEXT:    # zmm9 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm13, %zmm8
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm9, %zmm8
; AVX512BW-FCP-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512BW-FCP-NEXT:    kmovd %eax, %k3
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm10, %zmm8 {%k3}
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm19 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm15, %zmm19, %zmm8
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
...
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512BW-FCP-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512BW-FCP-NEXT:    vpermt2d %zmm16, %zmm11, %zmm10
; AVX512BW-FCP-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512BW-FCP-NEXT:    kmovd %eax, %k2
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm21, %zmm10 {%k2}
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm21 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm15, %zmm21, %zmm10
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm22 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512BW-FCP-NEXT:    # zmm22 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512BW-FCP-NEXT:    vpermt2d %zmm13, %zmm22, %zmm23
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm24 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512BW-FCP-NEXT:    # zmm24 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm16, %zmm25
; AVX512BW-FCP-NEXT:    vpermt2d %zmm14, %zmm24, %zmm25
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm23, %zmm25 {%k1}
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm23 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm15, %zmm23, %zmm25
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm26 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512BW-FCP-NEXT:    # zmm26 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm16, %zmm26, %zmm14
...
; AVX512BW-FCP-NEXT:    vpermt2d %zmm13, %zmm16, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm14, %zmm0 {%k2}
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm15, %zmm13, %zmm0
; AVX512BW-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm12
; AVX512BW-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm5
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm12, %zmm5 {%k1}
; AVX512BW-FCP-NEXT:    vpermt2d %zmm6, %zmm17, %zmm5
; AVX512BW-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm18
; AVX512BW-FCP-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm18, %zmm9 {%k3}
; AVX512BW-FCP-NEXT:    vpermt2d %zmm6, %zmm19, %zmm9
; AVX512BW-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm20
; AVX512BW-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm11
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm20, %zmm11 {%k2}
; AVX512BW-FCP-NEXT:    vpermt2d %zmm6, %zmm21, %zmm11
; AVX512BW-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm22
; AVX512BW-FCP-NEXT:    vpermi2d %zmm4, %zmm7, %zmm24
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm22, %zmm24 {%k1}
; AVX512BW-FCP-NEXT:    vpermt2d %zmm6, %zmm23, %zmm24
; AVX512BW-FCP-NEXT:    vpermt2d %zmm7, %zmm26, %zmm4
; AVX512BW-FCP-NEXT:    vpermt2d %zmm3, %zmm16, %zmm1
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm4, %zmm1 {%k2}
; AVX512BW-FCP-NEXT:    vpermt2d %zmm6, %zmm13, %zmm1
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm1, 576(%r9)
...
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, 256(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm25, 192(%r9)
...
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rsi), %zmm13
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rsi), %zmm3
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rdx), %zmm14
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rdx), %zmm4
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rcx), %zmm16
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rcx), %zmm7
; AVX512DQ-BW-NEXT:    vmovdqa64 (%r8), %zmm15
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%r8), %zmm6
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512DQ-BW-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm14, %zmm8
; AVX512DQ-BW-NEXT:    vpermt2d %zmm16, %zmm12, %zmm8
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm5 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512DQ-BW-NEXT:    # zmm5 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, %zmm2
; AVX512DQ-BW-NEXT:    vpermt2d %zmm13, %zmm5, %zmm2
; AVX512DQ-BW-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512DQ-BW-NEXT:    kmovd %eax, %k1
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm8, %zmm2 {%k1}
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm15, %zmm17, %zmm2
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512DQ-BW-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512DQ-BW-NEXT:    vpermt2d %zmm16, %zmm18, %zmm10
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm9 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-BW-NEXT:    # zmm9 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm13, %zmm8
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm9, %zmm8
; AVX512DQ-BW-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512DQ-BW-NEXT:    kmovd %eax, %k3
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm10, %zmm8 {%k3}
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm19 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm15, %zmm19, %zmm8
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
...
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512DQ-BW-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512DQ-BW-NEXT:    vpermt2d %zmm16, %zmm11, %zmm10
; AVX512DQ-BW-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512DQ-BW-NEXT:    kmovd %eax, %k2
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm21, %zmm10 {%k2}
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm21 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm15, %zmm21, %zmm10
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm22 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-BW-NEXT:    # zmm22 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512DQ-BW-NEXT:    vpermt2d %zmm13, %zmm22, %zmm23
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm24 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512DQ-BW-NEXT:    # zmm24 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm16, %zmm25
; AVX512DQ-BW-NEXT:    vpermt2d %zmm14, %zmm24, %zmm25
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm23, %zmm25 {%k1}
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm23 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm15, %zmm23, %zmm25
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm26 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-BW-NEXT:    # zmm26 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm16, %zmm26, %zmm14
...
; AVX512DQ-BW-NEXT:    vpermt2d %zmm13, %zmm16, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm14, %zmm0 {%k2}
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm15, %zmm13, %zmm0
; AVX512DQ-BW-NEXT:    vpermi2d %zmm7, %zmm4, %zmm12
; AVX512DQ-BW-NEXT:    vpermi2d %zmm3, %zmm1, %zmm5
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm12, %zmm5 {%k1}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm6, %zmm17, %zmm5
; AVX512DQ-BW-NEXT:    vpermi2d %zmm7, %zmm4, %zmm18
; AVX512DQ-BW-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm18, %zmm9 {%k3}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm6, %zmm19, %zmm9
; AVX512DQ-BW-NEXT:    vpermi2d %zmm3, %zmm1, %zmm20
; AVX512DQ-BW-NEXT:    vpermi2d %zmm7, %zmm4, %zmm11
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm20, %zmm11 {%k2}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm6, %zmm21, %zmm11
; AVX512DQ-BW-NEXT:    vpermi2d %zmm3, %zmm1, %zmm22
; AVX512DQ-BW-NEXT:    vpermi2d %zmm4, %zmm7, %zmm24
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm22, %zmm24 {%k1}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm6, %zmm23, %zmm24
; AVX512DQ-BW-NEXT:    vpermt2d %zmm7, %zmm26, %zmm4
; AVX512DQ-BW-NEXT:    vpermt2d %zmm3, %zmm16, %zmm1
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm4, %zmm1 {%k2}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm6, %zmm13, %zmm1
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm1, 576(%r9)
...
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, 256(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm25, 192(%r9)
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%rsi), %zmm13
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%rcx), %zmm16
...
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512DQ-BW-FCP-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm14, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm16, %zmm12, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm5 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512DQ-BW-FCP-NEXT:    # zmm5 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm2
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm13, %zmm5, %zmm2
; AVX512DQ-BW-FCP-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512DQ-BW-FCP-NEXT:    kmovd %eax, %k1
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm8, %zmm2 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm17 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm15, %zmm17, %zmm2
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512DQ-BW-FCP-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm16, %zmm18, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm9 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-BW-FCP-NEXT:    # zmm9 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm13, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm9, %zmm8
; AVX512DQ-BW-FCP-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512DQ-BW-FCP-NEXT:    kmovd %eax, %k3
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm10, %zmm8 {%k3}
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm19 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm15, %zmm19, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
...
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512DQ-BW-FCP-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm14, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm16, %zmm11, %zmm10
; AVX512DQ-BW-FCP-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512DQ-BW-FCP-NEXT:    kmovd %eax, %k2
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm21, %zmm10 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm21 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm15, %zmm21, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm22 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-BW-FCP-NEXT:    # zmm22 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm13, %zmm22, %zmm23
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm24 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512DQ-BW-FCP-NEXT:    # zmm24 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm16, %zmm25
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm14, %zmm24, %zmm25
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm23, %zmm25 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm23 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm15, %zmm23, %zmm25
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm26 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-BW-FCP-NEXT:    # zmm26 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm16, %zmm26, %zmm14
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm13, %zmm16, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm14, %zmm0 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm15, %zmm13, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm12, %zmm5 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm6, %zmm17, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm18
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm1, %zmm3, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm18, %zmm9 {%k3}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm6, %zmm19, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm20
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm7, %zmm4, %zmm11
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm20, %zmm11 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm6, %zmm21, %zmm11
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm3, %zmm1, %zmm22
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm4, %zmm7, %zmm24
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm22, %zmm24 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm6, %zmm23, %zmm24
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm7, %zmm26, %zmm4
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm3, %zmm16, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm4, %zmm1 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm6, %zmm13, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm1, 576(%r9)
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, 256(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm25, 192(%r9)
...
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm5[1,1],xmm7[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm3 = xmm5[0],xmm7[0],xmm5[1],xmm7[1]
...
; AVX-NEXT:    vmovaps 32(%rcx), %xmm8
; AVX-NEXT:    vmovaps %xmm8, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovlhps {{.*#+}} xmm4 = xmm9[0],xmm0[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm4 = xmm4[0,1,2,0]
; AVX-NEXT:    vbroadcastss 4(%rdx), %xmm6
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm4, %ymm4
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm4[2,3],ymm1[4,5,6],ymm4[7]
; AVX-NEXT:    vinsertf128 $1, (%r8), %ymm3, %ymm3
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0],ymm1[1,2,3],ymm3[4],ymm1[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm15[1,1],xmm14[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm3 = xmm15[0],xmm14[0],xmm15[1],xmm14[1]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm3, %ymm1
; AVX-NEXT:    vmovlhps {{.*#+}} xmm4 = xmm8[0],xmm2[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm4 = xmm4[0,1,2,0]
; AVX-NEXT:    vbroadcastss 36(%rdx), %xmm6
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm4, %ymm4
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm4[2,3],ymm1[4,5,6],ymm4[7]
...
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm1, %ymm1
; AVX-NEXT:    vshufps {{.*#+}} xmm3 = xmm10[1,1],xmm13[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm4 = xmm10[0],xmm13[0],xmm10[1],xmm13[1]
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm4, %ymm3
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0,1],ymm1[2,3],ymm3[4,5,6],ymm1[7]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm4 = xmm8[1,1],xmm0[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm8[0],xmm0[0],xmm8[1],xmm0[1]
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm6, %ymm4
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0,1],ymm3[2,3],ymm4[4,5,6],ymm3[7]
; AVX-NEXT:    vinsertf128 $1, 96(%r8), %ymm6, %ymm4
...
; AVX-NEXT:    vshufps {{.*#+}} xmm6 = xmm3[1,1],xmm0[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm3[0],xmm0[0],xmm3[1],xmm0[1]
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm11, %ymm6
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm6[0,1],ymm4[2,3],ymm6[4,5,6],ymm4[7]
; AVX-NEXT:    vinsertf128 $1, 128(%r8), %ymm11, %ymm6
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm6[0],ymm4[1,2,3],ymm6[4],ymm4[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vshufps {{.*#+}} xmm4 = xmm4[0,1,2,0]
; AVX-NEXT:    vbroadcastss 164(%rdx), %xmm6
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm4, %ymm6
; AVX-NEXT:    vmovaps 160(%rsi), %xmm0
; AVX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovaps 160(%rdi), %xmm4
; AVX-NEXT:    vshufps {{.*#+}} xmm11 = xmm4[1,1],xmm0[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm12 = xmm4[0],xmm0[0],xmm4[1],xmm0[1]
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm12, %ymm11
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm11[0,1],ymm6[2,3],ymm11[4,5,6],ymm6[7]
; AVX-NEXT:    vinsertf128 $1, 160(%r8), %ymm12, %ymm11
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0],ymm6[1,2,3],ymm11[4],ymm6[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 192(%rdx), %xmm0
; AVX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovaps 192(%rcx), %xmm1
; AVX-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovlhps {{.*#+}} xmm6 = xmm1[0],xmm0[0]
; AVX-NEXT:    vshufps {{.*#+}} xmm6 = xmm6[0,1,2,0]
; AVX-NEXT:    vbroadcastss 196(%rdx), %xmm11
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm6, %ymm11
; AVX-NEXT:    vmovaps 192(%rsi), %xmm0
; AVX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovaps 192(%rdi), %xmm6
; AVX-NEXT:    vshufps {{.*#+}} xmm12 = xmm6[1,1],xmm0[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm6[0],xmm0[0],xmm6[1],xmm0[1]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm0, %ymm12
; AVX-NEXT:    vblendps {{.*#+}} ymm11 = ymm12[0,1],ymm11[2,3],ymm12[4,5,6],ymm11[7]
; AVX-NEXT:    vinsertf128 $1, 192(%r8), %ymm0, %ymm0
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm11[1,2,3],ymm0[4],ymm11[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vbroadcastss 228(%rdx), %xmm11
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm0, %ymm2
; AVX-NEXT:    vmovaps 224(%rsi), %xmm0
; AVX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovaps 224(%rdi), %xmm12
; AVX-NEXT:    vshufps {{.*#+}} xmm11 = xmm12[1,1],xmm0[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm12[0],xmm0[0],xmm12[1],xmm0[1]
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm1, %ymm11
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm11[0,1],ymm2[2,3],ymm11[4,5,6],ymm2[7]
; AVX-NEXT:    vinsertf128 $1, 224(%r8), %ymm1, %ymm0
...
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm5[2],xmm7[2]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm7 = xmm1[3,3],xmm2[3,3]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm7 = xmm2[3,3],xmm1[3,3]
...
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[3,3],ymm5[3,3],ymm2[7,7],ymm5[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm2[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2],ymm2[3,4],ymm1[5,6,7]
; AVX-NEXT:    vmovaps 96(%r8), %ymm2
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vinsertps $51, {{[-0-9]+}}(%r{{[sb]}}p), %xmm3, %xmm1 # 16-byte Folded Reload
; AVX-NEXT:    # xmm1 = zero,zero,xmm3[2],mem[0]
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm1 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2,3,4,5],ymm1[6],ymm0[7]
...
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[3,3],ymm11[3,3],ymm2[7,7],ymm11[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm2[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2],ymm2[3,4],ymm1[5,6,7]
...
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vinsertps $51, {{[-0-9]+}}(%r{{[sb]}}p), %xmm6, %xmm1 # 16-byte Folded Reload
; AVX-NEXT:    # xmm1 = zero,zero,xmm6[2],mem[0]
...
; AVX-NEXT:    vmovaps 192(%rsi), %ymm7
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm7[3,3],ymm8[3,3],ymm7[7,7],ymm8[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm2[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2],ymm2[3,4],ymm1[5,6,7]
; AVX-NEXT:    vmovaps 192(%r8), %ymm9
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm9[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0],ymm0[1,2,3,4],ymm2[5],ymm0[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm2[2],ymm1[3,4,5,6],ymm2[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vinsertps $51, {{[-0-9]+}}(%r{{[sb]}}p), %xmm12, %xmm1 # 16-byte Folded Reload
; AVX-NEXT:    # xmm1 = zero,zero,xmm12[2],mem[0]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm1[1,1],xmm0[1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 224(%rdx), %ymm12
; AVX-NEXT:    vmovaps 224(%rcx), %ymm4
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm4[1,1],ymm12[1,1],ymm4[5,5],ymm12[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm1[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm0[0,1,2],ymm1[3,4],ymm0[5,6,7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm6[0],ymm3[1,2,3,4],ymm6[5],ymm3[6,7]
; AVX-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm5[0,1],ymm6[2],ymm5[3,4,5,6],ymm6[7]
; AVX-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm6[0,1],ymm5[2],ymm6[3,4,5,6],ymm5[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm5[1,2,3],ymm3[4,5],ymm5[6,7]
; AVX-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm10 # 32-byte Folded Reload
; AVX-NEXT:    # ymm10 = ymm3[0,1,2],mem[3],ymm3[4,5,6,7]
; AVX-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Folded Reload
; AVX-NEXT:    # ymm3 = mem[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm3 # 32-byte Folded Reload
; AVX-NEXT:    # ymm3 = ymm3[0,1,2,3],mem[4],ymm3[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm15[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vshufpd {{.*#+}} ymm6 = ymm14[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm6[0,1],ymm5[2],ymm6[3,4,5,6],ymm5[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm5[1,2,3],ymm3[4,5],ymm5[6,7]
; AVX-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm6 # 32-byte Folded Reload
; AVX-NEXT:    # ymm6 = ymm3[0,1,2],mem[3],ymm3[4,5,6,7]
; AVX-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Folded Reload
; AVX-NEXT:    # ymm3 = mem[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm3 # 32-byte Folded Reload
; AVX-NEXT:    # ymm3 = ymm3[0,1,2,3],mem[4],ymm3[5,6,7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm11 = ymm14[0],ymm11[1,2,3],ymm14[4,5],ymm11[6,7]
; AVX-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11, %ymm11 # 32-byte Folded Reload
; AVX-NEXT:    # ymm11 = ymm11[0,1,2],mem[3],ymm11[4,5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3],ymm8[4],ymm7[5,6,7]
; AVX-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Folded Reload
; AVX-NEXT:    # ymm8 = mem[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vpermilpd $1, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX-NEXT:    # ymm14 = mem[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm14[0,1],ymm8[2],ymm14[3,4,5,6],ymm8[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm8[1,2,3],ymm7[4,5],ymm8[6,7]
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm12[1,0,2,2]
...
; AVX-NEXT:    vmovaps %ymm7, 1024(%r9)
; AVX-NEXT:    vmovaps %ymm11, 864(%r9)
; AVX-NEXT:    vmovaps %ymm13, 704(%r9)
; AVX-NEXT:    vmovaps %ymm3, 544(%r9)
; AVX-NEXT:    vmovaps %ymm5, 384(%r9)
; AVX-NEXT:    vmovaps %ymm6, 224(%r9)
; AVX-NEXT:    vmovaps %ymm10, 64(%r9)
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX512-NEXT:    vmovdqa64 64(%rdi), %zmm17
; AVX512-NEXT:    vmovdqa64 (%rsi), %zmm20
; AVX512-NEXT:    vmovdqa64 (%rdx), %zmm14
; AVX512-NEXT:    vmovdqa64 64(%rdx), %zmm25
; AVX512-NEXT:    vmovdqa64 128(%rdx), %zmm30
; AVX512-NEXT:    vmovdqa64 192(%rdx), %zmm2
; AVX512-NEXT:    vmovdqa64 (%rcx), %zmm0
; AVX512-NEXT:    vmovdqa64 64(%rcx), %zmm26
; AVX512-NEXT:    vmovdqa64 128(%rcx), %zmm28
; AVX512-NEXT:    vmovdqa64 192(%rcx), %zmm23
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm14, %zmm3
; AVX512-NEXT:    vpermt2d %zmm0, %zmm1, %zmm3
; AVX512-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vmovdqa64 %zmm1, %zmm3
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm19, %zmm1
; AVX512-NEXT:    vpermt2d %zmm20, %zmm18, %zmm1
; AVX512-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm14, %zmm4
; AVX512-NEXT:    vpermt2d %zmm0, %zmm1, %zmm4
; AVX512-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm15 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512-NEXT:    # zmm15 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm20, %zmm4
; AVX512-NEXT:    vpermt2d %zmm19, %zmm15, %zmm4
; AVX512-NEXT:    vmovdqa64 %zmm4, %zmm13
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm19, %zmm5
; AVX512-NEXT:    vpermt2d %zmm20, %zmm11, %zmm5
; AVX512-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm14, %zmm29
; AVX512-NEXT:    vpermt2d %zmm0, %zmm12, %zmm29
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm0, %zmm21
; AVX512-NEXT:    vpermt2d %zmm14, %zmm16, %zmm21
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm31 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512-NEXT:    # zmm31 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm31, %zmm14
; AVX512-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512-NEXT:    vpermt2d %zmm26, %zmm3, %zmm0
; AVX512-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512-NEXT:    vpermt2d %zmm26, %zmm1, %zmm0
; AVX512-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vmovdqa64 %zmm25, %zmm24
; AVX512-NEXT:    vpermt2d %zmm26, %zmm12, %zmm24
; AVX512-NEXT:    vmovdqa64 %zmm26, %zmm22
; AVX512-NEXT:    vpermt2d %zmm25, %zmm16, %zmm22
; AVX512-NEXT:    vpermt2d %zmm26, %zmm31, %zmm25
; AVX512-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512-NEXT:    vpermt2d %zmm28, %zmm3, %zmm0
; AVX512-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512-NEXT:    vpermt2d %zmm28, %zmm1, %zmm0
; AVX512-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vmovdqa64 %zmm30, %zmm26
; AVX512-NEXT:    vpermt2d %zmm28, %zmm12, %zmm26
; AVX512-NEXT:    vmovdqa64 %zmm28, %zmm27
; AVX512-NEXT:    vpermt2d %zmm30, %zmm16, %zmm27
; AVX512-NEXT:    vpermt2d %zmm28, %zmm31, %zmm30
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm28 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vpermi2d %zmm23, %zmm2, %zmm3
; AVX512-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpermi2d %zmm23, %zmm2, %zmm1
; AVX512-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpermi2d %zmm23, %zmm2, %zmm12
; AVX512-NEXT:    vpermi2d %zmm2, %zmm23, %zmm16
; AVX512-NEXT:    vpermt2d %zmm23, %zmm31, %zmm2
; AVX512-NEXT:    vmovdqu64 %zmm2, (%rsp) # 64-byte Spill
; AVX512-NEXT:    vmovdqa64 %zmm19, %zmm7
; AVX512-NEXT:    vpermt2d %zmm20, %zmm28, %zmm7
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm2 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512-NEXT:    # zmm2 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vpermt2d %zmm20, %zmm2, %zmm19
; AVX512-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512-NEXT:    vmovdqa64 %zmm17, %zmm20
; AVX512-NEXT:    vpermt2d %zmm0, %zmm18, %zmm20
; AVX512-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512-NEXT:    vpermt2d %zmm17, %zmm15, %zmm23
; AVX512-NEXT:    vmovdqa64 %zmm17, %zmm9
; AVX512-NEXT:    vpermt2d %zmm0, %zmm11, %zmm9
; AVX512-NEXT:    vmovdqa64 %zmm17, %zmm5
; AVX512-NEXT:    vpermt2d %zmm0, %zmm28, %zmm5
; AVX512-NEXT:    vpermt2d %zmm0, %zmm2, %zmm17
; AVX512-NEXT:    vmovdqa64 128(%rdi), %zmm31
; AVX512-NEXT:    vmovdqa64 128(%rsi), %zmm0
; AVX512-NEXT:    vmovdqa64 %zmm31, %zmm4
; AVX512-NEXT:    vpermt2d %zmm0, %zmm18, %zmm4
; AVX512-NEXT:    vmovdqa64 %zmm0, %zmm3
; AVX512-NEXT:    vpermt2d %zmm31, %zmm15, %zmm3
; AVX512-NEXT:    vmovdqa64 %zmm31, %zmm8
; AVX512-NEXT:    vpermt2d %zmm0, %zmm11, %zmm8
; AVX512-NEXT:    vmovdqa64 %zmm31, %zmm6
; AVX512-NEXT:    vpermt2d %zmm0, %zmm28, %zmm6
; AVX512-NEXT:    vpermt2d %zmm0, %zmm2, %zmm31
; AVX512-NEXT:    vmovdqa64 192(%rdi), %zmm1
; AVX512-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512-NEXT:    vpermi2d %zmm0, %zmm1, %zmm18
; AVX512-NEXT:    vpermi2d %zmm1, %zmm0, %zmm15
; AVX512-NEXT:    vpermi2d %zmm0, %zmm1, %zmm11
; AVX512-NEXT:    vpermi2d %zmm0, %zmm1, %zmm28
...
; AVX512-NEXT:    kmovw %eax, %k3
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm13 {%k3}
; AVX512-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512-NEXT:    kmovw %eax, %k2
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm29 {%k2}
; AVX512-NEXT:    vmovdqa32 %zmm7, %zmm21 {%k1}
; AVX512-NEXT:    vmovdqa32 %zmm14, %zmm19 {%k2}
; AVX512-NEXT:    vmovdqa64 (%r8), %zmm0
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm2, %zmm10
; AVX512-NEXT:    vmovdqu64 %zmm10, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm7 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm7, %zmm13
; AVX512-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm14 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm14, %zmm29
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm10 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm10, %zmm21
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm13, %zmm19
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm20 {%k1}
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm23 {%k3}
; AVX512-NEXT:    vmovdqa32 %zmm9, %zmm24 {%k2}
; AVX512-NEXT:    vmovdqa32 %zmm5, %zmm22 {%k1}
; AVX512-NEXT:    vmovdqa32 %zmm25, %zmm17 {%k2}
; AVX512-NEXT:    vmovdqa64 64(%r8), %zmm0
; AVX512-NEXT:    vpermt2d %zmm0, %zmm2, %zmm20
; AVX512-NEXT:    vpermt2d %zmm0, %zmm7, %zmm23
; AVX512-NEXT:    vpermt2d %zmm0, %zmm14, %zmm24
; AVX512-NEXT:    vpermt2d %zmm0, %zmm10, %zmm22
; AVX512-NEXT:    vpermt2d %zmm0, %zmm13, %zmm17
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k1}
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm3 {%k3}
; AVX512-NEXT:    vmovdqa32 %zmm8, %zmm26 {%k2}
; AVX512-NEXT:    vmovdqa32 %zmm6, %zmm27 {%k1}
; AVX512-NEXT:    vmovdqa32 %zmm30, %zmm31 {%k2}
; AVX512-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512-NEXT:    vpermt2d %zmm0, %zmm2, %zmm4
; AVX512-NEXT:    vpermt2d %zmm0, %zmm7, %zmm3
; AVX512-NEXT:    vpermt2d %zmm0, %zmm14, %zmm26
; AVX512-NEXT:    vpermt2d %zmm0, %zmm10, %zmm27
; AVX512-NEXT:    vpermt2d %zmm0, %zmm13, %zmm31
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k1}
; AVX512-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512-NEXT:    vpermt2d %zmm0, %zmm2, %zmm18
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm2 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm2, %zmm15 {%k3}
; AVX512-NEXT:    vpermt2d %zmm0, %zmm7, %zmm15
; AVX512-NEXT:    vmovdqa32 %zmm11, %zmm12 {%k2}
; AVX512-NEXT:    vpermt2d %zmm0, %zmm14, %zmm12
; AVX512-NEXT:    vmovdqa32 %zmm28, %zmm16 {%k1}
; AVX512-NEXT:    vpermt2d %zmm0, %zmm10, %zmm16
; AVX512-NEXT:    vmovdqu64 (%rsp), %zmm2 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm2, %zmm1 {%k2}
; AVX512-NEXT:    vpermt2d %zmm0, %zmm13, %zmm1
; AVX512-NEXT:    vmovdqa64 %zmm1, 1216(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm16, 1152(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm12, 1088(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm15, 1024(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm18, 960(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm31, 896(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm27, 832(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm26, 768(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm3, 704(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm4, 640(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm17, 576(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm22, 512(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm24, 448(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm23, 384(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm20, 320(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm19, 256(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm21, 192(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm29, 128(%r9)
...
; AVX512-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm17
; AVX512-FCP-NEXT:    vmovdqa64 (%rsi), %zmm20
; AVX512-FCP-NEXT:    vmovdqa64 (%rdx), %zmm14
; AVX512-FCP-NEXT:    vmovdqa64 64(%rdx), %zmm25
; AVX512-FCP-NEXT:    vmovdqa64 128(%rdx), %zmm30
; AVX512-FCP-NEXT:    vmovdqa64 192(%rdx), %zmm2
; AVX512-FCP-NEXT:    vmovdqa64 (%rcx), %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 64(%rcx), %zmm26
; AVX512-FCP-NEXT:    vmovdqa64 128(%rcx), %zmm28
; AVX512-FCP-NEXT:    vmovdqa64 192(%rcx), %zmm23
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm14, %zmm3
...
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512-FCP-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm19, %zmm1
; AVX512-FCP-NEXT:    vpermt2d %zmm20, %zmm18, %zmm1
; AVX512-FCP-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
...
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm15 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512-FCP-NEXT:    # zmm15 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm20, %zmm4
; AVX512-FCP-NEXT:    vpermt2d %zmm19, %zmm15, %zmm4
; AVX512-FCP-NEXT:    vmovdqa64 %zmm4, %zmm13
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512-FCP-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm19, %zmm5
; AVX512-FCP-NEXT:    vpermt2d %zmm20, %zmm11, %zmm5
; AVX512-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512-FCP-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm14, %zmm29
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm12, %zmm29
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512-FCP-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm0, %zmm21
; AVX512-FCP-NEXT:    vpermt2d %zmm14, %zmm16, %zmm21
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm31 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512-FCP-NEXT:    # zmm31 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm31, %zmm14
; AVX512-FCP-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512-FCP-NEXT:    vpermt2d %zmm26, %zmm3, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512-FCP-NEXT:    vpermt2d %zmm26, %zmm1, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm25, %zmm24
; AVX512-FCP-NEXT:    vpermt2d %zmm26, %zmm12, %zmm24
; AVX512-FCP-NEXT:    vmovdqa64 %zmm26, %zmm22
; AVX512-FCP-NEXT:    vpermt2d %zmm25, %zmm16, %zmm22
; AVX512-FCP-NEXT:    vpermt2d %zmm26, %zmm31, %zmm25
; AVX512-FCP-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512-FCP-NEXT:    vpermt2d %zmm28, %zmm3, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512-FCP-NEXT:    vpermt2d %zmm28, %zmm1, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm30, %zmm26
; AVX512-FCP-NEXT:    vpermt2d %zmm28, %zmm12, %zmm26
; AVX512-FCP-NEXT:    vmovdqa64 %zmm28, %zmm27
; AVX512-FCP-NEXT:    vpermt2d %zmm30, %zmm16, %zmm27
; AVX512-FCP-NEXT:    vpermt2d %zmm28, %zmm31, %zmm30
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm28 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512-FCP-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm3
; AVX512-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm1
; AVX512-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm12
; AVX512-FCP-NEXT:    vpermi2d %zmm2, %zmm23, %zmm16
; AVX512-FCP-NEXT:    vpermt2d %zmm23, %zmm31, %zmm2
; AVX512-FCP-NEXT:    vmovdqu64 %zmm2, (%rsp) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm19, %zmm7
; AVX512-FCP-NEXT:    vpermt2d %zmm20, %zmm28, %zmm7
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm2 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512-FCP-NEXT:    # zmm2 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vpermt2d %zmm20, %zmm2, %zmm19
; AVX512-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 %zmm17, %zmm20
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm18, %zmm20
; AVX512-FCP-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512-FCP-NEXT:    vpermt2d %zmm17, %zmm15, %zmm23
; AVX512-FCP-NEXT:    vmovdqa64 %zmm17, %zmm9
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm11, %zmm9
; AVX512-FCP-NEXT:    vmovdqa64 %zmm17, %zmm5
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm5
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm17
; AVX512-FCP-NEXT:    vmovdqa64 128(%rdi), %zmm31
...
; AVX512-FCP-NEXT:    vpermt2d %zmm31, %zmm15, %zmm3
; AVX512-FCP-NEXT:    vmovdqa64 %zmm31, %zmm8
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm11, %zmm8
; AVX512-FCP-NEXT:    vmovdqa64 %zmm31, %zmm6
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm6
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm31
; AVX512-FCP-NEXT:    vmovdqa64 192(%rdi), %zmm1
; AVX512-FCP-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm18
; AVX512-FCP-NEXT:    vpermi2d %zmm1, %zmm0, %zmm15
; AVX512-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm11
; AVX512-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm28
...
; AVX512-FCP-NEXT:    kmovw %eax, %k3
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm13 {%k3}
; AVX512-FCP-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512-FCP-NEXT:    kmovw %eax, %k2
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm29 {%k2}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm7, %zmm21 {%k1}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm14, %zmm19 {%k2}
; AVX512-FCP-NEXT:    vmovdqa64 (%r8), %zmm0
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm10
...
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm13
; AVX512-FCP-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm14 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm29
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm10 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm21
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm19
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm20 {%k1}
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm23 {%k3}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm9, %zmm24 {%k2}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm5, %zmm22 {%k1}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm25, %zmm17 {%k2}
; AVX512-FCP-NEXT:    vmovdqa64 64(%r8), %zmm0
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm20
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm23
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm24
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm22
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm17
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k1}
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm3 {%k3}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm8, %zmm26 {%k2}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm6, %zmm27 {%k1}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm30, %zmm31 {%k2}
; AVX512-FCP-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm4
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm3
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm26
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm27
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm31
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k1}
; AVX512-FCP-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm18
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm2 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm2, %zmm15 {%k3}
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm15
; AVX512-FCP-NEXT:    vmovdqa32 %zmm11, %zmm12 {%k2}
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm12
; AVX512-FCP-NEXT:    vmovdqa32 %zmm28, %zmm16 {%k1}
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm16
...
; AVX512-FCP-NEXT:    vmovdqa64 %zmm1, 1216(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm16, 1152(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm12, 1088(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm15, 1024(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm18, 960(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm31, 896(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm27, 832(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm26, 768(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm3, 704(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm4, 640(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm17, 576(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm22, 512(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm24, 448(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm23, 384(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm20, 320(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm19, 256(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm21, 192(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm29, 128(%r9)
...
; AVX512DQ-NEXT:    vmovdqa64 (%rdi), %zmm19
; AVX512DQ-NEXT:    vmovdqa64 64(%rdi), %zmm17
; AVX512DQ-NEXT:    vmovdqa64 (%rsi), %zmm20
; AVX512DQ-NEXT:    vmovdqa64 (%rdx), %zmm14
; AVX512DQ-NEXT:    vmovdqa64 64(%rdx), %zmm25
; AVX512DQ-NEXT:    vmovdqa64 128(%rdx), %zmm30
; AVX512DQ-NEXT:    vmovdqa64 192(%rdx), %zmm2
; AVX512DQ-NEXT:    vmovdqa64 (%rcx), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 64(%rcx), %zmm26
; AVX512DQ-NEXT:    vmovdqa64 128(%rcx), %zmm28
; AVX512DQ-NEXT:    vmovdqa64 192(%rcx), %zmm23
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512DQ-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm14, %zmm3
...
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512DQ-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm19, %zmm1
; AVX512DQ-NEXT:    vpermt2d %zmm20, %zmm18, %zmm1
; AVX512DQ-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512DQ-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm14, %zmm4
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm1, %zmm4
; AVX512DQ-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm15 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-NEXT:    # zmm15 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm20, %zmm4
; AVX512DQ-NEXT:    vpermt2d %zmm19, %zmm15, %zmm4
; AVX512DQ-NEXT:    vmovdqa64 %zmm4, %zmm13
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512DQ-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm19, %zmm5
; AVX512DQ-NEXT:    vpermt2d %zmm20, %zmm11, %zmm5
; AVX512DQ-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512DQ-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm14, %zmm29
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm12, %zmm29
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512DQ-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, %zmm21
; AVX512DQ-NEXT:    vpermt2d %zmm14, %zmm16, %zmm21
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm31 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-NEXT:    # zmm31 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm31, %zmm14
; AVX512DQ-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512DQ-NEXT:    vpermt2d %zmm26, %zmm3, %zmm0
; AVX512DQ-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512DQ-NEXT:    vpermt2d %zmm26, %zmm1, %zmm0
; AVX512DQ-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm25, %zmm24
; AVX512DQ-NEXT:    vpermt2d %zmm26, %zmm12, %zmm24
; AVX512DQ-NEXT:    vmovdqa64 %zmm26, %zmm22
; AVX512DQ-NEXT:    vpermt2d %zmm25, %zmm16, %zmm22
; AVX512DQ-NEXT:    vpermt2d %zmm26, %zmm31, %zmm25
; AVX512DQ-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512DQ-NEXT:    vpermt2d %zmm28, %zmm3, %zmm0
; AVX512DQ-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512DQ-NEXT:    vpermt2d %zmm28, %zmm1, %zmm0
; AVX512DQ-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm30, %zmm26
; AVX512DQ-NEXT:    vpermt2d %zmm28, %zmm12, %zmm26
; AVX512DQ-NEXT:    vmovdqa64 %zmm28, %zmm27
; AVX512DQ-NEXT:    vpermt2d %zmm30, %zmm16, %zmm27
; AVX512DQ-NEXT:    vpermt2d %zmm28, %zmm31, %zmm30
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm28 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vpermi2d %zmm23, %zmm2, %zmm3
; AVX512DQ-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpermi2d %zmm23, %zmm2, %zmm1
; AVX512DQ-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpermi2d %zmm23, %zmm2, %zmm12
; AVX512DQ-NEXT:    vpermi2d %zmm2, %zmm23, %zmm16
; AVX512DQ-NEXT:    vpermt2d %zmm23, %zmm31, %zmm2
; AVX512DQ-NEXT:    vmovdqu64 %zmm2, (%rsp) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm19, %zmm7
; AVX512DQ-NEXT:    vpermt2d %zmm20, %zmm28, %zmm7
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm2 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512DQ-NEXT:    # zmm2 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vpermt2d %zmm20, %zmm2, %zmm19
; AVX512DQ-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 %zmm17, %zmm20
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm18, %zmm20
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512DQ-NEXT:    vpermt2d %zmm17, %zmm15, %zmm23
; AVX512DQ-NEXT:    vmovdqa64 %zmm17, %zmm9
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm11, %zmm9
; AVX512DQ-NEXT:    vmovdqa64 %zmm17, %zmm5
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm28, %zmm5
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm2, %zmm17
; AVX512DQ-NEXT:    vmovdqa64 128(%rdi), %zmm31
; AVX512DQ-NEXT:    vmovdqa64 128(%rsi), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 %zmm31, %zmm4
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm18, %zmm4
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, %zmm3
; AVX512DQ-NEXT:    vpermt2d %zmm31, %zmm15, %zmm3
; AVX512DQ-NEXT:    vmovdqa64 %zmm31, %zmm8
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm11, %zmm8
; AVX512DQ-NEXT:    vmovdqa64 %zmm31, %zmm6
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm28, %zmm6
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm2, %zmm31
; AVX512DQ-NEXT:    vmovdqa64 192(%rdi), %zmm1
; AVX512DQ-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512DQ-NEXT:    vpermi2d %zmm0, %zmm1, %zmm18
; AVX512DQ-NEXT:    vpermi2d %zmm1, %zmm0, %zmm15
; AVX512DQ-NEXT:    vpermi2d %zmm0, %zmm1, %zmm11
; AVX512DQ-NEXT:    vpermi2d %zmm0, %zmm1, %zmm28
...
; AVX512DQ-NEXT:    kmovw %eax, %k3
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm13 {%k3}
; AVX512DQ-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512DQ-NEXT:    kmovw %eax, %k2
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm29 {%k2}
; AVX512DQ-NEXT:    vmovdqa32 %zmm7, %zmm21 {%k1}
; AVX512DQ-NEXT:    vmovdqa32 %zmm14, %zmm19 {%k2}
; AVX512DQ-NEXT:    vmovdqa64 (%r8), %zmm0
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm2, %zmm10
...
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm7, %zmm13
; AVX512DQ-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm14 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm14, %zmm29
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm10 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm10, %zmm21
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm13, %zmm19
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm20 {%k1}
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm23 {%k3}
; AVX512DQ-NEXT:    vmovdqa32 %zmm9, %zmm24 {%k2}
; AVX512DQ-NEXT:    vmovdqa32 %zmm5, %zmm22 {%k1}
; AVX512DQ-NEXT:    vmovdqa32 %zmm25, %zmm17 {%k2}
; AVX512DQ-NEXT:    vmovdqa64 64(%r8), %zmm0
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm2, %zmm20
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm7, %zmm23
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm14, %zmm24
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm10, %zmm22
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm13, %zmm17
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k1}
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm3 {%k3}
; AVX512DQ-NEXT:    vmovdqa32 %zmm8, %zmm26 {%k2}
; AVX512DQ-NEXT:    vmovdqa32 %zmm6, %zmm27 {%k1}
; AVX512DQ-NEXT:    vmovdqa32 %zmm30, %zmm31 {%k2}
; AVX512DQ-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm2, %zmm4
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm7, %zmm3
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm14, %zmm26
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm10, %zmm27
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm13, %zmm31
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k1}
; AVX512DQ-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm2, %zmm18
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm2 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm2, %zmm15 {%k3}
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm7, %zmm15
; AVX512DQ-NEXT:    vmovdqa32 %zmm11, %zmm12 {%k2}
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm14, %zmm12
; AVX512DQ-NEXT:    vmovdqa32 %zmm28, %zmm16 {%k1}
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm10, %zmm16
; AVX512DQ-NEXT:    vmovdqu64 (%rsp), %zmm2 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm2, %zmm1 {%k2}
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm13, %zmm1
; AVX512DQ-NEXT:    vmovdqa64 %zmm1, 1216(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm16, 1152(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm12, 1088(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm15, 1024(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm18, 960(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm31, 896(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm27, 832(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm26, 768(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm3, 704(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm4, 640(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm17, 576(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm22, 512(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm24, 448(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm23, 384(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm20, 320(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm19, 256(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm21, 192(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm29, 128(%r9)
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm17
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rsi), %zmm20
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rdx), %zmm14
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rdx), %zmm25
; AVX512DQ-FCP-NEXT:    vmovdqa64 128(%rdx), %zmm30
; AVX512DQ-FCP-NEXT:    vmovdqa64 192(%rdx), %zmm2
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rcx), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rcx), %zmm26
; AVX512DQ-FCP-NEXT:    vmovdqa64 128(%rcx), %zmm28
; AVX512DQ-FCP-NEXT:    vmovdqa64 192(%rcx), %zmm23
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512DQ-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm14, %zmm3
...
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512DQ-FCP-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm19, %zmm1
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm20, %zmm18, %zmm1
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512DQ-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
...
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm15 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-FCP-NEXT:    # zmm15 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm20, %zmm4
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm19, %zmm15, %zmm4
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm4, %zmm13
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512DQ-FCP-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm19, %zmm5
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm20, %zmm11, %zmm5
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512DQ-FCP-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm14, %zmm29
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm12, %zmm29
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512DQ-FCP-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm0, %zmm21
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm14, %zmm16, %zmm21
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm31 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-FCP-NEXT:    # zmm31 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm31, %zmm14
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm26, %zmm3, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm26, %zmm1, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm25, %zmm24
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm26, %zmm12, %zmm24
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm26, %zmm22
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm25, %zmm16, %zmm22
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm26, %zmm31, %zmm25
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm28, %zmm3, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm28, %zmm1, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm30, %zmm26
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm28, %zmm12, %zmm26
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm28, %zmm27
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm30, %zmm16, %zmm27
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm28, %zmm31, %zmm30
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm28 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-FCP-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm1
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm12
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm2, %zmm23, %zmm16
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm23, %zmm31, %zmm2
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm2, (%rsp) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm19, %zmm7
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm20, %zmm28, %zmm7
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm2 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512DQ-FCP-NEXT:    # zmm2 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm20, %zmm2, %zmm19
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm17, %zmm20
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm18, %zmm20
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm17, %zmm15, %zmm23
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm17, %zmm9
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm11, %zmm9
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm17, %zmm5
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm5
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm17
; AVX512DQ-FCP-NEXT:    vmovdqa64 128(%rdi), %zmm31
...
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm31, %zmm15, %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm31, %zmm8
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm11, %zmm8
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm31, %zmm6
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm6
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm31
; AVX512DQ-FCP-NEXT:    vmovdqa64 192(%rdi), %zmm1
; AVX512DQ-FCP-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm18
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm1, %zmm0, %zmm15
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm11
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm28
...
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k3
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm0, %zmm13 {%k3}
; AVX512DQ-FCP-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k2
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm0, %zmm29 {%k2}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm7, %zmm21 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm14, %zmm19 {%k2}
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%r8), %zmm0
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm10
...
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm13
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm14 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm29
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm10 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm21
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm19
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm0, %zmm20 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm0, %zmm23 {%k3}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm9, %zmm24 {%k2}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm5, %zmm22 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm25, %zmm17 {%k2}
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%r8), %zmm0
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm20
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm23
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm24
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm22
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm17
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm0, %zmm3 {%k3}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm8, %zmm26 {%k2}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm6, %zmm27 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm30, %zmm31 {%k2}
...
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm26
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm27
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm31
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm18
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm2 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm2, %zmm15 {%k3}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm15
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm11, %zmm12 {%k2}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm12
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm28, %zmm16 {%k1}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm16
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm1, 1216(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm16, 1152(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm12, 1088(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm15, 1024(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm18, 960(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm31, 896(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm27, 832(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm26, 768(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm3, 704(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm4, 640(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm17, 576(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm22, 512(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm24, 448(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm23, 384(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm20, 320(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm19, 256(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm21, 192(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm29, 128(%r9)
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm14 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm14, %zmm29
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm10 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
...
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512BW-FCP-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm1
; AVX512BW-FCP-NEXT:    vpermt2d %zmm20, %zmm18, %zmm1
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512BW-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
...
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm15 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512BW-FCP-NEXT:    # zmm15 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm20, %zmm4
; AVX512BW-FCP-NEXT:    vpermt2d %zmm19, %zmm15, %zmm4
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm13
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512BW-FCP-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2d %zmm20, %zmm11, %zmm5
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512BW-FCP-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm14, %zmm29
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm12, %zmm29
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512BW-FCP-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm21
; AVX512BW-FCP-NEXT:    vpermt2d %zmm14, %zmm16, %zmm21
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm31 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512BW-FCP-NEXT:    # zmm31 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm31, %zmm14
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512BW-FCP-NEXT:    vpermt2d %zmm26, %zmm3, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512BW-FCP-NEXT:    vpermt2d %zmm26, %zmm1, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm25, %zmm24
; AVX512BW-FCP-NEXT:    vpermt2d %zmm26, %zmm12, %zmm24
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm26, %zmm22
; AVX512BW-FCP-NEXT:    vpermt2d %zmm25, %zmm16, %zmm22
; AVX512BW-FCP-NEXT:    vpermt2d %zmm26, %zmm31, %zmm25
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512BW-FCP-NEXT:    vpermt2d %zmm28, %zmm3, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512BW-FCP-NEXT:    vpermt2d %zmm28, %zmm1, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm30, %zmm26
; AVX512BW-FCP-NEXT:    vpermt2d %zmm28, %zmm12, %zmm26
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm28, %zmm27
; AVX512BW-FCP-NEXT:    vpermt2d %zmm30, %zmm16, %zmm27
; AVX512BW-FCP-NEXT:    vpermt2d %zmm28, %zmm31, %zmm30
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm28 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512BW-FCP-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm3
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm1
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm12
; AVX512BW-FCP-NEXT:    vpermi2d %zmm2, %zmm23, %zmm16
; AVX512BW-FCP-NEXT:    vpermt2d %zmm23, %zmm31, %zmm2
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm2, (%rsp) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm7
; AVX512BW-FCP-NEXT:    vpermt2d %zmm20, %zmm28, %zmm7
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm2 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512BW-FCP-NEXT:    # zmm2 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm20, %zmm2, %zmm19
; AVX512BW-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm17, %zmm20
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm18, %zmm20
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512BW-FCP-NEXT:    vpermt2d %zmm17, %zmm15, %zmm23
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm17, %zmm9
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm11, %zmm9
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm17, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm17
; AVX512BW-FCP-NEXT:    vmovdqa64 128(%rdi), %zmm31
...
; AVX512BW-FCP-NEXT:    vpermt2d %zmm31, %zmm15, %zmm3
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm31, %zmm8
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm11, %zmm8
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm31, %zmm6
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm6
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm31
; AVX512BW-FCP-NEXT:    vmovdqa64 192(%rdi), %zmm1
; AVX512BW-FCP-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512BW-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm18
; AVX512BW-FCP-NEXT:    vpermi2d %zmm1, %zmm0, %zmm15
; AVX512BW-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm11
; AVX512BW-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm28
...
; AVX512BW-FCP-NEXT:    kmovd %eax, %k3
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm13 {%k3}
; AVX512BW-FCP-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512BW-FCP-NEXT:    kmovd %eax, %k2
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm29 {%k2}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm7, %zmm21 {%k1}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm14, %zmm19 {%k2}
; AVX512BW-FCP-NEXT:    vmovdqa64 (%r8), %zmm0
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm10
...
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm13
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm14 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm29
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm10 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm21
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm19
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm20 {%k1}
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm23 {%k3}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm9, %zmm24 {%k2}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm5, %zmm22 {%k1}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm25, %zmm17 {%k2}
; AVX512BW-FCP-NEXT:    vmovdqa64 64(%r8), %zmm0
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm20
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm23
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm24
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm22
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm17
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k1}
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm3 {%k3}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm8, %zmm26 {%k2}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm6, %zmm27 {%k1}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm30, %zmm31 {%k2}
; AVX512BW-FCP-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm4
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm3
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm26
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm27
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm31
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k1}
; AVX512BW-FCP-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm18
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm2 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm2, %zmm15 {%k3}
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm15
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm11, %zmm12 {%k2}
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm12
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm28, %zmm16 {%k1}
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm16
; AVX512BW-FCP-NEXT:    vmovdqu64 (%rsp), %zmm2 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm2, %zmm1 {%k2}
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm1
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm1, 1216(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm16, 1152(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm12, 1088(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm15, 1024(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm18, 960(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm31, 896(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm27, 832(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm26, 768(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm3, 704(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm4, 640(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm17, 576(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm22, 512(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm24, 448(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm23, 384(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm20, 320(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm19, 256(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm21, 192(%r9)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm29, 128(%r9)
...
; AVX512BW-FCP-NEXT:    addq $520, %rsp # imm = 0x208
; AVX512BW-FCP-NEXT:    vzeroupper
; AVX512BW-FCP-NEXT:    retq
;
...
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rsi), %zmm20
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rdx), %zmm14
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rdx), %zmm25
; AVX512DQ-BW-NEXT:    vmovdqa64 128(%rdx), %zmm30
; AVX512DQ-BW-NEXT:    vmovdqa64 192(%rdx), %zmm2
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rcx), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rcx), %zmm26
; AVX512DQ-BW-NEXT:    vmovdqa64 128(%rcx), %zmm28
; AVX512DQ-BW-NEXT:    vmovdqa64 192(%rcx), %zmm23
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512DQ-BW-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm14, %zmm3
...
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512DQ-BW-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm19, %zmm1
; AVX512DQ-BW-NEXT:    vpermt2d %zmm20, %zmm18, %zmm1
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512DQ-BW-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm14, %zmm4
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm4
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm15 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-BW-NEXT:    # zmm15 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm20, %zmm4
; AVX512DQ-BW-NEXT:    vpermt2d %zmm19, %zmm15, %zmm4
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm4, %zmm13
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512DQ-BW-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm19, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2d %zmm20, %zmm11, %zmm5
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512DQ-BW-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm14, %zmm29
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm12, %zmm29
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512DQ-BW-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, %zmm21
; AVX512DQ-BW-NEXT:    vpermt2d %zmm14, %zmm16, %zmm21
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm31 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-BW-NEXT:    # zmm31 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm31, %zmm14
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512DQ-BW-NEXT:    vpermt2d %zmm26, %zmm3, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512DQ-BW-NEXT:    vpermt2d %zmm26, %zmm1, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm25, %zmm24
; AVX512DQ-BW-NEXT:    vpermt2d %zmm26, %zmm12, %zmm24
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm26, %zmm22
; AVX512DQ-BW-NEXT:    vpermt2d %zmm25, %zmm16, %zmm22
; AVX512DQ-BW-NEXT:    vpermt2d %zmm26, %zmm31, %zmm25
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512DQ-BW-NEXT:    vpermt2d %zmm28, %zmm3, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512DQ-BW-NEXT:    vpermt2d %zmm28, %zmm1, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm30, %zmm26
; AVX512DQ-BW-NEXT:    vpermt2d %zmm28, %zmm12, %zmm26
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm28, %zmm27
; AVX512DQ-BW-NEXT:    vpermt2d %zmm30, %zmm16, %zmm27
; AVX512DQ-BW-NEXT:    vpermt2d %zmm28, %zmm31, %zmm30
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm28 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-BW-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vpermi2d %zmm23, %zmm2, %zmm3
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpermi2d %zmm23, %zmm2, %zmm1
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpermi2d %zmm23, %zmm2, %zmm12
; AVX512DQ-BW-NEXT:    vpermi2d %zmm2, %zmm23, %zmm16
; AVX512DQ-BW-NEXT:    vpermt2d %zmm23, %zmm31, %zmm2
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm2, (%rsp) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm19, %zmm7
; AVX512DQ-BW-NEXT:    vpermt2d %zmm20, %zmm28, %zmm7
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm2 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512DQ-BW-NEXT:    # zmm2 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm20, %zmm2, %zmm19
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm17, %zmm20
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm18, %zmm20
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512DQ-BW-NEXT:    vpermt2d %zmm17, %zmm15, %zmm23
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm17, %zmm9
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm11, %zmm9
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm17, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm28, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm2, %zmm17
; AVX512DQ-BW-NEXT:    vmovdqa64 128(%rdi), %zmm31
; AVX512DQ-BW-NEXT:    vmovdqa64 128(%rsi), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm31, %zmm4
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm18, %zmm4
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, %zmm3
; AVX512DQ-BW-NEXT:    vpermt2d %zmm31, %zmm15, %zmm3
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm31, %zmm8
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm11, %zmm8
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm31, %zmm6
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm28, %zmm6
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm2, %zmm31
; AVX512DQ-BW-NEXT:    vmovdqa64 192(%rdi), %zmm1
; AVX512DQ-BW-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512DQ-BW-NEXT:    vpermi2d %zmm0, %zmm1, %zmm18
; AVX512DQ-BW-NEXT:    vpermi2d %zmm1, %zmm0, %zmm15
; AVX512DQ-BW-NEXT:    vpermi2d %zmm0, %zmm1, %zmm11
; AVX512DQ-BW-NEXT:    vpermi2d %zmm0, %zmm1, %zmm28
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm2, %zmm1
; AVX512DQ-BW-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512DQ-BW-NEXT:    kmovd %eax, %k1
...
; AVX512DQ-BW-NEXT:    kmovd %eax, %k3
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm13 {%k3}
; AVX512DQ-BW-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512DQ-BW-NEXT:    kmovd %eax, %k2
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm29 {%k2}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm7, %zmm21 {%k1}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm14, %zmm19 {%k2}
; AVX512DQ-BW-NEXT:    vmovdqa64 (%r8), %zmm0
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm2, %zmm10
...
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm7, %zmm13
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm14 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm14, %zmm29
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm10 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm10, %zmm21
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm13, %zmm19
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm20 {%k1}
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm23 {%k3}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm9, %zmm24 {%k2}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm5, %zmm22 {%k1}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm25, %zmm17 {%k2}
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%r8), %zmm0
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm2, %zmm20
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm7, %zmm23
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm14, %zmm24
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm10, %zmm22
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm13, %zmm17
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k1}
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm3 {%k3}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm8, %zmm26 {%k2}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm6, %zmm27 {%k1}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm30, %zmm31 {%k2}
; AVX512DQ-BW-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm2, %zmm4
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm7, %zmm3
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm14, %zmm26
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm10, %zmm27
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm13, %zmm31
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k1}
; AVX512DQ-BW-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm2, %zmm18
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm2 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm2, %zmm15 {%k3}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm7, %zmm15
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm11, %zmm12 {%k2}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm14, %zmm12
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm28, %zmm16 {%k1}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm10, %zmm16
; AVX512DQ-BW-NEXT:    vmovdqu64 (%rsp), %zmm2 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm2, %zmm1 {%k2}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm13, %zmm1
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm1, 1216(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm16, 1152(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm12, 1088(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm15, 1024(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm18, 960(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm31, 896(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm27, 832(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm26, 768(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm3, 704(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm4, 640(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm17, 576(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm22, 512(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm24, 448(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm23, 384(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm20, 320(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm19, 256(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm21, 192(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm29, 128(%r9)
...
; AVX512DQ-BW-FCP:       # %bb.0:
; AVX512DQ-BW-FCP-NEXT:    subq $520, %rsp # imm = 0x208
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%rdi), %zmm19
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 128(%rdx), %zmm30
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 128(%rcx), %zmm28
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 192(%rcx), %zmm23
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
...
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512DQ-BW-FCP-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm20, %zmm18, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512DQ-BW-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm14, %zmm4
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm4
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm15 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-BW-FCP-NEXT:    # zmm15 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm20, %zmm4
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm19, %zmm15, %zmm4
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm13
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512DQ-BW-FCP-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm20, %zmm11, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm12 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512DQ-BW-FCP-NEXT:    # zmm12 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm14, %zmm29
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm12, %zmm29
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512DQ-BW-FCP-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm21
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm14, %zmm16, %zmm21
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm31 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-BW-FCP-NEXT:    # zmm31 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm31, %zmm14
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm26, %zmm3, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm25, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm26, %zmm1, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm25, %zmm24
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm26, %zmm12, %zmm24
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm26, %zmm22
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm25, %zmm16, %zmm22
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm26, %zmm31, %zmm25
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm28, %zmm3, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm30, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm28, %zmm1, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm30, %zmm26
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm28, %zmm12, %zmm26
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm28, %zmm27
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm30, %zmm16, %zmm27
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm28, %zmm31, %zmm30
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm28 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-BW-FCP-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm23, %zmm2, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm2, %zmm23, %zmm16
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm23, %zmm31, %zmm2
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm2, (%rsp) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm7
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm20, %zmm28, %zmm7
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm2 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512DQ-BW-FCP-NEXT:    # zmm2 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm20, %zmm2, %zmm19
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm17, %zmm20
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm18, %zmm20
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm17, %zmm15, %zmm23
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm17, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm11, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm17, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm17
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 128(%rdi), %zmm31
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm31, %zmm15, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm31, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm11, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm31, %zmm6
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm6
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm31
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 192(%rdi), %zmm1
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm18
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm1, %zmm0, %zmm15
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm11
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm0, %zmm1, %zmm28
...
; AVX512DQ-BW-FCP-NEXT:    kmovd %eax, %k3
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm13 {%k3}
; AVX512DQ-BW-FCP-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512DQ-BW-FCP-NEXT:    kmovd %eax, %k2
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm29 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm7, %zmm21 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm14, %zmm19 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%r8), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm2 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm10
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm13
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm14 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm29
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm10 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm21
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm13 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm19
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm20 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm23 {%k3}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm9, %zmm24 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm5, %zmm22 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm25, %zmm17 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 64(%r8), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm20
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm23
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm24
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm22
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm17
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm3 {%k3}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm8, %zmm26 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm6, %zmm27 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm30, %zmm31 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm4
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm26
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm27
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm31
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm2, %zmm18
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm2 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm2, %zmm15 {%k3}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm15
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm11, %zmm12 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm14, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm28, %zmm16 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm10, %zmm16
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 (%rsp), %zmm2 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm2, %zmm1 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm13, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm1, 1216(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm16, 1152(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm12, 1088(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm15, 1024(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm18, 960(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm31, 896(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm27, 832(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm26, 768(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm3, 704(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm4, 640(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm17, 576(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm22, 512(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm24, 448(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm23, 384(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm20, 320(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm19, 256(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm21, 192(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm29, 128(%r9)
...
; AVX512DQ-BW-FCP-NEXT:    addq $520, %rsp # imm = 0x208
; AVX512DQ-BW-FCP-NEXT:    vzeroupper
; AVX512DQ-BW-FCP-NEXT:    retq
