...
; AVX-NEXT:    vshufps {{.*#+}} xmm5 = xmm6[1,1],xmm5[1,1]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm12 = xmm7[1,1],xmm6[1,1]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm6 = xmm9[1,1],xmm8[1,1]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm6 = xmm11[1,1],xmm10[1,1]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,1],xmm6[1,1]
