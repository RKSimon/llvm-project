...
; AVX-NEXT:    vinsertps {{.*#+}} xmm4 = zero,xmm8[1],xmm7[1],zero
...
; AVX-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm7 = xmm8[0,1,2],xmm7[3]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm7, %ymm7
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm9[0,1],ymm7[2,3],ymm9[4,5],ymm7[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm13[1],ymm7[2,3,4,5],ymm13[6],ymm7[7]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm10 = xmm5[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm10 = xmm6[0,1,2],xmm10[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm5 = zero,xmm6[1],xmm5[1],zero
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm5, %ymm5
; AVX-NEXT:    vshufps {{.*#+}} ymm6 = ymm3[1,1],ymm1[1,1],ymm3[5,5],ymm1[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm6[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2],ymm6[3,4],ymm5[5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm9[0],ymm5[1,2,3,4],ymm9[5],ymm5[6,7]
...
; AVX-NEXT:    vinsertps {{.*#+}} xmm12 = zero,xmm7[1],xmm6[1],zero
; AVX-NEXT:    vunpcklps {{.*#+}} xmm13 = xmm7[0],xmm6[0],xmm7[1],xmm6[1]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm13, %ymm12
; AVX-NEXT:    vmovaps (%rcx), %xmm13
...
; AVX-NEXT:    vmovddup {{.*#+}} ymm15 = ymm15[0,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1],ymm15[2,3],ymm12[4,5,6],ymm15[7]
; AVX-NEXT:    vmovaps 32(%rcx), %xmm15
; AVX-NEXT:    vunpckhps {{.*#+}} xmm14 = xmm14[2],xmm13[2],xmm14[3],xmm13[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm13 = xmm13[1,1,1,1]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0,1,2,3],ymm6[4],ymm12[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm13[0,1],ymm7[2,3],ymm13[4,5],ymm7[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm12 = ymm7[0],ymm6[1],ymm7[2,3,4,5],ymm6[6],ymm7[7]
; AVX-NEXT:    vinsertps {{.*#+}} xmm6 = zero,xmm9[1],xmm8[1],zero
; AVX-NEXT:    vunpcklps {{.*#+}} xmm13 = xmm9[0],xmm8[0],xmm9[1],xmm8[1]
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm13, %ymm6
; AVX-NEXT:    vunpcklps {{.*#+}} xmm13 = xmm14[0],xmm15[0],xmm14[1],xmm15[1]
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm13, %ymm13
; AVX-NEXT:    vmovddup {{.*#+}} ymm13 = ymm13[0,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1],ymm13[2,3],ymm6[4,5,6],ymm13[7]
; AVX-NEXT:    vmovaps 16(%rcx), %xmm13
; AVX-NEXT:    vunpckhps {{.*#+}} xmm14 = xmm14[2],xmm15[2],xmm14[3],xmm15[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm15 = xmm15[1,1,1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm15, %ymm14
; AVX-NEXT:    vmovaps 16(%rdx), %xmm15
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm8[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm8 = xmm9[0,1,2],xmm8[3]
; AVX-NEXT:    vinsertf128 $1, %xmm9, %ymm8, %ymm9
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm0 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm6[0,1,2,3],ymm0[4],ymm6[5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm14[0,1],ymm9[2,3],ymm14[4,5],ymm9[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm9 = ymm6[0],ymm0[1],ymm6[2,3,4,5],ymm0[6],ymm6[7]
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm10[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm0 = xmm11[0,1,2],xmm0[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm6 = zero,xmm11[1],xmm10[1],zero
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm6, %ymm0
; AVX-NEXT:    vshufps {{.*#+}} ymm6 = ymm3[1,1],ymm1[1,1],ymm3[5,5],ymm1[5,5]
; AVX-NEXT:    vmovaps %ymm1, %ymm7
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm6[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm6[3,4],ymm0[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm6 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm10 = ymm6[0],ymm0[1,2,3,4],ymm6[5],ymm0[6,7]
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm15[3,3],xmm13[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm11 = xmm15[2],xmm13[2],xmm15[3],xmm13[3]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm11, %ymm0
; AVX-NEXT:    vshufps {{.*#+}} ymm11 = ymm4[3,3],ymm2[3,3],ymm4[7,7],ymm2[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm11 = ymm11[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm11[3,4],ymm0[5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm11 = ymm0[0,1],ymm6[2],ymm0[3,4,5,6],ymm6[7]
; AVX-NEXT:    vmovaps 48(%rdi), %xmm0
; AVX-NEXT:    vmovaps 48(%rsi), %xmm6
; AVX-NEXT:    vshufps {{.*#+}} xmm13 = xmm6[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm13 = xmm0[0,1,2],xmm13[3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm0 = zero,xmm0[1],xmm6[1],zero
; AVX-NEXT:    vinsertf128 $1, %xmm13, %ymm0, %ymm0
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Reload
; AVX-NEXT:    vshufps {{.*#+}} ymm6 = ymm1[1,1],ymm5[1,1],ymm1[5,5],ymm5[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm6[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm6[3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovaps 48(%rcx), %xmm6
; AVX-NEXT:    vmovaps 48(%rdx), %xmm13
; AVX-NEXT:    vshufps {{.*#+}} xmm14 = xmm13[3,3],xmm6[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm6 = xmm13[2],xmm6[2],xmm13[3],xmm6[3]
; AVX-NEXT:    vmovaps 32(%rdi), %ymm13
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm6, %ymm6
; AVX-NEXT:    vmovaps 32(%rsi), %ymm14
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm14[3,3],ymm13[3,3],ymm14[7,7],ymm13[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm15[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1,2],ymm15[3,4],ymm6[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm15 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm0[1,2,3,4],ymm15[5],ymm0[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1],ymm15[2],ymm6[3,4,5,6],ymm15[7]
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm3 = ymm7[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4,5,6],ymm4[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm3[1,2,3],ymm2[4,5],ymm3[6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm14[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm13[4],ymm3[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm5[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm4[0,1],ymm1[2],ymm4[3,4,5,6],ymm1[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0],ymm1[1,2,3],ymm3[4,5],ymm1[6,7]
...
; AVX-NEXT:    vmovaps %ymm6, 288(%r9)
; AVX-NEXT:    vmovaps %ymm0, 256(%r9)
; AVX-NEXT:    vmovaps %ymm11, 128(%r9)
; AVX-NEXT:    vmovaps %ymm10, 96(%r9)
; AVX-NEXT:    vmovaps %ymm9, 192(%r9)
; AVX-NEXT:    vmovaps %ymm8, 160(%r9)
; AVX-NEXT:    vmovaps %ymm12, 32(%r9)
