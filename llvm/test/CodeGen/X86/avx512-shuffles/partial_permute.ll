...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [3,1,2,4]
; CHECK-NEXT:    vpermd (%rdi), %ymm0, %ymm0
; CHECK-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[14,15,2,3,14,15,0,1,14,15,8,9,6,7,4,5]
; CHECK-NEXT:    vzeroupper
; CHECK-NEXT:    retq
  %vec = load <16 x i16>, ptr %vp
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} xmm2 = [3,1,2,4]
; CHECK-NEXT:    vpermd (%rdi), %ymm2, %ymm2
; CHECK-NEXT:    vpshufb {{.*#+}} xmm2 = xmm2[14,15,2,3,14,15,0,1,14,15,8,9,6,7,4,5]
; CHECK-NEXT:    vptestnmw %xmm1, %xmm1, %k1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} xmm1 = [3,1,2,4]
; CHECK-NEXT:    vpermd (%rdi), %ymm1, %ymm1
; CHECK-NEXT:    vpshufb {{.*#+}} xmm1 = xmm1[14,15,2,3,14,15,0,1,14,15,8,9,6,7,4,5]
; CHECK-NEXT:    vptestnmw %xmm0, %xmm0, %k1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} ymm1 = [0,2,0,8,4,6,4,12]
; CHECK-NEXT:    vpermps %zmm0, %zmm1, %zmm0
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} ymm3 = [0,2,0,8,4,6,4,12]
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpmovsxbd {{.*#+}} ymm2 = [0,2,0,8,4,6,4,12]
...
; CHECK-NEXT:    vpmovsxbd {{.*#+}} ymm3 = [1,13,10,11,10,0,0,9]
