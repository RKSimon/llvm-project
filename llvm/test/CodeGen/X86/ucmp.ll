...
; SSE4-NEXT:    movq %xmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Folded Spill
...
; SSE4-NEXT:    movq %xmm12, %rbx
; SSE4-NEXT:    pshufd {{.*#+}} xmm12 = xmm15[2,3,2,3]
; SSE4-NEXT:    movq %xmm14, %r15
...
; SSE4-NEXT:    cmpq %rbx, %r15
; SSE4-NEXT:    movq %r11, %r12
; SSE4-NEXT:    sbbq %r10, %r12
; SSE4-NEXT:    movq %xmm12, %r12
; SSE4-NEXT:    movdqu {{[0-9]+}}(%rsp), %xmm14
; SSE4-NEXT:    pand %xmm0, %xmm14
; SSE4-NEXT:    pshufd {{.*#+}} xmm12 = xmm14[2,3,2,3]
; SSE4-NEXT:    setb %dl
; SSE4-NEXT:    cmpq %r15, %rbx
; SSE4-NEXT:    movq %xmm12, %rbx
; SSE4-NEXT:    pshufd {{.*#+}} xmm12 = xmm10[2,3,2,3]
; SSE4-NEXT:    movq %xmm15, %r15
; SSE4-NEXT:    movdqu {{[0-9]+}}(%rsp), %xmm15
...
; SSE4-NEXT:    movdqu {{[0-9]+}}(%rsp), %xmm14
; SSE4-NEXT:    pand %xmm0, %xmm14
; SSE4-NEXT:    sbbq %rbx, %r12
; SSE4-NEXT:    movq %xmm13, %r11
...
; SSE4-NEXT:    movdqu {{[0-9]+}}(%rsp), %xmm14
; SSE4-NEXT:    pand %xmm0, %xmm14
; SSE4-NEXT:    sbbq %r10, %rax
; SSE4-NEXT:    movq %xmm15, %r8
; SSE4-NEXT:    pshufd {{.*#+}} xmm15 = xmm14[2,3,2,3]
; SSE4-NEXT:    sbbb $0, %dl
; SSE4-NEXT:    movb %dl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
...
; SSE4-NEXT:    sbbq %r14, %r10
; SSE4-NEXT:    movq %xmm8, %rbx
...
; SSE4-NEXT:    movq %xmm1, %rdx
; SSE4-NEXT:    sbbb $0, %bpl
; SSE4-NEXT:    cmpq %r9, %rdx
; SSE4-NEXT:    movq %rax, %r14
; SSE4-NEXT:    sbbq %r13, %r14
; SSE4-NEXT:    setb %r15b
; SSE4-NEXT:    cmpq %rdx, %r9
; SSE4-NEXT:    movdqu {{[0-9]+}}(%rsp), %xmm1
; SSE4-NEXT:    pand %xmm0, %xmm1
; SSE4-NEXT:    pshufd {{.*#+}} xmm2 = xmm1[2,3,2,3]
; SSE4-NEXT:    sbbq %rax, %r13
; SSE4-NEXT:    movq %xmm2, %rax
; SSE4-NEXT:    movq %xmm1, %rdx
...
; SSE4-NEXT:    movzbl -{{[0-9]+}}(%rsp), %edx
; SSE4-NEXT:    andl $3, %edx
; SSE4-NEXT:    shll $26, %edx
; SSE4-NEXT:    orq %rsi, %rdx
; SSE4-NEXT:    orq %rcx, %rdx
; SSE4-NEXT:    movzbl -{{[0-9]+}}(%rsp), %ecx
; SSE4-NEXT:    andl $3, %ecx
; SSE4-NEXT:    shll $28, %ecx
; SSE4-NEXT:    movzbl -{{[0-9]+}}(%rsp), %esi
; SSE4-NEXT:    shll $30, %esi
; SSE4-NEXT:    orq %rcx, %rsi
; SSE4-NEXT:    orq %rdx, %rsi
...
; SSE2-NEXT:    pextrq $1, %xmm7, %rsi
; SSE2-NEXT:    movdqu {{[0-9]+}}(%rsp), %xmm8
; SSE2-NEXT:    pand %xmm0, %xmm8
; SSE2-NEXT:    pextrq $1, %xmm8, %rbx
...
; SSE2-NEXT:    pextrq $1, %xmm7, %r10
; SSE2-NEXT:    movdqu {{[0-9]+}}(%rsp), %xmm6
; SSE2-NEXT:    pand %xmm0, %xmm6
; SSE2-NEXT:    setb %al
; SSE2-NEXT:    cmpq %rdx, %rsi
; SSE2-NEXT:    pextrq $1, %xmm6, %rdx
...
; SSE2-NEXT:    sbbq %r12, %r9
; SSE2-NEXT:    pextrq $1, %xmm6, %r10
; SSE2-NEXT:    movdqu {{[0-9]+}}(%rsp), %xmm5
; SSE2-NEXT:    pand %xmm0, %xmm5
; SSE2-NEXT:    setb %al
; SSE2-NEXT:    cmpq %rdx, %rcx
; SSE2-NEXT:    pextrq $1, %xmm5, %rcx
; SSE2-NEXT:    sbbq %rbx, %r12
; SSE2-NEXT:    movq %xmm6, %rdx
; SSE2-NEXT:    movq %xmm5, %rbx
; SSE2-NEXT:    sbbb $0, %al
; SSE2-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; SSE2-NEXT:    cmpq %rdx, %rbx
; SSE2-NEXT:    movq %rcx, %r12
; SSE2-NEXT:    sbbq %r10, %r12
; SSE2-NEXT:    movdqu {{[0-9]+}}(%rsp), %xmm5
; SSE2-NEXT:    setb %r12b
; SSE2-NEXT:    cmpq %rbx, %rdx
...
; SSE2-NEXT:    orl %esi, %ecx
; SSE2-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; SSE2-NEXT:    shll $30, %esi
; SSE2-NEXT:    orl %ecx, %esi
; SSE2-NEXT:    orl %edx, %esi
; SSE2-NEXT:    movl %esi, (%rax)
; SSE2-NEXT:    popq %rbx
; SSE2-NEXT:    popq %r12
; SSE2-NEXT:    popq %r13
; SSE2-NEXT:    popq %r14
...
; AVX2-NEXT:    vpextrq $1, %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Folded Spill
; AVX2-NEXT:    vpand {{[0-9]+}}(%rsp), %xmm0, %xmm4
; AVX2-NEXT:    vpand {{[0-9]+}}(%rsp), %xmm0, %xmm5
; AVX2-NEXT:    vpextrq $1, %xmm5, %r11
...
; AVX2-NEXT:    vmovq %xmm8, %r14
; AVX2-NEXT:    vpand {{[0-9]+}}(%rsp), %xmm0, %xmm8
; AVX2-NEXT:    vpextrq $1, %xmm8, %r12
; AVX2-NEXT:    sbbq %r15, %rbp
; AVX2-NEXT:    vmovq %xmm8, %r15
; AVX2-NEXT:    sbbb $0, %r8b
; AVX2-NEXT:    movb %r8b, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
...
; AVX2-NEXT:    cmpq %r14, %r10
; AVX2-NEXT:    movq %r15, %r12
; AVX2-NEXT:    sbbq %r13, %r12
; AVX2-NEXT:    setb %dl
; AVX2-NEXT:    cmpq %r10, %r14
; AVX2-NEXT:    vmovq %xmm6, %r10
; AVX2-NEXT:    vpand {{[0-9]+}}(%rsp), %xmm0, %xmm6
...
; AVX2-NEXT:    cmpq %r10, %rbx
; AVX2-NEXT:    movq %r14, %r15
; AVX2-NEXT:    sbbq %r11, %r15
; AVX2-NEXT:    setb %dl
; AVX2-NEXT:    cmpq %rbx, %r10
...
; AVX2-NEXT:    sbbq %r8, %rsi
; AVX2-NEXT:    setb %sil
; AVX2-NEXT:    cmpq %rdx, %rcx
; AVX2-NEXT:    sbbq %rdi, %r8
; AVX2-NEXT:    sbbb $0, %sil
; AVX2-NEXT:    movzbl %sil, %ecx
; AVX2-NEXT:    andl $3, %ecx
; AVX2-NEXT:    movb %cl, 4(%rax)
...
; AVX512-NEXT:    cmpq %r8, %rdx
; AVX512-NEXT:    movq %rcx, %rax
; AVX512-NEXT:    sbbq %r12, %rax
; AVX512-NEXT:    setb %sil
; AVX512-NEXT:    cmpq %rdx, %r8
; AVX512-NEXT:    vpand {{[0-9]+}}(%rsp), %xmm0, %xmm1
...
; AVX512-NEXT:    movq %rdx, %r8
; AVX512-NEXT:    sbbq %r14, %r8
; AVX512-NEXT:    vpand {{[0-9]+}}(%rsp), %xmm0, %xmm1
; AVX512-NEXT:    vpand {{[0-9]+}}(%rsp), %xmm0, %xmm2
; AVX512-NEXT:    setb %r12b
; AVX512-NEXT:    cmpq %rcx, %rax
; AVX512-NEXT:    vpextrq $1, %xmm2, %rcx
; AVX512-NEXT:    sbbq %rdx, %r14
; AVX512-NEXT:    vmovq %xmm2, %rdx
...
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; AVX512-NEXT:    andl $3, %ecx
; AVX512-NEXT:    shll $26, %ecx
; AVX512-NEXT:    orq %rdx, %rcx
; AVX512-NEXT:    orq %rax, %rcx
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 1-byte Folded Reload
; AVX512-NEXT:    andl $3, %eax
; AVX512-NEXT:    shll $28, %eax
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 1-byte Folded Reload
; AVX512-NEXT:    shll $30, %edx
; AVX512-NEXT:    orq %rax, %rdx
; AVX512-NEXT:    orq %rcx, %rdx
; AVX512-NEXT:    movq %r8, %rax
; AVX512-NEXT:    movl %edx, (%r8)
