...
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm1 = [3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12]
; AVX2-NEXT:    vmovdqa (%rdi), %xmm3
; AVX2-NEXT:    vmovdqa 16(%rdi), %xmm4
; AVX2-NEXT:    vmovdqa 32(%rdi), %xmm5
; AVX2-NEXT:    vmovdqa 48(%rdi), %xmm6
; AVX2-NEXT:    vpshufb %xmm1, %xmm6, %xmm7
; AVX2-NEXT:    vpshufb %xmm1, %xmm5, %xmm8
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm7 = xmm8[0],xmm7[0],xmm8[1],xmm7[1]
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm8 = [0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15]
; AVX2-NEXT:    vpshufb %xmm8, %xmm4, %xmm9
; AVX2-NEXT:    vpshufb %xmm8, %xmm3, %xmm10
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1]
; AVX2-NEXT:    vpblendd {{.*#+}} xmm9 = xmm9[0,1],xmm7[2,3]
; AVX2-NEXT:    vpshufb %ymm8, %ymm2, %ymm10
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm7 = [0,4,0,4,0,4,0,4]
; AVX2-NEXT:    vpermd %ymm10, %ymm7, %ymm10
; AVX2-NEXT:    vpshufb %ymm8, %ymm0, %ymm11
...
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm10 = [2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13]
...
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm12 = [1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14]
; AVX2-NEXT:    vpshufb %xmm12, %xmm4, %xmm13
; AVX2-NEXT:    vpshufb %xmm12, %xmm3, %xmm14
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm13 = xmm14[0],xmm13[0],xmm14[1],xmm13[1]
; AVX2-NEXT:    vpblendd {{.*#+}} xmm11 = xmm13[0,1],xmm11[2,3]
; AVX2-NEXT:    vpshufb %ymm12, %ymm2, %ymm13
; AVX2-NEXT:    vpermd %ymm13, %ymm7, %ymm13
; AVX2-NEXT:    vpshufb %ymm12, %ymm0, %ymm14
; AVX2-NEXT:    vpermd %ymm14, %ymm7, %ymm14
; AVX2-NEXT:    vpblendd {{.*#+}} ymm13 = ymm14[0,1,2,3,4,5],ymm13[6,7]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm11 = ymm11[0,1,2,3],ymm13[4,5,6,7]
; AVX2-NEXT:    vpshufb %xmm12, %xmm6, %xmm13
; AVX2-NEXT:    vpshufb %xmm12, %xmm5, %xmm12
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm12 = xmm12[0],xmm13[0],xmm12[1],xmm13[1]
; AVX2-NEXT:    vpshufb %xmm10, %xmm4, %xmm13
; AVX2-NEXT:    vpshufb %xmm10, %xmm3, %xmm14
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm13 = xmm14[0],xmm13[0],xmm14[1],xmm13[1]
; AVX2-NEXT:    vpblendd {{.*#+}} xmm12 = xmm13[0,1],xmm12[2,3]
; AVX2-NEXT:    vpshufb %ymm10, %ymm2, %ymm13
; AVX2-NEXT:    vpermd %ymm13, %ymm7, %ymm13
; AVX2-NEXT:    vpshufb %ymm10, %ymm0, %ymm10
; AVX2-NEXT:    vpermd %ymm10, %ymm7, %ymm10
; AVX2-NEXT:    vpblendd {{.*#+}} ymm10 = ymm10[0,1,2,3,4,5],ymm13[6,7]
...
; AVX2-FP-NEXT:    vpbroadcastq {{.*#+}} ymm1 = [3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12]
...
; AVX2-FP-NEXT:    vpshufb %xmm1, %xmm6, %xmm7
; AVX2-FP-NEXT:    vpshufb %xmm1, %xmm5, %xmm8
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm7 = xmm8[0],xmm7[0],xmm8[1],xmm7[1]
; AVX2-FP-NEXT:    vpbroadcastq {{.*#+}} ymm8 = [0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15]
; AVX2-FP-NEXT:    vpshufb %xmm8, %xmm4, %xmm9
; AVX2-FP-NEXT:    vpshufb %xmm8, %xmm3, %xmm10
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm9 = xmm9[0,1],xmm7[2,3]
; AVX2-FP-NEXT:    vpshufb %ymm8, %ymm2, %ymm10
; AVX2-FP-NEXT:    vpbroadcastq {{.*#+}} ymm7 = [0,4,0,4,0,4,0,4]
...
; AVX2-FP-NEXT:    vpbroadcastq {{.*#+}} ymm10 = [2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13]
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm6, %xmm11
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm5, %xmm12
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm11 = xmm12[0],xmm11[0],xmm12[1],xmm11[1]
; AVX2-FP-NEXT:    vpbroadcastq {{.*#+}} ymm12 = [1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14]
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm4, %xmm13
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm3, %xmm14
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm13 = xmm14[0],xmm13[0],xmm14[1],xmm13[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm11 = xmm13[0,1],xmm11[2,3]
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm2, %ymm13
; AVX2-FP-NEXT:    vpermd %ymm13, %ymm7, %ymm13
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm0, %ymm14
; AVX2-FP-NEXT:    vpermd %ymm14, %ymm7, %ymm14
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm13 = ymm14[0,1,2,3,4,5],ymm13[6,7]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm11 = ymm11[0,1,2,3],ymm13[4,5,6,7]
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm6, %xmm13
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm5, %xmm12
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm12 = xmm12[0],xmm13[0],xmm12[1],xmm13[1]
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm4, %xmm13
; AVX2-FP-NEXT:    vpshufb %xmm10, %xmm3, %xmm14
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm13 = xmm14[0],xmm13[0],xmm14[1],xmm13[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm12 = xmm13[0,1],xmm12[2,3]
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm2, %ymm13
; AVX2-FP-NEXT:    vpermd %ymm13, %ymm7, %ymm13
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm0, %ymm10
; AVX2-FP-NEXT:    vpermd %ymm10, %ymm7, %ymm10
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm10 = ymm10[0,1,2,3,4,5],ymm13[6,7]
...
; AVX2-FCP-NEXT:    vpbroadcastq {{.*#+}} ymm1 = [3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12]
...
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm6, %xmm7
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm5, %xmm8
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm7 = xmm8[0],xmm7[0],xmm8[1],xmm7[1]
; AVX2-FCP-NEXT:    vpbroadcastq {{.*#+}} ymm8 = [0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15]
; AVX2-FCP-NEXT:    vpshufb %xmm8, %xmm4, %xmm9
; AVX2-FCP-NEXT:    vpshufb %xmm8, %xmm3, %xmm10
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm9 = xmm9[0,1],xmm7[2,3]
; AVX2-FCP-NEXT:    vpshufb %ymm8, %ymm2, %ymm10
; AVX2-FCP-NEXT:    vpbroadcastq {{.*#+}} ymm7 = [0,4,0,4,0,4,0,4]
...
; AVX2-FCP-NEXT:    vpbroadcastq {{.*#+}} ymm10 = [2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13]
...
; AVX2-FCP-NEXT:    vpbroadcastq {{.*#+}} ymm12 = [1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14]
; AVX2-FCP-NEXT:    vpshufb %xmm12, %xmm4, %xmm13
; AVX2-FCP-NEXT:    vpshufb %xmm12, %xmm3, %xmm14
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm13 = xmm14[0],xmm13[0],xmm14[1],xmm13[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm11 = xmm13[0,1],xmm11[2,3]
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm2, %ymm13
; AVX2-FCP-NEXT:    vpermd %ymm13, %ymm7, %ymm13
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm0, %ymm14
; AVX2-FCP-NEXT:    vpermd %ymm14, %ymm7, %ymm14
...
; AVX2-FCP-NEXT:    vpshufb %xmm10, %xmm4, %xmm13
; AVX2-FCP-NEXT:    vpshufb %xmm10, %xmm3, %xmm14
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm13 = xmm14[0],xmm13[0],xmm14[1],xmm13[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm12 = xmm13[0,1],xmm12[2,3]
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm2, %ymm13
; AVX2-FCP-NEXT:    vpermd %ymm13, %ymm7, %ymm13
...
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm6 = [3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12]
; AVX2-NEXT:    vmovdqa (%rdi), %xmm7
; AVX2-NEXT:    vmovdqa 16(%rdi), %xmm2
; AVX2-NEXT:    vmovdqa 32(%rdi), %xmm5
; AVX2-NEXT:    vmovdqa 48(%rdi), %xmm1
; AVX2-NEXT:    vpshufb %xmm6, %xmm1, %xmm0
; AVX2-NEXT:    vmovdqa %xmm1, %xmm10
; AVX2-NEXT:    vpshufb %xmm6, %xmm5, %xmm1
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm14 = [0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15]
; AVX2-NEXT:    vpshufb %xmm14, %xmm2, %xmm1
; AVX2-NEXT:    vmovdqa %xmm2, %xmm8
; AVX2-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vpshufb %xmm14, %xmm7, %xmm2
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
; AVX2-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX2-NEXT:    vpshufb %ymm14, %ymm3, %ymm1
; AVX2-NEXT:    vmovdqa %ymm3, %ymm9
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm3 = [0,4,0,4,0,4,0,4]
; AVX2-NEXT:    vpermd %ymm1, %ymm3, %ymm1
; AVX2-NEXT:    vpshufb %ymm14, %ymm4, %ymm2
...
; AVX2-NEXT:    vpshufb %xmm14, %xmm11, %xmm1
...
; AVX2-NEXT:    vpshufb %ymm14, %ymm13, %ymm1
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm1 = [2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13]
; AVX2-NEXT:    vmovdqa %xmm10, %xmm6
; AVX2-NEXT:    vpshufb %xmm1, %xmm10, %xmm0
; AVX2-NEXT:    vmovdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vpshufb %xmm1, %xmm5, %xmm15
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm15 = xmm15[0],xmm0[0],xmm15[1],xmm0[1]
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm0 = [1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14]
; AVX2-NEXT:    vpshufb %xmm0, %xmm8, %xmm2
; AVX2-NEXT:    vmovdqa %xmm7, %xmm4
...
; AVX2-NEXT:    vpblendd {{.*#+}} xmm8 = xmm2[0,1],xmm15[2,3]
; AVX2-NEXT:    vmovdqa %ymm9, %ymm2
; AVX2-NEXT:    vmovdqu %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpshufb %ymm0, %ymm9, %ymm7
; AVX2-NEXT:    vpermd %ymm7, %ymm3, %ymm7
; AVX2-NEXT:    vmovdqa %ymm12, %ymm10
; AVX2-NEXT:    vpshufb %ymm0, %ymm12, %ymm15
; AVX2-NEXT:    vpermd %ymm15, %ymm3, %ymm15
; AVX2-NEXT:    vpblendd {{.*#+}} ymm7 = ymm15[0,1,2,3,4,5],ymm7[6,7]
...
; AVX2-NEXT:    vpshufb %xmm1, %xmm5, %xmm7
; AVX2-NEXT:    vpshufb %xmm1, %xmm4, %xmm15
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm7 = xmm15[0],xmm7[0],xmm15[1],xmm7[1]
; AVX2-NEXT:    vpblendd {{.*#+}} xmm4 = xmm7[0,1],xmm8[2,3]
; AVX2-NEXT:    vpshufb %ymm1, %ymm2, %ymm7
; AVX2-NEXT:    vpermd %ymm7, %ymm3, %ymm7
; AVX2-NEXT:    vmovdqa %ymm10, %ymm8
; AVX2-NEXT:    vpshufb %ymm1, %ymm10, %ymm15
; AVX2-NEXT:    vpermd %ymm15, %ymm3, %ymm15
; AVX2-NEXT:    vpblendd {{.*#+}} ymm7 = ymm15[0,1,2,3,4,5],ymm7[6,7]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm2 = ymm4[0,1,2,3],ymm7[4,5,6,7]
; AVX2-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovdqa %xmm9, %xmm4
...
; AVX2-NEXT:    vpshufb %ymm1, %ymm10, %ymm2
; AVX2-NEXT:    vpermd %ymm2, %ymm3, %ymm2
; AVX2-NEXT:    vpshufb %ymm1, %ymm13, %ymm1
; AVX2-NEXT:    vpermd %ymm1, %ymm3, %ymm1
; AVX2-NEXT:    vpblendd {{.*#+}} ymm1 = ymm1[0,1,2,3,4,5],ymm2[6,7]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-NEXT:    vpshufb %xmm14, %xmm6, %xmm1
; AVX2-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX2-NEXT:    vpshufb %xmm14, %xmm2, %xmm2
; AVX2-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm6 = [3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12]
; AVX2-NEXT:    vpshufb %xmm6, %xmm5, %xmm2
; AVX2-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
...
; AVX2-NEXT:    vpermd %ymm2, %ymm3, %ymm2
; AVX2-NEXT:    vpshufb %ymm6, %ymm8, %ymm7
; AVX2-NEXT:    vpermd %ymm7, %ymm3, %ymm7
...
; AVX2-NEXT:    vpshufb %xmm6, %xmm11, %xmm7
...
; AVX2-FP-NEXT:    vpbroadcastq {{.*#+}} ymm6 = [3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12]
; AVX2-FP-NEXT:    vmovdqa (%rdi), %xmm7
; AVX2-FP-NEXT:    vmovdqa 16(%rdi), %xmm2
; AVX2-FP-NEXT:    vmovdqa 32(%rdi), %xmm5
; AVX2-FP-NEXT:    vmovdqa 48(%rdi), %xmm1
; AVX2-FP-NEXT:    vpshufb %xmm6, %xmm1, %xmm0
...
; AVX2-FP-NEXT:    vpbroadcastq {{.*#+}} ymm14 = [0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15]
; AVX2-FP-NEXT:    vpshufb %xmm14, %xmm2, %xmm1
; AVX2-FP-NEXT:    vmovdqa %xmm2, %xmm8
; AVX2-FP-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpshufb %xmm14, %xmm7, %xmm2
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX2-FP-NEXT:    vpshufb %ymm14, %ymm3, %ymm1
...
; AVX2-FP-NEXT:    vpshufb %xmm14, %xmm11, %xmm1
...
; AVX2-FP-NEXT:    vpshufb %ymm14, %ymm13, %ymm1
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpbroadcastq {{.*#+}} ymm1 = [2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13]
; AVX2-FP-NEXT:    vmovdqa %xmm10, %xmm6
; AVX2-FP-NEXT:    vpshufb %xmm1, %xmm10, %xmm0
; AVX2-FP-NEXT:    vmovdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpshufb %xmm1, %xmm5, %xmm15
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm15 = xmm15[0],xmm0[0],xmm15[1],xmm0[1]
; AVX2-FP-NEXT:    vpbroadcastq {{.*#+}} ymm0 = [1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14]
; AVX2-FP-NEXT:    vpshufb %xmm0, %xmm8, %xmm2
; AVX2-FP-NEXT:    vmovdqa %xmm7, %xmm4
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm8 = xmm2[0,1],xmm15[2,3]
; AVX2-FP-NEXT:    vmovdqa %ymm9, %ymm2
; AVX2-FP-NEXT:    vmovdqu %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpshufb %ymm0, %ymm9, %ymm7
; AVX2-FP-NEXT:    vpermd %ymm7, %ymm3, %ymm7
; AVX2-FP-NEXT:    vmovdqa %ymm12, %ymm10
; AVX2-FP-NEXT:    vpshufb %ymm0, %ymm12, %ymm15
; AVX2-FP-NEXT:    vpermd %ymm15, %ymm3, %ymm15
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm7 = ymm15[0,1,2,3,4,5],ymm7[6,7]
...
; AVX2-FP-NEXT:    vpshufb %xmm1, %xmm9, %xmm8
; AVX2-FP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; AVX2-FP-NEXT:    vpshufb %xmm1, %xmm12, %xmm7
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm8 = xmm7[0],xmm8[0],xmm7[1],xmm8[1]
...
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm7 = xmm15[0],xmm7[0],xmm15[1],xmm7[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm8 = xmm7[0,1],xmm8[2,3]
; AVX2-FP-NEXT:    vpshufb %ymm0, %ymm13, %ymm7
; AVX2-FP-NEXT:    vpermd %ymm7, %ymm3, %ymm7
; AVX2-FP-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Reload
; AVX2-FP-NEXT:    vpshufb %ymm0, %ymm13, %ymm15
; AVX2-FP-NEXT:    vpermd %ymm15, %ymm3, %ymm15
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm7 = ymm15[0,1,2,3,4,5],ymm7[6,7]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm7 = ymm8[0,1,2,3],ymm7[4,5,6,7]
; AVX2-FP-NEXT:    vmovdqu %ymm7, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpshufb %xmm0, %xmm6, %xmm8
; AVX2-FP-NEXT:    vpshufb %xmm0, %xmm5, %xmm7
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm8 = xmm7[0],xmm8[0],xmm7[1],xmm8[1]
; AVX2-FP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX2-FP-NEXT:    vpshufb %xmm1, %xmm5, %xmm7
; AVX2-FP-NEXT:    vpshufb %xmm1, %xmm4, %xmm15
; AVX2-FP-NEXT:    vpunpckldq {{.*#+}} xmm7 = xmm15[0],xmm7[0],xmm15[1],xmm7[1]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm4 = xmm7[0,1],xmm8[2,3]
; AVX2-FP-NEXT:    vpshufb %ymm1, %ymm2, %ymm7
; AVX2-FP-NEXT:    vpermd %ymm7, %ymm3, %ymm7
; AVX2-FP-NEXT:    vmovdqa %ymm10, %ymm8
; AVX2-FP-NEXT:    vpshufb %ymm1, %ymm10, %ymm15
; AVX2-FP-NEXT:    vpermd %ymm15, %ymm3, %ymm15
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm7 = ymm15[0,1,2,3,4,5],ymm7[6,7]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm2 = ymm4[0,1,2,3],ymm7[4,5,6,7]
; AVX2-FP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vpshufb %xmm14, %xmm4, %xmm2
...
; AVX2-FP-NEXT:    vpshufb %ymm6, %ymm10, %ymm5
...
; AVX2-FCP-NEXT:    vpbroadcastq {{.*#+}} ymm6 = [3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12]
...
; AVX2-FCP-NEXT:    vpbroadcastq {{.*#+}} ymm14 = [0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15,0,4,8,12,3,7,11,15]
; AVX2-FCP-NEXT:    vpshufb %xmm14, %xmm2, %xmm1
; AVX2-FCP-NEXT:    vmovdqa %xmm2, %xmm8
; AVX2-FCP-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vpshufb %xmm14, %xmm7, %xmm2
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm3, %ymm1
...
; AVX2-FCP-NEXT:    vpshufb %xmm14, %xmm11, %xmm1
...
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm13, %ymm1
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm15[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpbroadcastq {{.*#+}} ymm1 = [2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13]
; AVX2-FCP-NEXT:    vmovdqa %xmm10, %xmm6
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm10, %xmm0
; AVX2-FCP-NEXT:    vmovdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm5, %xmm15
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm15 = xmm15[0],xmm0[0],xmm15[1],xmm0[1]
; AVX2-FCP-NEXT:    vpbroadcastq {{.*#+}} ymm0 = [1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14,1,5,9,13,2,6,10,14]
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm8, %xmm2
; AVX2-FCP-NEXT:    vmovdqa %xmm7, %xmm4
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm8 = xmm2[0,1],xmm15[2,3]
; AVX2-FCP-NEXT:    vmovdqa %ymm9, %ymm2
; AVX2-FCP-NEXT:    vmovdqu %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpshufb %ymm0, %ymm9, %ymm7
; AVX2-FCP-NEXT:    vpermd %ymm7, %ymm3, %ymm7
; AVX2-FCP-NEXT:    vmovdqa %ymm12, %ymm10
; AVX2-FCP-NEXT:    vpshufb %ymm0, %ymm12, %ymm15
; AVX2-FCP-NEXT:    vpermd %ymm15, %ymm3, %ymm15
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm7 = ymm15[0,1,2,3,4,5],ymm7[6,7]
...
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm9, %xmm8
; AVX2-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm12, %xmm7
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm8 = xmm7[0],xmm8[0],xmm7[1],xmm8[1]
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm11, %xmm7
; AVX2-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm11, %xmm15
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm7 = xmm15[0],xmm7[0],xmm15[1],xmm7[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm8 = xmm7[0,1],xmm8[2,3]
; AVX2-FCP-NEXT:    vpshufb %ymm0, %ymm13, %ymm7
; AVX2-FCP-NEXT:    vpermd %ymm7, %ymm3, %ymm7
; AVX2-FCP-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Reload
; AVX2-FCP-NEXT:    vpshufb %ymm0, %ymm13, %ymm15
; AVX2-FCP-NEXT:    vpermd %ymm15, %ymm3, %ymm15
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm7 = ymm15[0,1,2,3,4,5],ymm7[6,7]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm7 = ymm8[0,1,2,3],ymm7[4,5,6,7]
; AVX2-FCP-NEXT:    vmovdqu %ymm7, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm6, %xmm8
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm5, %xmm7
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm8 = xmm7[0],xmm8[0],xmm7[1],xmm8[1]
; AVX2-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm5, %xmm7
; AVX2-FCP-NEXT:    vpshufb %xmm1, %xmm4, %xmm15
; AVX2-FCP-NEXT:    vpunpckldq {{.*#+}} xmm7 = xmm15[0],xmm7[0],xmm15[1],xmm7[1]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm4 = xmm7[0,1],xmm8[2,3]
; AVX2-FCP-NEXT:    vpshufb %ymm1, %ymm2, %ymm7
; AVX2-FCP-NEXT:    vpermd %ymm7, %ymm3, %ymm7
; AVX2-FCP-NEXT:    vmovdqa %ymm10, %ymm8
; AVX2-FCP-NEXT:    vpshufb %ymm1, %ymm10, %ymm15
; AVX2-FCP-NEXT:    vpermd %ymm15, %ymm3, %ymm15
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm7 = ymm15[0,1,2,3,4,5],ymm7[6,7]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm2 = ymm4[0,1,2,3],ymm7[4,5,6,7]
; AVX2-FCP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa %xmm9, %xmm4
...
; AVX2-FCP-NEXT:    vpshufb %xmm14, %xmm4, %xmm2
...
; AVX2-FCP-NEXT:    vpshufb %ymm6, %ymm10, %ymm5
; AVX2-FCP-NEXT:    vpshufb %ymm6, %ymm13, %ymm4
