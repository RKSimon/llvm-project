...
; X64-AVX2-NEXT:    retq
;
; AVX512F-LABEL: test_v2i32_v2i16:
; AVX512F:       # %bb.0:
...
; AVX512F-NEXT:    retq
;
; AVX512VL-LABEL: test_v2i32_v2i16:
; AVX512VL:       # %bb.0:
...
; AVX512VL-NEXT:    retq
;
; AVX512BW-LABEL: test_v2i32_v2i16:
; AVX512BW:       # %bb.0:
...
; AVX512BW-NEXT:    retq
;
; AVX512BWVL-LABEL: test_v2i32_v2i16:
; AVX512BWVL:       # %bb.0:
...
; X86-SSE2-NEXT:    paddq %xmm3, %xmm1
; X86-SSE2-NEXT:    psadbw %xmm4, %xmm2
; X86-SSE2-NEXT:    psadbw %xmm4, %xmm0
; X86-SSE2-NEXT:    paddq %xmm2, %xmm0
; X86-SSE2-NEXT:    paddq %xmm1, %xmm0
; X86-SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
; X86-SSE2-NEXT:    paddq %xmm0, %xmm1
...
; X64-SSE2-NEXT:    psadbw %xmm4, %xmm3
; X64-SSE2-NEXT:    psadbw %xmm4, %xmm1
; X64-SSE2-NEXT:    paddq %xmm3, %xmm1
; X64-SSE2-NEXT:    psadbw %xmm4, %xmm2
...
; X64-SSE4-NEXT:    psadbw %xmm4, %xmm3
; X64-SSE4-NEXT:    psadbw %xmm4, %xmm1
; X64-SSE4-NEXT:    paddq %xmm3, %xmm1
; X64-SSE4-NEXT:    psadbw %xmm4, %xmm2
...
; X64-AVX1-NEXT:    vpsadbw %xmm3, %xmm4, %xmm4
; X64-AVX1-NEXT:    vpaddq %xmm2, %xmm4, %xmm2
...
; X86-SSE2-NEXT:    movdqa {{.*#+}} xmm5 = [255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0]
...
; X86-SSE2-NEXT:    pand %xmm5, %xmm0
; X86-SSE2-NEXT:    pand 72(%ebp), %xmm5
; X86-SSE2-NEXT:    pxor %xmm6, %xmm6
; X86-SSE2-NEXT:    psadbw %xmm6, %xmm5
; X86-SSE2-NEXT:    psadbw %xmm6, %xmm0
; X86-SSE2-NEXT:    paddq %xmm5, %xmm0
; X86-SSE2-NEXT:    pxor %xmm5, %xmm5
; X86-SSE2-NEXT:    psadbw %xmm5, %xmm7
; X86-SSE2-NEXT:    psadbw %xmm5, %xmm2
; X86-SSE2-NEXT:    paddq %xmm7, %xmm2
; X86-SSE2-NEXT:    paddq %xmm0, %xmm2
; X86-SSE2-NEXT:    psadbw %xmm5, %xmm4
; X86-SSE2-NEXT:    psadbw %xmm5, %xmm3
...
; X86-SSE4-NEXT:    pmovzxbd {{.*#+}} xmm5 = [255,255,255,255]
...
; X86-SSE4-NEXT:    movdqa %xmm0, (%esp) # 16-byte Spill
...
; X86-SSE4-NEXT:    pand %xmm5, %xmm0
; X86-SSE4-NEXT:    pand 72(%ebp), %xmm5
; X86-SSE4-NEXT:    pxor %xmm6, %xmm6
; X86-SSE4-NEXT:    psadbw %xmm6, %xmm5
; X86-SSE4-NEXT:    psadbw %xmm6, %xmm0
; X86-SSE4-NEXT:    paddq %xmm5, %xmm0
; X86-SSE4-NEXT:    pxor %xmm5, %xmm5
; X86-SSE4-NEXT:    psadbw %xmm5, %xmm7
; X86-SSE4-NEXT:    psadbw %xmm5, %xmm2
; X86-SSE4-NEXT:    paddq %xmm7, %xmm2
; X86-SSE4-NEXT:    paddq %xmm0, %xmm2
; X86-SSE4-NEXT:    psadbw %xmm5, %xmm4
; X86-SSE4-NEXT:    psadbw %xmm5, %xmm3
; X86-SSE4-NEXT:    paddq %xmm4, %xmm3
; X86-SSE4-NEXT:    movdqa (%esp), %xmm4 # 16-byte Reload
; X86-SSE4-NEXT:    psadbw %xmm5, %xmm4
...
; X64-SSE4-NEXT:    retq
;
; X86-AVX1-LABEL: test_v32i32_v32i8:
; X86-AVX1:       # %bb.0:
; X86-AVX1-NEXT:    pushl %ebp
; X86-AVX1-NEXT:    movl %esp, %ebp
; X86-AVX1-NEXT:    andl $-32, %esp
; X86-AVX1-NEXT:    subl $32, %esp
; X86-AVX1-NEXT:    vbroadcastss {{.*#+}} ymm4 = [255,255,255,255,255,255,255,255]
; X86-AVX1-NEXT:    vandps %ymm4, %ymm0, %ymm0
; X86-AVX1-NEXT:    vandps %ymm4, %ymm2, %ymm2
; X86-AVX1-NEXT:    vandps %ymm4, %ymm1, %ymm3
; X86-AVX1-NEXT:    vandps 8(%ebp), %ymm4, %ymm4
; X86-AVX1-NEXT:    vextractf128 $1, %ymm4, %xmm5
; X86-AVX1-NEXT:    vxorps %xmm1, %xmm1, %xmm1
; X86-AVX1-NEXT:    vpsadbw %xmm1, %xmm5, %xmm5
; X86-AVX1-NEXT:    vextractf128 $1, %ymm3, %xmm6
; X86-AVX1-NEXT:    vpsadbw %xmm1, %xmm6, %xmm6
; X86-AVX1-NEXT:    vpaddq %xmm5, %xmm6, %xmm5
; X86-AVX1-NEXT:    vextractf128 $1, %ymm2, %xmm6
; X86-AVX1-NEXT:    vpsadbw %xmm1, %xmm6, %xmm6
; X86-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm7
; X86-AVX1-NEXT:    vpsadbw %xmm1, %xmm7, %xmm7
; X86-AVX1-NEXT:    vpaddq %xmm6, %xmm7, %xmm6
; X86-AVX1-NEXT:    vpaddq %xmm5, %xmm6, %xmm5
; X86-AVX1-NEXT:    vpsadbw %xmm1, %xmm4, %xmm4
; X86-AVX1-NEXT:    vpsadbw %xmm1, %xmm3, %xmm3
...
; X86-AVX1-NEXT:    retl
;
; X64-AVX1-LABEL: test_v32i32_v32i8:
; X64-AVX1:       # %bb.0:
; X64-AVX1-NEXT:    vbroadcastss {{.*#+}} ymm4 = [255,255,255,255,255,255,255,255]
; X64-AVX1-NEXT:    vandps %ymm4, %ymm0, %ymm0
; X64-AVX1-NEXT:    vandps %ymm4, %ymm2, %ymm2
; X64-AVX1-NEXT:    vandps %ymm4, %ymm1, %ymm1
; X64-AVX1-NEXT:    vandps %ymm4, %ymm3, %ymm3
; X64-AVX1-NEXT:    vextractf128 $1, %ymm3, %xmm4
; X64-AVX1-NEXT:    vpxor %xmm5, %xmm5, %xmm5
; X64-AVX1-NEXT:    vpsadbw %xmm5, %xmm4, %xmm4
; X64-AVX1-NEXT:    vextractf128 $1, %ymm1, %xmm6
; X64-AVX1-NEXT:    vpsadbw %xmm5, %xmm6, %xmm6
; X64-AVX1-NEXT:    vpaddq %xmm4, %xmm6, %xmm4
; X64-AVX1-NEXT:    vextractf128 $1, %ymm2, %xmm6
; X64-AVX1-NEXT:    vpsadbw %xmm5, %xmm6, %xmm6
; X64-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm7
; X64-AVX1-NEXT:    vpsadbw %xmm5, %xmm7, %xmm7
; X64-AVX1-NEXT:    vpaddq %xmm6, %xmm7, %xmm6
; X64-AVX1-NEXT:    vpaddq %xmm4, %xmm6, %xmm4
; X64-AVX1-NEXT:    vpsadbw %xmm5, %xmm3, %xmm3
; X64-AVX1-NEXT:    vpsadbw %xmm5, %xmm1, %xmm1
; X64-AVX1-NEXT:    vpaddq %xmm3, %xmm1, %xmm1
; X64-AVX1-NEXT:    vpsadbw %xmm5, %xmm2, %xmm2
; X64-AVX1-NEXT:    vpsadbw %xmm5, %xmm0, %xmm0
; X64-AVX1-NEXT:    vpaddq %xmm2, %xmm0, %xmm0
; X64-AVX1-NEXT:    vpaddq %xmm1, %xmm0, %xmm0
; X64-AVX1-NEXT:    vpaddq %xmm4, %xmm0, %xmm0
; X64-AVX1-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
...
; X86-AVX2-NEXT:    vpand %ymm3, %ymm2, %ymm2
; X86-AVX2-NEXT:    vpand %ymm3, %ymm1, %ymm1
; X86-AVX2-NEXT:    vpand 8(%ebp), %ymm3, %ymm3
; X86-AVX2-NEXT:    vpxor %xmm4, %xmm4, %xmm4
; X86-AVX2-NEXT:    vpsadbw %ymm4, %ymm3, %ymm3
; X86-AVX2-NEXT:    vpsadbw %ymm4, %ymm1, %ymm1
; X86-AVX2-NEXT:    vpaddq %ymm3, %ymm1, %ymm1
; X86-AVX2-NEXT:    vpsadbw %ymm4, %ymm2, %ymm2
; X86-AVX2-NEXT:    vpsadbw %ymm4, %ymm0, %ymm0
; X86-AVX2-NEXT:    vpaddq %ymm2, %ymm0, %ymm0
; X86-AVX2-NEXT:    vpaddq %ymm1, %ymm0, %ymm0
; X86-AVX2-NEXT:    vextracti128 $1, %ymm0, %xmm1
; X86-AVX2-NEXT:    vpaddq %xmm1, %xmm0, %xmm0
...
; X64-AVX2-NEXT:    retq
;
; AVX512F-LABEL: test_v32i32_v32i8:
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    vpbroadcastd {{.*#+}} zmm2 = [255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0]
...
; AVX512F-NEXT:    vpsadbw %ymm3, %ymm4, %ymm4
...
; AVX512F-NEXT:    retq
;
; AVX512VL-LABEL: test_v32i32_v32i8:
; AVX512VL:       # %bb.0:
; AVX512VL-NEXT:    vpbroadcastd {{.*#+}} zmm2 = [255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0]
...
; AVX512VL-NEXT:    vpsadbw %ymm3, %ymm4, %ymm4
; AVX512VL-NEXT:    vpaddq %ymm2, %ymm4, %ymm2
...
; AVX512VL-NEXT:    retq
;
; AVX512BW-LABEL: test_v32i32_v32i8:
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vpbroadcastd {{.*#+}} zmm2 = [255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0]
; AVX512BW-NEXT:    vpandq %zmm2, %zmm1, %zmm1
; AVX512BW-NEXT:    vpxor %xmm3, %xmm3, %xmm3
; AVX512BW-NEXT:    vpsadbw %zmm3, %zmm1, %zmm1
; AVX512BW-NEXT:    vpandq %zmm2, %zmm0, %zmm0
; AVX512BW-NEXT:    vpsadbw %zmm3, %zmm0, %zmm0
...
; AVX512BW-NEXT:    retq
;
; AVX512BWVL-LABEL: test_v32i32_v32i8:
; AVX512BWVL:       # %bb.0:
; AVX512BWVL-NEXT:    vpbroadcastd {{.*#+}} zmm2 = [255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0,255,0,0,0]
; AVX512BWVL-NEXT:    vpandq %zmm2, %zmm1, %zmm1
; AVX512BWVL-NEXT:    vpxor %xmm3, %xmm3, %xmm3
; AVX512BWVL-NEXT:    vpsadbw %zmm3, %zmm1, %zmm1
; AVX512BWVL-NEXT:    vpandq %zmm2, %zmm0, %zmm0
; AVX512BWVL-NEXT:    vpsadbw %zmm3, %zmm0, %zmm0
...
; AVX512F-NEXT:    retq
;
; AVX512VL-LABEL: test_v2i16_v2i8:
; AVX512VL:       # %bb.0:
...
; X64-SSE-NEXT:    retq
;
; X86-AVX1-LABEL: test_v32i16_v32i8:
; X86-AVX1:       # %bb.0:
; X86-AVX1-NEXT:    vpsrlw $8, %xmm0, %xmm2
; X86-AVX1-NEXT:    vpsrlw $8, %xmm1, %xmm3
; X86-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm0
...
; X86-AVX1-NEXT:    vpaddq %xmm1, %xmm0, %xmm0
; X86-AVX1-NEXT:    vpsadbw %xmm4, %xmm3, %xmm1
...
; X64-AVX1-NEXT:    retq
;
; X86-AVX2-LABEL: test_v32i16_v32i8:
; X86-AVX2:       # %bb.0:
...
; X86-AVX2-NEXT:    retl
;
; X64-AVX2-LABEL: test_v32i16_v32i8:
; X64-AVX2:       # %bb.0:
; X64-AVX2-NEXT:    vpsrlw $8, %ymm0, %ymm0
; X64-AVX2-NEXT:    vpsrlw $8, %ymm1, %ymm1
...
; X86-SSE2-NEXT:    andl $-16, %esp
; X86-SSE2-NEXT:    subl $16, %esp
; X86-SSE2-NEXT:    movdqa {{.*#+}} xmm4 = [127,127,127,127,127,127,127,127]
...
; X86-SSE4-NEXT:    andl $-16, %esp
; X86-SSE4-NEXT:    subl $16, %esp
; X86-SSE4-NEXT:    pmovsxbw {{.*#+}} xmm4 = [127,127,127,127,127,127,127,127]
