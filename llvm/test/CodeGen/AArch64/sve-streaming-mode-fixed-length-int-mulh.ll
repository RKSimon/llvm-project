...
; SVE-NEXT:    mov w9, #24 // =0x18
; SVE-NEXT:    mov w10, #8 // =0x8
; SVE-NEXT:    ld1sb { z0.h }, p0/z, [x0, x8]
; SVE-NEXT:    ld1sb { z1.h }, p0/z, [x1, x8]
; SVE-NEXT:    ld1sb { z2.h }, p0/z, [x0, x9]
; SVE-NEXT:    ld1sb { z3.h }, p0/z, [x1, x9]
; SVE-NEXT:    ld1sb { z4.h }, p0/z, [x0, x10]
; SVE-NEXT:    ld1sb { z5.h }, p0/z, [x1, x10]
; SVE-NEXT:    ld1sb { z6.h }, p0/z, [x0]
; SVE-NEXT:    ld1sb { z7.h }, p0/z, [x1]
; SVE-NEXT:    mul z0.h, p0/m, z0.h, z1.h
; SVE-NEXT:    mul z2.h, p0/m, z2.h, z3.h
; SVE-NEXT:    mul z4.h, p0/m, z4.h, z5.h
; SVE-NEXT:    mul z6.h, p0/m, z6.h, z7.h
; SVE-NEXT:    lsr z0.h, z0.h, #8
; SVE-NEXT:    lsr z1.h, z2.h, #8
; SVE-NEXT:    lsr z2.h, z4.h, #8
; SVE-NEXT:    lsr z3.h, z6.h, #8
; SVE-NEXT:    st1b { z0.h }, p0, [x0, x8]
; SVE-NEXT:    st1b { z1.h }, p0, [x0, x9]
; SVE-NEXT:    st1b { z2.h }, p0, [x0, x10]
; SVE-NEXT:    st1b { z3.h }, p0, [x0]
; SVE-NEXT:    ret
;
; SVE2-LABEL: smulh_v32i8:
; SVE2:       // %bb.0:
; SVE2-NEXT:    ptrue p0.h, vl8
; SVE2-NEXT:    mov w8, #16 // =0x10
; SVE2-NEXT:    mov w9, #24 // =0x18
; SVE2-NEXT:    mov w10, #8 // =0x8
; SVE2-NEXT:    ld1sb { z0.h }, p0/z, [x0, x8]
; SVE2-NEXT:    ld1sb { z1.h }, p0/z, [x1, x8]
; SVE2-NEXT:    ld1sb { z2.h }, p0/z, [x0, x9]
; SVE2-NEXT:    ld1sb { z3.h }, p0/z, [x1, x9]
; SVE2-NEXT:    ld1sb { z4.h }, p0/z, [x0, x10]
; SVE2-NEXT:    ld1sb { z5.h }, p0/z, [x1, x10]
; SVE2-NEXT:    ld1sb { z6.h }, p0/z, [x0]
; SVE2-NEXT:    ld1sb { z7.h }, p0/z, [x1]
; SVE2-NEXT:    mul z0.h, z0.h, z1.h
; SVE2-NEXT:    mul z1.h, z2.h, z3.h
; SVE2-NEXT:    mul z2.h, z4.h, z5.h
...
; SVE2-NEXT:    st1b { z0.h }, p0, [x0, x8]
; SVE2-NEXT:    st1b { z1.h }, p0, [x0, x9]
; SVE2-NEXT:    st1b { z2.h }, p0, [x0, x10]
; SVE2-NEXT:    st1b { z3.h }, p0, [x0]
; SVE2-NEXT:    ret
;
...
; SVE-NEXT:    mov x9, #12 // =0xc
; SVE-NEXT:    mov x10, #4 // =0x4
; SVE-NEXT:    ld1sh { z0.s }, p0/z, [x0, x8, lsl #1]
; SVE-NEXT:    ld1sh { z1.s }, p0/z, [x1, x8, lsl #1]
; SVE-NEXT:    ld1sh { z2.s }, p0/z, [x0, x9, lsl #1]
; SVE-NEXT:    ld1sh { z3.s }, p0/z, [x1, x9, lsl #1]
; SVE-NEXT:    ld1sh { z4.s }, p0/z, [x0, x10, lsl #1]
; SVE-NEXT:    ld1sh { z5.s }, p0/z, [x1, x10, lsl #1]
; SVE-NEXT:    ld1sh { z6.s }, p0/z, [x0]
; SVE-NEXT:    ld1sh { z7.s }, p0/z, [x1]
; SVE-NEXT:    mul z0.s, p0/m, z0.s, z1.s
; SVE-NEXT:    mul z2.s, p0/m, z2.s, z3.s
; SVE-NEXT:    mul z4.s, p0/m, z4.s, z5.s
; SVE-NEXT:    mul z6.s, p0/m, z6.s, z7.s
; SVE-NEXT:    lsr z0.s, z0.s, #16
; SVE-NEXT:    lsr z1.s, z2.s, #16
; SVE-NEXT:    lsr z2.s, z4.s, #16
; SVE-NEXT:    lsr z3.s, z6.s, #16
; SVE-NEXT:    st1h { z0.s }, p0, [x0, x8, lsl #1]
; SVE-NEXT:    st1h { z1.s }, p0, [x0, x9, lsl #1]
; SVE-NEXT:    st1h { z2.s }, p0, [x0, x10, lsl #1]
; SVE-NEXT:    st1h { z3.s }, p0, [x0]
; SVE-NEXT:    ret
;
...
; SVE2-NEXT:    mov x9, #12 // =0xc
; SVE2-NEXT:    mov x10, #4 // =0x4
; SVE2-NEXT:    ld1sh { z0.s }, p0/z, [x0, x8, lsl #1]
; SVE2-NEXT:    ld1sh { z1.s }, p0/z, [x1, x8, lsl #1]
; SVE2-NEXT:    ld1sh { z2.s }, p0/z, [x0, x9, lsl #1]
; SVE2-NEXT:    ld1sh { z3.s }, p0/z, [x1, x9, lsl #1]
; SVE2-NEXT:    ld1sh { z4.s }, p0/z, [x0, x10, lsl #1]
; SVE2-NEXT:    ld1sh { z5.s }, p0/z, [x1, x10, lsl #1]
; SVE2-NEXT:    ld1sh { z6.s }, p0/z, [x0]
; SVE2-NEXT:    ld1sh { z7.s }, p0/z, [x1]
; SVE2-NEXT:    mul z0.s, z0.s, z1.s
; SVE2-NEXT:    mul z1.s, z2.s, z3.s
; SVE2-NEXT:    mul z2.s, z4.s, z5.s
; SVE2-NEXT:    mul z3.s, z6.s, z7.s
; SVE2-NEXT:    lsr z0.s, z0.s, #16
; SVE2-NEXT:    lsr z1.s, z1.s, #16
; SVE2-NEXT:    lsr z2.s, z2.s, #16
; SVE2-NEXT:    lsr z3.s, z3.s, #16
; SVE2-NEXT:    st1h { z0.s }, p0, [x0, x8, lsl #1]
; SVE2-NEXT:    st1h { z1.s }, p0, [x0, x9, lsl #1]
; SVE2-NEXT:    st1h { z2.s }, p0, [x0, x10, lsl #1]
; SVE2-NEXT:    st1h { z3.s }, p0, [x0]
; SVE2-NEXT:    ret
;
...
; SVE-NEXT:    mov x10, #2 // =0x2
; SVE-NEXT:    ld1sw { z0.d }, p0/z, [x0, x8, lsl #2]
; SVE-NEXT:    ld1sw { z1.d }, p0/z, [x1, x8, lsl #2]
; SVE-NEXT:    ld1sw { z2.d }, p0/z, [x0, x9, lsl #2]
; SVE-NEXT:    ld1sw { z3.d }, p0/z, [x1, x9, lsl #2]
; SVE-NEXT:    ld1sw { z4.d }, p0/z, [x0, x10, lsl #2]
; SVE-NEXT:    ld1sw { z5.d }, p0/z, [x1, x10, lsl #2]
; SVE-NEXT:    ld1sw { z6.d }, p0/z, [x0]
; SVE-NEXT:    ld1sw { z7.d }, p0/z, [x1]
; SVE-NEXT:    mul z0.d, p0/m, z0.d, z1.d
; SVE-NEXT:    mul z2.d, p0/m, z2.d, z3.d
; SVE-NEXT:    mul z4.d, p0/m, z4.d, z5.d
; SVE-NEXT:    mul z6.d, p0/m, z6.d, z7.d
; SVE-NEXT:    lsr z0.d, z0.d, #32
; SVE-NEXT:    lsr z1.d, z2.d, #32
; SVE-NEXT:    lsr z2.d, z4.d, #32
; SVE-NEXT:    lsr z3.d, z6.d, #32
; SVE-NEXT:    st1w { z0.d }, p0, [x0, x8, lsl #2]
; SVE-NEXT:    st1w { z1.d }, p0, [x0, x9, lsl #2]
; SVE-NEXT:    st1w { z2.d }, p0, [x0, x10, lsl #2]
; SVE-NEXT:    st1w { z3.d }, p0, [x0]
; SVE-NEXT:    ret
;
...
; SVE2-NEXT:    mov x9, #6 // =0x6
; SVE2-NEXT:    mov x10, #2 // =0x2
; SVE2-NEXT:    ld1sw { z0.d }, p0/z, [x0, x8, lsl #2]
; SVE2-NEXT:    ld1sw { z1.d }, p0/z, [x1, x8, lsl #2]
; SVE2-NEXT:    ld1sw { z2.d }, p0/z, [x0, x9, lsl #2]
; SVE2-NEXT:    ld1sw { z3.d }, p0/z, [x1, x9, lsl #2]
; SVE2-NEXT:    ld1sw { z4.d }, p0/z, [x0, x10, lsl #2]
; SVE2-NEXT:    ld1sw { z5.d }, p0/z, [x1, x10, lsl #2]
; SVE2-NEXT:    ld1sw { z6.d }, p0/z, [x0]
; SVE2-NEXT:    ld1sw { z7.d }, p0/z, [x1]
; SVE2-NEXT:    mul z0.d, z0.d, z1.d
; SVE2-NEXT:    mul z1.d, z2.d, z3.d
; SVE2-NEXT:    mul z2.d, z4.d, z5.d
...
; SVE2-NEXT:    st1w { z0.d }, p0, [x0, x8, lsl #2]
; SVE2-NEXT:    st1w { z1.d }, p0, [x0, x9, lsl #2]
; SVE2-NEXT:    st1w { z2.d }, p0, [x0, x10, lsl #2]
; SVE2-NEXT:    st1w { z3.d }, p0, [x0]
; SVE2-NEXT:    ret
;
...
; SVE-NEXT:    ld1b { z1.h }, p0/z, [x1, x8]
; SVE-NEXT:    ld1b { z2.h }, p0/z, [x0, x9]
; SVE-NEXT:    ld1b { z3.h }, p0/z, [x1, x9]
; SVE-NEXT:    ld1b { z4.h }, p0/z, [x0, x10]
; SVE-NEXT:    ld1b { z5.h }, p0/z, [x1, x10]
; SVE-NEXT:    ld1b { z6.h }, p0/z, [x0]
...
; SVE2-NEXT:    ld1b { z1.h }, p0/z, [x1, x8]
; SVE2-NEXT:    ld1b { z2.h }, p0/z, [x0, x9]
; SVE2-NEXT:    ld1b { z3.h }, p0/z, [x1, x9]
; SVE2-NEXT:    ld1b { z4.h }, p0/z, [x0, x10]
; SVE2-NEXT:    ld1b { z5.h }, p0/z, [x1, x10]
...
; SVE-NEXT:    ld1h { z1.s }, p0/z, [x1, x8, lsl #1]
; SVE-NEXT:    ld1h { z2.s }, p0/z, [x0, x9, lsl #1]
; SVE-NEXT:    ld1h { z3.s }, p0/z, [x1, x9, lsl #1]
; SVE-NEXT:    ld1h { z4.s }, p0/z, [x0, x10, lsl #1]
; SVE-NEXT:    ld1h { z5.s }, p0/z, [x1, x10, lsl #1]
; SVE-NEXT:    ld1h { z6.s }, p0/z, [x0]
...
; SVE2-NEXT:    ld1h { z1.s }, p0/z, [x1, x8, lsl #1]
; SVE2-NEXT:    ld1h { z2.s }, p0/z, [x0, x9, lsl #1]
; SVE2-NEXT:    ld1h { z3.s }, p0/z, [x1, x9, lsl #1]
; SVE2-NEXT:    ld1h { z4.s }, p0/z, [x0, x10, lsl #1]
; SVE2-NEXT:    ld1h { z5.s }, p0/z, [x1, x10, lsl #1]
...
; SVE-NEXT:    ld1w { z2.d }, p0/z, [x0, x9, lsl #2]
; SVE-NEXT:    ld1w { z3.d }, p0/z, [x1, x9, lsl #2]
; SVE-NEXT:    ld1w { z4.d }, p0/z, [x0, x10, lsl #2]
; SVE-NEXT:    ld1w { z5.d }, p0/z, [x1, x10, lsl #2]
; SVE-NEXT:    ld1w { z6.d }, p0/z, [x0]
...
; SVE2-NEXT:    ld1w { z2.d }, p0/z, [x0, x9, lsl #2]
; SVE2-NEXT:    ld1w { z3.d }, p0/z, [x1, x9, lsl #2]
; SVE2-NEXT:    ld1w { z4.d }, p0/z, [x0, x10, lsl #2]
; SVE2-NEXT:    ld1w { z5.d }, p0/z, [x1, x10, lsl #2]
