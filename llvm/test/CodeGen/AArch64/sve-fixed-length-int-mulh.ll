...
; VBITS_GE_256-NEXT:    mov w9, #48 // =0x30
; VBITS_GE_256-NEXT:    mov w10, #16 // =0x10
; VBITS_GE_256-NEXT:    ld1sb { z0.h }, p0/z, [x0, x8]
; VBITS_GE_256-NEXT:    ld1sb { z1.h }, p0/z, [x1, x8]
; VBITS_GE_256-NEXT:    ld1sb { z2.h }, p0/z, [x0, x9]
; VBITS_GE_256-NEXT:    ld1sb { z3.h }, p0/z, [x1, x9]
; VBITS_GE_256-NEXT:    ld1sb { z4.h }, p0/z, [x0, x10]
; VBITS_GE_256-NEXT:    ld1sb { z5.h }, p0/z, [x1, x10]
; VBITS_GE_256-NEXT:    ld1sb { z6.h }, p0/z, [x0]
; VBITS_GE_256-NEXT:    ld1sb { z7.h }, p0/z, [x1]
; VBITS_GE_256-NEXT:    mul z0.h, p0/m, z0.h, z1.h
; VBITS_GE_256-NEXT:    mul z2.h, p0/m, z2.h, z3.h
; VBITS_GE_256-NEXT:    mul z4.h, p0/m, z4.h, z5.h
; VBITS_GE_256-NEXT:    mul z6.h, p0/m, z6.h, z7.h
; VBITS_GE_256-NEXT:    lsr z0.h, z0.h, #8
; VBITS_GE_256-NEXT:    lsr z1.h, z2.h, #8
; VBITS_GE_256-NEXT:    lsr z2.h, z4.h, #8
; VBITS_GE_256-NEXT:    lsr z3.h, z6.h, #8
; VBITS_GE_256-NEXT:    st1b { z0.h }, p0, [x0, x8]
; VBITS_GE_256-NEXT:    st1b { z1.h }, p0, [x0, x9]
; VBITS_GE_256-NEXT:    st1b { z2.h }, p0, [x0, x10]
; VBITS_GE_256-NEXT:    st1b { z3.h }, p0, [x0]
...
; VBITS_EQ_512-NEXT:    ld1sb { z1.h }, p0/z, [x1, x8]
; VBITS_EQ_512-NEXT:    ld1sb { z2.h }, p0/z, [x0]
; VBITS_EQ_512-NEXT:    ld1sb { z3.h }, p0/z, [x1]
; VBITS_EQ_512-NEXT:    mul z0.h, p0/m, z0.h, z1.h
; VBITS_EQ_512-NEXT:    mul z2.h, p0/m, z2.h, z3.h
; VBITS_EQ_512-NEXT:    lsr z0.h, z0.h, #8
; VBITS_EQ_512-NEXT:    lsr z1.h, z2.h, #8
; VBITS_EQ_512-NEXT:    st1b { z0.h }, p0, [x0, x8]
; VBITS_EQ_512-NEXT:    st1b { z1.h }, p0, [x0]
; VBITS_EQ_512-NEXT:    ret
;
; VBITS_GT_512-LABEL: smulh_v64i8:
; VBITS_GT_512:       // %bb.0:
; VBITS_GT_512-NEXT:    ptrue p0.h, vl64
; VBITS_GT_512-NEXT:    ld1sb { z0.h }, p0/z, [x0]
; VBITS_GT_512-NEXT:    ld1sb { z1.h }, p0/z, [x1]
; VBITS_GT_512-NEXT:    mul z0.h, p0/m, z0.h, z1.h
; VBITS_GT_512-NEXT:    lsr z0.h, z0.h, #8
; VBITS_GT_512-NEXT:    st1b { z0.h }, p0, [x0]
...
; CHECK-NEXT:    ld1sh { z1.s }, p0/z, [x1, x8, lsl #1]
; CHECK-NEXT:    ld1sh { z2.s }, p0/z, [x0]
; CHECK-NEXT:    ld1sh { z3.s }, p0/z, [x1]
; CHECK-NEXT:    mul z0.s, p0/m, z0.s, z1.s
; CHECK-NEXT:    mul z2.s, p0/m, z2.s, z3.s
; CHECK-NEXT:    lsr z0.s, z0.s, #16
; CHECK-NEXT:    lsr z1.s, z2.s, #16
; CHECK-NEXT:    st1h { z0.s }, p0, [x0, x8, lsl #1]
...
; VBITS_GE_256-NEXT:    ld1sh { z1.s }, p0/z, [x1, x8, lsl #1]
; VBITS_GE_256-NEXT:    ld1sh { z2.s }, p0/z, [x0, x9, lsl #1]
; VBITS_GE_256-NEXT:    ld1sh { z3.s }, p0/z, [x1, x9, lsl #1]
; VBITS_GE_256-NEXT:    ld1sh { z4.s }, p0/z, [x0, x10, lsl #1]
; VBITS_GE_256-NEXT:    ld1sh { z5.s }, p0/z, [x1, x10, lsl #1]
; VBITS_GE_256-NEXT:    ld1sh { z6.s }, p0/z, [x0]
; VBITS_GE_256-NEXT:    ld1sh { z7.s }, p0/z, [x1]
; VBITS_GE_256-NEXT:    mul z0.s, p0/m, z0.s, z1.s
; VBITS_GE_256-NEXT:    mul z2.s, p0/m, z2.s, z3.s
; VBITS_GE_256-NEXT:    mul z4.s, p0/m, z4.s, z5.s
; VBITS_GE_256-NEXT:    mul z6.s, p0/m, z6.s, z7.s
; VBITS_GE_256-NEXT:    lsr z0.s, z0.s, #16
; VBITS_GE_256-NEXT:    lsr z1.s, z2.s, #16
; VBITS_GE_256-NEXT:    lsr z2.s, z4.s, #16
; VBITS_GE_256-NEXT:    lsr z3.s, z6.s, #16
; VBITS_GE_256-NEXT:    st1h { z0.s }, p0, [x0, x8, lsl #1]
; VBITS_GE_256-NEXT:    st1h { z1.s }, p0, [x0, x9, lsl #1]
; VBITS_GE_256-NEXT:    st1h { z2.s }, p0, [x0, x10, lsl #1]
; VBITS_GE_256-NEXT:    st1h { z3.s }, p0, [x0]
; VBITS_GE_256-NEXT:    ret
;
...
; VBITS_EQ_512-NEXT:    ld1sh { z1.s }, p0/z, [x1, x8, lsl #1]
; VBITS_EQ_512-NEXT:    ld1sh { z2.s }, p0/z, [x0]
; VBITS_EQ_512-NEXT:    ld1sh { z3.s }, p0/z, [x1]
; VBITS_EQ_512-NEXT:    mul z0.s, p0/m, z0.s, z1.s
; VBITS_EQ_512-NEXT:    mul z2.s, p0/m, z2.s, z3.s
; VBITS_EQ_512-NEXT:    lsr z0.s, z0.s, #16
; VBITS_EQ_512-NEXT:    lsr z1.s, z2.s, #16
; VBITS_EQ_512-NEXT:    st1h { z0.s }, p0, [x0, x8, lsl #1]
; VBITS_EQ_512-NEXT:    st1h { z1.s }, p0, [x0]
; VBITS_EQ_512-NEXT:    ret
;
; VBITS_GT_512-LABEL: smulh_v32i16:
; VBITS_GT_512:       // %bb.0:
; VBITS_GT_512-NEXT:    ptrue p0.s, vl32
; VBITS_GT_512-NEXT:    ld1sh { z0.s }, p0/z, [x0]
; VBITS_GT_512-NEXT:    ld1sh { z1.s }, p0/z, [x1]
; VBITS_GT_512-NEXT:    mul z0.s, p0/m, z0.s, z1.s
; VBITS_GT_512-NEXT:    lsr z0.s, z0.s, #16
; VBITS_GT_512-NEXT:    st1h { z0.s }, p0, [x0]
; VBITS_GT_512-NEXT:    ret
...
; CHECK-NEXT:    ld1sw { z1.d }, p0/z, [x1, x8, lsl #2]
; CHECK-NEXT:    ld1sw { z2.d }, p0/z, [x0]
...
; CHECK-NEXT:    st1w { z0.d }, p0, [x0, x8, lsl #2]
...
; VBITS_GE_256-NEXT:    mov x9, #12 // =0xc
; VBITS_GE_256-NEXT:    mov x10, #4 // =0x4
; VBITS_GE_256-NEXT:    ld1sw { z0.d }, p0/z, [x0, x8, lsl #2]
; VBITS_GE_256-NEXT:    ld1sw { z1.d }, p0/z, [x1, x8, lsl #2]
; VBITS_GE_256-NEXT:    ld1sw { z2.d }, p0/z, [x0, x9, lsl #2]
; VBITS_GE_256-NEXT:    ld1sw { z3.d }, p0/z, [x1, x9, lsl #2]
; VBITS_GE_256-NEXT:    ld1sw { z4.d }, p0/z, [x0, x10, lsl #2]
; VBITS_GE_256-NEXT:    ld1sw { z5.d }, p0/z, [x1, x10, lsl #2]
; VBITS_GE_256-NEXT:    ld1sw { z6.d }, p0/z, [x0]
; VBITS_GE_256-NEXT:    ld1sw { z7.d }, p0/z, [x1]
; VBITS_GE_256-NEXT:    mul z0.d, p0/m, z0.d, z1.d
; VBITS_GE_256-NEXT:    mul z2.d, p0/m, z2.d, z3.d
; VBITS_GE_256-NEXT:    mul z4.d, p0/m, z4.d, z5.d
; VBITS_GE_256-NEXT:    mul z6.d, p0/m, z6.d, z7.d
; VBITS_GE_256-NEXT:    lsr z0.d, z0.d, #32
; VBITS_GE_256-NEXT:    lsr z1.d, z2.d, #32
; VBITS_GE_256-NEXT:    lsr z2.d, z4.d, #32
; VBITS_GE_256-NEXT:    lsr z3.d, z6.d, #32
; VBITS_GE_256-NEXT:    st1w { z0.d }, p0, [x0, x8, lsl #2]
; VBITS_GE_256-NEXT:    st1w { z1.d }, p0, [x0, x9, lsl #2]
; VBITS_GE_256-NEXT:    st1w { z2.d }, p0, [x0, x10, lsl #2]
; VBITS_GE_256-NEXT:    st1w { z3.d }, p0, [x0]
; VBITS_GE_256-NEXT:    ret
;
...
; VBITS_EQ_512-NEXT:    ld1sw { z1.d }, p0/z, [x1, x8, lsl #2]
; VBITS_EQ_512-NEXT:    ld1sw { z2.d }, p0/z, [x0]
; VBITS_EQ_512-NEXT:    ld1sw { z3.d }, p0/z, [x1]
; VBITS_EQ_512-NEXT:    mul z0.d, p0/m, z0.d, z1.d
; VBITS_EQ_512-NEXT:    mul z2.d, p0/m, z2.d, z3.d
; VBITS_EQ_512-NEXT:    lsr z0.d, z0.d, #32
; VBITS_EQ_512-NEXT:    lsr z1.d, z2.d, #32
; VBITS_EQ_512-NEXT:    st1w { z0.d }, p0, [x0, x8, lsl #2]
; VBITS_EQ_512-NEXT:    st1w { z1.d }, p0, [x0]
; VBITS_EQ_512-NEXT:    ret
;
; VBITS_GT_512-LABEL: smulh_v16i32:
; VBITS_GT_512:       // %bb.0:
; VBITS_GT_512-NEXT:    ptrue p0.d, vl16
; VBITS_GT_512-NEXT:    ld1sw { z0.d }, p0/z, [x0]
; VBITS_GT_512-NEXT:    ld1sw { z1.d }, p0/z, [x1]
; VBITS_GT_512-NEXT:    mul z0.d, p0/m, z0.d, z1.d
; VBITS_GT_512-NEXT:    lsr z0.d, z0.d, #32
; VBITS_GT_512-NEXT:    st1w { z0.d }, p0, [x0]
; VBITS_GT_512-NEXT:    ret
...
; VBITS_GE_256-NEXT:    ld1b { z1.h }, p0/z, [x1, x8]
; VBITS_GE_256-NEXT:    ld1b { z2.h }, p0/z, [x0, x9]
; VBITS_GE_256-NEXT:    ld1b { z3.h }, p0/z, [x1, x9]
; VBITS_GE_256-NEXT:    ld1b { z4.h }, p0/z, [x0, x10]
; VBITS_GE_256-NEXT:    ld1b { z5.h }, p0/z, [x1, x10]
; VBITS_GE_256-NEXT:    ld1b { z6.h }, p0/z, [x0]
...
; VBITS_EQ_512-NEXT:    ld1b { z1.h }, p0/z, [x1, x8]
; VBITS_EQ_512-NEXT:    ld1b { z2.h }, p0/z, [x0]
...
; VBITS_EQ_512-NEXT:    ret
;
; VBITS_GT_512-LABEL: umulh_v64i8:
; VBITS_GT_512:       // %bb.0:
; VBITS_GT_512-NEXT:    ptrue p0.h, vl64
; VBITS_GT_512-NEXT:    ld1b { z0.h }, p0/z, [x0]
; VBITS_GT_512-NEXT:    ld1b { z1.h }, p0/z, [x1]
; VBITS_GT_512-NEXT:    mul z0.h, p0/m, z0.h, z1.h
; VBITS_GT_512-NEXT:    lsr z0.h, z0.h, #8
; VBITS_GT_512-NEXT:    st1b { z0.h }, p0, [x0]
; VBITS_GT_512-NEXT:    ret
...
; CHECK-NEXT:    ld1h { z1.s }, p0/z, [x1, x8, lsl #1]
...
; VBITS_GE_256-NEXT:    ld1h { z1.s }, p0/z, [x1, x8, lsl #1]
; VBITS_GE_256-NEXT:    ld1h { z2.s }, p0/z, [x0, x9, lsl #1]
; VBITS_GE_256-NEXT:    ld1h { z3.s }, p0/z, [x1, x9, lsl #1]
; VBITS_GE_256-NEXT:    ld1h { z4.s }, p0/z, [x0, x10, lsl #1]
; VBITS_GE_256-NEXT:    ld1h { z5.s }, p0/z, [x1, x10, lsl #1]
; VBITS_GE_256-NEXT:    ld1h { z6.s }, p0/z, [x0]
...
; VBITS_EQ_512-NEXT:    ld1h { z1.s }, p0/z, [x1, x8, lsl #1]
; VBITS_EQ_512-NEXT:    ld1h { z2.s }, p0/z, [x0]
...
; VBITS_EQ_512-NEXT:    ret
;
; VBITS_GT_512-LABEL: umulh_v32i16:
; VBITS_GT_512:       // %bb.0:
; VBITS_GT_512-NEXT:    ptrue p0.s, vl32
; VBITS_GT_512-NEXT:    ld1h { z0.s }, p0/z, [x0]
; VBITS_GT_512-NEXT:    ld1h { z1.s }, p0/z, [x1]
; VBITS_GT_512-NEXT:    mul z0.s, p0/m, z0.s, z1.s
; VBITS_GT_512-NEXT:    lsr z0.s, z0.s, #16
; VBITS_GT_512-NEXT:    st1h { z0.s }, p0, [x0]
; VBITS_GT_512-NEXT:    ret
...
; CHECK-NEXT:    ld1w { z1.d }, p0/z, [x1, x8, lsl #2]
...
; VBITS_GE_256-NEXT:    ld1w { z1.d }, p0/z, [x1, x8, lsl #2]
; VBITS_GE_256-NEXT:    ld1w { z2.d }, p0/z, [x0, x9, lsl #2]
; VBITS_GE_256-NEXT:    ld1w { z3.d }, p0/z, [x1, x9, lsl #2]
; VBITS_GE_256-NEXT:    ld1w { z4.d }, p0/z, [x0, x10, lsl #2]
; VBITS_GE_256-NEXT:    ld1w { z5.d }, p0/z, [x1, x10, lsl #2]
; VBITS_GE_256-NEXT:    ld1w { z6.d }, p0/z, [x0]
...
; VBITS_EQ_512-NEXT:    ld1w { z1.d }, p0/z, [x1, x8, lsl #2]
; VBITS_EQ_512-NEXT:    ld1w { z2.d }, p0/z, [x0]
...
; VBITS_EQ_512-NEXT:    ret
;
; VBITS_GT_512-LABEL: umulh_v16i32:
; VBITS_GT_512:       // %bb.0:
; VBITS_GT_512-NEXT:    ptrue p0.d, vl16
; VBITS_GT_512-NEXT:    ld1w { z0.d }, p0/z, [x0]
; VBITS_GT_512-NEXT:    ld1w { z1.d }, p0/z, [x1]
; VBITS_GT_512-NEXT:    mul z0.d, p0/m, z0.d, z1.d
; VBITS_GT_512-NEXT:    lsr z0.d, z0.d, #32
; VBITS_GT_512-NEXT:    st1w { z0.d }, p0, [x0]
; VBITS_GT_512-NEXT:    ret
