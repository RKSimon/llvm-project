...
; CHECK-NEXT:    mov v21.s[1], v4.s[0]
; CHECK-NEXT:    mov v20.16b, v16.16b
; CHECK-NEXT:    mov v19.s[2], v4.s[3]
...
; CHECK-NEXT:    add v1.4s, v3.4s, v4.4s
