...
; CHECK-NEXT:    ldr d3, [x13, x9]
; CHECK-NEXT:    ldr d4, [x13]
...
; CHECK-NEXT:    mov v21.s[1], v2.s[0]
; CHECK-NEXT:    mov v20.16b, v16.16b
; CHECK-NEXT:    mov v19.s[2], v2.s[3]
; CHECK-NEXT:    trn2 v0.4s, v17.4s, v0.4s
; CHECK-NEXT:    add v16.4s, v16.4s, v5.4s
; CHECK-NEXT:    mov v17.16b, v18.16b
; CHECK-NEXT:    ext v3.16b, v6.16b, v3.16b, #4
; CHECK-NEXT:    add v7.4s, v7.4s, v4.4s
; CHECK-NEXT:    mov v20.s[2], v1.s[3]
; CHECK-NEXT:    mov v17.s[0], v1.s[1]
; CHECK-NEXT:    mov v1.16b, v21.16b
; CHECK-NEXT:    sub v4.4s, v19.4s, v4.4s
; CHECK-NEXT:    sub v5.4s, v20.4s, v5.4s
; CHECK-NEXT:    mov v1.s[2], v2.s[1]
...
; CHECK-NEXT:    add v4.4s, v21.4s, v2.4s
; CHECK-NEXT:    sub v1.4s, v1.4s, v2.4s
; CHECK-NEXT:    mov v0.d[1], v3.d[1]
; CHECK-NEXT:    cmlt v3.8h, v7.8h, #0
; CHECK-NEXT:    cmlt v2.8h, v16.8h, #0
; CHECK-NEXT:    mov v4.d[1], v1.d[1]
; CHECK-NEXT:    cmlt v1.8h, v0.8h, #0
; CHECK-NEXT:    add v5.4s, v3.4s, v7.4s
; CHECK-NEXT:    add v6.4s, v2.4s, v16.4s
...
; CHECK-NEXT:    ldr d5, [x12]
; CHECK-NEXT:    ldr d6, [x13, x9]
; CHECK-NEXT:    ldr d7, [x13]
; CHECK-NEXT:    usubl v0.8h, v0.8b, v1.8b
; CHECK-NEXT:    usubl v1.8h, v2.8b, v3.8b
; CHECK-NEXT:    usubl v2.8h, v5.8b, v7.8b
; CHECK-NEXT:    usubl v3.8h, v4.8b, v6.8b
