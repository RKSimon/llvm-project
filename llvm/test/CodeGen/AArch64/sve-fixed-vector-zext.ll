...
; SVE256-LABEL: test:
; SVE256:       // %bb.0: // %L.entry
; SVE256-NEXT:    ptrue p0.s, vl8
; SVE256-NEXT:    mov w11, #-16 // =0xfffffff0
; SVE256-NEXT:    mov w12, #8 // =0x8
...
; SVE256-NEXT:    sxtw x13, w9
; SVE256-NEXT:    sxtw x15, w10
; SVE256-NEXT:    adds w11, w11, #1
; SVE256-NEXT:    add w10, w10, w3
; SVE256-NEXT:    ld1b { z1.s }, p0/z, [x0, x13]
; SVE256-NEXT:    add x14, x0, x13
; SVE256-NEXT:    add x16, x2, x15
; SVE256-NEXT:    ld1b { z3.s }, p0/z, [x2, x15]
; SVE256-NEXT:    add w9, w9, w1
; SVE256-NEXT:    ld1b { z0.s }, p0/z, [x14, x12]
; SVE256-NEXT:    ld1b { z2.s }, p0/z, [x16, x12]
; SVE256-NEXT:    sub z1.s, z1.s, z3.s
; SVE256-NEXT:    sub z0.s, z0.s, z2.s
; SVE256-NEXT:    add z0.s, z1.s, z0.s
; SVE256-NEXT:    uaddv d0, p0, z0.s
; SVE256-NEXT:    fmov w13, s0
; SVE256-NEXT:    add w8, w13, w8
