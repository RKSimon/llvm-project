...
; CHECK-NEXT:    shrn v0.4h, v1.4s, #8
; CHECK-NEXT:    shrn2 v0.8h, v2.4s, #8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    shrn v0.4h, v3.4s, #8
; CHECK-NEXT:    shrn v1.4h, v2.4s, #8
; CHECK-NEXT:    shrn2 v0.8h, v5.4s, #8
; CHECK-NEXT:    shrn2 v1.8h, v4.4s, #8
; CHECK-NEXT:    ret
