...
; CHECK:       // %bb.0:
; CHECK-NEXT:    ldp q4, q0, [x1]
; CHECK-NEXT:    ptrue p0.h, vl8
; CHECK-NEXT:    ldp q5, q1, [x2]
...
; NONEON-NOSVE-NEXT:    ldp q19, q18, [x2]
...
; NONEON-NOSVE-NEXT:    str q19, [sp, #48]
; NONEON-NOSVE-NEXT:    ldr h15, [sp, #44]
; NONEON-NOSVE-NEXT:    ldr h13, [sp, #42]
; NONEON-NOSVE-NEXT:    fcvt s20, h0
; NONEON-NOSVE-NEXT:    fcvt s21, h1
; NONEON-NOSVE-NEXT:    ldr h0, [sp, #80]
; NONEON-NOSVE-NEXT:    str q18, [sp, #96]
; NONEON-NOSVE-NEXT:    ldr h18, [sp, #62]
; NONEON-NOSVE-NEXT:    ldr h14, [sp, #26]
; NONEON-NOSVE-NEXT:    str h0, [sp, #14] // 2-byte Spill
; NONEON-NOSVE-NEXT:    ldr h0, [sp, #28]
; NONEON-NOSVE-NEXT:    ldr h11, [sp, #40]
; NONEON-NOSVE-NEXT:    fcvt s18, h18
; NONEON-NOSVE-NEXT:    ldr h12, [sp, #24]
; NONEON-NOSVE-NEXT:    ldr h9, [sp, #38]
; NONEON-NOSVE-NEXT:    fmul s30, s21, s20
; NONEON-NOSVE-NEXT:    fcvt s0, h0
; NONEON-NOSVE-NEXT:    ldr h10, [sp, #22]
; NONEON-NOSVE-NEXT:    ldr h31, [sp, #36]
; NONEON-NOSVE-NEXT:    ldr h8, [sp, #20]
; NONEON-NOSVE-NEXT:    ldr h28, [sp, #34]
; NONEON-NOSVE-NEXT:    ldr h29, [sp, #18]
; NONEON-NOSVE-NEXT:    ldr h26, [sp, #32]
; NONEON-NOSVE-NEXT:    ldr h27, [sp, #16]
; NONEON-NOSVE-NEXT:    ldr h24, [sp, #94]
; NONEON-NOSVE-NEXT:    ldr h25, [sp, #78]
; NONEON-NOSVE-NEXT:    ldr h22, [sp, #92]
; NONEON-NOSVE-NEXT:    fcvt h19, s30
; NONEON-NOSVE-NEXT:    fcvt s30, h15
; NONEON-NOSVE-NEXT:    ldr h23, [sp, #76]
; NONEON-NOSVE-NEXT:    ldr h20, [sp, #90]
; NONEON-NOSVE-NEXT:    ldr h21, [sp, #74]
; NONEON-NOSVE-NEXT:    ldr h16, [sp, #88]
; NONEON-NOSVE-NEXT:    ldr h17, [sp, #72]
; NONEON-NOSVE-NEXT:    ldr h6, [sp, #86]
; NONEON-NOSVE-NEXT:    ldr h7, [sp, #70]
; NONEON-NOSVE-NEXT:    fcvt s16, h16
; NONEON-NOSVE-NEXT:    ldr h4, [sp, #84]
; NONEON-NOSVE-NEXT:    ldr h5, [sp, #68]
; NONEON-NOSVE-NEXT:    fcvt s19, h19
...
; NONEON-NOSVE-NEXT:    fcvt s4, h4
; NONEON-NOSVE-NEXT:    fcvt s5, h5
; NONEON-NOSVE-NEXT:    ldr h2, [sp, #82]
; NONEON-NOSVE-NEXT:    ldr h3, [sp, #66]
...
; NONEON-NOSVE-NEXT:    str h18, [sp, #126]
; NONEON-NOSVE-NEXT:    ldr h18, [sp, #60]
; NONEON-NOSVE-NEXT:    fcvt s3, h3
; NONEON-NOSVE-NEXT:    fcvt s16, h16
; NONEON-NOSVE-NEXT:    fcvt s6, h6
; NONEON-NOSVE-NEXT:    fcvt s18, h18
...
; NONEON-NOSVE-NEXT:    ldp q0, q1, [x2]
...
; NONEON-NOSVE-NEXT:    ldp s1, s3, [sp, #24]
; NONEON-NOSVE-NEXT:    str q4, [sp, #48]
; NONEON-NOSVE-NEXT:    ldp s2, s4, [sp, #8]
; NONEON-NOSVE-NEXT:    fmadd s5, s4, s3, s0
; NONEON-NOSVE-NEXT:    ldr s0, [sp, #40]
; NONEON-NOSVE-NEXT:    fmadd s0, s2, s1, s0
