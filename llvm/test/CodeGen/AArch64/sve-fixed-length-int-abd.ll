...
; VBITS_GE_256-NEXT:    sshll v24.4s, v23.4h, #0
; VBITS_GE_256-NEXT:    ldp s25, s23, [x1, #32]
; VBITS_GE_256-NEXT:    ldp s31, s30, [x1, #56]
; VBITS_GE_256-NEXT:    sshll v27.8h, v27.8b, #0
; VBITS_GE_256-NEXT:    sshll v6.8h, v6.8b, #0
; VBITS_GE_256-NEXT:    sshll v7.8h, v7.8b, #0
; VBITS_GE_256-NEXT:    sshll v8.8h, v29.8b, #0
; VBITS_GE_256-NEXT:    sshll v25.8h, v25.8b, #0
; VBITS_GE_256-NEXT:    sshll v23.8h, v23.8b, #0
; VBITS_GE_256-NEXT:    sshll v26.8h, v26.8b, #0
; VBITS_GE_256-NEXT:    sshll v28.8h, v28.8b, #0
; VBITS_GE_256-NEXT:    sshll v9.8h, v31.8b, #0
...
; VBITS_GE_256-NEXT:    sshll v1.4s, v30.4h, #0
; VBITS_GE_256-NEXT:    sshll v20.8h, v20.8b, #0
; VBITS_GE_256-NEXT:    sshll v21.8h, v21.8b, #0
...
; VBITS_GE_256-NEXT:    sshll v4.8h, v4.8b, #0
; VBITS_GE_256-NEXT:    sshll v5.8h, v5.8b, #0
; VBITS_GE_256-NEXT:    sshll v31.4s, v20.4h, #0
; VBITS_GE_256-NEXT:    sshll v20.4s, v25.4h, #0
; VBITS_GE_256-NEXT:    sshll v25.4s, v27.4h, #0
; VBITS_GE_256-NEXT:    sshll v27.4s, v8.4h, #0
; VBITS_GE_256-NEXT:    ldp s12, s8, [x1, #12]
; VBITS_GE_256-NEXT:    sshll v29.4s, v21.4h, #0
; VBITS_GE_256-NEXT:    sshll v21.4s, v23.4h, #0
; VBITS_GE_256-NEXT:    sshll v23.4s, v26.4h, #0
; VBITS_GE_256-NEXT:    sshll v26.4s, v28.4h, #0
; VBITS_GE_256-NEXT:    sshll v28.4s, v9.4h, #0
; VBITS_GE_256-NEXT:    sshll v15.8h, v15.8b, #0
; VBITS_GE_256-NEXT:    ldp s9, s10, [x1, #24]
...
; VBITS_GE_256-NEXT:    sshll v0.4s, v8.4h, #0
; VBITS_GE_256-NEXT:    sshll v30.4s, v14.4h, #0
; VBITS_GE_256-NEXT:    sshll v14.4s, v12.4h, #0
; VBITS_GE_256-NEXT:    sshll v12.4s, v15.4h, #0
; VBITS_GE_256-NEXT:    sabd v24.4s, v24.4s, v13.4s
...
; VBITS_GE_256-NEXT:    sshll v8.4s, v9.4h, #0
; VBITS_GE_256-NEXT:    sshll v9.4s, v11.4h, #0
; VBITS_GE_256-NEXT:    sabd v22.4s, v22.4s, v0.4s
...
; VBITS_GE_256-NEXT:    sabd v19.4s, v19.4s, v14.4s
; VBITS_GE_256-NEXT:    sabd v31.4s, v31.4s, v10.4s
; VBITS_GE_256-NEXT:    sabd v29.4s, v29.4s, v8.4s
; VBITS_GE_256-NEXT:    sabd v3.4s, v3.4s, v25.4s
; VBITS_GE_256-NEXT:    sabd v2.4s, v2.4s, v23.4s
...
; VBITS_GE_256-NEXT:    sabd v7.4s, v7.4s, v12.4s
; VBITS_GE_256-NEXT:    ldp d9, d8, [sp, #80] // 16-byte Folded Reload
; VBITS_GE_256-NEXT:    sabd v6.4s, v6.4s, v30.4s
; VBITS_GE_256-NEXT:    splice z29.s, p0, z29.s, z31.s
...
; VBITS_GE_256-NEXT:    splice z22.s, p0, z22.s, z24.s
...
; VBITS_GE_256-NEXT:    uzp1 z5.h, z22.h, z22.h
