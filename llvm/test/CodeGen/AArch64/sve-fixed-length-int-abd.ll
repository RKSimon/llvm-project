...
; VBITS_GE_256:       // %bb.0:
; VBITS_GE_256-NEXT:    ldp s0, s1, [x0, #8]
; VBITS_GE_256-NEXT:    ptrue p0.s, vl4
; VBITS_GE_256-NEXT:    ldp s2, s3, [x0]
...
; VBITS_GE_256-NEXT:    sabdl v1.4s, v1.4h, v5.4h
; VBITS_GE_256-NEXT:    sabdl v0.4s, v0.4h, v4.4h
; VBITS_GE_256-NEXT:    sabdl v3.4s, v3.4h, v7.4h
; VBITS_GE_256-NEXT:    sabdl v2.4s, v2.4h, v6.4h
; VBITS_GE_256-NEXT:    splice z0.s, p0, z0.s, z1.s
; VBITS_GE_256-NEXT:    splice z2.s, p0, z2.s, z3.s
; VBITS_GE_256-NEXT:    ptrue p0.s, vl8
; VBITS_GE_256-NEXT:    st1b { z0.s }, p0, [x0, x8]
; VBITS_GE_256-NEXT:    st1b { z2.s }, p0, [x0]
; VBITS_GE_256-NEXT:    ret
;
...
; VBITS_GT_512-NEXT:    ld1sb { z1.d }, p0/z, [x1, x8]
; VBITS_GT_512-NEXT:    ld1sb { z2.d }, p0/z, [x0]
; VBITS_GT_512-NEXT:    ld1sb { z3.d }, p0/z, [x1]
; VBITS_GT_512-NEXT:    sabd z0.d, p0/m, z0.d, z1.d
; VBITS_GT_512-NEXT:    sabd z2.d, p0/m, z2.d, z3.d
; VBITS_GT_512-NEXT:    st1b { z0.d }, p0, [x0, x8]
; VBITS_GT_512-NEXT:    st1b { z2.d }, p0, [x0]
; VBITS_GT_512-NEXT:    ret
