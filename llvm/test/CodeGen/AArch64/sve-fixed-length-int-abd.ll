...
; VBITS_GE_256-NEXT:    mov w8, #4 // =0x4
; VBITS_GE_256-NEXT:    mov w9, #8 // =0x8
; VBITS_GE_256-NEXT:    mov w10, #12 // =0xc
...
; VBITS_GE_256-NEXT:    ld1sb { z4.d }, p0/z, [x1, x10]
; VBITS_GE_256-NEXT:    ld1sb { z5.d }, p0/z, [x1, x8]
; VBITS_GE_256-NEXT:    ld1sb { z6.d }, p0/z, [x1, x9]
; VBITS_GE_256-NEXT:    ld1sb { z7.d }, p0/z, [x1]
; VBITS_GE_256-NEXT:    sub z2.d, z2.d, z4.d
; VBITS_GE_256-NEXT:    sub z0.d, z0.d, z5.d
; VBITS_GE_256-NEXT:    sub z1.d, z1.d, z6.d
; VBITS_GE_256-NEXT:    sub z3.d, z3.d, z7.d
; VBITS_GE_256-NEXT:    abs z2.d, p0/m, z2.d
; VBITS_GE_256-NEXT:    abs z0.d, p0/m, z0.d
; VBITS_GE_256-NEXT:    abs z1.d, p0/m, z1.d
; VBITS_GE_256-NEXT:    abs z3.d, p0/m, z3.d
...
; VBITS_GE_256-NEXT:    abs z0.h, p0/m, z0.h
; VBITS_GE_256-NEXT:    abs z1.h, p0/m, z1.h
...
; VBITS_GE_512-NEXT:    abs z0.h, p0/m, z0.h
...
; VBITS_GE_256-NEXT:    mov w10, #24 // =0x18
; VBITS_GE_256-NEXT:    ld1sb { z0.s }, p0/z, [x0, x8]
; VBITS_GE_256-NEXT:    ld1sb { z1.s }, p0/z, [x0, x9]
; VBITS_GE_256-NEXT:    ld1sb { z2.s }, p0/z, [x0, x10]
; VBITS_GE_256-NEXT:    ld1sb { z3.s }, p0/z, [x0]
; VBITS_GE_256-NEXT:    ld1sb { z4.s }, p0/z, [x1, x10]
; VBITS_GE_256-NEXT:    ld1sb { z5.s }, p0/z, [x1, x8]
; VBITS_GE_256-NEXT:    ld1sb { z6.s }, p0/z, [x1, x9]
; VBITS_GE_256-NEXT:    ld1sb { z7.s }, p0/z, [x1]
; VBITS_GE_256-NEXT:    sub z2.s, z2.s, z4.s
; VBITS_GE_256-NEXT:    sub z0.s, z0.s, z5.s
; VBITS_GE_256-NEXT:    sub z1.s, z1.s, z6.s
; VBITS_GE_256-NEXT:    sub z3.s, z3.s, z7.s
; VBITS_GE_256-NEXT:    abs z2.s, p0/m, z2.s
; VBITS_GE_256-NEXT:    abs z0.s, p0/m, z0.s
; VBITS_GE_256-NEXT:    abs z1.s, p0/m, z1.s
; VBITS_GE_256-NEXT:    abs z3.s, p0/m, z3.s
; VBITS_GE_256-NEXT:    ptrue p0.b, vl16
...
; VBITS_GE_256-NEXT:    mov v3.d[1], v0.d[0]
...
; VBITS_GE_256-NEXT:    mov w12, #20 // =0x14
; VBITS_GE_256-NEXT:    mov w13, #24 // =0x18
; VBITS_GE_256-NEXT:    mov w14, #28 // =0x1c
; VBITS_GE_256-NEXT:    ld1sb { z0.d }, p0/z, [x0, x8]
; VBITS_GE_256-NEXT:    ld1sb { z1.d }, p0/z, [x0, x9]
; VBITS_GE_256-NEXT:    ld1sb { z2.d }, p0/z, [x0, x10]
...
; VBITS_GE_256-NEXT:    ld1sb { z16.d }, p0/z, [x1, x13]
; VBITS_GE_256-NEXT:    ld1sb { z17.d }, p0/z, [x1, x14]
...
; VBITS_GE_256-NEXT:    ld1sb { z21.d }, p0/z, [x1, x8]
; VBITS_GE_256-NEXT:    ld1sb { z22.d }, p0/z, [x1, x9]
; VBITS_GE_256-NEXT:    ld1sb { z23.d }, p0/z, [x1]
; VBITS_GE_256-NEXT:    sub z6.d, z6.d, z17.d
; VBITS_GE_256-NEXT:    sub z5.d, z5.d, z16.d
; VBITS_GE_256-NEXT:    sub z4.d, z4.d, z20.d
; VBITS_GE_256-NEXT:    sub z3.d, z3.d, z19.d
; VBITS_GE_256-NEXT:    sub z2.d, z2.d, z18.d
; VBITS_GE_256-NEXT:    sub z1.d, z1.d, z22.d
; VBITS_GE_256-NEXT:    sub z0.d, z0.d, z21.d
; VBITS_GE_256-NEXT:    sub z7.d, z7.d, z23.d
; VBITS_GE_256-NEXT:    abs z5.d, p0/m, z5.d
; VBITS_GE_256-NEXT:    abs z6.d, p0/m, z6.d
; VBITS_GE_256-NEXT:    abs z2.d, p0/m, z2.d
; VBITS_GE_256-NEXT:    abs z3.d, p0/m, z3.d
; VBITS_GE_256-NEXT:    abs z4.d, p0/m, z4.d
; VBITS_GE_256-NEXT:    abs z0.d, p0/m, z0.d
; VBITS_GE_256-NEXT:    abs z1.d, p0/m, z1.d
; VBITS_GE_256-NEXT:    abs z7.d, p0/m, z7.d
...
; VBITS_GE_256-NEXT:    splice z3.s, p0, z3.s, z4.s
; VBITS_GE_256-NEXT:    splice z1.s, p0, z1.s, z2.s
; VBITS_GE_256-NEXT:    splice z7.s, p0, z7.s, z0.s
; VBITS_GE_256-NEXT:    ptrue p0.b, vl16
; VBITS_GE_256-NEXT:    uzp1 z0.h, z5.h, z5.h
...
; VBITS_GE_256:       // %bb.0:
; VBITS_GE_256-NEXT:    str d8, [sp, #-16]! // 8-byte Folded Spill
; VBITS_GE_256-NEXT:    .cfi_def_cfa_offset 16
; VBITS_GE_256-NEXT:    .cfi_offset b8, -16
; VBITS_GE_256-NEXT:    ptrue p0.d, vl4
; VBITS_GE_256-NEXT:    mov w16, #36 // =0x24
; VBITS_GE_256-NEXT:    mov w17, #40 // =0x28
; VBITS_GE_256-NEXT:    mov w18, #44 // =0x2c
; VBITS_GE_256-NEXT:    mov w2, #48 // =0x30
; VBITS_GE_256-NEXT:    mov w3, #52 // =0x34
; VBITS_GE_256-NEXT:    mov w4, #60 // =0x3c
; VBITS_GE_256-NEXT:    mov w5, #56 // =0x38
; VBITS_GE_256-NEXT:    ld1sb { z16.d }, p0/z, [x0, x16]
; VBITS_GE_256-NEXT:    ld1sb { z17.d }, p0/z, [x0, x17]
; VBITS_GE_256-NEXT:    ld1sb { z18.d }, p0/z, [x0, x18]
; VBITS_GE_256-NEXT:    ld1sb { z19.d }, p0/z, [x0, x2]
; VBITS_GE_256-NEXT:    ld1sb { z20.d }, p0/z, [x0, x3]
; VBITS_GE_256-NEXT:    ld1sb { z21.d }, p0/z, [x0, x4]
; VBITS_GE_256-NEXT:    ld1sb { z22.d }, p0/z, [x1, x4]
; VBITS_GE_256-NEXT:    ld1sb { z23.d }, p0/z, [x0, x5]
; VBITS_GE_256-NEXT:    ld1sb { z24.d }, p0/z, [x1, x3]
; VBITS_GE_256-NEXT:    ld1sb { z25.d }, p0/z, [x1, x5]
; VBITS_GE_256-NEXT:    ld1sb { z27.d }, p0/z, [x1, x18]
; VBITS_GE_256-NEXT:    ld1sb { z28.d }, p0/z, [x1, x2]
; VBITS_GE_256-NEXT:    ld1sb { z29.d }, p0/z, [x1, x16]
; VBITS_GE_256-NEXT:    ld1sb { z30.d }, p0/z, [x1, x17]
; VBITS_GE_256-NEXT:    mov w9, #4 // =0x4
; VBITS_GE_256-NEXT:    mov w10, #8 // =0x8
; VBITS_GE_256-NEXT:    mov w11, #12 // =0xc
; VBITS_GE_256-NEXT:    mov w12, #16 // =0x10
; VBITS_GE_256-NEXT:    mov w13, #20 // =0x14
; VBITS_GE_256-NEXT:    mov w14, #24 // =0x18
; VBITS_GE_256-NEXT:    mov w15, #28 // =0x1c
; VBITS_GE_256-NEXT:    mov w8, #32 // =0x20
; VBITS_GE_256-NEXT:    ld1sb { z0.d }, p0/z, [x0, x9]
; VBITS_GE_256-NEXT:    ld1sb { z2.d }, p0/z, [x0, x10]
; VBITS_GE_256-NEXT:    ld1sb { z3.d }, p0/z, [x0, x11]
; VBITS_GE_256-NEXT:    ld1sb { z1.d }, p0/z, [x0, x12]
; VBITS_GE_256-NEXT:    ld1sb { z4.d }, p0/z, [x0, x13]
; VBITS_GE_256-NEXT:    ld1sb { z6.d }, p0/z, [x0, x14]
; VBITS_GE_256-NEXT:    ld1sb { z5.d }, p0/z, [x0, x15]
; VBITS_GE_256-NEXT:    ld1sb { z7.d }, p0/z, [x0, x8]
; VBITS_GE_256-NEXT:    ld1sb { z26.d }, p0/z, [x0]
; VBITS_GE_256-NEXT:    sub z21.d, z21.d, z22.d
; VBITS_GE_256-NEXT:    ld1sb { z22.d }, p0/z, [x1, x9]
; VBITS_GE_256-NEXT:    sub z23.d, z23.d, z25.d
; VBITS_GE_256-NEXT:    sub z20.d, z20.d, z24.d
; VBITS_GE_256-NEXT:    ld1sb { z24.d }, p0/z, [x1, x10]
; VBITS_GE_256-NEXT:    sub z19.d, z19.d, z28.d
; VBITS_GE_256-NEXT:    sub z18.d, z18.d, z27.d
; VBITS_GE_256-NEXT:    ld1sb { z25.d }, p0/z, [x1, x11]
; VBITS_GE_256-NEXT:    sub z17.d, z17.d, z30.d
; VBITS_GE_256-NEXT:    sub z16.d, z16.d, z29.d
...
; VBITS_GE_256-NEXT:    ld1sb { z30.d }, p0/z, [x1, x15]
; VBITS_GE_256-NEXT:    ld1sb { z31.d }, p0/z, [x1, x8]
; VBITS_GE_256-NEXT:    ld1sb { z8.d }, p0/z, [x1]
; VBITS_GE_256-NEXT:    sub z3.d, z3.d, z25.d
; VBITS_GE_256-NEXT:    sub z2.d, z2.d, z24.d
; VBITS_GE_256-NEXT:    sub z0.d, z0.d, z22.d
; VBITS_GE_256-NEXT:    sub z22.d, z4.d, z28.d
; VBITS_GE_256-NEXT:    sub z4.d, z1.d, z27.d
; VBITS_GE_256-NEXT:    sub z6.d, z6.d, z29.d
; VBITS_GE_256-NEXT:    sub z7.d, z7.d, z31.d
; VBITS_GE_256-NEXT:    sub z5.d, z5.d, z30.d
; VBITS_GE_256-NEXT:    sub z24.d, z26.d, z8.d
; VBITS_GE_256-NEXT:    movprfx z1, z2
; VBITS_GE_256-NEXT:    abs z1.d, p0/m, z2.d
; VBITS_GE_256-NEXT:    movprfx z2, z3
; VBITS_GE_256-NEXT:    abs z2.d, p0/m, z3.d
; VBITS_GE_256-NEXT:    abs z0.d, p0/m, z0.d
; VBITS_GE_256-NEXT:    abs z4.d, p0/m, z4.d
; VBITS_GE_256-NEXT:    abs z22.d, p0/m, z22.d
; VBITS_GE_256-NEXT:    abs z6.d, p0/m, z6.d
; VBITS_GE_256-NEXT:    movprfx z25, z5
; VBITS_GE_256-NEXT:    abs z25.d, p0/m, z5.d
; VBITS_GE_256-NEXT:    movprfx z3, z23
; VBITS_GE_256-NEXT:    abs z3.d, p0/m, z23.d
; VBITS_GE_256-NEXT:    movprfx z5, z21
; VBITS_GE_256-NEXT:    abs z5.d, p0/m, z21.d
; VBITS_GE_256-NEXT:    abs z7.d, p0/m, z7.d
; VBITS_GE_256-NEXT:    abs z19.d, p0/m, z19.d
; VBITS_GE_256-NEXT:    abs z20.d, p0/m, z20.d
; VBITS_GE_256-NEXT:    abs z16.d, p0/m, z16.d
; VBITS_GE_256-NEXT:    abs z17.d, p0/m, z17.d
; VBITS_GE_256-NEXT:    abs z18.d, p0/m, z18.d
; VBITS_GE_256-NEXT:    movprfx z21, z24
; VBITS_GE_256-NEXT:    abs z21.d, p0/m, z24.d
; VBITS_GE_256-NEXT:    uzp1 z3.s, z3.s, z3.s
; VBITS_GE_256-NEXT:    uzp1 z23.s, z5.s, z5.s
; VBITS_GE_256-NEXT:    uzp1 z5.s, z19.s, z19.s
; VBITS_GE_256-NEXT:    uzp1 z7.s, z7.s, z7.s
; VBITS_GE_256-NEXT:    uzp1 z20.s, z20.s, z20.s
; VBITS_GE_256-NEXT:    uzp1 z17.s, z17.s, z17.s
; VBITS_GE_256-NEXT:    uzp1 z16.s, z16.s, z16.s
; VBITS_GE_256-NEXT:    uzp1 z18.s, z18.s, z18.s
; VBITS_GE_256-NEXT:    uzp1 z19.s, z25.s, z25.s
; VBITS_GE_256-NEXT:    uzp1 z6.s, z6.s, z6.s
...
; VBITS_GE_256-NEXT:    ptrue p0.s, vl4
; VBITS_GE_256-NEXT:    splice z3.s, p0, z3.s, z23.s
; VBITS_GE_256-NEXT:    splice z5.s, p0, z5.s, z20.s
; VBITS_GE_256-NEXT:    splice z17.s, p0, z17.s, z18.s
; VBITS_GE_256-NEXT:    splice z7.s, p0, z7.s, z16.s
; VBITS_GE_256-NEXT:    splice z6.s, p0, z6.s, z19.s
; VBITS_GE_256-NEXT:    splice z4.s, p0, z4.s, z22.s
; VBITS_GE_256-NEXT:    splice z1.s, p0, z1.s, z2.s
; VBITS_GE_256-NEXT:    splice z21.s, p0, z21.s, z0.s
; VBITS_GE_256-NEXT:    ptrue p0.b, vl16
; VBITS_GE_256-NEXT:    uzp1 z0.h, z3.h, z3.h
; VBITS_GE_256-NEXT:    uzp1 z2.h, z5.h, z5.h
; VBITS_GE_256-NEXT:    uzp1 z3.h, z17.h, z17.h
; VBITS_GE_256-NEXT:    uzp1 z5.h, z7.h, z7.h
; VBITS_GE_256-NEXT:    uzp1 z6.h, z6.h, z6.h
; VBITS_GE_256-NEXT:    uzp1 z4.h, z4.h, z4.h
; VBITS_GE_256-NEXT:    uzp1 z1.h, z1.h, z1.h
; VBITS_GE_256-NEXT:    uzp1 z7.h, z21.h, z21.h
; VBITS_GE_256-NEXT:    uzp1 z0.b, z0.b, z0.b
; VBITS_GE_256-NEXT:    uzp1 z2.b, z2.b, z2.b
; VBITS_GE_256-NEXT:    uzp1 z3.b, z3.b, z3.b
...
; VBITS_GE_256-NEXT:    mov v2.d[1], v0.d[0]
; VBITS_GE_256-NEXT:    mov v5.d[1], v3.d[0]
; VBITS_GE_256-NEXT:    mov v4.d[1], v6.d[0]
; VBITS_GE_256-NEXT:    mov v7.d[1], v1.d[0]
; VBITS_GE_256-NEXT:    splice z5.b, p0, z5.b, z2.b
; VBITS_GE_256-NEXT:    splice z7.b, p0, z7.b, z4.b
; VBITS_GE_256-NEXT:    ptrue p0.b, vl32
; VBITS_GE_256-NEXT:    st1b { z5.b }, p0, [x0, x8]
; VBITS_GE_256-NEXT:    st1b { z7.b }, p0, [x0]
; VBITS_GE_256-NEXT:    ldr d8, [sp], #16 // 8-byte Folded Reload
; VBITS_GE_256-NEXT:    ret
