...
; CHECK-NEXT:    ldrh w9, [x0, #6]
; CHECK-NEXT:    ldrh w10, [x0, #4]
; CHECK-NEXT:    mov x8, sp
; CHECK-NEXT:    ldrh w11, [x0, #2]
; CHECK-NEXT:    ldrh w12, [x0]
; CHECK-NEXT:    ldrh w13, [x0, #14]
; CHECK-NEXT:    ldrh w14, [x0, #12]
; CHECK-NEXT:    ldrh w15, [x0, #10]
; CHECK-NEXT:    ldrh w16, [x0, #8]
; CHECK-NEXT:    ldrh w17, [x1, #6]
; CHECK-NEXT:    ldrh w18, [x1, #4]
; CHECK-NEXT:    ldrh w0, [x1, #8]
; CHECK-NEXT:    ldrh w3, [x1, #2]
; CHECK-NEXT:    ldrh w4, [x1]
; CHECK-NEXT:    ldrh w5, [x1, #10]
; CHECK-NEXT:    ldrh w6, [x1, #14]
; CHECK-NEXT:    ldrh w1, [x1, #12]
; CHECK-NEXT:    strh w0, [sp, #30]
; CHECK-NEXT:    strh w5, [sp, #28]
; CHECK-NEXT:    strh w1, [sp, #26]
; CHECK-NEXT:    strh w6, [sp, #24]
; CHECK-NEXT:    strh w4, [sp, #22]
; CHECK-NEXT:    strh w3, [sp, #20]
; CHECK-NEXT:    strh w18, [sp, #18]
; CHECK-NEXT:    strh w17, [sp, #16]
; CHECK-NEXT:    strh w16, [sp, #14]
; CHECK-NEXT:    strh w15, [sp, #12]
; CHECK-NEXT:    strh w14, [sp, #10]
; CHECK-NEXT:    strh w13, [sp, #8]
