...
; CHECK-SD-NOFP16-NEXT:    mov v7.h[3], w8
; CHECK-SD-NOFP16-NEXT:    cset w8, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s5, s4
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    fcvt s4, h6
...
; CHECK-SD-NOFP16-NEXT:    fcvt s1, h1
; CHECK-SD-NOFP16-NEXT:    fcvt s0, h0
; CHECK-SD-NOFP16-NEXT:    mov v7.h[4], w8
; CHECK-SD-NOFP16-NEXT:    cset w8, mi
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    fcmp s5, s4
; CHECK-SD-NOFP16-NEXT:    mov v7.h[5], w8
; CHECK-SD-NOFP16-NEXT:    cset w8, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s0, s1
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v7.h[6], w8
; CHECK-SD-NOFP16-NEXT:    cset w8, mi
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v7.h[7], w8
; CHECK-SD-NOFP16-NEXT:    mov v0.16b, v7.16b
...
; CHECK-SD-NOFP16-NEXT:    fcvt s17, h17
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    cset w14, mi
...
; CHECK-SD-NOFP16-NEXT:    sbfx w14, w14, #0, #1
; CHECK-SD-NOFP16-NEXT:    fcvt s21, h21
; CHECK-SD-NOFP16-NEXT:    cset w11, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s17, s16
...
; CHECK-SD-NOFP16-NEXT:    fcvt s19, h19
; CHECK-SD-NOFP16-NEXT:    mov h1, v1.h[7]
; CHECK-SD-NOFP16-NEXT:    sbfx w11, w11, #0, #1
; CHECK-SD-NOFP16-NEXT:    cset w10, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s21, s20
; CHECK-SD-NOFP16-NEXT:    fcvt s16, h16
; CHECK-SD-NOFP16-NEXT:    fcvt s17, h17
; CHECK-SD-NOFP16-NEXT:    fcvt s3, h3
; CHECK-SD-NOFP16-NEXT:    cset w13, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s19, s18
; CHECK-SD-NOFP16-NEXT:    mov h18, v2.h[1]
; CHECK-SD-NOFP16-NEXT:    mov h19, v0.h[1]
; CHECK-SD-NOFP16-NEXT:    fcvt s1, h1
; CHECK-SD-NOFP16-NEXT:    cset w12, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s17, s16
...
; CHECK-SD-NOFP16-NEXT:    sbfx w9, w9, #0, #1
; CHECK-SD-NOFP16-NEXT:    cset w15, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s17, s16
; CHECK-SD-NOFP16-NEXT:    mov h16, v2.h[3]
; CHECK-SD-NOFP16-NEXT:    mov h17, v0.h[3]
; CHECK-SD-NOFP16-NEXT:    cset w16, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s3, s1
; CHECK-SD-NOFP16-NEXT:    fcvt s1, h18
; CHECK-SD-NOFP16-NEXT:    fcvt s3, h19
; CHECK-SD-NOFP16-NEXT:    mov h18, v2.h[4]
; CHECK-SD-NOFP16-NEXT:    mov h19, v0.h[4]
; CHECK-SD-NOFP16-NEXT:    fcvt s16, h16
; CHECK-SD-NOFP16-NEXT:    fcvt s17, h17
; CHECK-SD-NOFP16-NEXT:    sbfx w16, w16, #0, #1
; CHECK-SD-NOFP16-NEXT:    cset w17, mi
; CHECK-SD-NOFP16-NEXT:    sbfx w17, w17, #0, #1
; CHECK-SD-NOFP16-NEXT:    fcmp s3, s1
...
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v1.h[2], w11
; CHECK-SD-NOFP16-NEXT:    cset w11, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s19, s18
...
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w10, #0, #1
; CHECK-SD-NOFP16-NEXT:    sbfx w10, w11, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov h19, v0.h[6]
; CHECK-SD-NOFP16-NEXT:    cset w11, mi
; CHECK-SD-NOFP16-NEXT:    mov h2, v2.h[7]
; CHECK-SD-NOFP16-NEXT:    mov v1.h[3], w8
; CHECK-SD-NOFP16-NEXT:    mov h0, v0.h[7]
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w13, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v3.h[3], w10
; CHECK-SD-NOFP16-NEXT:    fcmp s17, s16
; CHECK-SD-NOFP16-NEXT:    sbfx w10, w11, #0, #1
; CHECK-SD-NOFP16-NEXT:    fcvt s16, h18
; CHECK-SD-NOFP16-NEXT:    fcvt s17, h19
; CHECK-SD-NOFP16-NEXT:    fcvt s2, h2
; CHECK-SD-NOFP16-NEXT:    mov v1.h[4], w8
; CHECK-SD-NOFP16-NEXT:    cset w8, mi
; CHECK-SD-NOFP16-NEXT:    fcvt s0, h0
; CHECK-SD-NOFP16-NEXT:    mov v3.h[4], w10
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    sbfx w10, w12, #0, #1
; CHECK-SD-NOFP16-NEXT:    fcmp s17, s16
...
; CHECK-SD-NOFP16-NEXT:    sbfx w9, w15, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v3.h[6], w8
; CHECK-SD-NOFP16-NEXT:    cset w8, mi
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v1.h[7], w9
...
; CHECK-SD-NOFP16-NEXT:    fcvt s1, h1
; CHECK-SD-NOFP16-NEXT:    fcvt s3, h7
; CHECK-SD-NOFP16-NEXT:    cset w12, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s6, s5
; CHECK-SD-NOFP16-NEXT:    sbfx w12, w12, #0, #1
; CHECK-SD-NOFP16-NEXT:    fmov s5, w8
; CHECK-SD-NOFP16-NEXT:    fcvt s0, h0
; CHECK-SD-NOFP16-NEXT:    cset w8, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s3, s2
; CHECK-SD-NOFP16-NEXT:    fmov s2, w12
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v5.h[1], w9
; CHECK-SD-NOFP16-NEXT:    mov x9, sp
; CHECK-SD-NOFP16-NEXT:    fmov s3, w0
; CHECK-SD-NOFP16-NEXT:    ld1 { v4.s }[1], [x9]
; CHECK-SD-NOFP16-NEXT:    mov v2.h[1], w8
; CHECK-SD-NOFP16-NEXT:    cset w9, mi
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w10, #0, #1
; CHECK-SD-NOFP16-NEXT:    sbfx w9, w9, #0, #1
; CHECK-SD-NOFP16-NEXT:    fcmp s0, s1
...
; CHECK-SD-NOFP16-NEXT:    fmov s0, w4
; CHECK-SD-NOFP16-NEXT:    add x8, sp, #8
; CHECK-SD-NOFP16-NEXT:    ld1 { v4.s }[2], [x8]
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w11, #0, #1
; CHECK-SD-NOFP16-NEXT:    ldr s1, [sp, #24]
; CHECK-SD-NOFP16-NEXT:    mov v2.h[2], w9
; CHECK-SD-NOFP16-NEXT:    cset w9, mi
; CHECK-SD-NOFP16-NEXT:    sbfx w9, w9, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v3.s[2], w2
; CHECK-SD-NOFP16-NEXT:    mov v0.s[1], w5
; CHECK-SD-NOFP16-NEXT:    mov v5.h[3], w8
; CHECK-SD-NOFP16-NEXT:    add x8, sp, #32
; CHECK-SD-NOFP16-NEXT:    ld1 { v1.s }[1], [x8]
; CHECK-SD-NOFP16-NEXT:    add x8, sp, #40
; CHECK-SD-NOFP16-NEXT:    mov v2.h[3], w9
; CHECK-SD-NOFP16-NEXT:    add x9, sp, #16
; CHECK-SD-NOFP16-NEXT:    mov v3.s[3], w3
; CHECK-SD-NOFP16-NEXT:    mov v0.s[2], w6
; CHECK-SD-NOFP16-NEXT:    ld1 { v4.s }[3], [x9]
; CHECK-SD-NOFP16-NEXT:    sshll v5.4s, v5.4h, #0
; CHECK-SD-NOFP16-NEXT:    ld1 { v1.s }[2], [x8]
; CHECK-SD-NOFP16-NEXT:    sshll v2.4s, v2.4h, #0
; CHECK-SD-NOFP16-NEXT:    bif v3.16b, v4.16b, v5.16b
; CHECK-SD-NOFP16-NEXT:    bif v0.16b, v1.16b, v2.16b
...
; CHECK-SD-NOFP16-NEXT:    fcvt s0, h0
; CHECK-SD-NOFP16-NEXT:    cset w13, mi
; CHECK-SD-NOFP16-NEXT:    sbfx w13, w13, #0, #1
; CHECK-SD-NOFP16-NEXT:    fcmp s7, s6
; CHECK-SD-NOFP16-NEXT:    fmov s6, w8
; CHECK-SD-NOFP16-NEXT:    fmov s7, w12
; CHECK-SD-NOFP16-NEXT:    mov v6.h[1], w9
; CHECK-SD-NOFP16-NEXT:    mov v7.h[1], w13
; CHECK-SD-NOFP16-NEXT:    cset w8, mi
; CHECK-SD-NOFP16-NEXT:    sbfx w9, w10, #0, #1
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    fcmp s0, s1
; CHECK-SD-NOFP16-NEXT:    mov v6.h[2], w9
; CHECK-SD-NOFP16-NEXT:    mov v7.h[2], w8
; CHECK-SD-NOFP16-NEXT:    cset w8, mi
; CHECK-SD-NOFP16-NEXT:    sbfx w9, w11, #0, #1
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v6.h[3], w9
; CHECK-SD-NOFP16-NEXT:    mov v7.h[3], w8
; CHECK-SD-NOFP16-NEXT:    sshll v1.4s, v6.4h, #0
; CHECK-SD-NOFP16-NEXT:    sshll v0.4s, v7.4h, #0
...
; CHECK-SD-NOFP16-NEXT:    mov h17, v1.h[4]
; CHECK-SD-NOFP16-NEXT:    mov h18, v3.h[5]
; CHECK-SD-NOFP16-NEXT:    mov h19, v1.h[5]
...
; CHECK-SD-NOFP16-NEXT:    cset w16, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s3, s1
; CHECK-SD-NOFP16-NEXT:    mov h1, v2.h[1]
; CHECK-SD-NOFP16-NEXT:    mov h3, v0.h[1]
; CHECK-SD-NOFP16-NEXT:    cset w18, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s17, s16
...
; CHECK-SD-NOFP16-NEXT:    fcvt s3, h3
; CHECK-SD-NOFP16-NEXT:    mov h0, v0.h[3]
; CHECK-SD-NOFP16-NEXT:    cset w0, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s19, s18
; CHECK-SD-NOFP16-NEXT:    fcvt s16, h16
; CHECK-SD-NOFP16-NEXT:    fcvt s17, h17
; CHECK-SD-NOFP16-NEXT:    fcvt s2, h2
; CHECK-SD-NOFP16-NEXT:    cset w1, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s3, s1
; CHECK-SD-NOFP16-NEXT:    fmov s1, w8
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w12, #0, #1
; CHECK-SD-NOFP16-NEXT:    fcvt s0, h0
; CHECK-SD-NOFP16-NEXT:    mov v1.h[1], w9
; CHECK-SD-NOFP16-NEXT:    sbfx w9, w1, #0, #1
; CHECK-SD-NOFP16-NEXT:    cset w12, mi
; CHECK-SD-NOFP16-NEXT:    fcmp s17, s16
; CHECK-SD-NOFP16-NEXT:    fmov s16, w8
; CHECK-SD-NOFP16-NEXT:    fmov s17, w17
; CHECK-SD-NOFP16-NEXT:    fmov s3, w9
; CHECK-SD-NOFP16-NEXT:    sbfx w12, w12, #0, #1
; CHECK-SD-NOFP16-NEXT:    sbfx w9, w13, #0, #1
; CHECK-SD-NOFP16-NEXT:    sbfx w13, w16, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v16.h[1], w9
; CHECK-SD-NOFP16-NEXT:    cset w8, mi
; CHECK-SD-NOFP16-NEXT:    sbfx w9, w10, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v3.h[1], w12
; CHECK-SD-NOFP16-NEXT:    mov v17.h[1], w13
; CHECK-SD-NOFP16-NEXT:    fcmp s0, s2
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    sbfx w10, w14, #0, #1
; CHECK-SD-NOFP16-NEXT:    sbfx w12, w18, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v1.h[2], w9
; CHECK-SD-NOFP16-NEXT:    sbfx w9, w11, #0, #1
; CHECK-SD-NOFP16-NEXT:    sbfx w11, w0, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v16.h[2], w10
; CHECK-SD-NOFP16-NEXT:    sbfx w10, w15, #0, #1
; CHECK-SD-NOFP16-NEXT:    mov v3.h[2], w8
; CHECK-SD-NOFP16-NEXT:    mov v17.h[2], w12
; CHECK-SD-NOFP16-NEXT:    cset w8, mi
; CHECK-SD-NOFP16-NEXT:    sbfx w8, w8, #0, #1
; CHECK-SD-NOFP16-NEXT:    ldp q0, q18, [sp]
; CHECK-SD-NOFP16-NEXT:    mov v1.h[3], w9
; CHECK-SD-NOFP16-NEXT:    mov v16.h[3], w10
; CHECK-SD-NOFP16-NEXT:    mov v3.h[3], w8
; CHECK-SD-NOFP16-NEXT:    mov v17.h[3], w11
; CHECK-SD-NOFP16-NEXT:    sshll v1.4s, v1.4h, #0
; CHECK-SD-NOFP16-NEXT:    sshll v16.4s, v16.4h, #0
; CHECK-SD-NOFP16-NEXT:    sshll v2.4s, v3.4h, #0
; CHECK-SD-NOFP16-NEXT:    sshll v17.4s, v17.4h, #0
; CHECK-SD-NOFP16-NEXT:    ldp q19, q3, [sp, #32]
; CHECK-SD-NOFP16-NEXT:    bit v0.16b, v4.16b, v2.16b
; CHECK-SD-NOFP16-NEXT:    mov v2.16b, v16.16b
; CHECK-SD-NOFP16-NEXT:    bit v3.16b, v7.16b, v1.16b
