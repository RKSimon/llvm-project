...
; CHECK-NEXT:    ucvtf s16, x9
; CHECK-NEXT:    ldp x9, x8, [sp, #48]
; CHECK-NEXT:    ucvtf s23, x10
; CHECK-NEXT:    ucvtf s20, x12
; CHECK-NEXT:    ldp x14, x12, [sp, #112]
