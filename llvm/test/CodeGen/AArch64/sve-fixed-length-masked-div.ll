...
; VBITS_GE_128-NEXT:    ldp q4, q3, [x0, #32]
; VBITS_GE_128-NEXT:    cmeq v5.4s, v3.4s, #0
; VBITS_GE_128-NEXT:    cmeq v6.4s, v4.4s, #0
...
; VBITS_GE_128-NEXT:    zip2 v7.8b, v2.8b, v0.8b
; VBITS_GE_128-NEXT:    zip1 v2.8b, v2.8b, v0.8b
; VBITS_GE_128-NEXT:    xtn v5.8b, v5.8h
; VBITS_GE_128-NEXT:    ushll v6.4s, v7.4h, #0
; VBITS_GE_128-NEXT:    ldp q16, q7, [x1]
...
; VBITS_GE_128-NEXT:    zip1 v6.8b, v5.8b, v0.8b
...
; VBITS_GE_128-NEXT:    stp q4, q3, [x0, #32]
; VBITS_GE_128-NEXT:    stp q0, q1, [x0]
; VBITS_GE_128-NEXT:    ret
;
...
; VBITS_GE_128:       // %bb.0:
; VBITS_GE_128-NEXT:    ldp q2, q0, [x0, #32]
; VBITS_GE_128-NEXT:    ptrue p0.d, vl2
; VBITS_GE_128-NEXT:    ldp q1, q3, [x0]
; VBITS_GE_128-NEXT:    cmeq v4.2d, v0.2d, #0
; VBITS_GE_128-NEXT:    cmeq v5.2d, v2.2d, #0
; VBITS_GE_128-NEXT:    cmeq v6.2d, v3.2d, #0
; VBITS_GE_128-NEXT:    cmeq v7.2d, v1.2d, #0
...
; VBITS_GE_128-NEXT:    ldp q6, q5, [x1]
...
; VBITS_GE_128-NEXT:    cmpne p1.d, p0/z, z5.d, #0
; VBITS_GE_128-NEXT:    ldr q5, [x1, #48]
; VBITS_GE_128-NEXT:    sdiv z0.d, p1/m, z0.d, z5.d
...
; VBITS_GE_128-NEXT:    sdiv z1.d, p1/m, z1.d, z6.d
; VBITS_GE_128-NEXT:    stp q2, q0, [x0, #32]
; VBITS_GE_128-NEXT:    stp q1, q3, [x0]
; VBITS_GE_128-NEXT:    ret
;
...
; VBITS_GE_128-NEXT:    cmpne p1.d, p0/z, z5.d, #0
; VBITS_GE_128-NEXT:    ldr q5, [x1, #48]
; VBITS_GE_128-NEXT:    udiv z0.d, p1/m, z0.d, z5.d
; VBITS_GE_128-NEXT:    mov b5, v4.b[0]
; VBITS_GE_128-NEXT:    mov v5.b[4], v4.b[1]
; VBITS_GE_128-NEXT:    ushll v4.2d, v5.2s, #0
; VBITS_GE_128-NEXT:    shl v4.2d, v4.2d, #63
; VBITS_GE_128-NEXT:    cmpne p1.d, p0/z, z4.d, #0
; VBITS_GE_128-NEXT:    udiv z1.d, p1/m, z1.d, z6.d
; VBITS_GE_128-NEXT:    stp q2, q0, [x0, #32]
; VBITS_GE_128-NEXT:    stp q1, q3, [x0]
; VBITS_GE_128-NEXT:    ret
;
