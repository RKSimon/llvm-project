...
; CHECK-MACHO-NEXT:    mov x8, sp
; CHECK-MACHO-NEXT:    add x9, x0, #15
; CHECK-MACHO-NEXT:    and x9, x9, #0xfffffffffffffff0
; CHECK-MACHO-NEXT:    sub x0, x8, x9
...
; CHECK-NOFP-ARM64-NEXT:    mov x8, sp
; CHECK-NOFP-ARM64-NEXT:    add x9, x0, #15
; CHECK-NOFP-ARM64-NEXT:    and x9, x9, #0xfffffffffffffff0
; CHECK-NOFP-ARM64-NEXT:    sub x0, x8, x9
...
; CHECK-NEXT:    stp x6, x7, [x29, #-48]
; CHECK-NEXT:    stp x4, x5, [x29, #-64]
; CHECK-NEXT:    stp x2, x3, [x29, #-80]
; CHECK-NEXT:    stur x1, [x29, #-88]
...
; CHECK-NOFP-ARM64-NEXT:    .cfi_offset w30, -8
; CHECK-NOFP-ARM64-NEXT:    .cfi_offset w29, -16
; CHECK-NOFP-ARM64-NEXT:    stp x6, x7, [x29, #-48]
; CHECK-NOFP-ARM64-NEXT:    stp x4, x5, [x29, #-64]
; CHECK-NOFP-ARM64-NEXT:    stp x2, x3, [x29, #-80]
; CHECK-NOFP-ARM64-NEXT:    stur x1, [x29, #-88]
; CHECK-NOFP-ARM64-NEXT:    mov w8, #-56 // =0xffffffc8
; CHECK-NOFP-ARM64-NEXT:    add x9, x29, #16
; CHECK-NOFP-ARM64-NEXT:    stur x8, [x29, #-8]
; CHECK-NOFP-ARM64-NEXT:    sub x8, x29, #88
; CHECK-NOFP-ARM64-NEXT:    add x8, x8, #56
; CHECK-NOFP-ARM64-NEXT:    stp x9, x8, [x29, #-32]
; CHECK-NOFP-ARM64-NEXT:    mov x8, sp
; CHECK-NOFP-ARM64-NEXT:    add x9, x0, #15
; CHECK-NOFP-ARM64-NEXT:    and x9, x9, #0xfffffffffffffff0
; CHECK-NOFP-ARM64-NEXT:    sub x0, x8, x9
...
; CHECK-NOFP-ARM64:       // %bb.0:
; CHECK-NOFP-ARM64-NEXT:    stp x29, x30, [sp, #-32]! // 16-byte Folded Spill
; CHECK-NOFP-ARM64-NEXT:    str x19, [sp, #16] // 8-byte Folded Spill
; CHECK-NOFP-ARM64-NEXT:    mov x29, sp
; CHECK-NOFP-ARM64-NEXT:    .cfi_def_cfa w29, 32
...
; CHECK-NOFP-ARM64-NEXT:    mov sp, x29
; CHECK-NOFP-ARM64-NEXT:    ldr x19, [sp, #16] // 8-byte Folded Reload
; CHECK-NOFP-ARM64-NEXT:    ldp x29, x30, [sp], #32 // 16-byte Folded Reload
; CHECK-NOFP-ARM64-NEXT:    ret
