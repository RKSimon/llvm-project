...
; CHECK-SD-NEXT:    csel w9, w1, w2, lo
; CHECK-SD-NEXT:    ccmp w0, w8, #4, hs
; CHECK-SD-NEXT:    adrp x8, out
; CHECK-SD-NEXT:    csel w10, w1, w2, eq
; CHECK-SD-NEXT:    str w9, [x8, :lo12:out]
; CHECK-SD-NEXT:    str w10, [x8, :lo12:out]
; CHECK-SD-NEXT:    ret
;
