...
; CHECK-NEXT:    and x0, x8, #0xc0
; CHECK-NEXT:    mov x20, sp
; CHECK-NEXT:    add x0, x20, x0, lsr #3
...
; CHECK-NEXT:    lsl x22, x1, #1
; CHECK-NEXT:    lsl x20, x3, #1
; CHECK-NEXT:    lsr x24, x1, x8
; CHECK-NEXT:    mov x1, #-1 // =0xffffffffffffffff
; CHECK-NEXT:    lsl x23, x22, x23
; CHECK-NEXT:    ldp x22, x21, [x0]
; CHECK-NEXT:    subs x0, x4, #1
; CHECK-NEXT:    lsl x20, x20, x2
; CHECK-NEXT:    lsl x25, x21, #1
; CHECK-NEXT:    lsr x26, x21, x8
; CHECK-NEXT:    lsr x27, x22, x8
; CHECK-NEXT:    lsr x22, x3, x8
; CHECK-NEXT:    orr x21, x20, x24
; CHECK-NEXT:    lsl x25, x25, x2
; CHECK-NEXT:    adcs x2, x5, x1
; CHECK-NEXT:    orr x24, x26, x23
; CHECK-NEXT:    adcs x3, x6, x1
; CHECK-NEXT:    orr x23, x25, x27
...
; CHECK-NEXT:    orr x1, x16, x18
; CHECK-NEXT:    sbcs x10, x10, x13
; CHECK-NEXT:    orr x4, x14, x0
...
; CHECK-NEXT:    csel x7, xzr, x14, ne
; CHECK-NEXT:    csel x3, xzr, x16, ne
...
; CHECK-NEXT:    add x3, sp, #64
; CHECK-NEXT:    sub x5, x13, x2
; CHECK-NEXT:    add x13, x3, #32
; CHECK-NEXT:    stp x0, x29, [sp, #120] // 8-byte Folded Spill
; CHECK-NEXT:    and x3, x5, #0xc0
; CHECK-NEXT:    stp x28, x27, [sp, #144] // 16-byte Folded Spill
; CHECK-NEXT:    sub x3, x13, x3, lsr #3
...
; CHECK-NEXT:    and x19, x5, #0x3f
; CHECK-NEXT:    mvn w20, w5
; CHECK-NEXT:    stp x16, x14, [sp, #96]
; CHECK-NEXT:    eor x19, x19, #0x3f
; CHECK-NEXT:    stp q0, q0, [sp, #64]
; CHECK-NEXT:    str x18, [sp, #112]
; CHECK-NEXT:    ldp x2, x7, [x3, #8]
; CHECK-NEXT:    ldr x6, [x3, #24]
; CHECK-NEXT:    ldr x3, [x3]
; CHECK-NEXT:    lsl x6, x6, x5
; CHECK-NEXT:    lsr x4, x2, #1
; CHECK-NEXT:    lsr x21, x7, #1
; CHECK-NEXT:    lsr x22, x3, #1
; CHECK-NEXT:    lsl x7, x7, x5
; CHECK-NEXT:    lsl x2, x2, x5
; CHECK-NEXT:    lsr x20, x4, x20
; CHECK-NEXT:    lsr x21, x21, x19
; CHECK-NEXT:    lsr x19, x22, x19
; CHECK-NEXT:    adcs x4, x1, xzr
; CHECK-NEXT:    lsl x1, x3, x5
; CHECK-NEXT:    cset w22, hs
; CHECK-NEXT:    orr x5, x6, x21
; CHECK-NEXT:    orr x3, x7, x20
; CHECK-NEXT:    orr x2, x2, x19
; CHECK-NEXT:    mov x6, xzr
; CHECK-NEXT:    tbnz w22, #0, .LBB1_5
; CHECK-NEXT:  // %bb.3: // %udiv-preheader
; CHECK-NEXT:    stp x16, x14, [sp]
; CHECK-NEXT:    and x16, x13, #0xc0
; CHECK-NEXT:    mov x21, sp
; CHECK-NEXT:    add x14, x21, x16, lsr #3
; CHECK-NEXT:    stp q0, q0, [sp, #32]
; CHECK-NEXT:    mvn w24, w13
; CHECK-NEXT:    stp x18, x0, [sp, #16]
; CHECK-NEXT:    and x18, x13, #0x3f
; CHECK-NEXT:    mov x19, xzr
; CHECK-NEXT:    ldp x16, x0, [x14, #16]
; CHECK-NEXT:    eor x18, x18, #0x3f
; CHECK-NEXT:    mov x20, xzr
; CHECK-NEXT:    mov x7, xzr
; CHECK-NEXT:    lsl x23, x16, #1
; CHECK-NEXT:    lsl x21, x0, #1
; CHECK-NEXT:    lsr x25, x16, x13
; CHECK-NEXT:    mov x16, #-1 // =0xffffffffffffffff
; CHECK-NEXT:    lsl x24, x23, x24
; CHECK-NEXT:    ldp x23, x22, [x14]
; CHECK-NEXT:    subs x14, x8, #1
; CHECK-NEXT:    lsl x21, x21, x18
; CHECK-NEXT:    lsl x26, x22, #1
; CHECK-NEXT:    lsr x27, x22, x13
; CHECK-NEXT:    lsr x28, x23, x13
; CHECK-NEXT:    lsr x23, x0, x13
; CHECK-NEXT:    orr x22, x21, x25
; CHECK-NEXT:    lsl x26, x26, x18
; CHECK-NEXT:    adcs x18, x9, x16
; CHECK-NEXT:    orr x25, x27, x24
; CHECK-NEXT:    adcs x0, x10, x16
; CHECK-NEXT:    orr x24, x26, x28
; CHECK-NEXT:    adc x21, x11, x16
...
; CHECK-NEXT:    mvn w19, w15
; CHECK-NEXT:    stp x0, x1, [sp, #112]
; CHECK-NEXT:    stp q0, q0, [sp, #80]
; CHECK-NEXT:    stp x2, x3, [sp, #128]
; CHECK-NEXT:    ldp x12, x17, [x13, #8]
; CHECK-NEXT:    ldr x16, [x13, #24]
; CHECK-NEXT:    ldr x13, [x13]
; CHECK-NEXT:    stp x0, x2, [sp] // 16-byte Folded Spill
; CHECK-NEXT:    lsl x16, x16, x15
; CHECK-NEXT:    lsr x14, x12, #1
; CHECK-NEXT:    lsr x20, x17, #1
; CHECK-NEXT:    lsl x17, x17, x15
; CHECK-NEXT:    lsl x12, x12, x15
; CHECK-NEXT:    lsr x21, x14, x19
; CHECK-NEXT:    lsr x19, x13, #1
; CHECK-NEXT:    lsr x20, x20, x18
; CHECK-NEXT:    adcs x14, x11, xzr
; CHECK-NEXT:    lsl x11, x13, x15
; CHECK-NEXT:    lsr x18, x19, x18
; CHECK-NEXT:    cset w19, hs
; CHECK-NEXT:    orr x15, x16, x20
; CHECK-NEXT:    orr x13, x17, x21
; CHECK-NEXT:    mov x16, xzr
...
; CHECK-NEXT:    eor x23, x21, #0x3f
; CHECK-NEXT:    mvn w25, w8
; CHECK-NEXT:    ldp x2, x20, [x0, #16]
; CHECK-NEXT:    mov x18, xzr
; CHECK-NEXT:    ldp x0, x21, [x0]
; CHECK-NEXT:    mov x19, xzr
; CHECK-NEXT:    mov x17, xzr
; CHECK-NEXT:    lsl x22, x20, #1
; CHECK-NEXT:    lsl x24, x2, #1
; CHECK-NEXT:    lsr x26, x2, x8
; CHECK-NEXT:    lsr x28, x21, x8
; CHECK-NEXT:    subs x2, x4, #1
; CHECK-NEXT:    lsr x0, x0, x8
; CHECK-NEXT:    lsl x27, x22, x23
; CHECK-NEXT:    lsl x22, x21, #1
; CHECK-NEXT:    mov x21, #-1 // =0xffffffffffffffff
; CHECK-NEXT:    lsl x24, x24, x25
; CHECK-NEXT:    lsl x29, x22, x23
; CHECK-NEXT:    adcs x22, x5, x21
; CHECK-NEXT:    orr x25, x27, x26
; CHECK-NEXT:    lsr x26, x20, x8
; CHECK-NEXT:    adcs x23, x6, x21
; CHECK-NEXT:    orr x28, x28, x24
; CHECK-NEXT:    orr x27, x29, x0
...
; CHECK-NEXT:    ldp x0, x2, [sp] // 16-byte Folded Reload
...
; CHECK-NEXT:    and x12, x9, #0xc0
; CHECK-NEXT:    stp x23, x11, [sp, #144]
; CHECK-NEXT:    adds x17, x2, #1
; CHECK-NEXT:    sub x10, x10, x12, lsr #3
...
; CHECK-NEXT:  // %bb.3: // %udiv-preheader
; CHECK-NEXT:    and x9, x17, #0xc0
; CHECK-NEXT:    add x10, sp, #32
; CHECK-NEXT:    stp q0, q0, [sp, #64]
; CHECK-NEXT:    add x9, x10, x9, lsr #3
; CHECK-NEXT:    stp x21, x22, [sp, #32]
; CHECK-NEXT:    and x21, x17, #0x3f
; CHECK-NEXT:    stp x23, x11, [sp, #48]
; CHECK-NEXT:    eor x23, x21, #0x3f
; CHECK-NEXT:    mvn w25, w17
; CHECK-NEXT:    ldp x12, x10, [x9, #16]
; CHECK-NEXT:    mov x19, xzr
; CHECK-NEXT:    ldp x9, x21, [x9]
; CHECK-NEXT:    mov x20, xzr
; CHECK-NEXT:    mov x7, xzr
; CHECK-NEXT:    lsl x24, x12, #1
; CHECK-NEXT:    lsl x22, x10, #1
; CHECK-NEXT:    lsr x12, x12, x17
; CHECK-NEXT:    lsr x28, x21, x17
; CHECK-NEXT:    lsr x9, x9, x17
; CHECK-NEXT:    lsr x27, x10, x17
; CHECK-NEXT:    lsl x25, x24, x25
; CHECK-NEXT:    lsl x24, x21, #1
; CHECK-NEXT:    lsl x26, x22, x23
; CHECK-NEXT:    subs x21, x13, #1
; CHECK-NEXT:    mov x22, #-1 // =0xffffffffffffffff
; CHECK-NEXT:    lsl x30, x24, x23
; CHECK-NEXT:    adcs x23, x14, x22
; CHECK-NEXT:    orr x26, x26, x12
...
; CHECK-NEXT:    orr x14, x0, x3
; CHECK-NEXT:    orr x13, x19, x2
; CHECK-NEXT:    mov x17, xzr
; CHECK-NEXT:    tbnz w7, #0, .LBB5_5
; CHECK-NEXT:  // %bb.3: // %udiv-preheader
; CHECK-NEXT:    stp x4, x18, [sp]
; CHECK-NEXT:    and x4, x9, #0xc0
; CHECK-NEXT:    mov x6, sp
; CHECK-NEXT:    add x4, x6, x4, lsr #3
; CHECK-NEXT:    stp q0, q0, [sp, #32]
; CHECK-NEXT:    mvn w21, w9
; CHECK-NEXT:    stp x1, x5, [sp, #16]
; CHECK-NEXT:    mov w18, #7 // =0x7
; CHECK-NEXT:    and x5, x9, #0x3f
; CHECK-NEXT:    ldp x1, x6, [x4, #16]
; CHECK-NEXT:    eor x5, x5, #0x3f
; CHECK-NEXT:    mov x2, xzr
; CHECK-NEXT:    mov x3, xzr
; CHECK-NEXT:    mov x0, xzr
; CHECK-NEXT:    lsl x20, x1, #1
; CHECK-NEXT:    lsl x7, x6, #1
; CHECK-NEXT:    lsr x22, x1, x9
; CHECK-NEXT:    subs x1, x18, #1
; CHECK-NEXT:    lsl x21, x20, x21
; CHECK-NEXT:    ldp x20, x19, [x4]
; CHECK-NEXT:    mov x4, #-1 // =0xffffffffffffffff
; CHECK-NEXT:    lsl x7, x7, x5
; CHECK-NEXT:    lsl x23, x19, #1
; CHECK-NEXT:    lsr x24, x19, x9
; CHECK-NEXT:    lsr x25, x20, x9
; CHECK-NEXT:    lsr x20, x6, x9
; CHECK-NEXT:    orr x19, x7, x22
; CHECK-NEXT:    lsl x23, x23, x5
; CHECK-NEXT:    adcs x5, xzr, x4
; CHECK-NEXT:    orr x21, x24, x21
; CHECK-NEXT:    adcs x6, xzr, x4
; CHECK-NEXT:    orr x22, x23, x25
; CHECK-NEXT:    adc x7, xzr, x4
...
; CHECK-NEXT:    orr x13, x2, x23
; CHECK-NEXT:    sbc x20, x20, xzr
; CHECK-NEXT:    subs x9, x9, #1
; CHECK-NEXT:    adcs x10, x10, x4
; CHECK-NEXT:    adcs x11, x11, x4
; CHECK-NEXT:    adc x15, x15, x4
; CHECK-NEXT:    orr x3, x9, x11
; CHECK-NEXT:    orr x2, x10, x15
; CHECK-NEXT:    orr x23, x3, x2
; CHECK-NEXT:    mov x2, xzr
; CHECK-NEXT:    mov x3, xzr
