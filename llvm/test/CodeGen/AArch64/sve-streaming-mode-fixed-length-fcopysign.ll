...
; NONEON-NOSVE-NEXT:    stp q2, q1, [sp, #96]
...
; SVE-NEXT:    ld1w { z0.d }, p0/z, [x1, x8, lsl #2]
; SVE-NEXT:    ld1w { z1.d }, p0/z, [x1]
; SVE-NEXT:    and z2.d, z2.d, #0x7fffffffffffffff
...
; SVE2-NEXT:    ldp q4, q3, [x0]
; SVE2-NEXT:    ld1w { z0.d }, p0/z, [x1, x8, lsl #2]
...
; NONEON-NOSVE-NEXT:    ldr q0, [x1]
; NONEON-NOSVE-NEXT:    stp q2, q0, [sp, #-96]!
; NONEON-NOSVE-NEXT:    .cfi_def_cfa_offset 96
