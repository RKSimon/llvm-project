...
; EL-LABEL: ebpf_filter:
; EL:       # %bb.0:
; EL-NEXT:    r1 = 0
; EL-NEXT:    *(u16 *)(r10 + 26) = r1
; EL-NEXT:    *(u16 *)(r10 + 24) = r1
; EL-NEXT:    *(u16 *)(r10 + 22) = r1
; EL-NEXT:    *(u16 *)(r10 + 20) = r1
; EL-NEXT:    *(u16 *)(r10 + 18) = r1
; EL-NEXT:    *(u16 *)(r10 + 16) = r1
; EL-NEXT:    *(u16 *)(r10 + 14) = r1
; EL-NEXT:    *(u16 *)(r10 + 12) = r1
; EL-NEXT:    *(u16 *)(r10 + 10) = r1
; EL-NEXT:    *(u16 *)(r10 + 8) = r1
; EL-NEXT:    *(u16 *)(r10 + 6) = r1
; EL-NEXT:    *(u16 *)(r10 + 4) = r1
; EL-NEXT:    *(u16 *)(r10 + 2) = r1
; EL-NEXT:    *(u16 *)(r10 + 0) = r1
; EL-NEXT:    r1 = 11033905661445 ll
; EL-NEXT:    *(u64 *)(r10 - 8) = r1
; EL-NEXT:    r2 = r10
; EL-NEXT:    r2 += -8
; EL-NEXT:    r1 = routing ll
; EL-NEXT:    call bpf_map_lookup_elem
; EL-NEXT:    exit
;
; EB-LABEL: ebpf_filter:
; EB:       # %bb.0:
; EB-NEXT:    r1 = 0
; EB-NEXT:    *(u16 *)(r10 + 26) = r1
; EB-NEXT:    *(u16 *)(r10 + 24) = r1
; EB-NEXT:    *(u16 *)(r10 + 22) = r1
; EB-NEXT:    *(u16 *)(r10 + 20) = r1
; EB-NEXT:    *(u16 *)(r10 + 18) = r1
; EB-NEXT:    *(u16 *)(r10 + 16) = r1
; EB-NEXT:    *(u16 *)(r10 + 14) = r1
; EB-NEXT:    *(u16 *)(r10 + 12) = r1
; EB-NEXT:    *(u16 *)(r10 + 10) = r1
; EB-NEXT:    *(u16 *)(r10 + 8) = r1
; EB-NEXT:    *(u16 *)(r10 + 6) = r1
; EB-NEXT:    *(u16 *)(r10 + 4) = r1
; EB-NEXT:    *(u16 *)(r10 + 2) = r1
; EB-NEXT:    *(u16 *)(r10 + 0) = r1
; EB-NEXT:    r1 = 361984551142686720 ll
; EB-NEXT:    *(u64 *)(r10 - 8) = r1
; EB-NEXT:    r2 = r10
; EB-NEXT:    r2 += -8
; EB-NEXT:    r1 = routing ll
; EB-NEXT:    call bpf_map_lookup_elem
; EB-NEXT:    exit
