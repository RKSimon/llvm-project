...
; RV32I-NEXT:    lw t6, 0(a2)
; RV32I-NEXT:    lw t1, 4(a2)
; RV32I-NEXT:    sltu a6, a3, a4
; RV32I-NEXT:    mv a2, a6
; RV32I-NEXT:    beq a1, a5, .LBB11_2
; RV32I-NEXT:  # %bb.1:
; RV32I-NEXT:    slt a2, a5, a1
; RV32I-NEXT:  .LBB11_2:
; RV32I-NEXT:    addi sp, sp, -16
; RV32I-NEXT:    sw s0, 12(sp) # 4-byte Folded Spill
; RV32I-NEXT:    sltu t2, t6, t4
; RV32I-NEXT:    sltu s0, t1, t0
; RV32I-NEXT:    mv t3, t2
; RV32I-NEXT:    beq t0, t1, .LBB11_4
; RV32I-NEXT:  # %bb.3:
; RV32I-NEXT:    mv t3, s0
; RV32I-NEXT:  .LBB11_4:
; RV32I-NEXT:    xor a7, a1, a5
; RV32I-NEXT:    xor t5, a4, a3
; RV32I-NEXT:    or a7, t5, a7
; RV32I-NEXT:    beqz a7, .LBB11_6
; RV32I-NEXT:  # %bb.5:
; RV32I-NEXT:    mv t3, a2
; RV32I-NEXT:  .LBB11_6:
; RV32I-NEXT:    sltu t5, t4, t6
; RV32I-NEXT:    bnez t3, .LBB11_8
; RV32I-NEXT:  # %bb.7:
; RV32I-NEXT:    sub a2, t1, t0
; RV32I-NEXT:    sub a7, a2, t2
; RV32I-NEXT:    sub a2, t6, t4
; RV32I-NEXT:    bne t1, t0, .LBB11_9
; RV32I-NEXT:    j .LBB11_10
; RV32I-NEXT:  .LBB11_8:
; RV32I-NEXT:    sub a2, t0, t1
; RV32I-NEXT:    sub a7, a2, t5
; RV32I-NEXT:    sub a2, t4, t6
; RV32I-NEXT:    beq t1, t0, .LBB11_10
; RV32I-NEXT:  .LBB11_9:
; RV32I-NEXT:    mv t2, s0
; RV32I-NEXT:  .LBB11_10:
; RV32I-NEXT:    bne t0, t1, .LBB11_13
; RV32I-NEXT:  # %bb.11:
; RV32I-NEXT:    bnez t3, .LBB11_14
; RV32I-NEXT:  .LBB11_12:
; RV32I-NEXT:    sub a5, a5, a1
; RV32I-NEXT:    sub a1, a3, a4
; RV32I-NEXT:    sub a3, a5, a6
; RV32I-NEXT:    sltu a4, a1, t2
; RV32I-NEXT:    sub a3, a3, a4
; RV32I-NEXT:    sub a1, a1, t2
; RV32I-NEXT:    j .LBB11_15
; RV32I-NEXT:  .LBB11_13:
; RV32I-NEXT:    sltu t5, t0, t1
...
; RV32I-NEXT:    sltu a3, a4, t5
; RV32I-NEXT:    sub a3, a1, a3
; RV32I-NEXT:    sub a1, a4, t5
; RV32I-NEXT:  .LBB11_15:
; RV32I-NEXT:    snez a4, a1
; RV32I-NEXT:    or a5, a2, a7
; RV32I-NEXT:    add a3, a3, a4
; RV32I-NEXT:    snez a4, a5
; RV32I-NEXT:    neg a1, a1
...
; RV32ZBB-NEXT:    lw a5, 12(a2)
; RV32ZBB-NEXT:    lw t6, 0(a2)
; RV32ZBB-NEXT:    lw t1, 4(a2)
; RV32ZBB-NEXT:    sltu a6, a3, a4
; RV32ZBB-NEXT:    mv a2, a6
; RV32ZBB-NEXT:    beq a1, a5, .LBB11_2
; RV32ZBB-NEXT:  # %bb.1:
; RV32ZBB-NEXT:    slt a2, a5, a1
; RV32ZBB-NEXT:  .LBB11_2:
; RV32ZBB-NEXT:    addi sp, sp, -16
; RV32ZBB-NEXT:    sw s0, 12(sp) # 4-byte Folded Spill
; RV32ZBB-NEXT:    sltu t2, t6, t4
; RV32ZBB-NEXT:    sltu s0, t1, t0
; RV32ZBB-NEXT:    mv t3, t2
; RV32ZBB-NEXT:    beq t0, t1, .LBB11_4
; RV32ZBB-NEXT:  # %bb.3:
; RV32ZBB-NEXT:    mv t3, s0
; RV32ZBB-NEXT:  .LBB11_4:
; RV32ZBB-NEXT:    xor a7, a1, a5
; RV32ZBB-NEXT:    xor t5, a4, a3
; RV32ZBB-NEXT:    or a7, t5, a7
; RV32ZBB-NEXT:    beqz a7, .LBB11_6
; RV32ZBB-NEXT:  # %bb.5:
; RV32ZBB-NEXT:    mv t3, a2
; RV32ZBB-NEXT:  .LBB11_6:
; RV32ZBB-NEXT:    sltu t5, t4, t6
; RV32ZBB-NEXT:    bnez t3, .LBB11_8
; RV32ZBB-NEXT:  # %bb.7:
; RV32ZBB-NEXT:    sub a2, t1, t0
; RV32ZBB-NEXT:    sub a7, a2, t2
; RV32ZBB-NEXT:    sub a2, t6, t4
; RV32ZBB-NEXT:    bne t1, t0, .LBB11_9
; RV32ZBB-NEXT:    j .LBB11_10
; RV32ZBB-NEXT:  .LBB11_8:
; RV32ZBB-NEXT:    sub a2, t0, t1
; RV32ZBB-NEXT:    sub a7, a2, t5
; RV32ZBB-NEXT:    sub a2, t4, t6
; RV32ZBB-NEXT:    beq t1, t0, .LBB11_10
; RV32ZBB-NEXT:  .LBB11_9:
; RV32ZBB-NEXT:    mv t2, s0
; RV32ZBB-NEXT:  .LBB11_10:
; RV32ZBB-NEXT:    bne t0, t1, .LBB11_13
; RV32ZBB-NEXT:  # %bb.11:
; RV32ZBB-NEXT:    bnez t3, .LBB11_14
; RV32ZBB-NEXT:  .LBB11_12:
; RV32ZBB-NEXT:    sub a5, a5, a1
; RV32ZBB-NEXT:    sub a1, a3, a4
; RV32ZBB-NEXT:    sub a3, a5, a6
; RV32ZBB-NEXT:    sltu a4, a1, t2
; RV32ZBB-NEXT:    sub a3, a3, a4
; RV32ZBB-NEXT:    sub a1, a1, t2
; RV32ZBB-NEXT:    j .LBB11_15
; RV32ZBB-NEXT:  .LBB11_13:
; RV32ZBB-NEXT:    sltu t5, t0, t1
...
; RV32ZBB-NEXT:    sltu a3, a4, t5
; RV32ZBB-NEXT:    sub a3, a1, a3
; RV32ZBB-NEXT:    sub a1, a4, t5
; RV32ZBB-NEXT:  .LBB11_15:
; RV32ZBB-NEXT:    snez a4, a1
; RV32ZBB-NEXT:    or a5, a2, a7
; RV32ZBB-NEXT:    add a3, a3, a4
; RV32ZBB-NEXT:    snez a4, a5
; RV32ZBB-NEXT:    neg a1, a1
...
; RV32I-NEXT:    sub a7, a2, t2
; RV32I-NEXT:    sub a2, t6, t4
; RV32I-NEXT:    bne t1, t0, .LBB12_9
; RV32I-NEXT:    j .LBB12_10
; RV32I-NEXT:  .LBB12_8:
; RV32I-NEXT:    sub a2, t0, t1
; RV32I-NEXT:    sub a7, a2, t5
; RV32I-NEXT:    sub a2, t4, t6
; RV32I-NEXT:    beq t1, t0, .LBB12_10
; RV32I-NEXT:  .LBB12_9:
; RV32I-NEXT:    mv t2, s0
; RV32I-NEXT:  .LBB12_10:
; RV32I-NEXT:    bne t0, t1, .LBB12_13
; RV32I-NEXT:  # %bb.11:
...
; RV32ZBB-NEXT:    sltu s0, t1, t0
; RV32ZBB-NEXT:    mv t3, t2
; RV32ZBB-NEXT:    beq t0, t1, .LBB12_4
; RV32ZBB-NEXT:  # %bb.3:
; RV32ZBB-NEXT:    mv t3, s0
...
; RV32ZBB-NEXT:    sub a7, a2, t2
; RV32ZBB-NEXT:    sub a2, t6, t4
; RV32ZBB-NEXT:    bne t1, t0, .LBB12_9
; RV32ZBB-NEXT:    j .LBB12_10
; RV32ZBB-NEXT:  .LBB12_8:
; RV32ZBB-NEXT:    sub a2, t0, t1
; RV32ZBB-NEXT:    sub a7, a2, t5
; RV32ZBB-NEXT:    sub a2, t4, t6
; RV32ZBB-NEXT:    beq t1, t0, .LBB12_10
; RV32ZBB-NEXT:  .LBB12_9:
; RV32ZBB-NEXT:    mv t2, s0
; RV32ZBB-NEXT:  .LBB12_10:
; RV32ZBB-NEXT:    bne t0, t1, .LBB12_13
; RV32ZBB-NEXT:  # %bb.11:
