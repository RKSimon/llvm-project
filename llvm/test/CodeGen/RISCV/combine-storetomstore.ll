...
; RISCV-NEXT:    vfirst.m a4, v0
; RISCV-NEXT:    beqz a4, .LBB4_7
; RISCV-NEXT:  # %bb.6:
; RISCV-NEXT:    addi a4, a1, 4
; RISCV-NEXT:    j .LBB4_8
; RISCV-NEXT:  .LBB4_7:
; RISCV-NEXT:    addi a4, a0, 16
; RISCV-NEXT:  .LBB4_8:
; RISCV-NEXT:    lh a2, 0(a2)
; RISCV-NEXT:    lh a3, 0(a3)
; RISCV-NEXT:    lh a4, 0(a4)
; RISCV-NEXT:    vmerge.vim v8, v8, 1, v0
; RISCV-NEXT:    vslidedown.vi v8, v8, 1
; RISCV-NEXT:    vmv.x.s a5, v8
; RISCV-NEXT:    andi a5, a5, 1
; RISCV-NEXT:    bnez a5, .LBB4_10
; RISCV-NEXT:  # %bb.9:
; RISCV-NEXT:    addi a0, a1, 6
; RISCV-NEXT:    j .LBB4_11
; RISCV-NEXT:  .LBB4_10:
; RISCV-NEXT:    addi a0, a0, 24
; RISCV-NEXT:  .LBB4_11:
; RISCV-NEXT:    lh a0, 0(a0)
; RISCV-NEXT:    sh a2, 0(a1)
; RISCV-NEXT:    sh a3, 2(a1)
; RISCV-NEXT:    sh a4, 4(a1)
; RISCV-NEXT:    sh a0, 6(a1)
; RISCV-NEXT:    ret
...
; RISCV-NEXT:    vmerge.vim v10, v9, 1, v0
...
; RISCV-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; RISCV-NEXT:    vmsne.vi v0, v11, 0
; RISCV-NEXT:    vfirst.m a4, v0
; RISCV-NEXT:    beqz a4, .LBB11_7
; RISCV-NEXT:  # %bb.6:
; RISCV-NEXT:    addi a4, a1, 4
...
; RISCV-NEXT:    vmv.x.s a5, v11
; RISCV-NEXT:    andi a5, a5, 1
; RISCV-NEXT:    bnez a5, .LBB11_10
; RISCV-NEXT:  # %bb.9:
; RISCV-NEXT:    addi a5, a1, 6
; RISCV-NEXT:    j .LBB11_11
; RISCV-NEXT:  .LBB11_10:
; RISCV-NEXT:    addi a5, a0, 24
; RISCV-NEXT:  .LBB11_11:
; RISCV-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; RISCV-NEXT:    vmv.v.i v11, 0
; RISCV-NEXT:    vmv1r.v v0, v8
; RISCV-NEXT:    vmerge.vim v8, v11, 1, v0
; RISCV-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; RISCV-NEXT:    vslidedown.vi v8, v8, 4
; RISCV-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
; RISCV-NEXT:    vmsne.vi v0, v8, 0
; RISCV-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; RISCV-NEXT:    vfirst.m a6, v0
; RISCV-NEXT:    beqz a6, .LBB11_13
; RISCV-NEXT:  # %bb.12:
; RISCV-NEXT:    addi a6, a1, 8
; RISCV-NEXT:    j .LBB11_14
; RISCV-NEXT:  .LBB11_13:
; RISCV-NEXT:    addi a6, a0, 32
; RISCV-NEXT:  .LBB11_14:
; RISCV-NEXT:    vmerge.vim v8, v9, 1, v0
; RISCV-NEXT:    vslidedown.vi v8, v8, 1
; RISCV-NEXT:    vmv.x.s a7, v8
; RISCV-NEXT:    andi a7, a7, 1
; RISCV-NEXT:    bnez a7, .LBB11_16
; RISCV-NEXT:  # %bb.15:
; RISCV-NEXT:    addi a7, a1, 10
; RISCV-NEXT:    j .LBB11_17
; RISCV-NEXT:  .LBB11_16:
; RISCV-NEXT:    addi a7, a0, 40
; RISCV-NEXT:  .LBB11_17:
; RISCV-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
...
; RISCV-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; RISCV-NEXT:    vmsne.vi v0, v8, 0
; RISCV-NEXT:    vfirst.m t0, v0
; RISCV-NEXT:    beqz t0, .LBB11_19
; RISCV-NEXT:  # %bb.18:
; RISCV-NEXT:    addi t0, a1, 12
; RISCV-NEXT:    j .LBB11_20
; RISCV-NEXT:  .LBB11_19:
; RISCV-NEXT:    addi t0, a0, 48
; RISCV-NEXT:  .LBB11_20:
; RISCV-NEXT:    lh a2, 0(a2)
; RISCV-NEXT:    lh a3, 0(a3)
; RISCV-NEXT:    lh a4, 0(a4)
; RISCV-NEXT:    lh a5, 0(a5)
; RISCV-NEXT:    lh a6, 0(a6)
; RISCV-NEXT:    lh a7, 0(a7)
; RISCV-NEXT:    lh t0, 0(t0)
; RISCV-NEXT:    vmerge.vim v8, v9, 1, v0
; RISCV-NEXT:    vslidedown.vi v8, v8, 1
; RISCV-NEXT:    vmv.x.s t1, v8
; RISCV-NEXT:    andi t1, t1, 1
; RISCV-NEXT:    bnez t1, .LBB11_22
; RISCV-NEXT:  # %bb.21:
; RISCV-NEXT:    addi a0, a1, 14
; RISCV-NEXT:    j .LBB11_23
; RISCV-NEXT:  .LBB11_22:
; RISCV-NEXT:    addi a0, a0, 56
; RISCV-NEXT:  .LBB11_23:
; RISCV-NEXT:    lh a0, 0(a0)
; RISCV-NEXT:    sh a6, 8(a1)
; RISCV-NEXT:    sh a7, 10(a1)
; RISCV-NEXT:    sh t0, 12(a1)
; RISCV-NEXT:    sh a0, 14(a1)
; RISCV-NEXT:    sh a2, 0(a1)
; RISCV-NEXT:    sh a3, 2(a1)
; RISCV-NEXT:    sh a4, 4(a1)
; RISCV-NEXT:    sh a5, 6(a1)
; RISCV-NEXT:    ret
