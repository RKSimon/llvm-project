...
; RV32-NEXT:    lw s0, 4(a2)
; RV32-NEXT:    lw s1, 8(a2)
; RV32-NEXT:    lw a2, 12(a2)
; RV32-NEXT:    sltu s2, t5, t6
; RV32-NEXT:    or s3, a7, t5
; RV32-NEXT:    add t6, t6, s2
; RV32-NEXT:    or s2, t3, t6
; RV32-NEXT:    or s3, s3, s2
; RV32-NEXT:    srli s2, s1, 1
; RV32-NEXT:    srli s4, s0, 1
...
; RV32-NEXT:    sll a2, s1, t4
; RV32-NEXT:    or a2, a2, s4
; RV32-NEXT:    sll s1, s0, t4
; RV32-NEXT:    or s1, s1, a4
; RV32-NEXT:    sll t4, a0, t4
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    bnez s3, .LBB2_26
...
; RV32-NEXT:    or a6, a5, a3
; RV32-NEXT:    addi a2, a4, 64
; RV32-NEXT:    addi a0, t1, 128
; RV32-NEXT:    or a7, a7, a3
; RV32-NEXT:    or t0, t0, a5
; RV32-NEXT:    or s4, t0, a7
; RV32-NEXT:    sltu s1, a0, t1
...
; RV32-NEXT:    beqz a6, .LBB3_13
; RV32-NEXT:    j .LBB3_14
; RV32-NEXT:  .LBB3_11:
; RV32-NEXT:    snez a7, a6
; RV32-NEXT:    sltu a4, a2, a4
; RV32-NEXT:    addi a7, a7, -1
; RV32-NEXT:    and s0, a7, a4
...
; RV32-NEXT:    slli a5, s9, 31
; RV32-NEXT:    srli a6, a7, 1
...
; RV32-NEXT:    and s6, s3, t4
; RV32-NEXT:    srli s3, s3, 2
; RV32-NEXT:    and s3, s3, t4
; RV32-NEXT:    add s3, s6, s3
; RV32-NEXT:    srli s6, s3, 4
...
; RV32-NEXT:    j .LBB3_28
; RV32-NEXT:  .LBB3_26:
; RV32-NEXT:    snez a1, s7
; RV32-NEXT:    sltu a4, a2, a4
; RV32-NEXT:    addi a1, a1, -1
; RV32-NEXT:    and a1, a1, a4
; RV32-NEXT:    snez s3, s4
; RV32-NEXT:    bnez s8, .LBB3_25
...
; RV32-NEXT:    mv s5, s10
; RV32-NEXT:    andi a2, s10, 1
; RV32-NEXT:    lw a5, 32(sp) # 4-byte Folded Reload
; RV32-NEXT:    lw t0, 28(sp) # 4-byte Folded Reload
; RV32-NEXT:    or s7, a5, t0
; RV32-NEXT:    or t4, s9, a7
; RV32-NEXT:    neg t3, a3
; RV32-NEXT:    and t5, s3, s1
; RV32-NEXT:    bnez a6, .LBB3_32
...
; RV32-NEXT:    or a5, t1, t2
; RV32-NEXT:    or t4, t4, s11
; RV32-NEXT:    and a2, t5, t3
; RV32-NEXT:    xori t3, a0, 1
; RV32-NEXT:    snez a6, a6
; RV32-NEXT:    neg t3, t3
; RV32-NEXT:    addi a6, a6, -1
; RV32-NEXT:    and a0, a6, a0
; RV32-NEXT:    sltu a6, s2, a4
; RV32-NEXT:    and t3, a0, t3
; RV32-NEXT:    mv a0, a6
; RV32-NEXT:    beq s0, a1, .LBB3_34
...
; RV32-NEXT:    sltu t4, a2, t3
; RV32-NEXT:    mv t5, a0
; RV32-NEXT:    beq a2, t3, .LBB3_36
...
; RV32-NEXT:    sub s1, a2, t3
; RV32-NEXT:    sub t3, s0, a6
; RV32-NEXT:    sltu a1, s1, a0
; RV32-NEXT:    add a1, t4, a1
; RV32-NEXT:    neg t4, a1
; RV32-NEXT:    sub s1, s1, a0
; RV32-NEXT:    or a1, s1, t4
; RV32-NEXT:    sub a0, s2, a4
...
; RV32-NEXT:    or s4, a3, a4
; RV32-NEXT:    or a3, a5, s2
; RV32-NEXT:    sll t6, a1, ra
; RV32-NEXT:    beqz a3, .LBB3_55
...
; RV32-NEXT:    or a5, s7, s10
; RV32-NEXT:    srl a2, a2, a6
; RV32-NEXT:    srli a1, a1, 3
; RV32-NEXT:    xori a4, a4, 31
; RV32-NEXT:    snez a5, a5
; RV32-NEXT:    add a1, a3, a1
; RV32-NEXT:    add a5, s5, a5
...
; RV32-NEXT:    srl a3, t1, t0
; RV32-NEXT:    or ra, a3, a2
; RV32-NEXT:    lw a3, 20(sp) # 4-byte Folded Reload
...
; RV32-NEXT:    sub s7, a2, a1
; RV32-NEXT:    andi a5, a5, 1
; RV32-NEXT:    sw a5, 16(sp) # 4-byte Folded Spill
; RV32-NEXT:    andi t2, a0, 1
...
; RV32-NEXT:    andi a4, t2, 1
; RV32-NEXT:    or s10, a0, a4
; RV32-NEXT:    beq s6, s11, .LBB3_50
...
; RV32-NEXT:    # in Loop: Header=BB3_45 Depth=1
; RV32-NEXT:    lw a1, 36(sp) # 4-byte Folded Reload
; RV32-NEXT:    xor a4, a1, ra
; RV32-NEXT:    xor a5, s7, a6
...
; RV32-NEXT:    and a3, t2, a0
; RV32-NEXT:    lw a0, 32(sp) # 4-byte Folded Reload
; RV32-NEXT:    and a0, t2, a0
; RV32-NEXT:    lw a1, 20(sp) # 4-byte Folded Reload
; RV32-NEXT:    and a5, t2, a1
; RV32-NEXT:    sltu a4, s10, a0
; RV32-NEXT:    mv s9, a4
...
; RV32-NEXT:    sw a5, 0(ra)
; RV32-NEXT:    sw a1, 4(ra)
; RV32-NEXT:    sw a3, 8(ra)
; RV32-NEXT:    sw a4, 12(ra)
