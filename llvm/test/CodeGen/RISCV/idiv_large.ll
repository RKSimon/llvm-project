...
; RV32-NEXT:    addi t3, a5, 32
; RV32-NEXT:    j .LBB1_3
; RV32-NEXT:  .LBB1_2:
; RV32-NEXT:    srli a5, t1, 1
...
; RV32-NEXT:    slli t4, t1, 16
; RV32-NEXT:    add t1, t1, t4
; RV32-NEXT:    srli s2, t1, 24
; RV32-NEXT:  .LBB1_11: # %_udiv-special-cases
; RV32-NEXT:    andi t4, a1, 1
; RV32-NEXT:    andi s5, a4, 1
; RV32-NEXT:    or t1, a2, a3
; RV32-NEXT:    sltu s1, s3, s1
; RV32-NEXT:    slli s6, a6, 31
; RV32-NEXT:    or s3, a6, a5
; RV32-NEXT:    addi s4, s4, -1
; RV32-NEXT:    beqz s6, .LBB1_13
; RV32-NEXT:  # %bb.12:
; RV32-NEXT:    srli t5, s6, 1
; RV32-NEXT:    or t5, s6, t5
; RV32-NEXT:    srli s6, t5, 2
; RV32-NEXT:    or t5, t5, s6
; RV32-NEXT:    srli s6, t5, 4
; RV32-NEXT:    or t5, t5, s6
; RV32-NEXT:    srli s6, t5, 8
; RV32-NEXT:    or t5, t5, s6
; RV32-NEXT:    srli s6, t5, 16
; RV32-NEXT:    or t5, t5, s6
; RV32-NEXT:    not t5, t5
; RV32-NEXT:    srli s6, t5, 1
; RV32-NEXT:    and t2, s6, t2
...
; RV32-NEXT:    or t2, t1, s5
; RV32-NEXT:    or t0, s3, t4
; RV32-NEXT:    or t6, s0, t6
; RV32-NEXT:    and a7, s4, s1
...
; RV32-NEXT:    slli s4, a1, 1
; RV32-NEXT:    slli t2, t2, 1
; RV32-NEXT:    or s1, s4, s1
; RV32-NEXT:    srli s4, a1, 31
; RV32-NEXT:    or t2, t5, t2
; RV32-NEXT:    or a1, t6, s1
...
; RV32-NEXT:    sub t4, t1, s0
; RV32-NEXT:    sub s2, s2, t6
; RV32-NEXT:    or t1, a7, t0
; RV32-NEXT:    seqz t6, a7
; RV32-NEXT:    snez t1, t1
; RV32-NEXT:    sub t0, t0, t6
; RV32-NEXT:    add t1, t3, t1
; RV32-NEXT:    not t1, t1
; RV32-NEXT:    addi a7, a7, -1
; RV32-NEXT:    andi t3, t1, 1
; RV32-NEXT:    or t1, a7, t0
...
; RV32-NEXT:    addi t5, a5, 1365
; RV32-NEXT:    or t6, a4, a2
...
; RV32-NEXT:    j .LBB3_3
; RV32-NEXT:  .LBB3_2:
; RV32-NEXT:    srli a2, t6, 1
; RV32-NEXT:    or a2, t6, a2
; RV32-NEXT:    srli a3, a2, 2
; RV32-NEXT:    or a2, a2, a3
; RV32-NEXT:    srli a3, a2, 4
; RV32-NEXT:    or a2, a2, a3
...
; RV32-NEXT:    or a5, t6, a2
; RV32-NEXT:    or a6, a6, a4
; RV32-NEXT:    addi t2, t1, 128
; RV32-NEXT:    or s2, a6, a5
; RV32-NEXT:    addi a6, a7, 64
; RV32-NEXT:    sltu s1, t2, t1
; RV32-NEXT:    bnez s2, .LBB3_11
; RV32-NEXT:  # %bb.9: # %_udiv-special-cases
; RV32-NEXT:    mv s0, s1
...
; RV32-NEXT:    or a3, a5, a2
; RV32-NEXT:    or a4, s7, a2
; RV32-NEXT:    or a1, a1, a5
; RV32-NEXT:    addi a6, s4, 128
; RV32-NEXT:    or s5, a1, a4
; RV32-NEXT:    addi s7, s6, 64
; RV32-NEXT:    sltu s4, a6, s4
...
; RV32-NEXT:    or a4, s6, a4
; RV32-NEXT:    or t5, t1, t2
; RV32-NEXT:    or s1, a3, s11
; RV32-NEXT:    and a3, a5, a2
; RV32-NEXT:    addi a2, s4, -1
; RV32-NEXT:    and a5, a2, s4
; RV32-NEXT:    snez a2, s5
; RV32-NEXT:    addi t4, a2, -1
; RV32-NEXT:    sltu a2, s3, t3
; RV32-NEXT:    and t4, t4, a5
; RV32-NEXT:    mv a5, a2
; RV32-NEXT:    beq s0, a1, .LBB3_34
; RV32-NEXT:  # %bb.33: # %_udiv-special-cases
; RV32-NEXT:    sltu a5, s0, a1
; RV32-NEXT:  .LBB3_34: # %_udiv-special-cases
; RV32-NEXT:    or a4, a4, a6
; RV32-NEXT:    or s1, s1, t5
; RV32-NEXT:    sltu t5, a3, t4
; RV32-NEXT:    mv s4, a5
; RV32-NEXT:    beq a3, t4, .LBB3_36
; RV32-NEXT:  # %bb.35: # %_udiv-special-cases
; RV32-NEXT:    mv s4, t5
; RV32-NEXT:  .LBB3_36: # %_udiv-special-cases
; RV32-NEXT:    seqz a4, a4
; RV32-NEXT:    sub a3, a3, t4
; RV32-NEXT:    seqz s2, s1
; RV32-NEXT:    sltu t4, a3, a5
; RV32-NEXT:    andi s1, s4, 1
; RV32-NEXT:    add t4, t5, t4
; RV32-NEXT:    neg t4, t4
; RV32-NEXT:    sub a3, a3, a5
; RV32-NEXT:    sub s0, s0, a1
; RV32-NEXT:    or a1, a3, t4
; RV32-NEXT:    sub t5, s0, a2
; RV32-NEXT:    sub s0, s3, t3
; RV32-NEXT:    beqz a1, .LBB3_38
; RV32-NEXT:  # %bb.37: # %_udiv-special-cases
; RV32-NEXT:    snez a1, a1
; RV32-NEXT:    or a2, a4, s2
; RV32-NEXT:    bnez s1, .LBB3_39
; RV32-NEXT:    j .LBB3_40
; RV32-NEXT:  .LBB3_38:
; RV32-NEXT:    sltiu a1, s0, 129
; RV32-NEXT:    snez a2, t5
; RV32-NEXT:    xori a1, a1, 1
; RV32-NEXT:    or a1, a1, a2
; RV32-NEXT:    or a2, a4, s2
; RV32-NEXT:    beqz s1, .LBB3_40
; RV32-NEXT:  .LBB3_39: # %_udiv-special-cases
; RV32-NEXT:    mv a1, s1
; RV32-NEXT:  .LBB3_40: # %_udiv-special-cases
; RV32-NEXT:    or s2, a2, a1
; RV32-NEXT:    addi t3, s2, -1
; RV32-NEXT:    and a5, s11, t3
; RV32-NEXT:    and a4, t3, t2
; RV32-NEXT:    and a1, t3, a7
; RV32-NEXT:    and a2, t3, t1
; RV32-NEXT:    and t3, t3, t0
; RV32-NEXT:    bnez s2, .LBB3_57
; RV32-NEXT:  # %bb.41: # %_udiv-special-cases
; RV32-NEXT:    xori s2, s0, 128
; RV32-NEXT:    or s3, s1, a3
; RV32-NEXT:    or s4, t5, t4
; RV32-NEXT:    or s2, s2, s3
; RV32-NEXT:    or s2, s2, s4
; RV32-NEXT:    beqz s2, .LBB3_57
...
; RV32-NEXT:    lw a2, 0(a2)
; RV32-NEXT:    srl a3, s6, a3
; RV32-NEXT:    sll t1, ra, s5
; RV32-NEXT:    andi t2, a1, 31
; RV32-NEXT:    slli a4, a4, 1
; RV32-NEXT:    xori t2, t2, 31
; RV32-NEXT:    srl s5, t0, a1
; RV32-NEXT:    sll a4, a4, t2
; RV32-NEXT:    or a3, t1, a3
; RV32-NEXT:    or s11, s5, a4
; RV32-NEXT:    srl a4, a7, a1
; RV32-NEXT:    slli t0, t0, 1
; RV32-NEXT:    sll t0, t0, t2
; RV32-NEXT:    slli a7, a7, 1
; RV32-NEXT:    srl t1, a5, a1
; RV32-NEXT:    sll a7, a7, t2
; RV32-NEXT:    or s6, a4, t0
; RV32-NEXT:    or s5, t1, a7
; RV32-NEXT:    li t1, 0
...
; RV32-NEXT:    xor t0, s6, a7
; RV32-NEXT:    or t0, t0, ra
; RV32-NEXT:    srli t0, s1, 31
; RV32-NEXT:    slli ra, t6, 1
; RV32-NEXT:    srli t1, s3, 31
; RV32-NEXT:    slli s1, s1, 1
; RV32-NEXT:    or t0, ra, t0
; RV32-NEXT:    or t1, s1, t1
; RV32-NEXT:    srli s1, s0, 31
; RV32-NEXT:    slli s3, s3, 1
; RV32-NEXT:    or s1, s3, s1
; RV32-NEXT:    slli s0, s0, 1
; RV32-NEXT:    srli ra, t6, 31
; RV32-NEXT:    or s0, s7, s0
; RV32-NEXT:    or s3, s8, s1
; RV32-NEXT:    or s1, s9, t1
; RV32-NEXT:    or t6, s10, t0
; RV32-NEXT:    or t0, s4, ra
; RV32-NEXT:    andi ra, t0, 1
; RV32-NEXT:    andi t1, t2, 1
; RV32-NEXT:    sltu t0, s6, a7
; RV32-NEXT:    sub a7, s6, a7
; RV32-NEXT:    sub s6, a7, a5
...
; RV32-NEXT:    or a3, a1, t3
; RV32-NEXT:    not a2, a2
; RV32-NEXT:    seqz a3, a3
; RV32-NEXT:    seqz a4, a1
; RV32-NEXT:    sltu a5, a7, a3
; RV32-NEXT:    sub t5, a7, a3
; RV32-NEXT:    sub t3, t3, a4
; RV32-NEXT:    sub t4, t4, a5
; RV32-NEXT:    addi a1, a1, -1
; RV32-NEXT:    or a3, t3, t4
; RV32-NEXT:    or a4, a1, t5
; RV32-NEXT:    andi s4, a2, 1
; RV32-NEXT:    or a3, a4, a3
; RV32-NEXT:    or a2, a3, s4
; RV32-NEXT:    li s7, 0
; RV32-NEXT:    li s8, 0
; RV32-NEXT:    li s9, 0
; RV32-NEXT:    li s10, 0
...
; RV32-NEXT:    slli s6, s6, 1
; RV32-NEXT:    or s6, s6, a2
; RV32-NEXT:    sw t5, 36(sp) # 4-byte Folded Spill
; RV32-NEXT:    beq s2, a3, .LBB3_47
...
; RV32-NEXT:    xor a5, a5, s6
; RV32-NEXT:    xor a6, s2, a3
; RV32-NEXT:    or a5, a5, a6
...
; RV32-NEXT:    slli a2, s3, 1
; RV32-NEXT:    srli a1, s3, 31
; RV32-NEXT:    slli a3, s1, 1
; RV32-NEXT:    or a2, a2, a0
; RV32-NEXT:    or a1, a3, a1
; RV32-NEXT:    srli s1, s1, 31
; RV32-NEXT:    slli a4, t6, 1
; RV32-NEXT:    or a4, a4, s1
; RV32-NEXT:    slli s0, s0, 1
; RV32-NEXT:    srli a5, t6, 31
; RV32-NEXT:    or t3, t1, s0
...
; RV64-NEXT:    or t2, t4, t2
; RV64-NEXT:    addi s2, s1, 128
; RV64-NEXT:    bnez t2, .LBB3_8
; RV64-NEXT:  # %bb.7: # %_udiv-special-cases
; RV64-NEXT:    mv t3, s2
; RV64-NEXT:  .LBB3_8: # %_udiv-special-cases
; RV64-NEXT:    srli t4, a5, 1
; RV64-NEXT:    slli t6, a1, 63
; RV64-NEXT:    or t6, t6, t4
; RV64-NEXT:    slli t4, a5, 63
; RV64-NEXT:    srli s0, a6, 1
; RV64-NEXT:    snez s4, t2
; RV64-NEXT:    or s0, s0, t4
; RV64-NEXT:    bnez t6, .LBB3_10
; RV64-NEXT:  # %bb.9: # %_udiv-special-cases
; RV64-NEXT:    srli t2, s0, 1
; RV64-NEXT:    or t2, s0, t2
; RV64-NEXT:    srli t4, t2, 2
; RV64-NEXT:    or t2, t2, t4
; RV64-NEXT:    srli t4, t2, 4
; RV64-NEXT:    or t2, t2, t4
; RV64-NEXT:    srli t4, t2, 8
; RV64-NEXT:    or t2, t2, t4
; RV64-NEXT:    srli t4, t2, 16
; RV64-NEXT:    or t2, t2, t4
; RV64-NEXT:    srli t4, t2, 32
; RV64-NEXT:    or t2, t2, t4
; RV64-NEXT:    not t2, t2
; RV64-NEXT:    srli t4, t2, 1
; RV64-NEXT:    and t4, t4, a7
; RV64-NEXT:    sub t2, t2, t4
; RV64-NEXT:    srli t4, t2, 2
...
; RV64-NEXT:    srli t4, t2, 4
; RV64-NEXT:    add t2, t2, t4
; RV64-NEXT:    and t2, t2, t1
; RV64-NEXT:    slli t4, t2, 8
; RV64-NEXT:    add t2, t2, t4
; RV64-NEXT:    slli t4, t2, 16
; RV64-NEXT:    add t2, t2, t4
; RV64-NEXT:    slli t4, t2, 32
; RV64-NEXT:    add t2, t2, t4
; RV64-NEXT:    srli t2, t2, 56
; RV64-NEXT:    addi s3, t2, 64
; RV64-NEXT:    j .LBB3_11
; RV64-NEXT:  .LBB3_10:
...
; RV64-NEXT:    slli t4, t2, 32
; RV64-NEXT:    add t2, t2, t4
; RV64-NEXT:    srli s3, t2, 56
; RV64-NEXT:  .LBB3_11: # %_udiv-special-cases
; RV64-NEXT:    andi t4, a1, 1
; RV64-NEXT:    andi s5, a4, 1
; RV64-NEXT:    or t2, a2, a3
; RV64-NEXT:    sltu s1, s2, s1
; RV64-NEXT:    slli s6, a6, 63
; RV64-NEXT:    or s2, a6, a5
; RV64-NEXT:    addi s4, s4, -1
; RV64-NEXT:    beqz s6, .LBB3_13
; RV64-NEXT:  # %bb.12:
; RV64-NEXT:    srli t5, s6, 1
; RV64-NEXT:    or t5, s6, t5
; RV64-NEXT:    srli s6, t5, 2
; RV64-NEXT:    or t5, t5, s6
; RV64-NEXT:    srli s6, t5, 4
; RV64-NEXT:    or t5, t5, s6
; RV64-NEXT:    srli s6, t5, 8
; RV64-NEXT:    or t5, t5, s6
; RV64-NEXT:    srli s6, t5, 16
; RV64-NEXT:    or t5, t5, s6
; RV64-NEXT:    srli s6, t5, 32
; RV64-NEXT:    or t5, t5, s6
; RV64-NEXT:    not t5, t5
; RV64-NEXT:    srli s6, t5, 1
; RV64-NEXT:    and a7, s6, a7
; RV64-NEXT:    sub a7, t5, a7
; RV64-NEXT:    srli t5, a7, 2
; RV64-NEXT:    and a7, a7, t0
; RV64-NEXT:    and t0, t5, t0
; RV64-NEXT:    add a7, a7, t0
; RV64-NEXT:    srli t0, a7, 4
; RV64-NEXT:    add a7, a7, t0
; RV64-NEXT:    and a7, a7, t1
...
; RV64-NEXT:    add a7, a7, t0
; RV64-NEXT:    srli t5, a7, 56
; RV64-NEXT:  .LBB3_13: # %_udiv-special-cases
; RV64-NEXT:    or t1, t2, s5
; RV64-NEXT:    or t0, s2, t4
; RV64-NEXT:    or t6, s0, t6
; RV64-NEXT:    and a7, s4, s1
...
; RV64-NEXT:    sltu t5, s0, t5
; RV64-NEXT:    addi t6, t6, -1
; RV64-NEXT:    and s0, t6, t5
; RV64-NEXT:    sltu s1, t3, s3
; RV64-NEXT:    seqz t0, t0
; RV64-NEXT:    mv t5, s1
; RV64-NEXT:    beq a7, s0, .LBB3_17
; RV64-NEXT:  # %bb.16: # %_udiv-special-cases
; RV64-NEXT:    sltu t5, a7, s0
; RV64-NEXT:  .LBB3_17: # %_udiv-special-cases
; RV64-NEXT:    or t6, t1, t0
; RV64-NEXT:    andi t5, t5, 1
; RV64-NEXT:    sub a7, a7, s0
; RV64-NEXT:    sub t0, a7, s1
; RV64-NEXT:    sub t1, t3, s3
; RV64-NEXT:    beqz t5, .LBB3_19
...
; RV64-NEXT:    snez t3, t0
; RV64-NEXT:    or a7, a7, t3
; RV64-NEXT:  .LBB3_20: # %_udiv-special-cases
; RV64-NEXT:    or s0, t6, a7
; RV64-NEXT:    addi t6, s0, -1
; RV64-NEXT:    and a7, t4, t6
...
; RV64-NEXT:    ld a5, 8(s5)
; RV64-NEXT:    srli a6, s2, 1
; RV64-NEXT:    ld t4, 16(s5)
; RV64-NEXT:    srl a6, a6, s1
; RV64-NEXT:    sll s1, s4, s3
; RV64-NEXT:    ld s2, 0(s5)
; RV64-NEXT:    or s1, s1, a6
; RV64-NEXT:    srl a6, a5, a7
; RV64-NEXT:    andi s3, a7, 63
; RV64-NEXT:    slli t4, t4, 1
; RV64-NEXT:    xori s3, s3, 63
; RV64-NEXT:    sll t4, t4, s3
; RV64-NEXT:    slli a5, a5, 1
; RV64-NEXT:    or t4, a6, t4
; RV64-NEXT:    sll a5, a5, s3
; RV64-NEXT:    andi s1, s1, 1
; RV64-NEXT:    srl a6, s2, a7
; RV64-NEXT:    or s2, a6, a5
; RV64-NEXT:    snez a5, t2
; RV64-NEXT:    seqz a6, a2
; RV64-NEXT:    add a5, a4, a5
; RV64-NEXT:    sub a4, a3, a6
; RV64-NEXT:    not a5, a5
; RV64-NEXT:    andi a5, a5, 1
; RV64-NEXT:    addi a6, a2, -1
; RV64-NEXT:    j .LBB3_26
; RV64-NEXT:  .LBB3_24: # %udiv-do-while
; RV64-NEXT:    # in Loop: Header=BB3_26 Depth=1
; RV64-NEXT:    sltu s1, a4, t2
...
; RV64-NEXT:    and s3, t4, a3
; RV64-NEXT:    srli s1, t1, 63
; RV64-NEXT:    slli s4, a1, 1
; RV64-NEXT:    slli t1, t1, 1
; RV64-NEXT:    or s1, s4, s1
; RV64-NEXT:    srli s4, a1, 63
; RV64-NEXT:    or t1, t5, t1
; RV64-NEXT:    or a1, t6, s1
; RV64-NEXT:    or s1, s0, s4
; RV64-NEXT:    andi s1, s1, 1
; RV64-NEXT:    and t6, t4, a2
; RV64-NEXT:    sltu s0, s2, t6
; RV64-NEXT:    sub t2, t2, s3
; RV64-NEXT:    andi t5, t4, 1
; RV64-NEXT:    sub t4, t2, s0
; RV64-NEXT:    sub s2, s2, t6
; RV64-NEXT:    or t2, a7, t0
; RV64-NEXT:    seqz t6, a7
; RV64-NEXT:    snez t2, t2
; RV64-NEXT:    sub t0, t0, t6
; RV64-NEXT:    add t2, t3, t2
; RV64-NEXT:    not t2, t2
; RV64-NEXT:    addi a7, a7, -1
; RV64-NEXT:    andi t3, t2, 1
; RV64-NEXT:    or t2, a7, t0
