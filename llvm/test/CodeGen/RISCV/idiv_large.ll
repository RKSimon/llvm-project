...
; RV32-NEXT:    neg s1, t1
; RV32-NEXT:    seqz t4, a1
; RV32-NEXT:    sub t1, t2, t1
; RV32-NEXT:    add t4, t0, t4
; RV32-NEXT:    andi t0, t1, 31
; RV32-NEXT:    andi t1, t1, 96
; RV32-NEXT:    or t2, a1, t4
; RV32-NEXT:    xori s2, t0, 31
; RV32-NEXT:    srli t0, t1, 3
; RV32-NEXT:    seqz t1, t2
; RV32-NEXT:    sub s3, t6, t0
; RV32-NEXT:    add a7, a7, t1
; RV32-NEXT:    lw t6, 0(s3)
; RV32-NEXT:    lw s4, 4(s3)
; RV32-NEXT:    andi t0, a7, 1
; RV32-NEXT:    or t2, t2, t0
; RV32-NEXT:    srli a7, t6, 1
; RV32-NEXT:    sll t1, s4, s1
; RV32-NEXT:    srl a7, a7, s2
; RV32-NEXT:    or t1, t1, a7
; RV32-NEXT:    sll a7, t6, s1
; RV32-NEXT:    beqz t2, .LBB1_28
...
; RV32-NEXT:    srli t3, s2, 31
; RV32-NEXT:    slli t5, s1, 1
; RV32-NEXT:    slli s2, s2, 1
; RV32-NEXT:    or s4, t5, t3
; RV32-NEXT:    andi t3, s3, 1
; RV32-NEXT:    or s2, s2, t3
; RV32-NEXT:    bne a2, s4, .LBB1_24
; RV32-NEXT:  # %bb.27: # in Loop: Header=BB1_26 Depth=1
; RV32-NEXT:    sltu t3, a6, s2
; RV32-NEXT:    j .LBB1_25
; RV32-NEXT:  .LBB1_28:
; RV32-NEXT:    li t3, 0
; RV32-NEXT:    li t5, 0
; RV32-NEXT:  .LBB1_29: # %udiv-loop-exit
; RV32-NEXT:    srli a2, a7, 31
; RV32-NEXT:    slli a3, t1, 1
; RV32-NEXT:    srli a4, t1, 31
; RV32-NEXT:    slli a7, a7, 1
; RV32-NEXT:    or a1, t2, a7
; RV32-NEXT:    or a2, t3, a2
; RV32-NEXT:    or a4, t5, a4
; RV32-NEXT:    or t4, a2, a3
; RV32-NEXT:    andi t6, a4, 1
; RV32-NEXT:  .LBB1_30: # %udiv-end
; RV32-NEXT:    andi a2, t6, 1
...
; RV32-NEXT:    sltu a5, t5, a3
; RV32-NEXT:    seqz t2, t2
; RV32-NEXT:    mv t3, a5
...
; RV32-NEXT:    sltu a2, a4, a7
; RV32-NEXT:    addi a0, a0, -1
; RV32-NEXT:    and s0, a0, a2
; RV32-NEXT:    bnez t2, .LBB3_10
...
; RV32-NEXT:    sub t5, s4, t5
; RV32-NEXT:    and s4, t5, t4
; RV32-NEXT:    srli t5, t5, 2
; RV32-NEXT:    and t4, t5, t4
; RV32-NEXT:    add t4, s4, t4
...
; RV32-NEXT:    or s9, a5, t5
; RV32-NEXT:    or t5, t0, a7
; RV32-NEXT:    neg t3, t3
; RV32-NEXT:    and s4, s3, s1
...
; RV32-NEXT:    or a5, s9, a4
; RV32-NEXT:    or s1, t1, t2
; RV32-NEXT:    or s3, t5, s11
; RV32-NEXT:    and a3, s4, t3
; RV32-NEXT:    xori a4, a0, 1
; RV32-NEXT:    snez a2, a2
; RV32-NEXT:    neg a4, a4
; RV32-NEXT:    addi a2, a2, -1
; RV32-NEXT:    and a0, a2, a0
; RV32-NEXT:    sltu t3, s2, t4
; RV32-NEXT:    and t5, a0, a4
; RV32-NEXT:    mv a4, t3
...
; RV32-NEXT:    and t4, a1, a7
; RV32-NEXT:    and s0, a1, t1
; RV32-NEXT:    and a1, a1, t0
; RV32-NEXT:    bnez s1, .LBB3_57
; RV32-NEXT:  # %bb.41: # %_udiv-special-cases
; RV32-NEXT:    or s1, t3, t5
; RV32-NEXT:    xori s2, a3, 128
; RV32-NEXT:    or s2, s2, a0
; RV32-NEXT:    or s2, s2, a4
; RV32-NEXT:    or s1, s2, s1
; RV32-NEXT:    beqz s1, .LBB3_57
...
; RV32-NEXT:    andi t6, a5, 224
; RV32-NEXT:    or s0, a1, t3
; RV32-NEXT:    xori a5, a3, 31
; RV32-NEXT:    srli a3, t6, 3
; RV32-NEXT:    seqz s0, s0
; RV32-NEXT:    sub ra, t4, a3
; RV32-NEXT:    add s0, a4, s0
; RV32-NEXT:    lw t4, 0(ra)
; RV32-NEXT:    lw s1, 4(ra)
; RV32-NEXT:    lw s2, 8(ra)
; RV32-NEXT:    lw a3, 12(ra)
; RV32-NEXT:    sltu a4, s0, a4
; RV32-NEXT:    or t6, a1, s0
; RV32-NEXT:    add t5, t5, a4
; RV32-NEXT:    or a4, t3, t5
; RV32-NEXT:    or a4, t6, a4
; RV32-NEXT:    srli t6, s2, 1
; RV32-NEXT:    seqz s3, a4
; RV32-NEXT:    add a0, a0, s3
; RV32-NEXT:    sll s3, a3, a2
; RV32-NEXT:    srl t6, t6, a5
; RV32-NEXT:    or t6, s3, t6
; RV32-NEXT:    srli s3, s1, 1
; RV32-NEXT:    sll s2, s2, a2
; RV32-NEXT:    srl s3, s3, a5
; RV32-NEXT:    or s3, s2, s3
; RV32-NEXT:    srli s2, t4, 1
; RV32-NEXT:    sll s1, s1, a2
; RV32-NEXT:    srl s2, s2, a5
; RV32-NEXT:    andi s4, a0, 1
; RV32-NEXT:    or s2, s1, s2
; RV32-NEXT:    or a0, a4, s4
...
; RV32-NEXT:    andi a4, a1, 224
; RV32-NEXT:    addi a7, sp, 56
; RV32-NEXT:    andi t0, a1, 31
; RV32-NEXT:    or t1, s9, s10
; RV32-NEXT:    srl a3, a3, a5
; RV32-NEXT:    srli a4, a4, 3
; RV32-NEXT:    xori a5, t0, 31
; RV32-NEXT:    snez t0, t1
; RV32-NEXT:    add a4, a7, a4
; RV32-NEXT:    add a6, a6, t0
; RV32-NEXT:    lw a7, 16(a4)
; RV32-NEXT:    lw t0, 0(a4)
; RV32-NEXT:    lw t1, 4(a4)
; RV32-NEXT:    lw t2, 8(a4)
...
; RV32-NEXT:    slli s1, t1, 1
; RV32-NEXT:    sll a7, a7, a5
; RV32-NEXT:    sll a0, a0, a5
; RV32-NEXT:    sll s5, a2, a5
; RV32-NEXT:    sll s1, s1, a5
; RV32-NEXT:    srl a2, a4, a1
; RV32-NEXT:    or ra, a2, a7
; RV32-NEXT:    lw a7, 36(sp) # 4-byte Folded Reload
; RV32-NEXT:    seqz a4, a7
; RV32-NEXT:    srl a2, t2, a1
; RV32-NEXT:    or a2, a2, a0
...
; RV32-NEXT:    sw a7, 12(sp) # 4-byte Folded Spill
; RV32-NEXT:    li s11, 0
; RV32-NEXT:    li s10, 0
; RV32-NEXT:    j .LBB3_45
...
; RV32-NEXT:    and s1, a5, s1
; RV32-NEXT:    xor t2, t1, a7
; RV32-NEXT:    xor s9, a2, s1
; RV32-NEXT:    or t2, s9, t2
; RV32-NEXT:    li s9, 0
; RV32-NEXT:    li t2, 0
; RV32-NEXT:    sltu s5, a2, s1
; RV32-NEXT:    sub s1, a2, s1
; RV32-NEXT:    sub a7, t1, a7
; RV32-NEXT:    srli a2, s3, 31
; RV32-NEXT:    sub a0, a0, t0
; RV32-NEXT:    slli t0, t6, 1
; RV32-NEXT:    or t0, t0, a2
; RV32-NEXT:    srli a2, s2, 31
; RV32-NEXT:    slli s3, s3, 1
; RV32-NEXT:    or t1, s3, a2
; RV32-NEXT:    srli a2, t4, 31
; RV32-NEXT:    slli s2, s2, 1
; RV32-NEXT:    or s2, s2, a2
; RV32-NEXT:    slli t4, t4, 1
; RV32-NEXT:    lw a2, 52(sp) # 4-byte Folded Reload
; RV32-NEXT:    or t4, a2, t4
; RV32-NEXT:    srli a2, t6, 31
; RV32-NEXT:    or s8, s8, a2
; RV32-NEXT:    sub a2, s1, ra
; RV32-NEXT:    sltu s1, s1, ra
; RV32-NEXT:    or t6, a1, s0
; RV32-NEXT:    sub a7, a7, s5
; RV32-NEXT:    or s3, t3, t5
; RV32-NEXT:    sub a0, a0, a6
; RV32-NEXT:    or a6, a1, t3
...
; RV32-NEXT:    sub t3, t3, t6
; RV32-NEXT:    lw a5, 48(sp) # 4-byte Folded Reload
; RV32-NEXT:    or s2, a5, s2
; RV32-NEXT:    lw a5, 44(sp) # 4-byte Folded Reload
; RV32-NEXT:    or s3, a5, t1
; RV32-NEXT:    or t6, s7, t0
; RV32-NEXT:    andi a5, s8, 1
; RV32-NEXT:    sub ra, a7, s1
; RV32-NEXT:    snez a7, s5
; RV32-NEXT:    sltu t0, s0, a6
; RV32-NEXT:    sub s0, s0, a6
; RV32-NEXT:    add a7, s4, a7
; RV32-NEXT:    sub t5, t5, t0
; RV32-NEXT:    or a6, a1, s0
; RV32-NEXT:    addi a7, a7, 1
; RV32-NEXT:    or t0, t3, t5
; RV32-NEXT:    andi s4, a7, 1
...
; RV32-NEXT:    slli a1, t6, 1
; RV32-NEXT:    or a0, a1, a0
; RV32-NEXT:    srli a1, s2, 31
; RV32-NEXT:    slli s3, s3, 1
; RV32-NEXT:    or a2, s3, a1
...
; RV32-NEXT:    or s0, a3, s2
; RV32-NEXT:    or t4, s9, a2
...
; RV32-NEXT:    sw s0, 4(s8)
; RV32-NEXT:    sw t4, 8(s8)
...
; RV64-NEXT:    neg s1, t1
; RV64-NEXT:    seqz t3, a1
; RV64-NEXT:    sub t1, t2, t1
; RV64-NEXT:    add t3, t0, t3
; RV64-NEXT:    andi t0, t1, 63
; RV64-NEXT:    andi t1, t1, 192
; RV64-NEXT:    or t2, a1, t3
; RV64-NEXT:    xori s2, t0, 63
; RV64-NEXT:    srli t0, t1, 3
; RV64-NEXT:    seqz t1, t2
; RV64-NEXT:    sub s3, t6, t0
; RV64-NEXT:    add a7, a7, t1
; RV64-NEXT:    ld t6, 0(s3)
; RV64-NEXT:    ld s4, 8(s3)
; RV64-NEXT:    andi t0, a7, 1
; RV64-NEXT:    or t2, t2, t0
; RV64-NEXT:    srli a7, t6, 1
; RV64-NEXT:    sll t1, s4, s1
; RV64-NEXT:    srl a7, a7, s2
; RV64-NEXT:    or t1, t1, a7
; RV64-NEXT:    sll a7, t6, s1
; RV64-NEXT:    beqz t2, .LBB3_28
...
; RV64-NEXT:    srli t4, s2, 63
; RV64-NEXT:    slli t5, s1, 1
; RV64-NEXT:    slli s2, s2, 1
; RV64-NEXT:    or s4, t5, t4
; RV64-NEXT:    andi t4, s3, 1
; RV64-NEXT:    or s2, s2, t4
; RV64-NEXT:    bne a2, s4, .LBB3_24
; RV64-NEXT:  # %bb.27: # in Loop: Header=BB3_26 Depth=1
; RV64-NEXT:    sltu t4, a6, s2
; RV64-NEXT:    j .LBB3_25
; RV64-NEXT:  .LBB3_28:
; RV64-NEXT:    li t4, 0
; RV64-NEXT:    li t5, 0
; RV64-NEXT:  .LBB3_29: # %udiv-loop-exit
; RV64-NEXT:    srli a2, a7, 63
; RV64-NEXT:    slli a3, t1, 1
; RV64-NEXT:    srli a4, t1, 63
; RV64-NEXT:    slli a7, a7, 1
; RV64-NEXT:    or a1, t2, a7
; RV64-NEXT:    or a2, t4, a2
; RV64-NEXT:    or a4, t5, a4
; RV64-NEXT:    or t3, a2, a3
; RV64-NEXT:    andi t6, a4, 1
; RV64-NEXT:  .LBB3_30: # %udiv-end
; RV64-NEXT:    andi a2, t6, 1
