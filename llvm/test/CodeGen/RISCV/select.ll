...
; RV64IM-NEXT:    addi a2, a2, -1
; RV64IM-NEXT:    addw a0, a0, a2
; RV64IM-NEXT:    ret
;
; RV64IMXVTCONDOPS-LABEL: select_cst_not4:
; RV64IMXVTCONDOPS:       # %bb.0:
; RV64IMXVTCONDOPS-NEXT:    lui a2, 524288
; RV64IMXVTCONDOPS-NEXT:    slt a0, a0, a1
; RV64IMXVTCONDOPS-NEXT:    addi a2, a2, -1
; RV64IMXVTCONDOPS-NEXT:    addw a0, a0, a2
; RV64IMXVTCONDOPS-NEXT:    ret
;
...
; RV64IMZICOND:       # %bb.0:
; RV64IMZICOND-NEXT:    lui a2, 524288
; RV64IMZICOND-NEXT:    slt a0, a0, a1
; RV64IMZICOND-NEXT:    addi a2, a2, -1
; RV64IMZICOND-NEXT:    addw a0, a0, a2
; RV64IMZICOND-NEXT:    ret
;
