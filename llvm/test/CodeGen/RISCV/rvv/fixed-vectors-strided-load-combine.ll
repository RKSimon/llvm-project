...
; RV64-MISALIGN-NEXT:    addi a0, a0, 16
; RV64-MISALIGN-NEXT:    vle64.v v10, (a0)
; RV64-MISALIGN-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-MISALIGN-NEXT:    vslideup.vi v8, v10, 8
...
; ZVE64F-NEXT:    vlse64.v v10, (a0), a2
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    li a2, -64
; CHECK-NEXT:    addi a3, a0, 192
; CHECK-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; CHECK-NEXT:    vlse64.v v8, (a3), a2
