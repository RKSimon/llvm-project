...
; CHECK-LABEL: vdota4u_vv_scalar_add:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; CHECK-NEXT:    vwmulu.vv v10, v8, v9
; CHECK-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
...
; CHECK-LABEL: vdota4u_vv_partial_reduce_v1i32_v4i8:
; CHECK:       # %bb.0: # %entry
...
; CHECK-LABEL: vdota4_vx_partial_reduce:
; CHECK:       # %bb.0: # %entry
...
; CHECK-LABEL: vdota4su_vv_partial_v4i31_v16i7:
; CHECK:       # %bb.0: # %entry
...
; CHECK-LABEL: vdota4u_vv_accum_disjoint_or:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; CHECK-NEXT:    vwmulu.vv v10, v8, v9
; CHECK-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
