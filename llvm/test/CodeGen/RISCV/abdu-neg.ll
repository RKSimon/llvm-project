...
; RV32I-NEXT:    xor a5, a6, a4
; RV32I-NEXT:    sltu a6, a5, a4
; RV32I-NEXT:    xor t1, t0, a4
; RV32I-NEXT:    mv a7, a6
; RV32I-NEXT:    beqz t0, .LBB11_12
; RV32I-NEXT:  # %bb.11:
; RV32I-NEXT:    sltu a7, t1, a4
; RV32I-NEXT:  .LBB11_12:
...
; RV32I-NEXT:    or a5, a3, a6
; RV32I-NEXT:    snez a5, a5
; RV32I-NEXT:    sub a2, a2, a1
; RV32I-NEXT:    add a2, t1, a2
; RV32I-NEXT:    snez a1, a7
; RV32I-NEXT:    sltu a7, a4, a5
; RV32I-NEXT:    sub a2, a2, a1
; RV32I-NEXT:    sub a1, a2, a7
...
; RV32ZBB-NEXT:    xor a5, a6, a4
; RV32ZBB-NEXT:    sltu a6, a5, a4
; RV32ZBB-NEXT:    xor t1, t0, a4
; RV32ZBB-NEXT:    mv a7, a6
; RV32ZBB-NEXT:    beqz t0, .LBB11_12
; RV32ZBB-NEXT:  # %bb.11:
; RV32ZBB-NEXT:    sltu a7, t1, a4
...
; RV32ZBB-NEXT:    or a5, a3, a6
; RV32ZBB-NEXT:    snez a5, a5
; RV32ZBB-NEXT:    sub a2, a2, a1
; RV32ZBB-NEXT:    add a2, t1, a2
; RV32ZBB-NEXT:    snez a1, a7
; RV32ZBB-NEXT:    sltu a7, a4, a5
; RV32ZBB-NEXT:    sub a2, a2, a1
; RV32ZBB-NEXT:    sub a1, a2, a7
; RV32ZBB-NEXT:    snez a2, a3
