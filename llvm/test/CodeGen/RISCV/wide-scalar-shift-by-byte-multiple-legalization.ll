...
; RV32I-NEXT:    sb t5, 5(a2)
; RV32I-NEXT:    sb t4, 6(a2)
...
; RV32I-NEXT:    srli t2, a4, 16
; RV32I-NEXT:    srli t6, a4, 8
; RV32I-NEXT:    srli s0, a6, 16
...
; RV64I-NEXT:    slli t2, a7, 1
; RV64I-NEXT:    srl a3, a7, a4
; RV64I-NEXT:    slli a7, t0, 1
; RV64I-NEXT:    srl t0, t0, a4
; RV64I-NEXT:    sll a4, t1, a6
; RV64I-NEXT:    sll a5, t2, a5
...
; RV32I-NEXT:    srl a1, a3, t0
; RV32I-NEXT:    slli t6, a4, 1
; RV32I-NEXT:    srl a3, a4, t0
; RV32I-NEXT:    slli s0, a5, 1
; RV32I-NEXT:    srl a4, a5, t0
; RV32I-NEXT:    slli s1, a6, 1
; RV32I-NEXT:    srl a5, a6, t0
; RV32I-NEXT:    slli s2, a7, 1
; RV32I-NEXT:    srl a6, a7, t0
; RV32I-NEXT:    slli s3, t3, 1
; RV32I-NEXT:    srl a7, t3, t0
; RV32I-NEXT:    slli t3, t4, 1
; RV32I-NEXT:    srl t4, t4, t0
; RV32I-NEXT:    sll t0, t5, t2
; RV32I-NEXT:    sll t5, t6, t1
; RV32I-NEXT:    sll t6, s0, t2
; RV32I-NEXT:    sll s0, s1, t1
; RV32I-NEXT:    sll s1, s2, t2
; RV32I-NEXT:    sll t1, s3, t1
; RV32I-NEXT:    sll t2, t3, t2
; RV32I-NEXT:    srli t3, t4, 24
; RV32I-NEXT:    srli s2, t4, 16
; RV32I-NEXT:    srli s3, t4, 8
...
; RV32I-NEXT:    srli s8, t6, 24
; RV32I-NEXT:    srli s9, t6, 16
; RV32I-NEXT:    srli t6, t6, 8
; RV32I-NEXT:    srli s10, t5, 24
; RV32I-NEXT:    srli s11, t5, 16
; RV32I-NEXT:    srli t5, t5, 8
; RV32I-NEXT:    sb a7, 24(a2)
; RV32I-NEXT:    sb t2, 25(a2)
; RV32I-NEXT:    sb t4, 26(a2)
; RV32I-NEXT:    sb t3, 27(a2)
...
; RV32I-NEXT:    sb s6, 15(a2)
; RV32I-NEXT:    sb a3, 8(a2)
; RV32I-NEXT:    sb t6, 9(a2)
; RV32I-NEXT:    sb s9, 10(a2)
; RV32I-NEXT:    sb s8, 11(a2)
; RV32I-NEXT:    sb a1, 4(a2)
; RV32I-NEXT:    sb t5, 5(a2)
; RV32I-NEXT:    sb s11, 6(a2)
; RV32I-NEXT:    sb s10, 7(a2)
; RV32I-NEXT:    sb a0, 0(a2)
...
; RV64I-NEXT:    srl a1, a6, a3
; RV64I-NEXT:    slli a6, a7, 1
; RV64I-NEXT:    srl a7, a7, a3
; RV64I-NEXT:    slli t2, t0, 1
; RV64I-NEXT:    srl a3, t0, a3
; RV64I-NEXT:    sll t0, t1, a5
...
; RV64I-NEXT:    srli t5, a3, 16
; RV64I-NEXT:    srli t6, a3, 8
; RV64I-NEXT:    srli s0, a7, 24
; RV64I-NEXT:    srli s1, a7, 16
; RV64I-NEXT:    srli s2, a7, 8
...
; RV64I-NEXT:    sb s1, 18(a2)
; RV64I-NEXT:    sb s0, 19(a2)
; RV64I-NEXT:    sb a1, 8(a2)
; RV64I-NEXT:    sb s5, 9(a2)
; RV64I-NEXT:    sb s4, 10(a2)
; RV64I-NEXT:    sb s3, 11(a2)
; RV64I-NEXT:    sb a0, 0(a2)
; RV64I-NEXT:    sb a3, 1(a2)
; RV64I-NEXT:    sb a6, 2(a2)
; RV64I-NEXT:    sb s6, 3(a2)
; RV64I-NEXT:    srli a0, a5, 56
; RV64I-NEXT:    srli a1, a5, 48
; RV64I-NEXT:    srli a3, a5, 40
; RV64I-NEXT:    srli a5, a5, 32
; RV64I-NEXT:    srli a6, a4, 56
; RV64I-NEXT:    srli a7, a4, 48
; RV64I-NEXT:    srli t1, a4, 40
...
; RV32I-NEXT:    lw a4, 16(t6)
; RV32I-NEXT:    lw a6, 20(t6)
; RV32I-NEXT:    lw a7, 24(t6)
; RV32I-NEXT:    lw t0, 28(t6)
; RV32I-NEXT:    lw a0, 0(t6)
; RV32I-NEXT:    lw a1, 4(t6)
; RV32I-NEXT:    lw a3, 8(t6)
; RV32I-NEXT:    lw a5, 12(t6)
; RV32I-NEXT:    srli t1, t0, 24
; RV32I-NEXT:    srli t2, t0, 16
; RV32I-NEXT:    srli t3, t0, 8
; RV32I-NEXT:    srli t4, a7, 24
; RV32I-NEXT:    srli t5, a7, 16
; RV32I-NEXT:    srli t6, a7, 8
; RV32I-NEXT:    srli s0, a6, 24
; RV32I-NEXT:    srli s1, a6, 16
; RV32I-NEXT:    srli s2, a6, 8
; RV32I-NEXT:    srli s3, a4, 24
; RV32I-NEXT:    srli s4, a4, 16
; RV32I-NEXT:    srli s5, a4, 8
; RV32I-NEXT:    srli s6, a5, 24
; RV32I-NEXT:    srli s7, a5, 16
; RV32I-NEXT:    srli s8, a5, 8
...
; RV32I-NEXT:    sb s9, 11(a2)
; RV32I-NEXT:    sb a1, 4(a2)
; RV32I-NEXT:    sb a7, 5(a2)
; RV32I-NEXT:    sb t0, 6(a2)
; RV32I-NEXT:    sb ra, 7(a2)
; RV32I-NEXT:    sb a0, 0(a2)
...
; RV64I-NEXT:    ld a4, 24(t3)
; RV64I-NEXT:    ld a0, 0(t3)
; RV64I-NEXT:    ld a1, 8(t3)
; RV64I-NEXT:    ld a3, 16(t3)
...
; RV64I-NEXT:    sb t3, 25(a2)
; RV64I-NEXT:    sb t2, 26(a2)
; RV64I-NEXT:    sb t1, 27(a2)
; RV64I-NEXT:    srli a4, a0, 40
; RV64I-NEXT:    sb s0, 20(a2)
; RV64I-NEXT:    sb t6, 21(a2)
; RV64I-NEXT:    sb t5, 22(a2)
; RV64I-NEXT:    sb t4, 23(a2)
; RV64I-NEXT:    srli a6, a0, 32
; RV64I-NEXT:    sb a3, 16(a2)
; RV64I-NEXT:    sb s3, 17(a2)
; RV64I-NEXT:    sb s2, 18(a2)
; RV64I-NEXT:    sb s1, 19(a2)
; RV64I-NEXT:    srli a3, a0, 24
; RV64I-NEXT:    sb s7, 12(a2)
; RV64I-NEXT:    sb s6, 13(a2)
; RV64I-NEXT:    sb s5, 14(a2)
; RV64I-NEXT:    sb s4, 15(a2)
; RV64I-NEXT:    srli a7, a0, 16
; RV64I-NEXT:    sb a1, 8(a2)
; RV64I-NEXT:    sb s10, 9(a2)
; RV64I-NEXT:    sb s9, 10(a2)
; RV64I-NEXT:    sb s8, 11(a2)
; RV64I-NEXT:    srli a1, a0, 8
; RV64I-NEXT:    sb a6, 4(a2)
; RV64I-NEXT:    sb a4, 5(a2)
; RV64I-NEXT:    sb a5, 6(a2)
...
; RV64I-NEXT:    not a4, a0
; RV64I-NEXT:    xori a3, a3, 63
; RV64I-NEXT:    ld a5, 8(a1)
; RV64I-NEXT:    ld a6, 0(a1)
; RV64I-NEXT:    ld a7, 16(a1)
; RV64I-NEXT:    ld a1, 24(a1)
; RV64I-NEXT:    sll t0, a5, a0
; RV64I-NEXT:    srli t1, a6, 1
; RV64I-NEXT:    sll t2, a7, a0
; RV64I-NEXT:    srli a5, a5, 1
; RV64I-NEXT:    sll t3, a1, a0
; RV64I-NEXT:    srli a1, a7, 1
; RV64I-NEXT:    sll a7, a6, a0
; RV64I-NEXT:    srl a6, t1, a3
; RV64I-NEXT:    srl a5, a5, a4
; RV64I-NEXT:    srl t1, a1, a3
; RV64I-NEXT:    srli a4, t3, 56
; RV64I-NEXT:    srli a3, t2, 56
; RV64I-NEXT:    srli a0, t0, 56
; RV64I-NEXT:    srli t4, a7, 56
; RV64I-NEXT:    srli t5, a7, 48
; RV64I-NEXT:    srli t6, a7, 40
; RV64I-NEXT:    srli s0, a7, 32
; RV64I-NEXT:    srli s1, a7, 24
; RV64I-NEXT:    srli s2, a7, 16
; RV64I-NEXT:    srli s3, a7, 8
; RV64I-NEXT:    or a1, t0, a6
; RV64I-NEXT:    or a5, t2, a5
; RV64I-NEXT:    or a6, t3, t1
; RV64I-NEXT:    sb s0, 4(a2)
; RV64I-NEXT:    sb t6, 5(a2)
; RV64I-NEXT:    sb t5, 6(a2)
; RV64I-NEXT:    sb t4, 7(a2)
; RV64I-NEXT:    sb a7, 0(a2)
; RV64I-NEXT:    sb s3, 1(a2)
; RV64I-NEXT:    sb s2, 2(a2)
; RV64I-NEXT:    sb s1, 3(a2)
; RV64I-NEXT:    srli a7, a6, 48
; RV64I-NEXT:    srli t0, a6, 40
; RV64I-NEXT:    srli t1, a6, 32
; RV64I-NEXT:    srli t2, a6, 24
; RV64I-NEXT:    srli t3, a6, 16
; RV64I-NEXT:    srli t4, a6, 8
; RV64I-NEXT:    srli t5, a5, 48
; RV64I-NEXT:    srli t6, a5, 40
; RV64I-NEXT:    srli s0, a5, 32
; RV64I-NEXT:    srli s1, a5, 24
; RV64I-NEXT:    srli s2, a5, 16
; RV64I-NEXT:    srli s3, a5, 8
; RV64I-NEXT:    srli s4, a1, 48
; RV64I-NEXT:    srli s5, a1, 40
...
; RV32I-NEXT:    or a4, a5, a4
; RV32I-NEXT:    or a5, t1, a6
; RV32I-NEXT:    or a6, s2, s1
; RV32I-NEXT:    lbu t1, 24(a0)
; RV32I-NEXT:    lbu s1, 25(a0)
; RV32I-NEXT:    lbu s2, 26(a0)
; RV32I-NEXT:    lbu s3, 27(a0)
; RV32I-NEXT:    slli t3, t3, 16
; RV32I-NEXT:    slli t6, t6, 24
...
; RV32I-NEXT:    slli a3, a3, 8
; RV32I-NEXT:    or a0, s6, s5
; RV32I-NEXT:    or s5, s10, s8
; RV32I-NEXT:    or s6, a3, s11
; RV32I-NEXT:    lbu s8, 0(a1)
; RV32I-NEXT:    lbu a3, 1(a1)
; RV32I-NEXT:    lbu s10, 2(a1)
; RV32I-NEXT:    lbu a1, 3(a1)
; RV32I-NEXT:    sw zero, 24(sp)
...
; RV32I-NEXT:    or a7, a7, s11
; RV32I-NEXT:    or t0, t2, t0
; RV32I-NEXT:    or t1, s1, t1
; RV32I-NEXT:    or t2, s3, s2
; RV32I-NEXT:    or s1, s7, s4
; RV32I-NEXT:    or s2, ra, s9
; RV32I-NEXT:    or a3, a3, s8
; RV32I-NEXT:    or a1, a1, s10
; RV32I-NEXT:    or a4, a5, a4
; RV32I-NEXT:    or a5, t3, a6
; RV32I-NEXT:    or a6, t6, t4
; RV32I-NEXT:    or a0, s5, a0
; RV32I-NEXT:    or t3, t5, s6
; RV32I-NEXT:    or a7, t0, a7
; RV32I-NEXT:    or t0, t2, t1
; RV32I-NEXT:    or t1, s2, s1
; RV32I-NEXT:    or a1, a1, a3
...
; RV32I-NEXT:    andi a1, a0, 24
; RV32I-NEXT:    not a3, a0
; RV32I-NEXT:    xori a1, a1, 31
; RV32I-NEXT:    lw a4, 0(s0)
; RV32I-NEXT:    lw a5, 4(s0)
; RV32I-NEXT:    lw a6, 8(s0)
; RV32I-NEXT:    lw a7, 12(s0)
; RV32I-NEXT:    lw t0, 16(s0)
; RV32I-NEXT:    lw t1, 20(s0)
; RV32I-NEXT:    lw t2, 24(s0)
; RV32I-NEXT:    lw t3, 28(s0)
; RV32I-NEXT:    sll t4, a5, a0
; RV32I-NEXT:    srli t5, a4, 1
; RV32I-NEXT:    sll t6, a6, a0
; RV32I-NEXT:    srli a5, a5, 1
; RV32I-NEXT:    sll s0, a7, a0
; RV32I-NEXT:    srli a6, a6, 1
; RV32I-NEXT:    sll s1, t0, a0
; RV32I-NEXT:    srli a7, a7, 1
; RV32I-NEXT:    sll s2, t1, a0
; RV32I-NEXT:    srli t0, t0, 1
; RV32I-NEXT:    sll s3, t2, a0
; RV32I-NEXT:    srli t1, t1, 1
; RV32I-NEXT:    sll s4, t3, a0
; RV32I-NEXT:    srli t2, t2, 1
; RV32I-NEXT:    sll a0, a4, a0
; RV32I-NEXT:    srl s5, t5, a1
; RV32I-NEXT:    srl s6, a5, a3
; RV32I-NEXT:    srl s7, a6, a1
; RV32I-NEXT:    srl s8, a7, a3
; RV32I-NEXT:    srl s9, t0, a1
; RV32I-NEXT:    srl s10, t1, a3
; RV32I-NEXT:    srl s11, t2, a1
; RV32I-NEXT:    srli t5, s4, 24
; RV32I-NEXT:    srli t3, s3, 24
; RV32I-NEXT:    srli t2, s2, 24
; RV32I-NEXT:    srli t0, s1, 24
; RV32I-NEXT:    srli a6, s0, 24
; RV32I-NEXT:    srli a5, t6, 24
; RV32I-NEXT:    srli a3, t4, 24
; RV32I-NEXT:    srli a1, a0, 24
; RV32I-NEXT:    srli a4, a0, 16
; RV32I-NEXT:    srli a7, a0, 8
; RV32I-NEXT:    or t1, t4, s5
; RV32I-NEXT:    or t4, t6, s6
; RV32I-NEXT:    or t6, s0, s7
; RV32I-NEXT:    or s0, s1, s8
; RV32I-NEXT:    or s1, s2, s9
; RV32I-NEXT:    or s2, s3, s10
; RV32I-NEXT:    or s3, s4, s11
; RV32I-NEXT:    srli s4, s3, 8
; RV32I-NEXT:    sb s3, 28(a2)
; RV32I-NEXT:    srli s3, s3, 16
; RV32I-NEXT:    srli s5, s2, 16
; RV32I-NEXT:    srli s6, s2, 8
; RV32I-NEXT:    srli s7, s1, 16
; RV32I-NEXT:    srli s8, s1, 8
; RV32I-NEXT:    srli s9, s0, 16
; RV32I-NEXT:    srli s10, s0, 8
; RV32I-NEXT:    srli s11, t6, 16
; RV32I-NEXT:    srli ra, t6, 8
; RV32I-NEXT:    sb s4, 29(a2)
; RV32I-NEXT:    srli s4, t4, 16
; RV32I-NEXT:    sb s3, 30(a2)
; RV32I-NEXT:    sb t5, 31(a2)
; RV32I-NEXT:    srli t5, t4, 8
; RV32I-NEXT:    sb s2, 24(a2)
...
; RV64I-NEXT:    sd a0, 48(sp)
; RV64I-NEXT:    sd a5, 56(sp)
; RV64I-NEXT:    slli a0, a1, 5
; RV64I-NEXT:    slli a1, a1, 2
; RV64I-NEXT:    andi a1, a1, 24
; RV64I-NEXT:    andi a3, a0, 32
; RV64I-NEXT:    not a4, a0
; RV64I-NEXT:    sub a1, s6, a1
; RV64I-NEXT:    xori a3, a3, 63
; RV64I-NEXT:    ld a5, 8(a1)
...
; RV64I-NEXT:    srli a5, a5, 1
; RV64I-NEXT:    sll t3, a1, a0
; RV64I-NEXT:    srli a7, a7, 1
; RV64I-NEXT:    sll a1, a6, a0
; RV64I-NEXT:    srl a0, t1, a3
; RV64I-NEXT:    srl a4, a5, a4
; RV64I-NEXT:    srl a3, a7, a3
; RV64I-NEXT:    srli a5, t3, 56
; RV64I-NEXT:    srli a6, t3, 48
; RV64I-NEXT:    srli a7, t3, 40
; RV64I-NEXT:    srli t1, t3, 32
; RV64I-NEXT:    srli t4, t2, 56
; RV64I-NEXT:    srli t5, t2, 48
; RV64I-NEXT:    srli t6, t2, 40
; RV64I-NEXT:    srli s0, t2, 32
; RV64I-NEXT:    srli s1, t0, 56
; RV64I-NEXT:    srli s2, t0, 48
; RV64I-NEXT:    srli s3, t0, 40
; RV64I-NEXT:    srli s4, t0, 32
; RV64I-NEXT:    srli s5, a1, 56
; RV64I-NEXT:    srli s6, a1, 48
; RV64I-NEXT:    or a0, t0, a0
; RV64I-NEXT:    srli t0, a1, 40
; RV64I-NEXT:    or a4, t2, a4
; RV64I-NEXT:    srli t2, a1, 32
...
; RV64I-NEXT:    sb s4, 12(a2)
; RV64I-NEXT:    sb s3, 13(a2)
; RV64I-NEXT:    sb s2, 14(a2)
; RV64I-NEXT:    sb s1, 15(a2)
; RV64I-NEXT:    sb t2, 4(a2)
; RV64I-NEXT:    sb t0, 5(a2)
; RV64I-NEXT:    sb s6, 6(a2)
; RV64I-NEXT:    sb s5, 7(a2)
; RV64I-NEXT:    sb a1, 0(a2)
...
; RV64I-NEXT:    srli t0, a4, 16
; RV64I-NEXT:    srli t1, a4, 8
...
; RV32I-NEXT:    lw a4, 16(t2)
; RV32I-NEXT:    lw a6, 20(t2)
; RV32I-NEXT:    lw a7, 24(t2)
; RV32I-NEXT:    lw t0, 28(t2)
; RV32I-NEXT:    lw a0, 0(t2)
; RV32I-NEXT:    lw a1, 4(t2)
; RV32I-NEXT:    lw a3, 8(t2)
; RV32I-NEXT:    lw a5, 12(t2)
; RV32I-NEXT:    srli t1, t0, 24
; RV32I-NEXT:    srli t2, t0, 16
; RV32I-NEXT:    srli t3, t0, 8
; RV32I-NEXT:    srli t4, a7, 24
...
; RV64I-NEXT:    ld a4, 24(t2)
; RV64I-NEXT:    ld a0, 0(t2)
; RV64I-NEXT:    ld a1, 8(t2)
; RV64I-NEXT:    ld a3, 16(t2)
; RV64I-NEXT:    srli a5, a4, 56
; RV64I-NEXT:    srli a6, a4, 48
; RV64I-NEXT:    srli a7, a4, 40
; RV64I-NEXT:    srli t0, a4, 32
...
; RV32I-NEXT:    sw t1, 16(sp)
; RV32I-NEXT:    sw a5, 20(sp)
; RV32I-NEXT:    lw a4, 16(s6)
; RV32I-NEXT:    lw a6, 20(s6)
; RV32I-NEXT:    lw a7, 24(s6)
; RV32I-NEXT:    lw t0, 28(s6)
; RV32I-NEXT:    lw a0, 0(s6)
; RV32I-NEXT:    lw a1, 4(s6)
; RV32I-NEXT:    lw a3, 8(s6)
; RV32I-NEXT:    lw a5, 12(s6)
; RV32I-NEXT:    srli t1, t0, 24
; RV32I-NEXT:    srli t2, t0, 16
; RV32I-NEXT:    srli t3, t0, 8
; RV32I-NEXT:    srli t4, a7, 24
...
; RV64I-NEXT:    ld a4, 24(t5)
; RV64I-NEXT:    ld a0, 0(t5)
; RV64I-NEXT:    ld a1, 8(t5)
; RV64I-NEXT:    ld a3, 16(t5)
; RV64I-NEXT:    srli a5, a4, 56
; RV64I-NEXT:    srli a6, a4, 48
; RV64I-NEXT:    srli a7, a4, 40
; RV64I-NEXT:    srli t0, a4, 32
