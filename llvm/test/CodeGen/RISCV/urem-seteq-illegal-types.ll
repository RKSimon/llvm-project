...
; RV32M:       # %bb.0:
; RV32M-NEXT:    li a1, 13
; RV32M-NEXT:    andi a2, a0, 15
; RV32M-NEXT:    mul a1, a2, a1
; RV32M-NEXT:    srli a1, a1, 6
; RV32M-NEXT:    slli a2, a1, 2
...
; RV64M:       # %bb.0:
; RV64M-NEXT:    li a1, 13
; RV64M-NEXT:    andi a2, a0, 15
; RV64M-NEXT:    mul a1, a2, a1
; RV64M-NEXT:    srli a1, a1, 6
...
; RV32MV:       # %bb.0:
; RV32MV-NEXT:    li a1, 13
; RV32MV-NEXT:    andi a2, a0, 15
; RV32MV-NEXT:    mul a1, a2, a1
; RV32MV-NEXT:    srli a1, a1, 6
; RV32MV-NEXT:    slli a2, a1, 2
...
; RV64MV:       # %bb.0:
; RV64MV-NEXT:    li a1, 13
; RV64MV-NEXT:    andi a2, a0, 15
; RV64MV-NEXT:    mul a1, a2, a1
; RV64MV-NEXT:    srli a1, a1, 6
...
; RV32-NEXT:    srli a4, a3, 22
; RV32-NEXT:    srli a5, a3, 11
; RV32-NEXT:    andi a6, a3, 2047
; RV32-NEXT:    or a2, a4, a2
; RV32-NEXT:    slli a4, a4, 10
; RV32-NEXT:    andi a7, a2, 2047
; RV32-NEXT:    slli a2, a2, 8
; RV32-NEXT:    slli t0, a7, 2
; RV32-NEXT:    sub a2, a2, a4
; RV32-NEXT:    slli a4, a7, 4
; RV32-NEXT:    sub t0, t0, a7
; RV32-NEXT:    slli a7, a7, 6
; RV32-NEXT:    sub a4, a4, a7
; RV32-NEXT:    slli a7, a6, 2
; RV32-NEXT:    sub a4, t0, a4
; RV32-NEXT:    slli t0, a6, 4
; RV32-NEXT:    sub a4, a4, a2
; RV32-NEXT:    slli a2, a6, 6
; RV32-NEXT:    add a7, a6, a7
; RV32-NEXT:    add a2, t0, a2
; RV32-NEXT:    addi a4, a4, -1638
; RV32-NEXT:    slli t0, a6, 8
; RV32-NEXT:    andi a4, a4, 2047
; RV32-NEXT:    slli a6, a6, 10
; RV32-NEXT:    add a2, a7, a2
; RV32-NEXT:    sub a6, a6, t0
; RV32-NEXT:    sltiu a4, a4, 2
; RV32-NEXT:    sub a2, a6, a2
; RV32-NEXT:    slli a6, a2, 10
; RV32-NEXT:    srli a3, a3, 8
; RV32-NEXT:    slli a2, a2, 21
; RV32-NEXT:    andi a3, a3, 2040
; RV32-NEXT:    slli a7, a5, 6
; RV32-NEXT:    slli t0, a5, 9
...
; RV32-NEXT:    slli a3, a3, 22
; RV32-NEXT:    xori a2, a4, 1
...
; RV64-NEXT:    andi a2, a2, 2040
; RV64-NEXT:    slli a4, a7, 6
; RV64-NEXT:    slli a6, a7, 9
; RV64-NEXT:    add a2, a7, a2
; RV64-NEXT:    add a4, a4, a6
; RV64-NEXT:    addi a5, a5, -1638
; RV64-NEXT:    add a2, a2, a4
; RV64-NEXT:    andi a4, a5, 2047
; RV64-NEXT:    sub a1, a1, a2
; RV64-NEXT:    sltiu a2, a4, 2
...
; RV64M-NEXT:    srli a3, a2, 22
; RV64M-NEXT:    andi a5, a2, 2047
; RV64M-NEXT:    mul a1, a5, a1
...
; RV64M-NEXT:    srli a4, a4, 63
; RV64M-NEXT:    or a1, a1, a2
; RV64M-NEXT:    sw a1, 0(a0)
; RV64M-NEXT:    sb a4, 4(a0)
; RV64M-NEXT:    ret
;
...
; RV64MV-NEXT:    slli a4, a2, 22
; RV64MV-NEXT:    or a1, a1, a4
; RV64MV-NEXT:    andi a3, a3, 2047
; RV64MV-NEXT:    slli a2, a2, 53
