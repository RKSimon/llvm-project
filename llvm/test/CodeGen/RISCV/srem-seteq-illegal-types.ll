...
; RV64-NEXT:    mv s0, a0
; RV64-NEXT:    ld s3, 0(a0)
; RV64-NEXT:    lwu a0, 8(a0)
; RV64-NEXT:    lbu a1, 12(s0)
...
; RV64-NEXT:    slli a1, s3, 31
; RV64-NEXT:    srai a0, a0, 31
; RV64-NEXT:    srai s4, a1, 31
; RV64-NEXT:    li a1, -5
; RV64-NEXT:    call __moddi3
; RV64-NEXT:    mv s1, a0
; RV64-NEXT:    li a1, 7
...
; RV64M-NEXT:    lwu a3, 8(a0)
; RV64M-NEXT:    lui a4, %hi(.LCPI3_1)
; RV64M-NEXT:    lbu a5, 12(a0)
; RV64M-NEXT:    lui a6, %hi(.LCPI3_2)
; RV64M-NEXT:    ld a1, %lo(.LCPI3_0)(a1)
; RV64M-NEXT:    ld a4, %lo(.LCPI3_1)(a4)
; RV64M-NEXT:    ld a6, %lo(.LCPI3_2)(a6)
; RV64M-NEXT:    srli a7, a2, 2
; RV64M-NEXT:    slli t0, a3, 62
; RV64M-NEXT:    slli a5, a5, 32
; RV64M-NEXT:    or a7, t0, a7
; RV64M-NEXT:    slli a2, a2, 31
; RV64M-NEXT:    srai a7, a7, 31
; RV64M-NEXT:    or a3, a3, a5
; RV64M-NEXT:    srai a2, a2, 31
; RV64M-NEXT:    slli a3, a3, 29
; RV64M-NEXT:    mulh a5, a2, a6
; RV64M-NEXT:    srai a3, a3, 31
; RV64M-NEXT:    mulh a4, a7, a4
; RV64M-NEXT:    mulh a1, a3, a1
; RV64M-NEXT:    srli a6, a5, 63
; RV64M-NEXT:    srli t0, a4, 63
; RV64M-NEXT:    srai a4, a4, 1
; RV64M-NEXT:    add a5, a5, a6
; RV64M-NEXT:    srli a6, a1, 63
; RV64M-NEXT:    srai a1, a1, 1
; RV64M-NEXT:    add a4, a4, t0
; RV64M-NEXT:    slli t0, a5, 1
; RV64M-NEXT:    slli a5, a5, 2
; RV64M-NEXT:    add a1, a1, a6
; RV64M-NEXT:    add a5, a5, t0
; RV64M-NEXT:    add a3, a3, a1
; RV64M-NEXT:    slli a1, a1, 2
; RV64M-NEXT:    add a1, a3, a1
; RV64M-NEXT:    add a7, a7, a4
; RV64M-NEXT:    slli a4, a4, 3
; RV64M-NEXT:    sub a2, a2, a5
; RV64M-NEXT:    sub a3, a7, a4
...
; RV64M-NEXT:    slli a2, a2, 31
; RV64M-NEXT:    srli a4, a4, 62
; RV64M-NEXT:    srli a2, a2, 31
; RV64M-NEXT:    or a1, a1, a4
; RV64M-NEXT:    slli a3, a3, 33
; RV64M-NEXT:    addi a1, a1, -4
