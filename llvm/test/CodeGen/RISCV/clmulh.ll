...
; CHECK-M:       # %bb.0:
; CHECK-M-NEXT:    andi a2, a1, 1
; CHECK-M-NEXT:    andi a3, a0, 2
; CHECK-M-NEXT:    andi a4, a1, 2
; CHECK-M-NEXT:    andi a5, a0, 1
; CHECK-M-NEXT:    mul a6, a3, a2
; CHECK-M-NEXT:    mul a7, a5, a4
; CHECK-M-NEXT:    andi t0, a1, 8
; CHECK-M-NEXT:    andi t1, a0, 4
; CHECK-M-NEXT:    andi a1, a1, 4
; CHECK-M-NEXT:    andi a0, a0, 8
; CHECK-M-NEXT:    mul a3, a3, t0
; CHECK-M-NEXT:    mul a2, a5, a2
; CHECK-M-NEXT:    mul a5, t1, a1
; CHECK-M-NEXT:    mul a4, a0, a4
; CHECK-M-NEXT:    mul t1, t1, t0
; CHECK-M-NEXT:    mul a1, a0, a1
; CHECK-M-NEXT:    mul a0, a0, t0
; CHECK-M-NEXT:    xor a6, a7, a6
; CHECK-M-NEXT:    or a2, a2, a3
; CHECK-M-NEXT:    xor a4, a5, a4
; CHECK-M-NEXT:    or a3, a6, t1
...
; CHECK-ZBS:       # %bb.0:
; CHECK-ZBS-NEXT:    andi a2, a1, 1
; CHECK-ZBS-NEXT:    andi a3, a0, 2
; CHECK-ZBS-NEXT:    andi a4, a1, 2
; CHECK-ZBS-NEXT:    andi a5, a0, 1
; CHECK-ZBS-NEXT:    mul a6, a3, a2
; CHECK-ZBS-NEXT:    mul a7, a5, a4
; CHECK-ZBS-NEXT:    andi t0, a1, 8
; CHECK-ZBS-NEXT:    andi t1, a0, 4
; CHECK-ZBS-NEXT:    andi a1, a1, 4
; CHECK-ZBS-NEXT:    andi a0, a0, 8
; CHECK-ZBS-NEXT:    mul a3, a3, t0
; CHECK-ZBS-NEXT:    mul a2, a5, a2
; CHECK-ZBS-NEXT:    mul a5, t1, a1
; CHECK-ZBS-NEXT:    mul a4, a0, a4
; CHECK-ZBS-NEXT:    mul t1, t1, t0
; CHECK-ZBS-NEXT:    mul a1, a0, a1
; CHECK-ZBS-NEXT:    mul a0, a0, t0
; CHECK-ZBS-NEXT:    xor a6, a7, a6
; CHECK-ZBS-NEXT:    or a2, a2, a3
; CHECK-ZBS-NEXT:    xor a4, a5, a4
; CHECK-ZBS-NEXT:    or a3, a6, t1
; CHECK-ZBS-NEXT:    xor a2, a2, a4
; CHECK-ZBS-NEXT:    xor a1, a3, a1
...
; RV64IM-NEXT:    mul a7, a2, a3
; RV64IM-NEXT:    lui t0, 9
; RV64IM-NEXT:    lui t1, 4
; RV64IM-NEXT:    addi t0, t0, -1912
; RV64IM-NEXT:    addi t1, t1, 1092
; RV64IM-NEXT:    and t2, a1, t0
; RV64IM-NEXT:    and t3, a0, t1
; RV64IM-NEXT:    and a1, a1, t1
; RV64IM-NEXT:    and a0, a0, t0
; RV64IM-NEXT:    mul t0, t3, t2
; RV64IM-NEXT:    mul t1, a0, a1
; RV64IM-NEXT:    mul t4, a5, t2
; RV64IM-NEXT:    mul t5, a2, a4
; RV64IM-NEXT:    xor a6, a7, a6
; RV64IM-NEXT:    xor a7, t0, t1
; RV64IM-NEXT:    mul t0, t3, a1
; RV64IM-NEXT:    mul t1, a0, a3
; RV64IM-NEXT:    xor a6, a6, a7
; RV64IM-NEXT:    xor a7, t5, t4
; RV64IM-NEXT:    mul t4, a5, a3
; RV64IM-NEXT:    mul t5, a2, a1
; RV64IM-NEXT:    mul t6, t3, a4
; RV64IM-NEXT:    mul s0, a0, t2
; RV64IM-NEXT:    mul a1, a5, a1
; RV64IM-NEXT:    mul a2, a2, t2
; RV64IM-NEXT:    mul a3, t3, a3
; RV64IM-NEXT:    mul a0, a0, a4
; RV64IM-NEXT:    xor a4, t0, t1
; RV64IM-NEXT:    lui a5, 139808
; RV64IM-NEXT:    xor a4, a7, a4
; RV64IM-NEXT:    lui a7, 69904
; RV64IM-NEXT:    and a5, a6, a5
; RV64IM-NEXT:    and a4, a4, a7
; RV64IM-NEXT:    xor a6, t5, t4
; RV64IM-NEXT:    xor a7, t6, s0
; RV64IM-NEXT:    xor a6, a6, a7
; RV64IM-NEXT:    lui a7, 279616
; RV64IM-NEXT:    xor a1, a2, a1
; RV64IM-NEXT:    xor a0, a3, a0
; RV64IM-NEXT:    xor a0, a1, a0
; RV64IM-NEXT:    lui a1, 34944
; RV64IM-NEXT:    and a2, a6, a7
...
; RV64IMZBS-NEXT:    lui a2, 1
; RV64IMZBS-NEXT:    lui a3, 2
; RV64IMZBS-NEXT:    addi a2, a2, 273
; RV64IMZBS-NEXT:    addi a3, a3, 546
; RV64IMZBS-NEXT:    and a4, a1, a2
; RV64IMZBS-NEXT:    and a5, a0, a3
; RV64IMZBS-NEXT:    and a3, a1, a3
; RV64IMZBS-NEXT:    and a2, a0, a2
; RV64IMZBS-NEXT:    mul a6, a5, a4
; RV64IMZBS-NEXT:    mul a7, a2, a3
; RV64IMZBS-NEXT:    lui t0, 9
; RV64IMZBS-NEXT:    lui t1, 4
; RV64IMZBS-NEXT:    addi t0, t0, -1912
; RV64IMZBS-NEXT:    addi t1, t1, 1092
; RV64IMZBS-NEXT:    and t2, a1, t0
; RV64IMZBS-NEXT:    and t3, a0, t1
; RV64IMZBS-NEXT:    and a1, a1, t1
; RV64IMZBS-NEXT:    and a0, a0, t0
; RV64IMZBS-NEXT:    mul t0, t3, t2
; RV64IMZBS-NEXT:    mul t1, a0, a1
; RV64IMZBS-NEXT:    mul t4, a5, t2
; RV64IMZBS-NEXT:    mul t5, a2, a4
; RV64IMZBS-NEXT:    xor a6, a7, a6
; RV64IMZBS-NEXT:    xor a7, t0, t1
; RV64IMZBS-NEXT:    mul t0, t3, a1
; RV64IMZBS-NEXT:    mul t1, a0, a3
; RV64IMZBS-NEXT:    xor a6, a6, a7
; RV64IMZBS-NEXT:    xor a7, t5, t4
; RV64IMZBS-NEXT:    mul t4, a5, a3
; RV64IMZBS-NEXT:    mul t5, a2, a1
; RV64IMZBS-NEXT:    mul t6, t3, a4
; RV64IMZBS-NEXT:    mul s0, a0, t2
; RV64IMZBS-NEXT:    mul a1, a5, a1
; RV64IMZBS-NEXT:    mul a2, a2, t2
; RV64IMZBS-NEXT:    mul a3, t3, a3
; RV64IMZBS-NEXT:    mul a0, a0, a4
; RV64IMZBS-NEXT:    xor a4, t0, t1
; RV64IMZBS-NEXT:    lui a5, 139808
; RV64IMZBS-NEXT:    xor a4, a7, a4
; RV64IMZBS-NEXT:    lui a7, 69904
; RV64IMZBS-NEXT:    and a5, a6, a5
; RV64IMZBS-NEXT:    and a4, a4, a7
; RV64IMZBS-NEXT:    xor a6, t5, t4
; RV64IMZBS-NEXT:    xor a7, t6, s0
; RV64IMZBS-NEXT:    xor a6, a6, a7
; RV64IMZBS-NEXT:    lui a7, 279616
; RV64IMZBS-NEXT:    xor a1, a2, a1
; RV64IMZBS-NEXT:    xor a0, a3, a0
; RV64IMZBS-NEXT:    xor a0, a1, a0
; RV64IMZBS-NEXT:    lui a1, 34944
; RV64IMZBS-NEXT:    and a2, a6, a7
...
; RV32I-NEXT:    slli t2, a1, 2
; RV32I-NEXT:    andi t3, a7, 4
; RV32I-NEXT:    seqz t3, t3
; RV32I-NEXT:    andi t4, a7, 8
; RV32I-NEXT:    addi t3, t3, -1
...
; RV32I-NEXT:    and t3, t4, t5
; RV32I-NEXT:    xor t2, t2, t3
; RV32I-NEXT:    andi t3, a7, 128
; RV32I-NEXT:    xor t1, t1, t2
; RV32I-NEXT:    seqz t2, t3
; RV32I-NEXT:    slli t3, a1, 7
; RV32I-NEXT:    addi t2, t2, -1
; RV32I-NEXT:    and t2, t2, t3
; RV32I-NEXT:    andi t3, a7, 256
; RV32I-NEXT:    slli t4, a1, 8
; RV32I-NEXT:    seqz t3, t3
; RV32I-NEXT:    addi t3, t3, -1
; RV32I-NEXT:    andi t5, a7, 512
; RV32I-NEXT:    and t3, t3, t4
; RV32I-NEXT:    seqz t4, t5
; RV32I-NEXT:    slli t5, a1, 9
; RV32I-NEXT:    addi t4, t4, -1
; RV32I-NEXT:    and t4, t4, t5
; RV32I-NEXT:    andi t5, a7, 1024
; RV32I-NEXT:    xor t3, t3, t4
; RV32I-NEXT:    seqz t4, t5
; RV32I-NEXT:    slli t5, a1, 10
; RV32I-NEXT:    addi t4, t4, -1
; RV32I-NEXT:    and t4, t4, t5
; RV32I-NEXT:    li t5, 1
; RV32I-NEXT:    xor t3, t3, t4
...
; RV32I-NEXT:    xor t2, t1, t2
; RV32I-NEXT:    lui t3, 2
; RV32I-NEXT:    slli t4, a1, 13
...
; RV32I-NEXT:    addi s5, a3, 819
; RV32I-NEXT:    and a4, a4, s5
; RV32I-NEXT:    and a0, a0, s5
; RV32I-NEXT:    slli a0, a0, 2
; RV32I-NEXT:    lui a3, 349525
; RV32I-NEXT:    or a0, a4, a0
; RV32I-NEXT:    addi s6, a3, 1365
; RV32I-NEXT:    srli a4, a0, 1
; RV32I-NEXT:    and a0, a0, s6
; RV32I-NEXT:    and a4, a4, s6
; RV32I-NEXT:    slli a0, a0, 1
; RV32I-NEXT:    or t0, a4, a0
; RV32I-NEXT:    srli a0, t0, 8
; RV32I-NEXT:    and a0, a0, s8
; RV32I-NEXT:    srli a4, t0, 24
; RV32I-NEXT:    and a5, t0, s8
; RV32I-NEXT:    slli a6, t0, 24
; RV32I-NEXT:    sw a6, 200(sp) # 4-byte Folded Spill
; RV32I-NEXT:    slli a5, a5, 8
...
; RV32I-NEXT:    slli a7, t1, 2
; RV32I-NEXT:    andi t2, t3, 4
; RV32I-NEXT:    seqz t2, t2
; RV32I-NEXT:    andi t4, t3, 8
; RV32I-NEXT:    addi t2, t2, -1
; RV32I-NEXT:    seqz t4, t4
; RV32I-NEXT:    slli t5, t1, 3
; RV32I-NEXT:    addi t4, t4, -1
; RV32I-NEXT:    and a7, t2, a7
; RV32I-NEXT:    and t2, t4, t5
; RV32I-NEXT:    xor a5, a6, a5
; RV32I-NEXT:    xor a6, a7, t2
; RV32I-NEXT:    xor a5, a5, a6
; RV32I-NEXT:    andi a6, t3, 16
; RV32I-NEXT:    slli a7, t1, 4
; RV32I-NEXT:    seqz a6, a6
; RV32I-NEXT:    addi a6, a6, -1
; RV32I-NEXT:    andi t2, t3, 32
; RV32I-NEXT:    and a6, a6, a7
; RV32I-NEXT:    seqz a7, t2
; RV32I-NEXT:    slli t2, t1, 5
; RV32I-NEXT:    addi a7, a7, -1
; RV32I-NEXT:    and a7, a7, t2
; RV32I-NEXT:    andi t2, t3, 64
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    seqz a7, t2
; RV32I-NEXT:    slli t2, t1, 6
; RV32I-NEXT:    addi a7, a7, -1
; RV32I-NEXT:    and a7, a7, t2
; RV32I-NEXT:    andi t2, t3, 128
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    seqz a7, t2
; RV32I-NEXT:    slli t2, t1, 7
; RV32I-NEXT:    addi a7, a7, -1
; RV32I-NEXT:    xor a5, a5, a6
; RV32I-NEXT:    and a6, a7, t2
; RV32I-NEXT:    xor a5, a5, a6
; RV32I-NEXT:    slli a6, t1, 8
; RV32I-NEXT:    andi a7, t3, 256
; RV32I-NEXT:    seqz a7, a7
; RV32I-NEXT:    andi t2, t3, 512
; RV32I-NEXT:    addi a7, a7, -1
; RV32I-NEXT:    seqz t2, t2
; RV32I-NEXT:    slli t4, t1, 9
; RV32I-NEXT:    addi t2, t2, -1
; RV32I-NEXT:    and a6, a7, a6
; RV32I-NEXT:    and a7, t2, t4
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    slli a7, t1, 10
; RV32I-NEXT:    andi t2, t3, 1024
; RV32I-NEXT:    li t4, 1
; RV32I-NEXT:    seqz t2, t2
; RV32I-NEXT:    slli s0, t4, 11
; RV32I-NEXT:    addi t2, t2, -1
; RV32I-NEXT:    and t4, t3, s0
; RV32I-NEXT:    and a7, t2, a7
; RV32I-NEXT:    seqz t2, t4
; RV32I-NEXT:    slli t4, t1, 11
; RV32I-NEXT:    addi t2, t2, -1
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    and a7, t2, t4
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    lui t2, 1
; RV32I-NEXT:    slli a7, t1, 12
; RV32I-NEXT:    and t2, t3, t2
; RV32I-NEXT:    seqz t2, t2
; RV32I-NEXT:    lui t4, 2
; RV32I-NEXT:    addi t2, t2, -1
...
; RV32I-NEXT:    addi t2, t2, -1
; RV32I-NEXT:    lui t5, 4
; RV32I-NEXT:    slli t4, t1, 13
; RV32I-NEXT:    and t5, t3, t5
; RV32I-NEXT:    and t2, t2, t4
; RV32I-NEXT:    seqz t4, t5
; RV32I-NEXT:    addi t4, t4, -1
; RV32I-NEXT:    lui s1, 8
; RV32I-NEXT:    slli t5, t1, 14
; RV32I-NEXT:    and s2, t3, s1
; RV32I-NEXT:    and t4, t4, t5
; RV32I-NEXT:    seqz t5, s2
; RV32I-NEXT:    xor t2, t2, t4
; RV32I-NEXT:    addi t5, t5, -1
; RV32I-NEXT:    slli t4, t1, 15
; RV32I-NEXT:    and s2, t3, t6
; RV32I-NEXT:    and t4, t5, t4
; RV32I-NEXT:    seqz t5, s2
; RV32I-NEXT:    xor t2, t2, t4
; RV32I-NEXT:    addi t5, t5, -1
; RV32I-NEXT:    slli t4, t1, 16
; RV32I-NEXT:    lui t6, 32
; RV32I-NEXT:    and t4, t5, t4
; RV32I-NEXT:    and t5, t3, t6
; RV32I-NEXT:    xor t2, t2, t4
; RV32I-NEXT:    seqz t4, t5
; RV32I-NEXT:    addi t4, t4, -1
; RV32I-NEXT:    lui t6, 64
; RV32I-NEXT:    slli t5, t1, 17
; RV32I-NEXT:    and s2, t3, t6
; RV32I-NEXT:    and t4, t4, t5
; RV32I-NEXT:    seqz t5, s2
; RV32I-NEXT:    addi t5, t5, -1
; RV32I-NEXT:    slli s2, t1, 18
; RV32I-NEXT:    xor t2, t2, t4
; RV32I-NEXT:    and t4, t5, s2
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    xor a7, t2, t4
; RV32I-NEXT:    xor a6, a5, a6
; RV32I-NEXT:    lui t2, 128
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    and a7, t3, t2
...
; RV32I-NEXT:    and t2, t3, t2
; RV32I-NEXT:    seqz t2, t2
; RV32I-NEXT:    slli t4, t1, 19
; RV32I-NEXT:    and a7, a7, t4
; RV32I-NEXT:    addi t2, t2, -1
; RV32I-NEXT:    slli t4, t1, 20
; RV32I-NEXT:    lui t5, 512
; RV32I-NEXT:    and t2, t2, t4
; RV32I-NEXT:    and t4, t3, t5
; RV32I-NEXT:    xor a7, a7, t2
; RV32I-NEXT:    seqz t2, t4
; RV32I-NEXT:    addi t2, t2, -1
; RV32I-NEXT:    lui t5, 1024
; RV32I-NEXT:    slli t4, t1, 21
; RV32I-NEXT:    and t5, t3, t5
; RV32I-NEXT:    and t2, t2, t4
; RV32I-NEXT:    seqz t4, t5
; RV32I-NEXT:    xor a7, a7, t2
; RV32I-NEXT:    addi t4, t4, -1
; RV32I-NEXT:    slli t2, t1, 22
; RV32I-NEXT:    lui t5, 2048
...
; RV32I-NEXT:    addi t2, t2, -1
; RV32I-NEXT:    lui t5, 16384
; RV32I-NEXT:    slli t4, t1, 25
; RV32I-NEXT:    and t5, t3, t5
; RV32I-NEXT:    lui s11, 16384
; RV32I-NEXT:    and t2, t2, t4
; RV32I-NEXT:    seqz t4, t5
; RV32I-NEXT:    xor a7, a7, t2
; RV32I-NEXT:    addi t4, t4, -1
; RV32I-NEXT:    slli t2, t1, 26
...
; RV32I-NEXT:    lui t4, 262144
; RV32I-NEXT:    and t3, t3, t4
; RV32I-NEXT:    slli t4, t1, 29
; RV32I-NEXT:    and t2, t2, t4
; RV32I-NEXT:    seqz t3, t3
; RV32I-NEXT:    addi t3, t3, -1
; RV32I-NEXT:    slli t4, t1, 30
; RV32I-NEXT:    xor a7, a7, t2
; RV32I-NEXT:    and t2, t3, t4
; RV32I-NEXT:    xor a7, a7, t2
...
; RV32I-NEXT:    and a3, a0, t3
; RV32I-NEXT:    and a4, a4, a5
; RV32I-NEXT:    seqz a3, a3
; RV32I-NEXT:    xor a2, a2, a4
; RV32I-NEXT:    addi a3, a3, -1
; RV32I-NEXT:    slli ra, t0, 14
; RV32I-NEXT:    and a4, a0, t4
; RV32I-NEXT:    and a3, a3, ra
; RV32I-NEXT:    seqz a4, a4
; RV32I-NEXT:    addi a4, a4, -1
; RV32I-NEXT:    slli s11, t0, 15
; RV32I-NEXT:    xor a2, a2, a3
...
; RV32I-NEXT:    andi t2, a3, 64
; RV32I-NEXT:    and a6, a6, a7
; RV32I-NEXT:    seqz a7, t2
; RV32I-NEXT:    addi a7, a7, -1
; RV32I-NEXT:    slli t2, a1, 6
; RV32I-NEXT:    xor a5, a5, a6
; RV32I-NEXT:    and a6, a7, t2
; RV32I-NEXT:    xor a5, a5, a6
...
; RV32I-NEXT:    andi t2, a3, 1024
; RV32I-NEXT:    and a6, a6, a7
; RV32I-NEXT:    seqz a7, t2
; RV32I-NEXT:    xor a5, a5, a6
; RV32I-NEXT:    addi a7, a7, -1
; RV32I-NEXT:    slli a6, a1, 10
; RV32I-NEXT:    lw s9, 152(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and t2, a3, s9
; RV32I-NEXT:    and a6, a7, a6
; RV32I-NEXT:    seqz a7, t2
; RV32I-NEXT:    xor a5, a5, a6
; RV32I-NEXT:    addi a7, a7, -1
; RV32I-NEXT:    slli a6, a1, 11
; RV32I-NEXT:    lui t2, 1
; RV32I-NEXT:    and t2, a3, t2
; RV32I-NEXT:    and a6, a7, a6
; RV32I-NEXT:    seqz a7, t2
; RV32I-NEXT:    xor a5, a5, a6
; RV32I-NEXT:    addi a7, a7, -1
...
; RV32I-NEXT:    lui t4, 8
; RV32I-NEXT:    and t4, a3, t4
; RV32I-NEXT:    and t2, t2, t3
; RV32I-NEXT:    seqz t3, t4
; RV32I-NEXT:    xor a7, a7, t2
; RV32I-NEXT:    addi t3, t3, -1
; RV32I-NEXT:    slli t2, a1, 15
...
; RV32I-NEXT:    xor a7, a7, t2
; RV32I-NEXT:    addi t3, t3, -1
; RV32I-NEXT:    slli t2, a1, 17
; RV32I-NEXT:    lui ra, 64
; RV32I-NEXT:    and t4, a3, ra
; RV32I-NEXT:    and t2, t3, t2
; RV32I-NEXT:    seqz t3, t4
; RV32I-NEXT:    addi t3, t3, -1
; RV32I-NEXT:    slli t4, a1, 18
...
; RV32I-NEXT:    seqz a7, a7
; RV32I-NEXT:    slli t2, a1, 19
; RV32I-NEXT:    and a6, a6, t2
; RV32I-NEXT:    addi a7, a7, -1
; RV32I-NEXT:    slli t2, a1, 20
; RV32I-NEXT:    lui s0, 512
; RV32I-NEXT:    and t3, a3, s0
; RV32I-NEXT:    and a7, a7, t2
; RV32I-NEXT:    seqz t2, t3
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    addi t2, t2, -1
...
; RV32I-NEXT:    and t3, a3, s1
; RV32I-NEXT:    and a7, t2, a7
; RV32I-NEXT:    seqz t2, t3
; RV32I-NEXT:    addi t2, t2, -1
; RV32I-NEXT:    slli t3, a1, 23
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    and a7, t2, t3
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    lui s6, 4096
; RV32I-NEXT:    and a7, a3, s6
; RV32I-NEXT:    xor a5, a5, a6
; RV32I-NEXT:    seqz a6, a7
; RV32I-NEXT:    addi a6, a6, -1
; RV32I-NEXT:    lui s2, 8192
; RV32I-NEXT:    and a7, a3, s2
; RV32I-NEXT:    seqz a7, a7
...
; RV32I-NEXT:    and t3, a3, s7
; RV32I-NEXT:    and a7, a7, t2
; RV32I-NEXT:    seqz t2, t3
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    addi t2, t2, -1
; RV32I-NEXT:    slli a7, a1, 26
; RV32I-NEXT:    lui s3, 32768
; RV32I-NEXT:    and t3, a3, s3
; RV32I-NEXT:    and a7, t2, a7
; RV32I-NEXT:    seqz t2, t3
; RV32I-NEXT:    xor a6, a6, a7
; RV32I-NEXT:    addi t2, t2, -1
...
; RV32I-NEXT:    or a1, a2, a1
; RV32I-NEXT:    lw a4, 216(sp) # 4-byte Folded Reload
; RV32I-NEXT:    srli a0, a4, 8
; RV32I-NEXT:    and a2, a4, s8
; RV32I-NEXT:    and a0, a0, s8
; RV32I-NEXT:    slli a2, a2, 8
...
; RV32I-NEXT:    and a3, a4, a3
; RV32I-NEXT:    and a4, t1, t5
; RV32I-NEXT:    xor a2, a2, a3
; RV32I-NEXT:    seqz a3, a4
; RV32I-NEXT:    addi a5, a3, -1
; RV32I-NEXT:    sw a5, 100(sp) # 4-byte Folded Spill
; RV32I-NEXT:    and a3, t1, s1
; RV32I-NEXT:    lui t5, 2048
; RV32I-NEXT:    seqz a3, a3
...
; RV32I-NEXT:    and a5, t1, s7
; RV32I-NEXT:    and a4, a6, a4
; RV32I-NEXT:    seqz a5, a5
; RV32I-NEXT:    xor a3, a3, a4
; RV32I-NEXT:    addi a6, a5, -1
; RV32I-NEXT:    sw a6, 88(sp) # 4-byte Folded Spill
; RV32I-NEXT:    slli a4, a0, 26
; RV32I-NEXT:    and a5, t1, s3
; RV32I-NEXT:    and a4, a6, a4
; RV32I-NEXT:    seqz a5, a5
; RV32I-NEXT:    xor a3, a3, a4
; RV32I-NEXT:    addi a6, a5, -1
...
; RV32I-NEXT:    seqz a2, a2
; RV32I-NEXT:    slli t5, t0, 22
; RV32I-NEXT:    and a1, a1, t5
; RV32I-NEXT:    addi a2, a2, -1
; RV32I-NEXT:    lui a3, 4096
; RV32I-NEXT:    and a3, a0, a3
; RV32I-NEXT:    slli t4, t0, 23
; RV32I-NEXT:    and a2, a2, t4
; RV32I-NEXT:    seqz a3, a3
; RV32I-NEXT:    xor a1, a1, a2
; RV32I-NEXT:    addi a3, a3, -1
; RV32I-NEXT:    lw s3, 208(sp) # 4-byte Folded Reload
...
; RV32I-NEXT:    slli a4, t0, 31
; RV32I-NEXT:    xor a0, a2, a0
; RV32I-NEXT:    and a2, ra, a4
; RV32I-NEXT:    xor a1, a6, a1
; RV32I-NEXT:    xor a0, a0, a2
; RV32I-NEXT:    lw a2, 68(sp) # 4-byte Folded Reload
; RV32I-NEXT:    xor a2, a2, s10
...
; RV32I-NEXT:    and a6, a6, s8
; RV32I-NEXT:    srli ra, a3, 24
; RV32I-NEXT:    or a1, a1, a2
; RV32I-NEXT:    or a2, a6, ra
...
; RV32I-NEXT:    lw ra, 176(sp) # 4-byte Folded Reload
; RV32I-NEXT:    lw s10, 48(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and ra, ra, s10
; RV32I-NEXT:    xor t0, t0, ra
; RV32I-NEXT:    lw ra, 172(sp) # 4-byte Folded Reload
; RV32I-NEXT:    lw s10, 44(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and ra, ra, s10
; RV32I-NEXT:    xor a0, a6, a0
; RV32I-NEXT:    xor a6, t0, ra
; RV32I-NEXT:    xor a0, a0, a6
; RV32I-NEXT:    lw a6, 168(sp) # 4-byte Folded Reload
; RV32I-NEXT:    lw t0, 40(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and a6, a6, t0
; RV32I-NEXT:    lw t0, 164(sp) # 4-byte Folded Reload
; RV32I-NEXT:    lw s10, 36(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and t0, t0, s10
; RV32I-NEXT:    lw ra, 160(sp) # 4-byte Folded Reload
...
; RV32I-NEXT:    lw s10, 152(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and ra, ra, s10
; RV32I-NEXT:    xor t0, t0, ra
...
; RV32I-NEXT:    lw s10, 20(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and t0, t0, s10
; RV32I-NEXT:    lw ra, 136(sp) # 4-byte Folded Reload
; RV32I-NEXT:    lw s10, 16(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and s10, ra, s10
; RV32I-NEXT:    xor t0, t0, s10
; RV32I-NEXT:    lw s10, 132(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and s9, s10, s9
; RV32I-NEXT:    xor t0, t0, s9
; RV32I-NEXT:    lw s9, 128(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and s7, s9, s7
; RV32I-NEXT:    xor t0, t0, s7
; RV32I-NEXT:    lw s7, 124(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and s6, s7, s6
; RV32I-NEXT:    xor t0, t0, s6
; RV32I-NEXT:    lw s6, 120(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and s6, s6, s11
; RV32I-NEXT:    lw s7, 116(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and s2, s7, s2
; RV32I-NEXT:    lw s7, 112(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and s1, s7, s1
; RV32I-NEXT:    xor s1, s2, s1
; RV32I-NEXT:    lw s2, 108(sp) # 4-byte Folded Reload
; RV32I-NEXT:    and s0, s2, s0
...
; RV32I-NEXT:    and t4, s0, t4
; RV32I-NEXT:    xor a6, a0, a6
; RV32I-NEXT:    xor a6, a6, t0
; RV32I-NEXT:    xor t0, t5, t4
; RV32I-NEXT:    xor a6, a6, t0
; RV32I-NEXT:    and t0, a3, s8
; RV32I-NEXT:    slli a3, a3, 24
; RV32I-NEXT:    slli t0, t0, 8
; RV32I-NEXT:    or a3, a3, t0
; RV32I-NEXT:    and t0, a6, s8
; RV32I-NEXT:    slli a0, a0, 24
; RV32I-NEXT:    slli t0, t0, 8
; RV32I-NEXT:    or a2, a3, a2
...
; RV32I-NEXT:    lw t0, 232(sp) # 4-byte Folded Reload
...
; RV32I-NEXT:    sw a5, 0(a3)
; RV32I-NEXT:    sw a1, 4(a3)
; RV32I-NEXT:    sw a2, 8(a3)
; RV32I-NEXT:    sw a0, 12(a3)
...
; RV64I-NEXT:    add t5, a7, a1
; RV64I-NEXT:    and a1, a3, t5
; RV64I-NEXT:    and a0, a0, t5
...
; RV64I-NEXT:    or a2, a1, a0
; RV64I-NEXT:    or a3, a3, a4
; RV64I-NEXT:    srli a0, a3, 1
; RV64I-NEXT:    and t4, a3, t1
; RV64I-NEXT:    and a0, a0, t1
; RV64I-NEXT:    slli t4, t4, 1
; RV64I-NEXT:    slli a1, a2, 1
; RV64I-NEXT:    or a0, a0, t4
; RV64I-NEXT:    andi a3, a0, 2
; RV64I-NEXT:    andi a4, a0, 1
...
; RV64I-NEXT:    andi t6, a0, 8
; RV64I-NEXT:    addi t3, t3, -1
; RV64I-NEXT:    seqz t6, t6
; RV64I-NEXT:    slli s1, a2, 3
; RV64I-NEXT:    addi t6, t6, -1
; RV64I-NEXT:    and a3, t3, a3
; RV64I-NEXT:    and t3, t6, s1
; RV64I-NEXT:    xor a1, a4, a1
; RV64I-NEXT:    xor a3, a3, t3
; RV64I-NEXT:    xor a1, a1, a3
; RV64I-NEXT:    andi a3, a0, 16
; RV64I-NEXT:    slli a4, a2, 4
; RV64I-NEXT:    seqz a3, a3
; RV64I-NEXT:    addi a3, a3, -1
; RV64I-NEXT:    andi t3, a0, 32
; RV64I-NEXT:    and a3, a3, a4
; RV64I-NEXT:    seqz a4, t3
; RV64I-NEXT:    slli t3, a2, 5
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    and a4, a4, t3
; RV64I-NEXT:    andi t3, a0, 64
; RV64I-NEXT:    xor a3, a3, a4
; RV64I-NEXT:    seqz a4, t3
; RV64I-NEXT:    slli t3, a2, 6
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    and a4, a4, t3
; RV64I-NEXT:    andi t3, a0, 128
; RV64I-NEXT:    xor a3, a3, a4
; RV64I-NEXT:    seqz a4, t3
; RV64I-NEXT:    slli t3, a2, 7
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    xor a1, a1, a3
; RV64I-NEXT:    and a3, a4, t3
; RV64I-NEXT:    xor a1, a1, a3
; RV64I-NEXT:    slli a3, a2, 8
; RV64I-NEXT:    andi a4, a0, 256
; RV64I-NEXT:    seqz a4, a4
; RV64I-NEXT:    andi t3, a0, 512
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    seqz t3, t3
; RV64I-NEXT:    slli t6, a2, 9
; RV64I-NEXT:    addi t3, t3, -1
; RV64I-NEXT:    and a3, a4, a3
; RV64I-NEXT:    and a4, t3, t6
; RV64I-NEXT:    xor a3, a3, a4
; RV64I-NEXT:    andi a4, a0, 1024
; RV64I-NEXT:    slli t6, a2, 10
; RV64I-NEXT:    seqz a4, a4
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    li t3, 1
; RV64I-NEXT:    and a4, a4, t6
; RV64I-NEXT:    slli a6, t3, 11
; RV64I-NEXT:    sd a6, 176(sp) # 8-byte Folded Spill
; RV64I-NEXT:    xor a3, a3, a4
; RV64I-NEXT:    and a4, a0, a6
; RV64I-NEXT:    slli t6, a2, 11
; RV64I-NEXT:    seqz a4, a4
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    lui a6, 1
; RV64I-NEXT:    and a4, a4, t6
; RV64I-NEXT:    and t6, a0, a6
; RV64I-NEXT:    xor a3, a3, a4
; RV64I-NEXT:    seqz a4, t6
; RV64I-NEXT:    slli t6, a2, 12
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    and a4, a4, t6
; RV64I-NEXT:    lui a6, 2
; RV64I-NEXT:    xor a4, a3, a4
; RV64I-NEXT:    and a3, a0, a6
; RV64I-NEXT:    slli t6, a2, 13
; RV64I-NEXT:    seqz a3, a3
; RV64I-NEXT:    addi a3, a3, -1
; RV64I-NEXT:    lui a6, 4
; RV64I-NEXT:    and a3, a3, t6
; RV64I-NEXT:    and t6, a0, a6
; RV64I-NEXT:    slli s1, a2, 14
; RV64I-NEXT:    seqz t6, t6
; RV64I-NEXT:    addi t6, t6, -1
; RV64I-NEXT:    lui a6, 8
; RV64I-NEXT:    and t6, t6, s1
; RV64I-NEXT:    and s1, a0, a6
; RV64I-NEXT:    xor a3, a3, t6
; RV64I-NEXT:    seqz t6, s1
; RV64I-NEXT:    slli s1, a2, 15
; RV64I-NEXT:    addi t6, t6, -1
; RV64I-NEXT:    and t6, t6, s1
; RV64I-NEXT:    and s1, a0, a5
; RV64I-NEXT:    xor a3, a3, t6
; RV64I-NEXT:    seqz t6, s1
; RV64I-NEXT:    slli s1, a2, 16
; RV64I-NEXT:    addi t6, t6, -1
; RV64I-NEXT:    and t6, t6, s1
; RV64I-NEXT:    lui a5, 32
; RV64I-NEXT:    xor a3, a3, t6
; RV64I-NEXT:    and t6, a0, a5
; RV64I-NEXT:    slli s1, a2, 17
; RV64I-NEXT:    seqz t6, t6
; RV64I-NEXT:    addi t6, t6, -1
...
; RV64I-NEXT:    slli s2, a2, 19
; RV64I-NEXT:    and t6, t6, s2
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli s2, a2, 20
; RV64I-NEXT:    lui a5, 512
; RV64I-NEXT:    and s1, s1, s2
; RV64I-NEXT:    and s2, a0, a5
; RV64I-NEXT:    xor t6, t6, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    lui a5, 1024
; RV64I-NEXT:    slli s2, a2, 21
; RV64I-NEXT:    and s3, a0, a5
; RV64I-NEXT:    and s1, s1, s2
; RV64I-NEXT:    seqz s2, s3
; RV64I-NEXT:    xor t6, t6, s1
; RV64I-NEXT:    addi s2, s2, -1
; RV64I-NEXT:    slli s1, a2, 22
; RV64I-NEXT:    lui a5, 2048
...
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli s2, a2, 23
; RV64I-NEXT:    and s1, s1, s2
; RV64I-NEXT:    xor a4, a1, a4
; RV64I-NEXT:    xor a3, a4, a3
; RV64I-NEXT:    xor a4, t6, s1
; RV64I-NEXT:    xor a4, a3, a4
; RV64I-NEXT:    slli a1, a1, 56
; RV64I-NEXT:    and a3, a4, s4
; RV64I-NEXT:    slli a3, a3, 40
; RV64I-NEXT:    lui a5, 4096
; RV64I-NEXT:    or t6, a1, a3
...
; RV64I-NEXT:    addi a3, a3, -1
; RV64I-NEXT:    slli s1, a2, 25
; RV64I-NEXT:    lui a5, 16384
; RV64I-NEXT:    and a3, a3, s1
; RV64I-NEXT:    and s1, a0, a5
; RV64I-NEXT:    xor a1, a1, a3
; RV64I-NEXT:    seqz a3, s1
; RV64I-NEXT:    addi a3, a3, -1
; RV64I-NEXT:    lui a5, 32768
; RV64I-NEXT:    slli s1, a2, 26
; RV64I-NEXT:    and s2, a0, a5
; RV64I-NEXT:    and a3, a3, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    xor a1, a1, a3
...
; RV64I-NEXT:    lui a5, 65536
; RV64I-NEXT:    and a3, s1, a3
; RV64I-NEXT:    and s1, a0, a5
; RV64I-NEXT:    xor a1, a1, a3
; RV64I-NEXT:    seqz a3, s1
; RV64I-NEXT:    addi a3, a3, -1
; RV64I-NEXT:    lui a5, 131072
; RV64I-NEXT:    slli s1, a2, 28
; RV64I-NEXT:    and s2, a0, a5
; RV64I-NEXT:    and a3, a3, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    xor a1, a1, a3
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli a3, a2, 29
; RV64I-NEXT:    lui a5, 262144
; RV64I-NEXT:    and a3, s1, a3
; RV64I-NEXT:    and s1, a0, a5
; RV64I-NEXT:    xor a1, a1, a3
; RV64I-NEXT:    seqz a3, s1
; RV64I-NEXT:    addi a3, a3, -1
; RV64I-NEXT:    slli s1, a2, 30
; RV64I-NEXT:    and a3, a3, s1
; RV64I-NEXT:    sraiw s1, a0, 31
; RV64I-NEXT:    xor a1, a1, a3
; RV64I-NEXT:    seqz a3, s1
; RV64I-NEXT:    addi a3, a3, -1
; RV64I-NEXT:    slli s1, a2, 31
; RV64I-NEXT:    and a3, a3, s1
; RV64I-NEXT:    slli a5, t3, 32
; RV64I-NEXT:    sd a5, 168(sp) # 8-byte Folded Spill
; RV64I-NEXT:    xor a1, a1, a3
; RV64I-NEXT:    and a3, a0, a5
; RV64I-NEXT:    xor a1, a4, a1
; RV64I-NEXT:    seqz a3, a3
; RV64I-NEXT:    addi a3, a3, -1
...
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    slli a5, t3, 34
; RV64I-NEXT:    sd a5, 152(sp) # 8-byte Folded Spill
; RV64I-NEXT:    slli s1, a2, 33
; RV64I-NEXT:    and s2, a0, a5
...
; RV64I-NEXT:    slli a5, t3, 35
; RV64I-NEXT:    sd a5, 144(sp) # 8-byte Folded Spill
; RV64I-NEXT:    and a4, s1, a4
; RV64I-NEXT:    and s1, a0, a5
; RV64I-NEXT:    xor a3, a3, a4
; RV64I-NEXT:    seqz a4, s1
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    slli a5, t3, 36
; RV64I-NEXT:    sd a5, 136(sp) # 8-byte Folded Spill
; RV64I-NEXT:    slli s1, a2, 35
; RV64I-NEXT:    and s2, a0, a5
; RV64I-NEXT:    and a4, a4, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    xor a3, a3, a4
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli a4, a2, 36
; RV64I-NEXT:    slli a5, t3, 37
; RV64I-NEXT:    sd a5, 128(sp) # 8-byte Folded Spill
; RV64I-NEXT:    and a4, s1, a4
; RV64I-NEXT:    and s1, a0, a5
; RV64I-NEXT:    xor a3, a3, a4
; RV64I-NEXT:    seqz a4, s1
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    slli a5, t3, 38
; RV64I-NEXT:    sd a5, 120(sp) # 8-byte Folded Spill
; RV64I-NEXT:    slli s1, a2, 37
; RV64I-NEXT:    and s2, a0, a5
; RV64I-NEXT:    and a4, a4, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    xor a3, a3, a4
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli a4, a2, 38
; RV64I-NEXT:    slli a5, t3, 39
...
; RV64I-NEXT:    seqz a4, s1
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    slli s1, a2, 39
; RV64I-NEXT:    and a4, a4, s1
; RV64I-NEXT:    slli a5, t3, 40
; RV64I-NEXT:    sd a5, 104(sp) # 8-byte Folded Spill
; RV64I-NEXT:    xor a3, a3, a4
; RV64I-NEXT:    and a4, a0, a5
; RV64I-NEXT:    xor a6, a1, a3
...
; RV64I-NEXT:    slli s1, a2, 41
; RV64I-NEXT:    and s2, a0, a3
; RV64I-NEXT:    and a4, a4, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    xor a1, a1, a4
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli a4, a2, 42
; RV64I-NEXT:    slli a3, t3, 43
...
; RV64I-NEXT:    slli s1, a2, 43
; RV64I-NEXT:    and s2, a0, a3
; RV64I-NEXT:    and a4, a4, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    xor a1, a1, a4
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli a4, a2, 44
; RV64I-NEXT:    slli a3, t3, 45
...
; RV64I-NEXT:    slli s1, a2, 45
; RV64I-NEXT:    and s2, a0, a3
; RV64I-NEXT:    and a4, a4, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    xor a1, a1, a4
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli a4, a2, 46
...
; RV64I-NEXT:    seqz a4, s1
; RV64I-NEXT:    addi a4, a4, -1
; RV64I-NEXT:    slli s1, a2, 47
; RV64I-NEXT:    and a4, a4, s1
; RV64I-NEXT:    slli a3, t3, 48
; RV64I-NEXT:    sd a3, 40(sp) # 8-byte Folded Spill
; RV64I-NEXT:    xor a7, a1, a4
; RV64I-NEXT:    and a1, a0, a3
; RV64I-NEXT:    seqz a1, a1
...
; RV64I-NEXT:    and s1, a0, s1
; RV64I-NEXT:    seqz s1, s1
; RV64I-NEXT:    slli s2, a2, 48
; RV64I-NEXT:    and a1, a1, s2
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli s2, a2, 49
; RV64I-NEXT:    slli a3, t3, 50
; RV64I-NEXT:    sd a3, 24(sp) # 8-byte Folded Spill
; RV64I-NEXT:    and s1, s1, s2
; RV64I-NEXT:    and s2, a0, a3
; RV64I-NEXT:    xor a1, a1, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli a3, t3, 51
; RV64I-NEXT:    sd a3, 16(sp) # 8-byte Folded Spill
; RV64I-NEXT:    slli s2, a2, 50
; RV64I-NEXT:    and s3, a0, a3
; RV64I-NEXT:    and s1, s1, s2
; RV64I-NEXT:    seqz s2, s3
; RV64I-NEXT:    xor a1, a1, s1
; RV64I-NEXT:    addi s2, s2, -1
; RV64I-NEXT:    slli s1, a2, 51
; RV64I-NEXT:    slli s11, t3, 52
; RV64I-NEXT:    and s1, s2, s1
; RV64I-NEXT:    and s2, a0, s11
; RV64I-NEXT:    xor a1, a1, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli a3, t3, 53
; RV64I-NEXT:    sd a3, 8(sp) # 8-byte Folded Spill
; RV64I-NEXT:    slli s2, a2, 52
; RV64I-NEXT:    and s3, a0, a3
; RV64I-NEXT:    and s1, s1, s2
; RV64I-NEXT:    seqz s2, s3
; RV64I-NEXT:    xor a1, a1, s1
; RV64I-NEXT:    addi s2, s2, -1
; RV64I-NEXT:    slli s1, a2, 53
; RV64I-NEXT:    slli s7, t3, 54
; RV64I-NEXT:    and s1, s2, s1
; RV64I-NEXT:    and s2, a0, s7
; RV64I-NEXT:    xor a1, a1, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli s9, t3, 55
; RV64I-NEXT:    slli s2, a2, 54
; RV64I-NEXT:    and s3, a0, s9
; RV64I-NEXT:    and s1, s1, s2
; RV64I-NEXT:    seqz s2, s3
; RV64I-NEXT:    xor a1, a1, s1
; RV64I-NEXT:    addi s2, s2, -1
; RV64I-NEXT:    slli s1, a2, 55
; RV64I-NEXT:    slli ra, t3, 56
; RV64I-NEXT:    and s1, s2, s1
; RV64I-NEXT:    and s2, a0, ra
; RV64I-NEXT:    xor a5, a1, s1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli s10, t3, 57
; RV64I-NEXT:    slli s2, a2, 56
; RV64I-NEXT:    and s3, a0, s10
; RV64I-NEXT:    and s1, s1, s2
; RV64I-NEXT:    seqz s2, s3
; RV64I-NEXT:    addi s2, s2, -1
; RV64I-NEXT:    slli s8, t3, 58
; RV64I-NEXT:    slli s3, a2, 57
; RV64I-NEXT:    and a1, a0, s8
; RV64I-NEXT:    and s2, s2, s3
; RV64I-NEXT:    seqz a1, a1
; RV64I-NEXT:    xor s1, s1, s2
; RV64I-NEXT:    addi a1, a1, -1
; RV64I-NEXT:    slli s2, a2, 58
; RV64I-NEXT:    slli s3, t3, 59
; RV64I-NEXT:    and a1, a1, s2
; RV64I-NEXT:    and s2, a0, s3
; RV64I-NEXT:    xor a4, s1, a1
; RV64I-NEXT:    seqz s1, s2
; RV64I-NEXT:    addi s1, s1, -1
; RV64I-NEXT:    slli s2, t3, 60
; RV64I-NEXT:    slli a1, a2, 59
; RV64I-NEXT:    and a3, a0, s2
; RV64I-NEXT:    and a1, s1, a1
; RV64I-NEXT:    seqz a3, a3
; RV64I-NEXT:    xor a1, a4, a1
; RV64I-NEXT:    addi a3, a3, -1
; RV64I-NEXT:    slli a4, a2, 60
; RV64I-NEXT:    slli s1, t3, 61
; RV64I-NEXT:    and a3, a3, a4
; RV64I-NEXT:    and a4, a0, s1
; RV64I-NEXT:    xor a1, a1, a3
; RV64I-NEXT:    seqz a3, a4
; RV64I-NEXT:    addi a3, a3, -1
; RV64I-NEXT:    slli t3, t3, 62
; RV64I-NEXT:    and a0, a0, t3
; RV64I-NEXT:    slli a4, a2, 61
; RV64I-NEXT:    and a3, a3, a4
...
; RV64I-NEXT:    srli a1, t4, 63
; RV64I-NEXT:    xor a3, a6, a7
; RV64I-NEXT:    seqz a1, a1
; RV64I-NEXT:    slli a2, a2, 63
; RV64I-NEXT:    addi a1, a1, -1
; RV64I-NEXT:    and a1, a1, a2
; RV64I-NEXT:    xor a5, a3, a5
; RV64I-NEXT:    and a2, a6, s6
; RV64I-NEXT:    srliw a4, a5, 24
; RV64I-NEXT:    slli a2, a2, 24
; RV64I-NEXT:    slli a4, a4, 32
; RV64I-NEXT:    or a2, a2, a4
; RV64I-NEXT:    xor a0, a0, a1
; RV64I-NEXT:    srli a1, a6, 8
; RV64I-NEXT:    srli a3, a3, 24
; RV64I-NEXT:    and a1, a1, s5
; RV64I-NEXT:    and a3, a3, s6
; RV64I-NEXT:    xor a0, a5, a0
; RV64I-NEXT:    srli a5, a5, 40
; RV64I-NEXT:    and a4, a5, s4
; RV64I-NEXT:    srli a0, a0, 56
; RV64I-NEXT:    or a1, a1, a3
...
; RV64I-NEXT:    srli a0, t2, 24
; RV64I-NEXT:    and a0, a0, s6
; RV64I-NEXT:    srli a1, t2, 8
; RV64I-NEXT:    and a1, a1, s5
; RV64I-NEXT:    srli a3, t2, 40
; RV64I-NEXT:    and a3, a3, s4
; RV64I-NEXT:    srli a4, t2, 56
; RV64I-NEXT:    or a0, a1, a0
; RV64I-NEXT:    or a3, a3, a4
; RV64I-NEXT:    or a0, a0, a3
; RV64I-NEXT:    and a1, t2, s6
; RV64I-NEXT:    slli a1, a1, 24
; RV64I-NEXT:    srliw a3, t2, 24
; RV64I-NEXT:    slli a3, a3, 32
; RV64I-NEXT:    and a4, t2, s4
; RV64I-NEXT:    slli a4, a4, 40
; RV64I-NEXT:    slli t2, t2, 56
; RV64I-NEXT:    or a1, a1, a3
; RV64I-NEXT:    or a3, t2, a4
; RV64I-NEXT:    srli a4, s0, 24
; RV64I-NEXT:    srli a5, s0, 8
; RV64I-NEXT:    and a4, a4, s6
; RV64I-NEXT:    and a5, a5, s5
; RV64I-NEXT:    or a4, a5, a4
; RV64I-NEXT:    srli a5, s0, 40
; RV64I-NEXT:    and a5, a5, s4
; RV64I-NEXT:    srli a6, s0, 56
; RV64I-NEXT:    or a5, a5, a6
; RV64I-NEXT:    and a6, s0, s6
; RV64I-NEXT:    slli a6, a6, 24
; RV64I-NEXT:    srliw a7, s0, 24
; RV64I-NEXT:    slli a7, a7, 32
; RV64I-NEXT:    and t2, s0, s4
; RV64I-NEXT:    slli t2, t2, 40
; RV64I-NEXT:    slli s0, s0, 56
; RV64I-NEXT:    or a6, a6, a7
; RV64I-NEXT:    or a7, s0, t2
...
; RV64I-NEXT:    srli a0, a3, 1
; RV64I-NEXT:    and a4, a0, t1
; RV64I-NEXT:    and a0, a3, t1
; RV64I-NEXT:    slli a0, a0, 1
; RV64I-NEXT:    srli a3, a1, 1
; RV64I-NEXT:    and a5, a3, t1
; RV64I-NEXT:    or a3, a4, a0
...
; RV64I-NEXT:    andi a6, a3, 1
; RV64I-NEXT:    and a4, a4, a5
; RV64I-NEXT:    seqz a5, a6
; RV64I-NEXT:    addi a5, a5, -1
; RV64I-NEXT:    andi a6, a3, 4
...
; RV64I-NEXT:    slli t2, a1, 13
; RV64I-NEXT:    and a6, a6, t2
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    lui t2, 8
; RV64I-NEXT:    and t2, a3, t2
...
; RV64I-NEXT:    and a7, a3, a7
; RV64I-NEXT:    slli t4, a1, 15
; RV64I-NEXT:    and t2, t2, t4
; RV64I-NEXT:    seqz a7, a7
; RV64I-NEXT:    xor a6, a6, t2
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    lui t2, 32
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    slli t4, a1, 16
; RV64I-NEXT:    and a7, a7, t4
; RV64I-NEXT:    seqz t2, t2
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    addi t2, t2, -1
...
; RV64I-NEXT:    slli t2, a1, 19
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    seqz a6, a6
; RV64I-NEXT:    addi a6, a6, -1
; RV64I-NEXT:    slli t2, a1, 20
; RV64I-NEXT:    and a6, a6, t2
; RV64I-NEXT:    lui t2, 512
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    xor a6, a7, a6
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    slli t2, a1, 21
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    lui t2, 1024
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    addi a7, a7, -1
...
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    slli t2, a1, 23
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    lui t2, 4096
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    xor t4, a5, a6
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    lui a5, 8192
...
; RV64I-NEXT:    and a7, a3, a7
; RV64I-NEXT:    seqz a7, a7
; RV64I-NEXT:    slli t2, a1, 32
; RV64I-NEXT:    and a6, a6, t2
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    ld t2, 152(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    slli t6, a1, 33
; RV64I-NEXT:    and a7, a7, t6
; RV64I-NEXT:    seqz t2, t2
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    addi t2, t2, -1
; RV64I-NEXT:    ld a7, 144(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and a7, a3, a7
; RV64I-NEXT:    slli t6, a1, 34
; RV64I-NEXT:    and t2, t2, t6
; RV64I-NEXT:    seqz a7, a7
; RV64I-NEXT:    xor a6, a6, t2
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    ld t2, 136(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and t2, a3, t2
...
; RV64I-NEXT:    and a7, a3, a7
; RV64I-NEXT:    slli t6, a1, 36
; RV64I-NEXT:    and t2, t2, t6
; RV64I-NEXT:    seqz a7, a7
; RV64I-NEXT:    xor a6, a6, t2
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    ld t2, 120(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and t2, a3, t2
...
; RV64I-NEXT:    and a7, a3, a7
; RV64I-NEXT:    xor a5, t4, a5
; RV64I-NEXT:    seqz a7, a7
; RV64I-NEXT:    xor a5, a5, a6
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    ld a6, 96(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and a6, a3, a6
; RV64I-NEXT:    slli t2, a1, 40
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    seqz a6, a6
; RV64I-NEXT:    addi a6, a6, -1
; RV64I-NEXT:    slli t2, a1, 41
; RV64I-NEXT:    and a6, a6, t2
; RV64I-NEXT:    ld t2, 88(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    xor a6, a7, a6
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    slli t2, a1, 42
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    ld t2, 80(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    addi a7, a7, -1
...
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    ld t2, 72(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    slli t2, a1, 44
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    ld t2, 64(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    slli t2, a1, 45
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    ld t2, 56(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    addi a7, a7, -1
...
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    ld t2, 48(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    slli t2, a1, 47
; RV64I-NEXT:    and a7, a7, t2
...
; RV64I-NEXT:    addi t6, t6, -1
; RV64I-NEXT:    ld t2, 16(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and t2, a3, t2
...
; RV64I-NEXT:    xor a7, a7, t2
; RV64I-NEXT:    and t2, t6, s0
; RV64I-NEXT:    xor a7, a7, t2
; RV64I-NEXT:    ld t2, 8(sp) # 8-byte Folded Reload
; RV64I-NEXT:    and t2, a3, t2
; RV64I-NEXT:    slli t6, a1, 53
; RV64I-NEXT:    seqz t2, t2
; RV64I-NEXT:    addi t2, t2, -1
; RV64I-NEXT:    and s0, a3, s7
; RV64I-NEXT:    and t2, t2, t6
...
; RV64I-NEXT:    and t6, a3, s9
; RV64I-NEXT:    xor a7, a7, t2
; RV64I-NEXT:    seqz t2, t6
; RV64I-NEXT:    slli t6, a1, 55
; RV64I-NEXT:    addi t2, t2, -1
; RV64I-NEXT:    and t4, t4, s4
; RV64I-NEXT:    and t2, t2, t6
; RV64I-NEXT:    xor t6, a5, a6
; RV64I-NEXT:    xor a6, a7, t2
; RV64I-NEXT:    slli a7, t4, 40
; RV64I-NEXT:    xor t4, t6, a6
; RV64I-NEXT:    and a6, a5, s6
; RV64I-NEXT:    srliw t2, t4, 24
; RV64I-NEXT:    slli a6, a6, 24
...
; RV64I-NEXT:    seqz a6, a6
; RV64I-NEXT:    addi a6, a6, -1
; RV64I-NEXT:    and t2, a3, s10
; RV64I-NEXT:    and a6, a6, a7
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    slli t2, a1, 57
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    and t2, a3, s8
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    slli t2, a1, 58
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    and t2, a3, s3
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    slli t2, a1, 59
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    and t2, a3, s2
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    seqz a7, t2
; RV64I-NEXT:    slli t2, a1, 60
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    and a7, a7, t2
; RV64I-NEXT:    and s1, a3, s1
; RV64I-NEXT:    xor a6, a6, a7
; RV64I-NEXT:    seqz a7, s1
; RV64I-NEXT:    slli t2, a1, 61
; RV64I-NEXT:    addi a7, a7, -1
; RV64I-NEXT:    and a7, a7, t2
...
; RV64I-NEXT:    srli a1, t6, 24
; RV64I-NEXT:    and a1, a1, s6
; RV64I-NEXT:    xor a0, a3, a0
; RV64I-NEXT:    xor a0, t4, a0
; RV64I-NEXT:    srli a3, t4, 40
; RV64I-NEXT:    and a3, a3, s4
; RV64I-NEXT:    srli a0, a0, 56
; RV64I-NEXT:    or a1, a5, a1
; RV64I-NEXT:    or a0, a3, a0
; RV64I-NEXT:    or a0, a1, a0
; RV64I-NEXT:    srli a1, a2, 4
; RV64I-NEXT:    and a1, a1, t5
; RV64I-NEXT:    or a0, a4, a0
; RV64I-NEXT:    and a2, a2, t5
; RV64I-NEXT:    srli a3, a0, 4
...
; RV32IM-NEXT:    addi s4, a5, -256
; RV32IM-NEXT:    srli a6, a4, 8
; RV32IM-NEXT:    srli a7, a4, 24
; RV32IM-NEXT:    and t0, a4, s4
...
; RV32IM-NEXT:    and s1, s0, s4
; RV32IM-NEXT:    slli s2, s0, 24
...
; RV32IM-NEXT:    and a2, a1, t1
; RV32IM-NEXT:    and s2, s3, t1
; RV32IM-NEXT:    and a4, a1, t4
; RV32IM-NEXT:    mul a5, a2, s6
...
; RV32IM-NEXT:    and ra, s3, t2
; RV32IM-NEXT:    and a5, a1, t3
; RV32IM-NEXT:    and a7, s3, t3
; RV32IM-NEXT:    mv a0, t3
; RV32IM-NEXT:    and a1, a1, t2
; RV32IM-NEXT:    mul a6, a5, ra
; RV32IM-NEXT:    mv t3, a7
; RV32IM-NEXT:    sw a7, 48(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a7, a1, a7
; RV32IM-NEXT:    mul t0, a2, ra
; RV32IM-NEXT:    mul t6, a4, s6
; RV32IM-NEXT:    mul s7, a5, t3
; RV32IM-NEXT:    mul s8, a1, s2
; RV32IM-NEXT:    mul s9, a2, s2
; RV32IM-NEXT:    mv s3, s2
; RV32IM-NEXT:    sw s2, 40(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s10, a4, t3
; RV32IM-NEXT:    sw s6, 36(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s11, a5, s6
; RV32IM-NEXT:    mv s2, ra
; RV32IM-NEXT:    sw ra, 44(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul ra, a1, ra
; RV32IM-NEXT:    mul a2, a2, t3
; RV32IM-NEXT:    mul a4, a4, s2
; RV32IM-NEXT:    mul a5, a5, s3
; RV32IM-NEXT:    mul a1, a1, s6
; RV32IM-NEXT:    xor a6, a6, a7
; RV32IM-NEXT:    xor a7, t6, t0
; RV32IM-NEXT:    xor t0, s7, s8
; RV32IM-NEXT:    lw t3, 64(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw t6, 0(t3)
...
; RV32IM-NEXT:    and a1, a1, s4
; RV32IM-NEXT:    srli a4, t6, 24
; RV32IM-NEXT:    or a4, a1, a4
; RV32IM-NEXT:    and a1, t6, s4
; RV32IM-NEXT:    slli a1, a1, 8
; RV32IM-NEXT:    slli t6, t6, 24
; RV32IM-NEXT:    or t0, t6, a1
; RV32IM-NEXT:    and a1, a3, t1
; RV32IM-NEXT:    sw a1, 64(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a1, a6, t4
; RV32IM-NEXT:    sw a1, 28(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    or a3, t0, a4
; RV32IM-NEXT:    srli a4, a3, 4
; RV32IM-NEXT:    sw t5, 88(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a3, a3, t5
; RV32IM-NEXT:    and a4, a4, t5
; RV32IM-NEXT:    slli a3, a3, 4
; RV32IM-NEXT:    and a1, a7, a0
...
; RV32IM-NEXT:    xor a1, s2, a2
; RV32IM-NEXT:    xor a2, a3, t1
; RV32IM-NEXT:    xor a3, a6, t3
; RV32IM-NEXT:    xor a4, a5, a4
...
; RV32IM-NEXT:    mul a5, s10, s0
; RV32IM-NEXT:    mul a6, s9, s1
...
; RV32IM-NEXT:    and a3, a3, s5
; RV32IM-NEXT:    slli a3, a3, 2
; RV32IM-NEXT:    mul s1, s7, t6
; RV32IM-NEXT:    mul a7, s9, t6
; RV32IM-NEXT:    or a3, a6, a3
; RV32IM-NEXT:    srli a6, a3, 1
; RV32IM-NEXT:    mv s10, s2
; RV32IM-NEXT:    and a3, a3, s2
; RV32IM-NEXT:    and a6, a6, s2
; RV32IM-NEXT:    slli a3, a3, 1
; RV32IM-NEXT:    mul t0, s8, s0
; RV32IM-NEXT:    or s0, a6, a3
; RV32IM-NEXT:    mul a3, s7, t3
; RV32IM-NEXT:    srli a6, s0, 8
; RV32IM-NEXT:    xor s1, a4, s1
; RV32IM-NEXT:    and a4, a6, s4
; RV32IM-NEXT:    srli a6, s0, 24
; RV32IM-NEXT:    and t1, s0, s4
; RV32IM-NEXT:    slli t2, s0, 24
; RV32IM-NEXT:    slli t1, t1, 8
; RV32IM-NEXT:    or a4, a4, a6
; RV32IM-NEXT:    or a6, t2, t1
; RV32IM-NEXT:    xor s2, a7, a5
; RV32IM-NEXT:    or a4, a6, a4
; RV32IM-NEXT:    xor s4, t0, a3
...
; RV32IM-NEXT:    slli a3, a3, 2
; RV32IM-NEXT:    or t6, a5, a4
; RV32IM-NEXT:    or a3, a6, a3
; RV32IM-NEXT:    srli a4, t6, 8
; RV32IM-NEXT:    srli a5, a3, 1
; RV32IM-NEXT:    and a4, a4, s3
; RV32IM-NEXT:    srli a6, t6, 24
; RV32IM-NEXT:    and a7, t6, s3
; RV32IM-NEXT:    slli t0, t6, 24
...
; RV32IM-NEXT:    or a4, a6, a4
; RV32IM-NEXT:    and s5, a3, s6
; RV32IM-NEXT:    lw s11, 96(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    and a5, a4, s11
; RV32IM-NEXT:    and a6, a3, s11
; RV32IM-NEXT:    and a7, a3, t5
; RV32IM-NEXT:    and a3, a3, t4
; RV32IM-NEXT:    and t0, a4, s6
; RV32IM-NEXT:    and t1, a4, t4
; RV32IM-NEXT:    mv a1, t4
; RV32IM-NEXT:    and a4, a4, t5
; RV32IM-NEXT:    mv s9, t5
; RV32IM-NEXT:    mul t2, a5, s5
; RV32IM-NEXT:    mul t3, t0, a6
; RV32IM-NEXT:    mul t4, t1, a7
; RV32IM-NEXT:    mul t5, a4, a3
; RV32IM-NEXT:    xor s1, a0, s1
; RV32IM-NEXT:    xor s2, s2, s4
; RV32IM-NEXT:    and a2, a2, s11
; RV32IM-NEXT:    lw a0, 52(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    and a0, a0, s6
; RV32IM-NEXT:    mv s8, s6
; RV32IM-NEXT:    and s1, s1, a1
; RV32IM-NEXT:    and s2, s2, s9
; RV32IM-NEXT:    or a0, a0, a2
; RV32IM-NEXT:    or a2, s1, s2
; RV32IM-NEXT:    or a0, a0, a2
...
; RV32IM-NEXT:    mul t5, a5, a7
; RV32IM-NEXT:    mul s1, t0, s5
; RV32IM-NEXT:    mul s2, t1, a3
; RV32IM-NEXT:    mul s4, a4, a6
; RV32IM-NEXT:    mul s6, a5, a6
; RV32IM-NEXT:    mul s7, t0, a3
; RV32IM-NEXT:    or t3, t3, t4
; RV32IM-NEXT:    xor a2, a2, t2
; RV32IM-NEXT:    mul a3, a5, a3
; RV32IM-NEXT:    mul a5, t0, a7
; RV32IM-NEXT:    mul a7, a4, a7
; RV32IM-NEXT:    mul t0, t1, s5
; RV32IM-NEXT:    mul a6, t1, a6
; RV32IM-NEXT:    mul a4, a4, s5
; RV32IM-NEXT:    xor t1, s1, t5
...
; RV32IM-NEXT:    xor a5, t2, a7
; RV32IM-NEXT:    xor a3, a3, a4
; RV32IM-NEXT:    and a4, a5, a1
...
; RV32IM-NEXT:    and a6, a2, s3
; RV32IM-NEXT:    slli a2, a2, 24
; RV32IM-NEXT:    slli a6, a6, 8
; RV32IM-NEXT:    or a3, a3, a5
; RV32IM-NEXT:    or a5, a2, a6
; RV32IM-NEXT:    and a4, a4, ra
...
; RV32IM-NEXT:    or a3, a4, a3
; RV32IM-NEXT:    sw s8, 84(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and t5, s0, s8
; RV32IM-NEXT:    and a4, a3, s11
; RV32IM-NEXT:    and s1, s0, s11
; RV32IM-NEXT:    and a6, a3, s8
; RV32IM-NEXT:    mul a7, a4, t5
; RV32IM-NEXT:    mul t0, a6, s1
; RV32IM-NEXT:    sw s9, 32(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s2, s0, s9
...
; RV32IM-NEXT:    mul s5, a6, t5
; RV32IM-NEXT:    mul s6, t1, s0
; RV32IM-NEXT:    mul s7, a3, s1
; RV32IM-NEXT:    mul s8, a4, s1
; RV32IM-NEXT:    mul s9, a6, s0
; RV32IM-NEXT:    mul s10, t1, t5
...
; RV32IM-NEXT:    xor a7, s5, t4
; RV32IM-NEXT:    xor t0, s6, s7
; RV32IM-NEXT:    xor a0, a0, a5
; RV32IM-NEXT:    xor a5, a7, t0
; RV32IM-NEXT:    xor a7, s9, s8
...
; RV32IM-NEXT:    and a5, a5, s5
; RV32IM-NEXT:    mv t3, a2
; RV32IM-NEXT:    and a7, a7, a2
; RV32IM-NEXT:    xor a4, a6, a4
; RV32IM-NEXT:    or a6, t2, t0
...
; RV32IM-NEXT:    and a6, a4, s5
; RV32IM-NEXT:    and s5, t6, t4
; RV32IM-NEXT:    and t0, a4, t4
; RV32IM-NEXT:    and t1, a4, s4
; RV32IM-NEXT:    sw t3, 16(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a4, a4, t3
; RV32IM-NEXT:    and s7, t6, a1
; RV32IM-NEXT:    and s6, t6, t3
; RV32IM-NEXT:    and t6, t6, s4
; RV32IM-NEXT:    mul t2, s5, a6
; RV32IM-NEXT:    mul t3, s7, t0
; RV32IM-NEXT:    mul t4, s6, t1
; RV32IM-NEXT:    mul s8, t6, a4
; RV32IM-NEXT:    or a2, a5, a0
; RV32IM-NEXT:    or a3, a7, a3
; RV32IM-NEXT:    mul a5, s5, t1
; RV32IM-NEXT:    mul a7, s7, a6
; RV32IM-NEXT:    mul s9, s6, a4
; RV32IM-NEXT:    mul s10, t6, t0
; RV32IM-NEXT:    mul s11, s5, t0
; RV32IM-NEXT:    mul ra, s7, a4
; RV32IM-NEXT:    mul a1, s6, a6
; RV32IM-NEXT:    mul a0, t6, t1
; RV32IM-NEXT:    xor t2, t3, t2
; RV32IM-NEXT:    xor t3, t4, s8
; RV32IM-NEXT:    mul a4, s5, a4
; RV32IM-NEXT:    mul t1, s7, t1
; RV32IM-NEXT:    mul t0, s6, t0
; RV32IM-NEXT:    mul a6, t6, a6
; RV32IM-NEXT:    xor a5, a7, a5
; RV32IM-NEXT:    xor a7, s9, s10
; RV32IM-NEXT:    xor t2, t2, t3
; RV32IM-NEXT:    xor a5, a5, a7
; RV32IM-NEXT:    xor a7, ra, s11
; RV32IM-NEXT:    xor a0, a1, a0
; RV32IM-NEXT:    lw s9, 96(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    and a1, t2, s9
; RV32IM-NEXT:    lw ra, 84(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    and a5, a5, ra
...
; RV32IM-NEXT:    mv s10, s4
; RV32IM-NEXT:    lw s8, 92(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    srli a1, a1, 1
; RV32IM-NEXT:    xor a0, a0, a2
; RV32IM-NEXT:    and a2, a6, s8
; RV32IM-NEXT:    xor s4, a1, a0
; RV32IM-NEXT:    slli a2, a2, 2
; RV32IM-NEXT:    srli a0, s4, 8
; RV32IM-NEXT:    and a0, a0, s3
; RV32IM-NEXT:    srli a3, s4, 24
; RV32IM-NEXT:    or a2, a5, a2
; RV32IM-NEXT:    or a3, a0, a3
; RV32IM-NEXT:    mul a0, s5, t5
; RV32IM-NEXT:    mul a1, s7, s1
; RV32IM-NEXT:    mul a4, s6, s2
; RV32IM-NEXT:    mul a5, t6, s0
; RV32IM-NEXT:    mul a6, s5, s2
; RV32IM-NEXT:    mul a7, s7, t5
; RV32IM-NEXT:    mul t0, s6, s0
; RV32IM-NEXT:    mul t1, t6, s1
; RV32IM-NEXT:    mul t2, s5, s1
; RV32IM-NEXT:    mul t3, s5, s0
; RV32IM-NEXT:    mul t4, s7, s0
; RV32IM-NEXT:    mul s0, s7, s2
; RV32IM-NEXT:    mul s2, t6, s2
; RV32IM-NEXT:    mul s5, s6, t5
...
; RV32IM-NEXT:    and a1, a1, ra
; RV32IM-NEXT:    xor a4, t4, t2
; RV32IM-NEXT:    xor a5, s5, s2
; RV32IM-NEXT:    xor a6, s0, t3
; RV32IM-NEXT:    xor a7, s1, t5
; RV32IM-NEXT:    xor a4, a4, a5
; RV32IM-NEXT:    xor a5, a6, a7
...
; RV32IM-NEXT:    sw a3, 0(a4)
; RV32IM-NEXT:    sw a2, 4(a4)
; RV32IM-NEXT:    sw a1, 8(a4)
; RV32IM-NEXT:    sw a0, 12(a4)
...
; RV32IMZBS-NEXT:    addi s4, a5, -256
; RV32IMZBS-NEXT:    srli a6, a4, 8
; RV32IMZBS-NEXT:    srli a7, a4, 24
; RV32IMZBS-NEXT:    and t0, a4, s4
...
; RV32IMZBS-NEXT:    lw s1, 104(sp) # 4-byte Folded Reload
...
; RV32IMZBS-NEXT:    and a2, a1, t1
; RV32IMZBS-NEXT:    and s2, s3, t1
; RV32IMZBS-NEXT:    and a4, a1, t4
; RV32IMZBS-NEXT:    mul a5, a2, s6
...
; RV32IMZBS-NEXT:    and ra, s3, t2
; RV32IMZBS-NEXT:    and a5, a1, t3
; RV32IMZBS-NEXT:    and a7, s3, t3
; RV32IMZBS-NEXT:    mv a0, t3
; RV32IMZBS-NEXT:    and a1, a1, t2
; RV32IMZBS-NEXT:    mul a6, a5, ra
; RV32IMZBS-NEXT:    mv t3, a7
; RV32IMZBS-NEXT:    sw a7, 48(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    mul a7, a1, a7
; RV32IMZBS-NEXT:    mul t0, a2, ra
; RV32IMZBS-NEXT:    mul t6, a4, s6
; RV32IMZBS-NEXT:    mul s7, a5, t3
; RV32IMZBS-NEXT:    mul s8, a1, s2
; RV32IMZBS-NEXT:    mul s9, a2, s2
; RV32IMZBS-NEXT:    mv s3, s2
; RV32IMZBS-NEXT:    sw s2, 40(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    mul s10, a4, t3
; RV32IMZBS-NEXT:    sw s6, 36(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    mul s11, a5, s6
; RV32IMZBS-NEXT:    mv s2, ra
; RV32IMZBS-NEXT:    sw ra, 44(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    mul ra, a1, ra
; RV32IMZBS-NEXT:    mul a2, a2, t3
; RV32IMZBS-NEXT:    mul a4, a4, s2
; RV32IMZBS-NEXT:    mul a5, a5, s3
; RV32IMZBS-NEXT:    mul a1, a1, s6
; RV32IMZBS-NEXT:    xor a6, a6, a7
; RV32IMZBS-NEXT:    xor a7, t6, t0
; RV32IMZBS-NEXT:    xor t0, s7, s8
; RV32IMZBS-NEXT:    lw t3, 64(sp) # 4-byte Folded Reload
; RV32IMZBS-NEXT:    lw t6, 0(t3)
...
; RV32IMZBS-NEXT:    srli a1, t6, 8
; RV32IMZBS-NEXT:    and a1, a1, s4
; RV32IMZBS-NEXT:    srli a4, t6, 24
; RV32IMZBS-NEXT:    or a4, a1, a4
; RV32IMZBS-NEXT:    and a1, t6, s4
; RV32IMZBS-NEXT:    slli a1, a1, 8
; RV32IMZBS-NEXT:    slli t6, t6, 24
; RV32IMZBS-NEXT:    or t0, t6, a1
; RV32IMZBS-NEXT:    and a1, a3, t1
; RV32IMZBS-NEXT:    sw a1, 64(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    and a1, a6, t4
; RV32IMZBS-NEXT:    sw a1, 28(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    or a3, t0, a4
; RV32IMZBS-NEXT:    srli a4, a3, 4
; RV32IMZBS-NEXT:    sw t5, 88(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    and a3, a3, t5
; RV32IMZBS-NEXT:    and a4, a4, t5
; RV32IMZBS-NEXT:    slli a3, a3, 4
; RV32IMZBS-NEXT:    and a1, a7, a0
...
; RV32IMZBS-NEXT:    slli a3, a3, 1
; RV32IMZBS-NEXT:    mv t5, t2
; RV32IMZBS-NEXT:    and a1, a2, t2
; RV32IMZBS-NEXT:    sw a1, 20(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    or a3, a4, a3
; RV32IMZBS-NEXT:    mv s6, t4
; RV32IMZBS-NEXT:    and a4, a3, t4
; RV32IMZBS-NEXT:    mv s1, t1
; RV32IMZBS-NEXT:    and a5, a3, t1
; RV32IMZBS-NEXT:    and a6, a3, t2
; RV32IMZBS-NEXT:    and a3, a3, a0
; RV32IMZBS-NEXT:    and s10, s0, t1
; RV32IMZBS-NEXT:    sw t1, 96(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    and s9, s0, t4
; RV32IMZBS-NEXT:    and s8, s0, a0
; RV32IMZBS-NEXT:    mv t4, a0
; RV32IMZBS-NEXT:    and s7, s0, t2
; RV32IMZBS-NEXT:    mul a0, s7, a3
; RV32IMZBS-NEXT:    sw a0, 12(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    mul s3, s8, a3
; RV32IMZBS-NEXT:    mul s2, s9, a3
; RV32IMZBS-NEXT:    mul t3, s10, a3
; RV32IMZBS-NEXT:    mul t6, s10, a4
; RV32IMZBS-NEXT:    mul s0, s9, a5
...
; RV32IMZBS-NEXT:    xor a7, t6, a7
; RV32IMZBS-NEXT:    xor a0, a0, a1
; RV32IMZBS-NEXT:    xor a1, s2, a2
; RV32IMZBS-NEXT:    xor a2, a3, t1
; RV32IMZBS-NEXT:    xor a3, a6, t3
; RV32IMZBS-NEXT:    xor a4, a5, a4
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    xor a3, a3, a4
; RV32IMZBS-NEXT:    and a2, a7, s1
; RV32IMZBS-NEXT:    and a0, a0, s6
; RV32IMZBS-NEXT:    and a1, a1, t4
; RV32IMZBS-NEXT:    and a3, a3, t5
; RV32IMZBS-NEXT:    or a0, a0, a2
; RV32IMZBS-NEXT:    or a1, a1, a3
; RV32IMZBS-NEXT:    or a2, t2, s11
; RV32IMZBS-NEXT:    or a0, a0, a1
...
; RV32IMZBS-NEXT:    mul a5, s10, s0
; RV32IMZBS-NEXT:    mul a6, s9, s1
...
; RV32IMZBS-NEXT:    and a3, a3, s5
; RV32IMZBS-NEXT:    slli a3, a3, 2
; RV32IMZBS-NEXT:    mul s1, s7, t6
; RV32IMZBS-NEXT:    mul a7, s9, t6
; RV32IMZBS-NEXT:    or a3, a6, a3
; RV32IMZBS-NEXT:    srli a6, a3, 1
; RV32IMZBS-NEXT:    mv s10, s2
; RV32IMZBS-NEXT:    and a3, a3, s2
; RV32IMZBS-NEXT:    and a6, a6, s2
; RV32IMZBS-NEXT:    slli a3, a3, 1
; RV32IMZBS-NEXT:    mul t0, s8, s0
; RV32IMZBS-NEXT:    or s0, a6, a3
; RV32IMZBS-NEXT:    mul a3, s7, t3
; RV32IMZBS-NEXT:    srli a6, s0, 8
; RV32IMZBS-NEXT:    xor s1, a4, s1
; RV32IMZBS-NEXT:    and a4, a6, s4
; RV32IMZBS-NEXT:    srli a6, s0, 24
; RV32IMZBS-NEXT:    and t1, s0, s4
; RV32IMZBS-NEXT:    slli t2, s0, 24
; RV32IMZBS-NEXT:    slli t1, t1, 8
; RV32IMZBS-NEXT:    or a4, a4, a6
; RV32IMZBS-NEXT:    or a6, t2, t1
; RV32IMZBS-NEXT:    xor s2, a7, a5
; RV32IMZBS-NEXT:    or a4, a6, a4
; RV32IMZBS-NEXT:    xor s4, t0, a3
...
; RV32IMZBS-NEXT:    slli a3, a3, 2
; RV32IMZBS-NEXT:    or t6, a5, a4
; RV32IMZBS-NEXT:    or a3, a6, a3
; RV32IMZBS-NEXT:    srli a4, t6, 8
; RV32IMZBS-NEXT:    srli a5, a3, 1
; RV32IMZBS-NEXT:    and a4, a4, s3
; RV32IMZBS-NEXT:    srli a6, t6, 24
; RV32IMZBS-NEXT:    and a7, t6, s3
; RV32IMZBS-NEXT:    slli t0, t6, 24
...
; RV32IMZBS-NEXT:    or a4, a6, a4
; RV32IMZBS-NEXT:    and s5, a3, s6
; RV32IMZBS-NEXT:    lw s11, 96(sp) # 4-byte Folded Reload
; RV32IMZBS-NEXT:    and a5, a4, s11
; RV32IMZBS-NEXT:    and a6, a3, s11
; RV32IMZBS-NEXT:    and a7, a3, t5
; RV32IMZBS-NEXT:    and a3, a3, t4
; RV32IMZBS-NEXT:    and t0, a4, s6
; RV32IMZBS-NEXT:    and t1, a4, t4
; RV32IMZBS-NEXT:    mv a1, t4
; RV32IMZBS-NEXT:    and a4, a4, t5
; RV32IMZBS-NEXT:    mv s9, t5
; RV32IMZBS-NEXT:    mul t2, a5, s5
; RV32IMZBS-NEXT:    mul t3, t0, a6
; RV32IMZBS-NEXT:    mul t4, t1, a7
; RV32IMZBS-NEXT:    mul t5, a4, a3
; RV32IMZBS-NEXT:    xor s1, a0, s1
; RV32IMZBS-NEXT:    xor s2, s2, s4
; RV32IMZBS-NEXT:    and a2, a2, s11
; RV32IMZBS-NEXT:    lw a0, 52(sp) # 4-byte Folded Reload
; RV32IMZBS-NEXT:    and a0, a0, s6
; RV32IMZBS-NEXT:    mv s8, s6
; RV32IMZBS-NEXT:    and s1, s1, a1
; RV32IMZBS-NEXT:    and s2, s2, s9
; RV32IMZBS-NEXT:    or a0, a0, a2
; RV32IMZBS-NEXT:    or a2, s1, s2
; RV32IMZBS-NEXT:    or a0, a0, a2
; RV32IMZBS-NEXT:    xor a2, t3, t2
; RV32IMZBS-NEXT:    xor t2, t4, t5
; RV32IMZBS-NEXT:    srli t3, a0, 8
; RV32IMZBS-NEXT:    and t3, t3, s3
; RV32IMZBS-NEXT:    srli t4, a0, 24
; RV32IMZBS-NEXT:    mul t5, a5, a7
; RV32IMZBS-NEXT:    mul s1, t0, s5
; RV32IMZBS-NEXT:    mul s2, t1, a3
; RV32IMZBS-NEXT:    mul s4, a4, a6
; RV32IMZBS-NEXT:    mul s6, a5, a6
; RV32IMZBS-NEXT:    mul s7, t0, a3
; RV32IMZBS-NEXT:    or t3, t3, t4
; RV32IMZBS-NEXT:    xor a2, a2, t2
; RV32IMZBS-NEXT:    mul a3, a5, a3
; RV32IMZBS-NEXT:    mul a5, t0, a7
; RV32IMZBS-NEXT:    mul a7, a4, a7
; RV32IMZBS-NEXT:    mul t0, t1, s5
; RV32IMZBS-NEXT:    mul a6, t1, a6
; RV32IMZBS-NEXT:    mul a4, a4, s5
; RV32IMZBS-NEXT:    xor t1, s1, t5
...
; RV32IMZBS-NEXT:    xor a5, t2, a7
; RV32IMZBS-NEXT:    xor a3, a3, a4
; RV32IMZBS-NEXT:    and a4, a5, a1
...
; RV32IMZBS-NEXT:    and a6, a2, s3
; RV32IMZBS-NEXT:    slli a2, a2, 24
; RV32IMZBS-NEXT:    slli a6, a6, 8
; RV32IMZBS-NEXT:    or a3, a3, a5
; RV32IMZBS-NEXT:    or a5, a2, a6
; RV32IMZBS-NEXT:    and a4, a4, ra
...
; RV32IMZBS-NEXT:    or a3, a4, a3
; RV32IMZBS-NEXT:    sw s8, 84(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    and t5, s0, s8
; RV32IMZBS-NEXT:    and a4, a3, s11
; RV32IMZBS-NEXT:    and s1, s0, s11
; RV32IMZBS-NEXT:    and a6, a3, s8
; RV32IMZBS-NEXT:    mul a7, a4, t5
; RV32IMZBS-NEXT:    mul t0, a6, s1
; RV32IMZBS-NEXT:    sw s9, 32(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    and s2, s0, s9
; RV32IMZBS-NEXT:    mv a2, t2
; RV32IMZBS-NEXT:    and t1, a3, t2
; RV32IMZBS-NEXT:    and s0, s0, t2
; RV32IMZBS-NEXT:    and a3, a3, s9
; RV32IMZBS-NEXT:    mul t2, t1, s2
; RV32IMZBS-NEXT:    mul t3, a3, s0
; RV32IMZBS-NEXT:    mul t4, a4, s2
; RV32IMZBS-NEXT:    mul s5, a6, t5
; RV32IMZBS-NEXT:    mul s6, t1, s0
; RV32IMZBS-NEXT:    mul s7, a3, s1
; RV32IMZBS-NEXT:    mul s8, a4, s1
; RV32IMZBS-NEXT:    mul s9, a6, s0
; RV32IMZBS-NEXT:    mul s10, t1, t5
...
; RV32IMZBS-NEXT:    xor a7, s5, t4
; RV32IMZBS-NEXT:    xor t0, s6, s7
; RV32IMZBS-NEXT:    xor a0, a0, a5
; RV32IMZBS-NEXT:    xor a5, a7, t0
; RV32IMZBS-NEXT:    xor a7, s9, s8
...
; RV32IMZBS-NEXT:    and a5, a5, s5
; RV32IMZBS-NEXT:    mv t3, a2
; RV32IMZBS-NEXT:    and a7, a7, a2
; RV32IMZBS-NEXT:    xor a4, a6, a4
; RV32IMZBS-NEXT:    or a6, t2, t0
...
; RV32IMZBS-NEXT:    or a4, t0, a6
; RV32IMZBS-NEXT:    srli a6, a4, 1
; RV32IMZBS-NEXT:    lw a1, 104(sp) # 4-byte Folded Reload
; RV32IMZBS-NEXT:    and a4, a4, a1
; RV32IMZBS-NEXT:    and a6, a6, a1
; RV32IMZBS-NEXT:    slli a4, a4, 1
; RV32IMZBS-NEXT:    lw s4, 32(sp) # 4-byte Folded Reload
; RV32IMZBS-NEXT:    and a3, a3, s4
; RV32IMZBS-NEXT:    or a4, a6, a4
; RV32IMZBS-NEXT:    mv a1, s5
; RV32IMZBS-NEXT:    and a6, a4, s5
; RV32IMZBS-NEXT:    and s5, t6, t4
; RV32IMZBS-NEXT:    and t0, a4, t4
; RV32IMZBS-NEXT:    and t1, a4, s4
; RV32IMZBS-NEXT:    sw t3, 16(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    and a4, a4, t3
; RV32IMZBS-NEXT:    and s7, t6, a1
; RV32IMZBS-NEXT:    and s6, t6, t3
; RV32IMZBS-NEXT:    and t6, t6, s4
; RV32IMZBS-NEXT:    mul t2, s5, a6
; RV32IMZBS-NEXT:    mul t3, s7, t0
; RV32IMZBS-NEXT:    mul t4, s6, t1
; RV32IMZBS-NEXT:    mul s8, t6, a4
; RV32IMZBS-NEXT:    or a2, a5, a0
; RV32IMZBS-NEXT:    or a3, a7, a3
; RV32IMZBS-NEXT:    mul a5, s5, t1
; RV32IMZBS-NEXT:    mul a7, s7, a6
; RV32IMZBS-NEXT:    mul s9, s6, a4
; RV32IMZBS-NEXT:    mul s10, t6, t0
; RV32IMZBS-NEXT:    mul s11, s5, t0
; RV32IMZBS-NEXT:    mul ra, s7, a4
; RV32IMZBS-NEXT:    mul a1, s6, a6
; RV32IMZBS-NEXT:    mul a0, t6, t1
; RV32IMZBS-NEXT:    xor t2, t3, t2
; RV32IMZBS-NEXT:    xor t3, t4, s8
; RV32IMZBS-NEXT:    mul a4, s5, a4
; RV32IMZBS-NEXT:    mul t1, s7, t1
; RV32IMZBS-NEXT:    mul t0, s6, t0
; RV32IMZBS-NEXT:    mul a6, t6, a6
; RV32IMZBS-NEXT:    xor a5, a7, a5
; RV32IMZBS-NEXT:    xor a7, s9, s10
; RV32IMZBS-NEXT:    xor t2, t2, t3
; RV32IMZBS-NEXT:    xor a5, a5, a7
; RV32IMZBS-NEXT:    xor a7, ra, s11
; RV32IMZBS-NEXT:    xor a0, a1, a0
; RV32IMZBS-NEXT:    lw s9, 96(sp) # 4-byte Folded Reload
; RV32IMZBS-NEXT:    and a1, t2, s9
...
; RV32IMZBS-NEXT:    srli a1, a1, 1
; RV32IMZBS-NEXT:    xor a0, a0, a2
; RV32IMZBS-NEXT:    and a2, a6, s8
; RV32IMZBS-NEXT:    xor s4, a1, a0
; RV32IMZBS-NEXT:    slli a2, a2, 2
; RV32IMZBS-NEXT:    srli a0, s4, 8
; RV32IMZBS-NEXT:    and a0, a0, s3
; RV32IMZBS-NEXT:    srli a3, s4, 24
; RV32IMZBS-NEXT:    or a2, a5, a2
; RV32IMZBS-NEXT:    or a3, a0, a3
; RV32IMZBS-NEXT:    mul a0, s5, t5
; RV32IMZBS-NEXT:    mul a1, s7, s1
; RV32IMZBS-NEXT:    mul a4, s6, s2
; RV32IMZBS-NEXT:    mul a5, t6, s0
; RV32IMZBS-NEXT:    mul a6, s5, s2
; RV32IMZBS-NEXT:    mul a7, s7, t5
; RV32IMZBS-NEXT:    mul t0, s6, s0
; RV32IMZBS-NEXT:    mul t1, t6, s1
; RV32IMZBS-NEXT:    mul t2, s5, s1
; RV32IMZBS-NEXT:    mul t3, s5, s0
; RV32IMZBS-NEXT:    mul t4, s7, s0
; RV32IMZBS-NEXT:    mul s0, s7, s2
; RV32IMZBS-NEXT:    mul s2, t6, s2
; RV32IMZBS-NEXT:    mul s5, s6, t5
...
; RV32IMZBS-NEXT:    and a1, a1, ra
; RV32IMZBS-NEXT:    xor a4, t4, t2
; RV32IMZBS-NEXT:    xor a5, s5, s2
; RV32IMZBS-NEXT:    xor a6, s0, t3
; RV32IMZBS-NEXT:    xor a7, s1, t5
; RV32IMZBS-NEXT:    xor a4, a4, a5
; RV32IMZBS-NEXT:    xor a5, a6, a7
...
; RV64IMZBS-NEXT:    mv a4, a3
; RV64IMZBS-NEXT:    mv a6, a1
